...
Type
  ...
  Public
    ...
    Function EMoneyExt (TheAmount : Extended; MonedaUnidad, MonedaDecimal: string; EuroMode : Boolean) : String;
...
Function TNumWords.EMoneyExt (TheAmount : Extended; MonedaUnidad, MonedaDecimal: string; EuroMode : Boolean) : String;
Begin
  If LanguageDriver = Nil Then InitialiseNumWords;
  LanguageDriver.BigSing := MonedaUnidad;
  LanguageDriver.BigPlural := MonedaUnidad;
  LanguageDriver.SmallSing := MonedaDecimal;
  LanguageDriver.SmallPlural := MonedaDecimal;
