...
uses
  ...
  StrUtils, PNGImage, Messages, Graphics, AdvStyleIF;
...
const
  ...
  // v1.1.3.1 : Fixed : VCL styles check updated to work in 10.4 Sydney
  // v1.1.3.2 : Fixed : Issue with toggling enabled at runtime
...
begin
  if (FHoverColor <> clNone) and Enabled then
