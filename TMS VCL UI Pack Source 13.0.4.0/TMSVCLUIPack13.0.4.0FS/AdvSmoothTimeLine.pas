...
const
  ...
  // v2.8.0.0 : New : Support for Office 2019 styles
  // v2.8.1.0 : New : UIStyle property for TMSStyle
  // v2.8.1.1 : Fixed : UIStyle set to tsCustom after initial Office look
  // v2.8.1.2 : Improved : On creation check for enabeld AdvFormStyler
  // v2.8.1.3 : Fixed : VCL styles check updated to work in 10.4 Sydney
  // v2.8.2.0 : New : StyleElements property exposed
...
{$ENDIF}
    property OnChange: TNotifyEvent read FOnChange write FOnChange;
    property Style: TTMSStyle read FTMSStyle write SetUIStyle default tsCustom;
  end;
  ...
  tsWindows8, tsWindows10:
    ...
    tsOffice2019White:
      begin
        ...
        TimeLineBar.Fill.Color := clWhite;
        TimeLineBar.Fill.ColorTo := clNone;
        TimeLineBar.Fill.BorderColor := $00ABABAB;

        DefaultSectionFill.Color := $00F2E1D5;
        DefaultSectionFill.ColorTo := $00F2E1D5;
        DefaultSectionFill.ColorMirror := clNone;
        DefaultSectionFill.ColorMirrorTo := clNone;
        DefaultSectionFill.BorderColor := $00F2E1D5;
        DefaultSectionFill.GradientMirrorType := gtVertical;

        RangeAppearance.DivisionFont.Color := $00444648;
        RangeAppearance.SubDivisionFont.Color := $00444648;
        RangeAppearance.DivisionTickMarkColor := $00444648;
        RangeAppearance.SubDivisionTickMarkColor := $00444648;
      end;
    ...
    tsOffice2019Gray:
      begin
        ...
        TimeLineBar.Fill.Color := $00D4D4D4;
        TimeLineBar.Fill.ColorTo := clNone;
        TimeLineBar.Fill.BorderColor := $00808080;

        DefaultSectionFill.Color := $00969696;
        DefaultSectionFill.ColorTo := $00969696;
        DefaultSectionFill.ColorMirror := clNone;
        DefaultSectionFill.ColorMirrorTo := clNone;
        DefaultSectionFill.BorderColor := $00969696;
        DefaultSectionFill.GradientMirrorType := gtVertical;

        RangeAppearance.DivisionFont.Color := $00232425;
        RangeAppearance.SubDivisionFont.Color := $00232425;
        RangeAppearance.DivisionTickMarkColor := $00232425;
        RangeAppearance.SubDivisionTickMarkColor := $00232425;
      end;
    ...
    tsOffice2019Black:
      begin
        ...
        TimeLineBar.Fill.Color := $00444444;
        TimeLineBar.Fill.ColorTo := clNone;
        TimeLineBar.Fill.BorderColor := $00686868;

        DefaultSectionFill.Color := $00505050;
        DefaultSectionFill.ColorTo := $00505050;
        DefaultSectionFill.ColorMirror := clNone;
        DefaultSectionFill.ColorMirrorTo := clNone;
        DefaultSectionFill.BorderColor := $00505050;
        DefaultSectionFill.GradientMirrorType := gtVertical;
...
procedure TAdvSmoothTimeLine.SetUIStyle(const Value: TTMSStyle);
begin
