...
type
  ...
  public
    ...
    procedure SetLogPixX(AValue: Integer);
    procedure SetLogPixY(AValue: Integer);
  published
...
procedure TAdvImage.SetLogPixX(AValue: Integer);
begin
  FLogPixX := AValue;
end;

procedure TAdvImage.SetLogPixY(AValue: Integer);
begin
  FLogPixY := AValue;
end;
