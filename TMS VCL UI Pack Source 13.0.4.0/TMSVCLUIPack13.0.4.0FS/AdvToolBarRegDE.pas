...
uses
  AdvToolBar, AdvToolBarDE, AdvToolBarStylers, AdvGlowButton, GDIPicture, AdvAppStyler;
...
begin
  ...
  RegisterSelectionEditor(TAdvFormStyler, TAdvFormStylerSelectionEditor);
  RegisterSelectionEditor(TAdvAppStyler, TAdvFormStylerSelectionEditor);
