...
begin
  ...
  OpenDialog.Filter := 'All (*.jpg;*.jpeg;*.gif;*.bmp;*.png;*.ico;*tiff;*.svg)|*.jpg;*.jpeg;*.gif;*.' +
      'bmp;*.png;*.ico;*.tiff;*.svg|JPEG Image File (*.jpg)|*.jpg|JPEG Image File (*' +
      '.jpeg)|*.jpeg|GIF files (*.gif)|*.gif|Bitmaps (*.bmp)|*.bmp|PNG ' +
      'files (*.png)|*.png|ICO files (*.ico)|*.ico|TIFF files (*.tiff)|*.tiff|Scalable Vector Graphics (*.svg)|*.svg';
