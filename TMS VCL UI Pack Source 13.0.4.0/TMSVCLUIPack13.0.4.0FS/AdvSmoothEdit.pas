...
const
  ...
  // v2.8.6.0 : New : BorderColor property implemented
...
begin
  ...
  try
    ...
    begin
      ...
      if not (FBorderColor <> clNone) then
        FrameRect(DC, ARect, BtnFaceBrush);
    end;
  finally
...
begin
  inherited;
  if (FFocusBorderColor <> clNone) or (not Enabled and DisabledBorder) or (FBorderColor <> clNone) then
    DrawBorder;
end;
...
procedure TAdvSmoothEdit.SetBorderColor(const Value: TColor);
begin
  FBorderColor := Value;
  Invalidate;
end;
