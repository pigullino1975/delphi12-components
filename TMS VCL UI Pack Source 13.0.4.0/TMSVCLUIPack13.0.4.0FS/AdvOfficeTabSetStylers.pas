...
begin
  ...
  case ot of
    ...
    ot2019White: Style := tsOffice2019White;
    ot2019Gray: Style := tsOffice2019Gray;
    ot2019Black: Style := tsOffice2019Black;
  end;
...
begin
  SetOfficeTabSetStyleAndAppColor(TOfficeTabSetStyle(AStyle), AppColor);
end;
...
begin
  SetOfficeTabSetStyleAndAppColor(Value, clNone);
end;
...
begin
  ...
  if FOfficeTabSetStyle <> tsCustom then
  begin
    BlendFactor := 50;
