...
const
  ...
  // v1.4.1.3 : Fixed : Access violation while closing with non modal dialogs
      ...
      case AStyle of
       ...
       tsOffice2013Gray:
        ...
        begin
          BackGroundFill.Color := clWhite;
          BackGroundFill.ColorTo := clWhite;
          BackGroundFill.BorderColor := $00C4C6C8;
        ...
        begin
          ...
          BackGroundFill.ColorTo := $00B8BBBE;
          BackGroundFill.BorderColor := $00666666;
        ...
        begin
          ...
          BackGroundFill.ColorTo := $00303132;
          BackGroundFill.BorderColor := $00ADB0B3;
...
procedure TAdvSmoothMessageDialog.SetUIStyle(const Value: TTMSStyle);
begin
...
begin
  inherited;
  if Assigned(Dialog) and not Dialog.FBlockFRMSet and not Dialog.frmclosed then
  begin
