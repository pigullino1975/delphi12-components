...
uses
  ...
  AdvGlowButton, AdvMetroTile, Forms;
...
const
  ...
  // v1.1.1.3 : Fixed : Issue with z-order for badges on TAdvGlowButton
  // v1.1.1.4 : Fixed : Issue with high DPI during runtime creation
  // v1.1.1.5 : Fixed : Regression with badge high DPI handling
  // v1.1.1.6 : Fixed : Adapted high DPI calculation
...
type
  ...
  public
    ...
    property BadgeCtrl: TAdvBadge read FBadgeCtrl;
  published
    property Badge: string read FBadge write SetBadge;
    property BadgeColor: TColor read FBadgeColor write SetBadgeColor default clRed;
    property BadgeTextColor: TColor read FBadgeTextColor write SetBadgeTextColor default clWhite;
...
{$IFDEF DELPHIXE11_LVL}
procedure TAdvBadge.ScaleForPPI(NewPPI: Integer);
begin
  //  do nothing
end;
{$ENDIF}
