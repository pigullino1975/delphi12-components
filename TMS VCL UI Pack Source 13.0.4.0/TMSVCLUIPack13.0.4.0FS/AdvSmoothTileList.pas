...
const
  ...
  // v1.7.1.0 : New : UIStyle property for TMSStyle
  // v1.7.1.1 : Fixed : UIStyle set to tsCustom after initial Office look
  // v1.7.1.2 : Improved : On creation check for enabeld AdvFormStyler
  // v1.7.1.3 : Fixed : VCL styles check updated to work in 10.4 Sydney
  // v1.7.1.4 : Improved : GDIP drawing of the tiles
...
uses
  ShellApi, CommCtrl, GDIPHTMLEngine;
...
begin
  ...
  tsOffice2019White:
    begin
      ...
      Header.Fill.ColorTo := clNone;
      Header.Font.Color := clBlack;
      Header.Fill.BorderColor := $00ABABAB;

      Footer.Fill.Color := clWhite;
      Footer.Fill.ColorTo := clNone;
      Footer.Font.Color := clBlack;
      Footer.Fill.BorderColor := $00ABABAB;
      ...
      TileAppearance.SmallViewFillDisabled.ColorMirror := clNone;
      TileAppearance.SmallViewFillDisabled.ColorMirrorTo := clNone;
      TileAppearance.SmallViewFillDisabled.BorderColor := $00D4D4D4;
      TileAppearance.SmallViewFillDisabled.GradientMirrorType := gtVertical;

      TileAppearance.SmallViewFillSelected.Color := $00E3BDA3;
      TileAppearance.SmallViewFillSelected.ColorTo := clNone;
      TileAppearance.SmallViewFillSelected.ColorMirror := clNone;
      TileAppearance.SmallViewFillSelected.ColorMirrorTo := clNone;
      TileAppearance.SmallViewFillSelected.BorderColor := $00E3BDA3;
      TileAppearance.SmallViewFillSelected.GradientMirrorType := gtVertical;
      TileAppearance.SmallViewFillSelected.Glow:= gmNone;
      TileAppearance.SmallViewFillSelected.GlowGradientColor:= clNone;

      TileAppearance.SmallViewFillHover.Color := $00F2E1D5;
      TileAppearance.SmallViewFillHover.ColorTo := $00F2E1D5;
      TileAppearance.SmallViewFillHover.ColorMirror := clNone;
      TileAppearance.SmallViewFillHover.ColorMirrorTo := clNone;
      TileAppearance.SmallViewFillHover.BorderColor := $00F2E1D5;
      TileAppearance.SmallViewFillHover.GradientMirrorType := gtVertical;
    end;
  tsOffice2019Gray:
    begin
      ...
      Header.Fill.ColorTo := clNone;
      Header.Font.Color := clBlack;
      Header.Fill.BorderColor := $00808080;

      Footer.Fill.Color := $00B8BBBE;
      Footer.Fill.ColorTo := clNone;
      Footer.Font.Color := clBlack;
      Footer.Fill.BorderColor := $00808080;

      TileAppearance.SmallViewFill.Color := $00B8BBBE;
      TileAppearance.SmallViewFill.ColorTo := clNone;
      TileAppearance.SmallViewFill.ColorMirror := clNone;
      TileAppearance.SmallViewFill.ColorMirrorTo := clNone;
      TileAppearance.SmallViewFill.BorderColor := $00B8BBBE;
      TileAppearance.SmallViewFill.GradientMirrorType := gtVertical;

      TileAppearance.SmallViewFillDisabled.Color := $00B8BBBE;
      TileAppearance.SmallViewFillDisabled.ColorTo := $00B8BBBE;
      TileAppearance.SmallViewFillDisabled.ColorMirror := clNone;
      TileAppearance.SmallViewFillDisabled.ColorMirrorTo := clNone;
      TileAppearance.SmallViewFillDisabled.BorderColor := $00D4D4D4;
      TileAppearance.SmallViewFillDisabled.GradientMirrorType := gtVertical;

      TileAppearance.SmallViewFillSelected.Color := $00666666;
      TileAppearance.SmallViewFillSelected.ColorTo := clNone;
      TileAppearance.SmallViewFillSelected.ColorMirror := clNone;
      TileAppearance.SmallViewFillSelected.ColorMirrorTo := clNone;
      TileAppearance.SmallViewFillSelected.BorderColor := $00666666;
      TileAppearance.SmallViewFillSelected.GradientMirrorType := gtVertical;
      TileAppearance.SmallViewFillSelected.Glow:= gmNone;
      TileAppearance.SmallViewFillSelected.GlowGradientColor:= clNone;

      TileAppearance.SmallViewFillHover.Color := $00969696;
      TileAppearance.SmallViewFillHover.ColorTo := $00969696;
      TileAppearance.SmallViewFillHover.ColorMirror := clNone;
      TileAppearance.SmallViewFillHover.ColorMirrorTo := clNone;
      TileAppearance.SmallViewFillHover.BorderColor :=  $00969696;
      TileAppearance.SmallViewFillHover.GradientMirrorType := gtVertical;
    end;
  tsOffice2019Black:
    begin
      ...
      TileAppearance.SmallViewFont.Color:= $00FFFFFF;
      TileAppearance.SmallViewFontSelected.Color:= $00FFFFFF;
      TileAppearance.SmallViewFontDisabled.Color:= $00DADADA;
      TileAppearance.SmallViewFontHover.Color:= $00FFFFFF;

      TileAppearance.SmallViewFill.Color := $00303132;
      TileAppearance.SmallViewFill.ColorTo := clNone;
      TileAppearance.SmallViewFill.ColorMirror := clNone;
      TileAppearance.SmallViewFill.ColorMirrorTo := clNone;
      TileAppearance.SmallViewFill.BorderColor := $00303132;
      TileAppearance.SmallViewFill.GradientMirrorType := gtVertical;

      TileAppearance.SmallViewFillDisabled.Color := $00303132;
      TileAppearance.SmallViewFillDisabled.ColorTo := $00303132;
      TileAppearance.SmallViewFillDisabled.ColorMirror := clNone;
      TileAppearance.SmallViewFillDisabled.ColorMirrorTo := clNone;
      TileAppearance.SmallViewFillDisabled.BorderColor := $00DADADA;
      TileAppearance.SmallViewFillDisabled.GradientMirrorType := gtVertical;

      TileAppearance.SmallViewFillSelected.Color := $00828282;
      TileAppearance.SmallViewFillSelected.ColorTo := clNone;
      TileAppearance.SmallViewFillSelected.ColorMirror := clNone;
      TileAppearance.SmallViewFillSelected.ColorMirrorTo := clNone;
      TileAppearance.SmallViewFillSelected.BorderColor := $00828282;
      TileAppearance.SmallViewFillSelected.GradientMirrorType := gtVertical;
      TileAppearance.SmallViewFillSelected.Glow:= gmNone;
      TileAppearance.SmallViewFillSelected.GlowGradientColor:= clNone;

      TileAppearance.SmallViewFillHover.Color := $00686868;
      TileAppearance.SmallViewFillHover.ColorTo := $00686868;
      TileAppearance.SmallViewFillHover.ColorMirror := clNone;
      TileAppearance.SmallViewFillHover.ColorMirrorTo := clNone;
      TileAppearance.SmallViewFillHover.BorderColor :=  $00686868;
      TileAppearance.SmallViewFillHover.GradientMirrorType := gtVertical;
      end;
  end;
...
procedure TAdvSmoothTileList.SetUIStyle(const Value: TTMSStyle);
begin
...
begin
  ...
  begin
    ...
    begin
      ...
      begin
        ft := g.MakeFontEx(Font, Round(DPIScale * Font.Size));
...
begin
  ...
  f := g.MakeFontEx(ft, Round(ft.Size * GetDPIScale(Tile.FOwner, Tile.FOwner.Canvas )));
  sf := TGPStringFormat.Create;
