...
uses
  Classes, AdvPDFLib, AdvMemo, AdvPDFIO, AdvGraphicsTypes, AdvTypes, Types;
...
uses
  AdvUtils, Forms, SysUtils, AdvGraphics, Graphics
  {$HINTS OFF}
...
procedure TAdvCustomMemoPDFIO.DoPDFExport(const APDFLib: TAdvPDFLib; const AExportObject: TAdvPDFIOExportObject; const AExportRect: TRectF);
begin
