...
const
  ...
  //v1.0.0.1 : Fixed : Button size was not correct on high DPI
...
begin
  ...
  case GraphicPosition of
    gpLeft: ri := Bounds(Round(r.x + DPIScale * ControlMargin.Left), Round(r.y + (r.height - DPIScale * ButtonHeight) / 2), Round(DPIScale * ButtonWidth), Round(DPIScale * ButtonHeight));
    gpRight: ri := Bounds(Round(r.x + r.Width - DPIScale * ButtonWidth - DPIScale * ControlMargin.Right), Round(r.y + (r.height - DPIScale * ButtonHeight) / 2), Round(DPIScale * ButtonWidth), Round(DPIScale * ButtonHeight));
  end;
...
begin
  case GraphicPosition of
    gpLeft:
    begin
      ARect.X := ARect.X + Round(DPIScale * ControlMargin.Left) + Round(DPIScale * ButtonWidth) - 16;
      ARect.Width := Arect.Width - Round(DPIScale * ControlMargin.Left) - Round(DPIScale * ButtonWidth) + 16;
    end;
    gpRight:
    begin
      ARect.Width := ARect.Width - Round(DPIScale * ButtonWidth) - Round(DPIScale * ControlMargin.Right) + 16;
    end;
  end;
...
begin
  case GraphicPosition of
    gpLeft:
    begin
      ARect.X := ARect.X + Round(DPIScale * ControlMargin.Left) + Round(DPIScale * ButtonWidth);
      ARect.Width := Arect.Width - Round(DPIScale * ControlMargin.Left) - Round(DPIScale * ButtonWidth);
    end;
    gpRight:
    begin
      ARect.Width := ARect.Width - Round(DPIScale * ButtonWidth) - Round(DPIScale * ControlMargin.Right);
    end;
  end;
...
begin
  Result := false;
  case GraphicPosition of
    gpLeft: Result := PtInRect(Bounds(Round(x + DPIScale * ControlMargin.Left), Round(y + (height - Round(DPIScale * ButtonHeight)) / 2), Round(DPIScale * ButtonWidth), Round(DPIScale * ButtonHeight)), Point(pX, pY));
    gpRight: Result := PtInRect(Bounds(Round(x + Width - DPIScale * ButtonWidth - DPIScale * ControlMargin.Right), Round(y + (height - Round(DPIScale * ButtonHeight)) / 2), Round(DPIScale * ButtonWidth), Round(DPIScale * ButtonHeight)), Point(pX, pY));
  end;
end;
