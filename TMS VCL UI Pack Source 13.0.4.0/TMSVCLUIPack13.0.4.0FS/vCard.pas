...
const
  ...
  // v1.1.1.1 : Improved : Added flexibility to parse non-ISO formatted dates
  // v1.1.1.2 : Improved : telephone type specifier adding in export
...
begin
  ...
  begin
    ...
    Result := Result + 'TEL' + Ty + FieldTypeToStr(vContact.PhoneNumbers[i].FieldType, vContact.vCardVersion) + PreferredToStr
