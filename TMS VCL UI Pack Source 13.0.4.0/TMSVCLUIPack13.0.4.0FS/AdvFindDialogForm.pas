...
begin
  ...
  frm.FMemoVisible := fdovFindMemo in VisibleOptions;
...
begin
  ...
  if not More then
  begin
    Label2.Visible := FMemoVisible;
    Memo1.Visible := FMemoVisible;
