...
const
  ...
  // v2.7.0.0 : New : Support for Office 2019 styles
  //          : New : Property StyleElements added
  // v2.7.1.0 : New : Style property for TMSStyle
  // v2.7.1.1 : Fixed : UIStyle set to tsCustom after initial Office look
  // v2.7.1.2 : Improved : On creation check for enabled AdvFormStyler
  // v2.7.1.3 : Fixed : Issue with scroll flickering and never ending animation
  // v2.7.1.4 : Fixed : VCL styles check updated to work in 10.4 Sydney
  // v2.7.2.0 : New : DragScroll property similar to TAdvSmoothListbox to disable scrolling with the left mouse button.
  // v2.7.2.1 : Fixed : HTML caption location and improvements on GDIP drawing
  // v2.7.3.0 : New: OnMultiItemSelect event introduced for better handling when multiselect is enabled
  // v2.7.3.1 : Fixed : Issue with multi selection for filtered items
...
type
  ...
  TAdvSmoothImageListBoxMultiItemEvent = procedure(Sender: TObject; LastSelectedItemIndex: integer; SelectedItems: TAdvSmoothImageListBoxItemArray) of object;
  ...
  private
    ...
    FDPIScale: single;
    FDragScroll: boolean;
    FOnMultiItemSelect: TAdvSmoothImageListBoxMultiItemEvent;
  ...
  protected
    ...
    procedure DoMultiItemSelect(ALastItemIndex: Integer; ASelectedItems: TAdvSmoothImageListBoxItemArray); virtual;
  ...
  published
    ...
    property OnMultiItemSelect: TAdvSmoothImageListBoxMultiItemEvent read FOnMultiItemSelect write FOnMultiItemSelect;
...
function TAdvSmoothImageListBox.UseVCLStyle: boolean;
begin
  Result := CheckVCLStylesEnabled(StyleServices, (csDesigning in ComponentState));
  {$IFDEF DELPHIXE6_LVL}
...
procedure TAdvSmoothImageListBox.DoMultiItemSelect(ALastItemIndex: Integer;
  ASelectedItems: TAdvSmoothImageListBoxItemArray);
begin
  if Assigned(OnMultiItemSelect) then
    OnMultiItemSelect(Self, ALastItemIndex, ASelectedItems);
end;
            ...
            begin
              ...
              begin
                ...
                begin
                  ...
                  begin
                    if ((FSelectedItemIndex = Index) and not MultiSelect) or (MultiSelect and Selected) then
                    begin
...
begin
  ...
  for I := 0 to FDisplayList.Count - 1 do
  begin
    if FDisplayList.GetItem(i).Rectangle.Y <> y - CurrentScPos then
    begin
...
begin
  ...
  for I := 0 to FDisplayList.Count - 1 do
  begin
    if FDisplayList.GetItem(i).Rectangle.X <> x - CurrentScPos then
    begin
...
begin
  ...
  {$IFDEF DELPHIXE2_LVL}
  if not (csDesigning in ComponentState) and UseVCLStyle then
  begin
    SetColorTones(GetVCLStyleTones);
  end;
  {$ENDIF}
      ...
      begin
        ...
        begin
          ...
          begin
            ...
            if MultiSelect then
              DoMultiItemSelect(sel, Items.SelectedItems);
          end;
        end
        else
        begin
        ...
        begin
          ...
          begin
            ...
            begin
              ...
              DoMultiItemSelect(FFocusedItemIndex, Items.SelectedItems);
            end
          end;
...
case AStyle of
  ...
  tsOffice2016Black:
    ...
    begin
      ...
      ItemAppearance.DisabledFill.ColorMirror := clNone;
      ItemAppearance.DisabledFill.ColorMirrorTo := clNone;
      ItemAppearance.DisabledFill.BorderColor := $00D4D4D4;
      ItemAppearance.DisabledFill.GradientMirrorType := gtVertical;

      ItemAppearance.SelectedFill.Color := $00E3BDA3;
      ItemAppearance.SelectedFill.ColorTo := clNone;
      ItemAppearance.SelectedFill.ColorMirror := clNone;
      ItemAppearance.SelectedFill.ColorMirrorTo := clNone;
      ItemAppearance.SelectedFill.BorderColor := $00E3BDA3;
      ItemAppearance.SelectedFill.GradientMirrorType := gtVertical;
      ItemAppearance.SelectedFill.Glow:= gmNone;
      ItemAppearance.SelectedFill.GlowGradientColor:= clNone;

      ItemAppearance.HoverFill.Color := $00F2E1D5;
      ItemAppearance.HoverFill.ColorTo := clNone;
      ItemAppearance.HoverFill.ColorMirror := clNone;
      ItemAppearance.HoverFill.ColorMirrorTo := clNone;
      ItemAppearance.HoverFill.BorderColor :=  $00F2E1D5;
      ItemAppearance.HoverFill.GradientMirrorType := gtVertical;

      Footer.Navigator.Color := $00F0F0F0;
      Footer.Navigator.HoverColor := $00FAECE3;
      Footer.Navigator.DownColor := $00B0784A;
      Footer.Navigator.BorderColor := $00C4C6C8;
      Footer.Navigator.DisabledColor := clWhite;

      ItemAppearance.Splitter.ExpanderColor := clWhite;
      ItemAppearance.Splitter.ExpanderHoverColor := $00F2E1D5;
      ItemAppearance.Splitter.ExpanderDownColor := $00E3BDA3;
      ItemAppearance.Splitter.ExpanderBorderColor := $00C4C6C8;

      Header.Navigator.Color := $00F0F0F0;
      Header.Navigator.HoverColor := $00FAECE3;
      Header.Navigator.DownColor := $00B0784A;
      Header.Navigator.BorderColor := $00C4C6C8;
      Header.Navigator.DisabledColor := clWhite;

      with ItemAppearance.Splitter do
      begin
        Fill.Color := $00F2E1D5;
        Fill.ColorTo := $00F2E1D5;
        Fill.BorderColor := $00F2E1D5;
      end;
    end;
  tsOffice2019Gray:
    begin
      ...
      ItemAppearance.DisabledFill.Color := $00B8BBBE;
      ItemAppearance.DisabledFill.ColorTo := clNone;
      ItemAppearance.DisabledFill.ColorMirror := clNone;
      ItemAppearance.DisabledFill.ColorMirrorTo := clNone;
      ItemAppearance.DisabledFill.BorderColor := $00D4D4D4;
      ...
      ItemAppearance.SelectedFill.Color := $00666666;
      ItemAppearance.SelectedFill.ColorTo := clNone;
      ItemAppearance.SelectedFill.ColorMirror := clNone;
      ItemAppearance.SelectedFill.ColorMirrorTo := clNone;
      ItemAppearance.SelectedFill.BorderColor := $00666666;
      ItemAppearance.SelectedFill.GradientMirrorType := gtVertical;
      ItemAppearance.SelectedFill.Glow:= gmNone;
      ItemAppearance.SelectedFill.GlowGradientColor:= clNone;

      ItemAppearance.HoverFill.Color := $00969696;
      ItemAppearance.HoverFill.ColorTo := $00969696;
      ItemAppearance.HoverFill.ColorMirror := clNone;
      ItemAppearance.HoverFill.ColorMirrorTo := clNone;
      ItemAppearance.HoverFill.BorderColor :=  $00969696;
      ItemAppearance.HoverFill.GradientMirrorType := gtVertical;


      Footer.Navigator.Color := $00D4D4D4;
      Footer.Navigator.HoverColor := $00939597;
      Footer.Navigator.DownColor := $0086888A;
      Footer.Navigator.BorderColor := $00C4C6C8;
      Footer.Navigator.DisabledColor := $00B8BBBE;

      ItemAppearance.Splitter.ExpanderColor := $00B8BBBE;
      ItemAppearance.Splitter.ExpanderHoverColor := $00939597;
      ItemAppearance.Splitter.ExpanderDownColor := $0086888A;
      ItemAppearance.Splitter.ExpanderBorderColor := $00C4C6C8;

      Header.Navigator.Color := $00D4D4D4;
      Header.Navigator.HoverColor := $00939597;
      Header.Navigator.DownColor := $0086888A;
      Header.Navigator.BorderColor := $00C4C6C8;
      Header.Navigator.DisabledColor := $00B8BBBE;

      with ItemAppearance.Splitter do
      begin
        Fill.Color := $00969696;
        Fill.ColorTo := $00969696;
        Fill.BorderColor := $00969696;
      end;
    end;
  tsOffice2019Black:
    begin
      ...
      ItemAppearance.DisabledFill.Color := $00303132;
      ItemAppearance.DisabledFill.ColorTo := clNone;
      ItemAppearance.DisabledFill.ColorMirror := clNone;
      ItemAppearance.DisabledFill.ColorMirrorTo := clNone;
      ItemAppearance.DisabledFill.BorderColor := $00D4D4D4;
      ...
      ItemAppearance.SelectedFill.Color := $00828282;
      ItemAppearance.SelectedFill.ColorTo := clNone;
      ItemAppearance.SelectedFill.ColorMirror := clNone;
      ItemAppearance.SelectedFill.ColorMirrorTo := clNone;
      ItemAppearance.SelectedFill.BorderColor := $00828282;
      ItemAppearance.SelectedFill.GradientMirrorType := gtVertical;
      ItemAppearance.SelectedFill.Glow:= gmNone;
      ItemAppearance.SelectedFill.GlowGradientColor:= clNone;

      ItemAppearance.HoverFill.Color := $00686868;
      ItemAppearance.HoverFill.ColorTo := $00686868;
      ItemAppearance.HoverFill.ColorMirror := clNone;
      ItemAppearance.HoverFill.ColorMirrorTo := clNone;
      ItemAppearance.HoverFill.BorderColor :=  $00686868;
      ItemAppearance.HoverFill.GradientMirrorType := gtVertical;

      Footer.Navigator.Color := $00444444;
      Footer.Navigator.HoverColor := $00444648;
      Footer.Navigator.DownColor := $005C5E60;
      Footer.Navigator.BorderColor := $00ADB0B3;
      Footer.Navigator.DisabledColor := $00303132;
      Footer.Navigator.ArrowColor := clWhite;
      Footer.Navigator.ArrowColorHover := clWhite;
      Footer.Navigator.ArrowColorDown := clWhite;
      Footer.Navigator.ArrowColorDisabled := $00303132;

      ItemAppearance.Splitter.ExpanderColor := $363636;
      ItemAppearance.Splitter.ExpanderHoverColor := $00686868;
      ItemAppearance.Splitter.ExpanderDownColor := $00828282;
      ItemAppearance.Splitter.ExpanderBorderColor := $00ADB0B3;

      Header.Navigator.Color := $00444444;
      Header.Navigator.HoverColor := $00444648;
      Header.Navigator.DownColor := $005C5E60;
      Header.Navigator.BorderColor := $00ADB0B3;
      Header.Navigator.DisabledColor := $00303132;
      Header.Navigator.ArrowColor := clWhite;
      Header.Navigator.ArrowColorHover := clWhite;
      Header.Navigator.ArrowColorDown := clWhite;
      Header.Navigator.ArrowColorDisabled := $00303132;


      with ItemAppearance.Splitter do
      begin
        Fill.Color := $00686868;
        Fill.ColorTo := $00686868;
        Fill.BorderColor := $00686868;
      end;
    end;
  end;
end;
...
procedure TAdvSmoothImageListBox.SetUIStyle(const Value: TTMSStyle);
begin
      ...
      begin
        ...
        begin
          ...
          begin
            ...
            {$IFDEF DELPHIXE_LVL}
            if Image.HasSVG then
              Image.DrawSVG(g, FX, FY, FWidth, FHeight)
            else
            {$ENDIF}
