...
const
  ...
  // v1.5.0.1   : Fixed : Design-time TAdvToolPanel painting
  // v1.5.1.0   : New : UIStyle property for office look
  //            : Improved : On creation check for enabled AdvFormStyler
  // v1.5.1.1   : Fixed : Issue with opening share drives
  // v1.5.1.2   : Improved : Code to retrieve folder tree from OS
     ...
     tsOffice2013White:
      ...
      begin
        ...
        begin
          ...
          BorderColorNodeHot := $00F2E1D5;
          ColorDown := $00E3BDA3;
          ColorDownTo := $00E3BDA3;
          ColorMirrorDown := $00E3BDA3;
          ColorMirrorDownTo := $00E3BDA3;
          ColorHot := $000F2E1D5;
          ColorHotTo := $00F2E1D5;
          ColorMirrorHot := $00F2E1D5;
          ColorMirrorHotTo := $00F2E1D5;
          ColorNodeHot := $00F2E1D5;
          ColorNodeHotTo := $00F2E1D5;
          ColorMirrorNodeHot := $00F2E1D5;
          ColorMirrorNodeHotTo := $00F2E1D5;
          Font.Color := $00444648;
        end;
      end;
      tsOffice2019Gray:
      begin
        OuterBorderColor := $00808080;
        InnerBorderColor := clNone;
        FocusouterBorderColor := clNone;
        FocusInnerBorderColor := brdr;
        InnerMostBorderColor := clNone;
        ...
        begin
          ArrowColorDown := clBlack;
          ArrowColorHot := clBlack;
          BorderColorDown := $00505050;
          BorderColorHot := $00505050;
          BorderColorNodeHot := $00505050;
          ColorDown := $00666666;
          ColorDownTo := $00666666;
          ColorMirrorDown := $00666666;
          ColorMirrorDownTo := $00666666;
          ColorHot := $00969696;
          ColorHotTo := $00969696;
          ColorMirrorHot := $00969696;
          ColorMirrorHotTo := $00969696;
          ColorNodeHot := $00969696;
          ColorNodeHotTo := $00969696;
          ColorMirrorNodeHot := $00969696;
          ColorMirrorNodeHotTo := $00969696;
          Font.Color := $001E1F20;
       end;
      end;
      tsOffice2019Black:
      begin
        OuterBorderColor := $00686868;
        InnerBorderColor := clNone;
        FocusouterBorderColor := clNone;
        FocusInnerBorderColor := brdr;
        InnerMostBorderColor := clNone;
        ...
        with ButtonAppearance do
        begin
          ArrowColorDown := clWhite;
          ArrowColorHot := clWhite;
          BorderColorDown := $00828282;
          BorderColorHot := $00B5B5B5;
          BorderColorNodeHot := $00B5B5B5;
          ColorDown := $00828282;
          ColorDownTo := $00828282;
          ColorMirrorDown := $00828282;
          ColorMirrorDownTo := $00828282;
          ColorHot := $00686868;
          ColorHotTo := $00686868;
          ColorMirrorHot := $00686868;
          ColorMirrorHotTo := $00686868;
          ColorNodeHot := $00686868;
          ColorNodeHotTo := $00686868;
          ColorMirrorNodeHot := $00686868;
          ColorMirrorNodeHotTo := $00686868;
          Font.Color := clWhite;
       end;
      end;
...
procedure TCustomExplorerTreeview.SetUIStyle(const Value: TTMSStyle);
begin
...
begin
  ...
  begin
    ...
    {$IFDEF DELPHI_UNICODE}
    SHGetFileInfo(LPWSTR(Pidl), 0,FileInfo, SizeOf(FileInfo),SHGFI_PIDL or SHGFI_DISPLAYNAME);
    {$ENDIF}
    {$IFNDEF DELPHI_UNICODE}
    SHGetFileInfo(LPCSTR(Pidl), 0,FileInfo, SizeOf(FileInfo),SHGFI_PIDL or SHGFI_DISPLAYNAME);
    {$ENDIF}
  ...
  begin
    ...
    if (UpperCase(s) = UpperCase(Path)) and (pos('\\',Path) <> 1) then  // Drive as path
    begin
      Icon := TIcon.Create;
      // Desktop
      OleCheck(SHGetDesktopFolder(DeskTopFolder));
    ...
    begin
      ...
      begin
        ...
        begin
          ...
          if Length(s) > 0 then
            if Path[Length(s)] <> NODE_SEP then
              s := s + NODE_SEP;
