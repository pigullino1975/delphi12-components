...
const
  ...
  // 1.8.0.0  : New : Support for Office 2019 styles
  // 1.8.0.1  : Fixed : Design-time TAdvToolPanel painting
  // 1.8.1.0  : New : UIStyle property for office look
  //          : Improved : On creation check for enabled AdvFormStyler
  // 1.8.1.1  : Fixed : VCL styles check updated to work in 10.4 Sydney
  // 1.8.2.0  : New : Support for TVirtualImageList in TAdvToolPanelTab
  // 1.8.3.0  : New : Design-time interface to reorder toolpanels
  // 1.8.4.0  : New : BidiMode right-to-left support added in ToolPanel caption
  //          : Fixed : Issue with OpenWidth handling for ppRight positioned tabs
  // 1.8.5.0  : Improved : ImageIndex property editor in Object Inspector
  // 1.8.5.1  : Fixed : Issue with DPI handling
...
type
  ...
  private
    ...
    procedure SetCaptionImageIndex(const Value: TImageIndex);
  ...
  published
    ...
    property CaptionImageIndex: TImageIndex read FCaptionImageIndex write SetCaptionImageIndex;
  end;
  ...
  private
    ...
    procedure SetSectionImages(Value: TCustomImageList);
  ...
  public
    ...
    procedure MovePanel(APanel: TAdvToolPanel; ToIndex: integer);
  published
    property Alignment;
...
begin
  VerInfo.dwOSVersionInfoSize := SizeOf(TOSVersionInfo);
  GetVersionEx(verinfo);
  Result := (verinfo.dwMajorVersion >= 6) and (verinfo.dwMajorVersion < 10);
end;
...
procedure TAdvToolPanelTab.MovePanel(APanel: TAdvToolPanel; ToIndex: integer);
begin
  SetChildOrder(APanel, ToIndex);
end;
...
begin
  ...
  FPanelForm.Scaled := true;
  FPanelForm.Parent := Parent;
  FPanelForm.Visible := False;
...
begin
  Result := TAdvToolPanel.Create(Parent);
  Result.Tab := Self;
  Result.Parent := self.Parent;
  Result.Visible := False;
  if Assigned(Parent) and (Parent is TAdvToolPanelTab) then
    Result.Style := (Parent as TAdvToolPanelTab).Style;
...
procedure TAdvToolPanelTab.SetChildOrder(Child: TComponent; Order: Integer);
begin
  inherited;
end;
...
procedure TAdvToolPanelTab.SetImages(const Value: TCustomImageList);
begin
  FImages := Value;
  Invalidate;
end;
     ...
     esWindowsXP:
      ...
      esOffice2019White:
        begin
          ...
          TabColor := clWhite;
          TabColorTo := clWhite;
          TabHoverColor := $00F2E1D5;
          TabHoverColorTo := $00F2E1D5;
      ...
      esOffice2019Gray:
        begin
          ...
          TabColor := $00B8BBBE;
          TabColorTo := $00B8BBBE;
          TabHoverColor := $00939597;
          TabHoverColorTo := $00939597;
          TabBorderColor := $00B8BBBE;
          Color := $00B8BBBE;
          ColorTo := $00B8BBBE;
          AutoThemeAdapt := false;
        end;
      esOffice2019Black:
        begin
          ...
          TabColor := $003B3B3B;
          TabColorTo := $003B3B3B;
          TabHoverColor := $00686868;
          TabHoverColorTo := $00686868;
          TabBorderColor := $003B3B3B;
          Color := $003B3B3B;
          ColorTo := $003B3B3B;
          AutoThemeAdapt := false;
        end;
...
procedure TToolPanel.SetImageIndex(const Value: TImageIndex);
begin
  FImageIndex := Value;
end;
...
procedure TAdvToolPanelSection.SetCaptionImageIndex(const Value: TImageIndex);
begin
...
procedure TAdvToolPanel.SetSectionImages(Value: TCustomImageList);
begin
    ...
    esOffice2016Black:
      ...
      esOffice2019White:
        begin
          ...
          NoFocusCaptionColor := clWhite;
          NoFocusCaptionColorTo := clWhite;
          NoFocusCaptionFontColor := $00444648;

          HoverButtonColor := $00F2E1D5;
          HoverButtonColorTo := $00F2E1D5;

          DownButtonColor := $00E3BDA3;
          DownButtonColorTo := $00E3BDA3;
          ...
          SectionLayout.CaptionGradientDir := gdVertical;
          SectionLayout.BackGroundGradientDir := gdVertical;
          SectionLayout.ItemFontColor := $00444648;
          SectionLayout.ItemHoverTextColor := AppColor;
          SectionLayout.ItemHoverUnderLine := true;
          SectionLayout.BorderWidth := 1;
          SectionLayout.BorderColor := $00ABABAB;
          SectionLayout.CaptionFontColor := $00444648;

          CaptionGradientDirection := gdVertical;

          FocusCaptionColor := $00F2E1D5;
          FocusCaptionColorTo := $00F2E1D5;
          FocusCaptionFontColor := AppColor;
     ...
     esOffice2019Gray:
        begin
          SectionLayout.CaptionColor := $00B8BBBE;
          SectionLayout.CaptionColorTo := $00B8BBBE;
          SectionLayout.CaptionGradientDir := gdVertical;

          NoFocusCaptionColor := $00B8BBBE;
          NoFocusCaptionColorTo := $00B8BBBE;
          NoFocusCaptionFontColor := $00232425;

          HoverButtonColor := $00969696;
          HoverButtonColorTo := $00969696;

          DownButtonColor := $00666666;
          DownButtonColorTo := $00666666;

          SectionLayout.BackGroundColor := $00B8BBBE;
          SectionLayout.BackGroundColorTo := $00B8BBBE;
          ...
          SectionLayout.CaptionGradientDir := gdVertical;
          SectionLayout.BackGroundGradientDir := gdVertical;
          SectionLayout.ItemFontColor := $00232425;
          SectionLayout.ItemHoverTextColor := $003B3B3B;
          SectionLayout.ItemHoverUnderLine := true;
          SectionLayout.BorderWidth := 1;
          SectionLayout.BorderColor := $00808080;
          SectionLayout.CaptionFontColor := $00232425;

          CaptionGradientDirection := gdVertical;

          FocusCaptionColor := $00969696;
          FocusCaptionColorTo := $00969696;
          FocusCaptionFontColor := $001E1F20;
      ...
      esOffice2019Black:
        begin
          SectionLayout.CaptionColor := $003B3B3B;
          SectionLayout.CaptionColorTo := $003B3B3B;
          SectionLayout.CaptionGradientDir := gdVertical;

          NoFocusCaptionColor := $003B3B3B;
          NoFocusCaptionColorTo := $003B3B3B;
          NoFocusCaptionFontColor := clWhite;

          HoverButtonColor := $00686868;
          HoverButtonColorTo := $00686868;

          DownButtonColor := $00828282;
          DownButtonColorTo := $00828282;

          SectionLayout.BackGroundColor := $003B3B3B;
          SectionLayout.BackGroundColorTo := $003B3B3B;
          ...
          SectionLayout.CaptionGradientDir := gdVertical;
          SectionLayout.BackGroundGradientDir := gdVertical;
          SectionLayout.ItemFontColor := clWhite;
          SectionLayout.ItemHoverTextColor := clWhite;
          SectionLayout.ItemHoverUnderLine := true;
          SectionLayout.BorderWidth := 1;
          SectionLayout.BorderColor := $00686868;
          SectionLayout.CaptionFontColor := clWhite;

          CaptionGradientDirection := gdVertical;

          FocusCaptionColor := $00686868;
          FocusCaptionColorTo := $00686868;
          FocusCaptionFontColor := $FFFFFF;
...
var
  ...
  FGColor: TColor;
  NormalShow: Boolean;
  lf, tp, i, h, a, j, fh, yo, xo: integer;
  tRgn, rgn1, rgn2: HRGN;
  {$IFDEF DELPHIXE2_LVL}
  lDetails: TThemedElementDetails;
  clr: TColor;
...
//----- End Section
    ...
    if BidiMode = bdRightToLeft then
      DrawText(Handle, Pchar(Caption), Length(Caption), r, DT_RIGHT or DT_SINGLELINE or DT_END_ELLIPSIS or DT_NOPREFIX or DT_RTLREADING)
    else
...
procedure TAdvToolPanel.SetImageIndex(const Value: TImageIndex);
begin
  FImageIndex := Value;
  Parent.Repaint;
  Width := Width + 1;
...
{$IFNDEF DELPHIXE10_LVL}
procedure TToolPanelForm.ChangeScale(M, D: Integer);
{$ENDIF}
{$IFDEF DELPHIXE10_LVL}
procedure TToolPanelForm.ChangeScale(M, D: Integer; isDpiChange: Boolean);
{$ENDIF}
begin
  inherited;
end;
