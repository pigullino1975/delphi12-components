{*************************************************************************}
{ TMS Advanced ToolBars customizer                                        }
...
begin
  ...
  begin
    ...
    begin
      ...
      else if (FToolBarCustomizer.AdvToolBar.ToolBarControls[i] is TAdvToolbarContainer) then
      begin
        ATBItem := TATBItemProp.Create;
        ATBItem.ATBItem := TAdvToolbarContainer(FToolBarCustomizer.AdvToolBar.ToolBarControls[i]);
        ATBItem.Visible := TAdvToolbarContainer(FToolBarCustomizer.AdvToolBar.ToolBarControls[i]).Visible;
        if TAdvToolbarContainer(FToolBarCustomizer.AdvToolBar.ToolBarControls[i]).Caption <> '' then
          LstBxToolBarItems.Items.AddObject(TAdvToolbarContainer(FToolBarCustomizer.AdvToolBar.ToolBarControls[i]).Caption, ATBItem)
        else
          LstBxToolBarItems.Items.AddObject(TAdvToolbarContainer(FToolBarCustomizer.AdvToolBar.ToolBarControls[i]).Name, ATBItem);
      end
...
begin
  BtnEdit.Enabled := FCanEditBtn and (LstBxToolBarItems.ItemIndex >= 0) and (LstBxToolBarItems.Items.Objects[LstBxToolBarItems.ItemIndex] <> nil) and (LstBxToolBarItems.Items.Objects[LstBxToolBarItems.ItemIndex] is TATBItemProp)
    and ((TATBItemProp(LstBxToolBarItems.Items.Objects[LstBxToolBarItems.ItemIndex]).ATBItem is TAdvToolBarButton)
    or (TATBItemProp(LstBxToolBarItems.Items.Objects[LstBxToolBarItems.ItemIndex]).IsATBButton)
    or ((TATBItemProp(LstBxToolBarItems.Items.Objects[LstBxToolBarItems.ItemIndex]).ATBItem is TAdvCustomGlowButton))
    or (TATBItemProp(LstBxToolBarItems.Items.Objects[LstBxToolBarItems.ItemIndex]).IsGlowButton));
    ...
    begin
      ...
      begin
        if (((LstBxToolBarItems.Items.Objects[i] as TATBItemProp).ATBItem <> nil) and (((LstBxToolBarItems.Items.Objects[i] as TATBItemProp).ATBItem is TAdvToolBarButton))
           ...
           or (((LstBxToolBarItems.Items.Objects[i] as TATBItemProp).CustomizerCreated) and (((LstBxToolBarItems.Items.Objects[i] as TATBItemProp).IsATBButton)
           or ((LstBxToolBarItems.Items.Objects[i] as TATBItemProp).IsGlowButton)) ) then
        begin
        ...
        begin
          ...
          begin
            ...
            begin
              ...
              else if ((LstBxToolBarItems.Items.Objects[i] as TATBItemProp).ATBItem is TAdvToolBarContainer) then
              begin
                Item := (LstBxToolBarItems.Items.Objects[i] as TATBItemProp);
                WriteString(FToolBarCustomizer.Name {Section}, 'Name'+ inttostr(i), TControl(Item.ATBItem).Name);
