...
type
  ...
  TAdvGraphicsFillGradientMode = (gfgmDefault, gfgmCollection);
  TAdvGraphicsFillGradientType = (gfgtLinear, gfgtRadial);
  TAdvGraphicsFillOrientation = (gfoHorizontal, gfoVertical, gfoCustom);
...
type
 {$IFNDEF WEBLIB}
  ...
  TAdvGraphicsFillGradientItem = class(TCollectionItem)
  private
  ...
  TAdvCustomGraphicsFill = class;

  {$IFDEF WEBLIB}
  TAdvGraphicsFillGradientItems = class(TAdvOwnedCollection)
  {$ENDIF}
  {$IFNDEF WEBLIB}
  {$IFDEF USEOWNEDCOLLECTION}
  TAdvGraphicsFillGradientItems = class({$IFDEF LCLLIB}specialize {$ENDIF}TAdvOwnedCollection<TAdvGraphicsFillGradientItem>)
  {$ELSE}
  TAdvGraphicsFillGradientItems = class({$IFDEF LCLLIB}specialize {$ENDIF}TAdvOwnedCollection)
  {$ENDIF}
  {$ENDIF}
  private
    FOwner: TAdvCustomGraphicsFill;
    function GetItemEx(Index: Integer): TAdvGraphicsFillGradientItem;
    procedure SetItemEx(Index: Integer; const Value: TAdvGraphicsFillGradientItem);
  protected
    procedure UpdateGradient;
    function GetGradientClass: TCollectionItemClass; virtual;
  public
    constructor Create(AOwner: TAdvCustomGraphicsFill);
    function Add: TAdvGraphicsFillGradientItem; {$IFDEF WEBLIB}reintroduce;{$ENDIF}
    function Insert(index: Integer): TAdvGraphicsFillGradientItem;{$IFDEF WEBLIB}reintroduce;{$ENDIF}
    property Items[Index: Integer]: TAdvGraphicsFillGradientItem read GetItemEx write SetItemEx; default;
  end;
  ...
  private
    ...
    FDefaultKind: TAdvGraphicsFillKind;
    FColor: TAdvGraphicsColor;
    FDefaultColor: TAdvGraphicsColor;
    FColorTo: TAdvGraphicsColor;
    FColorMirror: TAdvGraphicsColor;
    FColorMirrorTo: TAdvGraphicsColor;
    FDefaultColorTo: TAdvGraphicsColor;
    FDefaultColorMirror: TAdvGraphicsColor;
    FDefaultColorMirrorTo: TAdvGraphicsColor;
    FOpacity: Single;
    FTexture: TAdvBitmap;
    FTextureMode: TAdvGraphicsTextureMode;
    FGradientMode: TAdvGraphicsFillGradientMode;
    FGradientItems: TAdvGraphicsFillGradientItems;
    FGradientType: TAdvGraphicsFillGradientType;
    FGradientAngle: Single;
    FGradientCenterPoint: TPointF;
    FGradientCenterColor: TAdvGraphicsColor;
    ...
    procedure SetGradientItems(const Value: TAdvGraphicsFillGradientItems);
    procedure SetGradientMode(const Value: TAdvGraphicsFillGradientMode);
    procedure SetGradientType(const Value: TAdvGraphicsFillGradientType);
    ...
    procedure SetGradientCenterColor(const Value: TAdvGraphicsColor);
  ...
  protected
    ...
    property GradientType: TAdvGraphicsFillGradientType read FGradientType write SetGradientType default gfgtLinear;
    property GradientMode: TAdvGraphicsFillGradientMode read FGradientMode write SetGradientMode default gfgmDefault;
    property GradientItems: TAdvGraphicsFillGradientItems read FGradientItems write SetGradientItems;
    property GradientCenterPoint: TPointF read FGradientCenterPoint write SetGradientCenterPoint;
    property GradientMatrix: TAdvGraphicsMatrix read FGradientMatrix write FGradientMatrix;
    property GradientCenterColor: TAdvGraphicsColor read FGradientCenterColor write SetGradientCenterColor default gcNull;
    property GradientOrientation: TAdvGraphicsFillOrientation read FOrientation write SetOrientation default gfoVertical;
    property Kind: TAdvGraphicsFillKind read FKind write SetKind stored IsKindStored nodefault;
    property Orientation: TAdvGraphicsFillOrientation read FOrientation write SetOrientation default gfoVertical;
    property Color: TAdvGraphicsColor read FColor write SetColor stored IsColorStored nodefault;
    property ColorTo: TAdvGraphicsColor read FColorTo write SetColorTo stored IsColorToStored nodefault;
    property ColorMirror: TAdvGraphicsColor read FColorMirror write SetColorMirror stored IsColorMirrorStored nodefault;
    property ColorMirrorTo: TAdvGraphicsColor read FColorMirrorTo write SetColorMirrorTo stored IsColorMirrorToStored nodefault;
    property Opacity: Single read FOpacity write SetOpacity stored IsOpacityStored nodefault;
  ...
  public
    constructor Create(const AKind: TAdvGraphicsFillKind = gfkSolid; const AColor: TAdvGraphicsColor = gcWhite; const AColorTo: TAdvGraphicsColor = gcGray; const AColorMirror: TAdvGraphicsColor = gcNull; const AColorMirrorTo: TAdvGraphicsColor = gcNull); virtual;
    destructor Destroy; override;
    procedure Assign(Source: TPersistent); override;
    procedure BeginUpdate; virtual;
    procedure EndUpdate; virtual;
    procedure ClearGradientItems; virtual;
    function AddGradientItem(AColor: TAdvGraphicsColor; APosition: Single; AOpacity: Single = 1.0): TAdvGraphicsFillGradientItem; virtual;
  end;
  ...
  public
    ...
    destructor Destroy; override;
    procedure Assign(Source: TPersistent); override;
    procedure ApplyChange(AFont: TAdvGraphicsFont; ASetType: TAdvAppearanceGlobalFontType);
  ...
  private
    ...
    FWidth: Single;
    FOpacity: Single;
    FDefaultKind: TAdvGraphicsStrokeKind;
    FDefaultColor: TAdvGraphicsColor;
  ...
  protected
    procedure Changed;
    property OnChanged: TNotifyEvent read FOnChanged write FOnChanged;
    property Kind: TAdvGraphicsStrokeKind read FKind write SetKind stored IsKindStored nodefault;
    property Color: TAdvGraphicsColor read FColor write SetColor stored IsColorStored nodefault;
  ...
  TAdvGraphicsPathDrawMode = (pdmPolygon, pdmPolyline, pdmPath);
  ...
  private
    ...
    procedure CalculateBezierCoefficients(const Bezier: TAdvGraphicsPathCubicBezier; out AX, BX, CX, AY, BY, CY: Double);
...
function IsMatrixEmpty(const AMatrix: TAdvGraphicsMatrix): Boolean;
function MatrixEmpty: TAdvGraphicsMatrix;
...
function TAdvCustomGraphicsFill.AddGradientItem(AColor: TAdvGraphicsColor;
  APosition, AOpacity: Single): TAdvGraphicsFillGradientItem;
begin
...
begin
  ...
  begin
    ...
    FGradientMode := (Source as TAdvCustomGraphicsFill).GradientMode;
    FGradientAngle := (Source as TAdvCustomGraphicsFill).GradientAngle;
    FGradientCenterPoint := (Source as TAdvCustomGraphicsFill).GradientCenterPoint;
    FGradientItems.Assign((Source as TAdvCustomGraphicsFill).GradientItems);
    FGradientType := (Source as TAdvCustomGraphicsFill).GradientType;
    FGradientCenterColor := (Source as TAdvCustomGraphicsFill).GradientCenterColor;
  end
...
procedure TAdvCustomGraphicsFill.ClearGradientItems;
begin
  GradientItems.Clear;
end;

constructor TAdvCustomGraphicsFill.Create(const AKind: TAdvGraphicsFillKind = gfkSolid; const AColor: TAdvGraphicsColor = gcWhite; const AColorTo: TAdvGraphicsColor = gcGray; const AColorMirror: TAdvGraphicsColor = gcNull; const AColorMirrorTo: TAdvGraphicsColor = gcNull);
begin
  FGradientItems := TAdvGraphicsFillGradientItems.Create(Self);
  FKind := AKind;
  FDefaultKind := AKind;
...
procedure TAdvCustomGraphicsFill.SetGradientAngle(const Value: Single);
begin
...
procedure TAdvCustomGraphicsFill.SetGradientCenterColor(
...
procedure TAdvCustomGraphicsFill.SetGradientCenterPoint(
  const Value: TPointF);
begin
...
procedure TAdvCustomGraphicsFill.SetGradientItems(
  const Value: TAdvGraphicsFillGradientItems);
begin
  FGradientItems.Assign(Value);
end;

procedure TAdvCustomGraphicsFill.SetGradientMode(
  const Value: TAdvGraphicsFillGradientMode);
begin
...
procedure TAdvCustomGraphicsFill.SetGradientType(
  const Value: TAdvGraphicsFillGradientType);
begin
...
function TAdvCustomGraphicsFill.IsColorMirrorStored: Boolean;
begin
  Result := ColorMirror <> FDefaultColorMirror;
end;

function TAdvCustomGraphicsFill.IsColorMirrorToStored: Boolean;
begin
  Result := ColorMirrorTo <> FDefaultColorMirrorTo;
end;

function TAdvCustomGraphicsFill.IsColorStored: Boolean;
begin
  Result := Color <> FDefaultColor;
end;

function TAdvCustomGraphicsFill.IsColorToStored: Boolean;
begin
  Result := ColorTo <> FDefaultColorTo;
end;

function TAdvCustomGraphicsFill.IsGradientAngleStored: Boolean;
begin
  Result := GradientAngle <> 0;
end;

function TAdvCustomGraphicsFill.IsKindStored: Boolean;
begin
...
{ TAdvGraphicsFillGradientItems }

function TAdvGraphicsFillGradientItems.Add: TAdvGraphicsFillGradientItem;
begin
  Result := TAdvGraphicsFillGradientItem(inherited Add);
end;

constructor TAdvGraphicsFillGradientItems.Create(AOwner: TAdvCustomGraphicsFill);
begin
  inherited Create(AOwner, GetGradientClass);
  FOwner := AOwner;
end;

function TAdvGraphicsFillGradientItems.GetGradientClass: TCollectionItemClass;
begin
  Result := TAdvGraphicsFillGradientItem;
end;

function TAdvGraphicsFillGradientItems.GetItemEx(Index: Integer): TAdvGraphicsFillGradientItem;
begin
  Result := TAdvGraphicsFillGradientItem(inherited Items[Index]);
end;

function TAdvGraphicsFillGradientItems.Insert(index: Integer): TAdvGraphicsFillGradientItem;
begin
  Result := TAdvGraphicsFillGradientItem(inherited Insert(Index));
end;

procedure TAdvGraphicsFillGradientItems.SetItemEx(Index: Integer; const Value: TAdvGraphicsFillGradientItem);
begin
  inherited SetItem(Index, Value);
end;

procedure TAdvGraphicsFillGradientItems.UpdateGradient;
begin
...
function TAdvCustomGraphicsStroke.IsColorStored: Boolean;
begin
  Result := Color <> FDefaultColor;
end;

function TAdvCustomGraphicsStroke.IsKindStored: Boolean;
begin
  Result := Kind <> FDefaultKind;
end;
...
procedure TAdvGraphicsPath.CalculateBezierCoefficients(const Bezier: TAdvGraphicsPathCubicBezier; out AX, BX, CX, AY, BY, CY: Double);
begin
...
function TAdvGraphicsPath.PointOnBezier(const StartPoint: TPointF; const AX, BX, CX, AY, BY, CY, T: Double): TPointF;
var
...
procedure TAdvGraphicsPath.AddRectangle(const ARect: TRectF; ARoundingX: Single = 0.0; ARoundingY: Single = 0.0);
var
...
{ TAdvGraphicsFillGradientItem }

procedure TAdvGraphicsFillGradientItem.Assign(Source: TPersistent);
begin
  if Source is TAdvGraphicsFillGradientItem then
  begin
    FColor := (Source as TAdvGraphicsFillGradientItem).Color;
    FOpacity := (Source as TAdvGraphicsFillGradientItem).Opacity;
    FPosition := (Source as TAdvGraphicsFillGradientItem).Position;
  end
  else
    inherited;
end;

constructor TAdvGraphicsFillGradientItem.Create(Collection: TCollection);
begin
  inherited;
  FColor := gcWhite;
  FPosition := 0.0;
...
function TAdvGraphicsFillGradientItem.IsOpacityStored: Boolean;
begin
  Result := Opacity <> 1.0;
end;

function TAdvGraphicsFillGradientItem.IsPositionStored: Boolean;
begin
  Result := Position <> 0.0;
end;

procedure TAdvGraphicsFillGradientItem.SetColor(
  const Value: TAdvGraphicsColor);
begin
  if FColor <> Value then
  begin
...
procedure TAdvGraphicsFillGradientItem.SetOpacity(const Value: Single);
begin
  if FOpacity <> Value then
  begin
    FOpacity := Value;
...
procedure TAdvGraphicsFillGradientItem.SetPosition(const Value: Single);
begin
...
procedure TAdvGraphicsFillGradientItem.UpdateGradient;
begin
  if (Collection is TAdvGraphicsFillGradientItems) then
    (Collection as TAdvGraphicsFillGradientItems).UpdateGradient;
end;

{ TAdvAppearanceGlobalFont }

constructor TAdvAppearanceGlobalFont.Create(AOwner: TPersistent);
begin
  FOwner := AOwner;
  FColor := gcNull;
  FSize := 0;
...
procedure TAdvAppearanceGlobalFont.SetColor(const Value: TAdvGraphicsColor);
begin
  if FColor <> Value then
  begin
    FColor := Value;
...
procedure TAdvAppearanceGlobalFont.ApplyChange(AFont: TAdvGraphicsFont; ASetType: TAdvAppearanceGlobalFontType);
begin
