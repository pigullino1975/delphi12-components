...
const
  ...
  // v1.7.2.0 : New : StyleElements property added
  // v1.7.2.1 : Fixed : Issue with using StyleElements
...
//        ProgressFill.GradientMirrorType := gtVertical;
  ...
  tsOffice2019White:
    begin
      ...
      Font.Color:= $00444648;
      ProgressFont.Color := $00444648;
      TickMarkColor := $00444648;

      ProgressFill.Color := $00E3BDA3;
      ProgressFill.ColorTo := $00E3BDA3;
      ProgressFill.ColorMirror := clNone;
      ProgressFill.ColorMirrorTo := clNone;
  ...
  tsOffice2019Gray:
    begin
      ...
      Font.Color:= $00232425;
      ProgressFont.Color := $00232425;
      TickMarkColor := $00232425;

      ProgressFill.Color := $00666666;
      ProgressFill.ColorTo := $00666666;
      ProgressFill.ColorMirror := clNone;
      ProgressFill.ColorMirrorTo := clNone;
  ...
  tsOffice2019Black:
    begin
      ...
      Font.Color:= $00FFFFFF;
      ProgressFont.Color := $00FFFFFF;
      TickMarkColor := clWhite;

      ProgressFill.Color := $00828282;
      ProgressFill.ColorTo := $00828282;
      ProgressFill.ColorMirror := clNone;
      ProgressFill.ColorMirrorTo := clNone;
...
procedure TAdvSmoothTrackBar.SetUIStyle(const Value: TTMSStyle);
begin
...
function TAdvSmoothTrackBar.UseVCLStyle: boolean;
begin
