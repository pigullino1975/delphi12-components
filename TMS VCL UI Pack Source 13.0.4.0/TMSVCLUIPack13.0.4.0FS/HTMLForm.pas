...
const
  ...
  // v1.4.0.3 : Fixed : VCL styles check updated to work in 10.4 Sydney
...
begin
  ...
  begin
    ...
    HTMLDrawEx(Canvas,s,r,Images,XPos,YPos,-1,0,1,
               ...
               XSize,YSize,ml,hl,hr,CR,NewID,CV,CT,FImageCache,FContainer,self.Handle,scale,BidiMode);
...
begin
  ...
  try
    ...
    scale := GetDPIScale(Self, ACanvas);
    ...
    begin
      ...
      HTMLDrawEx(ACanvas,s,r,FImages,pt.x,pt.y,fhl,FHoverHyperlink,FShadowOffset,True,True,False,False,FBlinking,FHover,not FEllipsis,FCtrlDown,'',1.0,
        FURLColor,FHoverColor,FHoverFontColor,FShadowColor,Anchor,Stripped,FocusAnchor,AnchorHint,x,y,hl,ml,HR,CtrlRect,CID,CV,CT,FImageCache,FContainer,Handle,scale,BidiMode);
    ...
    begin
      ...
      HTMLDrawEx(ACanvas,s,r,nil,0,0,fhl,FHoverHyperlink,FShadowOffset,False,False,false,False,FBlinking,FHover,not FEllipsis,FCtrlDown,'',1.0,
        clWhite,clNone,clNone,FShadowColor,Anchor,Stripped,FocusAnchor,AnchorHint,x,y,hl,ml,HR,CtrlRect,CID,CV,CT,FImageCache,FContainer,Handle,scale,BidiMode);
      ...
      HTMLDrawEx(ACanvas,s,r,FImages,0,0,fhl,FHoverHyperlink,FShadowOffset,False,False,false,False,FBlinking,FHover,not FEllipsis,FCtrlDown,'',1.0,
        clGray,clNone,clNone,FShadowColor,Anchor,Stripped,FocusAnchor,AnchorHint,x,y,hl,ml,HR,CtrlRect,CID,CV,CT,FImageCache,FContainer,Handle,scale,BidiMode);
     end
    else
...
begin
  ...
  begin
    HTMLDrawEx(Canvas,s,r,FImages,x,y,-1,FHoverHyperlink,FShadowOffset,True,False,False,False,FBlinking,FHover,not FEllipsis,FCtrlDown,'',1.0,
        FURLColor,FHoverColor,FHoverFontColor,FShadowColor,Anchor,Stripped,FocusAnchor,AnchorHint,xsize,ysize,hl,FHoverHyperlink,HoverRect,CtrlRect,CID,CV,CT,FImageCache,FContainer,Handle,scale,BidiMode);
  ...
  if HTMLDrawEx(Canvas,s,r,FImages,x,y,-1,-1,FShadowOffset,True,False,False,False,false,FHover,not FEllipsis,FCtrlDown,'',1.0,
    clWhite,clNone,clNone,clNone,Anchor,Stripped,FocusAnchor, AnchorHint,xsize,ysize,hl,FHoverHyperlink,HoverRect,CtrlRect,CID,CV,CT,FImageCache,FContainer,Handle,scale,BidiMode) then
  begin
    Result := Anchor;
  end
  else
