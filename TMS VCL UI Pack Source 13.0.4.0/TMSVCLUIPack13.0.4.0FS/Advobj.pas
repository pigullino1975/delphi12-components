...
uses
  ...
  SysUtils, Buttons, Menus, ImgList, StdCtrls, Grids, AdvStyleIF
  {$IFDEF TMSGDIPLUS}
  , AdvHintInfo
  {$ENDIF}
  , AdvXPVS
...
type
  ...
  TCanDisjunctRowSelectDragEvent = procedure(Sender: TObject; FromRow: integer; var Allow: boolean) of object;
  ...
  published
    ...
    property AllowDeleteCells: Boolean read FAllowDeleteCells write FAllowDeleteCells default False;
    property AllowSelectAll: Boolean read FAllowSelectAll write FAllowSelectAll default True;
    ...
    property SkipReadOnly: Boolean read FSkipReadOnly write FSkipReadOnly default False;
  ...
  private
    ...
    FAllSelectAllFixedColumns: Boolean;
    FDisjunctRowSelectDrag: Boolean;
    ...
    procedure SetDisjunctRowSelectDrag(const Value: Boolean);
  protected
    procedure Changed;
  ...
  published
    ...
    property AllSelectAllFixedColumns: Boolean read FAllSelectAllFixedColumns write FAllSelectAllFixedColumns default True;
    ...
    property DisjunctRowSelectDrag: Boolean read FDisjunctRowSelectDrag write SetDisjunctRowSelectDrag default False;
...
begin
  ...
  begin
    HTMLDrawEx(Canvas,FCaption, r, FImages, 2, 2, -1, -1, 2, false, false, false, false, false, false, false, false, '', 1.0, clBlue, clNone, clNone,
      clGray, v, a, fa, ah, xs, ys, hl, ml, hr, cr, cid, cv, ct, nil, nil, self.Handle,1)
  end
  else
  begin
...
procedure TAdvControlList.AddControl(X, Y: Integer; AObject: TControl);
begin
  Add(TControlItem.Create(X,Y,AObject));
end;

procedure TAdvControlList.ClearControls;
var
  i: Integer;
  ci: TControlItem;
begin
...
function TAdvControlList.ControlIndex(X, Y: Integer): Integer;
var
  i: Integer;
  CI: TControlItem;
begin
...
destructor TAdvControlList.Destroy;
begin
  while Count > 0 do
    RemoveControl(0);
  inherited;
...
function TAdvControlList.GetControl(i: Integer): TControlItem;
begin
  Result := TControlItem(Items[i]);
end;

function TAdvControlList.HasHandle(Handle: THandle): Boolean;
var
  i: Integer;
  CI: TControlItem;
begin
...
procedure TAdvControlList.RemoveControl(i: Integer);
begin
...
begin
  ...
  begin
    ...
    r.Top := r.Top + 1 + (r.Bottom - r.Top - th) div 2;
...
begin
  ...
  begin
    ...
    FAllowDeleteCells := (Source as TNavigation).AllowDeleteCells;
    FAllowSelectAll := (Source as TNavigation).AllowSelectAll;
    ...
    FSkipReadOnly := (Source as TNavigation).SkipReadOnly;
  end;
end;
...
begin
  ...
  FAllSelectAllFixedColumns := true;
...
procedure TMouseActions.SetDisjunctRowSelectDrag(const Value: Boolean);
begin
  FDisjunctRowSelectDrag := Value;
end;
...
begin
  ...
  begin
    ...
    FAllSelectAllFixedColumns := (Source as TMouseActions).AllSelectAllFixedColumns;
    ...
    FDisjunctRowSelectDrag := (Source as TMouseActions).DisjunctRowSelectDrag;
