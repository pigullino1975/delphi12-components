...
const
  ...
  // v1.7.1.0 : Improved : UIStyle property for TMSStyle
  // v1.7.1.1 : Fixed : UIStyle set to tsCustom after initial Office look
  // v1.7.2.0 : New : Exposed StyleElements property
  // v1.7.2.1 : Fixed : ParentFont kept true on initialization
  // v1.7.2.2 : Fixed : VCL styles check updated to work in 10.4 Sydney
  // v1.7.2.3 : New : OnRightClick event implemented and behavior blocked
...
procedure TAdvSmoothToggleButton.DoRightClick;
begin
...
begin
  ...
  if (Button = mbRight) and FRightClick then
  begin
    DoRightClick;
  end
  else if Button = mbLeft then
...
procedure TAdvSmoothToggleButton.SetUIStyle(const Value: TTMSStyle);
begin
