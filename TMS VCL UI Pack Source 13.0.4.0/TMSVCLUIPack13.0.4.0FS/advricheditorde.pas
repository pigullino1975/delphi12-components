...
begin
  ...
  0:
    begin
      {$I COMPILERTEXT.INC}
      MessageDlg(Component.ClassName+' version '+ (Component as TAdvRichEditor).Version + ' for ' + compiler + #13#10#13#10'© 2015-2020 by TMS software'#13#10'https://www.tmssoftware.com',
