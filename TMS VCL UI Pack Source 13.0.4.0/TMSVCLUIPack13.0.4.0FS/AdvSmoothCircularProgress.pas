...
const
  ...
  // v1.2.1.2 : Improved : On creation check for AdvFormStyler
...
begin
  ...
  ProgressCircle.StepLineColor := $00D0751C;
  ProgressCircle.StepFont.Color := clBlack;
  Digits.Font.Color := clSilver;
  Digits.BorderColor := clGray;
  InnerCircle.Fill.Color := $00EBEBEB;
  InnerCircle.Fill.ColorTo := $00EBEBEB;

  ProgressCircle.FBackGroundFill.Color := $00D8D4D2;
  ProgressCircle.FBackGroundFill.ColorTo := $00D8D4D2;
 ...
 tsOffice2016White:
  ...
  tsOffice2019White:
    begin
      ProgressCircle.StepFont.Color := $00444648;
      Digits.Font.Color := $00E3BDA3;
      Digits.BorderColor := $00E3BDA3;
      Digits.Overlay := False;
      ...
      OuterCircle.Fill.Color := clWhite;
      OuterCircle.Fill.ColorTo := clWhite;
      OuterCircle.Fill.BorderColor := $00C4C6C8;

      ProgressCircle.Fill.Color := $00E3BDA3;
      ProgressCircle.Fill.ColorTo := clNone;
      ProgressCircle.Fill.ColorMirror := clNone;
      ProgressCircle.Fill.ColorMirrorTo := clNone;
      ProgressCircle.Fill.BorderColor := clNone;
      ProgressCircle.Fill.GradientMirrorType := gtVertical;
      ProgressCircle.StepLineColor := $00F2E1D5;

      InnerCircle.Fill.Color := clWhite;
      InnerCircle.Fill.ColorTo := clWhite;

      ProgressCircle.FBackGroundFill.Color := clWhite;
      ProgressCircle.FBackGroundFill.ColorTo := clWhite;
    end;
  tsOffice2019Gray:
    begin
      ProgressCircle.StepFont.Color := $001E1F20;
      Digits.Font.Color := $00232425;
      Digits.BorderColor := $00232425;
      Digits.Overlay := False;
      ...
      OuterCircle.Fill.Color := $00B8BBBE;
      OuterCircle.Fill.ColorTo := $00B8BBBE;
      OuterCircle.Fill.BorderColor := $00666666;

      ProgressCircle.Fill.Color := $00666666;
      ProgressCircle.Fill.ColorTo := clNone;
      ProgressCircle.Fill.ColorMirror := clNone;
      ProgressCircle.Fill.ColorMirrorTo := clNone;
      ProgressCircle.Fill.BorderColor := clNone;
      ProgressCircle.Fill.GradientMirrorType := gtVertical;
      ProgressCircle.StepLineColor := $00232425;

      InnerCircle.Fill.Color := $00B8BBBE;
      InnerCircle.Fill.ColorTo := $00B8BBBE;

      ProgressCircle.FBackGroundFill.Color := $0086888A;
      ProgressCircle.FBackGroundFill.ColorTo := $0086888A;
    end;
  ...
  tsOffice2019Black:
    begin
      ...
      ProgressCircle.StepFont.Color := clwhite;
      Digits.Font.Color := clWhite;
      Digits.BorderWidth := 0;
      Digits.BorderColor := clWhite;
      Digits.Overlay := False;
      ...
      OuterCircle.Fill.Color := $00303132;
      OuterCircle.Fill.ColorTo := $00303132;
      OuterCircle.Fill.BorderColor := $00ADB0B3;

      ProgressCircle.Fill.Color := $00444648;
      ProgressCircle.Fill.ColorTo := clNone;
      ProgressCircle.Fill.ColorMirror := clNone;
      ProgressCircle.Fill.ColorMirrorTo := clNone;
      ProgressCircle.Fill.BorderColor := clNone;
      ProgressCircle.Fill.GradientMirrorType := gtVertical;
      ProgressCircle.StepLineColor := clWhite;

      InnerCircle.Fill.Color := $00686868;
      InnerCircle.Fill.ColorTo := $00686868;

      ProgressCircle.FBackGroundFill.Color := $00828282;
      ProgressCircle.FBackGroundFill.ColorTo := $00828282;
    end;
  end;
...
procedure TAdvSmoothCircularProgress.SetUIStyle(const Value: TTMSStyle);
begin
