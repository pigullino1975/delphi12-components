...
const
  ...
  // v1.3.1.0 : New : Style property for TMSStyle
  // v1.3.1.1 : Fixed : UIStyle set to tsCustom after initial Office look
  // v1.3.1.2 : Improved : On creation check for enabled AdvFormStyler   
...
procedure TAdvSmoothPage.SetUIStyle(const Value: TTMSStyle);
begin
...
begin
  ...
  tsOffice2016Black:
    ...
    begin
      ...
      HeaderFill.BorderColor := $00C4C6C8;

      FooterFill.Color := clWhite;
      FooterFill.ColorTo := clNone;
      FooterFont.Color := $00444648;
      FooterFill.BorderColor := $00C4C6C8;
    end;
  ...
  tsOffice2019Gray:
    begin
      ...
      HeaderFill.Color := $00B8BBBE;
      HeaderFill.ColorTo := clNone;
      HeaderFont.Color := $00232425;
      HeaderFill.BorderColor := $00666666;

      FooterFill.Color := $00B8BBBE;
      FooterFill.ColorTo := clNone;
      FooterFont.Color := $00232425;
      FooterFill.BorderColor := $00666666;
    end;
  ...
  tsOffice2019Black:
    begin
      ...
      HeaderFill.Color := $00303132;
      HeaderFill.ColorTo := clNone;
      HeaderFont.Color := $FFFFFF;
      HeaderFill.BorderColor := $00ADB0B3;

      FooterFill.Color := $00303132;
      FooterFill.ColorTo := clNone;
      FooterFont.Color := $FFFFFF;
      FooterFill.BorderColor := $00ADB0B3;
     end;
  end;
