...
const
  ...
  // v1.4.0.1 : Fixed : Arrow size on high DPI and updated style of arrow
  // v1.4.0.2 : Fixed : Design-time style painting
  // v1.4.1.0 : New : UIStyle property for office look
  //          : Improved : On creation check for enabled AdvFormStyler
  // v1.4.1.1 : Fixed : Issue with disabled colors in Office 2019 styles
  // v1.4.1.2 : Fixed : Issue with selected text painting on high DPI screens
  // v1.4.1.3 : Fixed : Issue with using TDBAdvOfficeComboBox with no DataSource assigned
  ...
  case AStyle of
    ...
    tsOffice2019White:
      begin
        ...
        Button.ColorHot := $00F2E1D5;
        Button.ColorHotTo := $00F2E1D5;
        Button.ColorMirrorHot := $00F2E1D5;
        Button.ColorMirrorHotTo := $00F2E1D5;
        Button.GradientHot := ggVertical;
        Button.GradientMirrorHot := ggVertical;

        Button.ColorDown := $00E3BDA3;
        Button.ColorDownTo := $00E3BDA3;
        Button.ColorMirrorDown := $00E3BDA3;
        Button.ColorMirrorDownTo := $00E3BDA3;
        Button.GradientDown := ggVertical;
        Button.GradientMirrorDown := ggVertical;

        Button.ColorDisabled := $00D4D4D4;
        Button.ColorDisabledTo := $00D4D4D4;
        Button.ColorMirrorDisabled := $00D4D4D4;
        Button.ColorMirrorDisabledTo := $00D4D4D4;

        DropDownColor := clWhite;

        SelectionAppearance.Color := $00F2E1D5;
        SelectionAppearance.ColorTo := $00F2E1D5;
        SelectionAppearance.ColorMirror := $00F2E1D5;
        SelectionAppearance.ColorMirrorTo := $00F2E1D5;
        SelectionAppearance.TextColor := $003B3B3B;
        SelectionAppearance.BorderColor := $00F2E1D5;

        BorderColor := $00ABABAB;
        BorderHotColor := $00E3BDA3;
      end;

    tsOffice2019Gray:
      begin
        Button.Color := $00D4D4D4;
        Button.ColorTo := $00D4D4D4;
        Button.ColorMirror := $00D4D4D4;
        Button.ColorMirrorTo := $00D4D4D4;
        Button.Gradient := ggVertical;
        Button.GradientMirror := ggVertical;

        Button.ColorHot := $00969696;
        Button.ColorHotTo := $00969696;
        Button.ColorMirrorHot := $00969696;
        Button.ColorMirrorHotTo := $00969696;
        Button.GradientHot := ggVertical;
        Button.GradientMirrorHot := ggVertical;

        Button.ColorDown := $00666666;
        Button.ColorDownTo := $00666666;
        Button.ColorMirrorDown := $00666666;
        Button.ColorMirrorDownTo := $00666666;
        Button.GradientDown := ggVertical;
        Button.GradientMirrorDown := ggVertical;

        Button.ColorDisabled := $00C4C4C4;
        Button.ColorDisabledTo := $00C4C4C4;
        Button.ColorMirrorDisabled := $00C4C4C4;
        Button.ColorMirrorDisabledTo := $00C4C4C4;

        DropDownColor := $00D4D4D4;

        SelectionAppearance.Color := $00969696;
        SelectionAppearance.ColorTo := $00969696;
        SelectionAppearance.ColorMirror := $00969696;
        SelectionAppearance.ColorMirrorTo := $00969696;
        SelectionAppearance.TextColor := $003B3B3B;
        SelectionAppearance.BorderColor := $00969696;

        BorderColor := $00808080;
        BorderHotColor := $00505050;
        Color := $00D4D4D4;
        Font.Color  := $00232425;
        Button.ArrowColor := $00232425;
      end;

    tsOffice2019Black:
      begin
        Button.Color := $00444444;
        Button.ColorTo := $00444444;
        Button.ColorMirror := $00444444;
        Button.ColorMirrorTo := $00444444;
        Button.Gradient := ggVertical;
        Button.GradientMirror := ggVertical;

        Button.ColorHot := $00686868;
        Button.ColorHotTo := $00686868;
        Button.ColorMirrorHot := $00686868;
        Button.ColorMirrorHotTo := $00686868;
        Button.GradientHot := ggVertical;
        Button.GradientMirrorHot := ggVertical;

        Button.ColorDown := $00828282;
        Button.ColorDownTo := $00828282;
        Button.ColorMirrorDown := $00828282;
        Button.ColorMirrorDownTo := $00828282;
        Button.GradientDown := ggVertical;
        Button.GradientMirrorDown := ggVertical;
        ...
        SelectionAppearance.Color := $00505050;
        SelectionAppearance.ColorTo := $00505050;
        SelectionAppearance.ColorMirror := $00505050;
        SelectionAppearance.ColorMirrorTo := $00505050;
        SelectionAppearance.TextColor := clWhite;
        SelectionAppearance.BorderColor := $00505050;

        BorderColor := $00686868;
        BorderHotColor := $00B5B5B5;
        Color := $00444444;
        Font.Color  := clWhite;
        Button.ArrowColor := clWhite;
      end;
...
begin
  ...
  if FDPIscale > 1 then
  begin
    Loc.Left := Loc.Left + Trunc(FDPIScale);
    Loc.Right := Loc.Right - Trunc(FDPIScale);
  end;
...
begin
  ...
  begin
    ...
    begin
      ...
      begin
        clr := clNone;
        LStyle.GetElementColor(LStyle.GetElementDetails(teEditTextHot), ecBorderColor, clr);
    ...
    begin
      ...
      begin
        clr := clNone;
        LStyle.GetElementColor(LStyle.GetElementDetails(teEditTextNormal), ecBorderColor, clr);
...
var
  ...
  procedure DrawArrow(ArP: TPoint; ArClr: TColor; ADPIScale: Single);
  begin
    g := TGPGraphics.Create(Canvas.Handle);
    pen := TGPPen.Create(MakeColor(255, ArClr), ADPIScale + 0.5);
    path := TGPGraphicsPath.Create;

    Path.AddLine(ArP.X - (ADPIScale * 3), ArP.Y - (ADPIScale * 2), ArP.X, ArP.Y + ADPIScale);
      Path.AddLine(ArP.X, ArP.Y + ADPIScale, ArP.X + (ADPIScale * 3) , ArP.Y - (ADPIScale * 2));
...
begin
  ...
  P.X := BtnR.Left + ((BtnR.Right - BtnR.Left) div 2);
  P.Y := BtnR.Top + ((BtnR.Bottom - BtnR.Top) div 2) + Round(FDPIScale);
  ...
  begin
    ...
    begin
      ...
      begin
        ...
        DrawArrow(P, FButton.DownArrowColor, FDPIScale);
    end
    ...
    begin
      ...
      begin
        ...
        DrawArrow(P, FButton.HotArrowColor, FDPIScale);
    end
    else
    begin
      ...
      begin
        ...
        if not Enabled and not (csDesigning in ComponentState) then
          DrawArrow(P, FButton.DisabledArrowColor, FDPIScale)
        else
          DrawArrow(P, FButton.ArrowColor, FDPIScale);
    end;
  end;
...
begin
  ...
  FButton.Width := Round(12 * FDPIScale);
end;
