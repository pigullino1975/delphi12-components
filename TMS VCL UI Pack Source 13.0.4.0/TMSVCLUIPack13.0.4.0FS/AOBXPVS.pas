...
var
  ...
  OpenThemeDataForDpi: function(hwnd: THandle; pszClassList: PWideChar; dpi: integer): HTheme cdecl stdcall;
  {$EXTERNALSYM OpenThemeDataForDpi}

  CloseThemeData: function(hTheme: HTHEME): THandle cdecl stdcall;
  {$EXTERNALSYM CloseThemeData}

  GetThemePartSize: function(hTheme: HTHEME;
                                hdc: HDC;
                                iPartId: Integer;
                                iStateId: Integer;
                                const pRect: PRECT;
                                eSize: THEMESIZE;
                                var psz: TSize): THandle cdecl stdcall;
