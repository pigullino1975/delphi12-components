...
const
  ...
  //v1.5.1.2 : Improved : On creation check for enabeld AdvFormStyler
...
uses
  CommCtrl, ShellApi, Consts, GDIPHTMLEngine;
...
begin
  ...
  with Appearance do
  begin
    InActiveCaptionFont.Color := clWindowText;
    ActiveCaptionFont.Color := clWindowText;
    ProcessedCaptionFont.Color := clWindowText;
    ...
    case AStyle of
      ...
      begin
        ...
        begin
          ...
          InActiveAppearance.BackGroundFill.GradientType := gtSolid;
          InActiveAppearance.BackGroundFill.GradientMirrorType := gtVertical;
          InActiveAppearance.BackGroundFill.BorderColor := $00C4C6C8;

          ProcessedAppearance.BackGroundFill.Color := $00F2E1D5;
          ProcessedAppearance.BackGroundFill.ColorTo := clNone;
          ProcessedAppearance.BackGroundFill.ColorMirror := clNone;
          ProcessedAppearance.BackGroundFill.ColorMirrorTo := clNone;
          ProcessedAppearance.BackGroundFill.GradientType := gtSolid;
          ProcessedAppearance.BackGroundFill.GradientMirrorType := gtVertical;
          ProcessedAppearance.BackGroundFill.BorderColor := $00F2E1D5;
          ...
          DisabledAppearance.BackGroundFill.GradientType := gtSolid;
          DisabledAppearance.BackGroundFill.GradientMirrorType := gtVertical;
          DisabledAppearance.BackGroundFill.BorderColor := $00D4D4D4;

          ActiveAppearance.BackGroundFill.Color := $00E3BDA3;
          ActiveAppearance.BackGroundFill.ColorTo :=  clNone;
          ActiveAppearance.BackGroundFill.ColorMirror := clNone;
          ActiveAppearance.BackGroundFill.ColorMirrorTo := clNone;
          ActiveAppearance.BackGroundFill.GradientType := gtSolid;
          ActiveAppearance.BackGroundFill.GradientMirrorType := gtVertical;
          ActiveAppearance.BackGroundFill.BorderColor := $00E3BDA3;

          InActiveAppearance.CaptionColor := $00444648;
          InActiveAppearance.DescriptionColor := $00444648;

          ProcessedAppearance.CaptionColor := $00444648;
          ProcessedAppearance.DescriptionColor := $00444648;

          DisabledAppearance.CaptionColor := $00444648;
          DisabledAppearance.DescriptionColor := $00444648;

          ActiveAppearance.CaptionColor := $00444648;
          ActiveAppearance.DescriptionColor := $00444648;
      ...
      begin
        with Appearance do
        begin
          InActiveAppearance.BackGroundFill.Color := $00B8BBBE;
          InActiveAppearance.BackGroundFill.ColorTo := $00B8BBBE;
          InActiveAppearance.BackGroundFill.ColorMirror := clNone;
          InActiveAppearance.BackGroundFill.ColorMirrorTo := clNone;
          InActiveAppearance.BackGroundFill.GradientType := gtSolid;
          InActiveAppearance.BackGroundFill.GradientMirrorType := gtVertical;
          InActiveAppearance.BackGroundFill.BorderColor := $00B8BBBE;

          ProcessedAppearance.BackGroundFill.Color := $00969696;
          ProcessedAppearance.BackGroundFill.ColorTo := clNone;
          ProcessedAppearance.BackGroundFill.ColorMirror := clNone;
          ProcessedAppearance.BackGroundFill.ColorMirrorTo := clNone;
          ProcessedAppearance.BackGroundFill.GradientType := gtSolid;
          ProcessedAppearance.BackGroundFill.GradientMirrorType := gtVertical;
          ProcessedAppearance.BackGroundFill.BorderColor := $00969696;

          DisabledAppearance.BackGroundFill.Color := $00B8BBBE;
          DisabledAppearance.BackGroundFill.ColorTo := clNone;
          DisabledAppearance.BackGroundFill.ColorMirror := clNone;
          DisabledAppearance.BackGroundFill.ColorMirrorTo := clNone;
          DisabledAppearance.BackGroundFill.GradientType := gtSolid;
          ...
          ActiveAppearance.BackGroundFill.Color := $00666666;
          ActiveAppearance.BackGroundFill.ColorTo :=  clNone;
          ActiveAppearance.BackGroundFill.ColorMirror := clNone;
          ActiveAppearance.BackGroundFill.ColorMirrorTo := clNone;
          ActiveAppearance.BackGroundFill.GradientType := gtSolid;
          ActiveAppearance.BackGroundFill.GradientMirrorType := gtVertical;
          ActiveAppearance.BackGroundFill.BorderColor := $00666666;

          InActiveAppearance.CaptionColor := $00232425;
          InActiveAppearance.DescriptionColor := $00232425;

          ProcessedAppearance.CaptionColor := $001E1F20;
          ProcessedAppearance.DescriptionColor := $001E1F20;

          DisabledAppearance.CaptionColor := $00232425;
          DisabledAppearance.DescriptionColor := $00232425;

          ActiveAppearance.CaptionColor := $00232425;
          ActiveAppearance.DescriptionColor := $00232425;
      ...
      begin
        with Appearance do
        begin
          InActiveAppearance.BackGroundFill.Color := $00303132;
          InActiveAppearance.BackGroundFill.ColorTo := $00303132;
          InActiveAppearance.BackGroundFill.ColorMirror := clNone;
          InActiveAppearance.BackGroundFill.ColorMirrorTo := clNone;
          InActiveAppearance.BackGroundFill.GradientType := gtSolid;
          InActiveAppearance.BackGroundFill.GradientMirrorType := gtVertical;
          InActiveAppearance.BackGroundFill.BorderColor := $00ADB0B3;

          ProcessedAppearance.BackGroundFill.Color := $00686868;
          ProcessedAppearance.BackGroundFill.ColorTo := clNone;
          ProcessedAppearance.BackGroundFill.ColorMirror := clNone;
          ProcessedAppearance.BackGroundFill.ColorMirrorTo := clNone;
          ProcessedAppearance.BackGroundFill.GradientType := gtSolid;
          ProcessedAppearance.BackGroundFill.GradientMirrorType := gtVertical;
          ProcessedAppearance.BackGroundFill.BorderColor := $00686868;

          DisabledAppearance.BackGroundFill.Color := $00303132;
          DisabledAppearance.BackGroundFill.ColorTo := clNone;
          DisabledAppearance.BackGroundFill.ColorMirror := clNone;
          DisabledAppearance.BackGroundFill.ColorMirrorTo := clNone;
          DisabledAppearance.BackGroundFill.GradientType := gtSolid;
          ...
          ActiveAppearance.BackGroundFill.Color := $00828282;
          ActiveAppearance.BackGroundFill.ColorTo :=  clNone;
          ActiveAppearance.BackGroundFill.ColorMirror := clNone;
          ActiveAppearance.BackGroundFill.ColorMirrorTo := clNone;
          ActiveAppearance.BackGroundFill.GradientType := gtSolid;
          ActiveAppearance.BackGroundFill.GradientMirrorType := gtVertical;
          ActiveAppearance.BackGroundFill.BorderColor := $00828282;

          InActiveAppearance.CaptionColor := clWhite;
          InActiveAppearance.DescriptionColor := clWhite;

          ProcessedAppearance.CaptionColor := clWhite;
          ProcessedAppearance.DescriptionColor := clWhite;

          DisabledAppearance.CaptionColor := clWhite;
          DisabledAppearance.DescriptionColor := clWhite;

          ActiveAppearance.CaptionColor := clWhite;
          ActiveAppearance.DescriptionColor := clWhite;
    ...
    else if not (Astyle in [tsOffice2019White, tsOffice2019Gray, tsOffice2019Black]) then
    begin
...
procedure TAdvSmoothStepControl.SetUIStyle(const Value: TTMSStyle);
begin
