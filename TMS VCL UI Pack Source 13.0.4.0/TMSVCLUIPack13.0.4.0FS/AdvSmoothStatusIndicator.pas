...
const
  ...
  // v1.0.1.1 : Fixed : Issue with high DPI font handling on Delphi 11
...
{$IFDEF DELPHIXE10_LVL}
procedure TAdvSmoothStatusIndicator.ChangeScale(M, D: Integer; isDpiChange: Boolean);
{$ELSE}
procedure TAdvSmoothStatusIndicator.ChangeScale(M, D: Integer);
{$ENDIF}
begin
  inherited;
