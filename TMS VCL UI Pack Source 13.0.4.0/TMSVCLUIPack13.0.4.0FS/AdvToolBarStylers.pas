...
type
  ...
  TToolBarStyle = (bsOffice2003Blue, bsOffice2003Silver, bsOffice2003Olive, bsOffice2003Classic,
    ...
    bsOffice2019White, bsOffice2019Gray, bsOffice2019Black);
...
begin
  ...
  FToolBarStyle := bsOffice2003Blue;
...
begin
  ...
  case ot of
    ...
    ot2019White: Style := bsOffice2019White;
    ot2019Gray: Style := bsOffice2019Gray;
    ot2019Black: Style := bsOffice2019Black;
  end;
...
begin
  ...
  begin
    ...
    rd := (rgb AND $FF0000) shr 16;
    gd := ((rgb AND $00FF00) shr 8);
    bd := (rgb AND $0000FF);


    if (RD * 0.299 + GD * 0.587 + BD * 0.114) > 186 then
    begin
      if (AStyle in [tsOffice2019White]) then
      begin
        AppColor.AppButtonHoverColor := ChangeColorPerc(AAppColor, +15);
        AppColor.SelectedColor := AppColor.AppButtonHoverColor;
        AppColor.HoverColor := ChangeColorPerc(AAppColor, -30);
      end
      else
      begin
  ...
  case AStyle of
    ...
    tsOffice2019White: Style := bsOffice2019White;
    tsOffice2019Gray: Style := bsOffice2019Gray;
    tsOffice2019Black: Style := bsOffice2019Black;
  end;
end;
...
var
  ...
  PrevAppButtonColor: TColor;
  PrevAppButtonHoverColor: TColor;
...
//  if FToolBarStyle <> Value then
  begin
    ...
    begin
      ButtonAppearance.CaptionTextColor := clBlack;
      ButtonAppearance.CaptionTextColorHot := clBlack;
      ButtonAppearance.CaptionTextColorDown := clBlack;
    end;
    ...
    case FToolBarStyle of
      ...
      bsOffice2019White: ApplyStyle(tsOffice2019White);
      bsOffice2019Gray: ApplyStyle(tsOffice2019Gray);
      bsOffice2019Black: ApplyStyle(tsOffice2019Black);
    end;
...
//    PagerCaption.Font.Height := -13;
    ...
    GlowButtonAppearance.TranspHover := (FToolBarStyle in [bsOffice2010Blue, bsOffice2010Silver, bsOffice2010Black, bsOffice2013White, bsOffice2013LightGray, bsOffice2013Gray,
                                                              bsOffice2016White, bsOffice2016Gray, bsOffice2016Black, bsOffice2019White, bsOffice2019Gray, bsOffice2019Black]);
    GlowButtonAppearance.NoBorderDefault := (FToolBarStyle in [bsOffice2013White, bsOffice2013LightGray, bsOffice2013Gray,
                                                              bsOffice2016White, bsOffice2016Gray, bsOffice2016Black, bsOffice2019White, bsOffice2019Gray, bsOffice2019Black]);
   ...
   bsOffice2003Classic:
    ...
    bsOffice2016White:
      begin
        ...
        begin
          ...
          FTones.Tab := ATones;
          FTones.Tab.Hover.BrushColor := $F2E1D5;
    ...
    bsOffice2016Black:
      begin
        ...
        ButtonAppearance.CaptionTextColor := clWhite;
        ButtonAppearance.CaptionTextColorHot := clWhite;
      ...
      begin
        ...
        RightHandleColor := clWhite;
        RightHandleColorTo := clWhite;
        RightHandleColorHot := $00F2E1D5;
        RightHandleColorHotTo := $00F2E1D5;
        RightHandleColorDown := $00E3BDA3;
        RightHandleColorDownTo := $00E3BDA3;
        ...
        ButtonAppearance.CaptionTextColor := $00444648;
        ButtonAppearance.CaptionTextColorHot := $00444648;

        PagerCaption.TextColorExtended := AppColor.TextColor;
        PagerCaption.TextColor := AppColor.TextColor;

        CaptionAppearance.CaptionColor := clWhite;
        CaptionAppearance.CaptionColorTo := clWhite;
        CaptionAppearance.CaptionColorHot := $00F2E1D5;
        CaptionAppearance.CaptionColorHotTo := $00F2E1D5;
        CaptionAppearance.CaptionTextColor := $00444648;
        CaptionAppearance.CaptionTextColorHot := $00444648;
        DragGripStyle := dsNone;
        ...
        begin
          ...
          if (AppColor.AppButtonColor = clWhite) or (AppColor.AppButtonColor = clNone) then
          begin
            AppColor.AppButtonColor := $00FFAC3C;
            AppColor.AppButtonHoverColor := $00E29E00;
            AppColor.HoverColor := $00F7E6CD;
            AppColor.HoverBorderColor := $00E7BE7A;
            AppColor.SelectedColor := $00E7BE7A;
            AppColor.SelectedBorderColor := $00E7BE7A;
            FTones.Buttons.Foreground.BrushColor := $00D1B9A5;
            FTones.Buttons.Foreground.BorderColor := $00D1B9A5;
          end
          else
          begin
            FTones.Buttons.Foreground.BrushColor := AppColor.HoverColor;
            FTones.Buttons.Foreground.BorderColor := AppColor.HoverColor;
          end;
          FTones.Buttons.Background.BrushColor := clWhite;
          FTones.Buttons.Background.BorderColor := clWhite;
          FTones.Buttons.Background.TextColor := $00444648;

          FTones.Buttons.Hover.BrushColor := AppColor.HoverColor;
          FTones.Buttons.Hover.BorderColor := AppColor.HoverColor;
          FTones.Buttons.Hover.TextColor := $00444648;

          FTones.Buttons.Selected.BrushColor := AppColor.SelectedColor;
          FTones.Buttons.Selected.BorderColor := AppColor.SelectedColor;
          FTones.Buttons.Selected.TextColor := $00444648;

          FTones.Buttons.Foreground.TextColor := $00444648;

          FTones.Pager := ATones;
          FTones.Pager.Foreground.BrushColor := clWhite;
          FTones.Pager.Foreground.BorderColor := clWhite;
          FTones.Pager.Background.BrushColor := clWhite;
          FTones.Pager.Background.BorderColor := clWhite;

          FTones.Tab := ATones;
          FTones.Tab.Foreground.BorderColor := $00C4C6C8;
          FTones.Tab.Foreground.TextColor := $00444648;
          FTones.Tab.Foreground.BrushColor := clWhite;
          FTones.Tab.Background.BrushColor := clWhite;

          FTones.Tab.Hover.BrushColor := $00F8F9FA;
          FTones.Tab.Hover.BorderColor :=   $00F8F9FA;
          FTones.Tab.Hover.TextColor := AppColor.AppButtonColor;

          FTones.Tab.Selected.BrushColor := clWhite;
          FTones.Tab.Selected.BorderColor := clWhite;
          FTones.Tab.Selected.TextColor := $00444648;

          FTones.Tab.Background.BrushColor := clWhite;
          FTones.Tab.Background.BorderColor := clWhite;
          FTones.Tab.Background.TextColor := $00444648;

          FTones.App := AppColor;
          FTones.App.HoverBorderColor := FTones.App.HoverColor;
          FTones.App.SelectedBorderColor := FTones.App.SelectedColor;
          FTones.App.TextColor := $00262626;
          APager.SetOfficeTones(FTones, gsOffice2019);
        end;
        ...
        GlowButtonAppearance.ColorMirror := clWhite;
        GlowButtonAppearance.ColorMirrorTo := clWhite;
        GlowButtonAppearance.BorderColor := clWhite; //$D4D4D4;
        GlowButtonAppearance.Gradient := ggVertical;
        GlowButtonAppearance.GradientMirror := ggVertical;

        GlowButtonAppearance.ColorHot := $00F2E1D5;
        GlowButtonAppearance.ColorHotTo := $00F2E1D5;
        GlowButtonAppearance.ColorMirrorHot := $00F2E1D5;
        GlowButtonAppearance.ColorMirrorHotTo := $00F2E1D5;
        GlowButtonAppearance.BorderColorHot := $00F2E1D5;
        GlowButtonAppearance.GradientHot := ggVertical;
        GlowButtonAppearance.GradientMirrorHot := ggVertical;

        GlowButtonAppearance.ColorDown := $00E3BDA3;
        GlowButtonAppearance.ColorDownTo := $00E3BDA3;
        GlowButtonAppearance.ColorMirrorDown := $00E3BDA3;
        GlowButtonAppearance.ColorMirrorDownTo := $00E3BDA3;
        GlowButtonAppearance.BorderColorDown := $00E3BDA3;
        GlowButtonAppearance.GradientDown := ggVertical;
        GlowButtonAppearance.GradientMirrorDown := ggVertical;

        GlowButtonAppearance.ColorChecked := $00F2E1D5;
        GlowButtonAppearance.ColorCheckedTo := $00F2E1D5;
        GlowButtonAppearance.ColorMirrorChecked := $00F2E1D5;
        GlowButtonAppearance.ColorMirrorCheckedTo := $00F2E1D5;
        GlowButtonAppearance.BorderColorChecked := $00F2E1D5;
        GlowButtonAppearance.GradientChecked := ggVertical;
        GlowButtonAppearance.GradientMirrorChecked := ggVertical;

        GlowButtonAppearance.TextColor := $00444648;
        GlowButtonAppearance.TextColorChecked := $003B3B3B;
        GlowButtonAppearance.TextColorHot := $00444648;
        GlowButtonAppearance.TextColorDown := $00444648;

        TMSStyle := tsOffice2019White;
        ...
        begin
          ...
          CaptionAppearance.CaptionColorHot := PageAppearance.Color;
          CaptionAppearance.CaptionColorHotTo := PageAppearance.Color;
          CaptionAppearance.CaptionTextColor := $00232425;
          CaptionAppearance.CaptionTextColorHot := clBlack;
        end;
    ...
    bsOffice2019Gray:
      begin
        ...
        DockColor.ColorTo := $00B8BBBE;
        DockColor.Color := $00B8BBBE;
        DockColor.Direction := gdHorizontal;
        DockColor.Steps := 128;

        Color.Color := $00B8BBBE;
        Color.ColorTo := $00B8BBBE;
        Color.Direction := gdVertical;
        Color.Steps := 64;

        RightHandleColor := $00B8BBBE;
        RightHandleColorTo := $00B8BBBE;
        RightHandleColorHot := $00939597;
        RightHandleColorHotTo := $00939597;
        RightHandleColorDown := $0086888A;
        RightHandleColorDownTo := $0086888A;

        BorderColor := $00444444;
        ButtonAppearance.BorderColor := clNone;
        ButtonAppearance.BorderHotColor := clNone;
        ButtonAppearance.BorderDownColor := clNone;

        ButtonAppearance.CaptionTextColor := $00232425;
        ButtonAppearance.CaptionTextColorHot := $001E1F20;

        PagerCaption.TextColorExtended := clwhite;//AppColor.TextColor;
        PagerCaption.TextColor := AppColor.TextColor;

        CaptionAppearance.CaptionColor := $00B8BBBE;
        CaptionAppearance.CaptionColorTo := $00B8BBBE;
        CaptionAppearance.CaptionColorHot := $00939597;
        CaptionAppearance.CaptionColorHotTo := $00939597;
        CaptionAppearance.CaptionTextColor := $00232425;
        CaptionAppearance.CaptionTextColorHot := $001E1F20;
        DragGripStyle := dsNone;
        ...
        begin
          ...
          FTones.Buttons.Background.BrushColor := $00B8BBBE;
          FTones.Buttons.Background.BorderColor := $00B8BBBE;
          FTones.Buttons.Background.TextColor := $00232425;

          FTones.Buttons.Hover.BrushColor := $00939597;
          FTones.Buttons.Hover.BorderColor := $00939597;
          FTones.Buttons.Hover.TextColor := $00232425;

          FTones.Buttons.Selected.BrushColor := $0086888A;
          FTones.Buttons.Selected.BorderColor := $0086888A;
          FTones.Buttons.Selected.TextColor := $00232425;

          FTones.Buttons.Foreground.BrushColor := $00939597;
          FTones.Buttons.Foreground.BorderColor := $00939597;
          FTones.Buttons.Foreground.TextColor := $00232425;

          FTones.Pager.Background.BrushColor := $00444444;
          FTones.Pager.Background.BorderColor := $00444444;
          FTones.Pager.Background.TextColor := $00232425;
          FTones.Pager.Foreground.BrushColor := $00B8BBBE;
          FTones.Pager.Foreground.BorderColor := $00B8BBBE;

          FTones.Tab := ATones;
          FTones.Tab.Foreground.BorderColor := $00C4C6C8;
          FTones.Tab.Foreground.TextColor := $00444648;
          FTones.Tab.Foreground.BrushColor := $00B8BBBE;
          FTones.Tab.Background.BrushColor := $00B8BBBE;

          FTones.Tab.Hover.BrushColor := $00C4C6C8;
          FTones.Tab.Hover.BorderColor :=  $00C4C6C8;
          FTones.Tab.Hover.TextColor := $001E1F20;

          FTones.Tab.Selected.BrushColor := $00B8BBBE;
          FTones.Tab.Selected.BorderColor := $00B8BBBE;
          FTones.Tab.Selected.TextColor := $00232425;

          FTones.Tab.Background.BrushColor := $00444444;
          FTones.Tab.Background.BorderColor := $00444444;
          FTones.Tab.Background.TextColor := $00232425;

          PrevAppButtonColor := AppColor.AppButtonColor;
          PrevAppButtonHoverColor := AppColor.AppButtonHoverColor;

          FTones.App := AppColor;
          FTones.App.AppButtonColor := $00B8BBBE;
          FTones.App.AppButtonHoverColor := $00C4C6C8;
          FTones.App.HoverBorderColor := FTones.App.HoverColor;
          FTones.App.SelectedBorderColor := FTones.App.SelectedColor;
          FTones.App.TextColor := clWhite;
          APager.SetOfficeTones(FTones, gsOffice2019);

          AppColor.AppButtonColor := PrevAppButtonColor;
          AppColor.AppButtonHoverColor := PrevAppButtonHoverColor;
        end;

        RoundEdges := false;

        GlowButtonAppearance.Color := $00B8BBBE;
        GlowButtonAppearance.ColorTo := clNone;
        GlowButtonAppearance.ColorMirror := $00B8BBBE;
        GlowButtonAppearance.ColorMirrorTo := clNone;
        GlowButtonAppearance.BorderColor := $00B8BBBE;
        GlowButtonAppearance.Gradient := ggVertical;
        GlowButtonAppearance.GradientMirror := ggVertical;

        GlowButtonAppearance.ColorHot := $00939597;
        GlowButtonAppearance.ColorHotTo := clNone;
        GlowButtonAppearance.ColorMirrorHot := $00939597;
        GlowButtonAppearance.ColorMirrorHotTo := clNone;
        GlowButtonAppearance.BorderColorHot := $00939597;
        GlowButtonAppearance.GradientHot := ggVertical;
        GlowButtonAppearance.GradientMirrorHot := ggVertical;

        GlowButtonAppearance.ColorDown := $0086888A;
        GlowButtonAppearance.ColorDownTo := clNone;
        GlowButtonAppearance.ColorMirrorDown := $0086888A;
        GlowButtonAppearance.ColorMirrorDownTo := clNone;
        GlowButtonAppearance.BorderColorDown := $0086888A;
        GlowButtonAppearance.GradientDown := ggVertical;
        GlowButtonAppearance.GradientMirrorDown := ggVertical;

        GlowButtonAppearance.ColorChecked := $00939597;
        GlowButtonAppearance.ColorCheckedTo := clNone;
        GlowButtonAppearance.ColorMirrorChecked := $00939597;
        GlowButtonAppearance.ColorMirrorCheckedTo := clNone;
        GlowButtonAppearance.BorderColorChecked := $0086888A;
        GlowButtonAppearance.GradientChecked := ggVertical;
        GlowButtonAppearance.GradientMirrorChecked := ggVertical;

        GlowButtonAppearance.TextColor := $00232425;
        GlowButtonAppearance.TextColorChecked := $001E1F20;
        GlowButtonAppearance.TextColorHot := $001E1F20;
        GlowButtonAppearance.TextColorDown := $00232425;

        TMSStyle := tsOffice2019Gray;
    ...
    bsOffice2019Black:
      begin
        ...
        DockColor.ColorTo := $003B3B3B;
        DockColor.Color := $003B3B3B;
        DockColor.Direction := gdHorizontal;
        DockColor.Steps := 1;

        Color.Color := $003B3B3B;
        Color.ColorTo := $003B3B3B;
        Color.Direction := gdVertical;
        Color.Steps := 1;

        RightHandleColor := $003B3B3B;
        RightHandleColorTo := $003B3B3B;
        RightHandleColorHot := $00444648;
        RightHandleColorHotTo := $00444648;
        RightHandleColorDown := $005C5E60;
        RightHandleColorDownTo := $005C5E60;

        BorderColor := $000A0A0A;
        ButtonAppearance.BorderColor := clNone;
        ButtonAppearance.BorderHotColor := clNone;
        ButtonAppearance.BorderDownColor := clNone;
        ...
        CaptionAppearance.CaptionColor := $003B3B3B;
        CaptionAppearance.CaptionColorTo := $003B3B3B;
        CaptionAppearance.CaptionColorHot := $00444648;
        CaptionAppearance.CaptionColorHotTo := $00444648;
        CaptionAppearance.CaptionBorderColor := $000A0A0A;
        CaptionAppearance.CaptionTextColor := clWhite;
        CaptionAppearance.CaptionTextColorHot := clWhite;
        DragGripStyle := dsNone;
        ...
        begin
          ...
          FTones.Buttons.Background.BrushColor := $00303132;
          FTones.Buttons.Background.BorderColor := $00303132;
          FTones.Buttons.Background.TextColor := clWhite;

          FTones.Buttons.Hover.BrushColor := $00444648;
          FTones.Buttons.Hover.BorderColor := $00444648;
          FTones.Buttons.Hover.TextColor := clWhite;

          FTones.Buttons.Selected.BrushColor := $005C5E60;
          FTones.Buttons.Selected.BorderColor := $005C5E60;
          FTones.Buttons.Selected.TextColor := clWhite;

          FTones.Buttons.Foreground.BrushColor := $00444648;
          FTones.Buttons.Foreground.BorderColor := $00444648;
          FTones.Buttons.Foreground.TextColor := clWhite;

          FTones.Pager.Background.BrushColor := $000A0A0A;
          FTones.Pager.Background.BorderColor := $000A0A0A;
          FTones.Pager.Background.TextColor := clWhite;
          FTones.Pager.Foreground.BrushColor := $00303132;
          FTones.Pager.Foreground.BorderColor := $00303132;

          FTones.Tab := ATones;
          FTones.Tab.Foreground.BorderColor := $00444648;
          FTones.Tab.Foreground.TextColor := clWhite;
          FTones.Tab.Foreground.BrushColor := $00303132;
          FTones.Tab.Background.BrushColor := $00303132;

          FTones.Tab.Hover.BrushColor := $00444648;
          FTones.Tab.Hover.BorderColor :=  $00444648;
          FTones.Tab.Hover.TextColor := clWhite;

          FTones.Tab.Selected.BrushColor := $00303132;
          FTones.Tab.Selected.BorderColor := $00303132;
          FTones.Tab.Selected.TextColor := clWhite;

          FTones.Tab.Background.BrushColor := $000A0A0A;
          FTones.Tab.Background.BorderColor := $000A0A0A;
          FTones.Tab.Background.TextColor := clWhite;
          ...
          FTones.App := AppColor;
          FTones.App.AppButtonColor := $00303132;
          FTones.App.AppButtonHoverColor := $00444648;
          FTones.App.HoverBorderColor := FTones.App.HoverColor;
          FTones.App.SelectedBorderColor := FTones.App.SelectedColor;
          FTones.App.TextColor := clWhite;
        ...
        GlowButtonAppearance.Color := $003B3B3B;
        GlowButtonAppearance.ColorTo := $003B3B3B;
        GlowButtonAppearance.ColorMirror := $003B3B3B;
        GlowButtonAppearance.ColorMirrorTo := $003B3B3B;
        GlowButtonAppearance.BorderColor := $003B3B3B;
        GlowButtonAppearance.Gradient := ggVertical;
        GlowButtonAppearance.GradientMirror := ggVertical;

        GlowButtonAppearance.ColorHot := $00444648;
        GlowButtonAppearance.ColorHotTo := $00444648;
        GlowButtonAppearance.ColorMirrorHot := $00444648;
        GlowButtonAppearance.ColorMirrorHotTo := $00444648;
        GlowButtonAppearance.BorderColorHot := $00444648;
        GlowButtonAppearance.GradientHot := ggVertical;
        GlowButtonAppearance.GradientMirrorHot := ggVertical;

        GlowButtonAppearance.ColorDown := $005C5E60;
        GlowButtonAppearance.ColorDownTo := $005C5E60;
        GlowButtonAppearance.ColorMirrorDown := $005C5E60;
        GlowButtonAppearance.ColorMirrorDownTo := $005C5E60;
        GlowButtonAppearance.BorderColorDown := $005C5E60;
        GlowButtonAppearance.GradientDown := ggVertical;
        GlowButtonAppearance.GradientMirrorDown := ggVertical;

        GlowButtonAppearance.ColorChecked := $00444648;
        GlowButtonAppearance.ColorCheckedTo := $00444648;
        GlowButtonAppearance.ColorMirrorChecked := $00444648;
        GlowButtonAppearance.ColorMirrorCheckedTo := $00444648;
        GlowButtonAppearance.BorderColorChecked := $005C5E60;
        GlowButtonAppearance.GradientChecked := ggVertical;
        GlowButtonAppearance.GradientMirrorChecked := ggVertical;

        GlowButtonAppearance.TextColor := clWhite;
        GlowButtonAppearance.SystemFont := false;

        GlowButtonAppearance.TextColorChecked := clWhite;
        GlowButtonAppearance.TextColorHot := clWhite;
        GlowButtonAppearance.TextColorDown := clWhite;

        CompactGlowButtonAppearance.TextColor := clWhite;
        CompactGlowButtonAppearance.SystemFont := false;

        TMSStyle := tsOffice2019Black;
...
begin
  ...
  else if UpperCase(ss) = UpperCase('bsOffice2019White') then
    Style := bsOffice2019White
  else if UpperCase(ss) = UpperCase('bsOffice2019Gray') then
    Style := bsOffice2019Gray
  else if UpperCase(ss) = UpperCase('bsOffice2019Black') then
    Style := bsOffice2019Black;
...
begin
  ...
  case Style of
    ...
    bsOffice2019White:     ss := 'bsOffice2019White';
    bsOffice2019Gray:      ss := 'bsOffice2019Gray';
    bsOffice2019Black:      ss := 'bsOffice2019Black';
  end;
