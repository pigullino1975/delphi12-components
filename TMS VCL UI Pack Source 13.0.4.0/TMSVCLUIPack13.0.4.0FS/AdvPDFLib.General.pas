...
uses
  Classes, Math, DateUtils, Types, SysUtils, AdvPDFGraphicsLib, AdvGraphics, AdvGraphicsTypes
  ,AdvPDFLib, AdvUtils, AdvPDFCoreLibBase, Graphics, AdvTypes,
  PictureContainer
  {$IFDEF WEBLIB}
  ,Contnrs, Web
  {$ENDIF}
...
type
  ...
  {$IFDEF WEBLIB}
  TAdvGeneralPDFLibPageList = class(TList)
  private
    function GetItem(Index: Integer): TAdvGeneralPDFLibPage;
    procedure SetItem(Index: Integer; const Value: TAdvGeneralPDFLibPage);
  public
    property Items[Index: Integer]: TAdvGeneralPDFLibPage read GetItem write SetItem; default;
  end;
  {$ENDIF}
  {$IFNDEF WEBLIB}
  ...
  {$IFDEF WEBLIB}
  TAdvGeneralPDFLibFonts = class(TList)
  private
    function GetItem(Index: Integer): TAdvGeneralPDFLibFont;
    procedure SetItem(Index: Integer; const Value: TAdvGeneralPDFLibFont);
  public
    property Items[Index: Integer]: TAdvGeneralPDFLibFont read GetItem write SetItem; default;
  end;
  {$ENDIF}
  {$IFNDEF WEBLIB}
  TAdvGeneralPDFLibFonts = class(TList<TAdvGeneralPDFLibFont>);
  {$ENDIF}

  {$IFDEF WEBLIB}
  TAdvGeneralPDFLibXObjects = class(TList)
  private
    function GetItem(Index: Integer): TAdvGeneralPDFLibXObject;
    procedure SetItem(Index: Integer; const Value: TAdvGeneralPDFLibXObject);
  public
    property Items[Index: Integer]: TAdvGeneralPDFLibXObject read GetItem write SetItem; default;
  end;
  {$ENDIF}
  {$IFNDEF WEBLIB}
  TAdvGeneralPDFLibXObjects = class(TList<TAdvGeneralPDFLibXObject>);
  {$ENDIF}

  {$IFDEF WEBLIB}
  TAdvGeneralPDFLibShadings = class(TList)
  private
    function GetItem(Index: Integer): TAdvGeneralPDFLibShading;
    procedure SetItem(Index: Integer; const Value: TAdvGeneralPDFLibShading);
  public
    property Items[Index: Integer]: TAdvGeneralPDFLibShading read GetItem write SetItem; default;
  end;
  {$ENDIF}
  {$IFNDEF WEBLIB}
  TAdvGeneralPDFLibShadings = class(TList<TAdvGeneralPDFLibShading>);
  {$ENDIF}

  {$IFDEF WEBLIB}
  TAdvGeneralPDFLibPatterns = class(TList)
  private
    function GetItem(Index: Integer): TAdvGeneralPDFLibPattern;
    procedure SetItem(Index: Integer; const Value: TAdvGeneralPDFLibPattern);
  public
    property Items[Index: Integer]: TAdvGeneralPDFLibPattern read GetItem write SetItem; default;
  end;
  {$ENDIF}
  {$IFNDEF WEBLIB}
  TAdvGeneralPDFLibPatterns = class(TList<TAdvGeneralPDFLibPattern>);
  {$ENDIF}

  {$IFDEF WEBLIB}
  TAdvGeneralPDFLibAnnotations = class(TList)
  private
    function GetItem(Index: Integer): TAdvGeneralPDFLibAnnotation;
    procedure SetItem(Index: Integer; const Value: TAdvGeneralPDFLibAnnotation);
  public
    property Items[Index: Integer]: TAdvGeneralPDFLibAnnotation read GetItem write SetItem; default;
  end;
  {$ENDIF}
  {$IFNDEF WEBLIB}
  TAdvGeneralPDFLibAnnotations = class(TList<TAdvGeneralPDFLibAnnotation>);
  {$ENDIF}

  {$IFDEF WEBLIB}
  TAdvGeneralPDFLibBitmaps = class(TList)
  private
    function GetItem(Index: Integer): TAdvGeneralPDFLibBitmap;
    procedure SetItem(Index: Integer; const Value: TAdvGeneralPDFLibBitmap);
  public
    property Items[Index: Integer]: TAdvGeneralPDFLibBitmap read GetItem write SetItem; default;
  end;
  {$ENDIF}
  {$IFNDEF WEBLIB}
  TAdvGeneralPDFLibBitmaps = class(TList<TAdvGeneralPDFLibBitmap>);
  {$ENDIF}

  {$IFDEF WEBLIB}
  TAdvGeneralPDFLibAcroFormFields = class(TList)
  private
    function GetItem(Index: Integer): TAdvGeneralPDFLibAcroForm;
    procedure SetItem(Index: Integer; const Value: TAdvGeneralPDFLibAcroForm);
  public
    property Items[Index: Integer]: TAdvGeneralPDFLibAcroForm read GetItem write SetItem; default;
  end;
  {$ENDIF}
  {$IFNDEF WEBLIB}
  TAdvGeneralPDFLibAcroFormFields = class(TList<TAdvGeneralPDFLibAcroForm>);
  {$ENDIF}
  ...
  private
    ...
    FCapHeight: Integer;
    FUnitsPerEm: Integer;
    function GetGlyphIDs: TAdvPDFGraphicsLibUsedFontCharArray;
  ...
  public
    ...
    property GlyphIDs: TAdvPDFGraphicsLibUsedFontCharArray read GetGlyphIDs;
...
//  TAdvGeneralPDFLibTextField = class(TAdvGeneralPDFLibAcroFormField);
  ...
  public
    constructor Create(const APDFLib: TAdvGeneralPDFLib; const ABitmap: TAdvBitmapHelperClass; const AStream: TMemoryStream; const AImageType: TAdvPDFGraphicsLibImageType; const AQuality: Single; const ABackgroundColor: TAdvGraphicsColor); reintroduce; virtual;
    destructor Destroy; override;
  ...
  {$IFDEF WEBLIB}
  TAdvGeneralPDFLibShadingSubFunctions = class(TList)
  private
    function GetItem(Index: Integer): TAdvGeneralPDFLibShadingSubFunction;
    procedure SetItem(Index: Integer; const Value: TAdvGeneralPDFLibShadingSubFunction);
  public
    property Items[Index: Integer]: TAdvGeneralPDFLibShadingSubFunction read GetItem write SetItem; default;
  end;
  {$ENDIF}
  {$IFNDEF WEBLIB}
  TAdvGeneralPDFLibShadingSubFunctions = class(TList<TAdvGeneralPDFLibShadingSubFunction>);
  {$ENDIF}
  ...
  TAdvGeneralPDFLibGoTo = class(TAdvGeneralPDFLibAnnotation)
  private
    FDestination: UnicodeString;
  public
    constructor Create(const APDFLib: TAdvGeneralPDFLib; const ARect: TRectF; const ADestination: UnicodeString); reintroduce; virtual;
  ...
  {$IFDEF WEBLIB}
  TAdvGeneralPDFLibXRefObjects = class(TObjectList)
  private
    function GetItem(Index: Integer): TAdvGeneralPDFLibXRefObject;
    procedure SetItem(Index: Integer; const Value: TAdvGeneralPDFLibXRefObject);
  public
    property Items[Index: Integer]: TAdvGeneralPDFLibXRefObject read GetItem write SetItem; default;
  {$ENDIF}
  {$IFNDEF WEBLIB}
  ...
  protected
    ...
    procedure NotifyBitmap(Sender: TObject; AValue: TAdvBitmapHelperClass; AImageType: TAdvPDFGraphicsLibImageType; AQuality: Single; ABackgroundColor: TAdvGraphicsColor; var ABitmapReference: string);
...
procedure RegisterPDFLibGeneralService;
begin
  if not TAdvPDFLibPlatformServices.Current.SupportsPlatformService(IAdvPDFLibGeneralService, IInterface(PDFLibService)) then
  begin
    PDFLibService := TAdvGeneralPDFLibService.Create;
    TAdvPDFLibPlatformServices.Current.AddPlatformService(IAdvPDFLibGeneralService, PDFLibService);
  end;
end;

procedure UnregisterPDFLibGeneralService;
begin
  TAdvPDFLibPlatformServices.Current.RemovePlatformService(IAdvPDFLibGeneralService);
end;
...
begin
  ...
  {$IFDEF WEBLIB}
  for I := 0 to FontFallBackList.Count - 1 do
  begin
    f := FontFallBackList[I];
    if FOSFontList.IndexOf(f) = -1 then
      FOSFontList.Add(f);
  end;
  {$ENDIF}
...
procedure TAdvGeneralPDFLib.NotifyBitmap(Sender: TObject; AValue: TAdvBitmapHelperClass; AImageType: TAdvPDFGraphicsLibImageType; AQuality: Single; ABackgroundColor: TAdvGraphicsColor; var ABitmapReference: string);
var
  ...
  {$IFDEF WEBLIB}
  function GetBase64Image(AImage: TJSHTMLElement; AQL: Single; AC: TAdvGraphicsColor): string;
  var
    s: string;
    m: TJSHTMLElement;
    qt: Single;
...
begin
  ...
  begin
    ...
    try
      ...
      begin
        x := TAdvGeneralPDFLibXRefObject(v);
      {$ELSE}
...
procedure TAdvGeneralPDFLib.NotifyGoTo(Sender: TObject; ARect: TRectF; ADestination: UnicodeString);
var
  u: TAdvGeneralPDFLibGoTo;
begin
  if Assigned(FActivePage) then
  begin
    u := TAdvGeneralPDFLibGoTo.Create(Self, ARect, ADestination);
    FXRefObjects.AddObject(u);
    FActivePage.Annotations.Add(u);
  end;
end;
  ...
  {$ENDIF}
    ...
    begin
      ...
      begin
        ...
        FOutput.WriteString('<<');
        FOutput.WriteString('/Type/Annot');
        if (an is TAdvGeneralPDFLibURL) or (an is TAdvGeneralPDFLibGoto) then
        begin
          ...
          else if an is TAdvGeneralPDFLibGoTo then
          begin
            gt := an as TAdvGeneralPDFLibGoTo;
            {$IFDEF LCLLIB}
...
procedure TAdvGeneralPDFLib.InitializeFontList;
var
  x: TAdvGeneralPDFLibXRefObject;
  ftff: TAdvGeneralPDFLibFontFile;
  {$IFDEF WEBLIB}
...
begin
  ...
  {$ENDIF}
    if Assigned(x.XRefObject) then
    begin
      if x.XRefObject is TAdvGeneralPDFLibFontFile then
      begin
        ftff := (x.XRefObject as TAdvGeneralPDFLibFontFile);
        if not ftff.Font.Inactive then
...
{$IFDEF WEBLIB}
function TAdvGeneralPDFLib.GetFullFontEmbedding: Boolean;
begin
...
{$IFDEF WEBLIB}
procedure TAdvGeneralPDFLib.SetFullFontEmbedding(const Value: Boolean);
begin
...
procedure TAdvGeneralPDFLib.UpdateGlyphIds;
{$IFDEF WEBLIB}
var
  I, J, Idx: Integer;
  ft: TAdvGeneralPDFLibFont;
...
function TAdvGeneralPDFLibFont.GetGlyphIDs: TAdvPDFGraphicsLibUsedFontCharArray;
begin
...
begin
  ...
  begin
    ...
    begin
      x := TAdvGeneralPDFLibShadingSubFunction(v);
    {$ELSE}
...
constructor TAdvGeneralPDFLibBitmap.Create(const APDFLib: TAdvGeneralPDFLib; const ABitmap: TAdvBitmapHelperClass; const AStream: TMemoryStream; const AImageType: TAdvPDFGraphicsLibImageType; const AQuality: Single; const ABackgroundColor: TAdvGraphicsColor);
begin
  inherited Create(APDFLib);
...
{ TAdvGeneralPDFLibGoTo }

constructor TAdvGeneralPDFLibGoTo.Create(const APDFLib: TAdvGeneralPDFLib;
...
{$IFDEF WEBLIB}
function TAdvGeneralPDFLibPageList.GetItem(Index: Integer): TAdvGeneralPDFLibPage;
begin
  Result := TAdvGeneralPDFLibPage(inherited Items[Index]);
end;

procedure TAdvGeneralPDFLibPageList.SetItem(Index: Integer; const Value: TAdvGeneralPDFLibPage);
begin
  inherited Items[Index] := Value;
end;

function TAdvGeneralPDFLibFonts.GetItem(Index: Integer): TAdvGeneralPDFLibFont;
begin
  Result := TAdvGeneralPDFLibFont(inherited Items[Index]);
end;

procedure TAdvGeneralPDFLibFonts.SetItem(Index: Integer; const Value: TAdvGeneralPDFLibFont);
begin
  inherited Items[Index] := Value;
end;

function TAdvGeneralPDFLibShadings.GetItem(Index: Integer): TAdvGeneralPDFLibShading;
begin
  Result := TAdvGeneralPDFLibShading(inherited Items[Index]);
end;

procedure TAdvGeneralPDFLibShadings.SetItem(Index: Integer; const Value: TAdvGeneralPDFLibShading);
begin
  inherited Items[Index] := Value;
end;

function TAdvGeneralPDFLibXObjects.GetItem(Index: Integer): TAdvGeneralPDFLibXObject;
begin
  Result := TAdvGeneralPDFLibXObject(inherited Items[Index]);
end;

procedure TAdvGeneralPDFLibXObjects.SetItem(Index: Integer; const Value: TAdvGeneralPDFLibXObject);
begin
  inherited Items[Index] := Value;
end;

function TAdvGeneralPDFLibPatterns.GetItem(Index: Integer): TAdvGeneralPDFLibPattern;
begin
  Result := TAdvGeneralPDFLibPattern(inherited Items[Index]);
end;

procedure TAdvGeneralPDFLibPatterns.SetItem(Index: Integer; const Value: TAdvGeneralPDFLibPattern);
begin
  inherited Items[Index] := Value;
end;

function TAdvGeneralPDFLibAnnotations.GetItem(Index: Integer): TAdvGeneralPDFLibAnnotation;
begin
  Result := TAdvGeneralPDFLibAnnotation(inherited Items[Index]);
end;

procedure TAdvGeneralPDFLibAnnotations.SetItem(Index: Integer; const Value: TAdvGeneralPDFLibAnnotation);
begin
  inherited Items[Index] := Value;
end;

function TAdvGeneralPDFLibBitmaps.GetItem(Index: Integer): TAdvGeneralPDFLibBitmap;
begin
  Result := TAdvGeneralPDFLibBitmap(inherited Items[Index]);
end;

procedure TAdvGeneralPDFLibBitmaps.SetItem(Index: Integer; const Value: TAdvGeneralPDFLibBitmap);
begin
  inherited Items[Index] := Value;
end;

function TAdvGeneralPDFLibAcroFormFields.GetItem(Index: Integer): TAdvGeneralPDFLibAcroForm;
begin
  Result := TAdvGeneralPDFLibAcroForm(inherited Items[Index]);
end;

procedure TAdvGeneralPDFLibAcroFormFields.SetItem(Index: Integer; const Value: TAdvGeneralPDFLibAcroForm);
begin
  inherited Items[Index] := Value;
end;

function TAdvGeneralPDFLibShadingSubFunctions.GetItem(Index: Integer): TAdvGeneralPDFLibShadingSubFunction;
begin
  Result := TAdvGeneralPDFLibShadingSubFunction(inherited Items[Index]);
end;

procedure TAdvGeneralPDFLibShadingSubFunctions.SetItem(Index: Integer; const Value: TAdvGeneralPDFLibShadingSubFunction);
begin
  inherited Items[Index] := Value;
end;

function TAdvGeneralPDFLibXRefObjects.GetItem(Index: Integer): TAdvGeneralPDFLibXRefObject;
begin
  Result := TAdvGeneralPDFLibXRefObject(inherited Items[Index]);
end;

procedure TAdvGeneralPDFLibXRefObjects.SetItem(Index: Integer; const Value: TAdvGeneralPDFLibXRefObject);
begin
  inherited Items[Index] := Value;
end;
{$ENDIF}
