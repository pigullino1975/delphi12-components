...
const
  ...
  // v1.6.2.1  : Fixed : Issue with default item text color
  // v1.6.2.2  : Fixed : Issue with hints on selector items
  // v1.6.3.0  : New : UIStyle property for AdvOfficeSelectors and TAdvOfficeScrollSelector
  // v1.6.3.1  : Fixed : Issue with transparent drawing of pen width selection in dropdown button
  // v1.6.3.2  : Improved : High DPI font handling in TAdvOffice*Selectors
  // v1.6.3.3  : Improved : Precision for dropdown button click in high DPI
  // v1.6.4.0  : Improved : TAdvOfficeTableSelector high DPI handling
  // v1.6.4.1  : Improved : Drawing caption + selected color simultanously
...
type
  ...
  protected
    ...
    property UIStyle: TTMSStyle read FStyle write SetUIStyle default tsCustom;
  public
    constructor Create(AOwner: TComponent); override;
    destructor Destroy; override;
    procedure SetBounds(ALeft, ATop, AWidth, AHeight: Integer); override;
...
procedure TAdvCustomOfficeSelector.CreateWnd;
begin
  inherited;
  if FDesignTime then
  begin
    ...
    ssButton:
      begin
        if DropDownButton and
          ( ((DropDownPosition = dpRight) and (X > (Width - GetDropDownBtnWidth))) or
           ((DropDownPosition = dpBottom) and (Y > (Height - GetDropDownBtnWidth))) or not DropDownSplit) then
        begin
          PopupBtnDown;
        end
        else
...
{$ENDIF}
    begin
      ...
      begin
        ...
        bmp2.Canvas.FillRect(rect(0, 0, FToolImages.Width, FToolImages.Height));
   ...
   tsOffice2016White:
    ...
    tsOffice2016Black:
      ...
      begin
        ...
        Appearance.ColorMirror := clWhite;
        Appearance.ColorMirrorTo := clNone;
        Appearance.BorderColor := $00ABABAB;
        Appearance.Gradient := ggVertical;
        Appearance.GradientMirror := ggVertical;

        Appearance.ColorHot := $00F2E1D5;
        Appearance.ColorHotTo := clNone;
        Appearance.ColorMirrorHot := $00F2E1D5;
        Appearance.ColorMirrorHotTo := clNone;
        Appearance.BorderColorHot := $00F2E1D5;
        Appearance.GradientHot := ggVertical;
        Appearance.GradientMirrorHot := ggVertical;

        Appearance.ColorDown := $00E3BDA3;
        Appearance.ColorDownTo := clNone;
        Appearance.ColorMirrorDown := $00E3BDA3;
        Appearance.ColorMirrorDownTo := clNone;
        Appearance.BorderColorDown := $00E3BDA3;
        Appearance.GradientDown := ggVertical;
        Appearance.GradientMirrorDown := ggVertical;

        Appearance.ColorChecked := $00F2E1D5;
        Appearance.ColorCheckedTo := clNone;
        Appearance.ColorMirrorChecked := $00F2E1D5;
        Appearance.ColorMirrorCheckedTo := clNone;
        Appearance.BorderColorChecked := $00E3BDA3;
        Appearance.GradientChecked := ggVertical;
        Appearance.GradientMirrorChecked := ggVertical;
        ...
        CaptionAppearance.Color := clWhite;
        CaptionAppearance.TextColor := $00444648;


        DragGripAppearance.BorderColorHot := $00E3BDA3;
        DragGripAppearance.Color := clWhite;
        DragGripAppearance.ColorTo := DragGripAppearance.Color;
        DragGripAppearance.ColorHot := DragGripAppearance.Color;
        DragGripAppearance.ColorHotTo := DragGripAppearance.Color;
        ...
        SelectionAppearance.ColorHot := $00F2E1D5;
        SelectionAppearance.ColorHotTo := $00F2E1D5;
        SelectionAppearance.ColorMirrorHot := $00F2E1D5;
        SelectionAppearance.ColorMirrorHotTo := $00F2E1D5;
        SelectionAppearance.BorderColorHot := $00F2E1D5;
        SelectionAppearance.GradientHot := ggVertical;
        SelectionAppearance.GradientMirrorHot := ggVertical;
        SelectionAppearance.TextColorHot := $00444648;

        SelectionAppearance.ColorDown := $00E3BDA3;
        SelectionAppearance.ColorDownTo := $00E3BDA3;
        SelectionAppearance.ColorMirrorDown := $00E3BDA3;
        SelectionAppearance.ColorMirrorDownTo := $00E3BDA3;
        SelectionAppearance.BorderColorDown := $00E3BDA3;
        SelectionAppearance.GradientDown := ggVertical;
        SelectionAppearance.GradientMirrorDown := ggVertical;
        SelectionAppearance.TextColorDown := $00444648;

        SelectionAppearance.ColorChecked := $00F2E1D5;
        SelectionAppearance.ColorCheckedTo := $00F2E1D5;
        SelectionAppearance.ColorMirrorChecked := $00F2E1D5;
        SelectionAppearance.ColorMirrorCheckedTo := $00F2E1D5;
        SelectionAppearance.BorderColorChecked := $00E3BDA3;
        SelectionAppearance.TextColorChecked := $00444648;
        SelectionAppearance.GradientChecked := ggVertical;
        SelectionAppearance.GradientMirrorChecked := ggVertical;
        SelectionAppearance.Rounded := false;
    ...
    tsOffice2019Gray:
      begin
        BorderDropDownColor := $00666666;
        Rounded := False;

        Appearance.Color := $00D4D4D4;
        Appearance.ColorTo := clNone;
        Appearance.ColorMirror := $00D4D4D4;
        Appearance.ColorMirrorTo := clNone;
        Appearance.BorderColor := $00808080;
        Appearance.Gradient := ggVertical;
        Appearance.GradientMirror := ggVertical;

        Appearance.ColorHot := $00969696;
        Appearance.ColorHotTo := clNone;
        Appearance.ColorMirrorHot := $00969696;
        Appearance.ColorMirrorHotTo := clNone;
        Appearance.BorderColorHot := $00505050;
        Appearance.GradientHot := ggVertical;
        Appearance.GradientMirrorHot := ggVertical;

        Appearance.ColorDown := $0086888A;
        Appearance.ColorDownTo := clNone;
        Appearance.ColorMirrorDown := $0086888A;
        Appearance.ColorMirrorDownTo := clNone;
        Appearance.BorderColorDown := $0086888A;
        Appearance.GradientDown := ggVertical;
        Appearance.GradientMirrorDown := ggVertical;

        Appearance.ColorChecked := $00969696;
        Appearance.ColorCheckedTo := clNone;
        Appearance.ColorMirrorChecked := $00969696;
        Appearance.ColorMirrorCheckedTo := clNone;
        Appearance.BorderColorChecked := $0086888A;
        Appearance.GradientChecked := ggVertical;
        Appearance.GradientMirrorChecked := ggVertical;

        Appearance.ColorDisabled := $00D4D4D4;
        Appearance.ColorDisabledTo := clNone;
        Appearance.ColorMirrorDisabled := $00D4D4D4;
        Appearance.ColorMirrorDisabledTo := clNone;
        Appearance.BorderColorDisabled := $00D4D4D4;

        CaptionAppearance.Color := $00D4D4D4;
        CaptionAppearance.TextColor := $00232425;


        DragGripAppearance.BorderColorHot := $00505050;
        DragGripAppearance.Color := $00D4D4D4;
        DragGripAppearance.ColorTo := DragGripAppearance.Color;
        DragGripAppearance.ColorHot := DragGripAppearance.Color;
        DragGripAppearance.ColorHotTo := DragGripAppearance.Color;
        DragGripAppearance.ColorMirror := DragGripAppearance.Color;
        ...
        SelectionAppearance.Color := $00D4D4D4;
        SelectionAppearance.ColorTo := clNone;
        SelectionAppearance.ColorMirror := $00D4D4D4;
        SelectionAppearance.ColorMirrorTo := clNone;
        SelectionAppearance.BorderColor := $00D4D4D4;
        SelectionAppearance.Gradient := ggVertical;
        SelectionAppearance.GradientMirror := ggVertical;

        SelectionAppearance.ColorHot := $00969696;
        SelectionAppearance.ColorHotTo := clNone;
        SelectionAppearance.ColorMirrorHot := $00969696;
        SelectionAppearance.ColorMirrorHotTo := clNone;
        SelectionAppearance.BorderColorHot := $00969696;
        SelectionAppearance.GradientHot := ggVertical;
        SelectionAppearance.GradientMirrorHot := ggVertical;

        SelectionAppearance.ColorDown := $00666666;
        SelectionAppearance.ColorDownTo := clNone;
        SelectionAppearance.ColorMirrorDown := $00666666;
        SelectionAppearance.ColorMirrorDownTo := clNone;
        SelectionAppearance.BorderColorDown := $00666666;
        SelectionAppearance.GradientDown := ggVertical;
        SelectionAppearance.GradientMirrorDown := ggVertical;

        SelectionAppearance.ColorChecked := $00969696;
        SelectionAppearance.ColorCheckedTo := clNone;
        SelectionAppearance.ColorMirrorChecked := $00969696;
        SelectionAppearance.ColorMirrorCheckedTo := clNone;
        SelectionAppearance.BorderColorChecked := $00505050;
        SelectionAppearance.GradientChecked := ggVertical;
        SelectionAppearance.GradientMirrorChecked := ggVertical;
        ...
        SelectionAppearance.TextColorHot := $001E1F20;
        SelectionAppearance.TextColorDown := $00232425;
        SelectionAppearance.Rounded := false;

        ColorDropDown := $00D4D4D4;
        ColorDropDownTo := clNone;
      end;
    tsOffice2019Black:
      begin
        BorderDropDownColor := $00ADB0B3;
        Rounded :=false;

        Appearance.Color := $00444444;
        Appearance.ColorTo := $00444444;
        Appearance.ColorMirror := $00444444;
        Appearance.ColorMirrorTo := $00444444;
        Appearance.BorderColor := $444444;
        Appearance.Gradient := ggVertical;
        Appearance.GradientMirror := ggVertical;

        Appearance.ColorHot := $00686868;
        Appearance.ColorHotTo := $00686868;
        Appearance.ColorMirrorHot := $00686868;
        Appearance.ColorMirrorHotTo := $00686868;
        Appearance.BorderColorHot := $00B5B5B5;
        Appearance.GradientHot := ggVertical;
        Appearance.GradientMirrorHot := ggVertical;

        Appearance.ColorDown := $00828282;
        Appearance.ColorDownTo := $00828282;
        Appearance.ColorMirrorDown := $00828282;
        Appearance.ColorMirrorDownTo := $00828282;
        Appearance.BorderColorDown := $00828282;
        Appearance.GradientDown := ggVertical;
        Appearance.GradientMirrorDown := ggVertical;
        ...
        CaptionAppearance.Color := $00444444;
        CaptionAppearance.TextColor := clWhite;

        DragGripAppearance.BorderColorHot := $00B5B5B5;
        DragGripAppearance.Color := $00444444;
        DragGripAppearance.ColorTo := DragGripAppearance.Color;
        DragGripAppearance.ColorHot := DragGripAppearance.Color;
        DragGripAppearance.ColorHotTo := DragGripAppearance.Color;
        DragGripAppearance.ColorMirror := DragGripAppearance.Color;
        ...
        SelectionAppearance.Color := $00444444;
        SelectionAppearance.ColorTo := $00444444;
        SelectionAppearance.ColorMirror := $00444444;
        SelectionAppearance.ColorMirrorTo := $00444444;
        SelectionAppearance.BorderColor := $00444444;
        SelectionAppearance.Gradient := ggVertical;
        SelectionAppearance.GradientMirror := ggVertical;

        SelectionAppearance.ColorHot := $00686868;
        SelectionAppearance.ColorHotTo := $00686868;
        SelectionAppearance.ColorMirrorHot := $00686868;
        SelectionAppearance.ColorMirrorHotTo := $00686868;
        SelectionAppearance.BorderColorHot := $00686868;
        SelectionAppearance.GradientHot := ggVertical;
        SelectionAppearance.GradientMirrorHot := ggVertical;

        SelectionAppearance.ColorDown := $00828282;
        SelectionAppearance.ColorDownTo := $00828282;
        SelectionAppearance.ColorMirrorDown := $00828282;
        SelectionAppearance.ColorMirrorDownTo := $00828282;
        SelectionAppearance.BorderColorDown := $00828282;
        SelectionAppearance.GradientDown := ggVertical;
        SelectionAppearance.GradientMirrorDown := ggVertical;

        SelectionAppearance.ColorChecked := $00686868;
        SelectionAppearance.ColorCheckedTo := $00686868;
        SelectionAppearance.ColorMirrorChecked := $00686868;
        SelectionAppearance.ColorMirrorCheckedTo := $00686868;
        SelectionAppearance.BorderColorChecked := $00828282;
        SelectionAppearance.GradientChecked := ggVertical;
        SelectionAppearance.GradientMirrorChecked := ggVertical;
...
procedure TAdvCustomOfficeSelector.SetUIStyle(const Value: TTMSStyle);
begin
...
procedure TAdvCustomSelectorPanel.CMHintShow(var Msg: TMessage);
begin
  inherited;
end;
...
begin
  ...
  FScale := CalcDPIScale(Canvas, nil);

  Canvas.Font.Assign(Font);
  Canvas.Font.Height := Round(Canvas.Font.Height * FScale);
...
begin
  ...
  begin
    ...
    FSelectorPanel.Canvas.Font.Assign(Font);
...
begin
  ...
  FCellSize := Round(TABLECELLSIZE * FScale);
  FLeftMargin := 4;
  FTopMargin := 4;
  FCellSpace := 2;
  FSelectionColor := clHighlight;
  FLabelHeight := Round(20 * FScale);
end;
...
begin
  ...
  begin
    ...
    bmp.Canvas.Brush.Color := clWhite; //clFuchsia;
    bmp.Canvas.FillRect(rect(0, 0, bmp.Width, bmp.Height));

    FScale := CalcDPIScale(Canvas,nil);

    bmp.Canvas.Font.Name := CharFont.Name;
    bmp.Canvas.Font.Height := Round(CharFont.Height * FScale);
    bmp.Canvas.Font.Style := CharFont.Style;
...
procedure TAdvCustomOfficeScrollSelector.SetUIStyle(const Value: TTMSStyle);
begin
  SetComponentStyle(Value);
end;
...
begin
  ...
  begin
      ...
      ScrollerAppearance.BorderColorHot := $75A3BB;
      ...
      SelectionAppearance.ColorTo := clRed;
      SelectionAppearance.ColorMirror := clRed;
      SelectionAppearance.ColorMirrorTo := clRed;
   ...
   begin
    ...
    tsWhidbey:
      ...
      begin
        ...
        ResizerAppearance.BorderColor := $D4D4D4;
        ResizerAppearance.Color := clWhite;
        ResizerAppearance.ColorTo := clWhite;

        IconBarAppearance.BorderColor := $D4D4D4;
        IconBarAppearance.Color := clWhite;
        IconBarAppearance.ColorTo := clWhite;

        CaptionAppearance.BorderColor := $D4D4D4;
        CaptionAppearance.Color := $F2EFED;
        CaptionAppearance.ColorTo := $F2EFED;
        CaptionAppearance.TextColor := clWindowText;
        ...
        CaptionItemAppearance.Color := $F2EFED;
        CaptionItemAppearance.ColorTo := $F2EFED;
        CaptionItemAppearance.TextColor := clWindowText;

        ScrollerAppearance.TextColor := clWindowText;
        ScrollerAppearance.TextColorChecked := clWindowText;
        ScrollerAppearance.TextColorDisabled := clWindowText;
        ScrollerAppearance.TextColorDown := clWindowText;
        ScrollerAppearance.TextColorHot := clWindowText;

        ScrollerAppearance.Color := clWhite;
        ScrollerAppearance.ColorTo := clWhite;
        ScrollerAppearance.ColorMirror := clWhite;
        ScrollerAppearance.ColorMirrorTo := clWhite;
        ScrollerAppearance.BorderColor := $D4D4D4;
        ScrollerAppearance.Gradient := ggVertical;
        ScrollerAppearance.GradientMirror := ggVertical;

        ScrollerAppearance.ColorHot := $FCF0E4;
        ScrollerAppearance.ColorHotTo := $FCF0E4;
        ScrollerAppearance.ColorMirrorHot := $FCF0E4;
        ScrollerAppearance.ColorMirrorHotTo := $FCF0E4;
        ScrollerAppearance.BorderColorHot := $D4D4D4;
        ScrollerAppearance.GradientHot := ggVertical;
        ScrollerAppearance.GradientMirrorHot := ggVertical;

        ScrollerAppearance.ColorDown := $FCE2C8;
        ScrollerAppearance.ColorDownTo := $FCE2C8;
        ScrollerAppearance.ColorMirrorDown := $FCE2C8;
        ScrollerAppearance.ColorMirrorDownTo := $FCE2C8;
        ScrollerAppearance.BorderColorDown := $D4D4D4;
        ScrollerAppearance.GradientDown := ggVertical;
        ScrollerAppearance.GradientMirrorDown := ggVertical;

        ScrollerAppearance.ColorChecked := $FCE2C8;
        ScrollerAppearance.ColorCheckedTo := $FCE2C8;
        ScrollerAppearance.ColorMirrorChecked := $FCE2C8;
        ScrollerAppearance.ColorMirrorCheckedTo := $FCE2C8;
        ScrollerAppearance.BorderColorChecked := $FCE2C8;
        ScrollerAppearance.TextColorChecked := clBlack;
        ScrollerAppearance.GradientChecked := ggVertical;
        ScrollerAppearance.GradientMirrorChecked := ggVertical;

        ScrollerAppearance.ColorDisabled := $EEEEEE;
        ScrollerAppearance.ColorDisabledTo := $EEEEEE;
        ScrollerAppearance.ColorMirrorDisabled := $EEEEEE;
        ScrollerAppearance.ColorMirrorDisabledTo :=  $EEEEEE;
        ScrollerAppearance.BorderColorDisabled := $D4D4D4;
        ScrollerAppearance.TextColorDisabled := clWindowText;
        ...
        SelectionAppearance.GradientHot := ggVertical;
        SelectionAppearance.GradientMirrorHot := ggVertical;
        SelectionAppearance.TextColorHot := clWindowText;
        ...
        SelectionAppearance.GradientDown := ggVertical;
        SelectionAppearance.GradientMirrorDown := ggVertical;
        SelectionAppearance.TextColorDown := clWindowText;
        ...
        SelectionAppearance.ColorMirrorDownTo := clNone;
        SelectionAppearance.BorderColorDisabled := $ACACAC;
        SelectionAppearance.TextColorDisabled := clWindowText;
      end;
      ...
      begin
        ...
        ColorDropDownTo := clNone;
        BorderColor := $C6C6C6;
        BorderDropDownColor := $C6C6C6;
        FocusColor := clWhite;
        FocusColorTo := clWhite;

        ResizerAppearance.BorderColor := $C6C6C6;
        ResizerAppearance.Color := clWhite;
        ResizerAppearance.ColorTo := clWhite;

        IconBarAppearance.BorderColor := $C6C6C6;
        IconBarAppearance.Color := clWhite;
        IconBarAppearance.ColorTo := clWhite;

        CaptionAppearance.BorderColor := $C6C6C6;
        CaptionAppearance.Color := $F2EFED;
        CaptionAppearance.ColorTo := $F2EFED;
        CaptionAppearance.TextColor := clWindowText;

        CaptionItemAppearance.BorderColor := $C6C6C6;
        CaptionItemAppearance.Color := $F2EFED;
        CaptionItemAppearance.ColorTo := $F2EFED;
        CaptionItemAppearance.TextColor := clWindowText;
        ...
        ScrollerAppearance.Color := $F6F6F6;
        ScrollerAppearance.ColorTo := $F6F6F6;
        ScrollerAppearance.ColorMirror := $F6F6F6;
        ScrollerAppearance.ColorMirrorTo := $F6F6F6;
        ScrollerAppearance.BorderColor := $C6C6C6;
        ScrollerAppearance.Gradient := ggVertical;
        ScrollerAppearance.GradientMirror := ggVertical;
        ...
        ScrollerAppearance.ColorMirrorHot := $FCF0E4;
        ScrollerAppearance.ColorMirrorHotTo := $FCF0E4;
        ScrollerAppearance.BorderColorHot := $EAB47E;
        ScrollerAppearance.GradientHot := ggVertical;
        ScrollerAppearance.GradientMirrorHot := ggVertical;
        ...
        ScrollerAppearance.ColorMirrorDown := $FCE2C8;
        ScrollerAppearance.ColorMirrorDownTo := $FCE2C8;
        ScrollerAppearance.BorderColorDown := $E59D56;
        ScrollerAppearance.GradientDown := ggVertical;
        ScrollerAppearance.GradientMirrorDown := ggVertical;
        ...
        SelectionAppearance.Color := $F6F6F6;
        SelectionAppearance.ColorTo := $F6F6F6;
        SelectionAppearance.ColorMirror := $F6F6F6;
        SelectionAppearance.ColorMirrorTo := $F6F6F6;
      ...
      begin
        ...
        ColorDropDownTo := clNone;
        BorderColor := $ABABAB;
        BorderDropDownColor := $ABABAB;
        FocusColor := clWhite;
        FocusColorTo := clWhite;

        ResizerAppearance.BorderColor := $ABABAB;
        ResizerAppearance.Color := clWhite;
        ResizerAppearance.ColorTo := clWhite;

        IconBarAppearance.BorderColor := $ABABAB;
        IconBarAppearance.Color := clWhite;
        IconBarAppearance.ColorTo := clWhite;

        CaptionAppearance.BorderColor := $ABABAB;
        CaptionAppearance.Color := $E5E5E5;
        CaptionAppearance.ColorTo := $E5E5E5;
        CaptionAppearance.TextColor := clWindowText;

        CaptionItemAppearance.BorderColor := $ABABAB;
        CaptionItemAppearance.Color := $E5E5E5;
        CaptionItemAppearance.ColorTo := $E5E5E5;
        CaptionItemAppearance.TextColor := clWindowText;
        ...
        ScrollerAppearance.Color := $E5E5E5;
        ScrollerAppearance.ColorTo := $E5E5E5;
        ScrollerAppearance.ColorMirror := $E5E5E5;
        ScrollerAppearance.ColorMirrorTo := $E5E5E5;
        ScrollerAppearance.BorderColor := $ABABAB;
        ScrollerAppearance.Gradient := ggVertical;
        ScrollerAppearance.GradientMirror := ggVertical;
        ...
        SelectionAppearance.Color := $E5E5E5;
        SelectionAppearance.ColorTo := $E5E5E5;
        SelectionAppearance.ColorMirror := $E5E5E5;
        SelectionAppearance.ColorMirrorTo := $E5E5E5;
      ...
      begin
        ...
        CaptionItemAppearance.BorderColor := $D4D4D4;
        CaptionItemAppearance.Color := $F2EFED;
        CaptionItemAppearance.ColorTo := $F2EFED;
        CaptionItemAppearance.TextColor := $675F58;

        ScrollerAppearance.TextColor := $505050;
        ScrollerAppearance.TextColorChecked := $505050;
        ScrollerAppearance.TextColorDisabled := $505050;
        ScrollerAppearance.TextColorDown := $505050;
        ScrollerAppearance.TextColorHot := $505050;
        ...
        ScrollerAppearance.ColorHot := $F2E1D5;
        ScrollerAppearance.ColorHotTo := $F2E1D5;
        ScrollerAppearance.ColorMirrorHot := $F2E1D5;
        ScrollerAppearance.ColorMirrorHotTo := $F2E1D5;
        ScrollerAppearance.BorderColorHot := $D4D4D4;
        ScrollerAppearance.GradientHot := ggVertical;
        ScrollerAppearance.GradientMirrorHot := ggVertical;

        ScrollerAppearance.ColorDown := $E3BDA3;
        ScrollerAppearance.ColorDownTo := $E3BDA3;
        ScrollerAppearance.ColorMirrorDown := $E3BDA3;
        ScrollerAppearance.ColorMirrorDownTo := $E3BDA3;
        ScrollerAppearance.BorderColorDown := $D4D4D4;
        ScrollerAppearance.GradientDown := ggVertical;
        ScrollerAppearance.GradientMirrorDown := ggVertical;

        ScrollerAppearance.ColorChecked := $F2D5C2;
        ScrollerAppearance.ColorCheckedTo := $F2D5C2;
        ScrollerAppearance.ColorMirrorChecked := $F2D5C2;
        ScrollerAppearance.ColorMirrorCheckedTo := $F2D5C2;
        ScrollerAppearance.BorderColorChecked := $D4D4D4;
        ScrollerAppearance.TextColorChecked := clBlack;
        ScrollerAppearance.GradientChecked := ggVertical;
        ScrollerAppearance.GradientMirrorChecked := ggVertical;

        ScrollerAppearance.ColorDisabled := $D4D4D4;
        ScrollerAppearance.ColorDisabledTo := $D4D4D4;
        ScrollerAppearance.ColorMirrorDisabled := $D4D4D4;
        ScrollerAppearance.ColorMirrorDisabledTo :=  $D4D4D4;
        ScrollerAppearance.BorderColorDisabled := $D4D4D4;
        ScrollerAppearance.TextColorDisabled := $505050;
        ...
        SelectionAppearance.ColorMirrorHot := $F2E1D5;
        SelectionAppearance.ColorMirrorHotTo := $F2E1D5;
        SelectionAppearance.BorderColorHot := $D4D4D4;
        SelectionAppearance.GradientHot := ggVertical;
        SelectionAppearance.GradientMirrorHot := ggVertical;
        SelectionAppearance.TextColorHot := $505050;
        ...
        SelectionAppearance.ColorMirrorDown := $E3BDA3;
        SelectionAppearance.ColorMirrorDownTo := $E3BDA3;
        SelectionAppearance.BorderColorDown := $D4D4D4;
        SelectionAppearance.GradientDown := ggVertical;
        SelectionAppearance.GradientMirrorDown := ggVertical;
        SelectionAppearance.TextColorDown := $505050;

        SelectionAppearance.ColorChecked := $E3BDA3;
        SelectionAppearance.ColorCheckedTo := $E3BDA3;
        SelectionAppearance.ColorMirrorChecked := $E3BDA3;
        SelectionAppearance.ColorMirrorCheckedTo := $E3BDA3;
        SelectionAppearance.BorderColorChecked := $E3BDA3;
        SelectionAppearance.TextColorChecked := $505050;
        SelectionAppearance.GradientChecked := ggVertical;
        SelectionAppearance.GradientMirrorChecked := ggVertical;
        SelectionAppearance.Rounded := False;

        SelectionAppearance.ColorDisabled := $00D4D4D4;
        SelectionAppearance.ColorDisabledTo := $00D4D4D4;
        SelectionAppearance.ColorMirrorDisabled := $00D4D4D4;
        SelectionAppearance.ColorMirrorDisabledTo :=  $00D4D4D4;
        SelectionAppearance.BorderColorDisabled := $00D4D4D4;
        SelectionAppearance.TextColorDisabled := $505050;
      end;
      ...
      begin
        Color := $B2B2B2;
        ColorTo := clNone;
        ColorDropDown := $B2B2B2;
        ColorDropDownTo := clNone;
        BorderColor := $00B8BBBE;
        BorderDropDownColor := $00808080;
        FocusColor := clWhite;
        FocusColorTo := clWhite;

        ResizerAppearance.BorderColor := $00B8BBBE;
        ResizerAppearance.Color := $B2B2B2;
        ResizerAppearance.ColorTo := $B2B2B2;

        IconBarAppearance.BorderColor := $444444;
        IconBarAppearance.Color := $B2B2B2;
        IconBarAppearance.ColorTo := $B2B2B2;

        CaptionAppearance.BorderColor := $00808080;
        CaptionAppearance.Color := $B2B2B2;
        CaptionAppearance.ColorTo := $B2B2B2;
        CaptionAppearance.TextColor := $424242;

        CaptionItemAppearance.BorderColor := $444444;
        CaptionItemAppearance.Color := $B2B2B2;
        CaptionItemAppearance.ColorTo := $B2B2B2;
        CaptionItemAppearance.TextColor := $424242;

        ScrollerAppearance.TextColor := $424242;
        ScrollerAppearance.TextColorChecked := $424242;
        ScrollerAppearance.TextColorDisabled := $424242;
        ScrollerAppearance.TextColorDown := $424242;
        ScrollerAppearance.TextColorHot := $424242;

        ScrollerAppearance.Color :=$B2B2B2;
        ScrollerAppearance.ColorTo := $B2B2B2;
        ScrollerAppearance.ColorMirror := $B2B2B2;
        ScrollerAppearance.ColorMirrorTo := $B2B2B2;
        ScrollerAppearance.BorderColor := $444444;
        ScrollerAppearance.Gradient := ggVertical;
        ScrollerAppearance.GradientMirror := ggVertical;
        ...
        ScrollerAppearance.ColorMirrorHot := $F2E1D5;
        ScrollerAppearance.ColorMirrorHotTo := $F2E1D5;
        ScrollerAppearance.BorderColorHot := $444444;
        ScrollerAppearance.GradientHot := ggVertical;
        ScrollerAppearance.GradientMirrorHot := ggVertical;
        ...
        ScrollerAppearance.ColorMirrorDown := $E3BDA3;
        ScrollerAppearance.ColorMirrorDownTo := $E3BDA3;
        ScrollerAppearance.BorderColorDown := $444444;
        ScrollerAppearance.GradientDown := ggVertical;
        ScrollerAppearance.GradientMirrorDown := ggVertical;

        ScrollerAppearance.ColorChecked := $F2E1D5;
        ScrollerAppearance.ColorCheckedTo := $F2E1D5;
        ScrollerAppearance.ColorMirrorChecked := $F2E1D5;
        ScrollerAppearance.ColorMirrorCheckedTo := $F2E1D5;
        ScrollerAppearance.BorderColorChecked := $F2E1D5;
        ScrollerAppearance.GradientChecked := ggVertical;
        ScrollerAppearance.GradientMirrorChecked := ggVertical;

        ScrollerAppearance.ColorDisabled := $00D4D4D4;
        ScrollerAppearance.ColorDisabledTo := $00D4D4D4;
        ScrollerAppearance.ColorMirrorDisabled := $00D4D4D4;
        ScrollerAppearance.ColorMirrorDisabledTo :=  $00D4D4D4;
        ScrollerAppearance.BorderColorDisabled := $444444;

        SelectionAppearance.Color := $B2B2B2;
        SelectionAppearance.ColorTo := $B2B2B2;
        SelectionAppearance.ColorMirror := $B2B2B2;
        SelectionAppearance.ColorMirrorTo := $B2B2B2;
        ...
        SelectionAppearance.ColorMirrorHot := $F2E1D5;
        SelectionAppearance.ColorMirrorHotTo := $F2E1D5;
        SelectionAppearance.BorderColorHot := $444444;
        SelectionAppearance.GradientHot := ggVertical;
        SelectionAppearance.GradientMirrorHot := ggVertical;
        SelectionAppearance.TextColorHot := $424242;
        ...
        SelectionAppearance.ColorMirrorCheckedTo := $E3BDA3;
        SelectionAppearance.BorderColorChecked := $E3BDA3;
        SelectionAppearance.TextColorChecked := $424242;
        SelectionAppearance.GradientChecked := ggVertical;
        SelectionAppearance.GradientMirrorChecked := ggVertical;
        SelectionAppearance.Rounded := False;
        ...
        SelectionAppearance.ColorMirrorDisabledTo :=  $00D4D4D4;
        SelectionAppearance.BorderColorDisabled := $444444;
        SelectionAppearance.TextColorDisabled := $424242;
      ...
      begin
        ...
        ResizerAppearance.BorderColor := $444444;
        ResizerAppearance.Color := $363636;
        ResizerAppearance.ColorTo := $363636;

        IconBarAppearance.BorderColor := $444444;
        IconBarAppearance.Color := $363636;
        IconBarAppearance.ColorTo := $363636;

        CaptionAppearance.BorderColor := $444444;
        CaptionAppearance.Color := $363636;
        CaptionAppearance.ColorTo := $363636;
        CaptionAppearance.TextColor := clWhite;

        CaptionItemAppearance.BorderColor := $444444;
        CaptionItemAppearance.Color := $363636;
        CaptionItemAppearance.ColorTo := $363636;
        CaptionItemAppearance.TextColor := clWhite;

        ScrollerAppearance.TextColor := $A6A6A6;
        ScrollerAppearance.TextColorChecked := $A6A6A6;
        ScrollerAppearance.TextColorDisabled := $A6A6A6;
        ScrollerAppearance.TextColorDown := $A6A6A6;
        ScrollerAppearance.TextColorHot := $A6A6A6;

        ScrollerAppearance.Color :=$363636;
        ScrollerAppearance.ColorTo := $363636;
        ScrollerAppearance.ColorMirror := $363636;
        ScrollerAppearance.ColorMirrorTo := $363636;
        ScrollerAppearance.BorderColor := $444444;
        ScrollerAppearance.Gradient := ggVertical;
        ScrollerAppearance.GradientMirror := ggVertical;

        ScrollerAppearance.ColorHot := $6A6A6A;
        ScrollerAppearance.ColorHotTo := $6A6A6A;
        ScrollerAppearance.ColorMirrorHot := $6A6A6A;
        ScrollerAppearance.ColorMirrorHotTo := $6A6A6A;
        ScrollerAppearance.BorderColorHot := $444444;
        ScrollerAppearance.GradientHot := ggVertical;
        ScrollerAppearance.GradientMirrorHot := ggVertical;

        ScrollerAppearance.ColorDown := $444444;
        ScrollerAppearance.ColorDownTo := $444444;
        ScrollerAppearance.ColorMirrorDown := $444444;
        ScrollerAppearance.ColorMirrorDownTo := $444444;
        ScrollerAppearance.BorderColorDown := $444444;
        ScrollerAppearance.GradientDown := ggVertical;
        ScrollerAppearance.GradientMirrorDown := ggVertical;

        ScrollerAppearance.ColorChecked := $6A6A6A;
        ScrollerAppearance.ColorCheckedTo := $6A6A6A;
        ScrollerAppearance.ColorMirrorChecked := $6A6A6A;
        ScrollerAppearance.ColorMirrorCheckedTo := $6A6A6A;
        ScrollerAppearance.BorderColorChecked := $6A6A6A;
        ScrollerAppearance.GradientChecked := ggVertical;
        ScrollerAppearance.GradientMirrorChecked := ggVertical;

        ScrollerAppearance.ColorDisabled := $004D4D4D;
        ScrollerAppearance.ColorDisabledTo := $004D4D4D;
        ScrollerAppearance.ColorMirrorDisabled := $004D4D4D;
        ScrollerAppearance.ColorMirrorDisabledTo :=  $004D4D4D;
        ScrollerAppearance.BorderColorDisabled := $444444;
        ...
        SelectionAppearance.ColorChecked := $6A6A6A;
        SelectionAppearance.ColorCheckedTo := $6A6A6A;
        SelectionAppearance.ColorMirrorChecked := $6A6A6A;
        SelectionAppearance.ColorMirrorCheckedTo := $6A6A6A;
        SelectionAppearance.BorderColorChecked := $6A6A6A;
        SelectionAppearance.TextColorChecked := $A6A6A6;
        SelectionAppearance.GradientChecked := ggVertical;
        SelectionAppearance.GradientMirrorChecked := ggVertical;
        SelectionAppearance.Rounded := False;

        SelectionAppearance.ColorDisabled := $004D4D4D;
        SelectionAppearance.ColorDisabledTo := $004D4D4D;
        SelectionAppearance.ColorMirrorDisabled := $004D4D4D;
        SelectionAppearance.ColorMirrorDisabledTo :=  $004D4D4D;
        SelectionAppearance.BorderColorDisabled := $444444;
        SelectionAppearance.TextColorDisabled := $A6A6A6;
      end;
      ...
      begin
        ...
        BorderDropDownColor := $00F2E1D5;
        FocusColor := clWhite;
        FocusColorTo := clWhite;

        ResizerAppearance.BorderColor := $00ABABAB;
        ResizerAppearance.Color := clWhite;
        ResizerAppearance.ColorTo := clWhite;

        IconBarAppearance.BorderColor := $00ABABAB;
        IconBarAppearance.Color := clWhite;
        IconBarAppearance.ColorTo := clWhite;

        CaptionAppearance.BorderColor := $00A3A3A3;
        CaptionAppearance.Color := $00D1B9A5;
        CaptionAppearance.ColorTo := $00D1B9A5;
        CaptionAppearance.TextColor := $00444648;

        CaptionItemAppearance.BorderColor := $00ABABAB;
        CaptionItemAppearance.Color := clWhite;
        CaptionItemAppearance.ColorTo := clWhite;
        CaptionItemAppearance.TextColor := $00444648;

        ScrollerAppearance.TextColor := $00444648;
        ScrollerAppearance.TextColorChecked := $003B3B3B;
        ScrollerAppearance.TextColorDisabled := $004D4D4D;
        ScrollerAppearance.TextColorDown := $00444648;
        ScrollerAppearance.TextColorHot := $00444648;

        ScrollerAppearance.Color :=clWhite;
        ScrollerAppearance.ColorTo := clWhite;
        ScrollerAppearance.ColorMirror := clWhite;
        ScrollerAppearance.ColorMirrorTo := clWhite;
        ScrollerAppearance.BorderColor := $00A3A3A3;
        ScrollerAppearance.Gradient := ggVertical;
        ScrollerAppearance.GradientMirror := ggVertical;

        ScrollerAppearance.ColorHot := $00FAECE3;
        ScrollerAppearance.ColorHotTo := $00FAECE3;
        ScrollerAppearance.ColorMirrorHot := $00FAECE3;
        ScrollerAppearance.ColorMirrorHotTo := $00FAECE3;
        ScrollerAppearance.BorderColorHot := $00A3A3A3;
        ScrollerAppearance.GradientHot := ggVertical;
        ScrollerAppearance.GradientMirrorHot := ggVertical;

        ScrollerAppearance.ColorDown := $00B0784A;
        ScrollerAppearance.ColorDownTo := $00B0784A;
        ScrollerAppearance.ColorMirrorDown := $00B0784A;
        ScrollerAppearance.ColorMirrorDownTo := $00B0784A;
        ScrollerAppearance.BorderColorDown := $00A3A3A3;
        ScrollerAppearance.GradientDown := ggVertical;
        ScrollerAppearance.GradientMirrorDown := ggVertical;

        ScrollerAppearance.ColorChecked := $00D1B9A5;
        ScrollerAppearance.ColorCheckedTo := $00D1B9A5;
        ScrollerAppearance.ColorMirrorChecked := $00D1B9A5;
        ScrollerAppearance.ColorMirrorCheckedTo := $00D1B9A5;
        ScrollerAppearance.BorderColorChecked := $00A3A3A3;
        ScrollerAppearance.GradientChecked := ggVertical;
        ScrollerAppearance.GradientMirrorChecked := ggVertical;
        ...
        ScrollerAppearance.ColorMirrorDisabled := $00D4D4D4;
        ScrollerAppearance.ColorMirrorDisabledTo :=  $00D4D4D4;
        ScrollerAppearance.BorderColorDisabled := $00D4D4D4;

        SelectionAppearance.Color := clWhite;
        SelectionAppearance.ColorTo := clWhite;
        SelectionAppearance.ColorMirror := clWhite;
        SelectionAppearance.ColorMirrorTo := clWhite;
        SelectionAppearance.TextColor := $00444648;

        SelectionAppearance.ColorHot := $00F2E1D5;
        SelectionAppearance.ColorHotTo := $00F2E1D5;
        SelectionAppearance.ColorMirrorHot := $00F2E1D5;
        SelectionAppearance.ColorMirrorHotTo := $00F2E1D5;
        SelectionAppearance.BorderColorHot := $00ABABAB;
        SelectionAppearance.GradientHot := ggVertical;
        SelectionAppearance.GradientMirrorHot := ggVertical;
        SelectionAppearance.TextColorHot := $00444648;
        ...
        SelectionAppearance.ColorMirrorDown := $00E3BDA3;
        SelectionAppearance.ColorMirrorDownTo := $00E3BDA3;
        SelectionAppearance.BorderColorDown := $00ABABAB;
        SelectionAppearance.GradientDown := ggVertical;
        SelectionAppearance.GradientMirrorDown := ggVertical;
        SelectionAppearance.TextColorDown := clBlack;
        ...
        SelectionAppearance.ColorMirrorChecked := $00F2E1D5;
        SelectionAppearance.ColorMirrorCheckedTo := $00F2E1D5;
        SelectionAppearance.BorderColorChecked := $00F2E1D5;
        SelectionAppearance.TextColorChecked := $003B3B3B;
        SelectionAppearance.GradientChecked := ggVertical;
        SelectionAppearance.GradientMirrorChecked := ggVertical;
        SelectionAppearance.Rounded := False;
        ...
        SelectionAppearance.ColorMirrorDisabledTo :=  $00D4D4D4;
        SelectionAppearance.BorderColorDisabled := $00D4D4D4;
        SelectionAppearance.TextColorDisabled := $004D4D4D;
      end;
      ...
      begin
        ...
        ResizerAppearance.BorderColor := $00B8BBBE;
        ResizerAppearance.Color := $00B8BBBE;
        ResizerAppearance.ColorTo := $00B8BBBE;

        IconBarAppearance.BorderColor := $00B8BBBE;
        IconBarAppearance.Color := $00B8BBBE;
        IconBarAppearance.ColorTo := $00B8BBBE;

        CaptionAppearance.BorderColor := $00808080;
        CaptionAppearance.Color := $00D4D4D4;
        CaptionAppearance.ColorTo := $00D4D4D4;
        CaptionAppearance.TextColor := $00232425;

        CaptionItemAppearance.BorderColor := $00B8BBBE;
        CaptionItemAppearance.Color := clWhite;
        CaptionItemAppearance.ColorTo := clWhite;
        CaptionItemAppearance.TextColor := $00232425;

        ScrollerAppearance.TextColor := $00232425;
        ScrollerAppearance.TextColorChecked := $00232425;
        ScrollerAppearance.TextColorDisabled := $00232425;
        ScrollerAppearance.TextColorDown := $00232425;
        ScrollerAppearance.TextColorHot := $001E1F20;

        ScrollerAppearance.Color :=$00B8BBBE;
        ScrollerAppearance.ColorTo := $00B8BBBE;
        ScrollerAppearance.ColorMirror := $00B8BBBE;
        ScrollerAppearance.ColorMirrorTo := $00B8BBBE;
        ScrollerAppearance.BorderColor := $00808080;
        ScrollerAppearance.Gradient := ggVertical;
        ScrollerAppearance.GradientMirror := ggVertical;

        ScrollerAppearance.ColorHot := $00939597;
        ScrollerAppearance.ColorHotTo := $00939597;
        ScrollerAppearance.ColorMirrorHot := $00939597;
        ScrollerAppearance.ColorMirrorHotTo := $00939597;
        ScrollerAppearance.BorderColorHot := $00939597;
        ScrollerAppearance.GradientHot := ggVertical;
        ScrollerAppearance.GradientMirrorHot := ggVertical;

        ScrollerAppearance.ColorDown := $0086888A;
        ScrollerAppearance.ColorDownTo := $0086888A;
        ScrollerAppearance.ColorMirrorDown := $0086888A;
        ScrollerAppearance.ColorMirrorDownTo := $0086888A;
        ScrollerAppearance.BorderColorDown := $00B8BBBE;
        ScrollerAppearance.GradientDown := ggVertical;
        ScrollerAppearance.GradientMirrorDown := ggVertical;

        ScrollerAppearance.ColorChecked := $00969696;
        ScrollerAppearance.ColorCheckedTo := $00969696;
        ScrollerAppearance.ColorMirrorChecked := $00969696;
        ScrollerAppearance.ColorMirrorCheckedTo := $00969696;
        ScrollerAppearance.BorderColorChecked := $00969696;
        ScrollerAppearance.GradientChecked := ggVertical;
        ScrollerAppearance.GradientMirrorChecked := ggVertical;
        ...
        ScrollerAppearance.ColorMirrorDisabled := $00D4D4D4;
        ScrollerAppearance.ColorMirrorDisabledTo :=  $00D4D4D4;
        ScrollerAppearance.BorderColorDisabled := $00808080;

        SelectionAppearance.Color := $00D4D4D4;
        SelectionAppearance.ColorTo := $00D4D4D4;
        SelectionAppearance.ColorMirror := $00D4D4D4;
        SelectionAppearance.ColorMirrorTo := $00D4D4D4;
        SelectionAppearance.TextColor := $00232425;

        SelectionAppearance.ColorHot := $00969696;
        SelectionAppearance.ColorHotTo := $00969696;
        SelectionAppearance.ColorMirrorHot := $00969696;
        SelectionAppearance.ColorMirrorHotTo := $00969696;
        SelectionAppearance.BorderColorHot := $00505050;
        SelectionAppearance.GradientHot := ggVertical;
        SelectionAppearance.GradientMirrorHot := ggVertical;
        SelectionAppearance.TextColorHot := $00232425;

        SelectionAppearance.ColorDown := $00666666;
        SelectionAppearance.ColorDownTo := $00666666;
        SelectionAppearance.ColorMirrorDown := $00666666;
        SelectionAppearance.ColorMirrorDownTo := $00666666;
        SelectionAppearance.BorderColorDown := $00808080;
        SelectionAppearance.GradientDown := ggVertical;
        SelectionAppearance.GradientMirrorDown := ggVertical;
        SelectionAppearance.TextColorDown := $00232425;

        SelectionAppearance.ColorChecked := $00969696;
        SelectionAppearance.ColorCheckedTo := $00969696;
        SelectionAppearance.ColorMirrorChecked := $00969696;
        SelectionAppearance.ColorMirrorCheckedTo := $00969696;
        SelectionAppearance.BorderColorChecked := $00969696;
        SelectionAppearance.TextColorChecked := $003B3B3B;
        SelectionAppearance.GradientChecked := ggVertical;
        SelectionAppearance.GradientMirrorChecked := ggVertical;
        SelectionAppearance.Rounded := False;
      ...
      begin
        ...
        ResizerAppearance.BorderColor := $00B8BBBE;
        ResizerAppearance.Color := $003B3B3B;
        ResizerAppearance.ColorTo := $003B3B3B;

        IconBarAppearance.BorderColor := $00B8BBBE;
        IconBarAppearance.Color := $003B3B3B;
        IconBarAppearance.ColorTo := $003B3B3B;

        CaptionAppearance.BorderColor := $00808080;
        CaptionAppearance.Color := $003B3B3B;
        CaptionAppearance.ColorTo := $003B3B3B;
        CaptionAppearance.TextColor := clWhite;

        CaptionItemAppearance.BorderColor := $00B8BBBE;
        CaptionItemAppearance.Color := $003B3B3B;
        CaptionItemAppearance.ColorTo := $003B3B3B;
        CaptionItemAppearance.TextColor := clWhite;

        ScrollerAppearance.TextColor := clWhite;
        ScrollerAppearance.TextColorChecked := clWhite;
        ScrollerAppearance.TextColorDisabled := clWhite;
        ScrollerAppearance.TextColorDown := clWhite;
        ScrollerAppearance.TextColorHot := clWhite;

        ScrollerAppearance.Color :=$003B3B3B;
        ScrollerAppearance.ColorTo := $003B3B3B;
        ScrollerAppearance.ColorMirror := $003B3B3B;
        ScrollerAppearance.ColorMirrorTo := $003B3B3B;
        ScrollerAppearance.BorderColor := $003B3B3B;
        ScrollerAppearance.Gradient := ggVertical;
        ScrollerAppearance.GradientMirror := ggVertical;

        ScrollerAppearance.ColorHot := $00444648;
        ScrollerAppearance.ColorHotTo := $00444648;
        ScrollerAppearance.ColorMirrorHot := $00444648;
        ScrollerAppearance.ColorMirrorHotTo := $00444648;
        ScrollerAppearance.BorderColorHot := $00B8BBBE;
        ScrollerAppearance.GradientHot := ggVertical;
        ScrollerAppearance.GradientMirrorHot := ggVertical;

        ScrollerAppearance.ColorDown := $005C5E60;
        ScrollerAppearance.ColorDownTo := $0086888A;
        ScrollerAppearance.ColorMirrorDown := $005C5E60;
        ScrollerAppearance.ColorMirrorDownTo := $005C5E60;
        ScrollerAppearance.BorderColorDown := $00B8BBBE;
        ScrollerAppearance.GradientDown := ggVertical;
        ScrollerAppearance.GradientMirrorDown := ggVertical;

        ScrollerAppearance.ColorChecked := $00444648;
        ScrollerAppearance.ColorCheckedTo := $00444648;
        ScrollerAppearance.ColorMirrorChecked := $00444648;
        ScrollerAppearance.ColorMirrorCheckedTo := $00444648;
        ScrollerAppearance.BorderColorChecked := $00444648;
        ScrollerAppearance.GradientChecked := ggVertical;
        ScrollerAppearance.GradientMirrorChecked := ggVertical;
        ...
        ScrollerAppearance.ColorMirrorDisabled := $004D4D4D;
        ScrollerAppearance.ColorMirrorDisabledTo :=  $004D4D4D;
        ScrollerAppearance.BorderColorDisabled := $003B3B3B;
        ...
        SelectionAppearance.ColorMirrorDown := $00828282;
        SelectionAppearance.ColorMirrorDownTo := $00828282;
        SelectionAppearance.BorderColorDown := $00686868;
        SelectionAppearance.GradientDown := ggVertical;
        SelectionAppearance.GradientMirrorDown := ggVertical;
        SelectionAppearance.TextColorDown := clWhite;

        SelectionAppearance.ColorChecked := $00505050;
        SelectionAppearance.ColorCheckedTo := $00505050;
        SelectionAppearance.ColorMirrorChecked := $00505050;
        SelectionAppearance.ColorMirrorCheckedTo := $00505050;
        SelectionAppearance.BorderColorChecked := $00B5B5B5;
        SelectionAppearance.TextColorChecked := clWhite;
        SelectionAppearance.GradientChecked := ggVertical;
        SelectionAppearance.GradientMirrorChecked := ggVertical;
        SelectionAppearance.Rounded := False;

        SelectionAppearance.ColorDisabled := $006D6D6D;
        SelectionAppearance.ColorDisabledTo := $006D6D6D;
        SelectionAppearance.ColorMirrorDisabled := $006D6D6D;
        SelectionAppearance.ColorMirrorDisabledTo :=  $006D6D6D;
        SelectionAppearance.BorderColorDisabled := $006D6D6D;
        SelectionAppearance.TextColorDisabled := clWhite;
      end;
  end;
