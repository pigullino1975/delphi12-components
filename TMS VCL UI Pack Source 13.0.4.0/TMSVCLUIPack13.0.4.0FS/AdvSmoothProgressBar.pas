...
const
  ...
  // v1.10.0.0 : New : Support for Office 2019 styles
  // v1.10.1.0 : New : UIStyle property for TMSStyle
  // v1.10.1.1 : Fixed : UIStyle set to tsCustom after initial Office look
  // v1.10.1.2 : Improved : On creation check for enabeld AdvFormStyler
  ...
  begin
    ...
    tsOffice2019White:
      begin
        Appearance.Overlays := False;
        Appearance.Shadows := False;
        Appearance.Font.Color := $00444648;

        BackGroundFill.Color := clWhite;
        BackGroundFill.ColorTo := clWhite;
        BackGroundFill.BorderColor := $00ABABAB;
    ...
    tsOffice2019Gray:
      begin
        ...
        BackGroundFill.BorderColor := $00808080;
    ...
    tsOffice2019Black:
      begin
        ...
        BackGroundFill.BorderColor := $00686868;
...
procedure TAdvSmoothProgressBar.SetUIStyle(const Value: TTMSStyle);
begin
