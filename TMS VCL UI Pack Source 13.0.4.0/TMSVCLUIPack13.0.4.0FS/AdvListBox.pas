...
uses
  ...
  AdvMultiButtonEdit, ImgList, Dialogs, Forms, Graphics, AdvStyleIF
  {$IFDEF DELPHIXE2_LVL}
  , System.UITypes
  {$ENDIF}
  ;
...
const
  ...
  // v1.3.1.0 : New : UIStyle property for TMS styles
  //          : Fixed : VCL styles check updated to work in 10.4 Sydney
  // v1.3.1.1 : Fixed : Issue with highlight search function
  // v1.3.1.2 : Fixed : Issue with per monitor DPI handling for ItemHeight
  // v1.3.2.0 : New : Event OnSearchDone added
  // v1.3.3.0 : New : Property ShowImageSelected added
...
type
  ...
  private
    ...
    procedure SetButtonHotColor(const Value: TColor);
  protected
    procedure Changed;
  ...
  published
    ...
    property ButtonBorderColor: TColor read FButtonBorderColor write SetButtonBorderColor default clNone;
    property ButtonColor: TColor read FButtonColor write SetButtonColor default clNone;
    property ButtonDownColor: TColor read FButtonDownColor write SetButtonDownColor default clNone;
    property ButtonHotColor: TColor read FButtonHotColor write SetButtonHotColor default clNone;
  ...
  TAdvCustomListBox = class(TCustomControl, ITMSStyle)
  private
    ...
    procedure SetShowImageSelected(const Value: boolean);
  protected
  ...
  published
    ...
    property ShowHint;
    property ShowImageSelected: boolean read FShowImageSelected write SetShowImageSelected default true;
...
uses
  uxTheme, ShellAPI, ActiveX, CommCtrl, PictureContainer, Math, Menus, AdvHTML
{$IFDEF DELPHIXE2_LVL}
  , VCL.Themes
{$ENDIF}
  ;
...
begin
  ...
  begin
    ...
    begin
      ParentFont := True;
      FSearchEdit.ParentFont := True;
      FInsertEdit.ParentFont := True;
    end;
  end;
...
begin
  ...
  FInsertEdit.ButtonTextColor := Font.Color;
  FInsertEdit.ButtonColor := InsertOptions.ButtonColor;
  FInsertEdit.ButtonColorHot := InsertOptions.ButtonHotColor;
  FInsertEdit.ButtonColorDown := InsertOptions.ButtonDownColor;
  FInsertEdit.ButtonBorderColor := InsertOptions.ButtonBorderColor;
...
begin
  ...
  FSearchEdit.ButtonTextColor := Font.Color;
  FSearchEdit.ButtonColor := SearchOptions.ButtonColor;
  FSearchEdit.ButtonColorHot := SearchOptions.ButtonHotColor;
  FSearchEdit.ButtonColorDown := SearchOptions.ButtonDownColor;
  FSearchEdit.ButtonBorderColor := SearchOptions.ButtonBorderColor;
...
procedure TAdvCustomListBox.SetComponentStyle(AStyle: TTMSStyle);
begin
  ...
  begin
    ...
    case FTMSStyle of
      ...
      begin
        ...
        ListColor := clWhite;
        ListSelectionColor := $00E3BDA3;
        ListSelectionTextColor := $00505050;

        InsertOptions.EditColor := clWhite;
        InsertOptions.ButtonColor := clWhite;
        InsertOptions.ButtonHotColor := $00F2E1D5;
        InsertOptions.ButtonDownColor := $00E3BDA3;
        InsertOptions.ButtonBorderColor := $00D4D4D4;
      end;
      tsOffice2016Gray:
      begin
        ListColor := $00B2B2B2;
        ListSelectionColor := $00E3BDA3;
        ListSelectionTextColor := $00424242;
        Font.Color := clWindowText;
        InsertOptions.EditColor := $00B2B2B2;
        InsertOptions.ButtonColor := $00B2B2B2;
        InsertOptions.ButtonHotColor := $00F2E1D5;
        InsertOptions.ButtonDownColor := $00E3BDA3;
        InsertOptions.ButtonBorderColor := $00444444;
      end;
      tsOffice2016Black:
      begin
        Font.Color := clWhite;
        ListColor := $00363636;
        ListSelectionColor := $00444444;
        ListSelectionTextColor := $00A6A6A6;
        InsertOptions.EditColor := $00363636;
        InsertOptions.ButtonColor := $00363636;
        InsertOptions.ButtonHotColor := $006A6A6A;
        InsertOptions.ButtonDownColor := $00444444;
        InsertOptions.ButtonBorderColor := $00444444;
      end;
      tsOffice2019White:
      begin
        Font.Color := clWindowText;
        ListColor := clWhite;
        ListSelectionColor := $00F2E1D5;
        ListSelectionTextColor := $003B3B3B;
        InsertOptions.EditColor := clWhite;
        InsertOptions.ButtonColor := clWhite;
        InsertOptions.ButtonHotColor := $00F2E1D5;
        InsertOptions.ButtonDownColor := $00E3BDA3;
        InsertOptions.ButtonBorderColor := $00ABABAB;
      end;
      tsOffice2019Gray:
      begin
        Font.Color := $00232425;
        ...
        ListSelectionTextColor := $003B3B3B;
        InsertOptions.EditColor := $00B8BBBE;
        InsertOptions.ButtonColor := $00B8BBBE;
        InsertOptions.ButtonHotColor := $00969696;
        InsertOptions.ButtonDownColor := $00666666;
        InsertOptions.ButtonBorderColor := $00808080;
      end;
      tsOffice2019Black:
      begin
        Font.Color := clWhite;
        ...
        InsertOptions.EditColor := $00444444;
        InsertOptions.ButtonColor := $00444444;
        InsertOptions.ButtonHotColor := $00686868;
        InsertOptions.ButtonDownColor := $00828282;
        InsertOptions.ButtonBorderColor := $00686868;
      ...
      begin
        ...
        InsertOptions.EditColor := clWindow;
        InsertOptions.ButtonColor := clNone;
        InsertOptions.ButtonHotColor := clNone;
        InsertOptions.ButtonDownColor := clNone;
        InsertOptions.ButtonBorderColor := clNone;
      end;
    end;

    SearchOptions.EditColor := InsertOptions.EditColor;
    SearchOptions.ButtonColor := InsertOptions.ButtonColor;
    SearchOptions.ButtonDownColor := InsertOptions.ButtonDownColor;
    SearchOptions.ButtonHotColor := InsertOptions.ButtonHotColor;
    SearchOptions.ButtonBorderColor := InsertOptions.ButtonBorderColor;
//  end
//  else if FTMSStyle <> tsCustom then
//  begin
//    Color := FSearchEdit.Color;
  end;
end;
...
procedure TAdvCustomListBox.SetShowImageSelected(const Value: boolean);
begin
  if (FShowImageSelected <> Value) then
  begin
    FShowImageSelected := Value;
    ListBox.ShowImageSelected := Value;
  end;
end;

procedure TAdvCustomListBox.SetListSelectionColor(const Value: TColor);
begin
  if FListSelectionColor <> Value then
  begin
    FListSelectionColor := Value;
    if Assigned(ListBox) then
    begin
      ListBox.SelectionColor := FListSelectionColor;
      ListBox.Changed;
    end;
  end;
end;

procedure TAdvCustomListBox.SetListSelectionTextColor(const Value: TColor);
begin
  if FListSelectionTextColor <> Value then
  begin
    FListSelectionTextColor := Value;
    if Assigned(ListBox) then
    begin
      ListBox.SelectionTextColor:= FListSelectionTextColor;
      ListBox.Changed;
    end;
  end;
end;
...
procedure TAdvCustomListBox.SetUIStyle(const Value: TTMSStyle);
begin
...
begin
  ...
  if not FShowImageSelected and Assigned(FOwner.Images) then
  begin
    selrect := Rect;
    selrect.Left := selrect.Left + FOwner.Images.Width + 4;
    Canvas.Rectangle(selrect);

    Canvas.Brush.Color := Color;
    selrect := Rect;
    selrect.Right := selrect.Left + FOwner.Images.Width + 4;
    Canvas.Rectangle(selrect);
  end
  else
  ...
  if (FHighlightText <> '') then
    su := Hilight(su, FHighlightText,'hi',FOwner.SearchOptions.CaseSensitive);

  Rect.Top := Rect.Top - 2;

  HTMLDrawEx(Canvas, su, Rect, FOwner.Images, -1, -1,-1,-1,2,false,true,false,
  ...
  HTMLDrawEx(Canvas, su, Rect, FOwner.Images, -1, -1,-1,-1,2,false,false,false,
   (odSelected in State),false,false,false,FFormScaled,1.0,clBlue,clNone, clNone, clGray, a,s,fa,xs,ys,hl,ml,hr, nil, nil, 2, BiDiMode, clHighlight, clHighlightText, [], FDPIScale);
end;
...
procedure TVisualListBox.SetSelectionColor(const Value: TColor);
begin
  FSelectionColor := Value;
end;

procedure TVisualListBox.SetSelectionTextColor(const Value: TColor);
begin
  FSelectionTextColor := Value;
end;

procedure TVisualListBox.SetShowImageSelected(const Value: boolean);
begin
  if (FShowImageSelected <> Value) then
  begin
    FShowImageSelected := Value;
...
begin
  ...
  begin
    ...
    FButtonColor := (Source as TSearchOptions).ButtonColor;
    FButtonDownColor := (Source as TSearchOptions).ButtonDownColor;
    FButtonHotColor := (Source as TSearchOptions).ButtonHotColor;
    FButtonBorderColor := (Source as TSearchOptions).ButtonBorderColor;
  end;
end;
...
begin
  ...
  FShowFind := true;
  FButtonColor := clNone;
  FButtonDownColor := clNone;
  FButtonHotColor := clNone;
  FButtonBorderColor := clNone;
end;

procedure TSearchOptions.SetButtonBorderColor(const Value: TColor);
begin
...
procedure TSearchOptions.SetButtonColor(const Value: TColor);
begin
  if (FButtonColor <> Value) then
  begin
    FButtonColor := Value;
...
procedure TSearchOptions.SetButtonDownColor(const Value: TColor);
begin
...
procedure TSearchOptions.SetButtonHotColor(const Value: TColor);
begin
  if (FButtonColor <> Value) then
  begin
    FButtonHotColor := Value;
    Changed;
  end;
end;
...
procedure TInsertOptions.SetButtonBorderColor(const Value: TColor);
begin
  if (FButtonColor <> Value) then
  begin
    FButtonBorderColor := Value;
...
procedure TInsertOptions.SetButtonColor(const Value: TColor);
begin
  if (FButtonColor <> Value) then
  begin
    FButtonColor := Value;
...
procedure TInsertOptions.SetButtonDownColor(const Value: TColor);
begin
  if (FButtonDownColor <> Value) then
  begin
    FButtonDownColor := Value;
...
procedure TInsertOptions.SetButtonHotColor(const Value: TColor);
begin
  if (FButtonColor <> Value) then
  begin
    FButtonHotColor := Value;
