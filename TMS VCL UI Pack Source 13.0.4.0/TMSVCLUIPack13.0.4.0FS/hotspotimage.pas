...
const
  ...
  // 2.5.2.0 : New : Added HotSpot.BeginUpdate/HotSpot.EndUpdate to do runtime hotspot picture updates
  // 2.6.0.0 : New : Capability to load & save hotspots to file from the hotspot editor
...
procedure THotSpot.BeginUpdate;
begin
