...
const
  ...
  // v1.2.1.2 : Improved: On creation check for enabled AdvFormStyler
  ...
  case AStyle of
    ...
    tsOffice2019White:
      begin
        ...
        Bullets.BorderColor := $00F2E1D5;
        Bullets.Color := $00F2E1D5;
      end;
    tsOffice2019Gray:
      begin
        Fill.Color := $00B8BBBE;
        ...
        Bullets.BorderColor := $00969696;
        Bullets.Color := $00969696;
      end;
    tsOffice2019Black:
      begin
        Fill.Color := $00303132;
        ...
        Bullets.BorderColor := $00686868;
        Bullets.Color := $00686868;
      end;
  end;
end;
...
procedure TAdvSmoothWin8Marquee.SetUIStyle(const Value: TTMSStyle);
begin
