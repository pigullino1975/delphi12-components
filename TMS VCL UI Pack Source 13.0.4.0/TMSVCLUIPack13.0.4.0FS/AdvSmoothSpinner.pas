...
const
  ...
  // v1.6.1.3 : Fixed : VCL styles check updated to work in 10.4 Sydney
  // v1.6.1.4 : Fixed : Issue with columns font when VCL styles are used
...
begin
  ...
  begin
    if (TempStyleInt > 0) then
    begin
      if (BottomLayerFill.Opacity = 255) and (BottomLayerFill.OpacityTo = 255) and
         (TopLayerFill.Opacity = 255) and (TopLayerFill.OpacityTo = 255) then
      begin
...
begin
  ...
  for I := 0 to Columns.Count - 1 do
  begin
    Columns.Items[i].Font.Color := clWindowText;
  end;
  ...
  case AStyle of
    ...
    begin
      ...
      begin
        ...
        Fill.GradientType := gtNone;
        Fill.GradientMirrorType := gtNone;
        Fill.BorderColor := clWhite;//$D4D4D4;
        ...
        DisabledFill.ColorMirrorTo := clNone;
        DisabledFill.BorderColor := $D4D4D4;
        DisabledFill.GradientMirrorType := gtNone;

        HoverFill.Color := $00F2E1D5;
        HoverFill.ColorTo := clNone;
        HoverFill.ColorMirror := $00F2E1D5;
        HoverFill.ColorMirrorTo := clNone;
        HoverFill.BorderColor :=  $00F2E1D5;
        HoverFill.GradientMirrorType := gtNone;
        HoverFill.Glow := gmNone;
      end;

      for I := 0 to Columns.Count - 1 do
      begin
        Columns.Items[i].Font.Color := $00444648;
      end;
    ...
    begin
      Fill.Color := $00D4D4D4;
      Fill.ColorTo := clNone;
      Fill.ColorMirror := $00D4D4D4;
      Fill.ColorMirrorTo := clNone;
      Fill.GradientType := gtNone;
      Fill.GradientMirrorType := gtNone;
      Fill.BorderColor := $00808080;
      ...
      begin
        ...
        Fill.ColorMirror := $00D4D4D4;
        Fill.ColorMirrorTo := clNone;
        Fill.BorderColor := $00D4D4D4;
        Fill.GradientMirrorType := gtNone;

        DisabledFill.Color := $00D4D4D4;
        DisabledFill.ColorTo := clNone;
        DisabledFill.ColorMirror := $00D4D4D4;
        DisabledFill.ColorMirrorTo := clNone;
        DisabledFill.BorderColor := $FFFFFF;
        DisabledFill.GradientMirrorType := gtNone;

        HoverFill.Color := $00969696;
        HoverFill.ColorTo := clNone;
        HoverFill.ColorMirror := $00969696;
        HoverFill.ColorMirrorTo := clNone;
        HoverFill.BorderColor :=  $00969696;
        HoverFill.GradientMirrorType := gtNone;
        HoverFill.Glow := gmNone;
      end;
      ...
      for I := 0 to Columns.Count - 1 do
      begin
        Columns.Items[i].Font.Color := $00232425;
      end;
    end;
    ...
    begin
      ...
      begin
        ...
        Fill.ColorMirror := $00444444;
        Fill.ColorMirrorTo := clNone;
        Fill.BorderColor := $00444444;
        Fill.GradientMirrorType := gtNone;

        DisabledFill.Color := $00444444;
        DisabledFill.ColorTo := clNone;
        DisabledFill.ColorMirror := $00444444;
        DisabledFill.ColorMirrorTo := clNone;
        DisabledFill.BorderColor := $00D4D4D4;
        DisabledFill.GradientMirrorType := gtNone;

        HoverFill.Color := $00686868;
        HoverFill.ColorTo := clNone;
        HoverFill.ColorMirror := $00686868;
        HoverFill.ColorMirrorTo := clNone;
        HoverFill.BorderColor :=  $00686868;
        HoverFill.GradientMirrorType := gtNone;
        HoverFill.Glow := gmNone;
      end;
      ...
      for I := 0 to Columns.Count - 1 do
      begin
        Columns.Items[i].Font.Color := clWhite;
      end;
    end;
  end;
...
procedure TAdvSmoothSpinner.SetUIStyle(const Value: TTMSStyle);
begin
