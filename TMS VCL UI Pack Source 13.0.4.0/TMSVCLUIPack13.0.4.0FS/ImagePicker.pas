...
const
  ...
  // 1.1.3.1 : Fixed : Issue with vertically centering images
  // 1.1.4.0 : New : Support for TVirtualList added
...
begin
  ...
  begin
    FImages.Draw(Canvas, dr.Left, dr.top + ((dr.Bottom - dr.Top) - Images.Height ) div 2, imgidx);
  end;
...
procedure TImagePicker.SetImages(const Value: TCustomImageList);
begin
  FImages := Value;
  Invalidate;
end;
