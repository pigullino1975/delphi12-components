...
const
  ...
  // v1.4.0.0 : New : Support for Office 2019
  // v1.4.1.0 : Improved : UIStyle property for TMSStyle
  // v1.4.1.1 : Fixed : UIStyle set to tsCustom after initial Office look
  // v1.4.1.2 : Improved : On creation check for AdvFormStyler
  // v1.4.1.3 : Fixed : VCL styles check updated to work in 10.4 Sydney
  // v1.4.1.4 : Fixed : Issue with repaint after EndUpdate
...
begin
  ...
  for i := 0 to Calendars.Count - 1 do
    (Calendars[i] as TAdvSmoothCalendar).Invalidate;
end;
...
//        DateAppearance.DisabledDateFill.BorderColor := $588060;
        ...
        DateAppearance.CurrentDateFill.ColorMirror := clNone;
        DateAppearance.CurrentDateFill.ColorMirrorTo := clNone;
        DateAppearance.CurrentDateFill.BorderColor := clWhite;
        DateAppearance.CurrentDateFill.GradientMirrorType := gtVertical;
        DAteAppearance.CurrentDateFont.Color := clWhite;
      end;
...
procedure TAdvSmoothCalendarGroup.SetUIStyle(const Value: TTMSStyle);
begin
