...
type
  ...
  protected
    ...
    procedure DrawSetTransform(m: TAdvGraphicsMatrix); overload;
    ...
    function DrawImage(ABitmap: TAdvBitmapHelperClass; Point: TPointF; ImageType: TAdvPDFGraphicsLibImageType = itOriginal; Quality: Single = 1.0): TRectF; overload;
    ...
    function DrawImage(ABitmap: TAdvBitmapHelperClass; ABackgroundColor: TAdvGraphicsColor; Point: TPointF; ImageType: TAdvPDFGraphicsLibImageType = itOriginal; Quality: Single = 1.0): TRectF; overload;
    ...
    function DrawImage(ABitmap: TAdvBitmapHelperClass; Rect: TRectF; Stretch: Boolean = True; AspectRatio: Boolean = True; ImageType: TAdvPDFGraphicsLibImageType = itOriginal; Quality: Single = 1.0; Center: Boolean = True): TRectF; overload;
    ...
    function DrawImage(ABitmap: TAdvBitmapHelperClass; ABackgroundColor: TAdvGraphicsColor; Rect: TRectF; Stretch: Boolean = True; AspectRatio: Boolean = True; ImageType: TAdvPDFGraphicsLibImageType = itOriginal; Quality: Single = 1.0; Center: Boolean = True): TRectF; overload;
...
procedure RegisterPDFGraphicsLibGeneralService;
begin
  if not TAdvPDFLibPlatformServices.Current.SupportsPlatformService(IAdvPDFGraphicsLibGeneralService, IInterface(PDFGraphicsLibService)) then
  begin
    PDFGraphicsLibService := TAdvGeneralPDFGraphicsLibService.Create;
    TAdvPDFLibPlatformServices.Current.AddPlatformService(IAdvPDFGraphicsLibGeneralService, PDFGraphicsLibService);
  end;
end;

procedure UnregisterPDFGraphicsLibGeneralService;
begin
  TAdvPDFLibPlatformServices.Current.RemovePlatformService(IAdvPDFGraphicsLibGeneralService);
end;
...
procedure TAdvGeneralPDFGraphicsLib.AddGoTo(AText, ADestination: UnicodeString;
  ARect: TRectF);
var
  tr, trr: TRectF;
  fts: TAdvPDFGraphicsLibFont;
...
function TAdvGeneralPDFGraphicsLib.DrawImage(ABitmap: TAdvBitmapHelperClass; ABackgroundColor: TAdvGraphicsColor; Point: TPointF; ImageType: TAdvPDFGraphicsLibImageType; Quality: Single): TRectF;
var
  br: String;
  pt: TPointF;
  sz: TSizeF;
...
function TAdvGeneralPDFGraphicsLib.DrawImage(ABitmap: TAdvBitmapHelperClass; ABackgroundColor: TAdvGraphicsColor; Rect: TRectF; Stretch, AspectRatio: Boolean; ImageType: TAdvPDFGraphicsLibImageType; Quality: Single; Center: Boolean): TRectF;
var
  br: String;
  pt: TPointF;
  sz: TSizeF;
...
function TAdvGeneralPDFGraphicsLib.DrawImage(ABitmap: TAdvBitmapHelperClass;
...
begin
  ...
  bmp := TAdvBitmap(PictureContainer.FindBitmap(ABitmapName));
...
procedure TAdvGeneralPDFGraphicsLib.DrawSetTransform(
...
procedure TAdvGeneralPDFGraphicsLib.DrawSetTransform(m11, m12, m21, m22, dx,
  dy: Double);
begin
  if Assigned(FOutput) then
