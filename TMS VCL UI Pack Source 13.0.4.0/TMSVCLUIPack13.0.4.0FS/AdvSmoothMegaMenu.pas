...
const
  ...
  // v1.5.1.0 : New : UIStyle property for TMSStyle
  // v1.5.1.1 : Fixed : UIStyle set to tsCustom after initial Office look
  // v1.5.1.2 : Improved : On creation check for enabled AdvFormStyler
  // v1.5.1.3 : Improved : The unit GDIPMenu is added on creation in design-time
  // v1.5.1.4 : Improved : Changed TImageList property to TCustomImageList
...
//        ItemAppearance.MenuItemFillDisabled.BorderColor := $588060;
  ...
  tsOffice2016White:
    ...
    tsOffice2016Black:
      ...
      begin
        ...
        ItemAppearance.MenuItemFont.Color:= $00444648;
        ItemAppearance.MenuItemFontSelected.Color := $00444648;
        ItemAppearance.MenuItemFontHover.color := $00444648;

        ItemAppearance.MenuItemFill.Color := clWhite;
        ItemAppearance.MenuItemFill.ColorTo := clNone;
        ItemAppearance.MenuItemFill.ColorMirror := clNone;
        ItemAppearance.MenuItemFill.ColorMirrorTo := clNone;
        ItemAppearance.MenuItemFill.BorderColor := clWhite;
        ...
        ItemAppearance.MenuItemFillSelected.Color := $00E3BDA3;
        ItemAppearance.MenuItemFillSelected.ColorTo := clNone;
        ItemAppearance.MenuItemFillSelected.ColorMirror := clNone;
        ItemAppearance.MenuItemFillSelected.ColorMirrorTo := clNone;
        ItemAppearance.MenuItemFillSelected.BorderColor := $00E3BDA3;
        ItemAppearance.MenuItemFillSelected.GradientMirrorType := gtNone;
        ItemAppearance.MenuItemFillSelected.Glow:= gmNone;
        ItemAppearance.MenuItemFillSelected.GlowGradientColor:= clNone;

        ItemAppearance.MenuItemFillHover.Color := $00F2E1D5;
        ItemAppearance.MenuItemFillHover.ColorTo := clNone;
        ItemAppearance.MenuItemFillHover.ColorMirror := clNone;
        ItemAppearance.MenuItemFillHover.ColorMirrorTo := clNone;
        ItemAppearance.MenuItemFillHover.BorderColor :=  $00F2E1D5;
    ...
    tsOffice2019Gray:
      begin
        ...
        BackGroundFill.Color := $00B8BBBE;
        BackGroundFill.ColorTo := clNone;
        BackGroundFill.BorderColor := clNone;

        ItemAppearance.MenuItemFont.Color:= $00232425;
        ItemAppearance.MenuItemFontSelected.Color := $00232425;
        ItemAppearance.MenuItemFontHover.color := $001E1F20;

        ItemAppearance.MenuItemFill.Color := $00B8BBBE;
        ItemAppearance.MenuItemFill.ColorTo := clNone;
        ItemAppearance.MenuItemFill.ColorMirror := clNone;
        ItemAppearance.MenuItemFill.ColorMirrorTo := clNone;
        ItemAppearance.MenuItemFill.BorderColor := $00B8BBBE;
        ItemAppearance.MenuItemFill.GradientMirrorType := gtNone;

        ItemAppearance.MenuItemFillDisabled.Color := $00B8BBBE;
        ItemAppearance.MenuItemFillDisabled.ColorTo := clNone;
        ItemAppearance.MenuItemFillDisabled.ColorMirror := clNone;
        ItemAppearance.MenuItemFillDisabled.ColorMirrorTo := clNone;
        ItemAppearance.MenuItemFillDisabled.BorderColor := $D4D4D4;
        ...
        ItemAppearance.MenuItemFillSelected.Color := $00666666;
        ItemAppearance.MenuItemFillSelected.ColorTo := clNone;
        ItemAppearance.MenuItemFillSelected.ColorMirror := clNone;
        ItemAppearance.MenuItemFillSelected.ColorMirrorTo := clNone;
        ItemAppearance.MenuItemFillSelected.BorderColor := $00666666;
        ItemAppearance.MenuItemFillSelected.GradientMirrorType := gtNone;
        ItemAppearance.MenuItemFillSelected.Glow:= gmNone;
        ItemAppearance.MenuItemFillSelected.GlowGradientColor:= clNone;

        ItemAppearance.MenuItemFillHover.Color := $00969696;
        ItemAppearance.MenuItemFillHover.ColorTo := $00969696;
        ItemAppearance.MenuItemFillHover.ColorMirror := clNone;
        ItemAppearance.MenuItemFillHover.ColorMirrorTo := clNone;
        ItemAppearance.MenuItemFillHover.BorderColor :=  $00969696;
        ItemAppearance.MenuItemFillHover.GradientMirrorType := gtNone;
      end;
    ...
    tsOffice2019Black:
      begin
        ...
        BackGroundFill.Color := $00303132;
        BackGroundFill.ColorTo := clNone;
        BackGroundFill.BorderColor := clNone;

        ItemAppearance.MenuItemFill.Color := $00303132;
        ItemAppearance.MenuItemFill.ColorTo := clNone;
        ItemAppearance.MenuItemFill.ColorMirror := clNone;
        ItemAppearance.MenuItemFill.ColorMirrorTo := clNone;
        ItemAppearance.MenuItemFill.BorderColor := $00303132;;
        ItemAppearance.MenuItemFill.GradientMirrorType := gtNone;


        ItemAppearance.MenuItemFillDisabled.Color := $00303132;
        ItemAppearance.MenuItemFillDisabled.ColorTo := clNone;
        ItemAppearance.MenuItemFillDisabled.ColorMirror := clNone;
        ItemAppearance.MenuItemFillDisabled.ColorMirrorTo := clNone;
        ItemAppearance.MenuItemFillDisabled.BorderColor := $D4D4D4;
        ...
        ItemAppearance.MenuItemFillSelected.Color := $00828282;
        ItemAppearance.MenuItemFillSelected.ColorTo := clNone;
        ItemAppearance.MenuItemFillSelected.ColorMirror := clNone;
        ItemAppearance.MenuItemFillSelected.ColorMirrorTo := clNone;
        ItemAppearance.MenuItemFillSelected.BorderColor := $00828282;
        ItemAppearance.MenuItemFillSelected.GradientMirrorType := gtNone;
        ItemAppearance.MenuItemFillSelected.Glow:= gmNone;
        ItemAppearance.MenuItemFillSelected.GlowGradientColor:= clNone;

        ItemAppearance.MenuItemFillHover.Color := $00686868;
        ItemAppearance.MenuItemFillHover.ColorTo := $00686868;
        ItemAppearance.MenuItemFillHover.ColorMirror := clNone;
        ItemAppearance.MenuItemFillHover.ColorMirrorTo := clNone;
        ItemAppearance.MenuItemFillHover.BorderColor :=  $00686868;
        ItemAppearance.MenuItemFillHover.GradientMirrorType := gtNone;
      end;
  end;
 ...
 case AStyle of
  ...
  tsOffice2016White:
   ...
   tsOffice2019White:
      begin
        ...
        DefaultSectionItemAppearance.FillSelected.Color := $00E3BDA3;
        DefaultSectionItemAppearance.FillSelected.ColorTo := clNone;
        DefaultSectionItemAppearance.FillSelected.ColorMirror := clNone;
        DefaultSectionItemAppearance.FillSelected.ColorMirrorTo := clNone;
        DefaultSectionItemAppearance.FillSelected.BorderColor := $00E3BDA3;
        DefaultSectionItemAppearance.FillSelected.GradientMirrorType := gtNone;
        DefaultSectionItemAppearance.FillSelected.Glow:= gmNone;
        DefaultSectionItemAppearance.FillSelected.GlowGradientColor:= clNone;

        DefaultSectionItemAppearance.FillHover.Color := $00F2E1D5;
        DefaultSectionItemAppearance.FillHover.ColorTo := clNone;
        DefaultSectionItemAppearance.FillHover.ColorMirror := clNone;
        DefaultSectionItemAppearance.FillHover.ColorMirrorTo := clNone;
        DefaultSectionItemAppearance.FillHover.BorderColor :=  $00F2E1D5;
    ...
    tsOffice2019Gray:
      begin
        ...
        DefaultMenuContentFill.Color := $00B8BBBE;
        DefaultMenuContentFill.ColorTo := clNone;
        DefaultMenuContentFill.BorderColor := clNone;


        DefaultSectionItemAppearance.FillDisabled.Color := $00B8BBBE;
        DefaultSectionItemAppearance.FillDisabled.ColorTo := clNone;
        DefaultSectionItemAppearance.FillDisabled.ColorMirror := clNone;
        DefaultSectionItemAppearance.FillDisabled.ColorMirrorTo := clNone;
        DefaultSectionItemAppearance.FillDisabled.BorderColor := $D4D4D4;
        ...
        DefaultSectionItemAppearance.FillSelected.Color := $00969696;
        DefaultSectionItemAppearance.FillSelected.ColorTo := clNone;
        DefaultSectionItemAppearance.FillSelected.ColorMirror := clNone;
        DefaultSectionItemAppearance.FillSelected.ColorMirrorTo := clNone;
        DefaultSectionItemAppearance.FillSelected.BorderColor := $00969696;
        DefaultSectionItemAppearance.FillSelected.GradientMirrorType := gtNone;
        DefaultSectionItemAppearance.FillSelected.Glow:= gmNone;
        DefaultSectionItemAppearance.FillSelected.GlowGradientColor:= clNone;

        DefaultSectionItemAppearance.FillHover.Color := $00666666;
        DefaultSectionItemAppearance.FillHover.ColorTo := $00666666;
        DefaultSectionItemAppearance.FillHover.ColorMirror := clNone;
        DefaultSectionItemAppearance.FillHover.ColorMirrorTo := clNone;
        DefaultSectionItemAppearance.FillHover.BorderColor :=  $00666666;
        DefaultSectionItemAppearance.FillHover.GradientMirrorType := gtNone;
    ...
    tsOffice2019Black:
      begin
        ...
        DefaultMenuContentFill.Color := $00303132;
        DefaultMenuContentFill.ColorTo := clNone;
        DefaultMenuContentFill.BorderColor := clNone;

        DefaultSectionItemAppearance.FillDisabled.Color := $00303132;
        DefaultSectionItemAppearance.FillDisabled.ColorTo := clNone;
        DefaultSectionItemAppearance.FillDisabled.ColorMirror := clNone;
        DefaultSectionItemAppearance.FillDisabled.ColorMirrorTo := clNone;
        DefaultSectionItemAppearance.FillDisabled.BorderColor := $D4D4D4;
        ...
        DefaultSectionItemAppearance.FillSelected.Color := $00828282;
        DefaultSectionItemAppearance.FillSelected.ColorTo := clNone;
        DefaultSectionItemAppearance.FillSelected.ColorMirror := clNone;
        DefaultSectionItemAppearance.FillSelected.ColorMirrorTo := clNone;
        DefaultSectionItemAppearance.FillSelected.BorderColor := $00828282;
        DefaultSectionItemAppearance.FillSelected.GradientMirrorType := gtNone;
        DefaultSectionItemAppearance.FillSelected.Glow:= gmNone;
        DefaultSectionItemAppearance.FillSelected.GlowGradientColor:= clNone;

        DefaultSectionItemAppearance.FillHover.Color := $00686868;
        DefaultSectionItemAppearance.FillHover.ColorTo := $00686868;
        DefaultSectionItemAppearance.FillHover.ColorMirror := clNone;
        DefaultSectionItemAppearance.FillHover.ColorMirrorTo := clNone;
        DefaultSectionItemAppearance.FillHover.BorderColor :=  $00686868;
        DefaultSectionItemAppearance.FillHover.GradientMirrorType := gtNone;
      end;
  ...
  case AStyle of
    ...
    tsOffice2019White:
      begin
        DefaultMenuTearOffFill.Color := $00FAECE3;
        DefaultMenuTearOffFill.ColorTo := clNone;
        DefaultMenuTearOffFill.BorderColor := clNone;
      end;
    tsOffice2019Gray:
      begin
        DefaultMenuTearOffFill.Color := $00939597;
        DefaultMenuTearOffFill.ColorTo := clNone;
        DefaultMenuTearOffFill.BorderColor := clNone;
      end;
    tsOffice2019Black:
      begin
        DefaultMenuTearOffFill.Color := $00444648;
        DefaultMenuTearOffFill.ColorTo := clNone;
        DefaultMenuTearOffFill.BorderColor := clNone;
      end;
...
procedure TAdvSmoothMegaMenu.SetImageList(const Value: TCustomImageList);
begin
...
procedure TAdvSmoothMegaMenu.SetUIStyle(const Value: TTMSStyle);
begin
...
begin
  ...
  if (Fstyle = tsCustom) and (TempStyleInt <> 0) then
    Fstyle := tsCustom;  //For compiler warning TempStyleInt not used;
end;
...
procedure TAdvSmoothMegaMenuItemForm.DoTimer(Sender: TObject);
begin
