...
begin
  ...
  case AStyle of
    tsOffice2019White:
    begin
      CalcButtonAppearance.BorderColor := $00ABABAB;
      CalcButtonAppearance.BorderColorHot := $00F2E1D5;
      CalcButtonAppearance.BorderColorDown := $00F2E1D5;
      CalcButtonAppearance.BorderColorChecked := $00F2E1D5;
      CalcButtonAppearance.Color :=  clWhite;
      CalcButtonAppearance.ColorTo := clWhite;
      CalcButtonAppearance.ColorDown := $00E3BDA3;
      CalcButtonAppearance.ColorDownTo := $00E3BDA3;
      CalcButtonAppearance.ColorHot := $00F2E1D5;
      CalcButtonAppearance.ColorHotTo := $00F2E1D5;
      CalcButtonAppearance.ColorChecked := $00F2E1D5;
      CalcButtonAppearance.ColorCheckedTo := $00F2E1D5;
      CalcButtonAppearance.ColorDisabled := $00D4D4D4;
      CalcButtonAppearance.ColorDisabledTo := $00D4D4D4;
      CalcButtonAppearance.GlowColorHot := clWhite;
      CalcButtonAppearance.GlowColorDown := clNone;
      CalcButtonAppearance.Font.Color := $00444648;
      CalcButtonAppearance.TextColor := $00444648;
      CalcButtonAppearance.SpecialTextColor := $00B0784A;
      CalcButtonAppearance.ShineColor := clNone;
    end;
    tsOffice2019Gray:
    begin
      CalcButtonAppearance.BorderColor := $00808080;
      CalcButtonAppearance.BorderColorHot := $00969696;
      CalcButtonAppearance.BorderColorDown := $00969696;
      CalcButtonAppearance.BorderColorChecked := $00969696;
      CalcButtonAppearance.Color :=  $00D4D4D4;
      CalcButtonAppearance.ColorTo := $00D4D4D4;
      CalcButtonAppearance.ColorDown := $00666666;
      CalcButtonAppearance.ColorDownTo := $00666666;
      CalcButtonAppearance.ColorHot := $00969696;
      CalcButtonAppearance.ColorHotTo := $00969696;
      CalcButtonAppearance.ColorChecked := $00969696;
      CalcButtonAppearance.ColorCheckedTo := $00969696;
      CalcButtonAppearance.ColorDisabled := $004D4D4D;
      CalcButtonAppearance.ColorDisabledTo := $004D4D4D;
      CalcButtonAppearance.GlowColorHot := $00B8BBBE;
      CalcButtonAppearance.GlowColorDown := clNone;
      CalcButtonAppearance.Font.Color := clWhite;
      CalcButtonAppearance.TextColor := $00232425;
      CalcButtonAppearance.SpecialTextColor := $001E1F20;
      CalcButtonAppearance.ShineColor := clNone;
    end;
    tsOffice2019Black:
    begin
      CalcButtonAppearance.BorderColor := $00686868;
      CalcButtonAppearance.BorderColorHot := $00B5B5B5;
      CalcButtonAppearance.BorderColorDown := $00B5B5B5;
      CalcButtonAppearance.BorderColorChecked := $00B5B5B5;
      CalcButtonAppearance.Color :=  $00444444;
      CalcButtonAppearance.ColorTo := $00444444;
      CalcButtonAppearance.ColorDown := $00828282;
      CalcButtonAppearance.ColorDownTo := $00828282;
      CalcButtonAppearance.ColorHot := $00686868;
      CalcButtonAppearance.ColorHotTo := $00686868;
      CalcButtonAppearance.ColorChecked := $00505050;
      CalcButtonAppearance.ColorCheckedTo := $00505050;
      CalcButtonAppearance.ColorDisabled := $00D4D4D4;
      CalcButtonAppearance.ColorDisabledTo := $00D4D4D4;
      CalcButtonAppearance.GlowColorHot := $003B3B3B;
      CalcButtonAppearance.GlowColorDown := clNone;
      CalcButtonAppearance.Font.Color := clWhite;
      CalcButtonAppearance.TextColor := $00F1F1F1;
      CalcButtonAppearance.SpecialTextColor := clWhite;
      CalcButtonAppearance.ShineColor := clNone;
    end;
    else
    begin
      ...
      CalcButtonAppearance.TextColor := clBlack;
      CalcButtonAppearance.SpecialTextColor := clMaroon;
      CalcButtonAppearance.ShineColor := clWhite;

      if AStyle in [tsOffice2010Black, tsOffice2010Silver, tsOffice2010Blue] then
      begin
