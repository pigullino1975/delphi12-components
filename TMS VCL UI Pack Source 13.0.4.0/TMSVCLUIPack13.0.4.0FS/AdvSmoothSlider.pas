...
const
  ...
  // v1.5.1.2 : Fixed : Empty On and Off caption wasn't applied in runtime
  //          : Improved : On creation check for enabeld AdvFormStyler
  ...
  case AStyle of
    ...
    tsTerminal:
      ...
      begin
        ...
        ButtonAppearance.Fill.Color := clWhite;
        ButtonAppearance.Fill.ColorTo := clWhite;
        ButtonAppearance.Fill.BorderColor := $00ABABAB;

        AppearanceOff.Fill.Color := $00F2E1D5;
        AppearanceOff.Fill.ColorTo := $00F2E1D5;
        AppearanceOff.Fill.ColorMirror := clNone;
        AppearanceOff.Fill.ColorMirrorTo := clNone;
        AppearanceOff.Fill.BorderColor := $00F2E1D5;
        AppearanceOff.Fill.GradientMirrorType := gtNone;

        AppearanceOn.Fill.Color := $00E3BDA3;
        AppearanceOn.Fill.ColorTo := $00E3BDA3;
        AppearanceOn.Fill.ColorMirror := clNone;
        AppearanceOn.Fill.ColorMirrorTo := clNone;
        AppearanceOn.Fill.BorderColor := $00E3BDA3;
        AppearanceOn.Fill.GradientMirrorType := gtNone;
      end;
      tsOffice2019Gray:
      begin
        Fill.Rounding := 0;
        ...
        ButtonAppearance.Fill.Color := $00D4D4D4;
        ButtonAppearance.Fill.ColorTo := $00D4D4D4;
        ButtonAppearance.Fill.BorderColor := $00808080;

        AppearanceOff.Fill.Color := $00969696;
        AppearanceOff.Fill.ColorTo := $00969696;
        AppearanceOff.Fill.ColorMirror := clNone;
        AppearanceOff.Fill.ColorMirrorTo := clNone;
        AppearanceOff.Fill.BorderColor := $00969696;
        AppearanceOff.Fill.GradientMirrorType := gtNone;

        AppearanceOn.Fill.Color := $00666666;
        AppearanceOn.Fill.ColorTo := $00666666;
        AppearanceOn.Fill.ColorMirror := clNone;
        AppearanceOn.Fill.ColorMirrorTo := clNone;
        AppearanceOn.Fill.BorderColor := $00666666;
        AppearanceOn.Fill.GradientMirrorType := gtNone;
      end;
      tsOffice2019Black:
      begin
        ...
        ButtonAppearance.Fill.Color := $00444444;
        ButtonAppearance.Fill.ColorTo := $00444444;
        ButtonAppearance.Fill.BorderColor := $00686868;

        AppearanceOff.Fill.Color := $00686868;
        AppearanceOff.Fill.ColorTo := $00686868;
        AppearanceOff.Fill.ColorMirror := clNone;
        AppearanceOff.Fill.ColorMirrorTo := clNone;
        AppearanceOff.Fill.BorderColor := $00686868;
        AppearanceOff.Fill.GradientMirrorType := gtNone;

        AppearanceOn.Fill.Color := $00828282;
        AppearanceOn.Fill.ColorTo := $00828282;
        AppearanceOn.Fill.ColorMirror := clNone;
        AppearanceOn.Fill.ColorMirrorTo := clNone;
        AppearanceOn.Fill.BorderColor := $00828282;
        AppearanceOn.Fill.GradientMirrorType := gtNone;
...
procedure TAdvSmoothSlider.SetUIStyle(const Value: TTMSStyle);
begin
