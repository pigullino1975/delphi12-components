...
begin
  ...
  tsOffice2019White:
    begin
      ...
      ThumbNailHolderFill.Color := clWhite;
      ThumbNailHolderFill.ColorTo := clNone;
      ThumbNailHolderFill.BorderColor := clWhite;
      ThumbNailHolderFill.Glow := gmNone;

      ThumbNailSelectedFill.Color := $00F2E1D5;
      ThumbNailSelectedFill.ColorTo := clNone;
      ThumbNailSelectedFill.ColorMirror := clNone;
      ThumbNailSelectedFill.ColorMirrorTo := clNone;
      ThumbNailSelectedFill.BorderColor := $00F2E1D5;
      ThumbNailSelectedFill.GradientMirrorType := gtNone;
      ThumbNailSelectedFill.Rounding:= 0;
      ThumbNailSelectedFill.Glow:= gmNone;
    end;
  tsOffice2019Gray:
    begin
      ...
      ThumbNailHolderFill.Color := $00303132;
      ThumbNailHolderFill.ColorTo := clNone;
      ThumbNailHolderFill.BorderColor := $00303132;
      ThumbNailHolderFill.Glow := gmNone;

      ThumbNailSelectedFill.Color := $00969696;
      ThumbNailSelectedFill.ColorTo := clNone;
      ThumbNailSelectedFill.ColorMirror := clNone;
      ThumbNailSelectedFill.ColorMirrorTo := clNone;
      ThumbNailSelectedFill.BorderColor := $00969696;
      ThumbNailSelectedFill.GradientMirrorType := gtNone;
      ThumbNailSelectedFill.Rounding:= 0;
      ThumbNailSelectedFill.Glow:= gmNone;
    end;
  tsOffice2019Black:
    begin
      ...
      ThumbNailHolderFill.Color := $00303132; //$363636;
      ThumbNailHolderFill.ColorTo := clNone;
      ThumbNailHolderFill.BorderColor := $00303132;
      ThumbNailHolderFill.Glow := gmNone;

      ThumbNailSelectedFill.Color := $00505050;
      ThumbNailSelectedFill.ColorTo := clNone;
      ThumbNailSelectedFill.ColorMirror := clNone;
      ThumbNailSelectedFill.ColorMirrorTo := clNone;
      ThumbNailSelectedFill.BorderColor := $00505050;
      ThumbNailSelectedFill.GradientMirrorType := gtNone;
      ThumbNailSelectedFill.Rounding:= 0;
      ThumbNailSelectedFill.Glow:= gmNone;
    end;
...
procedure TAdvSmoothSlideShow.SetUIStyle(const Value: TTMSStyle);
begin
