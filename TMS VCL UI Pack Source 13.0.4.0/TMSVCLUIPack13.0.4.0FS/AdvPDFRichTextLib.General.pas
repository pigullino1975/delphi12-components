...
procedure RegisterPDFRichTextLibService;
begin
  if not TAdvPDFLibPlatformServices.Current.SupportsPlatformService(IAdvPDFRichTextLibService, IInterface(PDFRichTextLibService)) then
  begin
    PDFRichTextLibService := TAdvGeneralPDFRichTextLibService.Create;
    TAdvPDFLibPlatformServices.Current.AddPlatformService(IAdvPDFRichTextLibService, PDFRichTextLibService);
  end;
end;

procedure UnregisterPDFRichTextLibService;
begin
  TAdvPDFLibPlatformServices.Current.RemovePlatformService(IAdvPDFRichTextLibService);
end;
