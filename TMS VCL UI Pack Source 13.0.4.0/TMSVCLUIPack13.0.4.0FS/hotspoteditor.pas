...
procedure TfrmHSIEditor.SpeedButton2Click(Sender: TObject);
begin
  if OpenDialog1.Execute then
  begin
    FHotSpots.LoadFromFile(OpenDialog1.FileName);
  end;
end;

procedure TfrmHSIEditor.SpeedButton3Click(Sender: TObject);
begin
  if SaveDialog1.Execute then
  begin
    FHotSpots.SaveToFile(SaveDialog1.FileName);
  end;
end;
