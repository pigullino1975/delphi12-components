...
uses
  ...
  Graphics, Forms, PictureContainer, AdvStyleIF, ImgList;
...
const
  ...
  // 3.2.2.0 : New : Exposed popup menu access
  // 3.2.2.1 : Fixed : DefaultItem color initialization issue
...
type
  TCustomPlannerEx = class(TCustomPlanner);
...
begin
  ...
  TCustomPlannerEx(Result).WaitListDesign := not FDesignCreate;
  Result.UIStyle := tsCustom;
end;
...
function TPlannerWaitList.GetImages: TCustomImageList;
begin
...
procedure TPlannerWaitList.SetImages(const Value: TCustomImageList);
begin
