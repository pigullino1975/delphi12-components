  ...
  case AStyle of
     tsOffice2019Black:
      begin
        ...
        ColorFrom := $00505050;
        ColorTo := $00505050;
        ColorMirrorFrom := $00505050;
        ColorMirrorTo := $00505050;
      end;
   tsOffice2019Gray:
      begin
        BorderColor := $00969696;
        ColorFrom := $00969696;
        ColorTo := $00969696;
        ColorMirrorFrom := $00969696;
        ColorMirrorTo := $00969696;
      end;
   tsOffice2019White:
      begin
        BorderColor := $00F2E1D5;
        ColorFrom := $00F2E1D5;
        ColorTo := $00F2E1D5;
        ColorMirrorFrom := $00F2E1D5;
        ColorMirrorTo := $00F2E1D5;
      end;
   tsOffice2016Black:
      begin
        BorderColor := $6A6A6A;
