  ...
  case AStyle of
    ...
    tsTerminal:
      ...
      begin
        ...
        SelectionTextColor := $003B3B3B;
      end;
      tsOffice2019Gray:
      begin
        FixedLineColor := $00999999;
        LineColor := $00D4D4D4;
        HeaderColor := $00232425;
        HeaderColorTo := clNone;
        SelectionColor := $00969696;
        SelectionColorTo := $00969696;
        HeaderFont.Color := $F0F0F0;
        SelectionTextColor := $00232425;
      end;
      tsOffice2019Black:
      begin
        FixedLineColor := $00999999;
...
begin
  ...
  FOldRow := Row;
  {$IFDEF DELPHIXE6_LVL}
  if not CheckVCLStylesEnabled(StyleServices, (csDesigning in ComponentState)) then
    StyleElements := [];
  {$ENDIF}
end;
