...
const
  ...
  // v1.5.1.0 : Fixed : VCL styles check updated to work in 10.4 Sydney
  // v1.5.2.0 : New : OnScrollChanged event added
  // v1.5.2.1 : Fixed : Isuse with DPI scale initialization
...
type
  ...
  protected
    ...
    procedure DoScrollChanged; virtual;
...
uses
  CommCtrl, AdvStyleIF, Shellapi, AdvHTML
  {$IFDEF DELPHIXE2_LVL}
  ,VCL.Themes
  {$ENDIF}
  ;
...
procedure THTMLStaticText.DoScrollChanged;
begin
  if Assigned(OnScrollChanged) then
