...
unit ATBWizard2019Reg;

interface

uses
  ATBWizard2019, Classes, DesignIntf, ToolsAPI, DesignEditors;
...
procedure Register;
begin
  RegisterPackageWizard(TATBFrmWizard2019.Create);
  RegisterPackageWizard(TATBApplicationWizard2019.Create);
end;
