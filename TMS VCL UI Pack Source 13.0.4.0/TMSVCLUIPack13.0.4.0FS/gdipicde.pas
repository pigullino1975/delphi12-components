...
begin
  ...
  OpenDialog.Filter := 'All (*.jpg;*.jpeg;*.gif;*.bmp;*.png;*.tiff;*.tif;*.svg)'+
  '|*.jpg;*.jpeg;*.gif;*.bmp;*.png;*.tiff;*.tif;*.svg|JPEG Image File (*.jpg)|*.jpg|JPEG Image File (*.jpeg)|*.jpeg|GIF files (*.gif)|*.gif|Bitmaps (*.bmp)|*.bmp|PNG files (*.png)|*.png|TIFF files (*.tiff)|*.tiff;*.tif|Scalable Vector Graphics (*.svg)|*.svg';
