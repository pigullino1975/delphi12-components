...
uses
  Classes, AdvTypes, AdvGraphicsTypes,
  PictureContainer, AdvTreeViewBase
  {$IFNDEF LCLLIB}
  {$IFNDEF WEBLIB}
...
type
  ...
  TAdvArrayTRectF = array of TRectF;
  TAdvArrayBoolean = array of Boolean;
  ...
  private
    ...
    FExtended: Boolean;
    FExtraRects: TAdvArrayTRectF;
    FTitleRects: TAdvArrayTRectF;
    FTitleHeight: Double;
    FTitleExtraRects: TAdvArrayTRectF;
  ...
  public
    ...
    property ExtraRects: TAdvArrayTRectF read FExtraRects;
    property TextRects: TAdvArrayTRectF read FTextRects;
    property TitleRects: TAdvArrayTRectF read FTitleRects;
    property TitleExtraRects: TAdvArrayTRectF read FTitleExtraRects;
    ...
    procedure CopyFrom(Source: TAdvTreeViewVirtualNode); virtual;
  ...
  {$IFDEF WEBLIB}
  TAdvTreeViewCacheItemList = class(TList)
  private
  ...
  TAdvTreeViewIntegerList = class(TList)
  private
  ...
  TAdvTreeViewFilter = class(TAdvOwnedCollection)
  {$ENDIF}
  {$IFDEF USEOWNEDCOLLECTION}
  TAdvTreeViewFilter = class({$IFDEF LCLLIB}specialize {$ENDIF}TAdvOwnedCollection<TAdvTreeViewFilterData>)
  {$ENDIF}
  private
    FOwner: TAdvTreeViewData;
    function GetItem(Index: Integer): TAdvTreeViewFilterData;
    procedure SetItem(Index: Integer; const Value: TAdvTreeViewFilterData);
  ...
  public
    ...
    property TitleVerticalTextAlign: TAdvGraphicsTextAlign read FTitleVerticalTextAlign write SetTitleVerticalTextAlign default gtaCenter;
  ...
  {$IFNDEF USEOWNEDCOLLECTION}
  TAdvTreeViewColumns = class(TAdvOwnedCollection)
  {$ENDIF}
  {$IFDEF USEOWNEDCOLLECTION}
  TAdvTreeViewColumns = class({$IFDEF LCLLIB}specialize {$ENDIF}TAdvOwnedCollection<TAdvTreeViewColumn>)
  {$ENDIF}
  private
    FTreeView: TAdvTreeViewData;
  ...
  private
    ...
    FChecked: Boolean;
    FCollapsedIcon: TAdvBitmap;
    FCollapsedIconLarge: TAdvBitmap;
    FExpandedIcon: TAdvBitmap;
    FExpandedIconLarge: TAdvBitmap;
    ...
    procedure SetCollapsedIconLarge(const Value: TAdvBitmap);
    procedure SetCollapsedIcon(const Value: TAdvBitmap);
    procedure SetExpandedIconLarge(const Value: TAdvBitmap);
    procedure SetExpandedIcon(const Value: TAdvBitmap);
  ...
  published
    ...
    property CollapsedIcon: TAdvBitmap read FCollapsedIcon write SetCollapsedIcon;
    property CollapsedIconLarge: TAdvBitmap read FCollapsedIconLarge write SetCollapsedIconLarge;
    property ExpandedIcon: TAdvBitmap read FExpandedIcon write SetExpandedIcon;
    property ExpandedIconLarge: TAdvBitmap read FExpandedIconLarge write SetExpandedIconLarge;
  ...
  {$IFNDEF USEOWNEDCOLLECTION}
  TAdvTreeViewNodeValues = class(TAdvOwnedCollection)
  {$ENDIF}
  {$IFDEF USEOWNEDCOLLECTION}
  TAdvTreeViewNodeValues = class({$IFDEF LCLLIB}specialize {$ENDIF}TAdvOwnedCollection<TAdvTreeViewNodeValue>)
  {$ENDIF}
  private
    FTreeView: TAdvTreeViewData;
    FNode: TAdvTreeViewNode;
  ...
  TAdvTreeViewNodeIcons = array of TAdvBitmap;
  ...
  public
    ...
    property ExpandedIcons[AColumn: Integer; ALarge: Boolean]: TAdvBitmap read GetExpandedIcon write SetExpandedIcon;
    property CollapsedIcons[AColumn: Integer; ALarge: Boolean]: TAdvBitmap read GetCollapsedIcon write SetCollapsedIcon;
  ...
  {$IFNDEF USEOWNEDCOLLECTION}
  TAdvTreeViewNodes = class(TAdvOwnedCollection)
  {$ENDIF}
  {$IFDEF USEOWNEDCOLLECTION}
  TAdvTreeViewNodes = class({$IFDEF LCLLIB}specialize {$ENDIF}TAdvOwnedCollection<TAdvTreeViewNode>)
  {$ENDIF}
  private
    FTreeView: TAdvTreeViewData;
    FNode: TAdvTreeViewNode;
  ...
  {$IFNDEF USEOWNEDCOLLECTION}
  TAdvTreeViewGroups = class(TAdvOwnedCollection)
  {$ENDIF}
  {$IFDEF USEOWNEDCOLLECTION}
  TAdvTreeViewGroups = class({$IFDEF LCLLIB}specialize {$ENDIF}TAdvOwnedCollection<TAdvTreeViewGroup>)
  {$ENDIF}
  private
    FTreeView: TAdvTreeViewData;
  ...
  {$IFDEF WEBLIB}
  TAdvTreeViewNodeStructure = class(TObjectList)
  private
  ...
  TAdvTreeViewVisibleNodes = class(TList)
  private
    function GetItem(Index: Integer): TAdvTreeViewVirtualNode;
    procedure SetItem(Index: Integer; const Value: TAdvTreeViewVirtualNode);
  public
  ...
  {$IFDEF WEBLIB}
  TAdvTreeViewDisplayGroups = class(TList)
  private
    function GetItem(Index: Integer): TAdvTreeViewDisplayGroup;
    procedure SetItem(Index: Integer; const Value: TAdvTreeViewDisplayGroup);
  public
    property Items[Index: Integer]: TAdvTreeViewDisplayGroup read GetItem write SetItem; default;
  end;
  {$ENDIF}
  {$IFNDEF WEBLIB}
  ...
  {$IFDEF FNCLIB}
  TAdvTreeViewData = class(TAdvTreeViewBase, IAdvPictureContainer)
  {$ENDIF}
  {$IFNDEF FNCLIB}
  ...
  private
    ...
    FSortMode: TAdvTreeViewNodesSortMode;
  ...
  protected
    ...
    procedure DoGetColumnTrimming({%H-}AColumn: Integer; {%H-}AKind: TAdvTreeViewCacheItemKind; var {%H-}ATrimming: TAdvGraphicsTextTrimming); virtual;
    procedure DoGetColumnHorizontalTextAlign({%H-}AColumn: Integer; {%H-}AKind: TAdvTreeViewCacheItemKind; var {%H-}AHorizontalTextAlign: TAdvGraphicsTextAlign); virtual;
    procedure DoGetColumnVerticalTextAlign({%H-}AColumn: Integer; {%H-}AKind: TAdvTreeViewCacheItemKind; var {%H-}AVerticalTextAlign: TAdvGraphicsTextAlign); virtual;
    procedure DoGetColumnWordWrapping({%H-}AColumn: Integer; {%H-}AKind: TAdvTreeViewCacheItemKind; var {%H-}AWordWrapping: Boolean); virtual;
    procedure DoGetNodeSides({%H-}ANode: TAdvTreeViewVirtualNode; var {%H-}ASides: TAdvGraphicsSides); virtual;
    procedure DoGetNodeText({%H-}ANode: TAdvTreeViewVirtualNode; {%H-}AColumn: Integer; {%H-}AMode: TAdvTreeViewNodeTextMode; var {%H-}AText: String); virtual;
    procedure DoGetNodeData(ANode: TAdvTreeViewVirtualNode); virtual;
    procedure DoGetNodeTitle({%H-}ANode: TAdvTreeViewVirtualNode; {%H-}AColumn: Integer; {%H-}AMode: TAdvTreeViewNodeTextMode; var {%H-}ATitle: String); virtual;
    procedure DoGetNodeTitleExpanded({%H-}ANode: TAdvTreeViewVirtualNode; {%H-}AColumn: Integer; var {%H-}AExpanded: Boolean); virtual;
    procedure DoGetNodeTrimming({%H-}ANode: TAdvTreeViewVirtualNode; {%H-}AColumn: Integer; var {%H-}ATrimming: TAdvGraphicsTextTrimming); virtual;
    procedure DoGetNodeHorizontalTextAlign({%H-}ANode: TAdvTreeViewVirtualNode; {%H-}AColumn: Integer; var {%H-}AHorizontalTextAlign: TAdvGraphicsTextAlign); virtual;
    procedure DoGetNodeVerticalTextAlign({%H-}ANode: TAdvTreeViewVirtualNode; {%H-}AColumn: Integer; var {%H-}AVerticalTextAlign: TAdvGraphicsTextAlign); virtual;
    procedure DoGetNodeWordWrapping({%H-}ANode: TAdvTreeViewVirtualNode; {%H-}AColumn: Integer; var {%H-}AWordWrapping: Boolean); virtual;
    procedure DoGetNodeTitleTrimming({%H-}ANode: TAdvTreeViewVirtualNode; {%H-}AColumn: Integer; var {%H-}ATrimming: TAdvGraphicsTextTrimming); virtual;
    procedure DoGetNodeTitleHorizontalTextAlign({%H-}ANode: TAdvTreeViewVirtualNode; {%H-}AColumn: Integer; var {%H-}AHorizontalTextAlign: TAdvGraphicsTextAlign); virtual;
    procedure DoGetNodeTitleVerticalTextAlign({%H-}ANode: TAdvTreeViewVirtualNode; {%H-}AColumn: Integer; var {%H-}AVerticalTextAlign: TAdvGraphicsTextAlign); virtual;
    procedure DoGetNodeTitleWordWrapping({%H-}ANode: TAdvTreeViewVirtualNode; {%H-}AColumn: Integer; var {%H-}AWordWrapping: Boolean); virtual;
    procedure DoGetNodeExtraSize({%H-}ANode: TAdvTreeViewVirtualNode; {%H-}AColumn: Integer; var {%H-}AExtraSize: Single); virtual;
    procedure DoGetNodeTitleExtraSize({%H-}ANode: TAdvTreeViewVirtualNode; {%H-}AColumn: Integer; var {%H-}ATitleExtraSize: Single); virtual;
    procedure DoGetNodeCheckType({%H-}ANode: TAdvTreeViewVirtualNode; {%H-}AColumn: Integer; var {%H-}ACheckType: TAdvTreeViewNodeCheckType); virtual;
    procedure DoGetNodeIcon({%H-}ANode: TAdvTreeViewVirtualNode; {%H-}AColumn: Integer; {%H-}ALarge: Boolean; var {%H-}AIcon: TAdvBitmap); virtual;
    procedure DoGetNodeIconSize({%H-}ANode: TAdvTreeViewVirtualNode; {%H-}AColumn: Integer; {%H-}ALarge: Boolean; {%H-}AIcon: TAdvBitmap; var {%H-}AIconWidth: Double; var {%H-}AIconHeight: Double); virtual;
    procedure DoGetNodeSelectedColor({%H-}ANode: TAdvTreeViewVirtualNode; var {%H-}AColor: TAdvGraphicsColor); virtual;
    procedure DoGetNodeDisabledColor({%H-}ANode: TAdvTreeViewVirtualNode; var {%H-}AColor: TAdvGraphicsColor); virtual;
    procedure DoGetNodeColor({%H-}ANode: TAdvTreeViewVirtualNode; var {%H-}AColor: TAdvGraphicsColor); virtual;
    procedure DoGetNodeSelectedTextColor({%H-}ANode: TAdvTreeViewVirtualNode; {%H-}AColumn: Integer; var {%H-}ATextColor: TAdvGraphicsColor); virtual;
    procedure DoGetNodeDisabledTextColor({%H-}ANode: TAdvTreeViewVirtualNode; {%H-}AColumn: Integer; var {%H-}ATextColor: TAdvGraphicsColor); virtual;
    procedure DoGetNodeSelectedTitleColor({%H-}ANode: TAdvTreeViewVirtualNode; {%H-}AColumn: Integer; var {%H-}ATitleColor: TAdvGraphicsColor); virtual;
    procedure DoGetNodeDisabledTitleColor({%H-}ANode: TAdvTreeViewVirtualNode; {%H-}AColumn: Integer; var {%H-}ATitleColor: TAdvGraphicsColor); virtual;
    procedure DoGetNodeTextColor({%H-}ANode: TAdvTreeViewVirtualNode; {%H-}AColumn: Integer; var {%H-}ATextColor: TAdvGraphicsColor); virtual;
    procedure DoGetNodeTitleColor({%H-}ANode: TAdvTreeViewVirtualNode; {%H-}AColumn: Integer; var {%H-}ATitleColor: TAdvGraphicsColor); virtual;
    procedure DoIsNodeExpanded({%H-}ANode: TAdvTreeViewVirtualNode; var {%H-}AExpanded: Boolean); virtual;
    procedure DoIsNodeExtended({%H-}ANode: TAdvTreeViewVirtualNode; var {%H-}AExtended: Boolean); virtual;
    procedure DoIsNodeChecked({%H-}ANode: TAdvTreeViewVirtualNode; {%H-}AColumn: Integer; var {%H-}AChecked: Boolean); virtual;
    procedure DoIsNodeVisible({%H-}ANode: TAdvTreeViewVirtualNode; var {%H-}AVisible: Boolean); virtual;
    procedure DoIsNodeEnabled({%H-}ANode: TAdvTreeViewVirtualNode; var {%H-}AEnabled: Boolean); virtual;
    procedure DoNodeCompare({%H-}ANode1, {%H-}ANode2: TAdvTreeViewNode; {%H-}AColumn: Integer; var {%H-}ACompareResult: Integer); virtual;
    procedure DoGetHTMLTemplateValue(ANodeValue: TAdvTreeViewNodeValue; AName: string; var AValue: string); virtual;
    procedure DoGetHTMLTemplate(ANodeValue: TAdvTreeViewNodeValue; AColumnIndex: Integer; var AHTMLTemplate: string); virtual;
    ...
    procedure UpdateCheckState({%H-}ANode: TAdvTreeViewVirtualNode; {%H-}AColumn: Integer; {%H-}AChecked: Boolean); virtual;
    ...
    procedure ClearFocusedNode(ANode: TAdvTreeViewVirtualNode); virtual; abstract;
    ...
    function GetNodesSpacing: Single; virtual;
    function GetVisibleNodeForIndex(AIndex: Integer): TAdvTreeViewVirtualNode; virtual;
    ...
    procedure UpdateNodeTitleHeight(ANode: TAdvTreeViewVirtualNode; AHeight: Double); virtual;
    ...
    procedure UpdateNodeTitleRects(ANode: TAdvTreeViewVirtualNode; ATitleRects: TAdvArrayTRectF); virtual;
    procedure UpdateNodeExtraRects(ANode: TAdvTreeViewVirtualNode; AExtraRects: TAdvArrayTRectF); virtual;
    procedure UpdateNodeTitleExtraRects(ANode: TAdvTreeViewVirtualNode; ATitleExtraRects: TAdvArrayTRectF); virtual;
    ...
    procedure CustomizeScrollPosition({%H-}ANode: TAdvTreeViewVirtualNode; var {%H-}APosition, {%H-}ATopPosition: Double); virtual;
    function HTMLReplace(AValue: string; ANodeValue: TAdvTreeViewNodeValue): string;
  ...
  public
    ...
    procedure AddNodeToSelection(ANode: TAdvTreeViewVirtualNode); virtual; abstract;
    ...
    procedure ScrollToNode(ANode: TAdvTreeViewNode; AScrollIfNotVisible: Boolean = False; AScrollPosition: TAdvTreeViewNodeScrollPosition = tvnspTop; AForceScroll: Boolean = False); virtual;
    procedure ScrollToVirtualNode(ANode: TAdvTreeViewVirtualNode; AScrollIfNotVisible: Boolean = False; AScrollPosition: TAdvTreeViewNodeScrollPosition = tvnspTop; AForceScroll: Boolean = False); virtual;
    procedure ScrollToVirtualNodeInternal(ANode: TAdvTreeViewVirtualNode; AScrollIfNotVisible: Boolean = False; AScrollPosition: TAdvTreeViewNodeScrollPosition = tvnspTop; AForceScroll: Boolean = False); virtual;
    procedure ScrollToVirtualNodeRow(ARow: Integer; AScrollIfNotVisible: Boolean = False; AScrollPosition: TAdvTreeViewNodeScrollPosition = tvnspTop; AForceScroll: Boolean = False); virtual;
    ...
    function GetNodeTitle(ANode: TAdvTreeViewNode; AColumn: Integer): string; virtual;
    function GetVirtualNodeTitle(ANode: TAdvTreeViewVirtualNode; AColumn: Integer): string; virtual;
    function GetVirtualNodeTitleExpanded(ANode: TAdvTreeViewVirtualNode; AColumn: Integer): Boolean; virtual;
    ...
    function GetPreviousChildVirtualNode({%H-}ANode: TAdvTreeViewVirtualNode; AStartNode: TAdvTreeViewVirtualNode): TAdvTreeViewVirtualNode; virtual;
    function GetNextChildVirtualNode({%H-}ANode: TAdvTreeViewVirtualNode; AStartNode: TAdvTreeViewVirtualNode): TAdvTreeViewVirtualNode; virtual;
    function GetNextSiblingVirtualNode({%H-}ANode: TAdvTreeViewVirtualNode): TAdvTreeViewVirtualNode; virtual;
    function GetPreviousSiblingVirtualNode({%H-}ANode: TAdvTreeViewVirtualNode): TAdvTreeViewVirtualNode; virtual;
    function GetFirstChildVirtualNode({%H-}ANode: TAdvTreeViewVirtualNode): TAdvTreeViewVirtualNode; virtual;
    function GetLastChildVirtualNode({%H-}ANode: TAdvTreeViewVirtualNode): TAdvTreeViewVirtualNode; virtual;
    ...
    property SortMode: TAdvTreeViewNodesSortMode read FSortMode;
  end;
...
uses
  SysUtils, Math, AdvUtils, Graphics
  {$IFDEF FMXLIB}
  , FMX.Types
  {$ENDIF}
  {$IFDEF VCLLIB}
...
procedure TAdvTreeViewData.CopyNode(ANode,
...
function TAdvTreeViewData.GetNodesSpacing: Single;
begin
  Result := 0;
end;
...
function TAdvTreeViewData.GetNodeTitle(ANode: TAdvTreeViewNode;
  AColumn: Integer): string;
begin
...
procedure TAdvTreeViewData.CustomizeScrollPosition(
...
procedure TAdvTreeViewData.DoGetColumnHorizontalTextAlign(AColumn: Integer; AKind: TAdvTreeViewCacheItemKind; var AHorizontalTextAlign: TAdvGraphicsTextAlign);
begin

end;

procedure TAdvTreeViewData.DoGetColumnTrimming(AColumn: Integer; AKind: TAdvTreeViewCacheItemKind; var ATrimming: TAdvGraphicsTextTrimming);
begin

end;

procedure TAdvTreeViewData.DoGetColumnVerticalTextAlign(AColumn: Integer; AKind: TAdvTreeViewCacheItemKind; var AVerticalTextAlign: TAdvGraphicsTextAlign);
begin
...
procedure TAdvTreeViewData.DoGetHTMLTemplate(ANodeValue: TAdvTreeViewNodeValue; AColumnIndex: Integer; var AHTMLTemplate: string);
begin

end;

procedure TAdvTreeViewData.DoGetHTMLTemplateValue(ANodeValue: TAdvTreeViewNodeValue; AName: string; var AValue: string);
begin
...
procedure TAdvTreeViewData.DoGetNodeColor(ANode: TAdvTreeViewVirtualNode; var AColor: TAdvGraphicsColor);
begin

end;

procedure TAdvTreeViewData.DoGetNodeData(ANode: TAdvTreeViewVirtualNode);
begin
...
procedure TAdvTreeViewData.DoGetNodeDisabledTitleColor(
...
procedure TAdvTreeViewData.DoGetNodeExtraSize(
  ANode: TAdvTreeViewVirtualNode; AColumn: Integer; var AExtraSize: Single);
begin

end;

procedure TAdvTreeViewData.DoGetNodeTitleExtraSize(
...
begin
  inherited;
  if (AComponent = FPictureContainer) and (Operation = opRemove) then
...
function TAdvTreeViewData.GetPictureContainer: TPictureContainer;
begin
...
function TAdvTreeViewData.GetHTMLTemplate(AColumnIndex: Integer): string;
begin
  Result := '';
end;
       ...
       begin
         ...
         begin
           if Assigned(PictureContainer) and (v.ExpandedIconLargeName <> '') then
             AIcon := TAdvBitmap(PictureContainer.FindBitmap(v.ExpandedIconLargeName));
         ...
         begin
           if Assigned(PictureContainer) and (v.ExpandedIconName <> '') then
             AIcon := TAdvBitmap(PictureContainer.FindBitmap(v.ExpandedIconName));
       ...
       begin
         ...
         begin
           if Assigned(PictureContainer) and (v.CollapsedIconLargeName <> '') then
             AIcon := TAdvBitmap(PictureContainer.FindBitmap(v.CollapsedIconLargeName));
         ...
         begin
           if Assigned(PictureContainer) and (v.CollapsedIconName <> '') then
             AIcon := TAdvBitmap(PictureContainer.FindBitmap(v.CollapsedIconName));
...
procedure TAdvTreeViewData.DoGetNodeIconSize(
  ANode: TAdvTreeViewVirtualNode; AColumn: Integer; ALarge: Boolean;
  AIcon: TAdvBitmap; var AIconWidth: Double; var AIconHeight: Double);
begin
...
procedure TAdvTreeViewData.DoGetNodeSelectedTitleColor(
  ANode: TAdvTreeViewVirtualNode; AColumn: Integer;
  var ATitleColor: TAdvGraphicsColor);
begin
...
procedure TAdvTreeViewData.DoGetNodeSides(ANode: TAdvTreeViewVirtualNode;
  var ASides: TAdvGraphicsSides);
begin
...
procedure TAdvTreeViewData.DoGetNodeTitleExpanded(ANode: TAdvTreeViewVirtualNode;
...
procedure TAdvTreeViewData.DoGetNodeTitle(ANode: TAdvTreeViewVirtualNode;
  AColumn: Integer; AMode: TAdvTreeViewNodeTextMode; var ATitle: String);
var
  it: TAdvTreeViewNode;
begin
  it := ANode.Node;
...
procedure TAdvTreeViewData.DoGetNodeTitleColor(
  ANode: TAdvTreeViewVirtualNode; AColumn: Integer;
  var ATitleColor: TAdvGraphicsColor);
begin
...
procedure TAdvTreeViewData.DoGetNodeTitleHorizontalTextAlign(
  ANode: TAdvTreeViewVirtualNode; AColumn: Integer;
  var AHorizontalTextAlign: TAdvGraphicsTextAlign);
begin
...
procedure TAdvTreeViewData.DoGetNodeTitleTrimming(
  ANode: TAdvTreeViewVirtualNode; AColumn: Integer;
...
procedure TAdvTreeViewData.DoGetNodeTitleVerticalTextAlign(
  ANode: TAdvTreeViewVirtualNode; AColumn: Integer;
...
procedure TAdvTreeViewData.DoGetNodeTitleWordWrapping(
  ANode: TAdvTreeViewVirtualNode; AColumn: Integer;
...
procedure TAdvTreeViewData.DoGetNodeTextColor(ANode: TAdvTreeViewVirtualNode; AColumn: Integer;
  var ATextColor: TAdvGraphicsColor);
begin

end;

procedure TAdvTreeViewData.DoGetNodeTrimming(ANode: TAdvTreeViewVirtualNode;
  AColumn: Integer; var ATrimming: TAdvGraphicsTextTrimming);
begin
...
function TAdvTreeViewData.GetVirtualNodeTitleExpanded(
  ANode: TAdvTreeViewVirtualNode; AColumn: Integer): Boolean;
begin
  Result := True;
  if Assigned(ANode) then
  begin
...
function TAdvTreeViewData.GetVisibleNodeForIndex(
  AIndex: Integer): TAdvTreeViewVirtualNode;
begin
  Result := nil;
...
function TAdvTreeViewData.HTMLReplace(AValue: string; ANodeValue: TAdvTreeViewNodeValue): string;
var
...
function TAdvTreeViewData.GetVirtualNodeTitle(
  ANode: TAdvTreeViewVirtualNode; AColumn: Integer): string;
begin
  Result := '';
  if Assigned(ANode) then
...
procedure TAdvTreeViewData.UpdateCheckState(
...
procedure TAdvTreeViewData.UpdateNodeExtraRects(
  ANode: TAdvTreeViewVirtualNode; AExtraRects: TAdvArrayTRectF);
begin
...
procedure TAdvTreeViewData.UpdateNodeTitleHeight(
  ANode: TAdvTreeViewVirtualNode; AHeight: Double);
begin
  ANode.FTitleHeight := AHeight;
end;

procedure TAdvTreeViewData.UpdateNodeTitleRects(
  ANode: TAdvTreeViewVirtualNode; ATitleRects: TAdvArrayTRectF);
begin
  ANode.FTitleRects := ATitleRects;
end;

procedure TAdvTreeViewData.UpdateNodeTitleExtraRects(
  ANode: TAdvTreeViewVirtualNode; ATitleExtraRects: TAdvArrayTRectF);
begin
...
procedure TAdvTreeViewData.ScrollToBottom;
begin
  {$IFDEF FMXLIB}
...
procedure TAdvTreeViewData.ScrollToNode(ANode: TAdvTreeViewNode; AScrollIfNotVisible: Boolean = False; AScrollPosition: TAdvTreeViewNodeScrollPosition = tvnspTop; AForceScroll: Boolean = False);
begin
  if Assigned(ANode) then
    ScrollToVirtualNode(ANode.VirtualNode, AScrollIfNotVisible, AScrollPosition, AForceScroll);
end;

procedure TAdvTreeViewData.ScrollToTop;
begin
  {$IFDEF FMXLIB}
...
procedure TAdvTreeViewData.ScrollToVirtualNode(
  ANode: TAdvTreeViewVirtualNode; AScrollIfNotVisible: Boolean = False; AScrollPosition: TAdvTreeViewNodeScrollPosition = tvnspTop; AForceScroll: Boolean = False);
var
  v: Single;
begin
  if not Assigned(ANode) then
...
procedure TAdvTreeViewData.ScrollToVirtualNodeInternal(ANode: TAdvTreeViewVirtualNode; AScrollIfNotVisible: Boolean = False;
  AScrollPosition: TAdvTreeViewNodeScrollPosition = tvnspTop; AForceScroll: Boolean = False);
var
  I, C: Integer;
  yp, ps: Double;
  v: TAdvTreeViewVirtualNode;
...
function TAdvTreeViewData.GetNodeForRow(
  ARow: Integer): TAdvTreeViewVirtualNode;
begin
  Result := nil;
...
procedure TAdvTreeViewData.ScrollToVirtualNodeRow(ARow: Integer;
  AScrollIfNotVisible: Boolean;
  AScrollPosition: TAdvTreeViewNodeScrollPosition; AForceScroll: Boolean);
var
  n: TAdvTreeViewVirtualNode;
begin
...
procedure TAdvTreeViewData.SetPictureContainer(
...
begin
  ...
  FBottomFill := TAdvGraphicsFill.Create(gfkNone, gcWhite);
  FBottomStroke := TAdvGraphicsStroke.Create(gskSolid, gcDarkGray);
  FTopFill := TAdvGraphicsFill.Create(gfkNone, gcWhite);
  FTopStroke := TAdvGraphicsStroke.Create(gskSolid, gcGray);
...
procedure TAdvTreeViewGroup.SetBottomFont(const Value: TAdvGraphicsFont);
begin
...
procedure TAdvTreeViewGroup.SetBottomFill(const Value: TAdvGraphicsFill);
begin
  if FBottomFill <> Value then
    FBottomFill.Assign(Value);
end;

procedure TAdvTreeViewGroup.SetTopFont(const Value: TAdvGraphicsFont);
begin
...
procedure TAdvTreeViewGroup.SetTopFill(const Value: TAdvGraphicsFill);
begin
...
procedure TAdvTreeViewNode.SetCollapsedIcon(AColumn: Integer;
  ALarge: Boolean; const Value: TAdvBitmap);
var
  v: TAdvTreeViewNodeValue;
begin
  v := GetValueForColumn(AColumn);
...
begin
  Result := TAdvUtils.HTMLStrip(Text[AColumn]);
end;
    ...
    begin
      ...
      begin
        ...
        begin
          c := TStringList.Create;
          try
            TAdvUtils.Split('|', a[K], c);
            for L := 0 to c.Count - 1 do
            begin
              s := TStringList.Create;
              try
                TAdvUtils.Split(';', c[L], s);
...
begin
  ...
  begin
    ...
    FTitleTrimming := (Source as TAdvTreeViewColumn).TitleTrimming;
    FTitleWordWrapping := (Source as TAdvTreeViewColumn).TitleWordWrapping;
    FTitleHorizontalTextAlign := (Source as TAdvTreeViewColumn).TitleHorizontalTextAlign;
    FTitleVerticalTextAlign := (Source as TAdvTreeViewColumn).TitleVerticalTextAlign;
    ...
    FDisabledTitleFontColor := (Source as TAdvTreeViewColumn).DisabledTitleFontColor;
    FSelectedTitleFontColor := (Source as TAdvTreeViewColumn).SelectedTitleFontColor;
    FTitleFont.Assign((Source as TAdvTreeViewColumn).TitleFont);
    ...
    FExpandingButtonSize := (Source as TAdvTreeViewColumn).ExpandingButtonSize;
    FHTMLTemplate := (Source as TAdvTreeViewColumn).HTMLTemplate;
  end;
end;
...
function TAdvTreeViewColumn.GetDisplayName: string;
begin
  if FName <> '' then
    Result := FName
  {$IFDEF WEBLIB}
...
function TAdvTreeViewColumn.IsExpandingButtonSizeStored: Boolean;
begin
...
procedure TAdvTreeViewColumn.SetHTMLTemplate(const Value: string);
begin
...
procedure TAdvTreeViewColumn.SetBottomFont(const Value: TAdvGraphicsFont);
begin
  if FBottomFont <> Value then
    FBottomFont.Assign(Value);
end;
...
procedure TAdvTreeViewColumn.SetDisabledTitleFontColor(
  const Value: TAdvGraphicsColor);
begin
...
procedure TAdvTreeViewColumn.SetExpandable(const Value: Boolean);
begin
...
procedure TAdvTreeViewColumn.SetExpanded(const Value: Boolean);
begin
  if FExpanded <> Value then
  begin
    FExpanded := Value;
...
procedure TAdvTreeViewColumn.SetExpandingButtonSize(const Value: Single);
begin
  FExpandingButtonSize := Value;
end;

procedure TAdvTreeViewColumn.SetBottomFill(const Value: TAdvGraphicsFill);
begin
  if FBottomFill <> Value then
    FBottomFill.Assign(Value);
end;

procedure TAdvTreeViewColumn.SetFont(const Value: TAdvGraphicsFont);
begin
  if FFont <> Value then
    FFont.Assign(Value);
end;
...
procedure TAdvTreeViewColumn.SetSelectedTitleFontColor(
  const Value: TAdvGraphicsColor);
begin
...
procedure TAdvTreeViewColumn.SetFill(const Value: TAdvGraphicsFill);
begin
  if FFill <> Value then
    FFill.Assign(Value);
end;
...
procedure TAdvTreeViewColumn.SetTopFont(const Value: TAdvGraphicsFont);
begin
  if FTopFont <> Value then
    FTopFont.Assign(Value);
end;
...
procedure TAdvTreeViewColumn.SetTopFill(const Value: TAdvGraphicsFill);
begin
  if FTopFill <> Value then
    FTopFill.Assign(Value);
end;
...
procedure TAdvTreeViewColumn.SetTitleFont(const Value: TAdvGraphicsFont);
begin
  if FTitleFont <> Value then
    FTitleFont.Assign(Value);
end;

procedure TAdvTreeViewColumn.SetTitleHorizontalTextAlign(
  const Value: TAdvGraphicsTextAlign);
begin
...
procedure TAdvTreeViewColumn.SetTitleTrimming(
...
procedure TAdvTreeViewColumn.SetTitleVerticalTextAlign(
  const Value: TAdvGraphicsTextAlign);
begin
...
procedure TAdvTreeViewColumn.SetTitleWordWrapping(const Value: Boolean);
begin
...
procedure TAdvTreeViewColumn.SetTrimming(const Value: TAdvGraphicsTextTrimming);
begin
...
function TAdvTreeViewNodeValue.GetText: string;
var
  ht: string;
  s: string;
begin
...
begin
  ...
  begin
    ...
    FTitleExpanded := (Source as TAdvTreeViewNodeValue).TitleExpanded;
    FTitle := (Source as TAdvTreeViewNodeValue).Title;
    ...
    FHTMLTemplateItems.Assign((Source as TAdvTreeViewNodeValue).HTMLTemplateItems);
    AssignData(Source);
  end;
end;
...
begin
  ...
  FTitleExpanded := True;
  FCheckType := tvntNone;
  FCollapsedIcon := TAdvBitmap.Create;
  FCollapsedIcon.OnChange := BitmapChanged;
  FExpandedIcon := TAdvBitmap.Create;
  FExpandedIcon.OnChange := BitmapChanged;

  FCollapsedIconLarge := TAdvBitmap.Create;
  FCollapsedIconLarge.OnChange := BitmapChanged;
  FExpandedIconLarge := TAdvBitmap.Create;
...
procedure TAdvTreeViewNodeValue.TemplateItemsChanged(Sender: TObject);
begin
  UpdateNodeValue;
end;
...
procedure TAdvTreeViewNodeValue.SetHTMLTemplateItems(const Value: TStringList);
begin
...
procedure TAdvTreeViewNodeValue.SetTitleExpanded(const Value: Boolean);
begin
...
procedure TAdvTreeViewNodeValue.SetCollapsedIcon(const Value: TAdvBitmap);
begin
...
procedure TAdvTreeViewNodeValue.SetCollapsedIconLarge(const Value: TAdvBitmap);
begin
...
procedure TAdvTreeViewNodeValue.SetExpandedIcon(const Value: TAdvBitmap);
begin
...
procedure TAdvTreeViewNodeValue.SetExpandedIconLarge(const Value: TAdvBitmap);
begin
...
procedure TAdvTreeViewNodeValue.SetTitle(const Value: String);
begin
...
procedure TAdvTreeViewVirtualNode.CopyFrom(
  Source: TAdvTreeViewVirtualNode);
begin
  if Assigned(Source) then
  begin
    FChildren := (Source as TAdvTreeViewVirtualNode).Children;
    FTotalChildren := (Source as TAdvTreeViewVirtualNode).TotalChildren;
    FExpanded := (Source as TAdvTreeViewVirtualNode).Expanded;
    FExtended := (Source as TAdvTreeViewVirtualNode).Extended;
    FLevel := (Source as TAdvTreeViewVirtualNode).Level;
    FRow := (Source as TAdvTreeViewVirtualNode).Row;
    FCalculated := (Source as TAdvTreeViewVirtualNode).Calculated;
    FHeight := (Source as TAdvTreeViewVirtualNode).Height;
    FParentNode := (Source as TAdvTreeViewVirtualNode).ParentNode;
    FIndex := (Source as TAdvTreeViewVirtualNode).Index;
    FTextRects := (Source as TAdvTreeViewVirtualNode).TextRects;
    FExtraRects := (Source as TAdvTreeViewVirtualNode).ExtraRects;
    FBitmapRects := (Source as TAdvTreeViewVirtualNode).BitmapRects;
    FCheckRects := (Source as TAdvTreeViewVirtualNode).CheckRects;
    FExpandRects := (Source as TAdvTreeViewVirtualNode).ExpandRects;
    FCheckStates := (Source as TAdvTreeViewVirtualNode).CheckStates;
    FNode := (Source as TAdvTreeViewVirtualNode).Node;
  end;
end;
...
function TAdvTreeViewVirtualNode.GetTitleExpanded(AColumn: Integer): Boolean;
begin
  Result := True;
  if Assigned(FTreeView) then
...
function TAdvTreeViewVirtualNode.GetTitle(AColumn: Integer): String;
begin
  Result := '';
  if Assigned(FTreeView) then
...
begin
  ...
  begin
    ...
    FButtonSize := (Source as TAdvTreeViewColumnFiltering).ButtonSize;
  end;
end;
...
function TAdvTreeViewColumnFiltering.IsButtonSizeStored: Boolean;
begin
  Result := ButtonSize <> 15;
end;

procedure TAdvTreeViewColumnFiltering.SetButtonSize(const Value: Single);
begin
...
procedure TAdvTreeViewColumnFiltering.SetEnabled(const Value: Boolean);
begin
  if FEnabled <> Value then
  begin
    FEnabled := Value;
...
begin
  inherited Create(AOwner, TAdvTreeViewFilterData);
  FOwner := AOwner;
end;
...
procedure TAdvTreeViewFilter.SetItem(Index: Integer; const Value: TAdvTreeViewFilterData);
begin
  inherited SetItem(Index, Value);
end;

{$IFDEF WEBLIB}
function TAdvTreeViewCacheItemList.GetItem(Index: Integer): TAdvTreeViewCacheItem;
begin
  Result := TAdvTreeViewCacheItem(inherited Items[Index]);
end;

procedure TAdvTreeViewCacheItemList.SetItem(Index: Integer; const Value: TAdvTreeViewCacheItem);
begin
  inherited Items[Index] := Value;
end;

function TAdvTreeViewIntegerList.GetItem(Index: Integer): Integer;
begin
  Result := Integer(inherited Items[Index]);
end;

procedure TAdvTreeViewIntegerList.SetItem(Index: Integer; const Value: Integer);
begin
  inherited Items[Index] := Value;
end;

function TAdvTreeViewNodeStructure.GetItem(Index: Integer): TAdvTreeViewVirtualNode;
begin
  Result := TAdvTreeViewVirtualNode(inherited Items[Index]);
end;

procedure TAdvTreeViewNodeStructure.SetItem(Index: Integer; const Value: TAdvTreeViewVirtualNode);
begin
  inherited Items[Index] := Value;
end;

function TAdvTreeViewVisibleNodes.GetItem(Index: Integer): TAdvTreeViewVirtualNode;
begin
  Result := TAdvTreeViewVirtualNode(inherited Items[Index]);
end;

procedure TAdvTreeViewVisibleNodes.SetItem(Index: Integer; const Value: TAdvTreeViewVirtualNode);
begin
  inherited Items[Index] := Value;
end;

function TAdvTreeViewDisplayGroups.GetItem(Index: Integer): TAdvTreeViewDisplayGroup;
begin
  Result := TAdvTreeViewDisplayGroup(inherited Items[Index]);
end;

procedure TAdvTreeViewDisplayGroups.SetItem(Index: Integer; const Value: TAdvTreeViewDisplayGroup);
begin
  inherited Items[Index] := Value;
end;
{$ENDIF}
