...
begin
  ...
  case AStyle of
    ...
    begin
      ...
      ItemAppearance.FillSelected.Color := $00E3BDA3;
      ItemAppearance.FillSelected.ColorTo := clNone;
      ItemAppearance.FillSelected.ColorMirror := clNone;
      ItemAppearance.FillSelected.ColorMirrorTo := clNone;
      ItemAppearance.FillSelected.BorderColor := $00E3BDA3;
      ItemAppearance.FillSelected.GradientMirrorType := gtVertical;

      ItemAppearance.FillHover.Color := $00F2E1D5;
      ItemAppearance.FillHover.ColorTo := clNone;
      ItemAppearance.FillHover.ColorMirror := clNone;
      ItemAppearance.FillHover.ColorMirrorTo := clNone;
      ItemAppearance.FillHover.BorderColor :=  $00F2E1D5;
      ItemAppearance.FillHover.GradientMirrorType := gtVertical;

      ItemAppearance.Font.Color := $00444648;
      ItemAppearance.FontHover.Color := $00444648;
      ItemAppearance.FontSelected.Color := $00444648;
    end;
    tsOffice2019Gray:
    begin
      ItemAppearance.FillSelected.Glow := gmNone;
      ...
      ContentFill.Color := $00B8BBBE;
      ContentFill.ColorTo := clNone;
      ContentFill.BorderColor := clNone;

      ItemAppearance.FillDisabled.Color := $00B8BBBE;
      ItemAppearance.FillDisabled.ColorTo := $00B8BBBE;
      ItemAppearance.FillDisabled.ColorMirror := clNone;
      ItemAppearance.FillDisabled.ColorMirrorTo := clNone;
      ItemAppearance.FillDisabled.BorderColor := $00D4D4D4;
      ItemAppearance.FillDisabled.GradientMirrorType := gtVertical;

      ItemAppearance.FillSelected.Color := $00666666;
      ItemAppearance.FillSelected.ColorTo := clNone;
      ItemAppearance.FillSelected.ColorMirror := clNone;
      ItemAppearance.FillSelected.ColorMirrorTo := clNone;
      ItemAppearance.FillSelected.BorderColor := $00666666;
      ItemAppearance.FillSelected.GradientMirrorType := gtVertical;


      ItemAppearance.FillHover.Color := $00969696;
      ItemAppearance.FillHover.ColorTo := $00969696;
      ItemAppearance.FillHover.ColorMirror := clNone;
      ItemAppearance.FillHover.ColorMirrorTo := clNone;
      ItemAppearance.FillHover.BorderColor :=  $00969696;
      ItemAppearance.FillHover.GradientMirrorType := gtVertical;

      ItemAppearance.Font.Color := $00232425;
      ItemAppearance.FontHover.Color := $001E1F20;
      ItemAppearance.FontSelected.Color := $00232425;
    end;
    tsOffice2019Black:
    begin
      ItemAppearance.FillSelected.Glow := gmNone;
      ...
      ContentFill.Color := $00303132;
      ContentFill.ColorTo := clNone;
      ContentFill.BorderColor := clNone;

      ItemAppearance.FillDisabled.Color := $00303132;
      ItemAppearance.FillDisabled.ColorTo := $00303132;
      ItemAppearance.FillDisabled.ColorMirror := clNone;
      ItemAppearance.FillDisabled.ColorMirrorTo := clNone;
      ItemAppearance.FillDisabled.BorderColor := $00D4D4D4;
      ItemAppearance.FillDisabled.GradientMirrorType := gtVertical;

      ItemAppearance.FillSelected.Color := $00828282;
      ItemAppearance.FillSelected.ColorTo := clNone;
      ItemAppearance.FillSelected.ColorMirror := clNone;
      ItemAppearance.FillSelected.ColorMirrorTo := clNone;
      ItemAppearance.FillSelected.BorderColor := $00828282;
      ItemAppearance.FillSelected.GradientMirrorType := gtVertical;

      ItemAppearance.FillHover.Color := $00686868;
      ItemAppearance.FillHover.ColorTo := $00686868;
      ItemAppearance.FillHover.ColorMirror := clNone;
      ItemAppearance.FillHover.ColorMirrorTo := clNone;
      ItemAppearance.FillHover.BorderColor :=  $00686868;
      ItemAppearance.FillHover.GradientMirrorType := gtVertical;

      ItemAppearance.Font.Color := clWhite;
      ItemAppearance.FontHover.Color := clWhite;
      ItemAppearance.FontSelected.Color := clWhite;
    end;
  end;
  ...
  case AStyle of
   ...
   tsWindows8, tsWindows10:
    ...
    tsOffice2016White:
      begin
        TearOffFill.Color := $00F2E1D5;
        TearOffFill.ColorTo := clNone;
        TearOffFill.BorderColor := clNone;
      end;
    tsOffice2016Gray:
      begin
        TearOffFill.Color := $00969696;
        TearOffFill.ColorTo := clNone;
        TearOffFill.BorderColor := clNone;
      end;
    tsOffice2016Black:
      begin
        TearOffFill.Color := $00686868;
        TearOffFill.ColorTo := clNone;
        TearOffFill.BorderColor := clNone;
      end;
   ...
   tsOffice2016White:
    ...
    tsOffice2019White:
      begin
        ...
        CaptionFill.ColorMirror := clNone;
        CaptionFill.ColorMirrorTo := clNone;
        CaptionFill.BorderColor := $00F2E1D5;
        CaptionFill.GradientMirrorType := gtVertical;
    ...
    tsOffice2019Gray:
      begin
        ...
        CaptionFill.Color := $00D4D4D4;
        CaptionFill.ColorTo := clNone;
        CaptionFill.ColorMirror := clNone;
        CaptionFill.ColorMirrorTo := clNone;
        CaptionFill.BorderColor := $00808080;
        CaptionFill.GradientMirrorType := gtVertical;
    ...
    tsOffice2019Black:
      begin
        ...
        CaptionFill.Color := $00444444;
        CaptionFill.ColorTo := clNone;
        CaptionFill.ColorMirror := clNone;
        CaptionFill.ColorMirrorTo := clNone;
        CaptionFill.BorderColor := $00686868;
        CaptionFill.GradientMirrorType := gtVertical;
