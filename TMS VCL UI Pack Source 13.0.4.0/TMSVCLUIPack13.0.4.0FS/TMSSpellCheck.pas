...
const
  ...
  BLD_VER = 5; // Build nr.
  DATE_VER = 'Jan, 2020'; // Month version
  ...
  // v1.0.6.3 : Fixed : Issue with English affix file
  // v1.0.6.4 : Fixed : Issue with DatabaseFileName = ''
  // v1.0.6.5 : Fixed : Issue with Midas.dll dependency in Win64
...
type
  ...
  {$IFDEF FMXLIB}
  {$HINTS OFF}
  [ComponentPlatformsAttribute(pidWin32 or pidWin64 or pidOSX32{$IF COMPILERVERSION > 32} or pidOSX64{$IFEND})]
  {$HINTS ON}
  {$ENDIF}
