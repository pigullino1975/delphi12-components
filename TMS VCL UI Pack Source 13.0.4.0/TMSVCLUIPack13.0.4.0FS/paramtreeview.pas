...
uses
  ...
  Spin, Forms, ParHTML, PictureContainer, Dialogs, Types, AdvStyleIF, ImgList;
...
const
  ...
  // 1.5.0.1 : Fixed : Issue with TIME param input in newer Delphi versions
  // 1.5.0.2 : Improved : Date/Time Picker positioning on high DPI
...
uses
  ...
  VCL.Themes,
  {$ENDIF}
  CommCtrl, Shellapi, SysUtils, ShlObj, ActiveX, Math, Variants;
...
procedure TParamTreeview.CMChildKey(var Message: TCMDialogKey);
begin
  ...
  begin
    ...
    CDDS_ITEMPOSTPAINT:
      begin
        ...
        HTMLDrawEx(Canvas,tn.Text,TVcd.nmcd.rc,HTMLImages,0,0,-1,-1,2,
...
//        if  (TVcd.nmcd.uItemState and CDIS_FOCUS = CDIS_FOCUS) then
        ...
        HTMLDrawEx(Canvas,tn.Text,TVcd.nmcd.rc,HTMLImages,pt.X,pt.Y,fl,FHyperLink,ShadowOffset,
...
//    r.Right := r.Left + Width;
    ...
    HTMLDrawEx(Canvas,Node.Text,r,HTMLImages,0,0,-1,-1,2,
    ...
    if HTMLDrawEx(Canvas,Node.Text,r,HTMLImages,x,y,fl,-1,2,
...
begin
  ...
  begin
    ...
    HTMLDrawEx(Canvas,Node.Text,r,HTMLImages,message.xpos,message.ypos,-1,-1,2,
      True,True,False,False,False,False,WordWrap,FMouseDown,False,1.0,clBlue,
...
procedure TParamTreeview.SetImages(const Value: TCustomImageList);
begin
  FImages := Value;
  Invalidate;
end;
