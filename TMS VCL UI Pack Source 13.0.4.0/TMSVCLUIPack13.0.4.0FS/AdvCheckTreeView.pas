...
uses
  SysUtils, Classes, Controls, ComCtrls, Windows, Messages, CommCtrl, AdvStyleIF, Graphics;
...
const
  ...
  // v1.0.2.0 : New : Support for use with TAdvFormStyler added
  // v1.0.3.0 : New : UIStyle property added
...
type
  ...
  TAdvCheckTreeView = class(TTreeView, ITMSStyle)
  private
    FTMSStyle: TTMSStyle;
    FIsBusy: boolean;
    FCheckBoxes: boolean;
...
procedure TAdvCheckTreeView.SetComponentStyle(AStyle: TTMSStyle);
begin
  FTMSStyle := AStyle;
...
procedure TAdvCheckTreeView.SetUIStyle(const Value: TTMSStyle);
begin
