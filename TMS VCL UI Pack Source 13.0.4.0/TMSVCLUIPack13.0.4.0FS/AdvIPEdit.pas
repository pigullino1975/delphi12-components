...
const
  ...
  // v1.5.1.0 : New : CopyToClipboard method added
  //          : New : ClearIPAddress added
...
procedure TAdvIPEdit.ClearIPAddress;
var
  i: integer;
begin
  Text := '0';
...
procedure TAdvIPEdit.CopyToClipboard;
var
  clp: TClipboard;
begin
  clp := TClipboard.Create;
  clp.Open;
  clp.AsText := self.IPAddress;
  clp.Close;
end;
