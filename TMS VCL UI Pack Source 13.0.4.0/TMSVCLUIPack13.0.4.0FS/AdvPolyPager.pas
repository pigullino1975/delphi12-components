...
type
  ...
  TAdvDesignListCracker = class(TAdvDesignList)
  end;
...
procedure TAdvPolyPage.SetUIStyle(const Value: TTMSStyle);
begin
...
begin
  ...
  case AStyle of
   ...
   tsOffice2019White:
      begin
        PageAppearance.BorderColor := $00C4C6C8;
        PageAppearance.Color := clWhite;
        PageAppearance.ColorTo := clWhite;
        PageAppearance.ColorMirror := clWhite;
        PageAppearance.ColorMirrorTo := clWhite;
    ...
    tsOffice2019Gray:
      begin
        PageAppearance.BorderColor := $00666666;
    ...
    tsOffice2019Black:
      begin
        PageAppearance.BorderColor := $00ADB0B3;
...
begin
  ...
  TAdvDesignListCracker(FList).IsDesignTime := FDesignTime;
...
procedure TAdvPolyPager.SetUIStyle(const Value: TTMSStyle);
begin
  SetComponentStyle(Value);
end;
