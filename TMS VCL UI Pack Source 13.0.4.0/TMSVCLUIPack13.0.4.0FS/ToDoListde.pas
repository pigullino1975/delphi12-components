{*************************************************************************}
{ TTodoList Design Editor component                                       }
...
begin
  ...
  0: begin
      {$I COMPILERTEXT.INC}
      MessageDlg(Component.ClassName+' version '+ (Component as TCustomTodoList).VersionString + ' for ' + compiler + #13#10#13#10'© 2002-2023 by TMS software'#13#10'https://www.tmssoftware.com',
