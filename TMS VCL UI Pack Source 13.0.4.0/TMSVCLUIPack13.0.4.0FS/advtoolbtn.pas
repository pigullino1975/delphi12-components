...
const
  ...
  // 1.7.1.0 : New : UIStyle property for office look
  // 1.7.1.1 : Fixed : ParentFont kept true on initialization
  // 1.7.2.0 : Improved : Changed ImageIndex type to TImageIndex
...
begin
  ...
  if FGlyphDisabled.Empty and Assigned(Value) then
  begin
...
procedure TAdvToolButton.SetImageIndex(const Value: TImageIndex);
begin
...
begin
  ...
  case AStyle of
    ...
    tsOffice2019White: Look := 25;
    tsOffice2019Gray: Look := 26;
    tsOffice2019Black: Look := 27;
  end;
end;
...
begin
  ...
  0:begin
      ...
      BorderDownColor := $AF987A;
      BorderHotColor := $C3CECE;
      BorderColor := clNone;
      Rounded := True;
      Flat := True;
    end;
  ...
  6:begin
      ...
      ColorChecked := $00B5E6F2;
      ColorCheckedTo := $009CDDED;
  ...
  25:   begin
        ...
        ColorHot := $00FAECE3;
        ColorHotTo := clNone;
        BorderHotColor := $00FAECE3;

        ColorDown := $00E3BDA3;
        ColorDownTo := clNone;
        BorderDownColor := $00E3BDA3;

        ColorChecked := $00D1B9A5;
        ColorCheckedTo := clNone;
  ...
  26: Begin
        ...
        ColorHot := $00939597;
        ColorHotTo := clNone;
        BorderHotColor := $00939597;

        ColorDown := $0086888A;
        ColorDownTo := clNone;
        BorderDownColor := $0086888A;

        ColorChecked := $00939597;
        ColorCheckedTo := clNone;
  ...
  27:   Begin
        Color := $00303132;
        ColorTo := $00303132;
        BorderColor := $00303132;

        ColorHot := $00444648;
        ColorHotTo := $00444648;
        BorderHotColor := $00444648;

        ColorDown := $005C5E60;
        ColorDownTo := $005C5E60;
        BorderDownColor := $005C5E60;

        ColorChecked := $00444648;
        ColorCheckedTo := $00444648;
