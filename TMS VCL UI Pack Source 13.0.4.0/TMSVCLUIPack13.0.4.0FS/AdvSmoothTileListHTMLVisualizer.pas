...
uses
  Forms, Classes, Controls, AdvGDIP, AdvSmoothTileList, AdvSmoothTileListImageVisualizer, Types
  {$IFDEF DELPHIXE2_LVL}
  , System.UITypes
  {$ENDIF}
  ;
...
uses
  Windows, Graphics, SysUtils, GDIPPictureContainer, ImgList, CommCtrl, ShellApi, GDIPHTMLEngine;
