          ...
          'C':begin
                ...
                begin
                  ...
                  begin
                    ...
                    begin
                      IMGSize.x := Round(16 * FDPIScale);
                      IMGSize.y := Round(16 * FDPIScale);
                      if Print then
                        Indent := Round(16 * ResFactor)
                      else
                        Indent := Round(16 * FDPIScale);
                      ...
                      if Print then
                        ...
                        ir := Rect(cr.Left + 2,cr.Bottom - Round(15 * FDPIScale),cr.Left + Round(15 * FDPIScale), cr.Bottom);
                    ...
                    begin
                      ...
                      if Print then
                        ...
                        ir := Rect(cr.Left + 2,cr.Bottom - Round(14 * FDPIScale),cr.Left + Round(14 * FDPIScale), cr.Bottom);
                    ...
                    begin
                      IMGSize.y := Round(24 * FDPIScale);
                      Canvas.Pen.Color := clGray;
                      Canvas.Brush.Style := bsClear;

                      if Print then
                        ir := Rect(cr.Left + 2,cr.Bottom - Round(20 * ResFactor),cr.Left + Indent -2, cr.Bottom)
                      else
                        ir := Rect(cr.Left + 2,cr.Bottom - Round(20 * FDPIScale),cr.Left + Indent -2, cr.Bottom);
                  ...
                  begin
                    if (ControlType = 'BUTTON') then
                       IMGSize.y := Round(21 * FDPIScale);

                    if (ControlType = 'COMBO') then
                       IMGSize.y := Round(23 *  FDPIScale);
