...
type
  ...
  {$IFDEF WEBLIB}
  TAdvPDFGraphicsLibHTMLLines = class(TObjectList)
  private
    function GetItem(Index: Integer): TAdvPDFGraphicsLibHTMLLine;
    procedure SetItem(Index: Integer; const Value: TAdvPDFGraphicsLibHTMLLine);
  public
    property Items[Index: Integer]: TAdvPDFGraphicsLibHTMLLine read GetItem write SetItem; default;
  end;
  {$ENDIF}
  {$IFNDEF WEBLIB}
  TAdvPDFGraphicsLibHTMLLines = class(TObjectList<TAdvPDFGraphicsLibHTMLLine>);
  {$ENDIF}
...
begin
  ...
  try
    ...
    begin
      ...
      for v in lst do
      begin
        l := TAdvPDFGraphicsLibHTMLLine(v);
      {$ELSE}
      for l in lst do
      begin
      {$ENDIF}
          ...
          'I':begin
                ...
                begin
                  ...
                  begin
                    ...
                    begin
                      bmp := TAdvBitmap(APictureContainer.FindBitmap(Prop));
                    end;
...
{$IFDEF WEBLIB}
function TAdvPDFGraphicsLibHTMLLines.GetItem(Index: Integer): TAdvPDFGraphicsLibHTMLLine;
begin
  Result := TAdvPDFGraphicsLibHTMLLine(inherited Items[Index]);
end;

procedure TAdvPDFGraphicsLibHTMLLines.SetItem(Index: Integer; const Value: TAdvPDFGraphicsLibHTMLLine);
begin
