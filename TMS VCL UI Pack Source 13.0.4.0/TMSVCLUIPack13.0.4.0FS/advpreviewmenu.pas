...
{$ENDIF}
  ...
  // v6.1.0.0 : New : Support for Office 2019 styles
  // v6.1.1.0 : New : Internal Office styler implemented
  // v6.1.1.1 : Improved : On creation check for enabled AdvFormStyler
  // v6.1.1.2 : Fixed : Made ButtonImages property work with a TVirtualImageList
...
{ TItemActionLink }
  ...
  {$ENDIF}
  TAdvPreviewMenu = class(TComponent, ITMSStyle)
  private
    ...
    FMenuFont: TFont;
    FButtonDisabledImages: TCustomImageList;
    ...
    procedure SetButtonDisabledImages(const Value: TCustomImageList);
  ...
  public
    ...
    procedure SetDPIScale(ADPI: Integer);    
  ...
  published
    ...
    property ButtonDisabledImages: TCustomImageList read FButtonDisabledImages write SetButtonDisabledImages;
...
uses
  AdvToolBar, AdvPreviewMenuStylers
{$IFDEF DELPHI9_LVL}
  , Types
{$ENDIF}
  ;
...
procedure TAdvPreviewMenu.SetButtonDisabledImages(const Value: TCustomImageList);
begin
...
procedure TAdvPreviewMenu.SetButtonImages(const Value: TCustomImageList);
begin
  FButtonImages := Value;
end;
...
procedure TAdvPreviewMenu.SetUIStyle(const Value: TTMSStyle);
begin
  FTMSStyle := Value;
...
begin
  ...
  FDPIScale := GetDPIScale(FAdvPreviewMenuPanel, FAdvPreviewMenuPanel.Canvas);
...
procedure TAdvPreviewMenu.SetDPIScale(ADPI: Integer);
begin
  FDPIScale := ADPI/96;
...
procedure TAdvPreviewMenu.SetComponentStyle(AStyle: TTMSStyle);
var
  tempStyler: TAdvPreviewMenuOfficeStyler;
begin
  ...
  begin
    ...
    begin
      tempStyler := TAdvPreviewMenuOfficeStyler.Create(Self);
      tempStyler.SetComponentStyle(AStyle);
      FCurrentStyler.Assign(tempStyler);
    end;
  end;
end;
...
begin
  ...
  begin
    ...
    FRoundedButtons := TAdvCustomPreviewMenuStyler(Source).RoundedButtons;
  end
  else
    inherited;
end;
      ...
      begin
        ...
        begin
          ...
          *)
          ...
          ACanvas.Font.Height := Round(ACanvas.Font.Height * AdvPreviewMenu.DPIScale);
...
begin
  ...
  begin
    ...
    begin
      ...
      AdvGlowBtn.Font.Height := Round(AdvGlowBtn.Font.Height * AdvPreviewMenu.DPIScale);
...
begin
  ...
  begin
    ...
    begin
      ...
      Canvas.Font.Height := Round(Canvas.Font.Height * AdvPreviewMenu.DPIScale);
      R := Rect(0,0,1000,100);
