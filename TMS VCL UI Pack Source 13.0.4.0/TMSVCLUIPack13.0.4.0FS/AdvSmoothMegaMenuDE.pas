...
type
  ...
  TAdvSmoohtMegaMenuSelectionEditor = class(TSelectionEditor)
  public
...
{ TAdvSmoohtMegaMenuSelectionEditor }

procedure TAdvSmoohtMegaMenuSelectionEditor.RequiresUnits(Proc: TGetStrProc);
begin
  inherited;
  Proc('GDIPMenu');
end;
