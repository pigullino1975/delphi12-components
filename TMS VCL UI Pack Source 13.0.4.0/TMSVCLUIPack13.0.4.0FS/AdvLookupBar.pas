...
const
  ...
  // v1.2.0.1 : Fixed : Design-time style painting
  // v1.2.1.0 : New : UIStyle property for office look
  //          : Improved : On creation check for enabled AdvFormStyler
  // v1.2.1.1 : Fixed : VCL styles check updated to work in 10.4 Sydney
   ...
   tsOffice2016White:
    ...
    tsOffice2019White:
      begin
        ...
        ScrollColor := $00F2E1D5;
        SelectedFont.Color := $00E3BDA3;

        ScrollFont.Color := $00505050;
      end;
    tsOffice2019Gray:
      begin
        ...
        ScrollColor := $00969696;
        SelectedFont.Color := clWhite;

        ScrollFont.Color := $00424242;
      end;
    tsOffice2019Black:
      begin
        ...
        Color := $00444444;
        ColorTo := Color;
        ActiveFont.Color := $00F0F0F0;
        InActiveFont.Color := clSilver;

        ScrollColor := $00828282;
        SelectedFont.Color := clWhite;

        ScrollFont.Color := $00A6A6A6;
      end;
  end;
end;
...
procedure TAdvLookupBar.SetUIStyle(const Value: TTMSStyle);
begin
