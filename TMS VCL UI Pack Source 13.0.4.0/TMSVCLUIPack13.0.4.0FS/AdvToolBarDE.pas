...
type
  ...
  TAdvFormStylerSelectionEditor = class(TSelectionEditor)
  public
...
begin
  ...
  3:
    begin
      ...
      begin
        ...
        QAT.Left := 10;
        TAdvToolBarPager(Component).UpdateStyle;
      end;
  ...
  5:begin
      ShowMessage('TMS Advanced ToolBars & Menus version ' + TAdvToolBarPager(Component).Version+#13#10'Copyright © 2005 - 2020 by TMS software');
    end;
  end;
end;
...
begin
  ...
  OpenDialog.Filter := 'All (*.jpg;*.jpeg;*.gif;*.bmp;*.png;*.svg)|*.jpg;*.jpeg;*.gif;*.bmp;*.png;*.svg|JPEG Image File (*.jpg)|*.jpg|JPEG Image File (*.jpeg)|*.jpeg|GIF files (*.gif)|*.gif|Bitmaps (*.bmp)|*.bmp|PNG files (*.png)|*.png|Scalable Vector Graphics (*.svg)|*.svg';
...
{ TAdvFormStylerSelectionEditor }

procedure TAdvFormStylerSelectionEditor.RequiresUnits(Proc: TGetStrProc);
begin
  inherited;
  Proc('AdvStyleIF');
end;
