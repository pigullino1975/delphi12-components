...
const
  ...
  // v2.5.0.0 : New : Support for Office 2019 styles
  // v2.5.1.0 : New : StyleElements property exposed
  // v2.5.2.0 : New : UIStyle property for TMSStyle
  // v2.5.2.1 : Fixed : UIStyle set to tsCustom after initial Office look
  // v2.5.2.2 : Improved : On creation check for enabled AdvFormStyler
  // v2.5.2.3 : Fixed : VCL styles check updated to work in 10.4 Sydney
  // v2.5.2.4 : Fixed : Issue with day of week param in OnGetWeekDayName event
  ...
  begin
    ...
    begin
      ...
      if Assigned(OnGetWeekDayName) then
        OnGetWeekDayName(Self, DayOfTheWeek(EncodeDate(FCurrentYear, FCurrentMonth, i)), weekday);
...
//        DateAppearance.DateFill.BorderColor := $8CC0B1;
        ...
        DateAppearance.DisabledDateFill.ColorMirror := clNone;
        DateAppearance.DisabledDateFill.ColorMirrorTo := clNone;
        DateAppearance.DisabledDateFont.Color := $00D4D4D4;
//        DateAppearance.DisabledDateFill.BorderColor := $588060;
        DateAppearance.DisabledDateFill.GradientMirrorType := gtVertical;

        DateAppearance.HoverDateFill.Color := $00F2E1D5;
        DateAppearance.HoverDateFill.ColorTo := clNone;
        DateAppearance.HoverDateFill.ColorMirror := clNone;
        DateAppearance.HoverDateFill.ColorMirrorTo := clNone;
        DateAppearance.HoverDateFill.BorderColor :=  $00F2E1D5;
        DateAppearance.HoverDateFill.GradientMirrorType := gtVertical;
        DateAppearance.HoverDateFont.Color := $003B3B3B;


        DateAppearance.SelectedDateFill.Color := $00E3BDA3;
        DateAppearance.SelectedDateFill.ColorTo := clNone;
        DateAppearance.SelectedDateFill.ColorMirror := clNone;
        DateAppearance.SelectedDateFill.ColorMirrorTo := clNone;
        DateAppearance.SelectedDateFill.BorderColor := $00E3BDA3;
        DateAppearance.SelectedDateFill.GradientMirrorType := gtVertical;
        ...
        DateAppearance.CurrentDateFill.ColorMirror := clNone;
        DateAppearance.CurrentDateFill.ColorMirrorTo := clNone;
        DateAppearance.CurrentDateFill.BorderColor := $00E3BDA3;
        DateAppearance.CurrentDateFill.GradientMirrorType := gtVertical;
        DAteAppearance.CurrentDateFont.Color := $003B3B3B;
      end;
    ...
    tsOffice2019Gray:
       begin
        ...
        DateAppearance.DayOfWeekFill.Color :=  $00B8BBBE;
        DateAppearance.DayOfWeekFill.ColorTo := clNone;
        DateAppearance.DayOfWeekFill.BorderColor := $00B8BBBE;

        DateAppearance.DayOfWeekFont.Color := $00232425;
        DateAppearance.WeekNumbers.Font.Color := $00232425;
        DateAppearance.DateFont.Color := $00232425;
        DateAppearance.WeekendFont.Color := $00232425;

        DateAppearance.WeekNumbers.Fill.Color := DateAppearance.DayOfWeekFill.Color;
        DateAppearance.WeekNumbers.Fill.ColorTo := DateAppearance.DayOfWeekFill.ColorTo;
        DateAppearance.WeekNumbers.Fill.BorderColor := DateAppearance.DayOfWeekFill.BorderColor;

        DateAppearance.DateFill.Color := $00B8BBBE;
        DateAppearance.DateFill.ColorTo := clNone;
        DateAppearance.DateFill.ColorMirror := clNone;
        DateAppearance.DateFill.ColorMirrorTo := clNone;
//        DateAppearance.DateFill.BorderColor := $8CC0B1;
        ...
        DateAppearance.WeekendFill.Color := $00B8BBBE;
        DateAppearance.WeekendFill.ColorTo := clNone;
        DateAppearance.WeekendFill.ColorMirror := clNone;
        DateAppearance.WeekendFill.ColorMirrorTo := clNone;
//        DateAppearance.DateFill.BorderColor := $8CC0B1;
        ...
        DateAppearance.DisabledDateFill.Color := $00B8BBBE;
        DateAppearance.DisabledDateFill.ColorTo := clNone;
        DateAppearance.DisabledDateFill.ColorMirror := clNone;
        DateAppearance.DisabledDateFill.ColorMirrorTo := clNone;
        DateAppearance.DisabledDateFont.Color := $00D4D4D4;
//        DateAppearance.DisabledDateFill.BorderColor := $588060;
        ...
        DateAppearance.HoverDateFill.Color := $00969696;
        DateAppearance.HoverDateFill.ColorTo := clNone;
        DateAppearance.HoverDateFill.ColorMirror := clNone;
        DateAppearance.HoverDateFill.ColorMirrorTo := clNone;
        DateAppearance.HoverDateFill.BorderColor :=  $00969696;
        DateAppearance.HoverDateFill.GradientMirrorType := gtVertical;
        DateAppearance.HoverDateFont.Color := $001E1F20;

        DateAppearance.SelectedDateFill.Color := $00666666;
        DateAppearance.SelectedDateFill.ColorTo := clNone;
        DateAppearance.SelectedDateFill.ColorMirror := clNone;
        DateAppearance.SelectedDateFill.ColorMirrorTo := clNone;
        DateAppearance.SelectedDateFill.BorderColor := $00666666;
        DateAppearance.SelectedDateFill.GradientMirrorType := gtVertical;
        DateAppearance.SelectedDateFont.Color := $001E1F20;

        DateAppearance.CurrentDateFill.Color := $00B8BBBE;
        DateAppearance.CurrentDateFill.ColorTo := clNone;
        DateAppearance.CurrentDateFill.ColorMirror := clNone;
        DateAppearance.CurrentDateFill.ColorMirrorTo := clNone;
        DateAppearance.CurrentDateFill.BorderColor := $00666666;
        DateAppearance.CurrentDateFill.GradientMirrorType := gtVertical;
        DAteAppearance.CurrentDateFont.Color := $00232425;
      end;
    ...
    tsOffice2019Black:
       begin
        ...
        DateAppearance.DayOfWeekFill.Color :=  $00303132;
        DateAppearance.DayOfWeekFill.ColorTo := clNone;
        DateAppearance.DayOfWeekFill.BorderColor := $00303132;

        DateAppearance.WeekNumbers.Fill.Color := DateAppearance.DayOfWeekFill.Color;
        DateAppearance.WeekNumbers.Fill.ColorTo := DateAppearance.DayOfWeekFill.ColorTo;
        DateAppearance.WeekNumbers.Fill.BorderColor := DateAppearance.DayOfWeekFill.BorderColor;

        DateAppearance.DateFill.Color := $00303132;
        DateAppearance.DateFill.ColorTo := clNone;
        DateAppearance.DateFill.ColorMirror := clNone;
        DateAppearance.DateFill.ColorMirrorTo := clNone;
//        DateAppearance.DateFill.BorderColor := $8CC0B1;
        ...
        DateAppearance.WeekendFill.Color := $00303132;
        DateAppearance.WeekendFill.ColorTo := clNone;
        DateAppearance.WeekendFill.ColorMirror := clNone;
        DateAppearance.WeekendFill.ColorMirrorTo := clNone;
//        DateAppearance.DateFill.BorderColor := $8CC0B1;
        ...
        DateAppearance.DisabledDateFill.Color := $00303132;
        DateAppearance.DisabledDateFill.ColorTo := clNone;
        DateAppearance.DisabledDateFill.ColorMirror := clNone;
        DateAppearance.DisabledDateFill.ColorMirrorTo := clNone;
        DateAppearance.DisabledDateFont.Color := $00D4D4D4;
//        DateAppearance.DisabledDateFill.BorderColor := $588060;
        ...
        DateAppearance.HoverDateFill.Color := $00686868;
        DateAppearance.HoverDateFill.ColorTo := clNone;
        DateAppearance.HoverDateFill.ColorMirror := clNone;
        DateAppearance.HoverDateFill.ColorMirrorTo := clNone;
        DateAppearance.HoverDateFill.BorderColor :=  $00686868;
        DateAppearance.HoverDateFill.GradientMirrorType := gtVertical;
        DateAppearance.HoverDateFont.Color := clWhite;


        DateAppearance.SelectedDateFill.Color := $00505050;
        DateAppearance.SelectedDateFill.ColorTo := clNone;
        DateAppearance.SelectedDateFill.ColorMirror := clNone;
        DateAppearance.SelectedDateFill.ColorMirrorTo := clNone;
        DateAppearance.SelectedDateFill.BorderColor := $00505050;
        DateAppearance.SelectedDateFill.GradientMirrorType := gtVertical;
        DateAppearance.SelectedDateFont.Color:= clWhite;

        DateAppearance.CurrentDateFill.Color := $00303132;
        DateAppearance.CurrentDateFill.ColorTo := clNone;
        DateAppearance.CurrentDateFill.ColorMirror := clNone;
        DateAppearance.CurrentDateFill.ColorMirrorTo := clNone;
        DateAppearance.CurrentDateFill.BorderColor := $00505050;
        DateAppearance.CurrentDateFill.GradientMirrorType := gtVertical;
        DAteAppearance.CurrentDateFont.Color := clWhite;
      end;
...
procedure TAdvSmoothCalendar.SetUIStyle(const Value: TTMSStyle);
begin
