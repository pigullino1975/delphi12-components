...
uses
  AdvEdBtn, GDIPicDE, Classes, GDIPicture, DesignIntf, DesignEditors, AdvFileNameEdit;
...
begin
  ...
  RegisterPropertyEditor(TypeInfo(string), TAdvFileNameEdit, 'Filter', TFilterProperty);
end;
