...
type
  ...
  published
    property UIStyle: TTMSStyle read FStyle write SetComponentStyle default tsCustom;
  end;
...
constructor TAdvTaskDialogEx.Create(AOwner: TComponent);
begin
  inherited;
...
constructor TAdvInputTaskDialogEx.Create(AOwner: TComponent);
begin
  inherited;
