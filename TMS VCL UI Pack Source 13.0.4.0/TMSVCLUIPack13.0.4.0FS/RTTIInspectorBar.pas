...
begin
  ...
  if (InspectorItem.PropertyType in [ptText, ptTextButton]) then
  begin
  ...
  begin
    InspectorItem.StringsValue.Text := InspectorItem.TextValue;
  end;
    ...
    try
      ...
      begin
        ...
        begin
          ...
          begin
            if (CurrentProperty.PropType^.Name = 'TStrings') or (CurrentProperty.PropType^.Name = 'TStringList') then
            begin
              RTTIItem.PropertyType := ptStringList;
              RTTIItem.StringsValue := TStrings(GetObjectProp(AObject,string(CurrentProperty.Name)));
              RTTIItem.TextValue := RTTIItem.StringsValue.Text;
            end
            else
