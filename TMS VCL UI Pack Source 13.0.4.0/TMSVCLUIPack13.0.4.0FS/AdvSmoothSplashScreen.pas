...
const
  ...
  // v1.6.1.0 : New : UIStyle property added for TTMSStyles
  ...
  // v1.6.2.0 : New: FadeInSettings and FadeOutSettings to customize fading behavior
...
type
  ...
  TAdvSplashFadeSettings = class(TPersistent)
  private
    FFadeTime: Integer;
    FFadeStep: Integer;
    FFadeToOpacity: Integer;
    procedure SetFadeStep(const Value: Integer);
    procedure SetFadeTime(const Value: Integer);
    procedure SetFadeToOpacity(const Value: Integer);
  public
    constructor Create(AOwner: TAdvSmoothSplashScreen);
    destructor Destroy; override;
    procedure Assign(Source: TPersistent); override;
  published
    property FadeStep: Integer read FFadeStep write SetFadeStep default 20;
    property FadeTime: Integer read FFadeTime write SetFadeTime default 15;
    property FadeToOpacity: Integer read FFadeToOpacity write SetFadeToOpacity default 255;
  end;
  ...
  private
    ...
    FDPIScale: single;
    FDesignTime: Boolean;
    FFadeOutSettings: TAdvSplashFadeSettings;
    FFadeInSettings: TAdvSplashFadeSettings;
    function GetVersion: string;
    procedure SetVersion(const Value: string);
    function GetVersionNr: Integer;
    ...
    procedure SetFadeInSettings(const Value: TAdvSplashFadeSettings);
    procedure SetFadeOutSettings(const Value: TAdvSplashFadeSettings);
  protected
  ...
  public
    ...
    procedure FadeIn(const Step, Wait, Max: Integer); overload;
	  procedure FadeIn; overload;
    procedure FadeOut(const Step, Wait, Min: Integer); overload;
  ...
  published
    ...
    property FadeInSettings: TAdvSplashFadeSettings read FFadeInSettings write SetFadeInSettings;
    property FadeOutSettings: TAdvSplashFadeSettings read FFadeOutSettings write SetFadeOutSettings;
  end;


implementation
uses
  CommCtrl, ShellAPI, ActiveX, GDIPHTMLEngine;
...
begin
  ...
  begin
    ...
    begin
      ...
      Result.AlphaBlendValue := 5;  //GVH
      MaxOpacity :=  Min(SplashScreen.FadeInSettings.FadeToOpacity, SplashScreen.MaxOpacity);
    end;
  end
  else
    Result.FOpacity := 255;  //GVH
  ...
  begin
    if (SplashScreen.DisplayStyle = dsFadeInOut) then
    begin
      i := SplashScreen.FadeInSettings.FFadeStep;  //GVH
      ...
      begin
        ...
        Sleep(SplashScreen.FadeInSettings.FFadeTime);  //GVG
      end;
    end;
    Result.AlphaBlendValue := MaxOpacity; //GVH
  end
  else if (SplashScreen.DisplayStyle = dsFadeInOut) then
  begin
    Result.FadeIn(SplashScreen.FadeInSettings.FadeStep, SplashScreen.FadeInSettings.FadeTime, SplashScreen.FadeInSettings.FadeToOpacity); //GVH
  end;
  ...
  begin
    ...
    tsOffice2019White:
      begin
        ...
        ProgressFill.Color := $00E3BDA3;
        ProgressFill.ColorTo := clNone;
        ProgressFill.ColorMirror := clNone;
        ProgressFill.ColorMirrorTo := clNone;
        ProgressFill.BorderColor := $00E3BDA3;
        ProgressFill.GradientMirrorType := gtNone;
      end;
    tsOffice2019Gray:
      begin
        Appearance.Overlays := False;
        ...
        BackGroundFill.Color := $00D4D4D4;
        BackGroundFill.ColorTo := $00D4D4D4;
        BackGroundFill.BorderColor := $00D4D4D4;

        ProgressFill.Color := $00666666;
        ProgressFill.ColorTo := clNone;
        ProgressFill.ColorMirror := clNone;
        ProgressFill.ColorMirrorTo := clNone;
        ProgressFill.BorderColor := $00666666;
        ProgressFill.GradientMirrorType := gtNone;
      end;
    tsOffice2019Black:
      begin
        ...
        BackGroundFill.Color := $00444444;
        BackGroundFill.ColorTo := $00444444;
        BackGroundFill.BorderColor := $00444444;

        ProgressFill.Color := $00828282;
        ProgressFill.ColorTo := clNone;
        ProgressFill.ColorMirror := clNone;
        ProgressFill.ColorMirrorTo := clNone;
        ProgressFill.BorderColor := $00828282;
        ProgressFill.GradientMirrorType := gtNone;
      end;
    end;
  end;
...
begin
  ...
  FFadeInSettings := TAdvSplashFadeSettings.Create(Self);

  FFadeOutSettings := TAdvSplashFadeSettings.Create(Self);
  FFadeOutSettings.FFadeToOpacity := 10;
...
begin
  ...
  FTopLayerItems.Free;
  FFadeOutSettings.Free;
  FFadeInSettings.Free;
  inherited;
end;
...
procedure TAdvSmoothSplashScreen.SetUIStyle(const Value: TTMSStyle);
begin
...
begin
  ...
  if (DisplayStyle = dsFadeInOut) and Assigned(FSplashWindow) and (FSplashWindow.Visible) then
    FSplashWindow.FadeOut(FadeOutSettings.FadeStep, FadeOutSettings.FadeTime, FadeOutSettings.FadeToOpacity);
...
begin
  ...
  begin
    ...
    begin
      FSplashWindow.FadeIn(Step, Wait, Max);
    end;
  end;
end;
...
procedure TAdvSmoothSplashScreen.FadeIn;
begin
  FadeIn(FFadeInSettings.FadeStep, FFadeInSettings.FadeTime, FFadeInSettings.FadeToOpacity);
end;
...
procedure TAdvSmoothSplashScreen.FadeOut;
begin
  FadeOut(FFadeOutSettings.FadeStep, FFadeOutSettings.FadeTime, FFadeOutSettings.FadeToOpacity);
end;
...
procedure TAdvSmoothSplashScreen.SetFadeInSettings(const Value: TAdvSplashFadeSettings);
begin
  FFadeInSettings.Assign(Value);
end;

procedure TAdvSmoothSplashScreen.SetFadeOutSettings(const Value: TAdvSplashFadeSettings);
begin
  FFadeOutSettings.Assign(Value);
end;
...
{ TAdvSplashFadeSettings }

procedure TAdvSplashFadeSettings.Assign(Source: TPersistent);
begin
  if (Source is TAdvSplashFadeSettings) then
  begin
    FFadeTime := (Source as TAdvSplashFadeSettings).FadeTime;
    FFadeStep := (Source as TAdvSplashFadeSettings).FadeStep;
    FFadeToOpacity := (Source as TAdvSplashFadeSettings).FadeToOpacity;
  end;
  inherited;

end;

constructor TAdvSplashFadeSettings.Create(AOwner: TAdvSmoothSplashScreen);
begin
  FFadeTime := 15;
  FFadeStep := 20;
  FFadeToOpacity := 255;
...
destructor TAdvSplashFadeSettings.Destroy;
begin

  inherited;
end;

procedure TAdvSplashFadeSettings.SetFadeStep(const Value: Integer);
begin
  if (FadeStep <> Value) and (Value >0) then
    FFadeStep := Value;
end;

procedure TAdvSplashFadeSettings.SetFadeTime(const Value: Integer);
begin
  if (FFadeTime <> Value) and (Value >0) then
    FFadeTime := Value;
end;

procedure TAdvSplashFadeSettings.SetFadeToOpacity(const Value: Integer);
begin
  if (FFadeToOpacity <> Value) and (Value >= 0) and (Value <= 255) then
    FFadeToOpacity := Value;
end;
