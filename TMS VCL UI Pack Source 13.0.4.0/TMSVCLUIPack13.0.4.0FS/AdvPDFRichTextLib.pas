...
type
  ...
  {$IFDEF WEBLIB}
  TAdvPDFRichTextLibTabStops = class(TList)
  private
    function GetItem(Index: Integer): TAdvPDFRichTextLibTabStop;
    procedure SetItem(Index: Integer; const Value: TAdvPDFRichTextLibTabStop);
  public
    property Items[Index: Integer]: TAdvPDFRichTextLibTabStop read GetItem write SetItem; default;
  end;
  {$ENDIF}
  {$IFNDEF WEBLIB}
  TAdvPDFRichTextLibTabStops = class(TList<TAdvPDFRichTextLibTabStop>);
  {$ENDIF}
  ...
  {$IFDEF WEBLIB}
  TAdvPDFRichTextLibList = class(TList)
  private
    function GetItem(Index: Integer): IAdvCustomPDFRichTextLib;
    procedure SetItem(Index: Integer; const Value: IAdvCustomPDFRichTextLib);
  public
    property Items[Index: Integer]: IAdvCustomPDFRichTextLib read GetItem write SetItem; default;
  end;
  {$ENDIF}
  {$IFNDEF WEBLIB}
  TAdvPDFRichTextLibList = class(TList<IAdvCustomPDFRichTextLib>);
  {$ENDIF}

  TAdvPDFRichTextLibFactoryService = class(TInterfacedObject, IAdvPDFRichTextLibService)
  private
...
begin
  if TAdvPDFLibPlatformServices.Current.SupportsPlatformService(IAdvPDFRichTextLibService, IInterface(PDFRichTextLibService)) then
...
{$IFDEF WEBLIB}
function TAdvPDFRichTextLibList.GetItem(Index: Integer): IAdvCustomPDFRichTextLib;
begin
  Result := IAdvCustomPDFRichTextLib(inherited Items[Index]);
end;

procedure TAdvPDFRichTextLibList.SetItem(Index: Integer; const Value: IAdvCustomPDFRichTextLib);
begin
  inherited Items[Index] := Value;
end;

function TAdvPDFRichTextLibTabStops.GetItem(Index: Integer): TAdvPDFRichTextLibTabStop;
begin
  Result := TAdvPDFRichTextLibTabStop(inherited Items[Index]);
end;

procedure TAdvPDFRichTextLibTabStops.SetItem(Index: Integer; const Value: TAdvPDFRichTextLibTabStop);
var
  v: TAdvPDFRichTextLibTabStop;
begin
  v := Value;
