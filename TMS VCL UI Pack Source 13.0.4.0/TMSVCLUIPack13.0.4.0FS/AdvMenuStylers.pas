...
type
  TOfficeStyle = (osOffice2003Blue, osOffice2003Silver, osOffice2003Olive, osOfficeXP, osOffice2007Luna, osOffice2007Obsidian, osCustom, osOffice2007Silver, osVista, osWhidbey, osWindows7, osTerminal,
    ...
    osOffice2019White, osOffice2019Gray, osOffice2019Black);
...
begin
  ...
  begin
    SetComponentStyle(GetDefaultStyle);
  end;
...
begin
  case AStyle of
    ...
    tsOffice2019White: Style := osOffice2019White;
    tsOffice2019Gray: Style := osOffice2019Gray;
    tsOffice2019Black: Style := osOffice2019Black;
  end;
end;
...
begin
  ...
  osOffice2019White:
    begin
      Background.Color := clWhite;
      Background.ColorTo := clWhite;
      MenuBorderColor := $00A3A3A3;

      RootItem.Color := clWhite;
      RootItem.ColorTo := clWhite;

      RootItem.SelectedColor := $00B0784A;
      RootItem.SelectedColorTo := $00B0784A;
      RootItem.SelectedColorMirror := clNone;
      RootItem.SelectedColorMirrorTo := clNone;
      RootItem.SelectedBorderColor := $00B0784A;

      RootItem.HoverColor := $00F2E1D5;
      RootItem.HoverColorTo := $00F2E1D5;
      RootItem.HoverColorMirror := clNone;
      RootItem.HoverColorMirrorTo := clNone;
      RootItem.HoverBorderColor := $00F2E1D5;

      RootItem.HoverTextColor := $00444648;
      RootItem.GradientDirection := gdVertical;
      RootItem.Font.Color := $00444648;

      SelectedItem.Color := $00F2D5C2;
      SelectedItem.ColorTo := $00F2D5C2;
      SelectedItem.ColorMirror := clNone;
      SelectedItem.ColorMirrorTo := clNone;
      SelectedItem.BorderColor := $00F2D5C2;
      SelectedItem.Font.Color := clWindowText;

      SelectedItem.CheckColor := $00F2E1D5;
      SelectedItem.CheckColorTo := clNone;
      SelectedItem.RadioColor := $00F2E1D5;
      SelectedItem.RadioColorTo := clNone;
      SelectedItem.CheckBorder := $00F2E1D5;
      SelectedItem.RadioBorder := $00F2E1D5;
      ...
      IconBar.SeparatorColor := $00A3A3A3;

      Separator.Color := $00A3A3A3;
      Separator.ColorTo := $00A3A3A3;

      ButtonAppearance.HoverColor := $00FAECE3;
      ButtonAppearance.HoverColorTo := $00FAECE3;
      ButtonAppearance.HoverBorderColor := $00E3BDA3;

      ButtonAppearance.DownColor := $00B0784A;
      ButtonAppearance.DownColorTo := $00B0784A;
      ButtonAppearance.DownBorderColor := $00B0784A;
    end;
  osOffice2019Gray:
    begin
      Background.Color := $00B8BBBE;
      Background.ColorTo := $00B8BBBE;
      MenuBorderColor := $00808080;

      RootItem.Color := $00B8BBBE;
      RootItem.ColorTo := $00B8BBBE;


      RootItem.SelectedColor := $00969696;
      RootItem.SelectedColorTo := $00969696;
      RootItem.SelectedColorMirror := clNone;
      RootItem.SelectedColorMirrorTo := clNone;
      RootItem.SelectedBorderColor := $00969696;

      RootItem.HoverColor := $00939597;
      RootItem.HoverColorTo := $00939597;
      RootItem.HoverColorMirror := clNone;
      RootItem.HoverColorMirrorTo := clNone;
      RootItem.HoverBorderColor := $00939597;

      RootItem.HoverTextColor := $00232425;
      RootItem.GradientDirection := gdVertical;
      RootItem.Font.Color := $00232425;
      RootItem.UseSystemFont := false;

      SelectedItem.Color := $00969696;
      SelectedItem.ColorTo := $00969696;
      SelectedItem.ColorMirror := clNone;
      SelectedItem.ColorMirrorTo := clNone;
      SelectedItem.BorderColor := $00969696;

      SelectedItem.CheckColor := $00969696;
      SelectedItem.CheckColorTo := $00969696;
      SelectedItem.RadioColor := $00969696;
      SelectedItem.RadioColorTo := $00969696;
      SelectedItem.CheckBorder := $00969696;
      SelectedItem.RadioBorder := $00969696;


      IconBar.Color := $00B8BBBE;
      IconBar.ColorTo := $00B8BBBE;
      //IconBar.Size := 24;
      IconBar.CheckColor :=  $00B8BBBE;
      IconBar.CheckColorTo := $00B8BBBE;
      IconBar.CheckBorder := $00B8BBBE;

      IconBar.RadioColor := $00B8BBBE;
      IconBar.RadioColorTo := $00B8BBBE;
      IconBar.RadioBorder := $00B8BBBE;
      IconBar.SeparatorColor := $00808080;

      Separator.Color := $00808080;
      Separator.ColorTo := $00808080;

      ButtonAppearance.HoverColor := $00939597;
      ButtonAppearance.HoverColorTo := $00939597;
      ButtonAppearance.HoverBorderColor := $00939597;

      ButtonAppearance.DownColor := $0086888A;
      ButtonAppearance.DownColorTo := $0086888A;
      ButtonAppearance.DownBorderColor := $0086888A;
    end;
  osOffice2019Black:
    begin
      Background.Color := $003B3B3B;
      Background.ColorTo := $003B3B3B;
      MenuBorderColor := $00ADB0B3;

      Font.Color := clWhite;

      RootItem.Color := $003B3B3B;
      RootItem.ColorTo := $003B3B3B;

      RootItem.SelectedColor := $00505050;
      RootItem.SelectedColorTo := $505050;
      RootItem.SelectedColorMirror := clNone;
      RootItem.SelectedColorMirrorTo := clNone;
      RootItem.SelectedBorderColor := $505050;

      RootItem.HoverColor := $00686868;
      RootItem.HoverColorTo := clNone;
      RootItem.HoverColorMirror := $00686868;
      RootItem.HoverColorMirrorTo := clNone;
      RootItem.HoverBorderColor := $00B5B5B5;
      ...
      SelectedItem.Color := $00505050;
      SelectedItem.ColorTo := $00505050;
      SelectedItem.ColorMirror := clNone;
      SelectedItem.ColorMirrorTo := clNone;
      SelectedItem.BorderColor := $00505050;

      SelectedItem.CheckColor := $00828282;
      SelectedItem.CheckColorTo := $00828282;
      SelectedItem.RadioColor := $00828282;
      SelectedItem.RadioColorTo := $00828282;
      SelectedItem.CheckBorder := $00828282;
      SelectedItem.RadioBorder := $00828282;

      SelectedItem.Font.Color := clWhite;
      SelectedItem.UseSystemFont := false;

      IconBar.Color := $003B3B3B;
      IconBar.ColorTo := $003B3B3B;
      //IconBar.Size := 24;
      IconBar.CheckColor := $005C5E60;
      IconBar.CheckColorTo := $005C5E60;
      IconBar.CheckBorder := $005C5E60;

      IconBar.RadioColor := $005C5E60;
      IconBar.RadioColorTo := $005C5E60;
      IconBar.RadioBorder := $005C5E60;
      IconBar.SeparatorColor := $00686868;

      Separator.Color := $00686868;
      Separator.ColorTo := $00686868;

      ButtonAppearance.HoverColor := $00686868;
      ButtonAppearance.HoverColorTo := $00686868;
      ButtonAppearance.HoverBorderColor := $00B5B5B5;

      ButtonAppearance.DownColor := $00828282;
      ButtonAppearance.DownColorTo := $00828282;
      ButtonAppearance.DownBorderColor := $00828282;
