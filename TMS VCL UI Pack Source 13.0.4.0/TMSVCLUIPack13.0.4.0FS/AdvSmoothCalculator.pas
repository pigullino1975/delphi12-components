...
const
  ...
  // v1.6.1.0 : New : UIStyle property for TMSStyle
  // v1.6.1.1 : Fixed : UIStyle set to tsCustom after initial Office look
  // v1.6.1.2 : Improved : On creation check for enabled AdvFormStyler
...
begin
  ...
  if (FTMSStyle = tsCustom) and (TempStyleInt <> 0) then
    FTMSStyle := TTMSStyle(TempStyleInt);
end;
  ...
  case astyle of
    ...
    begin
      ...
      begin
        CalculatorLook.SimpleLayout := True;
        ButtonColor := clWhite;
        ButtonColorSpecial := $00F2E1D5;
        Fill.Color := clWhite;
        Fill.ColorTo := clNone;
        DisplayAppearance.ColorStart := $00E3BDA3;
        DisplayAppearance.ColorEnd := $00E3BDA3;
        CalculatorLook.Font.Color := $00444648;
      end;
    end;
    tsOffice2019Gray:
    begin
      ...
      begin
        ...
        ButtonColorSpecial := $00969696;
        Fill.Color := $00B8BBBE;
        Fill.ColorTo := $00B8BBBE;
        DisplayAppearance.ColorStart := $0086888A;
        DisplayAppearance.ColorEnd := $0086888A;
        CalculatorLook.Font.Color := $00232425;
        CalculatorLook.DisplayAppearance.Fill.Color := clNone;
        CalculatorLook.DisplayAppearance.Fill.ColorTo := clNone;
        CalculatorLook.DisplayAppearance.Fill.Opacity := 70;
        CalculatorLook.DisplayAppearance.Fill.OpacityTo := 120;
        CalculatorLook.DisplayAppearance.ColorOff := clNone;
      CalculatorLook.DisplayAppearance.ColorOffOpacity := 40;
      end;
    end;
    tsOffice2019Black:
    begin
      ...
      begin
        ...
        ButtonColorSpecial := $00686868;
        Fill.Color := $00303132;
        Fill.ColorTo := $00303132;
        DisplayAppearance.ColorStart := clWhite;
        DisplayAppearance.ColorEnd := clWhite;
        CalculatorLook.Font.Color := clWhite;
        CalculatorLook.DisplayAppearance.Fill.Color := clNone;
        CalculatorLook.DisplayAppearance.Fill.ColorTo := clNone;
        CalculatorLook.DisplayAppearance.Fill.Opacity := 70;
...
procedure TAdvSmoothCalculator.SetUIStyle(const Value: TTMSStyle);
begin
