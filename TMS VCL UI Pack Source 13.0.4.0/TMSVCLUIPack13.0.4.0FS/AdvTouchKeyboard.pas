...
const
  ...
  // 2.0.2.5 : Fixed : Issue with initializing keys in CreateWnd
  // 2.0.2.6 : Fixed : Issue with custom keyboards and high DPI
...
begin
  ...
  begin
    ...
    begin
      ...
      {$ENDIF}
//      if (KeyboardType <> ktCustom) and (FDPIScale <> 1) then
//      begin
