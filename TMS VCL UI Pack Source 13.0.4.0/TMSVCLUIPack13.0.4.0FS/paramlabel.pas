...
uses
  ...
  VCL.Themes,
  {$ENDIF}
  Commctrl, ShlObj, ActiveX, Variants;
...
procedure TParamLabel.SetImages(value: TCustomImagelist);
begin
  FImages := Value;
  InvalidateCtrl;
end;
...
procedure TParamLabel.CMChildKey(var Message: TCMDialogKey);
begin
