...
uses
  ...
  AsgDD, ActiveX, Types, AdvStyleIF;
...
const
  ...
  // 1.0.0.0 : New : Initial version
  // 1.0.0.1 : Fixed : VCL styles check updated to work in 10.4 Sydney
...
type
  ...
  public
    ...
    function DropText(pt:TPoint; s:string): boolean; override;
    ...
    procedure DropFileContents(pt:TPoint); override;
...
procedure TListDropTarget.DropFileContents(pt: TPoint);
begin
  //
end;
...
function TListDropTarget.DropText(pt: TPoint; s: string): boolean;
begin
  inherited;
  Result := true;
end;
