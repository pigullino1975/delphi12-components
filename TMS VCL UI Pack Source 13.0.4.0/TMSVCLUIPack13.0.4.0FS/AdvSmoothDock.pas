...
const
  ...
  //v1.5.1.0 : Improved : UIStyle property for TMSStyle
  ...
  //v1.5.1.3 : Fixed : Disabled functionality implemented.
...
begin
  ...
  if Assigned(frm) and Enabled then
  begin
 ...
 case AStyle of
    ...
    tsOffice2019White:
      begin
        ...
        ItemAppearance.SelectedFill.Color := $00F2E1D5;
        ItemAppearance.SelectedFill.ColorTo := clNone;
        ItemAppearance.SelectedFill.ColorMirror := clNone;
        ItemAppearance.SelectedFill.ColorMirrorTo := clNone;
    ...
    tsOffice2019Gray:
      ...
      ItemAppearance.Fill.Color := $00B8BBBE;
        ...
        ItemAppearance.SelectedFill.Color := $00969696;
        ItemAppearance.SelectedFill.ColorTo := clNone;
        ItemAppearance.SelectedFill.ColorMirror := clNone;
        ItemAppearance.SelectedFill.ColorMirrorTo := clNone;
        ItemAppearance.SelectedFill.BorderColor := $00505050;
        ItemAppearance.SelectedFill.GradientMirrorType := gtVertical;
        ItemAppearance.SelectedFill.Glow:= gmNone;
        ItemAppearance.SelectedFill.GlowGradientColor:= clNone;
    ...
    tsOffice2019Black:
      begin
        ...
        ItemAppearance.SelectedFill.Color := $00505050;
        ItemAppearance.SelectedFill.ColorTo := clNone;
        ItemAppearance.SelectedFill.ColorMirror := clNone;
        ItemAppearance.SelectedFill.ColorMirrorTo := clNone;
        ItemAppearance.SelectedFill.BorderColor := $005C5E60;
        ItemAppearance.SelectedFill.GradientMirrorType := gtVertical;
        ItemAppearance.SelectedFill.Glow:= gmNone;
        ItemAppearance.SelectedFill.GlowGradientColor:= clNone;
...
procedure TAdvSmoothDock.SetEnabled(Value: Boolean);
begin
  inherited;
  if not Enabled then
    FHoveredItemIndex := -1;
...
procedure TAdvSmoothDock.SetUIStyle(const Value: TTMSStyle);
begin
...
begin
  inherited;
  FMouseEntered := true;
  if Assigned(OwnerDock) and OwnerDock.Enabled then
  begin
...
begin
  ...
  if Assigned(OwnerDock) then
  begin
    if OwnerDock.Enabled then
    OwnerDock.DoMouseMove(Shift, X, Y)
    else
      OwnerDock.FHoveredItemIndex := -1;
  end;
end;
