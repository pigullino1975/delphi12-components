...
const
  ...
  // 1.6.0.0 : New : VCL Styles support added
  // 1.7.0.0 : New : Support for Office 2019 styles
  // 1.7.1.0 : New : UIStyle property added for office look
  //         : Improved : On creation check for enabled AdvFormStyler
  // 1.7.1.1 : Fixed : Rare repaint issue with non DoubleBuffered controls
  // 1.7.1.2 : Fixed : VCL styles check updated to work in 10.4 Sydney
  // 1.7.2.0 : New : Added public function SetSplitterSize()
...
type
  ...
  public
    ...
    procedure SetSplitterSize(const ASize: integer); virtual;
...
procedure TAdvCustomSplitter.SetSplitterSize(const ASize: integer);
begin
  SetSize(ASize);
end;
...
begin
  ...
  begin
    ...
    brClr := clNone;
    LStyle.GetElementColor(LDetails, ecFillColor, brClr);
    ...
    sgDots:       //--- draw dots grip
      begin
        ...
        begin
          ...
          for i := 1 to 9 do
          begin
            Canvas.Pixels[R.Left, R.Top] := clrfrom;
            R.Left := R.Left + 4;
          end;
        end
        else if (Align in [alLeft, alRight]) then
...
begin
  ...
  case AStyle of
    ...
    tsOffice2019White:
      begin
        Appearance.Color := $00C4C6C8;
        Appearance.ColorTo := $00C4C6C8;
        Appearance.ColorHot := $00F2E1D5;
        Appearance.ColorHotTo := $00F2E1D5;
        Appearance.DirectionType := dtAuto;
      end;
    tsOffice2019Gray:
      begin
        Appearance.Color := $00666666;
        Appearance.ColorTo := $00666666;
        Appearance.ColorHot := $00969696;
        Appearance.ColorHotTo := $00969696;
        Appearance.DirectionType := dtAuto;
      end;
    tsOffice2019Black:
      begin
        Appearance.Color := $00ADB0B3;
        Appearance.ColorTo := $00ADB0B3;
