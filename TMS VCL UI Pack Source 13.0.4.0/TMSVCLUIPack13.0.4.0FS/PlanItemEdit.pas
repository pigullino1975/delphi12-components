...
uses
  ...
  PlanRecurrEdit, PlanUtil, ImgList
  {$IFDEF DELPHIXE2_LVL}
  , System.UITypes
  {$ENDIF}
  ;
...
type
  ...
  protected
    ...
    procedure SetImageList(const Value: TCustomImageList); virtual;
  ...
  published
    ...
    property LblImage: string read FLblImage write FLblImage;
...
begin
  ...
  FEditForm.lbl_Image.Caption := FLblImage;
