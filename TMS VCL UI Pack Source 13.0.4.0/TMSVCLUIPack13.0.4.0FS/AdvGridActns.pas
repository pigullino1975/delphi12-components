...
type
  ...
  TAdvStringGridSelectAll = class(TAdvStringGridAction)
  public
    procedure UpdateTarget(Target: TObject); override;
    procedure ExecuteTarget(Target: TObject); override;
  end;

  TAdvStringGridClear = class(TAdvStringGridAction)
  public
    procedure UpdateTarget(Target: TObject); override;
    procedure ExecuteTarget(Target: TObject); override;
  end;
...
{ TAdvStringGridSelectAll }

procedure TAdvStringGridSelectAll.ExecuteTarget(Target: TObject);
begin
  inherited;
  GetControl(Target).SelectAll;
end;

procedure TAdvStringGridSelectAll.UpdateTarget(Target: TObject);
begin
  inherited;
  Enabled := (Target is TAdvStringGrid) and TAdvStringGrid(Target).Focused;
end;
...
procedure TAdvStringGridClear.ExecuteTarget(Target: TObject);
begin
  inherited;
  GetControl(Target).Clear;
end;

procedure TAdvStringGridClear.UpdateTarget(Target: TObject);
begin
  inherited;
  Enabled := (Target is TAdvStringGrid) and TAdvStringGrid(Target).Focused;
end;
