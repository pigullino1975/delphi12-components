...
const
  ...
  // 2.4.0.0 : New : Form background automatically adapts for Office 2016 & Office 2019 styles
  // 2.4.0.1 : Fixed : Error in IDE when deleting assigned ComboBox in design time
...
begin
  ...
  case AStyle of
    tsOffice2013White: Form.Color := clWhite ;
    tsOffice2013LightGray: Form.Color := clSilver;
    tsOffice2013Gray:  Form.Color := clGray;
    tsOffice2016White: Form.Color := clWhite;
    tsOffice2016Gray: Form.Color := clGray;
    tsOffice2016Black: Form.Color := clBlack;
    tsOffice2019White: Form.Color := clWhite;
    tsOffice2019Gray: Form.Color := $666666;
    tsOffice2019Black: Form.Color := clBlack;
  else
...
begin
  ...
  Result.AddObject('Office 2019 White', TObject(tsOffice2019White));
  Result.AddObject('Office 2019 Gray', TObject(tsOffice2019Gray));
  Result.AddObject('Office 2019 Black', TObject(tsOffice2019Black));
...
begin
  ...
  if (AOperation = opRemove) and (AComponent = FComboBox) then
  begin
    FComboBox := nil;
  end;
