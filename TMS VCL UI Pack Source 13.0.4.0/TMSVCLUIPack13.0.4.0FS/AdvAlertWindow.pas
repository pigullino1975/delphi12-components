...
const
 ...
 //  2.2.0.0 : New : Office 2019 styles added
 //  2.2.0.1 : Fixed : Design-time style painting
 //  2.2.0.2 : Improved : On creation check for enabled AdvFormStyler
 //  2.2.0.3 : Fixed : VCL styles check updated to work in 10.4 Sydney
 //  2.2.0.5 : Fixed : Initialisation of font height
 //  2.3.0.0 : New : Support for Emoji rendering in HTML
 //  2.3.0.1 : Fixed : Issue with anchor detection with centered paragraphs
...
type
  ...
  asOffice2019White, asOffice2019Gray, asOffice2019Black);
...
uses
  ComObj, Commctrl, ShellApi, AdvHTML
  {$IFDEF DELPHIXE_LVL}
  , MultiMon
  {$ENDIF}
  {$IFDEF DELPHIXE2_LVL}
    ...
    case FStyle of
     ...
     asOffice2019White:
        begin
          ...
          BtnDownColor := $00B0784A;
          BtnDownColorTo := $00B0784A;

          BtnHoverColor := $00FAECE3;
          BtnHoverColorTo := $00FAECE3;
     ...
     asOffice2019Gray:
        begin
          WindowColor := $00B8BBBE;
          WindowColorTo := $00B8BBBE;

          BtnDownColor := $0086888A;
          BtnDownColorTo := $0086888A;

          BtnHoverColor := $00939597;
          BtnHoverColorTo := $00939597;
     ...
     asOffice2019Black:
        begin
          WindowColor := $00303132;
          WindowColorTo := $00303132;
          Font.Color := $00FFFFFF;

          BtnDownColor := $005C5E60;
          BtnDownColorTo := $005C5E60;

          BtnHoverColor := $00444648;
          BtnHoverColorTo := $00444648;
