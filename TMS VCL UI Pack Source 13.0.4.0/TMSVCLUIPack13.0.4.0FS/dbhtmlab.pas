...
const
  ...
  // 1.4.0.1 : Improved : Ability to handle TWideMemoField blob fields added
  ...
  begin
    ...
    begin
      ...
      begin
        ...
        if (DataSet.FieldByName(Fld).IsBlob) {$IFDEF DELPHIXE10_LVL} and not (DataSet.FieldByName(Fld) is TWideMemoField) {$ENDIF} then
        begin
        ...
        begin
          ...
          if DataSet.FieldByName(Fld) is TWideMemoField then
