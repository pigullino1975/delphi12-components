...
const
  ...
  // v1.2.1.1 : Fixed : Dropdown button colors in office 2019 styles in AdvSmooth dropdown components
  //          : Fixed : ParentFont kept true on initialization
  // v1.2.1.2 : Fixed : VCL styles check updated to work in 10.4 Sydney
