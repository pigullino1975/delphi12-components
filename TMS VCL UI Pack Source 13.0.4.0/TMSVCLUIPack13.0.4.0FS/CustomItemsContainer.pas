...
const
  ...
  // v1.7.0.1 : Fixed : changes in colors for flat look in Office 2019 styles
  // v1.7.0.2 : Fixed : Design-time style painting
  // v1.7.1.0 : New : UIStyle property added for Office look
  //          : Improved : On creation check for enabled AdvFormStyler
  // v1.7.1.1 : Fixed : Issue in TAdvPolyPager with the TMS style colors when reading from form file.
  // v1.7.1.2 : Fixed : loading color issues in TAdvPolyPager
  // v1.7.1.3 : Improved : Performance for handling mouse scrolling
...
{$ENDIF}
    ...
    FAppColor: TColor;
    FAppColorHover: TColor;
    FAppColorDown: TColor;
...
{$ENDIF}
  ...
  public
    ...
    procedure SetAppStyle(AStyle: TTMSStyle; AppColor:TColor = clNone; AppColorHover: TColor = clNone; AppColorDown: TColor = clNone);
    ...
    property Items[Index: integer]: TCustomItem read GetItem write SetItem; default;                 property DragLineColor: TColor read FDragLineColor write SetDragLineColor default clRed;
...
function DarkColor(AColor: TColor):Boolean;
var
  rgb: LongInt;
  RD, GD, BD: Integer;
begin
...
begin
  if (Reader.ReadInteger <> 0) and (FTMSStyle = tsCustom) then
    FTMSStyle := tsCustom;
end;
...
{$IFNDEF DELPHIXE10_LVL}
procedure TCustomItemsContainer.ChangeScale(M, D: Integer);
{$ENDIF}
{$IFDEF DELPHIXE10_LVL}
procedure TCustomItemsContainer.ChangeScale(M, D: Integer; isDpiChange: Boolean);
{$ENDIF}
var
  I: Integer;
  it: TCustomItem;
begin
  ...
  begin
    ...
    begin
      ...
      if it.Visible then
      begin
        it.Height := Round(it.Height * M / D);
        it.Width := Round(it.Width * M / D);
      end;
    end;
  end;
  FDidScale := true;
...
begin
  ...
  FAppColor := clNone;
  FAppColorHover := clNone;
  FAppColorDown := clNone;
  FDPIScale := 1;
  ...
  begin
    ...
    begin
      ...
      begin
        ...
        if it.Visible then
        begin
          it.Height := Round(it.Height * FDPIScale);
          it.Width := Round(it.Width * FDPIScale);
        end;
      end;
    end;
...
begin
  ...
  FAppColor := ATones.Background.BrushColor;
...
procedure TCustomItemsContainer.SetAppStyle(AStyle: TTMSStyle; AppColor:TColor = clNone; AppColorHover: TColor = clNone; AppColorDown: TColor = clNone);
begin
  FAppColor := AppColor;
  FAppColorHover := AppColorHover;
  FAppColorDown := AppColorDown;
...
begin
  ...
  if not (AStyle in [tsOffice2019White, tsOffice2019Gray, tsOffice2019Black]) then
  begin
    FAppColor := clNone;
    FAppColorHover := clNone;
    FAppColorDown := clNone;
  ...
  case AStyle of
    ...
    begin
      ...
      if IsMainMenu then
      begin
        if FAppColor = clNone then
        begin
          FAppColor := $00FFAC3C;
          FAppColorHover := $00F7E6CD;
          FAppColorDown := $00E7BE7A;
        end;
        if FAppColorDown = clNone then
          FAppColorDown := Darker(FAppColor, 40);
        if FAppColorHover = clNone then
          FAppColorHover := Lighter(FAppColor, 40);

        List.MetroStyle := True;
        Fill.Color := FAppColor;
        Fill.ColorTo := FAppColor;
        Fill.BorderColor := FAppColor;

        with List.Appearance do
        begin
          Normal.Color := FAppColor;
          Normal.ColorTo := FAppColor;
          Normal.ColorMirror := FAppColor;
          Normal.ColorMirrorTo := FAppColor;
          Normal.BorderColor := FAppColor;
          Normal.GradientMirrorType := gtVertical;

          Disabled.Color := FAppColor;
          Disabled.ColorTo := FAppColor;
          Disabled.ColorMirror := FAppColor;
          Disabled.ColorMirrorTo := FAppColor;
          DisabledFont.Color := $00D4D4D4;
          Disabled.BorderColor := $00D4D4D4;
          Disabled.GradientMirrorType := gtVertical;

          Hovered.Color := FAppColorHover;
          Hovered.ColorTo := FAppColorHover;
          Hovered.ColorMirror := FAppColorHover;
          Hovered.ColorMirrorTo := FAppColorHover;
          Hovered.BorderColor := FAppColorHover;
          Hovered.GradientMirrorType := gtVertical;
          Hovered.Opacity := 255;

          Selected.Color := FAppColorHover;
          Selected.ColorTo :=FAppColorHover;
          Selected.ColorMirror := FAppColorHover;
          Selected.ColorMirrorTo := FAppColorHover;
          Selected.BorderColor := FAppColorDown;
          Selected.GradientMirrorType := gtVertical;

          Down.Color := FAppColorDown;
          Down.ColorTo := FAppColorDown;
          Down.ColorMirror := FAppColorDown;
          Down.ColorMirrorTo := FAppColorDown;
          Down.BorderColor := FAppColorDown;
          Down.GradientMirrorType := gtVertical;
          Down.Opacity := 255;

          if DarkColor(FAppColor) then
          begin
            NormalFont.Color := clWhite;
            DownFont.Color := clWhite;
          end
          else
          begin
            NormalFont.Color := $00444648;
            DownFont.Color := $00444648;
          end;

          if DarkColor(FAppColorHover) then
          begin
            SelectedFont.Color := clWhite;
            HoveredFont.Color := clWhite;
          end
          else
          begin
            SelectedFont.Color := $00444648;
            HoveredFont.Color := $00444648;
          end;
        end;
      end
      else
      begin
        ...
        begin
          ...
          Hovered.Color := $00F2E1D5;
          Hovered.ColorTo := clNone;
          Hovered.ColorMirror := clNone;
          Hovered.ColorMirrorTo := clNone;
          Hovered.BorderColor := $00E3BDA3;
          Hovered.GradientMirrorType := gtVertical;

          Selected.Color := $00F2E1D5;
          Selected.ColorTo := clNone;
          Selected.ColorMirror := clNone;
          Selected.ColorMirrorTo := clNone;
          Selected.BorderColor := $00F2E1D5;
          Selected.GradientMirrorType := gtVertical;
    ...
    begin
      ...
      begin
        ...
        Fill.Color := $00262626;
        Fill.ColorTo := clNone;
        Fill.BorderColor := $00262626;

        with List.Appearance do
        begin
          Normal.Color := $00262626;
          Normal.ColorTo := $00262626;
          Normal.ColorMirror := $00262626;
          Normal.ColorMirrorTo := $00262626;
          Normal.BorderColor := $00262626;
          Normal.GradientMirrorType := gtVertical;

          Disabled.Color := $00262626;
          Disabled.ColorTo := $00262626;
          Disabled.ColorMirror := $00262626;
          Disabled.ColorMirrorTo := $00262626;
          DisabledFont.Color := $00D4D4D4;
          Disabled.BorderColor := $00D4D4D4;
          Disabled.GradientMirrorType := gtVertical;
          ...
          begin
            SelectedFont.Color := $00232425;
            HoveredFont.Color := $00232425;
          end;
          DownFont.Color := $00232425;
        end;
      end
      else
      begin
        List.MetroStyle := True;
        Fill.Color := $00666666;
        Fill.ColorTo := $00666666;
        Fill.BorderColor := $00666666;
        ...
        begin
          ...
          Normal.Color := $00666666;
          Normal.ColorTo := clNone;
          Normal.ColorMirror := clNone;
          Normal.ColorMirrorTo := clNone;
          Normal.BorderColor := $00666666;
          Normal.BorderColor := clNone;
          Normal.GradientMirrorType := gtVertical;

          Disabled.Color := $00666666;
          Disabled.ColorTo := clNone;
          Disabled.ColorMirror := clNone;
          Disabled.ColorMirrorTo := clNone;
          DisabledFont.Color := $00D4D4D4;
          ...
          Hovered.Color := $00505050;
          Hovered.ColorTo := $00505050;
          Hovered.ColorMirror := $00505050;
          Hovered.ColorMirrorTo := $00505050;
          Hovered.BorderColor := $00505050;
          Hovered.GradientMirrorType := gtVertical;
          Hovered.Opacity := 255;
          Hovered.OpacityTo := 255;

          Selected.Color := $00505050;
          Selected.ColorTo := $00505050;
          Selected.ColorMirror := $00505050;
          Selected.ColorMirrorTo := $00505050;
          Selected.BorderColor := $00B1B1B1;
          Selected.GradientMirrorType := gtVertical;

          Down.Color := $00363636;
          Down.ColorTo := $00363636;
          Down.ColorMirror := $00363636;
          Down.ColorMirrorTo := $00363636;
          Down.BorderColor := $00B1B1B1;
          Down.GradientMirrorType := gtVertical;
        end;
      end;
    end;
    ...
    begin
      ...
      begin
        ...
        List.MetroStyle := True;
        Fill.Color := $00363636;
        Fill.ColorTo := $00363636;
        Fill.BorderColor := $00363636;

        with List.Appearance do
        begin
          Normal.Color := $00363636;
          Normal.ColorTo := $00363636;
          Normal.ColorMirror := $00363636;
          Normal.ColorMirrorTo := $00363636;
          Normal.BorderColor := $00363636;
          Normal.GradientMirrorType := gtSolid;

          Disabled.Color := $00363636;
          Disabled.ColorTo := $00363636;
          Disabled.ColorMirror := $00363636;
          Disabled.ColorMirrorTo := $00363636;
          DisabledFont.Color := $00D4D4D4;
          Disabled.BorderColor := $00D4D4D4;
          Disabled.GradientMirrorType := gtSolid;
          ...
          Hovered.ColorMirrorTo := FAppColorHover;
          Hovered.BorderColor := FAppColorHover;
          Hovered.GradientMirrorType := gtSolid;
          Hovered.Opacity := 255;
          Hovered.OpacityTo := 255;
          Hovered.OpacityMirror := 255;
          Hovered.OpacityMirrorTo := 255;
          ...
          Selected.ColorMirrorTo := FAppColorHover;
          Selected.BorderColor := FAppColorDown;
          Selected.GradientMirrorType := gtSolid;
          Selected.Opacity := 255;
          Selected.OpacityTo := 255;
          Selected.OpacityMirror := 255;
          Selected.OpacityMirrorTo := 255;
          ...
          Down.ColorMirrorTo := FAppColorDown;
          Down.BorderColor := FAppColorDown;
          Down.GradientMirrorType := gtSolid;
          Down.Opacity := 255;
          Down.OpacityTo := 255;
          Down.OpacityMirror := 255;
          Down.OpacityMirrorTo := 255;
      ...
      begin
        ...
        begin
          ...
          NormalFont.Color := $FFFFFF;
          HoveredFont.Color := $FFFFFF;
          Normal.Color := $00303132;
          Normal.ColorTo := clNone;
          Normal.ColorMirror := clNone;
          Normal.ColorMirrorTo := clNone;
          Normal.BorderColor := $00303132;
          Normal.BorderColor := clNone;
          Normal.GradientMirrorType := gtVertical;

          Disabled.Color := $00303132;
          Disabled.ColorTo := clNone;
          Disabled.ColorMirror := clNone;
          Disabled.ColorMirrorTo := clNone;
          DisabledFont.Color := clWhite;
          ...
          Hovered.Color := $00686868;
          Hovered.ColorTo := clNone;
          Hovered.ColorMirror := clNone;
          Hovered.ColorMirrorTo := clNone;
          Hovered.BorderColor := $00686868;
          Hovered.GradientMirrorType := gtVertical;
  ...
  or (AStyle = tsWindows10) or (AStyle = tsOffice2016White) or (AStyle = tsOffice2016Gray) or (AStyle = tsOffice2016Black)
  or (AStyle = tsOffice2019White) or (AStyle = tsOffice2019Gray) or (AStyle = tsOffice2019Black) then
