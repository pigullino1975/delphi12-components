...
begin
  ...
  if Assigned(DataSet) then
    ...
    begin
      sel := '';
      if Assigned(FDBPlannerMonthView.Items.Selected) then
      begin
        sel := FDBPlannerMonthView.Items.Selected.DBKey;
      end;
      ...
      begin
        ...
        if sel <> '' then
        begin
          plit := FDBPlannerMonthView.Items.FindKey(sel);
          if Assigned(plit) then
            FDBPlannerMonthView.Items.Select(plit);
        end;
      end;
    end;
end;
