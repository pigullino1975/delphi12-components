...
const
  ...
  // v1.3.2.0 : New : ModalResult property added
  // v1.3.3.0 : New : ImageList support added
  // v1.3.3.1 : Fixed : Memory leak
...
begin
  ...
  DrawButtonContent(ACanvas, R, Caption, '', ShowCaption, Font, FImages, FImageIndex, True, Layout, False, Enabled, DrawFocused,
...
procedure TAdvCustomGlassButton.SetImageIndex(const Value: integer);
begin
...
procedure TAdvCustomGlassButton.SetImages(const Value: TCustomImageList);
begin
