...
begin
  ...
  pic := AdvStringGrid1.CreatePicture(1, 7, True, noStretch, 0,
    haBeforeText, vaCenter);
  pic.Assign(PictureContainer1.Items[0].Picture);

  pic := AdvStringGrid1.CreatePicture(1, 8,  True, noStretch, 0,
    haBeforeText, vaCenter);
  pic.Assign(PictureContainer1.Items[1].Picture);

  pic := AdvStringGrid1.CreatePicture(1, 9, True, noStretch, 0,
    haBeforeText, vaCenter);
