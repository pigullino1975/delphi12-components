...
begin
  ...
  begin
    DBPlanner1.Header.Captions.Add(FormatDateTime('dd/mm/yy',DBDaySource1.Day + i - 1));
  end;

  DBDaySource2.Day := DBDaySource1.Day;

  DBPlanner2.Header.Captions.Clear;
  DBPlanner2.Header.Captions.Add('');
  for i := 1 to DBPlanner2.Positions do
  begin
    DBPlanner2.Header.Captions.Add(FormatDateTime('dd/mm/yy',DBDaySource2.Day + i - 1));
  end;
