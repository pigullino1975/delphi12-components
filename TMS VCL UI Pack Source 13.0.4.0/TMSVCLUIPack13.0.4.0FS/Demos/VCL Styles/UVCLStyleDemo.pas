...
uses
  ...
  Vcl.Controls, AdvGroupBox, Vcl.Forms, Vcl.Dialogs, AdvUtil, AdvGraphics, Vcl.ExtCtrls, AdvScrollControl, AdvResponsiveList, Planner,
  ...
  AdvEdBtn, AdvSmoothGauge, Vcl.Buttons, AdvOfficeButtons;
...
procedure TForm4.AdvOfficeRadioGroup1Click(Sender: TObject);
begin
  case AdvOfficeRadioGroup1.ItemIndex of
    1: TSTyleManager.SetStyle('Luna');
    2: TSTyleManager.SetStyle('Windows10 Dark');
    3: TSTyleManager.SetStyle('Emerald Light Slate');
    4: TSTyleManager.SetStyle('Smokey Quartz Kamri');
    else
