...
const
  ...
  BLD_VER = 10; // Build nr.
  DATE_VER = 'Oct, 2023'; // Month version

  TTMSFNCRichEditorDocURL = 'https://download.tmssoftware.com/doc/tmsfncuipack/components/ttmsfncricheditor/';
  ...
  // v1.7.3.1  : Fixed : Issue with OnChange after clipboard paste
  // v1.7.3.2  : Fixed : Issue with sized images in RTF
  //           : Fixed : Issue with printing with images
  // v1.7.4.0  : New : ResetUndoRedo method added to programmatically reset Undo/Redo stack
  // v1.7.4.1  : Fixed : OnPasteBitmap issue in VCL version of control
  // v1.7.4.2  : Fixed : Issue with setting default font on selected linebreak
  //           : Fixed : Issue with handling text that is wider than the control width
  // v1.7.4.3  : Fixed : Issue with non default ANSI charset handling
  //           : Fixed : Rare issue with long text inserted programmatically
  // v1.7.4.4  : Fixed : Issue with import of centered images from HTML
  //           : Fixed : Cursor navigation, insert, copy & paste caret handling
  // v1.7.4.5  : Improved : Workaround added for mail clients that cannot render &dollar; in HTML encoded correct
  // v1.7.4.6  : Improved : Made InsertFromStream() compatible with filestreams
  //           : Fixed : Issue with hyperlink font color in HTML export
  // v1.7.5.0  : New : Support for TAB during HTML export
  // v1.7.5.1  : Fixed : Issue with TDBAdvRichEditor.Clear
  // v1.7.5.2  : Fixed : Issue with OnChange being triggered during destroy
  // v1.7.5.3  : Fixed : Rare issue with using TAdvRichEditorHTMLIO & font persistence
  // v1.7.6.0  : New : Support for HTML DIV import + support for font settings on SPAN
  //           : New : Support for persisting indent in HTML
  // v1.7.6.1  : Fixed : Small issue with parsing image width / height from HTML file
  // v1.7.7.0  : New : OnBeforePopupMenu event added
  // v1.7.7.1  : Improved : Calling Clear resets the default font
  //           : Fixed : EditCanModify not called within BeginUpdate/EndUpdate block
  // v1.7.7.2  : Fixed : DataSet state issue after assigning DBAdvRichEditor.DataSource
  // v1.7.7.3  : Fixed : Issue with TAdvRichEditorBulletType
  // v1.8.0.0  : New : Tabs collection added to have list of programmable tabs
  //           : New : TAdvRichEditorHorizontalRuler integration
  //           : New : Overloads to specify encoding for HTML export via TAdvRichEditorHTMLIO
  //           : New : SetSelectionRightIndent() method added
  //           : Fixed : Memory leak issue with InsertMultiLineText()
  // v1.8.1.0  : New : Public property RTFAnsiEncoding: boolean added
  //           : New : Property TAdvRichEditorHTMLIO.PlainHTML added
  // v1.8.1.1  : Improved : Font rendering on high DPI screens
  // v1.8.2.0  : Improved : Higher quality image stretching added
  // v1.8.2.1  : Fixed : Issue font import/export in combination with bullets
  // v1.8.2.2  : Fixed : Rare memory issue when using together with EurekaLog
  // v1.8.2.3  : Fixed : Issue with font retrieval from TTabPersistent element
  // v1.8.2.4  : Fixed : Issue with paste from clipboard and caret
  // v1.8.2.5  : Fixed : Issue with unbalanced <P> tag in HTML export
  // v1.8.2.6  : Fixed : Issue with import from HTML with SUB/SUP tags
  // v1.8.2.7  : Fixed : Issue with InsertAsRTF() and update TDBAdvRichEditor
  // v1.8.2.8  : Fixed : Issue with repeated RTE clipboard paste
  // v1.8.2.9  : Fixed : Issue with image resize &nd update in TDBAdvRichEditor
  ...
  // v1.8.2.10 : Fixed : Memory leak OLE drag & drop
  // v1.8.2.11 : Fixed : Issue with backspace on last char
  // v1.8.2.12 : Fixed : Issue with use of system colors and clipboard
  //           : Fixed : Issue with importing base64 encoded picture from HTML
  // v1.8.3.0  : New : SelectError() returns the last found element where an error was found
  // v1.8.3.1  : Fixed : Issue with AddText(text,font) overload and text color
  // v1.8.3.2  : Fixed : Issue with parsing inline images in HTML files
  // v1.8.3.3  : Fixed : Issue with RTF generation with multiple hyperlinks
  // v1.8.3.4  : Fixed : Issue with Hyperlink handling and linebreaks in RTF
  // v1.8.4.0  : New : Support for IME based emoticon entry
  //           : Improved : Drawing performance
  // v1.8.4.1  : Fixed : Issue with ReadOnly and clipboard copy
  // v1.8.4.2  : Fixed : Issue with char indexing on mobile platform
  // v1.8.5.0  : New : Head property added to TAdvRichEditorHTMLIO
  //           : New : BodyClass property added to TAdvRichEditorHTMLIO
  // v1.8.5.1  : Fixed : Issue with HTML import & export when hyperlinks are used
  // v1.8.5.2  : Fixed : Issue with parsing bullets from RTF
  // v1.8.5.3  : Fixed : Issue with InsertAsRTF() position
  // v1.8.5.4  : Fixed : Issue with exporting extremely large pictures to RTF
  // v1.8.5.5  : Fixed : Rare issue with & followed by space character
  // v1.8.6.0  : New : Image hint export to HTML support added
  //           : Improved : Caret position after dbl-click to select a word
  //           : Fixed : Issue with HTML BODY font-family parsing
  // 1.8.6.1   : Fixed : Issue with PrevChar after non text element
  // 1.8.6.2   : Fixed : Issue with hovering over text with hints
  // 1.8.6.3   : Fixed : Issue with delete char and TDBAdvRichEditor
  // 1.8.6.4   : Fixed : Rare HTML generation issue with text background color
  // 1.8.6.5   : Fixed : Rare issue of actions in combination with ribbon toolbar
  // 1.8.6.6   : Improved : Zoom handling
  // 1.8.6.7   : Fixed : Issue with getting button control from compact ribbon toolbar
  // 1.8.6.8   : Fixed : Issue with TDBAdvRichEditorRTFIO when destroying component
  // 1.8.7.0   : New : Added HyperLinkTarget property in TAdvRichEditorHTMLIO
  //           : New : Added Target parameter in AdvRichEditor.GetContentAsHTML
  // 1.8.7.1   : Improved : Performance
  // 1.8.7.2   : Improved : Popup toolbar behavior in high DPI
  // 1.8.7.3   : Fixed : Issue with parsing unicode chars from RTF
  // 1.8.7.4   : Fixed : Issue with DblClick select for text with different alignments
  // 1.8.7.5   : Fixed : Isse with clipping and use of large images
  // 1.8.7.6   : Improved : HTML rendering for bullet lists
  //           : Improved : Format hotkey handling
  // 1.8.7.7   : Fixed : Issue with HighlightColor, HighLightTextColor
  // 1.8.7.8   : Fixed : Issue with setting line alignment from linebreak
  //           : Fixed : Issue with caret after selection dlb click
  // 1.8.7.9   : Fixed : Issue with persisting system colors to stream
  // 1.8.8.0   : New : Support for named picture element export to PDF
  //           : Improved : Font initialization in TAdvRichEditorFormatButtonBar
  // 1.8.8.1   : Fixed : Issue with ClearSelection and caret position
  // 1.8.8.2   : Fixed : Rare wordwrap rendering issue
  // 1.8.8.3   : Improved : Caret position handling after SetSelection* calls
  // 1.8.8.4   : Fixed : Issue with empty blob fields with TDBAdvRichEditor
  // 1.8.8.5   : Fixed : Issue with incorrect selection change after changing format in specific circumstances
  // 1.8.8.6   : Fixed : Issue with HTML export in connection with wordwrap
  // 1.8.8.7   : Fixed : Rare issue with RTF font parsing and bullets
  //           : Fixed : Rare issue with long URLs and wordwrap
  // 1.8.8.8   : Fixed : Issue with parsing alignment information from RTF
  // 1.8.8.9   : Improved : HTML parser to handle <BR/> as well as <BR>
  // 1.8.8.10  : Fixed : Issue with HTML parser with <BR /> tags
  // 1.8.9.0   : New : Auto completion capabilities
  //           : New : Text property is read/write now
  //           : Improved : URL detection
  // 1.8.9.1   : Fixed : Issue with selection after handling OnClickHyperLink
  // 1.8.9.2   : Fixed : Issue with RTF import and line-height of zero-length lines
  // 1.8.9.3   : Fixed : Issue with importing RTF for alignment on pictures
  // 1.8.9.4   : Improved : Handling input of multiline text with different linefeed characters
  // 1.8.9.5   : Fixed : Issue with return key when default mrOK button is on the form
  // 1.8.9.6   : Fixed : Issue with setting element colors to Windows system color values
  //           : Fixed : Issue with persisting tabs in streams
  // 1.8.9.7   : Fixed : Issue with paste in empty TAdvRichEditor
  // 1.8.9.8   : Fixed : Issue with CSS font size parsing in HTML import
  // 1.8.9.9   : Fixed : Issue with SaveToStream/LoadFromStream and selection
  // 1.8.9.10  : Fixed : Importing HTML special characters &sup2; &sup3;
...
{$ENDIF}
  ...
  TPasteBitmapEvent = procedure(Sender: TObject; ABitmap: {$IFNDEF FNCLIB}TBitmap{$ELSE}TTMSFNCBitmap{$ENDIF}; var Allow: boolean) of object;
  ...
  TPopupMenuEvent = procedure(Sender: TObject; APopupMenu: TPopupMenu) of object;
  ...
  {$ENDIF}
    ...
    FOnBeforePopupMenu: TPopupMenuEvent;
...
{$IFDEF TMSPACK}
    ...
    function GetNamedPicture(AElement: TNamedPictureElement): TGDIPPicture; override;
{$ENDIF}
    {$IFDEF ANDROIDSUPPORT}
    procedure AddGlyph(ABitmap: TTMSFNCBitmap; AWidth, AHeight: Single); override;
    {$ENDIF}
    ...
    procedure DoPasteBitmap(ABitmap: {$IFNDEF FNCLIB}TBitmap{$ELSE}TTMSFNCBitmap{$ENDIF}; var Allow: boolean); virtual;
    ...
    procedure AutoComplete(WordBefore, WordsBefore: string; var ACompletion: string); virtual;
    {$IFDEF USEVCLSTYLES}
    ...
    procedure SetZoomFactor(const Value: double); override;
  ...
  public
    ...
    property ContextMenu: TPopupMenu read FPopupMenu;
  ...
  {$ENDIF}
    ...
    property WantReturn default true;

    property OnBeforePopupMenu: TPopupMenuEvent read FOnBeforePopupMenu write FOnBeforePopupMenu;
...
{$ENDIF}
{$IFDEF FMXLIB}
  , FMX.TMSFNCStyles, System.UIConsts, Character
{$ENDIF}
  ;
...
begin
  ...
  if (FSizeTimer mod 10 = 0) and FSizeUpdate then
  begin
    UpdateSize;
    FSizeUpdate := false;
  end;
...
procedure TAdvRichEditor.AutoComplete(WordBefore, WordsBefore: string; var ACompletion: string);
begin
  if Assigned(OnAutoComplete) then
    OnAutoComplete(Self, WordBefore, WordsBefore, ACompletion);
end;
...
begin
  ...
  Result := TColor( b + g + r);
  {$IFDEF FMXLIB}
  Result := $FF000000 + (Result and $FF00) + ((Result and $FF) shl 16) +  ((Result and $FF0000) shr 16);
  {$ENDIF}
end;
...
begin
  ...
  {$IFDEF FMXLIB}
  Result := $FF000000 + (Result and $FF00) + ((Result and $FF0000) shr 16) + (Result and $FF shl 16);
  {$ENDIF}
end;
...
function IsNumHexChar(ch: char; AllowHex: boolean): boolean;
begin
  Result := IsNumChar(ch);
  if AllowHex and not Result then
  begin
...
var
  ...
  imgstream: TStream;
  tagc,hexc: char;
  htmlnumchar,htmlhexchar: boolean;
  sq,dq,hn,he,fntsize,fnterr: integer;
  firstchar: boolean;
    ...
    begin
      ...
      begin
        ...
        begin
          ...
          begin
            if not IsCharInStr(CharInStr(HtmlValue, PP), '>') then
              inc(PP);
          end;
        end;
        ...
        IDXTXT := IndexText(TagName, ['B', '/B', 'STRONG', '/STRONG', 'I', '/I',
                                  ...
                                  'XML','/XML','!--','STYLE','/STYLE','BODY','/BODY','TITLE','/TITLE','STRIKE','/STRIKE','DIV','/DIV','BR/','BR /']);
        ...
        case IDXTXT of
             ...
             begin                  { <IMG> }
               ...
               begin
                 ...
                 begin
                   ...
                   begin
                     InsertImage(sIdx, StrToInt(imgw), StrToInt(imgh)).Alignment := fParAlign;
                   end
                   else
                     InsertImage(sIdx).Alignment := fParAlign;
               ...
               begin
                 ...
                 try
                   if (imgw <> '') and (imgh <> '') then
                   begin
                     InsertImage(imgstream, StrToInt(imgw), StrToInt(imgh)).Alignment := fParAlign;
                   end
                   else
                     InsertImage(imgstream, 0, 0).Alignment := fParAlign;
           ...
           20:
             begin
               ...
               begin
                 bs.Font.Assign(GetDefaultFont);
                 bs.TextColor := GetDefaultFontColor;
                 bs.Color := Color;
               end;
           ...
           26: //  FONT
             begin
               ...
               clr := StripQuotes(TagParams.Values['STYLE']);
               fsize := Uppercase(clr);
               if (fsize <> '') then
               begin
                 ...
                 if (fsi > 0) then
                 begin
                   fface := Trim(Copy(clr,fsi + 12, Length(fsize)));
                 ...
                 begin
                   ...
                   Val(fsize, fntsize, fnterr);

                   if fnterr = 0 then
                     SetSelectionFontSize(fntsize);
                 end;
              end;
           ...
           28,43:  // SPAN, DIV
             begin
               ...
               begin
                 ...
                 fsi := Pos('FONT-FAMILY:',clr);
                 if (fsi > 0) then
                 begin
                   fface := Trim(Copy(clr,fsi + 12, Length(clr)));
                   ...
                   repeat
                     ...
                     if (fsi <= Length(clr)) and (stylechar <> '"') and (stylechar <> ';') then
                       inc(fsi)
                     else
                       isFace := false;
                 ...
                 fsi := Pos('FONT-SIZE:',clr);

                 if (fsi > 0) then
                 begin
                   clr := Trim(Copy(clr,fsi + 10, Length(clr)));

                   fsi := 1;
                   while (fsi <= Length(clr)) and IsNumChar(CharInStr(clr,fsi)) do
                     inc(fsi);

                   clr := Copy(clr,1,fsi - 1);

                   SetSelectionFontSize(strtoint(clr));
                 end;

                 clr := Uppercase(TagParams.Values['STYLE']);

                 fsi := Pos('MARGIN-LEFT:',clr);

                 if (fsi > 0) then
                 begin
                   clr := Trim(Copy(clr,fsi + 12, Length(clr)));
           ...
           37:  // BODY
             begin
               ...
               begin
                 ...
                 if (fsi > 0) then
                 begin
                   clr := Trim(Copy(clr,fsi + 12, Length(fsize)));

                   if CharInStr(clr,1) = '"' then
                     Delete(clr,1,1);
                   ...
                   fsi := 1;
                   while IsAlphaChar(CharInStr(clr,fsi)) or (CharInStr(clr,fsi) = ' ') do
                     inc(fsi);

                   fsize := Copy(clr,1,fsi - 1);
      ...
      begin
        ...
        begin
          ...
          begin
            ...
            htmlhexchar := false;
            hexc := CharInStr(HtmlValue, PP);

            if (hexc = 'x') or (hexc = 'X') then
            begin
              htmlhexchar := true;
              inc(pp);
            end;

            while IsNumHexChar(CharInStr(HtmlValue, PP), htmlhexchar) do Inc(PP);
          ...
          begin
            firstchar := true;
            while IsAlphaChar(CharInStr(HtmlValue, PP)) or (not firstchar and IsAlphaNumChar(CharInStr(HtmlValue, PP))) do
            begin
              Inc(PP);
              firstchar := false;
            end;
          ...
          if (LastIndent > 0) and Assigned(LastInsertElement) then
          begin
            LastInsertElement.LeftIndent := LastIndent;
          end;
        ...
        begin
          ...
          begin
            ...
            SetCaret(cpEndDoc);
            Caret.Element.LeftIndent := LastIndent;
...
begin
  ...
  if Assigned(FToolBarList) then
    ...
    {$ENDIF}
    {$IFDEF LCLLIB}
      ITMSRichEditorToolBar(FToolBarList[I]).UpdateToolBar;
    {$ENDIF}
end;
...
{$IFDEF FMXLIB}
procedure TAdvRichEditor.DialogKey(var Key: Word; Shift: TShiftState);
begin
  if (Key = KEY_TAB) and WantTab then
  begin
    InsertTab;
    Key := 0;
    SetFocus;
...
procedure TAdvRichEditor.DoPasteBitmap(ABitmap: {$IFNDEF FNCLIB}TBitmap{$ELSE}TTMSFNCBitmap{$ENDIF}; var Allow: boolean);
begin
...
{$IFDEF FMXLIB}
  ...
  r.Right := r.Right - PageMargin.RightIndent;
...
begin
  ...
  if Assigned(el) and (el is TTextElement) and not singlelb then
  begin
  ...
  begin
    if Assigned(Caret.Element) and (Caret.Element is TLineBreakElement) and singlelb then
    begin
      SetFontName(ACanvas.Font, GetFontName(Caret.Element.Font));
      ACanvas.Font.Size := GetFontSize(Caret.Element.Font);
    end
    else
    begin
  ...
  ACanvas.Font.Height := Round(ACanvas.Font.Height * ZoomFactor);
...
begin
  ...
  begin
    ...
    Canvas.Font.Size := Round(Canvas.Font.Size * ZoomFactor);
  end;
...
begin
  ...
  begin
    ...
    ACanvas.Font.Charset := el.FontCharset;
  ...
  begin
    ...
    r := Rect(x,y - Round(LineDescent * dpi),x + Round((el as TCustomGraphicElement).DrawSize.cx * dpi * ZoomFactor), y - Round(LineDescent * dpi) + Round((el as TCustomGraphicElement).DrawSize.cy * dpi * ZoomFactor));
    ...
    begin
      ...
      begin
        ...
        begin
          ...
          ACanvas.Fill.Color := HighlightColor;
          ACanvas.FillRect(RectF(Floor(r.Left) + 0.5, r.Top, Round(r.Left + tw) + 1.5, r.Bottom), 0, 0, AllCorners, AbsoluteOpacity);
      ...
      begin
        ...
        begin
          if (pw > 0) and (ph > 0) then
            ...
            pic.Draw(ACanvas, RectF(x + PICTURE_MARGIN div 2, y, x + PICTURE_MARGIN
              div 2 + pic.Width, y + pic.Height));
        end;
      end;
      {$ENDIF}
      {$IFNDEF SVGSUPPORT}
...
{$IFDEF ANDROIDSUPPORT}
procedure TTMSFNCRichEditor.AddGlyph(ABitmap: TTMSFNCBitmap; AWidth, AHeight: Single);
begin
  InsertImage(ABitmap, Round(AWidth), Round(AHeight));
end;
{$ENDIF}
...
{$IFNDEF FMXLIB}
  ...
  R := ClientRect;
  R.Left := R.Right - PageMargin.RightIndent;
  ACanvas.FillRect(r);
{$ENDIF}
...
begin
  ...
  ts.SystemFont := false;
  ts.Opaque := true;
  ACanvas.TextRect(r, r.Left, r.Top, s, ts);
...
{$IFDEF TMSPACK}
function TAdvRichEditor.GetNamedPicture(AElement: TNamedPictureElement): TGDIPPicture;
begin
  if (AElement is TEmoticonPictureElement) then
    Result := GetPictureByName(Emoticons, (AElement as TEmoticonPictureElement).Name)
  else
    Result := GetPictureByName(PictureContainer, (AElement as TNamedPictureElement).Name);
end;
...
begin
  ...
  sz.cx := Round(sz.cx * DPIratio * ZoomFactor);
  sz.cy := Round(sz.cy * DPIratio * ZoomFactor);
...
begin
  ...
  if (DPIRatio > 1) and (AValue <> '') and (AValue[length(AValue)] = ' ')  then
     AValue[length(AValue)] := 'u';
  ...
  dr := Rect(0,0,$FFFF,$FFFF);

  {$IFDEF LCLLIB}
  dr.Right := ACanvas.TextWidth(AValue);
  dr.Bottom := ACanvas.TextHeight(AValue);
  {$ENDIF}

  {$IFNDEF LCLLIB}
  DrawText(ACanvas.Handle, PChar(AValue), Length(AValue), dr, DT_CALCRECT + DT_LEFT or DT_EDITCONTROL or DT_NOPREFIX);
  {$ENDIF}

  Result.cx := Round(dr.Right * ZoomFactor);

  if not EqualFont(FCacheFont, ACanvas.Font) {$IFNDEF FNCLIB}and not FIsPrinting{$ENDIF} then
  begin
    FCacheHeight := Round(ACanvas.TextHeight(TextForHeight) * ZoomFactor);
...
begin
  ...
  if Assigned(OnBeforePopupMenu) then
    OnBeforePopupMenu(Self, FPopupMenu);
...
begin
  ...
  if ReadOnly then
  begin
    if (Key in [VK_C]) and (AState = ccCtrl) then
    begin
  ...
  {$IFDEF FMXLIB}
  if (Key = KEY_RETURN) and WantReturn then
  begin
...
{$ENDIF}
  IsShift: boolean;
  WordBefore, WordsBefore, WordsAfter: string;
...
begin
  ...
  begin
    if FPrediction <> '' then
    begin
      InsertChar(FPrediction);
      Caret.CharIndex := Caret.CharIndex + Length(FPrediction) - 1;

      if Caret.CharIndex > Length(Caret.Element.Text) then
  ...
  begin
    {$IFDEF FMXLIB}
    FBuffer := FBuffer + Key;
    if not Key.IsHighSurrogate then
    begin
      InsertChar(FBuffer);
      FBuffer := '';
    end;
    ...
    if AutoCompletion.Enabled then
    begin
      GetWordsAtCaret(WordBefore, WordsBefore, WordsAfter);
      if (WordsAfter = '') and (Length(WordBefore) >= AutoCompletion.NumChars) then
      begin
        if AutoCompletion.Words.Count > 0 then
        begin
          AutoCompletion.Words.AutoComplete(WordBefore, FPrediction);
        end;

        AutoComplete(WordBefore, WordsBefore, FPrediction);

        if pos(Uppercase(WordBefore), Uppercase(FPrediction)) = 1 then
          Delete(FPrediction, 1, Length(WordBefore));
      end;
    end;
  end;
end;
...
begin
  ...
  inarea := (x >= PageMargin.Horizontal) and (y >= PageMargin.Vertical) and (x <= CtrlWidth - PageMargin.RightIndent);

  if x < PageMargin.Horizontal then
    x := PageMargin.Horizontal + 3;
  if y < PageMargin.Vertical then
    y := PageMargin.Vertical + 3;
  if x > CtrlWidth - PageMargin.RightIndent then
    x := CtrlWidth - PageMargin.RightIndent;
  ...
  begin
    ...
    begin
      {$IFDEF USEVCLSTYLES}
      dpi := GetDPIScale(Self,Canvas);
      {$ELSE}
      dpi := 1;
      {$ENDIF}
      PT := ClientToScreen(Point(Selection.FromXY.X, Selection.FromXY.Y - Round(54 * dpi)));
...
begin
  ...
  {$IFNDEF FMXLIB}
  if (FPrediction <> '') and Assigned(Caret.Element) then
  begin
    Canvas.Font.Assign(Caret.Element.Font);
    Canvas.Font.Color := AutoCompletion.TextColor;
    DrawTextN(Canvas, FPrediction, Rect(Caret.XY.X, Caret.XY.Y, Caret.XY.X + Width, Caret.XY.Y + Caret.LH), 0);
  end;
  {$ENDIF}
...
begin
  ...
  try
    if clp.HasFormat(TTMSFNCClipBoardFormat.cfRichTextStream) and (cfRTF in ClipboardFormats) then
    begin
    ...
    if clp.HasFormat(TTMSFNCClipBoardFormat.cfRTF) and not didRTF and (cfRTF in ClipboardFormats) then
    begin
      rtfvalue := clp.GetRTF;
    ...
    if clp.HasFormat(TTMSFNCClipBoardFormat.cfBitmap) and (cfBMP in ClipboardFormats) then
    begin
      PushContext;
    ...
    if clp.HasFormat(TTMSFNCClipBoardFormat.cfText) and not didRTF and (cfText in ClipboardFormats) then
    begin
      Result := clp.GetText;
...
{$IFNDEF FNCLIB}
  ...
  begin
    CalcLine(ACanvas, 0, -1, FElementIndex, WordIndex, MaxLineWidth, LW, LH, ToElementIndex, ToWordIndex, Descent, BaseLine, Indent, FAlign);
...
begin
  ...
  if WantTab or AutoCompletion.Enabled then
...
{$IFDEF DELPHITOKYO}
procedure TAdvRichEditor.WMIMEStartComposition(var Message: TMessage);
begin
  FIMEPos := 0;
end;

procedure TAdvRichEditor.WMIMEEndComposition(var Message: TMessage);
begin
  FIMEPos := 0;
end;

procedure TAdvRichEditor.WMIMEComposition(var Message: TMessage);
var
  hHimc: THandle;
...
begin
  hHimc := ImmGetContext (Handle);
  if hHimc = 0 then
    Exit;

  fillchar (buf, 255, 0);
  ImmGetCompositionString (hHimc, GCS_COMPSTR, @buf, 255);

  //outputdebugstring(pchar('total buffer:'+IntToHex(Ord(buf[0]),4)+'/'+IntToHex(Ord(buf[1]),4)+'/'+IntToHex(Ord(buf[2]),4)+'/'+IntToHex(Ord(buf[3]),4)+'/'+IntToHex(Ord(buf[5]),4)));
  ...
  p := FIMEPos;
  normstr := PWideChar(@buf[p]);
  NormalizeString(NormalizationKC, normstr, -1, buf, 255);
  s := WideCharToString(normstr);
  InsertText(s);
  TidyElements;

  if Ord(buf[p]) and $D800 = $D800 then
    FIMEPos := FIMEPos + 2
  else
    FIMEPos := FIMEPos + 1;
end;

procedure TAdvRichEditor.WMIMERequest(var Message: TMessage);
const
...
var
  charpos:^tagIMECHARPOSITION;
  pt: TPoint;
begin
  if message.WParam = IMR_QUERYCHARPOSITION then
  begin
    charpos := pointer( message.LParam);
    pt := ClientToScreen(caret.XY);
    pt.Y := pt.Y + caret.LH;
    charpos^.pt := pt;
    message.Result := 1;
  end;
...
begin
  ...
  FRichEditor.InsertFromStreamInt(AStream, 1, true);
end;
...
begin
  ...
  if pt.x > FRichEditor.Width - FRichEditor.PageMargin.RightIndent then
    pt.x := FRichEditor.Width - FRichEditor.PageMargin.RightIndent;
