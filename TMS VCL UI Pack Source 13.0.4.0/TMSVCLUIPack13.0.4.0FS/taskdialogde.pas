...
type
  ...
  {$IFDEF DELPHIXE_LVL}
  TAdvMultiInputQueryDialogEditor = class(TDefaultEditor)
  public
    function GetVerb(Index: Integer):string; override;
    function GetVerbCount: Integer; override;
    procedure ExecuteVerb(Index: Integer); override;
...
{ TAdvMultiInputQueryDialogEditor }

procedure TAdvMultiInputQueryDialogEditor.ExecuteVerb(Index: Integer);
//var
//  AppIsParent: boolean;
begin
  inherited;
  case Index of
    0:
    begin
      //AppIsParent := TAdvCustomMultiInputQueryDialog(Component).ApplicationIsParent;
      //TAdvCustomMultiInputQueryDialog(Component).ApplicationIsParent := true;
      TAdvCustomMultiInputQueryDialog(Component).Execute(true);
      //TCustomAdvTaskDialog(Component).ApplicationIsParent := AppIsParent;
    end;
  end;
end;

function TAdvMultiInputQueryDialogEditor.GetVerb(Index: Integer): string;
begin
  case Index of
  0: Result := 'Preview';
  end;
...
function TAdvMultiInputQueryDialogEditor.GetVerbCount: Integer;
begin
  Result := 1;
end;
