...
uses
  ...
  // v1.2.0.1 : Fixed : Issue with repeatedly initializing the TAdvGridColumnPicker
...
procedure TAdvGridColumnPicker.Clear;
begin
  FGridFieldChooser.ButtonListbox1.Items.Clear;
end;
