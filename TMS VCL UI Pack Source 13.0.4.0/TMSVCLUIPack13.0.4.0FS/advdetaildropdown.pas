...
{$IFNDEF DELPHIXE10_LVL}
procedure TAdvDetailDropDown.ChangeScale(M, D: Integer);
begin
  inherited;
...
{$IFDEF DELPHIXE10_LVL}
procedure TAdvDetailDropDown.ChangeScale(M, D: Integer; isDpiChange: Boolean);
begin
  inherited;
  FDPIScale := GetDPIScale(Self,nil);
end;
...
begin
  ...
  begin
    ...
    begin
      ...
      HTMLDrawEx(Canvas, Items[Index].Notes,R,Images,-1,-1,-1,-1,2,false,false,false,false,false,false,true,false,'',1.0,clBlue,clNone,clNone,clGray,a,sv,fa,ah,xs,ys,hl,ml,hr,cr, CID,CV,CT,nil,nil,0,1);
    end;
  end;
end;
...
begin
  ...
  ASize.cy := Round(FItemHeight * FDPIScale);
end;
