...
const
  ...
  // 1.5.1.1 : Fixed : VCL styles check updated to work in 10.4 Sydney
  // 1.6.0.0 : New : Support for Emoji rendering in HTML
  // 1.6.0.1 : Fixed : Issue with popup positioning on high DPI
  // 1.6.1.0 : New : Event OnCreated added that is triggered when the internal popup window is created
...
uses
  Commctrl, ShellApi, AdvStyleIF, AdvHTML
  {$IFDEF DELPHIXE2_LVL}
  , VCL.Themes
  {$ENDIF}
  ;
