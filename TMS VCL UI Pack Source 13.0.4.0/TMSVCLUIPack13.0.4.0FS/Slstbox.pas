...
const
  ...
  // 2.0.0.1 : Fixed : VCL styles check updated to work in 10.4 Sydney
  // 2.0.1.0 : New : Added compatibility with TVirtualImageList
...
{$NODEFINE TOwnerDrawState}
 ...
 {---------------------------------------------------------}
  ...
  private
    ...
    FSubItemImages: TCustomImageList;
    ...
    procedure SetSubItemImages(const Value: TCustomImageList);
  ...
  published
   { Published declarations }
    ...
    {$ENDIF}
    property SubItemImages: TCustomImageList read FSubItemImages write SetSubItemImages;
...
procedure TSectionListBox.SetSectionImages(const Value: TCustomImageList);
begin
  FSectionImages := Value;
end;

procedure TSectionListBox.SetSubItemImages(const Value: TCustomImageList);
begin
