...
const
  ...
  //v1.0.0.1 : Fixed : Image scales when Imagelist or PictureContainer is used or it is a SVG
...
uses
  CommCtrl, ShellApi, GDIPHTMLEngine, CustomItemsContainer;
...
begin
  ...
  begin
    ...
    begin
      r.X := r.X + imgw + Spacing;
      r.Width := r.Width - imgw - Spacing;
    end;
    Result := r;
