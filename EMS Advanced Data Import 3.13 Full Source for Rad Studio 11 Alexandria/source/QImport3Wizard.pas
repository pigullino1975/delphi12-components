...
uses
  ...
  QImport3InfoPanel,
  QImport3XML,
  {$IFDEF HTML}QImport3HTML,{$ENDIF}
  {$IFDEF XMLDOC}QImport3XMLDoc,{$ENDIF}
  {$IFDEF XLSX}QImport3Xlsx, QImport3XlsxMapParser,{$ENDIF}
...
type
  ...
  private
    ...
    FOnImportCheckField: TImportCheckFieldEvent;
    FOnSetFieldValueAction: TSetFieldValueActionEvent;
    FOnCancelSetFieldValue: TCancelSetFieldValueEvent;
  ...
  published
    ...
    property FieldFormats: TQImportFieldFormats read FFieldFormats write SetFieldFormats;
    ...
    property ImportRecCount: Integer read FImportRecCount write FImportRecCount default 0;
    property AutoTrimValue: Boolean read FAutoTrimValue write FAutoTrimValue default False;
    property ImportEmptyRows: Boolean read FImportEmptyRows write FImportEmptyRows default True;
    property SkipInvisibleColumns: Boolean read FSkipInvisibleColumns write FSkipInvisibleColumns default False;

    property CommitRecCount: Integer read FCommitRecCount write FCommitRecCount default 1000;
    property CommitAfterDone: boolean read FCommitAfterDone write FCommitAfterDone default False;
    property ErrorLog: boolean read FErrorLog write FErrorLog default False;
    property ErrorLogFileName: qiString read FErrorLogFileName write FErrorLogFileName;
    property RewriteErrorLogFile: boolean read FRewriteErrorLogFile write FRewriteErrorLogFile default True;
    property ShowErrorLog: boolean read FShowErrorLog write FShowErrorLog default False;
    property ShowProgress: boolean read FShowProgress write FShowProgress default True;
    property AutoChangeExtension: boolean read FAutoChangeExtension write FAutoChangeExtension default True;
    property ShowHelpButton: boolean read FShowHelpButton write FShowHelpButton default True;
    property CloseAfterImport: boolean read FCloseAfterImport write FCloseAfterImport default False;
    property Picture: TPicture read FPicture write SetPicture;
    property TextViewerRows: Integer read FTextViewerRows write FTextViewerRows default 20;
    property CSVViewerRows: Integer read FCSVViewerRows write FCSVViewerRows default 20;
    property ExcelViewerRows: Integer read FExcelViewerRows write FExcelViewerRows default 256;
    property ExcelMaxColWidth: Integer read FExcelMaxColWidth write FExcelMaxColWidth default 130;

    property ShowSaveLoadButtons: boolean read FShowSaveLoadButtons write FShowSaveLoadButtons default True;

    property TemplateFileName: qiString read FTemplateFileName write FTemplateFileName;
    property AutoLoadTemplate: boolean read FAutoLoadTemplate write FAutoLoadTemplate default False;
    property AutoSaveTemplate: boolean read FAutoSaveTemplate write FAutoSaveTemplate default False;
    property GoToLastPage: boolean read FGoToLastPage write FGoToLastPage default False;

    property ImportDestination: TQImportDestination read FImportDestination write FImportDestination default qidDataSet;
    property ImportMode: TQImportMode read FImportMode write FImportMode default qimInsertAll;
    property AddType: TQImportAddType read FAddType write FAddType default qatAppend;
    property KeyColumns: TStrings read FKeyColumns write SetKeyColumns;
    property GridCaptionRow: Integer read FGridCaptionRow write FGridCaptionRow default -1;
    property GridStartRow: Integer read FGridStartRow write FGridStartRow default -1;
    property ConfirmOnCancel: boolean read FConfirmOnCancel write FConfirmOnCancel default True;

    property OnBeforeImport: TNotifyEvent read FOnBeforeImport write FOnBeforeImport;
    property OnAfterImport: TNotifyEvent read FOnAfterImport write FOnAfterImport;
    property OnImportRecord: TNotifyEvent read FOnImportRecord write FOnImportRecord;
    property OnImportError: TNotifyEvent read FOnImportError write FOnImportError;
    property OnImportErrorAdv: TNotifyEvent read FOnImportErrorAdv write FOnImportErrorAdv;
    property OnNeedCommit: TNotifyEvent read FOnNeedCommit write FOnNeedCommit;
    property OnImportCancel: TImportCancelEvent read FOnImportCancel write FOnImportCancel;
    property OnBeforePost: TImportBeforePostEvent read FOnBeforePost write FOnBeforePost;
    property OnLoadTemplate: TImportLoadTemplateEvent read FOnLoadTemplate write FOnLoadTemplate;
    property OnDestinationLocate: TDestinationLocateEvent read FOnDestinationLocate write FOnDestinationLocate;
    property OnError: TImportErrorEvent read FOnError write FOnError;

    property OnImportCheckField: TImportCheckFieldEvent read FOnImportCheckField write FOnImportCheckField;
    property OnSetFieldValueAction: TSetFieldValueActionEvent read FOnSetFieldValueAction write FOnSetFieldValueAction;
    property OnCancelSetFieldValue: TCancelSetFieldValueEvent read FOnCancelSetFieldValue write FOnCancelSetFieldValue;
  end;
...
//    beDocxFillGrid: TBevel;
    ...
    chSkipInvisibleColumns: TCheckBox;
    rbtAccess97_2003: TRadioButton;
    paXlsxWorkArea: TPanel;
    paXlsxGridArea: TPanel;
    XlsxSplitter: TSplitter;
    paXlsxToolbarArea: TPanel;
    paCSVWorkArea: TPanel;
    CSVSplitter: TSplitter;
    paCSVGridArea: TPanel;
    paCSVToolbarArea: TPanel;
    paHTMLWorkArea: TPanel;
    paHTMLGridArea: TPanel;
    HTMLSplitter: TSplitter;
    paHTMLToolbarArea: TPanel;
    paDocxWorkArea: TPanel;
    DocxSplitter: TSplitter;
    paDocxGridArea: TPanel;
    paDocxToolbarArea: TPanel;
    paXLSWorkArea: TPanel;
    paXLSGridArea: TPanel;
    paXLSToolbarArea: TPanel;
    XLSSplitter: TSplitter;
    paXMLDocFields: TPanel;
    paXMLDocWorkArea: TPanel;
    paXMLDocGridArea: TPanel;
    XMLDocSplitter: TSplitter;
    paXMLDocToolbarArea: TPanel;
    paODSWorkArea: TPanel;
    ODSSplitter: TSplitter;
    paODSGridArea: TPanel;
    paODSToolbarArea: TPanel;
    paODTWorkArea: TPanel;
    ODTSplitter: TSplitter;
    paODTGridArea: TPanel;
    paODTToolbarArea: TPanel;
    paTXTWorkArea: TPanel;
    TXTSplitter: TSplitter;
    paTXTGridArea: TPanel;
    paTXTToolbarArea: TPanel;
    paImage: TPanel;
    paImportType: TPanel;
    paTXTOptions: TPanel;
    paDBFOptions: TPanel;
    paAccessOptions_01: TPanel;
    paAccessOptions_02: TPanel;
    paCommitOptions: TPanel;
    paCSVOptions: TPanel;
    paDocxOptions: TPanel;
    paExcelOptions: TPanel;
    paFormats: TPanel;
    paHTMLOptions: TPanel;
    paXMLOptions: TPanel;
    paODSOptions: TPanel;
    paODTOptions: TPanel;
    paXlsxOptions: TPanel;
    paXMLDocOptions: TPanel;
    paCommit: TPanel;
    paAdvanced: TPanel;
    paBaseFormats: TPanel;
    paDataFormats: TPanel;
    paFieldTuning: TPanel;
    laXMLEncoding: TLabel;
    cmbXMLEncoding: TComboBox;
    ...
    procedure BeforePost(Sender: TObject; Row: TQImportRow; var Accept: Boolean);
    procedure DestinationLocate(Sender: TObject; KeyColumns: TStrings;
      Row: TQImportRow; var KeyFields: string; var KeyValues: Variant);
    procedure ImportCheckField(Sender: TObject; Field: TField; AValue: qiString);
    procedure SetFieldValueAction(Sender: TObject; DataSet: TDataSet; Col: TQImportCol);
    procedure CancelSetFieldValue(Sender: TObject; Field: TField; var Cancel: Boolean);
    ...
    procedure lstFormatFieldsChange(Sender: TObject; Item: TListItem; Change: TItemChange);
    ...
    procedure lstDBFDataSetChange(Sender: TObject; Item: TListItem; Change: TItemChange);
    procedure lstDBFChange(Sender: TObject; Item: TListItem; Change: TItemChange);
    procedure lstDBFMapChange(Sender: TObject; Item: TListItem; Change: TItemChange);
    procedure sgrCSVDrawCell(Sender: TObject; ACol, ARow: Integer; Rect: TRect; State: TGridDrawState);
    procedure edtCSVSkipLinesChange(Sender: TObject);
    procedure btnCSVClearClick(Sender: TObject);
    procedure sgrCSVMouseDown(Sender: TObject; Button: TMouseButton; Shift: TShiftState; X, Y: Integer);
    ...
    procedure KeyColumnsDragOver(Sender, Source: TObject; X, Y: Integer; State: TDragState; var Accept: Boolean);
    procedure KeyColumnsDragDrop(Sender, Source: TObject; X, Y: Integer);
...
{    procedure lvXLSFieldsSelectItem(Sender: TObject; Item: TListItem;
    ...
    procedure bDBFAddMouseDown(Sender: TObject; Button: TMouseButton; Shift: TShiftState; X, Y: Integer);
    procedure bDBFAddMouseUp(Sender: TObject; Button: TMouseButton; Shift: TShiftState; X, Y: Integer);
    procedure pbDBFAutoFillPaint(Sender: TObject);
    procedure bDBFAutoFillMouseDown(Sender: TObject; Button: TMouseButton; Shift: TShiftState; X, Y: Integer);
    procedure bDBFAutoFillMouseUp(Sender: TObject; Button: TMouseButton; Shift: TShiftState; X, Y: Integer);
    procedure pbDBFRemovePaint(Sender: TObject);
    procedure bDBFRemoveMouseDown(Sender: TObject; Button: TMouseButton; Shift: TShiftState; X, Y: Integer);
    procedure bDBFRemoveMouseUp(Sender: TObject; Button: TMouseButton; Shift: TShiftState; X, Y: Integer);
    procedure pbDBFClearPaint(Sender: TObject);
    procedure bDBFClearMouseDown(Sender: TObject; Button: TMouseButton; Shift: TShiftState; X, Y: Integer);
    procedure bDBFClearMouseUp(Sender: TObject; Button: TMouseButton; Shift: TShiftState; X, Y: Integer);
    procedure lvCSVFieldsChange(Sender: TObject; Item: TListItem; Change: TItemChange);
    procedure cbCSVColNumberChange(Sender: TObject);
    procedure lvTXTFieldsChange(Sender: TObject; Item: TListItem; Change: TItemChange);
    ...
    procedure bXMLAddMouseDown(Sender: TObject; Button: TMouseButton; Shift: TShiftState; X, Y: Integer);
    procedure bXMLAddMouseUp(Sender: TObject; Button: TMouseButton; Shift: TShiftState; X, Y: Integer);
    procedure pbXMLAddPaint(Sender: TObject);
    procedure bXMLAutoFillMouseDown(Sender: TObject; Button: TMouseButton; Shift: TShiftState; X, Y: Integer);
    procedure bXMLAutoFillMouseUp(Sender: TObject; Button: TMouseButton; Shift: TShiftState; X, Y: Integer);
    procedure pbXMLAutoFillPaint(Sender: TObject);
    procedure bXMLRemoveMouseDown(Sender: TObject; Button: TMouseButton; Shift: TShiftState; X, Y: Integer);
    procedure bXMLRemoveMouseUp(Sender: TObject; Button: TMouseButton; Shift: TShiftState; X, Y: Integer);
    procedure pbXMLRemovePaint(Sender: TObject);
    procedure bXMLClearMouseDown(Sender: TObject; Button: TMouseButton; Shift: TShiftState; X, Y: Integer);
    procedure bXMLClearMouseUp(Sender: TObject; Button: TMouseButton; Shift: TShiftState; X, Y: Integer);
    ...
    procedure lvXLSRangesChange(Sender: TObject; Item: TListItem; Change: TItemChange);
    procedure tbtAddReplacementClick(Sender: TObject);
    procedure lvReplacementsChange(Sender: TObject; Item: TListItem; Change: TItemChange);
    ...
    procedure lvXLSFieldsChange(Sender: TObject; Item: TListItem; Change: TItemChange);
    ...
    procedure chSkipInvisibleColumnsClick(Sender: TObject);
    procedure CommonError(Sender: TObject; Stage: TQImportStage);
    procedure mScriptChange(Sender: TObject);
    procedure XMLSelectItem(Sender: TObject; Item: TListItem; Selected: Boolean);
    procedure cmbXMLEncodingChange(Sender: TObject);
  private
...
{$ENDIF}
    ...
    procedure MoveToSelected(Source, Destination: TListView; All: boolean; Index: Integer);
    ...
    procedure ShowTip(Parent: TWinControl; Left, Top, Height, Width: Integer; const Tip: qiString);
    ...
    function TryGetImportType(const AFileName: qiString; var AImportType: TAllowedImport): Boolean;
...
{$IFDEF VCL6}
    ...
    procedure HTMLMouseDown(Sender: TObject; X, Y: Integer);
{$ENDIF}
{$ENDIF}
...
{$IFDEF VCL6}
    ...
    procedure XlsxDragDrop(Sender, Source: TObject; X, Y: Integer);
    procedure XlsxMouseDown(Sender: TObject; X, Y: Integer);
{$ENDIF}
{$ENDIF}
...
{$IFDEF VCL6}
    ...
    procedure DocxDragDrop(Sender, Source: TObject; X, Y: Integer);
    procedure DocxMouseDown(Sender: TObject; X, Y: Integer);
{$ENDIF}
{$ENDIF}
...
{$IFDEF VCL6}
    ...
    procedure OdsDragDrop(Sender, Source: TObject; X, Y: Integer);
    procedure OdsMouseDown(Sender: TObject; X, Y: Integer);
{$ENDIF}
{$ENDIF}
...
{$IFDEF VCL6}
    ...
    procedure OdtDragDrop(Sender, Source: TObject; X, Y: Integer);
    procedure OdtMouseDown(Sender: TObject; X, Y: Integer);
{$ENDIF}
{$ENDIF}
...
{$IFDEF VCL6}
    ...
    procedure XMLDocDragDrop(Sender, Source: TObject; X, Y: Integer);
    procedure XMLDocMouseDown(Sender: TObject; X, Y: Integer);
{$ENDIF}
{$ENDIF}
    ...
    procedure TXTDragOver(Sender, Source: TObject; X, Y: Integer; State: TDragState; var Accept: Boolean);
    procedure TXTDragDrop(Sender, Source: TObject; X, Y: Integer);
    ...
    procedure CSVDragDrop(Sender, Source: TObject; X, Y: Integer);
    procedure CSVMoudeDown(Sender: TObject; X, Y: Integer);
    ...
    procedure XLSDrawCell(Sender: TObject; ACol, ARow: Integer; Rect: TRect; State: TGridDrawState);
    procedure XLSMouseDown(Sender: TObject; Button: TMouseButton; Shift: TShiftState; X, Y: Integer);
    procedure XLSSelectCell(Sender: TObject; ACol, ARow: Integer; var CanSelect: Boolean);
    procedure XLSGridExit(Sender: TObject);
    procedure XLSGridKeyDown(Sender: TObject; var Key: Word; Shift: TShiftState);
    procedure XLSGridClick(Sender: TObject);
    procedure XLSDragDrop(Sender, Source: TObject; X, Y: Integer);
...
{$ENDIF}
    ...
    procedure SetXMLEncoding(const Value: TQICharsetType);
{$IFDEF HTML}
{$IFDEF VCL6}
...
{$IFDEF VCL6}
    ...
    procedure SetDocxSheetNumber(const Value: Integer);
//    procedure SetXlsxNeedFillMerge(const Value: Boolean);
{$ENDIF}
{$ENDIF}
{$IFDEF ODS}
{$IFDEF VCL6}
    ...
    procedure SetODSSheetName(const Value: qiString);
{$ENDIF}
{$ENDIF}
{$IFDEF ODT}
{$IFDEF VCL6}
    procedure SetODTSkipLines(const Value: Integer);
    procedure SetODTSheetName(const Value: qiString);
{$ENDIF}
{$ENDIF}
{$IFDEF XMLDOC}
{$IFDEF VCL6}
...
{$ENDIF}
    ...
    procedure SetSkipInvisibleColumns(const Value: Boolean);
{$IFDEF ADO}
...
{$ENDIF}
    procedure SharedDragOver(Sender, Source: TObject; X, Y: Integer; State: TDragState; var Accept: Boolean);
  protected
{$IFDEF HTML}
{$IFDEF VCL6}
...
{$ENDIF}
    ...
    property AutoSaveTemplate: boolean read FAutoSaveTemplate write SetAutoSaveTemplate;
    ...
    property FieldFormats: TQImportFieldFormats read FDataFormats write FDataFormats;
...
{$IFDEF ADO}
    // Access
    property AccessPassword: string read FAccessPassword write SetAccessPassword;
    property AccessSourceType: TQImportAccessSourceType read FAccessSourceType write SetAccessSourceType;
{$ENDIF}

    // DBF
    property DBFSkipDeleted: boolean read FDBFSkipDeleted write SetDBFSkipDeleted;
...
{$IFDEF VCL6}
    ...
    property DocxSheetNumber: Integer read FDocxSheetNumber write SetDocxSheetNumber;
{$ENDIF}
{$ENDIF}
...
{$IFDEF VCL6}
    ...
    property ODSSheetName: qiString read FODSSheetName write SetODSSheetName;
{$ENDIF}
{$ENDIF}
...
{$IFDEF VCL6}
    ...
    property ODTSheetName: qiString read FODTSheetName write SetODTSheetName;
...
{$ENDIF}
    // XML
    property XMLEncoding: TQICharsetType read FXMLEncoding write SetXMLEncoding;
{$IFDEF XMLDOC}
{$IFDEF VCL6}
    // XMLDoc
    property XMLDocSkipLines: Integer read FXMLDocSkipLines write SetXMLDocSkipLines;
    property XMLDocXPath: qiString read FXMLDocXPath write SetXMLDocXPath;
    property XMLDocDataLocation: TXMLDataLocation read FXMLDocDataLocation write SetXMLDocDataLocation;
{$ENDIF}
{$ENDIF}
    ...
    //---- Last Step
    property CommitAfterDone: boolean read FCommitAfterDone write SetCommitAfterDone;
    property CommitRecCount: Integer read FCommitRecCount write SetCommitRecCount;
    property ImportRecCount: Integer read FImportRecCount write SetImportRecCount;
    property CloseAfterImport: boolean read FCloseAfterImport write SetCloseAfterImport;
    property EnableErrorLog: boolean read FEnableErrorLog write SetEnableErrorLog;
    property ErrorLogFileName: qiString read FErrorLogFileName write SetErrorLogFileName;
    property RewriteErrorLogFile: boolean read FRewriteErrorLogFile write SetRewriteErrorLogFile;
    property ShowErrorLog: boolean read FShowErrorLog write SetShowErrorLog;
    property AutoTrimValue: Boolean read FAutoTrimValue write SetAutoTrimValue;
    property ImportEmptyRows: Boolean read FImportEmptyRows write SetImportEmptyRows;
    property SkipInvisibleColumns: Boolean read FSkipInvisibleColumns write SetSkipInvisibleColumns;

    property ImportMode: TQImportMode read FImportMode write SetImportMode;
    property AddType: TQImportAddType read FAddType write SetAddType;
  public
...
{$ENDIF}
  ...
  QImportCheckDestination(False, ImportDestination, DataSet, DBGrid, ListView,
    StringGrid);
  Wizard := TQImport3WizardF.Create(Self);
  try
    Wizard.ShowModal;
  finally
    Wizard.Free;
...
function TQImport3Wizard.GetHelpFile: string;
begin
  Result := QI_WIZARD_HELP;
  if Length(FHelpFile) > 0 then
    Result := FHelpFile;
end;
...
const
  FileExts: array[TAllowedImport] of string = (XLS_EXT, DBF_EXT, XML_EXT, TXT_EXT, CSV_EXT, MDB_EXT, HTML_EXT, XML_EXT,
      XLSX_EXT, DOCX_EXT, ODS_EXT, ODT_EXT, ACCDB_EXT);
...
begin
  ...
  if Assigned(Wizard.OnBeforeImport) then Wizard.OnBeforeImport(Sender);
end;
...
begin
  ...
  if Assigned(Wizard.OnAfterImport) then Wizard.OnAfterImport(Sender);
end;
...
begin
  ...
  begin
    PostMessage(FProgress.Handle, WM_QIMPORT_PROGRESS, QIP_IMPORT, Integer(Import.LastAction));
    Application.ProcessMessages;
  end;
  if Assigned(Wizard.OnImportRecord) then
    Wizard.OnImportRecord(Sender);
end;

procedure TQImport3WizardF.ImportCheckField(Sender: TObject; Field: TField; AValue: qiString);
begin
  if Assigned(Wizard.OnImportCheckField) then
    Wizard.OnImportCheckField(Sender, Field, AValue);
end;

procedure TQImport3WizardF.SetFieldValueAction(Sender: TObject; DataSet: TDataSet; Col: TQImportCol);
begin
  if Assigned(Wizard.OnSetFieldValueAction) then
    Wizard.OnSetFieldValueAction(Sender, DataSet, Col);
end;
...
begin
  ...
  if Assigned(Wizard.OnImportErrorAdv) then
    Wizard.OnImportErrorAdv(Sender);
end;

procedure TQImport3WizardF.CommonError(Sender: TObject; Stage: TQImportStage);
begin
  if Assigned(Wizard.OnError) then
    Wizard.OnError(Sender, Stage);
end;
...
begin
  ...
  if Assigned(Wizard.OnNeedCommit) then Wizard.OnNeedCommit(Sender);
end;
...
begin
  ...
  if Assigned(Wizard.OnImportCancel) then Wizard.OnImportCancel(Sender, Continue);
  if Assigned(FProgress) then begin
    if Continue then
...
procedure TQImport3WizardF.BeforePost(Sender: TObject; Row: TQImportRow; var Accept: Boolean);
begin
...
procedure TQImport3WizardF.TXTDragOver(Sender, Source: TObject; X, Y: Integer; State: TDragState; var Accept: Boolean);
begin
  Accept := (Source is TListView) or (Sender is TQImport3TXTViewer);
end;

procedure TQImport3WizardF.TXTDragDrop(Sender, Source: TObject; X, Y: Integer);
begin
  vwTXT.MouseDown(mbLeft, [ssLeft], X, Y);
end;

procedure TQImport3WizardF.SharedDragOver(Sender, Source: TObject; X, Y: Integer;
  State: TDragState; var Accept: Boolean);
begin
  Accept := (Source is TListView) or (Sender is TqiStringGrid);
end;  
...
var
  i: Integer;
begin
  paImage.Color := Image.Picture.Bitmap.Canvas.Pixels[0, 0];
  ...
  impASCII := TQImport3ASCII.Create(Self);
  impASCII.ErrorLogFileName := 'error.log';
  impASCII.AddType := qatInsert;
  impASCII.OnBeforeImport := BeforeImport;
  impASCII.OnAfterImport := AfterImport;
  impASCII.OnImportRecord := ImportRecord;
  impASCII.OnImportError := ImportError;
  impASCII.OnImportErrorAdv := ImportErrorAdv;
  impASCII.OnNeedCommit := NeedCommit;
  impASCII.OnImportCancel := ImportCancel;
  impASCII.OnBeforePost := BeforePost;
  impASCII.OnDestinationLocate := DestinationLocate;
  impASCII.OnSetFieldValueAction := SetFieldValueAction;
  impASCII.OnCancelSetFieldValue := CancelSetFieldValue;
  impASCII.OnImportCheckField := ImportCheckField;

  impDBF := TQImport3DBF.Create(Self);
  impDBF.ErrorLogFileName := 'error.log';
  impDBF.AddType := qatInsert;
  impDBF.OnBeforeImport := BeforeImport;
  impDBF.OnAfterImport := AfterImport;
  impDBF.OnImportRecord := ImportRecord;
  impDBF.OnImportError := ImportError;
  impDBF.OnImportErrorAdv := ImportErrorAdv;
  impDBF.OnNeedCommit := NeedCommit;
  impDBF.OnImportCancel := ImportCancel;
  impDBF.OnBeforePost := BeforePost;
  impDBF.OnDestinationLocate := DestinationLocate;
  impDBF.OnSetFieldValueAction := SetFieldValueAction;
  impDBF.OnCancelSetFieldValue := CancelSetFieldValue;
  impDBF.OnImportCheckField := ImportCheckField;

  impXLS := TQImport3XLS.Create(Self);
  impXLS.ErrorLogFileName := 'error.log';
  impXLS.AddType := qatInsert;
  impXLS.OnBeforeImport := BeforeImport;
  impXLS.OnAfterImport := AfterImport;
  impXLS.OnImportRecord := ImportRecord;
  impXLS.OnImportError := ImportError;
  impXLS.OnImportErrorAdv := ImportErrorAdv;
  impXLS.OnNeedCommit := NeedCommit;
  impXLS.OnImportCancel := ImportCancel;
  impXLS.OnBeforePost := BeforePost;
  impXLS.OnDestinationLocate := DestinationLocate;
  impXLS.OnSetFieldValueAction := SetFieldValueAction;
  impXLS.OnCancelSetFieldValue := CancelSetFieldValue;
  impXLS.OnImportCheckField := ImportCheckField;

  impXML := TQImport3XML.Create(Self);
  impXML.ErrorLogFileName := 'error.log';
  impXML.AddType := qatInsert;
  impXML.OnBeforeImport := BeforeImport;
  impXML.OnAfterImport := AfterImport;
  impXML.OnImportRecord := ImportRecord;
  impXML.OnImportError := ImportError;
  impXML.OnImportErrorAdv := ImportErrorAdv;
  impXML.OnNeedCommit := NeedCommit;
  impXML.OnImportCancel := ImportCancel;
  impXML.OnBeforePost := BeforePost;
  impXML.OnDestinationLocate := DestinationLocate;
  impXML.OnSetFieldValueAction := SetFieldValueAction;
  impXML.OnCancelSetFieldValue := CancelSetFieldValue;
  impXML.OnImportCheckField := ImportCheckField;
  ...
  ImpAccess.OnImportCheckField := ImportCheckField;
  ImpAccess.OnSetFieldValueAction := SetFieldValueAction;
  ImpAccess.OnCancelSetFieldValue := CancelSetFieldValue;
  ...
  impHTML.OnImportCheckField := ImportCheckField;
  impHTML.OnSetFieldValueAction := SetFieldValueAction;
  impHTML.OnCancelSetFieldValue := CancelSetFieldValue;

  sgrHTML := TqiStringGrid.Create(Self);
  sgrHTML.Parent := paHTMLGridArea;
  sgrHTML.Align := alClient;
  sgrHTML.ColCount := 1;
  ...
  sgrHTML.OnDragOver := SharedDragOver;
  sgrHTML.OnDragDrop := HTMLDragDrop;
  {$IFDEF WIN64}
  ...
  impXlsx.OnImportCheckField := ImportCheckField;
  impXlsx.OnSetFieldValueAction := SetFieldValueAction;
  impXlsx.OnCancelSetFieldValue := CancelSetFieldValue;
...
{  sgrHTML.OnDrawCell := sgrHTMLDrawCell;
  ...
  impDocx.OnImportCheckField := ImportCheckField;
  impDocx.OnSetFieldValueAction := SetFieldValueAction;
  impDocx.OnCancelSetFieldValue := CancelSetFieldValue;
...
{  sgrDocx.OnDrawCell := sgrDocxDrawCell;
  ...
  impODS.OnImportCheckField := ImportCheckField;
  impODS.OnSetFieldValueAction := SetFieldValueAction;
  impODS.OnCancelSetFieldValue := CancelSetFieldValue;
  ...
  impODT.OnImportCheckField := ImportCheckField;
  impODT.OnSetFieldValueAction := SetFieldValueAction;
  impODT.OnCancelSetFieldValue := CancelSetFieldValue;
  ...
  impXMLDoc.OnImportCheckField := ImportCheckField;
  impXMLDoc.OnSetFieldValueAction := SetFieldValueAction;
  impXMLDoc.OnCancelSetFieldValue := CancelSetFieldValue;

  sgrXMLDoc := TqiStringGrid.Create(Self);
  sgrXMLDoc.Parent := paXMLDocGridArea;
  sgrXMLDoc.Align := alClient;
  ...
  sgrXMLDoc.OnDragOver := SharedDragOver;
  sgrXMLDoc.OnDragDrop := XMLDocDragDrop;
  {$IFDEF WIN64}
  ...
  sgrCSV.Parent := paCSVGridArea;
  sgrCSV.Align := alClient;
  ...
  sgrCSV.OnDragOver := SharedDragOver;
  sgrCSV.OnDragDrop := CSVDragDrop;
  {$IFDEF WIN64}
  ...
  vwTXT.Parent := paTXTGridArea;
  vwTXT.Align := alClient;
  vwTXT.Charset := ctWinDefined;
  ...
  vwTXT.OnDragOver := TXTDragOver;
  vwTXT.OnDragDrop := TXTDragDrop;
...
{$ENDIF}
  ...
  rbtAccess.Enabled := aiACCDB in Wizard.AllowedImports;
  rbtAccess97_2003.Enabled := aiMDB in Wizard.AllowedImports;
  ...
  else if rbtAccess97_2003.Enabled then rbtAccess97_2003.Checked := true;
  ...
  TXTSkipLines := 0;
  cmbTXTEncoding.ItemIndex := -1;
  FTXTClearing := False;

  CSVSkipLines := 0;
  cmbCSVEncoding.ItemIndex := -1;

  cmbXMLEncoding.ItemIndex := -1;
  ...
  SkipInvisibleColumns := Wizard.SkipInvisibleColumns;
...
begin
  ...
  else if Rbt.Name = 'rbtAccess' then ImportType := aiACCDB
  else if Rbt.Name = 'rbtAccess97_2003' then ImportType := aiMDB;
end;
...
begin
  Quote := Str2Char(cbQuote.Text, {$IFDEF VCL12}AnsiChar{$ELSE}Char{$ENDIF}(#0));
end;
...
begin
  ...
  begin
    ...
    rbtAccess.Checked := FImportType = aiACCDB;
    rbtAccess97_2003.Checked := FImportType = aiMDB;
    //----
    TuneOpenDialog;
    ChangeExtension;
    {$IFDEF ADO}
...
begin
  ...
  OnChange := edtFileName.OnChange;
  edtFileName.OnChange := nil;
  try
    FFileName := Trim(Value);
    edtFileName.Text := FFileName;
  finally
    edtFileName.OnChange := OnChange;
  end;

  if TryGetImportType(FFileName, it) then
  begin
    if (it = aiXML) and rbtXMLDoc.Checked then
      it := aiXMLDoc;
    ImportType := it;
  end;
  ...
  case ImportType of
    ...
    aiTXT: cmbTXTEncoding.ItemIndex := -1;
    aiCSV: cmbCSVEncoding.ItemIndex := -1;
    aiXML: cmbXMLEncoding.ItemIndex := -1;
  end;
...
procedure TQImport3WizardF.MoveToSelected(Source, Destination: TListView; All: boolean; Index: Integer);
var
  List: TStringList;
  i: Integer;
  ListItem: TListItem;
...
begin
  ...
  rbtAccess97_2003.Caption := QImportLoadStr(QIW_Access97_2003);
  ...
  chSkipInvisibleColumns.Caption := QImportLoadStr(QIW_SkipInvisibleColumns);
  ...
  laXMLEncoding.Caption := QImportLoadStr(QIW_TXT_ENCODING);
  for I := Low(TQICharsetType) to High(TQICharsetType) do
    cmbXMLEncoding.Items.Add(QICharsetTypeNames[I]);
  //-----
...
begin
  case FImportType of
    ...
    aiACCDB: opnDialog.Filter := QImportLoadStr(QIF_ACCDB);
    aiMDB: opnDialog.Filter := QImportLoadStr(QIF_MDB);
  end;
end;
...
begin
  ...
  FileName := ChangeFileExt(FileName, FileExts[FImportType]);
end;
...
//        raise EQImportError.CreateFmt(QImportLoadStr(QIE_WrongFileType), [ImportTypeStr(ImportType)]);
    ...
    case Value of
      ...
      2: {$IFDEF ADO}if FImportType in [aiACCDB, aiMDB] then
      begin
           try
             AccessTune_02;
           except
      ...
      3: if FImportType in [aiACCDB, aiMDB] then
           TuneFormats
         else
           TuneFinish;
      4: if FImportType in [aiACCDB, aiMDB] then
           TuneFinish;
    end;
  end;
end;

procedure TQImport3WizardF.ShowTip(Parent: TWinControl; Left, Top, Height, Width: Integer; const Tip: qiString);
begin
  paTip.Parent := Parent;
  paTip.Left := Left;
  paTip.Top := Top;
...
procedure TQImport3WizardF.FormKeyDown(Sender: TObject; var Key: Word; Shift: TShiftState);
begin
  if (FImportType = aiXLS) and (Step = 1) then FShift := Shift;
end;

procedure TQImport3WizardF.FormKeyUp(Sender: TObject; var Key: Word; Shift: TShiftState);
begin
...
begin
  ...
  if FImportType in [aiACCDB, aiMDB] then
...
begin
  case Step of
    ...
    3:
      begin
        bNext.Enabled := FImportType in [aiACCDB, aiMDB];
        if FImportType in [aiACCDB, aiMDB] then
        begin
          tbtAddReplacement.Enabled := Assigned(lstFormatFields.ItemFocused);
          tbtEditReplacement.Enabled := Assigned(lstFormatFields.ItemFocused) and
  ...
  {$IFDEF ADO}
  if FImportType in [aiACCDB, aiMDB]
...
begin
  case FImportType of
    ...
    {$IFDEF ADO}
    aiACCDB, aiMDB: Import := impAccess;
    {$ENDIF}
    else Import := nil;
  end;
  if Wizard.ShowProgress then
  begin
    FProgress := TfmQImport3ProgressDlg.CreateProgress(Self, Import, CloseAfterImport);
    FProgress.Show;
  ...
  try
    ...
    Wizard.Errors.Text := Import.Errors.Text;
    ...
    if Assigned(FProgress) then
      FCloseAfterImport := FProgress.CloseAfterImport;

    if FCloseAfterImport then
    begin
      FClosingAfterImport := True;
      Close;
    end;
  finally
    if Assigned(FProgress) then
...
begin
  HelpFile := ExtractFilePath(Application.ExeName) + Wizard.HelpFile;
  if FileExists(HelpFile) then
  begin
    if Wizard.HelpContext > 0 then
    begin
      HelpContext := Wizard.HelpContext;
      Application.HelpCommand(HELP_CONTEXT, HelpContext);
    end
    else if Length(Wizard.HelpTopic) > 0 then
      Application.HelpJump(Wizard.HelpTopic)
    else
...
procedure TQImport3WizardF.lstFormatFieldsChange(Sender: TObject; Item: TListItem; Change: TItemChange);
begin
...
begin
  if pgFormats.ActivePage = tshDataFormats then
  begin
    ActiveControl := lstFormatFields;
    if lstFormatFields.Items.Count > 0 then
    begin
...
begin
  ...
  begin
    laTemplateFileName.Left := 204;
    laTemplateFileName.Width := 197;
  end
  else begin
  ...
  laTemplateFileNameTag.Visible := FileExists(AFileName) and not Wizard.ShowSaveLoadButtons;

  if not FileExists(AFileName) then
    raise EQImportError.CreateFmt(QImportLoadStr(QIE_FileNotExists), [AFileName]);

  laTemplateFileName.Caption := MinimizeName(AFileName, laTemplateFileName.Canvas, laTemplateFileName.Width);
  ...
  try
    ...
    try
      ...
      begin
        ...
        if not Wizard.SkipInvisibleColumns then
          SkipInvisibleColumns := ReadBool(QIW_FIRST_STEP, QIW_SKIP_INVISIBLE_COLUMNS, False);
        ...
        case ImportType of
          ...
          aiTXT:
            begin
              ...
              vwTXT.Charset := TXTEncoding;
              vwTXT.LineCount := Wizard.TextViewerRows;
              vwTXT.LoadFromFile(Wizard.FileName);
              FNeedLoadFile := False;
              ...
              begin
                ...
                if j > -1 then
                begin
                  TXTExtractPosSize(ReadString(QIW_TXT_MAP, AStrings[i], EmptyStr), TxtPos, TxtSize);
                  vwTXT.AddArrow(TxtPos);
                  vwTXT.AddArrow(TxtPos + TxtSize);
          ...
          aiCSV: begin
            Comma := Str2Char(ReadString(QIW_CSV_OPTIONS, QIW_CSV_DELIMITER, Char2Str(GetListSeparator)), Comma);
            Quote := Str2Char(ReadString(QIW_CSV_OPTIONS, QIW_CSV_QUOTE, '"'), Quote);
            CSVSkipLines := ReadInteger(QIW_CSV_OPTIONS, QIW_CSV_SKIP_LINES, 0);
            CSVEncoding := TQICharsetType(ReadInteger(QIW_CSV_OPTIONS, QIW_CSV_ENCODING_OPTION, 0));
          ...
          aiODS: begin
            ...
            ODSSheetName := ReadString(QIW_ODS_OPTIONS, QIW_ODS_SHEET_NAME, 'Sheet1');
          ...
          aiODT: begin
            ...
            ODTSheetName := ReadString(QIW_ODT_OPTIONS, QIW_ODT_SHEET_NAME, 'Table1');
          ...
          aiDocx: begin
            ...
            DocxSheetNumber := ReadInteger(QIW_DOCX_OPTIONS, QIW_DOCX_TABLE_NUMBER, 0);
          ...
          {$ENDIF}
          aiXML: begin
            XMLEncoding := TQICharsetType(ReadInteger(QIW_XML_OPTIONS, QIW_XML_ENCODING, Integer(XMLEncoding)));
          ...
          begin
            for j := 0 to lstFormatFields.Items.Count - 1 do
              ...
              begin
                ...
                {$IFDEF USESCRIPT}
                FF.Script.Text := ReadString(AStrings[i], QIW_DF_SCRIPT, FF.Script.Text);
                {$ENDIF}
              end;
          end
          // Replacements
  ...
  begin
    ...
    Step := 3
    {$IFDEF ADO}
    else if (ImportType in [aiACCDB, aiMDB]) and AccessReady then
      Step := 4;
    {$ENDIF}
  end;
end;
...
begin
  ...
  try
    with Template do begin
      ...
      WriteBool(QIW_FIRST_STEP, QIW_SKIP_INVISIBLE_COLUMNS, SkipInvisibleColumns);
      case ImportType of
        aiXLS: begin
          for i := 0 to lvXLSFields.Items.Count - 1 do
        ...
        aiCSV: begin
          ...
          WriteInteger(QIW_CSV_OPTIONS, QIW_CSV_ENCODING_OPTION,
            Integer(CSVEncoding));
        end;
        aiDBF: begin
        ...
        aiDocx: begin
          ...
          WriteInteger(QIW_DOCX_OPTIONS, QIW_DOCX_TABLE_NUMBER, DocxSheetNumber);
        end;
        {$ENDIF}
        {$ENDIF}
        aiXML: begin
          WriteInteger(QIW_XML_OPTIONS, QIW_XML_ENCODING, Integer(XMLEncoding));
          for i := 0 to lvXMLMap.Items.Count - 1 do
      ...
      for i := 0 to lstFormatFields.Items.Count - 1 do begin
        ...
        {$IFDEF USESCRIPT}
        if ff.Script.Text <> EmptyStr then
          WriteString(str, QIW_DF_SCRIPT, ff.Script.Text);
        {$ENDIF}
        // Replacements
...
procedure TQImport3WizardF.FieldsListCallback(var Item: TListItem; ImportType:
    TAllowedImport);
begin
...
begin
  if not ((aiXLS in Wizard.AllowedImports) and
    QImportDestinationAssigned(False, ImportDestination, DataSet, DBGrid,
           ListView, StringGrid)) then Exit;
  XLSClearFieldList;
  QImportFillDestinationFieldsList(lvXLSFields, ImportDestination, DataSet,
    DBGrid, Self.ListView, StringGrid, GridCaptionRow, FSkipInvisibleColumns,
    aiXLS, FieldsListCallback);
end;
...
begin
  ...
  try
    ...
    begin
      ...
      StringGrid.OnDragOver := SharedDragOver;
      StringGrid.OnDragDrop := XLSDragDrop;
      StringGrid.Tag := 1000;
...
var
  OnChange: TNotifyEvent;
begin
  if FXLSSkipCols <> Value then
  begin
    OnChange := edXLSSkipCols.OnChange;
    edXLSSkipCols.OnChange := nil;
    try
      FXLSSkipCols := Value;
      ...
      edXLSSkipCols.OnChange := OnChange;
    end;
  end;
end;
...
var
  OnChange: TNotifyEvent;
begin
  if FXLSSkipRows <> Value then
  begin
    OnChange := edXLSSkipRows.OnChange;
    edXLSSkipRows.OnChange := nil;
    try
      FXLSSkipRows := Value;
      ...
      edXLSSkipRows.OnChange := OnChange;
    end;
  end;
end;
...
procedure TQImport3WizardF.XLSDrawCell(Sender: TObject; ACol, ARow: Integer; Rect: TRect; State: TGridDrawState);
var
  i: Integer;
begin
...
procedure TQImport3WizardF.XLSMouseDown(Sender: TObject; Button: TMouseButton; Shift: TShiftState; X, Y: Integer);
...
procedure TQImport3WizardF.XLSSelectCell(Sender: TObject; ACol, ARow: Integer; var CanSelect: Boolean);
var
  Grid: TqiStringGrid;
  SCol, SRow, i: Integer;
//  Str: AnsiString;
...
procedure TQImport3WizardF.XLSGridKeyDown(Sender: TObject; var Key: Word; Shift: TShiftState);
begin
  if Shift = [] then
    case Key of
...
procedure TQImport3WizardF.XLSDragDrop(Sender, Source: TObject; X, Y: Integer);

  procedure AddColToSelection(Number: Integer);
  var
    Range: string;
    RangeIndex: Integer;
  begin
    Range := Format('[%s]%s-%s;', [pcXLSFile.ActivePage.Caption, Col2Letter(Number), COLFINISH]);

    RangeIndex := FXLSGridSelection.IndexOfRange(Range);
    if RangeIndex > -1 then
      FXLSGridSelection.Delete(RangeIndex);

    FXLSGridSelection.AsString := Range;
  end;

  procedure ChangeCurrentCell(Grid: TqiStringGrid; Col, Row: Integer);
  var
    Event: TSelectCellEvent;
  begin
    Event := Grid.OnSelectCell;
...
begin
  ...
  AddColToSelection(ACol);
  ChangeCurrentCell(Grid, ACol, Grid.Row);
...
procedure TQImport3WizardF.lvXLSFieldsChange(Sender: TObject; Item: TListItem; Change: TItemChange);
var
  i: Integer;
  Row: TMapRow;
begin
...
procedure TQImport3WizardF.lvXLSRangesChange(Sender: TObject; Item: TListItem; Change: TItemChange);
begin
  XLSRepaintCurrentGrid;
  TuneButtons;
end;
...
procedure TQImport3WizardF.XMLSelectItem(Sender: TObject; Item: TListItem; Selected: Boolean);
begin
  TuneButtons;
end;
...
begin
  ...
  begin
    TQImportFieldFormat(lstFormatFields.Selected.Data).Script.Text := mScript.Lines.Text;
    SetEnabledDataFormatControls;
  end;
  {$ENDIF}
end;
...
begin
  laAccessPassword.Enabled := FImportType in [aiACCDB, aiMDB];
  edAccessPassword.Enabled := laAccessPassword.Enabled;
end;
...
begin
  if not (((aiACCDB in Wizard.AllowedImports) or (aiMDB in Wizard.AllowedImports)) and
    QImportDestinationAssigned(False, ImportDestination, DataSet, DBGrid,
           ListView, StringGrid)) then Exit;
  AccessClearList;
  QImportFillDestinationFieldsList(lstAccessDataSet, ImportDestination, DataSet,
    DBGrid, ListView, StringGrid, GridCaptionRow, FSkipInvisibleColumns,
    aiMDB, FieldsListCallback);
end;
...
begin
  FShortDateFormat := edtShortDateFormat.Text;
end;

procedure TQImport3WizardF.edtLongDateFormatChange(Sender: TObject);
begin
  FLongDateFormat := edtLongDateFormat.Text;
end;
...
begin
  FShortTimeFormat := edtShortTimeFormat.Text;
end;

procedure TQImport3WizardF.edtLongTimeFormatChange(Sender: TObject);
begin
  FLongTimeFormat := edtLongTimeFormat.Text;
end;
...
begin
  ...
  try
    ...
    {$IFDEF USESCRIPT}
    mScript.Lines.Text := FieldFormat.Script.Text;
    {$ENDIF}
...
begin
  try
    FCommitRecCount := StrToInt(edtCommitRecCount.Text);
  except
  end;
end;
...
begin
  ...
  OnChange := edtImportRecCount.OnChange;
  edtImportRecCount.OnChange := nil;
  try
    edtImportRecCount.Text := IntToStr(FImportRecCount);
  finally
    edtImportRecCount.OnChange := OnChange;
  end;
...
procedure TQImport3WizardF.chSkipInvisibleColumnsClick(Sender: TObject);
begin
  SkipInvisibleColumns := chSkipInvisibleColumns.Checked;
end;
...
begin
  if FErrorLogFileName <> Value then
  begin
...
begin
  if FRewriteErrorLogFile <> Value then
  begin
...
procedure TQImport3WizardF.SetSkipInvisibleColumns(const Value: Boolean);
begin
  if FSkipInvisibleColumns <> Value then
  begin
    FSkipInvisibleColumns := Value;
    chSkipInvisibleColumns.Checked := FSkipInvisibleColumns;
    FCombosAndListsReady := False;
  end;
end;
...
begin
  FErrorLogFileName := edErrorLogFileName.Text;
end;
...
procedure TQImport3WizardF.KeyColumnsDragOver(Sender, Source: TObject; X, Y: Integer; State: TDragState; var Accept: Boolean);
begin
  Accept := Source is TListView;
end;

procedure TQImport3WizardF.KeyColumnsDragDrop(Sender, Source: TObject; X, Y: Integer);
var
  ListItem: TListItem;
  Index, i: Integer;
  str: string;
...
begin
  if FNeedLoadFile then
  begin
    if cmbTXTEncoding.ItemIndex = -1 then
    begin
      // detect charset
      fileStream := TEncodedReadStream.Create(FileName);
      try
        TXTEncoding := fileStream.Charset;
      finally
  ...
  ShowTip(tsTXTOptions, 5, 21, 39, tsTXTOptions.Width - 6, QImportLoadStr(QIW_TXT_Tip));

  pgImport.ActivePage := tsTXTOptions;
  laTXTStep_02.Caption := Format(QImportLoadStr(QIW_Step), [1, 3]);

  if (lvTXTFields.Items.Count > 0) and not Assigned(lvTXTFields.Selected) then
  begin
...
begin
  if not ((aiTXT in Wizard.AllowedImports) and
    QImportDestinationAssigned(False, ImportDestination, DataSet, DBGrid,
           ListView, StringGrid)) then Exit;
  TXTClearCombo;
  QImportFillDestinationFieldsList(lvTXTFields, ImportDestination, DataSet,
    DBGrid, ListView, StringGrid, GridCaptionRow, FSkipInvisibleColumns,
    aiTXT, FieldsListCallback);
end;
...
begin
  if (FTXTEncoding <> Value) or (cmbTXTEncoding.ItemIndex <> Integer(FTXTEncoding)) then
  begin
    FTXTEncoding := Value;
...
begin
  if (FCSVEncoding <> Value) or (cmbCSVEncoding.ItemIndex <> Integer(FCSVEncoding)) then
  begin
    FCSVEncoding := Value;
...
procedure TQImport3WizardF.SetXMLEncoding(const Value: TQICharsetType);
begin
  if (FXMLEncoding <> Value) or (cmbXMLEncoding.ItemIndex <> Integer(FXMLEncoding)) then
  begin
    FXMLEncoding := Value;
    cmbXMLEncoding.ItemIndex := Integer(FXMLEncoding);
  end;
end;

procedure TQImport3WizardF.cmbTXTEncodingChange(Sender: TObject);
begin
  TXTEncoding := TQICharsetType(cmbTXTEncoding.ItemIndex);
  vwTXT.Charset := TXTEncoding;
  vwTXT.LoadFromFile(FileName);
end;

procedure TQImport3WizardF.cmbXMLEncodingChange(Sender: TObject);
begin
  XMLEncoding := TQICharsetType(cmbXMLEncoding.ItemIndex);
end;
...
begin
  FTXTSkipLines := StrToIntDef(edtTXTSkipLines.Text, 0);
end;

procedure TQImport3WizardF.lvTXTFieldsChange(Sender: TObject; Item: TListItem; Change: TItemChange);
var
  P, S: Integer;
begin
  if not Assigned(Item) then Exit;
...
procedure TQImport3WizardF.TXTViewerDeleteArrow(Sender: TObject; Position: Integer);
var
  i, p, s: Integer;
begin
  for i := 0 to lvTXTFields.Items.Count - 1 do
...
begin
  if not ((aiCSV in Wizard.AllowedImports) and
    QImportDestinationAssigned(False, ImportDestination, DataSet, DBGrid,
           ListView, StringGrid)) then Exit;
  CSVClearCombo;
  QImportFillDestinationFieldsList(lvCSVFields, ImportDestination, DataSet,
    DBGrid, ListView, StringGrid, GridCaptionRow, FSkipInvisibleColumns,
    aiCSV, FieldsListCallback);
end;
...
var
  fileStream: TEncodedReadStream;
begin
  ShowTip(tsCSVOptions, 4, 21, 39, tsCSVOptions.Width - 6, QImportLoadStr(QIW_CSV_Tip));
  ...
  if FNeedLoadFile then
  begin
    if cmbCSVEncoding.ItemIndex = -1 then
    begin
      // detect charset
      fileStream := TEncodedReadStream.Create(FileName);
      try
        CSVEncoding := fileStream.Charset;
      finally
        FreeAndNil(fileStream);
      end;
    end;
  ...
  if (lvCSVFields.Items.Count > 0) and not Assigned(lvCSVFields.Selected) then
  begin
    lvCSVFields.Items[0].Focused := True;
    lvCSVFields.Items[0].Selected := True;
  end;
  ...
  try
    ...
    try
      ...
      try
        ...
        while not CSVReader.Eof and ((m <= 0) or (n <= m)) do
        begin
        ...
        begin
          sgrCSV.ColWidths[i] := sgrCSV.Canvas.
          {$IFNDEF WIN64}
            {$IFDEF QI_UNICODE}
              TextWidthW
            {$ELSE}
...
procedure TQImport3WizardF.CSVMoudeDown(Sender: TObject; X, Y: Integer);
var
  Col, Row: Integer;
begin
  if not Assigned(lvCSVFields.Selected) then Exit;
  sgrCSV.MouseToCell(X, Y, Col, Row);             
  if CSVCol = (Col + 1) then
    lvCSVFields.Selected.SubItems[0] := EmptyStr
  else
    lvCSVFields.Selected.SubItems[0] := IntToStr(Col + 1);
...
procedure TQImport3WizardF.sgrCSVDrawCell(Sender: TObject; ACol, ARow: Integer; Rect: TRect; State: TGridDrawState);
var
  X, Y: Integer;
begin
...
procedure TQImport3WizardF.CSVDragDrop(Sender, Source: TObject; X, Y: Integer);
begin
  CSVMoudeDown(Sender, X, Y);
end;

procedure TQImport3WizardF.edtCSVSkipLinesChange(Sender: TObject);
begin
  FCSVSkipLines := StrToIntDef(edtCSVSkipLines.Text, 0);
end;
...
procedure TQImport3WizardF.sgrCSVMouseDown(Sender: TObject; Button: TMouseButton; Shift: TShiftState; X, Y: Integer);
begin
  CSVMoudeDown(Sender, X, Y);
end;

procedure TQImport3WizardF.lvCSVFieldsChange(Sender: TObject; Item: TListItem; Change: TItemChange);
begin
  if not Assigned(Item) then Exit;
...
begin
  if not ((aiDBF in Wizard.AllowedImports) and
    QImportDestinationAssigned(False, ImportDestination, DataSet, DBGrid,
           ListView, StringGrid)) then Exit;
  DBFClearList;
  QImportFillDestinationFieldsList(lstDBFDataSet, ImportDestination, DataSet,
    DBGrid, ListView, StringGrid, GridCaptionRow, FSkipInvisibleColumns,
    aiDBF, FieldsListCallback);
end;
...
procedure TQImport3WizardF.lstDBFDataSetChange(Sender: TObject; Item: TListItem; Change: TItemChange);
begin
  TuneButtons;
end;

procedure TQImport3WizardF.lstDBFChange(Sender: TObject; Item: TListItem; Change: TItemChange);
begin
  TuneButtons;
end;

procedure TQImport3WizardF.lstDBFMapChange(Sender: TObject; Item: TListItem; Change: TItemChange);
begin
  TuneButtons;
end;
...
procedure TQImport3WizardF.bDBFAddMouseDown(Sender: TObject; Button: TMouseButton; Shift: TShiftState; X, Y: Integer);
begin
  pbDBFAdd.Left := pbDBFAdd.Left + 1;
  pbDBFAdd.Top := pbDBFAdd.Top + 1;
end;

procedure TQImport3WizardF.bDBFAddMouseUp(Sender: TObject; Button: TMouseButton; Shift: TShiftState; X, Y: Integer);
begin
  pbDBFAdd.Left := pbDBFAdd.Left - 1;
  pbDBFAdd.Top := pbDBFAdd.Top - 1;
end;
...
procedure TQImport3WizardF.bDBFAutoFillMouseDown(Sender: TObject; Button: TMouseButton; Shift: TShiftState; X, Y: Integer);
begin
  pbDBFAutoFill.Left := pbDBFAutoFill.Left + 1;
  pbDBFAutoFill.Top := pbDBFAutoFill.Top + 1;
end;

procedure TQImport3WizardF.bDBFAutoFillMouseUp(Sender: TObject; Button: TMouseButton; Shift: TShiftState; X, Y: Integer);
begin
  pbDBFAutoFill.Left := pbDBFAutoFill.Left - 1;
  pbDBFAutoFill.Top := pbDBFAutoFill.Top - 1;
end;
...
procedure TQImport3WizardF.bDBFRemoveMouseDown(Sender: TObject; Button: TMouseButton; Shift: TShiftState; X, Y: Integer);
begin
  pbDBFRemove.Left := pbDBFRemove.Left + 1;
  pbDBFRemove.Top := pbDBFRemove.Top + 1;
end;

procedure TQImport3WizardF.bDBFRemoveMouseUp(Sender: TObject; Button: TMouseButton; Shift: TShiftState; X, Y: Integer);
begin
  pbDBFRemove.Left := pbDBFRemove.Left - 1;
  pbDBFRemove.Top := pbDBFRemove.Top - 1;
end;
...
procedure TQImport3WizardF.bDBFClearMouseDown(Sender: TObject; Button: TMouseButton; Shift: TShiftState; X, Y: Integer);
begin
  pbDBFClear.Left := pbDBFClear.Left + 1;
  pbDBFClear.Top := pbDBFClear.Top + 1;
end;

procedure TQImport3WizardF.bDBFClearMouseUp(Sender: TObject; Button: TMouseButton; Shift: TShiftState; X, Y: Integer);
begin
  pbDBFClear.Left := pbDBFClear.Left - 1;
  pbDBFClear.Top := pbDBFClear.Top - 1;
end;

function TQImport3WizardF.CloseQuery: Boolean;
begin
  if FClosingAfterImport then
  begin
    if AutoSaveTemplate then
...
begin
  if not ((aiXML in Wizard.AllowedImports) and
    QImportDestinationAssigned(False, ImportDestination, DataSet, DBGrid,
           ListView, StringGrid)) then Exit;
  XMLClearList;
  QImportFillDestinationFieldsList(lvXMLDataSet, ImportDestination, DataSet,
    DBGrid, ListView, StringGrid, GridCaptionRow, FSkipInvisibleColumns,
    aiXML, FieldsListCallback);
end;
...
begin
  ...
  try
    ...
    XML.LoadEncodingFromDeclaration;
...
procedure TQImport3WizardF.bXMLAddMouseDown(Sender: TObject; Button: TMouseButton; Shift: TShiftState; X, Y: Integer);
begin
  pbXMLAdd.Left := pbXMLAdd.Left + 1;
  pbXMLAdd.Top := pbXMLAdd.Top + 1;
end;

procedure TQImport3WizardF.bXMLAddMouseUp(Sender: TObject; Button: TMouseButton; Shift: TShiftState; X, Y: Integer);
begin
  pbXMLAdd.Left := pbXMLAdd.Left - 1;
  pbXMLAdd.Top := pbXMLAdd.Top - 1;
end;
...
procedure TQImport3WizardF.bXMLAutoFillMouseDown(Sender: TObject; Button: TMouseButton; Shift: TShiftState; X, Y: Integer);
begin
  pbXMLAutoFill.Left := pbXMLAutoFill.Left + 1;
  pbXMLAutoFill.Top := pbXMLAutoFill.Top + 1;
end;

procedure TQImport3WizardF.bXMLAutoFillMouseUp(Sender: TObject; Button: TMouseButton; Shift: TShiftState; X, Y: Integer);
begin
  pbXMLAutoFill.Left := pbXMLAutoFill.Left - 1;
  pbXMLAutoFill.Top := pbXMLAutoFill.Top - 1;
end;
...
procedure TQImport3WizardF.bXMLRemoveMouseDown(Sender: TObject; Button: TMouseButton; Shift: TShiftState; X, Y: Integer);
begin
  pbXMLRemove.Left := pbXMLRemove.Left + 1;
  pbXMLRemove.Top := pbXMLRemove.Top + 1;
end;

procedure TQImport3WizardF.bXMLRemoveMouseUp(Sender: TObject; Button: TMouseButton; Shift: TShiftState; X, Y: Integer);
begin
  pbXMLRemove.Left := pbXMLRemove.Left - 1;
  pbXMLRemove.Top := pbXMLRemove.Top - 1;
end;

procedure TQImport3WizardF.CancelSetFieldValue(Sender: TObject;
  Field: TField; var Cancel: Boolean);
begin
  if Assigned(Wizard.OnCancelSetFieldValue) then
    Wizard.OnCancelSetFieldValue(Sender, Field, Cancel);
end;
...
procedure TQImport3WizardF.bXMLClearMouseDown(Sender: TObject; Button: TMouseButton; Shift: TShiftState; X, Y: Integer);
begin
  pbXMLClear.Left := pbXMLClear.Left + 1;
  pbXMLClear.Top := pbXMLClear.Top + 1;
end;

procedure TQImport3WizardF.bXMLClearMouseUp(Sender: TObject; Button: TMouseButton; Shift: TShiftState; X, Y: Integer);
begin
  pbXMLClear.Left := pbXMLClear.Left - 1;
  pbXMLClear.Top := pbXMLClear.Top - 1;
end;
...
procedure TQImport3WizardF.lvReplacementsChange(Sender: TObject; Item: TListItem; Change: TItemChange);
begin
  TuneButtons;
end;
...
function TQImport3WizardF.AllowedImportFileType(const AFileName: qiString): Boolean;
var
  i: TAllowedImport;
  ext: qiString;
begin
  ...
  for i := Low(FileExts) to High(FileExts) do
  begin
    if FileExts[i] = ext then
    begin
      Result := True;
      Break;
    end;
...
function TQImport3WizardF.ImportTypeStr(AImportType: TAllowedImport): string;
begin
  Result := FileExts[AImportType];
end;
...
function TQImport3WizardF.TryGetImportType(const AFileName: qiString; var AImportType: TAllowedImport): Boolean;
var
  i: TAllowedImport;
  ext: qiString;
begin
...
procedure TQImport3WizardF.sgrHTMLMouseDown(Sender: TObject;
  Button: TMouseButton; Shift: TShiftState; X, Y: Integer);
begin
  HTMLMouseDown(Sender, X, Y);
end;

procedure TQImport3WizardF.HTMLFillList;
begin
  if not ((aiHTML in Wizard.AllowedImports) and
    QImportDestinationAssigned(False, ImportDestination, DataSet, DBGrid,
           ListView, StringGrid)) then Exit;
  HTMLClearList;
  QImportFillDestinationFieldsList(lvHTMLFields, ImportDestination, DataSet,
    DBGrid, ListView, StringGrid, GridCaptionRow, FSkipInvisibleColumns,
    aiHTML, FieldsListCallback);
end;
...
begin
  ShowTip(tsHTMLOptions, 4, 21, 39, tsHTMLOptions.Width - 6, QImportLoadStr(QIW_HTML_Tip));
...
procedure TQImport3WizardF.HTMLDragDrop(Sender, Source: TObject; X, Y: Integer);
begin
  HTMLMouseDown(Sender, X, Y);
end;

procedure TQImport3WizardF.HTMLMouseDown(Sender: TObject; X, Y: Integer);
var
  Col, Row: Integer;
begin
  if not Assigned(lvHTMLFields.Selected) then Exit;
  sgrHTML.MouseToCell(X, Y, Col, Row);
  if HTMLCol = Col + 1 then
    lvHTMLFields.Selected.SubItems[0] := EmptyStr
  else
    if Col > -1 then
      lvHTMLFields.Selected.SubItems[0] := IntToStr(Col + 1);
...
begin
  ShowTip(tsXMLDocOptions, 4, 21, 39, tsXMLDocOptions.Width - 6, QImportLoadStr(QIW_XMLDoc_Tip));
...
begin
  if not ((aiXMLDoc in Wizard.AllowedImports) and
    QImportDestinationAssigned(False, ImportDestination, DataSet, DBGrid,
           ListView, StringGrid)) then Exit;
  XMLDocClearList;
  QImportFillDestinationFieldsList(lvXMLDocFields, ImportDestination, DataSet,
    DBGrid, ListView, StringGrid, GridCaptionRow, FSkipInvisibleColumns,
    aiXMLDoc, FieldsListCallback);
end;
...
procedure TQImport3WizardF.SetXMLDocDataLocation(const Value: TXMLDataLocation);
begin
...
procedure TQImport3WizardF.XMLDocDragDrop(Sender, Source: TObject; X, Y: Integer);
begin
  XMLDocMouseDown(Sender, X, Y);
end;

procedure TQImport3WizardF.XMLDocMouseDown(Sender: TObject; X, Y: Integer);
var
  Col, Row: integer;
begin
  if not Assigned(lvXMLDocFields.Selected) then Exit;
  sgrXMLDoc.MouseToCell(X, Y, Col, Row);             
  if XMLDocCol = Col + 1 then
    lvXMLDocFields.Selected.SubItems[0] := EmptyStr
  else
    lvXMLDocFields.Selected.SubItems[0] := IntToStr(Col + 1);
  lvXMLDocFieldsChange(lvXMLDocFields, lvXMLDocFields.Selected, ctState);
end;
{$ENDIF}
{$ENDIF}
...
begin
  ShowTip(tsXlsxOptions, 4, 21, 39, tsXlsxOptions.Width - 6, QImportLoadStr(QIW_Xlsx_Tip));
...
begin
  if not ((aiXlsx in Wizard.AllowedImports) and
    QImportDestinationAssigned(False, ImportDestination, DataSet, DBGrid,
           ListView, StringGrid)) then Exit;
  XlsxClearList;
  QImportFillDestinationFieldsList(lvXlsxFields, ImportDestination, DataSet,
    DBGrid, ListView, StringGrid, GridCaptionRow, FSkipInvisibleColumns,
    aiXlsx, FieldsListCallback);
end;
...
var
  I: Integer;
begin
  for I := lvXlsxFields.Items.Count - 1 downto 0 do
    lvXlsxFields.Items.Delete(I);
  lvXlsxFieldsChange(lvXlsxFields, lvXlsxFields.Selected, ctState);
end;
...
begin
  ...
  try
    ...
    XlsxFile.Workbook.ImportRecCount := DefMapColRowCount;
    ...
    try
      ...
      begin
        ...
        StringGrid.Parent := TabSheet;
        StringGrid.Align := alClient;
        StringGrid.ColCount := DefMapXlsxColCount;
        ...
        StringGrid.OnDragOver := SharedDragOver;
        StringGrid.OnDragDrop := XlsxDragDrop;
  ...
  begin
    ...
    if pcXlsxFile.ActivePage.ComponentCount > 0 then
      ...
      begin
        ...
        {$IFDEF WIN64}
        FXlsxCurrentStringGrid.DefaultDrawing := False;
        {$ENDIF}
      end;
  end;
end;
...
procedure TQImport3WizardF.XlsxDragDrop(Sender, Source: TObject; X, Y: Integer);
begin
  XlsxMouseDown(Sender, X, Y);
end;

procedure TQImport3WizardF.XlsxMouseDown(Sender: TObject; X, Y: Integer);
var
  Col, Row: Integer;
  grid: TqiStringGrid;
begin
  ...
  if (Col = XlsxCol) and (XlsxSheetNamingCol = XlsxSheetName) then
    lvXlsxFields.Selected.SubItems[0] := EmptyStr
  else
    lvXlsxFields.Selected.SubItems[0] := SheetPrefix + XlsxSheetName +
      SheetPostfix + GetColNameFromIndex(Col) + IntToStr(BeginRowInt) +
      LeftRightRangesDelim + ColFinishFlag;
...
begin
  DocxSheetNumber := pcDocxFile.ActivePage.Tag;
end;

procedure TQImport3WizardF.DocxTune;
begin
  ShowTip(tsDocxOptions, 4, 21, 39, tsDocxOptions.Width - 6, QImportLoadStr(QIW_Docx_Tip));
...
begin
  if not ((aiDocx in Wizard.AllowedImports) and
    QImportDestinationAssigned(False, ImportDestination, DataSet, DBGrid,
           ListView, StringGrid)) then Exit;
  DocxClearList;
  QImportFillDestinationFieldsList(lvDocxFields, ImportDestination, DataSet,
    DBGrid, ListView, StringGrid, GridCaptionRow, FSkipInvisibleColumns,
    aiDocx, FieldsListCallback);
end;
  ...
  try
    ...
    try
      ...
      begin
        ...
        StringGrid.OnDragOver := SharedDragOver;
        StringGrid.OnDragDrop := DocxDragDrop;
...
procedure TQImport3WizardF.SeTDocxSheetNumber(const Value: Integer);
var
  i: Integer;
begin
  ...
  begin
    FDocxSheetNumber := pcDocxFile.ActivePage.Tag;
    if pcDocxFile.ActivePage.ComponentCount > 0 then
      ...
      begin
        ...
        {$IFDEF WIN64}
        FDocxCurrentStringGrid.DefaultDrawing := False;
        {$ENDIF}
      end;
  end;
end;

procedure TQImport3WizardF.DocxDragDrop(Sender, Source: TObject; X, Y: Integer);
begin
  DocxMouseDown(Sender, X, Y);
end;

procedure TQImport3WizardF.DocxMouseDown(Sender: TObject; X, Y: Integer);
var
  Col, Row: Integer;
  grid: TqiStringGrid;
begin
  ...
  if DocxCol = Col + 1 then
    lvDocxFields.Selected.SubItems[0] := EmptyStr
  else
    if Col > -1 then
      lvDocxFields.Selected.SubItems[0] := IntToStr(Col + 1);
...
begin
  ODSSheetName := pcODSFile.ActivePage.Caption;
end;

procedure TQImport3WizardF.ODSTune;
begin
  ShowTip(tsODSOptions, 4, 21, 39, tsODSOptions.Width - 6, QImportLoadStr(QIW_ODS_Tip));
...
begin
  if not ((aiODS in Wizard.AllowedImports) and
    QImportDestinationAssigned(False, ImportDestination, DataSet, DBGrid,
           ListView, StringGrid)) then Exit;
  ODSClearList;
  QImportFillDestinationFieldsList(lvODSFields, ImportDestination, DataSet,
    DBGrid, ListView, StringGrid, GridCaptionRow, FSkipInvisibleColumns,
    aiODS, FieldsListCallback);
end;
  ...
  try
    ...
    try
      ...
      begin
        ...
        StringGrid.OnDragOver := SharedDragOver;
        StringGrid.OnDragDrop := OdsDragDrop;
...
procedure TQImport3WizardF.SetODSSheetName(const Value: qiString);
var
  i: Integer;
begin
  ...
  begin
    FODSSheetName := pcODSFile.ActivePage.Caption;
    if pcODSFile.ActivePage.ComponentCount > 0 then
      ...
      begin
        ...
        {$IFDEF WIN64}
        FODSCurrentStringGrid.DefaultDrawing := False;
        {$ENDIF}
      end;
  end;
end;

procedure TQImport3WizardF.OdsDragDrop(Sender, Source: TObject; X, Y: Integer);
begin
  OdsMouseDown(Sender, X, Y);
end;

procedure TQImport3WizardF.OdsMouseDown(Sender: TObject; X, Y: Integer);
var
  Col, Row: Integer;
  grid: TqiStringGrid;
begin
  ...
  if ODSCol = Col
    ...
    else lvODSFields.Selected.SubItems[0] := Col2Letter(Col);
  lvODSFieldsChange(lvODSFields, lvODSFields.Selected, ctState);
end;
...
begin
  ODTSheetName := pcODTFile.ActivePage.Caption;
end;

procedure TQImport3WizardF.ODTTune;
begin
  ShowTip(tsODTOptions, 4, 21, 39, tsODTOptions.Width - 6, QImportLoadStr(QIW_ODT_Tip));
...
begin
  if not ((aiODT in Wizard.AllowedImports) and
    QImportDestinationAssigned(False, ImportDestination, DataSet, DBGrid,
           ListView, StringGrid)) then Exit;
  ODTClearList;
  QImportFillDestinationFieldsList(lvODTFields, ImportDestination, DataSet,
    DBGrid, ListView, StringGrid, GridCaptionRow, FSkipInvisibleColumns,
    aiODT, FieldsListCallback);
end;
...
var
  TabSheet: TTabSheet;
  StringGrid: TqiStringGrid;
  SheetIndex, RowIndex, ColIndex, Modif: Integer;
  F: TForm;
  Start, Finish: TDateTime;
  FODTFile: TODTFile;
...
begin
  ...
  try
    ...
    try
      ...
      FODTFile.Load;
      ODTClearAll;
      SetLength(FODTComplexArray, FODTFile.Workbook.Sheets.Count);
      ...
      begin
        ...
        StringGrid := TqiStringGrid.Create(TabSheet);
        FODTComplexArray[SheetIndex] := Sheet.IsComplexTable;
        ...
        StringGrid.OnDragOver := SharedDragOver;
        StringGrid.OnDragDrop := OdtDragDrop;
        ...
        begin
          ...
          begin
            Cell := Sheet.Cell[ColIndex, RowIndex];
            if not Assigned(Cell) then Continue;
            StringGrid.Cells[ColIndex + 1, RowIndex + 1 * Modif] := Cell.Value;
            SetStringGridColWidth(StringGrid, ColIndex + 1, RowIndex + 1 * Modif);
          end;
        end;

        if (SheetIndex = 0) then
        begin
          ODTSheetName := TabSheet.Caption;
          ODTComplex := FODTFile.Workbook.Sheets[SheetIndex].IsComplexTable;
        end;
      end;
    finally
      Finish := Now;
...
procedure TQImport3WizardF.SetODTSheetName(const Value: qiString);
var
  i: Integer;
begin
  ...
  begin
    FODTSheetName := pcODTFile.ActivePage.Caption;
    if pcODTFile.ActivePage.ComponentCount > 0 then
      ...
      begin
        ...
        {$IFDEF WIN64}
        FODTCurrentStringGrid.DefaultDrawing := False;
        {$ENDIF}
      end;
  end;
end;
...
var
  TabSheet: TTabSheet;
  StringGrid: TqiStringGrid;
  SheetIndex, RowIndex, ColIndex, Modif, Border: Integer;
  F: TForm;
  Start, Finish: TDateTime;
  FODTFile: TODTFile;
  TempName: qiString;
...
begin
  ODTUseHeader := True;
  Modif := 0;
  if not cbODTUseHeader.Checked then
  begin
    ODTUseHeader := False;
    Modif := 1;
  end;
  ...
  try
    ...
    try
      ...
      ODTSheetName := '';
      ODTClearAll;
      for SheetIndex := 0 to Border do
      begin
        Sheet := FODTFile.Workbook.Sheets[SheetIndex];

        TabSheet := TTabSheet.Create(pcODTFile);
        TabSheet.PageControl := pcODTFile;
        TabSheet.Caption := Sheet.Name;
        TabSheet.Tag := SheetIndex;
        ...
        if ODTUseHeader then
          for RowIndex := 0 to StringGrid.ColCount - 1 do
            StringGrid.Cells[RowIndex, 0] := EmptyStr;
        StringGrid.OnDrawCell := sgrODTDrawCell;
        StringGrid.OnMouseDown := sgrODTMouseDown;
...
procedure TQImport3WizardF.OdtDragDrop(Sender, Source: TObject; X, Y: Integer);
begin
  OdtMouseDown(Sender, X, Y);
end;

procedure TQImport3WizardF.OdtMouseDown(Sender: TObject; X, Y: Integer);
var
  Col, Row: Integer;
  grid: TqiStringGrid;
begin
  ...
  if ODTCol = Col
    ...
    else lvODTFields.Selected.SubItems[0] := Col2Letter(Col);
  lvODTFieldsChange(lvODTFields, lvODTFields.Selected, ctState);
end;
