...
type
  TXlsxRangeDirection = (xdNone, xdCell, xdColDown, xdColUp, xdRowRight, xdRowLeft);
  ...
  private
    ...
    function SheetInRange(const ASheetIndex: Integer; const ASheetName: qiString): Boolean;
  public
    procedure Assign(Source: TXlsxRangeItem);
    function CellInRange(const CellPoint: TXlsxCellPoint; const SheetIndex: Integer; const SheetName: qiString): Boolean;
    procedure Reset;
  ...
  public
    ...
    procedure Clear;
    function CellInRanges(const CellPoint: TXlsxCellPoint; const SheetIndex: Integer; const SheetName: qiString): Boolean;
  ...
  private
    ...
    function GetRangeString(const MapString: qiString; var RangeString: qiString): Boolean;
    ...
    procedure FillRange(const Range: TXlsxRangeItem; const RangeString: qiString);
    procedure SetSkipRange(const Range: TXlsxRangeItem; const SkipRows, SkipCols: Integer);
    procedure RepairOldRange(var RangeString: qiString);
  public
    constructor Create(const MapString: qiString; const SkipRows, SkipCols: Integer);
    destructor Destroy; override;
    function GetNextRange(var Row, Col, SheetIndex: Integer; var SheetName: qiString): Boolean;
  ...
  public
    constructor Create;
    destructor Destroy; override;
    function Add(const MapString: qiString; const SkipRows, SkipCols: Integer): TXlsxMapParserItem;
    procedure Delete(const Index: Integer);
    procedure Clear;
    property Count: Integer read GetCount;
...
constructor TXlsxMapParserItem.Create(const MapString: qiString; const SkipRows, SkipCols: Integer);
begin
...
function TXlsxMapParserItem.GetNextRange(var Row, Col, SheetIndex: Integer; var SheetName: qiString): Boolean;
var
...
procedure TXlsxMapParserItem.SetSkipRange(const Range: TXlsxRangeItem; const SkipRows, SkipCols: Integer);
begin
  case Range.Direction of
    xdColDown:
    begin
...
begin
  ...
  if (ColData <> '') and (RowInt = 0) and (RightSideRange = '') then
    RangeString := RangeString + IntToStr(BeginRowInt) + LeftRightRangesDelim + ColFinishFlag;
end;

procedure TXlsxMapParserItem.FillRange(const Range: TXlsxRangeItem; const RangeString: qiString);
var
...
procedure TXlsxMapParserItem.Parse(const MapString: qiString; const SkipRows, SkipCols: Integer);
var
  MapStringTmp,
...
function TXlsxRangeItems.CellInRanges(const CellPoint: TXlsxCellPoint; const SheetIndex: Integer; const SheetName: qiString): Boolean;
var
  I: Integer;
begin
  Result := False;
...
procedure TXlsxRangeItems.Move(CurIndex, NewIndex: Integer);
begin
...
function TXlsxMapParserItems.Add(const MapString: qiString; const SkipRows, SkipCols: Integer): TXlsxMapParserItem;
begin
...
procedure TXlsxRangeItem.Assign(Source: TXlsxRangeItem);
begin
  if not Assigned(Source) then
    Exit;
  FSheetName := Source.SheetName;
  FSheetIndex := Source.SheetIndex;
  FFirstCol := Source.FirstCol;
  FLastCol := Source.LastCol;
  FFirstRow := Source.FirstRow;
  FLastRow := Source.LastRow;
end;

function TXlsxRangeItem.CellInRange(const CellPoint: TXlsxCellPoint; const SheetIndex: Integer; const SheetName: qiString): Boolean;
begin
...
function TXlsxRangeItem.SheetInRange(const ASheetIndex: Integer; const ASheetName: qiString): Boolean;
begin
