...
const
  ...
  QIE_CSVParseError = QIRes + 4225;
  QIE_CSVLineNumberError = QIRes + 4226;
  QIE_CSVColumnNumberError = QIRes + 4227;
  QIE_CSVWrongNumberOfColumns = QIRes + 4228;
  QIE_CSVWrongColumnValueFormat = QIRes + 4229;
  QIE_CSVInvalidCharacter = QIRes + 4230;

  QIE_CSVOperationNotAllowedInActiveState = QIRes + 4231;
  QIE_CSVOperationNotAllowedInInactiveState = QIRes + 4232;
  QIE_CSVGettingNextLine = QIRes + 4233;
  QIE_CSVModifyingInputParameter = QIRes + 4234;
  QIE_CSVGettingProperty = QIRes + 4235;
  QIE_CSVSettingProperty = QIRes + 4236;
  ...
  QIE_ColumnIndexError = QIRes + 2171;
  QIE_RowIndexError = QIRes + 2172;
  QIE_MaxColumnsError = QIRes + 2173;
  ...
  QIW_SkipInvisibleColumns = QIRes + 2411;
