...
type
  TDBDemoMainForm = class(TDemoBasicMainForm)
    ...
    mdEventsCaption: TWideStringField;
    ...
    mdResources: TdxMemData;
    dsResources: TDataSource;
    mdResourcesID: TIntegerField;
    mdResourcesName: TStringField;
    mdResourcesImageIndex: TIntegerField;
    mdResourcesColor: TWordField;
    mdResourcesVisible: TBooleanField;
    mdResourcesWorkDays: TIntegerField;
    mdResourcesWorkStart: TTimeField;
    mdResourcesWorkFinish: TTimeField;
...
begin
  GenerateRandomEvents(5000, True);
end;
