inherited DBDemoMainForm: TDBDemoMainForm
  ...
  inherited Scheduler: TcxScheduler
    ...
    Splitters = {
      1C020000FB000000AB0200000001000017020000010000001C020000B7010000}
  ...
  object SchedulerDBStorage: TcxSchedulerDBStorage
    ...
    Resources.Items = <>
    Resources.DataSource = dsResources
    Resources.ResourceColor = 'Color'
    Resources.ResourceID = 'ID'
    Resources.ResourceImageIndex = 'ImageIndex'
    Resources.ResourceName = 'Name'
    Resources.ResourceVisible = 'Visible'
    Resources.ResourceWorkDays = 'WorkDays'
    Resources.ResourceWorkFinish = 'WorkFinish'
    Resources.ResourceWorkStart = 'WorkStart'
    CustomFields = <
      item
  ...
  object mdResources: TdxMemData
    Active = True
    Indexes = <>
    Persistent.Data = {
      
      05000000000000010000017F00000001000000000100000000}
    SortOptions = []
    Left = 264
    Top = 184
    object mdResourcesID: TIntegerField
      FieldName = 'ID'
    end
    object mdResourcesName: TStringField
      FieldName = 'Name'
      Size = 100
    end
    object mdResourcesImageIndex: TIntegerField
      FieldName = 'ImageIndex'
    end
    object mdResourcesColor: TWordField
      FieldName = 'Color'
    end
    object mdResourcesVisible: TBooleanField
      FieldName = 'Visible'
    end
    object mdResourcesWorkDays: TIntegerField
      FieldName = 'WorkDays'
    end
    object mdResourcesWorkStart: TTimeField
      FieldName = 'WorkStart'
    end
    object mdResourcesWorkFinish: TTimeField
      FieldName = 'WorkFinish'
    end
  end
