...
{$IFDEF EXPRESSSKINS}
  ...
  dxSkinsdxBarPainter,
{$ENDIF}
  cxSchedulerTimeGridView, cxSchedulerUtils, cxSchedulerYearView, dxShellDialogs,
...
var
  ...
  SportEvents: array[0..279] of string =
   ('Basketball Qualifying - Men',
    ...
    'Sabre - Men - Final',
    'Épée - Women - 1st Round',
    'Épée - Women - Round 2',
    'Épée - Women - 3rd Round',
    'Épée - Women - Quarter final',
    'Épée - Women - Semi-finals',
    'Épée - Women - Final',
    'Épée - Women/Team - 1st Round',
    'Épée - Women/Team - Quarter final',
    'Épée - Women/Team - Semi-finals',
    'Épée - Women/Team - Final',
    'Foil - Men - 1st Round',
    'Foil - Men - Round 2',
    'Foil - Men - 3rd Round',
...
begin
  ...
  case TMenuItem(Sender).Tag of
    ...
    1:
     Scheduler.ViewAgenda.ShowMessages := AChecked;
    2:
