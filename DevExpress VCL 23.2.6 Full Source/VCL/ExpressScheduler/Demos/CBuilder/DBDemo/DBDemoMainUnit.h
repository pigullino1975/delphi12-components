...
__published:	// IDE-managed Components
	...
	TWideStringField *mdEventsCaption;
	...
	TdxMemData *mdResources;
	TDataSource *dsResources;
	TIntegerField * mdResourcesID;
	TStringField *mdResourcesName;
	TIntegerField *mdResourcesImageIndex;
	TWordField *mdResourcesColor;
	TBooleanField *mdResourcesVisible;
	TIntegerField *mdResourcesWorkDays;
	TTimeField *mdResourcesWorkStart;
	TTimeField *mdResourcesWorkFinish;
