...
uses
  ...
  dxLayoutLookAndFeels, dxLayoutControlAdapters, dxLayoutcxEditAdapters, Actions,
  cxImageList;
...
type
  ...
  protected
    // IcxShedulerCustomEventEditorForm //#ignoreTypo
    function GetForm: TForm;
    function GetModified: Boolean;
    function GetTimeZone: Integer; virtual;
    function GetTimeZoneDaylightSaving: Boolean; virtual;
...
const
  dxThisUnitName = 'cxSchedulerRibbonStyleEventEditor';
...
function TcxSchedulerEventRibbonStyleEditorForm.GetTimeZone: Integer;
begin
...
function TcxSchedulerEventRibbonStyleEditorForm.GetTimeZoneDaylightSaving: Boolean;
begin
