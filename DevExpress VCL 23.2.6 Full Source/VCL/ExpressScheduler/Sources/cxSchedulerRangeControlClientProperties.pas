...
uses
  ...
  cxGraphics, dxCoreClasses, cxClasses, cxGeometry, dxGenerics,
...
type
  ...
  public
    ...
    property Colors: TdxColorList read FColors;
  ...
  protected
    function AddEvents(const AMin, AMax: TDateTime): TdxColorList;
  ...
  public
    ...
    destructor Destroy; override;
    procedure Clear;
    function GetEvents(const AMin, AMax: TDateTime): TdxColorList;
  end;
...
uses
  dxGdiPlusClasses, dxGdiPlusApi, dxCoreGraphics, dxCore;

const
  dxThisUnitName = 'cxSchedulerRangeControlClientProperties';
...
function TcxSchedulerRangeControlEventsCache.AddEvents(const AMin, AMax: TDateTime): TdxColorList;
const
...
function TcxSchedulerRangeControlEventsCache.GetEvents(const AMin, AMax: TDateTime): TdxColorList;
var
  AInfo: TcxSchedulerRangeControlIntervalEventInfo;
begin
  Result := nil;
