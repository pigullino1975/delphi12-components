...
uses
  Types, Classes, SysUtils, Windows, Forms, Math, Graphics, Variants, Menus,
  dxCore, dxCoreClasses, cxClasses, cxControls, cxCustomData, cxDataStorage, cxVariants, cxGeometry,
...
const
  dxThisUnitName = 'cxSchedulercxGridConnection';
