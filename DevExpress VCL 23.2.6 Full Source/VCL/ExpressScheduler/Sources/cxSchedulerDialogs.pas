...
const
  dxThisUnitName = 'cxSchedulerDialogs';
...
var
  ...
  AIntf: IcxSchedulerEventEditorForm;
begin
  Result := False;
  ...
  try
    if Supports(AControl, IcxSchedulerEventEditorForm, AIntf) then
    begin
      AEditor.TimeZone := AIntf.GetTimeZone;
      AEditor.TimeZoneDaylightSaving := AIntf.GetTimeZoneDaylightSaving;
    end;
    AEditor.Initialize;
