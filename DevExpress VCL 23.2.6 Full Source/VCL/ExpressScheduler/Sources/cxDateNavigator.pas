...
uses
  ...
  cxSchedulerDateNavigator, cxSchedulerDayView, cxDateUtils, cxLookAndFeels, cxLookAndFeelPainters;
...
type
  ...
  protected
    ...
    property FirstWeekOfYear: TcxFirstWeekOfYear read GetFirstWeekOfYear write SetFirstWeekOfYear default fwySystem;
    ...
    property ShowDatesContainingEventsInBold: Boolean read GetShowDatesContainingEventsInBold write SetShowDatesContainingEventsInBold default True;
    property ShowDatesContainingHolidaysInColor: Boolean read GetShowDatesContainingHolidaysInColor write SetShowDatesContainingHolidaysInColor default False;
  ...
  public
    ...
    property InnerDateNavigator: TcxInnerDateNavigator read FInnerDateNavigator; // for internal use
...
const
  dxThisUnitName = 'cxDateNavigator';
...
begin
  ...
  FInnerDateNavigator.BoundsRect := ABounds;
  FInnerDateNavigator.AlignSubControls();
