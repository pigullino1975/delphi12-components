...
type
  ...
  private
    function GetItems(Index: TdxListIndex): TcxAppointmentInfo;
  public
    ...
    property Items[Index: TdxListIndex]: TcxAppointmentInfo read GetItems; default;
  end;
  ...
  private
    function GetItem(Index: TdxListIndex): TcxEventInfo;
  public
    ...
    property Items[Index: TdxListIndex]: TcxEventInfo read GetItem; default;
  end;
...
const
  dxThisUnitName = 'cxSchedulerOutlookExchange';
...
function TcxAppointmentEntryIDList.GetItems(Index: TdxListIndex): TcxAppointmentInfo;
begin
...
function TcxEventEntryIDList.GetItem(Index: TdxListIndex): TcxEventInfo;
begin
  ...
  try
    ...
    begin
      ...
      begin
        ...
        AppointmentItem.Start := VarFromDateTime(Start); 
        AppointmentItem.End := VarFromDateTime(Finish);  
      end;
