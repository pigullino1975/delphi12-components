...
uses
  SysUtils, Math, dxAnimation, dxCore;

const
  dxThisUnitName = 'dxActivityIndicator';
...
begin
  ...
  FArcArea := cxRectCenter(ABounds, ARadius, ARadius).DeflateToTRect;
...
function TdxCustomActivityIndicator.HasBackground: Boolean;
begin
  Result := True;
end;

procedure TdxCustomActivityIndicator.DrawOpaqueBackground(ACanvas: TcxCanvas; const ARect: TRect);
begin
