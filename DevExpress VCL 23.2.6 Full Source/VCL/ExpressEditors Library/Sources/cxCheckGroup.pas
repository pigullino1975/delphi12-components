...
type
  ...
  { TcxCheckGroupButtonViewData }

  TcxCheckGroupButtonViewData = class(TcxCustomCheckBoxViewData)
  protected
...
procedure TcxCheckGroupButtonViewData.AdjustPadding(var APadding: TdxPadding);
begin
  APadding := TdxPadding.Null;
end;

function TcxCheckGroupButtonViewData.CalculateReadOnly: Boolean;
begin
...
procedure TcxCheckGroupViewInfo.DrawButtonCaption(ACanvas: TcxCanvas;
  ...
  begin
    Result := TcxCustomCheckBoxViewInfoAccess.GetTextRect(AButtonViewInfo.Bounds, AGlyphRect, ItemAlignment, True,
      IsInplace, NativeStyle, Font, ScaleFactor);
  end;

begin
  DrawCheckBoxText(ACanvas, AButtonViewInfo.Caption, Font, AButtonViewInfo.TextColor,
    GetCaptionRect, DrawTextFlags, Enabled);
end;
...
begin
  ...
  TcxCheckGroupViewInfo(AViewInfo).ItemAlignment := GetBiDiModeDependentAlignment(ACheckGroupProperties.ItemAlignment);
  TcxCheckGroupViewInfo(AViewInfo).CheckBorderStyle := ABorderStyle[Style.LookAndFeel.Kind];
...
class function TcxCheckGroupButtonProperties.GetViewDataClass: TcxCustomEditViewDataClass;
begin
  Result := TcxCheckGroupButtonViewData;
end;
...
function TcxCheckGroupButton.NeedUpdateWindowRegion: Boolean;
begin
  Result := True;
end;
...
begin
  ...
  begin
    ...
    AButton.StyleReadOnly.Assign(StyleReadOnly);
    AButton.Style.Shadow := False;
    AButton.StyleDisabled.Shadow := False;
    AButton.StyleFocused.Shadow := False;
    AButton.StyleHot.Shadow := False;
    AButton.StyleReadOnly.Shadow := False;
