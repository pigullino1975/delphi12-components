...
type
  ...
  protected
    ...
    procedure CalculateConstraints; virtual;
...
const
  dxThisUnitName = 'dxAutoCompleteWindow';
...
procedure TdxCustomAutoCompleteInnerListBox.DoMouseMove(Shift: TShiftState; X, Y: Integer);
begin
...
procedure TdxCustomAutoCompleteInnerListBox.DoMouseUp(Button: TMouseButton; Shift: TShiftState; X, Y: Integer);
begin
  if ItemIndex <> -1 then
    DoSelectItem;
end;
...
procedure TdxCustomAutoCompleteWindow.CalculateConstraints;
begin
