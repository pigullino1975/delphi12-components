...
uses
  ...
  cxGraphics, cxMemo, cxCustomListBox, cxListBox, cxLookAndFeelPainters, cxLookAndFeels;
...
type
  ...
  TcxEditMaskEditorDlg = class(TdxForm)
    ...
    procedure cxEditMaskEditKeyDown(Sender: TObject; var Key: Word; Shift: TShiftState);
...
const
  dxThisUnitName = 'cxEditMaskEditor';
...
procedure TcxEditMaskEditorDlg.cxEditMaskEditKeyDown(Sender: TObject; var Key: Word; Shift: TShiftState);
begin
...
procedure TcxEditMaskEditorDlg.cxTextEdit1KeyDown(Sender: TObject; var Key: Word; Shift: TShiftState);
begin
  if Key = VK_RETURN then
  begin
    CorrectMaskBlank;
