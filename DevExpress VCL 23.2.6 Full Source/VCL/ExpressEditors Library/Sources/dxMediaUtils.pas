...
type
  ...
  ['{56A868B6-0AD4-11CE-B03A-0020AF0BA770}']
    ...
    function GetEvent(out lEventCode: Longint; out lParam1, lParam2: LONG_PTR; msTimeout: DWORD): HResult; stdcall;
    ...
    function FreeEventParams(lEvCode: Longint; lParam1, lParam2: LONG_PTR): HResult; stdcall;
  end;
