...
uses
  ...
  dxLayoutContainer, dxLayoutControl, dxLayoutControlAdapters, dxLayoutLookAndFeels, dxShellDialogs;
...
const
  dxThisUnitName = 'cxFilterControlDialog';
...
begin
  if ALookAndFeel <> nil then
    dxLayoutSkinLookAndFeel.LookAndFeel.MasterLookAndFeel := ALookAndFeel;
end;
