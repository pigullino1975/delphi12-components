...
uses
  Windows, cxControls, cxEditConsts, cxTextEdit, Math, dxCore;

const
  dxThisUnitName = 'cxMRUEdit';
...
function TcxMRUEdit.SupportsItemIndex: Boolean;
begin
  Result := True;
end;
...
function TcxMRUEditProperties.FindValueByItemIndex(AItemIndex: Integer;
...
function TcxMRUEditProperties.SupportsItemIndex: Boolean;
begin
  Result := True;
end;
