...
uses
  System.UITypes,
  Classes, Windows, Controls, ImgList, ComCtrls, cxContainer, cxControls, cxListBox, cxLookAndFeelPainters, dxCore, dxCoreClasses,
  ...
  cxCalendar, cxEdit, dxUIElementPopupWindow, cxGraphics, dxTreeView, Generics.Collections, cxFilterControlUtils, dxCustomTree,
  cxMaskEdit, dxCustomFunction;
...
type
  ...
  strict private
    ...
    procedure FromEditValidateHandler(ASender: TObject; var ADisplayValue: TcxEditValue;
      var AErrorText: TCaption; var AError: Boolean);
    procedure ToEditChangeHandler(ASender: TObject);
    procedure ToEditValidateHandler(ASender: TObject; var ADisplayValue: TcxEditValue;
      var AErrorText: TCaption; var AError: Boolean);
  protected
...
uses
  Types, SysUtils, Graphics, Math, Variants, DateUtils, Menus, StdCtrls, dxGDIPlusClasses, cxGeometry, cxDrawTextUtils, cxEditConsts,
  cxTrackBar, cxFormats, cxFilterConsts, cxVariants, RTLConsts, dxMessages, cxTimeEdit, cxImageComboBox,
  cxLookAndFeels;

const
  dxThisUnitName = 'dxFilterValueContainer';
...
begin
  if Safe.Cast(FilterValueContainer.FilterProperties, TcxCustomTimeEditProperties, ATimeEditProperties) and ATimeEditProperties.Use24HourFormat then
    Result := 'hh'
  else
    Result := 'hh ampm';
end;
...
procedure TdxExcelFilterValueContainerRangeModeValuesPageBetween.FromEditValidateHandler(ASender: TObject;
  var ADisplayValue: TcxEditValue; var AErrorText: TCaption; var AError: Boolean);
var
  AValue: Variant;
begin
...
procedure TdxExcelFilterValueContainerRangeModeValuesPageBetween.ToEditValidateHandler(ASender: TObject;
  var ADisplayValue: TcxEditValue; var AErrorText: TCaption; var AError: Boolean);
var
  AValue: Variant;
begin
