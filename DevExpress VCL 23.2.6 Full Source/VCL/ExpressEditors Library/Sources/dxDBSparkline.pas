...
type
  ...
  protected
    ...
    function GetItemsDataBindingClass: TdxSparklineItemDataBindingClass; override;
...
begin
  ...
  DetailBinding := GetItemsDataBindingClass.Create(Self, Self, TcxIntegerValueType) as TdxLookupSparklineItemDataBinding;
end;
...
function TdxLookupSparklineProperties.GetItemsDataBindingClass: TdxSparklineItemDataBindingClass;
begin
