...
const
  dxThisUnitName = 'dxServerModeFireDACDataSource';
...
function TdxServerModeFireDACDataSource.GetConnection: TFDConnection;
begin
...
procedure TdxServerModeFireDACDataSource.SetConnection(Value: TFDConnection);
begin
...
function TdxServerModeFireDACQueryDataSource.GetConnection: TFDConnection;
begin
  Result := TFDConnection(inherited Connection);
end;

procedure TdxServerModeFireDACQueryDataSource.SetConnection(Value: TFDConnection);
begin
  inherited Connection := Value;
end;
