...
uses
  TypInfo, cxVariants, dxCore;

const
  dxThisUnitName = 'cxFireDacAdapters';
...
begin
  ...
  begin
    ASQLParams := TFDQuery(ADataSet).Params;
...
initialization
  ...
  cxDetailFilterControllers.RegisterAdapter(TFDQuery, TcxFireDacProviderDetailFilterAdapter);
  cxFilterOperatorAdapters.RegisterAdapter(TFDQuery, TcxFireDacFilterOperatorAdapter);
  {$IFDEF DX_INITIALIZATION_LOGGING}TdxUnitSectionsLogger.InitializationFinished(dxThisUnitName, SysInit.HInstance);{$ENDIF}
finalization
  {$IFDEF DX_INITIALIZATION_LOGGING}TdxUnitSectionsLogger.FinalizationStarted(dxThisUnitName, SysInit.HInstance);{$ENDIF}
  cxDetailFilterControllers.UnregisterAdapter(TFDQuery, TcxFireDacProviderDetailFilterAdapter);
  cxFilterOperatorAdapters.UnregisterAdapter(TFDQuery, TcxFireDacFilterOperatorAdapter);
