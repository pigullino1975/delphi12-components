...
unit dxUxTheme; // for internal use
...
uses
  Types, Windows, Classes, Graphics, CommCtrl;
...
type
  ...
  TdxThemeSize = Integer;
   ...
   public
    ...
    function GetContentRect(const R: TRect): TRect; // for internal use
    function ToRect: TRect; // for internal use
  end;
...
function OpenThemeData(hWnd: HWND; pszClassList: PWideChar; Dpi: Integer = 0): TdxTheme;
...
function DrawThemeText(hTheme: TdxTheme; DC: HDC; iPartId, iStateId: Integer; pszText: PWideChar;
  iCharCount: Integer; dwTextFlags, dwTextFlags2: DWORD; pRect: PRect): HRESULT; overload;
function DrawThemeText(hTheme: TdxTheme; DC: HDC; iPartId, iStateId: Integer; pszText: string;
  iCharCount: Integer; dwTextFlags, dwTextFlags2: DWORD; const pRect: TRect): HRESULT; overload;

function DrawThemeTextEx(hTheme: TdxTheme; DC: HDC; iPartId, iStateId: Integer; const pszText: WideString;
  iCharCount: Integer; dwTextFlags: DWORD; const pRect: TRect; const pOptions: TdxDTTOpts): HRESULT;
...
function GetThemeTextExtent(hTheme: TdxTheme; DC: HDC; iPartId, iStateId: Integer; pszTextL: PWideChar;
  iCharCount: Integer; dwTextFlags: DWORD; pBoundingRect: PRect; out ExtentRect: TRect): HRESULT;
function GetThemeTextMetrics(hTheme: TdxTheme; DC: HDC; iPartId, iStateId: Integer;  out tm: TEXTMETRIC): HRESULT;
function GetThemeBackgroundRegion(hTheme: TdxTheme; DC: HDC; iPartId, iStateId: Integer; pRect: PRect; out Region: HRGN): HRESULT;
function HitTestThemeBackground(hTheme: TdxTheme; DC: HDC; iPartId, iStateId: Integer;
  dwOptions: DWORD; pRect: PRect; hRgn: HRGN; ptTest: TPoint; out wHitTestCode: WORD): HRESULT;
...
function DrawThemeIcon(hTheme: TdxTheme; DC: HDC; iPartId, iStateId: Integer; pRect: PRect; himl: HIMAGELIST; iImageIndex: Integer): HRESULT;
function IsThemeBackgroundPartiallyTransparent(hTheme: TdxTheme; iPartId, iStateId: Integer): BOOL;
function IsThemePartDefined(hTheme: TdxTheme; iPartId, iStateId: Integer): BOOL;
function IsThemeScalingSupported: Boolean;
function DrawThemeParentBackground(hWnd: HWND; DC: HDC; const prc: TRect): HRESULT;

// lower-level theme information services
function GetThemeColor(hTheme: TdxTheme; iPartId, iStateId, iPropId: Integer; out Color: TColor): HRESULT; overload;
function GetThemeColor(hTheme: TdxTheme; iPartId, iStateId, iPropId: Integer; out Color: TColorRef): HRESULT; overload;
function GetThemeMetric(hTheme: TdxTheme; DC: HDC; iPartId, iStateId, iPropId: Integer; out iVal: Integer): HRESULT;
function GetThemeString(hTheme: TdxTheme; iPartId, iStateId, iPropId: Integer; pszBuff: PWideChar; cchMaxBuffChars: Integer): HRESULT;
function GetThemeBool(hTheme: TdxTheme; iPartId, iStateId, iPropId: Integer; out fVal{???}: BOOL): HRESULT; // TODO
function GetThemeInt(hTheme: TdxTheme; iPartId, iStateId, iPropId: Integer; out iVal: Integer): HRESULT;
function GetThemeEnumValue(hTheme: TdxTheme; iPartId, iStateId, iPropId: Integer; out iVal: Integer): HRESULT;
function GetThemePosition(hTheme: TdxTheme; iPartId, iStateId, iPropId: Integer; out Point: TPoint): HRESULT;
function GetThemeFont(hTheme: TdxTheme; DC: HDC; iPartId, iStateId, iPropId: Integer; out Font: LOGFONTW): HRESULT;
function GetThemeRect(hTheme: TdxTheme; iPartId, iStateId, iPropId: Integer; out Rect: TRect): HRESULT;
function GetThemeMargins(hTheme: TdxTheme; DC: HDC; iPartId, iStateId, iPropId: Integer; prc: PRect; out Margins: TdxMargins): HRESULT; overload;
function GetThemeMargins(hTheme: TdxTheme; iPartId, iStateId, iPropId: Integer): TRect; overload;
function GetThemeIntList(hTheme: TdxTheme; iPartId, iStateId, iPropId: Integer; out IntList: TdxIntList): HRESULT;
function GetThemePropertyOrigin(hTheme: TdxTheme; iPartId, iStateId, iPropId: Integer; out Origin: TdxPropertyOrigin): HRESULT;
function SetWindowTheme(hWnd: HWND; pszSubAppName, pszSubIdList: PWideChar): HRESULT;
function GetThemeFilename(hTheme: TdxTheme; iPartId, iStateId, iPropId: Integer; pszThemeFileName: PWideChar; cchMaxBuffChars: Integer): HRESULT;
function GetThemeSysColor(hTheme: TdxTheme; iColorId: Integer): TColorRef;
...
function GetThemeSysString(hTheme: TdxTheme; iStringId: Integer; pszStringBuff: PWideChar; cchMaxStringChars: Integer): HRESULT;
...
function GetCurrentThemeName(pszThemeFileName: PWideChar; cchMaxNameChars: Integer;
  pszColorBuff: PWideChar; cchMaxColorChars: Integer; pszSizeBuff: PWideChar; cchMaxSizeChars: Integer): HRESULT;
function GetThemeDocumentationProperty(pszThemeName, pszPropertyName, pszValueBuff: PWideChar; cchMaxValChars: Integer): HRESULT;
...
uses
  ComCtrls, dxTypeHelpers, dxCore;

const
  dxThisUnitName = 'dxUxTheme';
...
type
  ...
  TGetThemeSysColor = function(hTheme: TdxTheme; iColorId: Integer): TColorRef; stdcall;
  ...
  TOpenThemeDataForDpi = function(hWnd: HWND; pszClassList: PWideChar; dpi: UINT): TdxTheme; stdcall;
  ...
  TThemeLibraryMethodPointersKeeper = record
    ...
    FOpenThemeDataForDpi: TOpenThemeDataForDpi;
...
var
  ...
  FUpdatePanningFeedback: function(hwnd: HWND; lTotalOverpanOffsetX, lTotalOverpanOffsetY: Integer; fInInertia: BOOL): BOOL; stdcall;
  FEndPanningFeedback: function(hwnd: HWND; fAnimateBack: BOOL): BOOL; stdcall;

{ TdxMargins }

function TdxMargins.GetContentRect(const R: TRect): TRect;
begin
  Result.Init(
    R.Left + cxLeftWidth,
    R.Top + cyTopHeight,
    R.Right - cxRightWidth,
    R.Bottom - cyBottomHeight);
end;

function TdxMargins.ToRect: TRect;
begin
  Result.Init(cxLeftWidth, cyTopHeight, cxRightWidth, cyBottomHeight);
end;

function OpenThemeData(hWnd: HWND; pszClassList: PWideChar; Dpi: Integer = 0): TdxTheme;
begin
  if IsThemeScalingSupported and (Dpi > 0) then
    Result := FThemeLibraryMethodPointersKeeper.FOpenThemeDataForDpi(hWnd, pszClassList, Dpi)
  else
...
function DrawThemeBackground(hTheme: TdxTheme; DC: HDC; iPartId, iStateId: Integer; pRect: PRect; pClipRect: PRect = nil): HRESULT;
begin
  Result := FThemeLibraryMethodPointersKeeper.FDrawThemeBackground(hTheme, DC, iPartId, iStateId, pRect, pClipRect);
end;

function DrawThemeBackground(hTheme: TdxTheme; DC: HDC; iPartId, iStateId: Integer; const pRect: TRect; pClipRect: PRect = nil): HRESULT;
begin
...
function IsThemeBackgroundPartiallyTransparent(hTheme: TdxTheme; iPartId: Integer; iStateId: Integer): BOOL;
begin
  Result := FThemeLibraryMethodPointersKeeper.FIsThemeBackgroundPartiallyTransparent(hTheme, iPartId, iStateId);
end;

function IsThemeScalingSupported: Boolean;
begin
  Result := Assigned(FThemeLibraryMethodPointersKeeper.FOpenThemeDataForDpi);
end;
...
function GetThemeColor(hTheme: TdxTheme; iPartId, iStateId, iPropId: Integer; out Color: TColor): HRESULT;
var
  AColorRef: TColorRef;
begin
  AColorRef := clRed;
  Result := GetThemeColor(hTheme, iPartId, iStateId, iPropId, AColorRef);
  Color := AColorRef;
end;

function GetThemeColor(hTheme: TdxTheme; iPartId, iStateId, iPropId: Integer; out Color: TColorRef): HRESULT;
begin
...
function GetThemeMargins(hTheme: TdxTheme; iPartId, iStateId, iPropId: Integer): TRect;
var
  AMargins: TdxMargins;
begin
  GetThemeMargins(hTheme, 0, iPartId, iStateId, iPropId, nil, AMargins);
  Result := MarginsToRect(AMargins);
end;
...
begin
  ...
  begin
    ...
    // windows 10.1703 extension
    @FOpenThemeDataForDpi := GetProcAddress(FThemeLibrary, 'OpenThemeDataForDpi');
  end;
