...
begin
  ...
  begin
    if not CharInSet(AInputPtr[AInputLength - 1], dxSpaceCharacters) then
      Break;
    Dec(AInputLength);
  end;
...
begin
  ...
  begin
    ...
    begin
      if not CharInSet(AInputPtr^, dxSpaceCharacters) then
        Break;
      Inc(AInputPtr);
    end;
