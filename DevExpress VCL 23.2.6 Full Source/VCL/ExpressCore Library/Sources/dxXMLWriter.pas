...
begin
  WriteAttributeString(ALocalName, TdxXMLHelper.EncodeBoolean(AValue));
end;

procedure TdxXmlWriter.WriteAttributeBoolean(const APrefix, ALocalName, ANs: string; AValue: Boolean);
begin
  WriteAttributeString(APrefix, ALocalName, ANs, TdxXMLHelper.EncodeBoolean(AValue));
end;

procedure TdxXmlWriter.WriteAttributeFloat(const APrefix, ALocalName, ANs: string; AValue: Single);
begin
  WriteAttributeString(APrefix, ALocalName, ANs, dxFloatToStr(AValue));
end;
...
procedure TdxXmlWriter.WriteAttributeInteger(const APrefix, ALocalName, ANs: string; AValue: Integer);
begin
  WriteAttributeString(APrefix, ALocalName, ANs, IntToStr(AValue));
end;

procedure TdxXmlWriter.WriteAttributeInt64(const ALocalName: string; const AValue: Int64);
begin
  WriteAttributeString(ALocalName, IntToStr(AValue));
end;

procedure TdxXmlWriter.WriteAttributeInt64(const APrefix, ALocalName, ANs: string; const AValue: Int64);
begin
  WriteAttributeString(APrefix, ALocalName, ANs, IntToStr(AValue));
end;
...
begin
  {$IFDEF DX_INITIALIZATION_LOGGING}TdxUnitSectionsLogger.ConstructorStarted(UnitName, 'TdxXmlWellFormedWriter.Initialize', SysInit.HInstance);{$ENDIF}
  ...
  {$IFDEF DX_INITIALIZATION_LOGGING}TdxUnitSectionsLogger.ConstructorFinished(UnitName, 'TdxXmlWellFormedWriter.Initialize', SysInit.HInstance);{$ENDIF}
end;
