...
resourcestring
  ...
  scxTreeListFindPanelNextButtonCaption = 'Next';
  scxTreeListFindPanelPreviousButtonCaption = 'Previous';
...
begin
  ...
  InternalAdd('scxTreeListFindPanelNextButtonCaption', @scxTreeListFindPanelNextButtonCaption);
  InternalAdd('scxTreeListFindPanelPreviousButtonCaption', @scxTreeListFindPanelPreviousButtonCaption);
