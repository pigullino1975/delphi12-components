...
uses
  Classes, Graphics, cxLookAndFeels, cxGraphics, cxControls, cxTL, dxBar, dxBarBuiltInMenu, cxClasses;
...
uses
  dxGDIPlusClasses, Forms, dxCore;

const
  dxThisUnitName = 'cxTLdxBarBuiltInMenu';
  ...
  begin
    ...
    begin
      ...
      if dxUseVectorIcons then
        TcxImageList(GetImages(AInternal)).GetImage(AImageIndex, Result)
      else
      begin
