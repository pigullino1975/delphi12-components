...
uses
  System.UITypes,
  Classes, SysUtils, Windows, Messages, Variants, Types, dxCore, cxVariants,
  cxControls, cxClasses, cxData, cxCustomData, cxInplaceContainer, cxTL,
  cxTLStrs;
...
type
  ...
  protected
    ...
    procedure ClearNodeLinks(ANode: TcxTreeListNode); virtual;
...
procedure TcxTreeListStructureLoader.ClearNodeLinks(ANode: TcxTreeListNode);
begin
  if Nodes <> nil then
    Nodes.Remove(ANode);
  if Loaded <> nil then
