...
uses
  Windows, Messages, SysUtils, Variants, Classes, Graphics, Controls, Forms, Dialogs, ExtCtrls, ImgList,
{$IFDEF DELPHI16}
  System.UITypes,
{$ENDIF}
  cxStyles, cxTL, cxControls, cxInplaceContainer, cxTextEdit, cxDropDownEdit, cxClasses, cxGraphics,
  cxLookAndFeels, cxLookAndFeelPainters, cxCustomData;
