...
__published: // IDE-managed Components
	...
	TMenuItem* miMainSeparator;
	TMenuItem* miMainSeparator2;
	TMenuItem* miCriteriaDisplayStyle;
	TMenuItem* miCriteriaDisplayStyleText;
	TMenuItem* miCriteriaDisplayStyleTokens;
	TAction* acCriteriaDisplayStyleText;
	TAction* acCriteriaDisplayStyleTokens;
    ...
    void __fastcall acCriteriaDisplayStyleExecute(TObject* Sender);
