...
const
  dxThisUnitName = 'dxRichEdit.Dialogs.BorderShading';
...
begin
  InitializeColorButtons(cmbBorderLineColor);
  InitializeColorButtons(cmbShadingColor, @sdxRichEditBorderShadingDialogNoColor);
