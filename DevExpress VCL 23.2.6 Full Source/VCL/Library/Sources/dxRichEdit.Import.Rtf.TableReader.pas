...
unit dxRichEdit.Import.Rtf.TableReader; // for internal use
...
const
  dxThisUnitName = 'dxRichEdit.Import.Rtf.TableReader';
...
type
  ...
  protected
    class function Merge(ASource: TdxRtfTableGrid; ADestination: TdxRtfTableGrid): TdxRtfTableGrid; virtual;
    class function GetRowColumns(ARow: TdxRtfTableRow): TdxRtfTableGrid; virtual;
  public
    class function Calculate(ATable: TdxRtfTable; ATableIndent: Integer): TdxRtfTableGrid;
  end;
...
begin
  Result := TdxRtfTableColumnsCalculator.Calculate(ATable, ATable.Indent);
end;
...
class function TdxRtfTableColumnsCalculator.Calculate(ATable: TdxRtfTable; ATableIndent: Integer): TdxRtfTableGrid;
var
  ARowsCount, I: Integer;
...
class function TdxRtfTableColumnsCalculator.Merge(ASource: TdxRtfTableGrid; ADestination: TdxRtfTableGrid): TdxRtfTableGrid;
var
...
class function TdxRtfTableColumnsCalculator.GetRowColumns(ARow: TdxRtfTableRow): TdxRtfTableGrid;
var
