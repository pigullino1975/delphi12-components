...
unit dxRichEdit.DocumentFormats.DocumentFormatUtils; // for internal use
...
type
 ...
 { TdxCellsRowSpanCollection }
  ...
  public
    ...
    function FindStartParagraphIndexForCell(AInputPositionParagraphIndex: TdxParagraphIndex): TdxParagraphIndex; virtual;
...
const
  dxThisUnitName = 'dxRichEdit.DocumentFormats.DocumentFormatUtils';
...
function TdxTablesImportHelper.FindStartParagraphIndexForCell(AInputPositionParagraphIndex: TdxParagraphIndex): TdxParagraphIndex;
var
  ATable: TdxTable;
...
begin
  ...
  begin
    ...
    if APrevious = nil then
      Exit(AInputPositionParagraphIndex);
  ...
  if AInputPositionParagraphIndex > ALastCellParagraphIndex + 1 then
    Result := ALastCellParagraphIndex + 1
  else
    Result := AInputPositionParagraphIndex;
end;
