...
uses
  cxCustomData, cxGridCustomTableView, dxCore;

const
  dxThisUnitName = 'cxGridUIHelper';
...
begin
  if Grid <> nil then
    Grid.UnregisterNotification(FFocusedViewChangedNotification);
...
finalization
  ...
  FreeAndNil(FGridViewOperationHelperList);
