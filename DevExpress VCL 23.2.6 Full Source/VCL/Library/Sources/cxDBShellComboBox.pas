...
type
  ...
  protected
    ...
    function InternalSynchronizeData: Boolean; override;
  public
...
const
  dxThisUnitName = 'cxDBShellComboBox';
...
function TcxDBShellComboBox.InternalSynchronizeData: Boolean;
begin
  Result := not DataBinding.IsDataAvailable;
  if Result then
