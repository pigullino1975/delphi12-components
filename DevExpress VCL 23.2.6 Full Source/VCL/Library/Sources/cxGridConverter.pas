...
uses
  cxGridCommon, cxGridBandedTableView, dxMessageDialog;

const
  dxThisUnitName = 'cxGridConverter';
...
begin
  ...
  if not Result  then
    dxMessageBox(Format(cxGetResourceString(@scxGridConverterIntermediaryMissing), [GetIntermediaryClassName]),
      cxGetResourceString(@scxImportErrorCaption), MB_OK or MB_ICONINFORMATION);
end;
