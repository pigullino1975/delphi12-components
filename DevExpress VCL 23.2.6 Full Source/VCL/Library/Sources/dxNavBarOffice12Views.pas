...
uses
  dxNavBarBase, dxNavBarViewsFact, dxNavBarConsts, cxCustomCanvas, dxCore;

const
  dxThisUnitName = 'dxNavBarOffice12Views';
...
procedure TdxNavBarcxOffice12NavPaneScrollBarPainter.DoDrawScrollBarPart(ACanvas: TcxCustomCanvas; const R: TRect; APart: TcxScrollBarPart; AState: TcxButtonState);
var
...
begin
  ...
  if ANavBarPainter <> nil then
    ANavBarPainter.DrawScrollBarPart(ACanvas as TcxCanvas, R, APart, AState)
  else
    inherited;
end;
...
procedure TdxNavBarcxOffice12ScrollBarPainter.DoDrawScrollBarPart(ACanvas: TcxCustomCanvas; const R: TRect; APart: TcxScrollBarPart; AState: TcxButtonState);
var
