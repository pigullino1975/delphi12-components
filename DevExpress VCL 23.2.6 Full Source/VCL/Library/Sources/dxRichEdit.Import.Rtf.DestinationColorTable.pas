...
unit dxRichEdit.Import.Rtf.DestinationColorTable; // for internal use
...
const
  dxThisUnitName = 'dxRichEdit.Import.Rtf.DestinationColorTable';
...
begin
  {$IFDEF DX_INITIALIZATION_LOGGING}TdxUnitSectionsLogger.ConstructorStarted(UnitName, 'TdxColorTableDestination.Initialize', SysInit.HInstance);{$ENDIF}
  ...
  {$IFDEF DX_INITIALIZATION_LOGGING}TdxUnitSectionsLogger.ConstructorFinished(UnitName, 'TdxColorTableDestination.Initialize', SysInit.HInstance);{$ENDIF}
end;
