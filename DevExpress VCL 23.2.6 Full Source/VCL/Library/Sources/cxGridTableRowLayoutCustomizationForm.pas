...
unit cxGridTableRowLayoutCustomizationForm;
...
uses
  ...
  cxGridViewLayoutCustomizationForm, cxGridRowLayout, cxGridRowLayoutCustomizationForm;

type
  { TcxGridTableRowLayoutCustomizationForm }

  TcxGridTableRowLayoutCustomizationForm = class(TcxGridRowLayoutCustomizationForm)
  protected
...
const
  dxThisUnitName = 'cxGridTableRowLayoutCustomizationForm';
...
function TcxGridTableRowLayoutCustomizationForm.GetLayoutController: TcxGridRowLayoutController;
begin
