...
uses
  ...
  dxLayoutLookAndFeels, cxClasses, dxLayoutControl, cxImageList, cxMaskEdit, cxDropDownEdit, dxGenerics,
...
type
  ...
  private
    FComponentInfo: TdxObjectDictionary;
...
begin
  ...
  FComponentInfo := TdxObjectDictionary.Create([doOwnsValues]);
