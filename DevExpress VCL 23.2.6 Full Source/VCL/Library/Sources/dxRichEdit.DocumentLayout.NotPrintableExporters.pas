...
unit dxRichEdit.DocumentLayout.NotPrintableExporters; // for internal use
...
type
  ...
  strict private
    ...
    FExporter: TdxNotPrintableGraphicsBoxExporter;
  protected
    procedure DrawBookmarkBox(AColor: TdxAlphaColor; const APoints: TArray<TdxPointF>);
    ...
    function GetBookmarkPoints(const X, Y, AHeight, AWidth: Single): TArray<TdxPointF>;

    property Exporter: TdxNotPrintableGraphicsBoxExporter read FExporter;
  public
    constructor Create(AExporter: TdxNotPrintableGraphicsBoxExporter);
    procedure ExportBookmarkStartBox(ABookmarkBox: TdxVisitableDocumentIntervalBox);
    procedure ExportBookmarkEndBox(ABookmarkBox: TdxVisitableDocumentIntervalBox);
  ...
  TdxNotPrintableGraphicsBoxExporter = class abstract(TdxDocumentLayoutExporter) // for internal use
  strict private
  ...
  TdxWinFormsNotPrintableGraphicsBoxExporter = class(TdxNotPrintableGraphicsBoxExporter) // for internal use
  strict private
  ...
  public
    ...
    procedure ExportPage(APage: TdxPageViewInfo);
...
const
  dxThisUnitName = 'dxRichEdit.DocumentLayout.NotPrintableExporters';
...
begin
  if Safe.Cast(ABookmarkBox.Interval, TdxBookmark, ABookmark) then
  begin
...
function TdxNotPrintableGraphicsBoxExporter.BeforeExportRotatedContent(ABox: TdxFloatingObjectBox): Boolean;
var
  ABounds: TRect;
  ACenter: TPoint;
begin
