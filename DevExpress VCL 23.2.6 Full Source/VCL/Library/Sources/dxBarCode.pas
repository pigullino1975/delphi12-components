...
uses
  Math,
  cxGeometry, cxConverterUtils, cxDrawTextUtils, cxCustomCanvas;

const
  dxThisUnitName = 'dxBarCode';
...
var
  ABitmap: TcxBitmap;
begin
  ABitmap := TcxBitmap.CreateSize(ViewInfo.Bounds);
  try
...
begin
  ...
  begin
    ...
    begin
      TBitmap(Dest).SetSize(cxRectWidth(ViewInfo.Bounds), cxRectHeight(ViewInfo.Bounds));
...
function TdxCustomBarCode.GetBackgroundStyle: TcxControlBackgroundStyle;
begin
