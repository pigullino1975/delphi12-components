...
unit dxRichEdit.Import.Rtf.DestinationsDefaultPropertes; // for internal use
...
uses
  ...
  dxRichEdit.DocumentModel.CharacterFormatting, dxRichEdit.DocumentModel.ParagraphFormatting, dxCore;

const
  dxThisUnitName = 'dxRichEdit.Import.Rtf.DestinationsDefaultPropertes';
...
begin
  {$IFDEF DX_INITIALIZATION_LOGGING}TdxUnitSectionsLogger.ConstructorStarted(UnitName, 'TdxDefaultCharacterPropertiesDestination.Initialize', SysInit.HInstance);{$ENDIF}
  FKeywordHT := CreateKeywordHT;
  {$IFDEF DX_INITIALIZATION_LOGGING}TdxUnitSectionsLogger.ConstructorFinished(UnitName, 'TdxDefaultCharacterPropertiesDestination.Initialize', SysInit.HInstance);{$ENDIF}
end;

class destructor TdxDefaultCharacterPropertiesDestination.Finalize;
begin
  {$IFDEF DX_INITIALIZATION_LOGGING}TdxUnitSectionsLogger.DestructorStarted(UnitName, 'TdxDefaultCharacterPropertiesDestination.Finalize', SysInit.HInstance);{$ENDIF}
  FreeAndNil(FKeywordHT);
  {$IFDEF DX_INITIALIZATION_LOGGING}TdxUnitSectionsLogger.DestructorFinished(UnitName, 'TdxDefaultCharacterPropertiesDestination.Finalize', SysInit.HInstance);{$ENDIF}
end;
