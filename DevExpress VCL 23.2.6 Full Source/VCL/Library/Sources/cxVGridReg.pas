...
type
  ...
  { TcxCustomEditorRowPropertiesVisibleForExpressionEditorPropertyEditor }

  TcxCustomEditorRowPropertiesVisibleForExpressionEditorPropertyEditor = class(TdxDefaultBooleanPropertyEditor)
  protected
...
function TcxCustomEditorRowPropertiesVisibleForExpressionEditorPropertyEditor.GetDefaultValue: Boolean;
begin
  Result := TcxCustomEditorRowPropertiesAccess(GetComponent(0)).IsDefaultVisibleForExpressionEditor;
end;
...
begin
  ...
  RegisterPropertyEditor(TypeInfo(TdxDefaultBoolean), TcxCustomEditorRowProperties, 'VisibleForExpressionEditor',
    TcxCustomEditorRowPropertiesVisibleForExpressionEditorPropertyEditor);
end;
