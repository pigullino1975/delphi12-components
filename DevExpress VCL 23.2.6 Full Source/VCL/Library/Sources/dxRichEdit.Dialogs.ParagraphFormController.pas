...
const
  dxThisUnitName = 'dxRichEdit.Dialogs.ParagraphFormController';

{ TdxParagraphFormControllerParameters }

constructor TdxParagraphFormControllerParameters.Create(const AControl: IdxRichEditControl; AParagraphProperties: TdxMergedParagraphProperties;
      AUnitConverter: TdxDocumentModelUnitConverter);
begin
