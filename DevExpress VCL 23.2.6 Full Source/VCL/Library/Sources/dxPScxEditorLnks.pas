...
uses
  ...
  cxControls, cxContainer, cxGraphics, dxPSCore, dxPScxEditorProducers, dxPSLbxLnk, dxPSGraphicLnk, dxPSTextLnk,
  cxListBox, cxImage, cxEdit, cxMemo, dxBarCode, dxBarCodeUtils;
...
uses
  ...
  dxPScxCommon, cxGeometry, dxCore;

const
  dxThisUnitName = 'dxPScxEditorLnks';
...
begin
  ...
  AnItem.FitMode := ABarCodeProperties.FitMode;
