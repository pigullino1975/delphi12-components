...
resourcestring
  ...
  sdxRichEditBorderShadingDialogNoColor = 'No color';
  ...
  sdxDocumentEncryptionQueryNewPasswordForm = 'Encrypt File Contents';
...
const
  dxThisUnitName = 'dxRichEdit.Dialogs.Strs';
...
begin
  ...
  AProduct.Add('sdxRichEditBorderShadingDialogNoColor', @sdxRichEditBorderShadingDialogNoColor);
