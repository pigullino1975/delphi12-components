...
const
  dxThisUnitName = 'cxPivotGridCustomDataSet';
...
begin
  ...
  if (APivotGridField.Area = faData) and (APivotGridField.SummaryType in [stMin, stMax]) and APivotGridField.DataBinding.ValueTypeClass.IsString then
  begin
    Result := ftString;
    Exit;
  end;
