...
{                                                                    }
{********************************************************************}
unit dxRichEdit.Import.Doc.DocStyles; // for internal use
...
const
  dxThisUnitName = 'dxRichEdit.Import.Doc.DocStyles';
...
begin
  ...
  try
    ...
    try
      AParagraphPropertiesActions.CreateParagraphPropertyModifiers;
