...
uses
  ...
  dxNavBarCustomPainters, dxNavBarBaseViews, cxGeometry;
...
uses
  Types, cxGraphics, dxNavBarViewsFact, dxNavBarGraphics, dxNavBarConsts, dxCore;

const
  dxThisUnitName = 'dxNavBarVSToolBoxViews';
...
begin
  inherited;
  AHintInfo.HintPos := NavBar.ClientToScreen(NavBar.ViewInfo.ClientRect.TopLeft);
end;
...
begin
  ...
  if ALinkViewInfo <> nil then
    ...
    begin
      ...
      SelectionPainterClass.DrawSelection(ACanvas, R, GroupViewInfo.BgBackColor, [sHotTracked], ScaleFactor);
