...
const
  dxThisUnitName = 'cxEditDBRegisteredRepositoryItems';
...
initialization
  ...
  dxUnitsLoader.AddUnit(SysInit.HInstance, dxThisUnitName, CreateDefaultRepositoryItems, DeleteDefaultRepositoryItems);

finalization
  {$IFDEF DX_INITIALIZATION_LOGGING}TdxUnitSectionsLogger.FinalizationStarted(dxThisUnitName, SysInit.HInstance);{$ENDIF}
  dxUnitsLoader.RemoveUnit(SysInit.HInstance, dxThisUnitName, DeleteDefaultRepositoryItems);
  dxFreeGlobalObject(DefaultDBEditRepositoryItems);
