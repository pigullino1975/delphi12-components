...
unit dxRichEdit.Import.Rtf.DestinationOldParagraphNumbering; // for internal use
...
uses
  Types, Classes, Math, SysUtils, Graphics, Generics.Defaults, Generics.Collections, RTLConsts,
  dxCoreClasses,
  dxRichEdit.Import,
...
type
  ...
  private
    ...
    class procedure ForegroundColorKeywordHandler(AImporter: TdxRtfImporter; AParameterValue: Integer; AHasParameter: Boolean); static;
  ...
  protected
    class function GetKeywordHT: TdxKeywordTranslatorTable; override;
    function CreateClone: TdxRichEditRtfDestinationBase; override;
    function CreateRtfOldListLevelInfo: TdxRtfOldListLevelInfo;
...
uses
  ...
  dxRichEdit.Utils.Exceptions, dxCore;

const
  dxThisUnitName = 'dxRichEdit.Import.Rtf.DestinationOldParagraphNumbering';
...
begin
  ...
  FMultiLevelListIndex := NumberingListIndexListIndexNotSet;
  FSimpleListIndex := NumberingListIndexListIndexNotSet;
end;
...
begin
  ...
  AExistingNumberingListIndex := NumberingListIndexListIndexNotSet;
...
begin
  {$IFDEF DX_INITIALIZATION_LOGGING}TdxUnitSectionsLogger.ConstructorStarted(UnitName, 'TdxDestinationOldParagraphNumbering.Initialize', SysInit.HInstance);{$ENDIF}
  FKeywordHT := CreateKeywordHT;
  {$IFDEF DX_INITIALIZATION_LOGGING}TdxUnitSectionsLogger.ConstructorFinished(UnitName, 'TdxDestinationOldParagraphNumbering.Initialize', SysInit.HInstance);{$ENDIF}
end;

class destructor TdxDestinationOldParagraphNumbering.Finalize;
begin
  {$IFDEF DX_INITIALIZATION_LOGGING}TdxUnitSectionsLogger.DestructorStarted(UnitName, 'TdxDestinationOldParagraphNumbering.Finalize', SysInit.HInstance);{$ENDIF}
  FreeAndNil(FKeywordHT);
  {$IFDEF DX_INITIALIZATION_LOGGING}TdxUnitSectionsLogger.DestructorFinished(UnitName, 'TdxDestinationOldParagraphNumbering.Finalize', SysInit.HInstance);{$ENDIF}
end;
...
begin
  {$IFDEF DX_INITIALIZATION_LOGGING}TdxUnitSectionsLogger.ConstructorStarted(UnitName, 'TdxDestinationOldSectionNumberingLevel.Initialize', SysInit.HInstance);{$ENDIF}
  FKeywordHT := CreateKeywordTable;
  {$IFDEF DX_INITIALIZATION_LOGGING}TdxUnitSectionsLogger.ConstructorFinished(UnitName, 'TdxDestinationOldSectionNumberingLevel.Initialize', SysInit.HInstance);{$ENDIF}
end;

class destructor TdxDestinationOldSectionNumberingLevel.Finalize;
begin
  {$IFDEF DX_INITIALIZATION_LOGGING}TdxUnitSectionsLogger.DestructorStarted(UnitName, 'TdxDestinationOldSectionNumberingLevel.Finalize', SysInit.HInstance);{$ENDIF}
  FreeAndNil(FKeywordHT);
  {$IFDEF DX_INITIALIZATION_LOGGING}TdxUnitSectionsLogger.DestructorFinished(UnitName, 'TdxDestinationOldSectionNumberingLevel.Finalize', SysInit.HInstance);{$ENDIF}
end;
