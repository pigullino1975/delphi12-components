...
resourcestring
  ...
  scxgwSelectViewPageGroupHeaderEMFViews = 'EMF Views';
  ...
  // EMF Data Source Page
  scxgwEMFDataSourcePageCollectionName = 'Collection: ';
  scxgwEMFDataSourcePageCollectionNameHint = '';
  scxgwEMFDataSourcePageDescription = 'Specify an EMF data source. Make sure that your data source has the EntityName and Session properties assigned.';
  scxgwEMFDataSourcePageMasterViewKeyFieldNamesHint =
    'Master Key Fields specify a list of fields in a master data source' + #13#10 +
    'that establish a master-detail relationship between two data sources.';
  scxgwEMFDataSourcePageDetailKeyFieldNamesHint =
    'Detail Key Fields specify one or more field names' + #13#10 +
    'in a detail data source that uniquely identify each detail record';
  scxgwEMFDataSourcePageInMemoryModeName = 'In-memory mode';
  scxgwEMFDataSourcePageQueryModeName = 'Query mode';

  // EMF Select Items For Display Page
  scxgwEMFSelectItemsForDisplayDataSourceFields = 'Remaining Fields in the Data Source';
...
const
  dxThisUnitName = 'cxGridWizardStrs';
