...
const
  dxThisUnitName = 'dxRichEdit.Dialogs.UnderlinePainter';
...
begin
  {$IFDEF DX_INITIALIZATION_LOGGING}TdxUnitSectionsLogger.ConstructorStarted(UnitName, 'TdxScreenCharacterLinePainter.Initialize', SysInit.HInstance);{$ENDIF}
  FParametersTable := TdxPatternLinePainterParametersTable.Create([doOwnsValues]);
  {$IFDEF DX_INITIALIZATION_LOGGING}TdxUnitSectionsLogger.ConstructorFinished(UnitName, 'TdxScreenCharacterLinePainter.Initialize', SysInit.HInstance);{$ENDIF}
end;
...
begin
  {$IFDEF DX_INITIALIZATION_LOGGING}TdxUnitSectionsLogger.DestructorStarted(UnitName, 'TdxScreenCharacterLinePainter.Finalize', SysInit.HInstance);{$ENDIF}
  FParametersTable.Free;
  {$IFDEF DX_INITIALIZATION_LOGGING}TdxUnitSectionsLogger.DestructorFinished(UnitName, 'TdxScreenCharacterLinePainter.Finalize', SysInit.HInstance);{$ENDIF}
end;
