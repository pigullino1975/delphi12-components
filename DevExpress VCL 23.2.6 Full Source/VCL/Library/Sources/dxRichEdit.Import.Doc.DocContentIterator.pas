...
{                                                                    }
{********************************************************************}
unit dxRichEdit.Import.Doc.DocContentIterator; // for internal use
...
const
  dxThisUnitName = 'dxRichEdit.Import.Doc.DocContentIterator';
...
begin
  {$IFDEF DX_INITIALIZATION_LOGGING}TdxUnitSectionsLogger.ConstructorStarted(UnitName, 'TdxDocFieldsIterator.Initialize', SysInit.HInstance);{$ENDIF}
  ...
  {$IFDEF DX_INITIALIZATION_LOGGING}TdxUnitSectionsLogger.ConstructorFinished(UnitName, 'TdxDocFieldsIterator.Initialize', SysInit.HInstance);{$ENDIF}
end;

class destructor TdxDocFieldsIterator.Finalize; 
begin
  {$IFDEF DX_INITIALIZATION_LOGGING}TdxUnitSectionsLogger.DestructorStarted(UnitName, 'TdxDocFieldsIterator.Finalize', SysInit.HInstance);{$ENDIF}
  FUnsupportedFieldCodes.Free;
  {$IFDEF DX_INITIALIZATION_LOGGING}TdxUnitSectionsLogger.DestructorFinished(UnitName, 'TdxDocFieldsIterator.Finalize', SysInit.HInstance);{$ENDIF}
end;
