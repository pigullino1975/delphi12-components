...
unit dxRichEdit.DocumentModel.Intervals; // for internal use
...
uses
  Types, SysUtils, Classes, Contnrs, Generics.Defaults, Generics.Collections, RTLConsts,
...
const
  dxThisUnitName = 'dxRichEdit.DocumentModel.Intervals';
