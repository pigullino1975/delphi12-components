...
uses
  System.UITypes,
  Classes, SysUtils, Windows, Messages, Variants, Types, dxCore, Forms, Controls, ImgList, StdCtrls, Graphics,
  ...
  cxGeometry, cxLibraryConsts, dxCustomHint, cxFindPanel, dxDateRanges, cxDateUtils, cxFilter, cxListBox,
  dxFilterPopupWindow, cxEdit, cxTextEdit, cxEditDataRegisteredRepositoryItems, cxNavigator,
  cxFilterControl, dxFilterValueContainer, dxFilterBox, dxScrollbarAnnotations;
...
type
  ...
  protected
    ...
    procedure Load(AItem: TcxCustomInplaceEditContainer; AInitSortByDisplayText: Boolean;
      ...
      AFilteredValuesShowFilteredItemsOnly: Boolean); reintroduce; overload;
  public
  ...
  protected
    ...
    function GetDefaultValuesProvider(AProperties: TcxCustomEditProperties): TcxCustomEditDefaultValuesProvider; virtual;
    ...
    function IsValueTypeChangeable: Boolean; virtual;
    function IsValueTypeStored: Boolean; virtual;
    procedure ResetValueTypeClass; virtual;
  ...
  public
    ...
    property StoredExpression: string read GetStoredExpression write SetStoredExpression; //for internal use only
  ...
  strict private
    ...
    FFilteredItemsListShowFilteredItemsOnly: Boolean;

    function GetEditContainer: TcxCustomInplaceEditContainer;
    procedure SetFilteredItemsList(Value: Boolean);
    procedure SetFilteredItemsListShowFilteredItemsOnly(Value: Boolean);
  protected
    procedure Changed; virtual;

    property EditContainer: TcxCustomInplaceEditContainer read GetEditContainer;
    property FilteredItemsList: Boolean read FFilteredItemsList write SetFilteredItemsList default True;
    property FilteredItemsListShowFilteredItemsOnly: Boolean read FFilteredItemsListShowFilteredItemsOnly
      write SetFilteredItemsListShowFilteredItemsOnly default True;
  public
    constructor Create(AOwner: TPersistent); override;
  ...
  TcxControlOptions = class(TcxOwnedInterfacedPersistent)
  private
    function GetEditingControl: TcxEditingControl;
  protected
    procedure Changed; virtual;
  ...
  TcxControlOptionsFilterBoxTokenCriteria = class(TcxControlOptions,
  ...
  private
    ...
    FTokenCriteria: TcxControlOptionsFilterBoxTokenCriteria;
    ...
    procedure SetTokenCriteria(Value: TcxControlOptionsFilterBoxTokenCriteria);
  protected
    procedure AddFilterToMRUItems; virtual;
    function CreateTokenCriteria: TcxControlOptionsFilterBoxTokenCriteria; virtual;
  ...
  published
    ...
    property TokenCriteria: TcxControlOptionsFilterBoxTokenCriteria read FTokenCriteria write SetTokenCriteria;
  end;
  ...
  strict private
    ...
    procedure SetFilteredItemsListShowFilteredItemsOnly(AValue: Boolean);
  protected
  ...
  published
    property ExpressionEditing: Boolean read FExpressionEditing write SetExpressionEditing default False;
  end;
  ...
  TcxControlScrollbarAnnotationOptionsHelper = class(TdxScrollbarAnnotationOptions)
  strict private
    FOwner: TcxExtEditingControl;
  protected
  ...
  public
    constructor Create(AOwner: TcxExtEditingControl); virtual;
  end;

  TcxControlScrollbarAnnotationOptions = class(TcxControlOptions)
  strict private
    FHelper: TcxControlScrollbarAnnotationOptionsHelper;
  ...
  protected
    function CreateHelper: TcxControlScrollbarAnnotationOptionsHelper; virtual;
    procedure DoAssign(Source: TPersistent); override;
    property Helper: TcxControlScrollbarAnnotationOptionsHelper read FHelper;
  public
    constructor Create(AOwner: TPersistent); override;
    destructor Destroy; override;
    function GetStyle(AKind: TdxScrollbarAnnotationKind): TdxScrollbarAnnotationStyle;
  ...
  protected
    ...
    FOnGetFilterImages: TcxGetFilterImagesEvent;
    ...
    property OnGetFilterImages: TcxGetFilterImagesEvent read FOnGetFilterImages write FOnGetFilterImages;
  ...
  protected
    ...
    function AllowDesignMouseEvents(const P: TPoint; AShift: TShiftState): Boolean; overload;
    function AllowDesignMouseEvents(X, Y: Integer; AShift: TShiftState): Boolean; overload; virtual;
  ...
  protected
    ...
    property ThumbTracking: Boolean read FThumbTracking write SetThumbTracking;
  ...
  protected
    ...
    // scroll animation
    procedure InitializeCellBeforeScrollAnimation;
    procedure FinalizeCellAfterScrollAnimation;
  ...
  private
    ...
    function GetPanelsHeight(APosition: TcxFilterBoxPosition): Integer;
    function GetScaleFactor: TdxScaleFactor;
  ...
  protected
    ...
    property PanelsHeight[APosition: TcxFilterBoxPosition]: Integer read GetPanelsHeight;
    property ScaleFactor: TdxScaleFactor read GetScaleFactor;
  ...
  public
    ...
    property Painter: TcxCustomControlPainter read FPainter write FPainter; // for internal use
  end;
  ...
  private
    function GetItem(AIndex: TdxListIndex): TcxCustomViewInfoItem;
  public
    ...
    property Items[Index: TdxListIndex]: TcxCustomViewInfoItem read GetItem; default;
  end;
  ...
  protected
    ...
    function GetCellBorderWidth: Integer; virtual;
    ...
    procedure GetFindTextInfo(out AStart, ALength: Integer); virtual; abstract;
    function GetFocused: Boolean; virtual;
    function GetInplaceEditPosition: TcxInplaceEditPosition;
    function GetMaxLineCount: Integer; virtual;
    function GetRealCellEditRect: TRect; virtual;
    ...
    procedure InitializeByHiddenEditor(AEdit: TcxCustomEdit); virtual;
    ...
    function NeedHideEdit: Boolean; virtual;
  ...
  protected
    ...
    property VertOffset: Integer read GetVertOffset;
    property Width: Integer read GetWidth;
  end;
  ...
  { TcxControlFindPanelNextButtonViewInfo }

  TcxControlFindPanelNextButtonViewInfo = class(TcxControlFindPanelButtonViewInfo)
  protected
    function GetKind: TcxFindPanelItemKind; override;
  end;

  { TcxControlFindPanelPreviousButtonViewInfo }

  TcxControlFindPanelPreviousButtonViewInfo = class(TcxControlFindPanelButtonViewInfo)
  protected
    function GetKind: TcxFindPanelItemKind; override;
  end;
  ...
  private
    ...
    FNextButtonViewInfo: TcxControlFindPanelNextButtonViewInfo;
    FPreviousButtonViewInfo: TcxControlFindPanelPreviousButtonViewInfo;
  ...
  protected
    ...
    procedure CalculateNextButton; virtual;
    procedure CalculatePreviousButton; virtual;
    ...
    function IsNextButtonVisible: Boolean; virtual;
    function IsPreviousButtonVisible: Boolean; virtual;
    ...
    property FindPanel: TcxControlFindPanel read GetFindPanel;
    property NextButtonViewInfo: TcxControlFindPanelNextButtonViewInfo read FNextButtonViewInfo;
    property PreviousButtonViewInfo: TcxControlFindPanelPreviousButtonViewInfo read FPreviousButtonViewInfo;
  public
    constructor Create(AOwner: TObject); override;
    destructor Destroy; override;
  end;
  ...
  protected
    ...
    function IsDropDownWindowExists: Boolean; virtual;
  ...
  protected
    ...
    procedure CalculateTokenCriteriaViewInfo; virtual;
    ...
    function GetHeight: Integer; override;
    function GetItemFromPoint(const APoint: TPoint): TcxControlItemViewInfo; override;
    function GetTextAreaLeft: Integer; virtual;
    function GetTextAreaRight: Integer; virtual;
    procedure GetViewParams(var AParams: TcxViewParams); override;
  ...
  public
    ...
    procedure RefreshTokenCriteriaViewInfo; virtual;
  end;
  ...
  public
    ...
    property Painter: TcxCustomLookAndFeelPainter read GetPainter;
    property ScaleFactor: TdxScaleFactor read GetScaleFactor;
    property ViewInfo: TcxCustomControlViewInfo read GetViewInfo; // for internal use
  end;
  ...
  TcxEditingControlScrollbarAnnotations = class(TdxScrollbarAnnotations) // for internal use
  strict private
    FOwner: TcxExtEditingControl;
  protected
  ...
  public
    constructor Create(AOwner: TcxExtEditingControl);
  ...
  TcxEditingControl = class(TcxControl)
  private
    ...
    FScrollbarAnnotationHelper: TcxEditingControlScrollbarAnnotations;
    ...
    FOnGetScrollbarAnnotationHint: TdxGetScrollbarAnnotationHint;
    FOnInitEdit: TcxecInitEditEvent;
    FOnInitEditValue: TcxecInitEditValueEvent;
    FOnInitFilteringDateRanges: TdxInitDateRangesEvent;
    FOnPopulateCustomScrollbarAnnotationRowIndexList: TdxPopulateCustomScrollbarAnnotationRowIndexList;
  ...
  protected
    ...
    function CreateExpressionProvider: TcxDataCustomExpressionProvider; virtual; abstract;
    ...
    procedure DestroyFilterBoxTokenCriteria; virtual;
    ...
    function HasInitFilteringDateRangesHandler: Boolean;
    function IsRecordIndexBasedScrollbarAnnotationRendering: Boolean; virtual;
    ...
    property ScrollbarAnnotationHelper: TcxEditingControlScrollbarAnnotations read FScrollbarAnnotationHelper;
    ...
    property OnGetScrollbarAnnotationHint: TdxGetScrollbarAnnotationHint read FOnGetScrollbarAnnotationHint
      write FOnGetScrollbarAnnotationHint;
    ...
    property OnInitFilteringDateRanges: TdxInitDateRangesEvent read FOnInitFilteringDateRanges write FOnInitFilteringDateRanges;
    property OnPopulateCustomScrollbarAnnotationRowIndexList: TdxPopulateCustomScrollbarAnnotationRowIndexList read FOnPopulateCustomScrollbarAnnotationRowIndexList write FOnPopulateCustomScrollbarAnnotationRowIndexList;
  public
    constructor Create(AOwner: TComponent); override;
    destructor Destroy; override;
  ...
  private
    ...
    FScrollbarAnnotations: TcxControlScrollbarAnnotationOptions;
    ...
    procedure SetScrollbarAnnotations(Value: TcxControlScrollbarAnnotationOptions);
  protected
    ...
    function CreateScrollbarAnnotationHelper: TcxEditingControlScrollbarAnnotations; virtual;
    function CreateScrollbarAnnotations: TcxControlScrollbarAnnotationOptions; virtual;
    ...
    property ScrollbarAnnotations: TcxControlScrollbarAnnotationOptions read FScrollbarAnnotations write SetScrollbarAnnotations; 
    property ViewInfo: TcxExtEditingControlViewInfo read GetViewInfo;
  end;
...
uses
  ...
  cxDrawTextUtils, cxDropDownEdit, RTLConsts, dxCoreGraphics, dxScrollAnimation, dxThreading, dxMessageDialog,
  cxImageComboBox;

const
  dxThisUnitName = 'cxInplaceContainer';
...
procedure TcxControlFindPanel.GetControlContentViewParams(var AParams: TcxViewParams);
begin
  EditingControl.Styles.GetViewParams(ecs_Content, nil, nil, AParams);
end;

function TcxControlFindPanel.GetCriteria: TcxDataFindCriteria;
begin
  Result := EditingControl.DataController.FindCriteria;
end;

function TcxControlFindPanel.GetLookAndFeel: TcxLookAndFeel;
begin
...
function TcxControlFindPanel.GetControl: TcxControl;
begin
  Result := EditingControl;
end;
...
procedure TcxControlFindPanel.Invalidate(ARecalculate: Boolean = False);
begin
  if EditingControl.ViewInfo.FindPanelViewInfo.VisibleInfoCalculated then
    EditingControl.ViewInfo.FindPanelViewInfo.Invalidate(ARecalculate);
end;
...
function TcxControlOptionsFindPanel.GetBehavior: TcxDataFindCriteriaBehavior;
begin
...
function TcxControlOptionsFindPanel.GetLayout: TcxFindPanelLayout;
begin
...
function TcxControlOptionsFindPanel.GetShowNextButton: Boolean;
begin
  Result := Options.ShowNextButton;
end;

function TcxControlOptionsFindPanel.GetShowPreviousButton: Boolean;
begin
...
procedure TcxControlOptionsFindPanel.SetBehavior(AValue: TcxDataFindCriteriaBehavior);
begin
...
procedure TcxControlOptionsFindPanel.SetLayout(AValue: TcxFindPanelLayout);
begin
...
procedure TcxControlOptionsFindPanel.SetShowNextButton(AValue: Boolean);
begin
  Options.ShowNextButton := AValue;
end;

procedure TcxControlOptionsFindPanel.SetShowPreviousButton(AValue: Boolean);
begin
...
begin
  inherited Load(AItem.ItemIndex, AInitSortByDisplayText, AUseFilteredValues, AAddValueItems,
...
procedure TcxCustomItemDataBinding.Assign(Source: TPersistent);
begin
  if Source is TcxCustomItemDataBinding then
  begin
    Expression := TcxItemDataBinding(Source).Expression;
...
function TcxCustomItemDataBinding.GetDefaultValuesProvider(
  AProperties: TcxCustomEditProperties): TcxCustomEditDefaultValuesProvider;
begin
...
function TcxCustomItemDataBinding.GetDefaultValueTypeClass: TcxValueTypeClass;
begin
...
function TcxCustomItemDataBinding.GetValueType: string;
begin
...
begin
  if FValueTypeClass = nil then
    Result := GetDefaultValueTypeClass
  else
...
function TcxCustomItemDataBinding.IsValueTypeChangeable: Boolean;
begin
  Result := True;
end;

function TcxCustomItemDataBinding.IsValueTypeStored: Boolean;
begin
  Result := ValueTypeClass <> GetDefaultValueTypeClass;
end;

procedure TcxCustomItemDataBinding.ResetValueTypeClass;
begin
  FValueTypeClass := nil;
end;

procedure TcxCustomItemDataBinding.SetValueTypeClass(Value: TcxValueTypeClass);
begin
  if (ValueTypeClass <> Value) and IsValueTypeChangeable then
  begin
...
begin
  ...
  DataController.ChangeValueTypeClass(EditContainer.ItemIndex, ValueTypeClass);
...
begin
  ...
  if (AText = '') and not (VarIsNull(AValue) or VarIsArray(AValue)) then
    AText := EditContainer.PropertiesValue.GetDisplayText(AValue);
...
begin
  AValueList.Load(EditContainer, AInitSortByDisplayText,
    ...
    EditContainer.UseValueItemsForFilterValueList, AUniqueOnly, EditContainer.ShowFilteredItemsOnlyForFilteredValues);
...
function TcxCustomItemDataBinding.GetExpression: string;
begin
  if csWriting in EditContainer.EditingControl.ComponentState then
    Result := StoredExpression
  else
    Result := DataController.ItemExpressions[EditContainer.ItemIndex];
end;
...
function TcxCustomItemDataBinding.GetStoredExpression: string;
begin
  Result := DataController.ItemExpressions[EditContainer.ItemIndex];
  if Result <> '' then
...
procedure TcxCustomItemDataBinding.SetExpression(const AValue: string);
begin
  if csReading in EditContainer.EditingControl.ComponentState then
    StoredExpression := AValue
  else
    DataController.ItemExpressions[EditContainer.ItemIndex] := AValue;
end;
...
procedure TcxCustomItemDataBinding.SetStoredExpression(const AValue: string);
var
  AExpression: string;
begin
  AExpression := AValue;
  ...
  DataController.ItemExpressions[EditContainer.ItemIndex] := AExpression;
end;

procedure TcxCustomItemDataBinding.SetValueType(const Value: string);
begin
...
function TcxControlDataController.CreateExpressionProvider: TcxDataCustomExpressionProvider;
begin
  Result := GetControl.CreateExpressionProvider;
end;
...
begin
  ...
  FFilteredItemsListShowFilteredItemsOnly := True;
end;
...
begin
  ...
  begin
    ...
    FilteredItemsListShowFilteredItemsOnly := ASource.FilteredItemsListShowFilteredItemsOnly;
  end;
end;
...
procedure TcxCustomEditContainerItemCustomFilterPopupOptions.SetFilteredItemsListShowFilteredItemsOnly(Value: Boolean);
begin
  if FilteredItemsListShowFilteredItemsOnly <> Value then
  begin
    FFilteredItemsListShowFilteredItemsOnly := Value;
    Changed;
  end;
end;
...
begin
  ...
  begin
    ...
    EditContainer.CheckUsingInFindCriteria;
  end;
end;
...
constructor TcxControlOptionsFilterBoxTokenCriteria.Create(AOwner: TPersistent);
begin
  inherited Create(AOwner);
  FItemRemoval := True;
end;

procedure TcxControlOptionsFilterBoxTokenCriteria.Assign(Source: TPersistent);
var
  ASource: TcxControlOptionsFilterBoxTokenCriteria;
begin
  inherited Assign(Source);
  if Source is TcxControlOptionsFilterBoxTokenCriteria then
  begin
    ASource := TcxControlOptionsFilterBoxTokenCriteria(Source);
    ItemRemoval := ASource.ItemRemoval;
  end;
end;

function TcxControlOptionsFilterBoxTokenCriteria.GetItemRemoval: Boolean;
begin
  Result := FItemRemoval;
end;

procedure TcxControlOptionsFilterBoxTokenCriteria.SetItemRemoval(AValue: Boolean);
begin
...
begin
  ...
  begin
    ...
    CriteriaDisplayStyle := ASource.CriteriaDisplayStyle;
    ...
    TokenCriteria := ASource.TokenCriteria;
  end;
end;
...
function TcxControlOptionsFilterBox.CreateTokenCriteria: TcxControlOptionsFilterBoxTokenCriteria;
begin
  Result := TcxControlOptionsFilterBoxTokenCriteria.Create(EditingControl);
end;
...
function TcxControlOptionsFilterBox.UseTokens: Boolean;
begin
...
procedure TcxControlOptionsFilterBox.SetCriteriaDisplayStyle(Value: TcxFilterCriteriaDisplayStyle);
begin
  if CriteriaDisplayStyle <> Value then
  begin
    FCriteriaDisplayStyle := Value;
    if not UseTokens  then
      EditingControl.DestroyFilterBoxTokenCriteria;
    EditingControl.UpdateLinkedFilterControls;
    Changed;
  end;
end;
...
procedure TcxControlOptionsFilterBox.SetTokenCriteria(Value: TcxControlOptionsFilterBoxTokenCriteria);
begin
...
constructor TcxControlOptionsFilteringItemCustomPopup.Create(AOwner: TPersistent);
begin
  inherited Create(AOwner);
  FFilteredItemsListShowFilteredItemsOnly := True;
end;
...
begin
  ...
  begin
    ...
    FilteredItemsListShowFilteredItemsOnly := AOptions.FilteredItemsListShowFilteredItemsOnly;
  end;
end;
...
procedure TcxControlOptionsFilteringItemCustomPopup.SetFilteredItemsListShowFilteredItemsOnly(AValue: Boolean);
begin
  if FFilteredItemsListShowFilteredItemsOnly <> AValue then
  begin
    FFilteredItemsListShowFilteredItemsOnly := AValue;
    Changed;
  end;
end;
...
procedure TcxControlOptionsFiltering.SetExpressionEditing(Value: Boolean);
begin
  if ExpressionEditing <> Value then
  begin
...
begin
  ...
  begin
    ...
    ExpressionEditing := ASource.ExpressionEditing;
...
{ TcxControlScrollbarAnnotationOptionsHelper }

constructor TcxControlScrollbarAnnotationOptionsHelper.Create(AOwner: TcxExtEditingControl);
begin
  inherited Create;
  FOwner := AOwner;
end;

procedure TcxControlScrollbarAnnotationOptionsHelper.CheckScrollbarAnnotations;
begin
  FOwner.CheckScrollbarAnnotations;
end;

function TcxControlScrollbarAnnotationOptionsHelper.IsVisible(AKind: Integer): Boolean;
begin
  Result := inherited IsVisible(AKind) and FOwner.IsScrollbarAnnotationVisible(AKind);
end;

procedure TcxControlScrollbarAnnotationOptionsHelper.RefreshScrollbarAnnotations(
...
constructor TcxControlScrollbarAnnotationOptions.Create(AOwner: TPersistent);
begin
  inherited Create(AOwner);
  FHelper := CreateHelper;
end;

destructor TcxControlScrollbarAnnotationOptions.Destroy;
begin
  FreeAndNil(FHelper);
  inherited;
end;

function TcxControlScrollbarAnnotationOptions.CreateHelper: TcxControlScrollbarAnnotationOptionsHelper;
begin
  Result := TcxControlScrollbarAnnotationOptionsHelper.Create(EditingControl as TcxExtEditingControl);
end;

procedure TcxControlScrollbarAnnotationOptions.DoAssign(Source: TPersistent);
begin
  if Source is TcxControlScrollbarAnnotationOptions then
    FHelper.Assign(TcxControlScrollbarAnnotationOptions(Source).FHelper);
end;

function TcxControlScrollbarAnnotationOptions.GetCustomScrollbarAnnotations: TdxCustomScrollbarAnnotations;
begin
  Result := FHelper.CustomAnnotations;
end;

function TcxControlScrollbarAnnotationOptions.GetStyle(
  AKind: TdxScrollbarAnnotationKind): TdxScrollbarAnnotationStyle;
begin
  Result := FHelper.GetStyle(AKind);
end;

function TcxControlScrollbarAnnotationOptions.GetValue(
  const Index: Integer): Boolean;
begin
  Result := FHelper.GetValue(Index);
end;

function TcxControlScrollbarAnnotationOptions.IsValueStored(Index: Integer): Boolean;
begin
  Result := FHelper.GetDefaultValue(Index) <> GetValue(Index);
end;

procedure TcxControlScrollbarAnnotationOptions.SetCustomScrollbarAnnotations(
  const Value: TdxCustomScrollbarAnnotations);
begin
  FHelper.CustomAnnotations := Value;
end;

procedure TcxControlScrollbarAnnotationOptions.SetValue(const Index: Integer;
  const Value: Boolean);
begin
...
begin
  ...
  begin
    ...
    FFilterImages := ASource.FFilterImages;
    ...
    VisibleForExpressionEditor := ASource.VisibleForExpressionEditor;
...
function TcxCustomInplaceEditContainer.IsExpression: Boolean;
begin
  Result := DataController.IsItemExpression(ItemIndex);
end;

procedure TcxCustomInplaceEditContainer.ShowExpressionEditor;
begin
  DataController.ExpressionProvider.EditExpression(ItemIndex);
end;
...
function TcxCustomInplaceEditContainer.GetFilterImages: TCustomImageList;
begin
  Result := FFilterImages;
end;

procedure TcxCustomInplaceEditContainer.PopulateFilterImages(AValues: TcxFilterValueList);
var
  I: Integer;
  AItems: TcxImageComboBoxProperties;
  AItem: TcxImageComboBoxItem;
begin
  if Safe.Cast(GetPropertiesValue, TcxImageComboBoxProperties, AItems) then
  begin
...
procedure TcxCustomInplaceEditContainer.CheckUsingInFindCriteria;
begin
  if csDestroying in ComponentState then
    Exit;
  if CanFind then
    EditingControl.DataController.FindCriteria.AddItem(ItemIndex)
  else
    EditingControl.DataController.FindCriteria.RemoveItem(ItemIndex);
end;
...
begin
  Result := AProperties.CreateViewData(GetEditStyle(AEditStyleData), True, ScaleFactor);
...
procedure TcxCustomInplaceEditContainer.DoGetFilterImages(AValueList: TcxFilterValueList; var AImages: TCustomImageList);
begin
...
begin
  Result := FDataBinding.ValueTypeClass;
end;
...
begin
  ASizeProp := cxDefaultEditSizeProperties;
  AEditViewInfo.ViewData.Style.Font := AEditViewInfo.ViewParams.Font;
  if AEditViewInfo.ViewParams.Font = nil then
    EditViewData.Style.Font := EditingControl.Font;
  AEditViewInfo.ViewData.ContentOffset := AEditViewInfo.ContentOffset;
  ASizeProp.Width := cxRectWidth(AEditViewInfo.ContentRect);
  ASizeProp.MaxLineCount := AEditViewInfo.MaxLineCount;
  Result := AEditViewInfo.ViewData.GetEditSize(GetControlCanvas, AEditViewInfo.DisplayValue, ASizeProp).cy;
  Inc(Result, Byte(bBottom in AEditViewInfo.Borders) * AEditViewInfo.GetCellBorderWidth);
  Inc(Result, Byte(bTop in AEditViewInfo.Borders) * AEditViewInfo.GetCellBorderWidth);
end;
...
function TcxCustomInplaceEditContainer.ShowFilteredItemsOnlyForFilteredValues: Boolean;
var
  AControlPopupOptions: TcxControlOptionsFilteringItemCustomPopup;
...
begin
  ...
  begin
    AControlPopupOptions := EditingControl.Options.OptionsFiltering.ItemExcelPopup;
    AItemPopupOptions := FOptions.ExcelFilterPopup;
  end
  else
  begin
    AControlPopupOptions := EditingControl.Options.OptionsFiltering.ItemPopup;
    AItemPopupOptions := FOptions.FilterPopup;
  end;
  Result := AControlPopupOptions.FilteredItemsListShowFilteredItemsOnly and
    AItemPopupOptions.FilteredItemsListShowFilteredItemsOnly;
end;
...
begin
  ...
  Result := AControlPopupOptions.FilteredItemsList and AItemPopupOptions.FilteredItemsList;
end;
...
begin
  AEditViewInfo.EditViewInfo.ErrorData.Reset;
end;
...
begin
  ...
  if FDataBinding = nil then
    Result.DefaultValuesProvider := nil
  else
    Result.DefaultValuesProvider := FDataBinding.DefaultValuesProvider;
  ...
  begin
    ...
    begin
      try
        ...
        if Properties = PropertiesValue then
        ...
        ViewInfo.OnAfterDrawBackground := AEditViewInfo.AfterDrawCellBackgroundHandler;
        ViewInfo.OnAfterDrawValue := AEditViewInfo.AfterDrawCellValueHandler;
        ViewInfo.OnCanDrawEditValue := AEditViewInfo.CanDrawEditValueHandler;
        ViewInfo.OnCalculateEditorBounds := AEditViewInfo.CalculateCellEditorBounds;
...
begin
  ...
  begin
    LockUpdate(True);
    try
      DefaultValuesProvider := DataBinding.GetDefaultValuesProvider(AProperties);
    finally
      LockUpdate(False);
    end;
  end;
...
function TcxCustomInplaceEditContainer.IsDefaultVisibleForExpressionEditor: Boolean;
begin
  Result := IsVisible;
end;
...
function TcxCustomInplaceEditContainer.IsVisibleForExpressionEditor: Boolean;
begin
...
begin
  ...
  begin
    ...
    ACanShowHint := AIHotTrackElement.IsNeedHint(cxMeasureCanvas, PrevHitPoint,
    ...
    begin
      ...
      FHintHelper.ShowHint(AHintBounds, ATextRect, AHintText,
        AHintIsMultiLine, HintElement, cxMeasureCanvas.Font);
    end;
  end;
end;
...
begin
  ...
  if IsEditing and (Edit <> nil) and not Controller.ThumbTracking then
  begin
    Controller.BeforeShowEdit;
    AEditViewInfo := EditingCellViewInfo;
    if (AEditViewInfo = nil) or not AEditViewInfo.Visible or cxRectIsEmpty(AEditViewInfo.EditRect) or AEditViewInfo.NeedHideEdit then
...
begin
  Result := not (Controller.IsFindPanelVisible and Controller.FindPanel.IsEditFocused);
end;
...
procedure TcxEditingController.InitializeCellBeforeScrollAnimation;
var
  AViewInfo: TcxEditCellViewInfo;
begin
  if {FCellInitialized or} (EditingItem = nil) then
    Exit;
  AViewInfo := EditingCellViewInfo;
  if AViewInfo = nil then
    Exit;
  AViewInfo.InitializeByHiddenEditor(Edit);
  if not FWasEditHide then
  begin
...
procedure TcxEditingController.FinalizeCellAfterScrollAnimation;
begin
  if not FWasEditHide then
    Exit;
  ShowEditAfterScrollContent;
  FWasEditHide := False;
end;
...
procedure TcxEditingController.EditExecuteAction(Action: TBasicAction; var Handled: Boolean);
begin
  Handled := EditingControl.ExecuteAction(Action);
end;
...
procedure TcxEditingController.EditUpdateAction(Action: TBasicAction; var Handled: Boolean);
begin
  Handled := EditingControl.UpdateAction(Action);
end;
...
function TcxCustomHitTestController.AllowDesignMouseEvents(const P: TPoint; AShift: TShiftState): Boolean;
begin
  Result := AllowDesignMouseEvents(P.X, P.Y, AShift);
end;

function TcxCustomHitTestController.AllowDesignMouseEvents(X, Y: Integer; AShift: TShiftState): Boolean;
begin
...
var
  ...
  AEditorOrigin: TPoint;

  procedure DoShowEdit;
  var
    AMousePos, ANewEditorOrigin: TPoint;
  begin
    if Button <> mbLeft then Exit;

    if AButtonClick then
    begin
      ANewEditorOrigin := AEditViewInfo.GetRealCellEditRect.TopLeft;
      ...
      FEditingController.ShowEdit(AEditViewInfo.EditContainer, Shift, AMousePos.X, AMousePos.Y);
    end
    else
      FEditingController.ShowEdit(AEditViewInfo.EditContainer, [], -1, -1)
  end;
...
begin
  ...
  begin
    ...
    AEditorOrigin := AEditViewInfo.GetRealCellEditRect.TopLeft;
...
begin
  Result := (EditingController.Edit <> nil) and EditingController.Edit.IsFocused or
    IsFindPanelVisible and FindPanel.IsEditFocused or HasFilterPopup and FilterPopup.Visible;
end;
...
function TcxCustomControlController.IsPixelScrollBar(AKind: TScrollBarKind): Boolean;
begin
  Result := False;
end;
...
begin
  ...
  if IsEditing then
  begin
    if Safe.Cast(EditingController.Edit, TcxCustomDropDownEdit, ADropDownEdit) and ADropDownEdit.DroppedDown then
...
procedure TcxCustomControlController.SetThumbTracking(Value: Boolean);
begin
  if Value <> ThumbTracking then
  begin
...
begin
  FilterBoxViewInfo.RefreshTokenCriteriaViewInfo;
...
begin
  Result := (Control.Options.OptionsFilterBox.Visible = fvAlways) or
    (Control.Options.OptionsFilterBox.Visible = fvNonEmpty) and not FilterBoxViewInfo.Filter.IsEmpty;
end;

function TcxCustomControlViewInfo.IsFindPanelVisible: Boolean;
begin
  Result := Control.Controller.IsFindPanelVisible;
end;
...
function TcxCustomControlViewInfo.GetPanelsHeight(APosition: TcxFilterBoxPosition): Integer;
begin
  Result := 0;
  if FindPanelPosition = TcxFindPanelPosition(APosition) then
    Inc(Result, FindPanelHeight);
  if FilterBoxPosition = APosition then
...
function TcxCustomControlCells.GetItem(AIndex: TdxListIndex): TcxCustomViewInfoItem;
begin
    ...
    sbmClassic:
      begin
        ...
        begin
          ...
          if ABounds.Left > ABounds.Right then
...
function TcxCustomViewInfoItem.GetBordersScaleFactor: TdxScaleFactor;
begin
  Result := ScaleFactor;
end;
...
begin
  if not IsSupportedHotTrack or IsEditing then Exit;
...
begin
  ...
  begin
    ...
    begin
      Inc(Left, Byte(bLeft in CellBorders) * GetCellBorderWidth);
      Inc(Top, Byte(bTop in CellBorders) * GetCellBorderWidth);
      Dec(Right, Byte(bRight in CellBorders) * GetCellBorderWidth);
      Dec(Bottom, Byte(bBottom in CellBorders) * GetCellBorderWidth);
    end;
...
begin
  ...
  begin
    ...
    if Editing and (Controller.FocusedRecordIndex = RecordIndex) then
      InitializeByHiddenEditor(Controller.EditingController.Edit);
  end;
end;
...
function TcxEditCellViewInfo.GetCellBorderWidth: Integer;
begin
  Result := 1;
end;
...
function TcxEditCellViewInfo.GetRealCellEditRect: TRect;
begin
  Result := CellEditRect;
end;
...
begin
  ...
  GetFindTextInfo(ViewData.SelStart, ViewData.SelLength);
end;

procedure TcxEditCellViewInfo.InitializeByHiddenEditor(AEdit: TcxCustomEdit);
var
  AEditAccess: TcxCustomEditAccess;
  AViewData: TcxCustomEditViewData;
  ATextViewInfo: TcxCustomTextEditViewInfo;
begin
  if not (AEdit.HandleAllocated and ViewInfo.InheritsFrom(AEdit.ActiveProperties.GetViewInfoClass)) then
    Exit;
  AEditAccess := TcxCustomEditAccess(AEdit);
  AViewData := AEditAccess.CreateViewData;
  try
    AEditAccess.InitializeInfoForHiddenInplaceEditor(AViewData, ViewInfo);
    AViewData.ContentOffset := ContentOffset;
    AViewData.CalculateEx(EditContainer.GetControlCanvas, ContentRect, cxNullPoint, cxmbNone, [], ViewInfo, False);
    if Safe.Cast(ViewInfo, TcxCustomTextEditViewInfo, ATextViewInfo) then
      ATextViewInfo.IsEditClass := False;
  finally
    AViewData.Free;
  end;
end;
...
function TcxEditCellViewInfo.IsEditing: Boolean;
begin
  Result := EditContainer.Editing and (RecordIndex = EditContainer.Controller.FocusedRecordIndex);
end;
...
function TcxEditCellViewInfo.NeedHideEdit: Boolean;
begin
  Result := EditRect.Top > GetRealCellEditRect.Top;
end;
...
procedure TcxEditCellViewInfo.AfterDrawCellBackgroundHandler(Sender: TcxCustomEditViewInfo; ACanvas: TcxCanvas);
begin
  AfterDrawCellBackground(ACanvas);
end;

procedure TcxEditCellViewInfo.AfterDrawCellValueHandler(Sender: TcxCustomEditViewInfo; ACanvas: TcxCanvas);
begin
...
procedure TcxCustomNavigatorSiteViewInfo.TrackingMouseLeave;
begin
  MouseLeave;
end;
...
function TcxCustomNavigatorSiteViewInfo.PtInCaller(const P: TPoint): Boolean;
begin
...
begin
  BeginMouseTracking(Control, BoundsRect, Self);
...
destructor TcxControlItemViewInfo.Destroy;
begin
...
var
  AIsClick: Boolean;
begin
  if not Enabled or IsCheck then
    Exit;
...
begin
  if Enabled and not MouseCapture and ((State = cxbsHot) or not IsCheck and (State = cxbsPressed)) then
    State := cxbsNormal;
end;
...
begin
  if Focused and Painter.SupportsNativeFocusRect then
...
function TcxControlItemViewInfo.GetEnabled: Boolean;
begin
  Result := True;
end;
...
begin
  Result := TdxTextMeasurer.TextLineHeight(GetFont);
end;

function TcxControlItemViewInfo.GetTextWidth: Integer;
begin
  Result := TdxTextMeasurer.TextWidthTO(GetFont, Text);
end;
...
function TcxControlPanelViewInfo.GetVertOffset: Integer;
begin
  Result := cxControlPanelItemsOffset;
end;
...
procedure TcxControlFindPanelButtonViewInfo.Click;
begin
  FindPanel.ItemExecute(Kind);
end;

function TcxControlFindPanelButtonViewInfo.GetEnabled: Boolean;
begin
  Result := FindPanel.IsItemEnabled(Kind);
end;

function TcxControlFindPanelButtonViewInfo.GetFocused: Boolean;
begin
  Result := FindPanel.IsItemFocused(Kind) and Control.IsFocused;
end;
...
begin
  Result := Max(inherited GetHeight, Scale(FindPanel.ButtonMinHeight));
end;

function TcxControlFindPanelButtonViewInfo.GetKind: TcxFindPanelItemKind;
begin
  Result := fpikNone;
end;

function TcxControlFindPanelButtonViewInfo.GetText: string;
begin
...
begin
  Result := Max(inherited GetWidth, Scale(FindPanel.ButtonMinWidth));
end;

function TcxControlFindPanelButtonViewInfo.Scale(AValue: Integer): Integer;
begin
  if Assigned(ControlViewInfo) and Assigned(ControlViewInfo.Control) and Assigned(ControlViewInfo.Control.ScaleFactor)  then
    Result := ControlViewInfo.Control.ScaleFactor.Apply(AValue)
  else
    Result := AValue;
end;
...
function TcxControlFindPanelFindButtonViewInfo.GetKind: TcxFindPanelItemKind;
begin
...
function TcxControlFindPanelClearButtonViewInfo.GetKind: TcxFindPanelItemKind;
begin
...
function TcxControlFindPanelNextButtonViewInfo.GetKind: TcxFindPanelItemKind;
begin
...
function TcxControlFindPanelPreviousButtonViewInfo.GetKind: TcxFindPanelItemKind;
begin
...
function TcxControlFindPanelCloseButtonViewInfo.GetKind: TcxFindPanelItemKind;
begin
...
begin
  ...
  FNextButtonViewInfo := TcxControlFindPanelNextButtonViewInfo.Create(Self);
  FPreviousButtonViewInfo := TcxControlFindPanelPreviousButtonViewInfo.Create(Self);
end;

destructor TcxControlFindPanelViewInfo.Destroy;
begin
  FreeAndNil(FPreviousButtonViewInfo);
  FreeAndNil(FNextButtonViewInfo);
...
begin
  ...
  ClearButtonViewInfo.IsRightToLeftConverted := False;
end;
...
begin
  ...
  CloseButtonViewInfo.IsRightToLeftConverted := False;
end;
...
begin
  ...
  EditViewInfo.IsRightToLeftConverted := False;
end;
...
begin
  ...
  FindButtonViewInfo.IsRightToLeftConverted := False;
end;

procedure TcxControlFindPanelViewInfo.CalculateNextButton;
var
  ABounds: TRect;
begin
  ABounds := cxRectCenterVertically(BoundsRect, NextButtonViewInfo.Height);
  if IsPreviousButtonVisible then
    ABounds.Left := PreviousButtonViewInfo.BoundsRect.Right
  else
    ABounds.Left := EditViewInfo.BoundsRect.Right;
  Inc(ABounds.Left, ItemsOffset);
  ABounds := cxRectSetWidth(ABounds, NextButtonViewInfo.Width);
  ABounds := cxRectSetHeight(ABounds, NextButtonViewInfo.Height);
  NextButtonViewInfo.CheckClipping(ABounds, ABounds);
  NextButtonViewInfo.VisibleInfoCalculated := False;
  NextButtonViewInfo.IsRightToLeftConverted := False;
end;

procedure TcxControlFindPanelViewInfo.CalculatePreviousButton;
var
  ABounds: TRect;
begin
  ABounds := cxRectCenterVertically(BoundsRect, PreviousButtonViewInfo.Height);
  ABounds.Left := EditViewInfo.BoundsRect.Right + ItemsOffset;
  ABounds := cxRectSetWidth(ABounds, PreviousButtonViewInfo.Width);
  ABounds := cxRectSetHeight(ABounds, PreviousButtonViewInfo.Height);
  PreviousButtonViewInfo.CheckClipping(ABounds, ABounds);
  PreviousButtonViewInfo.VisibleInfoCalculated := False;
  PreviousButtonViewInfo.IsRightToLeftConverted := False;
end;
...
begin
  ...
  if IsPreviousButtonVisible then
    CalculatePreviousButton;
  if IsNextButtonVisible then
    CalculateNextButton;
...
begin
  inherited DoRightToLeftConversion(AClientBounds);
  if IsCloseButtonVisible then
    CloseButtonViewInfo.RightToLeftConversion(AClientBounds);
  EditViewInfo.RightToLeftConversion(AClientBounds);
  if IsFindButtonVisible then
    FindButtonViewInfo.RightToLeftConversion(AClientBounds);
  if IsClearButtonVisible then
    ClearButtonViewInfo.RightToLeftConversion(AClientBounds);
  if IsNextButtonVisible then
    NextButtonViewInfo.RightToLeftConversion(AClientBounds);
  if IsPreviousButtonVisible then
    PreviousButtonViewInfo.RightToLeftConversion(AClientBounds);
end;
...
begin
  Painter.DrawFindPanel(ACanvas, BoundsRect, ViewParams.Bitmap <> nil, ViewParams.Color, ViewParams.Bitmap,
    Borders, ScaleFactor, GetBordersScaleFactor);
end;

procedure TcxControlFindPanelViewInfo.DrawBorders(ACanvas: TcxCanvas);
begin
  Painter.DrawFindPanelBorder(ACanvas, BoundsRect, Borders, ScaleFactor, GetBordersScaleFactor);
end;
...
begin
  ...
  if IsNextButtonVisible then
    NextButtonViewInfo.Draw(ACanvas);
  if IsPreviousButtonVisible then
    PreviousButtonViewInfo.Draw(ACanvas);
end;
...
begin
  ...
  if IsNextButtonVisible then
    Result := Max(Result, NextButtonViewInfo.Height);
  if IsPreviousButtonVisible then
    Result := Max(Result, PreviousButtonViewInfo.Height);
  Inc(Result, 2 * VertOffset);
end;
...
begin
  ...
  if IsCloseButtonVisible and CloseButtonViewInfo.HasPoint(APoint) then
    Exit(CloseButtonViewInfo);
  if EditViewInfo.HasPoint(APoint) then
    Exit(EditViewInfo);
  if IsFindButtonVisible and FindButtonViewInfo.HasPoint(APoint) then
    Exit(FindButtonViewInfo);
  if IsClearButtonVisible and ClearButtonViewInfo.HasPoint(APoint) then
    Exit(ClearButtonViewInfo);
  if IsNextButtonVisible and NextButtonViewInfo.HasPoint(APoint) then
    Exit(NextButtonViewInfo);
  if IsPreviousButtonVisible and PreviousButtonViewInfo.HasPoint(APoint) then
    Exit(PreviousButtonViewInfo);
end;

function TcxControlFindPanelViewInfo.GetVertOffset: Integer;
begin
...
begin
  Result := FindPanel.IsItemVisible(fpikClearButton);
end;

function TcxControlFindPanelViewInfo.IsCloseButtonVisible: Boolean;
begin
  Result := FindPanel.IsItemVisible(fpikCloseButton);
end;

function TcxControlFindPanelViewInfo.IsFindButtonVisible: Boolean;
begin
  Result := FindPanel.IsItemVisible(fpikFindButton);
end;

function TcxControlFindPanelViewInfo.IsNextButtonVisible: Boolean;
begin
  Result := FindPanel.IsItemVisible(fpikNextButton);
end;

function TcxControlFindPanelViewInfo.IsPreviousButtonVisible: Boolean;
begin
  Result := FindPanel.IsItemVisible(fpikPreviousButton);
end;
...
begin
  ...
  if IsPreviousButtonVisible then
    Dec(Result, PreviousButtonViewInfo.Width + ItemsOffset);
  if IsNextButtonVisible then
    Dec(Result, NextButtonViewInfo.Width + ItemsOffset);
  Result := EnsureRange(Result, ScaleFactor.Apply(FindPanel.EditMinWidth),
    ScaleFactor.Apply(FindPanel.GetEditMaxWidth));
end;
...
procedure TcxControlFilterBoxCustomizeButtonViewInfo.DoDraw(
  ACanvas: TcxCanvas);
var
  APrevFont: TFont;
begin
  ...
  ACanvas.Font := Font;
  try
    Painter.DrawFilterCustomizeButton(ACanvas, BoundsRect, Text, State, ScaleFactor);
  finally
    ACanvas.Font := APrevFont;
  end;
end;
...
function TcxControlFilterBoxCustomizeButtonViewInfo.GetHeight: Integer;
begin
  Result := TextHeight + Painter.GetFilterCustomizeButtonContentOffsets(ScaleFactor).Height;
end;
...
function TcxControlFilterBoxCustomizeButtonViewInfo.GetWidth: Integer;
begin
  Result := TextWidth + Painter.GetFilterCustomizeButtonContentOffsets(ScaleFactor).Width;
end;
...
begin
  inherited Click;
  FilterBoxViewInfo.MainFilter.Clear;
end;
...
begin
  inherited Click;
  FilterBoxViewInfo.MainFilter.Active := not FilterBoxViewInfo.MainFilter.Active;
end;
...
begin
  Result := FilterBoxViewInfo.MainFilter.Active;
end;
...
function TcxControlFilterBoxDropDownButtonViewInfo.IsDropDownWindowExists: Boolean;
begin
...
begin
  Result := IsDropDownWindowExists and (DropDownWindow.Owner = Self);
end;
...
begin
  Result := FilterBoxViewInfo.IsMRUItemsListAvailable;
end;
...
begin
  Result := FilterBoxViewInfo.Filter.FilterCaption;
  if Result = '' then
...
begin
  ...
  CheckBoxViewInfo.IsRightToLeftConverted := False;
end;
...
begin
  ...
  CustomizeButtonViewInfo.IsRightToLeftConverted := False;
end;
...
begin
  ...
  DropDownButtonViewInfo.IsRightToLeftConverted := False;
end;
...
begin
  ...
  ABounds.Left := GetTextAreaLeft + cxControlFilterBoxTextOffset + cxControlTextOffset;
  ABounds.Right := GetTextAreaRight - cxControlFilterBoxTextOffset - cxControlTextOffset;
  ABounds.Right := Min(ABounds.Right, ABounds.Left + TextViewInfo.Width);
  TextViewInfo.CheckClipping(ABounds, ABounds);
  TextViewInfo.VisibleInfoCalculated := False;
  TextViewInfo.IsRightToLeftConverted := False;
end;

procedure TcxControlFilterBoxViewInfo.CalculateTokenCriteriaViewInfo;
var
  ABounds: TRect;
begin
  ABounds := BoundsRect;
  ABounds.Left := GetTextAreaLeft + cxControlFilterBoxTextOffset;
  ABounds.Right := GetTextAreaRight - cxControlFilterBoxTextOffset;
  TokenCriteriaViewInfo.Calculate(ABounds);
end;

function TcxControlFilterBoxViewInfo.CreateTokenCriteriaViewInfo: TdxFilterBoxTokenCriteriaViewInfo;
begin
...
begin
  ...
  if IsTokenCriteriaVisible then
    CalculateTokenCriteriaViewInfo;
...
procedure TcxControlFilterBoxViewInfo.DoRightToLeftConversion(const AClientBounds: TRect);
begin
  inherited DoRightToLeftConversion(AClientBounds);
  if IsCustomizeButtonVisible then
    CustomizeButtonViewInfo.RightToLeftConversion(AClientBounds);
  if IsCloseButtonVisible then
    CloseButtonViewInfo.RightToLeftConversion(AClientBounds);
  if IsCheckBoxVisible then
    CheckBoxViewInfo.RightToLeftConversion(AClientBounds);
  if IsTextVisible then
    TextViewInfo.RightToLeftConversion(AClientBounds);
  if IsTokenCriteriaVisible then
    TokenCriteriaViewInfo.RightToLeftConversion(AClientBounds);
  if IsDropDownButtonVisible then
    DropDownButtonViewInfo.RightToLeftConversion(AClientBounds);
end;

procedure TcxControlFilterBoxViewInfo.DrawBackground(ACanvas: TcxCanvas);
begin
  Painter.DrawFilterPanel(ACanvas, BoundsRect, ViewParams.Bitmap <> nil, ViewParams.Color, ViewParams.Bitmap, [], ScaleFactor, GetBordersScaleFactor);
end;
...
begin
  ...
  if IsTokenCriteriaVisible then
    TokenCriteriaViewInfo.Paint(ACanvas);
  if IsDropDownButtonVisible then
...
begin
  ...
  if TokenCriteriaViewInfo <> nil then
    Result := Max(Result, TokenCriteriaViewInfo.ContentHeight);
  Inc(Result, 2 * VertOffset);
...
function TcxControlFilterBoxViewInfo.GetTextAreaLeft: Integer;
begin
  if IsCheckBoxVisible then
    Result := CheckBoxViewInfo.BoundsRect.Right + ItemsOffset
  else
    if IsCloseButtonVisible then
      Result := CloseButtonViewInfo.BoundsRect.Right + ItemsOffset
    else
      if IsCustomizeButtonVisible and (FilterBox.CustomizeButtonAlignment = fbaLeft) then
        Result := CustomizeButtonViewInfo.BoundsRect.Right + ItemsOffset
      else
        Result := BoundsRect.Left + FirstOffset;
end;

function TcxControlFilterBoxViewInfo.GetTextAreaRight: Integer;
begin
  if IsCustomizeButtonVisible and (FilterBox.CustomizeButtonAlignment = fbaRight) then
    Result := CustomizeButtonViewInfo.BoundsRect.Left - ItemsOffset
  else
    Result := BoundsRect.Right - FirstOffset;
end;
...
function TcxControlFilterBoxViewInfo.IsMRUItemsListAvailable: Boolean;
begin
  Result := FilterBox.IsMRUItemsListAvailable and not FilterBox.UseTokens;
end;

function TcxControlFilterBoxViewInfo.IsTextVisible: Boolean;
begin
  Result := not IsTokenCriteriaVisible;
end;

function TcxControlFilterBoxViewInfo.IsTokenCriteriaVisible: Boolean;
begin
  Result := (TokenCriteriaViewInfo <> nil) and not Filter.IsEmpty;
end;

procedure TcxControlFilterBoxViewInfo.MouseDown(Button: TMouseButton; Shift: TShiftState; X: Integer; Y: Integer);
begin
  if IsTokenCriteriaVisible and TokenCriteriaViewInfo.HasMouse(Point(X, Y)) then
    TokenCriteriaViewInfo.MouseDown(Point(X, Y))
  else
    inherited MouseDown(Button, Shift, X, Y);
end;

procedure TcxControlFilterBoxViewInfo.MouseMove(Shift: TShiftState; X: Integer; Y: Integer);
begin
  if IsTokenCriteriaVisible and TokenCriteriaViewInfo.HasMouse(Point(X, Y)) then
    TokenCriteriaViewInfo.MouseMove(Point(X, Y))
  else
    inherited MouseMove(Shift, X, Y);
end;

procedure TcxControlFilterBoxViewInfo.MouseUp(Button: TMouseButton; Shift: TShiftState; X: Integer; Y: Integer);
begin
  if IsTokenCriteriaVisible and TokenCriteriaViewInfo.HasMouse(Point(X, Y)) then
    TokenCriteriaViewInfo.MouseUp(Point(X, Y))
  else
    inherited MouseUp(Button, Shift, X, Y);
end;

procedure TcxControlFilterBoxViewInfo.RefreshTokenCriteriaViewInfo;
begin
  FreeAndNil(FTokenCriteriaViewInfo);
...
function TcxControlFilterBoxViewInfo.GetFilter: TcxDataFilterCriteria;
begin
  if TokenCriteriaViewInfo <> nil then
...
function TcxControlFilterBoxViewInfo.GetMainFilter: TcxDataFilterCriteria;
begin
  Result := FilterBox.Filter;
end;

function TcxControlFilterBoxViewInfo.GetTokenCriteria: TdxFilterBoxTokenCriteria;
begin
  Result := Control.FilterBoxTokenCriteria;
end;

function TcxControlFilterBoxViewInfo.GetTokenCriteriaControl: TcxControl;
begin
  Result := Control;
end;

function TcxControlFilterBoxViewInfo.GetTokenCriteriaOptions: IdxFilterBoxTokenCriteriaOptions;
begin
  Result := FilterBox.TokenCriteria;
end;

procedure TcxControlFilterBoxViewInfo.GetTokenCriteriaParams(var AParams: TcxViewParams);
begin
...
{ TcxEditingControlScrollbarAnnotations }

constructor TcxEditingControlScrollbarAnnotations.Create(AOwner: TcxExtEditingControl);
begin
  inherited Create;
  FOwner := AOwner;
end;

function TcxEditingControlScrollbarAnnotations.GetCurrentRecordIndex: Integer;
begin
  Result := FOwner.GetCurrentScrollbarAnnotationRecordIndex;
end;

procedure TcxEditingControlScrollbarAnnotations.GetHint(AAnnotationRowIndexLists: TdxScrollbarAnnotationRowIndexLists; var AHint: string);
begin
  FOwner.GetScrollbarAnnotationHint(AAnnotationRowIndexLists, AHint);
end;

function TcxEditingControlScrollbarAnnotations.GetRecordPixelScrollPosition(ARecordIndex: Integer): Integer;
begin
  Result := FOwner.GetRecordPixelScrollPosition(ARecordIndex);
end;

function TcxEditingControlScrollbarAnnotations.GetScrollableRecordCount: Integer;
begin
  Result := FOwner.GetScrollableRecordCount;
end;

function TcxEditingControlScrollbarAnnotations.IsRecordIndexBasedRendering: Boolean;
begin
  Result := FOwner.IsRecordIndexBasedScrollbarAnnotationRendering;
end;

function TcxEditingControlScrollbarAnnotations.GetDataPixelScrollSize: Integer;
begin
  Result := FOwner.GetDataPixelScrollSize;
end;

function TcxEditingControlScrollbarAnnotations.GetOptions: TdxScrollbarAnnotationOptions;
begin
  Result := FOwner.ScrollbarAnnotations.Helper;
end;

procedure TcxEditingControlScrollbarAnnotations.Populate(AKind: TdxScrollbarAnnotationKind; AList: TdxScrollbarAnnotationRowIndexList);
begin
  FOwner.PopulateScrollbarAnnotations(AKind, AList);
end;

procedure TcxEditingControlScrollbarAnnotations.SetCurrentRecordIndex(AIndex: Integer);
begin
  FOwner.SetCurrentScrollbarAnnotationRecordIndex(AIndex);
end;
...
function TcxEditingControl.CanFocusOnClick(X, Y: Integer): Boolean;
begin
  Result := not (GetIsFocused and IsScrollBarsArea(Point(X, Y)));
  if Result then
...
function TcxEditingControl.CreateFilterBoxTokenCriteria: TdxFilterBoxTokenCriteria;
begin
...
procedure TcxEditingControl.DestroyFilterBoxTokenCriteria;
begin
...
begin
  ...
  if Options.OptionsFilterBox.UseTokens then
  begin
...
function TcxEditingControl.GetCurrentScrollbarAnnotationRecordIndex: Integer;
begin
  Result := -1;
end;

function TcxEditingControl.GetDataPixelScrollSize: Integer;
begin
  Result := 0;
end;

function TcxEditingControl.GetRecordPixelScrollPosition(ARecordIndex: Integer): Integer;
begin
  Result := 0;
end;

function TcxEditingControl.GetScrollableRecordCount: Integer;
begin
  Result := 0;
end;

procedure TcxEditingControl.GetScrollbarAnnotationHint(AAnnotationRowIndexLists: TdxScrollbarAnnotationRowIndexLists; var AHint: string);
begin
...
function TcxEditingControl.IsRecordIndexBasedScrollbarAnnotationRendering: Boolean;
begin
  Result := True;
end;
...
begin
  Result := DataController.FindCriteria.IsActive and Options.OptionsFindPanel.HighlightSearchResults;
end;

procedure TcxEditingControl.PopulateScrollbarAnnotations(AKind: TdxScrollbarAnnotationKind; AList: TdxScrollbarAnnotationRowIndexList);
var
  I: Integer;
begin
  case AKind of
    ...
    dxSearchResultScrollbarAnnotationID:
      for I := 0 to DataController.FindCriteria.MatchCount - 1 do
        AList.Add(DataController.FindCriteria.MatchRowIndexes[I]);
  end;
end;
...
procedure TcxEditingControl.SetCurrentScrollbarAnnotationRecordIndex(AIndex: Integer);
begin
end;

procedure TcxEditingControl.UpdateFilterBoxTokenCriteria;
begin
...
procedure TcxEditingControl.BeginGestureScroll(APos: TPoint);
begin
  Controller.ThumbTracking := True;
...
procedure TcxEditingControl.EndGestureScroll;
begin
  inherited EndGestureScroll;
  Controller.ThumbTracking := False;
end;
...
function TcxEditingControl.GetDesignHitTest(X, Y: Integer; Shift: TShiftState): Boolean;
begin
  Result := inherited GetDesignHitTest(X, Y, Shift) or Controller.HitTestController.AllowDesignMouseEvents(X, Y, Shift);
end;
...
begin
  ...
  Controller.ThumbTracking := AScrollCode = scTrack;
...
function TcxEditingControl.AllowFilterExpressionEditing: Boolean;
begin
  Result := Options.OptionsFiltering.ExpressionEditing;
end;

function TcxEditingControl.GetExpressionProvider: TcxCustomExpressionProvider;
begin
  Result := DataController.ExpressionProvider;
end;

procedure TcxEditingControl.RegisterFilterControl(AControl: TcxCustomFilterControl);
begin
  if FLinkedFilterControls.IndexOf(AControl) = -1 then
    FLinkedFilterControls.Add(AControl);
end;

procedure TcxEditingControl.UnregisterFilterControl(AControl: TcxCustomFilterControl);
begin
  FLinkedFilterControls.Remove(AControl);
end;

procedure TcxEditingControl.UpdateLinkedFilterControls;
var
  I: Integer;
begin
...
function TcxEditingControl.UseFilterTokens: Boolean;
begin
  Result := Options.OptionsFilterBox.UseTokens;
end;
...
function TcxEditingControl.GetFilterBoxTokenCriteria: TdxFilterBoxTokenCriteria;
begin
...
function TcxEditingControl.GetScrollbarAnnotationHelper: TdxScrollbarAnnotations;
begin
...
begin
  inherited;
  if Controller.IsFindPanelVisible and Controller.FindPanel.IsFocused then
    Message.Result := Message.Result or DLGC_WANTALLKEYS;
end;

procedure TcxEditingControl.WMSetCursor(var Message: TWMSetCursor);
begin
  if IsDesigning and (DragAndDropState = ddsNone) and Controller.HitTestController.AllowDesignMouseEvents(ScreenToClient(GetMouseCursorPos), [ssLeft]) then
    SetCursor(Screen.Cursors[Controller.HitTestController.GetCurrentCursor])
  else
    inherited;
end;
...
procedure TcxExtEditingControl.CheckScrollbarAnnotations;
begin
...
function TcxExtEditingControl.IsScrollbarAnnotationVisible(AKind: Integer): Boolean;
begin
  case AKind of
    dxFirstScrollbarAnnotationID..dxFirstPredefinedScrollbarAnnotationID-1:
      Result := Assigned(OnPopulateCustomScrollbarAnnotationRowIndexList);
    dxSearchResultScrollbarAnnotationID:
      Result := DataController.FindCriteria.IsActive;
  else
    Result := True;
  end;
end;

procedure TcxExtEditingControl.Notification(AComponent: TComponent; Operation: TOperation);
begin
...
function TcxExtEditingControl.CreateScrollbarAnnotationHelper: TcxEditingControlScrollbarAnnotations;
begin
  Result := TcxEditingControlScrollbarAnnotations.Create(Self);
end;

function TcxExtEditingControl.CreateScrollbarAnnotations: TcxControlScrollbarAnnotationOptions;
begin
  Result := TcxControlScrollbarAnnotationOptions.Create(Self);
end;
...
procedure TcxExtEditingControl.SetScrollbarAnnotations(Value: TcxControlScrollbarAnnotationOptions);
begin
...
function cxConfirmMessageBox(const AText, ACaption: string): Boolean;
begin
  Result := dxMessageBox(AText, ACaption, MB_ICONQUESTION or MB_OKCANCEL) = ID_OK
end;
