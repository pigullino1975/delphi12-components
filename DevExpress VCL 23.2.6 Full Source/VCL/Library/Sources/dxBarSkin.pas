...
type
  ...
  strict private
    function GetPart(Index: TdxListIndex): TdxSkinnedRect;
  protected
  ...
  public
    ...
    property Parts[Index: TdxListIndex]: TdxSkinnedRect read GetPart; default; // for internal use
  end;
...
function TdxCustomBarSkin.GetPart(Index: TdxListIndex): TdxSkinnedRect;
begin
