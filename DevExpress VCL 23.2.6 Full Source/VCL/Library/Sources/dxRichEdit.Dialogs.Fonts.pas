...
type
  TdxRichEditFontDialogForm = class(TdxRichEditCustomDialogForm, IdxRichEditFontDialogForm)
    btnCancel: TcxButton;
    btnOk: TcxButton;
    cbAllCaps: TdxLayoutCheckBoxItem;
    cbDoubleStrikethrough: TdxLayoutCheckBoxItem;
    cbHidden: TdxLayoutCheckBoxItem;
    cbStrikethrough: TdxLayoutCheckBoxItem;
    cbSubscript: TdxLayoutCheckBoxItem;
    cbSuperscript: TdxLayoutCheckBoxItem;
    cbUnderlineWordsOnly: TdxLayoutCheckBoxItem;
...
const
  dxThisUnitName = 'dxRichEdit.Dialogs.Fonts';

{$R *.dfm}

{ TdxRichEditFontDialogForm }

procedure TdxRichEditFontDialogForm.cmbFontSizeKeyPress(Sender: TObject; var Key: Char);
begin
...
begin
  ...
  InitializeColorButtons(cmbUnderlineColor);
