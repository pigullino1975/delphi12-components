...
uses
  ...
  cxLookAndFeelPainters, dxRibbonSkins, dxAnimation, dxGallery, dxActions, cxCustomCanvas;
...
type
  ...
  TdxRibbonGalleryGroupClass = class of TdxRibbonGalleryGroup;
  ...
  TdxRibbonGalleryFindItemFunc = reference to function (AItem: TdxRibbonGalleryGroupItem): Boolean;
  ...
  protected
    ...
    function GetValuePart(Index: Integer): Integer; override;
    function IsValuePartStored(Index: Integer): Boolean; override;
    procedure SetValue(Value: TPoint); override;
  ...
  strict private
    ...
    FPopupMenu: TdxBarCustomPopupMenu;
  ...
  protected
    ...
    procedure CheckRemoveItemPadding(var APadding: TdxPadding); virtual;
    ...
    function GetPopupMenu: TdxBarCustomPopupMenu; virtual;
    ...
    function IsPopupMenuStored: Boolean; virtual;
    ...
    procedure SetPopupMenu(Value: TdxBarCustomPopupMenu); virtual;
  ...
  public
    ...
    property ItemSize: TcxItemSize read GetItemSize write SetItemSize stored IsItemSizeStored;
    ...
    property PopupMenu: TdxBarCustomPopupMenu read GetPopupMenu write SetPopupMenu stored IsPopupMenuStored;
  ...
  TdxRibbonGalleryGroupOptionsAssignedValue = (
    ...
    avItemSize, avItemTextAlignVert, avItemTextKind, avPopupMenu, avSpaceAfterGroupHeader,
  ...
  protected
    ...
    function GetPopupMenu: TdxBarCustomPopupMenu; override;
    ...
    function IsPopupMenuStored: Boolean; override;
    ...
    procedure SetPopupMenu(Value: TdxBarCustomPopupMenu); override;
  ...
  protected
    ...
    property SpaceBetweenItemsAndBorder: Integer read FSpaceBetweenItemsAndBorder write SetSpaceBetweenItemsAndBorder default 0;
  ...
  strict private
    ...
    FItemTextAlignVert: TcxAlignmentVert;
    FItemTextKind: TdxRibbonGalleryGroupItemTextKind;
    FLoopVerticalNavigation: Boolean;
    FRowCount: Integer;
    FUseAlternateNavigation: Boolean;
  ...
  protected
    procedure ChangeScale(M, D: Integer);
    //
    property LoopVerticalNavigation: Boolean read FLoopVerticalNavigation write FLoopVerticalNavigation default True;
    property UseAlternateNavigation: Boolean read FUseAlternateNavigation write FUseAlternateNavigation default False;
    property OnChanged: TNotifyEvent read FOnChanged write FOnChanged;
  public
    constructor Create;
    destructor Destroy; override;
  ...
  protected
    ...
    function DontUseRibbonGlyphInDropDown: Boolean; virtual;
    ...
    function ShowDescriptionInRibbon: Boolean; virtual;
    function GetMinItemSize(AIsInRibbon: Boolean): TSize; virtual;
  ...
  protected
    function GetGroupViewInfoClass: TdxRibbonGalleryGroupViewInfoClass; virtual;
    function GetOwner: TPersistent; override;
  ...
  strict private
    ...
    function GetItem(Index: TdxListIndex): TdxRibbonGalleryGroup;
  protected
  ...
  public
    ...
    property Items[Index: TdxListIndex]: TdxRibbonGalleryGroup read GetItem; default;
  end;
  ...
  protected
    ...
    function GetOwner: TPersistent; override;
    procedure Loaded;
    function GetSubMenuController: TdxRibbonOnSubmenuGalleryController;
    procedure Show(const AScreenPoint: TPoint);
    procedure Hide;
    property GalleryItem: TdxCustomRibbonGalleryItem read FGalleryItem;
  public
  ...
  TdxRibbonGalleryItemBarItemLink = class(TdxBarItemLink)
  strict private
  ...
  protected
    ...
    procedure DoCalculateDragLineParameters(const ADragOverBeginGroup: Boolean; var ADragLineFirstPart: Boolean;
      out ADragLineRect: TRect); override;
    function GetNeedDragLine(const ADragOverBeginGroup, ADragOverFirstPart: Boolean;
      ADragOverItemLink: TdxBarItemLink): Boolean; override;
    procedure PopulateCustomizationPopup(AItemLinks: TdxBarItemLinks; ASupportedActions: TdxBarCustomizationActions); override;
    procedure UpdateByDragParameters(const ADragOverBeginGroup, ADragOverFirstPart: Boolean;
      ADragOverItemLink: TdxBarItemLink); override;
  public
    constructor Create(Collection: TCollection); override;
    procedure Assign(Source: TPersistent); override;
  published
  ...
  { TdxRibbonGalleryDropDownNavigationList }

  TdxRibbonGalleryDropDownNavigationList = class // for internal use
  strict private
    FGalleryControl: TdxRibbonDropDownGalleryControl;
    FGalleryIndex: Integer;
    FList: TdxFastList;
    function GetCount: Integer;
    function GetFirst: TdxBarItemLink;
    function GetItem(AIndex: Integer): TdxBarItemLink;
    function GetLast: TdxBarItemLink;
    procedure Populate;
  public
    constructor Create(AGalleryControl: TdxRibbonDropDownGalleryControl);
    destructor Destroy; override;
    function IndexOf(AItem: TdxBarItemLink): Integer;
    property Count: Integer read GetCount;
    property First: TdxBarItemLink read GetFirst;
    property GalleryIndex: Integer read FGalleryIndex;
    property Items[AIndex: Integer]: TdxBarItemLink read GetItem; default;
    property Last: TdxBarItemLink read GetLast;
  end;
  ...
  TdxRibbonGalleryShowPopupMenuEvent = procedure(Sender: TObject; var APopupMenu: TdxBarCustomPopupMenu;
    var APopupPoint: TPoint; AHotGroupItem: TdxRibbonGalleryGroupItem) of object;
  ...
  private
    ...
    FLockGalleryCount: Integer;
    FRecreateControlsNeeded: Boolean;
    FNeedUpdateGallery: Boolean;
    FLockRecreateControlsCount: Integer;
    ...
    FOnShowPopupMenu: TdxRibbonGalleryShowPopupMenuEvent;
  ...
  protected
    function FindItem(out AItem: TdxRibbonGalleryGroupItem; const ACompare: TdxRibbonGalleryFindItemFunc): Boolean;
    ...
    procedure DoSelectedGroupItemChanged(AItem: TdxRibbonGalleryGroupItem); virtual;
    ...
    function GetGalleryGroupsClass: TdxRibbonGalleryGroupsClass; virtual;
    function GetGalleryGroupClass: TdxRibbonGalleryGroupClass; virtual;

    function GetErrorCanPlaceText : string; virtual;
    function GetMinDropDownGalleryControlSize: TSize; virtual;
    function GetMaxDropDownGalleryControlSize: TSize; virtual;
    function UseGroupItemSizeInRibbon: Boolean; virtual;
    ...
    procedure FilterUpdateUnlocked; virtual;
    procedure DoFilterChanged; virtual;
    procedure FilterMenuControlDestroying; virtual;

    procedure UpdateDropDownControlSize;
    ...
    procedure GalleryChanged(ARecreateControls: Boolean = True);
    procedure DoGalleryChanged(ARecreateControls: Boolean); virtual;
    procedure ResetControlsViewInfo(AFull: Boolean);
    procedure GalleryBeginUpdate;
    procedure GalleryEndUpdate;
    procedure LockRecreateControls;
    procedure UnlockRecreateControls;

    function IgnoreHeaderForGroupVisibility: Boolean; virtual;
    function CanShowGroupInFilterMenu(AGroupIndex: Integer; AIgnoreVisibleProperty: Boolean = False): Boolean; virtual;
    ...
    property OnShowPopupMenu: TdxRibbonGalleryShowPopupMenuEvent read FOnShowPopupMenu write FOnShowPopupMenu;
  public
    constructor Create(AOwner: TComponent); override;
    destructor Destroy; override;
    procedure Assign(Source: TPersistent); override;
  ...
  private
    ...
    procedure SetHotGroupItem(AValue: TdxRibbonGalleryGroupItem; AIsKeyboardNavigation: Boolean = False);
  ...
  protected
    ...
    property Owner: TdxRibbonGalleryControl read FOwner;
  public
  ...
  strict private
    ...
    function GetLastGroupItem(ALastInGroup: Boolean = True): TdxRibbonGalleryGroupItem;
    ...
    function GetFilterMenuControl: TdxRibbonGalleryFilterMenuControl;
  protected
    function FilterDropDownAutoSize(AGroupIndex: Integer): Boolean; virtual;
    function IsFilterMenuShowed: Boolean;
    function SupportsItemsNavigation: Boolean;
    function HasControlByVerticalDirection(var ANavigationItems: TdxRibbonGalleryDropDownNavigationList; ADownDirection, ALoop: Boolean): Boolean;
    procedure MouseDown(Button: TMouseButton; Shift: TShiftState; X, Y: Integer); override;
    procedure MouseLeave; override;
    procedure MouseMove(Shift: TShiftState; X, Y: Integer); override;
    procedure MouseUp(Button: TMouseButton; Shift: TShiftState; X, Y: Integer); override;
    procedure HideFilterMenu;
    procedure ShowFilterMenu; overload;
    procedure ShowFilterMenu(const AScreenPoint: TPoint); overload;
    function LoopVerticalNavigation: Boolean;
    function UseAlternateNavigation: Boolean;
    // External
    function HotTrackFirstGroupItem: Boolean;
    function HotTrackLastGroupItem: Boolean;
    function Navigation(ADirection: TcxAccessibilityNavigationDirection): Boolean;
    procedure UpdateHotTrack(ADirection: TdxRibbonDropDownGalleryNavigationDirection); virtual;
    function PageDown: Boolean;
    function PageUp: Boolean;
    function Tabulation: Boolean;

    property FilterMenuControl: TdxRibbonGalleryFilterMenuControl read GetFilterMenuControl;
  public
    destructor Destroy; override;
  ...
  strict private
    ...
    FCustomPopupMenu: TdxBarCustomPopupMenu; // for internal use only
    FFilterBandIAccessibilityHelper: IcxAccessibilityHelper;
    FHintBounds: TRect;
    FHintItem: TdxRibbonGalleryGroupItem;
    ...
    procedure CustomPopupMenuCloseUpHandler(Sender: TObject; AReason: TdxBarCloseUpReason);
    procedure CustomPopupMenuPopupHandler(Sender: TObject);
    procedure DoScrollBarDropDown(Sender: TObject);
    procedure DrawInvalid(const ABounds: TRect);
    function GetFilterBandIAccessibilityHelper: IcxAccessibilityHelper;
    function GetItem: TdxCustomRibbonGalleryItem;
    function GetViewInfo: TdxRibbonGalleryControlViewInfo;
    procedure ObtainTextColors;
    procedure SetCollapsed(Value: Boolean);
  protected
    FIsCustomPopupMenuShown: Boolean; // for internal use only
    ...
    procedure AccessibleSelectItem(AClickedGroupItem: TdxRibbonGalleryGroupItem);
    ...
    function IsEnabledScrollBar(AClientWidth: Integer = 0): Boolean;
    function IsHiddenForCustomization: Boolean; override;
    function IsNeedScrollBar(AClientWidth: Integer = 0): Boolean; virtual;
    function IsValidPainter: Boolean;
    function ShowCustomPopupMenu: Boolean; override;
    ...
    property FilterBandIAccessibilityHelper: IcxAccessibilityHelper read GetFilterBandIAccessibilityHelper;
  ...
  public
    ...
    property ViewInfo: TdxRibbonGalleryControlViewInfo read GetViewInfo; // for internal use
  end;
  ...
  public
    ...
    property Owner: TdxRibbonGalleryGroupViewInfo read FOwner; // for internal use
  ...
  protected
    ...
    function GetContentOffset: TdxPadding; virtual;
  public
  ...
  private
    ...
    function ShowDescriptionInRibbon: Boolean;
  ...
  protected
    ...
    procedure DrawInnerText(ACanvas: TcxCanvas; const AText: string; const ARect: TRect; AFormat: UINT);
    procedure DrawItemText(ACanvas: TcxCanvas); virtual;
    procedure DrawDescriptionText(ACanvas: TcxCanvas; ADescriptionRect: TRect; ATextAlignmentFlags: DWORD); virtual;
    function GetCaption: string; override;
    ...
    function GetDescriptionRectInner(ACanvas: TCanvas): TRect; virtual;
  ...
  public
    constructor Create(AOwner: TdxRibbonGalleryGroupViewInfo; AGroupItem: TdxRibbonGalleryGroupItem); virtual;
    destructor Destroy; override;
    procedure Calculate(const ABounds: TRect); override;
    procedure Paint(ACanvas: TcxCanvas); override;
  ...
  private
    ...
    function GetPainter: TdxBarPainter;
  protected
    function CalculateItemSize(const APredefinedItemSize: TSize; AMaxItemWidth, AMaxItemHeight: Integer): TSize;
    ...
    function GetItemViewInfoClass: TdxRibbonGalleryGroupItemViewInfoClass; virtual;
    ...
    property Painter: TdxBarPainter read GetPainter;
  public
    constructor Create(AOwner: TdxRibbonGalleryControlViewInfo; AGroup: TdxRibbonGalleryGroup); virtual;
    destructor Destroy; override;
    ...
    property Bounds: TRect read FBounds;
    property Group: TdxRibbonGalleryGroup read FGroup;
    property Header: TdxRibbonGalleryGroupHeaderViewInfo read FHeader; // for internal use
    property ItemCount: Integer read GetItemCount;
    property Items[Index: Integer]: TdxRibbonGalleryGroupItemViewInfo read GetItem; // for internal use
    property ItemSize: TSize read FItemSize;
    property Owner: TdxRibbonGalleryControlViewInfo read FOwner; // for internal use
  end;
  ...
  private
    ...
    function GetPainter: TdxBarPainter;
    function GetScrollBarBounds: TRect; virtual;
    function GetScrollBarWidth: Integer; overload;
    function GetScrollBarWidth(AClientWidth: Integer): Integer; overload;
    function GetScrollBarWidthEx(AWithIndents, AInverted: Boolean; AClientWidth: Integer): Integer;
    function GetLayoutWidthEx(AInverted: Boolean; out AGroupItemWidthIsNull: Boolean; out AScrollBarWidth: Integer): Integer;
  ...
  protected
    ...
    function GetGroupItemDescriptionRect(AGroupIndex, AnItemIndex: Integer): TRect; virtual;
    procedure SetGroupItemDescriptionRect(AGroupIndex, AnItemIndex: Integer; ARect: TRect);  virtual;
    ...
    procedure GalleryChanged;
    function GetAbsoluteGroupTop(AGroupIndex: Integer; AWidth: Integer): Integer;
    function GetContentOffset: TdxPadding; virtual; abstract;
    function GetControlBounds: TRect; virtual;
    function GetGalleryHeight(AWidth: Integer): Integer; virtual;
    function GetGalleryMargins: TdxPadding; virtual; abstract;
    function GetGroupItemCaptionContentOffset: TdxPadding; virtual; abstract;
    function GetGroupItemContentOffset: TdxPadding; virtual; abstract;
    function GetGroupItemDescriptionContentOffset: TdxPadding; virtual; abstract;
    function GetGroupItemImageContentOffset: TdxPadding; virtual; abstract;
    function GetGroupItemFixedSpaceBetweenCaptionAndDescription: Integer; virtual; abstract;
    function GetGroupItemFixedSpaceBetweenImageAndText: Integer; virtual; abstract;
    ...
    function GetLeftLayoutIndent: Integer; virtual; abstract;
    function GetRightLayoutIndent: Integer; virtual; abstract;
    ...
    procedure RemoveGroupItem(AItem: TdxRibbonGalleryGroupItem); virtual;
    procedure Changed; virtual;
  ...
  public
    ...
    property GroupCount: Integer read GetGroupCount;
    property Groups[Index: Integer]: TdxRibbonGalleryGroupViewInfo read GetGroup; // for internal use
    property ScrollBarBounds: TRect read GetScrollBarBounds;
  end;

  { TdxInRibbonGalleryControlViewInfo }

  TdxInRibbonGalleryControlViewInfo = class(TdxRibbonGalleryControlViewInfo, IdxBarMultiColumnItemControlViewInfo)
  strict private
  ...
  protected
    ...
    function GetContentOffset: TdxPadding; override;
    function GetControlMargins: TdxPadding; virtual;
    function GetGalleryMargins: TdxPadding; override;
    function GetGroupItemCaptionContentOffset: TdxPadding; override;
    function GetGroupItemContentOffset: TdxPadding; override;
    function GetGroupItemDescriptionContentOffset: TdxPadding; override;
    function GetGroupItemFixedSpaceBetweenCaptionAndDescription: Integer; override;
    function GetGroupItemFixedSpaceBetweenImageAndText: Integer; override;
    function GetGroupItemImageContentOffset: TdxPadding; override;
    ...
    procedure RemoveGroupItem(AItem: TdxRibbonGalleryGroupItem); override;
  ...
  strict private
    ...
    function GetFilterContentOffset: TdxPadding;
  ...
  private
    function GetScrollBarBounds: TRect; override;
  protected
    ...
    property FilterBandRect: TRect read FFilterBandRect;
  public
    procedure Calculate(ALayoutOffset: Integer; AScrollCode: TScrollCode); override;
  ...
  { TdxRibbonGalleryFilterAccessibilityHelper }

  TdxRibbonGalleryFilterAccessibilityHelper = class(TcxAccessibilityHelper)
  strict private
    function GetControl: TdxRibbonGalleryControl;
  ...
  protected
    ...
    property Control: TdxRibbonGalleryControl read GetControl;
    property OnSubmenuController: TdxRibbonOnSubmenuGalleryController read GetOnSubmenuController;
  public
    function GetScreenBounds(AChildID: TcxAccessibleSimpleChildElementID): TRect; override;
  end;

  { TdxRibbonGalleryGroupAccessibilityHelper }

  TdxRibbonGalleryGroupAccessibilityHelper = class(TdxGalleryGroupCustomAccessibilityHelper)
  strict private
    FLocalId: Integer;

    function GetRibbonGalleryControl: TdxRibbonGalleryControl;
    function GetGroupViewInfo: TdxRibbonGalleryGroupViewInfo;
  protected
    ...
    property RibbonGalleryControl: TdxRibbonGalleryControl read GetRibbonGalleryControl;
    property GroupViewInfo: TdxRibbonGalleryGroupViewInfo read GetGroupViewInfo;
  ...
  protected
    ...
    procedure OnSubmenuHotTrack(ANavigationDirection: TdxRibbonDropDownGalleryNavigationDirection);
    function GetGroupByIndex(AIndex: Integer): TdxRibbonGalleryGroupAccessibilityHelper;
  ...
  private
    FNavigationItems: TdxRibbonGalleryDropDownNavigationList; 
  ...
  protected
    ...
    function GetNextItemLink(AItemLink: TdxBarItemLink; AGoForward: Boolean): TdxBarItemLink; override;
    ...
    property NavigationItems: TdxRibbonGalleryDropDownNavigationList read FNavigationItems;
  end;
  ...
  protected
    ...
    procedure DoDrawScrollBarPart(ACanvas: TcxCustomCanvas; const R: TRect;
  ...
  public
    procedure Paint(ACanvas: TcxCustomCanvas); override;
  end;
  ...
  TdxRibbonDropDownGalleryControl = class(TdxRibbonPopupMenuControl, IdxGestureClient, IdxGestureClient2, IdxGestureOwner)
  private
    FGalleryItem: TdxCustomRibbonGalleryItem;
  ...
  protected
    ...
    property InternalPainter: TdxRibbonDropDownGalleryControlPainter read GetInternalPainter;
    property Resizing: TdxRibbonGalleryDropDownResizing read GetResizing write SetResizing;
  public
    constructor Create(AOwner: TComponent); override;
    destructor Destroy; override;
...
uses
  Types, RTLConsts, Math, Variants, cxContainer, dxBarSkinConsts, dxBarStrs, dxOffice11, cxLookAndFeels, dxCoreGraphics,
  dxDPIAwareUtils, dxTypeHelpers;

const
  dxThisUnitName = 'dxRibbonGallery';
...
type
  ...
  TdxBarDesignControllerAccess = class(TdxBarDesignController);
  TdxBarCustomizingPopupAccess = class(TdxBarCustomizingPopup);
...
begin
  ...
  begin
    ...
    if Result = nil then
    begin
      Result := AGalleryGroups.GetGroupViewInfoClass.Create(AGalleryControlViewInfo, AGalleryGroups[AGroupIndex]);
...
procedure TcxItemSize.DoChangeScale(M, D: Integer);
begin
  if Assigned then
    inherited;
end;

procedure TcxItemSize.DoChanged;
begin
  Assigned := True;
  inherited;
end;

function TcxItemSize.GetValuePart(Index: Integer): Integer;
begin
  if (Parent <> nil) and not Assigned then
    Result := Parent.GetValuePart(Index)
  else
    Result := inherited
end;

function TcxItemSize.IsValuePartStored(Index: Integer): Boolean;
begin
  Result := ((Parent = nil) or Assigned) and inherited;
end;
...
begin
  ...
  try
    FAssigned := AValue;
    if not AValue then
      SetValue(cxNullPoint);
  finally
    CancelUpdate;
  end;
end;

procedure TcxItemSize.SetValue(Value: TPoint);
begin
  Assigned := True;
  inherited;
end;
...
begin
  ...
  begin
    ...
    PopupMenu := TdxRibbonGalleryBaseOptions(Source).PopupMenu;
...
begin
  if IsItemSizeStored then
    ItemSize.ChangeScale(M, D);
  if IsItemImageSizeStored then
...
procedure TdxRibbonGalleryBaseOptions.CheckRemoveItemPadding(var APadding: TdxPadding);
begin
  if RemoveHorizontalItemPadding then
  begin
    APadding.Left := 0;
    APadding.Right := 0;
  end;
  if RemoveVerticalItemPadding then
  begin
    APadding.Top := 0;
    APadding.Bottom := 0;
  end;
...
function TdxRibbonGalleryBaseOptions.GetPopupMenu: TdxBarCustomPopupMenu;
begin
  Result := FPopupMenu;
end;
...
function TdxRibbonGalleryBaseOptions.IsPopupMenuStored: Boolean;
begin
...
procedure TdxRibbonGalleryBaseOptions.SetPopupMenu(Value: TdxBarCustomPopupMenu);
begin
  if Value <> FPopupMenu then
  begin
    if (Value <> nil) and Value.ItemLinks.IsReferencedBy(GalleryItem) then
...
function TdxRibbonGalleryGroupOptions.GetPopupMenu: TdxBarCustomPopupMenu;
begin
  if IsPopupMenuStored then
    Result := inherited GetPopupMenu
  else
    Result := ParentOptions.GetPopupMenu;
end;
...
function TdxRibbonGalleryGroupOptions.IsPopupMenuStored: Boolean;
begin
  Result := avPopupMenu in FAssignedValues;
end;
...
procedure TdxRibbonGalleryGroupOptions.SetPopupMenu(Value: TdxBarCustomPopupMenu);
begin
  Include(FAssignedValues, avPopupMenu);
  inherited;
end;
...
function TdxCustomRibbonGalleryOptions.GetSpaceBetweenGroups: Integer;
begin
  Result := FSpaceBetweenGroups;
end;
...
begin
  inherited Create;
  FLoopVerticalNavigation := True;
  FUseAlternateNavigation := False;
...
begin
  ...
  begin
    LoopVerticalNavigation := TdxInMenuGalleryOptions(Source).LoopVerticalNavigation;
    UseAlternateNavigation := TdxInMenuGalleryOptions(Source).UseAlternateNavigation;
...
function TdxRibbonGalleryGroupItem.DontUseRibbonGlyphInDropDown: Boolean;
begin
  Result := False;
end;
...
function TdxRibbonGalleryGroupItem.ShowDescriptionInRibbon: Boolean;
begin
  Result := False;
end;

function TdxRibbonGalleryGroupItem.GetMinItemSize(AIsInRibbon: Boolean): TSize;
begin
...
begin
  ACollection := GetCollectionFromParent(Value);
...
begin
  ...
  GalleryItem.GalleryChanged(AItem = nil);
end;
...
function TdxRibbonGalleryGroups.GetGroupViewInfoClass: TdxRibbonGalleryGroupViewInfoClass;
begin
  Result := TdxRibbonGalleryGroupViewInfo;
end;
...
function TdxRibbonGalleryFilterCategoryGroups.GetItem(
  Index: TdxListIndex): TdxRibbonGalleryGroup;
begin
  Result := TdxRibbonGalleryGroup(inherited Items[Index]);
end;
...
function TdxRibbonGalleryFilter.GetSubMenuController: TdxRibbonOnSubmenuGalleryController;
var
  I: Integer;
  AControl: TdxRibbonGalleryControl;
begin
  for I := 0 to FGalleryItem.LinkCount - 1 do
  begin
    AControl := Safe<TdxRibbonGalleryControl>.Cast(FGalleryItem.Links[I].Control);
    if AControl <> nil then
    begin
      Result := Safe<TdxRibbonOnSubmenuGalleryController>.Cast(AControl.Controller);
      if Result <> nil then
        Exit;
    end;
  end;
...
procedure TdxRibbonGalleryFilter.Show(const AScreenPoint: TPoint);
var
  AController: TdxRibbonOnSubmenuGalleryController;
begin
  AController := GetSubMenuController;
  if AController <> nil then
  begin
    if AController.IsFilterMenuShowed then
      AController.HideFilterMenu;
    AController.ShowFilterMenu(AScreenPoint);
  end;
end;

procedure TdxRibbonGalleryFilter.Hide;
var
  AController: TdxRibbonOnSubmenuGalleryController;
begin
  AController := GetSubMenuController;
...
procedure TdxRibbonGalleryItemBarItemLink.DoCalculateDragLineParameters(const ADragOverBeginGroup: Boolean;
  var ADragLineFirstPart: Boolean; out ADragLineRect: TRect);
var
  ADragLineItemLink: TdxBarItemLink;
begin
  ADragLineItemLink := Self;
  if ADragOverBeginGroup then
  begin
    if ADragLineFirstPart then
      ADragLineItemLink := Owner.Prev(ADragLineItemLink, True);
    ADragLineFirstPart := not ADragLineFirstPart;
  end;
  ADragLineRect := ADragLineItemLink.ItemRect;
end;

function TdxRibbonGalleryItemBarItemLink.GetNeedDragLine(const ADragOverBeginGroup, ADragOverFirstPart: Boolean;
  ADragOverItemLink: TdxBarItemLink): Boolean;
begin
  Result := inherited GetNeedDragLine(ADragOverBeginGroup, ADragOverFirstPart, ADragOverItemLink) or
    (not ADragOverBeginGroup and (ADragOverItemLink <> Self));
end;

procedure TdxRibbonGalleryItemBarItemLink.PopulateCustomizationPopup(AItemLinks: TdxBarItemLinks;
...
var
  ...
  I: Integer;
begin
  inherited PopulateCustomizationPopup(AItemLinks, ASupportedActions);

  ASubItem := TdxBarDesignControllerAccess(BarDesignController).AddCustomizationSubItem(AItemLinks,
    cxGetResourceString(@dxSBAR_GALLERYITEMLINKPOSITIONINDROPDOWN), True);
...
procedure TdxRibbonGalleryItemBarItemLink.UpdateByDragParameters(const ADragOverBeginGroup, ADragOverFirstPart: Boolean;
  ADragOverItemLink: TdxBarItemLink);
begin
  inherited UpdateByDragParameters(ADragOverBeginGroup, ADragOverFirstPart, ADragOverItemLink);
  if ADragOverItemLink is TdxRibbonGalleryItemBarItemLink then
    PositionInDropDown := TdxRibbonGalleryItemBarItemLink(ADragOverItemLink).PositionInDropDown;
end;
...
constructor TdxRibbonGalleryDropDownNavigationList.Create(AGalleryControl: TdxRibbonDropDownGalleryControl);
begin
  inherited Create;
...
destructor TdxRibbonGalleryDropDownNavigationList.Destroy;
begin
  FreeAndNil(FList);
  inherited Destroy;
end;

function TdxRibbonGalleryDropDownNavigationList.GetCount: Integer;
begin
  Result := FList.Count;
end;

function TdxRibbonGalleryDropDownNavigationList.GetFirst: TdxBarItemLink;
begin
  Result := FList.First;
end;

function TdxRibbonGalleryDropDownNavigationList.GetItem(AIndex: Integer): TdxBarItemLink;
begin
  Result := FList[AIndex];
end;

function TdxRibbonGalleryDropDownNavigationList.GetLast: TdxBarItemLink;
begin
  Result := FList.Last;
end;

function TdxRibbonGalleryDropDownNavigationList.IndexOf(AItem: TdxBarItemLink): Integer;
begin
  Result := FList.IndexOf(AItem);
end;

procedure TdxRibbonGalleryDropDownNavigationList.Populate;
var
  I: Integer;
  AItemLinks: TdxBarItemLinks;
begin
  FList.Clear;
  AItemLinks := FGalleryControl.ItemLinks;

  for I := 0 to AItemLinks.VisibleItemCount - 1 do
    if TdxRibbonGalleryItemBarItemLink(AItemLinks.VisibleItems[I]).PositionInDropDown = ilpBeforeGallery then
      FList.Add(AItemLinks.VisibleItems[I]);

  FGalleryIndex := FList.Add(FGalleryControl.InternalGalleryItemControl.ItemLink);

  for I := 0 to AItemLinks.VisibleItemCount - 1 do
    if TdxRibbonGalleryItemBarItemLink(AItemLinks.VisibleItems[I]).PositionInDropDown = ilpAfterGallery then
      FList.Add(AItemLinks.VisibleItems[I]);
end;
...
begin
  ...
  FGalleryGroups := GetGalleryGroupsClass.Create(Self, GetGalleryGroupClass);
...
begin
  ...
  Result := (AIgnoreVisibleProperty or AGroup.Visible) and
    (
      ...
      (not IgnoreHeaderForGroupVisibility and AGroup.Header.Visible)

    ) and not GalleryFilter.IsGroupFiltered(AGroup);
end;

function TdxCustomRibbonGalleryItem.IgnoreHeaderForGroupVisibility: Boolean;
begin
  Result := False;
end;

function TdxCustomRibbonGalleryItem.CanShowGroupInFilterMenu(AGroupIndex: Integer; AIgnoreVisibleProperty: Boolean = False): Boolean;
begin
  Result := IsGroupVisible(AGroupIndex, AIgnoreVisibleProperty);
end;
...
procedure TdxCustomRibbonGalleryItem.DoSelectedGroupItemChanged(AItem: TdxRibbonGalleryGroupItem);
begin
  // do nothing
end;
...
function TdxCustomRibbonGalleryItem.GetGalleryGroupsClass: TdxRibbonGalleryGroupsClass;
begin
  Result := TdxRibbonGalleryGroups;
end;

function TdxCustomRibbonGalleryItem.GetGalleryGroupClass: TdxRibbonGalleryGroupClass;
begin
  Result := TdxRibbonGalleryGroup;
end;

{function TdxCustomRibbonGalleryItem.GetGalleryGroupItemClass: TdxRibbonGalleryGroupItemClass;
begin
  Result := TdxRibbonGalleryGroupItem;
end;}
...
procedure TdxCustomRibbonGalleryItem.UpdateDropDownControlSize;
var
  AWinControl: TdxRibbonDropDownGalleryControl;
begin
  AWinControl := Safe<TdxRibbonDropDownGalleryControl>.Cast(ItemLinks.BarControl);
  if (AWinControl <> nil) then
    AWinControl.DoRepaintBar(False);
end;
...
begin
  ...
  try
    if FFilterChangedLockCount = 0 then
      FilterUpdateUnlocked;
  finally
    FRecalculatingOnFilterChanged := False;
  end;
end;

procedure TdxCustomRibbonGalleryItem.FilterMenuControlDestroying;
begin
// nothing to do
end;

procedure TdxCustomRibbonGalleryItem.FilterUpdateUnlocked;
var
...
procedure TdxCustomRibbonGalleryItem.GetAllItems(AList: TList);
var
  AGroup: TdxRibbonGalleryGroup;
  I, J: Integer;
begin
  ...
  begin
    AGroup := GalleryGroups[I];
    for J := 0 to AGroup.Items.Count - 1 do
      AList.Add(AGroup.Items[J]);
  end;
end;

function TdxCustomRibbonGalleryItem.FindItem(out AItem: TdxRibbonGalleryGroupItem; const ACompare: TdxRibbonGalleryFindItemFunc): Boolean;

  function FindItemInGroup(AGroup: TdxRibbonGalleryGroup; out AItem: TdxRibbonGalleryGroupItem): Boolean;
  var
    I: Integer;
...
begin
  ...
  if Assigned(ACompare) then
    for I := 0 to GalleryGroups.Count - 1 do
      if FindItemInGroup(GalleryGroups.Items[I], AItem) then
        Exit(True);
end;

procedure TdxCustomRibbonGalleryItem.GalleryChanged(ARecreateControls: Boolean);
begin
  FFirstVisibleGroupItem := nil;
  if (FLockGalleryCount > 0) or IsDestroying or (BarManager = nil) or
    (LinkCount = 0) or TdxBarManagerAccess(BarManager).IsLoading then
  begin
    FNeedUpdateGallery := True;
    FRecreateControlsNeeded := FRecreateControlsNeeded or ARecreateControls;
  end
  else
    DoGalleryChanged(ARecreateControls and (FLockRecreateControlsCount = 0));
end;

procedure TdxCustomRibbonGalleryItem.ResetControlsViewInfo(AFull: Boolean);
var
  AControl: TdxBarItemControl;
  I: Integer;
begin
  ...
  begin
    ...
    begin
      if AFull then
        TdxRibbonGalleryControl(AControl).GalleryChanged
      else
        TdxRibbonGalleryControl(AControl).ViewInfo.FGroups.Clear;
      TdxRibbonGalleryControl(AControl).ViewInfo.ResetCachedValues;
    end;
  end;
end;

procedure TdxCustomRibbonGalleryItem.DoGalleryChanged(ARecreateControls: Boolean);
begin
  FNeedUpdateGallery := False;
  FRecreateControlsNeeded := False;
  ResetControlsViewInfo(True);
  if ARecreateControls then
    UpdateEx;
end;

procedure TdxCustomRibbonGalleryItem.GalleryBeginUpdate;
begin
  Inc(FLockGalleryCount);
end;

procedure TdxCustomRibbonGalleryItem.GalleryEndUpdate;
begin
  Dec(FLockGalleryCount);
  if (FLockGalleryCount = 0) and FNeedUpdateGallery then
    GalleryChanged(FRecreateControlsNeeded);
end;

procedure TdxCustomRibbonGalleryItem.LockRecreateControls;
begin
  Inc(FLockRecreateControlsCount);
end;

procedure TdxCustomRibbonGalleryItem.UnlockRecreateControls;
begin
  Dec(FLockRecreateControlsCount);
end;
...
function TdxCustomRibbonGalleryItem.GetMinDropDownGalleryControlSize: TSize;
begin
  Result := cxInvalidSize;
end;

function TdxCustomRibbonGalleryItem.GetMaxDropDownGalleryControlSize: TSize;
begin
  Result := cxInvalidSize;
end;

function TdxCustomRibbonGalleryItem.UseGroupItemSizeInRibbon: Boolean;
begin
  Result := False;
end;
...
begin
  ...
  begin
    ...
    begin
      for I := 0 to GalleryGroups.Count - 1 do
        if CanShowGroupInFilterMenu(I) then
        begin
          if Result <> '' then
...
function TdxCustomRibbonGalleryItem.IsFilterVisible: Boolean;
  ...
  begin
    for I := 0 to GalleryGroups.Count - 1 do
      if CanShowGroupInFilterMenu(I, True) then
        Exit(True);
    Result := False;
  end;
...
procedure TdxCustomRibbonGalleryItem.Loaded;
  ...
  begin
    ...
    begin
      AGroup := GalleryGroups[I];
      for J := 0 to AGroup.Items.Count - 1 do
        if AGroup.Items[J].LoadedSelected then
        begin
          Result := AGroup.Items[J];
...
begin
  ...
  begin
    ...
    if AComponent is TdxBarCustomPopupMenu then
    begin
      if (GalleryOptions <> nil) and (AComponent = GalleryOptions.PopupMenu) then
        GalleryOptions.PopupMenu := nil;
      if GalleryCategories <> nil then
        for I := 0 to GalleryCategories.Count - 1 do
          if (GalleryCategories[I].Options <> nil) and (AComponent = GalleryCategories[I].Options.PopupMenu) then
            GalleryCategories[I].Options.PopupMenu := nil
    end;
  end;
end;
...
begin
  ...
  begin
    ...
    DoSelectedGroupItemChanged(FSelectedGroupItem);
    Update;
  end;
end;
...
constructor TdxRibbonGalleryController.Create(AOwner: TdxRibbonGalleryControl);
begin
  inherited Create;
  FOwner := AOwner;
...
procedure TdxRibbonGalleryController.HotTrackItem(AItem: TdxRibbonGalleryGroupItem);
begin
...
procedure TdxRibbonGalleryController.ProcessHotTrack(AGroupItem: TdxRibbonGalleryGroupItem);
begin
  if FGroupItemHotTrackEnabled then
  begin
    ViewInfo.DontDisplayHotTrackedGroupItem := ViewInfo.DontDisplayHotTrackedGroupItem + 1;
    try
...
procedure TdxRibbonGalleryController.SetHotGroupItem(AValue: TdxRibbonGalleryGroupItem; AIsKeyboardNavigation: Boolean = False);
begin
  if AValue <> ViewInfo.HotGroupItem then
  begin
    ViewInfo.HotGroupItem := AValue;
    if (AValue <> nil) or AIsKeyboardNavigation then
      FKeyboardHotGroupItem := AValue;
    UnsetDownedFromGroupItem(AValue);
  end;
end;
...
function TdxRibbonOnSubmenuGalleryController.Navigation(ADirection: TcxAccessibilityNavigationDirection): Boolean;
type
  TXRange = record
    Left: Integer;
    Right: Integer;
...
var
  ANavigationItems: TdxRibbonGalleryDropDownNavigationList;
  ASupportsItemsNavigation: Boolean;

  function HasControlByDirection(ADownDirection: Boolean; ALoop: Boolean): Boolean;
  begin
    Result := HasControlByVerticalDirection(ANavigationItems, ADownDirection, ALoop);
  end;
  ...
  begin
    Result := nil;
    if ASupportsItemsNavigation and (ADirection in [andUp, andDown]) then
    begin
      ALoop := LoopVerticalNavigation;
      if not ALoop and not HasControlByDirection(ADirection = andDown, False) then
         Result := KeyboardHotGroupItem;
    end;
  end;

  procedure TransferToAnotherGroup(var AGroupIndex: Integer;
    const AColumnRange: TXRange; ADownDirection: Boolean; var ARow, AColumn: Integer);
  var
    AColumnCountInRow: Integer;
    AColumnFound: Boolean;
  ...
  begin
    ...
    begin
      if ASupportsItemsNavigation then
      begin
        ALoop := LoopVerticalNavigation;
        if not ALoop or HasControlByDirection(ADownDirection, ALoop) then
          Exit;
      end
      else
      begin
    ...
    ACurrentRowIndex := 0;
    if GalleryItem.IsGroupVisible(AGroupIndex) and (FOwner.GetGroups[AGroupIndex].Items.Count > 0) then
    begin
      AGroupViewInfo := GetGroupViewInfo(FOwner.GetGroups, ViewInfo, AGroupIndex, ADestroyAfterUse);
      {if ADestroyAfterUse then
      ...
      repeat
        ANextRow := False;
        AColumnCountInRow := AGroupViewInfo.GetColumnCountInRow(ACurrentRowIndex, GetGalleryWidth);
        ACurrentColumnIndex := 0;
        APreviousColumnIntersected := False;
        repeat
          AColumnLeft := AGroupViewInfo.GetColumnLeft(ACurrentColumnIndex, ViewInfo.GalleryBounds.Left);
          AColumnRight := AColumnLeft + AGroupViewInfo.ItemSize.cx;
          ACurrentColumnIntersected := AreLinesIntersectedStrictly(AColumnLeft, AColumnRight, AColumnRange.Left, AColumnRange.Right);

          if ADownDirection then
          begin
            AColumnFound := ACurrentColumnIntersected;
            if not AColumnFound and UseAlternateNavigation and (ACurrentColumnIndex = AColumnCountInRow - 1) then
              AColumnFound := True;
          end
          else
          begin
            AColumnFound := APreviousColumnIntersected and not ACurrentColumnIntersected;
            if AColumnFound then
              Dec(ACurrentColumnIndex);
            if (ACurrentColumnIndex = AColumnCountInRow - 1) and ACurrentColumnIntersected then
              AColumnFound := True;
            if not AColumnFound and UseAlternateNavigation and (ACurrentColumnIndex = AColumnCountInRow - 1) then
              AColumnFound := True;
            APreviousColumnIntersected := ACurrentColumnIntersected;
          end;
          if not AColumnFound then
          begin
            ANextRow := ACurrentColumnIndex = AColumnCountInRow - 1;
            Inc(ACurrentColumnIndex);
          end;
        until AColumnFound or ANextRow;
        ...
        begin
          ...
          begin
            ...
            ANextGroup := ACurrentRowIndex > AGroupViewInfo.GetRowCount(GetGalleryWidth) - 1;
          end
          else
          begin
      ...
      until AColumnFound or ANextGroup;
    ...
    begin
      ...
      TransferToAnotherGroup(AGroupIndex, AColumnRange, ADownDirection, ARow, AColumn);
    end;
  end;

  function GetColumnRange(AGroupViewInfo: TdxRibbonGalleryGroupViewInfo; AColumn: Integer): TXRange;
  begin
    Result.Left := AGroupViewInfo.GetColumnLeft(AColumn, ViewInfo.GalleryBounds.Left);
    Result.Right := Result.Left + AGroupViewInfo.ItemSize.cx;
  end;

  procedure DownDirection(AGroupViewInfo: TdxRibbonGalleryGroupViewInfo; var AGroupIndex: Integer; var ARow, AColumn: Integer);

    procedure GoToAnotherGroup;
    var
      ARange: TXRange;
    begin
  ...
  begin
    if UseAlternateNavigation then
    begin
      if ARow < AGroupViewInfo.GetRowCount(GetGalleryWidth) - 1 then
      begin
        AColumnCount := AGroupViewInfo.GetColumnCountInRow(ARow + 1, GetGalleryWidth);
        if (AColumnCount > 0) and (AColumn >= AColumnCount) then
          AColumn := AColumnCount - 1;
        Inc(ARow);
      end
      else
        GoToAnotherGroup;
    ...
    begin
      if (ARow < AGroupViewInfo.GetRowCount(GetGalleryWidth) - 1) and
        (AColumn <= AGroupViewInfo.GetColumnCountInRow(ARow + 1, GetGalleryWidth) - 1) then
          Inc(ARow)
      else
        GoToAnotherGroup;
    end;
  ...
  procedure UpDirection(AGroupViewInfo: TdxRibbonGalleryGroupViewInfo; var AGroupIndex: Integer; var ARow, AColumn: Integer);
  var
    ARange: TXRange;
    AColumnCount: Integer;
  begin
  ...
  procedure LeftDirection(AGroupViewInfo: TdxRibbonGalleryGroupViewInfo; var ARow, AColumn: Integer);
  begin
    if AColumn > 0 then
      Dec(AColumn)
    else
      AColumn := AGroupViewInfo.GetColumnCountInRow(ARow, GetGalleryWidth) - 1;
  end;

  procedure RightDirection(AGroupViewInfo: TdxRibbonGalleryGroupViewInfo;  var ARow, AColumn: Integer);
  begin
    if AColumn < AGroupViewInfo.GetColumnCountInRow(ARow, GetGalleryWidth) - 1 then
      Inc(AColumn)
    else
      AColumn := 0;
  end;
  ...
  var
    ...
    AGroupViewInfo: TdxRibbonGalleryGroupViewInfo;
  begin
    AGroupViewInfo := GetGroupViewInfo(FOwner.GetGroups, ViewInfo, AHotGroupItem.Group.Index, ADestroyAfterUse);
    try
      AGroupIndex := AHotGroupItem.Group.Index;
      AGroupItemRow := AGroupViewInfo.GetItemRow(AHotGroupItem.Index, GetGalleryWidth);
      AGroupItemColumn := AGroupViewInfo.GetItemColumn(AHotGroupItem.Index, GetGalleryWidth);
      case ADirection of
        andLeft:
          LeftDirection(AGroupViewInfo, AGroupItemRow, AGroupItemColumn);
        andUp:
          UpDirection(AGroupViewInfo, AGroupIndex, AGroupItemRow, AGroupItemColumn);
        andRight:
          RightDirection(AGroupViewInfo, AGroupItemRow, AGroupItemColumn);
        andDown:
          DownDirection(AGroupViewInfo, AGroupIndex, AGroupItemRow, AGroupItemColumn);
      end;
      ...
      begin
        ...
        Result := GetGroupItem(AGroupIndex, AGroupViewInfo.GetItemIndex(AGroupItemRow, AGroupItemColumn, GetGalleryWidth));
        if not Result.Enabled then
          Result := Navigate(Result);
      end
      else
        Result := GetHotGroupItem;
    finally
      if ADestroyAfterUse then
        FreeAndNil(AGroupViewInfo);
    end;
...
begin
  ASupportsItemsNavigation := SupportsItemsNavigation;
  ANavigationItems := nil;
  try
    AHotGroupItem := KeyboardHotGroupItem;
    if AHotGroupItem <> nil then
      AHotGroupItem := Navigate(AHotGroupItem)
    else
      if ADirection = andUp then
        AHotGroupItem := GetLastGroupItem(False)
      else
        AHotGroupItem := GetFirstGroupItem;

    SetHotGroupItem(AHotGroupItem, True);
    FLastCommandFromKeyboard := True;

    Result := AHotGroupItem <> nil;
  finally
    FreeAndNil(ANavigationItems);
  end;
end;

function TdxRibbonOnSubmenuGalleryController.HotTrackFirstGroupItem: Boolean;
begin
  HotTrackItem(GetFirstGroupItem);
  Result := True;
end;

procedure TdxRibbonOnSubmenuGalleryController.UpdateHotTrack(ADirection: TdxRibbonDropDownGalleryNavigationDirection);
begin
  case ADirection of
    dgndNone:
      if Owner.Item.SelectedGroupItem <> nil then
        HotTrackItem(Owner.Item.SelectedGroupItem)
      else
...
function TdxRibbonOnSubmenuGalleryController.HotTrackLastGroupItem: Boolean;
begin
...
function TdxRibbonOnSubmenuGalleryController.SupportsItemsNavigation: Boolean;
begin
  Result := Owner.Parent is TdxRibbonDropDownGalleryControl;
end;

function TdxRibbonOnSubmenuGalleryController.HasControlByVerticalDirection(
  var ANavigationItems: TdxRibbonGalleryDropDownNavigationList; ADownDirection, ALoop: Boolean): Boolean;

  function HasControl: Boolean;
  begin
    Result := ANavigationItems.Count > 1;
  end;

  function HasNextControl: Boolean;
  begin
    Result := ANavigationItems.GalleryIndex < ANavigationItems.Count - 1
  end;

  function HasPrevControl: Boolean;
  begin
    Result := ANavigationItems.GalleryIndex > 0;
  end;

begin
  if ANavigationItems = nil then
    ANavigationItems := TdxRibbonGalleryDropDownNavigationList.Create(Owner.Parent as TdxRibbonDropDownGalleryControl);
  if ALoop then
    Result := HasControl
  else
    if ADownDirection then
      Result := HasNextControl
    else
      Result := HasPrevControl;
end;

function TdxRibbonOnSubmenuGalleryController.LoopVerticalNavigation: Boolean;
begin
  Result := Owner.Item.GalleryInMenuOptions.LoopVerticalNavigation;
end;

function TdxRibbonOnSubmenuGalleryController.UseAlternateNavigation: Boolean;
begin
  Result := Owner.Item.GalleryInMenuOptions.UseAlternateNavigation;
end;

procedure TdxRibbonOnSubmenuGalleryController.MouseDown(Button: TMouseButton; Shift: TShiftState; X, Y: Integer);
begin
  inherited MouseDown(Button, Shift, X, Y);
  if FDontShowFilterMenuOnMouseDown then
    FDontShowFilterMenuOnMouseDown := False
  else
    if (Button = mbLeft) and GalleryItem.IsFilterVisible and ViewInfo.IsPtInFilterBandHotTrackArea(Point(X, Y)) then
    begin
      ShowFilterMenu;
...
function TdxRibbonOnSubmenuGalleryController.PageDown: Boolean;
var
...
begin
  ...
  ViewInfo.GroupItemYRange(AHotGroupItem, AHotTrackedGroupItemTop, AHotTrackedGroupItemBottom);
  AGroupIndex := AHotGroupItem.Group.Index;
  ...
  repeat
    ...
    if AGroupViewInfo <> nil then
      try
        repeat
          ACurrentGroupItem := GetGroupItem(AGroupIndex, AGroupViewInfo.GetItemIndex(
            AGroupRowIndex, AGroupViewInfo.GetColumnCountInRow(AGroupRowIndex, AWidth) - 1, AWidth));
          ViewInfo.GroupItemYRange(ACurrentGroupItem, ACurrentGroupItemTop, ACurrentGroupItemBottom);
          if (ACurrentGroupItemBottom - AHotTrackedGroupItemBottom) < AViewInfo.GallerySize.cy then
            ARequiredGroupItem := ACurrentGroupItem
          else
            AItemIsObtained := True;
          Inc(AGroupRowIndex);
        until (AGroupRowIndex > AGroupViewInfo.GetRowCount(AWidth) - 1) or AItemIsObtained;
      finally
        if ADestroyAfterUse then
          AGroupViewInfo.Free;
      end;
...
function TdxRibbonOnSubmenuGalleryController.PageUp: Boolean;
var
  AHotTrackedGroupItemBottom, AHotTrackedGroupItemTop: Integer;
...
begin
  ...
  try
    AGroupRowIndex := AGroupViewInfo.GetItemRow(AHotGroupItem.Index, AWidth);
    ACurrentGroupItem := GetGroupItem(AGroupIndex, AGroupViewInfo.GetItemIndex(AGroupRowIndex, 0, AWidth));
  finally
    if ADestroyAfterUse then
      AGroupViewInfo.Free;
  end;
  ...
  repeat
    ...
    try
      ...
      repeat
        ...
        if (AHotTrackedGroupItemTop - ACurrentGroupItemTop) < AViewInfo.GallerySize.cy then
          ARequiredGroupItem := ACurrentGroupItem
        else
          AItemIsObtained := True;
        Dec(AGroupRowIndex);
  ...
  if AItemIsObtained then
  begin
    AViewInfo.DontDisplayGroupHeaderWhenHotTrackingGroupItem := AViewInfo.DontDisplayGroupHeaderWhenHotTrackingGroupItem + 1;
    try
      SetHotGroupItem(ARequiredGroupItem)
    finally
      AViewInfo.DontDisplayGroupHeaderWhenHotTrackingGroupItem := AViewInfo.DontDisplayGroupHeaderWhenHotTrackingGroupItem - 1;
...
function TdxRibbonOnSubmenuGalleryController.Tabulation: Boolean;
var
  ANavigationItems: TdxRibbonGalleryDropDownNavigationList;
  ASupportsItemsNavigation: Boolean;

  function HasControlsByDirection(ADownDirection: Boolean; ALoop: Boolean): Boolean;
  begin
    Result := HasControlByVerticalDirection(ANavigationItems, ADownDirection, ALoop)
  end;
...
begin
  Result := True;
  AIsForwardDirection := GetKeyState(VK_SHIFT) and 128 <> 128;
      ...
      begin
        ...
        begin
          ...
          if AGroupItem.Group.Index < FOwner.GetGroups.Count - 1 then
            AGroupIndex := ViewInfo.GetVisibleNotEmptyGroupIndex(AGroupItem.Group.Index + 1, True);
          if AGroupIndex = -1 then
          begin
            if ASupportsItemsNavigation then
            begin
              if HasControlsByDirection(AIsForwardDirection, ALoop) then
              begin
                SetHotGroupItem(nil, True);
                Exit(False);
              end
              else
                if ALoop then
            ...
            begin
              if TdxBarItemLinksAccess(FOwner.Parent.ItemLinks).Count > 0 then
              begin
                SetHotGroupItem(nil, True);
                Exit(False);
              end
        ...
        begin
          ...
          if AGroupItem.Group.Index > 0 then
            AGroupIndex := ViewInfo.GetVisibleNotEmptyGroupIndex(AGroupItem.Group.Index - 1, False);
          if AGroupIndex = -1 then
          begin
            if ASupportsItemsNavigation then
            begin
              ...
              begin
                ...
                if ALoop then
                  AGroupIndex := ViewInfo.GetVisibleNotEmptyGroupIndex(FOwner.GetGroups.Count - 1, False);
            end
            else
            begin
              if TdxBarItemLinksAccess(FOwner.Parent.ItemLinks).Count > 0 then
...
function TdxRibbonOnSubmenuGalleryController.FilterDropDownAutoSize(AGroupIndex: Integer): Boolean;
begin
  Result := False;
end;
...
begin
  ...
  begin
    if FilterDropDownAutoSize(AButton.Tag) then
      GalleryItem.UpdateDropDownControlSize;
    GalleryItem.FilterChanged;
    GalleryItem.DoFilterChanged;
    ViewInfo.RepaintFilterBand;
  end;
...
function TdxRibbonOnSubmenuGalleryController.GetFilterMenuControl: TdxRibbonGalleryFilterMenuControl;
begin
  Result := FFilterMenuLinksOwner.BarControl as TdxRibbonGalleryFilterMenuControl;
end;
...
function TdxRibbonOnSubmenuGalleryController.GetLastGroupItem(ALastInGroup: Boolean = True): TdxRibbonGalleryGroupItem;
var
  AGroup: TdxRibbonGalleryGroup;
  I: Integer;
begin
...
begin
  ...
  begin
    for I := 0 to GalleryItem.GalleryGroups.Count - 1 do
    begin
      if GalleryItem.CanShowGroupInFilterMenu(I, True) then
...
begin
  ShowFilterMenu(cxInvisiblePoint);
end;

procedure TdxRibbonOnSubmenuGalleryController.ShowFilterMenu(const AScreenPoint: TPoint);
var
...
begin
  ...
  if AScreenPoint.X <> cxInvisiblePoint.X then
    P.X := AScreenPoint.X;
  if AScreenPoint.Y <> cxInvisiblePoint.Y then
    P.Y := AScreenPoint.Y;
  APopupControl.OwnerHeight := AOwnerHeight;
  APopupControl.Left := P.X;
  APopupControl.Top := P.Y;
  if not APopupControl.ScaleFactor.Equals(FOwner.ScaleFactor) then
    APopupControl.ScaleForPPI(FOwner.ScaleFactor.TargetDPI);
  APopupControl.Show;
end;
...
begin
  if (FGalleryControl <> nil) and (FGalleryControl.Item <> nil) then
    FGalleryControl.Item.FilterMenuControlDestroying;
  inherited Destroy;
end;
...
function TdxRibbonGalleryFilterMenuControl.IsMeaningParent(AWnd: HWND): Boolean;
var
  AOwner: TWinControl;
begin
  AOwner := RealOwnerControl;
  Result := (AOwner <> nil) and AOwner.HandleAllocated and ((AWnd = AOwner.Handle) or
    ((AOwner is TCustomdxBarControl) and TCustomdxBarControlAccess(AOwner).IsChildWindow(AWnd)));
end;
...
procedure TdxRibbonGalleryFilterMenuControl.SetFont;
begin
  dxAssignFont(Font, GalleryControl.Parent.Font, ScaleFactor, TCustomdxBarControlAccess(GalleryControl.Parent).ScaleFactor);
end;
...
begin
  if FFilterBandIAccessibilityHelper <> nil then
    FFilterBandIAccessibilityHelper.OwnerObjectDestroyed;
  FFilterBandIAccessibilityHelper := nil;
  if (FScrollBar <> nil) and not (csDestroying in FScrollBar.ComponentState) then
...
begin
  ...
  begin
    ...
    if (AGroupItemViewInfo <> nil) and AGroupItemViewInfo.IsCaptionVisible and (FHintItem.Description <> '') then
...
procedure TdxRibbonGalleryControl.UpdateHint(AHintItem: TdxRibbonGalleryGroupItem; const ABounds: TRect);
begin
  FHintItem := AHintItem;
  FHintBounds := ABounds;
  if Parent <> nil then
    TCustomdxBarControlAccess(Parent).SynchronizeHints;
  if FHintItem <> nil then
...
procedure TdxRibbonGalleryControl.AccessibleSelectItem(AClickedGroupItem: TdxRibbonGalleryGroupItem);
begin
  Item.FClickedGroupItem := AClickedGroupItem;
  inherited ControlUnclick(False);
end;
...
begin
  ...
  begin
    ...
    Result := ViewInfo.GetLayoutWidthEx(False, AGroupItemWidthIsNull, AScrollbarAndIndents);
...
begin
  ...
  begin
    ALayoutOffset := Max(0, Min(FScrollBar.Position, GetScrollBarMaxPos));
    ViewInfo.Calculate(ALayoutOffset, TScrollCode.scPosition);
  end;
  ScrollBarSetup;
end;
...
function TdxRibbonGalleryControl.CanDropDown: Boolean;
begin
  Result := True;
end;
...
begin
  ...
  if not Collapsed then
    Result := Max(Result, ViewInfo.GetHeight(GetDefaultWidthInSubmenu));
end;
...
function TdxRibbonGalleryControl.GetHint: string;
begin
  if FHintItem <> nil then
    Result := GetHintText(FHintItem)
  else
...
begin
  ...
  begin
    R := ViewInfo.GetControlBounds;
    if UseRightToLeftAlignment then
      P := Parent.ClientToScreen(cxPoint(R.Right, R.Top))
    else
      P := Parent.ClientToScreen(R.TopLeft);
    AOwnerWidth := 0;
    AOwnerHeight := 1;
  end
  else
...
procedure TdxRibbonGalleryControl.GalleryChanged;
begin
  ViewInfo.FGroups.Clear;
  ViewInfo.Changed;
end;
...
begin
  Result := inherited WantsKey(Key) and
    not (((Key = VK_RETURN) or (Key = VK_SPACE)) and not Collapsed and (Parent.Kind <> bkBarControl));
end;
...
begin
  ...
  begin
    ...
    FDrawParams.DroppedDown := not Collapsed;
...
begin
  ...
  if (Parent.Kind = bkBarControl) and (Result <> nil) and (Result.ParentItemControl <> Self) and
    not FIsCreatingSubmenuControl and not FIsClosingUpSubmenuControl
  then
    Result := nil;
end;
...
begin
  case Parent.Kind of
    bkSubMenu:
      Result := TdxRibbonOnMenuGalleryControlViewInfo;
    bkBarControl:
      Result := TdxInRibbonGalleryControlViewInfo;
  else
    raise EdxException.Create(InvalidGalleryParentKind);
  end
end;
...
function TdxRibbonGalleryControl.IsEnabledScrollBar(AClientWidth: Integer = 0): Boolean;
begin
  if AClientWidth = 0 then
    AClientWidth := ClientWidth;
  Result := Enabled and (ScrollBar.IsDropDownStyle or
    (ViewInfo.GetGalleryHeight(AClientWidth) > ClientHeight) and not Item.RecalculatingOnFilterChanged);
end;
...
function TdxRibbonGalleryControl.IsNeedScrollBar(AClientWidth: Integer = 0): Boolean;
begin
  ...
  begin
    ...
    try
      Result := not Collapsed and ((Parent.Kind = bkBarControl) or
        ...
        IsEnabledScrollBar(AClientWidth));
    finally
...
function TdxRibbonGalleryControl.ShowCustomPopupMenu: Boolean;

  procedure DoShowCustomPopupMenu(APopupPoint: TPoint);
  var
    APopupMenuControl: TdxBarCustomizingPopupAccess;
  begin
    if FCustomPopupMenu.ItemLinks.Count > 0 then
    begin
      FCustomPopupMenu.ItemLinks.CreateBarControl;
      APopupMenuControl := TdxBarCustomizingPopupAccess(FCustomPopupMenu.ItemLinks.BarControl);
      APopupMenuControl.ParentBar := nil;
      if Parent <> nil then
        APopupMenuControl.FParentWnd := Parent.Handle;
      APopupMenuControl.FPainter := TCustomdxBarControlAccess(Parent).Painter;
      APopupMenuControl.FPopupAlignment := TdxBarCustomPopupMenuAccess(FCustomPopupMenu).PopupAlignment;
      APopupMenuControl.OnCloseUp := CustomPopupMenuCloseUpHandler;
      APopupMenuControl.OnPopup := CustomPopupMenuPopupHandler;
      APopupMenuControl.OnShow := FCustomPopupMenu.OnShow;
      APopupMenuControl.Left := APopupPoint.X;
      APopupMenuControl.Top := APopupPoint.Y;
      APopupMenuControl.Show;
    end;
  end;

var
  AHotGroupItem: TdxRibbonGalleryGroupItem;
  APopupPoint, AClientPopupPoint: TPoint;
begin
  Result := not BarManager.IsCustomizing;
  if Result then
  begin
    APopupPoint := GetMouseCursorPos;
    AClientPopupPoint := Parent.ScreenToClient(APopupPoint);
    AHotGroupItem := ViewInfo.GetGroupItem(AClientPopupPoint.X, AClientPopupPoint.Y);
    if AHotGroupItem <> ViewInfo.HotGroupItem then
      Controller.MouseMove([], AClientPopupPoint.X, AClientPopupPoint.Y);
    if AHotGroupItem <> nil then
      FCustomPopupMenu := AHotGroupItem.Group.Options.PopupMenu
    else
      FCustomPopupMenu := nil;
    if Assigned(Item.OnShowPopupMenu) then
      Item.OnShowPopupMenu(Item, FCustomPopupMenu, APopupPoint, AHotGroupItem);
    Result := FCustomPopupMenu <> nil;
    if Result then
      DoShowCustomPopupMenu(APopupPoint);
  end;
end;
...
begin
  if not CanHandleScrollCode then
    Exit;
  ScrollBarSetup;   
  ScrollPos := Min(ScrollPos, Max(0, GetScrollBarMaxPos));
...
begin
  if not FScrollBar.Enabled or (FScrollBar.Position = APosition) then
    Exit;
...
procedure TdxRibbonGalleryControl.CustomPopupMenuCloseUpHandler(Sender: TObject; AReason: TdxBarCloseUpReason);
begin
  if Assigned(FCustomPopupMenu.OnCloseUp) then
    FCustomPopupMenu.OnCloseUp(FCustomPopupMenu);
  FIsCustomPopupMenuShown := False;
end;

procedure TdxRibbonGalleryControl.CustomPopupMenuPopupHandler(Sender: TObject);
begin
  FIsCustomPopupMenuShown := True;
  if Assigned(FCustomPopupMenu.OnPopup) then
    FCustomPopupMenu.OnPopup(FCustomPopupMenu);
end;
...
function TdxRibbonGalleryControl.GetFilterBandIAccessibilityHelper: IcxAccessibilityHelper;
begin
  if FFilterBandIAccessibilityHelper = nil then
    FFilterBandIAccessibilityHelper := TdxRibbonGalleryFilterAccessibilityHelper.Create(Self);
  Result := FFilterBandIAccessibilityHelper;
end;
...
begin
  ...
  begin
    ...
    ACaptionRect := cxRectContent(Bounds, GetContentOffset);
    cxDrawText(ACanvas, Caption, ACaptionRect, GetTextFlags(Owner.Group.Header.Alignment) + DT_END_ELLIPSIS,
      Owner.Painter.DropDownGalleryGetGroupHeaderTextColor);
  end;
end;
...
function TdxRibbonGalleryGroupHeaderViewInfo.GetContentOffset: TdxPadding;
begin
  Result := Owner.Painter.LookAndFeelPainter.GetGalleryScaledGroupHeaderContentOffsets(ScaleFactor);
end;
...
begin
  ...
  begin
    Result := TdxTextMeasurer.TextLineHeight(GetFont) + GetContentOffset.Height;
    Result := Max(Owner.Group.Header.Height, Result);
...
begin
  ...
  try
    ...
    Owner.Owner.DrawBackground(ACanvas, Owner.Owner.Bounds);
...
procedure TdxRibbonGalleryGroupItemViewInfo.DrawDescriptionText(ACanvas: TcxCanvas; ADescriptionRect: TRect; ATextAlignmentFlags: DWORD);
var
  ARect: TRect;
...
begin
  ...
  begin
    DrawInnerText(ACanvas, FDescriptionLines[I], ARect, ATextAlignmentFlags);
...
var
  AImageBound: TRect;
begin
  AImageBound := cxRectContent(ARect, Owner.Owner.GetGroupItemImageContentOffset);
  TdxImageDrawer.DrawUncachedImage(DC, AImageBound, AImageBound, GetCurrentGlyph, GroupItem.Group.Images,
    GroupItem.ImageIndex, EnabledImageDrawModeMap[GroupItem.GetEnabled], True);
end;

procedure TdxRibbonGalleryGroupItemViewInfo.DrawInnerText(ACanvas: TcxCanvas; const AText: string; const ARect: TRect;
  AFormat: UINT);
begin
...
var
  ...
  ACaptionBounds, ADescriptionBounds: TRect;
begin
  ...
  begin
    ...
    ACaptionBounds := cxRectContent(FCaptionBounds, Owner.Owner.GetGroupItemCaptionContentOffset);
    DrawInnerText(ACanvas, Caption, ACaptionBounds, ATextAlignmentFlags + DT_END_ELLIPSIS);
  end;
  if ADescriptionVisible then
  begin
    ACanvas.Font.Style := ACanvas.Font.Style - [fsBold];
    ValidateDescriptionStrings(ACanvas);
    ADescriptionBounds := cxRectContent(FDescriptionBounds, Owner.Owner.GetGroupItemDescriptionContentOffset);
    DrawDescriptionText(ACanvas, ADescriptionBounds, ATextAlignmentFlags);
  end;
end;
...
begin
  if IsCaptionVisible then
    Result := TdxTextMeasurer.TextLineHeight(Font) + Owner.Owner.GetGroupItemCaptionContentOffset.Height
  else
    Result := 0;
end;
  ...
  begin
    ...
    begin
      ...
      try
        ...
        Result := cxTextWidth(AFont, GroupItem.Caption) + Owner.Owner.GetGroupItemCaptionContentOffset.Width;
      finally
        AFont.Free;
      end;
...
function TdxRibbonGalleryGroupItemViewInfo.GetContentOffset: TdxPadding;
begin
  Result := Owner.Owner.GetGroupItemContentOffset;
  Options.CheckRemoveItemPadding(Result);
end;

function TdxRibbonGalleryGroupItemViewInfo.GetCurrentGlyph: TdxSmartGlyph;
begin
  if not IsInplaceGallery and (not GroupItem.GlyphInDropDown.Empty or GroupItem.DontUseRibbonGlyphInDropDown) then
...
begin
  ...
  begin
    ...
    begin
      ...
      Result := ADescriptionRect.Height;
...
function TdxRibbonGalleryGroupItemViewInfo.GetItemSize(AMaxWidth, AMaxHeight: Integer): TSize;
  ...
  procedure AdjustSize(var AWidth, AHeight: Integer);
  var
    AMinItemSize: TSize;
  begin
    AMinItemSize := FGroupItem.GetMinItemSize(IsInplaceGallery);
    if AMinItemSize.cx <> cxInvalidSize.cx then
      AWidth := Max(AMinItemSize.cx, AWidth);
    if AMinItemSize.cy <> cxInvalidSize.cy then
      AHeight := Max(AMinItemSize.cy, AHeight);
  end;
...
begin
  ...
  case Options.GetItemImagePosition of
    gipTop, gipBottom:
      begin
        AMaxDescriptionWidth := AMaxWidth;
        AWidth := Max(Max(GetCaptionWidth, GetDescriptionWidth(ADescriptionRect, AMaxDescriptionWidth)), AImageSize.cx);
    ...
    AHeight := Max(AImageSize.cy,
      GetCaptionHeight + GetDescriptionHeight(ADescriptionRect) + GetSpaceBetweenItemCaptionAndDescription);
  end;
  AdjustSize(AWidth, AHeight);
  Inc(AWidth, GetContentOffset.Width);
  Inc(AHeight, GetContentOffset.Height);
  if AMaxWidth > 0 then
...
begin
  Result := Owner.Owner.GetGroupItemFixedSpaceBetweenCaptionAndDescription;
  if IsCaptionVisible and IsDescriptionVisible then
    Inc(Result, Options.GetSpaceBetweenItemCaptionAndDescription);
end;
...
begin
  if IsCaptionVisible and CanUseSize(GetUnsizedImageSize) then
    Result := Options.GetSpaceBetweenItemImageAndText + Owner.Owner.GetGroupItemFixedSpaceBetweenImageAndText
  else
    Result := 0;
end;
...
begin
  ...
  Inc(Result.cx, Owner.Owner.GetGroupItemImageContentOffset.Width);
  Inc(Result.cy, Owner.Owner.GetGroupItemImageContentOffset.Height);
end;
...
begin
  ...
  if not (IsImageVisible or IsDescriptionVisible) then
    Result := cxRectCenter(Bounds, TSize.Create(Result.Width, Result.Height));
end;
...
begin
  Result.Left := GetTextLeft;
  Result.Top := GetTextTop + GetCaptionHeight + GetSpaceBetweenItemCaptionAndDescription;
  Result.Right := GetTextRight;
...
begin
  ...
  begin
    ABounds := cxRectContent(Bounds, GetContentOffset);
    case Options.GetItemImagePosition of
      gipLeft:
        begin
          Result.Left := ABounds.Left;
          Result.Top := ABounds.Top;
...
begin
  ...
  begin
    if CanUseSize(CalculateImageSize) then
      Inc(Result, CalculateImageSize.cx + GetSpaceBetweenItemImageAndText);
  end;
  Inc(Result, GetContentOffset.Left);
end;
...
begin
  ...
  begin
    if CanUseSize(CalculateImageSize) then
      Dec(Result, CalculateImageSize.cx + GetSpaceBetweenItemImageAndText);
  end;
  Dec(Result, GetContentOffset.Right);
end;
...
begin
  ...
  begin
    if CanUseSize(CalculateImageSize) then
      Inc(Result, CalculateImageSize.cy + GetSpaceBetweenItemImageAndText);
  end;
  Inc(Result, GetContentOffset.Top);
end;

function TdxRibbonGalleryGroupItemViewInfo.IsBoldCaption: Boolean;
begin
  Result := (not IsInplaceGallery or ShowDescriptionInRibbon) and (Options.ItemTextKind in [itkCaptionAndDescription]);
end;
...
begin
  ...
  case AVerticalAlignment of
    ...
    vaCenter:
      ATextRect := cxRectCenterVertically(ARect, ATextRect.Height);
  end;

  FCaptionBounds := cxRectSetTop(FCaptionBounds, ATextRect.Top);
  FDescriptionBounds := cxRectSetTop(FDescriptionBounds,
    FCaptionBounds.Bottom + GetSpaceBetweenItemCaptionAndDescription);
end;
...
var
  ASuccess, ARecalculateDescription: Boolean;
begin
  ARecalculateDescription := AMaxWidth > 0;
  if (not IsInplaceGallery or ShowDescriptionInRibbon) and not ARecalculateDescription then
    Result := (Owner.Owner as TdxRibbonGalleryControlViewInfo).GetGroupItemDescriptionRect(
  ...
  begin
    ...
    try
      ...
      repeat
        Result := GetDescriptionRectInner(GetGalleryItemControl.Canvas.Canvas);
        if GetMinDescriptionWidth > AMaxWidth then
          ASuccess := True
        else
          if ARecalculateDescription then
          begin
    ...
    if not IsInplaceGallery or ShowDescriptionInRibbon then
...
function TdxRibbonGalleryGroupItemViewInfo.GetDescriptionRectInner(ACanvas: TCanvas): TRect;
begin
  Result := cxGetTextRect(ACanvas.Handle, Description, FDescriptionRowCount, False, DT_EXPANDTABS);
  Inc(Result.Right, Owner.Owner.GetGroupItemDescriptionContentOffset.Width);
  Inc(Result.Bottom, Owner.Owner.GetGroupItemDescriptionContentOffset.Height);
end;
...
begin
  ABounds := cxRectContent(Bounds, GetContentOffset);
  Result.Init(Max(0, ABounds.Width), Max(0, ABounds.Height));
end;
...
begin
  ...
  begin
    Result := (not IsInplaceGallery or ShowDescriptionInRibbon) and
...
function TdxRibbonGalleryGroupItemViewInfo.ShowDescriptionInRibbon: Boolean;
begin
  if GroupItem <> nil then
    Result := GroupItem.ShowDescriptionInRibbon
  else
    Result := False;
end;
...
var
  AIndent: Integer;
begin
  AIndent := GetSpaceBetweenItemImageAndText;
...
procedure TdxRibbonGalleryGroupItemViewInfo.ValidateDescriptionStrings(
  ACanvas: TcxCanvas);
var
  ADescriptionBounds: TRect;
begin
  if FChanged then
  begin
    ADescriptionBounds := FDescriptionBounds;
    ADescriptionBounds := cxRectContent(ADescriptionBounds, Owner.Owner.GetGroupItemDescriptionContentOffset);
    FDescriptionLines.Clear;
    cxGetTextLines(Description, ACanvas, ADescriptionBounds, FDescriptionLines);
  end;
end;
...
begin
  ...
  begin
    ...
    begin
      if Owner.GalleryItem.UseGroupItemSizeInRibbon then
      begin
        AItemSize := Group.Options.ItemSize.Size;
        if not CanUseSize(AItemSize) then
          AItemSize := Owner.GalleryItem.GalleryOptions.ItemSizeInRibbon.Value;
      end
      else
        AItemSize := Owner.GalleryItem.GalleryOptions.ItemSizeInRibbon.Value;
    end
    ...
    begin
      AItemSize := Group.Options.ItemSize.Size;
      if not CanUseSize(AItemSize) then
        AItemSize := Owner.GalleryItem.GalleryInMenuOptions.ItemSize.Value;
    end;
...
var
  ...
  AItemBounds: TRect;
  AScrollBarWidth: Integer;
begin
  FBounds := Rect(AControlClientRect.Left, AGroupTop, AControlClientRect.Right, AGroupBottom);
  ...
  if AColumnCount = 1 then
    AScrollBarWidth := Owner.GetScrollBarWidthEx(True, True, 0)
  else
    AScrollBarWidth := 0;
  ...
  begin
    ...
    if AreLinesIntersectedStrictly(ARowTop, ARowTop + ARowHeight, AControlClientRect.Top, AControlClientRect.Bottom) then
    begin
      AColumnIndex := 0;
      for AItemIndex := GetFirstItemInGroupRow(ARowIndex, AColumnCount) to GetLastItemInGroupRow(ARowIndex, AColumnCount) do
      begin
        AColumnLeft := GetColumnLeft(AColumnIndex, Bounds.Left);
        AItemBounds := Rect(AColumnLeft, ARowTop, AColumnLeft + FItemSize.cx, ARowTop + FItemSize.cy);
        AItemBounds.Width := AItemBounds.Width + AScrollBarWidth;
...
begin
  ...
  for I := 0 to Group.Items.Count - 1 do
  begin
    AItem := GetItemViewInfoClass.Create(Self, Group.Items[I]);
    try
...
begin
  AMaxItemWidth := ABounds.Width - (Owner.GetLeftLayoutIndent + Owner.GetRightLayoutIndent);
...
begin
  ...
  AGroupItemViewInfo := GetItemViewInfoClass.Create(Self, AGroupItem);
...
function TdxRibbonGalleryGroupViewInfo.GetIAccessibilityHelper: IcxAccessibilityHelper;
begin
  if FIAccessibilityHelper = nil then
    FIAccessibilityHelper := TdxRibbonGalleryGroupAccessibilityHelper.Create(Self);
  Result := FIAccessibilityHelper;
end;

function TdxRibbonGalleryGroupViewInfo.GetItem(Index: Integer): TdxRibbonGalleryGroupItemViewInfo;
begin
...
function TdxRibbonGalleryGroupViewInfo.GetItemViewInfoClass: TdxRibbonGalleryGroupItemViewInfoClass;
begin
  Result := TdxRibbonGalleryGroupItemViewInfo;
end;
...
procedure TdxRibbonGalleryControlViewInfo.InitializeGroupItemDescriptionRectCache;
  ...
  begin
    ...
    begin
      AGroup := GalleryItem.GalleryGroups[I];
      if AGroup.Options.ItemTextKind = itkCaptionAndDescription then
      begin
        Result := True;
        Break;
      end;
...
var
  ...
  AGroup: TdxRibbonGalleryGroup;
begin
  if (GalleryOptions.ItemTextKind <> itkCaptionAndDescription) and not IsGroupsWithDescription then
    Exit;
  ...
  begin
    ...
    AGroup := GalleryItem.GalleryGroups[I];
    AObjectList.Capacity := AGroup.Items.Count;
    for J := 0 to AGroup.Items.Count - 1 do
      AObjectList.Add(TcxRect.Create(Self));
  end;
end;

function TdxRibbonGalleryControlViewInfo.GetGroupItemDescriptionRect(AGroupIndex, AnItemIndex: Integer): TRect;
begin
  if FGroupItemDescriptionRectCache <> nil then
    Result := TcxRect(TObjectList(FGroupItemDescriptionRectCache[AGroupIndex]).Items[AnItemIndex]).Rect
  else
    Result := cxNullRect;
end;

procedure TdxRibbonGalleryControlViewInfo.SetGroupItemDescriptionRect(AGroupIndex, AnItemIndex: Integer; ARect: TRect);
begin
  if FGroupItemDescriptionRectCache = nil then
...
begin
  ...
  for I := 0 to AGroupIndex - 1 do
    if GalleryItem.IsGroupVisible(I) then
    begin
      AGroupViewInfo := GetGroupViewInfo(Control.GetGroups, Self, I, ADestroyAfterUse);
      try
        Result := Result + AGroupViewInfo.GetHeight(AWidth) + IfThen(AWidth > 0, GalleryOptions.GetSpaceBetweenGroups);
      finally
        if ADestroyAfterUse then
          AGroupViewInfo.Free;
      end;
...
begin
  ...
  begin
    ALastGroupIndex := GetVisibleNotEmptyGroupIndex(Control.GetGroups.Count - 1, False);
...
begin
  ...
  begin
    ...
    if not Control.FIsCustomPopupMenuShown then
      DoSetHotGroupItem(Value);
end;
...
function TdxRibbonGalleryControlViewInfo.GetGroup(Index: Integer): TdxRibbonGalleryGroupViewInfo;
begin
  Result := TdxRibbonGalleryGroupViewInfo(FGroups[Index]);
end;

function TdxRibbonGalleryControlViewInfo.GetGroupItemSize(AGroupIndex: Integer): TSize;
var
  ADestroyAfterUse: Boolean;
  AGroupViewInfo: TdxRibbonGalleryGroupViewInfo;
begin
  ...
  begin
    AGroupViewInfo := GetGroupViewInfo(Control.GetGroups, Self, AGroupIndex, ADestroyAfterUse);
    try
...
begin
  if (GalleryOptions.EqualItemSizeInAllGroups) or (Control.Parent.Kind in [bkBarControl]) then
...
begin
  ARect := GalleryBounds;
  Result.cx := ARect.Width;
  Result.cy := ARect.Height;
end;
...
begin
  Result := GetScrollBarWidth(0);
end;

function TdxRibbonGalleryControlViewInfo.GetScrollBarWidthEx(AWithIndents, AInverted: Boolean; AClientWidth: Integer): Integer;
var
  B: Boolean;
begin
  B := Control.IsNeedScrollBar(AClientWidth);
  if (AInverted and not B) or (not AInverted and B) then
    Result := InternalGetScrollBarWidth
  else
    Result := 0;
  if AWithIndents then
    Result := Result + GetLeftLayoutIndent + GetRightLayoutIndent;
end;

function TdxRibbonGalleryControlViewInfo.GetLayoutWidthEx(AInverted: Boolean; out AGroupItemWidthIsNull: Boolean; out AScrollBarWidth: Integer): Integer;

  function GetColumnCount: Integer;
  begin
    if Control.Parent.Kind = bkBarControl then
      Result := (Self as IdxBarMultiColumnItemControlViewInfo).GetColumnCount
    else
      Result := Control.Item.GalleryOptions.ColumnCount;
  end;

begin
  Result := GetLayoutWidth(GetColumnCount, AGroupItemWidthIsNull);
  AScrollBarWidth := GetScrollBarWidthEx(True, AInverted, Result);
end;

function TdxRibbonGalleryControlViewInfo.GetScrollBarWidth(AClientWidth: Integer): Integer;
begin
  if Control.IsNeedScrollBar(AClientWidth) then
    Result := InternalGetScrollBarWidth
  else
    Result := 0;
end;
...
begin
  ...
  begin
    ReturnRange(ANewItem, AOldItem, AStartGroupItem, AEndGroupItem, IsHotTrack);
    ReturnRangeStart(AStartGroupItem, IsHotTrack, AStartGroupIndex, AStartGroupItemIndex);
    ReturnRangeEnd(AEndGroupItem, IsHotTrack, AEndGroupIndex, AEndGroupItemIndex);
    DoRepaintChain(AStartGroupIndex, AStartGroupItemIndex, AEndGroupIndex, AEndGroupItemIndex, IsHotTrack);
  end;
end;
...
procedure TdxInRibbonGalleryControlViewInfo.Paint(ACanvas: TcxCanvas);
  ...
  begin
    ...
    ABitmap := TcxBitmap32.CreateSize(ARect);
    cxBitBlt(ABitmap.Canvas.Handle, ACanvas.Canvas.Handle, ARect, GalleryBounds.TopLeft, SRCCOPY);
    try
      DoDrawBackground(ABitmap.cxCanvas, ARect);
      ARect := cxRectSetHeight(ARect, FAnimationBitmapHeight);
      OffsetRect(ARect, 0, GetTopLayoutIndent);
      Animation.DrawTransparent(ABitmap.cxCanvas, ARect);
...
var
  ...
  AGalleryGroupItem: TdxRibbonGalleryGroupItem;
  AGroupViewInfo: TdxRibbonGalleryGroupViewInfo;
...
begin
  ...
  begin
    AGalleryGroupItem := TdxRibbonGalleryGroupItem(AGroupItemsList.Items[I]);
    AItemGroupIndex := TdxRibbonGalleryGroup(AGalleryGroupItem.Collection.ParentComponent).Index;
    if ACurrentGroupIndex <> AItemGroupIndex then
    begin
      ACurrentGroupIndex := AItemGroupIndex;
      AGroupViewInfo := AGalleryGroupItem.GalleryItem.GalleryGroups.GetGroupViewInfoClass.Create(Self, Control.GetGroups[AItemGroupIndex]);
    ...
    AGroupItemBounds.Left := AGroupViewInfo.GetColumnLeft(AColumnIndex, ABounds.Left);
    AGroupItemBounds.Right := AGroupItemBounds.Left + AGroupViewInfo.ItemSize.cx;
    if Control.UseRightToLeftAlignment then
      AGroupItemBounds := TdxRightToLeftLayoutConverter.ConvertRect(AGroupItemBounds, ABounds);
    AGroupViewInfo.CreateGroupItem(AGalleryGroupItem.Index, AGroupItemBounds);
    Inc(AColumnIndex);
...
procedure TdxInRibbonGalleryControlViewInfo.DoScrolling(ARowDelta: Integer);
  ...
  begin
    ...
    ABitmap.SetSize(GalleryBounds.Width, FAnimationBitmapHeight);
...
begin
  ...
  try
    ...
    DoDrawBackground(ACanvas, R);
  finally
    ACanvas.RestoreClipRegion;
  end;
end;

function TdxInRibbonGalleryControlViewInfo.GetControlMargins: TdxPadding;
begin
  Result.Init(0, 3, 0, 3);
end;

function TdxInRibbonGalleryControlViewInfo.GetGalleryMargins: TdxPadding;
begin
  Result.Empty;
  if Control.IsNeedScrollBar then
    Dec(Result.Right, Control.ScaleFactor.Apply(1));
end;

function TdxInRibbonGalleryControlViewInfo.GetLayoutWidth(
  AColumnCount: Integer; out AGroupItemWidthIsNull: Boolean): Integer;
begin
  Result := AColumnCount * GetMaxGroupItemSize.cx + (AColumnCount - 1) * GetSpaceBetweenItems(True) + GetControlMargins.Width - 1;
...
begin
  ...
  begin
    ...
    begin
      AIndent := GetGalleryMargins.Height + GetTopLayoutIndent + GetBottomLayoutIndent;
      ARowCount := Max(1, (AHeight - AIndent) div ADenominator);
      if not (GalleryOptions.RemoveHorizontalItemPadding or GalleryOptions.RemoveVerticalItemPadding) then
        Result.cy := (AHeight - GetSpaceBetweenItems(False) * (ARowCount - 1) - AIndent) div ARowCount;
...
procedure TdxInRibbonGalleryControlViewInfo.RemoveGroupItem(AItem: TdxRibbonGalleryGroupItem);
begin
  inherited RemoveGroupItem(AItem);
  if FShowGroupItem = AItem then
    FShowGroupItem := nil;
end;
...
function TdxInRibbonGalleryControlViewInfo.GetContentOffset: TdxPadding;
begin
  Result := Painter.LookAndFeelPainter.GetRibbonGalleryContentOffsets(Control.ScaleFactor);
  Result := Result + TdxPadding.Create(GalleryOptions.SpaceBetweenItemsAndBorder + 1);
end;
...
begin
  ...
  begin
    ...
    Dec(FControlHeight, GetControlMargins.Height);
  end;
...
function TdxInRibbonGalleryControlViewInfo.GetGroupItemCaptionContentOffset: TdxPadding;
begin
  Result := Painter.LookAndFeelPainter.GetRibbonGalleryItemCaptionContentOffsets(Control.ScaleFactor);
end;

function TdxInRibbonGalleryControlViewInfo.GetGroupItemContentOffset: TdxPadding;
begin
  Result := Painter.LookAndFeelPainter.GetRibbonGalleryItemContentOffsets(Control.ScaleFactor);
  GalleryOptions.CheckRemoveItemPadding(Result);
end;

function TdxInRibbonGalleryControlViewInfo.GetGroupItemDescriptionContentOffset: TdxPadding;
begin
  Result.Empty;
end;

function TdxInRibbonGalleryControlViewInfo.GetGroupItemFixedSpaceBetweenCaptionAndDescription: Integer;
begin
  Result := Painter.LookAndFeelPainter.GetRibbonGalleryItemFixedIndentBetweenCaptionAndDescription(Control.ScaleFactor);
  if GalleryOptions.RemoveVerticalItemPadding then
    Result := 0;
end;

function TdxInRibbonGalleryControlViewInfo.GetGroupItemFixedSpaceBetweenImageAndText: Integer;
begin
  Result := Painter.LookAndFeelPainter.GetRibbonGalleryItemFixedIndentBetweenImageAndText(Control.ScaleFactor);
end;

function TdxInRibbonGalleryControlViewInfo.GetGroupItemImageContentOffset: TdxPadding;
begin
  Result := Painter.LookAndFeelPainter.GetRibbonGalleryItemImageContentOffsets(Control.ScaleFactor);
  GalleryOptions.CheckRemoveItemPadding(Result);
end;
...
begin
  if (GalleryOptions.RemoveHorizontalItemPadding and AIsFlat) or (GalleryOptions.RemoveVerticalItemPadding and not AIsFlat) then
    Result := 0
  else
    if AIsFlat then
      Result := GalleryOptions.SpaceBetweenItemsHorizontally
    else
      Result := GalleryOptions.SpaceBetweenItemsVertically;
end;

function TdxInRibbonGalleryControlViewInfo.IsScrollingPossible(
  ARowDelta: Integer): Boolean;
begin
  Result := (ARowDelta < 0) and GetPreviousButtonEnabled or (ARowDelta > 0) and GetNextButtonEnabled;
end;
...
begin
  ...
  AColumnCount := GetGroupColumnCount;
  if AColumnCount <> 0 then
    Result := Ceil(GetGroupItemCount(GetVisibleNotEmptyGroupIndex(Control.GetGroups.Count - 1, False)) / AColumnCount);
end;

function TdxInRibbonGalleryControlViewInfo.GetWidthForColumnCount(AColumnCount: Integer): Integer;
var
  AIndex : Integer;
begin
  AIndex := AColumnCount - GetMinColumnCount;
  if FWidthForColumnCountInfos[AIndex].Calculated then
    Result := FWidthForColumnCountInfos[AIndex].Width
  else
  begin
    Result := Control.GetDefaultWidthInSubmenu;
    FWidthForColumnCountInfos[AIndex].Width := Result;
    FWidthForColumnCountInfos[AIndex].Calculated := True;
  end;
end;
...
procedure TdxRibbonOnMenuGalleryControlViewInfo.Calculate(ALayoutOffset: Integer; AScrollCode: TScrollCode);
var
...
begin
  ...
  begin
    ...
    begin
      ...
      if -FLayoutOffset + GetGalleryHeight(AGallerySize.cx) < AGalleryVisibleHeight then
  ...
  begin
    if GalleryItem.IsGroupVisible(I) then
    begin
      AGroupViewInfo := GalleryItem.GalleryGroups.GetGroupViewInfoClass.Create(Self, Control.GetGroups[I]);
      AGroupViewInfo.CorrectItemWidth(AGalleryBounds);
      AGroupBottom := ACurrentGroupTop + AGroupViewInfo.GetHeight(AGallerySize.cx) + GalleryOptions.GetSpaceBetweenGroups;
...
begin
  if Control.UseRightToLeftAlignment then
    APosition := Point(FFilterBandContentRect.Right, FFilterBandRect.Bottom)
  else
    APosition := Point(FFilterBandContentRect.Left, FFilterBandRect.Bottom);
  APosition := Control.Parent.ClientToScreen(APosition);
  AOwnerHeight := FFilterBandRect.Height;
end;
...
begin
  ...
  begin
    ...
    Dec(AGroupItemTop, GalleryBounds.Top);
    Dec(AGroupItemBottom, GalleryBounds.Top);
...
function TdxRibbonOnMenuGalleryControlViewInfo.GetContentOffset: TdxPadding;
begin
  Result := Painter.LookAndFeelPainter.GetDropdownGalleryContentOffsets(Control.ScaleFactor);
  Result := Result + TdxPadding.Create(GalleryOptions.SpaceBetweenItemsAndBorder + Painter.DropDownGalleryGetNCBorderSize - 1);
end;
...
begin
  Result := GetAbsoluteGroupTop(Control.GetGroups.Count, AWidth) - GalleryOptions.GetSpaceBetweenGroups;
  Result := Max(0, Result);
end;

function TdxRibbonOnMenuGalleryControlViewInfo.GetGalleryMargins: TdxPadding;
begin
  Result.Empty;
  Inc(Result.Top, GetFilterBandHeight);
  if NeedsDrawSeparator(ilpAfterGallery) then
...
function TdxRibbonOnMenuGalleryControlViewInfo.GetGroupItemCaptionContentOffset: TdxPadding;
begin
  Result := Painter.LookAndFeelPainter.GetDropdownGalleryItemCaptionContentOffsets(Control.ScaleFactor);
end;

function TdxRibbonOnMenuGalleryControlViewInfo.GetGroupItemContentOffset: TdxPadding;
begin
  Result := Painter.LookAndFeelPainter.GetDropdownGalleryItemContentOffsets(Control.ScaleFactor);
  GalleryOptions.CheckRemoveItemPadding(Result);
end;

function TdxRibbonOnMenuGalleryControlViewInfo.GetGroupItemDescriptionContentOffset: TdxPadding;
begin
  Result := Painter.LookAndFeelPainter.GetDropDownGalleryItemDescriptionContentOffsets(Control.ScaleFactor);
end;

function TdxRibbonOnMenuGalleryControlViewInfo.GetGroupItemFixedSpaceBetweenCaptionAndDescription: Integer;
begin
  Result := Painter.LookAndFeelPainter.GetDropDownGalleryItemFixedIndentBetweenCaptionAndDescription(Control.ScaleFactor);
  if GalleryOptions.RemoveVerticalItemPadding then
    Result := 0;
end;

function TdxRibbonOnMenuGalleryControlViewInfo.GetGroupItemFixedSpaceBetweenImageAndText: Integer;
begin
  Result := Painter.LookAndFeelPainter.GetDropDownGalleryItemFixedIndentBetweenImageAndText(Control.ScaleFactor);
end;

function TdxRibbonOnMenuGalleryControlViewInfo.GetGroupItemImageContentOffset: TdxPadding;
begin
  Result := Painter.LookAndFeelPainter.GetDropDownGalleryItemImageContentOffsets(Control.ScaleFactor);
  GalleryOptions.CheckRemoveItemPadding(Result);
end;
...
begin
  ...
  Result := Max(Result + GetGalleryMargins.Height, Control.CalcMinHeight);
end;
...
function TdxRibbonOnMenuGalleryControlViewInfo.GetLeftLayoutIndent: Integer;
begin
  Result := 0;
end;
...
begin
  AGallerySize := GallerySize;
  ATop := -FLayoutOffset + GalleryBounds.Top + GetAbsoluteGroupTop(AGroupItem.Group.Index, AGallerySize.cx) + GetFilterBandHeight;
  AGroupViewInfo := GetGroupViewInfo(Control.GetGroups, Self, AGroupItem.Group.Index, ADestroyAfterUse);
  try
    {if ADestroyAfterUse then
      AGroupViewInfo.SetBounds(GalleryBounds);}
    ATop := AGroupViewInfo.GetRowTop(AGroupViewInfo.GetItemRow(AGroupItem.Index, AGallerySize.cx), ATop, AGallerySize.cx);
...
begin
  Result.cx := Control.CalcDefaultWidth;
  if GroupCount <> 0 then
    Result.cy := Control.CalcMinHeight
  else
    Result.cy := 0;
  if GalleryItem.IsFilterVisible then
    Result.cy := Result.cy + FilterBandRect.Height;
end;

function TdxRibbonOnMenuGalleryControlViewInfo.GetRightLayoutIndent: Integer;
begin
  Result := 0;
end;
...
begin
  ...
  begin
    ...
    FFilterBandContentRect := cxRectContent(FFilterBandRect, GetFilterContentOffset);
    if Control.UseRightToLeftAlignment then
...
procedure TdxRibbonOnMenuGalleryControlViewInfo.DrawFilterBand;
  function CalculateFilterBandState: Integer;
  begin
    if not FFilterBandHotTrack then
      Result := DXBAR_NORMAL
    else
      Result := DXBAR_HOT;
  end;
...
begin
  if GalleryItem.IsFilterVisible then
  begin
    FillRectByColor(Control.Canvas.Handle, FFilterBandRect, Painter.DropDownGalleryGetFilterBandSeparatorColor);
    Painter.DropDownGalleryDrawFilterBand(Control.Canvas.Handle, FFilterBandRect, CalculateFilterBandState);
    DrawFilterCaption;
  end;
end;
...
begin
  ...
  Dec(ACaptionRect.Right, AArrowSize * 2 + Control.ScaleFactor.Apply(1) * 2 + AArrowOffset);
  ...
  AArrowRect := cxRectBounds(ACaptionRect.Right + AArrowOffset, FFilterBandContentRect.Top +
    (FFilterBandContentRect.Height - AArrowSize) div 2, AArrowSize * 2, AArrowSize);
  if Control.UseRightToLeftAlignment then
  begin
  ...
  cxDrawText(ACanvas.Handle, ACaption, ACaptionRect, GetDrawTextFlags);
...
begin
  Result := 0;
  if GalleryItem.IsFilterVisible then
    Result := TdxTextMeasurer.TextLineHeight(Control.Parent.Font) + GetFilterContentOffset.Height;
end;

function TdxRibbonOnMenuGalleryControlViewInfo.GetFilterContentOffset: TdxPadding;
begin
  Result := Painter.LookAndFeelPainter.GetDropdownGalleryFilterContentOffsets(Control.ScaleFactor);
end;
...
begin
  ...
  begin
    if Result <> 0 then
      Inc(Result, AGalleryOptions.GetSpaceBetweenGroups);
...
function TdxRibbonOnMenuGalleryControlViewInfo.GetScrollBarBounds: TRect;
var
  AGalleryBounds: TRect;
begin
  Result := inherited GetScrollBarBounds;
  AGalleryBounds := GalleryBounds;
...
begin
  if (Control.GetGroups[AGroupIndex].Options.RemoveHorizontalItemPadding and AIsFlat) or
    (Control.GetGroups[AGroupIndex].Options.RemoveVerticalItemPadding and not AIsFlat) then
    Result := 0
  else
    if AIsFlat then
      Result := Control.GetGroups[AGroupIndex].Options.SpaceBetweenItemsHorizontally
    else
      Result := Control.GetGroups[AGroupIndex].Options.SpaceBetweenItemsVertically;
end;
...
function TdxRibbonGalleryFilterAccessibilityHelper.GetScreenBounds(AChildID: TcxAccessibleSimpleChildElementID): TRect;
var
  APoint: TPoint;
begin
  Result := OnSubmenuController.ViewInfo.FilterBandRect;
  APoint := Result.TopLeft;
  ClientToScreen(OwnerObjectWindow, APoint);
  Result := cxRectSetOrigin(Result, APoint);
end;

procedure TdxRibbonGalleryFilterAccessibilityHelper.DoDefaultAction(AChildID: TcxAccessibleSimpleChildElementID);
begin
  if OnSubmenuController.IsFilterMenuShowed then
    OnSubmenuController.HideFilterMenu
  else
    OnSubmenuController.ShowFilterMenu;
end;

function TdxRibbonGalleryFilterAccessibilityHelper.GetName(AChildID: TcxAccessibleSimpleChildElementID): string;
begin
   Result := Control.Item.GalleryFilter.Caption;
end;

function TdxRibbonGalleryFilterAccessibilityHelper.GetOwnerObjectWindow: HWND;
begin
  Result := Control.IAccessibilityHelper.GetHelper.OwnerObjectWindow;
end;

function TdxRibbonGalleryFilterAccessibilityHelper.GetParent: TcxAccessibilityHelper;
begin
  Result := Control.IAccessibilityHelper.GetBarHelper;
end;

function TdxRibbonGalleryFilterAccessibilityHelper.GetRole(AChildID: TcxAccessibleSimpleChildElementID): Integer;
begin
  Result := cxROLE_SYSTEM_MENUITEM;
end;

function TdxRibbonGalleryFilterAccessibilityHelper.GetState(AChildID: TcxAccessibleSimpleChildElementID): Integer;
begin
  Result := Parent.States[cxAccessibleObjectSelfID];
  if (Result and cxSTATE_SYSTEM_INVISIBLE = 0) and not Control.Item.IsFilterVisible then
...
function TdxRibbonGalleryFilterAccessibilityHelper.GetSupportedProperties(
  AChildID: TcxAccessibleSimpleChildElementID): TcxAccessibleObjectProperties;
begin
  Result := [aopLocation, aopDefaultAction];
end;

function TdxRibbonGalleryFilterAccessibilityHelper.GetControl: TdxRibbonGalleryControl;
begin
  Result := TdxRibbonGalleryControl(FOwnerObject);
end;

function TdxRibbonGalleryFilterAccessibilityHelper.GetOnSubmenuController: TdxRibbonOnSubmenuGalleryController;
begin
...
constructor TdxRibbonGalleryGroupAccessibilityHelper.Create(AOwnerObject: TObject);
begin
  inherited;
  if RibbonGalleryControl.Parent.Kind <> bkBarControl then
  begin
    FLocalId := TCustomdxBarControlAccess(RibbonGalleryControl.Parent).FAccessibleObjects.Count + 1;
    TCustomdxBarControlAccess(RibbonGalleryControl.Parent).FAccessibleObjects.Add(Self);
  end;
end;

function TdxRibbonGalleryGroupAccessibilityHelper.GetScreenBounds(AChildID: TcxAccessibleSimpleChildElementID): TRect;
var
  APoint: TPoint;
begin
  if AChildID = 0 then
    Result := GroupViewInfo.Bounds
  else
    Result := GroupViewInfo.Items[AChildID - 1].Bounds;
...
procedure TdxRibbonGalleryGroupAccessibilityHelper.OwnerObjectDestroyed;
begin
  if FLocalID > 0 then
    TCustomdxBarControlAccess(RibbonGalleryControl.Parent).FAccessibleObjects[FLocalId - 1] := nil;
  inherited;
end;

procedure TdxRibbonGalleryGroupAccessibilityHelper.DoSelect(AFlags: Integer; AChildID: TcxAccessibleSimpleChildElementID);
begin
  if AChildID > 0 then
    RibbonGalleryControl.AccessibleSelectItem(GroupViewInfo.Items[AChildID - 1].GroupItem);
end;

function TdxRibbonGalleryGroupAccessibilityHelper.GetChildCount: Integer;
begin
  Result := GroupViewInfo.ItemCount;
end;

function TdxRibbonGalleryGroupAccessibilityHelper.GetGroup: TdxCustomGalleryGroup;
begin
  Result := GroupViewInfo.Group;
end;

function TdxRibbonGalleryGroupAccessibilityHelper.GetOwnerObjectWindow: HWND;
begin
  Result := RibbonGalleryControl.IAccessibilityHelper.GetHelper.OwnerObjectWindow;
end;

function TdxRibbonGalleryGroupAccessibilityHelper.GetParent: TcxAccessibilityHelper;
begin
  Result := RibbonGalleryControl.IAccessibilityHelper.GetHelper;
end;

function TdxRibbonGalleryGroupAccessibilityHelper.GetState(AChildID: TcxAccessibleSimpleChildElementID): Integer;
begin
  Result := inherited or Parent.States[cxAccessibleObjectSelfID];
  if (Result and cxSTATE_SYSTEM_INVISIBLE = 0) and ((GroupViewInfo = nil) or RibbonGalleryControl.Collapsed) then
    Result := cxSTATE_SYSTEM_INVISIBLE;
  if (RibbonGalleryControl.Controller.KeyboardHotGroupItem <> nil) and
    (AChildID = RibbonGalleryControl.Controller.KeyboardHotGroupItem.Index + 1) then
      Result := Result or cxSTATE_SYSTEM_FOCUSED;
end;

function TdxRibbonGalleryGroupAccessibilityHelper.GetRibbonGalleryControl: TdxRibbonGalleryControl;
begin
  Result := GroupViewInfo.Owner.Control;
end;

function TdxRibbonGalleryGroupAccessibilityHelper.GetGroupViewInfo: TdxRibbonGalleryGroupViewInfo;
begin
  Result := TdxRibbonGalleryGroupViewInfo(OwnerObject);
end;

{ TdxRibbonGalleryControlAccessibilityHelper }

function TdxRibbonGalleryControlAccessibilityHelper.HandleNavigationKey(var AKey: Word): Boolean;
begin
  Result := False;
  if not Control.Collapsed then
  begin
    ...
    begin
      ...
      case AKey of
        VK_DOWN:
          Result := OnSubmenuController.Navigation(andDown);
        VK_LEFT:
          Result := OnSubmenuController.Navigation(andLeft);
        VK_RIGHT:
          Result := OnSubmenuController.Navigation(andRight);
        VK_UP:
          Result := OnSubmenuController.Navigation(andUp);
        VK_TAB:
          Result := OnSubmenuController.Tabulation;
        VK_PRIOR:
          Result := OnSubmenuController.PageUp;
        VK_NEXT:
          Result := OnSubmenuController.PageDown;
        VK_HOME:
          Result := OnSubmenuController.HotTrackFirstGroupItem;
        VK_END:
          Result := OnSubmenuController.HotTrackLastGroupItem;
      else
        Result := False;
      end;
      if Result then
        NotifyWinEvent(EVENT_OBJECT_FOCUS, OwnerObjectWindow,
          GetGroupByIndex(OnSubmenuController.KeyboardHotGroupItem.Group.Index).LocalId,
          OnSubmenuController.KeyboardHotGroupItem.Index + 1);
    end;
  end;
...
function TdxRibbonGalleryControlAccessibilityHelper.IsNavigationKey(AKey: Word): Boolean;
begin
...
function TdxRibbonGalleryControlAccessibilityHelper.LogicalNavigationGetChildCount: Integer;
begin
  Result := 0;
end;

function TdxRibbonGalleryControlAccessibilityHelper.ChildIsSimpleElement(AIndex: Integer): Boolean;
begin
  Result := False;
end;

function TdxRibbonGalleryControlAccessibilityHelper.GetChildCount: Integer;
begin
  Result := Control.ViewInfo.GroupCount + 1;
end;

function TdxRibbonGalleryControlAccessibilityHelper.GetChild(AIndex: Integer): TcxAccessibilityHelper;
begin
  if AIndex < Control.ViewInfo.GroupCount then
    Result := Control.ViewInfo.Groups[AIndex].IAccessibilityHelper.GetHelper
  else
    Result := Control.FilterBandIAccessibilityHelper.GetHelper;
end;

function TdxRibbonGalleryControlAccessibilityHelper.GetChildIndex(AChild: TcxAccessibilityHelper): Integer;
var
  I: Integer;
begin
  Result := -1;
  if AChild = Control.FilterBandIAccessibilityHelper.GetHelper then
    Result := ChildCount
  else
    for I := 0 to ChildCount - 1 do
      if Control.ViewInfo.Groups[I].IAccessibilityHelper.GetHelper = AChild then
      begin
        Result := I;
        Break;
      end;
...
function TdxRibbonGalleryControlAccessibilityHelper.GetState(AChildID: TcxAccessibleSimpleChildElementID): Integer;
begin
  if Control.Parent.Kind = bkBarControl then
    Result := inherited
  else
...
procedure TdxRibbonGalleryControlAccessibilityHelper.GetKeyTipData(AKeyTipsData: TList);
begin
  if not (not Control.Collapsed and (Control.Parent.Kind = bkSubMenu)) then
    inherited GetKeyTipData(AKeyTipsData);
end;

procedure TdxRibbonGalleryControlAccessibilityHelper.GetKeyTipInfo(out AKeyTipInfo: TdxBarKeyTipInfo);
var
  R: TRect;
begin
...
begin
  OnSubmenuController.UpdateHotTrack(ANavigationDirection);
  if OnSubmenuController.KeyboardHotGroupItem <> nil then
    NotifyWinEvent(EVENT_OBJECT_FOCUS, OwnerObjectWindow, GetGroupByIndex(
      OnSubmenuController.KeyboardHotGroupItem.Group.Index).LocalId, OnSubmenuController.KeyboardHotGroupItem.Index + 1);
end;

function TdxRibbonGalleryControlAccessibilityHelper.GetGroupByIndex(AIndex: Integer): TdxRibbonGalleryGroupAccessibilityHelper;
var
  I: Integer;
  AChild: TdxRibbonGalleryGroupAccessibilityHelper;
begin
  Result := nil;
  for I := 0 to GetChildCount do
  begin
    AChild := TdxRibbonGalleryGroupAccessibilityHelper(GetChild(I));
    if AChild.GroupViewInfo.Group.Index = AIndex then
    begin
      Result := AChild;
      Break;
    end;
...
function TdxRibbonDropDownGalleryControlAccessibilityHelper.IsNavigationKey(AKey: Word): Boolean;
begin
  Result := inherited IsNavigationKey(AKey);
  if BarControl.SelectedControl = nil then
...
function TdxRibbonDropDownGalleryControlAccessibilityHelper.GetChildCount: Integer;
begin
  Result := 1 + inherited GetChildCount;
end;

function TdxRibbonDropDownGalleryControlAccessibilityHelper.GetChild(AIndex: Integer): TcxAccessibilityHelper;
begin
  if AIndex = 0 then
    Result := InternalGalleryItemControlAccessibilityHelper
  else
    Result := inherited GetChild(AIndex - 1);
end;

function TdxRibbonDropDownGalleryControlAccessibilityHelper.GetState(AChildID: TcxAccessibleSimpleChildElementID): Integer;
begin
  Result := cxSTATE_SYSTEM_NORMAL;
end;

function TdxRibbonDropDownGalleryControlAccessibilityHelper.GetOwnerObjectWindow: HWND;
begin
  Result := BarControl.Handle;
end;

procedure TdxRibbonDropDownGalleryControlAccessibilityHelper.HandleVertNavigationKey(AUpKey, AFocusItemControl: Boolean);

  function Loop: Boolean;
  begin
    Result := (BarControl.InternalGalleryItemControl.Controller as TdxRibbonOnSubmenuGalleryController).LoopVerticalNavigation;
  end;

  function CanSelectGallery: Boolean;
  begin
    Result := False;
    if NavigationItems.GalleryIndex > 0 then
    begin
      Result := not AUpKey and (BarControl.SelectedLink = NavigationItems[NavigationItems.GalleryIndex - 1]);
      if Result then
        Exit;
      Result := AUpKey and (BarControl.SelectedLink = NavigationItems.First) and (NavigationItems.GalleryIndex = NavigationItems.Count - 1) and Loop;
      if Result then
        Exit;
    end;
    if NavigationItems.GalleryIndex < NavigationItems.Count - 1 then
    begin
      Result := AUpKey and (BarControl.SelectedLink = NavigationItems[NavigationItems.GalleryIndex + 1]);
      if Result then
        Exit;
      Result := not AUpKey and (BarControl.SelectedLink = NavigationItems.Last) and (NavigationItems.GalleryIndex = 0) and Loop;
      if Result then
        Exit;
    end;
  end;

  procedure SelectGallery;
  begin
...
begin
  FNavigationItems := TdxRibbonGalleryDropDownNavigationList.Create(BarControl);
  try
    if CanSelectGallery then
      SelectGallery
    else
      inherited HandleVertNavigationKey(AUpKey, AFocusItemControl);
  finally
    FreeAndNil(FNavigationItems);
  end;
end;

function TdxRibbonDropDownGalleryControlAccessibilityHelper.GetNextItemLink(AItemLink: TdxBarItemLink; AGoForward: Boolean): TdxBarItemLink;
  ...
  function GetNextItemLinkFromGallery: TdxBarItemLink;
  begin
    Result := BarControl.SelectedLink;
    if AGoForward then
    begin
      if NavigationItems.GalleryIndex = NavigationItems.Count - 1 then
      begin
        if Loop then
          Result := NavigationItems.First;
      end
      else
        Result := NavigationItems[NavigationItems.GalleryIndex + 1];
    end
    else
    begin
      if NavigationItems.GalleryIndex = 0 then
  ...
  function GetNextItemLinkFromNonGallery: TdxBarItemLink;
    ...
    begin
      ...
      begin
        if Loop then
          Result := NavigationItems.Count - 1
        else
          Result := -1;
      end
      else
        if Result >= NavigationItems.Count then
        begin
          if Loop then
            Result := 0
          else
  ...
  begin
    Result := BarControl.SelectedLink;
    AIndex := NavigationItems.IndexOf(AItemLink);
    ...
    AIndex := ValidateIndex(AIndex);
    if AIndex >= 0 then
    begin


      Result := NavigationItems[AIndex];
    end;
  end;

begin
  if (BarControl.SelectedLink = BarControl.InternalGalleryItemControl.ItemLink) then
    Result := GetNextItemLinkFromGallery
  else
    Result := GetNextItemLinkFromNonGallery;
end;
...
procedure TdxRibbonGalleryScrollBarPainter.Paint(ACanvas: TcxCustomCanvas);
...
begin
  inherited Paint(ACanvas);
  AGdiCanvas := ACanvas as TcxCanvas;
  if ScrollBar.IsDropDownStyle then
  begin
    ScrollBar.GetRibbonSkin.DrawBackground(AGdiCanvas.Handle, ViewInfo.DropDownButtonRect,
  ...
  begin
    ...
    if BarDesignController.NeedDefaultSelection(GetGalleryControl.ItemLink) then
      dxBarFrameRect(AGdiCanvas.Handle, R, COLOR_WINDOWTEXT)
    else
      dxBarFocusRect(AGdiCanvas.Handle, R);
  end;
end;

procedure TdxRibbonGalleryScrollBarPainter.DoDrawScrollBarPart(ACanvas: TcxCustomCanvas;
  ...
  begin
    ...
    begin
      if not ScrollBar.IsButtonEnabled(GetButtonKind) then
        AState := cxbsDisabled;
      ScrollBar.GetRibbonSkin.DrawBackground((ACanvas as TcxCanvas).Handle, R, GetButtonSkinPart, ScrollBar.GetButtonSkinState(AState));
    end;
  end
  else
    ScrollBar.GetBarPainter.DropDownGalleryDrawScrollBarPartEx(GetGalleryControl, (ACanvas as TcxCanvas).Handle, R, APart, AState, ScaleFactor);
end;

procedure TdxRibbonGalleryScrollBarPainter.DrawScrollBarBackground(ACanvas: TcxCustomCanvas; const R: TRect);
begin
  if ScrollBar.IsDropDownStyle then
  begin
    if ScrollBar.GetRibbonSkin.GetIsAlphaUsed(DXBAR_INRIBBONGALLERYSCROLLBAR_BACKGROUND) then
      cxDrawTransparentControlBackground(ScrollBar.FRibbonScrollBar, ACanvas as TcxCanvas, R, False);
    ScrollBar.GetRibbonSkin.DrawBackground((ACanvas as TcxCanvas).Handle, R, DXBAR_INRIBBONGALLERYSCROLLBAR_BACKGROUND);
  end
  else
    ScrollBar.GetBarPainter.DropDownGalleryDrawScrollBarBackgroundEx(GetGalleryControl, (ACanvas as TcxCanvas).Handle, R, ScaleFactor);
end;
...
begin
  ...
  inherited;
  if (Button = mbLeft) and IsDropDownButtonUnderMouse and GalleryControl.CanDropDown then 
  begin
...
function TdxRibbonGalleryScrollBar.GetIAccessibilityHelper: IcxAccessibilityHelper;
begin
  Result := GalleryControl.IAccessibilityHelper;
end;
...
procedure TdxRibbonGalleryScrollBar.WMGetObject(var Message: TMessage);
var
  AObjectID: Cardinal;
begin
...
begin
  ...
  begin
    AButtonHeight := Painter.DropDownGalleryGetSizingBandHeight(
      AGalleryControl.BarManager.ImageOptions.GlyphSize, TdxTextMeasurer.TextLineHeight(AGalleryControl.Font),
...
begin
  ...
  begin
    ...
    begin
      AItemLink := ItemLinks.VisibleItems[I] as TdxRibbonGalleryItemBarItemLink;
      if AItemLink.PositionInDropDown = ilpBeforeGallery then
      begin
        if ATopItemIndex >= 0 then
          APos := ItemLinks.VisibleItems[ATopItemIndex].ItemRect.Bottom
        else
    ...
    ABottomItemIndex := -1;
    for I := ItemLinks.VisibleItemCount - 1 downto 0 do
    begin
      AItemLink := ItemLinks.VisibleItems[I] as TdxRibbonGalleryItemBarItemLink;
      if AItemLink.PositionInDropDown = ilpAfterGallery then
      begin
        if ABottomItemIndex >= 0 then
          APos := ItemLinks.VisibleItems[ABottomItemIndex].ItemRect.Top -
            GetItemControlOffset(ItemLinks.VisibleItems[ABottomItemIndex])
        else
    ...
    if ATopItemIndex >= 0 then
      AGalleryTop := ItemLinks.VisibleItems[ATopItemIndex].ItemRect.Bottom
    else
      AGalleryTop := VisibleItemsRect.Top;
  end
  else
  begin
    AGalleryHeight := VisibleItemsRect.Height;
    AGalleryTop := 0;
  end;
...
begin
  Result := InternalGalleryItemControl.ViewInfo.GetContentOffset;
...
begin
  ...
  if Result.cx <= InternalGalleryItemControl.Width then
    AHeight := InternalGalleryItemControl.Height
  else
  begin
    AHeight := InternalGalleryItemControl.ViewInfo.GetHeight(Result.cx);
    if InternalGalleryItemControl.Item.IsDesigning then
      AHeight := Max(AHeight, InternalGalleryItemControl.Height);
  end;
  Inc(Result.cy, AHeight);
  AWidth := InternalGalleryItemControl.Width;
  if Result.cx < AWidth then
    Result.cx := AWidth;
  ASize := FGalleryItem.GetMinDropDownGalleryControlSize;
  if ASize.cx <> cxInvalidSize.cx then
    Result.cx := Max(Result.cx, ASize.cx);
  if ASize.cy <> cxInvalidSize.cy then
    Result.cy := Max(Result.cy, ASize.cy);
  ASize := FGalleryItem.GetMaxDropDownGalleryControlSize;
  if ASize.cx <> cxInvalidSize.cx then
    Result.cx := Min(Result.cx, ASize.cx);
  if ASize.cy <> cxInvalidSize.cy then
    Result.cy := Min(Result.cy, ASize.cy);
  if GalleryItem.GalleryOptions.ColumnCount = 1 then
  begin
    InternalGalleryItemControl.ViewInfo.GetLayoutWidthEx(True, AGroupItemWidthIsNull, AScrollbarAndIndents);
    Result.cx := Result.cx + AScrollbarAndIndents;
  end;
end;

function TdxRibbonDropDownGalleryControl.GetItemsRectOffset: TRect;
begin
  Result.Init(Painter.DropDownGalleryGetClientBorderSize);
...
begin
  ...
  for I := 0 to ItemLinks.VisibleItemCount - 1 do
    Inc(Result.cy, ItemLinks[I].ItemRect.Height);
...
function TdxRibbonDropDownGalleryControl.HasBackground: Boolean;
begin
  Result := False;
end;

function TdxRibbonDropDownGalleryControl.IsControlExists(ABarItemControl: TdxBarItemControl): Boolean;
begin
  Result := (ABarItemControl = InternalGalleryItemControl) or inherited IsControlExists(ABarItemControl);
end;
...
begin
  Result := (SelectedControl = InternalGalleryItemControl) and InternalGalleryItemControl.IsNeedScrollBar;
end;
...
procedure TdxRibbonDropDownGalleryControl.DoResizing;
  ...
  begin
    ...
    SetWindowPos(Handle, 0, ANewRect.Left, ANewRect.Top, ANewRect.Width, ANewRect.Height, AFlags);
  end;
