...
{$IF DEFINED(VER210)}
  {$HPPEMIT '#pragma link "dxSkinTheBezierRS14.bpi"'}
{$ELSEIF DEFINED(VER220)}
  {$HPPEMIT '#pragma link "dxSkinTheBezierRS15.bpi"'}
{$ELSEIF DEFINED(VER230)}
  {$HPPEMIT '#pragma link "dxSkinTheBezierRS16.bpi"'}
{$ELSEIF DEFINED(VER240)}
  {$HPPEMIT '#pragma link "dxSkinTheBezierRS17.bpi"'}
{$ELSEIF DEFINED(VER250)}
  {$HPPEMIT '#pragma link "dxSkinTheBezierRS18.bpi"'}
{$ELSEIF DEFINED(VER260)}
  {$HPPEMIT '#pragma link "dxSkinTheBezierRS19.bpi"'}
{$ELSEIF DEFINED(VER270)}
  {$HPPEMIT '#pragma link "dxSkinTheBezierRS20.bpi"'}
{$ELSEIF DEFINED(VER280)}
  {$HPPEMIT '#pragma link "dxSkinTheBezierRS21.bpi"'}
{$ELSEIF DEFINED(VER290)}
  {$HPPEMIT '#pragma link "dxSkinTheBezierRS22.bpi"'}
{$ELSEIF DEFINED(VER300)}
  {$HPPEMIT '#pragma link "dxSkinTheBezierRS23.bpi"'}
{$ELSEIF DEFINED(VER310)}
  {$HPPEMIT '#pragma link "dxSkinTheBezierRS24.bpi"'}
{$ELSEIF DEFINED(VER320)}
  {$HPPEMIT '#pragma link "dxSkinTheBezierRS25.bpi"'}
{$ELSEIF DEFINED(VER330)}
  {$HPPEMIT '#pragma link "dxSkinTheBezierRS26.bpi"'}
{$ELSEIF DEFINED(VER340)}
  {$HPPEMIT '#pragma link "dxSkinTheBezierRS27.bpi"'}
{$ELSEIF DEFINED(VER350)}
  {$HPPEMIT '#pragma link "dxSkinTheBezierRS28.bpi"'}
{$ELSEIF DEFINED(VER360)}
  {$HPPEMIT '#pragma link "dxSkinTheBezierRS29.bpi"'}
{$ELSE}
  Unsupported
{$IFEND}
...
{$ELSEIF DEFINED(VER360)}
  {$HPPEMIT '#pragma link "dxSkinTheBezierRS29.a"'}
{$ELSE}
  Unsupported
{$IFEND}
...
{$ELSEIF DEFINED(VER360)}
  {$HPPEMIT '#pragma link "dxSkinTheBezierRS29.lib"'}
{$ELSE}
  Unsupported
{$IFEND}
...
const
  dxThisUnitName = 'dxSkinTheBezier';
