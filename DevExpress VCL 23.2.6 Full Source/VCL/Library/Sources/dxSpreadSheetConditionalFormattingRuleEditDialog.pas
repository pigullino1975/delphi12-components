...
uses
  ...
  dxSpreadSheetClasses, dxThreading, dxScrollbarAnnotations;

type

  { TfrmSpreadSheetConditionalFormattingRuleEditDialog }

  TfrmSpreadSheetConditionalFormattingRuleEditDialogClass = class of TfrmSpreadSheetConditionalFormattingRuleEditDialog;
...
var
  dxSpreadSheetConditionalFormattingRuleEditDialogClass: TfrmSpreadSheetConditionalFormattingRuleEditDialogClass = TfrmSpreadSheetConditionalFormattingRuleEditDialog; 
...
const
  dxThisUnitName = 'dxSpreadSheetConditionalFormattingRuleEditDialog';
...
begin
  ...
  begin
    ADialog := dxSpreadSheetConditionalFormattingRuleEditDialogClass.Create(AOwner);
    try
