...
unit dxRichEdit.DocumentModel.History.Paragraph; // for internal use
...
uses
  RTLConsts, Contnrs, dxCoreClasses,
...
const
  dxThisUnitName = 'dxRichEdit.DocumentModel.History.Paragraph';
