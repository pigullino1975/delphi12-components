...
begin
  Result := nil;
  if (FlowChart = nil) or ((FlowChart.ObjectCount = 0) and (FlowChart.ConnectionCount = 0)) then
    Exit;
...
begin
  ...
  try
    ...
    TdxImageDrawer.DrawImage(cxPaintCanvas, cxRectSetOrigin(R3, Point(cxRectCenter(R2).X - R3.Right div 2,
      R2.Top + ScaleFactor.Apply(10))), nil, ilFlowChart, 0, Enabled, nil, ScaleFactor);
    TdxImageDrawer.DrawImage(cxPaintCanvas, cxRectSetOrigin(R3, Point(cxRectCenter(R2).X - 2 * R3.Right,
      R2.Top + R3.Bottom + ScaleFactor.Apply(20))), nil, ilFlowChart, 0, Enabled, nil, ScaleFactor);
    TdxImageDrawer.DrawImage(cxPaintCanvas, cxRectSetOrigin(R3, Point(cxRectCenter(R2).X + R3.Right,
      R2.Top + R3.Bottom + ScaleFactor.Apply(20))), nil, ilFlowChart, 0, Enabled, nil, ScaleFactor);
  finally
