...
unit dxSpreadSheetFunctionsMath; // for internal use
...
const
  dxThisUnitName = 'dxSpreadSheetFunctionsMath';
...
function ExtractSourcesMatrix(Sender, AMatrixStorage: TdxSpreadSheetFormulaResult;
  const AParams: TdxSpreadSheetFormulaToken; var AMatrix1, AMatrix2: Variant): TdxSpreadSheetFormulaErrorCode;
var
...
begin
  ...
  dxSpreadSheetIsReferenceToken(AMatrixToken1, AMatrixStorage);
  if (AMatrixToken1 <> nil) and (AParams.Next <> nil) then
    AMatrixToken2 := AParams.Next.FirstChild;
  dxSpreadSheetIsReferenceToken(AMatrixToken2, AMatrixStorage);
...
var
  ...
  AValue: Variant;
  AMatrixStorage: TdxSpreadSheetFormulaResult;
begin
  AMatrixStorage := TdxSpreadSheetFormulaResult.Create(Sender.Owner);
  try
    AErrorCode := ExtractSourcesMatrix(Sender, AMatrixStorage, AParams, AMatrix1, AMatrix2);
    if AErrorCode <> ecNone then
...
begin
  if dxSpreadSheetExtractedArgumentsAreNotNull(Sender, AParams, ABottom, ATop) and
    ...
    Sender.ExtractNumericParameterWithoutBoolean(ATop, AParams.Next) then
      ...
      begin
        ALow := IfThen(ABottom >= 0, Trunc(ABottom), Trunc(ABottom) - 1);
        AHigh := IfThen(ATop >= 0, Trunc(ATop), Trunc(ATop) - 1);
        AResult := Round(ABottom + Random(AHigh - ALow + 1));
        if AResult < ABottom then
          AResult := ALow + 1;
        if ATop - ABottom < 1 then
        begin
          if AResult > ATop then
            AResult := Min(AResult, AHigh + 1);
        end
        else
          AResult := Min(AResult, AHigh);
        Sender.AddValue(AResult);
      end;
end;
...
begin
  ARepository.InternalAdd(@sfnAbs, fnABS, fpiABS, frkValue, 24, ftMath, @sfnAbsDescription);
  ARepository.InternalAdd(@sfnAcos, fnACOS, fpiACOS, frkValue, 99, ftMath, @sfnAcosDescription);
  ARepository.InternalAdd(@sfnAcosh, fnACOSH, fpiACOSH, frkValue, 233, ftMath, @sfnAcoshDescription);
  ARepository.InternalAdd(@sfnAcot, fnACOT, fpiACOT, frkValue, 255, ftMath, @sfnAcotDescription, 1);
  ARepository.InternalAdd(@sfnAcoth, fnACOTH, fpiACOTH, frkValue, 255, ftMath, @sfnAcothDescription, 1);
  ARepository.InternalAdd(@sfnAggregate, nil, nil, frkValue, 255, ftMath, @sfnAggregateDescription, 1);
  ARepository.InternalAdd(@sfnArabic, nil, nil, frkValue, 255, ftMath, @sfnArabicDescription);
  ARepository.InternalAdd(@sfnAsin, fnASIN, fpiASIN, frkValue, 98, ftMath, @sfnAsinDescription);
  ARepository.InternalAdd(@sfnAsinh, fnASINH, fpiASINH, frkValue, 232, ftMath, @sfnAsinhDescription);
  ARepository.InternalAdd(@sfnAtan, fnATAN, fpiATAN, frkValue, 18, ftMath, @sfnAtanDescription);
  ARepository.InternalAdd(@sfnAtan2, fnATAN2, fpiATAN2, frkValue, 97, ftMath, @sfnAtan2Description);
  ARepository.InternalAdd(@sfnAtanh, fnATANH, fpiATANH, frkValue, 234, ftMath, @sfnAtanhDescription);
  ARepository.InternalAdd(@sfnBase, fnBase, fpiBase, frkValue, 255, ftMath, @sfnBaseDescription, 1);
  ARepository.InternalAdd(@sfnCeiling, fnCeiling, fpiCeiling, frkValue, 288, ftMath, @sfnCeilingDescription);
  ARepository.InternalAdd(@sfnCeiling_Math, fnCeiling_Math, fpiCeiling_Math, frkValue, 255, ftMath, @sfnCeiling_MathDescription, 1);
  ARepository.InternalAdd(@sfnCeiling_Precise, fnCeiling_Precise, fpiCeiling_Precise, frkValue, 255, ftMath, @sfnCeiling_PreciseDescription, 1);
  ARepository.InternalAdd(@sfnCombin, fnCombin, fpiCombin, frkValue, 276, ftMath, @sfnCombinDescription);
  ARepository.InternalAdd(@sfnCombinA, fnCombinA, fpiCombinA, frkValue, 255, ftMath, @sfnCombinADescription, 1);
  ARepository.InternalAdd(@sfnCos, fnCOS, fpiCOS, frkValue, 16, ftMath, @sfnCosDescription);
  ARepository.InternalAdd(@sfnCosh, fnCOSH, fpiCOSH, frkValue, 230, ftMath, @sfnCoshDescription);
  ARepository.InternalAdd(@sfnCot, fnCOT, fpiCOT, frkValue, 255, ftMath, @sfnCotDescription, 1);
  ARepository.InternalAdd(@sfnCoth, fnCOTH, fpiCOTH, frkValue, 255, ftMath, @sfnCothDescription, 1);
  ARepository.InternalAdd(@sfnCsc, fnCSC, fpiCSC, frkValue, 255, ftMath, @sfnCscDescription, 1);
  ARepository.InternalAdd(@sfnCsch, fnCSCH, fpiCSCH, frkValue, 255, ftMath, @sfnCschDescription, 1);
  ARepository.InternalAdd(@sfnDecimal, fnDecimal, fpiDecimal, frkValue, 255, ftMath, @sfnDecimalDescription, 1);
  ARepository.InternalAdd(@sfnDegrees, fnDegrees, fpiDegrees, frkValue, 343, ftMath, @sfnDegreesDescription);
  ARepository.InternalAdd(@sfnExp, fnExp, fpiExp, frkValue, 21, ftMath, @sfnExpDescription);
  ARepository.InternalAdd(@sfnEven, fnEven, fpiEven, frkValue, 279, ftMath, @sfnEvenDescription);
  ARepository.InternalAdd(@sfnFact, fnFact, fpiFact, frkValue, 184, ftMath, @sfnFactDescription);
  ARepository.InternalAdd(@sfnFactDouble, fnFactDouble, fpiFactDouble, frkValue, 255, ftMath, @sfnFactDoubleDescription);
  ARepository.InternalAdd(@sfnFloor, fnFloor, fpiFloor, frkValue, 285, ftMath, @sfnFloorDescription);
  ARepository.InternalAdd(@sfnFloor_Math, fnFloor_Math, fpiFloor_Math, frkValue, 255, ftMath, @sfnFloor_MathDescription, 1);
  ARepository.InternalAdd(@sfnFloor_Precise, fnFloor_Precise, fpiFloor_Precise, frkValue, 255, ftMath, @sfnFloor_PreciseDescription, 1);
  ARepository.InternalAdd(@sfnGCD, nil, nil, frkValue, 255, ftMath, @sfnGCDDescription);
  ARepository.InternalAdd(@sfnInt, fnINT, fpiINT, frkValue, 25, ftMath, @sfnIntDescription);
  ARepository.InternalAdd(@sfnIso_Ceiling, fnIso_Ceiling, fpiIso_Ceiling, frkValue, 255, ftMath, @sfnIso_CeilingDescription);
  ARepository.InternalAdd(@sfnLCM, nil, nil, frkValue, 255, ftMath, @sfnLCMDescription);
  ARepository.InternalAdd(@sfnLn, fnLN, fpiLN, frkValue, 22, ftMath, @sfnLnDescription);
  ARepository.InternalAdd(@sfnLog, fnLOG, fpiLOG, frkValue, 109, ftMath, @sfnLogDescription);
  ARepository.InternalAdd(@sfnLog10, fnLOG10, fpiLOG10, frkValue, 23, ftMath, @sfnLog10Description);
  ARepository.InternalAdd(@sfnMDeterm, nil, nil, frkValue, 163, ftMath, @sfnMDetermDescription, 0, False);
  ARepository.InternalAdd(@sfnMInverse, nil, nil, frkValue, 164, ftMath, @sfnMInverseDescription, 0, False);
  ARepository.InternalAdd(@sfnMMult, fnMMult, fpiMMult, frkArray, 165, ftMath, @sfnMMultDescription, 0, False);
  ARepository.InternalAdd(@sfnMod, fnMOD, fpiMOD, frkValue, 39, ftMath, @sfnModDescription);
  ARepository.InternalAdd(@sfnMRound, fnMRound, fpiMRound, frkValue, 255, ftMath, @sfnMRoundDescription);
  ARepository.InternalAdd(@sfnMultiNomial, nil, nil, frkValue, 255, ftMath, @sfnMultiNomialDescription);
  ARepository.InternalAdd(@sfnMUnit, nil, nil, frkValue, 255, ftMath, @sfnMUnitDescription, 1);
  ARepository.InternalAdd(@sfnOdd, fnOdd, fpiOdd, frkValue, 298, ftMath, @sfnOddDescription);
  ARepository.InternalAdd(@sfnPi, fnPI, fpiPI, frkValue, 19, ftMath, @sfnPiDescription);
  ARepository.InternalAdd(@sfnPower, fnPower, fpiPower, frkValue, 337, ftMath, @sfnPowerDescription);
  ARepository.InternalAdd(@sfnProduct, fnProduct, fpiProduct, frkNonArrayValue, 183, ftMath, @sfnProductDescription);
  ARepository.InternalAdd(@sfnQuotient, fnQuotient, fpiQuotient, frkValue, 255, ftMath, @sfnQuotientDescription);
  ARepository.InternalAdd(@sfnRadians, fnRadians, fpiRadians, frkValue, 342, ftMath, @sfnRadiansDescription);
  ARepository.InternalAdd(@sfnRand, fnRand, fpiRand, frkValue, 63, ftMath, @sfnRandDescription);
  ARepository.InternalAdd(@sfnRandBetween, fnRandBetween, fpiRandBetween, frkValue, 255, ftMath, @sfnRandBetweenDescription);
  ARepository.InternalAdd(@sfnRound, fnRound, fpiRound, frkValue, 27, ftMath, @sfnRoundDescription);
  ARepository.InternalAdd(@sfnRoundDown, fnRoundDown, fpiRoundDown, frkValue, 213, ftMath, @sfnRoundDownDescription);
  ARepository.InternalAdd(@sfnRoundUp, fnRoundUp, fpiRoundUp, frkValue, 212, ftMath, @sfnRoundUpDescription);
  ARepository.InternalAdd(@sfnRoman, nil, nil, frkValue, 354, ftMath, @sfnRomanDescription);
  ARepository.InternalAdd(@sfnSec, fnSec, fpiSec, frkValue, 255, ftMath, @sfnSecDescription, 1);
  ARepository.InternalAdd(@sfnSech, fnSech, fpiSech, frkValue, 255, ftMath, @sfnSechDescription, 1);
  ARepository.InternalAdd(@sfnSeriesSum, nil, nil, frkValue, 255, ftMath, @sfnSeriesSumDescription);
  ARepository.InternalAdd(@sfnSign, fnSign, fpiSign, frkValue, 26, ftMath, @sfnSignDescription);
  ARepository.InternalAdd(@sfnSin, fnSin, fpiSin, frkValue, 15, ftMath, @sfnSinDescription);
  ARepository.InternalAdd(@sfnSinh, fnSinH, fpiSinH, frkValue, 229, ftMath, @sfnSinhDescription);
  ARepository.InternalAdd(@sfnSqrt, fnSQRT, fpiSQRT, frkValue, 20, ftMath, @sfnSqrtDescription);
  ARepository.InternalAdd(@sfnSqrtPi, fnSQRTPI, fpiSQRTPI, frkValue, 255, ftMath, @sfnSqrtPiDescription);
  ARepository.InternalAdd(@sfnSubTotal, fnSubTotal, fpiSubTotal, frkValue, 344, ftMath, @sfnSubTotalDescription);
  ARepository.InternalAdd(@sfnSum, fnSum, fpiSum, frkNonArrayValue, 4, ftMath, @sfnSumDescription);
  ARepository.InternalAdd(@sfnSumIF, fnSumIF, fpiSumIF, frkNonArrayValue, 345, ftMath, @sfnSumIFDescription, 0, False);
  ARepository.InternalAdd(@sfnSumIFS, fnSumIFS, fpiSumIFS, frkNonArrayValue, 255, ftMath, @sfnSumIFSDescription, 0, False);
  ARepository.InternalAdd(@sfnSumProduct, fnSumProduct, fpiSumProduct, frkNonArrayValue, 228, ftMath, @sfnSumProductDescription);
  ARepository.InternalAdd(@sfnSumSQ, fnSumSQ, fpiSumSQ, frkNonArrayValue, 321, ftMath, @sfnSumSQDescription);
  ARepository.InternalAdd(@sfnSumX2MY2, fnSumX2MY2, fpiSumX2MY2, frkNonArrayValue, 304, ftMath, @sfnSumX2MY2Description, 0, False);
  ARepository.InternalAdd(@sfnSumX2PY2, fnSumX2PY2, fpiSumX2PY2, frkNonArrayValue, 305, ftMath, @sfnSumX2PY2Description, 0, False);
  ARepository.InternalAdd(@sfnSumXMY2, fnSumXMY2, fpiSumXMY2, frkNonArrayValue, 303, ftMath, @sfnSumXMY2Description, 0, False);
  ARepository.InternalAdd(@sfnTan, fnTan, fpiTan, frkValue, 17, ftMath, @sfnTanDescription);
  ARepository.InternalAdd(@sfnTanh, fnTanH, fpiTanH, frkValue, 231, ftMath, @sfnTanhDescription);
  ARepository.InternalAdd(@sfnTrunc, fnTrunc, fpiTrunc, frkValue, 197, ftMath, @sfnTruncDescription);
end;
