...
type
  ...
  TdxDockingSelectionEditor = class(TdxSkinsBaseSelectionEditor)
  public
...
begin
  ...
  begin
    if (ASelection[I] is TdxCustomDockControl) and (TdxCustomDockControl(ASelection[I]).ParentDockControl = nil) then
      TdxCustomDockControl(ASelection[I]).Repaint;
  end;
end;
...
finalization
  ...
  FOnRegisterDockControl := nil;
  FOnUnregisterDockControl := nil;
