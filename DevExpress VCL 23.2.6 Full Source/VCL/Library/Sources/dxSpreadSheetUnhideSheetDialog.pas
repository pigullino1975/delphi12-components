...
var
  dxSpreadSheetUnhideSheetDialogClass: TdxSpreadSheetUnhideSheetDialogFormClass = TdxSpreadSheetUnhideSheetDialogForm; 
...
const
  dxThisUnitName = 'dxSpreadSheetUnhideSheetDialog';
...
begin
  ADialog := dxSpreadSheetUnhideSheetDialogClass.Create(GetParentForm(ASpreadSheet));
  try
