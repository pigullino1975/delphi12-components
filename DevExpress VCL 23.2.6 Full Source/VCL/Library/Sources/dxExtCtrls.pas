...
type
  ...
  protected
    ...
    function GetStyleName(Index: Integer): string; {$IFDEF DELPHI104SYDNEY} reintroduce;{$ENDIF} virtual;
  public
...
uses
  ...
  dxExtCtrlsStrs, dxPSUtl, dxPSImgs, dxPSGlbl, dxPSRes, dxPCPrVw, dxPSPopupMan, dxShellDialogs;

const
  dxThisUnitName = 'dxExtCtrls';
...
begin
  TdxImageDrawer.DrawImage(ACanvas, R, Picture.Graphic, ifmStretch, nil, ScaleFactor);
end;
...
begin
  if HasGraphic then
  begin
    with TdxSavePictureDialog.Create(nil) do
    try
