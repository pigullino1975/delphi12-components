...
unit dxRichEdit.Export.Html; // for internal use
...
type
  ...
  protected
    ...
    function ExportCssPropertiesToSeparateFile(AStyle: TdxStyleWebControl): string;
  ...
  protected
    ...
    function CreateContentExporter(ADocumentModel: TdxDocumentModel;
      AOptions: TdxHtmlDocumentExporterOptions): TdxHtmlContentExporter; virtual;
...
const
  dxThisUnitName = 'dxRichEdit.Export.Html';
...
begin
  ...
  try
    ...
    begin
      ...
      AHtml.Attributes.Add('xmlns:v', 'urn:schemas-microsoft-com:vml');
      AHtml.Attributes.Add('xmlns:o', 'urn:schemas-microsoft-com:office:office');
    end;
...
function TdxHtmlExporterBase.ExportCssPropertiesToSeparateFile(AStyle: TdxStyleWebControl): string;
var
  ASb: TStringBuilder;
...
begin
  AResult := ExportCssPropertiesToSeparateFile(StyleControl);
...
begin
  ...
  try
    if TdxEncoding.UTF8.Equals(Options.ActualEncoding) then
