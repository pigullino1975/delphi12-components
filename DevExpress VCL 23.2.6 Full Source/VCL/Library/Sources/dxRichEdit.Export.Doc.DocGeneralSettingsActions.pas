...
{                                                                    }
{********************************************************************}
unit dxRichEdit.Export.Doc.DocGeneralSettingsActions; // for internal use
...
uses
  ...
  dxCoreGraphics, dxGenerics, dxFontHelpers, 
...
const
  dxThisUnitName = 'dxRichEdit.Export.Doc.DocGeneralSettingsActions';
