...
type
  ...
  private
    FDrawBitmap: TcxBitmap32;
    FEditorMode: Boolean;
    FHasIntersection: Boolean;
  ...
  public
    ...
    property DrawBitmap: TcxBitmap32 read FDrawBitmap;
    property HasIntersection: Boolean read FHasIntersection write FHasIntersection;
...
const
  dxThisUnitName = 'dxLayoutSelection';
...
constructor TdxSelectionLayerInplaceEdit.Create(ASelectionLayer: TdxSelectionLayer);
begin
...
begin
  ...
  FDrawBitmap := TcxBitmap32.Create;
...
begin
  cxBitBlt(cxCanvas.Handle, DrawBitmap.cxCanvas.Handle, ClientRect, cxNullPoint, SRCCOPY);
end;
