...
/// <summary>Suffixed with 'Linq' to avoid clashes with calls to the System.SysUtils unit counterpart.</summary>
function NowLinq: TdxLinqExpression; overload;
/// <summary>Suffixed with 'Linq' to avoid clashes with calls to the System.DateUtils unit counterpart.</summary>
function TodayLinq: TdxLinqExpression; overload;
...
const
  dxThisUnitName = 'dxEMF.Linq.Expressions';
...
function NowLinq: TdxLinqExpression;
begin
...
function TodayLinq: TdxLinqExpression;
begin
