...
var
  dxSpreadSheetEditHyperlinkDialogClass: TdxSpreadSheetEditHyperlinkDialogFormClass = TdxSpreadSheetEditHyperlinkDialogForm; 
...
const
  dxThisUnitName = 'dxSpreadSheetEditHyperlinkDialog';
...
begin
  ADialogForm := dxSpreadSheetEditHyperlinkDialogClass.Create(GetParentForm(ASheet.SpreadSheet));
  try
    if ASheet <> nil then
...
begin
  ...
  lcbtnOK.Enabled := TdxSpreadSheetEditingHyperlink(EditingHyperlink).IsHyperlinkValid;
end;
