...
unit dxRichEdit.Import.OpenXML.DestinationSettings; // for internal use
...
const
  dxThisUnitName = 'dxRichEdit.Import.OpenXML.DestinationSettings';

{ TdxDocumentSettingsDestination }

class constructor TdxDocumentSettingsDestination.Initialize;
begin
  {$IFDEF DX_INITIALIZATION_LOGGING}TdxUnitSectionsLogger.ConstructorStarted(UnitName, 'TdxDocumentSettingsDestination.Initialize', SysInit.HInstance);{$ENDIF}
  FHandlerTable := CreateElementHandlerTable;
  {$IFDEF DX_INITIALIZATION_LOGGING}TdxUnitSectionsLogger.ConstructorFinished(UnitName, 'TdxDocumentSettingsDestination.Initialize', SysInit.HInstance);{$ENDIF}
end;

class destructor TdxDocumentSettingsDestination.Finalize;
begin
  {$IFDEF DX_INITIALIZATION_LOGGING}TdxUnitSectionsLogger.DestructorStarted(UnitName, 'TdxDocumentSettingsDestination.Finalize', SysInit.HInstance);{$ENDIF}
  FHandlerTable.Free;
  {$IFDEF DX_INITIALIZATION_LOGGING}TdxUnitSectionsLogger.DestructorFinished(UnitName, 'TdxDocumentSettingsDestination.Finalize', SysInit.HInstance);{$ENDIF}
end;
...
begin
  {$IFDEF DX_INITIALIZATION_LOGGING}TdxUnitSectionsLogger.ConstructorStarted(UnitName, 'TdxDocumentVariablesDestination.Initialize', SysInit.HInstance);{$ENDIF}
  FHandlerTable := CreateElementHandlerTable;
  {$IFDEF DX_INITIALIZATION_LOGGING}TdxUnitSectionsLogger.ConstructorFinished(UnitName, 'TdxDocumentVariablesDestination.Initialize', SysInit.HInstance);{$ENDIF}
end;

class destructor TdxDocumentVariablesDestination.Finalize;
begin
  {$IFDEF DX_INITIALIZATION_LOGGING}TdxUnitSectionsLogger.DestructorStarted(UnitName, 'TdxDocumentVariablesDestination.Finalize', SysInit.HInstance);{$ENDIF}
  FHandlerTable.Free;
  {$IFDEF DX_INITIALIZATION_LOGGING}TdxUnitSectionsLogger.DestructorFinished(UnitName, 'TdxDocumentVariablesDestination.Finalize', SysInit.HInstance);{$ENDIF}
end;
...
begin
  ...
  if (AName <> '') and (AVal <> '') then
    Importer.DocumentModel.Variables.Add(AName, TdxXmlConvert.DecodeName(AVal));
end;
