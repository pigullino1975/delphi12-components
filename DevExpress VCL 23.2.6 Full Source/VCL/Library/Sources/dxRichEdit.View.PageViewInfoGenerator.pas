...
unit dxRichEdit.View.PageViewInfoGenerator; // for internal use
...
type
  ...
  TdxPageViewInfoRow = class(TdxReferencedObject)
  strict private
    FList: TdxPageViewInfoCollection;
    FBounds: TRect;
    function GetCount: Integer; inline;
    function GetItem(AIndex: Integer): TdxPageViewInfo; inline;
    procedure SetItem(AIndex: Integer; const Value: TdxPageViewInfo); inline;
  protected
  ...
  public
    ...
    procedure Add(AItem: TdxPageViewInfo); inline;
    procedure AddRange(ARow: TdxPageViewInfoRow); inline;
    procedure Clear; inline;
    function First: TdxPageViewInfo; inline;
    function Last: TdxPageViewInfo; inline;
    function IndexOf(AItem: TdxPageViewInfo): Integer; inline;

    property Count: Integer read GetCount;
    property Bounds: TRect read FBounds write FBounds;
    property Items[AIndex: Integer]: TdxPageViewInfo read GetItem write SetItem; default;
  end;

  { PageViewInfoRowCollection }

  TdxPageViewInfoRowCollection = class(TdxReferencedObjectList<TdxPageViewInfoRow>)
  protected
  ...
  protected
    ...
    function CalculateVisibleHeightFactor(APageViewInfo: TdxPageViewInfo; const AViewPort: TRect): Single;
    function CalculateVisibleWidthFactor(APageViewInfo: TdxPageViewInfo; const AViewPort: TRect): Single;
    ...
    procedure AlignPagesVertically(ARow: TdxPageViewInfoRow);
    procedure AlignPagesHorizontally(ARow: TdxPageViewInfoRow; ARowLeftOffset: Integer);
    ...
    procedure UpdatePagesClientBounds(ARow: TdxPageViewInfoRow);
  ...
  public
    ...
    function CalculatePageVisibleLogicalWidth(APageViewInfo: TdxPageViewInfo): Integer; overload;
    function CalculatePageVisibleLogicalWidth(APageViewInfo: TdxPageViewInfo; const AViewPort: TRect): Integer; overload; virtual;
    function CalculatePageVisibleLogicalHeight(APageViewInfo: TdxPageViewInfo): Integer; overload;
    function CalculatePageVisibleLogicalHeight(APageViewInfo: TdxPageViewInfo; const AViewPort: TRect): Integer; overload;
    function CalculatePagesTotalLogicalHeight(ARow: TdxPageViewInfoRow): Int64;
    function CalculatePagesTotalVisibleLogicalHeight(ARow: TdxPageViewInfoRow): Int64; overload;
    function CalculatePagesTotalVisibleLogicalHeight(ARow: TdxPageViewInfoRow; const AViewPort: TRect): Int64; overload;
    function CalculatePagesTotalLogicalHeightAbove(ARow: TdxPageViewInfoRow; ALogicalY: Integer): Int64;
    function CalculatePagesTotalLogicalHeightBelow(ARow: TdxPageViewInfoRow; ALogicalY: Integer): Int64;
    ...
    function CalculatePagePhysicalWidth(APage: TdxPage): Integer;
    function CalculatePageLogicalHeight(APage: TdxPage): Integer;
    function CalculatePagePhysicalHeight(APage: TdxPage): Integer;
    function CalculatePageLogicalSize(APage: TdxPage): TSize;
    function CalculatePagePhysicalSize(APage: TdxPage): TSize;
  ...
  protected
    procedure UpdateRunningHeightAnchor;
    procedure UpdateFirstPageOffsetAnchor;
    function LookupFirstVisiblePage(ARow: TdxPageViewInfoRow): TdxPageViewInfo;
  public
    constructor Create(AView: TObject; AViewInfo: TObject); override;
    destructor Destroy; override;
    procedure CalculateMaxPageWidth;
    ...
    function GetPageRowAtPoint(const APoint: TPoint): TdxPageViewInfoRow; overload;
    function GetPageRowAtPoint(const APoint: TPoint; AStrictSearch: Boolean): TdxPageViewInfoRow; overload;
  ...
  private
    ...
    procedure SetResult(AResult: TdxPageViewInfoRow);
  protected
    procedure Reset;
    procedure OnRowFinished(Sender: TObject; E: TdxEventArgs);
  ...
  public
    ...
    destructor Destroy; override;
    function GenerateNextRow: TdxPageViewInfoRow;
...
const
  dxThisUnitName = 'dxRichEdit.View.PageViewInfoGenerator';
...
function TdxPageViewInfoRow.IndexOf(AItem: TdxPageViewInfo): Integer;
begin
...
function TdxPageViewInfoRow.Last: TdxPageViewInfo;
begin
  Result := FList.Last;
end;

procedure TdxPageViewInfoRow.SetItem(AIndex: Integer; const Value: TdxPageViewInfo);
begin
  FList[AIndex] := Value;
end;

function TdxPageViewInfoRow.GetCount: Integer;
begin
  Result := FList.Count;
end;

function TdxPageViewInfoRow.GetItem(AIndex: Integer): TdxPageViewInfo;
begin
  Result := FList[AIndex];
end;
...
procedure TdxPageViewInfoRow.Add(AItem: TdxPageViewInfo);
begin
  FList.Add(AItem);
end;

procedure TdxPageViewInfoRow.AddRange(ARow: TdxPageViewInfoRow);
begin
  FList.AddRange(ARow.FList);
end;

procedure TdxPageViewInfoRow.Clear;
begin
  FList.Clear;
end;

constructor TdxPageViewInfoRow.Create;
begin
  inherited Create;
  FList := TdxPageViewInfoCollection.Create;
end;
...
function TdxPageViewInfoRow.First: TdxPageViewInfo;
begin
  Result := FList.First;
end;
...
begin
  ...
  begin
    ...
    begin
      APage := ARow[0];
      ATotalWidthValue := Max(ATotalWidthValue, CalculatePageLogicalTotalWidth(APage.Page));
...
begin
  ...
  FPages := APages;
  FPageRows := TdxPageViewInfoRowCollection.Create(True);
  CurrentPageRow := TdxPageViewInfoRow.Create;
...
begin
  if FCurrentPageRow = Value then
    Exit;
  TdxPageViewInfoRow.Release(FCurrentPageRow);
  FCurrentPageRow := Value;
  TdxPageViewInfoRow.AddReference(FCurrentPageRow);
end;
...
begin
  ARow := CurrentRow;
  APageViewInfo := TdxPageViewInfo.Create(APage); 
...
begin
  ...
  ANewRow := TdxPageViewInfoRow.Create;
...
begin
  ...
  TdxPageViewInfoRow.Release(FCurrentRow);
  FCurrentRow := TdxPageViewInfoRow.Create;
  TdxPageViewInfoRow.AddReference(FCurrentRow);
  FCurrentRow.Bounds := LayoutManager.CreateInitialPageViewInfoRowBounds(0);
end;

destructor TdxStateInvisibleRowBase.Destroy;
begin
  TdxPageViewInfoRow.Release(FCurrentRow);
  inherited;
end;
...
begin
  ...
  if FPagesProcessed <= 0 then
    Exit(nil);
  SetResult(Generator.PageRows.Last);
  Exit(FResult);
end;
...
procedure TdxInvisiblePageRowsGenerator.SetResult(AResult: TdxPageViewInfoRow);
begin
  if AResult = FResult then
    Exit;
  TdxPageViewInfoRow.Release(FResult);
  FResult := AResult;
  TdxPageViewInfoRow.AddReference(FResult);
end;
