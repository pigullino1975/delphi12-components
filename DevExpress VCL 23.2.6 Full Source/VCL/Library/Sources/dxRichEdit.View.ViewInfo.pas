...
unit dxRichEdit.View.ViewInfo; // for internal use
...
const
  dxThisUnitName = 'dxRichEdit.View.ViewInfo';


{ TdxPageViewInfo }

constructor TdxPageViewInfo.Create(APage: TdxPage);
begin
  inherited Create;
...
procedure TdxPageViewInfoCollection.Grow;
var
  ADelta: Integer;
begin
  if Capacity > 64 then
