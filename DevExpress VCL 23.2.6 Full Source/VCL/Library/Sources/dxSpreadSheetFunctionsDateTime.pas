...
unit dxSpreadSheetFunctionsDateTime; // for internal use
...
const
  dxThisUnitName = 'dxSpreadSheetFunctionsDateTime';
...
begin
  ...
  begin
    ...
    if (ABasis < 0) or (ABasis > 4) then
      ...
      Sender.AddValue(Double(dxGetYearFrac(AStart, AEnd, ABasis)));
  end;
end;
...
begin
  ARepository.InternalAdd(@sfnDate, fnDate, fpiDate, frkValue, 65, ftDateTime, @sfnDateDescription);
  ARepository.InternalAdd(@sfnDateValue, fnDateValue, fpiDateValue, frkValue, 140, ftDateTime, @sfnDateValueDescription);
  ARepository.InternalAdd(@sfnDay, fnDay, fpiDay, frkValue, 67, ftDateTime, @sfnDayDescription);
  ARepository.InternalAdd(@sfnDays, fnDays, fpiDays, frkValue, 255, ftDateTime, @sfnDaysDescription, 1);
  ARepository.InternalAdd(@sfnDays360, fnDays360, fpiDays360, frkValue, 220, ftDateTime, @sfnDays360Description);
  ARepository.InternalAdd(@sfnEDate, fnEDate, fpiEDate, frkValue, 255, ftDateTime, @sfnEDateDescription);
  ARepository.InternalAdd(@sfnEOMonth, fnEOMonth, fpiEOMonth, frkValue, 255, ftDateTime, @sfnEOMonthDescription);
  ARepository.InternalAdd(@sfnHour, fnHour, fpiHour, frkValue, 71, ftDateTime, @sfnHourDescription);
  ARepository.InternalAdd(@sfnIsoWeekNum, fnIsoWeekNum, fpiIsoWeekNum, frkValue, 255, ftDateTime, @sfnIsoWeekNumDescription, 1);
  ARepository.InternalAdd(@sfnMinute, fnMinute, fpiMinute, frkValue, 72, ftDateTime, @sfnMinuteDescription);
  ARepository.InternalAdd(@sfnMonth, fnMonth, fpiMonth, frkValue, 68, ftDateTime, @sfnMonthDescription);
  ARepository.InternalAdd(@sfnNetworkDays, fnNetworkDays, fpiNetworkDays, frkValue, 255, ftDateTime, @sfnNetworkDaysDescription);
  ARepository.InternalAdd(@sfnNetworkDays_Intl, fnNetworkDays_Intl, fpiNetworkDays_Intl, frkValue, 255, ftDateTime, @sfnNetworkDays_IntlDescription);
  ARepository.InternalAdd(@sfnNow, fnNow, fpiNow, frkValue, 74, ftDateTime, @sfnNowDescription);
  ARepository.InternalAdd(@sfnSecond, fnSecond, fpiSecond, frkValue, 73, ftDateTime, @sfnSecondDescription);
  ARepository.InternalAdd(@sfnTime, fnTime, fpiTime, frkValue, 66, ftDateTime, @sfnTimeDescription);
  ARepository.InternalAdd(@sfnTimeValue, fnTimeValue, fpiTimeValue, frkValue, 141, ftDateTime, @sfnTimeValueDescription);
  ARepository.InternalAdd(@sfnToday, fnToday, fpiToday, frkValue, 221, ftDateTime, @sfnTodayDescription);
  ARepository.InternalAdd(@sfnWeekDay, fnWeekDay, fpiWeekDay, frkValue, 70, ftDateTime, @sfnWeekDayDescription);
  ARepository.InternalAdd(@sfnWeekNum, fnWeekNum, fpiWeekNum, frkValue, 255, ftDateTime, @sfnWeekNumDescription);
  ARepository.InternalAdd(@sfnWorkDay, fnWorkDay, fpiWorkDay, frkValue, 255, ftDateTime, @sfnWorkDayDescription);
  ARepository.InternalAdd(@sfnWorkDay_Intl, fnWorkDay_Intl, fpiWorkDay_Intl, frkValue, 255, ftDateTime, @sfnWorkDay_IntlDescription);
  ARepository.InternalAdd(@sfnYear, fnYear, fpiYear, frkValue, 69, ftDateTime, @sfnYearDescription);
  ARepository.InternalAdd(@sfnYearFrac, fnYearFrac, fpiYearFrac, frkValue, 255, ftDateTime, @sfnYearFracDescription);
end;
