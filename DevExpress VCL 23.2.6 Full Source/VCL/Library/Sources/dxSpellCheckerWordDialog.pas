...
uses
  ...
  dxLayoutControlAdapters, dxLayoutLookAndFeels, cxClasses, dxLayoutControl, cxCustomListBox;
...
uses
  dxSpellCheckerStrs, RichEdit, dxSpellCheckerDialogs, dxSpellCheckerRules, dxMessageDialog;

const
  dxThisUnitName = 'dxSpellCheckerWordDialog';
...
begin
  ...
  begin
    ...
    begin
      if FChangeAll then
      begin
        dxShowMessage(cxGetResourceString(@sdxSpellCheckerNotUseChangeAll));
        reMisspelledText.SetFocus;
      end
      else
      begin
