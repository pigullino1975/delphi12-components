...
type
  ...
  TdxMergedCloneableOptionsProperties<TInfo: TdxCloneable, constructor; TOptions: TdxCloneable, constructor> =
    class(TdxMergedProperties<TInfo, TOptions>) // for internal use
  public
...
const
  dxThisUnitName = 'dxRichEdit.DocumentModel.MergedProperties';
