...
type
  ...
  protected
    ...
    function FastHitTestCore(ACollection: TdxCustomBoxCollection;
      const APredicate: TdxBoxComparableFunc; AStrictHitTest: Boolean): Integer;
  ...
  {$REGION 'IdxBoxHitTestCustomCalculator'}
    ...
    function CreateSpaceBoxHitTestManager(ABox: TdxBox): TdxBoxHitTestCustomManager; override;
  ...
  {$ENDREGION}
    ...
    function FastHitTestIndexCore(ACollection: TdxBoxList;
      const APredicate: TdxBoxComparableFunc; AStrictHitTest: Boolean): Integer; overload;
    function FastHitTestIndexCore<T: class>(ACollection: TdxList<T>;
      const APredicate: TdxComparableFunc<T>; AStrictHitTest: Boolean): Integer; overload; 
  ...
  public
    ...
    procedure RegisterSuccessfulHitTest(AStrictMatch: Boolean); virtual;
  ...
  strict private
    ...
    function GetPageArea: TdxPageArea; inline;
  ...
  public
    ...
    procedure RegisterSuccessfulHitTest(AStrictMatch: Boolean); override;
...
const
  dxThisUnitName = 'dxRichEdit.Control.HitTest';
...
procedure TdxRichEditHitTestResult.SetFloatingObjectBox(const Value: TdxFloatingObjectBox);
begin
...
begin
  ...
  begin
    AManager.RegisterSuccessfulHitTest(AStrictMatch);
...
function TdxBoxHitTestCalculator.FastHitTestIndexCore<T>(ACollection: TdxList<T>; AStartIndex, ACount: Integer;
  const APredicate: TdxComparableFunc<T>; AStrictHitTest: Boolean): Integer;
begin
  ...
  begin
    if APredicate(ACollection[0]) > 0 then
      Result := 0
    else
...
begin
  ...
  Result := FastHitTestIndexCore(ARows, AComparable.CompareTo, AStrictHitTest);
end;
...
begin
  ...
  begin
    ...
    ACollection.RegisterSuccessfulItemHitTest(Self, TdxBox(ACollection[Result]));
  end
  else
...
begin
  ...
  Result := FastHitTestCore(ACollection, AComparer.CompareTo, AStrictHitTest);
end;
...
function TdxBoxHitTestCalculator.CreateSpaceBoxHitTestManager(ABox: TdxBox): TdxBoxHitTestCustomManager;
begin
  Result := TdxBoxHitTestManager.Create(Self, ABox);
end;
...
begin
  ...
  begin
    RegisterSuccessfulHitTest(AStrictMatch);
...
procedure TdxBoxHitTestManager.RegisterSuccessfulHitTest(AStrictMatch: Boolean);
begin
...
procedure TdxPageHitTestManager.RegisterSuccessfulHitTest(AStrictMatch: Boolean);
begin
...
procedure TdxPageAreaHitTestManager.RegisterSuccessfulHitTest(AStrictMatch: Boolean);
begin
...
begin
  ...
  begin
    ...
    RegisterSuccessfulHitTest(True);
  end;
  ...
  begin
    ...
    try
      ...
      begin
        ...
        if ARow.Bounds.Contains(HitTestRequest.LogicalPoint) or not ARow.IsTableCellRow then
...
procedure TdxColumnHitTestManager.RegisterSuccessfulHitTest(
...
begin
  ...
  ATableRowIndex := Calculator.FastHitTestIndexCore<TdxTableRowViewInfoBase>(ATable.Rows, 0, ATable.RowCount,
    ATableRowAnchorComparable.CompareTo, AStrictTableRowMatch);
  ...
  ATableCellIndex := Calculator.FastHitTestIndexCore<TdxTableCellViewInfo>(ATableRow.Cells,
    ATableCellAnchorComparable.CompareTo, AStrictTableCellMatch);
...
procedure TdxRowHitTestManager.RegisterSuccessfulHitTest(AStrictMatch: Boolean);
begin
...
procedure TdxCharacterBoxHitTestManager.RegisterSuccessfulHitTest(AStrictMatch: Boolean);
begin
...
procedure TdxEmptyHitTestManager.RegisterSuccessfulHitTest(AStrictMatch: Boolean);
begin
//do nothing
end;
