...
type
  ...
  protected
    ...
    function CreateButton(AWidth: Integer; ATag: NativeInt; AClickEvent: TNotifyEvent): TcxButton;
...
uses
  Buttons, SysUtils, dxPSGlBl, dxPSUtl, dxPSRes, dxPSPopupMan, Types, dxCoreGraphics,
...
const
  dxThisUnitName = 'dxPSHFToolBarBld';
...
type
  ...
  strict private
    ...
    function CreateButton(const ACaption: string; ATag: NativeInt): TcxButton;
...
function TdxPSHFImagePopup.CreateButton(const ACaption: string; ATag: NativeInt): TcxButton;
begin
...
function TdxPSHFToolBarHelper.CreateButton(AWidth: Integer; ATag: NativeInt; AClickEvent: TNotifyEvent): TcxButton;
var
  AOffset: Integer;
begin
