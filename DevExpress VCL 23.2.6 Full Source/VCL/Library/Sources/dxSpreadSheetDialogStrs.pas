...
resourcestring
  ...
  sdxInsertFunctionDialogSearchBoxTextHint = 'Search';
  ...
  // Defined Name Manager Dialog
  sdxDefinedNameManagerDialogCaption = 'Name Manager';
  sdxDefinedNameManagerDialogColumnComment = 'Comment';
  sdxDefinedNameManagerDialogColumnName = 'Name';
  sdxDefinedNameManagerDialogColumnReference = 'Refers To';
  sdxDefinedNameManagerDialogColumnScope = 'Scope';
  sdxDefinedNameManagerDialogColumnValue = 'Value';
  sdxDefinedNameManagerDialogButtonClose = '&Close';
  sdxDefinedNameManagerDialogButtonDelete = '&Delete';
  sdxDefinedNameManagerDialogButtonEdit = '&Edit...';
  sdxDefinedNameManagerDialogButtonNew = '&New...';
  sdxDefinedNameManagerDialogDeleteSelectedNameConfirmation = 'Are you sure you want to delete the ''%s'' name?';
  sdxDefinedNameManagerDialogDeleteSelectedNamesConfirmation = 'Are you sure you want to delete the selected names?';
  sdxDefinedNameManagerDialogRefersTo = '&Refers to:';
  sdxDefinedNameManagerDialogSaveConfirmation = 'Do you want to save the changes you made to the name reference?';
  sdxDefinedNameManagerDialogWorkbook = 'Workbook';

  // Defined Name Editing Dialog
  sdxDefinedNameEditorCaptionEditName = 'Edit Name';
  sdxDefinedNameEditorCaptionNewName = 'New Name';
  sdxDefinedNameEditorButtonCancel = 'Cancel';
  sdxDefinedNameEditorButtonOK = 'OK';
  sdxDefinedNameEditorComment = 'C&omment:';
  sdxDefinedNameEditorName = '&Name:';
  sdxDefinedNameEditorRefersTo = '&Refers to:';
  sdxDefinedNameEditorScope = '&Scope:';

  // Create Defined Names from Selection Dialog
  sdxCreateDefinedNameFromSelectionDialogCaption = 'Create Names from Selection';
  sdxCreateDefinedNameFromSelectionDialogHeader = 'Create names from values in the:';
  sdxCreateDefinedNameFromSelectionDialogLeftColumn = '&Left column';
  sdxCreateDefinedNameFromSelectionDialogTopRow = '&Top row';
  sdxCreateDefinedNameFromSelectionDialogRightColumn = '&Right column';
  sdxCreateDefinedNameFromSelectionDialogBottomRow = '&Bottom row';
  sdxCreateDefinedNameFromSelectionDialogButtonOK = 'OK';
  sdxCreateDefinedNameFromSelectionDialogButtonCancel = 'Cancel';
...
const
  dxThisUnitName = 'dxSpreadSheetDialogStrs';
...
begin
  ...
  AProduct.Add('sdxInsertFunctionDialogSearchBoxTextHint', @sdxInsertFunctionDialogSearchBoxTextHint);

  AProduct.Add('sdxDefinedNameManagerDialogCaption', @sdxDefinedNameManagerDialogCaption);
  AProduct.Add('sdxDefinedNameManagerDialogColumnComment', @sdxDefinedNameManagerDialogColumnComment);
  AProduct.Add('sdxDefinedNameManagerDialogColumnName', @sdxDefinedNameManagerDialogColumnName);
  AProduct.Add('sdxDefinedNameManagerDialogColumnReference', @sdxDefinedNameManagerDialogColumnReference);
  AProduct.Add('sdxDefinedNameManagerDialogColumnScope', @sdxDefinedNameManagerDialogColumnScope);
  AProduct.Add('sdxDefinedNameManagerDialogColumnValue', @sdxDefinedNameManagerDialogColumnValue);
  AProduct.Add('sdxDefinedNameManagerDialogButtonClose', @sdxDefinedNameManagerDialogButtonClose);
  AProduct.Add('sdxDefinedNameManagerDialogButtonDelete', @sdxDefinedNameManagerDialogButtonDelete);
  AProduct.Add('sdxDefinedNameManagerDialogButtonEdit', @sdxDefinedNameManagerDialogButtonEdit);
  AProduct.Add('sdxDefinedNameManagerDialogButtonNew', @sdxDefinedNameManagerDialogButtonNew);
  AProduct.Add('sdxDefinedNameManagerDialogRefersTo', @sdxDefinedNameManagerDialogRefersTo);
  AProduct.Add('sdxDefinedNameManagerDialogDeleteSelectedNameConfirmation', @sdxDefinedNameManagerDialogDeleteSelectedNameConfirmation);
  AProduct.Add('sdxDefinedNameManagerDialogDeleteSelectedNamesConfirmation', @sdxDefinedNameManagerDialogDeleteSelectedNamesConfirmation);
  AProduct.Add('sdxDefinedNameManagerDialogSaveConfirmation', @sdxDefinedNameManagerDialogSaveConfirmation);
  AProduct.Add('sdxDefinedNameManagerDialogWorkbook', @sdxDefinedNameManagerDialogWorkbook);

  AProduct.Add('sdxDefinedNameEditorCaptionEditName', @sdxDefinedNameEditorCaptionEditName);
  AProduct.Add('sdxDefinedNameEditorCaptionNewName', @sdxDefinedNameEditorCaptionNewName);
  AProduct.Add('sdxDefinedNameEditorButtonCancel', @sdxDefinedNameEditorButtonCancel);
  AProduct.Add('sdxDefinedNameEditorButtonOK', @sdxDefinedNameEditorButtonOK);
  AProduct.Add('sdxDefinedNameEditorComment', @sdxDefinedNameEditorComment);
  AProduct.Add('sdxDefinedNameEditorName', @sdxDefinedNameEditorName);
  AProduct.Add('sdxDefinedNameEditorRefersTo', @sdxDefinedNameEditorRefersTo);
  AProduct.Add('sdxDefinedNameEditorScope', @sdxDefinedNameEditorScope);

  // Create Defined Names from Selection Dialog
  AProduct.Add('sdxCreateDefinedNameFromSelectionDialogCaption', @sdxCreateDefinedNameFromSelectionDialogCaption);
  AProduct.Add('sdxCreateDefinedNameFromSelectionDialogHeader', @sdxCreateDefinedNameFromSelectionDialogHeader);
  AProduct.Add('sdxCreateDefinedNameFromSelectionDialogLeftColumn', @sdxCreateDefinedNameFromSelectionDialogLeftColumn);
  AProduct.Add('sdxCreateDefinedNameFromSelectionDialogTopRow', @sdxCreateDefinedNameFromSelectionDialogTopRow);
  AProduct.Add('sdxCreateDefinedNameFromSelectionDialogRightColumn', @sdxCreateDefinedNameFromSelectionDialogRightColumn);
  AProduct.Add('sdxCreateDefinedNameFromSelectionDialogBottomRow', @sdxCreateDefinedNameFromSelectionDialogBottomRow);
  AProduct.Add('sdxCreateDefinedNameFromSelectionDialogButtonOK', @sdxCreateDefinedNameFromSelectionDialogButtonOK);
  AProduct.Add('sdxCreateDefinedNameFromSelectionDialogButtonCancel', @sdxCreateDefinedNameFromSelectionDialogButtonCancel);
end;
