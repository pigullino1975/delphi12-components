...
const
  dxThisUnitName = 'dxSpreadSheetPageSetupHeaderFooterDialog';
...
begin
  ...
  begin
    liFooterLeft.Caption := cxGetResourceString(@sdxPageSetupHeaderFooterDialogRightFooter);
    liFooterRight.Caption := cxGetResourceString(@sdxPageSetupHeaderFooterDialogLeftFooter);
    liHeaderLeft.Caption := cxGetResourceString(@sdxPageSetupHeaderFooterDialogRightHeader);
    liHeaderRight.Caption := cxGetResourceString(@sdxPageSetupHeaderFooterDialogLeftHeader);
  end
  else
  begin
...
procedure TdxSpreadSheetPageSetupHeaderFooterDialogForm.CMBiDiModeChanged(var Message: TMessage);
begin
  inherited;
  ApplyLocalization;
end;
