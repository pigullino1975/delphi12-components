...
uses
  Registry, dxPSRes, dxPSEngn, dxPSEvnt, dxPSPopupMan, dxPSGlbl, dxPSUtl, dxPSImgs, dxMessageDialog;

const
  dxThisUnitName = 'dxfmDfnStl';
...
begin
  Result := dxMessageBox(Message, Application.Title, MB_OKCANCEL or MB_ICONEXCLAMATION) = ID_OK;
end;
