...
{$IF DEFINED(VER210)}
  {$HPPEMIT '#pragma link "dxSkinGlassOceansRS14.bpi"'}
{$ELSEIF DEFINED(VER220)}
  {$HPPEMIT '#pragma link "dxSkinGlassOceansRS15.bpi"'}
{$ELSEIF DEFINED(VER230)}
  {$HPPEMIT '#pragma link "dxSkinGlassOceansRS16.bpi"'}
{$ELSEIF DEFINED(VER240)}
  {$HPPEMIT '#pragma link "dxSkinGlassOceansRS17.bpi"'}
{$ELSEIF DEFINED(VER250)}
  {$HPPEMIT '#pragma link "dxSkinGlassOceansRS18.bpi"'}
{$ELSEIF DEFINED(VER260)}
  {$HPPEMIT '#pragma link "dxSkinGlassOceansRS19.bpi"'}
{$ELSEIF DEFINED(VER270)}
  {$HPPEMIT '#pragma link "dxSkinGlassOceansRS20.bpi"'}
{$ELSEIF DEFINED(VER280)}
  {$HPPEMIT '#pragma link "dxSkinGlassOceansRS21.bpi"'}
{$ELSEIF DEFINED(VER290)}
  {$HPPEMIT '#pragma link "dxSkinGlassOceansRS22.bpi"'}
{$ELSEIF DEFINED(VER300)}
  {$HPPEMIT '#pragma link "dxSkinGlassOceansRS23.bpi"'}
{$ELSEIF DEFINED(VER310)}
  {$HPPEMIT '#pragma link "dxSkinGlassOceansRS24.bpi"'}
{$ELSEIF DEFINED(VER320)}
  {$HPPEMIT '#pragma link "dxSkinGlassOceansRS25.bpi"'}
{$ELSEIF DEFINED(VER330)}
  {$HPPEMIT '#pragma link "dxSkinGlassOceansRS26.bpi"'}
{$ELSEIF DEFINED(VER340)}
  {$HPPEMIT '#pragma link "dxSkinGlassOceansRS27.bpi"'}
{$ELSEIF DEFINED(VER350)}
  {$HPPEMIT '#pragma link "dxSkinGlassOceansRS28.bpi"'}
{$ELSEIF DEFINED(VER360)}
  {$HPPEMIT '#pragma link "dxSkinGlassOceansRS29.bpi"'}
{$ELSE}
  Unsupported
{$IFEND}
...
{$ELSEIF DEFINED(VER360)}
  {$HPPEMIT '#pragma link "dxSkinGlassOceansRS29.a"'}
{$ELSE}
  Unsupported
{$IFEND}
...
{$ELSEIF DEFINED(VER360)}
  {$HPPEMIT '#pragma link "dxSkinGlassOceansRS29.lib"'}
{$ELSE}
  Unsupported
{$IFEND}
...
const
  dxThisUnitName = 'dxSkinGlassOceans';
