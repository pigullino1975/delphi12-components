...
uses
  Types, Windows, Messages, SysUtils, Classes, Graphics, Controls, Forms, Dialogs, Menus, StdCtrls, ActnList, Math,
  ...
  dxRibbonCustomizationFormHelper, dxBarStrs, cxLabel, dxInputDialogs, dxForms, dxScrollbarAnnotations;
...
type
  ...
  protected
    ...
    function CreateHelper: TdxCustomRibbonCustomizationFormHelper; virtual;
...
function ShowRibbonCustomizationForm(ARibbon: TdxCustomRibbon; const AMode: TdxRibbonCustomizationFormMode;
...
const
  dxThisUnitName = 'dxRibbonCustomizationForm';

type
  TdxRibbonCustomizationFormClass = class of TdxRibbonCustomizationForm;
...
function ShowRibbonCustomizationForm(ARibbon: TdxCustomRibbon; const AMode: TdxRibbonCustomizationFormMode;
  ...
  function CreateCustomizationForm: TdxRibbonCustomizationForm;
  var
    AActualCustomizationFormClass: TdxRibbonCustomizationFormClass;
  begin
    if (ACustomizationFormClass = nil) or not ACustomizationFormClass.InheritsFrom(TdxRibbonCustomizationForm) then
      AActualCustomizationFormClass := TdxRibbonCustomizationForm
    else
      AActualCustomizationFormClass := TdxRibbonCustomizationFormClass(ACustomizationFormClass);

    if AMode = rcfmCustomizeRibbon then
      Result := AActualCustomizationFormClass.Create(ARibbon)
    else
      Result := AActualCustomizationFormClass.Create(ARibbon.QuickAccessToolbar);
  end;
...
function TdxRibbonCustomizationForm.CreateHelper: TdxCustomRibbonCustomizationFormHelper;
begin
  if IsRibbonCustomization then
    Result := TdxRibbonCustomizationFormHelper.Create(Ribbon, tlCommands, tlRibbon, cbCommands, cbRibbon)
  else
    Result := TdxRibbonQATCustomizationFormHelper.Create(Ribbon, tlCommands, tlRibbon, cbCommands, cbRibbon);
end;
