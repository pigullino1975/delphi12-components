...
type
  ...
  TfrmSpreadSheetConditionalFormattingDataBarRuleStyleEditDialogClass = class of TfrmSpreadSheetConditionalFormattingDataBarRuleStyleEditDialog;
...
var
  dxSpreadSheetConditionalFormattingDataBarRuleStyleEditDialogClass:
    TfrmSpreadSheetConditionalFormattingDataBarRuleStyleEditDialogClass =
    TfrmSpreadSheetConditionalFormattingDataBarRuleStyleEditDialog; 
...
function ShowConditionalFormattingDataBarRuleStyleEditDialog(
  AOwner: TObject; AStyle: TdxSpreadSheetConditionalFormattingRuleDataBarStyle): Boolean; overload; 
...
const
  dxThisUnitName = 'dxSpreadSheetConditionalFormattingDataBarRuleStyleEditDialog';
...
begin
  ...
  begin
    ADialog := dxSpreadSheetConditionalFormattingDataBarRuleStyleEditDialogClass.Create(AOwner.GetParentForm);
    try
