...
unit dxRichEdit.Export.OpenXML; // for internal use
...
uses
  System.ZLib,
  Types, SysUtils, Classes, StrUtils, Graphics, Generics.Defaults, Generics.Collections,
...
const
  dxThisUnitName = 'dxRichEdit.Export.OpenXML';
