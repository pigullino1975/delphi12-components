...
uses
  Types, SysUtils, Generics.Defaults, Generics.Collections, Classes, cxGeometry, dxCoreClasses, cxClasses, dxPDFBase,
  dxPDFTypes, dxPDFCore, dxPDFCharacterMapping, dxPDFFontEncoding, dxPDFText, dxFontFile;

type
  { TdxPDFType0FontDescriptor }

  TdxPDFType0FontDescriptor = class(TdxPDFCustomFontDescriptor) // for internal use
  protected
    CompactFontFileData: TBytes;
    OpenTypeFontFileData: TBytes;
  end;

  { TdxPDFType0Font }

  TdxPDFType0Font = class(TdxPDFCustomFont) // for internal use
  strict private
    FCIDToGIDMap: TSmallIntDynArray;
    FDefaultWidth: Integer;
    FSystemInfo: TdxPDFCIDSystemInfo;
    //
    function GetFontDescriptor: TdxPDFType0FontDescriptor;
  ...
  protected
    ...
    procedure DoReadWidths(ADictionary: TdxPDFReaderDictionary); override;
    ...
    //
    procedure WriteCIDToGIDMap(AHelper: TdxPDFWriterHelper; ADictionary: TdxPDFWriterDictionary); virtual;
  public
    ...
    function GetCharacterWidth(ACharCode: Integer): Double; override;
    //
    procedure SetWidths(ADictionary: TdxPDFIntegerDoubleDictionary);
    //
    property CIDToGIDMap: TSmallIntDynArray read FCIDToGIDMap;
    property DefaultWidth: Integer read FDefaultWidth;
    property FontDescriptor: TdxPDFType0FontDescriptor read GetFontDescriptor;
  end;

  { TdxPDFCIDType0FontDescriptor }

  TdxPDFCIDType0FontDescriptor = class(TdxPDFType0FontDescriptor) // for internal use
  protected
    FontFileData: TdxPDFType1FontFileData;
    //
    procedure DoRead(ADictionary: TdxPDFReaderDictionary); override;
    procedure Initialize; override;
    procedure WriteFontFile(AHelper: TdxPDFWriterHelper; ADictionary: TdxPDFWriterDictionary); override;
    //
    function GetSubtypeName: string; virtual;
    procedure ReadFontFile(ADictionary: TdxPDFReaderDictionary); virtual;
    //
    function WriteFontFileData(AHelper: TdxPDFWriterHelper; AData: TdxPDFType1FontFileData): TdxPDFObject;
  end;

  { TdxPDFCIDType0Font }

  TdxPDFCIDType0Font = class(TdxPDFType0Font) // for internal use
  strict private
    function GetFontDescriptor: TdxPDFCIDType0FontDescriptor;
  protected
    function CreateFontProgramFacade: TObject; override;
    function GetFontDescriptorClass: TdxPDFCustomFontDescriptorClass; override;
  public
    class function GetSubTypeName: string; override;
    //
    property FontDescriptor: TdxPDFCIDType0FontDescriptor read GetFontDescriptor;
  end;

  { TdxPDFCIDType2FontDescriptor }

  TdxPDFCIDType2FontDescriptor = class(TdxPDFType0FontDescriptor) // for internal use
  protected
    procedure SetFont(AFont: TdxPDFCustomFont);
    procedure DoRead(ADictionary: TdxPDFReaderDictionary); override;
    procedure WriteFontFile(AHelper: TdxPDFWriterHelper; ADictionary: TdxPDFWriterDictionary); override;
  public
    FontFileData: TBytes;
  ...
  TdxPDFCIDType2Font = class(TdxPDFType0Font) // for internal use
  strict private
    function GetFontDescriptor: TdxPDFCIDType2FontDescriptor;
    function GetFontFileData: TBytes;
    procedure SetFontFileData(const AValue: TBytes);
  protected
    function CreateFontProgramFacade: TObject; override;
    function GetFontDescriptorClass: TdxPDFCustomFontDescriptorClass; override;
    procedure WriteCIDToGIDMap(AHelper: TdxPDFWriterHelper; ADictionary: TdxPDFWriterDictionary); override;
  public
    class function GetSubTypeName: string; override;
    procedure SetOpenTypeCFFData(const AData: TBytes);
    //
    property FontFileData: TBytes read GetFontFileData write SetFontFileData;
    property FontDescriptor: TdxPDFCIDType2FontDescriptor read GetFontDescriptor;
  end;

  { TdxPDFDeferredCIDType2Font }

  TdxPDFDeferredCIDType2Font = class(TdxPDFCIDType2Font) // for internal use
  public
    constructor Create(const ABaseFont: string; AFontDescriptor: TdxPDFCIDType2FontDescriptor); reintroduce;
  end;

  { TdxPDFSimpleFont }

  TdxPDFSimpleFont = class(TdxPDFCustomFont) // for internal use
  strict private
    FFirstChar: Integer;
    FLastChar: Integer;
    FUseDefaultWidths: Boolean;
    //
    function CreateEncoding(AObject: TdxPDFBase): TdxPDFSimpleFontEncoding;
    function GetEncoding: TdxPDFSimpleFontEncoding;
  protected
    procedure DoRead(ADictionary: TdxPDFReaderDictionary); override;
    procedure DoReadWidths(ADictionary: TdxPDFReaderDictionary); override;
  ...
  public
    function GetCharacterWidth(ACharCode: Integer): Double; override;
    //
    property Encoding: TdxPDFSimpleFontEncoding read GetEncoding;
    property FirstChar: Integer read FFirstChar;
    property LastChar: Integer read FLastChar;
  end;

  { TdxPDFTrueTypeFontDescriptor }

  TdxPDFTrueTypeFontDescriptor = class(TdxPDFCustomFontDescriptor) // for internal use
  protected
    CompactFontFileData: TBytes;
    FontFileData: TBytes;
    OpenTypeFontFileData: TBytes;
    Type1FontFileData: TdxPDFType1FontFileData;
    //
    class procedure WriteFontData(AHelper: TdxPDFWriterHelper; ADictionary: TdxPDFWriterDictionary; const AData: TBytes);
    //
    procedure DoRead(ADictionary: TdxPDFReaderDictionary); override;
    procedure Initialize; override;
    procedure WriteFontFile(AHelper: TdxPDFWriterHelper; ADictionary: TdxPDFWriterDictionary); override;
  ...
  TdxPDFTrueTypeFont = class(TdxPDFSimpleFont) // for internal use
  strict private
    function GetFontDescriptor: TdxPDFTrueTypeFontDescriptor;
  protected
    function CreateFontProgramFacade: TObject; override;
    function GetFontDescriptorClass: TdxPDFCustomFontDescriptorClass; override;
  ...
  public
    class function GetSubTypeName: string; override;
    property FontDescriptor: TdxPDFTrueTypeFontDescriptor read GetFontDescriptor;
  end;

  { TdxPDFType3Font }

  TdxPDFType3Font = class(TdxPDFSimpleFont) // for internal use
  strict private
    FCharProcs: TdxPDFStringObjectDictionary<TdxPDFCommandList>;
    FFontBBox: TdxRectF;
    ...
    procedure WriteCharProcs(AHelper: TdxPDFWriterHelper; ADictionary: TdxPDFWriterDictionary);
  protected
    function CreateFontProgramFacade: TObject; override;
    function CreateValidatedMetrics: TdxPDFFontMetricsMetadata; override;
    function GetHeightFactor: Double; override;
    function GetWidthFactor: Double; override;
    function HasSizeAttributes: Boolean; override;
    procedure CreateSubClasses; override;
    procedure DestroySubClasses; override;
    procedure DoRead(ADictionary: TdxPDFReaderDictionary); override;
    procedure Write(AHelper: TdxPDFWriterHelper; ADictionary: TdxPDFWriterDictionary); override;
  ...
  public
    class function GetSubTypeName: string; override;
    //
    property CharProcs: TdxPDFStringObjectDictionary<TdxPDFCommandList> read FCharProcs;
  ...
  TdxPDFFontFactory = class(TdxPDFFactory<TdxPDFCustomFontClass>); // for internal use

function dxPDFFontFactory: TdxPDFFontFactory; // for internal use
function dxPDFUnicodeConverter: TdxPDFUnicodeConverter; // for internal use

implementation

uses
  RTLConsts, Windows, Math, StrUtils, dxCore, cxVariants, dxPDFParser, dxPDFCommand, dxPDFType1Font, dxPDFFontUtils,
  dxPDFUtils;

const
  dxThisUnitName = 'dxPDFFont';
...
type
  ...
  public
    class function Parse(const AData: TBytes; ARepository: TdxPDFCustomRepository; AResources: TdxPDFResources): TdxPDFCommandList;
  end;
...
class function TdxPDFType3FontContentStreamParser.Parse(const AData: TBytes;
  ARepository: TdxPDFCustomRepository; AResources: TdxPDFResources): TdxPDFCommandList;
var
...
begin
  ...
  begin
    ...
    FStandardFontDefaultWidthsMap.Add('Courier', GetCourierWidths);
    FStandardFontDefaultWidthsMap.Add('Courier,Bold', GetCourierBoldWidths);
    FStandardFontDefaultWidthsMap.Add('Courier,BoldItalic', GetCourierBoldObliqueWidths);
    FStandardFontDefaultWidthsMap.Add('Courier,Italic', GetCourierObliqueWidths);
    FStandardFontDefaultWidthsMap.Add('Courier-Bold', GetCourierBoldWidths);
    FStandardFontDefaultWidthsMap.Add('Courier-BoldItalic', GetCourierBoldObliqueWidths);
    FStandardFontDefaultWidthsMap.Add('Courier-Italic', GetCourierObliqueWidths);
    FStandardFontDefaultWidthsMap.Add('CourierPS-BoldItalicMT', GetCourierBoldObliqueWidths);
    FStandardFontDefaultWidthsMap.Add('CourierPS-BoldMT', GetCourierBoldWidths);
    FStandardFontDefaultWidthsMap.Add('CourierPS-ItalicMT', GetCourierObliqueWidths);
    FStandardFontDefaultWidthsMap.Add('CourierPSMT', GetCourierWidths);
...
class function TdxPDFType0Font.GetDictionary(ADictionary: TdxPDFReaderDictionary): TdxPDFReaderDictionary;
var
  AFont: TdxPDFType0Font;
begin
  AFont := TdxPDFType0Font.CreateEx(ADictionary.Repository);
  try
...
class function TdxPDFType0Font.GetSubTypeName: string;
begin
  Result := TdxPDFKeywords.FontType0;
end;

function TdxPDFType0Font.GetFontDescriptorDictionary(ADictionary: TdxPDFReaderDictionary): TdxPDFReaderDictionary;
var
...
procedure TdxPDFType0Font.CreateSubClasses;
begin
  inherited CreateSubClasses;
  SetEncoding(TdxPDFHorizontalIdentityEncoding.CreateEx(Repository));
  FSystemInfo := Repository.CreateCIDSystemInfo;
end;

procedure TdxPDFType0Font.DestroySubClasses;
begin
  FreeAndNil(FSystemInfo);
  inherited DestroySubClasses;
end;

procedure TdxPDFType0Font.DoRead(ADictionary: TdxPDFReaderDictionary);
var
  AFontDictionary: TdxPDFReaderDictionary;
begin
  inherited DoRead(ADictionary);
  AFontDictionary := GetFontDictionary(ADictionary);
  FCIDBaseFont := AFontDictionary.GetString(TdxPDFKeywords.BaseFont);
  TdxPDFObjectAccess(FSystemInfo).Read(AFontDictionary.GetDictionary(TdxPDFKeywords.CIDSystemInfo));
  ReadGlyphMap(AFontDictionary);
end;

procedure TdxPDFType0Font.Initialize;
begin
  inherited Initialize;
  FDefaultWidth := 1000;
end;

procedure TdxPDFType0Font.ReadEncoding(ASourceObject: TdxPDFBase);
begin
  SetEncoding(TdxPDFCompositeFontEncoding.Parse(Repository, ASourceObject));
end;

procedure TdxPDFType0Font.DoReadWidths(ADictionary: TdxPDFReaderDictionary);

  procedure AddWidth(ADictionary: TdxPDFIntegerDoubleDictionary; AKey: Integer; AWidth: Double);
  begin
    if not ADictionary.ContainsKey(AKey) then
      ADictionary.Add(AKey, AWidth);
  end;

  procedure ReadWidthArray(ADictionary: TdxPDFIntegerDoubleDictionary; AElementList: TdxPDFBaseList; var AStartIndex: Integer);
  var
    AValue: TdxPDFBase;
  begin
    ...
    begin
      if AValue.ObjectType in [otInteger, otDouble] then
        AddWidth(ADictionary, AStartIndex, TdxPDFNumericObjectAccess(AValue).InternalValue);
      Inc(AStartIndex);
    end;
    AStartIndex := -1;
  end;
...
var
  ...
  AWidths: TdxPDFIntegerDoubleDictionary;
begin
  FDefaultWidth := ADictionary.GetInteger(TdxPDFKeywords.DefaultWidth, 1000);
  ...
  begin
    AStartIndex := -1;
    AEndIndex := -1;
    AWidths := TdxPDFIntegerDoubleDictionary.Create;
    try
      for J := 0 to AWidthArray.Count - 1 do
      begin
        AValue := AWidthArray.ElementList[J];
        if AStartIndex < 0 then
        begin
          if TdxPDFUtils.IsReference(AValue) then
            AStartIndex := Repository.GetInteger(TdxPDFReference(AValue).Number).Value
          else
              ...
              otIndirectReference:
                begin
                  ...
                  if AArrayObject is TdxPDFArray then
                    ReadWidthArray(AWidths, TdxPDFArray(AArrayObject).ElementList, AStartIndex)
                  else
                    AEndIndex := Repository.GetInteger(TdxPDFReference(AValue).Number).Value;
                end;
              otArray:
                ReadWidthArray(AWidths, TdxPDFArray(AValue).ElementList, AStartIndex);
            end
          else
          begin
            if TdxPDFUtils.IsReference(AValue) then
              AValue := Repository.GetNumericObject(TdxPDFReference(AValue).Number);
            if AValue is TdxPDFNumericObject then
            begin
              AWidth := TdxPDFDouble(AValue).Value;
              for I := AStartIndex to AEndIndex do
                AddWidth(AWidths, I, AWidth);
            end;
            AStartIndex := -1;
            AEndIndex := -1;
          end;
...
procedure TdxPDFType0Font.Write(AHelper: TdxPDFWriterHelper; ADictionary: TdxPDFWriterDictionary);

  function CreateWidthsArray: TdxPDFArray;
  var
    AWidth: Double;
    AWidthArray: TdxPDFArray;
    I, APrevGlyphIndex: Integer;
    AIsNewSequence: Boolean;
  begin
    AWidthArray := nil;
    APrevGlyphIndex := -2;
    ...
    begin
      AWidth := FWidths[I];
      if AWidth <> DefaultWidth then
      begin
        AIsNewSequence := I > APrevGlyphIndex + 1;
        if AIsNewSequence then
        begin
          AWidthArray := AHelper.CreateArray;
          AWidthArray.Add(AWidth);
          Result.Add(I);
          Result.Add(AWidthArray);
        end
        else
          AWidthArray.Add(AWidth);
        APrevGlyphIndex := I;
  ...
  function CreateDescendantFontsDictionary: TdxPDFObject;
  var
    ADescendantFontDictionary: TdxPDFWriterDictionary;
  begin
    ADescendantFontDictionary := AHelper.CreateDictionary;
    ADescendantFontDictionary.AddName(TdxPDFKeywords.TypeKey, GetTypeName);
    ADescendantFontDictionary.AddName(TdxPDFKeywords.Subtype, GetSubTypeName);
    ADescendantFontDictionary.AddName(TdxPDFKeywords.BaseFont, FCIDBaseFont, False);
    ADescendantFontDictionary.AddReference(TdxPDFKeywords.FontDescriptor, FontDescriptor);
    ADescendantFontDictionary.AddReference(TdxPDFKeywords.CIDSystemInfo, FSystemInfo);
    ADescendantFontDictionary.Add(TdxPDFKeywords.DefaultWidth, FDefaultWidth);
    ADescendantFontDictionary.Add(TdxPDFKeywords.ShortWidths, CreateWidthsArray);
    WriteCIDToGIDMap(AHelper, ADescendantFontDictionary);
    Result := AHelper.CreateIndirectObject(ADescendantFontDictionary);
  end;

  function CreateInlineArray: TdxPDFWriterArray;
  begin
    Result := AHelper.CreateArray;
    Result.AddReference(CreateDescendantFontsDictionary);
  end;

begin
  inherited Write(AHelper, ADictionary);
  ADictionary.AddName(TdxPDFKeywords.BaseFont, FCIDBaseFont, False);
  ADictionary.AddName(TdxPDFKeywords.Subtype, TdxPDFKeywords.FontType0);
  ADictionary.Add(TdxPDFKeywords.DescendantFonts, CreateInlineArray);
end;

procedure TdxPDFType0Font.WriteCIDToGIDMap(AHelper: TdxPDFWriterHelper; ADictionary: TdxPDFWriterDictionary);
var
  AData: TBytes;
  I, ALength, AIndex: Integer;
  AValue: SmallInt;
begin
  if CIDToGIDMap = nil then
    Exit;
  AIndex := 0;
  ALength := Length(CIDToGIDMap);
  SetLength(AData, 2 * ALength);
  for I := 0 to ALength - 1 do
  begin
    AValue := CIDToGIDMap[I];
    AData[AIndex] := AValue shr 8;
    AData[AIndex + 1] := AValue mod 256;
    Inc(AIndex, 2);
  end;
  ADictionary.AddReference(TdxPDFKeywords.CIDToGIDMap, AData);
end;

function TdxPDFType0Font.GetFontDescriptor: TdxPDFType0FontDescriptor;
begin
  Result := FFontDescriptor as TdxPDFType0FontDescriptor;
end;

procedure TdxPDFType0Font.ReadGlyphMap(ADictionary: TdxPDFReaderDictionary);
var
  AValue: TdxPDFBase;
...
function TdxPDFType0Font.CreateFontProgramFacade: TObject;
begin
  Result := nil;
end;

function TdxPDFType0Font.GetFontDictionary(ADictionary: TdxPDFReaderDictionary): TdxPDFReaderDictionary;
var
...
begin
  ...
  if (ADescendantFonts = nil) or (ADescendantFonts.Count <> 1) then
    TdxPDFUtils.RaiseTestException('TdxPDFType0Font.Parse');
...
function TdxPDFType0Font.GetFontDescriptorClass: TdxPDFCustomFontDescriptorClass;
begin
  Result := TdxPDFType0FontDescriptor;
end;

function TdxPDFType0Font.GetCharacterWidth(ACharCode: Integer): Double;
begin
  if (FDefaultWidth = 0) and (FontDescriptor <> nil) then
    Result := FontDescriptor.AvgWidth
  else
    Result := FDefaultWidth;
  if InRange(ACharCode, 0, Length(FWidths) - 1) then
    Result := FWidths[ACharCode];
end;

procedure TdxPDFType0Font.SetWidths(ADictionary: TdxPDFIntegerDoubleDictionary);
var
  AMaxGlyphIndex, AKey, AGlyphCount, I: Integer;
  AWidth: Double;
begin
  AMaxGlyphIndex := 0;
  for AKey in ADictionary.Keys do
    AMaxGlyphIndex := Max(AKey, AMaxGlyphIndex);
  AGlyphCount := AMaxGlyphIndex + 1;
  SetLength(FWidths, AGlyphCount);
  for I := 0 to AGlyphCount - 1 do
  begin
    if not ADictionary.TryGetValue(I, AWidth) then
...
procedure TdxPDFCIDType0FontDescriptor.DoRead(ADictionary: TdxPDFReaderDictionary);
begin
  inherited DoRead(ADictionary);
  ReadFontFile(ADictionary);
end;

procedure TdxPDFCIDType0FontDescriptor.Initialize;
begin
  inherited Initialize;
  FontFileData.Reset;
end;

procedure TdxPDFCIDType0FontDescriptor.WriteFontFile(AHelper: TdxPDFWriterHelper; ADictionary: TdxPDFWriterDictionary);
var
  AFontFileDictionary: TdxPDFWriterDictionary;
begin
  inherited WriteFontFile(AHelper, ADictionary);
  if not WriteOpenTypeFontData(AHelper, ADictionary, OpenTypeFontFileData) then
  begin
    if FontFileData.IsNull then
    begin
      if Length(CompactFontFileData) > 0 then
      begin
        AFontFileDictionary := AHelper.CreateDictionary;
        AFontFileDictionary.AddName(TdxPDFKeywords.Subtype, GetSubtypeName);
        ADictionary.AddReference(TdxPDFKeywords.FontFile3, AHelper.CreateStream(AFontFileDictionary, CompactFontFileData));
      end;
    end
    else
      ADictionary.AddReference(TdxPDFKeywords.FontFile3, WriteFontFileData(AHelper, FontFileData));
  end;
end;

function TdxPDFCIDType0FontDescriptor.GetSubtypeName: string;
begin
  Result := TdxPDFKeywords.CIDFontType0C;
end;

procedure TdxPDFCIDType0FontDescriptor.ReadFontFile(ADictionary: TdxPDFReaderDictionary);
var
...
begin
  ...
  begin
    ...
    AFont := Font;
    if FontFileData.IsNull and not (AFont.Encoding is TdxPDFPredefinedCompositeFontEncoding) and
      not (AFont.Encoding is TdxPDFCustomIdentityEncoding) then
        TdxPDFUtils.Abort;
  end
  else
  begin
    ...
    begin
      ...
      CompactFontFileData := TdxFontFileHelper.GetCFFData(AStream.UncompressedData);
  end;
end;

function TdxPDFCIDType0FontDescriptor.WriteFontFileData(AHelper: TdxPDFWriterHelper;
  AData: TdxPDFType1FontFileData): TdxPDFObject;
var
  AFontFileDictionary: TdxPDFWriterDictionary;
begin
  AFontFileDictionary := AHelper.CreateDictionary;
  AFontFileDictionary.Add(TdxPDFKeywords.Length1, AData.PlainTextLength);
  AFontFileDictionary.Add(TdxPDFKeywords.Length2, AData.CipherTextLength);
  AFontFileDictionary.Add(TdxPDFKeywords.Length3, AData.NullSegmentLength);
  Result := AHelper.CreateStream(AFontFileDictionary, AData.Data);
end;
...
function TdxPDFCIDType0Font.CreateFontProgramFacade: TObject;
begin
  if FontDescriptor.CompactFontFileData <> nil then
    Result := TdxPDFCFFFontProgramFacade.CreateForType0Font(Self, FontDescriptor.CompactFontFileData)
  else
    if not FontDescriptor.FontFileData.IsNull then
      Result := TdxPDFType1FontProgramFacade.CreateForType0Font(Self, FontDescriptor.FontFileData)
    else
      Result := TdxPDFNonEmbeddedFontProgramFacade.CreateForType0Font(Self);
end;

function TdxPDFCIDType0Font.GetFontDescriptorClass: TdxPDFCustomFontDescriptorClass;
begin
  Result := TdxPDFCIDType0FontDescriptor;
end;

function TdxPDFCIDType0Font.GetFontDescriptor: TdxPDFCIDType0FontDescriptor;
begin
  Result := FFontDescriptor as TdxPDFCIDType0FontDescriptor;
end;

{ TdxPDFCIDType2FontDescriptor }

procedure TdxPDFCIDType2FontDescriptor.SetFont(AFont: TdxPDFCustomFont);
begin
  FParent := AFont;
  if AFont.BaseFont <> '' then
    FontName := AFont.BaseFont;
end;

procedure TdxPDFCIDType2FontDescriptor.DoRead(ADictionary: TdxPDFReaderDictionary);
var
  AStream: TdxPDFStream;
begin
  inherited DoRead(ADictionary);
  ...
  if AStream = nil then
  begin
    OpenTypeFontFileData := GetOpenTypeFontFileData(ADictionary, False);
    if OpenTypeFontFileData <> nil then
      CompactFontFileData := TdxFontFileHelper.GetCFFData(OpenTypeFontFileData);
  end
  else
  begin
    if AStream.Dictionary.GetString(TdxPDFKeywords.Subtype) = TdxPDFKeywords.Type1C then
      CompactFontFileData := AStream.UncompressedData
    else
    begin
      FontFileData := AStream.UncompressedData;
      if Length(FontFileData) > 0 then
        CompactFontFileData := TdxFontFileHelper.GetCFFData(FontFileData);
    end;
  end;
end;

procedure TdxPDFCIDType2FontDescriptor.WriteFontFile(AHelper: TdxPDFWriterHelper; ADictionary: TdxPDFWriterDictionary);
begin
  if Length(FontFileData) = 0 then
  begin
    if (Length(OpenTypeFontFileData) = 0) and (Length(CompactFontFileData) > 0) then
      ADictionary.AddReference(TdxPDFKeywords.FontFile2, CompactFontFileData)
    else
      WriteOpenTypeFontData(AHelper, ADictionary, OpenTypeFontFileData);
  end
  else
    TdxPDFTrueTypeFontDescriptor.WriteFontData(AHelper, ADictionary, FontFileData);
end;
...
procedure TdxPDFCIDType2Font.SetOpenTypeCFFData(const AData: TBytes);
begin
  FontDescriptor.FontFileData := AData;
  FontDescriptor.CompactFontFileData := TdxFontFile.GetCFFData(AData);
  FreeAndNil(FFontProgramFacade);
  FFontProgramFacade := TdxPDFCFFFontProgramFacade.CreateForType0Font(Self, FontDescriptor.CompactFontFileData);
end;

function TdxPDFCIDType2Font.CreateFontProgramFacade: TObject;
var
  AData: TBytes;
begin
  if FontDescriptor.CompactFontFileData <> nil then
    ...
    if (FontDescriptor.FontFileData <> nil) or (FontDescriptor.OpenTypeFontFileData <> nil) then
    begin
      if Length(FontDescriptor.FontFileData) > 0 then
        AData := FontDescriptor.FontFileData
      else
        AData := FontDescriptor.OpenTypeFontFileData;
      Result := TdxPDFTrueTypeFontProgramFacade.CreateForType0Font(Self, AData);
    end
    else
      Result := TdxPDFNonEmbeddedFontProgramFacade.CreateForType0Font(Self);
end;

function TdxPDFCIDType2Font.GetFontDescriptor: TdxPDFCIDType2FontDescriptor;
begin
  Result := FFontDescriptor as TdxPDFCIDType2FontDescriptor;
end;

function TdxPDFCIDType2Font.GetFontDescriptorClass: TdxPDFCustomFontDescriptorClass;
begin
  Result := TdxPDFCIDType2FontDescriptor;
end;

function TdxPDFCIDType2Font.GetFontFileData: TBytes;
begin
  Result := FontDescriptor.FontFileData;
end;

procedure TdxPDFCIDType2Font.SetFontFileData(const AValue: TBytes);
begin
  FontDescriptor.FontFileData := AValue;
  FreeAndNil(FFontProgramFacade);
  FFontProgramFacade := TdxPDFTrueTypeFontProgramFacade.CreateForType0Font(Self, FontDescriptor.FontFileData);
end;

procedure TdxPDFCIDType2Font.WriteCIDToGIDMap(AHelper: TdxPDFWriterHelper; ADictionary: TdxPDFWriterDictionary);
begin
  inherited WriteCIDToGIDMap(AHelper, ADictionary);
  if CIDToGIDMap = nil then
    ADictionary.AddName(TdxPDFKeywords.CIDToGIDMap, TdxPDFKeywords.Identity);
end;

{ TdxPDFSimpleFont }

function TdxPDFSimpleFont.GetCharacterWidth(ACharCode: Integer): Double;
var
  AIndex, ALength: Integer;
begin
  ALength := Length(FWidths);
  AIndex := ACharCode - FFirstChar;
  if (ALength = 0) or (AIndex < 0) or (AIndex >= ALength) then
  begin
    if FontDescriptor <> nil then
      Result := FontDescriptor.MissingWidth
    else
      Result := 0;
  end
  else
...
procedure TdxPDFSimpleFont.DoRead(ADictionary: TdxPDFReaderDictionary);
begin
...
procedure TdxPDFSimpleFont.DoReadWidths(ADictionary: TdxPDFReaderDictionary);

  procedure AddWidth(AValue: Double);
  begin
    TdxPDFUtils.AddValue(AValue, FWidths);
  end;
...
begin
  ...
  begin
    ...
    begin
      ...
      FUseDefaultWidths := AWidthsDictionary <> nil;
      if FUseDefaultWidths then
      begin
        J := Byte(FFirstChar);
        for I := 0 to FLastChar - FFirstChar do
        begin
          AddWidth(0);
          AGlyphName := Encoding.GetGlyphName(J);
          if AGlyphName <> '' then
          begin
    ...
    for I := 0 to AWidthArray.Count - 1 do
      AddWidth(TdxPDFUtils.ConvertToDouble(AWidthArray[I]));
end;

procedure TdxPDFSimpleFont.ReadEncoding(AObject: TdxPDFBase);
begin
  SetEncoding(CreateEncoding(AObject));
end;

procedure TdxPDFSimpleFont.Write(AHelper: TdxPDFWriterHelper; ADictionary: TdxPDFWriterDictionary);
begin
  inherited Write(AHelper, ADictionary);
  ADictionary.Add(TdxPDFKeywords.FirstChar, FirstChar);
  ADictionary.Add(TdxPDFKeywords.LastChar, LastChar);
  if not FUseDefaultWidths then
    ADictionary.Add(TdxPDFKeywords.Widths, FWidths);
end;
...
function TdxPDFSimpleFont.CreateEncoding(AObject: TdxPDFBase): TdxPDFSimpleFontEncoding;

  function CreateByBaseFontName: TdxPDFSimpleFontEncoding;
  var
    AClass: TdxPDFObjectClass;
  begin
    if BaseFont = TdxPDFKeywords.SymbolFontName then
      AClass := TdxPDFSymbolEncoding
    else
      if BaseFont = TdxPDFKeywords.ZapfDingbatsFontName then
        AClass := TdxPDFZapfDingbatsEncoding
      else
        AClass := TdxPDFStandardEncoding;
    Result := Repository.CreateObject(AClass) as TdxPDFSimpleFontEncoding;
  end;

  function CreateByEncodingName(const AName: string): TdxPDFSimpleFontEncoding;
  var
    AClass: TdxPDFObjectClass;
  begin
    if not dxPDFTryGetDocumentObjectClass(AName, AClass) or not AClass.InheritsFrom(TdxPDFSimpleFontEncoding) then
      AClass := TdxPDFStandardEncoding;
    Result := AClass.CreateEx(Repository) as TdxPDFSimpleFontEncoding;
  end;

var
  ABaseEncoding: TdxPDFBase;
...
begin
  if AObject <> nil then
    case AObject.ObjectType of
      otDictionary:
        begin
          ADictionary := TdxPDFReaderDictionary(AObject);
          ABaseEncoding := ADictionary.GetObject(TdxPDFKeywords.BaseEncoding);
          if ABaseEncoding <> nil then
          begin
            case ABaseEncoding.ObjectType of
              otString, otName:
                AEncodingName := TdxPDFString(ABaseEncoding).Value;
              otDictionary:
                AEncodingName := TdxPDFDictionary(ABaseEncoding).GetString(TdxPDFKeywords.BaseEncoding);
            else
              Exit(CreateByBaseFontName);
            end;
            Result := CreateByEncodingName(AEncodingName);
          end
          else
            Result := CreateByBaseFontName;
          TdxPDFObjectAccess(Result).Read(ADictionary);
        end;
      otName, otString:
        Result := CreateByEncodingName(TdxPDFString(AObject).Value);
    else
      Result := nil;
    end
  else
...
function TdxPDFSimpleFont.GetEncoding: TdxPDFSimpleFontEncoding;
begin
  Result := inherited Encoding as TdxPDFSimpleFontEncoding;
end;

{ TdxPDFTrueTypeFontDescriptor }

class procedure TdxPDFTrueTypeFontDescriptor.WriteFontData(
  AHelper: TdxPDFWriterHelper; ADictionary: TdxPDFWriterDictionary; const AData: TBytes);
var
  AFontFileDictionary: TdxPDFWriterDictionary;
begin
  AFontFileDictionary := AHelper.CreateDictionary;
  AFontFileDictionary.Add(TdxPDFKeywords.Length1, Length(AData));
  ADictionary.AddReference(TdxPDFKeywords.FontFile2, AHelper.CreateStream(AFontFileDictionary, AData));
end;

procedure TdxPDFTrueTypeFontDescriptor.DoRead(ADictionary: TdxPDFReaderDictionary);

  function TryReadCompactFontFileData(const AData: TBytes): TBytes;
  var
    AFontProgram: TdxType1FontCompactFontProgram;
  begin
    SetLength(Result, 0);
    AFontProgram := TdxType1FontCompactFontProgram.Parse(AData);
    if AFontProgram <> nil then
      try
        if AFontProgram.Validate then
          Result := TdxPDFCompactFontFormatTopDictIndexWriter.Write(AFontProgram);
      finally
        AFontProgram.Free;
      end;
  end;
...
begin
  inherited DoRead(ADictionary);
  if ADictionary.TryGetStream(TdxPDFKeywords.FontFile2, AStream) then
  begin
    AData := AStream.UncompressedData;
    if TdxFontFileHelper.IsOpenType(AData) then
    begin
      OpenTypeFontFileData := AData;
      CompactFontFileData := TdxFontFileHelper.GetCFFData(OpenTypeFontFileData);
    end
    else
    begin
      FontFileData := AData;
      if TdxPDFType1FontFileData.IsPfbData(AData) then
        Type1FontFileData := TdxPDFType1FontFileData.Create(AData, Length(AData), 0, 0);
    end;
  end
  else
  begin
    ...
    begin
      ...
      if AStream <> nil then
      begin
        if (AStream.Dictionary <> nil) and (AStream.Dictionary.GetString(TdxPDFKeywords.Subtype) <> TdxPDFKeywords.Type1C) then
          TdxPDFUtils.Abort;
        AData := AStream.UncompressedData;
        try
          TryReadCompactFontFileData(AData);
          CompactFontFileData := AData;
        except
          Type1FontFileData := TdxPDFType1FontFileData.Create(AData, Length(AData), 0, 0);
        end;
      end;
...
procedure TdxPDFTrueTypeFontDescriptor.Initialize;
begin
  inherited Initialize;
  Type1FontFileData.Reset;
end;

procedure TdxPDFTrueTypeFontDescriptor.WriteFontFile(AHelper: TdxPDFWriterHelper; ADictionary: TdxPDFWriterDictionary);
begin
  if Length(FontFileData) = 0 then
    WriteOpenTypeFontData(AHelper, ADictionary, OpenTypeFontFileData)
  else
    WriteFontData(AHelper, ADictionary, FontFileData);
end;
...
function TdxPDFTrueTypeFont.CreateFontProgramFacade: TObject;
begin
  if FontDescriptor.CompactFontFileData <> nil then
    Result := TdxPDFCFFFontProgramFacade.CreateForSimpleFont(Self, FontDescriptor.CompactFontFileData)
  else
    if not FontDescriptor.Type1FontFileData.IsNull then
    begin
      if TdxFontFileHelper.IsTrueType(FontDescriptor.Type1FontFileData.Data) then
        try
          Exit(TdxPDFTrueTypeFontProgramFacade.CreateForSimpleFont(Self, FontDescriptor.Type1FontFileData.Data));
        except
        end;
      Result := TdxPDFType1FontProgramFacade.CreateForSimpleFont(Self, FontDescriptor.Type1FontFileData);
    end
    else
      if FontDescriptor.FontFileData <> nil then
        Result := TdxPDFTrueTypeFontProgramFacade.CreateForSimpleFont(Self, FontDescriptor.FontFileData)
      else
        Result := TdxPDFNonEmbeddedFontProgramFacade.CreateForSimpleFont(Self);
end;

function TdxPDFTrueTypeFont.GetFontDescriptorClass: TdxPDFCustomFontDescriptorClass;
begin
  Result := TdxPDFTrueTypeFontDescriptor;
end;
...
function TdxPDFTrueTypeFont.GetFontDescriptor: TdxPDFTrueTypeFontDescriptor;
begin
  Result := FFontDescriptor as TdxPDFTrueTypeFontDescriptor;
end;
...
begin
  Result := TdxPDFKeywords.FontType3;
end;

function TdxPDFType3Font.CreateFontProgramFacade: TObject;
begin
  Result := nil;
end;

function TdxPDFType3Font.CreateValidatedMetrics: TdxPDFFontMetricsMetadata;
var
  AAscent, ADescent: Double;
  ABBox: TdxRectF;
  ACharProc: TPair<string, TdxPDFCommandList>;
...
begin
  AAscent := 0;
  ADescent := 0;
  if not TdxPDFUtils.IsRectEmpty(FontBBox) then
  begin
    AAscent := FontBBox.Top;
    ADescent := FontBBox.Bottom;
  end;
  for ACharProc in CharProcs do
    ...
    begin
      ...
      if (ACommands.Count > 0) and (ACommands[0] is TdxPDFSetCacheDeviceCommand) then
        begin
          ...
          AAscent := Max(AAscent, ABBox.Top);
          ADescent := Min(ADescent, ABBox.Bottom);
        end
        else
          if (AAscent = 0) and (ADescent = 0) then
            for I  := 0 to ACommands.Count - 1 do
              ...
              begin
                ...
                AAscent := Max(AAscent, AModifyTransformationMatrixCommand.Matrix.D);
              end;
      end;
  Result := TdxPDFFontMetricsMetadata.Create(AAscent, ADescent, 1 / WidthFactor, 0);
end;
...
function TdxPDFType3Font.HasSizeAttributes: Boolean;
begin
  Result := False;
end;
...
begin
  ...
  FCharProcs := TdxPDFStringObjectDictionary<TdxPDFCommandList>.Create([doOwnsValues]);
  FResources := nil;
end;
...
procedure TdxPDFType3Font.DoRead(ADictionary: TdxPDFReaderDictionary);
begin
  inherited DoRead(ADictionary);
  FFontBBox := ADictionary.GetRectangle(TdxPDFKeywords.FontDescriptorBBox);
  ExchangeSingle(FFontBBox.Top, FFontBBox.Bottom);
...
procedure TdxPDFType3Font.Write(AHelper: TdxPDFWriterHelper; ADictionary: TdxPDFWriterDictionary);
begin
  inherited Write(AHelper, ADictionary);
  ADictionary.Add(TdxPDFKeywords.FontDescriptorBBox, FFontBBox, True, False);
  ADictionary.Add(TdxPDFKeywords.FontMatrix, FMatrix, False);
  ADictionary.AddReference(TdxPDFKeywords.Resources, Resources);
  WriteCharProcs(AHelper, ADictionary);
end;
...
procedure TdxPDFType3Font.WriteCharProcs(AHelper: TdxPDFWriterHelper; ADictionary: TdxPDFWriterDictionary);
var
  ACharProcsDictionary: TdxPDFWriterDictionary;
  APair: TPair<string, TdxPDFCommandList>;
begin
  if CharProcs.Count = 0 then
    Exit;
  ACharProcsDictionary := AHelper.CreateDictionary;
  for APair in FCharProcs do
    ACharProcsDictionary.AddReference(APair.Key, APair.Value.ToByteArray(AHelper.Context), False);
  ADictionary.Add(TdxPDFKeywords.CharProcs, ACharProcsDictionary);
end;

{ TdxPDFDeferredCIDType2Font }

constructor TdxPDFDeferredCIDType2Font.Create(const ABaseFont: string; AFontDescriptor: TdxPDFCIDType2FontDescriptor);
begin
  inherited Create(nil);
  FBaseFont := ABaseFont;
  FCIDBaseFont := FBaseFont;
  ReadFontName;
  SetFontDescriptor(AFontDescriptor);
  AFontDescriptor.SetFont(Self);
end;
