...
const
  dxThisUnitName = 'dxServerModeSQLAdapters';
...
function TdxServerModeMSSQLAdapter.GetMaximumStringSize: Integer;
begin
  Result := 4000;
end;
...
function TdxServerModeMySQLAdapter.GetMaximumStringSize: Integer;
begin
  Result := 255;
end;
...
function TdxServerModeFirebirdAdapter.GetMaximumStringSize: Integer;
begin
  Result := 4000;
end;
...
function TdxServerModeInterBaseAdapter.GetMaximumStringSize: Integer;
begin
  Result := 4000;
end;
...
function TdxServerModeOracleAdapter.GetMaximumStringSize: Integer;
begin
  Result := 2000;
end;
...
function TdxServerModePostgreSQLAdapter.GetMaximumStringSize: Integer;
begin
  Result := 4000;
end;
...
function TdxServerModeAdvantageAdapter.GetMaximumStringSize: Integer;
begin
  Result := 4000;
end;
...
function TdxServerModeMSAccessAdapter.GetMaximumStringSize: Integer;
begin
 Result := 255;
end;
...
function TdxServerModeSQLiteAdapter.GetMaximumStringSize: Integer;
begin
  Result := 800;
end;
