...
unit dxRichEdit.DocumentModel.TableCalculator; // for internal use
...
type
  ...
  protected
    function CalculateCellWidthsInfo(ACell: TdxTableCell; APercentBaseWidth: Integer): TdxWidthsInfo;
    procedure EnlargeColumnsHorizontalMargins(AGrid: TdxTableGrid; AStartColumnIndex, AEndColumnIndex, AOldWidth, ANewWidth: TdxLayoutUnit);
    function CreateTableGridInterval(AUnitConverter: TdxDocumentModelUnitToLayoutUnitConverter; AWidth: TdxWidthUnit; AColumnSpan: Integer): TdxTableGridInterval;
    function CreateIntervals(ARow: TdxTableRow): TdxTableGridIntervalList;
    procedure ConvertToIntervals(ACells: TdxTableCellCollection; AIntervals: TdxTableGridIntervalList; AUnitConverter: TdxDocumentModelUnitToLayoutUnitConverter);
    function CalculateTableGridCore(ACurrentRow, ANextRow: TdxTableGridIntervalList; APercentBaseWidth: Integer): TdxTableGridIntervalList;
    function CalculateTableGridPartially(ACurrentRow, ANextRow: TdxTableGridIntervalList; APercentBaseWidth: Integer): TdxTableGridIntervalList;
    function CanUseCachedTableLayoutInfo(ATableLayoutInfo: TdxTableLayoutInfo; APercentBaseWidth: TdxLayoutUnit): Boolean;
    procedure ReplaceCachedTableLayoutInfoIfNeeded(ATable: TdxTable; ATableGrid: TdxTableGrid; APercentBaseWidth: TdxLayoutUnit);
  public
...
const
  dxThisUnitName = 'dxRichEdit.DocumentModel.TableCalculator';

type

  { TdxAutofitTableLayoutCalculator }

  TdxAutofitTableLayoutCalculator = class sealed
  private
    class procedure CompressProportionallyWidthCore(AGrid: TdxTableGrid; AItems: TdxIntegerList; ATotalItemsWidth,  ADeltaTableWidth: TdxLayoutUnit); static;
  public
    class procedure CompressTableGrid(AGrid: TdxTableGrid; AStartIndex, AEndIndex: Integer; ANewTableWidth: TdxLayoutUnit); static;
    class procedure EnlargeProportionallyAverageWidth(AGrid: TdxTableGrid; AStartIndex, AEndIndex: Integer; ANewWidth: TdxLayoutUnit); static;
    class procedure ChangeColumnsProportionally(AGrid: TdxTableGrid; AStartIndex, AEndIndex: Integer; AInitialWidth, ANewWidth: TdxLayoutUnit); static;
  end;

  TdxTableGridCalculatorCompressHelper = record
  public type
...
class procedure TdxAutofitTableLayoutCalculator.CompressTableGrid(AGrid: TdxTableGrid;
...
class procedure TdxAutofitTableLayoutCalculator.EnlargeProportionallyAverageWidth(AGrid: TdxTableGrid;
...
class procedure TdxAutofitTableLayoutCalculator.ChangeColumnsProportionally(AGrid: TdxTableGrid; AStartIndex, AEndIndex: Integer;
...
class procedure TdxAutofitTableLayoutCalculator.CompressProportionallyWidthCore(AGrid: TdxTableGrid; AItems: TdxIntegerList; ATotalItemsWidth,  ADeltaTableWidth: TdxLayoutUnit);
var
  I, AColCount: Integer;
...
var
  ...
  AContentInfo, AExistingStartSummaryInfo, ANewSummaryInfo, AExistingEndSummaryInfo: TdxWidthsContentInfo;
begin
  ...
  try
    ...
    begin
      ...
      ANewSummaryInfo := TdxWidthsContentInfo.Create(AExistingStartSummaryInfo.MinWidth + AContentInfo.MinWidth,
      ...
      begin
        ...
        if (ANewSummaryInfo.MinWidth <= AExistingEndSummaryInfo.MinWidth) and
          (ANewSummaryInfo.MaxWidth <= AExistingEndSummaryInfo.MaxWidth) then
          Break;
        ASummaryWidths[I] := TdxWidthsContentInfo.Create(Max(AExistingEndSummaryInfo.MinWidth, ANewSummaryInfo.MinWidth),
          Max(AExistingEndSummaryInfo.MaxWidth, ANewSummaryInfo.MaxWidth));
      end;
    end;
...
{ TdxTableGridCalculatorCompressHelper }

constructor TdxTableGridCalculatorCompressHelper.Create(ATable: TdxTable; AResult: TdxTableGrid);
begin
  FTable := ATable;
  FResult := AResult;
...
procedure TdxTableGridCalculatorCompressHelper.InitMatrices;
var
...
function TdxTableGridCalculatorCompressHelper.Work: TIntegerDynArray;
var
  I, J: Integer;
begin
  for I := 0 to FColsCount - 1 do
...
procedure TdxTableGridCalculatorCompressHelper.MarkColumn(ACol: Integer);
var
  I, J: Integer;
begin
  for I := 0 to FRowsCount - 1 do
...
begin
  ...
  begin
    ...
    TdxAutofitTableLayoutCalculator.CompressTableGrid(Result, 0, Result.Columns.Count - 1, ANewWidth);
  end;

  AMargins := TdxTableGridCalculatorCompressHelper.Create(ATable, Result).Work;
...
begin
  ...
  try
    ...
    repeat
      ...
      ARestMasterInterval := TdxTableGridIntervalIterator.SubstructIntervals(ARestMasterInterval, ASlaveInterval,
