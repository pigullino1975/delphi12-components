...
type
  ...
  {$REGION 'Rectangles'}
    ...
    class function GetRectanglePoints(AWidth, AHeight: Single; const ARoundings: TRectangleParameter<Single>;
      const AArcs: TRectangleParameter<TdxNullableValue<TdxSweepDirectionKind>>): TdxShapeGeometry; overload; static;
    class procedure AddRectangleSegment(ASegments: TdxGPPath; const ALastPoint, AEnd: TdxPointF;
      const ASweepDirection: TdxNullableValue<TdxSweepDirectionKind>); static;
...
const
  dxThisUnitName = 'dxFlowChartShapeDescriptions.Code';
...
class function TdxBasicCodeShapes.GetRectanglePoints(AWidth, AHeight: Single;
  const ARoundings: TRectangleParameter<Single>;
  const AArcs: TRectangleParameter<TdxNullableValue<TdxSweepDirectionKind>>): TdxShapeGeometry;
var
...
class procedure TdxBasicCodeShapes.AddRectangleSegment(ASegments: TdxGPPath; const ALastPoint, AEnd: TdxPointF;
  const ASweepDirection: TdxNullableValue<TdxSweepDirectionKind>);
begin
