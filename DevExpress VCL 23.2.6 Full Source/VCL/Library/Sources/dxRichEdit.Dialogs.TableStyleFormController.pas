...
uses
  SysUtils, Classes, Graphics, Types, Generics.Defaults, Generics.Collections, dxCoreGraphics,
...
type
  ...
  public
    ...
    procedure CopyCharacterPropertiesFromMerged(const AMergedProperties: TdxMergedCharacterProperties); overload;
    procedure CopyParagraphPropertiesFromMerged(const AMergedProperties: TdxMergedParagraphProperties); overload;
...
const
  dxThisUnitName = 'dxRichEdit.Dialogs.TableStyleFormController';
...
procedure TdxTableStyleFormControllerBase.CopyCharacterPropertiesFromMerged(const AMergedProperties: TdxMergedCharacterProperties);
var
...
procedure TdxTableStyleFormControllerBase.CopyParagraphPropertiesFromMerged(const AMergedProperties: TdxMergedParagraphProperties);
var
