...
function TcxRegExprIdLetter.Check(var AToken: Char; ACaseInsensitive, ACanChangeCase: Boolean): Boolean;
begin
...
function TcxRegExprSpace.Check(var AToken: Char; ACaseInsensitive, ACanChangeCase: Boolean): Boolean;
begin
  if CharInSet(AToken, dxSpaceCharacters + [#0, #12]) then
    Result := not FInverse
  else
    Result := FInverse;
end;
...
function TcxRegExprAll.Check(var AToken: Char; ACaseInsensitive, ACanChangeCase: Boolean): Boolean;
begin
  Result := True;
end;
