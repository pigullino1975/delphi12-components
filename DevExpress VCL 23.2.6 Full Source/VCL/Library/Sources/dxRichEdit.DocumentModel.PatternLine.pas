...
unit dxRichEdit.DocumentModel.PatternLine; // for internal use
...
const
  dxThisUnitName = 'dxRichEdit.DocumentModel.PatternLine';
...
begin
  {$IFDEF DX_INITIALIZATION_LOGGING}TdxUnitSectionsLogger.DestructorStarted(UnitName, 'TdxUnderline.Finalize', SysInit.HInstance);{$ENDIF}
  FUnderlineNone.Free;
  {$IFDEF DX_INITIALIZATION_LOGGING}TdxUnitSectionsLogger.DestructorFinished(UnitName, 'TdxUnderline.Finalize', SysInit.HInstance);{$ENDIF}
end;
