...
type
  ...
  { TdxParentlessDefaultBooleanPropertyEditor }

  TdxParentlessDefaultBooleanPropertyEditor = class(TEnumProperty,
  ...
  protected
    ...
    function GetDisplayText(Value: TdxDefaultBoolean): string; virtual;
  ...
  { TdxDefaultBooleanPropertyEditor }

  TdxDefaultBooleanPropertyEditor = class(TdxParentlessDefaultBooleanPropertyEditor)
  protected
...
function TdxParentlessDefaultBooleanPropertyEditor.GetCheckBoxBounds(const ARect: TRect): TRect;
begin
  Result := Rect(ARect.Right + 2, ARect.Top, ARect.Right + ARect.Bottom - ARect.Top + 2, ARect.Bottom);
end;

function TdxParentlessDefaultBooleanPropertyEditor.GetDisplayText(Value: TdxDefaultBoolean): string;
begin
  case Value of
    bFalse:
...
function TdxParentlessDefaultBooleanPropertyEditor.GetValue: string;
begin
  Result := GetDisplayText(TdxDefaultBoolean(GetOrdValue));
end;

procedure TdxParentlessDefaultBooleanPropertyEditor.GetValues(Proc: TGetStrProc);
begin
...
procedure TdxParentlessDefaultBooleanPropertyEditor.SetValue(const Value: string);
begin
...
procedure TdxParentlessDefaultBooleanPropertyEditor.PropDrawName(ACanvas: TCanvas; const ARect: TRect;
  ASelected: Boolean);
begin
  DefaultPropertyDrawName(Self, ACanvas, ARect);
end;

procedure TdxParentlessDefaultBooleanPropertyEditor.PropDrawValue(ACanvas: TCanvas; const ARect: TRect;
  ASelected: Boolean);
begin
  PaintCheckbox(ACanvas, ARect, ASelected);
end;

function TdxParentlessDefaultBooleanPropertyEditor.PropDrawNameRect(const ARect: TRect): TRect;
begin
  Result := ARect;
end;

function TdxParentlessDefaultBooleanPropertyEditor.PropDrawValueRect(const ARect: TRect): TRect;
begin
  Result := Rect(ARect.Left, ARect.Top, (ARect.Bottom - ARect.Top) + ARect.Left, ARect.Bottom);
end;

procedure TdxParentlessDefaultBooleanPropertyEditor.HintShow(var HintInfo: THintInfo;
  InNameRect: Boolean; const ItemRect: TRect; var Handled: Boolean);
begin
  Handled := False;
end;

procedure TdxParentlessDefaultBooleanPropertyEditor.MouseDown(Button: TMouseButton; Shift: TShiftState;
...
procedure TdxParentlessDefaultBooleanPropertyEditor.MouseMove(Shift: TShiftState; X, Y: Integer;
  InNameRect: Boolean; const ItemRect: TRect; var Handled: Boolean);
begin
  Handled := False;
end;

procedure TdxParentlessDefaultBooleanPropertyEditor.MouseUp(Button: TMouseButton; Shift: TShiftState; X,
...
procedure TdxParentlessDefaultBooleanPropertyEditor.PaintCheckbox(ACanvas: TCanvas;
