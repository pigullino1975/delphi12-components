...
uses
  ...
  cxFontNameComboBox, dxMessageDialog,
...
uses
  ...
  dxRichEdit.View.Core, dxMeasurementUnitEdit;

const
  dxThisUnitName = 'dxRichEdit.Dialogs.TableStyle';
...
procedure TdxRichEditTableStyleDialogForm.ApplyCharacterProperties(AProperties: TdxMergedCharacterProperties; AData: TObject);
begin
  Controller.AddStyle;
...
procedure TdxRichEditTableStyleDialogForm.ApplyParagraphProperties(AProperties: TdxMergedParagraphProperties; AData: TObject);
begin
  Controller.AddStyle;
...
begin
  InitializeColorButtons(cmbFontColor);
  InitializeColorButtons(cmbTableBorderLineColor);
  InitializeColorButtons(cmbTableCellsShading);
