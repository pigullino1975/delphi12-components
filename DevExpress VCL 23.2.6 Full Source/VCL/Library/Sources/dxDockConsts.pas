...
resourcestring
  ...
  sdxInvalidZoneOwner = 'You cannot create a TdxZone without the owning TdxCustomDockControl.';
  sdxInternalErrorAutoHide = 'Internal error while auto-hide controls.';
...
begin
  ...
  InternalAdd('sdxInvalidZoneOwner', @sdxInvalidZoneOwner);
