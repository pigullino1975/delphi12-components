...
uses
  ...
  dxLayoutControl, dxLayoutLookAndFeels, cxContainer, cxEdit, cxListBox, cxCustomListBox;
...
type
  ...
  private
    ...
    function GetOperations: IcxTreeListDesignTimeOperations2;
  ...
  protected
   ...
   // IcxTreeListDesigner
    ...
    property Operations: IcxTreeListDesignTimeOperations2 read GetOperations;
...
function TcxTreeListBandColumnDesigner.GetOperations: IcxTreeListDesignTimeOperations2;
begin
  Supports(TreeList, IcxTreeListDesignTimeOperations2, Result)
end;
...
begin
  ...
  //
  liCreateAllFields.Enabled := Operations.CanCreateAllItems;
  mnuCreateAllFields.Enabled := Operations.CanCreateAllItems;
  //
