...
type
  ...
  public
    ...
    class function EncodeValue(const S: string): string;
  end;
...
const
  ...
  NCNameXml4eRanges =
    ...
    #$3099#$309A#$309D#$309E#$30A1#$30FA#$30FC#$30FE#$3105#$312C#$4E00#$9FA5#$AC00#$D7A3;
begin
  {$IFDEF DX_INITIALIZATION_LOGGING}TdxUnitSectionsLogger.ConstructorStarted(UnitName, 'TdxXmlCharType.Initialize', SysInit.HInstance);{$ENDIF}
  ...
  {$IFDEF DX_INITIALIZATION_LOGGING}TdxUnitSectionsLogger.ConstructorFinished(UnitName, 'TdxXmlCharType.Initialize', SysInit.HInstance);{$ENDIF}
end;
...
class function TdxXmlConvert.DecodeName(const S: string): string;
begin
  Result := TdxXMLHelper.DecodeString(S);
end;

class function TdxXmlConvert.EncodeName(const S: string): string;
begin
  Result := TdxXMLHelper.EncodeString(S, False, True);
end;

class function TdxXmlConvert.EncodeValue(const S: string): string;
begin
  Result := TdxXMLHelper.EncodeString(S, False, True, True);
end;
