...
uses
  System.UITypes,
  Windows, Messages, SysUtils, Variants, Classes, RTLConsts, Graphics, Controls, Forms, Dialogs, Menus,
...
const
  dxThisUnitName = 'dxRichEdit.Dialogs.CustomNumberingList';
...
begin
  Populate(cmbDisplayFormat, procedure(ACombobox: TcxCustomComboBox)
    var
      AValues: TArray<TdxNumberingFormat>;
