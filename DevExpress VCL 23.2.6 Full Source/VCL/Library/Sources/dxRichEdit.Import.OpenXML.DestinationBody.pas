...
unit dxRichEdit.Import.OpenXML.DestinationBody; // for internal use
...
const
  dxThisUnitName = 'dxRichEdit.Import.OpenXML.DestinationBody';
...
begin
  {$IFDEF DX_INITIALIZATION_LOGGING}TdxUnitSectionsLogger.ConstructorStarted(UnitName, 'TdxBodyDestination.Initialize', SysInit.HInstance);{$ENDIF}
  FHandlerTable := CreateElementHandlerTable;
  {$IFDEF DX_INITIALIZATION_LOGGING}TdxUnitSectionsLogger.ConstructorFinished(UnitName, 'TdxBodyDestination.Initialize', SysInit.HInstance);{$ENDIF}
end;

class destructor TdxBodyDestination.Finalize;
begin
  {$IFDEF DX_INITIALIZATION_LOGGING}TdxUnitSectionsLogger.DestructorStarted(UnitName, 'TdxBodyDestination.Finalize', SysInit.HInstance);{$ENDIF}
  FHandlerTable.Free;
  {$IFDEF DX_INITIALIZATION_LOGGING}TdxUnitSectionsLogger.DestructorFinished(UnitName, 'TdxBodyDestination.Finalize', SysInit.HInstance);{$ENDIF}
end;
