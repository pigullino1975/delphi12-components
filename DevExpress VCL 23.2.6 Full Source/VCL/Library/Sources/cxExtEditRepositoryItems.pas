...
const
  dxThisUnitName = 'cxExtEditRepositoryItems';
...
procedure TcxEditRepositoryRangeTrackBar.SetProperties(Value: TdxRangeTrackBarProperties);
begin
  inherited Properties := Value;
end;
...
procedure TcxEditRepositoryCheckGroupItem.SetProperties(Value: TcxCheckGroupProperties);
begin
  inherited Properties := Value;
end;
...
procedure TcxEditRepositoryRichItem.SetProperties(Value: TcxRichEditProperties);
begin
  inherited Properties := Value;
end;
