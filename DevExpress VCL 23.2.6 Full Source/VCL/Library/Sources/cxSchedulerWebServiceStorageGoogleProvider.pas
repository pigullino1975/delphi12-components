...
uses
  ...
  cxClasses, dxCore, dxCoreClasses, dxWinInet, dxGenerics,
...
type
  ...
  {$ENDREGION}
    ...
    property Colors: TdxIntegersDictionary read FColors;
  public
...
const
  dxThisUnitName = 'cxSchedulerWebServiceStorageGoogleProvider';
...
begin
  ...
  FColors := TdxIntegersDictionary.Create;
end;
