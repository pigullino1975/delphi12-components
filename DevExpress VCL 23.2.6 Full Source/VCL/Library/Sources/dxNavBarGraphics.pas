...
//  dxAdvExplorerBarSpecialGroupCaptionExpandSignBitmap: TBitmap;
  ...
  dxAdvExplorerBarBackgroundColor1: TColor;
  dxAdvExplorerBarBackgroundColor2: TColor;
  dxAdvExplorerBarFontColor: TColor;
  dxAdvExplorerBarFontHotColor: TColor;
  dxAdvExplorerBarGroupBackgroundColor: TColor;
  dxAdvExplorerBarGroupCaptionColor1: TColor;
  dxAdvExplorerBarGroupCaptionColor2: TColor;
  dxAdvExplorerBarGroupCaptionSignColor: TColor;
  dxAdvExplorerBarGroupCaptionSignHotColor: TColor;
  dxAdvExplorerBarGroupFontColor: TColor;
  dxAdvExplorerBarGroupFontHotColor: TColor;
  dxAdvExplorerBarSpecialGroupCaptionColor1: TColor;
  dxAdvExplorerBarSpecialGroupCaptionColor2: TColor;
  dxAdvExplorerBarSpecialGroupCaptionSignColor: TColor;
  dxAdvExplorerBarSpecialGroupCaptionSignHotColor: TColor;
  dxAdvExplorerBarSpecialGroupFontColor: TColor;
  dxAdvExplorerBarSpecialGroupFontHotColor: TColor;

  // Office11 color and bitmaps
  dxOffice11BackgroundColor1: TColor;
  dxOffice11BackgroundColor2: TColor;
  dxOffice11GroupBackgroundColor1: TColor;
  dxOffice11GroupBackgroundColor2: TColor;
  dxOffice11GroupCaptionColor1: TColor;
  dxOffice11GroupCaptionColor2: TColor;
  dxOffice11GroupBorderColor: TColor;
  dxOffice11GroupFontColor: TColor;
  dxOffice11LinkFontColor: TColor;
...
uses
  ...
  dxThemeConsts, dxUxTheme, dxThemeManager, dxOffice11, dxCore;

const
  dxThisUnitName = 'dxNavBarGraphics';

const
  ShellLibraryName = 'shell32.dll';

type
  TdxSHGetShellStyleHInstance = function: HINST; stdcall;
...
const
  Colors: array[TXPSchemeColor, 0..11] of TColor = (
...
const
  Office11Colors: array[TXPSchemeColor, 0..8] of TColor = (
...
begin
  ...
  begin
    AResInfo := FindResource(FShellInstance, MakeIntResource(AID), RT_BITMAP);
    if AResInfo > 0 then
    begin
