...
type
  ...
  TcxSchedulerAgendaViewControllerAccess = class(TcxSchedulerAgendaViewController);
...
begin
  ...
  try
    ...
    if CurrentView is TcxSchedulerAgendaView then
      TcxSchedulerAgendaViewControllerAccess(TcxSchedulerAgendaViewAccess(CurrentView).Controller).SelectTopInfoCell(False);
        ...
        begin
          ...
          case AViewMode of
            ...
            begin
              ...
              TcxSchedulerAgendaViewControllerAccess(TcxSchedulerAgendaViewAccess(ViewAgenda).Controller).SelectTopInfoCell(False);
            end;
          end;
        end;
      vmMonth:
