...
type
  ...
  TdxBingMapRESTServiceLocationParams = class(TdxBingMapRESTServiceParams) // for internal use
  private
 ...
 //   FInclude: string;
  ...
  TdxBingMapRESTServiceLocationByPointParams = class(TdxBingMapRESTServiceLocationParams) // for internal use
  private
  ...
  TdxBingMapRESTServiceLocationByQueryParams = class(TdxBingMapRESTServiceLocationParams) // for internal use
  private
    FMaxResults: Integer;
    FQuery: string;
  ...
  TdxBingMapCustomLocationDataService = class(TdxBingMapRESTService) // for internal use
  protected
    function CreateResponse: TdxRestServiceResponse; override;
    function GetAddress: string; override;
  end;

  TdxBingMapLocationByQueryDataService = class(TdxBingMapCustomLocationDataService) // for internal use
  protected
    function CreateParams: TdxBingMapRESTServiceParams; override;
  end;

  TdxBingMapLocationByPointDataService = class(TdxBingMapCustomLocationDataService) // for internal use
  protected
    function CreateParams: TdxBingMapRESTServiceParams; override;
    function GetAddress: string; override;
  end;
...
const
  dxThisUnitName = 'dxBingMapLocationDataService';
...
function TdxBingMapCustomLocationDataService.GetAddress: string;
begin
  Result := dxBingLocationServiceBaseAddress;
end;
...
function TdxBingMapLocationByPointDataService.GetAddress: string;
begin
