...
resourcestring
  ...
  sdxOutsideMarginsMessage =
    ...
    'Do you want to increase the appropriate margins and continue?';
  ...
  sdxPDFDialogSignatureContactInfo = 'Contact Info:';
  sdxPDFDialogSignatureDetails = 'Details';
  sdxPDFDialogSignatureDigitalID = 'Certificate (Digital ID)';
  sdxPDFDialogSignatureOpenDlgDigitalIDFile = 'Digital ID File';
  sdxPDFDialogSignatureOpenDlgTitle = 'Locate Digital ID File';
  sdxPDFDialogSignatureFileName = 'File Name:';
  sdxPDFDialogSignatureIssuer = 'Issuer:';
  sdxPDFDialogSignatureIssuerColumnCaption = 'Issuer';
  sdxPDFDialogSignatureExpirationDateColumnCaption = 'Expiration Date';
  sdxPDFDialogSignatureLocation = 'Location:';
  sdxPDFDialogSignaturePasswordDialogCaption = 'Private Key Protection';
  sdxPDFDialogSignatureReason = 'Reason:';
  sdxPDFDialogSignatureSettings = 'Signature Settings';
  sdxPDFDialogSignatureUseCertificateFromFileStore = 'Use Certificate from File';
  sdxPDFDialogSignatureUseCertificateFromSystemStore = 'Use Certificate from System Store';
  sdxPDFDialogSignatureViewCertificate = 'View Certificate...';
  sdxPDFDialogSignatureRequiredDigitalID = 'Certificate is not specified.';
  sdxPDFDialogSignatureRequiredDigitalIDPassword = 'The password is incorrect.';
  ...
  sdxPDFDialogTabSignature = 'S&ignature';
  ...
  sdxInvalidStorageVersion = 'Invalid Storage Version: %d';
