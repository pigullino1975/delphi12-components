...
uses
  Math, dxDockConsts, cxGeometry, dxDPIAwareUtils, dxCore, dxCoreGraphics;

const
  dxThisUnitName = 'dxDockControlNETView';
...
function TdxDockControlNETPainter.GetCaptionAreaContentHeight: Integer;
begin
