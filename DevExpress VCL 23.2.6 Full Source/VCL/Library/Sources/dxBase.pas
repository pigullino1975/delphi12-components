...
uses
  Types, Classes, dxPSSngltn, dxCore;
...
type
  ...
  private
    function GetItem(Index: TdxListIndex): TClass;
    procedure SetItem(Index: TdxListIndex; Value: TClass);
  public
    ...
    property Items[Index: TdxListIndex]: TClass read GetItem write SetItem; default;
  end;

  TdxPersistentClassList = class(TdxClassList)
  private
    function GetItem(Index: TdxListIndex): TPersistentClass;
    procedure SetItem(Index: TdxListIndex; Value: TPersistentClass);
  protected
  ...
  public
    ...
    property Items[Index: TdxListIndex]: TPersistentClass read GetItem write SetItem; default;
  end;
...
function TdxClassList.GetItem(Index: TdxListIndex): TClass;
begin
  Result := TClass(inherited Items[Index]);
end;

procedure TdxClassList.SetItem(Index: TdxListIndex; Value: TClass);
begin
...
function TdxPersistentClassList.GetItem(Index: TdxListIndex): TPersistentClass;
begin
  Result := TPersistentClass(inherited Items[Index]);
end;

procedure TdxPersistentClassList.SetItem(Index: TdxListIndex; Value: TPersistentClass);
begin
