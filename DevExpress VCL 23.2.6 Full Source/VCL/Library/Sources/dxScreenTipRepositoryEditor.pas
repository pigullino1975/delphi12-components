...
uses
  ...
  cxControls, cxLibraryReg, dxRichTextEditor, dxGDIPlusClasses;

const
  dxThisUnitName = 'dxScreenTipRepositoryEditor';
...
begin
  ...
  OpenPictureDialog1.Filter := cxGraphicFilter(TdxSmartGlyph);
...
begin
  TdxImageDrawer.DrawUncachedImage(APaintBox.Canvas.Handle, APaintBox.ClientRect,
...
begin
  ...
  begin
    ...
    ABand.Glyph.LoadFromFile(OpenPictureDialog1.FileName);
