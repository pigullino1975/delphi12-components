...
unit dxRichEdit.DocumentModel.TableStyles; // for internal use
...
type
  ...
  public type
    TdxMaskPredicate = reference to function(AConditionalStyle: TdxTableConditionalStyle): Boolean; 
  private
  ...
  public
    ...
    procedure SubscribeTablePropertiesPropertiesEvents;
    procedure SubscribeTableRowPropertiesEvents;
    procedure SubscribeTableCellPropertiesEvents;
    ...
    procedure TryGetConditionalStyle(AConditionalStyles: TdxEnumeratedObjectDictionary<TdxConditionalTableStyleFormattingType, TdxTableConditionalStyle>;
      AStyleType: TdxConditionalTableStyleFormattingType; out AResult: TdxTableConditionalStyle; const AMaskPredicate: TdxMaskPredicate); overload;
    procedure TryGetConditionalStyle(AConditionalStyles: TdxEnumeratedObjectDictionary<TdxConditionalTableStyleFormattingType, TdxTableConditionalStyle>;
    ...
    function GetConditionalPropertiesSource(ARowType: TdxConditionalRowType; AColumnType: TdxConditionalColumnType;
      const AMaskPredicate: TdxMaskPredicate): TdxTableConditionalStyle; overload;
    ...
    function GetTableProperties(AMask: Integer; ARowType: TdxConditionalRowType; 
      AColumnType: TdxConditionalColumnType; AIsBorderCell: Boolean;
        out AInsideBorder: Boolean): TdxTableProperties; overload; 
    function GetMergedCharacterProperties(ARowType: TdxConditionalRowType;
      AColumnType: TdxConditionalColumnType): TdxMergedCharacterProperties; overload;
    function GetMergedCharacterProperties: TdxMergedCharacterProperties; overload;
    ...
    function GetMergedTableProperties: TdxMergedTableProperties;
    function GetMergedWithDefaultTableProperties: TdxMergedTableProperties;
    function GetMergedWithDefaultTableRowProperties: TdxMergedTableRowProperties;
    function GetMergedWithDefaultTableCellProperties: TdxMergedTableCellProperties;
    function GetTableCellProperties(AMask: Integer; ARowType: TdxConditionalRowType; 
      AColumnType: TdxConditionalColumnType): TdxTableCellProperties; overload; 
    function GetCharacterProperties(AMask: TdxUsedCharacterFormattingOption; ARowType: TdxConditionalRowType; 
      AColumnType: TdxConditionalColumnType): TdxCharacterProperties; overload; 
    ...
    function GetTableRowProperties(AMask: Integer; 
      ARowType: TdxConditionalRowType): TdxTableRowProperties; overload; 
    ...
    function CopyTo(ATargetModel: TdxCustomDocumentModel): TdxTableStyle;
    ...
    function GetMergedTableRowProperties: TdxMergedTableRowProperties; overload;
    ...
    function GetMergedTableCellProperties: TdxMergedTableCellProperties; overload;
  ...
  public
    ...
    function GetTableSimpleStyle: Integer;
  ...
  public
    ...
    function GetTableProperties(AMask: Integer): TdxTableProperties; overload;
    function GetTableRowProperties(AMask: Integer): TdxTableRowProperties; overload;
    function GetTableCellProperties(AMask: Integer): TdxTableCellProperties; overload;
    ...
    function GetMergedWithDefaultCharacterProperties: TdxMergedCharacterProperties;
    function GetMergedParagraphProperties: TdxMergedParagraphProperties;
    function GetMergedWithDefaultParagraphProperties: TdxMergedParagraphProperties;
    function GetMergedTableProperties: TdxMergedTableProperties;
    function GetMergedTableRowProperties: TdxMergedTableRowProperties;
    function GetMergedTableCellProperties: TdxMergedTableCellProperties;
  ...
  protected
    ...
    procedure OnObtainAffectedRange(ASender: TObject; E: TdxObtainAffectedRangeEventArgs);
    procedure MergePropertiesWithParent; override;
    function CopyTo(ATargetModel: TdxCustomDocumentModel): TdxTableCellStyle;
  ...
  public
    ...
    function GetMergedCharacterProperties(ARowType: TdxConditionalRowType; AColumnType: TdxConditionalColumnType): TdxMergedCharacterProperties;
    function GetMergedWithDefaultCharacterProperties(ARowType: TdxConditionalRowType; AColumnType: TdxConditionalColumnType): TdxMergedCharacterProperties;
    function GetMergedWithDefaultTableCellProperties: TdxMergedTableCellProperties;
    function GetTableCellProperties(AMask: Integer): TdxTableCellProperties; overload; 
    function GetCharacterProperties(AMask: TdxUsedCharacterFormattingOption; ARowType: TdxConditionalRowType; AColumnType: TdxConditionalColumnType): TdxCharacterProperties; overload;
    function GetParagraphProperties(AMask: TdxUsedParagraphFormattingOption; ARowType: TdxConditionalRowType; AColumnType: TdxConditionalColumnType): TdxParagraphProperties; overload;
    function GetMergedParagraphProperties(ARowType: TdxConditionalRowType; AColumnType: TdxConditionalColumnType): TdxMergedParagraphProperties; reintroduce; overload;
    function GetMergedParagraphProperties: TdxMergedParagraphProperties; overload; override;
    function Copy(ATargetModel: TdxCustomDocumentModel): Integer; override;
  ...
  public
    ...
    const TableCellSimpleStyleName: string = 'Table Cell Simple 1';
    const DefaultTableCellStyleName: string = 'Normal Table Cell';
  private
    procedure SetDefaultBorder(ABorder: TdxBorderBase; AStyle: TdxBorderLineStyle; AWidthInTwips: Integer);
    procedure SetDefaultMargin(AMargin: TdxWidthUnit; AValueInTwips: Integer);
    function GetItem(Index: Integer): TdxTableCellStyle;
  protected
    function CreateNormalTableCellStyle(AChangeDefaultTableCellStyle: Boolean): TdxTableCellStyle;
    function CreateTableSimpleStyle: TdxTableCellStyle;
    function CreateDefaultItem: TdxStyleBase; override;
    procedure NotifyPieceTableStyleDeleting(APieceTable: TdxCustomPieceTable; AStyle: TdxStyleBase); override;
  public
...
uses
  ...
  dxRichEdit.DocumentModel.History.Table, dxCore;

const
  dxThisUnitName = 'dxRichEdit.DocumentModel.TableStyles';
...
function TdxTableStyle.GetConditionalPropertiesSource(ARowType: TdxConditionalRowType;
  AColumnType: TdxConditionalColumnType; const AMaskPredicate: TdxMaskPredicate): TdxTableConditionalStyle;
var
  AConditionalStyles: TdxEnumeratedObjectDictionary<TdxConditionalTableStyleFormattingType, TdxTableConditionalStyle>;
begin
  Result := nil;
...
procedure TdxTableStyle.TryGetConditionalStyle(
  ...
  const AMaskPredicate: TdxMaskPredicate);
begin
...
function TdxTableStyleCollection.GetTableSimpleStyle: Integer;
var
  AStyleIndex: Integer;
begin
  AStyleIndex := GetStyleIndexByName(TableSimpleStyleName, False);
  if (AStyleIndex >= 0) and not TdxDocumentModel(DocumentModel).TableStyles[AStyleIndex].Deleted then
    Exit(AStyleIndex);
  Result := -1;
end;
...
begin
  {$IFDEF DX_INITIALIZATION_LOGGING}TdxUnitSectionsLogger.ConstructorStarted(UnitName, 'TdxTableConditionalStyleProperties.Initialize', SysInit.HInstance);{$ENDIF}
  for I := Low(TdxConditionalTableStyleFormattingType) to High(TdxConditionalTableStyleFormattingType) do
    FStyleTypes[I] := I;
  {$IFDEF DX_INITIALIZATION_LOGGING}TdxUnitSectionsLogger.ConstructorFinished(UnitName, 'TdxTableConditionalStyleProperties.Initialize', SysInit.HInstance);{$ENDIF}
end;
