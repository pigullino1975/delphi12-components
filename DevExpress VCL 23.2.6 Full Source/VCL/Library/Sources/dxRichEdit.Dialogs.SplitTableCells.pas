...
const
  dxThisUnitName = 'dxRichEdit.Dialogs.SplitTableCells';
...
begin
  ...
  begin
    ...
    begin
      dxMessageDlg(FValidationEquals.ErrorMessage, mtWarning, [mbOK], 0);
...
begin
  ...
  if not Result and FUseMessage then
    dxMessageDlg(ErrorMessage, mtWarning, [mbOK], 0);
end;
