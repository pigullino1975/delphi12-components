...
function DataCompareText(const S1, S2: string; APartialCompare: Boolean; AIsAnywhere: Boolean = False; ACaseSensitive: Boolean = False): Boolean;

implementation

const
  dxThisUnitName = 'cxDataUtils';
