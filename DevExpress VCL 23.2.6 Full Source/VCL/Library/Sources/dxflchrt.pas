...
uses
  ...
  dxLines, cxGeometry, cxControls, cxGraphics, cxLookAndFeels, cxLookAndFeelPainters, dxTouch, dxForms, cxTextEdit, dxScrollAnimation,
...
type
  ...
  public
    ...
    property Font: TdxGPFont read GetFont; // for internal use
    property FontBrush: TdxGPBrush read GetFontBrush;
    property FontFormat: TdxGPStringFormat read GetFontFormat; // for internal use
  ...
  TdxFlowChartDragHelper = class // for internal use
  public type
  {$SCOPEDENUMS ON}
  ...
  strict protected type
    ...
    protected
      ...
      function GetScaled(AValue: Single): Single;
  ...
  protected
    ...
    procedure CalculateAdvancedShapeLinkedPoints; virtual;
  ...
  public
    ...
    function GetBoundingRect: TRect; overload;               // for internal use
    function GetBoundsForRotatedRect(const R: TRect): TRect; // for internal use
...
*)
  ...
  private
    ...
    procedure DelObj(AObj, APartner: TdxFcObject; Index: Integer);
    procedure InsObj(AObj, APartner: TdxFcObject; Index: Integer);
  ...
  protected
    ...
    function GetExcludeTextBounds: TRect;
    ...
    function PointToRealPoint(const P: TPoint): TPoint;
    function RealPointToPoint(const P: TPoint): TPoint;
    procedure Save(Stream: TStream); overload; virtual;
    procedure Save(ANode: TdxXMLNode); overload; virtual;
    procedure SetText(Value: string); override;
  ...
  strict private class var
    ...
    class function GetRotationImage: TdxSmartImage; static;
  strict private
  ...
  strict protected
    ...
    procedure DrawEqualitySizes(AGraphics: TdxGPGraphics; ASize: TSize; ABounds: TdxRectList); virtual;
  ...
  protected
    ...
    class procedure FinalizeImages;
    ...
    class property RotationImage: TdxSmartImage read GetRotationImage;
  ...
  TdxFlowChartScrollAnimationHelper = class(TdxScrollAnimationHelper)
  strict private
    FOwner: TdxCustomFlowChart;
  protected
    property Owner: TdxCustomFlowChart read FOwner;
  ...
  TdxFlowChartVerticalScrollAnimationHelper = class(TdxFlowChartScrollAnimationHelper)
  protected
  ...
  TdxFlowChartHorizontalScrollAnimationHelper = class(TdxFlowChartScrollAnimationHelper)
  protected
    procedure CheckPosition(var AValue: Integer); override;
    function GetOwnerPosition: Integer; override;
    procedure UpdateOwnerPosition(AValue: Integer); override;
  ...
  private
    ...
    FHorizontalScrollAnimationHelper: TdxFlowChartHorizontalScrollAnimationHelper;
    ...
    FVerticalScrollAnimationHelper: TdxFlowChartVerticalScrollAnimationHelper;
    FZoom: Word;
    ...
    procedure AbortDrag;
    procedure AdjustEdge(AMin, AMax: Integer; var AValue: Integer);
  ...
  protected
    procedure CalculateFontRelatedSizes; virtual;
    ...
    procedure CheckLeftEdge(var AValue: Integer);
    procedure CheckTopEdge(var AValue: Integer);
    ...
    procedure DoSetLeftTop(ALeft, ATop: Integer);
    ...
    function GetConnectionRealPoint(const P: TPoint): TPoint;
    ...
    procedure SetLeftEdgeAnimated(AValue: Integer);
    procedure SetTopEdgeAnimated(AValue: Integer);
    ...
    function ChartPointToDisplayPoint(const P: TPoint): TPoint;
    ...
    function DisplayPointToChartPoint(const P: TPoint): TPoint;
    ...
    procedure FontChanged; override;
    function GetScaledPoint(const P: TPoint): TPoint;
    function GetUnscaledPoint(const P: TPoint): TPoint;
    function IsMultiSelectShiftState(AShift: TShiftState): Boolean; virtual;
    ...
    procedure ApplySugiyamaPositionInfo(AInfo: TdxSugiyamaPositionsInfo; AUseDummyEdges: Boolean); virtual;
    procedure ApplySugiyamaLayout; virtual;
...
uses
  ...
  dxStringHelper, dxSugiyamaLayout.Utils;

const
  dxThisUnitName = 'dxflchrt';
...
type
  ...
  TXMLFormatHelper = record
    ...
    class procedure WriteAlignment(AAttributes: TdxXMLNodeAttributes; const AName: TdxXMLString;
    ...
    class procedure ReadAlignment(AAttributes: TdxXMLNodeAttributes; const AName: TdxXMLString;
...
class procedure TXMLFormatHelper.ReadAlignment(AAttributes: TdxXMLNodeAttributes; const AName: TdxXMLString; out AHorizontal: TdxFcHorzPos;
...
class procedure TXMLFormatHelper.WriteAlignment(AAttributes: TdxXMLNodeAttributes; const AName: TdxXMLString; AHorizontal: TdxFcHorzPos;
...
class function TdxFcSelection.GetRotationImage: TdxSmartImage;
begin
  if not Assigned(FRotationImage) then
    InitializeImages;
  Result := FRotationImage;
end;
...
procedure TdxFcSelection.DrawEqualitySizes(AGraphics: TdxGPGraphics; ASize: TSize; ABounds: TdxRectList);
var
  I: Integer;
  ABrush: TdxGPBrush;
  APen: TdxGPPen;
...
class procedure TdxFcSelection.FinalizeImages;
begin
  FRotationImage.Free;
end;
...
begin
  FRotationImage := TdxSmartImage.Create;
  if dxUseVectorIcons then
    FRotationImage.LoadFromResource(HInstance, 'DXFCRotateIcon', 'SVG')
  else
    FRotationImage.LoadFromResource(HInstance, 'DXFCRotateIcon', RT_RCDATA);
end;

{ TdxFlowChartScrollAnimationHelper }

constructor TdxFlowChartScrollAnimationHelper.Create(
...
{ TdxFlowChartVerticalScrollAnimationHelper }

procedure TdxFlowChartVerticalScrollAnimationHelper.CheckPosition(
  var AValue: Integer);
begin
  Owner.CheckTopEdge(AValue);
end;

function TdxFlowChartVerticalScrollAnimationHelper.GetOwnerPosition: Integer;
begin
  Result := Owner.TopEdge;
end;

procedure TdxFlowChartVerticalScrollAnimationHelper.UpdateOwnerPosition(
  AValue: Integer);
begin
  Owner.DoSetLeftTop(Owner.LeftEdge, AValue);
end;

{ TdxFlowChartHorizontalScrollAnimationHelper }

procedure TdxFlowChartHorizontalScrollAnimationHelper.CheckPosition(
  var AValue: Integer);
begin
  Owner.CheckLeftEdge(AValue);
end;

function TdxFlowChartHorizontalScrollAnimationHelper.GetOwnerPosition: Integer;
begin
  Result := Owner.LeftEdge;
end;

procedure TdxFlowChartHorizontalScrollAnimationHelper.UpdateOwnerPosition(
  AValue: Integer);
begin
  Owner.DoSetLeftTop(AValue, Owner.TopEdge);
end;
...
begin
  ...
  FHorizontalScrollAnimationHelper := TdxFlowChartHorizontalScrollAnimationHelper.Create(Self);
  FVerticalScrollAnimationHelper := TdxFlowChartVerticalScrollAnimationHelper.Create(Self);
  DoubleBuffered := True;
...
begin
  ...
  OnSelected := nil;
  Clear;
  FreeAndNil(FVerticalScrollAnimationHelper);
  FreeAndNil(FHorizontalScrollAnimationHelper);
  FreeAndNil(FObjects);
...
procedure TdxCustomFlowChart.ApplySugiyamaPositionInfo(AInfo: TdxSugiyamaPositionsInfo; AUseDummyEdges: Boolean);
var
  I, J: Integer;
  AMinX, AMinY: Double;
  AObject: TdxFcObject;
...
begin
  ...
  ACenterOfGraph := cxPointsBox(APoints).CenterPoint;
  for I := 0 to ConnectionCount - 1 do
  begin
    AConnection := Connections[I];
    if (AConnection.ObjectSource = nil) or (AConnection.ObjectDest = nil) then
...
procedure TdxCustomFlowChart.ApplySugiyamaLayout;
var
  AGraph: TdxGraph;
  ...
  try
    ...
    try
      AInfo := TdxSugiyamaLayout.LayoutGraph(AGraph,
        TdxSugiyamaLayoutAlgorithm.Create(
          ...
          begin
            Result := TdxCoordinateAssignment.GetSugiyamaPositionsInfo(AGraphInfo,
          ...
          []));
      try
        ApplySugiyamaPositionInfo(AInfo, UseDummyEdgesForRouting);
      finally
        AInfo.Free;
      end;
    finally
...
begin
  {$IFDEF DX_INITIALIZATION_LOGGING}TdxUnitSectionsLogger.ConstructorStarted(UnitName, 'TdxCustomFlowChart.Initialize', SysInit.HInstance);{$ENDIF}
  FRepository := TdxFlowChartAdvancedShapeRepository.Create;
  {$IFDEF DX_INITIALIZATION_LOGGING}TdxUnitSectionsLogger.ConstructorFinished(UnitName, 'TdxCustomFlowChart.Initialize', SysInit.HInstance);{$ENDIF}
end;

class destructor TdxCustomFlowChart.Finalize;
begin
  {$IFDEF DX_INITIALIZATION_LOGGING}TdxUnitSectionsLogger.DestructorStarted(UnitName, 'TdxCustomFlowChart.Finalize', SysInit.HInstance);{$ENDIF}
  FRepository.Free;
  {$IFDEF DX_INITIALIZATION_LOGGING}TdxUnitSectionsLogger.DestructorFinished(UnitName, 'TdxCustomFlowChart.Finalize', SysInit.HInstance);{$ENDIF}
end;
...
begin
  Result := DisplayPointToChartPoint(TPoint.Create(X, Y));
end;

function TdxCustomFlowChart.ChartPoint(const P: TPoint): TPoint;
begin
  Result := DisplayPointToChartPoint(P);
end;

procedure TdxCustomFlowChart.CalculateChartSizes;

  procedure CombineRects(R: TRect; var AResult: TRect);
  begin
    R := ScrollRect(R);
    AResult.Init(
      Min(R.Left, AResult.Left), Min(R.Top, AResult.Top),
      Max(R.Right, AResult.Right), Max(R.Bottom, AResult.Bottom));
  end;
...
begin
  ...
  ANewR.Init(MaxInt, MaxInt, MinInt, MinInt);
  AOldR.InitSize(FChartLeft, FChartTop, FChartWidth, FChartHeight);
  for I := 0 to ObjectCount - 1 do
  begin
    AObject := Objects[I];
    CombineRects(AObject.GetBoundsForRotatedRect(AObject.DisplayRect), ANewR);
  end;
  for I := 0 to ConnectionCount - 1 do
    CombineRects(Connections[I].DisplayRect, ANewR);

  if ANewR.IsEmpty then
    ANewR.Empty
  else
  begin
    ANewR.Offset(cxPointInvert(ClientBounds.TopLeft));
    ANewR.Left := Min(0, ANewR.Left);
    ANewR.Top := Min(0, ANewR.Top);
  end;
  ...
  begin
    ...
    FChartWidth := ANewR.Width;
    FChartHeight := ANewR.Height;
  end;
  UpdateScrollBars;
end;
...
procedure TdxCustomFlowChart.DoSetLeftTop(ALeft, ATop: Integer);
begin
...
procedure TdxCustomFlowChart.SetLeftEdgeAnimated(AValue: Integer);
begin
  FHorizontalScrollAnimationHelper.SetPosition(AValue);
end;

procedure TdxCustomFlowChart.SetTopEdgeAnimated(AValue: Integer);
begin
  FVerticalScrollAnimationHelper.SetPosition(AValue);
end;
...
function TdxCustomFlowChart.ScrollPoint(const P: TPoint; APositiveFactor: Boolean = True): TPoint;
begin
  Result := cxPointOffset(P, LeftEdge, TopEdge, APositiveFactor);
end;

function TdxCustomFlowChart.ScrollRect(const R: TRect; APositiveFactor: Boolean = True): TRect;
begin
  Result := cxRectOffset(R, LeftEdge, TopEdge, APositiveFactor);
end;

procedure TdxCustomFlowChart.StopScrollAnimation;
begin
  if FVerticalScrollAnimationHelper.IsAnimationActive then
    FVerticalScrollAnimationHelper.StopAnimation(False);
  if FHorizontalScrollAnimationHelper.IsAnimationActive then
    FHorizontalScrollAnimationHelper.StopAnimation(False);
end;
...
begin
  ...
  begin
    AObject := Objects[I];
    if Printing or RectVisible(Canvas.Handle, AObject.InvalidateRect) then
...
procedure TdxCustomFlowChart.FontChanged;
...
function TdxCustomFlowChart.GetScaledPoint(const P: TPoint): TPoint;
begin
  Result.Init(MulDiv(P.X, RealZoom, 100), MulDiv(P.Y, RealZoom, 100));
end;

function TdxCustomFlowChart.GetUnscaledPoint(const P: TPoint): TPoint;
begin
  Result.Init(MulDiv(P.X, 100, RealZoom), MulDiv(P.Y, 100, RealZoom));
end;
...
begin
  ...
  begin
    AConnection := Connections[I];
    if Printing or RectVisible(Canvas.Handle, AConnection.SelectionRect) then
...
function TdxCustomFlowChart.IsMultiSelectShiftState(AShift: TShiftState): Boolean;
begin
...
begin
  ...
  try
    ...
    P := GetConnectionRealPoint(TPoint.Create(DX, DY));
    for I := 0 to ConnectionCount - 1 do
    begin
      AConnection := Connections[I];
...
procedure TdxCustomFlowChart.ScaleFactorChanging;
begin
  BeginUpdate;
...
procedure TdxCustomFlowChart.KeyDown(var Key: Word; Shift: TShiftState);
  ...
  procedure ScrollHorz(ADirectionValue: TValueSign);
  var
    APos: Integer;
  begin
    if FHorizontalScrollAnimationHelper.IsAnimationActive then
      APos := FHorizontalScrollAnimationHelper.TargetPosition
    else
      APos := LeftEdge;
    APos := APos + ADirectionValue*(ClientWidth - 16);
    if IsScrollAnimationEnabled then
      SetLeftEdgeAnimated(APos)
    else
      LeftEdge := APos;
  end;

  procedure ScrollVert(ADirectionValue: TValueSign);
  var
    APos: Integer;
  begin
    if FVerticalScrollAnimationHelper.IsAnimationActive then
      APos := FVerticalScrollAnimationHelper.TargetPosition
    else
      APos := TopEdge;
    APos := APos + ADirectionValue*(ClientHeight - 16);
    if IsScrollAnimationEnabled then
      SetTopEdgeAnimated(APos)
    else
      TopEdge := APos;
  end;
...
begin
  ...
  if Shift = [] then
    case Key of
      ...
      VK_NEXT: ScrollVert(1);
      VK_PRIOR: ScrollVert(-1);
...
procedure TdxCustomFlowChart.MouseDown(Button: TMouseButton; Shift: TShiftState; X, Y: Integer);
  ...
  begin
    ...
    if Result then
    begin
      if IsMultiSelectShiftState([ssShift]) then
        Result := Shift * [ssCtrl] = []
      else
...
procedure TdxCustomFlowChart.AdjustEdge(AMin, AMax: Integer; var AValue: Integer);
begin
...
function TdxCustomFlowChart.GetConnectionRealPoint(const P: TPoint): TPoint;
begin
  Result := GetScaledPoint(P);
  Result.Offset(ClientBounds.TopLeft);
end;
...
function TdxCustomFlowChart.IsScrollAnimationActive: Boolean;
begin
  Result := FHorizontalScrollAnimationHelper.IsAnimationActive or FVerticalScrollAnimationHelper.IsAnimationActive;
end;
...
procedure TdxCustomFlowChart.CheckLeftEdge(var AValue: Integer);
begin
  AdjustEdge(FChartLeft, FChartLeft + FChartWidth + 1 - ClientWidth, AValue);
end;

procedure TdxCustomFlowChart.CheckTopEdge(var AValue: Integer);
begin
  AdjustEdge(FChartTop, FChartTop + FChartHeight + 1 - ClientHeight, AValue);
end;

procedure TdxCustomFlowChart.CalculateFontRelatedSizes;
begin
end;
...
var
  AOffset: TPoint;
begin
  AOffset := ClientBounds.TopLeft;
  Result.X := MulDiv(P.X, RealZoom, 100) - LeftEdge + AOffset.X;
  Result.Y := MulDiv(P.Y, RealZoom, 100) - TopEdge + AOffset.Y;
end;
...
function TdxCustomFlowChart.DisplayPointToChartPoint(const P: TPoint): TPoint;
var
  AClientPoint: TPoint;
begin
  AClientPoint := P.Subtract(ClientBounds.TopLeft);
  Result.X := MulDiv(AClientPoint.X + LeftEdge, 100, RealZoom);
  Result.Y := MulDiv(AClientPoint.Y + TopEdge, 100, RealZoom);
end;

procedure TdxCustomFlowChart.Scroll(AScrollBarKind: TScrollBarKind; AScrollCode: TScrollCode; var AScrollPos: Integer);

  function GetPosition(ACode: TScrollCode; AValue, APage: Integer): Integer;
  begin
    case ACode of
      scLineDown:
...
var
  APos: Integer;
  AAnimationScrollHelper: TdxFlowChartScrollAnimationHelper;
begin
  if AScrollBarKind = sbHorizontal then
    AAnimationScrollHelper := FHorizontalScrollAnimationHelper
  else
    AAnimationScrollHelper := FVerticalScrollAnimationHelper;

  if AAnimationScrollHelper.IsAnimationActive and (AScrollCode in [scTrack]) then
    AAnimationScrollHelper.StopAnimation(True);
  if AAnimationScrollHelper.IsAnimationActive then
    APos := AAnimationScrollHelper.TargetPosition
  else
    APos := AAnimationScrollHelper.GetOwnerPosition;
  APos := GetPosition(AScrollCode, APos, ClientWidth);
  if IsScrollAnimationEnabled and (AScrollCode in [scLineUp..scPageDown]) then
    AAnimationScrollHelper.SetPosition(APos)
  else
    if AScrollBarKind = sbHorizontal then
      SetLeftEdge(APos)
    else
      SetTopEdge(APos);
  AScrollPos := AAnimationScrollHelper.GetOwnerPosition;
end;
...
var
  AStrokeColor: TdxNullableValue<TdxAlphaColor>;
  AStrokeThickness: TdxNullableValue<Single>;
  APenColor: TdxAlphaColor;
  AElement: TdxShapeElementViewData;
  AThickness: Single;
begin
  AElement := ViewData[AIndex];
  AStrokeColor := AElement.StrokeColor;
  AStrokeThickness := AElement.StrokeThickness;
  if AStrokeColor.HasValue then                            
    APenColor := AStrokeColor
  else
    APenColor := TdxAlphaColors.FromColor(Owner.ShapeColor);
  if AStrokeThickness.HasValue then
    AThickness := AStrokeThickness
  else
    AThickness := Owner.ShapeWidth;
  Result := TdxGPPen.Create(APenColor, GetScaled(AThickness), Owner.ShapeStyle);
...
function TdxFcObject.TAdvancedShapeInfo.GetScaled(AValue: Single): Single;
begin
...
begin
  ...
  FFont := TdxGPFont.SafeCreate(Owner.RealFont.Name, Abs(Owner.Font.Size * Owner.Owner.RealZoom / 100), AStyle);
end;
...
var
  AOffset: TPoint;
begin
  AOffset := Owner.ClientBounds.TopLeft;
  FRealLeft := AOffset.X + MulDiv(Left, Owner.RealZoom, 100);
  FRealTop := AOffset.Y + MulDiv(Top, Owner.RealZoom, 100);
...
procedure TdxFcObject.CalculateAdvancedShapeLinkedPoints;
var
...
begin
  ...
  if ShapeType = fcsAdvanced then
  begin
    CalculateAdvancedShapeLinkedPoints;
    if IsRotated then
    begin
      AMatrix := TdxGPMatrix.Create;
      try
  ...
  begin
    ...
    FBoundingRect := cxPointsBox(LinkedPoints);
  end;
end;
...
begin
  Result.InitSize(RealLeft, RealTop, RealWidth, RealHeight);
  Result := Owner.ScrollRect(Result, False);
end;
...
begin
  ...
  Inc(Result.Right);
  if ShapeType <> fcsNone then
    Result.Inflate(FRealShapeWidth);
end;
...
begin
  if IsRotated then
    Result := cxRotatedRectBox(R, DisplayRect.ToRectF.CenterPoint, Angle).InflateToTRect
  else
    Result := R;
end;
...
begin
  ...
  SetBounds(MulDiv(Left, M, D), MulDiv(Top, M, D), MulDiv(Width, M, D), MulDiv(Height, M, D));
  CalculateRealBounds;
end;
...
begin
  ...
  begin
    X := Owner.LeftEdge + R.Left - X;
    Y := Owner.TopEdge + R.Top - Y;
    if Owner.IsScrollAnimationEnabled then
    begin
      Owner.SetLeftEdgeAnimated(X);
      Owner.SetTopEdgeAnimated(Y);
    end
    else
      Owner.SetLeftTop(X, Y);
  end
  else
    if Owner.IsScrollAnimationActive then
      Owner.StopScrollAnimation;
end;
...
begin
  ...
  TXMLFormatHelper.ReadAlignment(AAttributes, 'TextAlignment', FHorzTextPos, FVertTextPos);
  UpdateFontFormat;

  TXMLFormatHelper.ReadAlignment(AAttributes, 'ImageAlignment', FHorzImagePos, FVertImagePos);
...
begin
  AAttributes := ANode.Attributes;
  if Text <>'' then
    AAttributes.SetValueAsString('Text', TdxXMLHelper.EncodeString(Text, False));
  if CustomData <> '' then
  ...
  if (HorzTextPos <> fchpLeft) or (VertTextPos <> fcvpUp) then
    TXMLFormatHelper.WriteAlignment(AAttributes, 'TextAlignment', HorzTextPos, VertTextPos);
  if (HorzImagePos <> fchpLeft) or (VertImagePos <> fcvpUp) then
    TXMLFormatHelper.WriteAlignment(AAttributes, 'ImageAlignment', HorzImagePos, VertImagePos);
...
begin
  Result.X := Round(P.X * Owner.RealZoom / 100);
  Result.Y := Round(P.Y * Owner.RealZoom / 100);
...
begin
  ...
  begin
    ...
    FRealPoints[AIndex] := PointToRealPoint(AValue);
    CalculateDisplayRect;
    Changed;
    Owner.SetChartSizes;
  end;
...
begin
  ...
  FRealPoints.Insert(AIndex, PointToRealPoint(P));
end;

procedure TdxFcConnection.InsertDisplayPoint(AIndex: Integer; P: TPoint);
begin
  FRealPoints.Insert(AIndex, P);
  FPoints.Insert(AIndex, Owner.DisplayPointToChartPoint(P));
end;
...
begin
  ...
  begin
    AEndpoint := FRealPoints[APointCount - 1];
    Result := FRealPoints.Points[APointCount - 2];
  end;
  case Style of
    fclRectH:
      begin
        if AForSource then
        begin
          if AEndpoint.X <> Result.X then
            Result.Y := AEndpoint.Y;
        end
        else
        begin
          if AEndpoint.Y <> Result.Y then
...
begin
  ...
  begin
    P := FPoints[I];
    FRealPoints[I] := PointToRealPoint(P);
  end;
end;
...
begin
  ...
  cxTextOut(cxMeasureCanvas.Handle, Text, FTextRect, CXTO_CALCRECT, RealFont);
...
function TdxFcConnection.GetExcludeTextBounds: TRect;
const
  TextIndent = 1;
begin
  if Text <> '' then
...
procedure TdxFcConnection.DelObj(AObj, APartner: TdxFcObject; Index: Integer);
begin
  if APartner <> nil then
  begin
    AObj.FLinkedObjects.Remove(APartner);
    APartner.FLinkedObjects.Remove(AObj);
  end;
...
procedure TdxFcConnection.InsObj(AObj, APartner: TdxFcObject; Index: Integer);
begin
  if APartner <> nil then
  begin
    AObj.FLinkedObjects.Add(APartner);
    APartner.FLinkedObjects.Add(AObj);
  end;
...
begin
  ...
  begin
    ...
    FPoints[0] := ASource.Owner.GetUnscaledPoint(P);
  end;
  if ASource.ObjectDest <> nil then
  begin
    P := ASource.ObjectDest.LinkedPoints[ASource.PointDest];
    FPoints[FPoints.Count - 1] := ASource.Owner.GetUnscaledPoint(P);
  end;
  Calculate;
end;
...
function TdxFcConnection.PointToRealPoint(const P: TPoint): TPoint;
begin
  Result := Owner.GetConnectionRealPoint(P);
end;

function TdxFcConnection.RealPointToPoint(const P: TPoint): TPoint;
begin
  Result := P.Subtract(Owner.ClientBounds.TopLeft);
  Result := Owner.GetUnscaledPoint(Result);
end;
...
begin
  ...
  begin
    R := RealTextRect;
    R.Offset(0, -1);
    cxTextOut(ACanvas.Handle, Text, R, CXTO_CENTER_HORIZONTALLY or CXTO_CENTER_VERTICALLY, RealFont, 0);
  end;
end;
...
begin
  ...
  Dec(AIndex);
  repeat
    APaintTop := AScaleFactor.Apply(ATop) + AClientBounds.Top;
    Inc(ATop, AGridSize);
    Inc(AIndex);
...
begin
  ...
  Dec(AIndex);
  repeat
    APaintLeft := AScaleFactor.Apply(ALeft) + AClientBounds.Left;
    Inc(ALeft, AGridSize);
    Inc(AIndex);
    if AIsMajorLines <> (AIndex mod 5 = 0) then
      Continue;
...
procedure TdxFlowChartPainter.DrawPolygon(ACanvas: TcxCanvas; const P: array of TPoint;
  ABackgroundColor, AFrameColor: TColor; AFrameStyle: TPenStyle; AFrameWidth: Integer);
begin
  ACanvas.SaveState;
  try
...
begin
  dxRegisterCursor(crFlChartCross, HInstance, 'DXFCCROSS');
  dxRegisterCursor(crFlChartDrawFreeConnector, HInstance, 'DXFCDRAWFREECONNECTOR');
  dxRegisterCursor(crFlChartArrow, HInstance, 'DXFCARROW');
  dxRegisterCursor(crFlChartCopy, HInstance, 'DXFCCOPY');
  dxRegisterCursor(crFlChartCreateRectangle, HInstance, 'DXFCCREATERECTANGLE');
  dxRegisterCursor(crFlChartDragRemove, HInstance, 'DXFCDRAGREMOVE');
  dxRegisterCursor(crFlChartDrawConnectedConnector, HInstance, 'DXFCDRAWCONNECTEDCONNECTOR');
  dxRegisterCursor(crFlChartHandDragPreview, HInstance, 'DXFCHANDDRAGPREVIEW');
  dxRegisterCursor(crFlChartHandPreview, HInstance, 'DXFCHANDPREVIEW');
  dxRegisterCursor(crFlChartHoverRotation, HInstance, 'DXFCHOVERROTATION');
  dxRegisterCursor(crFlChartMove, HInstance, 'DXFCMOVE');
  dxRegisterCursor(crFlChartNo, HInstance, 'DXFCNO');
  dxRegisterCursor(crFlChartRotation, HInstance, 'DXFCROTATION');
  dxRegisterCursor(crFlChartSizeAll, HInstance, 'DXFCSIZEALL');
  dxRegisterCursor(crFlChartSizeNESW, HInstance, 'DXFCSIZENESW');
  dxRegisterCursor(crFlChartSizeNS, HInstance, 'DXFCSIZENS');
  dxRegisterCursor(crFlChartSizeNWSE, HInstance, 'DXFCSIZENWSE');
  dxRegisterCursor(crFlChartSizeWE, HInstance, 'DXFCSIZEWE');
end;

procedure FinalizeCursors;
begin
  dxUnregisterCursor(crFlChartCross);
  dxUnregisterCursor(crFlChartDrawFreeConnector);
  dxUnregisterCursor(crFlChartArrow);
  dxUnregisterCursor(crFlChartCopy);
  dxUnregisterCursor(crFlChartCreateRectangle);
  dxUnregisterCursor(crFlChartDragRemove);
  dxUnregisterCursor(crFlChartDrawConnectedConnector);
  dxUnregisterCursor(crFlChartHandDragPreview);
  dxUnregisterCursor(crFlChartHandPreview);
  dxUnregisterCursor(crFlChartHoverRotation);
  dxUnregisterCursor(crFlChartMove);
  dxUnregisterCursor(crFlChartNo);
  dxUnregisterCursor(crFlChartRotation);
  dxUnregisterCursor(crFlChartSizeAll);
  dxUnregisterCursor(crFlChartSizeNESW);
  dxUnregisterCursor(crFlChartSizeNS);
  dxUnregisterCursor(crFlChartSizeNWSE);
  dxUnregisterCursor(crFlChartSizeWE);
end;
...
begin
  ...
  try
    ...
    Result := TdxSugiyamaLayoutInfo.Create(TdxLayoutInfo.Create(APositionList.ToArray, ASize), ADummyEdgesRoutePoints);
  finally
    APositionList.Free;
    APositions.Free;
...
begin
  ...
  AGraph := TInfoGraph.Create(AGraphInfo.NodesInfo.ToArray, AEdges);
