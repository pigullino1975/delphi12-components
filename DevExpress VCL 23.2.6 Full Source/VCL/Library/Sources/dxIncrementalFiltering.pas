...
type
  ...
  public
    ScaleFactor: TdxOwnedScaleFactor; // for internal use
  ...
  public
    ...
    property ViewInfo: TdxCustomIncrementalFilteringContainerViewInfo read GetViewInfo; // for internal use
  end;

implementation

uses
  dxCore, dxCoreGraphics, cxEditConsts, cxDrawTextUtils;

const
  dxThisUnitName = 'dxIncrementalFiltering';
...
begin
  Result := TdxTextMeasurer.TextLineHeight(Font) + 8;
end;
...
begin
  Result := TdxTextMeasurer.TextWidthTO(Font, GetSearchInfoPanelText) + 2 * GetSearchInfoPanelTextOffset;
end;
