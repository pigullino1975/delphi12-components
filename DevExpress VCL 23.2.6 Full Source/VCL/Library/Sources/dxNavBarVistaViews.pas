...
uses
  ...
  cxGraphics, cxClasses, cxGeometry;
...
uses
  cxControls, dxOffice11, dxUxTheme, dxNavBarViewsFact, dxNavBarConsts, dxCore;

const
  dxThisUnitName = 'dxNavBarVistaViews';
...
begin
  ...
  DrawSkinElement(FSkinBasedPainterHelper.NavBarBackground, Canvas, ViewInfo.ClientRect, ScaleFactor);
end;
