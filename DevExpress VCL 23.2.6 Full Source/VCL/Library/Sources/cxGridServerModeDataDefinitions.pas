...
uses
  ...
  dxCoreClasses, cxEdit, cxDBEdit, cxGridCustomTableView, dxServerModeData;
...
uses
  ...
  cxStorage, cxGridCommon, cxGridLevel, Controls, Forms, RTLConsts, dxCore;

const
  dxThisUnitName = 'cxGridServerModeDataDefinitions';
