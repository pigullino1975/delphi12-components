...
uses
  ...
  cxGeometry, dxCoreGraphics, dxAnimation, dxFluentDesignFormInterfaces, dxGenerics, cxCustomCanvas;
...
type
  ...
  TdxRibbonShowCustomizationFormFunc = function(ARibbon: TdxCustomRibbon; const AMode: TdxRibbonCustomizationFormMode;
    ACustomizationFormClass: TFormClass{TdxRibbonCustomizationForm} = nil): Boolean;
  ...
  ['{0A28260B-C352-4704-A88B-44DD8461955C}']
    ...
    procedure Changed(AObject: TObject; AChangeType: TdxChangeType);
  ...
  public
    ...
    destructor Destroy; override;
    procedure AdjustApplicationButtonFont(AFont: TFont; AState: TdxRibbonApplicationButtonState);
    procedure AdjustContextFont(AFont: TFont; AContextColor: TColor);
    procedure AdjustTabHeaderFont(AFont: TFont; AState: Integer; AContext: TdxRibbonContext = nil);
    procedure FlushCache;

    //non-client routines
    procedure DrawRibbonFormCaption(ACanvas: TcxCanvas; const ABounds, ABordersWidth: TRect); virtual;
    procedure DrawRibbonFormCaptionFrameArea(ACanvas: TcxCanvas; R: TRect; const ABordersWidth: TRect); virtual;
    ...
    procedure DrawRibbonFormBorders(ACanvas: TcxCanvas; const ABounds, ABordersWidth: TRect); virtual;
    function HasRoundedWindowCorners: Boolean;
    ...
    property QuickAccessToolbarViewInfo: TdxRibbonQuickAccessToolbarViewInfo read GetQuickAccessToolbarViewInfo; // for internal use
    property Ribbon: TdxCustomRibbon read FRibbon;
    property ViewInfo: TdxRibbonViewInfo read GetViewInfo; // for internal use
  end;
  ...
  public
    ...
    property HitObjectAsButton: TdxRibbonCustomButtonViewInfo read GetHitObjectAsButton; // for internal use
  ...
  public
    ...
    property Owner: TdxRibbonViewInfo read FOwner; // for internal use
    property Ribbon: TdxCustomRibbon read GetRibbon;
  ...
  protected
    function GetAccessibleObjects: TList<TdxBarAccessibilityHelper>; virtual;
    function GetIAccessibilityHelper: IdxBarAccessibilityHelper; virtual;

    property AccessibleObjects: TList<TdxBarAccessibilityHelper> read GetAccessibleObjects;
  ...
  TdxRibbonCustomButtonAccessibilityHelper = class(TdxBarAccessibilityHelper) // for internal use
  private
    FLocalId: Integer;

    function GetButtonViewInfo: TdxRibbonCustomButtonViewInfo;
    function GetContainerViewInfo: TdxRibbonCustomContainerViewInfo;
    function GetRibbon: TdxCustomRibbon;
  protected
    ...
    property ButtonViewInfo: TdxRibbonCustomButtonViewInfo read GetButtonViewInfo;
    property ContainerViewInfo: TdxRibbonCustomContainerViewInfo read GetContainerViewInfo;
  ...
  protected
    ...
    function GetAccessibilityName: string; virtual;
  ...
  public
    ...
    function GetHitInfo(const AHitInfo: TdxRibbonHitInfo): Boolean; virtual;
    //
    property IAccessibilityHelper: IdxBarAccessibilityHelper read GetIAccessibilityHelper; // for internal use
    property Bounds: TRect read FBounds write FBounds;
    property Enabled: Boolean read GetIsEnabled;
    property Hint: string read GetHint;
    property Owner: TdxRibbonCustomContainerViewInfo read FOwner; // for internal use
    property Painter: TdxRibbonPainter read GetPainter; // for internal use
    property Ribbon: TdxCustomRibbon read GetRibbon;
    property ScaleFactor: TdxScaleFactor read GetScaleFactor;
  ...
  public
    ...
    property Bitmap: TcxBitmap32 read FBitmap; // for internal use
    property Items[Index: Integer]: TdxRibbonTabViewInfo read GetTabViewInfo; default; // for internal use
  ...
  protected
    function GetAccessibilityName: string; override;
  ...
  public
    ...
    procedure PopulateHorizontalNavigationList(AProc: TdxRibbonAddAccessibilityHelperProc); override;
    //
    property SelectedButton: TdxRibbonCustomButtonViewInfo read GetSelectedButton; // for internal use
    property Items[Index: Integer]: TdxRibbonCustomButtonViewInfo read GetItem; default; // for internal use
  end;
  ...
  public
    ...
    //
    property Items[Index: Integer]: TdxRibbonContextViewInfo read GetItem; default; // for internal use
  end;
  ...
  public
    ...
    //
    property ButtonsViewInfo: TdxRibbonTabsAreaButtonsViewInfo read FButtonsViewInfo; // for internal use
    ...
    property TabsViewInfo: TdxRibbonTabsViewInfo read FTabs; // for internal use
  ...
  strict private
    ...
    function GetPlace: TdxQATPosition;
  ...
  public
    ...
    property DockControl: TdxRibbonQuickAccessToolbarDockControl read GetDockControl; // for internal use
    ...
    property Place: TdxQATPosition read GetPlace;
  ...
  public
    ...
    property ApplicationButtonViewInfo: TdxRibbonApplicationButtonViewInfo read FApplicationButtonViewInfo; // for internal use
    ...
    property ContextsViewInfo: TdxRibbonContextsViewInfo read FContextsViewInfo; // for internal use
    property GroupsDockControlSiteBounds: TRect read FGroupsDockControlSiteBounds;
    property GroupsDockControlSiteViewInfo: TdxRibbonGroupsDockControlSiteViewInfo read FGroupsDockControlSiteViewInfo; // for internal use
    property QuickAccessToolbarViewInfo: TdxRibbonQuickAccessToolbarViewInfo read FQuickAccessToolbarViewInfo; // for internal use
    property TabGroupsDockControlBounds: TRect read FTabGroupsDockControlBounds;
    property TabsAreaViewInfo: TdxRibbonTabsAreaViewInfo read FTabsAreaViewInfo; // for internal use
  end;
  ...
  TdxRibbonBarControlAccessibilityHelper = class(TdxBarControlAccessibilityHelper) // for internal use
  protected
  ...
  strict private
    ...
    FCollapsedGroupWidthCache: TdxStringIntegerDictionary;
    FCollapsedGroupWidthCacheHeight: Integer;
  ...
  public
    ...
    function DropDownGalleryGetScrollBarWidth(AControlHeight: Integer): Integer; override;
  ...
  protected
    class procedure AdjustInnerItemPadding(var APadding: TdxPadding); override; // for internal use
    ...
    function NeedActivateOnPopup: Boolean; override;
  ...
  { TdxRibbonBorderIconsAreaAccessibilityHelper }

  TdxRibbonBorderIconsAreaAccessibilityHelper = class(TdxBarAccessibilityHelper) // for internal use
  protected
    ...
    function GetFormCaptionHelper: TdxRibbonFormCaptionHelper; virtual;

    property FormCaptionHelper: TdxRibbonFormCaptionHelper read GetFormCaptionHelper;
  public
    function GetScreenBounds(AChildID: TcxAccessibleSimpleChildElementID): TRect; override;
  end;
  ...
  TdxRibbonTabAreaToolbarBarControlAccessibilityHelper = class(TdxRibbonBarControlAccessibilityHelper) // for internal use
  strict private
    function GetRibbon: TdxCustomRibbon;
  protected
  ...
  public
    ...
    property DockControl: TdxRibbonGroupsDockControl read FDockControl; // for internal use
    property IAccessibilityHelper: IdxBarAccessibilityHelper read GetIAccessibilityHelper; // for internal use
  ...
  private
    FAccessibleObjects: TList<TdxBarAccessibilityHelper>;
  ...
  protected
    function GetAccessibleObjects: TList<dxBar.TdxBarAccessibilityHelper>; override;
    function GetIAccessibilityHelper: IdxBarAccessibilityHelper; override;
    procedure CalculateButtonsBounds(const ABounds: TRect); override;
  ...
  public
    ...
    property RibbonViewInfo: TdxRibbonViewInfo read GetRibbonViewInfo; // for internal use
    property TabGroupsScrollButtons: TdxRibbonScrollButtons read FTabGroupsScrollButtons;
    property TabGroupsScrollButtonLeft: TdxRibbonGroupsDockControlScrollButtonViewInfo read FTabGroupsScrollButtonLeft; // for internal use
    property TabGroupsScrollButtonRight: TdxRibbonGroupsDockControlScrollButtonViewInfo read FTabGroupsScrollButtonRight; // for internal use
  end;
  ...
  strict private
    ...
    function GetAccessibilityObjects: TList<TdxBarAccessibilityHelper>;
  ...
  private
    ...
    FIAccessibilityHelper: IdxBarAccessibilityHelper;
    FBorderIconsAreaIAccessibilityHelper: IdxBarAccessibilityHelper;
    ...
    procedure SetColorSchemeEx(const AName: string; AStyle: TdxRibbonStyle);
    ...
    function GetBorderIconsAreaIAccessibilityHelper: IdxBarAccessibilityHelper;
  protected
    FAccessibleObjects: TList<TdxBarAccessibilityHelper>;
    ...
    procedure DrawRibbonFormBorders(ACanvas: TcxCanvas; const ABounds, ABordersWidth: TRect);
    procedure DrawRibbonFormCaption(ACanvas: TcxCanvas; const ABounds, ABordersWidth: TRect; const ACaption: string);
    procedure DrawRibbonFormCorners(ACanvas: TcxCanvas; const ABounds: TRect; ACorners: TdxCorners);
    ...
    function GetSkin: TdxCustomRibbonSkin;
    function GetStatusBar(out AStatusBar: IdxRibbonFormStatusBar): Boolean;
    ...
    function IdxSkin.UseRoundedWindowCorners = SkinGetUseRoundedWindowCorners;
    ...
    function SkinGetUseRoundedWindowCorners: Boolean;
    // IdxRibbonMouseWheelReceiver
    function CanProcessMouseWheel: Boolean;
    //IdxFormKeyPreviewListener
    ...
    procedure RibbonFormNonClientDrawChanged(AObject: TObject; AChangeType: TdxChangeType);
  ...
  public
    ...
    property ColorScheme: TdxCustomRibbonSkin read FColorScheme write SetColorScheme; // for internal use
    ...
    property IAccessibilityHelper: IdxBarAccessibilityHelper read GetIAccessibilityHelper; // for internal use
    property BorderIconsAreaIAccessibilityHelper: IdxBarAccessibilityHelper read GetBorderIconsAreaIAccessibilityHelper; // for internal use
    ...
    property ViewInfo: TdxRibbonViewInfo read FViewInfo; // for internal use
  ...
  TdxRibbonAccessibilityHelper = class(TdxBarAccessibilityHelper) // for internal use
  private
  ...
  TdxRibbonTabCollectionAccessibilityHelper = class(TdxBarAccessibilityHelper) // for internal use
  private
  ...
  TdxRibbonTabAccessibilityHelper = class(TdxBarAccessibilityHelper) // for internal use
  private
    FLocalId: Integer;
  ...
  protected
    ...
    function IsNavigationKey(AKey: Word): Boolean; override;
    procedure OwnerObjectDestroyed; override;
    function LogicalNavigationGetNextAccessibleObject(AShift: TShiftState): IdxBarAccessibilityHelper; override;
  ...
  TdxRibbonApplicationButtonAccessibilityHelper = class(TdxBarAccessibilityHelper) // for internal use
  private
    FLocalId: Integer;
  ...
  { TdxRibbonContextAccessibilityHelper }

  TdxRibbonContextAccessibilityHelper = class(TdxBarAccessibilityHelper) // for internal use
  private
    function GetContext: TdxRibbonContext;
    function GetContextViewInfo: TdxRibbonContextViewInfo;
    function GetRibbon: TdxCustomRibbon;
  protected
    procedure DoDefaultAction(AChildID: TcxAccessibleSimpleChildElementID); override;
    function GetName(AChildID: TcxAccessibleSimpleChildElementID): string; override;
    ...
    property Context: TdxRibbonContext read GetContext;
    property ContextViewInfo: TdxRibbonContextViewInfo read GetContextViewInfo;
    property Ribbon: TdxCustomRibbon read GetRibbon;
  public
    function GetScreenBounds(AChildID: TcxAccessibleSimpleChildElementID): TRect; override;
  end;
  ...
  TdxRibbonGroupsDockControlAccessibilityHelper = class(TdxDockControlAccessibilityHelper) // for internal use
  private
    function GetDockControl: TdxRibbonGroupsDockControl;
  protected
    function GetChild(AIndex: Integer): TcxAccessibilityHelper; override;
  ...
  { TdxRibbonGroupsDockControlSiteAccessibilityHelper }

  TdxRibbonGroupsDockControlSiteAccessibilityHelper = class(TdxDockControlAccessibilityHelper) // for internal use
  private
    function GetDockControlSite: TdxRibbonGroupsDockControlSite;
  protected
    function ChildIsSimpleElement(AIndex: Integer): Boolean; override;
    function GetChild(AIndex: Integer): TcxAccessibilityHelper; override;
    function GetChildCount: Integer; override;
    ...
    function GetState(AChildID: TcxAccessibleSimpleChildElementID): Integer; override;
    function GetSupportedProperties(AChildID: TcxAccessibleSimpleChildElementID): TcxAccessibleObjectProperties; override;
    function IsParentForKeyTip: Boolean; override;

    property DockControlSite: TdxRibbonGroupsDockControlSite read GetDockControlSite;
  end;

  { TdxRibbonQuickAccessToolbarBarControlAccessibilityHelper }

  TdxRibbonQuickAccessToolbarBarControlAccessibilityHelper = class(TdxRibbonBarControlAccessibilityHelper) // for internal use
  private
    function GetBarControl: TdxRibbonQuickAccessToolbarBarControl;
  protected
    function GetChild(AIndex: Integer): TcxAccessibilityHelper; override;
  ...
  TdxRibbonQuickAccessToolbarBarControlMarkAccessibilityHelper = class(TdxBarControlMarkAccessibilityHelper) // for internal use
  private
    function GetBarControl: TdxRibbonQuickAccessToolbarBarControl;
  protected
    // IdxBarAccessibilityHelper
  ...
  TdxRibbonGroupBarControlAccessibilityHelper = class(TdxRibbonBarControlAccessibilityHelper) // for internal use
  private
    function GetBarControl: TdxRibbonGroupBarControl;
  ...
  TdxRibbonQuickAccessGroupButtonControlAccessibilityHelper = class(TdxBarButtonLikeControlAccessibilityHelper) // for internal use
  protected
...
uses
  Math, Types, dxOffice11, CommCtrl, MultiMon, dxThreading, dxCustomFluentDesignForm,
  ...
  //
  cxStyles, dxTypeHelpers;

const
  dxThisUnitName = 'dxRibbon';
...
type
  ...
  TdxRibbonFormCaptionHelperAccess = class(TdxRibbonFormCaptionHelper);
...
begin
  if not CheckGdiPlus then
    raise EdxBarException.CreateFmt(cxGetResourceString(@dxSBAR_GDIPLUSNEEDED), [AClass.ClassName]);
  if (AOwner = nil) and (Application.MainForm <> nil) then
    AOwner := Application.MainForm;
  if not (AOwner is TCustomForm) then
    raise EdxBarException.CreateFmt(cxGetResourceString(@dxSBAR_RIBBONBADOWNER), [AClass.ClassName]);
  if HasComponentOnForm(TCustomForm(AOwner), AClass) then
    raise EdxBarException.CreateFmt(cxGetResourceString(@dxSBAR_RIBBONMORETHANONE), [AClass.ClassName]);
end;
    ...
    mwrActiveBarControl:
      begin
        SendMessage(ActiveBarControl.Handle, WM_MOUSEWHEEL,
          ...
          PointToLParam(AMHS.MouseHookStruct.pt));
        AHookResult := 1;
      end;

    mwrWindow:
      if FindMouseWheelReceiver(WindowFromPoint(AMHS.MouseHookStruct.pt), AReceiver) and AReceiver.CanProcessMouseWheel then
      begin
        if AReceiver.DoMouseWheel(KeyboardStateToShiftState, SmallInt(HiWord(AMHS.mouseData)), AMHS.MouseHookStruct.pt) then
          AHookResult := 1;
      end
  end;
end;
...
begin
  raise EdxBarMergeException.Create(cxGetResourceString(AResString));
end;

procedure RaiseMergingError(AResString: Pointer; ATargetComponent, ASourceComponent: TComponent); overload;
begin
  raise EdxBarMergeException.Create(Format(cxGetResourceString(AResString),
...
procedure TdxRibbonPainter.AdjustApplicationButtonFont(AFont: TFont; AState: TdxRibbonApplicationButtonState);
begin
  ColorScheme.InitializePaintData(Self);
  ColorScheme.AdjustApplicationButtonFont(AFont, AState);
end;

procedure TdxRibbonPainter.AdjustContextFont(AFont: TFont; AContextColor: TColor);
begin
  ColorScheme.InitializePaintData(Self);
  ColorScheme.AdjustContextFont(AFont, ViewInfo.UseGlass, AContextColor);
end;

procedure TdxRibbonPainter.AdjustTabHeaderFont(AFont: TFont; AState: Integer; AContext: TdxRibbonContext = nil);
begin
  ColorScheme.InitializePaintData(Self);
  if AContext <> nil then
    ColorScheme.AdjustContextTabFont(AFont, AState, AContext.Color)
  else
    ColorScheme.AdjustTabFont(AFont, AState);
end;
...
begin
  if not cxRectIsEmpty(ABounds) then
    GetDefaultFormIcon(TSize.Create(ABounds)).StretchDraw(ACanvas.Handle, ABounds);
end;
...
begin
  if not cxRectIsEmpty(ABounds) then
    TdxImageDrawer.DrawUncachedImage(ACanvas.Handle, ABounds, ABounds, AGlyph, nil, -1, idmNormal, True);
end;
...
begin
  if AIsAllowContextPaint and ViewInfo.HasActiveContextTab then
    ...
    ColorScheme.DrawTabGroupsArea(ACanvas.Handle, ABounds, QuickAccessToolbarViewInfo.AtBottom, Ribbon.IsPopupGroupsMode);
end;
...
begin
  Result := Ribbon.ScaleFactor.Apply(TRect.Create(dxRibbonTabTextOffset, 7, dxRibbonTabTextOffset, 4));
...
begin
  ...
  begin
    ...
    S := cxGetStringAdjustedToWidth(ACanvas.Handle, ACanvas.Font.Handle,
      ADocumentName + ACaption, R.Width - 2 * dxCaptionGlowRadius);
    if Ribbon.UseRightToLeftAlignment then
...
procedure TdxRibbonPainter.DrawRibbonFormCaption(ACanvas: TcxCanvas; const ABounds, ABordersWidth: TRect);
var
  AFormPaintData: IdxRibbonFormPaintData;
begin
  AFormPaintData := GetRibbonFormPaintData;
  ColorScheme.InitializePaintData(Self);
  if not UseAeroNCPaint(AFormPaintData) then
    ColorScheme.DrawFormCaption(ACanvas.Handle, ABounds);
  if not Ribbon.Hidden and (AFormPaintData.GetState <> wsMinimized) then
  begin
    if Ribbon.ShowTabHeaders then
      DrawRibbonFormCaptionFrameArea(ACanvas, ABounds, ABordersWidth);
...
procedure TdxRibbonPainter.DrawRibbonFormCaptionFrameArea(ACanvas: TcxCanvas; R: TRect; const ABordersWidth: TRect);
begin
  ACanvas.SaveClipRegion;
  try
...
procedure TdxRibbonPainter.DrawRibbonFormBorders(ACanvas: TcxCanvas; const ABounds, ABordersWidth: TRect);
var
  AData: IdxRibbonFormPaintData;
begin
  AData := GetRibbonFormPaintData;
  ColorScheme.InitializePaintData(Self);
  ColorScheme.UseRightToLeftAlignment := Ribbon.UseRightToLeftAlignment;
  ColorScheme.DrawFormBorders(ACanvas.Handle, ABounds, ABordersWidth, AData.GetIsActive, IsRectangularFormBottom(AData));
  ColorScheme.DrawFormCorners(ACanvas.Handle, ABounds, dxAllCorners);
  ColorScheme.UseRightToLeftAlignment := False;
end;

function TdxRibbonPainter.HasRoundedWindowCorners: Boolean;
var
  AData: IdxRibbonFormPaintData;
begin
  AData := GetRibbonFormPaintData;
  Result := (AData <> nil) and (AData.GetWindowCornersRadius > 0);
end;
...
function TdxRibbonPainter.IsStatusBarVisible: Boolean;
begin
...
begin
  Result := dxRibbon.IsFormZoomed(Ribbon.RibbonForm);
end;
...
function TdxRibbonCustomContainerViewInfo.GetAccessibleObjects: TList<TdxBarAccessibilityHelper>;
begin
  Result := Owner.Ribbon.FAccessibleObjects;
end;

function TdxRibbonCustomContainerViewInfo.GetIAccessibilityHelper: IdxBarAccessibilityHelper;
begin
  Result := Owner.Ribbon.IAccessibilityHelper;
end;
...
procedure TdxRibbonCustomButtonAccessibilityHelper.OwnerObjectDestroyed;
begin
  if ContainerViewInfo.AccessibleObjects <> nil then
    ContainerViewInfo.AccessibleObjects[FLocalId - 1] := nil;
  inherited;
end;
...
procedure TdxRibbonCustomButtonAccessibilityHelper.Unselect(ANextSelectedObject: IdxBarAccessibilityHelper);
begin
...
function TdxRibbonCustomButtonAccessibilityHelper.GetName(AChildID: TcxAccessibleSimpleChildElementID): string;
begin
  Result := ButtonViewInfo.GetAccessibilityName;
end;
...
begin
  Result := ContainerViewInfo.IAccessibilityHelper.GetBarHelper;
end;

function TdxRibbonCustomButtonAccessibilityHelper.GetRole(AChildID: TcxAccessibleSimpleChildElementID): Integer;
begin
  Result := cxROLE_SYSTEM_PUSHBUTTON;
end;

constructor TdxRibbonCustomButtonAccessibilityHelper.Create(AOwnerObject: TObject);
begin
  inherited;
  FLocalId := ContainerViewInfo.AccessibleObjects.Count + 1;
  ContainerViewInfo.AccessibleObjects.Add(Self);
end;

function TdxRibbonCustomButtonAccessibilityHelper.GetScreenBounds(AChildID: TcxAccessibleSimpleChildElementID): TRect;
begin
  if Visible then
    Result := cxRectOffset(ButtonViewInfo.Bounds, ContainerViewInfo.IAccessibilityHelper.GetHelper.GetScreenBounds(0).TopLeft)
  else
    Result := cxEmptyRect;
end;
...
function TdxRibbonCustomButtonAccessibilityHelper.GetState(AChildID: TcxAccessibleSimpleChildElementID): Integer;
begin
  Result := Parent.States[cxAccessibleObjectSelfID];
  if (Result and cxSTATE_SYSTEM_INVISIBLE = 0) and IsRectEmpty(ButtonViewInfo.Bounds) then
    Result := Result or cxSTATE_SYSTEM_INVISIBLE;
  Result := Result or cxSTATE_SYSTEM_FOCUSABLE;
  if BarNavigationController.SelectedObject = ButtonViewInfo.IAccessibilityHelper then
    Result := Result or cxSTATE_SYSTEM_FOCUSED;
end;

function TdxRibbonCustomButtonAccessibilityHelper.GetSupportedProperties(
  AChildID: TcxAccessibleSimpleChildElementID): TcxAccessibleObjectProperties;
begin
  Result := [aopLocation, aopDefaultAction, aopFocus];
end;

function TdxRibbonCustomButtonAccessibilityHelper.GetButtonViewInfo: TdxRibbonCustomButtonViewInfo;
begin
  Result := TdxRibbonCustomButtonViewInfo(FOwnerObject);
end;

function TdxRibbonCustomButtonAccessibilityHelper.GetContainerViewInfo: TdxRibbonCustomContainerViewInfo;
begin
  Result := ButtonViewInfo.Owner;
end;

function TdxRibbonCustomButtonAccessibilityHelper.GetRibbon: TdxCustomRibbon;
begin
  Result := ButtonViewInfo.Ribbon;
end;
...
function TdxRibbonCustomButtonViewInfo.GetAccessibilityHelperClass: TdxBarAccessibilityHelperClass;
begin
  Result := TdxRibbonCustomButtonAccessibilityHelper;
end;

function TdxRibbonCustomButtonViewInfo.GetAccessibilityName: string;
begin
  Result := Hint;
end;
...
function TdxRibbonCustomButtonViewInfo.GetIAccessibilityHelper: IdxBarAccessibilityHelper;
begin
...
begin
  Result := FState;
  if (Result = cxbsNormal) and IAccessibilityHelper.IsSelected then
    Result := cxbsHot;
end;
...
begin
  ...
  if HasSeparator then
    FSeparatorBounds.Init(Bounds.Right - dxRibbonTabSeparatorWidth, Bounds.Top, Bounds.Right, Bounds.Bottom - 1)
  else
    FSeparatorBounds.Empty;
...
begin
  ...
  try
    FMenu.BarManager := Ribbon.BarManager;
    FMenu.Ribbon := Ribbon;
...
begin
  ...
  cxMeasureCanvas.Font := Ribbon.Fonts.TabHeader;
  for I := 0 to Count - 1 do
  begin
    ATab := Items[I];
    ATab.CalculateWidths(cxMeasureCanvas, Owner);
...
begin
  RemoveScrolling;
  R := Bounds;
  ADelta := FTotalOptimalWidth - R.Width;
...
begin
  if FTotalOptimalWidth <= Bounds.Width then
    CalculateSimpleTabLayout
  else
    if FTotalMinimalWidth <= Bounds.Width then
...
begin
  inherited;
  AProc(DropDownButton.IAccessibilityHelper);
end;
...
begin
  ...
  begin
    ...
    begin
      ...
      if ATextWidth < FTabBaseRectLTR.Width then
...
begin
  if (HelpButton.Glyph = nil) or HelpButton.Glyph.Empty then
    AIconSize.Init(dxGetSystemMetrics(SM_CXSMICON, ScaleFactor), dxGetSystemMetrics(SM_CYSMICON, ScaleFactor))
  else
    AIconSize := dxGetImageSize(HelpButton.Glyph, ScaleFactor);

  Result := Bounds;
  if HelpButton.StretchGlyph then
    AIconSize.Init(cxRectProportionalStretch(Result, AIconSize.cx, AIconSize.cy));
  Result := cxRectCenter(Result, AIconSize);
end;

function TdxRibbonHelpButtonViewInfo.GetAccessibilityName: string;
begin
  if HelpButton.ScreenTip <> nil then
    Result := HelpButton.ScreenTip.Header.Text
  else
    Result := 'Help';
end;
...
begin
  Result := nil;
  for I := 0 to Count - 1 do
    if Items[I].IAccessibilityHelper.IsSelected then
    begin
      Result := Items[I];
      Break;
    end;
...
begin
  for I := 0 to Count - 1 do
    AProc(Items[I].IAccessibilityHelper);
end;
...
begin
  ...
  R := cxRectSetRight(R, R.Left, R.Height);
  for I := Count - 1 downto 0 do
  begin
    Items[I].Bounds := R;
    R := cxRectOffset(R, -R.Width, 0);
  end;
...
destructor TdxRibbonContextViewInfo.Destroy;
begin
  BarAccessibilityHelperOwnerObjectDestroyed(FIAccessibilityHelper);
  inherited;
end;
...
begin
  ...
  begin
    ...
    FNeedShowHint := Bounds.Width < Owner.CalculateCaptionWidth(ACanvas, Context.Caption);
  end;
end;
...
begin
  Result := Bounds;
  FText := cxGetStringAdjustedToWidth(ACanvas.Handle, 0, Context.Caption, Bounds.Width - 2 * AIndent);
end;
...
begin
  ...
  begin
    if IsWinVistaOrLater and (IsPaintOnGlass or (Context.Alpha < MaxByte)) then
    begin
      AFlags := DT_CENTER or DT_SINGLELINE or DT_END_ELLIPSIS or DT_VCENTER or DT_NOPREFIX;
...
function TdxRibbonContextViewInfo.GetIAccessibilityHelper: IdxBarAccessibilityHelper;
begin
  if FIAccessibilityHelper = nil then
    FIAccessibilityHelper := TdxRibbonContextAccessibilityHelper.Create(Self);
  Result := FIAccessibilityHelper;
end;
...
begin
  ...
  cxMeasureCanvas.Font := GetContextFont;
  ...
  begin
    ...
    begin
      ...
      if R.Width > AMinWidth then
      begin
        AContextViewInfo := CreateContextViewInfo(ATabViewInfo.Tab.Context);
        AContextViewInfo.Calculate(cxMeasureCanvas, R);
...
begin
  ...
  if ApplicationButton.StretchGlyph then
    AIconSize.Init(cxRectProportionalStretch(FGlyphBounds, AIconSize));
...
begin
  ...
  Result := cxSizeAddMargins(Result, ClientOffsets);
end;
...
begin
  Result := Ribbon.CanFade and IsVisible and (State <> rabsPressed);
end;
...
begin
  if ApplicationButton.IAccessibilityHelper.IsSelected then
    ...
    if IsPressed or (Ribbon.ApplicationMenuState <> ramsHidden) then
      Result := rabsPressed
    else
      if IsHot then
        Result := rabsHot
...
begin
  Result.Init(0, ScaleFactor.Apply(3), 0, 0);
end;
...
begin
  ...
  begin
    ASize := CalculateToolbarSize(SearchToolbar.Toolbar, ARect.Width);
    if ASize.cx <= ARect.Width then
    begin
...
begin
  ...
  begin
    ASize := CalculateToolbarSize(Toolbar.Toolbar, ARect.Width div 2);
...
begin
  ...
  if IsSearchToolbarVisible then
    Result := Max(Result, GetBarHeight(SearchToolbar) + ScaleFactor.Apply(dxRibbonTabsAreaBottomIndent));
  if IsToolbarVisible then
    Result := Max(Result, GetBarHeight(Toolbar) + ScaleFactor.Apply(dxRibbonTabsAreaBottomIndent));
end;
...
begin
  ...
  if Visible then
  begin
    CalculateControlSize(ABounds.Width - cxMarginsWidth(DockControlOffsets));
    ...
    if Place = qatpBelow then
      FBounds.Deflate(ColorScheme.GetTabPanelHorizontalMargins);
...
begin
  ...
  CalculateControlSize(Owner.Bounds.Width);
...
begin
  ...
  begin
    ColorScheme.UseRightToLeftAlignment := Ribbon.UseRightToLeftAlignment;
    ColorScheme.DrawQuickAccessToolbar(ACanvas.Handle, Bounds, Place,
      Owner.IsApplicationButtonNearQAT, IsActive, not IsPaintOnGlass, not Owner.IsTabGroupsVisible(True));
    ColorScheme.UseRightToLeftAlignment := False;
  end;
end;
...
function TdxRibbonQuickAccessToolbarViewInfo.GetPlace: TdxQATPosition;
begin
  FAtTop := Visible and (Toolbar.Position = qtpAboveRibbon);
  FAtBottom := Visible and (Toolbar.Position = qtpBelowRibbon);
  FAtNonClientArea := AtTop and IsNonClientDrawingSupported;
  if AtNonClientArea then
    Result := qatpInCaption
  else if AtBottom then
    Result := qatpBelow
  else
    Result := qatpAbove;
  if (Result in [qatpInCaption, qatpAbove]) and (Ribbon.Style = rs2016Tablet) then
    Result := qatpInRibbon;
end;
...
begin
  ...
  begin
    ...
    Result.Right := Ribbon.ClientBounds.Right;
  end
  else
...
begin
  CalculateMetricsCore(cxMeasureCanvas);
end;
...
begin
  ...
  ACenterRect.Init(Bounds.Left, Result.Top, Bounds.Right, Result.Bottom);
  if not UseGlass then
    InflateRect(ACenterRect, -ScaleFactor.Apply(dxRibbonFormCaptionTextSpace), 0);

  W := ACenterRect.Width - ATextWidth;
...
begin
  //try center
  ALeftRect.Init(ABounds.Left, ABounds.Top, ContextsViewInfo.Bounds.Left, ABounds.Bottom);
  if not UseGlass then
  ...
  ARightRect.Init(ContextsViewInfo.Bounds.Right, ABounds.Top, ABounds.Right, ABounds.Bottom);
  if not UseGlass then
  ...
  //select the best
  ALeftWidth := ALeftRect.Width;
  ARightWidth := ARightRect.Width;
...
begin
  ...
  Result.Deflate(Ribbon.ColorScheme.GetTabPanelHorizontalMargins);
end;
...
begin
  if ApplicationButtonViewInfo.IsVisible then
    ApplicationButtonViewInfo.Calculate(TRect.CreateSize(ApplicationButtonViewInfo.MeasureSize))
  else
...
begin
  ...
  begin
    ARect := Bounds;
    AData := Ribbon.Painter.GetRibbonFormPaintData;
    if AData <> nil then
      Inc(ARect.Top, AData.GetWindowBordersWidth.Top + 1);
...
begin
  ...
  FCollapsedGroupWidthCache := TdxStringIntegerDictionary.Create;
...
begin
  ...
  FCollapsedGroupElementSizeDenominator := Skin.GetContentOffsets(DXBAR_COLLAPSEDTOOLBAR).Top +
    GetButtonHeight(GetSmallIconSize, DefaultFontHeight + dxRibbonGroupRowHeightCorrection, 0, DrawParams.ScaleFactor) * GetGroupRowCount +
  ...
  FGroupCaptionTextHeight := TdxTextMeasurer.TextLineHeight(Ribbon.Fonts.GetGroupHeaderFont);
  FGroupRowTextHeight := TdxTextMeasurer.TextLineHeight(Ribbon.Fonts.GetGroupFont);
end;
...
begin
  Result := GetButtonHeight(AIconSize, ATextHeight + AScaleFactor.Apply(dxRibbonGroupRowHeightCorrection), 0, AScaleFactor);
  APainter := GetLookAndFeelPainter;
  if APainter.ApplyEditorAdvancedMode then
    APadding := TRect.Null
  else
    APadding := TdxVisualRefinements.Padding;
  TdxRibbonCustomBarControl.AdjustInnerItemPadding(APadding);
  Inc(Result, APadding.ScaledHeight(AScaleFactor));
end;
...
function TdxRibbonBarPainter.DropDownGalleryGetScrollBarWidth(AControlHeight: Integer): Integer;
begin
  if IsSimplifiedGroupsLayout then
  begin
    Result := AControlHeight;
    dxAdjustToTouchableSize(Result, ScaleFactor);
  end
  else
    Result := inherited DropDownGalleryGetScrollBarWidth(AControlHeight)
end;
...
class function TdxRibbonBarPainter.SubMenuControlTextSize(ACanvas: TcxCanvas; AScaleFactor: TdxScaleFactor; APainter: TdxBarPainter): Integer;
var
  APadding: TRect;
begin
...
begin
  ...
  if FCollapsedGroupWidthCacheHeight <> ABarControl.Height then
  begin
    FCollapsedGroupWidthCacheHeight := ABarControl.Height;
    FCollapsedGroupWidthCache.Clear;
  end;

  if not FCollapsedGroupWidthCache.TryGetValue(ABarControl.GetCaption, Result) then
  begin
    cxMeasureCanvas.Font := ABarControl.Font;
    DrawParams.ResetCachedValues;
    DrawParams.Canvas := cxMeasureCanvas;
...
begin
  ...
  if IsSimplifiedGroupsLayout then
    ...
    Inc(Result.Top, Result.Height * FCollapsedGroupElementSizeNumerator div FCollapsedGroupElementSizeDenominator);
end;
...
begin
  ...
  if ABarControl.CaptionButtons.Count > 0 then
    Inc(Result, ABarControl.CaptionButtons.Rect.Width + Skin.GetContentOffsets(GetToolbarSkinPart(ABarControl)).Right);
end;
...
begin
  ...
  if AGroupGlyph <> nil then
    ...
    AGlyphSize.Init(GetSmallIconSize);
...
begin
  ...
  cxPaintControlTo(ADockControl, FImage.cxCanvas, cxNullPoint, cxGetClientRect(ADockControl), True, False, True, False);
  FImage.MakeOpaque;
end;
...
begin
  ...
  begin
    if (R.Width > ClientWidth) or (R.Left < 0) then
      ANewLeft := 0
    else
      ANewLeft := ClientWidth - R.Width;

    if ANewLeft <> R.Left then
      ViewInfo.InternalScrollGroups(ANewLeft - R.Left, Ribbon.ViewInfo.GetTabGroupsDockControlBounds.Width);
  end;
end;
...
begin
  ...
  try
    ...
    begin
      ...
      ARect := cxRectOffset(TRect.CreateSize(AToolbar.ViewInfo.GetSize), AOffset, 0);
...
procedure TdxRibbonGroupsDockControlViewInfo.Calculate(const ABoundsRect: TRect);
  ...
  begin
    Result := TryPlaceGroups(ABoundsRect.Width);
  end;
...
begin
  ...
  CalculateGroupsScrollInfo(ABoundsRect.Width);
...
begin
  ...
  Result.Init(ARibbonRect.Left, ATabsRect.Top - 1, ARibbonRect.Right, ATabsRect.Bottom);
  ...
  if (Result.Bottom + ATabGroupsHeight > AMonitorRect.Bottom) and (Ribbon.Style < rs2013) then
    Result.Init(Result.Left, Result.Top - ATabGroupsHeight, Result.Right, Result.Top)
  else
    Result.Init(Result.Left, Result.Bottom, Result.Right, Result.Bottom + ATabGroupsHeight);
  Result.Deflate(Ribbon.ColorScheme.GetTabPanelHorizontalMargins);
end;
...
procedure TdxRibbonTabGroupsPopupWindow.CMActionUpdate(var Message: TMessage);
begin
  inherited;
  if Message.Result = 0 then
    Message.Result := GetParentForm(Ribbon).Perform(Message.Msg, Message.WParam, Message.LParam);
end;
...
begin
  inherited;
  if Ribbon.ColorScheme.UseRoundedWindowCorners then
    SetWindowRgn(Handle, CreateRoundRectRgn(0, 0, Message.Width + 1, Message.Height + 1, 4, 4), True);
end;

{ TdxRibbonCustomBarControl }

class procedure TdxRibbonCustomBarControl.AdjustInnerItemPadding(var APadding: TdxPadding);
begin
...
begin
  ...
  if (BarDesignController.CustomizingItemLink <> nil) and TdxBarItemAccess(BarDesignController.CustomizingItemLink.Item).CanHaveOnlyOneLink then
...
function TdxRibbonCustomBarControl.NeedActivateOnPopup: Boolean;
begin
  Result := False;
end;
...
begin
  HandleNeeded;
  Result.Init(GetMarkSize, GetMinHeight(dsTop));
  for I := 0 to ItemLinks.CanVisibleItemCount - 1 do
  begin
  ...
  Result := cxSizeAddMargins(Result, GetClientOffset);
...
begin
  ...
  begin
    ASubItem := BarDesignController.AddInternalItem(AQuickControl.ItemLinks, TdxRibbonQuickAccessPopupSubItem, BarManager, InternalItems).Item as TdxRibbonQuickAccessPopupSubItem;
...
begin
  ...
  begin
    ASeparator := BarDesignController.AddInternalItem(AItemLinks, TdxBarSeparator, BarManager, InternalItems).Item;
    ...
    begin
      ...
      ASubItemButton := TdxRibbonQuickAccessPopupSubItemButton(BarDesignController.AddInternalItem(AItemLinks, TdxRibbonQuickAccessPopupSubItemButton, BarManager, InternalItems).Item);
...
begin
  ...
  try
    Ribbon.ColorScheme.DrawQuickAccessToolbarDefaultGlyph(ABitmap.Canvas.Handle, ABitmap.ClientRect, Ribbon.ViewInfo.QuickAccessToolbarViewInfo.Place);
...
begin
  if APaintType = ptMenu then
    ...
    Result := ColorScheme.GetQuickAccessToolbarColorPalette(AState, QuickAccessToolbarViewInfo.Place);
end;
...
function TdxRibbonBorderIconsAreaAccessibilityHelper.GetScreenBounds(AChildID: TcxAccessibleSimpleChildElementID): TRect;
begin
  if AChildID = 0 then
    Result := FormCaptionHelper.BorderIconsArea
  else
    Result := TdxRibbonFormCaptionHelperAccess(FormCaptionHelper).FBorderIconBounds[TdxRibbonBorderIcon(AChildID - 1)];

  Result := cxRectSetOrigin(Result, TdxCustomRibbon(FOwnerObject).ClientToScreen(Result.TopLeft));
end;

function TdxRibbonBorderIconsAreaAccessibilityHelper.ChildIsSimpleElement(AIndex: Integer): Boolean;
begin
  Result := True;
end;

procedure TdxRibbonBorderIconsAreaAccessibilityHelper.DoDefaultAction(AChildID: TcxAccessibleSimpleChildElementID);
begin
  if AChildID > 0 then
    SendMessage(TdxRibbonFormCaptionHelperAccess(FormCaptionHelper).FormHandle,
      DXM_RIBBONFORM_SYSCOMMAND, Ord(TdxRibbonBorderIcon(AChildID - 1)), 0);
end;

function TdxRibbonBorderIconsAreaAccessibilityHelper.GetChildCount: Integer;
begin
  Result := Integer(High(TdxRibbonBorderIcon)) + 1;
end;

function TdxRibbonBorderIconsAreaAccessibilityHelper.GetName(AChildID: TcxAccessibleSimpleChildElementID): string;
begin
  if AChildID = 0 then
    Result := ''
  else
    Result := TdxRibbonFormCaptionHelperAccess(FormCaptionHelper).GetHintText(TdxRibbonTrackedBorderIcon(AChildID));
end;

function TdxRibbonBorderIconsAreaAccessibilityHelper.GetOwnerObjectWindow: HWND;
begin
  Result := TdxBarAccessibilityHelperAccess(Parent).GetOwnerObjectWindow;
end;

function TdxRibbonBorderIconsAreaAccessibilityHelper.GetParent: TcxAccessibilityHelper;
begin
  Result := TdxCustomRibbon(FOwnerObject).RibbonForm.IAccessibilityHelper.GetHelper;
end;

function TdxRibbonBorderIconsAreaAccessibilityHelper.GetRole(AChildID: TcxAccessibleSimpleChildElementID): Integer;
begin
  if AChildID = 0 then
    Result := cxROLE_SYSTEM_TITLEBAR
  else
    Result := cxROLE_SYSTEM_PUSHBUTTON;
end;

function TdxRibbonBorderIconsAreaAccessibilityHelper.GetState(AChildID: TcxAccessibleSimpleChildElementID): Integer;
begin
  Result := Parent.States[cxAccessibleObjectSelfID];
  if (Result and cxSTATE_SYSTEM_INVISIBLE = 0) and not Assigned(FormCaptionHelper) then
    Result := Result or cxSTATE_SYSTEM_INVISIBLE;
  if AChildID > 0 then
  begin
    Result := Result or cxSTATE_SYSTEM_SELECTABLE;
    if cxRectIsEmpty(
      TdxRibbonFormCaptionHelperAccess(FormCaptionHelper).FBorderIconBounds[TdxRibbonBorderIcon(AChildID - 1)]) then
        Result := cxSTATE_SYSTEM_INVISIBLE;
  end;
end;

function TdxRibbonBorderIconsAreaAccessibilityHelper.GetSupportedProperties(
  AChildID: TcxAccessibleSimpleChildElementID): TcxAccessibleObjectProperties;
begin
  Result := [aopLocation];
  if AChildID > 0 then
...
function TdxRibbonBorderIconsAreaAccessibilityHelper.AreKeyTipsSupported(out AKeyTipWindowsManager: IdxBarKeyTipWindowsManager): Boolean;
begin
  Result := False;
end;

function TdxRibbonBorderIconsAreaAccessibilityHelper.GetAssignedKeyTip: string;
begin
  Result := '';
end;

function TdxRibbonBorderIconsAreaAccessibilityHelper.GetDefaultKeyTip: string;
begin
  Result := '';
end;

function TdxRibbonBorderIconsAreaAccessibilityHelper.GetFormCaptionHelper: TdxRibbonFormCaptionHelper;
begin
  Result := TdxCustomRibbon(FOwnerObject).FormCaptionHelper;
end;
...
begin
  Ribbon.UpdateHorizontalNavigationList;
  Result := GetRibbon.GetNextHorizontalAccessibleObject(AItemLinkHelper, ADirection)
end;

function TdxRibbonTabAreaToolbarBarControlAccessibilityHelper.GetParent: TcxAccessibilityHelper;
begin
  Result := Ribbon.IAccessibilityHelper.GetBarHelper;
end;

function TdxRibbonTabAreaToolbarBarControlAccessibilityHelper.LogicalNavigationGetNextChild(AChildIndex: Integer;
  AShift: TShiftState): TdxBarAccessibilityHelper;
begin
  Result := TdxBarAccessibilityHelperAccess(Childs[AChildIndex]).GetNextAccessibleObject(andRight).GetBarHelper;
end;

function TdxRibbonTabAreaToolbarBarControlAccessibilityHelper.GetRibbon: TdxCustomRibbon;
begin
  Result := TdxRibbonCustomToolbarBarControl(FOwnerObject).Ribbon;
end;
...
var
  AStyle: TcxStyle;
begin
  AStyle := TdxCustomBarEditAccess(ADrawParams.BarItemControl.Item).StyleEdit;
  if (AStyle = nil) or not (svTextColor in AStyle.AssignedValues) then
    Result := Ribbon.ColorScheme.GetPartColor(rtatpEditText, GetPartState(ADrawParams, icpControl))
  else
    Result := inherited EditControlGetTextColor(ADrawParams);
end;
...
procedure TdxRibbonTabAreaToolbarPopupBarControl.Finalize;
begin
  FreeAndNil(FPainter);
  inherited Finalize;
end;
...
begin
  ...
  if IsPopup then
  begin
    ARect := cxRectSetNullOrigin(WindowRect);
  ...
  begin
    ...
    ARect := cxRectOffset(cxGetClientRect(AHandle), APoint, False);
  end;
...
begin
  ...
  begin
    ...
    AButtonWidth := AButtonRect.Height + 1;
...
begin
  ...
  AGlyphRectSize := Min(AButton.Rect.Width, AButton.Rect.Height) - 2 {BorderSize} * 2;
...
procedure TdxRibbonGroupBarControl.DrawSelectedFrame(DC: HDC; const R: TRect);
  ...
  begin
    DrawRect(DC, TRect.Create(X1, Y1, X2, Y2), clBlack, True);
  end;
...
begin
  ...
  if Collapsed then
  begin
    ContentSize.Init(Ribbon.GroupsPainter.GetCollapsedGroupWidth(BarControl), Ribbon.GetGroupHeight);
...
begin
  if Ribbon.UseRightToLeftAlignment then
    DoRightToLeftConversion(TRect.CreateSize(ContentSize));
...
begin
  if not BarControl.HandleAllocated or not IsWindowVisible(BarControl.Handle) then
    raise EdxBarException.Create('TdxRibbonGroupBarControlViewInfo.CalculateKeyTipsBaseLinePositions fails');
...
begin
  ...
  Result.Init(cxMarginsWidth(R), cxMarginsHeight(R));
end;
...
procedure TdxRibbonGroupBarControlViewInfo.UpdateItemRects;
  ...
  function GetItemControlBounds(AItemViewInfo: TdxBarItemControlViewInfo): TRect;
  begin
    if Collapsed then
      Result := cxEmptyRect
    else
...
var
  AItemLink: TdxBarItemLink;
  ACompositeItemControlViewInfo: IdxBarCompositeItemControlViewInfo;
  AItemViewInfo: TdxBarItemControlViewInfo;
...
begin
  ...
  try
    ...
    for I := 0 to ItemControlCount - 1 do
    begin
      AItemViewInfo := ItemControlViewInfos[I];
      AItemLink := AItemViewInfo.Control.ItemLink;
      ABounds := GetItemControlBounds(AItemViewInfo);
      ANeedsInvalidateBarControl := ANeedsInvalidateBarControl or not EqualRect(AItemLink.ItemRect, ABounds);
      AItemLink.ItemRect := ABounds;
      if Supports(AItemViewInfo, IdxBarCompositeItemControlViewInfo, ACompositeItemControlViewInfo) then
        ANeedsInvalidateBarControl := ACompositeItemControlViewInfo.UpdateItemLinksBounds or ANeedsInvalidateBarControl;
    end;
  finally
...
begin
  for I := 0 to ItemControlCount - 1 do
  begin
    AItemViewInfo := IdxBarItemControlViewInfo(ItemControlViewInfos[I]);
    AItemBounds := AItemViewInfo.GetBounds;
    AItemViewInfo.SetBounds(TdxRightToLeftLayoutConverter.ConvertRect(AItemBounds, ABounds));
    if Supports(AItemViewInfo, IdxBarCompositeItemControlViewInfo, ACompositeItemControlViewInfo) then
      ACompositeItemControlViewInfo.DoRightToLeftConversion(ABounds);
  end;
...
begin
  ...
  if (ARowIndex < 0) or (ARowIndex > High(FKeyTipsBaseLinePositions.RowKeyTipsBaseLinePositions)) then
    raise EdxBarException.Create('TdxRibbonGroupBarControlViewInfo.GetRowKeyTipsBaseLinePosition fails');
...
begin
  Result.Init(FContentSize.cx + FNonContentAreaSize.cx, FContentSize.cy + FNonContentAreaSize.cy);
end;
...
begin
  Result.Init(ClientWidth, ClientHeight);
end;
...
begin
  if Value = Ribbon.QuickAccessToolbar.Toolbar then
    raise EdxBarException.Create(sdxErrorToolbarUsedAsQAT);
  for I := 0 to Tab.Groups.Count - 1 do
    if (Tab.Groups[I] <> Self) and (Tab.Groups[I].ToolBar = Value) then
      raise EdxBarException.Create(sdxErrorToolbarUsedInAnotherGroupInThisTab);
end;
...
begin
  for I := 0 to Ribbon.TabCount - 1 do
    for J := Ribbon.Tabs[I].Groups.Count - 1 downto 0 do
      if Ribbon.Tabs[I].Groups[J].ToolBar = AValue then
        Ribbon.Tabs[I].Groups[J].ToolBar := nil;
  if (Self <> Ribbon.QuickAccessToolbar) and (Ribbon.QuickAccessToolbar.Toolbar = AValue) then
    Ribbon.QuickAccessToolbar.Toolbar := nil;
  if (Self <> Ribbon.TabAreaToolbar) and (Ribbon.TabAreaToolbar.Toolbar = AValue) then
    Ribbon.TabAreaToolbar.Toolbar := nil;
  if (Self <> Ribbon.TabAreaSearchToolbar) and (Ribbon.TabAreaSearchToolbar.Toolbar = AValue) then
    Ribbon.TabAreaSearchToolbar.Toolbar := nil;
end;
...
begin
  ...
  begin
    AGroup := Groups[I];
    if (AGroup.ToolBar <> nil) and not (
      (I < AGroupCount) or (AGroup.IsToolBarShared and AGroup.ToolBar.Visible)) then
      Groups.Delete(I);
  end;
...
begin
  ...
  begin
    FFonts[I] := dxCreateFontForDefaultDPI;
...
begin
  Result := GetInternalFont(afTabHeader);
  Painter.AdjustTabHeaderFont(Result, AState, AContext);
end;
...
function TdxRibbonFonts.GetPainter: TdxRibbonPainter;
begin
  Result := Ribbon.Painter;
end;
...
var
  ...
  AFontIndex: TdxRibbonAssignedFont;
  AMasterFont: TFont;
  AMasterFontScaleFactor: TdxScaleFactor;
  AScaleFactor: TdxScaleFactor;
begin
  AScaleFactor := Ribbon.ScaleFactor;
  FCaptionFont.Handle := CreateFontIndirect(dxSystemInfo.NonClientMetrics.lfCaptionFont);
  FCaptionFont.Height := AScaleFactor.Apply(FCaptionFont.Height, dxSystemScaleFactor);

  if Ribbon.IsBarManagerValid then
  begin
    AMasterFont := Ribbon.BarManager.Font;
    AMasterFontScaleFactor := dxGetScaleFactor(Ribbon.BarManager);
  end
  else
  begin
    AMasterFont := Ribbon.Font;
    AMasterFontScaleFactor := AScaleFactor;
  end;
  ...
  try
    for AFontIndex := Low(TdxRibbonAssignedFont) to High(TdxRibbonAssignedFont) do
      ...
      begin
        ...
        dxAssignFont(AFont, AMasterFont, AScaleFactor, AMasterFontScaleFactor);
        case AFontIndex of
          afGroup:
...
begin
  ...
  try
    ...
    PopupEx(P.X, P.Y, AOwnerBounds.Width, AOwnerOffset, False, @AOwnerBounds, True, ARibbon);
...
begin
  if FRibbonPainter = nil then
    raise EdxBarException.Create(cxGetResourceString(@dxSBAR_APPMENUOUTSIDERIBBON));
  inherited Popup(X, Y);
end;
...
function TdxBarApplicationMenu.IsHiding: Boolean;
begin
  Result := False;
end;
...
begin
  if IsApplicationMenuDropped and not ApplicationButton.IMenu.IsHiding then
...
begin
  ...
  inherited Create(AOwner);
  FAccessibleObjects := TList<TdxBarAccessibilityHelper>.Create;
...
function TdxRibbonGroupsDockControlSiteViewInfo.GetAccessibleObjects: TList<dxBar.TdxBarAccessibilityHelper>;
begin
  Result := FAccessibleObjects;
end;

function TdxRibbonGroupsDockControlSiteViewInfo.GetIAccessibilityHelper: IdxBarAccessibilityHelper;
begin
  Result := FSite.IAccessibilityHelper;
end;
...
begin
  if (Ribbon.Style >= rs2013) and Ribbon.ShowMinimizeButton then
    Result := Ribbon.ScaleFactor.Apply(TSize.Create(30, 17))
  else
    Result := cxNullSize;
end;
...
function TdxRibbonGroupsDockControlSite.GetAccessibilityHelperClass: TdxBarAccessibilityHelperClass;
begin
  Result := TdxRibbonGroupsDockControlSiteAccessibilityHelper;
end;
...
function TdxRibbonGroupsDockControlSite.GetAccessibilityObjects: TList<TdxBarAccessibilityHelper>;
begin
  Result := Ribbon.ViewInfo.GroupsDockControlSiteViewInfo.AccessibleObjects;
end;
...
function TdxRibbonGroupsDockControlSite.GetIAccessibilityHelper: IdxBarAccessibilityHelper;
begin
  if FIAccessibilityHelper = nil then
    FIAccessibilityHelper := GetAccessibilityHelperClass.Create(Self);
  Result := FIAccessibilityHelper;
...
procedure TdxRibbonGroupsDockControlSite.WMGetObject(var Message: TMessage);
var
  AObjectID: Cardinal;
begin
  ...
  begin
    ...
    if (AObjectID = OBJID_CLIENT) or (AObjectID = OBJID_WINDOW) then
      ...
      if (AObjectID > 0) and (AObjectID <= Cardinal(GetAccessibilityObjects.Count)) then
        Message.Result := WMGetObjectResultFromIAccessibilityHelper(Message, GetAccessibilityObjects.Items[AObjectID - 1])
      else
        inherited;
  end
  else
...
begin
  ...
  FreeAndNil(FFonts);
  BarAccessibilityHelperOwnerObjectDestroyed(FIAccessibilityHelper);
  BarAccessibilityHelperOwnerObjectDestroyed(FBorderIconsAreaIAccessibilityHelper);
  FreeAndNil(FAccessibleObjects);
  inherited Destroy;
end;
...
procedure TdxCustomRibbon.DrawRibbonFormBorders(ACanvas: TcxCanvas; const ABounds, ABordersWidth: TRect);
var
  AFormData: IdxRibbonFormPaintData;
  AStatusBar: IdxRibbonFormStatusBar;
  AStatusBarBounds: TRect;
begin
  AFormData := Painter.GetRibbonFormPaintData;
  if (AFormData.GetState = wsNormal) and (ApplicationMenuState < ramsShownAsFrame) and GetStatusBar(AStatusBar) then
  begin
    AStatusBarBounds := ABounds;
    AStatusBarBounds.Bottom := AStatusBarBounds.Bottom - ABordersWidth.Bottom;
    AStatusBarBounds.Top := AStatusBarBounds.Bottom - AStatusBar.GetControl.Height;

    ACanvas.SaveClipRegion;
    try
      ACanvas.ExcludeClipRect(cxRectContent(ABounds, ABordersWidth));
      ColorScheme.UseRightToLeftAlignment := UseRightToLeftAlignment;
      ColorScheme.DrawStatusBar(ACanvas.Handle, AStatusBarBounds, AStatusBar.GetIsRaised(True), AStatusBar.GetIsRaised(False));
      ColorScheme.DrawFormCorners(ACanvas.Handle, ABounds, [coBottomLeft, coBottomRight]);
    finally
      ACanvas.RestoreClipRegion;
    end;

    ACanvas.ExcludeClipRect(AStatusBarBounds);
  end;

  Painter.DrawRibbonFormBorders(ACanvas, ABounds, ABordersWidth);
end;

procedure TdxCustomRibbon.DrawRibbonFormCaption(ACanvas: TcxCanvas; const ABounds, ABordersWidth: TRect; const ACaption: string);
begin
  Painter.DrawRibbonFormCaption(ACanvas, ABounds, ABordersWidth);
end;

procedure TdxCustomRibbon.DrawRibbonFormCorners(ACanvas: TcxCanvas; const ABounds: TRect; ACorners: TdxCorners);
begin
  ColorScheme.InitializePaintData(Painter);
  ColorScheme.DrawFormCorners(ACanvas.Handle, ABounds, ACorners);
end;
...
begin
  if ColorScheme.ExtendCaptionAreaOnTabs and (not ViewInfo.UseGlass or EnableTabAero) then
    Result := ViewInfo.TabsAreaViewInfo.MeasuredHeight - SkinGetPartSize(DXBAR_TABSGROUPSOVERLAPHEIGHT)
  else
    Result := 0;
end;
...
begin
  Result := GetStatusBar(AIntf) and (ApplicationMenuState < ramsShownAsFrame);
end;
...
begin
  ...
  begin
    ...
    begin
      ...
      if Painter.HasRoundedWindowCorners and GetStatusBar(AStatusBar) then
        cxRedrawWindow(AStatusBar.GetControl.Handle, RedrawAllFlags);
    end;
    if ViewInfo.QuickAccessToolbarViewInfo.AtNonClientArea then
...
begin
  ...
  case APart of
    ...
    DXBAR_GALLERYFILTERBAND:
      ColorScheme.DrawGalleryFilterBandBackground(DC, ARect, AState);
    ...
    DXBAR_MENUMARK:
      ColorScheme.DrawMenuMark(DC, ARect, AState);
    ...
    DXRIBBON_QAT_ARROWDOWN:              
      ColorScheme.DrawQuickAccessToolbarArrowDown(DC, ARect, AState, ViewInfo.QuickAccessToolbarViewInfo.Place);
    DXRIBBON_QAT_SMALLBUTTON:            
      ColorScheme.DrawQuickAccessToolbarSmallButton(DC, ARect, AState, ViewInfo.QuickAccessToolbarViewInfo.Place);
    DXRIBBON_QAT_SMALLBUTTON_GLYPH:      
      ColorScheme.DrawQuickAccessToolbarSmallButtonDropButtonMainPart(DC, ARect, AState, ViewInfo.QuickAccessToolbarViewInfo.Place);
    DXRIBBON_QAT_SMALLBUTTON_DROPBUTTON: 
      ColorScheme.DrawQuickAccessToolbarSmallButtonDropButtonArrowPart(DC, ARect, AState, ViewInfo.QuickAccessToolbarViewInfo.Place);
    DXRIBBON_QAT_MARKARROW:              
      ColorScheme.DrawQuickAccessToolbarMarkArrow(DC, ARect, AState, ViewInfo.QuickAccessToolbarViewInfo.Place);
    DXRIBBON_QAT_MARKTRUNCATED:
      ColorScheme.DrawQuickAccessToolbarMarkTruncated(DC, ARect, AState, ViewInfo.QuickAccessToolbarViewInfo.Place);
    DXRIBBON_QAT_GROUPBUTTON:
      ColorScheme.DrawQuickAccessToolbarGroupButton(DC, ARect,
        ViewInfo.QuickAccessToolbarViewInfo.Place, ViewInfo.IsFormCaptionActive, AState);
...
function TdxCustomRibbon.SkinGetUseRoundedWindowCorners: Boolean;
begin
...
procedure TdxCustomRibbon.RibbonFormNonClientDrawChanged(AObject: TObject; AChangeType: TdxChangeType);
var
  ARibbonForm: TdxCustomRibbonForm;
begin
  if SupportNonClientDrawing and not (rsSizing in FState) then
  begin
    ...
    begin
      ...
      begin
        ...
        ARibbonForm.UpdateColorScheme;
      end;
      WinControlFullInvalidate(ARibbonForm);
    end;
  end;
end;
...
function TdxCustomRibbon.FluentDesignContainerControlCanBeOpaque: Boolean;
begin
  Result := True;
end;
...
procedure TdxCustomRibbon.SetBiDiMode(Value: TBiDiMode);
begin
...
begin
  ...
  begin
    ...
    if Assigned(AParent) and not (AParent is TCustomForm) then
      raise EdxBarException.CreateFmt(cxGetResourceString(@dxSBAR_RIBBONBADPARENT), [ClassName]);
  end;
...
begin
  ...
  begin
    ...
    Result := Max(Result, ColorScheme.GetPartSize(rfspRibbonFormCaption));
...
procedure TdxCustomRibbon.PopulatePopupMenuItems(ALinks: TdxBarItemLinks; AItems: TdxRibbonPopupMenuItems; AOnClick: TNotifyEvent);
  ...
  begin
    ALink := BarDesignController.AddInternalItem(ALinks, TdxBarButton, BarManager, FInternalItems);
    ALink.BeginGroup := ANeedSeparator;
    Result := ALink.Item as TdxBarButton;
...
function TdxCustomRibbon.GetBorderIconsAreaIAccessibilityHelper: IdxBarAccessibilityHelper;
begin
  if FBorderIconsAreaIAccessibilityHelper = nil then
    FBorderIconsAreaIAccessibilityHelper:= TdxRibbonBorderIconsAreaAccessibilityHelper.Create(Self);
  Result := FBorderIconsAreaIAccessibilityHelper;
end;
...
function TdxCustomRibbon.GetSkin: TdxCustomRibbonSkin;
begin
  Result := ColorScheme;
end;

function TdxCustomRibbon.GetStatusBar(out AStatusBar: IdxRibbonFormStatusBar): Boolean;
var
  AForm: TCustomForm;
  I: Integer;
begin
  ...
  begin
    ...
    if (AForm <> nil) and AForm.HandleAllocated then
      ...
      begin
        if Supports(RibbonFormNonClientParts[I], IdxRibbonFormStatusBar, AStatusBar) and AStatusBar.GetActive(AForm) then
          Exit(True);
      end;
  end;
end;
...
procedure TdxCustomRibbon.SetColorSchemeEx(const AName: string; AStyle: TdxRibbonStyle);
begin
...
begin
  if not dxSameMethods(Value, FOnHelpButtonClick) then
  begin
...
begin
  SetColorSchemeEx(ColorSchemeName, AValue);
end;
...
function TdxRibbonAccessibilityHelper.ChildIsSimpleElement(AIndex: Integer): Boolean;
begin
  Result := False;
end;
...
begin
  ...
  AddAccessibilityChild(Ribbon.GroupsDockControlSite.IAccessibilityHelper);
  ...
  for I := 0 to Ribbon.ViewInfo.TabsAreaViewInfo.ButtonsViewInfo.Count - 1 do
    AddAccessibilityChild(Ribbon.ViewInfo.TabsAreaViewInfo.ButtonsViewInfo[I].IAccessibilityHelper);
  ...
  for I := 0 to Ribbon.ViewInfo.ContextsViewInfo.Count - 1 do
    AddAccessibilityChild(Ribbon.ViewInfo.ContextsViewInfo[I].IAccessibilityHelper);
...
function TdxRibbonAccessibilityHelper.GetName(AChildID: TcxAccessibleSimpleChildElementID): string;
begin
  Result := 'Ribbon';
end;
...
function TdxRibbonAccessibilityHelper.GetRole(AChildID: TcxAccessibleSimpleChildElementID): Integer;
begin
  Result := cxROLE_SYSTEM_TOOLBAR;
end;

function TdxRibbonAccessibilityHelper.GetScreenBounds(AChildID: TcxAccessibleSimpleChildElementID): TRect;
begin
  if Visible then
...
function TdxRibbonAccessibilityHelper.GetState(AChildID: TcxAccessibleSimpleChildElementID): Integer;
var
  AHandle: HWND;
begin
...
function TdxRibbonAccessibilityHelper.GetSupportedProperties(AChildID: TcxAccessibleSimpleChildElementID): TcxAccessibleObjectProperties;
begin
  Result := [aopLocation, aopFocus];
end;

function TdxRibbonAccessibilityHelper.LogicalNavigationGetChild(AIndex: Integer): TdxBarAccessibilityHelper;
begin
...
function TdxRibbonTabCollectionAccessibilityHelper.ChildIsSimpleElement(AIndex: Integer): Boolean;
begin
  Result := False;
end;
...
function TdxRibbonTabCollectionAccessibilityHelper.GetName(AChildID: TcxAccessibleSimpleChildElementID): string;
begin
  Result := 'Ribbon Tabs';
end;
...
function TdxRibbonTabCollectionAccessibilityHelper.GetRole(AChildID: TcxAccessibleSimpleChildElementID): Integer;
begin
...
function TdxRibbonTabCollectionAccessibilityHelper.GetSupportedProperties(AChildID: TcxAccessibleSimpleChildElementID): TcxAccessibleObjectProperties;
begin
  Result := [aopLocation];
end;
...
constructor TdxRibbonTabAccessibilityHelper.Create(AOwnerObject: TObject);
begin
  inherited;
  FLocalId := Ribbon.FAccessibleObjects.Count + 1;
  Ribbon.FAccessibleObjects.Add(Self);
end;
...
procedure TdxRibbonTabAccessibilityHelper.OwnerObjectDestroyed;
begin
  Ribbon.FAccessibleObjects[FLocalId - 1] := nil;
  inherited;
end;
...
function TdxRibbonTabAccessibilityHelper.LogicalNavigationGetNextChild(AChildIndex: Integer; AGoForward: Boolean): TdxBarAccessibilityHelper;
begin
  Result := TdxRibbonGroupsDockControlSiteAccessibilityHelper(
    Ribbon.GroupsDockControlSite.IAccessibilityHelper.GetHelper).LogicalNavigationGetNextChild(AChildIndex, AGoForward);
end;
...
procedure TdxRibbonTabAccessibilityHelper.Unselect(ANextSelectedObject: IdxBarAccessibilityHelper);
begin
  inherited Unselect(ANextSelectedObject);
  Tab.Invalidate;
end;

procedure TdxRibbonTabAccessibilityHelper.DoSelect(AFlags: Integer; AChildID: TcxAccessibleSimpleChildElementID);
begin
  Ribbon.ActiveTab := Tab;
end;

function TdxRibbonTabAccessibilityHelper.GetName(AChildID: TcxAccessibleSimpleChildElementID): string;
begin
  Result := Tab.Caption;
end;
...
function TdxRibbonTabAccessibilityHelper.GetRole(AChildID: TcxAccessibleSimpleChildElementID): Integer;
begin
  Result := cxROLE_SYSTEM_PAGETAB;
end;

function TdxRibbonTabAccessibilityHelper.GetScreenBounds(AChildID: TcxAccessibleSimpleChildElementID): TRect;
begin
  if Visible then
  begin
...
function TdxRibbonTabAccessibilityHelper.GetState(AChildID: TcxAccessibleSimpleChildElementID): Integer;
begin
  Result := Parent.States[cxAccessibleObjectSelfID];
  ...
  if BarNavigationController.SelectedObject = Tab.IAccessibilityHelper then
    Result := Result or cxSTATE_SYSTEM_FOCUSED;
end;

function TdxRibbonTabAccessibilityHelper.GetSupportedProperties(AChildID: TcxAccessibleSimpleChildElementID): TcxAccessibleObjectProperties;
begin
  Result := [aopLocation, aopFocus, aopShortcut, aopSelect];
end;

procedure TdxRibbonTabAccessibilityHelper.DoGetKeyTipsData(AKeyTipsData: TList);
begin
  TdxRibbonGroupsDockControlSiteAccessibilityHelper(
    Ribbon.GroupsDockControlSite.IAccessibilityHelper.GetHelper).DoGetKeyTipsData(AKeyTipsData);
end;
...
function TdxRibbonApplicationButtonAccessibilityHelper.HandleNavigationKey(var AKey: Word): Boolean;
begin
  Result := inherited HandleNavigationKey(AKey);
  if not Result then
  begin
...
procedure TdxRibbonApplicationButtonAccessibilityHelper.OwnerObjectDestroyed;
begin
  Ribbon.FAccessibleObjects[FLocalId - 1] := nil;
  inherited;
end;
...
begin
  inherited Select(ASetFocus);
  NotifyWinEvent(EVENT_OBJECT_FOCUS, Parent.OwnerObjectWindow, FLocalId, CHILDID_SELF);
...
procedure TdxRibbonApplicationButtonAccessibilityHelper.DoDefaultAction(AChildID: TcxAccessibleSimpleChildElementID);
begin
  Ribbon.ApplicationMenuPopup;
end;

function TdxRibbonApplicationButtonAccessibilityHelper.GetName(AChildID: TcxAccessibleSimpleChildElementID): string;
begin
  if (ApplicationButton.ScreenTip <> nil) and (ApplicationButton.ScreenTip.Header <> nil) then
    Result := ApplicationButton.ScreenTip.Header.Text
  else
    Result := ApplicationButton.Text;
end;
...
function TdxRibbonApplicationButtonAccessibilityHelper.GetRole(AChildID: TcxAccessibleSimpleChildElementID): Integer;
begin
  Result := cxROLE_SYSTEM_PUSHBUTTON;
end;

constructor TdxRibbonApplicationButtonAccessibilityHelper.Create(AOwnerObject: TObject);
begin
  inherited;
  FLocalId := Ribbon.FAccessibleObjects.Count + 1;
  Ribbon.FAccessibleObjects.Add(Self);
...
function TdxRibbonApplicationButtonAccessibilityHelper.GetScreenBounds(AChildID: TcxAccessibleSimpleChildElementID): TRect;
begin
  if Visible then
  begin
...
function TdxRibbonApplicationButtonAccessibilityHelper.GetState(AChildID: TcxAccessibleSimpleChildElementID): Integer;
begin
  Result := Parent.States[cxAccessibleObjectSelfID];
  if not ApplicationButtonViewInfo.IsVisible then
    Result := Result or cxSTATE_SYSTEM_INVISIBLE;
  Result := Result or cxSTATE_SYSTEM_FOCUSABLE;
  if BarNavigationController.SelectedObject = ApplicationButton.IAccessibilityHelper then
    Result := Result or cxSTATE_SYSTEM_FOCUSED;
end;

function TdxRibbonApplicationButtonAccessibilityHelper.GetSupportedProperties(
  AChildID: TcxAccessibleSimpleChildElementID): TcxAccessibleObjectProperties;
begin
...
function TdxRibbonApplicationButtonAccessibilityHelper.GetApplicationButton: TdxRibbonApplicationButton;
begin
  Result := OwnerObject as TdxRibbonApplicationButton;
end;
...
procedure TdxRibbonApplicationButtonAccessibilityHelper.ShowApplicationMenu(APostMessage: UINT);
begin
  BarNavigationController.UnselectAssignedSelectedObject;
...
function TdxRibbonContextAccessibilityHelper.GetScreenBounds(AChildID: TcxAccessibleSimpleChildElementID): TRect;
begin
  if Visible then
  begin
    Result := ContextViewInfo.Bounds;
    Result.TopLeft := Ribbon.ClientToScreen(Result.TopLeft);
    Result.BottomRight := Ribbon.ClientToScreen(Result.BottomRight);
  end
  else
...
procedure TdxRibbonContextAccessibilityHelper.DoDefaultAction(AChildID: TcxAccessibleSimpleChildElementID);
begin
  Context.Activate;
end;

function TdxRibbonContextAccessibilityHelper.GetName(AChildID: TcxAccessibleSimpleChildElementID): string;
begin
  Result := Context.Caption;
end;

function TdxRibbonContextAccessibilityHelper.GetOwnerObjectWindow: HWND;
begin
  Result := Ribbon.Handle;
end;

function TdxRibbonContextAccessibilityHelper.GetParent: TcxAccessibilityHelper;
begin
  Result := Ribbon.IAccessibilityHelper.GetHelper;
end;

function TdxRibbonContextAccessibilityHelper.GetRole(AChildID: TcxAccessibleSimpleChildElementID): Integer;
begin
  Result := cxROLE_SYSTEM_PUSHBUTTON;
end;

function TdxRibbonContextAccessibilityHelper.GetSelectable: Boolean;
begin
  Result := False;
end;

function TdxRibbonContextAccessibilityHelper.GetState(AChildID: TcxAccessibleSimpleChildElementID): Integer;
begin
  Result := Parent.States[cxAccessibleObjectSelfID];
  if not Context.Visible then
    Result := Result or cxSTATE_SYSTEM_INVISIBLE;
end;

function TdxRibbonContextAccessibilityHelper.GetSupportedProperties(AChildID: TcxAccessibleSimpleChildElementID): TcxAccessibleObjectProperties;
begin
  Result := [aopLocation, aopDefaultAction];
end;

function TdxRibbonContextAccessibilityHelper.AreKeyTipsSupported(out AKeyTipWindowsManager: IdxBarKeyTipWindowsManager): Boolean;
begin
  Result := False;
end;

function TdxRibbonContextAccessibilityHelper.GetAssignedKeyTip: string;
begin
  Result := '';
end;

function TdxRibbonContextAccessibilityHelper.GetDefaultKeyTip: string;
begin
  Result := '';
end;

function TdxRibbonContextAccessibilityHelper.GetContext: TdxRibbonContext;
begin
  Result := ContextViewInfo.Context;
end;

function TdxRibbonContextAccessibilityHelper.GetContextViewInfo: TdxRibbonContextViewInfo;
begin
  Result := TdxRibbonContextViewInfo(OwnerObject);
end;

function TdxRibbonContextAccessibilityHelper.GetRibbon: TdxCustomRibbon;
begin
  Result := Context.Ribbon;
end;
...
function TdxRibbonGroupsDockControlAccessibilityHelper.GetName(AChildID: TcxAccessibleSimpleChildElementID): string;
begin
  Result := DockControl.Ribbon.ActiveTab.Caption;
end;
...
begin
  if dxBarGetParentPopupWindow(DockControl, False) <> nil then
    ...
    Result := TdxRibbonGroupsDockControl(DockControl).Ribbon.GroupsDockControlSite.IAccessibilityHelper.GetHelper;
end;

function TdxRibbonGroupsDockControlAccessibilityHelper.GetRole(AChildID: TcxAccessibleSimpleChildElementID): Integer;
begin
...
function TdxRibbonGroupsDockControlSiteAccessibilityHelper.ChildIsSimpleElement(AIndex: Integer): Boolean;
begin
  Result := False;
end;

function TdxRibbonGroupsDockControlSiteAccessibilityHelper.GetChild(AIndex: Integer): TcxAccessibilityHelper;
begin
  if AIndex = 0 then
    Result := DockControlSite.DockControl.IAccessibilityHelper.GetBarHelper
  else
    Result := DockControlSite.Ribbon.ViewInfo.GroupsDockControlSiteViewInfo.Items[AIndex - 1].IAccessibilityHelper.GetBarHelper;
end;

function TdxRibbonGroupsDockControlSiteAccessibilityHelper.GetChildCount: Integer;
begin
  if States[0] and cxSTATE_SYSTEM_INVISIBLE = 0 then
    Result := DockControlSite.Ribbon.ViewInfo.GroupsDockControlSiteViewInfo.Count + 1
  else
    Result := 0;
end;

function TdxRibbonGroupsDockControlSiteAccessibilityHelper.GetChildIndex(AChild: TcxAccessibilityHelper): Integer;
var
  I: Integer;
begin
  Result := 1;
  if AChild <> DockControlSite.DockControl.IAccessibilityHelper.GetBarHelper then
    for I := 0 to DockControlSite.Ribbon.ViewInfo.GroupsDockControlSiteViewInfo.Count - 1 do
      if AChild = DockControlSite.Ribbon.ViewInfo.GroupsDockControlSiteViewInfo.Items[I].IAccessibilityHelper.GetBarHelper then
        Result := I + 2;
end;

function TdxRibbonGroupsDockControlSiteAccessibilityHelper.GetParent: TcxAccessibilityHelper;
begin
  Result := DockControlSite.Ribbon.IAccessibilityHelper.GetHelper;
end;

function TdxRibbonGroupsDockControlSiteAccessibilityHelper.GetRole(AChildID: TcxAccessibleSimpleChildElementID): Integer;
begin
  Result := cxROLE_SYSTEM_PANE;
end;

function TdxRibbonGroupsDockControlSiteAccessibilityHelper.GetState(AChildID: TcxAccessibleSimpleChildElementID): Integer;
begin
  Result := Parent.States[cxAccessibleObjectSelfID];
  if (Result and cxSTATE_SYSTEM_INVISIBLE = 0) and (not DockControlSite.Visible or cxRectIsEmpty(DockControlSite.Bounds)) then
    Result := Result or cxSTATE_SYSTEM_INVISIBLE;
end;

function TdxRibbonGroupsDockControlSiteAccessibilityHelper.GetSupportedProperties(
  AChildID: TcxAccessibleSimpleChildElementID): TcxAccessibleObjectProperties;
begin
  Result := [aopLocation];
end;

function TdxRibbonGroupsDockControlSiteAccessibilityHelper.IsParentForKeyTip: Boolean;
begin
  Result := False;
end;

function TdxRibbonGroupsDockControlSiteAccessibilityHelper.GetDockControlSite: TdxRibbonGroupsDockControlSite;
begin
  Result := TdxRibbonGroupsDockControlSite(FOwnerObject);
end;
...
begin
  ...
  begin
    ...
    NotifyWinEvent(EVENT_OBJECT_FOCUS, OwnerObjectWindow,
      TdxBarControlMarkAccessibilityHelper(BarControl.MarkIAccessibilityHelper).LocalId, CHILDID_SELF);
  end;
end;
...
begin
  if not IsCollapsed then
    raise EdxBarException.Create('TdxRibbonGroupBarControlAccessibilityHelper.Expand fails');
  ShowPopupBarControl;
...
begin
  ...
  FRibbon := ARibbon;
  Canvas.Font.Height := GetScaled(dxGetFontHeightForDefaultDPI(Canvas.Font.Size));
end;
...
begin
  ...
  with GetWindowPosition(TSize.Create(ATempWindow.Width, ATempWindow.Height), ABasePoint, AVertAlign) do
  begin
    ATempWindow.Left := X;
    ATempWindow.Top := Y;
  end;
...
procedure TdxRibbonScrollBarPainter.DoDrawScrollBarPart(ACanvas: TcxCustomCanvas; const R: TRect; APart: TcxScrollBarPart; AState: TcxButtonState);
const
  StateMap: array[TcxButtonState] of Integer = (
...
begin
  if Skin <> nil then
    Skin.DrawBackground((ACanvas as TcxCanvas).Handle, R, PartMap[ScrollBar.Kind, APart], StateMap[AState])
  else
    inherited DoDrawScrollBarPart(ACanvas, R, APart, AState);
end;

procedure TdxRibbonScrollBarPainter.DrawScrollBarBackground(ACanvas: TcxCustomCanvas; const R: TRect);
const
  PartMap: array[TScrollBarKind] of Integer = (DXBAR_SCROLLBARHORZ_BACKGROUND, DXBAR_SCROLLBARVERT_BACKGROUND);
begin
  if Skin <> nil then
    Skin.DrawBackground((ACanvas as TcxCanvas).Handle, R, PartMap[ScrollBar.Kind])
  else
