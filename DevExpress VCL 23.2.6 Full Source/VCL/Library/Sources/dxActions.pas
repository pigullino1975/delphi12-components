...
type
  ...
  { IdxActionDescriptionTabbedText }

  IdxActionGalleryWithDescriptionTabbedText = interface
  ['{B55F386C-EC46-44C4-BC98-7C26AB067A43}']
  end;
  ...
  protected
    ...
    procedure DoAfterSetControl; virtual;
    procedure DoBeforeSetControl; virtual;
...
procedure TdxBasicAction.DoAfterSetControl;
begin
  if FControl <> nil then
    FControl.FreeNotification(Self);
end;

procedure TdxBasicAction.DoBeforeSetControl;
begin
  if FControl <> nil then
...
function TdxBasicAction.IsDestroying: Boolean;
begin
