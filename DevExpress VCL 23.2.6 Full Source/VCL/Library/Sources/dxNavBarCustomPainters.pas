...
type
  ...
  protected
    ...
    class procedure InternalDrawSelection(ACanvas: TCanvas; ARect: TRect;
      ABackColor: TColor; AState: TdxNavBarObjectStates; AScaleFactor: TdxScaleFactor); virtual;
    class function IsPressed(AState: TdxNavBarObjectStates): Boolean; virtual;
  public
    class procedure DrawSelection(ACanvas: TCanvas; ARect: TRect; ABackColor: TColor;
  ...
  protected
    ...
    class procedure FillGradientRect(DC: HDC; const ARect: TRect; AColor1, AColor2: TColor;
    ...
    class procedure InternalDrawBackground(ACanvas: TCanvas; ARect: TRect; APicture: TPicture;
      AEraseBackground: Boolean; ABackgroundColor: TColor; AColor1, AColor2: TColor; AAlphaBlend1, AAlphaBlend2: Byte;
      AGradientMode: TdxBarStyleGradientMode; AScaleFactor: TdxScaleFactor); virtual;
  public
    class procedure DrawBackground(ACanvas: TCanvas; ARect: TRect; APicture: TPicture; AEraseBackground: Boolean;
      ABackgroundColor: TColor; AColor1, AColor2: TColor; AAlphaBlend1, AAlphaBlend2: Byte;
      AGradientMode: TdxBarStyleGradientMode; AScaleFactor: TdxScaleFactor);
  end;
  ...
  protected
    class procedure InternalDrawBackground(ACanvas: TCanvas; ARect: TRect; APicture: TPicture; AColor1, AColor2: TColor;
      AAlphaBlend1, AAlphaBlend2: Byte; AGradientMode: TdxBarStyleGradientMode; AScaleFactor: TdxScaleFactor); virtual;
  public
    class procedure DrawBackground(ACanvas: TCanvas; ARect: TRect; APicture: TPicture; AColor1, AColor2: TColor;
      AAlphaBlend1, AAlphaBlend2: Byte; AGradientMode: TdxBarStyleGradientMode; AScaleFactor: TdxScaleFactor);
  end;
  ...
  protected
    class procedure InternalDrawHint(ACanvas: TCanvas; ARect: TRect; AHint: string;
      ...
      AGradientMode: TdxBarStyleGradientMode; AFont: TFont; AScaleFactor: TdxScaleFactor); virtual;
  public
    class procedure DrawHint(ACanvas: TCanvas; ARect: TRect; AHint: string;
      APicture: TPicture; AColor1, AColor2: TColor; AAlphaBlend1, AAlphaBlend2: Byte;
      AGradientMode: TdxBarStyleGradientMode; AFont: TFont; AScaleFactor: TdxScaleFactor);
  end;
  ...
  protected
    class procedure InternalDrawButton(ACanvas: TCanvas; ARect: TRect; APicture: TPicture;
      ...
      AState: TdxNavBarObjectStates; AScaleFactor: TdxScaleFactor); virtual;
  public
  ...
  protected
    class procedure InternalDrawBottomButton(ACanvas: TCanvas; ARect: TRect;
      ...
      AAlphaBlend1, AAlphaBlend2: Byte; AGradientMode: TdxBarStyleGradientMode;
      ABorderColor: TColor; AState: TdxNavBarObjectStates; AScaleFactor: TdxScaleFactor); virtual;
  ...
  protected
    ...
    // Color Palettes
    function GetGroupColorPalette(AGroupViewInfo: TdxNavBarGroupViewInfo): IdxColorPalette; virtual;
    ...
    class function OverflowPanelBackgroundPainterClass: TdxNavBarCustomButtonPainterClass; virtual;
...
const
  dxThisUnitName = 'dxNavBarCustomPainters';
...
begin
  ...
  if Result then
    TdxImageDrawer.DrawUncachedImage(ACanvas.Handle, ARect, ARect, nil, AImageList,
...
class procedure TdxNavBarCustomSelectionPainter.DrawSelection(ACanvas: TCanvas;
  ARect: TRect; ABackColor: TColor; AState: TdxNavBarObjectStates; AScaleFactor: TdxScaleFactor);
begin
  InternalDrawSelection(ACanvas, ARect, ABackColor, AState, AScaleFactor);
end;
...
class procedure TdxNavBarCustomSelectionPainter.InternalDrawSelection(
  ACanvas: TCanvas; ARect: TRect; ABackColor: TColor; AState: TdxNavBarObjectStates; AScaleFactor: TdxScaleFactor);
var
...
begin
  ...
  begin
    GetColors(AState, ABackColor, AFillColor, ATopLeftOuterColor, ABottomRightOuterColor, ATopLeftInnerColor, ABottomRightInnerColor);
    dxNavBarDrawSelectedFrame(ACanvas, ARect, ATopLeftOuterColor, ABottomRightOuterColor, ATopLeftInnerColor, ABottomRightInnerColor);
...
class procedure TdxNavBarCustomBackgroundPainter.DrawBackground(ACanvas: TCanvas; ARect: TRect;
  APicture: TPicture; AEraseBackground: Boolean; ABackgroundColor: TColor; AColor1, AColor2: TColor;
  AAlphaBlend1, AAlphaBlend2: Byte; AGradientMode: TdxBarStyleGradientMode; AScaleFactor: TdxScaleFactor);
begin
  InternalDrawBackground(ACanvas, ARect, APicture, AEraseBackground, ABackgroundColor,
    AColor1, AColor2, AAlphaBlend1, AAlphaBlend2, AGradientMode, AScaleFactor);
end;
...
begin
  InternalDrawBackground(ACanvas, ARect, APicture, AColor1, AColor2,
    AAlphaBlend1, AAlphaBlend2, AGradientMode, AScaleFactor);
end;
...
class procedure TdxNavBarCustomHintPainter.DrawHint(ACanvas: TCanvas; ARect: TRect; AHint: string;
  APicture: TPicture; AColor1, AColor2: TColor; AAlphaBlend1, AAlphaBlend2: Byte;
  AGradientMode: TdxBarStyleGradientMode; AFont: TFont; AScaleFactor: TdxScaleFactor);
begin
  InternalDrawHint(ACanvas, ARect, AHint, APicture, AColor1, AColor2,
    AAlphaBlend1, AAlphaBlend2, AGradientMode, AFont, AScaleFactor);
end;

class procedure TdxNavBarCustomHintPainter.InternalDrawHint(ACanvas: TCanvas; ARect: TRect; AHint: string;
  APicture: TPicture; AColor1, AColor2: TColor; AAlphaBlend1, AAlphaBlend2: Byte;
  AGradientMode: TdxBarStyleGradientMode; AFont: TFont; AScaleFactor: TdxScaleFactor);
begin
  if AHint <> '' then
...
class procedure TdxNavBarCustomButtonPainter.InternalDrawButton(ACanvas: TCanvas; ARect: TRect; APicture: TPicture;
  AColor1, AColor2: TColor; AAlphaBlend1, AAlphaBlend2: Byte; AGradientMode: TdxBarStyleGradientMode;
  ABorderColor: TColor; AState: TdxNavBarObjectStates; AScaleFactor: TdxScaleFactor);
begin
  TdxNavBarCustomBackgroundPainter.DrawBackground(ACanvas,
    ARect, APicture, False, clBtnFace, AColor1, AColor2,
    AAlphaBlend1, AAlphaBlend2, AGradientMode, AScaleFactor);
end;
...
class procedure TdxNavBarCustomDropTargetGroupPainter.InternalDrawTargetGroup(
  ACanvas: TCanvas; ARect: TRect; AColor1, AColor2: TColor; AAlphaBlend1, AAlphaBlend2: Byte;
  AGradientMode: TdxBarStyleGradientMode; AScaleFactor: TdxScaleFactor);
begin
  if IsGdiPlusAvailable then
...
begin
  with ViewInfo do
    BackgroundPainterClass.DrawBackground(Canvas, ViewInfo.ClientRect, BgImage, True, NavBar.Color,
      BgBackColor, BgBackColor2, BgAlphaBlend, BgAlphaBlend2, BgGradientMode, ScaleFactor);
end;
...
begin
  ...
  if (AGroupViewInfo <> nil) and (AGroupViewInfo.Group <> NavBar.SourceGroup) then
    ...
    DropTargetGroupPainterClass.DrawTargetGroup(Canvas, AGroupViewInfo.CaptionRect,
      ...
      DragDropGroupTargetGradient, ScaleFactor);
end;

procedure TdxNavBarElementPainter.DrawDropTargetLinkSelection;

  function IsVisible(ATargetObject: TObject): Boolean;
  begin
    Result := False;
    if ATargetObject is TdxNavBarGroup then
      Result := TdxNavBarGroup(ATargetObject).Visible
    else
      if ATargetObject is TdxNavBarItemLink then
        Result := TdxNavBarItemLink(ATargetObject).Item.Visible;
  end;

  function GetItemInfoTargetPosition: Integer;
  var
    AGroup: TdxNavBarGroup;
    I: Integer;
  begin
    Result := NavBar.TargetPosition;
    AGroup := NavBar.TargetGroup;
    if InRange(Result, 1, AGroup.ChildCount - 1) then
    begin
      Result := 0;
      for I := 0 to NavBar.TargetPosition - 1 do
        if IsVisible(AGroup.Children[I]) then
          Inc(Result);
    end;
  end;
...
begin
  ...
  ItemGroup := ViewInfo.GetGroupViewInfoByGroup(NavBar.TargetGroup);
  if ItemGroup = nil then
    Exit;
  APosition := GetItemInfoTargetPosition;
...
procedure TdxNavBarElementPainter.DrawChildGroupSelection(AChildGroupViewInfo: TdxNavBarChildGroupViewInfo);
begin
  with AChildGroupViewInfo do
    SelectionPainterClass.DrawSelection(Canvas, SelectionRect, BgBackColor, State, ScaleFactor);
end;
...
begin
  with AGroupViewInfo do
    ImagePainterClass.DrawImage(Canvas, ImageList, ImageIndex, CaptionImageRect, True, GetGroupColorPalette(AGroupViewInfo));
end;
...
begin
  with AGroupViewInfo do
    GroupBackgroundPainterClass.DrawBackground(ACanvas, ARect, ControlImage,
      ...
      ControlGradientMode, ScaleFactor);
end;
...
begin
  with ALinkViewInfo do
    if Item.Enabled then
      SelectionPainterClass.DrawSelection(Canvas, SelectionRect, GroupViewInfo.BgBackColor, State, ScaleFactor);
end;
...
begin
  ...
  begin
    ScrollButtonsPainterClass.DrawBottomButton(Canvas, BottomScrollButtonRect,
      ...
      BorderColor, BottomScrollButtonState, ScaleFactor);
...
begin
  ...
  begin
    ScrollButtonsPainterClass.DrawTopButton(Canvas, TopScrollButtonRect,
      ...
      BorderColor, TopScrollButtonState, ScaleFactor);
...
function TdxNavBarElementPainter.GetGroupColorPalette(AGroupViewInfo: TdxNavBarGroupViewInfo): IdxColorPalette;
begin
  Result := nil;
end;
...
class function TdxNavBarElementPainter.OverflowPanelBackgroundPainterClass: TdxNavBarCustomButtonPainterClass;
begin
  Result := ButtonPainterClass;
end;
