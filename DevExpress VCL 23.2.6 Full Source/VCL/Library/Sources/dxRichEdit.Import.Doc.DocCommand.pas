...
{                                                                    }
{********************************************************************}
unit dxRichEdit.Import.Doc.DocCommand; // for internal use
...
type
  ...
  strict private const
    ScriptCodes: array[TdxCharacterFormattingScript] of Byte = (0, 2, 1);
  strict private
    FScriptType: Byte;
    function GetScript: TdxCharacterFormattingScript;
    procedure SetScript(const AValue: TdxCharacterFormattingScript); inline;
  protected
    function GetChangeAction: TdxChangeActionType; override;
  public
    procedure Read(const ASprm: TBytes); override;
  ...
  strict private const
    ChapterSeparators: array[0..4] of Char = (
  ...
  strict private
    function GetChapterSeparator: Char; inline;
  ...
  strict private const
    StartTypes: array[TdxSectionStartType] of Byte = (2, 4, 3, 0, 1);
  strict private
  ...
  strict private const
    VerticalAlignmentTypes: array[TdxVerticalAlignment] of Byte = (0, 2, 1, 3);
  strict private
    function GetVerticalTextAlignment: TdxVerticalAlignment; inline;
    procedure SetVerticalTextAlignment(const AValue: TdxVerticalAlignment); inline;
  protected
    function GetChangeAction: TdxChangeActionType; override;
  public
    procedure Execute(APropertyContainer: TdxDocPropertyContainer; ADataStreamReader: TBinaryReader); override;
...
const
  dxThisUnitName = 'dxRichEdit.Import.Doc.DocCommand';
...
begin
  FScriptType := ScriptCodes[AValue];
end;
...
class constructor TdxDocCommandUnderline.Initialize;
  ...
  procedure AddDocUnderlineInfo(ATypeCode: Byte; AUnderlineType: TdxUnderlineType);
  begin
    FUnderlineTypes.Add(ATypeCode, AUnderlineType);
    FUnderlineTypeCodes.Add(AUnderlineType, ATypeCode);
  end;

begin
  {$IFDEF DX_INITIALIZATION_LOGGING}TdxUnitSectionsLogger.ConstructorStarted(UnitName, 'TdxDocCommandUnderline.Initialize', SysInit.HInstance);{$ENDIF}
  ...
  AddDocUnderlineInfo(0, TdxUnderlineType.None);
  AddDocUnderlineInfo(1, TdxUnderlineType.Single);
  AddDocUnderlineInfo(3, TdxUnderlineType.Double);
  AddDocUnderlineInfo(4, TdxUnderlineType.Dotted);
  AddDocUnderlineInfo(6, TdxUnderlineType.ThickSingle);
  AddDocUnderlineInfo(7, TdxUnderlineType.Dashed);
  AddDocUnderlineInfo(9, TdxUnderlineType.DashDotted);
  AddDocUnderlineInfo(10, TdxUnderlineType.DashDotDotted);
  AddDocUnderlineInfo(11, TdxUnderlineType.Wave);
  AddDocUnderlineInfo(20, TdxUnderlineType.ThickDotted);
  AddDocUnderlineInfo(23, TdxUnderlineType.ThickDashed);
  AddDocUnderlineInfo(25, TdxUnderlineType.ThickDashDotted);
  AddDocUnderlineInfo(26, TdxUnderlineType.ThickDashDotDotted);
  AddDocUnderlineInfo(27, TdxUnderlineType.HeavyWave);
  AddDocUnderlineInfo(39, TdxUnderlineType.LongDashed);
  AddDocUnderlineInfo(43, TdxUnderlineType.DoubleWave);
  AddDocUnderlineInfo(55, TdxUnderlineType.ThickLongDashed);
  {$IFDEF DX_INITIALIZATION_LOGGING}TdxUnitSectionsLogger.ConstructorFinished(UnitName, 'TdxDocCommandUnderline.Initialize', SysInit.HInstance);{$ENDIF}
end;

class destructor TdxDocCommandUnderline.Finalize;
begin
  {$IFDEF DX_INITIALIZATION_LOGGING}TdxUnitSectionsLogger.DestructorStarted(UnitName, 'TdxDocCommandUnderline.Finalize', SysInit.HInstance);{$ENDIF}
  FUnderlineTypes.Free;
  FUnderlineTypeCodes.Free;
  {$IFDEF DX_INITIALIZATION_LOGGING}TdxUnitSectionsLogger.DestructorFinished(UnitName, 'TdxDocCommandUnderline.Finalize', SysInit.HInstance);{$ENDIF}
end;
...
begin
  ...
  APropertyContainer.TableRowInfo.WidthBeforeAssign := True;
end;
...
begin
  ...
  APropertyContainer.TableRowInfo.RowLeftAssigned := True;
end;
...
begin
  ...
  APropertyContainer.TableRowInfo.RowLeftOffsetAssigned := True;
end;
...
begin
  Result := ChapterSeparators[Value];
end;
...
begin
  if Value <= High(ChapterSeparators) then
    APropertyContainer.SectionInfo.SectionPageNumbering.ChapterSeparator := ChapterSeparators[Value];
end;
...
begin
  Value := VerticalAlignmentTypes[AValue];
end;
...
begin
  {$IFDEF DX_INITIALIZATION_LOGGING}TdxUnitSectionsLogger.ConstructorStarted(UnitName, 'TdxDocCommandFactory.Initialize', SysInit.HInstance);{$ENDIF}
  ...
  {$IFDEF DX_INITIALIZATION_LOGGING}TdxUnitSectionsLogger.ConstructorFinished(UnitName, 'TdxDocCommandFactory.Initialize', SysInit.HInstance);{$ENDIF}
end;

class destructor TdxDocCommandFactory.Finalize;
begin
  {$IFDEF DX_INITIALIZATION_LOGGING}TdxUnitSectionsLogger.DestructorStarted(UnitName, 'TdxDocCommandFactory.Finalize', SysInit.HInstance);{$ENDIF}
  FCommandTypes.Free;
  FCommandOpcodes.Free;
  {$IFDEF DX_INITIALIZATION_LOGGING}TdxUnitSectionsLogger.DestructorFinished(UnitName, 'TdxDocCommandFactory.Finalize', SysInit.HInstance);{$ENDIF}
end;
