...
{                                                                    }
{********************************************************************}
unit dxRichEdit.Import.Doc.DCO; // for internal use
...
type
  ...
  strict private
    FWidthBeforeAssign: Boolean;
    FRowLeft: Integer;
    FRowLeftAssigned: Boolean;
    FRowLeftOffset: Integer;
    FRowLeftOffsetAssigned: Boolean;
  ...
  public
    ...
    property WidthBeforeAssign: Boolean read FWidthBeforeAssign write FWidthBeforeAssign;
    property RowLeft: Integer read FRowLeft write FRowLeft;
    property RowLeftAssigned: Boolean read FRowLeftAssigned write FRowLeftAssigned;
    property RowLeftOffset: Integer read FRowLeftOffset write FRowLeftOffset;
    property RowLeftOffsetAssigned: Boolean read FRowLeftOffsetAssigned write FRowLeftOffsetAssigned;
...
{$REGION 'strict private type'}
    ...
    const
      KnownStyles: array[0..39] of string = (
        TKnownStyleNames.NormalTable,
        TKnownStyleNames.TableSimple1,
        TKnownStyleNames.TableSimple2,
        TKnownStyleNames.TableSimple3,
        TKnownStyleNames.TableClassic1,
        TKnownStyleNames.TableClassic2,
        TKnownStyleNames.TableClassic3,
        TKnownStyleNames.TableClassic4,
        TKnownStyleNames.TableColorful1,
        TKnownStyleNames.TableColorful2,
        TKnownStyleNames.TableColorful3,
        TKnownStyleNames.TableColumns1,
        TKnownStyleNames.TableColumns2,
        TKnownStyleNames.TableColumns3,
        TKnownStyleNames.TableColumns4,
        TKnownStyleNames.TableColumns5,
        TKnownStyleNames.TableGrid1,
        TKnownStyleNames.TableGrid2,
        TKnownStyleNames.TableGrid3,
        TKnownStyleNames.TableGrid4,
        TKnownStyleNames.TableGrid5,
        TKnownStyleNames.TableGrid6,
        TKnownStyleNames.TableGrid7,
        TKnownStyleNames.TableGrid8,
        TKnownStyleNames.TableList1,
        TKnownStyleNames.TableList2,
        TKnownStyleNames.TableList3,
        TKnownStyleNames.TableList4,
        TKnownStyleNames.TableList5,
        TKnownStyleNames.TableList6,
        TKnownStyleNames.TableList7,
        TKnownStyleNames.TableList8,
        TKnownStyleNames.Table3DEffects1,
        TKnownStyleNames.Table3DEffects2,
        TKnownStyleNames.Table3DEffects3,
        TKnownStyleNames.TableContemporary,
        TKnownStyleNames.TableElegant,
        TKnownStyleNames.TableProfessional,
        TKnownStyleNames.TableSubtle1,
        TKnownStyleNames.TableSubtle2);
...
const
  dxThisUnitName = 'dxRichEdit.Import.Doc.DCO';
...
begin
  ...
  if ATabAlignmentCode <= High(TabAlignments) then
    FTabAlignment := TabAlignments[ATabAlignmentCode];
  if ATabLeaderCode <= High(TabLeaders) then
    FTabLeader := TabLeaders[ATabLeaderCode];
end;
...
begin
  if (FItl <= High(KnownStyles)) and (FItl >= 0) then
    Result := TdxTableStyle(ADocumentModel.TableStyles.GetStyleByName(KnownStyles[FItl]))
  else
    Result := nil;
end;
