...
type
  ...
  TdxAsyncTask = class // for internal use
  private
    FThread: TThread;
  ...
  TdxAsyncTaskRunnerThread = class(TcxThread) // for internal use
  private
    FTask: TdxAsyncTask;
  protected
  ...
  TdxAsyncTaskRunner = class // for internal use
  private
  ...
  public
    procedure Parse(AStream: TStream; AFormat: TdxRestServiceOutputFormat); virtual; // for internal use
    property IsSuccess: Boolean read FIsSuccess;
  end;

  TdxRESTServiceResponseEvent = procedure(Sender: TObject;
    AResponse: TdxRestServiceResponse; var ADestroyResponse: Boolean) of object; // for internal use

  TdxRESTServiceTask = class(TdxAsyncTask) // for internal use
  private
  ...
  TdxRESTService = class // for internal use
  private
