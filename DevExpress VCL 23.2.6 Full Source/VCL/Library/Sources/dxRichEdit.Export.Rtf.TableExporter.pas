...
unit dxRichEdit.Export.Rtf.TableExporter; // for internal use
...
type
  ...
  private
    ...
    function GetActualLeftBorderInfo(ACell: TdxTableCell): TdxBorderInfo;
    function GetActualRightBorderInfo(ACell: TdxTableCell): TdxBorderInfo;
    function GetActualTopBorderInfo(ACell: TdxTableCell): TdxBorderInfo;
    function GetActualBottomBorderInfo(ACell: TdxTableCell): TdxBorderInfo;
    function GetActualBorderInfoCore(ACellBorderInfo: TdxBorderInfo; AUse: Boolean): TdxBorderInfo;
  ...
  protected
    ...
    procedure ExportNestedTable(ATable: TdxTable; var ALastParIndex: TdxParagraphIndex); overload; 
    function CreateTableHelper(ATable: TdxTable): TdxRtfTableExportHelper; 
    ...
    function CalculateRowLeftOffset(ARow: TdxTableRow): Integer;
...
const
  dxThisUnitName = 'dxRichEdit.Export.Rtf.TableExporter';
...
begin
  ...
  if ExportAsNestedTable then
    ...
    Result := TdxRtfTableExporterState.Create(RtfExporter, ARootTable);
end;
...
function TdxRtfTableExporterStateBase.GetActualLeftBorderInfo(ACell: TdxTableCell): TdxBorderInfo;
begin
  Result := GetActualBorderInfoCore(ACell.GetActualLeftCellBorder.Info, ACell.Properties.Borders.UseLeftBorder);
end;

function TdxRtfTableExporterStateBase.GetActualRightBorderInfo(ACell: TdxTableCell): TdxBorderInfo;
begin
  Result := GetActualBorderInfoCore(ACell.GetActualRightCellBorder.Info, ACell.Properties.Borders.UseRightBorder);
end;

function TdxRtfTableExporterStateBase.GetActualTopBorderInfo(ACell: TdxTableCell): TdxBorderInfo;
begin
  Result := GetActualBorderInfoCore(ACell.GetActualTopCellBorder.Info, ACell.Properties.Borders.UseTopBorder);
end;

function TdxRtfTableExporterStateBase.GetActualBottomBorderInfo(ACell: TdxTableCell): TdxBorderInfo;
begin
  Result := GetActualBorderInfoCore(ACell.GetActualBottomCellBorder.Info, ACell.Properties.Borders.UseBottomBorder);
end;

function TdxRtfTableExporterStateBase.GetActualBorderInfoCore(ACellBorderInfo: TdxBorderInfo; AUse: Boolean): TdxBorderInfo;
begin
  if (ACellBorderInfo.Style = TdxBorderLineStyle.&Nil) and AUse then
    Result := TdxBorderInfo.Empty
  else
    Result := ACellBorderInfo;
end;
...
begin
  ...
  begin
    ...
    begin
      if (NestingLevel = 1) and (AParIndex = AStartParagraphIndex) and ACell.IsFirstCellInRow then
        ExportRowProperties(ACell.Row, AParentRowIndex);
...
begin
  ...
  FTableCellPropertiesExporter.WriteCellBasicBorders(GetActualTopBorderInfo(ACell),
    GetActualLeftBorderInfo(ACell), GetActualRightBorderInfo(ACell), GetActualBottomBorderInfo(ACell));
