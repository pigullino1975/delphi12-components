...
const
  dxThisUnitName = 'dxGaugeCustomScale';
...
var
  A160B4C69766C66330005011B182516116D62590366706473: TStream;
begin
  A160B4C69766C66330005011B182516116D62590366706473 := TFileStream.Create(AFileName, fmOpenRead or fmShareDenyNone);
  try
    Result := CreateFromStream(A160B4C69766C66330005011B182516116D62590366706473);
  finally
    A160B4C69766C66330005011B182516116D62590366706473.Free;
  end;
end;
...
begin
  ...
  ScaleInfo.Selection := ScaleInfo.Bounds.InflateToTRect;
end;
...
begin
  ...
  ScaleInfo.Selection := GetScaledRect(ASize, dxPointF(ScaleInfo.Bounds.Width / ASize.cx,
        ScaleInfo.Bounds.Height / ASize.cy)).InflateToTRect;
  ScaleInfo.ScaleFactor := FScaleFactor;
end;

procedure TdxGaugeCustomScaleViewInfo.CalculateScaleFactor;
var
  A160B4C69766C66330005011B182516116D62590366706473: TdxSizeF;
begin
  A160B4C69766C66330005011B182516116D62590366706473 := GetContentOriginalSize;
  FScaleFactor.X := ScaleInfo.Bounds.Width / A160B4C69766C66330005011B182516116D62590366706473.cx;
  FScaleFactor.Y := ScaleInfo.Bounds.Height / A160B4C69766C66330005011B182516116D62590366706473.cy;
...
begin
  Result := FSelectionBounds.DeflateToTRect;
end;
...
procedure TdxGaugeScaleStyleFactory.UnregisterStyles(AScaleType: TdxGaugeScaleType);
  ...
  procedure UnregistryStyles(A160B4C69766C66330005011B182516116D62590366706473: TStringList);
  begin
    if A160B4C69766C66330005011B182516116D62590366706473 <> nil then
      while A160B4C69766C66330005011B182516116D62590366706473.Count > 0 do
        DeleteStyle(A160B4C69766C66330005011B182516116D62590366706473, 0);
  end;
