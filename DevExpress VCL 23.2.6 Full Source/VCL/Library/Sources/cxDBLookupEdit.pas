...
type
  ...
  protected
    ...
    function DoFindRecordIndex: Integer; override;
  ...
  protected
    ...
    function GetCaseSensitiveSearchValue: Boolean; override;
  ...
  public
    ...
    property Properties: TcxCustomDBLookupEditProperties read GetProperties write SetProperties;
  end;
...
function TcxCustomDBLookupEditLookupData.DoFindRecordIndex: Integer;
begin
  Result := DataController.FindRecordIndexByKey(Edit.EditValue);
  if Result = -1 then
    Result := inherited DoFindRecordIndex;
end;
...
begin
  ...
  begin
    ...
    try
      ...
      SetLookupField(TcxCustomDBLookupEditProperties(Source).FLookupField);
...
function TcxCustomDBLookupEditProperties.GetCaseSensitiveSearchValue: Boolean;
begin
  Result := CaseSensitiveSearch;
end;
...
begin
  ...
  begin
    ADefaultValuesProvider := DefaultValuesProvider;
