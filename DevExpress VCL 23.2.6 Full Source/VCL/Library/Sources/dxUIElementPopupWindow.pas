...
uses
  Controls, Types, MultiMon, cxControls, cxContainer, dxIncrementalFiltering, cxLookAndFeels;
...
type
  ...
  public
    ...
    property ViewInfo: TdxUIElementPopupWindowViewInfo read GetViewInfo; // for internal use
  end;
...
const
  dxThisUnitName = 'dxUIElementPopupWindow';
