...
const
  dxThisUnitName = 'dxRichEdit.Utils.CheckSumStream';
...
var
  ...
  K: Integer;
begin
  {$IFDEF DX_INITIALIZATION_LOGGING}TdxUnitSectionsLogger.ConstructorStarted(UnitName, 'TdxCrc32CheckSum.Initialize', SysInit.HInstance);{$ENDIF}
  ...
  {$IFDEF DX_INITIALIZATION_LOGGING}TdxUnitSectionsLogger.ConstructorFinished(UnitName, 'TdxCrc32CheckSum.Initialize', SysInit.HInstance);{$ENDIF}
end;

class destructor TdxCrc32CheckSum.Finalize;
begin
  {$IFDEF DX_INITIALIZATION_LOGGING}TdxUnitSectionsLogger.DestructorStarted(UnitName, 'TdxCrc32CheckSum.Finalize', SysInit.HInstance);{$ENDIF}
  SetLength(FTable, 0);
  {$IFDEF DX_INITIALIZATION_LOGGING}TdxUnitSectionsLogger.DestructorFinished(UnitName, 'TdxCrc32CheckSum.Finalize', SysInit.HInstance);{$ENDIF}
end;
