...
type
  ...
  TdxNativeTable = class(TInterfacedObject,
    IdxRichEditTable, IdxBatchUpdatable)
  strict private
    type
  ...
  strict private
    ...
    function GetFirst: IdxRichEditTable; inline;
    function GetItem(Index: Integer): IdxRichEditTable; inline;
    function GetLast: IdxRichEditTable; inline;
  protected
  ...
  TdxNativeTableRowCollection = class(TInterfacedObject, IdxRichEditTableRowCollection)
  strict private
  ...
  TdxNativeTableCellCollection = class(TInterfacedObject, IdxRichEditTableCellCollection)
  strict private
...
const
  dxThisUnitName = 'dxRichEdit.Api.Tables';
...
type
  ...
  TdxNativeTableCellBorder = class(TdxNativeTableBorderBase, IdxRichEditTableCellBorder)
  strict private
    FCell: TdxNativeTableCell;
  protected
    property Cell: TdxNativeTableCell read FCell;
  ...
  TdxNativeTableBottomCellBorder = class(TdxNativeTableCellBorder)
  protected
  ...
  TdxNativeTableLeftCellBorder = class(TdxNativeTableCellBorder)
  protected
    function GetActualBorder: TdxBorderBase; override;
    function GetBorder: TdxBorderBase; override;
  end;
  ...
  TdxNativeTableRightCellBorder = class(TdxNativeTableCellBorder)
  protected
    function GetActualBorder: TdxBorderBase; override;
    function GetBorder: TdxBorderBase; override;
  end;
  ...
  TdxNativeTableTopCellBorder = class(TdxNativeTableCellBorder)
  protected
    function GetActualBorder: TdxBorderBase; override;
    function GetBorder: TdxBorderBase; override;
  end;
  ...
  TdxNativeTableBottomBorder = class(TdxNativeTableBorder)
  protected
    function GetActualBorder: TdxBorderBase; override;
    function GetBorder: TdxBorderBase; override;
  end;
  ...
  TdxNativeTableLeftBorder = class(TdxNativeTableBorder)
  protected
    function GetActualBorder: TdxBorderBase; override;
    function GetBorder: TdxBorderBase; override;
  end;
  ...
  TdxNativeTableRightBorder = class(TdxNativeTableBorder)
  protected
    function GetActualBorder: TdxBorderBase; override;
    function GetBorder: TdxBorderBase; override;
  end;
  ...
  TdxNativeTableTopBorder = class(TdxNativeTableBorder)
  protected
    function GetActualBorder: TdxBorderBase; override;
    function GetBorder: TdxBorderBase; override;
  end;
  ...
  TdxNativeTableInsideHorizontalBorder = class(TdxNativeTableBorder)
  protected
    function GetActualBorder: TdxBorderBase; override;
    function GetBorder: TdxBorderBase; override;
  end;
  ...
  TdxNativeTableInsideVerticalBorder = class(TdxNativeTableBorder)
  protected
    function GetActualBorder: TdxBorderBase; override;
    function GetBorder: TdxBorderBase; override;
  end;
  ...
  TdxNativeTableComparer = class(TcxIUnknownObject, IComparer<IdxRichEditTable>)
  private class var
    FInstance: TdxNativeTableComparer;
    class function GetInstance: TdxNativeTableComparer; static; inline;
  protected
    class destructor Finalize;
  public
    function Compare(const Left, Right: IdxRichEditTable): Integer;
    class property Instance: TdxNativeTableComparer read GetInstance;
  end;
...
class destructor TdxNativeTableComparer.Finalize;
begin
  {$IFDEF DX_INITIALIZATION_LOGGING}TdxUnitSectionsLogger.DestructorStarted(UnitName, 'TdxNativeTableComparer.Finalize', SysInit.HInstance);{$ENDIF}
  FreeAndNil(FInstance);
  {$IFDEF DX_INITIALIZATION_LOGGING}TdxUnitSectionsLogger.DestructorFinished(UnitName, 'TdxNativeTableComparer.Finalize', SysInit.HInstance);{$ENDIF}
end;

class function TdxNativeTableComparer.GetInstance: TdxNativeTableComparer;
begin
  if FInstance = nil then
    FInstance := TdxNativeTableComparer.Create;
  Result := FInstance;
end;
...
begin
  Result := TdxNativeProperties.VerticalAlignmentMap[ModelCell.VerticalAlignment];
end;
...
begin
  ModelCell.Properties.VerticalAlignment := TdxNativeProperties.ModelVerticalAlignmentMap[Value];
end;
...
begin
  ModelTable.TableProperties.ResetUse(TdxNativeProperties.ApiMaskToModelMask(AMask));
end;
...
begin
  CheckValid;
  Result := TdxNativeStyleCollections.GetStyle(Document.MainDocument.TableStyles, ModelTable.TableStyle);
end;
...
begin
  CheckValid;
  if Value <> nil then
    AStyle := TdxNativeStyleCollections.GetInnerStyle(Value)
  else
    AStyle := nil;
...
begin
  ...
  try
    ...
    if TdxRichEditControlCompatibility.MergeSuccessiveTables then
      ANewTable := PieceTable.JoinTableWithPrevious(ANewTable);
  finally
    DocumentModel.EndUpdate;
  end;
...
function TdxNativeTableCollection.Get(const ARange: IdxRichEditDocumentRange): IdxRichEditReadOnlyTableCollection;
var
...
begin
  ...
  begin
    ...
    if (ATableStartParagraphIndex >= AFirstIndex) and (ATableEndParagraphIndex <= ALastIndex) then
      AResult.FInnerList.Add(TdxNativeTable.Create(FDocument, ATable));
  end;
  Result := AResult;
end;
...
begin
  ...
  FInnerList.Sort(TdxNativeTableComparer.Instance);
end;
