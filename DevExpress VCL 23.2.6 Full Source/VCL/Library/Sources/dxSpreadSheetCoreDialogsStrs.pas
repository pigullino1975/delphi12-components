...
resourcestring
  ...
  sdxConditionalFormattingRulesManagerDialogActionMoveDown = 'Move Down';
  sdxConditionalFormattingRulesManagerDialogActionMoveUp = 'Move Up';
  ...
  // Expression Editor
  sdxExpressionEditorButtonOK = '&OK';
  sdxExpressionEditorButtonCancel = 'Cancel';
  sdxExpressionEditorCaption = 'Expression Editor';
  sdxExpressionEditorFieldsCategoryCaption = 'Fields';
  sdxExpressionEditorConstantsCategoryCaption = 'Constants';
  sdxExpressionEditorOperatorsCategoryCaption = 'Operators';
  sdxExpressionEditorFunctionGroupsCategoryCaption = 'Functions';
  sdxExpressionEditorFieldDescription = '%s %s';
  sdxExpressionEditorFilterTextHint = 'Enter text to search...';
  sdxExpressionEditorNoSuggestions = 'No suggestions';

  // Expression Editor Formula Operation Description
  sdxExpressionEditorOperatorAddDescription = 'Adds the first value to the second.';
  sdxExpressionEditorOperatorSubDescription = 'Subtracts the second value from the first.';
  sdxExpressionEditorOperatorMulDescription = 'Multiplies the first value by the second.';
  sdxExpressionEditorOperatorDivDescription = 'Divides the first value by the second.';
  sdxExpressionEditorOperatorPowerDescription = 'Raises the first value by the power of the second.';
  sdxExpressionEditorOperatorConcatDescription = 'Concatenates two strings into one.';
  sdxExpressionEditorOperatorLTDescription = 'Returns TRUE if the first value is less than the second; otherwise FALSE.';
  sdxExpressionEditorOperatorLEDescription = 'Returns TRUE if the first value is less than the second or if they are equal; otherwise FALSE.';
  sdxExpressionEditorOperatorEQDescription = 'Returns TRUE if two values are equal; otherwise FALSE.';
  sdxExpressionEditorOperatorGEDescription = 'Returns TRUE if the first value is greater than the second or if they are equal; otherwise FALSE.';
  sdxExpressionEditorOperatorGTDescription = 'Returns TRUE if the first value is greater than the second; otherwise FALSE.';
  sdxExpressionEditorOperatorNEDescription = 'Returns TRUE if two values are not equal; otherwise FALSE.';
  sdxExpressionEditorOperatorPercentDescription = 'Specifies that the entered numeric value is a percentage.';

  // Expression Editor Formula Error
  sdxExpressionEditorUnknownField = 'Unknown field';
  sdxExpressionEditorUnknownFunction = 'Unknown function';
  sdxExpressionEditorInvalidExpressionExceptionText = 'Invalid expression.';
  sdxExpressionEditorMissingClosingFieldMark = 'Field names should be enclosed in []';
  sdxExpressionEditorMissingClosingStringMark = 'Strings should be enclosed in single or double quotes';
  sdxExpressionEditorSyntaxError = 'Syntax error';
  sdxExpressionEditorUnknownFieldOrFunctionConfirmation = 'The expression contains a reference to an unknown field or function. Save changes?';
  sdxExpressionEditorCloseDialogConfirmation = 'The expression was modified. Save changes?';
...
const
  dxThisUnitName = 'dxSpreadSheetCoreDialogsStrs';
...
begin
  ...
  AProduct.Add('sdxConditionalFormattingRulesManagerDialogActionMoveDown',
    @sdxConditionalFormattingRulesManagerDialogActionMoveDown);
  AProduct.Add('sdxConditionalFormattingRulesManagerDialogActionMoveUp',
  ...
  AProduct.Add('sdxExpressionEditorButtonOK', @sdxExpressionEditorButtonOK);
  AProduct.Add('sdxExpressionEditorButtonCancel', @sdxExpressionEditorButtonCancel);
  AProduct.Add('sdxExpressionEditorCaption', @sdxExpressionEditorCaption);
  AProduct.Add('sdxExpressionEditorFieldsCategoryCaption', @sdxExpressionEditorFieldsCategoryCaption);
  AProduct.Add('sdxExpressionEditorConstantsCategoryCaption', @sdxExpressionEditorConstantsCategoryCaption);
  AProduct.Add('sdxExpressionEditorOperatorsCategoryCaption', @sdxExpressionEditorOperatorsCategoryCaption);
  AProduct.Add('sdxExpressionEditorFunctionGroupsCategoryCaption', @sdxExpressionEditorFunctionGroupsCategoryCaption);
  AProduct.Add('sdxExpressionEditorFieldDescription', @sdxExpressionEditorFieldDescription);
  AProduct.Add('sdxExpressionEditorFilterTextHint', @sdxExpressionEditorFilterTextHint);
  AProduct.Add('sdxExpressionEditorNoSuggestions', @sdxExpressionEditorNoSuggestions);

  AProduct.Add('sdxExpressionEditorOperatorAddDescription', @sdxExpressionEditorOperatorAddDescription);
  AProduct.Add('sdxExpressionEditorOperatorSubDescription', @sdxExpressionEditorOperatorSubDescription);
  AProduct.Add('sdxExpressionEditorOperatorMulDescription', @sdxExpressionEditorOperatorMulDescription);
  AProduct.Add('sdxExpressionEditorOperatorDivDescription', @sdxExpressionEditorOperatorDivDescription);
  AProduct.Add('sdxExpressionEditorOperatorPowerDescription', @sdxExpressionEditorOperatorPowerDescription);
  AProduct.Add('sdxExpressionEditorOperatorConcatDescription', @sdxExpressionEditorOperatorConcatDescription);
  AProduct.Add('sdxExpressionEditorOperatorLTDescription', @sdxExpressionEditorOperatorLTDescription);
  AProduct.Add('sdxExpressionEditorOperatorLEDescription', @sdxExpressionEditorOperatorLEDescription);
  AProduct.Add('sdxExpressionEditorOperatorEQDescription', @sdxExpressionEditorOperatorEQDescription);
  AProduct.Add('sdxExpressionEditorOperatorGEDescription', @sdxExpressionEditorOperatorGEDescription);
  AProduct.Add('sdxExpressionEditorOperatorGTDescription', @sdxExpressionEditorOperatorGTDescription);
  AProduct.Add('sdxExpressionEditorOperatorNEDescription', @sdxExpressionEditorOperatorNEDescription);
  AProduct.Add('sdxExpressionEditorOperatorPercentDescription', @sdxExpressionEditorOperatorPercentDescription);

  AProduct.Add('sdxExpressionEditorMissingClosingFieldMark', @sdxExpressionEditorMissingClosingFieldMark);
  AProduct.Add('sdxExpressionEditorMissingClosingStringMark', @sdxExpressionEditorMissingClosingStringMark);
  AProduct.Add('sdxExpressionEditorSyntaxError', @sdxExpressionEditorSyntaxError);
  AProduct.Add('sdxExpressionEditorUnknownField', @sdxExpressionEditorUnknownField);
  AProduct.Add('sdxExpressionEditorUnknownFunction', @sdxExpressionEditorUnknownFunction);
  AProduct.Add('sdxExpressionEditorInvalidExpressionExceptionText', @sdxExpressionEditorInvalidExpressionExceptionText);
  AProduct.Add('sdxExpressionEditorUnknownFieldOrFunctionConfirmation', @sdxExpressionEditorUnknownFieldOrFunctionConfirmation);
  AProduct.Add('sdxExpressionEditorCloseDialogConfirmation', @sdxExpressionEditorCloseDialogConfirmation);
end;
