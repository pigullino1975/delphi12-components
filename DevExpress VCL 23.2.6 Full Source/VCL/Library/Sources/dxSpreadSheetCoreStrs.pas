...
resourcestring
  ...
  sdxErrorCannotSaveDocumentWithoutSheets = 'Cannot save the document because none of its sheets are visible. Make at least one sheet visible and try again.';
  ...
  sdxErrorInvalidDefinedNameSyntax =
    'The syntax of this name is incorrect.'
      + dxCRLF + dxCRLF +
    'Verify that the name:' + dxCRLF +
    ' - Starts with a letter or underscore' + dxCRLF +
    ' - Does not include a space or unallowed character' + dxCRLF +
  ...
  sdxConditionalFormattingAboveAverageOnStandardDeviation = '%d std dev above average for the selected range';
  ...
  sdxConditionalFormattingBelowAverageOnStandardDeviation = '%d std dev below average for the selected range';
...
const
  ...
  dxAbsoluteReferenceChar: Char = '$';
  dxReferenceLeftParenthesis: Char = '[';
  dxReferenceRightParenthesis: Char = ']';
  dxRCRowReferenceChar: Char = 'R';
  dxRCColumnReferenceChar: Char = 'C';

  dxAreaSeparator: Char = ':';
  dxRefSeparator: Char = '!';

  dxStringMarkChar: Char = '"';
  dxStringMarkChar2: Char = '''';

  dxErrorPrefix: Char = '#';
  dxExponentChar: Char = 'E';

  dxLeftParenthesis: Char = '(';
  dxRightParenthesis: Char = ')';

  dxLeftArrayParenthesis: Char = '{';
  dxRightArrayParenthesis: Char = '}';
...
const
  dxThisUnitName = 'dxSpreadSheetCoreStrs';
...
begin
  ...
  AProduct.Add('sdxErrorCannotSaveDocumentWithoutSheets', @sdxErrorCannotSaveDocumentWithoutSheets);
  ...
  AProduct.Add('sdxErrorInvalidDefinedNameSyntax', @sdxErrorInvalidDefinedNameSyntax);
