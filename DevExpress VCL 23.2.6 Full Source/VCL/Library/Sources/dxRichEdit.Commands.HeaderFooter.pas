...
type
  ...
  protected
    ...
    function CreatePrevHeaderFooterCalculator: TdxPrevNextHeaderFooterInfoCalculator<T>; virtual; abstract;
    function CreateNextHeaderFooterCalculator: TdxPrevNextHeaderFooterInfoCalculator<T>; virtual; abstract;
  ...
  protected
    function CreatePrevHeaderFooterCalculator: TdxPrevNextHeaderFooterInfoCalculator<TdxSectionHeader>; override;
    function CreateNextHeaderFooterCalculator: TdxPrevNextHeaderFooterInfoCalculator<TdxSectionHeader>; override;
  ...
  protected
    function CreatePrevHeaderFooterCalculator: TdxPrevNextHeaderFooterInfoCalculator<TdxSectionFooter>; override;
    function CreateNextHeaderFooterCalculator: TdxPrevNextHeaderFooterInfoCalculator<TdxSectionFooter>; override;
    function GetPageHeaderFooter(APage: TdxPage): TdxPieceTable; override;
  end;
...
const
  dxThisUnitName = 'dxRichEdit.Commands.HeaderFooter';
...
var
  ...
  ACalculator: TdxPrevNextHeaderFooterInfoCalculator<T>;
begin
...
function TdxMakeNearestHeaderActiveCommand.CreatePrevHeaderFooterCalculator: TdxPrevNextHeaderFooterInfoCalculator<TdxSectionHeader>;
begin
  Result := TdxPrevHeaderInfoCalculator.Create(RichEditControl);
end;

function TdxMakeNearestHeaderActiveCommand.CreateNextHeaderFooterCalculator: TdxPrevNextHeaderFooterInfoCalculator<TdxSectionHeader>;
begin
...
function TdxMakeNearestFooterActiveCommand.CreatePrevHeaderFooterCalculator: TdxPrevNextHeaderFooterInfoCalculator<TdxSectionFooter>;
begin
  Result := TdxPrevFooterInfoCalculator.Create(RichEditControl);
end;

function TdxMakeNearestFooterActiveCommand.CreateNextHeaderFooterCalculator: TdxPrevNextHeaderFooterInfoCalculator<TdxSectionFooter>;
begin
...
begin
  if Safe.Cast(ActivePieceTable.ContentType, TdxSectionFooter, AFooter) then
...
begin
  if Safe.Cast(ActivePieceTable.ContentType, TdxSectionFooter, AFooter) then
    Result := DocumentModel.GetActiveSectionBySelectionEnd.GetCorrespondingHeader(AFooter)
  else
    Result := nil;
end;
...
begin
  if Safe.Cast(ActivePieceTable.ContentType, TdxSectionHeader, AHeader) then
...
begin
  if Safe.Cast(ActivePieceTable.ContentType, TdxSectionHeader, AHeader) then
    Result := DocumentModel.GetActiveSectionBySelectionEnd.GetCorrespondingFooter(AHeader)
  else
    Result := nil;
end;
...
var
  ...
  ACommand: TdxChangeActivePieceTableCommand;
begin
  if not Safe.Cast(ActivePieceTable.ContentType, TdxSectionHeaderFooterBase, AHeaderFooter) then
    Exit;
