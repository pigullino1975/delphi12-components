...
const
  dxThisUnitName = 'dxNavBarOfficeNavigationBar';
...
procedure TdxNavBarOfficeNavigationBarItemViewInfo.DoPaintDragImage(ACanvas: TcxCanvas);
  ...
  begin
    ...
    try
      ...
      TdxImageDrawer.DrawBitmap(ACanvas.Handle, ABitmap, Bounds, cxNullPoint);
    finally
      ABitmap.Free;
    end;
  end;
...
procedure TdxNavBarOfficeNavigationBarItemViewInfo.DrawItemContent(ACanvas: TcxCanvas);
  ...
  begin
    TdxImageDrawer.DrawImage(ACanvas, R, nil, NavigationBar.Images, ImageIndex, True, nil, ScaleFactor);
  end;
  ...
  begin
    ...
    try
      ...
      TdxImageDrawer.DrawBitmap(ACanvas.Handle, ABitmap, FContentBounds, cxNullPoint);
    finally
      ABitmap.Free;
    end;
  end;
