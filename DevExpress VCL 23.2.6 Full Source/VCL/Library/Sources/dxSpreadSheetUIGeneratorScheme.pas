...
const
  ...
  sdxSpreadSheetBarDefinedNames = 'Defined Names';
...
const
  dxThisUnitName = 'dxSpreadSheetUIGeneratorScheme';
...
begin
  ...
  ACommand := ACategory.Add('RichEdit\BordersAll.png', sdxSpreadSheetSubItemHomeFontBorders, [ugivlSmallIcon], ugigpStart, ugipContinuesRow);
  ...
  ACommand.Add(TdxSpreadSheetBordersBottomDouble, dxUIGeneratorItemDefaultViewLevels, ugigpNone, ugipBeginsNewRow, True);
...
begin
  ...
  ACommand := ACategory.Add('Alignment\MergeCenter.png', sdxSpreadSheetSubItemHomeAlignmentMergeCells, [ugivlSmallIcon, ugivlText]);
...
procedure RegisterCategoryDefinedNames(ACategory: TdxUIGeneratorCategoryInfo);
begin
  ACategory.Add(TdxSpreadSheetShowDefinedNameManager);
  ACategory.Add(TdxSpreadSheetCreateDefinedName, [ugivlSmallIcon, ugivlText]);
  ACategory.Add(TdxSpreadSheetUseDefinedNameInFormula, True, False, True, False, 1, 0, False, vaTop, [ugivlSmallIcon, ugivlText]);
  ACategory.Add(TdxSpreadSheetCreateDefinedNamesFromSelection, [ugivlSmallIcon, ugivlText]);
end;
...
begin
  ...
  RegisterCategoryFont(AComponent.Add(sdxSpreadSheetTabHome, sdxSpreadSheetBarHomeFont, 'RichEdit\FontColor_16x16.png', 1));
  ...
  RegisterCategoryLinks(AComponent.Add(sdxSpreadSheetTabInsert, sdxSpreadSheetBarInsertLinks, 'RichEdit\Hyperlink_16x16.png', 0));
  ...
  RegisterCategoryFunctionLibrary(AComponent.Add(sdxSpreadSheetTabFormulas, sdxSpreadSheetBarFormulasFunctionLibrary, 'RichEdit\InsertEquationCaption_16x16.png', 0));
  RegisterCategoryDefinedNames(AComponent.Add(sdxSpreadSheetTabFormulas, sdxSpreadSheetBarDefinedNames, 'SpreadSheet\NameManager_16x16.png', 0));
