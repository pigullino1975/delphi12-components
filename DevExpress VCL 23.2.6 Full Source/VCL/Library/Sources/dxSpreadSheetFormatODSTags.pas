...
unit dxSpreadSheetFormatODSTags; // for internal use
...
const
  ...
  sdxODSNodeCreationDate = AnsiString('meta:creation-date');
  sdxODSNodeCreator = AnsiString('dc:creator');
  sdxODSNodeDescription = AnsiString('dc:description');
  ...
  sdxODSNodeInitialCreator = AnsiString('meta:initial-creator');
  sdxODSNodeKeywords = AnsiString('meta:keyword');
  sdxODSNodeMetaPrintDate = AnsiString('meta:print-date');
  sdxODSNodeModificationDate = AnsiString('dc:date');
  ...
  sdxODSNodeOfficeMeta = AnsiString('office:meta');
  ...
  sdxODSNodeSubject = AnsiString('dc:subject');
  ...
  sdxODSNodeTitle = AnsiString('dc:title');
  ...
  sdxODSAttrDrawTextBox = AnsiString('draw:text-box');
...
const
  dxThisUnitName = 'dxSpreadSheetFormatODSTags';
