...
uses
  ...
  dxCore, dxCoreClasses, cxClasses, cxControls, cxGraphics, cxGeometry, cxLookAndFeelPainters, cxStyles,
  cxCustomData,
...
type
  ...
  private
    ...
    function GetActuallyVisible: Boolean; inline;
    function GetCanBeVisible: Boolean; inline;
    function GetCount: Integer;
    function GetIndex: Integer;
    function GetIsLoading: Boolean;
    function GetIsMaster: Boolean; inline;
    function GetIsRoot: Boolean; inline;
    function GetIsTop: Boolean; inline;
...
begin
  Result := FVisible and (not IsTop or Active) and ((FParent = nil) or FParent.ActuallyVisible);
end;
