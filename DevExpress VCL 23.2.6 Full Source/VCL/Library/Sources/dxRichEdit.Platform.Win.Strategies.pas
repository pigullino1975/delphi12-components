...
unit dxRichEdit.Platform.Win.Strategies; // for internal use
...
type
  ...
  private
    procedure SetTransform(const Value: TdxTransformMatrix);
  public
    ...
    property Transform: TdxTransformMatrix read FTransform write SetTransform;
...
const
  dxThisUnitName = 'dxRichEdit.Platform.Win.Strategies';
...
procedure TdxShadowedFloatingObjectPainter.SetTransform(const Value: TdxTransformMatrix);
begin
...
begin
  ...
  try
    ...
    AImgRect := TdxImageTool.CalculateImageRectCore(ABounds, AImgActualSize, SizeMode).DeflateToTRect;
...
destructor TdxShadowedFloatingObjectPainter.Destroy;
begin
