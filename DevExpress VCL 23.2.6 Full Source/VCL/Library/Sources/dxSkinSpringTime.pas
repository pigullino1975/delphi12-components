...
{$IF DEFINED(VER210)}
  {$HPPEMIT '#pragma link "dxSkinSpringTimeRS14.bpi"'}
{$ELSEIF DEFINED(VER220)}
  {$HPPEMIT '#pragma link "dxSkinSpringTimeRS15.bpi"'}
{$ELSEIF DEFINED(VER230)}
  {$HPPEMIT '#pragma link "dxSkinSpringTimeRS16.bpi"'}
{$ELSEIF DEFINED(VER240)}
  {$HPPEMIT '#pragma link "dxSkinSpringTimeRS17.bpi"'}
{$ELSEIF DEFINED(VER250)}
  {$HPPEMIT '#pragma link "dxSkinSpringTimeRS18.bpi"'}
{$ELSEIF DEFINED(VER260)}
  {$HPPEMIT '#pragma link "dxSkinSpringTimeRS19.bpi"'}
{$ELSEIF DEFINED(VER270)}
  {$HPPEMIT '#pragma link "dxSkinSpringTimeRS20.bpi"'}
{$ELSEIF DEFINED(VER280)}
  {$HPPEMIT '#pragma link "dxSkinSpringTimeRS21.bpi"'}
{$ELSEIF DEFINED(VER290)}
  {$HPPEMIT '#pragma link "dxSkinSpringTimeRS22.bpi"'}
{$ELSEIF DEFINED(VER300)}
  {$HPPEMIT '#pragma link "dxSkinSpringTimeRS23.bpi"'}
{$ELSEIF DEFINED(VER310)}
  {$HPPEMIT '#pragma link "dxSkinSpringTimeRS24.bpi"'}
{$ELSEIF DEFINED(VER320)}
  {$HPPEMIT '#pragma link "dxSkinSpringTimeRS25.bpi"'}
{$ELSEIF DEFINED(VER330)}
  {$HPPEMIT '#pragma link "dxSkinSpringTimeRS26.bpi"'}
{$ELSEIF DEFINED(VER340)}
  {$HPPEMIT '#pragma link "dxSkinSpringTimeRS27.bpi"'}
{$ELSEIF DEFINED(VER350)}
  {$HPPEMIT '#pragma link "dxSkinSpringTimeRS28.bpi"'}
{$ELSEIF DEFINED(VER360)}
  {$HPPEMIT '#pragma link "dxSkinSpringTimeRS29.bpi"'}
{$ELSE}
  Unsupported
{$IFEND}
...
{$ELSEIF DEFINED(VER360)}
  {$HPPEMIT '#pragma link "dxSkinSpringTimeRS29.a"'}
{$ELSE}
  Unsupported
{$IFEND}
...
{$ELSEIF DEFINED(VER360)}
  {$HPPEMIT '#pragma link "dxSkinSpringTimeRS29.lib"'}
{$ELSE}
  Unsupported
{$IFEND}
...
const
  dxThisUnitName = 'dxSkinSpringTime';
