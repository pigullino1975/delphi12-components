...
unit dxRichEdit.DocumentModel.NumericFieldFormatter; // for internal use
...
type
  ...
  protected
    ...
    procedure FormatIntegerPartCore(ANumber: Double; AIterator: TdxFormatRangeIterator; AResult: TStringBuilder);
    procedure FormatFractionalPart(ANumber: Double; APattern: TdxNumberPattern; AResult: TStringBuilder); virtual;
    procedure FormatFractionalPartCore(ANumber: Double; AResult: TStringBuilder; AIterator: TdxFormatRangeIterator);
...
const
  dxThisUnitName = 'dxRichEdit.DocumentModel.NumericFieldFormatter';
...
var
  AFactor: Double;
  AOriginRoundingMode: TRoundingMode;
begin
...
procedure TdxNumericFieldFormatter.FormatIntegerPartCore(ANumber: Double; AIterator: TdxFormatRangeIterator; AResult: TStringBuilder);
var
  AIntegerPart: Double;
...
procedure TdxNumericFieldFormatter.FormatFractionalPartCore(ANumber: Double; AResult: TStringBuilder; AIterator: TdxFormatRangeIterator);
var
  ANumberString: string;
