...
unit dxRichEdit.NumberConverters.EnglishUS; // for internal use
...
const
  dxThisUnitName = 'dxRichEdit.NumberConverters.EnglishUS';

{ TdxCardinalEnglishNumericsProvider }

class constructor TdxCardinalEnglishNumericsProvider.Initialize;
begin
  {$IFDEF DX_INITIALIZATION_LOGGING}TdxUnitSectionsLogger.ConstructorStarted(UnitName, 'TdxCardinalEnglishNumericsProvider.Initialize', SysInit.HInstance);{$ENDIF}
  ...
  {$IFDEF DX_INITIALIZATION_LOGGING}TdxUnitSectionsLogger.ConstructorFinished(UnitName, 'TdxCardinalEnglishNumericsProvider.Initialize', SysInit.HInstance);{$ENDIF}
end;
...
begin
  {$IFDEF DX_INITIALIZATION_LOGGING}TdxUnitSectionsLogger.ConstructorStarted(UnitName, 'TdxOrdinalEnglishNumericsProvider.Initialize', SysInit.HInstance);{$ENDIF}
  ...
  {$IFDEF DX_INITIALIZATION_LOGGING}TdxUnitSectionsLogger.ConstructorFinished(UnitName, 'TdxOrdinalEnglishNumericsProvider.Initialize', SysInit.HInstance);{$ENDIF}
end;
...
begin
  {$IFDEF DX_INITIALIZATION_LOGGING}TdxUnitSectionsLogger.ConstructorStarted(UnitName, 'TdxOrdinalEnglishNumberConverter.Initialize', SysInit.HInstance);{$ENDIF}
  FEnding := TArray<string>.Create('st', 'nd', 'rd', 'th');
  {$IFDEF DX_INITIALIZATION_LOGGING}TdxUnitSectionsLogger.ConstructorFinished(UnitName, 'TdxOrdinalEnglishNumberConverter.Initialize', SysInit.HInstance);{$ENDIF}
end;
