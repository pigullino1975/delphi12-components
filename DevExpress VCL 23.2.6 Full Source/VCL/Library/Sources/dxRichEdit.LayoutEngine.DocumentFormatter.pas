...
unit dxRichEdit.LayoutEngine.DocumentFormatter; // for internal use
...
type
  ...
  protected
    ...
    procedure ClearPagesFrom(APageIndex: Integer);
  ...
  public
    ...
    procedure RaisePageFormattingStarted(APage: TdxPage);

    property PageFormattingComplete: TdxPageFormattingCompleteEventHandler read FOnPageFormattingComplete;

    procedure RaisePageFormattingComplete(APage: TdxPage; ADocumentFormattingComplete: Boolean);
    procedure RaisePageCountChanged;
    procedure RaiseResetSecondaryFormattingForPage(APage: TdxPage; APageIndex: Integer);
    ...
    procedure Reset(AKeepFloatingObjects: Boolean);
    function ResetFrom(var AFrom: TdxDocumentModelPosition; AKeepFloatingObjects: Boolean): TdxDocumentModelPosition;
    ...
    procedure RestartFormattingFromTheStartOfRowAtCurrentPage(AClearContentResult: TdxClearInvalidatedContentResult;
      const AFrom: TdxDocumentModelPosition);
    function EnsurePositionVisible(var APos: TdxDocumentModelPosition): TdxDocumentModelPosition;
    function EnsureParagraphVisible(var APos: TdxDocumentModelPosition): TdxDocumentModelPosition;
    function EnsureRunVisible(var APos: TdxDocumentModelPosition): TdxDocumentModelPosition;
    ...
    function ClearInvalidatedContentFromTheStartOfRowAtCurrentPage(const AFrom: TdxDocumentModelPosition;
      ARoundToParagraphBoundary, AKeepFloatingObjects: Boolean): TdxClearInvalidatedContentResult;
    function CleanupEmptyBoxesForCurrentPage(const AFrom: TdxDocumentModelPosition): TdxDocumentModelPosition;
    function CleanupEmptyBoxes(const AFrom: TdxDocumentModelPosition): TdxDocumentModelPosition;
    procedure SetPageCount(APageCount: Integer; APrimaryFormattingFinished: Boolean);
    procedure OnBeginNextSectionFormatting(ASender: TObject; E: TdxEventArgs);
    procedure BeginNextSectionFormatting(ASectionIndex: TdxSectionIndex);
    procedure RestartFormattingFromTheStartOfSection;
    procedure RestartFormattingFromTheMiddleOfSection;
    procedure OnPageFormattingStarted(ASender: TObject; E: TdxPageFormattingCompleteEventArgs);
    ...
    procedure OnParagraphFormattingComplete(AParagraphIndex: TdxParagraphIndex);
...
uses
  RTLConsts, Contnrs, cxGeometry, dxTypeHelpers, Math,
...
const
  dxThisUnitName = 'dxRichEdit.LayoutEngine.DocumentFormatter';
...
type
  ...
  protected
    ...
    procedure SetBeginFromParagraphStart(Value: Boolean); override; final;
