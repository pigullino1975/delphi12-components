...
uses
  SysUtils, dxPSUtl, dxPSRes, dxCoreGraphics, cxGeometry, dxDPIAwareUtils;

const
  dxThisUnitName = 'dxPSTextLnk';
...
begin
  ...
  PlaceItem(Result);
  InitializeItem(Result, ATextRow.ToString);
...
begin
  ...
  TdxImageDrawer.DrawImage(ACanvas, AImageRect, nil, ilAlignments, AIndex, True, nil, ScaleFactor);
