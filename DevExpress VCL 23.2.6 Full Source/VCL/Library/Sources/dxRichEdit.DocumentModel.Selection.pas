...
unit dxRichEdit.DocumentModel.Selection; // for internal use
...
type
  ...
  private
    function GetItem(Index: Integer): IdxSelectionLayoutItem; inline;
  public
    procedure AddRange(ARange: TdxSelectionLayoutItemList);
    function First: IdxSelectionLayoutItem; reintroduce; inline;
    function Last: IdxSelectionLayoutItem; reintroduce; inline;
  ...
  TdxTableStructureBySelectionCalculator = record
  strict private
  ...
  public
    ...
    function CalculateSelectedCells(AResult: TdxSelectedCellsCollection; ARow: TdxTableRow; ALeftColumnIndex: Integer;
      ARightColumnIndex: Integer; AIsLeftToRight: Boolean): Boolean;
  ...
  public
    destructor Destroy; override;
    class function CreateResizableLayout(AView: TObject{TdxRichEditView}; ABox: TdxBox; AStart: TdxDocumentLogPosition;
      APieceTable: TdxPieceTable): TdxRectangularObjectSelectionLayout; static;
  ...
  protected
    ...
    function GetIsNotEmpty: Boolean; override;
    function GetRowsCount: Integer; override;
    function GetSelectedColumnsCountInRow(ASelectionInterval: TdxSelectedCellsIntervalInRow): Integer;
    function GetSelectedRowsCountCore(ACell: TdxTableCell): Integer;
    function GetMergedCellsCount(ACurrentCell: TdxTableCell): Integer;
    procedure Clear;
  public
    ...
    destructor Destroy; override;
    procedure AddSelectedCells(ARow: TdxTableRow; AStart: Integer; AEnd: Integer);
    ...
    function IsWholeCellSelected(ACell: TdxTableCell): Boolean;

    procedure Add(AItem: TdxSelectedCellsIntervalInRow);
    procedure Remove(AItem: TdxSelectedCellsIntervalInRow);

    function IsSelectedEntireTable: Boolean;
    property First: TdxSelectedCellsIntervalInRow read GetFirst;
    property Last: TdxSelectedCellsIntervalInRow read GetLast;

    // for internal use
    function IsSelectedEntireTableRows: Boolean;
    function IsSelectedEntireTableColumns: Boolean;
...
const
  dxThisUnitName = 'dxRichEdit.DocumentModel.Selection';

type

  { TdxResizableRectangularObjectSelectionLayout }

  TdxResizableRectangularObjectSelectionLayout = class(TdxRectangularObjectSelectionLayout)
  public const
...
constructor TdxTableStructureBySelectionCalculator.Create(APieceTable: TdxPieceTable);
begin
  FPieceTable := APieceTable;
end;

function TdxTableStructureBySelectionCalculator.CalculateSelectedCells(AResult: TdxSelectedCellsCollection;
  ARow: TdxTableRow; ALeftColumnIndex: Integer; ARightColumnIndex: Integer; AIsLeftToRight: Boolean): Boolean;
var
...
function TdxTableStructureBySelectionCalculator.CalculateCore(AStartCell: TdxTableCell; AEndCell: TdxTableCell;
  ATable: TdxTable; AIsColumnSelected: Boolean): TdxSelectedCellsCollection;
var
  AStartCellColumnIndex, AEndCellColumnIndex, AStartCellRowIndex, AEndCellRowIndex, ANormalizedLeft, ANormalizedRight,
  ARightColumnIndex, I : Integer;
...
class function TdxRectangularObjectSelectionLayout.CreateResizableLayout(AView: TObject; ABox: TdxBox;
  AStart: TdxDocumentLogPosition; APieceTable: TdxPieceTable): TdxRectangularObjectSelectionLayout;
begin
  Result := TdxResizableRectangularObjectSelectionLayout.Create(AView, ABox, AStart, APieceTable);
end;
...
function TdxRectangularObjectSelectionLayout.GetResizable: Boolean;
begin
  Result := False;
end;
...
constructor TdxResizableRectangularObjectSelectionLayout.Create(AView: TObject{TdxRichEditView}; ABox: TdxBox; AStart: TdxDocumentLogPosition; APieceTable: TdxPieceTable);
begin
...
function TdxResizableRectangularObjectSelectionLayout.GetResizable: Boolean;
begin
  Result := True;
end;

function TdxResizableRectangularObjectSelectionLayout.Update: Boolean;
var
...
procedure TdxResizableRectangularObjectSelectionLayout.AddHotZone(AHotZone: TdxHotZone; const ABounds: TRect);
var
...
function TdxResizableRectangularObjectSelectionLayout.TryCreateAnchorSelectionItem: TdxFloatingObjectAnchorSelectionLayout;
var
  ...
  ABounds: TRect;
begin
  if not Safe.Cast(Box, TdxFloatingObjectBox, AFloatingObjectBox) then
    Exit(nil);
...
function TdxResizableRectangularObjectSelectionLayout.CalculateExtendedBounds(const R: TRect): TRect;
begin
...
function TdxResizableRectangularObjectSelectionLayout.RectangleFromCenter(X: Integer; Y: Integer; ALargeHotZoneSize: Integer): TRect;
var
...
function TdxResizableRectangularObjectSelectionLayout.AlignSizeToPixel(ALayoutSize: Integer): Integer;
begin
