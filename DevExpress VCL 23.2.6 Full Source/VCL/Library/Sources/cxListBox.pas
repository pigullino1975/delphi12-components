...
uses
  ...
  cxClasses, cxControls, cxContainer, cxDataUtils, cxGraphics, cxLookAndFeels, dxTypeHelpers, cxAccessibility,
  cxScrollBar, cxLookAndFeelPainters, dxCustomHint, cxEdit, cxCustomListBox, dxCoreClasses, dxIncrementalSearch,
  cxGeometry;
...
type
  ...
  TcxListBox = class;
  TdxCustomCheckListBox = class;
  TdxQuickCustomizationCustomCheckListBox = class;
  ...
  private
    FItemHeight: Integer;
    FItemHeightScale: TdxScaleFactor;
    ...
    function GetStandardItemHeight: Integer;
  ...
  protected
    ...
    function NeedApplyPaddings: Boolean;
  ...
  public
    ...
    property Count; 
    property InnerListBox: TcxInnerListBox read GetInnerListBox; // for internal use
    property ItemIndex; 
  ...
  private
    ...
    function GetItem(Index: TdxListIndex): TdxCustomListBoxItem;
  ...
  public
    ...
    function AddObject(const ACaption: string; AData: TObject): TdxCustomListBoxItem; overload;
    ...
    //
    property Items[Index: TdxListIndex]: TdxCustomListBoxItem read GetItem; default; // for internal use
  ...
  private
    function GetItem(Index: TdxListIndex): TdxCustomCheckListBoxItem;
  protected
    function GetItemClass: TdxCustomListBoxItemClass; override;
  public
    function AddObject(const ACaption: string; AData: TObject): TdxCustomCheckListBoxItem; overload;
    function AddObject(const ACaption: string; AData: TObject; AImageIndex: Integer): TdxCustomListBoxItem; overload;

    property Items[Index: TdxListIndex]: TdxCustomCheckListBoxItem read GetItem; default; // for internal use
  end;
  ...
  TdxListBoxIncrementalSearchController = class(TdxIncrementalSearchController)
  strict private
    FListBox: TdxCustomListBox;
  protected
    function FocusNextItemWithText(const AText: string): Boolean; override;
    property ListBox: TdxCustomListBox read FListBox;
  public
    constructor Create(AListBox: TdxCustomListBox); virtual;
  end;

  { TdxCustomListBoxAccessibilityHelper }

  TdxCustomListBoxAccessibilityHelper = class(TcxAccessibilityHelper) // for internal use
  strict private
    function GetListBox: TdxCustomListBox;
  protected
    ...
    property ListBox: TdxCustomListBox read GetListBox;
  public
    function GetScreenBounds(AChildID: TcxAccessibleSimpleChildElementID): TRect; override;
  end;

  TdxCustomListBoxAccessibilityHelperClass = class of TdxCustomListBoxAccessibilityHelper;
  ...
  strict private
    ...
    FIncrementalSearchController: TdxListBoxIncrementalSearchController;
    ...
    procedure SetAlignImages(AValue: Boolean);
  ...
  protected
    ...
    function GetAccessibilityHelperClass: TdxCustomListBoxAccessibilityHelperClass; virtual;
    function GetHasSeparator(AItem: TdxCustomListBoxItem): Boolean; virtual;
    function GetImagesAreaRect: TRect; virtual;
    function GetItemFontStyle(AItem: TdxCustomListBoxItem): TFontStyles; virtual;
    ...
    function GetItemBackgroundRect(AItem: TdxCustomListBoxItem; const AItemRect: TRect): TRect; virtual;
    function GetItemImageRect(AItem: TdxCustomListBoxItem; const AItemRect: TRect): TRect; virtual;
    ...
    function GetItemTextRect(AItem: TdxCustomListBoxItem; const AItemRect: TRect): TRect; virtual;
    ...
    function CreateIncrementalSearchController: TdxListBoxIncrementalSearchController; virtual;
    ...
    property AlignImages: Boolean read FAlignImages write SetAlignImages default True;
    ...
    property IncrementalSearchController: TdxListBoxIncrementalSearchController read FIncrementalSearchController;
  ...
  public
    ...
    function CalculateContentSize(AMaxVisibleItemsCount: Integer): TSize; overload; virtual;
    ...
    property AutoCompleteDelay: Cardinal read GetAutoCompleteDelay write SetAutoCompleteDelay;
    ...
    property ItemObject: TObject read GetItemObject write SetItemObject;
    property Items: TdxCustomListBoxItems read FItems write FItems; // for internal use
  ...
  TdxCheckListBoxIncrementalSearchController = class(TdxListBoxIncrementalSearchController)
  strict private
    function GetListBox: TdxCustomCheckListBox;
  protected
    function CanProcessIncSearch(Key: Char): Boolean; override;
    function DoIncrementalSearch(var Key: Char): Boolean; override;
    property ListBox: TdxCustomCheckListBox read GetListBox;
  end;
  ...
  public
    ...
    property Items: TdxCustomCheckListBoxItems read GetItems; // for internal use
  ...
  protected
    ...
    function GetItemFontStyle(AItem: TdxCustomListBoxItem): TFontStyles; override;
    ...
    function IsDefaultItem(AItem: TdxCustomListBoxItem): Boolean; virtual;
    procedure MouseLeave(AControl: TControl); override;
    procedure MouseMove(Shift: TShiftState; X, Y: Integer); override;
    procedure MouseUp(Button: TMouseButton; Shift: TShiftState; X, Y: Integer); override;
    function ProcessNavigationKey(var Key: Word; Shift: TShiftState): Boolean; override;
  ...
  { TdxQuickCustomizationCustomCheckListBoxIncrementalSearchController }

  TdxQuickCustomizationCustomCheckListBoxIncrementalSearchController = class(TdxCheckListBoxIncrementalSearchController)
  strict private
    function GetListBox: TdxQuickCustomizationCustomCheckListBox;
  protected
    function DoIncrementalSearch(var Key: Char): Boolean; override;
    property ListBox: TdxQuickCustomizationCustomCheckListBox read GetListBox;
  end;
  ...
  public
    ...
    property QuickCustomizationControl: TdxQuickCustomizationCustomControl read GetQuickCustomizationControl; // for internal use
  ...
  public
    ...
    property CheckListBox: TdxQuickCustomizationCheckListBox read FCheckListBox; // for internal use
    property CommandListBox: TdxQuickCustomizationCustomCheckListBox read FCommandListBox; // for internal use
...
uses
  Variants, dxCoreGraphics, StrUtils, dxDPIAwareUtils;

const
  dxThisUnitName = 'cxListBox';
...
function TcxInnerListBox.DoCustomDrawItem(AIndex: Integer; const ARect: TRect; AState: TOwnerDrawState): Boolean;
begin
  Result := Container.DrawItem(Canvas, AIndex, ARect, AState);
end;
...
function TcxInnerListBox.GetDefaultItemHeight: Integer;
begin
...
begin
  ...
  FItemHeightScale := TdxScaleFactor.Create;
  FItemHeight := 16;
end;

destructor TcxListBox.Destroy;
begin
  FreeAndNil(FItemHeightScale);
  inherited Destroy;
end;
...
begin
  ...
  if NeedApplyPaddings and (FListStyle = lbStandard) then
    InnerListBox.ItemHeight := GetStandardItemHeight + TdxVisualRefinements.Padding.ScaledHeight(ScaleFactor);
  SetSize;
end;
...
function TcxListBox.NeedApplyPaddings: Boolean;
begin
  Result := False;
  //Result := LookAndFeelPainter.SupportsListBoxPadding or (TdxVisualRefinements.UsePaddingForStandaloneEditors and not TdxVisualRefinements.Padding.IsZero);
end;

procedure TcxListBox.SetItemHeight(Value: Integer);
begin
  FItemHeight := Value;
  FItemHeightScale.Assign(ScaleFactor);
  if not NeedApplyPaddings or (FListStyle <> lbStandard) then
...
begin
  ...
  Result := Assigned(FOnDrawItem) and (FListStyle <> lbStandard);
  if Result then
...
function TcxListBox.GetStandardItemHeight: Integer;
begin
  if HandleAllocated then
    Result := TdxTextMeasurer.TextLineHeight(Font)
  else
    Result := ScaleFactor.Apply(FItemHeight);
end;
...
procedure TcxListBox.VisualRefinementsListenerChanged;
begin
//  if NeedApplyPaddings and (FListStyle = lbStandard) then
//  begin
//    InnerListBox.Style := lbOwnerDrawFixed;
//    InnerListBox.ItemHeight := GetStandardItemHeight + TdxVisualRefinements.Padding.ScaledHeight(ScaleFactor);
//  end
//  else
//  begin
//    InnerListBox.Style := FListStyle;
//    InnerListBox.ItemHeight := ScaleFactor.Apply(FItemHeight, FItemHeightScale);
//  end;
  Invalidate;
  inherited;
end;
...
function TdxCustomListBoxItems.AddObject(const ACaption: string; AData: TObject; AImageIndex: Integer): TdxCustomListBoxItem;
begin
  Result := Add(ACaption, AImageIndex, AData);
end;
...
function TdxCustomListBoxItems.GetItem(Index: TdxListIndex): TdxCustomListBoxItem;
begin
...
function TdxCustomCheckListBoxItems.AddObject(const ACaption: string; AData: TObject; AImageIndex: Integer): TdxCustomListBoxItem;
begin
  Result := inherited AddObject(ACaption, AData, AImageIndex) as TdxCustomCheckListBoxItem;
end;

function TdxCustomCheckListBoxItems.GetItem(Index: TdxListIndex): TdxCustomCheckListBoxItem;
begin
...
function TdxCustomListBoxAccessibilityHelper.GetScreenBounds(AChildID: TcxAccessibleSimpleChildElementID): TRect;
begin
  if AChildID = 0 then
...
function TdxCustomListBoxAccessibilityHelper.ChildIsSimpleElement(AIndex: Integer): Boolean;
begin
  Result := True;
end;

procedure TdxCustomListBoxAccessibilityHelper.DoDefaultAction(AChildID: TcxAccessibleSimpleChildElementID);
begin
  if AChildID > 0 then
    ListBox.ItemIndex := AChildID - 1;
end;

function TdxCustomListBoxAccessibilityHelper.GetChildCount: Integer;
begin
  Result := ListBox.Items.Count;
end;

function TdxCustomListBoxAccessibilityHelper.GetDefaultActionDescription(AChildID: TcxAccessibleSimpleChildElementID): string;
begin
  if AChildID = 0 then
    Result := ''
  else
...
function TdxCustomListBoxAccessibilityHelper.GetName(AChildID: TcxAccessibleSimpleChildElementID): string;
begin
  if AChildID > 0 then
    Result := ListBox.Items[AChildID - 1].Caption
  else
    Result := '';
end;

function TdxCustomListBoxAccessibilityHelper.GetOwnerObjectWindow: HWND;
begin
  Result := ListBox.Handle;
end;

function TdxCustomListBoxAccessibilityHelper.GetRole(AChildID: TcxAccessibleSimpleChildElementID): Integer;
begin
  if AChildID = 0 then
...
function TdxCustomListBoxAccessibilityHelper.GetState(AChildID: TcxAccessibleSimpleChildElementID): Integer;
begin
...
function TdxCustomListBoxAccessibilityHelper.GetSupportedProperties(AChildID: TcxAccessibleSimpleChildElementID): TcxAccessibleObjectProperties;
begin
  Result := [aopFocus, aopLocation, aopDefaultAction];
end;

function TdxCustomListBoxAccessibilityHelper.IsExtended: Boolean;
begin
  Result := True;
end;

function TdxCustomListBoxAccessibilityHelper.GetListBox: TdxCustomListBox;
begin
  Result := TdxCustomListBox(OwnerObject);
end;
...
function TdxCustomListBox.CanShowHint(AItemIndex: Integer; out AItemRect, AItemTextRect: TRect): Boolean;
var
  AItem: TdxCustomListBoxItem;
begin
  Result := False;
  ...
  begin
    ...
    AItemTextRect := GetItemTextRect(AItem, AItemRect);
    Result := cxMeasureCanvas.TextWidth(AItem.Caption) > cxRectWidth(AItemTextRect);
  end;
end;
...
begin
  ...
  begin
    AItem := Items[I];
    Result.cx := Max(Result.cx, TdxTextMeasurer.TextWidthTO(Font, AItem.Caption, GetItemFontStyle(AItem)));
  end;
...
begin
  Result := Max(
    ...
    cxMarginsHeight(TextOffsets) + TdxTextMeasurer.TextLineHeight(Font));
end;
...
begin
  Result := 0;
  for I := 0 to Count - 1 do
    Result := Max(Result, TdxTextMeasurer.TextWidthTO(Font, Items[I].Caption));
...
procedure TdxCustomListBox.DoKeyPress(var Key: Char);
begin
  if IncrementalSearch and (Count > 0) then
...
begin
  ...
  ABackgroundRect := GetItemBackgroundRect(AItem, AItemRect);
  AImageRect := GetItemImageRect(AItem, AItemRect);
  ATextRect := GetItemTextRect(AItem, AItemRect);
...
begin
  ...
  begin
    ...
    TdxImageDrawer.DrawUncachedImage(Canvas.Handle, AImageRect, AImageRect, nil, Images, AItem.ImageIndex, idmNormal,
      False, 0, clNone, True, LookAndFeelPainter.EditButtonColorPalette(cxbsNormal));
  end;
end;
...
function TdxCustomListBox.GetAccessibilityHelperClass: TdxCustomListBoxAccessibilityHelperClass;
begin
  Result := TdxCustomListBoxAccessibilityHelper;
end;
...
function TdxCustomListBox.CreateIncrementalSearchController: TdxListBoxIncrementalSearchController;
begin
  Result := TdxListBoxIncrementalSearchController.Create(Self);
end;
...
begin
  ...
  begin
    AItemHeight := CalculateItemHeight;
    dxAdjustToTouchableSize(AItemHeight, ScaleFactor);
    ItemHeight := AItemHeight;
  end;
end;

function TdxCustomListBox.GetAutoCompleteDelay: Cardinal;
begin
  Result := FIncrementalSearchController.AutoCompleteDelay;
end;
...
function TdxCustomListBox.GetIAccessibilityHelper: IcxAccessibilityHelper;
begin
...
function TdxCustomListBox.GetItemFontStyle(AItem: TdxCustomListBoxItem): TFontStyles;
begin
  Result := Font.Style;
end;
...
begin
  if NeedUseSelectionColor(AItem, AState) or NeedUseHotColor(AItem, AState) then
    Result := LookAndFeelPainter.DefaultSelectionColor
  else
    Result := clDefault;
end;

function TdxCustomListBox.GetItemBackgroundRect(AItem: TdxCustomListBoxItem; const AItemRect: TRect): TRect;
begin
  Result := AItemRect;
  if Columns > 1 then
    Result.Right := AItemRect.Left + ColumnWidth;
  Inc(Result.Left, ImagesAreaRect.Right - ClientBounds.Left);
  if not (FAlignImages or IsImageAssigned(Images, AItem.ImageIndex)) then
    Dec(Result.Left, ImagesAreaRect.Width);
end;

function TdxCustomListBox.GetItemImageRect(AItem: TdxCustomListBoxItem; const AItemRect: TRect): TRect;
begin
...
function TdxCustomListBox.GetItemTextRect(AItem: TdxCustomListBoxItem; const AItemRect: TRect): TRect;
begin
  Result := GetItemBackgroundRect(AItem, AItemRect);
...
begin
  if Columns = 0 then
    ...
    Result := Max((ClientBounds.Bottom - ClientBounds.Top) div ItemHeight, 1);
end;

function TdxCustomListBox.GetSearchText: string;
begin
  Result := FIncrementalSearchController.SearchText;
end;
...
procedure TdxCustomListBox.SetAutoCompleteDelay(const Value: Cardinal);
begin
  FIncrementalSearchController.AutoCompleteDelay := Value;
end;
...
procedure TdxCustomListBox.SetSearchText(const Value: string);
begin
  FIncrementalSearchController.SearchText := Value;
end;

procedure TdxCustomListBox.SetAlignImages(AValue: Boolean);
begin
  if FAlignImages <> AValue then
  begin
    FAlignImages := AValue;
    LayoutChanged;
  end;
...
procedure TdxCustomListBox.WMGetObject(var Message: TMessage);
var
  AObjectID: Cardinal;
begin
...
{ TdxListBoxIncrementalSearchController }

constructor TdxListBoxIncrementalSearchController.Create(AListBox: TdxCustomListBox);
begin
  inherited Create;
  FListBox := AListBox;
end;

function TdxListBoxIncrementalSearchController.FocusNextItemWithText(
  const AText: string): Boolean;
begin
  Result := FListBox.FocusNextItemWithText(AText);
end;

{ TdxCheckListBoxIncrementalSearchController }

function TdxCheckListBoxIncrementalSearchController.CanProcessIncSearch(Key: Char): Boolean;
begin
  if (Key = dxSpace) and (SearchText = '') then
    Result := False
  else
    Result := inherited CanProcessIncSearch(Key);
end;

function TdxCheckListBoxIncrementalSearchController.DoIncrementalSearch(var Key: Char): Boolean;
begin
  Result := inherited DoIncrementalSearch(Key);
  if Result and ListBox.MultiSelect then
    ListBox.SelectFocusedItem;
end;

function TdxCheckListBoxIncrementalSearchController.GetListBox: TdxCustomCheckListBox;
begin
  Result := inherited ListBox as TdxCustomCheckListBox;
end;
...
function TdxCustomCheckListBox.CalculateItemHeight: Integer;
begin
...
procedure TdxCustomCheckListBox.DragOver(Source: TObject; X, Y: Integer;
  ...
  var
    ALeftArrowRect: TRect;
    ARightArrowRect: TRect;
  begin
    if FDragItemIndex = -1 then Exit;
    ALeftArrowRect := FDragAndDropLeftArrowRect;
    ARightArrowRect := FDragAndDropRightArrowRect;
    FDragAndDropLeftArrowRect := GetArrowBounds(apLeft);
    FDragAndDropRightArrowRect := GetArrowBounds(apRight);
    if not ALeftArrowRect.IsEqual(FDragAndDropLeftArrowRect) then
    begin
      cxInvalidateRect(Self, ALeftArrowRect);
      cxInvalidateRect(Self, FDragAndDropLeftArrowRect);
    end;
    if not ARightArrowRect.IsEqual(FDragAndDropRightArrowRect) then
    begin
      cxInvalidateRect(Self, ARightArrowRect);
...
begin
  if LookAndFeelPainter.SupportsNativeFocusRect(TdxPaintPartID.ListBox) then
...
function TdxCustomCheckListBox.CreateIncrementalSearchController: TdxListBoxIncrementalSearchController;
begin
  Result := TdxCheckListBoxIncrementalSearchController.Create(Self);
end;
...
procedure TdxCustomDropDownInnerListBox.AdjustItemFont(
  AFont: TFont; AItem: TdxCustomListBoxItem; AState: TcxButtonState);
begin
  AFont.Style := GetItemFontStyle(AItem);
end;
...
function TdxCustomDropDownInnerListBox.GetItemFontStyle(AItem: TdxCustomListBoxItem): TFontStyles;
begin
  Result := Font.Style;
  if IsDefaultItem(AItem) then
...
function TdxCustomDropDownInnerListBox.IsDefaultItem(AItem: TdxCustomListBoxItem): Boolean;
begin
  Result := (DefaultItemIndex > -1) and (DefaultItemIndex = AItem.Index);
end;
...
begin
  ...
  begin
    ItemIndex := -1;
    InnerListBox.IncrementalSearchController.DoIncrementalSearch(AActivateKey);
  end;
  OwnerBounds := ABounds;
  Popup;
end;
...
function TdxQuickCustomizationCustomCheckListBox.CreateIncrementalSearchController: TdxListBoxIncrementalSearchController;
begin
  Result := TdxQuickCustomizationCustomCheckListBoxIncrementalSearchController.Create(Self);
end;
...
begin
  ...
  AListBox.IncrementalSearchController.SearchText := ASearchText;
  AListBox.IncrementalSearchController.FStartIncrementalSearch := Sender.IncrementalSearchController.FStartIncrementalSearch;
...
begin
  ...
  if Result then
  begin
    Sender.IncrementalSearchController.ClearIncrementalSearch;
    Key := 0;
  end;
end;
...
function TdxQuickCustomizationCustomCheckListBoxIncrementalSearchController.DoIncrementalSearch(var Key: Char): Boolean;
begin
  Result := inherited DoIncrementalSearch(Key);
  if not Result and (SearchText <> '') then
    ListBox.QuickCustomizationControl.Controller.DoIncrementalSearchOnOtherListBox(ListBox, SearchText);
end;

function TdxQuickCustomizationCustomCheckListBoxIncrementalSearchController.GetListBox: TdxQuickCustomizationCustomCheckListBox;
begin
  Result := inherited ListBox as TdxQuickCustomizationCustomCheckListBox;
end;
