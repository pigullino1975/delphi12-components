...
uses
  ...
  dxPSImgs,dxPSEngn, dxMessageDialog;

const
  dxThisUnitName = 'dxPSFileBasedXplorer';
    ...
    begin
      ...
      try
        if Explorer.IOStatus <> mrYesToAll then
          ...
          begin
            Explorer.IOStatus := dxMessageDlg(Item.OverwriteMessageText(AParent), mtWarning, Buttons, 0);
...
begin
  ...
  begin
    ...
    begin
      ...
      if Explorer.IOStatus <> mrYesToAll then
      begin
        Explorer.IOStatus := dxMessageDlg(OverwriteMessageText(AParent), mtWarning, Buttons, 0);
