...
resourcestring
  ...
  scxGridFindPanelNextButtonCaption = 'Next';
  scxGridFindPanelPreviousButtonCaption = 'Previous';
  ...
  cxSEditRepositoryExtLookupComboBoxItem = 'ExtLookupComboBox|Defines an advanced lookup editor that can display the ExpressQuantumGrid as its drop-down control';
  ...
  scxGridLayoutViewCustomizeFormTemplateCard = 'Template Layout';
