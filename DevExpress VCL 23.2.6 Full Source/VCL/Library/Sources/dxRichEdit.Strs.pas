...
resourcestring
  ...
  sdxRichEditFileFilterDescription_OpenXmlFiles = 'Word Document';
  ...
  sdxRichEditFileFilterDescription_DocFiles = 'Word 97-2003 Document';
  ...
  sdxRichEditToolTipFooter_ClickToFollowHyperlink = 'Click to follow link';
...
const
  dxThisUnitName = 'dxRichEdit.Strs';
...
begin
  ...
  AProduct.Add('sdxRichEditToolTipFooter_ClickToFollowHyperlink', @sdxRichEditToolTipFooter_ClickToFollowHyperlink);
