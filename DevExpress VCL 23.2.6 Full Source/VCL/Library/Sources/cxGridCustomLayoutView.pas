...
uses
  Types, Classes, Controls, Graphics, Windows, Forms, StdCtrls, Contnrs, dxFilterPopupWindow, cxGraphics,
...
type
  ...
  TcxGridCustomLayoutRecordExpandButtonViewInfo = class;
  ...
  public
    ...
    function GetMouseWheelMajorScrollBarKind: TScrollBarKind; virtual; abstract;
  ...
  { TcxGridCustomLayoutRecordExpandButtonPainter }

  TcxGridCustomLayoutRecordExpandButtonPainter = class(TcxCustomGridCellPainter)
  private
    function GetViewInfo: TcxGridCustomLayoutRecordExpandButtonViewInfo;
  protected
    procedure Paint; override;

    property ViewInfo: TcxGridCustomLayoutRecordExpandButtonViewInfo read GetViewInfo;
  end;

  { TcxGridCustomLayoutRecordPainter }

  TcxGridCustomLayoutRecordPainter = class(TcxCustomGridRecordPainter)
  strict private
    FClipRegion: TcxRegion;

    function GetViewInfo: TcxGridCustomLayoutRecordViewInfo;
  protected
    ...
    property ViewInfo: TcxGridCustomLayoutRecordViewInfo read GetViewInfo;
  end;
  ...
  protected
    ...
    function DrawBackgroundBeforePaint: Boolean; override;
  ...
  { TcxGridCustomLayoutRecordExpandButtonViewInfo }

  TcxGridCustomLayoutRecordExpandButtonViewInfo = class(TcxCustomGridViewCellViewInfo)
  private
    FRecordViewInfo: TcxGridCustomLayoutRecordViewInfo;
  protected
  ...
  public
    ...
    property RecordViewInfo: TcxGridCustomLayoutRecordViewInfo read FRecordViewInfo;
  end;
  TcxGridCustomLayoutViewRecordExpandButtonViewInfoClass = class of TcxGridCustomLayoutRecordExpandButtonViewInfo;
  ...
  private
    ...
    FExpandButtonViewInfo: TcxGridCustomLayoutRecordExpandButtonViewInfo;

    function GetExpandButtonSizeValue: Integer;
    function GetGridRecord: TcxGridCustomLayoutRecord;
  ...
  protected
    ...
    function GetExpandButtonOffset: Integer; virtual; abstract;
    function GetExpandButtonViewInfoClass: TcxGridCustomLayoutViewRecordExpandButtonViewInfoClass; virtual;
    function GetPainterClass: TcxCustomGridCellPainterClass; override;
    ...
    property ExpandButtonOffset: Integer read GetExpandButtonOffset;
  ...
  public
    ...
    procedure MainCalculate(ALeftBound: Integer; ATopBound: Integer); override;

    property ExpandButtonViewInfo: TcxGridCustomLayoutRecordExpandButtonViewInfo read FExpandButtonViewInfo;
    property GridRecord: TcxGridCustomLayoutRecord read GetGridRecord;
...
uses
  Math, SysUtils, cxGridCommon, cxLookAndFeels, cxFilter;

const
  dxThisUnitName = 'cxGridCustomLayoutView';
...
function TcxGridCustomLayoutViewControllerHorizontalHelper.GetMouseWheelMajorScrollBarKind: TScrollBarKind;
begin
  Result := sbHorizontal;
end;
...
function TcxGridCustomLayoutViewControllerVerticalHelper.GetMouseWheelMajorScrollBarKind: TScrollBarKind;
begin
  Result := sbVertical;
end;
...
function TcxGridCustomLayoutViewController.GetMouseWheelMajorScrollBarKind: TScrollBarKind;
begin
...
function TcxGridCustomLayoutRecordExpandButtonPainter.GetViewInfo: TcxGridCustomLayoutRecordExpandButtonViewInfo;
begin
  Result := TcxGridCustomLayoutRecordExpandButtonViewInfo(inherited ViewInfo);
end;

procedure TcxGridCustomLayoutRecordExpandButtonPainter.Paint;
begin
//do nothing
end;
...
procedure TcxGridCustomLayoutRecordPainter.AfterPaint;
begin
  inherited AfterPaint;
  Canvas.SetClipRegion(FClipRegion, roSet);
end;

procedure TcxGridCustomLayoutRecordPainter.BeforePaint;
begin
...
procedure TcxGridCustomLayoutRecordPainter.DrawExpandButton;
begin
  ViewInfo.ExpandButtonViewInfo.Paint(Canvas);
end;

function TcxGridCustomLayoutRecordPainter.DrawExpandButtonBeforePaint: Boolean;
begin
  Result := False;
end;

function TcxGridCustomLayoutRecordPainter.GetViewInfo: TcxGridCustomLayoutRecordViewInfo;
begin
  Result := TcxGridCustomLayoutRecordViewInfo(inherited ViewInfo);
end;
...
function TcxGridCustomLayoutViewPainter.DrawBackgroundBeforePaint: Boolean;
begin
  Result := True;
end;
...
constructor TcxGridCustomLayoutRecordExpandButtonViewInfo.Create(ARecordViewInfo: TcxGridCustomLayoutRecordViewInfo);
begin
  inherited Create(ARecordViewInfo.GridViewInfo);
  FRecordViewInfo := ARecordViewInfo;
end;

function TcxGridCustomLayoutRecordExpandButtonViewInfo.CalculateHeight: Integer;
begin
  Result := RecordViewInfo.ExpandButtonSize;
end;

function TcxGridCustomLayoutRecordExpandButtonViewInfo.CalculateWidth: Integer;
begin
  Result := RecordViewInfo.ExpandButtonSize;
end;

function TcxGridCustomLayoutRecordExpandButtonViewInfo.CaptureMouseOnPress: Boolean;
begin
  Result := True;
end;

procedure TcxGridCustomLayoutRecordExpandButtonViewInfo.Click;
begin
  inherited Click;
  FRecordViewInfo.GridRecord.ToggleExpanded;
end;

function TcxGridCustomLayoutRecordExpandButtonViewInfo.GetHitTestClass: TcxCustomGridHitTestClass;
begin
  Result := TcxGridExpandButtonHitTest;
end;

function TcxGridCustomLayoutRecordExpandButtonViewInfo.GetHotTrack: Boolean;
begin
  Result := True;
end;

function TcxGridCustomLayoutRecordExpandButtonViewInfo.GetPainterClass: TcxCustomGridCellPainterClass;
begin
  Result := TcxGridCustomLayoutRecordExpandButtonPainter;
end;

function TcxGridCustomLayoutRecordExpandButtonViewInfo.GetVisible: Boolean;
begin
  Result := RecordViewInfo.GridRecord.Expandable;
end;

function TcxGridCustomLayoutRecordExpandButtonViewInfo.HasPoint(const P: TPoint): Boolean;
begin
  Result := inherited HasPoint(P) and LookAndFeelPainter.IsPointOverGroupExpandButton(Bounds, P);
end;

procedure TcxGridCustomLayoutRecordExpandButtonViewInfo.InitHitTest(AHitTest: TcxCustomGridHitTest);
begin
...
constructor TcxGridCustomLayoutRecordViewInfo.Create(ARecordsViewInfo: TcxCustomGridRecordsViewInfo;
...
destructor TcxGridCustomLayoutRecordViewInfo.Destroy;
begin
  FreeAndNil(FExpandButtonViewInfo);
  inherited Destroy;
end;

procedure TcxGridCustomLayoutRecordViewInfo.BeforeRecalculation;
begin
  inherited BeforeRecalculation;
  FExpandButtonViewInfo.BeforeRecalculation;
end;

procedure TcxGridCustomLayoutRecordViewInfo.DoRightToLeftConversion(const ABounds: TRect);
begin
...
procedure TcxGridCustomLayoutRecordViewInfo.MainCalculate(ALeftBound: Integer; ATopBound: Integer);
begin
...
procedure TcxGridCustomLayoutRecordViewInfo.CalculateExpandButtonBounds(var ABounds: TRect);
var
  ASize: Integer;
begin
...
function TcxGridCustomLayoutRecordViewInfo.CanGenerateExpandButtonHitTest: Boolean;
begin
  Result := False;
end;

function TcxGridCustomLayoutRecordViewInfo.GetExpandButtonAreaWidth: Integer;
begin
  Result := ExpandButtonOffset + ExpandButtonSize + ExpandButtonOffset;
end;

function TcxGridCustomLayoutRecordViewInfo.GetExpandButtonViewInfoClass: TcxGridCustomLayoutViewRecordExpandButtonViewInfoClass;
begin
  Result := TcxGridCustomLayoutRecordExpandButtonViewInfo;
end;

function TcxGridCustomLayoutRecordViewInfo.GetPainterClass: TcxCustomGridCellPainterClass;
begin
  Result := TcxGridCustomLayoutRecordPainter;
end;

function TcxGridCustomLayoutRecordViewInfo.GetPixelScrollSize: Integer;
begin
  if TcxGridCustomLayoutViewController(Controller).GetMouseWheelMajorScrollBarKind = sbVertical then
...
function TcxGridCustomLayoutRecordViewInfo.GetExpandButtonSizeValue: Integer;
begin
  Result := GetExpandButtonSize(LookAndFeelPainter, ScaleFactor);
end;

function TcxGridCustomLayoutRecordViewInfo.GetGridRecord: TcxGridCustomLayoutRecord;
begin
  Result := TcxGridCustomLayoutRecord(inherited GridRecord);
end;
...
begin
  Result := TcxGridCustomLayoutViewController(Controller).GetMouseWheelMajorScrollBarKind = sbVertical;
end;
...
function TcxGridCustomLayoutView.GetController: TcxGridCustomLayoutViewController;
begin
  Result := TcxGridCustomLayoutViewController(inherited Controller);
end;
...
function TcxGridCustomLayoutView.IsDataScrollbar(AKind: TScrollBarKind): Boolean;
begin
