...
uses
  ...
  dxExtCtrls, dxPreVw, dxPSForm, UITypes,
...
const
  ...
  begin
    TdxImageDrawer.DrawImage(ACanvas, GetPreviewBounds, nil, ilMonitor, AImageIndex, True, nil, ScaleFactor);
  end;
