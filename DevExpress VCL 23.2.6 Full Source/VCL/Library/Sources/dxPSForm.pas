...
type
  ...
  protected
    ...
    function GetDefaultPosition: TPosition; virtual;
...
function TCustomdxPSForm.GetDefaultPosition: TPosition;
begin
  Result := poDesktopCenter;
end;
...
procedure TCustomdxPSForm.InitializeNewForm;
begin
  inherited;
  PopupMode := pmAuto;
