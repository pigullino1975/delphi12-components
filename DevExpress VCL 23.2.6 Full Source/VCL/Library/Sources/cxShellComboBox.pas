...
uses
  Windows, Messages, Classes, ComCtrls, Controls, ImgList, ShlObj, ComObj,
...
//    procedure SetRelativePath(const Value: string);
  ...
  protected
    ...
    function CheckAbsolutePIDL(var APIDL: PItemIDList; ACheckObjectExistence: Boolean): Boolean;
    ...
    function InternalSynchronizeData: Boolean; virtual;
    procedure InternalSynchronizeEditValue(APIDL: PItemIDList; const ADisplayText: string = ''); virtual;
  ...
  public
    ...
    property ActiveProperties: TcxCustomShellComboBoxProperties read GetActiveProperties;
    property GroupIndex: Integer read FGroupIndex write SetGroupIndex;
    property Path: string read GetPath write SetPath;
    property PopupShellTreeView: TcxPopupShellTreeView read FPopupShellTreeView;
    property Properties: TcxCustomShellComboBoxProperties read GetProperties write SetProperties;
...
//    property RelativePath: string read GetRelativePath write SetRelativePath;
  ...
  public
    class function GetPropertiesClass: TcxCustomEditPropertiesClass; override;
    property ActiveProperties: TcxShellComboBoxProperties read GetActiveProperties;
  published
    property Anchors;
    property AutoSize;
...
uses
  Variants,
  ActiveX, CommCtrl, Graphics, ShellAPI, SysUtils, cxControls, cxEditPaintUtils, cxEditUtils, cxExtEditConsts,
  cxFilterControlUtils, cxGeometry, cxVariants;

const
  dxThisUnitName = 'cxShellComboBox';
...
begin
  ...
  PopupShellTreeView.Color := ViewInfo.BackgroundColor;
  PopupWindow.Font := VisibleFont;
end;

procedure TcxCustomShellComboBox.Loaded;
begin
  inherited Loaded;
...
var
  ...
  S: String;
begin
  if InternalSynchronizeData then
    Exit;
      ...
      case APathType of
        ...
        sptRelativePhysical:
          begin
            ...
            dxShellPrepareShellSpecialFolderInfoTable;
...
begin
  if not InternalSynchronizeData then
  begin
...
function TcxCustomShellComboBox.InternalSynchronizeData: Boolean;
begin
  Result := False;
end;

procedure TcxCustomShellComboBox.InternalSynchronizeEditValue(APIDL: PItemIDList; const ADisplayText: string = '');
var
  APIDLName: string;
...
begin
  ...
  try
    ...
    try
      ...
      TdxShellControlGroups.AbsolutePidlChanged(Self, ATempPIDL, FGroupIndex);
      SynchronizePopupShellTreeView;
    finally
      DisposePidl(ATempPIDL);
    end;
...
begin
  ...
  begin
    ...
    TdxShellControlGroups.RootChanged(Self, ActiveProperties.Root, FGroupIndex);
  end;
end;
...
procedure TcxCustomShellComboBox.SetGroupIndex(AValue: Integer);
begin
