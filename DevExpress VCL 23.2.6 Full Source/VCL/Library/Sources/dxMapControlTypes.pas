...
type
  TdxMapControlTileIndex = record // for internal use
    X: Integer;
    Y: Integer;
    Level: Integer;
  end;

  TdxMapControlTileRange = record // for internal use
...
const
  ...
  {$HPPEMIT    'static const System::Extended dxMapControlInvalidLatitude = Math::NaN;'}
  dxMapControlInvalidLongitude = NaN;
  {$NODEFINE dxMapControlInvalidLongitude}
  {$HPPEMIT    'static const System::Extended dxMapControlInvalidLongitude = Math::NaN;'}
...
const
  dxThisUnitName = 'dxMapControlTypes';
