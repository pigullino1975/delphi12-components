...
uses
  SysUtils, Classes, dxCore, dxCoreClasses, cxClasses, cxEdit;
...
type
  ...
  private
    ...
    function Find(const AItems: TcxEditRegisteredRepositoryItemsDataArray;
      ADataType: TdxNativeInt; AVersion: Integer; AFindItemWithMaxVersion: Boolean; out AIndex: Integer): Boolean;
...
//    function GetRepositoryItem(Index: Integer): PcxEditRegisteredRepositoryItemsData;
  protected
    ...
    function Add(var AItems: TcxEditRegisteredRepositoryItemsDataArray;
      ADataType: TdxNativeInt; AVersion: Integer;
    ...
    procedure Delete(var AItems: TcxEditRegisteredRepositoryItemsDataArray;
      ...
      ADataType: TdxNativeInt; AVersion: Integer; out AIndex: Integer): Boolean;
  	function FindItemWithMaxVersion(
      const AItems: TcxEditRegisteredRepositoryItemsDataArray;
  		ADataType: TdxNativeInt): Integer;
...
//    property Items[Index: Integer]: PcxEditRegisteredRepositoryItemsData read GetRepositoryItem;
  public
    ...
    function GetItem(ADataType: TdxNativeInt): TcxEditRepositoryItem; virtual;
    procedure RegisterDefaultItem(AVersion: Integer; ARepositoryItem: TcxEditRepositoryItem); virtual;
    procedure RegisterItem(ADataType: TdxNativeInt; AVersion: Integer; ARepositoryItem: TcxEditRepositoryItem); virtual;
    procedure UnregisterDefaultItem(AVersion: Integer); virtual;
    procedure UnregisterItem(ADataType: TdxNativeInt; AVersion: Integer); virtual;
  end;
...
const
  dxThisUnitName = 'cxEditRegisteredRepositoryItems';
...
function TcxEditRegisteredRepositoryItems.GetItem(ADataType: TdxNativeInt): TcxEditRepositoryItem;
var
  AIndex: Integer;
begin
...
procedure TcxEditRegisteredRepositoryItems.RegisterItem(ADataType: TdxNativeInt;
  AVersion: Integer; ARepositoryItem: TcxEditRepositoryItem);
begin
...
procedure TcxEditRegisteredRepositoryItems.UnregisterItem(ADataType: TdxNativeInt; AVersion: Integer);
var
  AIndex: Integer;
begin
...
function TcxEditRegisteredRepositoryItems.Add(var AItems: TcxEditRegisteredRepositoryItemsDataArray;
  ADataType: TdxNativeInt; AVersion: Integer; ARepositoryItem: TcxEditRepositoryItem): Integer;
begin
...
function TcxEditRegisteredRepositoryItems.FindIndexForInsertion(const AItems: TcxEditRegisteredRepositoryItemsDataArray; ADataType: TdxNativeInt; AVersion: Integer; out AIndex: Integer): Boolean;
begin
	Result := Find(AItems, ADataType, AVersion, False, AIndex);
end;

function TcxEditRegisteredRepositoryItems.FindItemWithMaxVersion(const AItems: TcxEditRegisteredRepositoryItemsDataArray;
  ADataType: TdxNativeInt): Integer;
var
  AIndex: Integer;
begin
...
function TcxEditRegisteredRepositoryItems.Find(
  const AItems: TcxEditRegisteredRepositoryItemsDataArray;
  ADataType: TdxNativeInt; AVersion: Integer; AFindItemWithMaxVersion: Boolean;
