...
uses
  ...
  cxGraphics, dxCoreClasses, cxControls, dxCoreGraphics, cxGeometry, dxThreading,
  dxRichEdit.Types,
...
const
  dxThisUnitName = 'dxRichEdit.View.Draft';
...
type
  ...
  public
    ...
    function CalculatePageVisibleLogicalWidth(APageViewInfo: TdxPageViewInfo; const AViewPort: TRect): Integer; override;
...
function TdxDraftViewPageViewInfoGenerator.ProcessPage(APage: TdxPage;
  APageIndex: Integer): TdxProcessPageResult;
begin
...
function TdxDraftViewPageViewInfoGenerator.CalculatePageLogicalTotalWidth(
  APage: TdxPage): Integer;
begin
  Result := Max(inherited CalculatePageLogicalTotalWidth(APage), TdxMaxWidthCalculator.GetMaxWidth(APage));
end;

function TdxDraftViewPageViewInfoGenerator.CalculatePageVisibleLogicalWidth(
  APageViewInfo: TdxPageViewInfo; const AViewPort: TRect): Integer;
var
  AResultF: Single;
begin
  AResultF := AViewPort.Width / ScaleFactor;
...
procedure TdxDraftView.UpdateHorizontalScrollBar;
var
