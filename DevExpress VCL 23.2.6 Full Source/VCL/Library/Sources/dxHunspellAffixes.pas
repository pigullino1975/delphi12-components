...
type
  ...
  private
    FAffixManager: TdxHunspellAffixManager;
    function GetItem(Index: TdxListIndex): TdxAffixFileAttributeReader;
  public
    constructor Create(AAffixManager: TdxHunspellAffixManager);
    ...
    property Items[Index: TdxListIndex]: TdxAffixFileAttributeReader read GetItem; default;
  end;
...
const
  dxThisUnitName = 'dxHunspellAffixes';
...
function TdxAffixReaderList.GetItem(Index: TdxListIndex): TdxAffixFileAttributeReader;
begin
