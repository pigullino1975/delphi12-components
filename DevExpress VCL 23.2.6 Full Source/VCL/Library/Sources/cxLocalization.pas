...
type
  ...
  private
    function GetEncodingFromLocaleID(ALocaleID: Integer): TEncoding;
  public
...
procedure TcxLocalizer.LoadFromResource(AHandle: THandle);
var
  AStream: TStream;
begin
  ...
  try
    ...
    begin
      ...
      begin
        ...
        begin
          AEncoding := GetEncodingFromLocaleID(StrToInt(ASectionName));
          try
            AStream.Position := AStartPos;
...
begin
  ...
  try
    ...
    begin
      ...
      begin
        AEncoding := GetEncodingFromLocaleID(ALanguages[I].LocaleID);
        try
...
function TcxLocalizerStorage.GetEncodingFromLocaleID(ALocaleID: Integer): TEncoding;
var
  ACodePage: Integer;
