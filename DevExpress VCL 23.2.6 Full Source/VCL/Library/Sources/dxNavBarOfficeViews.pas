...
uses
  ...
  dxNavBarBaseViews, dxNavBarCollns, dxNavBarCustomPainters, cxGeometry;
...
uses
  CommCtrl, ImgList, Buttons, cxGraphics, dxOffice11,
  dxNavBarViewsFact, dxNavBarGraphics, dxNavBarConsts, dxCore;

const
  dxThisUnitName = 'dxNavBarOfficeViews';
...
class procedure TdxNavBarOfficeButtonPainter.InternalDrawButton(ACanvas: TCanvas; ARect: TRect; APicture: TPicture;
  AColor1, AColor2: TColor; AAlphaBlend1, AAlphaBlend2: Byte; AGradientMode: TdxBarStyleGradientMode;
