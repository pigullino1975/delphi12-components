...
unit dxRichEdit.Import.OpenXML.WordProcessingMLBaseImporter; // for internal use
...
uses
  Types, Classes, SysUtils, Graphics, Generics.Defaults, Generics.Collections, RTLConsts,
...
const
  dxThisUnitName = 'dxRichEdit.Import.OpenXML.WordProcessingMLBaseImporter';
