...
unit dxRichEdit.DocumentModel.CopyManager; // for internal use
...
type
  ...
  protected
    ...
    function CopyCellAllowed(ACell: TdxTableCell; AInfo: TdxRunInfo): Boolean;
...
const
  dxThisUnitName = 'dxRichEdit.DocumentModel.CopyManager';
...
begin
  ...
  begin
    ...
    AStartParagraph := SourcePieceTable.Paragraphs[ASection.FirstParagraphIndex];
    AEndParagraph := SourcePieceTable.Paragraphs[ASection.LastParagraphIndex];
    Result := (AStartSectionIndex = AEndSectionIndex) and
      ((AInfo.Start.RunIndex <> AStartParagraph.FirstRunIndex) or
