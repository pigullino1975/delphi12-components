...
const
  dxThisUnitName = 'dxSpreadSheetCellStyleEditDialogHelpers';
...
begin
  ...
  begin
    BordersInfo[fcdbLeft].Bounds :=  cxRectSetRight(R, R.Right, BordersInfo[fcdbLeft].Size);
    BordersInfo[fcdbRight].Bounds := cxRectSetWidth(R, BordersInfo[fcdbRight].Size);
  end;
...
procedure TdxSpreadSheetCellStyleEditDialogBordersPreview.SetBiDiMode(const Value: TBiDiMode);
begin
