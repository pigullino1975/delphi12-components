...
unit dxDbfFileInfo; // for internal use
...
type
  ...
  public
    constructor Create; virtual;
    destructor Destroy; override;
    procedure LoadFromStream(AStream: TStream; AEncoding: TEncoding = nil);
...
procedure TdxDbfFileInfo.LoadFromStream(AStream: TStream; AEncoding: TEncoding = nil);
begin
  FEncoding := AEncoding;
  LoadHeader(AStream);
  LoadRecords(AStream);
