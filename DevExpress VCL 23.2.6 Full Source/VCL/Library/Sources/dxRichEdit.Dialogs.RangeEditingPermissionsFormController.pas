...
const
  dxThisUnitName = 'dxRichEdit.Dialogs.RangeEditingPermissionsFormController';
...
function TdxRangeEditingPermissionsFormController.IsValidUserName(const AUserName: string): Boolean;
var
  ARegEx: TRegEx;
begin
...
begin
  ...
  if AUserName = '' then
    Exit;
  if IsValidUserName(AUserName) and not AvailableUsers.Contains(AUserName) then
  begin
