...
begin
  ...
  if (not IsInplace) and Focused and (not HasPopupWindow) and Painter.SupportsNativeFocusRect then
...
begin
  if IsReadOnly and (not ActiveProperties.AllowDropDownWhenReadOnly) then
    Exit;
