...
unit dxRichEdit.DocumentModel.Fields.DocVariableField; // for internal use
...
const
  dxThisUnitName = 'dxRichEdit.DocumentModel.Fields.DocVariableField';
...
begin
  ...
  if Safe.Cast(AObject, TdxNativeSubDocumentBase, ADocument) then
