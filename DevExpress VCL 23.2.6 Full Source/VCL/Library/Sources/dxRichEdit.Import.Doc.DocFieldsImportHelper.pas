...
{                                                                    }
{********************************************************************}
unit dxRichEdit.Import.Doc.DocFieldsImportHelper; // for internal use
...
const
  dxThisUnitName = 'dxRichEdit.Import.Doc.DocFieldsImportHelper';
...
begin
  {$IFDEF DX_INITIALIZATION_LOGGING}TdxUnitSectionsLogger.ConstructorStarted(UnitName, 'TdxDocFieldBeginDescriptor.Initialize', SysInit.HInstance);{$ENDIF}
  ...
  {$IFDEF DX_INITIALIZATION_LOGGING}TdxUnitSectionsLogger.ConstructorFinished(UnitName, 'TdxDocFieldBeginDescriptor.Initialize', SysInit.HInstance);{$ENDIF}
end;

class destructor TdxDocFieldBeginDescriptor.Finalize;
begin
  {$IFDEF DX_INITIALIZATION_LOGGING}TdxUnitSectionsLogger.DestructorStarted(UnitName, 'TdxDocFieldBeginDescriptor.Finalize', SysInit.HInstance);{$ENDIF}
  FEmpty.Free;
  FFieldTypes.Free;
  {$IFDEF DX_INITIALIZATION_LOGGING}TdxUnitSectionsLogger.DestructorFinished(UnitName, 'TdxDocFieldBeginDescriptor.Finalize', SysInit.HInstance);{$ENDIF}
end;
