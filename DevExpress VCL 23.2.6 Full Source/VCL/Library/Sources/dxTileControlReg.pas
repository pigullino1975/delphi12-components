...
const
  dxThisUnitName = 'dxTileControlReg';
...
type
  { TdxTileControlActionBarItemImageIndexProperty }

  TdxTileControlActionBarItemAccess = class(TdxTileControlActionBarItem);

  TdxTileControlActionBarItemImageIndexProperty = class(TImageIndexProperty)
  private
    function GetActionBarItem: TdxTileControlActionBarItem;
  protected
    property ActionBarItem: TdxTileControlActionBarItem read GetActionBarItem;
  public
...
function TdxTileControlActionBarItemImageIndexProperty.GetActionBarItem: TdxTileControlActionBarItem;
begin
  Result := GetComponent(0) as TdxTileControlActionBarItem;
end;

function TdxTileControlActionBarItemImageIndexProperty.GetImages: TCustomImageList;
begin
  Result := TdxTileControlActionBarItemAccess(ActionBarItem).GetImages;
end;
...
begin
  ...
  RegisterPropertyEditor(TypeInfo(TcxImageIndex), TdxTileControlActionBarItem, 'ImageIndex', TdxTileControlActionBarItemImageIndexProperty);
