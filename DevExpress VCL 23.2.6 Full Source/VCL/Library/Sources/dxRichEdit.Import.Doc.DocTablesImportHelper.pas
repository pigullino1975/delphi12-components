...
unit dxRichEdit.Import.Doc.DocTablesImportHelper; // for internal use
...
const
  dxThisUnitName = 'dxRichEdit.Import.Doc.DocTablesImportHelper';
...
begin
  ...
  if (ARowInfo <> nil) and (ARowInfo.RowLeftAssigned or ARowInfo.RowLeftOffsetAssigned) then
  begin
    ARowLeft := 0;
    if ARowInfo.RowLeftAssigned then
      ARowLeft := ARowInfo.RowLeft;
    if ARowInfo.RowLeftOffsetAssigned then
