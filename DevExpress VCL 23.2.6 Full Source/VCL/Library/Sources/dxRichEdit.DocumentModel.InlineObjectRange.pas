...
type
  ...
  IdxPictureContainerRun = interface // for internal use
  ...
  IdxInlineObjectRun = interface // for internal use
  ...
  TdxImageScaleCalculator = class sealed // for internal use
  public
  ...
  TdxInlineCustomObjectRun = class(TdxInlineObjectRunBase<TdxInlineCustomObjectInfo>) // for internal use
  strict private
    FOriginalSize: TSize;
  ...
  TdxCustomObjectContent = class abstract(TcxIUnknownObject) // for internal use
  strict private
    FRun: TdxTextRunBase;
  ...
  TdxPictureFloatingObjectContent = class(TdxCustomObjectContent) // for internal use
  strict private
...
const
  dxThisUnitName = 'dxRichEdit.DocumentModel.InlineObjectRange';
