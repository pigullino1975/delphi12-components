...
uses
  Classes, StrUtils, dxCore, cxGridMenuOperations, cxFindPanel;
...
type
  ...
  TcxGridShowExpressionEditor = class(TcxGridHeaderPopupMenuOperation)
  protected
    procedure Execute(Sender: TObject); override;
    function GetEnabled: Boolean; override;
    function GetImageResourceName: string; override;
...
uses
  cxLookAndFeels, cxCustomData, cxEdit, cxGridCustomTableView, cxGridTableView, cxGridPopupMenuConsts;

const
  dxThisUnitName = 'cxGridHeaderPopupMenuItems';
...
begin
  Result := IfThen(dxUseVectorIcons, ClassName, AImageName + '1');
end;
...
begin
  Result := IfThen(dxUseVectorIcons, ClassName, AImageName + '2');
end;
...
function TcxGridClearSorting.GetImageResourceName: string;
begin
  Result := IfThen(dxUseVectorIcons, ClassName, '');
end;
...
begin
  ...
  TcxGridTableViewAccess(HitGridView).DoColumnPosChanged(HitColumn);
end;
...
begin
  Result := IfThen(dxUseVectorIcons, ClassName, AImageName + '3');
end;
...
begin
  Result := IfThen(dxUseVectorIcons, ClassName, AImageName + '7');
end;
...
begin
  Result := IfThen(dxUseVectorIcons, ClassName, AImageName + '4');
end;
...
begin
  Result := IfThen(dxUseVectorIcons, ClassName, AImageName + '5');
end;
...
begin
  Result := IfThen(dxUseVectorIcons, ClassName, AImageName + '6');
end;
...
begin
  Result := IfThen(dxUseVectorIcons, ClassName, AImageName + '9');
end;
...
begin
  Result := IfThen(dxUseVectorIcons, ClassName, AImageName + '8');
end;
...
begin
  Result := IfThen(dxUseVectorIcons, ClassName, AImageName + '10');
end;
...
begin
  Result := IfThen(dxUseVectorIcons, ClassName, AImageName + '11');
end;
...
begin
  Result := IfThen(dxUseVectorIcons, ClassName, AImageName + '12');
end;
...
{ TcxGridShowExpressionEditor }

constructor TcxGridShowExpressionEditor.Create;
begin
  inherited Create;
  ResCaption := @cxSGridShowExpressionEditor;
end;

procedure TcxGridShowExpressionEditor.Execute(Sender: TObject);
begin
  HitColumn.ShowExpressionEditor;
end;

function TcxGridShowExpressionEditor.GetEnabled: Boolean;
begin
  Result := HitGridView.OptionsCustomize.ColumnExpressionEditing and HitColumn.Options.ExpressionEditing and
    TcxDataControllerAccess(HitGridView.DataController).IsItemSupportsExpression(HitColumn.Index);
end;

function TcxGridShowExpressionEditor.GetImageResourceName: string;
begin
  Result := IfThen(dxUseVectorIcons, ClassName, AImageName + '13');
end;

function TcxGridShowExpressionEditor.GetVisible: Boolean;
begin
  Result := HitGridView.OptionsCustomize.ColumnExpressionEditing;
end;
...
begin
  ...
  AddItem(TcxGridShowExpressionEditor).BeginGroup := True;
end;
