...
resourcestring
  ...
  sdxActionCreateDefinedName = 'Create Defined Name(s)';
  sdxActionChangeDefinedName = 'Change Defined Name';
  ...
  sdxActionDeleteDefinedName = 'Delete Defined Name(s)';
...
const
  dxThisUnitName = 'dxSpreadSheetStrs';
...
begin
  ...
  AProduct.Add('sdxActionChangeDefinedName', @sdxActionChangeDefinedName);
  AProduct.Add('sdxActionDeleteDefinedName', @sdxActionDeleteDefinedName);
