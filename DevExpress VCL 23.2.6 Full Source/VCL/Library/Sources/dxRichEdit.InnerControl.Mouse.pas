...
unit dxRichEdit.InnerControl.Mouse; // for internal use
...
type
  ...
  public
    ...
    property ActiveObject: TObject read FActiveObject write FActiveObject; //for internal use
...
const
  dxThisUnitName = 'dxRichEdit.InnerControl.Mouse';
...
begin
  if Safe.Cast(APieceTable.ContentType, TdxTextBoxContentType, ATextBoxPieceTable) then
  begin
...
begin
  ...
  begin
    if not Safe.Cast(AHitTestResult.Box, TdxInlinePictureBox, AInlinePictureBox) then
      Exit(False);
