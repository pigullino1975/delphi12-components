...
uses
  Classes, DB, cxCustomData, cxDataStorage, cxDBData, dxCoreClasses, cxEdit,
...
uses
  SysUtils, cxClasses, cxDBEdit, cxEditDBRegisteredRepositoryItems, RTLConsts, dxCore;

const
  dxThisUnitName = 'cxGridDBChartView';
