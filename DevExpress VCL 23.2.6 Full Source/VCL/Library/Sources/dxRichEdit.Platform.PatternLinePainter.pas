...
unit dxRichEdit.Platform.PatternLinePainter; // for internal use
...
const
  dxThisUnitName = 'dxRichEdit.Platform.PatternLinePainter';
...
begin
  {$IFDEF DX_INITIALIZATION_LOGGING}TdxUnitSectionsLogger.ConstructorStarted(UnitName, 'TdxRichEditHorizontalPatternLinePainter.Initialize', SysInit.HInstance);{$ENDIF}
  FParametersTable := TdxPatternLinePainterParametersTable.Create([doOwnsValues]);
  {$IFDEF DX_INITIALIZATION_LOGGING}TdxUnitSectionsLogger.ConstructorFinished(UnitName, 'TdxRichEditHorizontalPatternLinePainter.Initialize', SysInit.HInstance);{$ENDIF}
end;

class destructor TdxRichEditHorizontalPatternLinePainter.Finalize;
begin
  {$IFDEF DX_INITIALIZATION_LOGGING}TdxUnitSectionsLogger.DestructorStarted(UnitName, 'TdxRichEditHorizontalPatternLinePainter.Finalize', SysInit.HInstance);{$ENDIF}
  FreeAndNil(FParametersTable);
  {$IFDEF DX_INITIALIZATION_LOGGING}TdxUnitSectionsLogger.DestructorFinished(UnitName, 'TdxRichEditHorizontalPatternLinePainter.Finalize', SysInit.HInstance);{$ENDIF}
end;
...
begin
  {$IFDEF DX_INITIALIZATION_LOGGING}TdxUnitSectionsLogger.ConstructorStarted(UnitName, 'TdxRichEditVerticalPatternLinePainter.Initialize', SysInit.HInstance);{$ENDIF}
  FParametersTable := TdxPatternLinePainterParametersTable.Create([doOwnsValues]);
  {$IFDEF DX_INITIALIZATION_LOGGING}TdxUnitSectionsLogger.ConstructorFinished(UnitName, 'TdxRichEditVerticalPatternLinePainter.Initialize', SysInit.HInstance);{$ENDIF}
end;

class destructor TdxRichEditVerticalPatternLinePainter.Finalize;
begin
  {$IFDEF DX_INITIALIZATION_LOGGING}TdxUnitSectionsLogger.DestructorStarted(UnitName, 'TdxRichEditVerticalPatternLinePainter.Finalize', SysInit.HInstance);{$ENDIF}
  FreeAndNil(FParametersTable);
  {$IFDEF DX_INITIALIZATION_LOGGING}TdxUnitSectionsLogger.DestructorFinished(UnitName, 'TdxRichEditVerticalPatternLinePainter.Finalize', SysInit.HInstance);{$ENDIF}
end;
