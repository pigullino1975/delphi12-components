...
uses
  CommCtrl, DBConsts, cxLookAndFeelPainters, dxDPIAwareUtils, dxCoreGraphics;

const
  dxThisUnitName = 'dxdbtrel';
...
var
  A160B6F6A7779661C5B061407110E11127575121F29736178: TCreateParams;
  R: TRect;
begin
  CreateParams(A160B6F6A7779661C5B061407110E11127575121F29736178);
  SetRect(R, 0, 0, 0, 0);
  AdjustWindowRectEx(R, A160B6F6A7779661C5B061407110E11127575121F29736178.Style, False, A160B6F6A7779661C5B061407110E11127575121F29736178.ExStyle);
...
var
  p: TPoint;
begin
  if (VirtualTreeView.Selected <> nil) and CanSelectTreeNode(VirtualTreeView.Selected) then
  begin
    p := GetMouseCursorPos;
