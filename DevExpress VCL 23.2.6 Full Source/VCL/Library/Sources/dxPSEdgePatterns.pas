...
const
  dxThisUnitName = 'dxPSEdgePatterns';
...
begin
  FreeAndNil(FBrushes[cepoVertical]);
  FreeAndNil(FBrushes[cepoHorizontal]);
  FreeAndNil(FBitmaps[cepoVertical]);
  FreeAndNil(FBitmaps[cepoHorizontal]);
  inherited Destroy;
end;
