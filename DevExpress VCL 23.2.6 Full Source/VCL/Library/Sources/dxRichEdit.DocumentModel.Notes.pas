...
unit dxRichEdit.DocumentModel.Notes; // for internal use
...
uses
  SysUtils, Classes, Generics.Defaults, Generics.Collections, dxCore,
...
type
  ...
  private
    function GetItem(Index: TdxListIndex): TdxFootNote; inline;
  public
    property Items[Index: TdxListIndex]: TdxFootNote read GetItem; default;
  end;
  ...
  private
    function GetItem(Index: TdxListIndex): TdxEndNote; inline;
  public
    property Items[Index: TdxListIndex]: TdxEndNote read GetItem; default;
  end;

implementation

const
  dxThisUnitName = 'dxRichEdit.DocumentModel.Notes';
...
function TdxFootNoteCollection.GetItem(Index: TdxListIndex): TdxFootNote;
begin
...
function TdxEndNoteCollection.GetItem(Index: TdxListIndex): TdxEndNote;
begin
