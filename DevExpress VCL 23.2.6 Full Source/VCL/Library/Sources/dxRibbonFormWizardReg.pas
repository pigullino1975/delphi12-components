...
const
  ...
  sdxRibbonApplicationWizardComment = 'Create a Ribbon style VCL application';
  ...
  sdxRibbonFormWizardComment = 'Create a Ribbon style VCL form';
...
const
  dxThisUnitName = 'dxRibbonFormWizardReg';
