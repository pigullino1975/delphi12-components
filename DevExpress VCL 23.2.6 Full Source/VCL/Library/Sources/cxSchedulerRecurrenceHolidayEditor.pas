...
type
  ...
  TcxSchedulerRecurrenceHolidayEditorForm = class(TcxSchedulerCustomRecurrenceHolidayEditor)
    ...
    procedure deStartPropertiesValidate(Sender: TObject;
...
const
  dxThisUnitName = 'cxSchedulerRecurrenceHolidayEditor';
...
procedure TcxSchedulerRecurrenceHolidayEditorForm.deStartPropertiesValidate(
  Sender: TObject; var DisplayValue: Variant; var ErrorText: TCaption;
  var Error: Boolean);
var
  ADateTime: TDateTime;
begin
  Error := not TryStrToDate(VarToStr(DisplayValue), ADateTime);
  ErrorText := cxGetResourceString(@scxWrongPattern);
end;
    ...
    begin
      case GetRecurrenceInfoValidStatus of
        ...
        rvsReplaceOccurrenceDate:
          if (dxMessageDlg(Format(cxGetResourceString(@scxReplaceOccurrenceDate),
