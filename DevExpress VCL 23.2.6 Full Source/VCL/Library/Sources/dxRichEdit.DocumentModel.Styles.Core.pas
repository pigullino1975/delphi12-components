...
unit dxRichEdit.DocumentModel.Styles.Core; // for internal use
...
type
  ...
  TdxStyleBase = class(TdxCustomStyleObject, IdxStyle, IdxBatchUpdatable, IdxBatchUpdateHandler)
  private
    FDeleted: Boolean;
...
const
  dxThisUnitName = 'dxRichEdit.DocumentModel.Styles.Core';
