...
{$ELSEIF DEFINED(VER360)}
  {$HPPEMIT '#pragma link "dxSkiniMaginaryRS29.bpi"'}
{$ELSE}
  Unsupported
{$IFEND}
...
{$ELSEIF DEFINED(VER360)}
  {$HPPEMIT '#pragma link "dxSkiniMaginaryRS29.a"'}
{$ELSE}
  Unsupported
{$IFEND}
...
{$ELSEIF DEFINED(VER360)}
  {$HPPEMIT '#pragma link "dxSkiniMaginaryRS29.lib"'}
{$ELSE}
  Unsupported
{$IFEND}
...
const
  dxThisUnitName = 'dxSkiniMaginary';
