...
type
  ...
  IdxSpreadSheetCellStyleOwner = interface // for internal use
  ...
  public
    ...
    procedure Assign(ASource: TdxSpreadSheetBordersHandle); overload; virtual; // for internal use
    procedure Assign(AStyle: TdxSpreadSheetCellBorderStyle; AColor: TColor); overload; virtual; // for internal use
    procedure Reset;
  ...
  public
    ...
    //
    property Handle: TdxSpreadSheetCellStyleHandle read FHandle write SetHandle; // for internal use
...
const
  dxThisUnitName = 'dxSpreadSheetStyles';
...
begin
  Assign(ASource.Style, ASource.Color);
end;

procedure TdxSpreadSheetCellBorder.Assign(ASource: TdxSpreadSheetBordersHandle);
begin
  Assign(ASource.BorderStyle[FKind], ASource.BorderColor[FKind]);
end;

procedure TdxSpreadSheetCellBorder.Assign(AStyle: TdxSpreadSheetCellBorderStyle; AColor: TColor);
var
...
begin
  ...
  begin
    ...
    AHandle.BorderIsAuto[Kind] := False;
...
begin
  ...
  if dxChangeHandle(FHandle, AHandle) then
    Changed;
end;
