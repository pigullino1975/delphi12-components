...
const
  ...
  crcxLeftArrow = crBase + 27;
  crcxRightArrow = crBase + 28;
  crcxCross = crBase + 29;
  crcxTaskLink = crBase + 30;
  crcxHorzResize = crBase + 31;
  ...
  crSchedulerHorzResize = crcxHorzResize;
  crCalendarMirrorArrow = 4208;
  crTaskLink            = crcxTaskLink;
  ...
  // Preview
  crdxPreviewBase = 4500;
  crdxPreviewHorzResize = crdxPreviewBase + 1;
  crdxPreviewVertResize = crdxPreviewBase + 2;
  crdxPreviewZoomIn = crdxPreviewBase + 3;
  crdxPreviewZoomOut = crdxPreviewBase + 4;
  ...
  crdxSpreadSheetLeftArrow = crcxLeftArrow;
  crdxSpreadSheetRightArrow = crcxRightArrow;
  crdxSpreadSheetCross = crcxCross;
  ...
  crdxPDFViewerCross = crdxPDFViewerBase + 2;
    ...
    // dxGanttControl
  crdxGanttControlBase = 6200;
  crdxGanttControlTaskComplete = crdxGanttControlBase;
  crdxGanttControlTaskMove = crdxGanttControlBase + 1;
  ...
  // dxChartControl
  crdxChartControlBase = 6300;
  crdxChartControlZoomIn = crdxChartControlBase;
  crdxChartControlZoomOut = crdxChartControlBase + 1;
  crdxChartControlHand = crdxChartControlBase + 2;
  crdxChartControlDragByHand = crdxChartControlBase + 3;


implementation

const
  dxThisUnitName = 'cxLibraryConsts';
