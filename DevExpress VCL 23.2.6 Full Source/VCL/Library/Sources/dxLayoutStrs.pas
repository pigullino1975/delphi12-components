...
resourcestring
  ...
  sdxLayoutControlNewCheckBoxItemCaption = 'Check Box';
  sdxLayoutControlNewRadioButtonItemCaption = 'Radio Button';
  ...
  sdxLayoutControlCustomizeFormAddCheckBoxItem = 'Add Check Box Item';
  sdxLayoutControlCustomizeFormAddRadioButtonItem = 'Add Radio Button Item';
...
begin
  ...
  InternalAdd('sdxLayoutControlNewCheckBoxItemCaption', @sdxLayoutControlNewCheckBoxItemCaption);
  InternalAdd('sdxLayoutControlNewRadioButtonItemCaption', @sdxLayoutControlNewRadioButtonItemCaption);
  ...
  InternalAdd('sdxLayoutControlCustomizeFormAddCheckBoxItem', @sdxLayoutControlCustomizeFormAddCheckBoxItem);
  InternalAdd('sdxLayoutControlCustomizeFormAddRadioButtonItem', @sdxLayoutControlCustomizeFormAddRadioButtonItem);
