...
uses
  ...
  {$IFNDEF NONDB},FMTBcd, SqlTimSt{$ENDIF}, AnsiStrings, dxCoreClasses;
...
type
  ...
  TcxValueDefDataType = (dtEmpty, dtNull, dtValue, dtError); //for internal use only
  ...
  public
    ...
    class function IsManaged: Boolean; override;
  ...
  public
    class function CompareValues(P1, P2: Pointer): Integer; override;
    class function GetVarType: Integer; override;
    class function IsNumeric: Boolean; override;
  end;
  ...
  strict private
    ...
    function GetTextStored: Boolean; inline;
  ...
  protected
    ...
    procedure ClearValue(ABuffer: PAnsiChar);
    ...
    function GetDataType(ABuffer: PAnsiChar): TcxValueDefDataType; inline;
    ...
    function GetErrorCode(ABuffer: PAnsiChar): Integer;
    ...
    procedure SetErrorCode(ABuffer: PAnsiChar; ACode: Integer);
    procedure SetLinkObject(Value: TObject); virtual;
    procedure SetNullValue(ABuffer: PAnsiChar);
    procedure SetValueFlag(ABuffer: PAnsiChar; AValue: AnsiChar);
    function UseDataBuffer(ABuffer: PAnsiChar): Boolean;
  ...
  public
    ...
    property IsNeedConversion: Boolean read FIsNeedConversion;
  ...
  private
    ...
    function GetItem(Index: Integer): TcxValueDef; inline;
  protected
  ...
  public
    ...
    procedure ClearValue(ABuffer: PAnsiChar; AValueDef: TcxValueDef);
    ...
    procedure Read(ABuffer: PAnsiChar; AValueDef: TcxValueDef); virtual;
  end;
  ...
  TcxOnClearRecord = procedure (Sender: TObject; ARecordIndex: Integer) of object;
  ...
  private
    ...
    FOnClearRecord: TcxOnClearRecord;
  ...
  public
    ...
    procedure ClearValue(ARecordIndex: Integer; AValueDef: TcxValueDef);
    ...
    function GetErrorCode(ARecordIndex: Integer; AValueDef: TcxValueDef): Integer;
    ...
    function IsValueEmpty(ARecordIndex: Integer; AValueDef: TcxValueDef): Boolean;
    ...
    procedure SetErrorCode(ARecordIndex: Integer; AValueDef: TcxValueDef; ACode: Integer);
    ...
    property OnClearRecord: TcxOnClearRecord read FOnClearRecord write FOnClearRecord;
  end;

  TcxValueTypeHelper = class //for internal use only
  public
    class function Compare(AValueTypeClass: TcxValueTypeClass; P1, P2: Pointer): Integer; static; inline;
    class procedure FreeBuffer(AValueTypeClass: TcxValueTypeClass; ABuffer: PAnsiChar); static; inline;
    class procedure FreeTextBuffer(AValueTypeClass: TcxValueTypeClass; ABuffer: PAnsiChar); static; inline;
    class function GetDataSize(AValueTypeClass: TcxValueTypeClass): Integer; static; inline;
    class function GetDataValue(AValueTypeClass: TcxValueTypeClass; ABuffer: PAnsiChar): Variant; static; inline;
    class function GetDefaultDisplayText(AValueTypeClass: TcxValueTypeClass; ABuffer: PAnsiChar): string; static; inline;
    class function GetDisplayText(AValueTypeClass: TcxValueTypeClass; ABuffer: PAnsiChar): string; static; inline;
    class procedure ReadDataValue(AValueTypeClass: TcxValueTypeClass; ABuffer: PAnsiChar; AStream: TdxStream); static; inline;
    class procedure ReadDisplayText(AValueTypeClass: TcxValueTypeClass; ABuffer: PAnsiChar; AStream: TdxStream); static; inline;
    class procedure SetDataValue(AValueTypeClass: TcxValueTypeClass; ABuffer: PAnsiChar; const AValue: Variant); static; inline;
    class procedure SetDisplayText(AValueTypeClass: TcxValueTypeClass; ABuffer: PAnsiChar; const ADisplayText: string); static; inline;
    class procedure WriteDataValue(AValueTypeClass: TcxValueTypeClass; ABuffer: PAnsiChar; AStream: TdxStream); static; inline;
    class procedure WriteDisplayText(AValueTypeClass: TcxValueTypeClass; ABuffer: PAnsiChar; AStream: TdxStream); static; inline;
  end;
  ...
  public
    ...
    class procedure ClearValue(ARecord: Pointer; AValueDef: TcxValueDef);
    ...
    class function GetErrorCode(AValueDef: TcxValueDef; ARecord: Pointer): Variant;
    ...
    class function IsValueEmpty(AValueDef: TcxValueDef; ARecord: Pointer): Boolean;
    ...
    class procedure SetErrorCode(ARecord: Pointer; AValueDef: TcxValueDef; ACode: Variant);
...
class function TcxValueType.IsManaged: Boolean;
begin
  Result := False;
end;

class function TcxValueType.IsNumeric: Boolean;
begin
  Result := False;
end;
...
class function TcxStringValueType.IsManaged: Boolean;
begin
  Result := True;
end;
...
class function TcxSmallintValueType.IsNumeric: Boolean;
begin
  Result := True;
end;
...
class function TcxIntegerValueType.IsNumeric: Boolean;
begin
  Result := True;
end;
...
class function TcxWordValueType.IsNumeric: Boolean;
begin
  Result := True;
end;
...
begin
  ...
  class function TcxSingleValueType.IsNumeric: Boolean;
begin
  Result := True;
end;
...
class function TcxFloatValueType.IsNumeric: Boolean;
begin
  Result := True;
end;
...
class function TcxCurrencyValueType.IsNumeric: Boolean;
begin
  Result := True;
end;
...
class function TcxDateTimeValueType.IsNumeric: Boolean;
begin
  Result := True;
end;
...
class function TcxLargeIntValueType.IsNumeric: Boolean;
begin
  Result := True;
end;
...
class function TcxFMTBcdValueType.IsNumeric: Boolean;
begin
  Result := True;
end;
...
class function TcxSQLTimeStampValueType.IsNumeric: Boolean;
begin
  Result := True;
end;
...
class function TcxVariantValueType.IsManaged: Boolean;
begin
  Result := True;
end;
...
class function TcxBLOBValueType.IsManaged: Boolean;
begin
  Result := True;
end;
...
class function TcxObjectValueType.IsManaged: Boolean;
begin
  Result := True;
end;
...
procedure TcxValueDef.ClearValue(ABuffer: PAnsiChar);
begin
  SetValueFlag(ABuffer, ValueFlag_Empty);
end;
...
function TcxValueDef.GetDataType(ABuffer: PAnsiChar): TcxValueDefDataType;
begin
  Result := TcxValueDefDataType((ABuffer + Offset)^);
end;

function TcxValueDef.GetDataValue(ABuffer: PAnsiChar): Variant;
begin
  if GetDataType(ABuffer) = dtValue then
...
function TcxValueDef.GetErrorCode(ABuffer: PAnsiChar): Integer;
begin
  if GetDataType(ABuffer) = dtError then
    Result := ValueTypeClass.GetDataValue(GetDataFromBuffer(ABuffer))
  else
    Result := 0;
end;
...
begin
  Result := (ABuffer = nil) or (GetDataType(ABuffer) in [dtEmpty, dtNull, dtError]);
end;
...
begin
  if ReadNullFlag then
    SetNullValue(ABuffer)
  else
  begin
    SetValueFlag(ABuffer, ValueFlag_Value);
...
procedure TcxValueDef.SetErrorCode(ABuffer: PAnsiChar; ACode: Integer);
begin
  SetValueFlag(ABuffer, ValueFlag_Error);
  ValueTypeClass.SetDataValue(GetDataFromBuffer(ABuffer), ACode);
end;
...
procedure TcxValueDef.SetNullValue(ABuffer: PAnsiChar);
begin
  SetValueFlag(ABuffer, ValueFlag_Null);
end;

procedure TcxValueDef.SetValueFlag(ABuffer: PAnsiChar; AValue: AnsiChar);
var
  AUseDataBuffer: Boolean;
begin
  AUseDataBuffer := UseDataBuffer(ABuffer);
  (ABuffer + Offset)^ := AValue;
  if AUseDataBuffer and not UseDataBuffer(ABuffer) then
  begin
    Inc(ABuffer, Offset + ValueFlagSize);
    ValueTypeClass.FreeBuffer(ABuffer);
    FillChar(ABuffer^, DataSize, 0);
  end;
end;

function TcxValueDef.UseDataBuffer(ABuffer: PAnsiChar): Boolean;
begin
  Result := GetDataType(ABuffer) in [dtValue, dtError];
end;
...
begin
  if DataStorage.FValueDefsList <> nil then
    Result := TcxValueDef(DataStorage.FValueDefsList.Items[Index])
  else
    Result := TcxValueDef(FItems.List[Index]);
end;
...
procedure TcxValueDefReader.ClearValue(ABuffer: PAnsiChar; AValueDef: TcxValueDef);
begin
  AValueDef.ClearValue(ABuffer);
end;
...
procedure TcxValueDefReader.Read(ABuffer: PAnsiChar; AValueDef: TcxValueDef);
begin
  if IsInternal(AValueDef) then
    Exit;
  AValueDef.SetDataValue(ABuffer, GetValue(AValueDef));
  if AValueDef.TextStored then
    AValueDef.SetDisplayText(ABuffer, GetDisplayText(AValueDef));
end;
...
begin
  ...
  begin
    if Assigned(FOnClearRecord) then
      FOnClearRecord(Self, I);
    FreeAndNilRecordBuffer(I);
  end;
  if AClearList then
...
procedure TcxDataStorage.ClearValue(ARecordIndex: Integer; AValueDef: TcxValueDef);
var
  ABuffer: PAnsiChar;
begin
  ABuffer := AllocRecordBuffer(ARecordIndex);
  if CheckValueDef(ARecordIndex, AValueDef) then
    AValueDef.ClearValue(ABuffer);
end;

function TcxDataStorage.CompareRecords(ARecordIndex1, ARecordIndex2: Integer; AValueDef: TcxValueDef): Integer;
var
  P1, P2: PAnsiChar;
begin
...
begin
  P := RecordBuffers[ARecordIndex];
  Result := AValueDef.GetDataType(P) <> dtValue;
  if not Result then
  begin
...
function TcxDataStorage.GetErrorCode(ARecordIndex: Integer; AValueDef: TcxValueDef): Integer;
var
  P: PAnsiChar;
begin
  Result := 0;
  P := RecordBuffers[ARecordIndex];
  if (P <> nil) and CheckValueDef(ARecordIndex, AValueDef) then
    Result := AValueDef.GetErrorCode(P);
end;
...
function TcxDataStorage.IsValueEmpty(ARecordIndex: Integer; AValueDef: TcxValueDef): Boolean;
var
  ABuffer: PAnsiChar;
begin
  ABuffer := RecordBuffers[ARecordIndex];
  Result := (ABuffer = nil) or not CheckValueDef(ARecordIndex, AValueDef) or (AValueDef.GetDataType(ABuffer) = dtEmpty);
end;
...
begin
  ...
  for I := 0 to AValueDefs.Count - 1 do
    if AFields.IndexOf(AValueDefs[I].LinkObject) > -1 then
      AValueDefReader.Read(P, AValueDefs[I]);
end;
...
begin
  ...
  for I := 0 to AValueDefs.Count - 1 do
    if not AValueDefReader.IsInternal(ValueDefs[I]) then
...
procedure TcxDataStorage.SetErrorCode(ARecordIndex: Integer; AValueDef: TcxValueDef; ACode: Integer);
var
  P: PAnsiChar;
begin
  P := AllocRecordBuffer(ARecordIndex);
  if CheckValueDef(ARecordIndex, AValueDef) then
    AValueDef.SetErrorCode(P, ACode);
end;
...
class function TcxValueTypeHelper.Compare(AValueTypeClass: TcxValueTypeClass; P1, P2: Pointer): Integer;
begin
  Result := AValueTypeClass.Compare(P1, P2);
end;

class procedure TcxValueTypeHelper.FreeBuffer(AValueTypeClass: TcxValueTypeClass; ABuffer: PAnsiChar);
begin
  AValueTypeClass.FreeBuffer(ABuffer)
end;

class procedure TcxValueTypeHelper.FreeTextBuffer(AValueTypeClass: TcxValueTypeClass; ABuffer: PAnsiChar);
begin
  AValueTypeClass.FreeTextBuffer(ABuffer)
end;

class function TcxValueTypeHelper.GetDataSize(AValueTypeClass: TcxValueTypeClass): Integer;
begin
  Result := AValueTypeClass.GetDataSize;
end;

class function TcxValueTypeHelper.GetDataValue(AValueTypeClass: TcxValueTypeClass; ABuffer: PAnsiChar): Variant;
begin
  Result := AValueTypeClass.GetDataValue(ABuffer);
end;

class function TcxValueTypeHelper.GetDefaultDisplayText(AValueTypeClass: TcxValueTypeClass; ABuffer: PAnsiChar): string;
begin
  Result := AValueTypeClass.GetDefaultDisplayText(ABuffer);
end;

class function TcxValueTypeHelper.GetDisplayText(AValueTypeClass: TcxValueTypeClass; ABuffer: PAnsiChar): string;
begin
  Result := AValueTypeClass.GetDisplayText(ABuffer);
end;

class procedure TcxValueTypeHelper.ReadDataValue(AValueTypeClass: TcxValueTypeClass; ABuffer: PAnsiChar; AStream: TdxStream);
begin
  AValueTypeClass.ReadDataValue(ABuffer, AStream);
end;

class procedure TcxValueTypeHelper.ReadDisplayText(AValueTypeClass: TcxValueTypeClass; ABuffer: PAnsiChar; AStream: TdxStream);
begin
  AValueTypeClass.ReadDisplayText(ABuffer, AStream);
end;

class procedure TcxValueTypeHelper.SetDataValue(AValueTypeClass: TcxValueTypeClass; ABuffer: PAnsiChar; const AValue: Variant);
begin
  AValueTypeClass.SetDataValue(ABuffer, AValue);
end;

class procedure TcxValueTypeHelper.SetDisplayText(AValueTypeClass: TcxValueTypeClass; ABuffer: PAnsiChar; const ADisplayText: string);
begin
  AValueTypeClass.SetDisplayText(ABuffer, ADisplayText);
end;

class procedure TcxValueTypeHelper.WriteDataValue(AValueTypeClass: TcxValueTypeClass; ABuffer: PAnsiChar; AStream: TdxStream);
begin
  AValueTypeClass.WriteDataValue(ABuffer, AStream);
end;

class procedure TcxValueTypeHelper.WriteDisplayText(AValueTypeClass: TcxValueTypeClass; ABuffer: PAnsiChar; AStream: TdxStream);
begin
  AValueTypeClass.WriteDisplayText(ABuffer, AStream);
end;
...
class procedure TcxDataStorageHelper.ClearValue(ARecord: Pointer; AValueDef: TcxValueDef);
begin
  if AValueDef <> nil then 
    AValueDef.ClearValue(ARecord);
end;
...
class function TcxDataStorageHelper.GetErrorCode(AValueDef: TcxValueDef; ARecord: Pointer): Variant;
begin
  if AValueDef <> nil then 
    Result := AValueDef.GetErrorCode(ARecord)
  else
    Result := 0; 
end;
...
begin
  if (ARecord <> nil) and (AValueDef <> nil) then
    Result := AValueDef.GetDataValue(ARecord)
  else
    Result := Null;
end;

class function TcxDataStorageHelper.IsValueEmpty(AValueDef: TcxValueDef; ARecord: Pointer): Boolean;
begin
  if AValueDef <> nil then 
    Result := AValueDef.GetDataType(ARecord) = dtEmpty
  else
    Result := True; 
end;
...
class procedure TcxDataStorageHelper.SetErrorCode(ARecord: Pointer; AValueDef: TcxValueDef; ACode: Variant);
begin
  if AValueDef <> nil then 
    AValueDef.SetErrorCode(ARecord, ACode);
end;
...
begin
  if (AValueDef <> nil) and (AValueDef.FTextStored <> ATextStored) then
  begin
...
begin
  Result := nil;
  for I := 0 to FItems.Count - 1 do
    if SameText(TcxValueTypeClass(FItems[I]).Caption, ACaption) then
    begin
