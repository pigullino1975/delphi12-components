...
type
  TdxInlineObjectChangeType = ( 
    ...
    ScaleY,
    BatchUpdate,
    Sizing); // for internal use

  TdxInlineCustomObjectChangeType = ( 
    None,
    State,
    BatchUpdate); // for internal use

  { IdxInlineCustomObject }

  IdxInlineCustomObject = interface // for internal use
  ...
  TdxInlineObjectChangeActionsCalculator = class sealed // for internal use
  public
  ...
  TdxInlineCustomObjectInfo = class(TdxInlineObjectInfo) // for internal use
  private
    FState: TArray<Byte>;
  public
    function Equals(Obj: TObject): Boolean; override;
  ...
  TdxInlineObjectProperties<T: TdxInlineObjectInfo> = class abstract(TdxRichEditIndexBasedObject<T>) // for internal use
  private
  ...
  TdxInlineCustomObjectProperties = class(TdxInlineObjectProperties<TdxInlineCustomObjectInfo>) // for internal use
  protected
  ...
  TdxInlineCustomObjectInfoCache = class(TdxUniqueItemsCache<TdxInlineCustomObjectInfo>) // for internal use
  protected
  ...
  IdxInlinePicturePropertiesContainer = interface // for internal use
  ...
  TdxInlinePictureProperties = class(TdxInlineObjectProperties<TdxInlinePictureInfo>) // for internal use
  strict private
  ...
  TdxInlinePictureInfoCache = class(TdxUniqueItemsCache<TdxInlinePictureInfo>) // for internal use
  protected
...
const
  dxThisUnitName = 'dxRichEdit.DocumentModel.InlineObjectFormatting';

type

  { TdxInlinePictureChangeActionsCalculator }

  TdxInlinePictureChangeActionsCalculator = class sealed
  public
  ...
  TdxInlineCustomObjectChangeActionsCalculator = class sealed
  public
