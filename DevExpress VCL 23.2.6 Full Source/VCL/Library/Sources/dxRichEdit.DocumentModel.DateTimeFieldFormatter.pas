...
unit dxRichEdit.DocumentModel.DateTimeFieldFormatter; // for internal use
...
const
  dxThisUnitName = 'dxRichEdit.DocumentModel.DateTimeFieldFormatter';
...
begin
  {$IFDEF DX_INITIALIZATION_LOGGING}TdxUnitSectionsLogger.ConstructorStarted(UnitName, 'TdxNumericFormattingItem.Initialize', SysInit.HInstance);{$ENDIF}
  FPatternsLength := TArray<Integer>.Create(1, 2);
  {$IFDEF DX_INITIALIZATION_LOGGING}TdxUnitSectionsLogger.ConstructorFinished(UnitName, 'TdxNumericFormattingItem.Initialize', SysInit.HInstance);{$ENDIF}
end;
...
begin
  {$IFDEF DX_INITIALIZATION_LOGGING}TdxUnitSectionsLogger.ConstructorStarted(UnitName, 'TdxCombinedFormattingItem.Initialize', SysInit.HInstance);{$ENDIF}
  FPatternsLength := TArray<Integer>.Create(1, 2, 3, 4);
  {$IFDEF DX_INITIALIZATION_LOGGING}TdxUnitSectionsLogger.ConstructorFinished(UnitName, 'TdxCombinedFormattingItem.Initialize', SysInit.HInstance);{$ENDIF}
end;
...
begin
  {$IFDEF DX_INITIALIZATION_LOGGING}TdxUnitSectionsLogger.ConstructorStarted(UnitName, 'TdxYearFormattingItem.Initialize', SysInit.HInstance);{$ENDIF}
  FPatternsLength := TArray<Integer>.Create(2, 4);
  {$IFDEF DX_INITIALIZATION_LOGGING}TdxUnitSectionsLogger.ConstructorFinished(UnitName, 'TdxYearFormattingItem.Initialize', SysInit.HInstance);{$ENDIF}
end;
