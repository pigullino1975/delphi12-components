...
type
  ...
  protected
    ...
    function GetTreeSize: TSize; override;
...
function TfrmOrgChartAdvEditor.GetTreeSize: TSize;
begin
  Result := TSize.Create(Tree.Width, Tree.Height);
end;
