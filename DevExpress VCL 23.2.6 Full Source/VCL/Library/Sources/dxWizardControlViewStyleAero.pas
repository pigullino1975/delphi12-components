...
uses
  cxGeometry, Math, dxGDIPlusClasses, cxDWMApi, SysUtils, dxCoreGraphics, dxUxTheme, dxDPIAwareUtils;

const
  dxThisUnitName = 'dxWizardControlViewStyleAero';
...
begin
  ...
  begin
    ...
    FTextRect := cxRectSetWidth(R, cxMeasureCanvas.TextWidth(Title.Text) +
...
begin
  Result := Max(TdxTextMeasurer.TextLineHeight(Font), BackButtonViewInfo.MeasureHeight);
