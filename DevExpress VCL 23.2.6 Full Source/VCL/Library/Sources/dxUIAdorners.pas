...
begin
  ...
  try
    ...
    try
      TdxImageDrawer.DrawImage(ABitmap.cxCanvas, ABitmap.ClientRect, ViewInfo.Glyph, ViewInfo.Images, ViewInfo.ImageIndex,
...
begin
  ...
  begin
    ...
    CalloutPopup.Popup(Guides.LayeredWindow.OwnerControl, AForGuide.ViewInfo.Bounds);
  end;
end;
...
begin
  if AMessage.Msg = DXM_SCALECHANGED then
    UpdateBadges;
...
initialization
  ...
  dxUnitsLoader.AddUnit(SysInit.HInstance, dxThisUnitName, UnitRegister, UnitUnregister);

finalization

  dxUnitsLoader.RemoveUnit(SysInit.HInstance, dxThisUnitName, UnitUnregister);
