inherited dxfmCustomContainerDesignWindow: TdxfmCustomContainerDesignWindow
  ...
  inherited lcMain: TdxLayoutControl
    ...
    object tvControls: TdxTreeViewControl [39]
      Left = 10000
      Top = 10000
      Width = 735
      Height = 282
      ...
      TabOrder = 31
      Visible = False
      OnCustomDrawNode = tvControlsCustomDrawNode
      OnEditing = TreeViewControlsEditing
      OnMouseUp = TreeViewMouseUp
      OnNodeStateChanged = TreeViewNodeStateChanged
    end
    ...
    object tvHiddenControls: TdxTreeViewControl [42]
      Left = 10000
      Top = 10000
      Width = 735
      Height = 263
