...
{$IF DEFINED(VER210)}
  {$HPPEMIT '#pragma link "dxSkinMetropolisRS14.bpi"'}
{$ELSEIF DEFINED(VER220)}
  {$HPPEMIT '#pragma link "dxSkinMetropolisRS15.bpi"'}
{$ELSEIF DEFINED(VER230)}
  {$HPPEMIT '#pragma link "dxSkinMetropolisRS16.bpi"'}
{$ELSEIF DEFINED(VER240)}
  {$HPPEMIT '#pragma link "dxSkinMetropolisRS17.bpi"'}
{$ELSEIF DEFINED(VER250)}
  {$HPPEMIT '#pragma link "dxSkinMetropolisRS18.bpi"'}
{$ELSEIF DEFINED(VER260)}
  {$HPPEMIT '#pragma link "dxSkinMetropolisRS19.bpi"'}
{$ELSEIF DEFINED(VER270)}
  {$HPPEMIT '#pragma link "dxSkinMetropolisRS20.bpi"'}
{$ELSEIF DEFINED(VER280)}
  {$HPPEMIT '#pragma link "dxSkinMetropolisRS21.bpi"'}
{$ELSEIF DEFINED(VER290)}
  {$HPPEMIT '#pragma link "dxSkinMetropolisRS22.bpi"'}
{$ELSEIF DEFINED(VER300)}
  {$HPPEMIT '#pragma link "dxSkinMetropolisRS23.bpi"'}
{$ELSEIF DEFINED(VER310)}
  {$HPPEMIT '#pragma link "dxSkinMetropolisRS24.bpi"'}
{$ELSEIF DEFINED(VER320)}
  {$HPPEMIT '#pragma link "dxSkinMetropolisRS25.bpi"'}
{$ELSEIF DEFINED(VER330)}
  {$HPPEMIT '#pragma link "dxSkinMetropolisRS26.bpi"'}
{$ELSEIF DEFINED(VER340)}
  {$HPPEMIT '#pragma link "dxSkinMetropolisRS27.bpi"'}
{$ELSEIF DEFINED(VER350)}
  {$HPPEMIT '#pragma link "dxSkinMetropolisRS28.bpi"'}
{$ELSEIF DEFINED(VER360)}
  {$HPPEMIT '#pragma link "dxSkinMetropolisRS29.bpi"'}
{$ELSE}
  Unsupported
{$IFEND}
...
{$ELSEIF DEFINED(VER360)}
  {$HPPEMIT '#pragma link "dxSkinMetropolisRS29.a"'}
{$ELSE}
  Unsupported
{$IFEND}
...
{$ELSEIF DEFINED(VER360)}
  {$HPPEMIT '#pragma link "dxSkinMetropolisRS29.lib"'}
{$ELSE}
  Unsupported
{$IFEND}
...
const
  dxThisUnitName = 'dxSkinMetropolis';
