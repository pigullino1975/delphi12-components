...
{$ELSEIF DEFINED(VER360)}
  {$HPPEMIT '#pragma link "dxSkinOffice2019WhiteRS29.bpi"'}
{$ELSE}
  Unsupported
{$IFEND}
...
{$ELSEIF DEFINED(VER360)}
  {$HPPEMIT '#pragma link "dxSkinOffice2019WhiteRS29.a"'}
{$ELSE}
  Unsupported
{$IFEND}
...
{$ELSEIF DEFINED(VER360)}
  {$HPPEMIT '#pragma link "dxSkinOffice2019WhiteRS29.lib"'}
{$ELSE}
  Unsupported
{$IFEND}
...
type
  ...
  TdxSkinOffice2019WhitePainter = class(TdxSkinLookAndFeelPainter)
  public
...
const
  dxThisUnitName = 'dxSkinOffice2019White';
