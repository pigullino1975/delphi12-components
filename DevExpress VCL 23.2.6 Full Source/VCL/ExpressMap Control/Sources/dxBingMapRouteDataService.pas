...
type
  ...
  public
    ...
    procedure Parse(ANode: TdxXmlNode); // for internal use
  ...
  public
    ...
    function AsString: string; virtual; // for internal use
  ...
  public
    constructor Create;
    destructor Destroy; override;
    function Add(const AGeoPoint: TdxMapControlGeoPoint; // for internal use
      APointType: TdxBingMapRouteWaypointType = bmwtWayPoint): TdxBingMapRouteWaypoint; overload; // for internal use
    function Add(const ALandmark: string;
      APointType: TdxBingMapRouteWaypointType = bmwtWayPoint): TdxBingMapRouteWaypoint; overload; // for internal use
    procedure Clear; // for internal use
  ...
  TdxBingMapRESTServiceCustomRouteParams = class(TdxBingMapRESTServiceParams) // for internal use
  private
  ...
  TdxBingMapRESTServiceRouteParams = class(TdxBingMapRESTServiceCustomRouteParams) // for internal use
  private
    FDateTime: TDateTime;
  ...
  TdxBingMapRESTServiceRoutesFromMajorRoadsParams = class(TdxBingMapRESTServiceCustomRouteParams) // for internal use
  private
    FDestination: string;
  ...
  TdxBingMapCustomRouteDataService = class(TdxBingMapRESTService) // for internal use
  protected
    function CreateResponse: TdxRestServiceResponse; override;
  end;

  TdxBingMapRouteDataService = class(TdxBingMapCustomRouteDataService) // for internal use
  protected
    function CreateParams: TdxBingMapRESTServiceParams; override;
    function GetAddress: string; override;
  end;

  TdxBingMapRoutesFromMajorRoadsDataService = class(TdxBingMapCustomRouteDataService) // for internal use
  protected
    function CreateParams: TdxBingMapRESTServiceParams; override;
    function GetAddress: string; override;
  end;
...
const
  dxThisUnitName = 'dxBingMapRouteDataService';
...
function TdxBingMapRouteDataService.GetAddress: string;
begin
  Result := dxBingRouteServiceBaseAddress + '/';
end;
...
function TdxBingMapRoutesFromMajorRoadsDataService.GetAddress: string;
begin
  Result := dxBingRoutesFromMajorRoadsBaseAddress;
end;
