...
unit dxMapUnitConverter; // for internal use
...
function dxMapGeoPointNormalize(const APoint: TdxMapControlGeoPoint): TdxMapControlGeoPoint; inline;
function dxMapPointNormalize(const APoint: TdxPointDouble): TdxPointDouble; inline;

implementation

const
  dxThisUnitName = 'dxMapUnitConverter';

function NormalizeRadian(AAngleRadian: Double): Double; inline;
begin
  Result := ArcTan2(Sin(AAngleRadian), Cos(AAngleRadian));
end;

function NormalizeDegree(AAngleDegree: Double): Double; inline;
begin
