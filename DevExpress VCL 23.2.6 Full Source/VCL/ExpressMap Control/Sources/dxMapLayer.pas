...
type
  ...
  TdxMapLayerViewInfo = class(TdxMapControlElementViewInfo) // for internal use
  private
    FLayer: TdxMapLayer;
  protected
  ...
  public
    ...
    procedure Invalidate; // for internal use
    procedure InvalidateRect(const R: TRect); // for internal use
    function IsActuallyVisible: Boolean; virtual;
    function Move(ACenterPoint: TdxMapControlGeoPoint; AOffset: TPoint): TdxMapControlGeoPoint; virtual; // for internal use
    function MoveAndZoom(ACenterPoint: TdxMapControlGeoPoint; AAnchorPoint: TdxPointDouble;
      ACurrentZoomLevel, ANewZoomLevel: Double): TdxMapControlGeoPoint; virtual; // for internal use
    procedure UpdateViewport; virtual; // for internal use

    function GetKilometersScale(const ACenterPoint: TdxMapControlGeoPoint; AScreenDistance: Double): Double; // for internal use
    ...
    function GeoToKilometersSize(const AAnchorPoint: TdxMapControlGeoPoint; const ASize: TdxSizeDouble): TdxSizeDouble; // for internal use
    function KilometersToGeoSize(const AAnchorPoint: TdxMapControlGeoPoint; const ASize: TdxSizeDouble): TdxSizeDouble; // for internal use
    ...
    property CenterPoint: TdxMapControlGeoPoint read GetCenterPoint; // for internal use
    property RenderScale: TdxPointDouble read FRenderScale; // for internal use
    property RenderOffset: TdxPointDouble read FRenderOffset; // for internal use
    property ViewInfo: TdxMapLayerViewInfo read FViewInfo; // for internal use
    property ViewPort: TdxRectDouble read FViewPort write SetViewPort; // for internal use
    property ViewportInPixels: TSize read GetViewportInPixels; // for internal use
    property ZoomLevel: Double read GetZoomLevel; // for internal use
  published
    property Visible: Boolean read FVisible write SetVisible default True;
  end;
  TdxMapLayerClass = class of TdxMapLayer;

  TdxMapLayersViewInfo = class(TdxMapControlElementViewInfo) // for internal use
  private
