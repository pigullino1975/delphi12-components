...
type
  ...
  public
    ...
    function GetMapSizeInPixels(AZoomLevel: Double): TdxSizeDouble; virtual; abstract; // for internal use
    procedure PrepareData; virtual; // for internal use
    procedure StartLoadTiles; // for internal use
    ...
    property Projection: TdxMapControlCustomProjection read FProjection write SetProjection; // for internal use
    property TileSource: TdxMapControlMultiScaleTileSource read FTileSource; // for internal use
  ...
  function dxMapControlImageryDataProviders: TcxRegisteredClasses; // for internal use

implementation

uses
  dxMapImageTileLayer, dxCore;

const
  dxThisUnitName = 'dxMapControlImageTileProvider';
