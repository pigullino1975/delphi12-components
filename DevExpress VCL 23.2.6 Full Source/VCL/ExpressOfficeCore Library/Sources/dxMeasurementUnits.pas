...
function PointsToInchesF(const AValue: Single): Single; inline;
function PointsToCentimetersF(const AValue: Single): Single; inline;
function PointsToMillimetersF(const AValue: Single): Single; inline;
...
function CentimetersToInchesF(const AValue: Single): Single; inline;
function CentimetersToPointsF(const AValue: Single): Single; inline;
...
function InchesToCentimetersF(const AValue: Single): Single; inline;
...
const
  dxThisUnitName = 'dxMeasurementUnits';
...
function PointsToInchesF(const AValue: Single): Single;
begin
  Result := AValue / 72;
end;

function PointsToCentimetersF(const AValue: Single): Single;
begin
  Result := MulDivF(AValue, 2.54, 72);
end;

function PointsToMillimetersF(const AValue: Single): Single;
begin
  Result := MulDivF(AValue, 25.4, 72);
end;
...
function CentimetersToInchesF(const AValue: Single): Single;
begin
  Result := AValue * 2.54;
end;

function CentimetersToPointsF(const AValue: Single): Single;
begin
  Result := MulDivF(AValue, 72, 2.54);
end;
