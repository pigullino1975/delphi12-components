...
unit dxRichEdit.DocumentModel.VisibleTextFilter.Core; // for internal use
...
const
  dxThisUnitName = 'dxRichEdit.DocumentModel.VisibleTextFilter.Core';
...
var
  AMaxRunIndex: TdxRunIndex;
begin
  AMaxRunIndex := PieceTable.Runs.Count - 1;
...
var
  ARun: TdxTextRunBase;
  AParagraphRun: TdxParagraphRun absolute ARun;
  ACell: TdxCustomTableCell;
