...
unit dxRichEdit.DocumentModel.DocumentsToLayoutPixelsConverter; // for internal use
...
const
  dxThisUnitName = 'dxRichEdit.DocumentModel.DocumentsToLayoutPixelsConverter';
