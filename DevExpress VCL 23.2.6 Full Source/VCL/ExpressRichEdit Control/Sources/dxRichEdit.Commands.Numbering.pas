...
type
  ...
  protected
    ...
    function LookupBoxCore(ABoxes: TdxBoxListBase; const AComparer: TdxBoxComparableFunc): TdxBoxBase; virtual;
    function LookupBoxIndexCore(ABoxes: TdxBoxListBase; const AComparer: TdxBoxComparableFunc): Integer; virtual;
  ...
  protected
    type
      TModifyParagraphIntervalsProc = procedure (AParagraphIntervals: TdxParagraphIntervalList) of object;
    procedure ModifyModel; override;
    procedure ModifySelection(AModifyIntervalsProc: TModifyParagraphIntervalsProc); virtual;
  ...
  protected
    ...
    procedure DeleteOldNumbering; virtual;
    procedure DeleteParagraphsNumbering(AParagraphIntervals: TdxParagraphIntervalList); virtual;
    procedure DeleteParagraphsNumberingCore(AStartParagraphIndex, AEndParagraphIndex: TdxParagraphIndex); virtual;
  ...
  protected
    ...
    function CalculateLeftIndentDelta(ATargetNumerationOrBulletPosition, ACurrentLeftIndent, AFirstLineIndent: Integer;
      AFirstLineIndentType: TdxParagraphFirstLineIndent): Integer; virtual;
...
uses
  RTLConsts, Contnrs, Math, dxCore, dxCoreClasses,
...
const
  dxThisUnitName = 'dxRichEdit.Commands.Numbering';

type

  { TdxPageRunComparer }

  TdxPageRunComparer = record
  private
    FIndex: TdxRunIndex;
  ...
  public
    ...
    function CompareTo(const Page: TdxBoxBase): Integer;
  end;

  { TdxColumnRunComparer }

  TdxColumnRunComparer = record
  private
    FIndex: TdxRunIndex;
    function IsRunBeforeColumn(AColumn: TdxColumn): Boolean; inline;
    function IsRunAfterColumn(AColumn: TdxColumn): Boolean; inline;
  public
    constructor Create(AIndex: TdxRunIndex);
    function CompareTo(const Column: TdxBoxBase): Integer;
  end;

  { TdxPageAreaRunComparer }

  TdxPageAreaRunComparer = record
  private
    FIndex: TdxRunIndex;
    function IsRunBeforePageArea(APageArea: TdxPageArea): Boolean; inline;
    function IsRunAfterPageArea(APageArea: TdxPageArea): Boolean; inline;
  public
    constructor Create(AIndex: TdxRunIndex);
    function CompareTo(const PageArea: TdxBoxBase): Integer;
  end;

  { TdxRowRunComparer }

  TdxRowRunComparer = record
  private
    FIndex: TdxRunIndex;
    function IsRunBeforeRow(ARow: TdxRow): Boolean; inline;
    function IsRunAfterRow(ARow: TdxRow): Boolean; inline;
  public
    constructor Create(AIndex: TdxRunIndex);
    function CompareTo(const Row: TdxBoxBase): Integer;
  end;

  { TdxBoxRunComparer }

  TdxBoxRunComparer = record
  private
    FIndex: TdxRunIndex;
  ...
  public
    ...
    function CompareTo(const ABox: TdxBoxBase): Integer;
  end;
...
function TdxParagraphLayoutPosition.LookupBoxCore(ABoxes: TdxBoxListBase; const AComparer: TdxBoxComparableFunc): TdxBoxBase;
var
  ABoxIndex: Integer;
begin
...
begin
  ...
  Result := LookupBoxIndexCore(ABoxes, AComparer.CompareTo);
end;

function TdxParagraphLayoutPosition.LookupBoxIndexCore(ABoxes: TdxBoxListBase; const AComparer: TdxBoxComparableFunc): Integer;
begin
...
begin
  ...
  Result := TdxColumn(LookupBoxCore(AColumns, AComparer.CompareTo));
end;
...
begin
  ...
  Result := TdxPage(LookupBoxCore(APages, AComparer.CompareTo));
end;
...
begin
  ...
  Result := TdxPageArea(LookupBoxCore(Page.Areas, AComparer.CompareTo));
end;
...
begin
  ...
  Result := TdxRow(LookupBoxCore(ARows, AComparer.CompareTo));
end;
...
procedure TdxNumberingListCommandBase.ModifySelection(AModifyIntervalsProc: TModifyParagraphIntervalsProc);
var
  I: Integer;
...
begin
  ...
  try
    ...
    AIntervals.Sort;
    AModifyIntervalsProc(AIntervals);
  finally
    AIntervals.Free;
  end;
end;
...
begin
  ModifySelection(ModifyParagraphs);
  ClearCore;
end;
...
procedure TdxInsertMultiLevelListCommand.BeforeUpdate;
begin
  inherited BeforeUpdate;
  DeleteOldNumbering;
end;

procedure TdxInsertMultiLevelListCommand.DeleteOldNumbering;
begin
  ModifySelection(DeleteParagraphsNumbering);
end;

procedure TdxInsertMultiLevelListCommand.DeleteParagraphsNumbering(AParagraphIntervals: TdxParagraphIntervalList);
var
  I: Integer;
  AParagraphInterval: TdxParagraphInterval;
begin
  ...
  begin
    AParagraphInterval := AParagraphIntervals[I];
    DeleteParagraphsNumberingCore(AParagraphInterval.Start, AParagraphInterval.&End);
  end;
end;

procedure TdxInsertMultiLevelListCommand.DeleteParagraphsNumberingCore(AStartParagraphIndex, AEndParagraphIndex: TdxParagraphIndex);
var
  I: TdxParagraphIndex;
  AParagraph: TdxParagraph;
begin
...
function TdxNumerationParagraphIndentCommandBase.CalculateLeftIndentDelta(ATargetNumerationOrBulletPosition,
  ACurrentLeftIndent, AFirstLineIndent: Integer; AFirstLineIndentType: TdxParagraphFirstLineIndent): Integer;
begin
  Result := ATargetNumerationOrBulletPosition - CalculateCurrentBulletOrNumberingPosition(ACurrentLeftIndent,
...
begin
  Result := TdxPieceTableModifiers.CreateSectionLineNumberingStepAndRestartModifier(LineNumberingRestart);
end;
