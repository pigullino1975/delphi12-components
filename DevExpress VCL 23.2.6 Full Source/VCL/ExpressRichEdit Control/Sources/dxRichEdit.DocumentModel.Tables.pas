...
unit dxRichEdit.DocumentModel.Tables; // for internal use
...
type
  ...
  TdxTableCellLayoutProperties = record
  strict private
    FColumnSpan: Integer;
  ...
  private
    ...
    procedure SetContainerWidthsInfo(const Value: TdxWidthsContentInfo);
    procedure SetContentWidthsInfo(const Value: TdxWidthsContentInfo);
  public
    property ColumnSpan: Integer read FColumnSpan write SetColumnSpan;
    property ContainerWidthsInfo: TdxWidthsContentInfo read FContainerWidthsInfo write SetContainerWidthsInfo;
    property ContentWidthsInfo: TdxWidthsContentInfo read FContentWidthsInfo write SetContentWidthsInfo;
  end;
  ...
  TdxTableRowLayoutProperties = record
  strict private
    FGridBefore: Integer;
    FGridAfter: Integer;
  ...
  public
    property GridBefore: Integer read FGridBefore write SetGridBefore;
    property GridAfter: Integer read FGridAfter write SetGridAfter;
  end;

  { TdxTableItemCollectionCore }

  TdxTableItemCollectionCore = class
  strict private
    FItems: TdxObjectList<TObject>;
    FOwner: TObject;
  ...
  public
    ...
    procedure ForEach<T: class>(const Action: TdxAction<T>);
    function First: TObject; inline;
    function Last: TObject; inline;

    property Items: TdxObjectList<TObject> read FItems;
    property Self[Index: Integer]: TObject read GetItem; default;
  ...
  TdxTableCellCollection = class(TdxTableItemCollectionCore) 
  strict private
    function GetOwner: TdxTableRow; inline;
    function GetItem(Index: Integer): TdxTableCell; inline;
    procedure AddCellCore(AIndex: Integer); overload; inline;
  public
    ...
    procedure ForEach(const Action: TdxAction<TdxTableCell>); inline;
    function First: TdxTableCell; inline;
    function Last: TdxTableCell; inline;
    ...
    property Self[Index: Integer]: TdxTableCell read GetItem; default;
  ...
  strict private
    ...
    function GetDocumentModel: TdxSimpleDocumentModel; inline;
    function GetFirstCell: TdxTableCell; inline;
    ...
    function GetLastCell: TdxTableCell; inline;
    function GetNext: TdxTableRow;
    function GetPieceTable: TdxSimplePieceTable; inline;
  ...
  protected
    ...
    procedure OnRowPropertiesObtainAffectedRange(ASender: TObject; E: TdxObtainAffectedRangeEventArgs);
    procedure CopyFrom(ASourceRow: TdxTableRow);
  public
    ...
    procedure ResetConditionalType;
    procedure SetTable(ATable: TdxTable);

    function GetLeftCellMarginConsiderExceptions: TdxMarginUnitBase;
    function GetRightCellMarginConsiderExceptions: TdxMarginUnitBase;
    function GetTopCellMarginConsiderExceptions: TdxMarginUnitBase;
    function GetBottomCellMarginConsiderExceptions: TdxMarginUnitBase;
    function GetParentMergedTableRowProperties: TdxMergedTableRowProperties;
    procedure SubscribeRowPropertiesEvents;
    procedure UnsubscribeRowPropertiesEvents;
  ...
  private
    function GetItem(Index: Integer): TdxTableRow; inline;
  public
  ...
  TdxTableRowCollection = class(TdxTableItemCollectionCore) 
  strict private const
    BinarySearchThreshold = 32;
  strict private
    function GetDocumentModel: TdxSimpleDocumentModel; inline;
    function GetOwner: TdxTable; inline;
    function GetItem(Index: Integer): TdxTableRow; inline;
  protected
  ...
  public
    ...
    procedure ForEach(const Action: TdxAction<TdxTableRow>); inline;
    function First: TdxTableRow; inline;
    function Last: TdxTableRow; inline;
    ...
    property Self[Index: Integer]: TdxTableRow read GetItem; default;
  ...
  strict private
    ...
    function GetColumn(Index: Integer): TdxTableGridColumn; inline;
  public
  ...
  public
    ...
    class function SubstructIntervals(const AInterval1, AInterval2: TdxTableGridInterval; ABaseWidth1, ABaseWidth2: Integer): TdxTableGridInterval; static;
  ...
  strict private
    ...
    function GetDocumentModel: TdxSimpleDocumentModel;
    function GetEndParagraphIndex: TdxParagraphIndex; inline;
    function GetFirstRow: TdxTableRow; inline;
    function GetIsTableOverlap: Boolean;
    function GetLastRow: TdxTableRow; inline;
    function GetLeftMargin: TdxMarginUnitBase;
    function GetPreferredWidth: TdxPreferredWidth;
    function GetRightMargin: TdxMarginUnitBase;
    function GetStartParagraphIndex: TdxParagraphIndex; inline;
  ...
  public
    ...
    procedure RemoveInvalidVerticalSpansFromTableWithOneRow(ARows: TdxTableRowCollection);
  ...
  private
    ...
    function GetCount: Integer; inline;
    function GetTable(Index: Integer): TdxTable; inline;
  ...
  TdxTableChangeActionCalculator = class sealed
  public
...
const
  dxThisUnitName = 'dxRichEdit.DocumentModel.Tables';
...
begin
  Result := FTables{$IFDEF RELEASE}.List{$ENDIF}[Index];
end;
...
procedure TdxTableRowLayoutProperties.SetGridAfter(const Value: Integer);
begin
  FGridAfter := Value;
end;

procedure TdxTableRowLayoutProperties.SetGridBefore(const Value: Integer);
begin
  FGridBefore := Value;
end;
...
constructor TdxTableItemCollectionCore.Create(AOwner: TObject);
begin
  inherited Create;
  Assert(AOwner <> nil); 
  FOwner := AOwner;
  FItems := TdxObjectList<TObject>.Create;
end;

destructor TdxTableItemCollectionCore.Destroy;
begin
  FItems.Free;
  inherited Destroy;
end;

function TdxTableItemCollectionCore.GetCount: Integer;
begin
  Result := FItems.Count;
end;

function TdxTableItemCollectionCore.First: TObject;
begin
  if Count > 0 then
    Result := Items.List[0]
  else
...
procedure TdxTableItemCollectionCore.ForEach<T>(const Action: TdxAction<T>);
var
  I: Integer;
begin
  for I := 0 to FItems.Count - 1 do
    Action(T(TObject(FItems.List[I])));
end;

function TdxTableItemCollectionCore.GetItem(Index: Integer): TObject;
begin
  Result := FItems[Index];
end;

function TdxTableItemCollectionCore.Last: TObject;
begin
  if Count > 0 then
    Result := Items.List[Count - 1]
  else
    Result := nil;
end;
...
begin
  Result := TdxTableCell(Items.Extract(ACell));
end;

function TdxTableCellCollection.First: TdxTableCell;
begin
  Result := TdxTableCell(inherited First);
end;

procedure TdxTableCellCollection.ForEach(const Action: TdxAction<TdxTableCell>);
begin
  inherited ForEach<TdxTableCell>(Action);
end;

function TdxTableCellCollection.GetItem(Index: Integer): TdxTableCell;
begin
  Result := TdxTableCell(Items[Index]);
end;

function TdxTableCellCollection.GetOwner: TdxTableRow;
begin
  Result := TdxTableRow(inherited Owner);
end;
...
function TdxTableCellCollection.Last: TdxTableCell;
begin
  Result := TdxTableCell(inherited Last);
end;
...
begin
  ...
  FLayoutProperties := ASourceRow.LayoutProperties;
...
function TdxTableRowCollection.GetItem(Index: Integer): TdxTableRow;
begin
  Result := TdxTableRow(Items[Index]);
end;

function TdxTableRowCollection.GetOwner: TdxTable;
begin
  Result := TdxTable(inherited Owner);
end;
...
function TdxTableRowCollection.First: TdxTableRow;
begin
  Result := TdxTableRow(inherited First);
end;

procedure TdxTableRowCollection.ForEach(const Action: TdxAction<TdxTableRow>);
begin
  inherited ForEach<TdxTableRow>(Action);
end;
...
begin
  ...
  if not TdxAlgorithms1<TObject>.BinarySearch(Items,
    function (const AValue: TObject): Integer
    var
      ATableRow: TdxTableRow absolute AValue;
    begin
      Result := ATableRow.FirstCell.StartParagraphIndex - AStartParagraphIndex;
    end, Result) then
    Result := -1;
end;

function TdxTableRowCollection.Last: TdxTableRow;
begin
  Result := TdxTableRow(inherited Last);
end;

function TdxTableRowCollection.IndexOf(ARow: TdxTableRow): Integer;
begin
  if Items.Count >= BinarySearchThreshold then
...
begin
  ...
  begin
    FCurrentInterval := SubstructIntervals(CurrentInterval.Value, AInterval, PercentBaseWidth, PercentBaseWidth);
    Result := True;
  end;
end;
...
class function TdxTableGridIntervalIterator.SubstructIntervals(const AInterval1,
...
var
  ...
  AParagraphIndex, AStartParagraphIndex: TdxParagraphIndex;
begin
  AStartParagraphIndex := StartParagraphIndex;
  AFrameProperties := PieceTable.Paragraphs[AStartParagraphIndex].GetActualFrameProperties(False);
  try
    for AParagraphIndex := AStartParagraphIndex + 1 to EndParagraphIndex - 1 do
    begin
...
procedure TdxTable.RecalcNestedLevel;
begin
...
procedure TdxTable.RemoveInvalidVerticalSpansFromTableWithOneRow(ARows: TdxTableRowCollection);
var
  ACell: TdxTableCell;
  ACellIndex: Integer;
  ACells: TdxTableCellCollection;
...
begin
  ...
  if ARowCount = 1 then
  begin
    RemoveInvalidVerticalSpansFromTableWithOneRow(ARows);
    Exit;
  end;
...
procedure TdxTableCellLayoutProperties.SetColumnSpan(const Value: Integer);
begin
  FColumnSpan := Value;
end;

procedure TdxTableCellLayoutProperties.SetContainerWidthsInfo(const Value: TdxWidthsContentInfo);
begin
  FContainerWidthsInfo := Value;
end;

procedure TdxTableCellLayoutProperties.SetContentWidthsInfo(const Value: TdxWidthsContentInfo);
begin
  FContentWidthsInfo := Value;
end;
