...
unit dxRichEdit.DocumentModel.CopyParagraphOperation; // for internal use
...
type
  ...
  protected
    ...
    procedure DeleteLastParagraphInTableCell;
...
const
  dxThisUnitName = 'dxRichEdit.DocumentModel.CopyParagraphOperation';
