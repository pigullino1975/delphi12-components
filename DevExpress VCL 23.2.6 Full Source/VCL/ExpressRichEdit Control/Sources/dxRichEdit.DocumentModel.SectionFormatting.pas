...
unit dxRichEdit.DocumentModel.SectionFormatting; // for internal use
...
{$ENDREGION}
  ...
  strict private
    ...
    FColumns: TdxColumnInfoCollection; 
    FSpace: Integer;
  public
    constructor Create; override;
    ...
    property Columns: TdxColumnInfoCollection read FColumns;
  end;
...
const
  dxThisUnitName = 'dxRichEdit.DocumentModel.SectionFormatting';
...
begin
  inherited Create;
  FColumns := TdxColumnInfoCollection.Create(True);
end;
...
var
  AInfo: TdxColumnsInfo absolute Obj;
  ACount, I: Integer;
begin
