...
unit dxRichEdit.Ruler.Mouse; // for internal use
...
type
  ...
  protected
    ...
    function CreateZone(const APoint: TPoint): TdxRulerHotZone;
    function GetRulerMovableElementIndex(const APoint: TPoint): TdxRulerHotZone;
    function GetHitActiveAreaStartPosition(const APoint: TPoint): Integer;
  ...
  strict private
    ...
    FPoint: TPoint;
    function GetController: TdxRulerMouseController; inline;
    function GetControl: TdxRulerControlBase; inline;
  protected
    function GetStopClickTimerOnStart: Boolean; override;
    function GetVisualFeedbackValue: TdxRectangleVisualFeedbackValue; override;
    procedure MouseMoveCore(const APt: TPoint);
    procedure BeginVisualFeedback;
    procedure ShowVisualFeedback;
    procedure HideVisualFeedback;
    procedure EndVisualFeedback;
  ...
  strict private
    function GetControl: TdxHorizontalRulerControl; inline;
  protected
  ...
  protected
    function ConvertMouseEventArgs(const Args: TdxMouseEventArgs): TdxMouseEventArgs; override;
    function CreateLogicalPoint(const AClientBounds: TRect; const APoint: TPoint): TPoint;
  public
    function CreateLineVisualFeedback(const AValueProvider: TdxRichEditMouseCustomVisualFeedbackState): IdxVisualFeedback; override;
  end;
...
const
  dxThisUnitName = 'dxRichEdit.Ruler.Mouse';
...
var
  ...
  AHotZone: TdxRulerHotZone;
begin
  if Safe.Cast(Control, TdxHorizontalRulerControl, ARulerControl) then
  begin
...
var
  AActiveAreaCollection: TdxRectFList;
  ABounds: TdxRectF;
begin
