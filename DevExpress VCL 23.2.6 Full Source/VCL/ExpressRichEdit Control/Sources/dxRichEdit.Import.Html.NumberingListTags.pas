...
unit dxRichEdit.Import.Html.NumberingListTags; // for internal use
...
uses
  SysUtils, Classes, RTLConsts, dxCore,
...
const
  dxThisUnitName = 'dxRichEdit.Import.Html.NumberingListTags';
...
begin
  {$IFDEF DX_INITIALIZATION_LOGGING}TdxUnitSectionsLogger.ConstructorStarted(UnitName, 'TdxNumberingListTag.Initialize', SysInit.HInstance);{$ENDIF}
  FAttributeTable := AddAttributes;
  {$IFDEF DX_INITIALIZATION_LOGGING}TdxUnitSectionsLogger.ConstructorFinished(UnitName, 'TdxNumberingListTag.Initialize', SysInit.HInstance);{$ENDIF}
end;

class destructor TdxNumberingListTag.Finalize;
begin
  {$IFDEF DX_INITIALIZATION_LOGGING}TdxUnitSectionsLogger.DestructorStarted(UnitName, 'TdxNumberingListTag.Finalize', SysInit.HInstance);{$ENDIF}
  FAttributeTable.Free;
  {$IFDEF DX_INITIALIZATION_LOGGING}TdxUnitSectionsLogger.DestructorFinished(UnitName, 'TdxNumberingListTag.Finalize', SysInit.HInstance);{$ENDIF}
end;
...
begin
  {$IFDEF DX_INITIALIZATION_LOGGING}TdxUnitSectionsLogger.ConstructorStarted(UnitName, 'TdxBulletListTag.Initialize', SysInit.HInstance);{$ENDIF}
  FAttributeTable := AddAttributes;
  {$IFDEF DX_INITIALIZATION_LOGGING}TdxUnitSectionsLogger.ConstructorFinished(UnitName, 'TdxBulletListTag.Initialize', SysInit.HInstance);{$ENDIF}
end;

class destructor TdxBulletListTag.Finalize;
begin
  {$IFDEF DX_INITIALIZATION_LOGGING}TdxUnitSectionsLogger.DestructorStarted(UnitName, 'TdxBulletListTag.Finalize', SysInit.HInstance);{$ENDIF}
  FAttributeTable.Free;
  {$IFDEF DX_INITIALIZATION_LOGGING}TdxUnitSectionsLogger.DestructorFinished(UnitName, 'TdxBulletListTag.Finalize', SysInit.HInstance);{$ENDIF}
end;
...
begin
  {$IFDEF DX_INITIALIZATION_LOGGING}TdxUnitSectionsLogger.ConstructorStarted(UnitName, 'TdxLevelTag.Initialize', SysInit.HInstance);{$ENDIF}
  FAttributeTable := AddAttributes;
  {$IFDEF DX_INITIALIZATION_LOGGING}TdxUnitSectionsLogger.ConstructorFinished(UnitName, 'TdxLevelTag.Initialize', SysInit.HInstance);{$ENDIF}
end;

class destructor TdxLevelTag.Finalize;
begin
  {$IFDEF DX_INITIALIZATION_LOGGING}TdxUnitSectionsLogger.DestructorStarted(UnitName, 'TdxLevelTag.Finalize', SysInit.HInstance);{$ENDIF}
  FAttributeTable.Free;
  {$IFDEF DX_INITIALIZATION_LOGGING}TdxUnitSectionsLogger.DestructorFinished(UnitName, 'TdxLevelTag.Finalize', SysInit.HInstance);{$ENDIF}
end;
