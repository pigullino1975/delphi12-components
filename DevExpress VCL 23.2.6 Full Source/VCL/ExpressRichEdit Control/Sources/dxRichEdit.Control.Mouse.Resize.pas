...
type
  ...
  TdxObjectRotationAngleCalculator = class sealed
  public
...
const
  dxThisUnitName = 'dxRichEdit.Control.Mouse.Resize';
...
begin
  ...
  PageViewInfo := Control.InnerControl.ActiveView.LookupPageViewInfoByPage(ATopLevelPage);
end;
...
begin
  ...
  if TdxAlgorithms1<TdxTableCellVerticalAnchor>.BinarySearch(AItems, AComparable.CompareTo, AIndex) then
    Exit(AValue);
