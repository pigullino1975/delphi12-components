...
type
  ...
  public
    constructor Create(const AControl: IdxRichEditControl; const ASourceCharacterProperties: TdxMergedCharacterProperties);
...
const
  dxThisUnitName = 'dxRichEdit.Dialogs.FontsFormController';

{ TdxFontFormControllerParameters }

constructor TdxFontFormControllerParameters.Create(const AControl: IdxRichEditControl; const ASourceCharacterProperties: TdxMergedCharacterProperties);
begin
  inherited Create(AControl);
  Assert(ASourceCharacterProperties <> nil);
