...
{                                                                    }
{********************************************************************}
unit dxRichEdit.Export.Doc.DocExporter; // for internal use
...
const
  dxThisUnitName = 'dxRichEdit.Export.Doc.DocExporter';
...
begin
  ...
  if (AListIndex = NumberingListIndexNoNumberingList) or (AListIndex = NumberingListIndexListIndexNotSet) then
    Exit;
