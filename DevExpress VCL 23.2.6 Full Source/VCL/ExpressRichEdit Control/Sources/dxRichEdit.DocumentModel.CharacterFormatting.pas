...
type
  ...
  IdxCharacterProperties = interface // for internal use
  ...
  IdxCharacterPropertiesContainer = interface // for internal use
  ...
  TdxCharacterFormattingInfoCache = class(TdxUniqueItemsCache<TdxCharacterFormattingInfo>) // for internal use
  public const
    DefaultItemIndex = 0;
  public
  ...
  TdxCharacterFormattingCache = class(TdxUniqueItemsCache<TdxCharacterFormattingBase>) // for internal use
  public const
  ...
  TdxCharacterPropertiesFontAssignmentHelper = class sealed // for internal use
  public
  ...
  { TdxCharacterFormattingChangeActionsCalculator }
	...
	TdxCharacterFormattingChangeActionsCalculator = class sealed // for internal use
  public
  ...
  TdxParagraphMergedCharacterPropertiesCachedResult = class // for internal use
  strict private
  ...
  TdxRunMergedCharacterPropertiesCachedResult = class(TdxParagraphMergedCharacterPropertiesCachedResult) // for internal use
  strict private
...
const
  dxThisUnitName = 'dxRichEdit.DocumentModel.CharacterFormatting';
