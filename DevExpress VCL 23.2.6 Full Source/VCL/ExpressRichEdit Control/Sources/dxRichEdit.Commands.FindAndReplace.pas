...
const
  dxThisUnitName = 'dxRichEdit.Commands.FindAndReplace';
...
begin
  Result := TdxTextSearchProvider.CreateForwardProvider(ActivePieceTable, SearchParameters, SearchContext);
end;
...
begin
  Result := TdxTextSearchProvider.CreateBackwardProvider(ActivePieceTable, SearchParameters, SearchContext);
end;
