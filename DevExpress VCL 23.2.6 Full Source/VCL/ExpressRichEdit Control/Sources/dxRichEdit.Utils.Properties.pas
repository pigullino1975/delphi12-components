...
type
 ...
 { TdxSymbolProperties }
  ...
  public
    ...
    class function CreateSingleColumnsInfoPreset: TdxColumnsInfoPreset; static;
    class function CreateTwoUniformColumnsInfoPreset: TdxColumnsInfoPreset; static;
    class function CreateThreeUniformColumnsInfoPreset: TdxColumnsInfoPreset; static;
    class function CreateLeftNarrowColumnsInfoPreset: TdxColumnsInfoPreset; static;
    class function CreateRightNarrowColumnsInfoPreset: TdxColumnsInfoPreset; static;
  end;
...
const
  dxThisUnitName = 'dxRichEdit.Utils.Properties';
...
type
  ...
  protected
    ...
    function CalculateTotal(AFrom, ATo: Integer): Integer;
    function HasEnoughSpaceForDistribution(AFrom, ATo, ASpace: Integer): Boolean;
    function SetMinValues(AFrom, ATo, ASpace: Integer): Integer;
    procedure CorrectValue(AIndex: Integer);
    function DistributeRemainder(AFrom: Integer; ATo: Integer; ARemainder: Integer): Integer;
    function DistributeSpaceCore(AFrom: Integer; ATo: Integer; ASpace: Integer): Integer;
    function DistributeSpace(AFrom: Integer; ATo: Integer; ASpace: Integer): Integer;
    procedure SetAllValues(AValue: Integer; ARest: Integer);
...
class function TdxColumnsInfoPreset.CreateLeftNarrowColumnsInfoPreset: TdxColumnsInfoPreset;
begin
  Result := TdxLeftNarrowColumnsInfoPreset.Create;
end;

class function TdxColumnsInfoPreset.CreateRightNarrowColumnsInfoPreset: TdxColumnsInfoPreset;
begin
  Result := TdxRightNarrowColumnsInfoPreset.Create;
end;

class function TdxColumnsInfoPreset.CreateSingleColumnsInfoPreset: TdxColumnsInfoPreset;
begin
  Result := TdxSingleColumnsInfoPreset.Create;
end;

class function TdxColumnsInfoPreset.CreateThreeUniformColumnsInfoPreset: TdxColumnsInfoPreset;
begin
  Result := TdxThreeUniformColumnsInfoPreset.Create;
end;

class function TdxColumnsInfoPreset.CreateTwoUniformColumnsInfoPreset: TdxColumnsInfoPreset;
begin
  Result := TdxTwoUniformColumnsInfoPreset.Create;
end;
