...
type
  ...
  public
    ...
    procedure Assign(ASource: TdxGPCustomGraphicObject); override; final;
  ...
  strict private
    ...
    FOldMapMode: Integer;
  protected
    function GetDpi: Integer; inline;
    procedure ApplyHDCDpi;
    procedure RestoreHDCDpi;
...
const
  dxThisUnitName = 'dxRichEdit.Utils.Graphics';
...
begin
  ...
  FGraphics.PageUnit := TdxGraphicUnit(FUnitConverter.GraphicsPageUnit);
