...
unit dxRichEdit.Import.OpenXML.DestinationPicture; // for internal use
...
const
  dxThisUnitName = 'dxRichEdit.Import.OpenXML.DestinationPicture';

{ TdxInlineObjectDestination }

class constructor TdxInlineObjectDestination.Initialize;
begin
  {$IFDEF DX_INITIALIZATION_LOGGING}TdxUnitSectionsLogger.ConstructorStarted(UnitName, 'TdxInlineObjectDestination.Initialize', SysInit.HInstance);{$ENDIF}
  ...
  {$IFDEF DX_INITIALIZATION_LOGGING}TdxUnitSectionsLogger.ConstructorFinished(UnitName, 'TdxInlineObjectDestination.Initialize', SysInit.HInstance);{$ENDIF}
end;

class destructor TdxInlineObjectDestination.Finalize;
begin
  {$IFDEF DX_INITIALIZATION_LOGGING}TdxUnitSectionsLogger.DestructorStarted(UnitName, 'TdxInlineObjectDestination.Finalize', SysInit.HInstance);{$ENDIF}
  FHandlerTable.Free;
  FHorizontalPositionTypeAttributeTable.Free;
  FVerticalPositionTypeAttributeTable.Free;
  {$IFDEF DX_INITIALIZATION_LOGGING}TdxUnitSectionsLogger.DestructorFinished(UnitName, 'TdxInlineObjectDestination.Finalize', SysInit.HInstance);{$ENDIF}
end;
...
begin
  {$IFDEF DX_INITIALIZATION_LOGGING}TdxUnitSectionsLogger.ConstructorStarted(UnitName, 'TdxVMLShapeDestination.Initialize', SysInit.HInstance);{$ENDIF}
  FHandlerTable := CreateElementHandlerTable;
  {$IFDEF DX_INITIALIZATION_LOGGING}TdxUnitSectionsLogger.ConstructorFinished(UnitName, 'TdxVMLShapeDestination.Initialize', SysInit.HInstance);{$ENDIF}
end;

class destructor TdxVMLShapeDestination.Finalize;
begin
  {$IFDEF DX_INITIALIZATION_LOGGING}TdxUnitSectionsLogger.DestructorStarted(UnitName, 'TdxVMLShapeDestination.Finalize', SysInit.HInstance);{$ENDIF}
  FreeAndNil(FHandlerTable);
  {$IFDEF DX_INITIALIZATION_LOGGING}TdxUnitSectionsLogger.DestructorFinished(UnitName, 'TdxVMLShapeDestination.Finalize', SysInit.HInstance);{$ENDIF}
end;
