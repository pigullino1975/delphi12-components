...
const
  ...
  NumberingListIndexListIndexNotSet = -1;
...
type
  ...
  TdxMergedParagraphProperties = class;

  IdxParagraphProperties = interface // for internal use
  ...
  IdxParagraphPropertiesContainer = interface // for internal use
  ...
  TdxUsedParagraphFormattingOptions = set of TdxUsedParagraphFormattingOption; // for internal use
  ...
  PdxParagraphFormattingOptions = ^TdxParagraphFormattingOptions; // for internal use
  ...
  TdxParagraphFormattingBase = class(TdxIndexBasedObjectB<TdxParagraphFormattingInfo, TdxParagraphFormattingOptions>,
    IdxParagraphProperties) // for internal use
  private
  ...
  TdxParagraphProperties = class(TdxRichEditIndexBasedObject<TdxParagraphFormattingBase>, IdxParagraphProperties) // for internal use
  private
  ...
  public
    ...
    procedure CopyFrom(const AParagraphProperties: TdxMergedParagraphProperties); overload;
  ...
  TdxParagraphFormattingInfoCache = class(TdxUniqueItemsCache<TdxParagraphFormattingInfo>) // for internal use
  public const
    DefaultItemIndex = 0;
  protected
  ...
  TdxParagraphFormattingCache = class(TdxUniqueItemsCache<TdxParagraphFormattingBase>) // for internal use
  public const
  ...
  TdxParagraphFormattingChangeActionsCalculator = class sealed // for internal use
  public
  ...
  TdxParagraphParagraphPropertiesChangedHistoryItem = class(TdxIndexChangedHistoryItemCore) // for internal use
  private
  ...
  TdxParagraphMergedParagraphPropertiesCachedResult = class // for internal use
  private
...
const
  dxThisUnitName = 'dxRichEdit.DocumentModel.ParagraphFormatting';
...
procedure TdxParagraphProperties.CopyFrom(const AParagraphProperties: TdxMergedParagraphProperties);
var
