...
const
  dxThisUnitName = 'dxRichEdit.Dialogs.FloatingObjectLayoutForm';
...
begin
  ...
  UpdateTabPageSize;
  if Control.InnerControl.Options.DocumentCapabilities.FloatingObjects = TdxDocumentCapability.Disabled then
  begin
    lcgTabPagePosition.Visible := False;
    lcgTabPageTextWrapping.Visible := False;
    lciRotation.Visible := False;
    lciRotate.Visible := False;
  end;
end;
