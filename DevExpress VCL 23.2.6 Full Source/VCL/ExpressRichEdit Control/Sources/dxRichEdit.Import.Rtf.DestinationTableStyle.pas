...
unit dxRichEdit.Import.Rtf.DestinationTableStyle; // for internal use
...
const
  dxThisUnitName = 'dxRichEdit.Import.Rtf.DestinationTableStyle';
...
begin
  {$IFDEF DX_INITIALIZATION_LOGGING}TdxUnitSectionsLogger.ConstructorStarted(UnitName, 'TdxDestinationTableStyle.Initialize', SysInit.HInstance);{$ENDIF}
  FKeywordHT := CreateKeywordHT;
  {$IFDEF DX_INITIALIZATION_LOGGING}TdxUnitSectionsLogger.ConstructorFinished(UnitName, 'TdxDestinationTableStyle.Initialize', SysInit.HInstance);{$ENDIF}
end;

class destructor TdxDestinationTableStyle.Finalize;
begin
  {$IFDEF DX_INITIALIZATION_LOGGING}TdxUnitSectionsLogger.DestructorStarted(UnitName, 'TdxDestinationTableStyle.Finalize', SysInit.HInstance);{$ENDIF}
  FreeAndNil(FKeywordHT);
  {$IFDEF DX_INITIALIZATION_LOGGING}TdxUnitSectionsLogger.DestructorFinished(UnitName, 'TdxDestinationTableStyle.Finalize', SysInit.HInstance);{$ENDIF}
end;
