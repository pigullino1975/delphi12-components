...
unit dxRichEdit.DocumentModel.Fields.HyperlinkField; // for internal use
...
const
  dxThisUnitName = 'dxRichEdit.DocumentModel.Fields.HyperlinkField';

{ TdxHyperlinkField }

class constructor TdxHyperlinkField.Initialize;
begin
  {$IFDEF DX_INITIALIZATION_LOGGING}TdxUnitSectionsLogger.ConstructorStarted(UnitName, 'TdxHyperlinkField.Initialize', SysInit.HInstance);{$ENDIF}
  FSwitchesWithArgument := CreateSwitchesWithArgument(['l', 'o', 't']);
  {$IFDEF DX_INITIALIZATION_LOGGING}TdxUnitSectionsLogger.ConstructorFinished(UnitName, 'TdxHyperlinkField.Initialize', SysInit.HInstance);{$ENDIF}
end;

class destructor TdxHyperlinkField.Finalize;
begin
  {$IFDEF DX_INITIALIZATION_LOGGING}TdxUnitSectionsLogger.DestructorStarted(UnitName, 'TdxHyperlinkField.Finalize', SysInit.HInstance);{$ENDIF}
  FreeAndNil(FSwitchesWithArgument);
  {$IFDEF DX_INITIALIZATION_LOGGING}TdxUnitSectionsLogger.DestructorFinished(UnitName, 'TdxHyperlinkField.Finalize', SysInit.HInstance);{$ENDIF}
end;
