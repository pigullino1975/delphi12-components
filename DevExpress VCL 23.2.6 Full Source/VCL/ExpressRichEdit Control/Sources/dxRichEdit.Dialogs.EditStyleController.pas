...
uses
  SysUtils, Classes, Graphics, Generics.Defaults, Generics.Collections, dxCoreGraphics,
...
type
  ...
  public
    ...
    procedure CopyCharacterPropertiesFromMerged(const AMergedProperties: TdxMergedCharacterProperties);
    procedure CopyParagraphPropertiesFromMerged(const AMergedProperties: TdxMergedParagraphProperties);
...
const
  dxThisUnitName = 'dxRichEdit.Dialogs.EditStyleController';
...
procedure TdxEditStyleFormController.CopyCharacterPropertiesFromMerged(const AMergedProperties: TdxMergedCharacterProperties);
var
...
procedure TdxEditStyleFormController.CopyParagraphPropertiesFromMerged(const AMergedProperties: TdxMergedParagraphProperties);
var
