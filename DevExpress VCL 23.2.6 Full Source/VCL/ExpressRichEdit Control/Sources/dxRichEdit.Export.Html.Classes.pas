...
unit dxRichEdit.Export.Html.Classes; // for internal use
...
type
  ...
  public
    ...
    class property Empty: TdxWebUnit read FEmpty;
  end;
  ...
  public
    ...
    class property Empty: TdxWebFontUnit read FEmpty;
    class property Smaller: TdxWebFontUnit read FSmaller;
    class property Larger: TdxWebFontUnit read FLarger;
    class property XXSmall: TdxWebFontUnit read FXXSmall;
    class property XSmall: TdxWebFontUnit read FXSmall;
    class property Small: TdxWebFontUnit read FSmall;
    class property Medium: TdxWebFontUnit read FMedium;
    class property Large: TdxWebFontUnit read FLarge;
    class property XLarge: TdxWebFontUnit read FXLarge;
    class property XXLarge: TdxWebFontUnit read FXXLarge;
  end;
  ...
  public
    ...
    class function GetHtmlStyle(const AFontFamilyName: string; ASize: Single; AUnit: TdxGraphicUnit;
    ...
    class procedure GetHtmlStyle(const AFontFamilyName: string; ASize: Single; AUnit: TdxGraphicUnit;
    ...
    class function GetFontHtml(const AFontFamilyName: string; ASize: Single; AUnit: TdxGraphicUnit;
    ...
    class procedure GetFontHtml(const AFontFamilyName: string; ASize: Single; AUnit: TdxGraphicUnit;
...
const
  dxThisUnitName = 'dxRichEdit.Export.Html.Classes';
...
begin
  {$IFDEF DX_INITIALIZATION_LOGGING}TdxUnitSectionsLogger.ConstructorStarted(dxThisUnitName, 'TdxWebUnit.Initialize', SysInit.HInstance);{$ENDIF}
  FEmpty := TdxWebUnit.Create('');
  {$IFDEF DX_INITIALIZATION_LOGGING}TdxUnitSectionsLogger.ConstructorFinished(dxThisUnitName, 'TdxWebUnit.Initialize', SysInit.HInstance);{$ENDIF}
end;
...
begin
  {$IFDEF DX_INITIALIZATION_LOGGING}TdxUnitSectionsLogger.ConstructorStarted(dxThisUnitName, 'TdxWebFontUnit.Initialize', SysInit.HInstance);{$ENDIF}
  ...
  {$IFDEF DX_INITIALIZATION_LOGGING}TdxUnitSectionsLogger.ConstructorFinished(dxThisUnitName, 'TdxWebFontUnit.Initialize', SysInit.HInstance);{$ENDIF}
end;
...
begin
  {$IFDEF DX_INITIALIZATION_LOGGING}TdxUnitSectionsLogger.ConstructorStarted(UnitName, 'TdxCssStyleCollection.Initialize', SysInit.HInstance);{$ENDIF}
  FStyleAttribRegex := TRegex.Create('\G(\s*(;\s*)*(?<stylename>[^:]+?)\s*:\s*(?<styleval>[^;]*))*\s*(;\s*)*$',
    [TRegExOption.roExplicitCapture, TRegExOption.roMultiLine]);
  {$IFDEF DX_INITIALIZATION_LOGGING}TdxUnitSectionsLogger.ConstructorFinished(UnitName, 'TdxCssStyleCollection.Initialize', SysInit.HInstance);{$ENDIF}
end;
...
const
  ResultMap: array[TdxHtmlTextWriterTag] of string = (
    ...
    'code', 'col', 'colgroup', 'dd', 'del', 'dfn', 'dir', 'div', 'dl', 'dt', 'em', 'embed', 'o:p',
...
class function TdxHtmlStyleRender.GetHtmlStyle(const AFontFamilyName: string; ASize: Single; AUnit: TdxGraphicUnit;
...
class procedure TdxHtmlStyleRender.GetHtmlStyle(const AFontFamilyName: string; ASize: Single; AUnit: TdxGraphicUnit;
...
class function TdxHtmlStyleRender.GetFontHtml(const AFontFamilyName: string; ASize: Single; AUnit: TdxGraphicUnit;
...
class procedure TdxHtmlStyleRender.GetFontHtml(const AFontFamilyName: string; ASize: Single; AUnit: TdxGraphicUnit;
...
begin
  {$IFDEF DX_INITIALIZATION_LOGGING}TdxUnitSectionsLogger.ConstructorStarted(UnitName, 'TdxCssTextWriter.Initialize', SysInit.HInstance);{$ENDIF}
  ...
  {$IFDEF DX_INITIALIZATION_LOGGING}TdxUnitSectionsLogger.ConstructorFinished(UnitName, 'TdxCssTextWriter.Initialize', SysInit.HInstance);{$ENDIF}
end;

class destructor TdxCssTextWriter.Finalize; 
begin
  {$IFDEF DX_INITIALIZATION_LOGGING}TdxUnitSectionsLogger.DestructorStarted(UnitName, 'TdxCssTextWriter.Finalize', SysInit.HInstance);{$ENDIF}
  FStyleLookup.Free;
  {$IFDEF DX_INITIALIZATION_LOGGING}TdxUnitSectionsLogger.DestructorFinished(UnitName, 'TdxCssTextWriter.Finalize', SysInit.HInstance);{$ENDIF}
end;
...
begin
  {$IFDEF DX_INITIALIZATION_LOGGING}TdxUnitSectionsLogger.ConstructorStarted(UnitName, 'TdxHtmlTextWriter.Initialize', SysInit.HInstance);{$ENDIF}
  ...
  RegisterTag('o:p', TdxHtmlTextWriterTag.EmptyP, TTagType.Inline);
  ...
  {$IFDEF DX_INITIALIZATION_LOGGING}TdxUnitSectionsLogger.ConstructorFinished(UnitName, 'TdxHtmlTextWriter.Initialize', SysInit.HInstance);{$ENDIF}
end;

class destructor TdxHtmlTextWriter.Finalize;
begin
  {$IFDEF DX_INITIALIZATION_LOGGING}TdxUnitSectionsLogger.DestructorStarted(UnitName, 'TdxHtmlTextWriter.Finalize', SysInit.HInstance);{$ENDIF}
  FTagsLookup.Free;
  FAttributeLookup.Free;
  {$IFDEF DX_INITIALIZATION_LOGGING}TdxUnitSectionsLogger.DestructorFinished(UnitName, 'TdxHtmlTextWriter.Finalize', SysInit.HInstance);{$ENDIF}
end;
