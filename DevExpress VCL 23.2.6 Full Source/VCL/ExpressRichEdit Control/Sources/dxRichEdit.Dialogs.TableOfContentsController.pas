...
uses
  Types, SysUtils, Classes, RTLConsts, Variants,
...
const
  dxThisUnitName = 'dxRichEdit.Dialogs.TableOfContentsController';
...
var
  ...
  ANativeSwitches, AInvariableSwitches: TArray<string>;
  ACount, I, J: Integer;
