...
{                                                                    }
{********************************************************************}
unit dxRichEdit.Import.Doc.FileShapeAddress; // for internal use
...
type
  ...
  strict private
    ...
    function GetWidthInTwips: Integer;
  ...
  public
    ...
    property WidthInTwips: Integer read GetWidthInTwips;
...
const
  dxThisUnitName = 'dxRichEdit.Import.Doc.FileShapeAddress';
...
function TdxFileShapeAddress.GetWidthInTwips: Integer;
begin
  Result := FRight - FLeft;
end;
