inherited dxRichEditParagraphDialogForm: TdxRichEditParagraphDialogForm
  ...
  inherited dxLayoutControl1: TdxLayoutControl
    ...
    object cbContextualSpacing: TdxLayoutCheckBoxItem
      Parent = dxLayoutControl1Group6
      CaptionOptions.Text = 'Don'#39't add spa&ce between paragraphs of the same style'
      Index = 1
    end
    object cbKeepLinesTogether: TdxLayoutCheckBoxItem
      Parent = dxLayoutControl1Group9
      CaptionOptions.Text = '&Keep lines together'
      Index = 0
    end
    object cbPageBreakBefore: TdxLayoutCheckBoxItem
      Parent = dxLayoutControl1Group9
      CaptionOptions.Text = 'Page &break before'
      Index = 1
    end
  end
