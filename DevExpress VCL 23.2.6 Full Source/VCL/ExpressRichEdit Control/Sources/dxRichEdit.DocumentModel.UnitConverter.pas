...
unit dxRichEdit.DocumentModel.UnitConverter; // for internal use
...
function ConvertValue(AValue: Single; ASrcUnit, ADestUnit: TdxRichEditDocumentUnit): Single;
...
const
  dxThisUnitName = 'dxRichEdit.DocumentModel.UnitConverter';

function ConvertValue(AValue: Single; ASrcUnit, ADestUnit: TdxRichEditDocumentUnit): Single;
begin
  Result := AValue;
  if ASrcUnit = ADestUnit then
    Exit;
  case ASrcUnit of
    TdxRichEditDocumentUnit.Document:
      case ADestUnit of
        TdxRichEditDocumentUnit.Document:
          Result := AValue;
    ...
    TdxRichEditDocumentUnit.Inch:
      case ADestUnit of
        ...
        TdxRichEditDocumentUnit.Inch:
          Result := AValue;
        TdxRichEditDocumentUnit.Millimeter:
          Result := InchesToMillimetersF(AValue);
        TdxRichEditDocumentUnit.Centimeter:
          Result := InchesToCentimetersF(AValue);
        TdxRichEditDocumentUnit.Point:
    ...
    TdxRichEditDocumentUnit.Millimeter:
      case ADestUnit of
        ...
        TdxRichEditDocumentUnit.Inch:
          Result := MillimetersToInchesF(AValue);
        TdxRichEditDocumentUnit.Millimeter:
          Result := AValue;
        TdxRichEditDocumentUnit.Centimeter:
          Result := AValue / 10;
    ...
    TdxRichEditDocumentUnit.Centimeter:
      case ADestUnit of
        ...
        TdxRichEditDocumentUnit.Inch:
          Result := CentimetersToInchesF(AValue);
        TdxRichEditDocumentUnit.Millimeter:
          Result := AValue * 10;
        TdxRichEditDocumentUnit.Centimeter:
          Result := AValue;
        TdxRichEditDocumentUnit.Point:
          Result := CentimetersToPointsF(AValue);
      end;
    TdxRichEditDocumentUnit.Point:
      case ADestUnit of
        TdxRichEditDocumentUnit.Document:
        ...
        TdxRichEditDocumentUnit.Inch:
          Result := PointsToInchesF(AValue);
        TdxRichEditDocumentUnit.Millimeter:
          Result := PointsToMillimetersF(AValue);
        TdxRichEditDocumentUnit.Centimeter:
          Result := PointsToCentimetersF(AValue);
        TdxRichEditDocumentUnit.Point:
          Result := AValue;
      end;
  end;
...
begin
  ...
  begin
    if not AStringValue[APosition - 1].IsDigit then
      Dec(APosition);
