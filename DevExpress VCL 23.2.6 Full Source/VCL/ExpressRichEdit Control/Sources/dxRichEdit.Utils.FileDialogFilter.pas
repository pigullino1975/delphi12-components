...
const
  dxThisUnitName = 'dxRichEdit.Utils.FileDialogFilter';
...
begin
  {$IFDEF DX_INITIALIZATION_LOGGING}TdxUnitSectionsLogger.ConstructorStarted(UnitName, 'TdxFileDialogFilter.Initialize', SysInit.HInstance);{$ENDIF}
  ...
  {$IFDEF DX_INITIALIZATION_LOGGING}TdxUnitSectionsLogger.ConstructorFinished(UnitName, 'TdxFileDialogFilter.Initialize', SysInit.HInstance);{$ENDIF}
end;

class destructor TdxFileDialogFilter.Finalize;
begin
  {$IFDEF DX_INITIALIZATION_LOGGING}TdxUnitSectionsLogger.DestructorStarted(UnitName, 'TdxFileDialogFilter.Finalize', SysInit.HInstance);{$ENDIF}
  ...
  {$IFDEF DX_INITIALIZATION_LOGGING}TdxUnitSectionsLogger.DestructorFinished(UnitName, 'TdxFileDialogFilter.Finalize', SysInit.HInstance);{$ENDIF}
end;
