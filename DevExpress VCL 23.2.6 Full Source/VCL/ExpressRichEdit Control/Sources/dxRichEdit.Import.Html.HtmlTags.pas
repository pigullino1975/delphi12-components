...
unit dxRichEdit.Import.Html.HtmlTags; // for internal use
...
const
  dxThisUnitName = 'dxRichEdit.Import.Html.HtmlTags';
...
begin
  {$IFDEF DX_INITIALIZATION_LOGGING}TdxUnitSectionsLogger.ConstructorStarted(UnitName, 'TdxAnchorTag.Initialize', SysInit.HInstance);{$ENDIF}
  FAttributeTable := AddAttributes;
  {$IFDEF DX_INITIALIZATION_LOGGING}TdxUnitSectionsLogger.ConstructorFinished(UnitName, 'TdxAnchorTag.Initialize', SysInit.HInstance);{$ENDIF}
end;

class destructor TdxAnchorTag.Finalize;
begin
  {$IFDEF DX_INITIALIZATION_LOGGING}TdxUnitSectionsLogger.DestructorStarted(UnitName, 'TdxAnchorTag.Finalize', SysInit.HInstance);{$ENDIF}
  FAttributeTable.Free;
  {$IFDEF DX_INITIALIZATION_LOGGING}TdxUnitSectionsLogger.DestructorFinished(UnitName, 'TdxAnchorTag.Finalize', SysInit.HInstance);{$ENDIF}
end;
...
begin
  {$IFDEF DX_INITIALIZATION_LOGGING}TdxUnitSectionsLogger.ConstructorStarted(UnitName, 'TdxBaseTag.Initialize', SysInit.HInstance);{$ENDIF}
  FAttributeTable := AddAttributes;
  {$IFDEF DX_INITIALIZATION_LOGGING}TdxUnitSectionsLogger.ConstructorFinished(UnitName, 'TdxBaseTag.Initialize', SysInit.HInstance);{$ENDIF}
end;

class destructor TdxBaseTag.Finalize;
begin
  {$IFDEF DX_INITIALIZATION_LOGGING}TdxUnitSectionsLogger.DestructorStarted(UnitName, 'TdxBaseTag.Finalize', SysInit.HInstance);{$ENDIF}
  FAttributeTable.Free;
  {$IFDEF DX_INITIALIZATION_LOGGING}TdxUnitSectionsLogger.DestructorFinished(UnitName, 'TdxBaseTag.Finalize', SysInit.HInstance);{$ENDIF}
end;
