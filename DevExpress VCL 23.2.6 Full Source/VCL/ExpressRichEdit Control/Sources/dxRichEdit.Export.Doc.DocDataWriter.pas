...
{                                                                    }
{********************************************************************}
unit dxRichEdit.Export.Doc.DocDataWriter; // for internal use
...
uses
  SysUtils, Classes, Generics.Defaults, Generics.Collections, dxCore, dxCoreClasses, RTLConsts,
...
type
  ...
  strict private const
    HeadingStyles: array[1..9] of string = (
      'Heading 1',
      'Heading 2',
      'Heading 3',
      'Heading 4',
...
const
  dxThisUnitName = 'dxRichEdit.Export.Doc.DocDataWriter';
...
begin
  ...
  try
    ...
    try
      AParagraphActions.CreateParagraphPropertyModifiers;
...
begin
  ...
  try
    ...
    try
      AActions.CreateParagraphPropertyModifiers;
      Result := AOutput.ToArray;
    finally
      AActions.Free;
    end;
...
begin
  ...
  begin
    AHeadingStyleName := HeadingStyles[ADefaultHeadingStyleIndex];
