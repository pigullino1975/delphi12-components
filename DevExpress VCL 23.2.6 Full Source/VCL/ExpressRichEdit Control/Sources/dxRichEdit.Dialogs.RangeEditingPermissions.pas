...
const
  dxThisUnitName = 'dxRichEdit.Dialogs.RangeEditingPermissions';
...
begin
  ...
  if ANewUser = '' then
    Exit;
  if not Controller.IsValidUserName(ANewUser) then
    dxMessageBox(cxGetResourceString(@sdxRangeEditingPermissionsInvalidUserNames), Application.Title, MB_OK or MB_ICONWARNING)
  else
