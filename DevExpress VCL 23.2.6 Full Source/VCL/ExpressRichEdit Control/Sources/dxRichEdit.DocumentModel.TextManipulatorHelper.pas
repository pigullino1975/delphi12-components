...
unit dxRichEdit.DocumentModel.TextManipulatorHelper; // for internal use
...
type
  ...
  public
    ...
    class procedure SetTextLines(ATable: TdxPieceTable; const ALines: TArray<string>; const ADefaultFontName: string;
      ADoubleFontSize: Integer); overload; static; inline;
    class procedure SetTextLinesCore(ATable: TdxPieceTable; const ALines: TArray<string>); static;
...
const
  dxThisUnitName = 'dxRichEdit.DocumentModel.TextManipulatorHelper';
