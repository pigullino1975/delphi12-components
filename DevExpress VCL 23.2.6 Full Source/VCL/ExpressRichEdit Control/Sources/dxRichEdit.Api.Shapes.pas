...
const
  dxThisUnitName = 'dxRichEdit.Api.Shapes';
...
begin
  if Safe.Cast(AnchorRun.Content, TdxPictureFloatingObjectContent, AContent) then
  begin
...
begin
  ...
  if Safe.Cast(AnchorRun.Content, TdxTextBoxFloatingObjectContent, AContent) then
  begin
...
begin
  ...
  for I := 0 to ARuns.Count - 1 do
    if Safe.Cast(ARuns[I], TdxFloatingObjectAnchorRun, ARun) then
    begin
