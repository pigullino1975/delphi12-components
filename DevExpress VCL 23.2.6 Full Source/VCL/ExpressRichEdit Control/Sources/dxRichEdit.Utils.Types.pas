...
type
  ...
  TdxReferencedIUnknownObject = class(TdxReferencedObject, IUnknown);
  ...
  protected
    ...
    function _Release: Integer; stdcall;
  public
    function Add(const Value: T): Integer; // for internal use
    procedure Delete(Index: Integer); // for internal use
    function Extract(const Value: T): T; // for internal use
    function GetItem(Index: Integer): T; // for internal use
    procedure Insert(Index: Integer; const Value: T); // for internal use
    function Remove(const Value: T): Integer; // for internal use
  end;
...
const
  dxThisUnitName = 'dxRichEdit.Utils.Types';
...
function TdxReferencedObject.QueryInterface(const IID: TGUID; out Obj): HResult;
begin
...
function TdxReferencedObject._AddRef: Integer;
begin
  Result := -1;
end;

function TdxReferencedObject._Release: Integer;
begin
  Result := -1;
end;
...
function TdxIUnknownList<T>.Add(const Value: T): Integer;
begin
  Result := inherited Add(Value);
end;

procedure TdxIUnknownList<T>.Delete(Index: Integer);
begin
  inherited Delete(Index);
end;

function TdxIUnknownList<T>.Extract(const Value: T): T;
begin
  Result := inherited Extract(Value);
end;

function TdxIUnknownList<T>.GetItem(Index: Integer): T;
begin
  Result := inherited Items[Index];
end;

procedure TdxIUnknownList<T>.Insert(Index: Integer; const Value: T);
begin
...
function TdxIUnknownList<T>.Remove(const Value: T): Integer;
begin
