...
unit dxRichEdit.Import.Formats; // for internal use
...
const
  dxThisUnitName = 'dxRichEdit.Import.Formats';
...
begin
  {$IFDEF DX_INITIALIZATION_LOGGING}TdxUnitSectionsLogger.DestructorStarted(UnitName, 'TdxImportFileFormats.Finalize', SysInit.HInstance);{$ENDIF}
  FreeAndNil(FImportFileFormats);
  {$IFDEF DX_INITIALIZATION_LOGGING}TdxUnitSectionsLogger.DestructorFinished(UnitName, 'TdxImportFileFormats.Finalize', SysInit.HInstance);{$ENDIF}
end;
