...
type
  ...
  IdxObtainAffectedRangeListener = interface // for internal use
  ...
  TdxObtainAffectedRangeEventArgs = class // for internal use
  private
    FEnd: TdxRunIndex;
    FStart: TdxRunIndex;
  public
  ...
  TdxItemsListComparer<T: class> = class(TComparer<T>) // for internal use
  public
  ...
  TdxItemsDictionaryComparer<T: class> = class(TEqualityComparer<T>) // for internal use
  public
  ...
  TdxUniqueItemsCache<T: TdxCloneable> = class(TcxIUnknownObject) // for internal use
  private
  ...
  TdxIndexBasedObjectValueSetter<T, U> = reference to procedure (const AInfo: T; const ANewValue: U); // for internal use
  ...
  public
    ...
    procedure ReplaceInfo(const ANewInfo: TInfo; const ANewOptions: TOptions); overload; inline; 
  ...
  public
    ...
    procedure CopyFrom(const Source: TdxUndoableIndexBasedObject<T>); overload;
  ...
  TdxRichEditIndexBasedObjectValueSetter<T, U> = reference to function (const AInfo: T; const AValue: U): TdxDocumentModelChangeActions; // for internal use

  TdxRichEditIndexBasedObject<T: TdxCloneable> = class(TdxUndoableIndexBasedObject<T>)
  private
...
const
  dxThisUnitName = 'dxRichEdit.DocumentModel.IndexBasedObject';
...
destructor TdxRichEditIndexBasedObject<T>.Destroy;
begin
  FOnObtainAffectedRange.Clear;
  inherited Destroy;
end;
