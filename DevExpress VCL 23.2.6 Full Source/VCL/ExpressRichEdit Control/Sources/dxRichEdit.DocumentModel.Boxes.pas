...
type
  ...
  TdxCounterItemList = class(TList<TdxCounterItem>); // for internal use

  { TdxCounter }

  TdxCounter = class sealed // for internal use
  strict private
  ...
  TdxCounters = class sealed // for internal use
  private
  ...
  strict private
    function GetItem(Index: TdxListIndex): TdxFloatingObjectBox;
  public
    property Items[Index: TdxListIndex]: TdxFloatingObjectBox read GetItem; default;
  end;
  ...
  strict private
    ...
    FWasRestart: Boolean;
    procedure SetFirstRow(const Value: TdxRow);
  protected
    function GetActualSizeBounds: TRect; override;
    function GetX: Integer;
    function GetY: Integer;
  ...
  public
    ...
    property ExtendedBounds: TRect read FExtendedBounds write FExtendedBounds;
    property FirstRow: TdxRow read FFirstRow write SetFirstRow;
  ...
  TdxParagraphFrameBoxList = class sealed(TdxBoxList) // for internal use
  strict private
    function GetItem(Index: TdxListIndex): TdxParagraphFrameBox;
  public
    property Items[Index: TdxListIndex]: TdxParagraphFrameBox read GetItem; default;
  end;
  ...
  public
    procedure RegisterSuccessfulItemHitTest(ACalculator: TdxBoxHitTestCustomCalculator; AItem: TdxBox); override;
  ...
  public
    procedure RegisterSuccessfulItemHitTest(ACalculator: TdxBoxHitTestCustomCalculator; AItem: TdxBox); override; final;
    procedure RegisterFailedItemHitTest(ACalculator: TdxBoxHitTestCustomCalculator); override; final;
  end;

  { TdxFootNotePageArea }

  TdxFootNotePageArea = class sealed(TdxPageArea) // for internal use
  strict private
  ...
  TdxFootNotePageAreaList = class(TdxBoxList) // for internal use
  private
    function GetItem(Index: TdxListIndex): TdxFootNotePageArea; inline;
  public
    property Items[Index: TdxListIndex]: TdxFootNotePageArea read GetItem; default;
  end;

  { TdxHeaderFooterPageAreaBase }

  TdxHeaderFooterPageAreaBase = class abstract(TdxPageArea) // for internal use
  strict private
    FContentBounds: TRect;
  public
    property ContentBounds: TRect read FContentBounds write FContentBounds;
  ...
  TdxHeaderPageArea = class sealed(TdxHeaderFooterPageAreaBase) // for internal use
  strict private
  ...
  TdxFooterPageArea = class sealed(TdxHeaderFooterPageAreaBase) // for internal use
  strict private
  ...
  TdxParagraphFrameBoxCollection = class sealed(TdxObjectList<TdxParagraphFrameBox>) // for internal use
  public
  ...
  TdxColumnExtendedBoxes = class sealed // for internal use
  strict private
  ...
  TdxFloatingObjectAnchorBox = class sealed(TdxSinglePositionBox) // for internal use
  strict private
    FActualBounds: TRect;
    FShapeBounds: TRect;
    FContentBounds: TRect;
    ...
    procedure SetFloatingObjectBox(const Value: TdxFloatingObjectBox);
  protected
    function GetActualSizeBounds: TRect; override;
  public
    destructor Destroy; override;
    ...
    property ActualBounds: TRect read FActualBounds write FActualBounds;
    property ContentBounds: TRect read FContentBounds write FContentBounds;
    property FloatingObjectBox: TdxFloatingObjectBox read FFloatingObjectBox write SetFloatingObjectBox;
    property ShapeBounds: TRect read FShapeBounds write FShapeBounds;
  end;
  ...
  TdxLayoutDependentTextBox = class(TdxTextBox) // for internal use
  strict private
  ...
  TdxNumberingListBoxInfo = class(TdxBoxInfo) // for internal use
  protected
  ...
  TdxNumberingListBoxWithSeparator = class(TdxNumberingListBox) // for internal use
  strict private
  ...
  { TdxExactPageComparable }

  TdxExactPageComparable = record
  strict private
    FPieceTable: TdxCustomPieceTable;
    FLogPosition: TdxDocumentLogPosition;
  ...
  public
    ...
    function ExactPageAndLogPositionCompare(const Value: TdxBoxBase): Integer;
    function ExactPageAreaAndLogPositionCompare(const Value: TdxBoxBase): Integer;
    function ExactColumnAndLogPositionCompare(const Value: TdxBoxBase): Integer;
  ...
  TdxParagraphBoxCollection = class(TdxSimpleParagraphBoxCollection) // for internal use
  strict private
  ...
  TdxCustomMarkBox = class(TdxReferencedObject) // for internal use
  strict private
    FCustomMark: TObject; 
    FBounds: TRect;
  public
  ...
  TdxCustomMarkBoxCollection = class(TdxReferencedObjectList<TdxCustomMarkBox>) // for internal use
  public
    procedure MoveVertically(ADeltaY: Integer);
  end;
  ...
  TdxLineNumberBox = class(TdxMultiPositionBox) // for internal use
  strict private
    FRow: TdxRow;
  ...
  TdxLineNumberBoxCollection = class(TdxBoxCollectionBase<TdxLineNumberBox>) // for internal use
  public
    procedure RegisterSuccessfulItemHitTest(ACalculator: TdxBoxHitTestCustomCalculator; AItem: TdxBox); override; final;
    procedure RegisterFailedItemHitTest(ACalculator: TdxBoxHitTestCustomCalculator); override; final;
  end;
  ...
  TdxRowExtendedBoxes = class(TdxSimpleRowExtendedBoxes) // for internal use
  strict private
  ...
  TdxTableCellRow = class(TdxRow) // for internal use
  strict private
  ...
  public
    ...
    function IsTableCellRow: Boolean; override;
  ...
  TdxDetailRow = class // for internal use
  strict private
  ...
  TdxTableCellViewInfo = class(TdxReferencedObject) // for internal use
  strict private
  ...
  TdxTableCellViewInfoCollection = class(TdxReferencedObjectList<TdxTableCellViewInfo>) // for internal use
  public
  ...
  TdxTableBorderViewInfoBase = class abstract (TcxIUnknownObject) // for internal use
  protected
  ...
  TdxParagraphHorizontalBorderViewInfo = class(TdxTableBorderViewInfoBase) // for internal use
  strict private
  ...
  TdxCornerViewInfoBase = class abstract // for internal use
  strict private
    FWidthF: Single;
    FHeightF: Single;
  ...
  TdxNoneLineCornerViewInfo = class(TdxCornerViewInfoBase) // for internal use
  protected
  ...
  TdxSingleLineCornerViewInfo = class(TdxCornerViewInfoBase) // for internal use
  strict private
  ...
  TdxTableCellVerticalAnchor = class // for internal use
  strict private
  ...
  public
    ...
    function CloneWithNewVerticalPosition(ANewVerticalPosition: TdxLayoutUnit): TdxTableCellVerticalAnchor;
    procedure MoveVertically(ADeltaY: TdxLayoutUnit);
  ...
  TdxTableCellVerticalAnchorList = class sealed(TdxList<TdxTableCellVerticalAnchor>); // for internal use

  { TdxTableCellVerticalAnchorCollection }

  TdxTableCellVerticalAnchorCollection = class sealed // for internal use
  strict private
  ...
  TdxTableCellVerticalBorderViewInfo = class(TdxTableBorderViewInfoBase) // for internal use
  public
  ...
  TdxTableCellVerticalBorderViewInfoList = class sealed(TdxObjectList<TdxTableCellVerticalBorderViewInfo>); // for internal use

  { TableRowViewInfoBase }

  TdxTableRowViewInfoBase = class abstract(TdxReferencedObject) // for internal use
  strict private
  ...
  TdxTableRowViewInfoWithCellSpacing = class(TdxTableRowViewInfoBase) // for internal use
  strict private
  ...
  TdxTableRowViewInfoCollection = class sealed(TdxReferencedObjectList<TdxTableRowViewInfoBase>) // for internal use
  strict private
    FTableViewInfo: TdxTableViewInfo;
  public
  ...
  TdxTableRowViewInfoNoCellSpacing = class(TdxTableRowViewInfoBase) // for internal use
  protected
    function CalculateVerticalBorders: TdxTableCellVerticalBorderViewInfoList; override;
  ...
  TdxTableViewInfo = class sealed(TdxReferencedObject) // for internal use
  strict private
    FTable: TdxTable;
  ...
  TdxTableViewInfoCollection = class sealed(TdxReferencedObjectList<TdxTableViewInfo>) // for internal use
  public
    procedure ExportTo(const AExporter: IdxDocumentLayoutExporter);
    procedure MoveVertically(ADeltaY: TdxLayoutUnit);
    procedure ExportBackground(const AExporter: IdxDocumentLayoutExporter);
  ...
  TdxTableBorderCalculator = class // for internal use
  strict private class var
  ...
  TdxTableCellVerticalBorderCalculator = record
  private
    FTable: TdxTable;
  ...
  TdxBookmarkStartBox = class(TdxVisitableDocumentIntervalBox) // for internal use
  public
    procedure ExportTo(const AExporter: IdxSimpleDocumentLayoutExporter); override;
  end;
  ...
  TdxBookmarkEndBox = class(TdxVisitableDocumentIntervalBox) // for internal use
  public
    procedure ExportTo(const AExporter: IdxSimpleDocumentLayoutExporter); override;
  end;
  ...
  TdxTableCellVerticalAnchorYComparable = record
  strict private
    FPos: Integer;
  public
  ...
  TdxTableRowAnchorComparable = record
  private
    FPos: Integer;
  ...
  TdxTableCellAnchorComparable = record
  private
    FPos: Integer;
  public
    constructor Create(APos: Integer);
...
const
  dxThisUnitName = 'dxRichEdit.DocumentModel.Boxes';
...
type
  ...
  TdxParagraphFrameBoxAndParagraphIndexComparable = record
  strict private
    FParagraphIndex: TdxParagraphIndex;
  public
  ...
  { TdxVerticalBorderAndColumnIndexComparable }

  TdxVerticalBorderAndColumnIndexComparable = record
  strict private
    FLayoutBorderIndex: Integer;
  public
  ...
  TdxCounterItemAndLogPositionComparable = record
  strict private
    FLogPosition: TdxDocumentLogPosition;
  public
  ...
  TdxTableBorderWithSpacingViewInfoBase = class abstract (TdxTableBorderViewInfoBase) // for internal use
  strict private
...
constructor TdxVerticalBorderAndColumnIndexComparable.Create(ALayoutBorderIndex: Integer);
begin
  FLayoutBorderIndex := ALayoutBorderIndex;
end;

function TdxVerticalBorderAndColumnIndexComparable.CompareTo(const AOther: TdxTableCellVerticalBorderViewInfo): Integer;
begin
...
begin
  ...
  AComparable := TdxBoxLogPositionComparable.Create(APieceTable,
    APieceTable.Paragraphs[ACell.StartParagraphIndex].LogPosition);
  if not TdxAlgorithms1<TdxBoxBase>.BinarySearch(ARows, AComparable.BoxAndLogPositionCompare, AFirstRowIndex) then
  ...
  if not TdxAlgorithms1<TdxBoxBase>.BinarySearch(ARows, AComparable.BoxAndLogPositionCompare, ALastRowIndex) then
  begin
    Dec(ALastRowIndex);
    Assert((AFirstRowIndex >= ARows.Count) or (ARows[AFirstRowIndex].Paragraph.Index >= ACell.StartParagraphIndex));
  end;
...
begin
  ...
  if not TdxAlgorithms1<TdxBoxBase>.BinarySearch(AColumn.Rows, AComparable.BoxAndLogPositionCompare, Result) then
  begin
...
begin
  {$IFDEF DX_INITIALIZATION_LOGGING}TdxUnitSectionsLogger.ConstructorStarted(UnitName, 'TdxTableBorderCalculator.Initialize', SysInit.HInstance);{$ENDIF}
  ...
  {$IFDEF DX_INITIALIZATION_LOGGING}TdxUnitSectionsLogger.ConstructorFinished(UnitName, 'TdxTableBorderCalculator.Initialize', SysInit.HInstance);{$ENDIF}
end;
...
begin
  ...
  if not TdxAlgorithms1<TdxTableCellVerticalAnchor>.BinarySearch(FAnchors, AComparable.CompareTo, Result) then
    Dec(Result);
...
begin
  {$IFDEF DX_INITIALIZATION_LOGGING}TdxUnitSectionsLogger.ConstructorStarted(UnitName, 'TdxSingleLineCornerViewInfo.Initialize', SysInit.HInstance);{$ENDIF}
  SetLength(FSingleLinePattern, 1);
  SetLength(FSingleLinePattern[0], 1);
  FSingleLinePattern[0][0] := True;
  {$IFDEF DX_INITIALIZATION_LOGGING}TdxUnitSectionsLogger.ConstructorFinished(UnitName, 'TdxSingleLineCornerViewInfo.Initialize', SysInit.HInstance);{$ENDIF}
end;
...
begin
  {$IFDEF DX_INITIALIZATION_LOGGING}TdxUnitSectionsLogger.ConstructorStarted(UnitName, 'TdxDoubleLineCornerViewInfo.Initialize', SysInit.HInstance);{$ENDIF}
  ...
  {$IFDEF DX_INITIALIZATION_LOGGING}TdxUnitSectionsLogger.ConstructorFinished(UnitName, 'TdxDoubleLineCornerViewInfo.Initialize', SysInit.HInstance);{$ENDIF}
end;
...
begin
  {$IFDEF DX_INITIALIZATION_LOGGING}TdxUnitSectionsLogger.ConstructorStarted(UnitName, 'TdxTripleLineCornerViewInfo.Initialize', SysInit.HInstance);{$ENDIF}
  ...
  {$IFDEF DX_INITIALIZATION_LOGGING}TdxUnitSectionsLogger.ConstructorFinished(UnitName, 'TdxTripleLineCornerViewInfo.Initialize', SysInit.HInstance);{$ENDIF}
end;
...
var
  AComparer: TdxVerticalBorderAndColumnIndexComparable;
begin
  AComparer := TdxVerticalBorderAndColumnIndexComparable.Create(ALayoutBorderIndex);
  TdxAlgorithms1<TdxTableCellVerticalBorderViewInfo>.BinarySearch(VerticalBorders, AComparer.CompareTo, Result);
end;
...
function TdxTableCellRow.IsTableCellRow: Boolean;
begin
  Result := True;
end;
...
procedure TdxRowCollection.RegisterSuccessfulItemHitTest(ACalculator: TdxBoxHitTestCustomCalculator; AItem: TdxBox);
var
...
destructor TdxFloatingObjectAnchorBox.Destroy;
begin
  FloatingObjectBox := nil;
  inherited Destroy;
end;
...
procedure TdxFloatingObjectAnchorBox.SetFloatingObjectBox(const Value: TdxFloatingObjectBox);
begin
  if FFloatingObjectBox <> Value then
  begin
    TdxReferencedObject.Release(FFloatingObjectBox);
    FFloatingObjectBox := Value;
    TdxReferencedObject.AddReference(FFloatingObjectBox);
  end;
end;
...
function TdxFootNotePageAreaList.GetItem(Index: TdxListIndex): TdxFootNotePageArea;
begin
...
procedure TdxColumnCollection.RegisterSuccessfulItemHitTest(
...
procedure TdxPageAreaCollection.RegisterSuccessfulItemHitTest(ACalculator: TdxBoxHitTestCustomCalculator; AItem: TdxBox);
var
  ABoxCalculator: TdxBoxHitTestCalculator;
begin
  ABoxCalculator := TdxBoxHitTestCalculator(ACalculator);
...
begin
  {$IFDEF DX_INITIALIZATION_LOGGING}TdxUnitSectionsLogger.ConstructorStarted(UnitName, 'TdxParagraphFrameBox.Initialize', SysInit.HInstance);{$ENDIF}
  FIndexComparer := TIndexComparer.Create;
  {$IFDEF DX_INITIALIZATION_LOGGING}TdxUnitSectionsLogger.ConstructorFinished(UnitName, 'TdxParagraphFrameBox.Initialize', SysInit.HInstance);{$ENDIF}
end;

class destructor TdxParagraphFrameBox.Finalize;
begin
  {$IFDEF DX_INITIALIZATION_LOGGING}TdxUnitSectionsLogger.DestructorStarted(UnitName, 'TdxParagraphFrameBox.Finalize', SysInit.HInstance);{$ENDIF}
  FreeAndNil(FIndexComparer);
  {$IFDEF DX_INITIALIZATION_LOGGING}TdxUnitSectionsLogger.DestructorFinished(UnitName, 'TdxParagraphFrameBox.Finalize', SysInit.HInstance);{$ENDIF}
end;
...
begin
  ...
  Result.Rotate(AAngle, dxPointF(ABounds.CenterPoint));
end;
...
procedure TdxParagraphFrameBox.SetFirstRow(const Value: TdxRow);
begin
  if FFirstRow <> Value then
  begin
    TdxRow.Release(FFirstRow);
    FFirstRow := Value;
    TdxRow.AddReference(FFirstRow);
  end;
end;
...
function TdxParagraphFrameBoxList.GetItem(Index: TdxListIndex): TdxParagraphFrameBox;
begin
...
begin
  ...
  if not TdxAlgorithms1<TdxParagraphFrameBox>.BinarySearch(Self, AComparable.CompareTo, AFirstIndex) then
  begin
...
begin
  ...
  TdxAlgorithms<TdxCounterItem>.BinarySearch(FItems, AComparable.CompareTo, AIndex);
...
begin
  AComparable := TdxCounterItemAndLogPositionComparable.Create(ALogPosition);
  if TdxAlgorithms<TdxCounterItem>.BinarySearch(FItems, AComparable.CompareTo, AIndex) then
...
procedure TdxPageCollection.RegisterSuccessfulItemHitTest(ACalculator: TdxBoxHitTestCustomCalculator; AItem: TdxBox);
var
  ABoxCalculator: TdxBoxHitTestCalculator;
begin
  ABoxCalculator := TdxBoxHitTestCalculator(ACalculator);
...
begin
  ...
  begin
    TdxReferencedObject.Release(FFooter);
    FFooter := Value;
    TdxReferencedObject.AddReference(FFooter);
  end;
end;
...
begin
  ...
  begin
    TdxReferencedObject.Release(FHeader);
    FHeader := Value;
    TdxReferencedObject.AddReference(FHeader);
  end;
end;
...
procedure TdxLineNumberBoxCollection.RegisterSuccessfulItemHitTest(ACalculator: TdxBoxHitTestCustomCalculator; AItem: TdxBox);
begin
//do nothing
end;
...
begin
  {$IFDEF DX_INITIALIZATION_LOGGING}TdxUnitSectionsLogger.ConstructorStarted(UnitName, 'TdxFloatingObjectBox.Initialize', SysInit.HInstance);{$ENDIF}
  FZOrderComparer := TZOrderComparer.Create;
  {$IFDEF DX_INITIALIZATION_LOGGING}TdxUnitSectionsLogger.ConstructorFinished(UnitName, 'TdxFloatingObjectBox.Initialize', SysInit.HInstance);{$ENDIF}
end;

class destructor TdxFloatingObjectBox.Finalize;
begin
  {$IFDEF DX_INITIALIZATION_LOGGING}TdxUnitSectionsLogger.DestructorStarted(UnitName, 'TdxFloatingObjectBox.Finalize', SysInit.HInstance);{$ENDIF}
  FreeAndNil(FZOrderComparer);
  {$IFDEF DX_INITIALIZATION_LOGGING}TdxUnitSectionsLogger.DestructorFinished(UnitName, 'TdxFloatingObjectBox.Finalize', SysInit.HInstance);{$ENDIF}
end;
...
class function TdxFloatingObjectBox.CreateTransformUnsafe(const AAngle: Single; const ABounds: TRect): TdxTransformMatrix;
begin
  if IsZero(Single(dxFMod(AAngle, 360))) then
    Exit(nil);
  Result := TdxTransformMatrix.Create;
  Result.Rotate(AAngle, ABounds.CenterPoint.ToPointF);
end;
...
begin
  ...
  if not Safe.Cast(ARun.Content, TdxTextBoxFloatingObjectContent, AContent) then
    Exit(ContentBounds);
...
function TdxFloatingObjectBoxList.GetItem(Index: TdxListIndex): TdxFloatingObjectBox;
begin
...
function TdxTableCellVerticalAnchor.CloneWithNewVerticalPosition(
  ANewVerticalPosition: TdxLayoutUnit): TdxTableCellVerticalAnchor;
var
  ACellBorders: TdxHorizontalCellBordersInfoList;
begin
  ACellBorders := CellBorders.Clone;
  Result := TdxTableCellVerticalAnchor.Create(ANewVerticalPosition, BottomTextIndent, ACellBorders);
...
constructor TdxExactPageComparable.Create(APieceTable: TdxCustomPieceTable; ALogPosition: TdxDocumentLogPosition);
begin
  FPieceTable := APieceTable;
  FLogPosition := ALogPosition;
end;

function TdxExactPageComparable.ExactColumnAndLogPositionCompare(const Value: TdxBoxBase): Integer;
var
  AColumn: TdxColumn;
  ACell: TdxTableCell;
  AParagraph: TdxParagraph;
...
function TdxExactPageComparable.ExactPageAndLogPositionCompare(const Value: TdxBoxBase): Integer;
var
...
begin
  ...
  if AFirstPos.LogPosition > LogPosition then
    ...
    begin
      ...
      AFirstAreaCompareResult := ExactPageAreaAndLogPositionCompare(APage.Areas[0]);
      if (APage.Areas.Count = 1) or (AFirstAreaCompareResult >= 0) then
        Result := AFirstAreaCompareResult
      else
      begin
        ALastAreaCompareResult := ExactPageAreaAndLogPositionCompare(APage.Areas.Last);
...
function TdxExactPageComparable.ExactPageAreaAndLogPositionCompare(const Value: TdxBoxBase): Integer;
var
  AFirstPos: TdxDocumentModelPosition;
  AArea: TdxPageArea;
...
begin
  ...
  begin
    ...
    begin
      AFirstBoxCompareResult := ExactColumnAndLogPositionCompare(AArea.Columns[0]);
      if (AArea.Columns.Count = 1) or (AFirstBoxCompareResult >= 0) then
        Result := AFirstBoxCompareResult
      else
      begin
        ALastBoxCompareResult := ExactColumnAndLogPositionCompare(AArea.Columns.Last);
...
function TdxExactPageComparable.FindTable(ATables: TdxTableViewInfoCollection; ACell: TdxTableCell;
  out ACellViewInfo: TdxTableCellViewInfo): TdxTableViewInfo;
var
