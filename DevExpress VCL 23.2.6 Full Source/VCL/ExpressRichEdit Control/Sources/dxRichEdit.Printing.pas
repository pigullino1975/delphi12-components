...
unit dxRichEdit.Printing; // for internal use
...
type
  ...
  protected
    ...
    function CreateDocumentPrinterFormattingController(ADocumentLayout: TdxDocumentLayout;
      APieceTable: TdxPieceTable): TdxDocumentFormattingController; virtual;
  ...
  protected
    ...
    function CreateDocumentPrinterController: TdxDocumentPrinterController; override;
    function CreateDocumentPrinterFormattingController(ADocumentLayout: TdxDocumentLayout; APieceTable: TdxPieceTable): TdxDocumentFormattingController; override;
...
const
  dxThisUnitName = 'dxRichEdit.Printing';
...
begin
  AFormattingController := TdxDocumentPrinterFormattingController(CreateDocumentPrinterFormattingController(ADocumentLayout, PieceTable));
...
function TdxSimpleDocumentPrinter.CreateDocumentPrinterFormattingController(ADocumentLayout: TdxDocumentLayout;
  APieceTable: TdxPieceTable): TdxDocumentFormattingController;
begin
...
function TdxTextBoxFloatingObjectContentPrinter.CreateDocumentPrinterFormattingController(ADocumentLayout: TdxDocumentLayout; APieceTable: TdxPieceTable): TdxDocumentFormattingController;
begin
