...
unit dxRichEdit.DocumentModel.History.Simple; // for internal use
...
uses
  Types, SysUtils, Classes, Generics.Defaults, Generics.Collections, Contnrs, RTLConsts, dxCoreClasses,
...
const
  dxThisUnitName = 'dxRichEdit.DocumentModel.History.Simple';
