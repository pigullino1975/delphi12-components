...
unit dxRichEdit.Import.Rtf.DestinationPageBackground; // for internal use
...
const
  dxThisUnitName = 'dxRichEdit.Import.Rtf.DestinationPageBackground';
...
begin
  {$IFDEF DX_INITIALIZATION_LOGGING}TdxUnitSectionsLogger.ConstructorStarted(UnitName, 'TdxPageBackgroundDestination.Initialize', SysInit.HInstance);{$ENDIF}
  FKeywordHT := CreateKeywordHT;
  {$IFDEF DX_INITIALIZATION_LOGGING}TdxUnitSectionsLogger.ConstructorFinished(UnitName, 'TdxPageBackgroundDestination.Initialize', SysInit.HInstance);{$ENDIF}
end;

class destructor TdxPageBackgroundDestination.Finalize;
begin
  {$IFDEF DX_INITIALIZATION_LOGGING}TdxUnitSectionsLogger.DestructorStarted(UnitName, 'TdxPageBackgroundDestination.Finalize', SysInit.HInstance);{$ENDIF}
  FreeAndNil(FKeywordHT);
  {$IFDEF DX_INITIALIZATION_LOGGING}TdxUnitSectionsLogger.DestructorFinished(UnitName, 'TdxPageBackgroundDestination.Finalize', SysInit.HInstance);{$ENDIF}
end;
