...
unit dxRichEdit.View.PrintLayout; // for internal use
...
type
  ...
  TdxSimplePieceTablePrimaryFormatter = record
  strict private
  ...
  public
    ...
    function Format(AMaxHeight: Integer; AController: TdxDocumentFormattingController): Integer;
  ...
  public
    ...
    function CreateDocumentLayoutExporter(APainter: TdxPainter; AAdapter: TdxGraphicsDocumentLayoutExporterAdapter;
      APageViewInfo: TdxPageViewInfo; const ABounds: TRect): TdxDocumentLayoutExporter; override; // for internal use
...
function GetSkinEdges(AElement: TdxSkinElement): TRect;
...
const
  dxThisUnitName = 'dxRichEdit.View.PrintLayout';
...
type
  ...
  protected
    ...
    procedure SetPageNumberSource(const AValue: TdxPage);
  public
  ...
  strict private
    ...
    function GetRichEditControl: IdxRichEditControl; inline;
  protected
    FControl: TdxVCLControl;
    function GetView: TdxPrintLayoutView;
    function GetOwner: IdxHeaderFooterDecoratorPainterOwner;
    procedure DrawPageDecorators(APage: TdxPage; APainter: TdxPainter);
    procedure DrawHeaderFrame(APage: TdxPage; AArea: TdxPageArea; APainter: TdxPainter);
    procedure DrawFooterFrame(APage: TdxPage; AArea: TdxPageArea; APainter: TdxPainter);
    function DrawHeaderFooterLine(APainter: TdxPainter; const AInitialLineBounds: TRect): TRect;
    function GetCaption(AHeaderFooter: TdxSectionHeaderFooterBase; APage: TdxPage): string;
    function MeasureString(const ACaption: string; APainter: TdxGdiPlusPainter): TSize;
    function CalculateHeaderCaptionBaseBounds(const ACaption: string; const AHeaderLineBounds: TRect; AGdiPlusPainter: TdxGdiPlusPainter): TRect;
    function CalculateHeaderLinkCaptionBaseBounds(const ACaption: string; const AHeaderLineBounds: TRect; AGdiPlusPainter: TdxGdiPlusPainter): TRect;
    function CalculateFooterCaptionBaseBounds(const ACaption: string; const AHeaderLineBounds: TRect; AGdiPlusPainter: TdxGdiPlusPainter): TRect;
    function CalculateFooterLinkCaptionBaseBounds(const ACaption: string; const AFooterLineBounds: TRect; AGdiPlusPainter: TdxGdiPlusPainter): TRect;
    procedure DrawHeaderCaptionBackground(const ABounds: TRect; AGdiPlusPainter: TdxGdiPlusPainter);
    procedure DrawFooterCaptionBackground(const ABounds: TRect; AGdiPlusPainter: TdxGdiPlusPainter);
    function CreateHeaderCaptionBackgroundPath(const ABounds: TRect): TdxGPPath;
    function CreateFooterCaptionBackgroundPath(const ABounds: TRect): TdxGPPath;
    procedure DrawHeaderFooterCaptionBackground(APath: TdxGPPath; AGdiPlusPainter: TdxGdiPlusPainter);
    procedure DrawCaptionText(const ACaption: string; ABounds: TRect; AGdiPlusPainter: TdxGdiPlusPainter; AOffset: Integer);
    function CreateHeaderFooterLinePen: TdxGPPen;
    function CreateHeaderFooterCaptionFont: TFont;

    property View: TdxPrintLayoutView read FView;
    property Owner: IdxHeaderFooterDecoratorPainterOwner read FOwner;
    property DocumentModel: TdxDocumentModel read GetDocumentModel;
  ...
  protected
    ...
    function GetActualPageBackColor: TdxAlphaColor; reintroduce;
    function CalculatePageViewInfoPixelBounds(APageViewInfo: TdxPageViewInfo): TRect;
  ...
  private
    ...
    function GetView: TdxRichEditView; inline;
    function GetViewInfo: TdxRichEditViewInfo; inline;
  protected
...
function TdxPrintLayoutViewPageViewInfoGenerator.GetView: TdxRichEditView;
begin
  Result := TdxRichEditView(FView);
end;

function TdxPrintLayoutViewPageViewInfoGenerator.GetViewInfo: TdxRichEditViewInfo;
begin
...
begin
  ...
  begin
    ACollection.RegisterSuccessfulItemHitTest(Self, AArea);
    Exit(True);
  end
  else
  begin
...
begin
  ...
  if not TdxAlgorithms1<TdxTableRowViewInfoBase>.BinarySearch(ATable.Rows, AComparable.CompareTo, ATableRowIndex) then
    Exit(nil);
...
begin
  ...
  if TdxAlgorithms1<TdxBoxBase>.BinarySearch(ARows, AComparable.CompareTo, ARowIndex) then
...
begin
  ...
  Result.Y := DocumentLayout.DocumentModel.ToDocumentLayoutUnitConverter.ToLayoutUnits(Section.Margins.HeaderOffset);
  Result.Height := Page.Bounds.Height div 2;
end;
...
begin
  Result := Page.ClientBounds;
  AMaxHeight := Page.Bounds.Height div 2;
  Result.Y := Page.Bounds.Height - AMaxHeight - DocumentLayout.DocumentModel.ToDocumentLayoutUnitConverter.ToLayoutUnits(Section.Margins.FooterOffset);
...
begin
  ...
  Result.Width := HeaderFooterLineThickness;
...
begin
  ...
  try
    ...
    try
      AGraphics.PageUnit := TdxGraphicUnit.guPixel;
