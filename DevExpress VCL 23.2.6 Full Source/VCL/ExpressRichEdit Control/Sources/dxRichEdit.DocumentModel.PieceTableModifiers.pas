...
unit dxRichEdit.DocumentModel.PieceTableModifiers; // for internal use
...
type
  ...
  strict private
    FRichEditHistoryItemClass: TdxTextRunChangeCaseHistoryItemClass;
  protected
    function CreateHistoryItem(APieceTable: TdxPieceTable; ARunIndex: TdxRunIndex): TdxTextRunChangeCaseHistoryItem; inline;
    constructor Create(ARichEditHistoryItemClass: TdxTextRunChangeCaseHistoryItemClass);
  public
    procedure ModifyTextRun(ARun: TdxTextRunBase; ARunIndex: TdxRunIndex); override;
    procedure ChangeRunCase(ATextRun: TdxTextRunBase; ARunIndex: TdxRunIndex);
  end;
  ...
  TdxMergedSectionPropertyModifier<T: class> = class abstract(TdxSectionPropertyModifier<T>)
  public
    function Merge(const ALeftValue, ARightValue: T): T; virtual; abstract;
  ...
  protected
    ...
    function ResetHorizontalPositionAlignment: Boolean;
    function ResetVerticalPositionAlignment(ALogPosition: TdxDocumentLogPosition): Boolean;
  ...
  { TdxPieceTableModifier }

  TdxPieceTableModifiers = class sealed
  public
    class function CreateFloatingObjectRunTextWrapTypeModifier(ANewValue: TdxFloatingObjectTextWrapType): TdxFloatingObjectRunPropertyModifier<TdxFloatingObjectTextWrapType>; static;
    class function CreateFloatingObjectRunHorizontalPositionAlignmentModifier(ANewValue: TdxFloatingObjectHorizontalPositionAlignment): TdxFloatingObjectRunPropertyModifierBase; static;
    class function CreateFloatingObjectRunVerticalPositionAlignmentModifier(ANewValue: TdxFloatingObjectVerticalPositionAlignment): TdxFloatingObjectRunPropertyModifierBase; static;
    class function CreateFloatingObjectRunHorizontalPositionTypeModifier(ANewValue: TdxFloatingObjectHorizontalPositionType): TdxFloatingObjectRunPropertyModifierBase; static;
    class function CreateFloatingObjectRunVerticalPositionTypeModifier(ANewValue: TdxFloatingObjectVerticalPositionType): TdxFloatingObjectRunPropertyModifierBase; static;
    class function CreateFloatingObjectRunFillColorModifier(ANewValue: TdxAlphaColor): TdxFloatingObjectRunPropertyModifier<TdxAlphaColor>; static;
    class function CreateFloatingObjectRunOutlineColorModifier(ANewValue: TdxAlphaColor): TdxFloatingObjectRunPropertyModifier<TdxAlphaColor>; static;
    class function CreateFloatingObjectRunOutlineWidthModifier(ANewValue: Integer): TdxFloatingObjectRunPropertyModifierBase; static;
    class function CreateFloatingObjectRunOutlineWidthAndColorModifier(ANewValue: Integer): TdxFloatingObjectRunPropertyModifier<Integer>; static;
    class function CreateFloatingObjectRunIsBehindDocTextWrapTypeNoneModifier(ANewValue: Boolean): TdxFloatingObjectRunPropertyModifier<Boolean>; static;
    class function CreateRunFontNamePropertyModifier(const ANewValue: string): TdxRunPropertyModifier<string>; static;
    class function CreateRunFontSizePropertyModifier(ANewValue: Single): TdxRunPropertyModifier<Single>; static;
    class function CreateRunFontBoldModifier(ANewValue: Boolean): TdxRunPropertyModifier<Boolean>; static;
    class function CreateRunFontItalicModifier(ANewValue: Boolean): TdxRunPropertyModifier<Boolean>; static;
    class function CreateRunFontUnderlineTypeModifier(ANewValue: TdxUnderlineType): TdxRunPropertyModifier<TdxUnderlineType>; static;
    class function CreateRunFontStrikeoutTypeModifier(ANewValue: TdxStrikeoutType): TdxRunPropertyModifier<TdxStrikeoutType>; static;
    class function CreateRunBackColorModifier(ANewValue: TdxAlphaColor): TdxRunPropertyModifier<TdxAlphaColor>; static;
    class function CreateRunForeColorModifier(ANewValue: TdxAlphaColor): TdxRunPropertyModifier<TdxAlphaColor>; static;
    class function CreateRunUnderlineColorModifier(ANewValue: TdxAlphaColor): TdxRunPropertyModifier<TdxAlphaColor>; static;
    class function CreateRunScriptModifier(ANewValue: TdxCharacterFormattingScript): TdxRunPropertyModifier<TdxCharacterFormattingScript>; static;
    class function CreateRunFontModifier(const ANewValue: TFont): TdxRunPropertyModifier<TFont>; static;
    class function CreateRunIncrementFontSizeModifier: TdxRunPropertyModifier<Integer>; static;
    class function CreateRunDecrementFontSizeModifier: TdxRunPropertyModifier<Integer>; static;
    class function CreateRunIncreaseFontSizeModifier(APredefinedFontSizeCollection: TdxPredefinedFontSizeCollection): TdxRunPropertyModifier<Integer>; static;
    class function CreateRunDecreaseFontSizeModifier(APredefinedFontSizeCollection: TdxPredefinedFontSizeCollection): TdxRunPropertyModifier<Integer>; static;
    class function CreateParagraphAlignmentModifier(ANewValue: TdxParagraphAlignment): TdxParagraphPropertyModifier<TdxParagraphAlignment>; static;
    class function CreateParagraphLeftIndentModifier(ANewValue: Integer): TdxParagraphPropertyModifier<Integer>; static;
    class function CreateParagraphRightIndentModifier(ANewValue: Integer): TdxParagraphPropertyModifier<Integer>; static;
    class function CreateAssignParagraphLeftIndentModifier(ALeftIndent, AMaxValue: Integer): TdxParagraphPropertyModifier<Integer>; static;
    class function CreateParagraphFirstLineIndentModifier(ANewValue: Integer): TdxParagraphPropertyModifier<Integer>; overload; static;
    class function CreateParagraphFirstLineIndentModifier(AFirstLineIndent, AMaxIndent: Integer): TdxParagraphPropertyModifier<Integer>; overload; static;
    class function CreateParagraphSpacingModifier(ANewValue: TdxParagraphLineSpacing): TdxParagraphPropertyModifier<TdxParagraphLineSpacing>; static;
    class function CreateRunFontColorPropertyModifier(ANewValue: TdxAlphaColor): TdxRunPropertyModifier<TdxAlphaColor>; static;
    class function CreateTabFormattingInfoModifier(ANewValue: TdxTabFormattingInfo; ADefaultTabWidth: Integer): TdxMergedParagraphPropertyModifier<TdxTabFormattingInfo>; static;
    class function CreateOwnTabFormattingInfoModifier(ANewValue: TdxTabFormattingInfo; ADefaultTabWidth: Integer): TdxMergedParagraphPropertyModifier<TdxTabFormattingInfo>; static;
    class function CreateSectionPageOrientationLandscapeModifier(ANewValue: Boolean): TdxSectionPropertyModifier<Boolean>; static;
    class function CreateSectionLineNumberingStepAndRestartModifier(ANewValue: TdxLineNumberingRestart): TdxSectionPropertyModifier<TdxLineNumberingRestart>; static;
    class function CreateSectionLineNumberingModifier(const ANewValue: TdxLineNumberingInfo): TdxSectionPropertyModifier<TdxLineNumberingInfo>; static;
    class function CreateSectionPageSetupModifier(const ANewValue: TdxPageSetupInfo): TdxSectionPropertyModifier<TdxPageSetupInfo>; static;
    class function CreateSectionColumnsSetupModifier(const ANewValue: TdxColumnsInfoUI): TdxSectionPropertyModifier<TdxColumnsInfoUI>; static;
    class function CreateUpperCaseModifier: TdxRunChangeCaseModifierBase; static;
    class function CreateLowerCaseModifier: TdxRunChangeCaseModifierBase; static;
    class function CreateRunToggleCaseModifier: TdxRunChangeCaseModifierBase; static;

    class function CreateSectionInserter(APieceTable: TdxCustomPieceTable): TdxParagraphInserter; static;
    class function CreateFootNoteRunInserter(APieceTable: TdxCustomPieceTable): TdxObjectInserter; static;
    class function CreateEndNoteRunInserter(APieceTable: TdxCustomPieceTable): TdxObjectInserter; static;
    class function CreateFloatingObjectAnchorInserter(APieceTable: TdxCustomPieceTable): TdxPieceTableObjectInserter; static;
    class function CreateFieldSymbolResultInserter(APieceTable: TdxCustomPieceTable): TdxSimpleTextInserter; static;
    class function CreateTextInserter(APieceTable: TdxCustomPieceTable): TdxSimpleTextInserter; static;
  end;
...
const
  dxThisUnitName = 'dxRichEdit.DocumentModel.PieceTableModifiers';
...
constructor TdxRunChangeCaseModifierBase.Create(ARichEditHistoryItemClass: TdxTextRunChangeCaseHistoryItemClass);
begin
  inherited Create;
  FRichEditHistoryItemClass := ARichEditHistoryItemClass;
end;

function TdxRunChangeCaseModifierBase.CreateHistoryItem(APieceTable: TdxPieceTable;
  ARunIndex: TdxRunIndex): TdxTextRunChangeCaseHistoryItem;
begin
  Result := FRichEditHistoryItemClass.Create(APieceTable, ARunIndex);
end;
...
begin
  ...
  try
    TdxCharacterPropertiesFontAssignmentHelper.AssignFont(ARun.CharacterProperties, NewValue);
  finally
...
begin
  ApplyCharacterProperties(ARun.CharacterProperties);
end;
...
var
  AIndex: Integer;
  APages: TdxPageCollection;
  AComparable: TdxBoxLogPositionComparable;
begin
  APages := Control.InnerControl.ActiveView.DocumentLayout.Pages;
  AComparable := TdxBoxLogPositionComparable.Create(APieceTable, ALogPosition);
  TdxAlgorithms1<TdxBoxBase>.BinarySearch(APages, AComparable.BoxAndLogPositionCompare, AIndex);
...
begin
  ...
  if AHitTestResult.Page <> nil then
    Result.PageIndex := AHitTestResult.Page.PageIndex;
...
{ TdxPieceTableModifiers }

class function TdxPieceTableModifiers.CreateSectionInserter(APieceTable: TdxCustomPieceTable): TdxParagraphInserter;
begin
  Result := TdxSectionInserter.Create(APieceTable);
end;

class function TdxPieceTableModifiers.CreateAssignParagraphLeftIndentModifier(ALeftIndent,
  AMaxValue: Integer): TdxParagraphPropertyModifier<Integer>;
begin
  Result := TdxAssignParagraphLeftIndentModifier.Create(ALeftIndent, AMaxValue);
end;

class function TdxPieceTableModifiers.CreateFloatingObjectRunFillColorModifier(
  ANewValue: TdxAlphaColor): TdxFloatingObjectRunPropertyModifier<TdxAlphaColor>;
begin
  Result := TdxFloatingObjectRunFillColorModifier.Create(ANewValue);
end;

class function TdxPieceTableModifiers.CreateFloatingObjectRunHorizontalPositionAlignmentModifier(
  ANewValue: TdxFloatingObjectHorizontalPositionAlignment): TdxFloatingObjectRunPropertyModifierBase;
begin
  Result := TdxFloatingObjectRunHorizontalPositionAlignmentModifier.Create(ANewValue);
end;

class function TdxPieceTableModifiers.CreateFloatingObjectRunHorizontalPositionTypeModifier(
  ANewValue: TdxFloatingObjectHorizontalPositionType): TdxFloatingObjectRunPropertyModifierBase;
begin
  Result := TdxFloatingObjectRunHorizontalPositionTypeModifier.Create(ANewValue);
end;

class function TdxPieceTableModifiers.CreateFloatingObjectRunIsBehindDocTextWrapTypeNoneModifier(
  ANewValue: Boolean): TdxFloatingObjectRunPropertyModifier<Boolean>;
begin
  Result := TdxFloatingObjectRunIsBehindDocTextWrapTypeNoneModifier.Create(ANewValue);
end;

class function TdxPieceTableModifiers.CreateFloatingObjectRunOutlineColorModifier(
  ANewValue: TdxAlphaColor): TdxFloatingObjectRunPropertyModifier<TdxAlphaColor>;
begin
  Result := TdxFloatingObjectRunOutlineColorModifier.Create(ANewValue);
end;

class function TdxPieceTableModifiers.CreateFloatingObjectRunOutlineWidthAndColorModifier(
  ANewValue: Integer): TdxFloatingObjectRunPropertyModifier<Integer>;
begin
  Result := TdxFloatingObjectRunOutlineWidthAndColorModifier.Create(ANewValue);
end;

class function TdxPieceTableModifiers.CreateFloatingObjectRunOutlineWidthModifier(
  ANewValue: Integer): TdxFloatingObjectRunPropertyModifierBase;
begin
  Result := TdxFloatingObjectRunOutlineWidthModifier.Create(ANewValue);
end;

class function TdxPieceTableModifiers.CreateFloatingObjectRunTextWrapTypeModifier(
  ANewValue: TdxFloatingObjectTextWrapType): TdxFloatingObjectRunPropertyModifier<TdxFloatingObjectTextWrapType>;
begin
  Result := TdxFloatingObjectRunTextWrapTypeModifier.Create(ANewValue);
end;

class function TdxPieceTableModifiers.CreateFloatingObjectRunVerticalPositionAlignmentModifier(
  ANewValue: TdxFloatingObjectVerticalPositionAlignment): TdxFloatingObjectRunPropertyModifierBase;
begin
  Result := TdxFloatingObjectRunVerticalPositionAlignmentModifier.Create(ANewValue);
end;

class function TdxPieceTableModifiers.CreateFloatingObjectRunVerticalPositionTypeModifier(ANewValue: TdxFloatingObjectVerticalPositionType): TdxFloatingObjectRunPropertyModifierBase;
begin
  Result := TdxFloatingObjectRunVerticalPositionTypeModifier.Create(ANewValue);
end;

class function TdxPieceTableModifiers.CreateOwnTabFormattingInfoModifier(ANewValue: TdxTabFormattingInfo;
  ADefaultTabWidth: Integer): TdxMergedParagraphPropertyModifier<TdxTabFormattingInfo>;
begin
  Result := TdxOwnTabFormattingInfoModifier.Create(ANewValue, ADefaultTabWidth);
end;

class function TdxPieceTableModifiers.CreateParagraphAlignmentModifier(
  ANewValue: TdxParagraphAlignment): TdxParagraphPropertyModifier<TdxParagraphAlignment>;
begin
  Result := TdxParagraphAlignmentModifier.Create(ANewValue);
end;

class function TdxPieceTableModifiers.CreateParagraphFirstLineIndentModifier(AFirstLineIndent,
  AMaxIndent: Integer): TdxParagraphPropertyModifier<Integer>;
begin
  Result := TdxParagraphFirstLineIndentModifier.Create(AFirstLineIndent, AMaxIndent);
end;

class function TdxPieceTableModifiers.CreateParagraphRightIndentModifier(
  ANewValue: Integer): TdxParagraphPropertyModifier<Integer>;
begin
  Result := TdxParagraphRightIndentModifier.Create(ANewValue);
end;

class function TdxPieceTableModifiers.CreateParagraphLeftIndentModifier(
  ANewValue: Integer): TdxParagraphPropertyModifier<Integer>;
begin
  Result := TdxParagraphLeftIndentModifier.Create(ANewValue);
end;

class function TdxPieceTableModifiers.CreateParagraphFirstLineIndentModifier(
  ANewValue: Integer): TdxParagraphPropertyModifier<Integer>;
begin
  Result := TdxParagraphFirstLineIndentModifier.Create(ANewValue);
end;

class function TdxPieceTableModifiers.CreateParagraphSpacingModifier(
  ANewValue: TdxParagraphLineSpacing): TdxParagraphPropertyModifier<TdxParagraphLineSpacing>;
begin
  Result := TdxParagraphSpacingModifier.Create(ANewVAlue);
end;

class function TdxPieceTableModifiers.CreateRunBackColorModifier(
  ANewValue: TdxAlphaColor): TdxRunPropertyModifier<TdxAlphaColor>;
begin
  Result := TdxRunBackColorModifier.Create(ANewValue);
end;

class function TdxPieceTableModifiers.CreateRunDecreaseFontSizeModifier(
  APredefinedFontSizeCollection: TdxPredefinedFontSizeCollection): TdxRunPropertyModifier<Integer>;
begin
  Result := TdxRunDecreaseFontSizeModifier.Create(APredefinedFontSizeCollection);
end;

class function TdxPieceTableModifiers.CreateRunDecrementFontSizeModifier: TdxRunPropertyModifier<Integer>;
begin
  Result := TdxRunDecrementFontSizeModifier.Create;
end;

class function TdxPieceTableModifiers.CreateRunFontBoldModifier(ANewValue: Boolean): TdxRunPropertyModifier<Boolean>;
begin
  Result := TdxRunFontBoldModifier.Create(ANewVAlue);
end;

class function TdxPieceTableModifiers.CreateRunFontColorPropertyModifier(
  ANewValue: TdxAlphaColor): TdxRunPropertyModifier<TdxAlphaColor>;
begin
  Result := TdxRunFontColorPropertyModifier.Create(ANewValue);
end;

class function TdxPieceTableModifiers.CreateRunFontItalicModifier(ANewValue: Boolean): TdxRunPropertyModifier<Boolean>;
begin
  Result := TdxRunFontItalicModifier.Create(ANewValue);
end;

class function TdxPieceTableModifiers.CreateRunFontModifier(const ANewValue: TFont): TdxRunPropertyModifier<TFont>;
begin
  Result := TdxRunFontModifier.Create(ANewValue);
end;

class function TdxPieceTableModifiers.CreateRunFontNamePropertyModifier(
  const ANewValue: string): TdxRunPropertyModifier<string>;
begin
  Result := TdxRunFontNamePropertyModifier.Create(ANewValue);
end;

class function TdxPieceTableModifiers.CreateRunFontSizePropertyModifier(
  ANewValue: Single): TdxRunPropertyModifier<Single>;
begin
  Result := TdxRunFontSizePropertyModifier.Create(ANewValue);
end;

class function TdxPieceTableModifiers.CreateRunFontStrikeoutTypeModifier(
  ANewValue: TdxStrikeoutType): TdxRunPropertyModifier<TdxStrikeoutType>;
begin
  Result := TdxRunFontStrikeoutTypeModifier.Create(ANewValue);
end;

class function TdxPieceTableModifiers.CreateRunFontUnderlineTypeModifier(
  ANewValue: TdxUnderlineType): TdxRunPropertyModifier<TdxUnderlineType>;
begin
  Result := TdxRunFontUnderlineTypeModifier.Create(ANewValue);
end;

class function TdxPieceTableModifiers.CreateRunForeColorModifier(ANewValue: TdxAlphaColor): TdxRunPropertyModifier<TdxAlphaColor>;
begin
  Result := TdxRunForeColorModifier.Create(ANewValue);
end;

class function TdxPieceTableModifiers.CreateRunIncreaseFontSizeModifier(
  APredefinedFontSizeCollection: TdxPredefinedFontSizeCollection): TdxRunPropertyModifier<Integer>;
begin
  Result := TdxRunIncreaseFontSizeModifier.Create(APredefinedFontSizeCollection);
end;

class function TdxPieceTableModifiers.CreateRunIncrementFontSizeModifier: TdxRunPropertyModifier<Integer>;
begin
  Result := TdxRunIncrementFontSizeModifier.Create;
end;

class function TdxPieceTableModifiers.CreateRunScriptModifier(
  ANewValue: TdxCharacterFormattingScript): TdxRunPropertyModifier<TdxCharacterFormattingScript>;
begin
  Result := TdxRunScriptModifier.Create(ANewValue);
end;

class function TdxPieceTableModifiers.CreateRunToggleCaseModifier: TdxRunChangeCaseModifierBase;
begin
  Result := TdxRunChangeCaseModifierBase.Create(TdxTextRunToggleCaseHistoryItem);
end;

class function TdxPieceTableModifiers.CreateRunUnderlineColorModifier(
  ANewValue: TdxAlphaColor): TdxRunPropertyModifier<TdxAlphaColor>;
begin
  Result := TdxRunUnderlineColorModifier.Create(ANewValue);
end;

class function TdxPieceTableModifiers.CreateSectionColumnsSetupModifier(const ANewValue: TdxColumnsInfoUI): TdxSectionPropertyModifier<TdxColumnsInfoUI>;
begin
  Result := TdxSectionColumnsSetupModifier.Create(ANewValue);
end;

class function TdxPieceTableModifiers.CreateSectionPageOrientationLandscapeModifier(
  ANewValue: Boolean): TdxSectionPropertyModifier<Boolean>;
begin
  Result := TdxSectionPageOrientationLandscapeModifier.Create(ANewValue);
end;

class function TdxPieceTableModifiers.CreateSectionPageSetupModifier(const ANewValue: TdxPageSetupInfo): TdxSectionPropertyModifier<TdxPageSetupInfo>;
begin
  Result := TdxSectionPageSetupModifier.Create(ANewValue);
end;

class function TdxPieceTableModifiers.CreateTabFormattingInfoModifier(ANewValue: TdxTabFormattingInfo;
  ADefaultTabWidth: Integer): TdxMergedParagraphPropertyModifier<TdxTabFormattingInfo>;
begin
  Result := TdxTabFormattingInfoModifier.Create(ANewValue, ADefaultTabWidth);
end;

class function TdxPieceTableModifiers.CreateEndNoteRunInserter(APieceTable: TdxCustomPieceTable): TdxObjectInserter;
begin
  Result := TdxEndNoteRunInserter.Create(APieceTable);
end;

class function TdxPieceTableModifiers.CreateFieldSymbolResultInserter(
  APieceTable: TdxCustomPieceTable): TdxSimpleTextInserter;
begin
  Result := TdxFieldSymbolResultInserter.Create(APieceTable);
end;

class function TdxPieceTableModifiers.CreateFloatingObjectAnchorInserter(
  APieceTable: TdxCustomPieceTable): TdxPieceTableObjectInserter;
begin
  Result := TdxFloatingObjectAnchorInserter.Create(APieceTable);
end;

class function TdxPieceTableModifiers.CreateFootNoteRunInserter(APieceTable: TdxCustomPieceTable): TdxObjectInserter;
begin
  Result := TdxFootNoteRunInserter.Create(APieceTable);
end;

class function TdxPieceTableModifiers.CreateLowerCaseModifier: TdxRunChangeCaseModifierBase;
begin
  Result := TdxRunChangeCaseModifierBase.Create(TdxTextRunMakeLowerCaseHistoryItem);
end;

class function TdxPieceTableModifiers.CreateTextInserter(APieceTable: TdxCustomPieceTable): TdxSimpleTextInserter;
begin
  Result := TdxTextInserter.Create(APieceTable);
end;

class function TdxPieceTableModifiers.CreateUpperCaseModifier: TdxRunChangeCaseModifierBase;
begin
  Result := TdxRunChangeCaseModifierBase.Create(TdxTextRunMakeUpperCaseHistoryItem);
end;

class function TdxPieceTableModifiers.CreateSectionLineNumberingModifier(
  const ANewValue: TdxLineNumberingInfo): TdxSectionPropertyModifier<TdxLineNumberingInfo>;
begin
  Result := TdxSectionLineNumberingModifier.Create(ANewValue);
end;

class function TdxPieceTableModifiers.CreateSectionLineNumberingStepAndRestartModifier(
  ANewValue: TdxLineNumberingRestart): TdxSectionPropertyModifier<TdxLineNumberingRestart>;
begin
  Result := TdxSectionLineNumberingStepAndRestartModifier.Create(ANewValue);
end;
