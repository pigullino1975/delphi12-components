...
type
  ...
  public type
    TCommandUIState = class(TdxDefaultValueBasedCommandUIState<TdxSplitTableCellsParameters>);
  strict private
...
const
  dxThisUnitName = 'dxRichEdit.Commands.Tables.Cells';
...
var
  AValueState: TCommandUIState;
begin
  AValueState := AState as TCommandUIState;
...
begin
  ...
  begin
    ATableBorders := DocumentModel.Selection.SelectedCells.FirstSelectedCell.Table.TableProperties.Borders;
    CollectTableBorders(ATableBorders, FBorders);
  end;
...
begin
  ...
  Result := TdxPieceTableModifiers.CreateParagraphAlignmentModifier(AAlignment);
end;
