...
unit dxRichEdit.DocumentModel.Borders; // for internal use
...
uses
  ...
  dxRichEdit.Utils.BatchUpdateHelper, dxCore;

const
  dxThisUnitName = 'dxRichEdit.DocumentModel.Borders';

{ TdxBorderInfo }

class constructor TdxBorderInfo.Initialize;
begin
  {$IFDEF DX_INITIALIZATION_LOGGING}TdxUnitSectionsLogger.ConstructorStarted(UnitName, 'TdxBorderInfo.Initialize', SysInit.HInstance);{$ENDIF}
  ...
  FEmpty.Offset := 0;
  FEmpty.Shadow := False;
  {$IFDEF DX_INITIALIZATION_LOGGING}TdxUnitSectionsLogger.ConstructorFinished(UnitName, 'TdxBorderInfo.Initialize', SysInit.HInstance);{$ENDIF}
end;

class destructor TdxBorderInfo.Finalize;
begin
  {$IFDEF DX_INITIALIZATION_LOGGING}TdxUnitSectionsLogger.DestructorStarted(UnitName, 'TdxBorderInfo.Finalize', SysInit.HInstance);{$ENDIF}
  FEmpty.Free;
  {$IFDEF DX_INITIALIZATION_LOGGING}TdxUnitSectionsLogger.DestructorFinished(UnitName, 'TdxBorderInfo.Finalize', SysInit.HInstance);{$ENDIF}
end;
...
begin
  {$IFDEF DX_INITIALIZATION_LOGGING}TdxUnitSectionsLogger.ConstructorStarted(UnitName, 'TdxLeftMarginUnit.Initialize', SysInit.HInstance);{$ENDIF}
  FPropertyAccessor := TdxLeftPropertyAccessor.Create;
  {$IFDEF DX_INITIALIZATION_LOGGING}TdxUnitSectionsLogger.ConstructorFinished(UnitName, 'TdxLeftMarginUnit.Initialize', SysInit.HInstance);{$ENDIF}
end;

class destructor TdxLeftMarginUnit.Finalize;
begin
  {$IFDEF DX_INITIALIZATION_LOGGING}TdxUnitSectionsLogger.DestructorStarted(UnitName, 'TdxLeftMarginUnit.Finalize', SysInit.HInstance);{$ENDIF}
  FreeAndNil(FPropertyAccessor);
  {$IFDEF DX_INITIALIZATION_LOGGING}TdxUnitSectionsLogger.DestructorFinished(UnitName, 'TdxLeftMarginUnit.Finalize', SysInit.HInstance);{$ENDIF}
end;
...
begin
  {$IFDEF DX_INITIALIZATION_LOGGING}TdxUnitSectionsLogger.ConstructorStarted(UnitName, 'TdxRightMarginUnit.Initialize', SysInit.HInstance);{$ENDIF}
  FPropertyAccessor := TdxRightPropertyAccessor.Create;
  {$IFDEF DX_INITIALIZATION_LOGGING}TdxUnitSectionsLogger.ConstructorFinished(UnitName, 'TdxRightMarginUnit.Initialize', SysInit.HInstance);{$ENDIF}
end;

class destructor TdxRightMarginUnit.Finalize;
begin
  {$IFDEF DX_INITIALIZATION_LOGGING}TdxUnitSectionsLogger.DestructorStarted(UnitName, 'TdxRightMarginUnit.Finalize', SysInit.HInstance);{$ENDIF}
  FreeAndNil(FPropertyAccessor);
  {$IFDEF DX_INITIALIZATION_LOGGING}TdxUnitSectionsLogger.DestructorFinished(UnitName, 'TdxRightMarginUnit.Finalize', SysInit.HInstance);{$ENDIF}
end;
...
begin
  {$IFDEF DX_INITIALIZATION_LOGGING}TdxUnitSectionsLogger.ConstructorStarted(UnitName, 'TdxTopMarginUnit.Initialize', SysInit.HInstance);{$ENDIF}
  FPropertyAccessor := TdxTopPropertyAccessor.Create;
  {$IFDEF DX_INITIALIZATION_LOGGING}TdxUnitSectionsLogger.ConstructorFinished(UnitName, 'TdxTopMarginUnit.Initialize', SysInit.HInstance);{$ENDIF}
end;

class destructor TdxTopMarginUnit.Finalize;
begin
  {$IFDEF DX_INITIALIZATION_LOGGING}TdxUnitSectionsLogger.DestructorStarted(UnitName, 'TdxTopMarginUnit.Finalize', SysInit.HInstance);{$ENDIF}
  FreeAndNil(FPropertyAccessor);
  {$IFDEF DX_INITIALIZATION_LOGGING}TdxUnitSectionsLogger.DestructorFinished(UnitName, 'TdxTopMarginUnit.Finalize', SysInit.HInstance);{$ENDIF}
end;
...
begin
  {$IFDEF DX_INITIALIZATION_LOGGING}TdxUnitSectionsLogger.ConstructorStarted(UnitName, 'TdxBottomMarginUnit.Initialize', SysInit.HInstance);{$ENDIF}
  FPropertyAccessor := TdxBottomPropertyAccessor.Create;
  {$IFDEF DX_INITIALIZATION_LOGGING}TdxUnitSectionsLogger.ConstructorFinished(UnitName, 'TdxBottomMarginUnit.Initialize', SysInit.HInstance);{$ENDIF}
end;

class destructor TdxBottomMarginUnit.Finalize;
begin
  {$IFDEF DX_INITIALIZATION_LOGGING}TdxUnitSectionsLogger.DestructorStarted(UnitName, 'TdxBottomMarginUnit.Finalize', SysInit.HInstance);{$ENDIF}
  FreeAndNil(FPropertyAccessor);
  {$IFDEF DX_INITIALIZATION_LOGGING}TdxUnitSectionsLogger.DestructorFinished(UnitName, 'TdxBottomMarginUnit.Finalize', SysInit.HInstance);{$ENDIF}
end;
...
begin
  {$IFDEF DX_INITIALIZATION_LOGGING}TdxUnitSectionsLogger.DestructorStarted(UnitName, 'TdxBorderInfoRepository.Finalize', SysInit.HInstance);{$ENDIF}
  for I := Low(UnderlineTable) to High(UnderlineTable) do
    UnderlineTable[I].Free;
  {$IFDEF DX_INITIALIZATION_LOGGING}TdxUnitSectionsLogger.DestructorFinished(UnitName, 'TdxBorderInfoRepository.Finalize', SysInit.HInstance);{$ENDIF}
end;
...
begin
  {$IFDEF DX_INITIALIZATION_LOGGING}TdxUnitSectionsLogger.ConstructorStarted(UnitName, 'TdxBorderInfoRepository.Initialize', SysInit.HInstance);{$ENDIF}
  CreateUnderlineTable;
  {$IFDEF DX_INITIALIZATION_LOGGING}TdxUnitSectionsLogger.ConstructorFinished(UnitName, 'TdxBorderInfoRepository.Initialize', SysInit.HInstance);{$ENDIF}
end;
