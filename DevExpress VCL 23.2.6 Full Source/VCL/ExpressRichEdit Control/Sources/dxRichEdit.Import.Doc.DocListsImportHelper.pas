...
unit dxRichEdit.Import.Doc.DocListsImportHelper; // for internal use
...
uses
  SysUtils, Classes, Generics.Defaults, Generics.Collections, RTLConsts,
...
const
  dxThisUnitName = 'dxRichEdit.Import.Doc.DocListsImportHelper';
