...
const
  dxThisUnitName = 'dxRichEdit.Commands.ChangeProperties';
...
begin
  ...
  Result := TdxPieceTableModifiers.CreateRunFontNamePropertyModifier(AValueBasedState.Value);
end;
...
begin
  ...
  if AValueBasedState.Value <> InvalidValue then
    Result := TdxPieceTableModifiers.CreateRunFontSizePropertyModifier(AValueBasedState.Value)
  else
    Result := TdxPieceTableModifiers.CreateRunFontSizePropertyModifier(0);
end;
...
begin
  if not Supports(AState, IdxValueBasedCommandUIState<TdxAlphaColor>, AValueBasedState) then
    TdxRichEditExceptions.ThrowInternalException;
  Result := TdxPieceTableModifiers.CreateRunFontColorPropertyModifier(AValueBasedState.Value);
end;
...
begin
  Result := TdxPieceTableModifiers.CreateParagraphFirstLineIndentModifier(FNewIndent);
end;
...
begin
  Result := TdxPieceTableModifiers.CreateParagraphLeftIndentModifier(FNewIndent);
end;
...
begin
  Result := TdxPieceTableModifiers.CreateParagraphRightIndentModifier(FNewIndent);
end;
...
begin
  ...
  Result := TdxPieceTableModifiers.CreateParagraphAlignmentModifier(Alignment);
end;
...
begin
  Result := TdxPieceTableModifiers.CreateRunFontBoldModifier(not AState.Checked);
end;
...
begin
  Result := TdxPieceTableModifiers.CreateRunFontItalicModifier(not AState.Checked);
end;
...
begin
  ...
  Result := TdxPieceTableModifiers.CreateRunFontUnderlineTypeModifier(AUnderlineType);
end;
...
begin
  ...
  Result := TdxPieceTableModifiers.CreateRunFontStrikeoutTypeModifier(AStrikeoutType);
end;
...
begin
  Result := TdxPieceTableModifiers.CreateRunIncrementFontSizeModifier;
end;
...
begin
  Result := TdxPieceTableModifiers.CreateRunDecrementFontSizeModifier;
end;
...
begin
  ...
  Result := TdxPieceTableModifiers.CreateRunScriptModifier(AScript);
end;
...
begin
  Result := TdxPieceTableModifiers.CreateRunIncreaseFontSizeModifier(InnerControl.PredefinedFontSizeCollection)
end;
...
begin
  Result := TdxPieceTableModifiers.CreateRunDecreaseFontSizeModifier(InnerControl.PredefinedFontSizeCollection);
end;
...
begin
  if not Supports(AState, IdxValueBasedCommandUIState<TdxAlphaColor>, AValueBasedState) then
    TdxRichEditExceptions.ThrowInternalException;
  Result := TdxPieceTableModifiers.CreateRunBackColorModifier(AValueBasedState.Value);
end;
...
begin
  Result := TdxPieceTableModifiers.CreateParagraphSpacingModifier(TdxParagraphLineSpacing.Single);
end;
...
begin
  Result := TdxPieceTableModifiers.CreateParagraphSpacingModifier(TdxParagraphLineSpacing.Sesquialteral);
end;
...
begin
  Result := TdxPieceTableModifiers.CreateParagraphSpacingModifier(TdxParagraphLineSpacing.Double);
end;
...
begin
  ...
  if (ANearestRightDefaultTab < ANearestRightTab) or (ANearestRightTab = AParagraph.LeftIndent) then
    Result := TdxPieceTableModifiers.CreateAssignParagraphLeftIndentModifier(ANearestRightDefaultTab - AParagraph.LeftIndent, AMaxValue)
  else
    Result := TdxPieceTableModifiers.CreateAssignParagraphLeftIndentModifier(ANearestRightTab - AParagraph.LeftIndent, AMaxValue);
end;
...
begin
  ...
  if (ADefaultTabWidth < ANearestRightTab) or (ANearestRightTab = AParagraph.FirstLineIndent) then
    Result := TdxPieceTableModifiers.CreateParagraphFirstLineIndentModifier(ADefaultTabWidth, AMaxValue)
  else
    Result := TdxPieceTableModifiers.CreateParagraphFirstLineIndentModifier(ANearestRightTab, AMaxValue);
end;
...
begin
  ...
  if (ANearLeftDefaultTab > ANearLeftTab) or (ANearLeftTab = AParagraph.LeftIndent) then
    Result := TdxPieceTableModifiers.CreateAssignParagraphLeftIndentModifier(ANearLeftDefaultTab - AParagraph.LeftIndent, MaxInt)
  else
    Result := TdxPieceTableModifiers.CreateAssignParagraphLeftIndentModifier(ANearLeftTab - AParagraph.LeftIndent, MaxInt);
end;
...
begin
  ...
  if ((ANearLeftDefaultTab > ANearLeftTab) and (ANearLeftDefaultTab >= AParagraph.LeftIndent)) or (ANearLeftTab = AParagraph.LeftIndent) then
    Result := TdxPieceTableModifiers.CreateParagraphFirstLineIndentModifier(ANearLeftDefaultTab)
  else
    if ANearLeftTab >= AParagraph.LeftIndent then
      Result := TdxPieceTableModifiers.CreateParagraphFirstLineIndentModifier(ANearLeftTab)
    else
      Result := TdxPieceTableModifiers.CreateParagraphFirstLineIndentModifier(0);
end;
...
begin
  Result := TdxPieceTableModifiers.CreateUpperCaseModifier;
end;
...
begin
  Result := TdxPieceTableModifiers.CreateLowerCaseModifier;
end;
...
begin
  Result := TdxPieceTableModifiers.CreateRunToggleCaseModifier;
end;
