...
{                                                                    }
{********************************************************************}
unit dxRichEdit.Import.Doc.FormattedDiskPageHelper; // for internal use
...
const
  dxThisUnitName = 'dxRichEdit.Import.Doc.FormattedDiskPageHelper';
...
begin
  ...
  try
    ...
    begin
      ...
      if TdxAlgorithms1<TdxTextRunBorder>.BinarySearch(ATextRunBorders, AComparable.CompareTo, AIndex) then
