...
unit dxRichEdit.DocumentLayout.BottomTextIndentCalculator; // for internal use
...
const
  dxThisUnitName = 'dxRichEdit.DocumentLayout.BottomTextIndentCalculator';
...
begin
  ...
  AHasCellSpacing := ACellSpacing > 0;
  if AHasCellSpacing then
