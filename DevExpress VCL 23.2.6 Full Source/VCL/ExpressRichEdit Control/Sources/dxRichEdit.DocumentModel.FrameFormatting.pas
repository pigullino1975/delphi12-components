...
unit dxRichEdit.DocumentModel.FrameFormatting; // for internal use
...
const
  dxThisUnitName = 'dxRichEdit.DocumentModel.FrameFormatting';
...
begin
  Result := Safe.Cast(AObj, TdxMergedFrameProperties, AOther) and Info.Equals(AOther.Info);
end;
...
begin
  if Safe.Cast(AObj, TdxFrameProperties, AOther) then
  begin
