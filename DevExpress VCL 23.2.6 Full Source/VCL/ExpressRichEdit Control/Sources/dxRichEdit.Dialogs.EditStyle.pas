...
const
  dxThisUnitName = 'dxRichEdit.Dialogs.EditStyle';
...
procedure TdxRichEditEditStyleDialogForm.ApplyCharacterProperties(AProperties: TdxMergedCharacterProperties; AData: TObject);
begin
...
procedure TdxRichEditEditStyleDialogForm.ApplyParagraphProperties(AProperties: TdxMergedParagraphProperties; AData: TObject);
begin
...
begin
  ...
  begin
    CanClose := False;
    dxMessageBox(cxGetResourceString(@sdxRichEditExceptionParagraphStyleNameAlreadyExists), Application.Title, MB_OK or MB_ICONWARNING);
  end;
end;
