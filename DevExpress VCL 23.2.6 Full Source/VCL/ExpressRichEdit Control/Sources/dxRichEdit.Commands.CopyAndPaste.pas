...
uses
  ...
  dxDocumentLayoutUnitConverter, dxCoreClasses;

const
  dxThisUnitName = 'dxRichEdit.Commands.CopyAndPaste';
...
begin
  ...
  begin
    if Safe.Cast(Commands[I], TdxPasteContentCommandBase, ACommand) then
