...
type
  TdxRichEditLineNumberingDialogForm = class(TdxRichEditCustomDialogForm)
    btnCancel: TcxButton;
    btnOk: TcxButton;
    cbAddLineNumbering: TdxLayoutCheckBoxItem;
    ...
    rbNumberingRestartEachPage: TdxLayoutRadioButtonItem;
    rbNumberingRestartEachSection: TdxLayoutRadioButtonItem;
    rbNumberingRestartContinuous: TdxLayoutRadioButtonItem;
...
const
  dxThisUnitName = 'dxRichEdit.Dialogs.LineNumbering';
