...
unit dxRichEdit.DocumentModel.Fields.DateTimeFields; // for internal use
...
type
  ...
  public
    ...
    property UseShakaEraCalendar: Boolean read FUseShakaEraCalendar;
...
const
  dxThisUnitName = 'dxRichEdit.DocumentModel.Fields.DateTimeFields';
...
begin
  ...
  FUseShakaEraCalendar := ASwitches.GetBool('s');
...
begin
  ...
  FUseShakaEraCalendar := AInstructions.GetBool('s');
end;
