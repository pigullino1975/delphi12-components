...
unit dxRichEdit.DocumentModel.History.Run; // for internal use
...
type
  ...
  TdxTextRunChangeCaseHistoryItemClass = class of TdxTextRunChangeCaseHistoryItem;
...
uses
  Classes, RTLConsts, Contnrs, Character, dxCoreClasses,
...
const
  dxThisUnitName = 'dxRichEdit.DocumentModel.History.Run';
