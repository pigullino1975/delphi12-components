...
type
  ...
  TdxRichEditDocumentFormats = set of TdxRichEditDocumentFormat;
  ...
  IdxRichEditDocumentContainer = interface(IdxBatchUpdatable)
  ...
  IdxRichEditDocument = interface(IdxRichEditSubDocument)
    ...
    property DocBytes: TBytes read GetDocBytes write SetDocBytes;
...
const
  dxThisUnitName = 'dxRichEdit.NativeApi';
