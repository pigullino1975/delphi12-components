...
unit dxRichEdit.Import.OpenXML.DestinationBase; // for internal use
...
const
  dxThisUnitName = 'dxRichEdit.Import.OpenXML.DestinationBase';
...
begin
  {$IFDEF DX_INITIALIZATION_LOGGING}TdxUnitSectionsLogger.ConstructorStarted(UnitName, 'TdxElementHandlerTable.Initialize', SysInit.HInstance);{$ENDIF}
  FEmpty := TdxElementHandlerTable.Create;
  {$IFDEF DX_INITIALIZATION_LOGGING}TdxUnitSectionsLogger.ConstructorFinished(UnitName, 'TdxElementHandlerTable.Initialize', SysInit.HInstance);{$ENDIF}
end;

class destructor TdxElementHandlerTable.Finalize;
begin
  {$IFDEF DX_INITIALIZATION_LOGGING}TdxUnitSectionsLogger.DestructorStarted(UnitName, 'TdxElementHandlerTable.Finalize', SysInit.HInstance);{$ENDIF}
  FEmpty.Free;
  {$IFDEF DX_INITIALIZATION_LOGGING}TdxUnitSectionsLogger.DestructorFinished(UnitName, 'TdxElementHandlerTable.Finalize', SysInit.HInstance);{$ENDIF}
end;
...
begin
  {$IFDEF DX_INITIALIZATION_LOGGING}TdxUnitSectionsLogger.ConstructorStarted(UnitName, 'TdxRangePermissionElementDestination.Initialize', SysInit.HInstance);{$ENDIF}
  FActualGroupNames := CreateActualGroupNames;
  {$IFDEF DX_INITIALIZATION_LOGGING}TdxUnitSectionsLogger.ConstructorFinished(UnitName, 'TdxRangePermissionElementDestination.Initialize', SysInit.HInstance);{$ENDIF}
end;

class destructor TdxRangePermissionElementDestination.Finalize;
begin
  {$IFDEF DX_INITIALIZATION_LOGGING}TdxUnitSectionsLogger.DestructorStarted(UnitName, 'TdxRangePermissionElementDestination.Finalize', SysInit.HInstance);{$ENDIF}
  FreeAndNil(FActualGroupNames);
  {$IFDEF DX_INITIALIZATION_LOGGING}TdxUnitSectionsLogger.DestructorFinished(UnitName, 'TdxRangePermissionElementDestination.Finalize', SysInit.HInstance);{$ENDIF}
end;
...
begin
  {$IFDEF DX_INITIALIZATION_LOGGING}TdxUnitSectionsLogger.ConstructorStarted(UnitName, 'TdxBorderDestination.Initialize', SysInit.HInstance);{$ENDIF}
  FBorderStyleTable := CreateBorderStyleTable;
  {$IFDEF DX_INITIALIZATION_LOGGING}TdxUnitSectionsLogger.ConstructorFinished(UnitName, 'TdxBorderDestination.Initialize', SysInit.HInstance);{$ENDIF}
end;

class destructor TdxBorderDestination.Finalize;
begin
  {$IFDEF DX_INITIALIZATION_LOGGING}TdxUnitSectionsLogger.DestructorStarted(UnitName, 'TdxBorderDestination.Finalize', SysInit.HInstance);{$ENDIF}
  FBorderStyleTable.Free;
  {$IFDEF DX_INITIALIZATION_LOGGING}TdxUnitSectionsLogger.DestructorFinished(UnitName, 'TdxBorderDestination.Finalize', SysInit.HInstance);{$ENDIF}
end;
