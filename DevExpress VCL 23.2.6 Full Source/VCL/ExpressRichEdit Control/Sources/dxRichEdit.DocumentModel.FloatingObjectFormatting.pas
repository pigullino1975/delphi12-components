...
type
  ...
  IdxFloatingObjectPropertiesContainer = interface // for internal use
  ...
  TdxFloatingObjectRelativeWidth = record // for internal use
  strict private
    FWidth: Integer; 
  ...
  TdxFloatingObjectRelativeHeight = record // for internal use
  strict private
    FHeight: Integer; 
  ...
  IdxFloatingObjectLocation = interface // for internal use
  ...
  TdxFloatingObjectInfoCache = class(TdxUniqueItemsCache<TdxFloatingObjectInfo>) // for internal use
  public const
    DefaultItemIndex = 0;
  protected
  ...
  TdxFloatingObjectChangeActionsCalculator = class // for internal use
  public
  ...
  TdxFloatingObjectFormattingCache = class(TdxUniqueItemsCache<TdxFloatingObjectFormatting>) // for internal use
  public const
  ...
  TdxZOrderManager = class // for internal use
  public
  ...
  IdxTextBoxPropertiesContainer = interface // for internal use
  ...
  TdxTextBoxInfo = class(TdxCloneable) // for internal use
  strict private
    FLeftMargin: Integer;
  ...
  TdxTextBoxOptions = record // for internal use
  public const
    MaskUseNone = [];
  ...
  TdxTextBoxFormatting = class(TdxIndexBasedObjectB<TdxTextBoxInfo, TdxTextBoxOptions>) // for internal use
  strict private
  ...
  TdxTextBoxProperties = class(TdxRichEditIndexBasedObject<TdxTextBoxFormatting>) // for internal use
  strict private
  ...
  TdxTextBoxFormattingCache = class(TdxUniqueItemsCache<TdxTextBoxFormatting>) // for internal use
  public const
  ...
  TdxTextBoxInfoCache = class(TdxUniqueItemsCache<TdxTextBoxInfo>) // for internal use
  public const
    DefaultItemIndex = 0;
  protected
...
const
  dxThisUnitName = 'dxRichEdit.DocumentModel.FloatingObjectFormatting';
