...
unit dxRichEdit.DocumentModel.Selections.Core; // for internal use
...
const
  dxThisUnitName = 'dxRichEdit.DocumentModel.Selections.Core';
...
begin
  {$IFDEF DX_INITIALIZATION_LOGGING}TdxUnitSectionsLogger.ConstructorStarted(UnitName, 'TdxCustomSelection.Initialize', SysInit.HInstance);{$ENDIF}
  FRangeComparer := TRangeComparer.Create;
  {$IFDEF DX_INITIALIZATION_LOGGING}TdxUnitSectionsLogger.ConstructorFinished(UnitName, 'TdxCustomSelection.Initialize', SysInit.HInstance);{$ENDIF}
end;

class destructor TdxCustomSelection.Finalize;
begin
  {$IFDEF DX_INITIALIZATION_LOGGING}TdxUnitSectionsLogger.DestructorStarted(UnitName, 'TdxCustomSelection.Finalize', SysInit.HInstance);{$ENDIF}
  FreeAndNil(FRangeComparer);
  {$IFDEF DX_INITIALIZATION_LOGGING}TdxUnitSectionsLogger.DestructorFinished(UnitName, 'TdxCustomSelection.Finalize', SysInit.HInstance);{$ENDIF}
end;
