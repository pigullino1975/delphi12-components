...
unit dxRichEdit.Import.OpenXML.DestinationEndNote; // for internal use
...
const
  dxThisUnitName = 'dxRichEdit.Import.OpenXML.DestinationEndNote';
...
begin
  {$IFDEF DX_INITIALIZATION_LOGGING}TdxUnitSectionsLogger.ConstructorStarted(UnitName, 'TdxEndNotesDestination.Initialize', SysInit.HInstance);{$ENDIF}
  FHandlerTable := CreateElementHandlerTable;
  {$IFDEF DX_INITIALIZATION_LOGGING}TdxUnitSectionsLogger.ConstructorFinished(UnitName, 'TdxEndNotesDestination.Initialize', SysInit.HInstance);{$ENDIF}
end;

class destructor TdxEndNotesDestination.Finalize;
begin
  {$IFDEF DX_INITIALIZATION_LOGGING}TdxUnitSectionsLogger.DestructorStarted(UnitName, 'TdxEndNotesDestination.Finalize', SysInit.HInstance);{$ENDIF}
  FHandlerTable.Free;
  {$IFDEF DX_INITIALIZATION_LOGGING}TdxUnitSectionsLogger.DestructorFinished(UnitName, 'TdxEndNotesDestination.Finalize', SysInit.HInstance);{$ENDIF}
end;
