...
type
  TdxRichEditNumberingListDialogForm = class(TdxRichEditCustomDialogForm, IdxRichEditNumberingListForm)
    ...
    rbContinuePreviousList: TdxLayoutRadioButtonItem;
    rbRestartNumbering: TdxLayoutRadioButtonItem;
  ...
  private
    FCustomNumberingDocumentModel: TdxDocumentModel;
...
const
  dxThisUnitName = 'dxRichEdit.Dialogs.Numbering';
...
begin
  FCustomNumberingDocumentModel.Free;
...
begin
  FreeAndNil(FCustomNumberingDocumentModel);
  FCustomNumberingDocumentModel := TdxDocumentModel.Create; 
  AClone := Controller.CreateAbstractNumberingListCopy(FCustomNumberingDocumentModel, ActiveGallery.SelectedAbstractList);
...
function TdxRichEditNumberingListDialogForm.ChangeSelectedTabPage(ACurrentSelectedTabPage: TdxLayoutGroup): TdxLayoutGroup;
begin
