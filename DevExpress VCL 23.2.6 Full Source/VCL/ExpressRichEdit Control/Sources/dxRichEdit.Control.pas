...
const
  dxThisUnitName = 'dxRichEdit.Control';
...
begin
  if SkinInfo = nil then
    ...
    Result := GetSkinEdges(SkinInfo.PrintingPageBorder).Left;
end;
...
begin
  if SkinInfo = nil then
    ...
    Result := GetSkinEdges(SkinInfo.PrintingPageBorder).Right;
end;
...
begin
  if SkinInfo = nil then
    ...
    Result := GetSkinEdges(SkinInfo.PrintingPageBorder).Top;
end;
...
begin
  if SkinInfo = nil then
    ...
    Result := GetSkinEdges(SkinInfo.PrintingPageBorder).Bottom;
end;
