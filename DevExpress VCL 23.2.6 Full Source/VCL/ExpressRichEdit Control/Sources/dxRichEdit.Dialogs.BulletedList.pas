...
uses
  System.UITypes,
  Windows, Messages, SysUtils, Variants, Classes, Graphics, RTLConsts,
...
uses
  dxCore, dxCoreClasses, dxRichEdit.Dialogs.Strs,
...
const
  dxThisUnitName = 'dxRichEdit.Dialogs.BulletedList';
