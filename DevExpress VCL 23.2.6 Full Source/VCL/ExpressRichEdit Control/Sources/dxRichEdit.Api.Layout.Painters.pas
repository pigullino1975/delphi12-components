...
type
  ...
  strict private
    function GetItem(Index: TdxListIndex): T;
  public
    function First: T;
    function Last: T;
    property Items[Index: TdxListIndex]: T read GetItem; default;
  end;
  ...
  strict private
    ...
    FPainterVisitor: TdxRichEditLayoutVisitor;
  public
    constructor Create;
    destructor Destroy; override;
    function ShouldOptimizeBox(ABox: IdxRichEditLayoutElement): Boolean;
    function GetDrawingBounds(const ABounds: TRect): TRect;
    procedure Draw;
    procedure DrawPage(APage: TdxRichEditLayoutPage);
    procedure DrawPageArea(APageArea: TdxRichEditLayoutPageArea);
    procedure DrawColumn(AColumn: TdxRichEditLayoutColumn);
    procedure DrawComments(APage: TdxRichEditLayoutPage);
    procedure DrawComment(AComment: TdxRichEditLayoutComment);
    procedure DrawHeader(AHeader: TdxRichEditLayoutHeader);
    procedure DrawFooter(AFooter: TdxRichEditLayoutFooter);
    procedure DrawFrame(AFrame: TdxRichEditLayoutFrame);
    procedure DrawParagraphFrame(AParagraphFrame: TdxRichEditParagraphFrameBox);
    procedure DrawTextBox(ATextBox: TdxRichEditLayoutTextBox);
    procedure DrawFloatingPicture(AFloatingPicture: TdxRichEditLayoutFloatingPicture);
    procedure DrawTable(ATable: TdxRichEditLayoutTable);
    procedure DrawTableRow(ATableRow: TdxRichEditLayoutTableRow);
    procedure DrawTableCell(ATableCell: TdxRichEditLayoutTableCell);
    ...
    procedure DrawRow(ARow: TdxRichEditLayoutRow);
    procedure DrawPlainTextBox(APlainTextBox: TdxRichEditPlainTextBox);
    procedure DrawSpecialTextBox(ASpecialTextBox: TdxRichEditPlainTextBox);
    procedure DrawInlinePictureBox(AInlinePictureBox: TdxRichEditInlinePictureBox);
    procedure DrawFloatingObjectAnchorBox(AFloatingObjectAnchorBox: TdxRichEditFloatingObjectAnchorBox);
    procedure DrawSpaceBox(ASpaceBox: TdxRichEditPlainTextBox);
    procedure DrawParagraphMarkBox(AParagraphMarkBox: TdxRichEditPlainTextBox);
    procedure DrawSectionBreakBox(ASectionBreakBox: TdxRichEditPlainTextBox);
    procedure DrawLineBreakBox(ALineBreakBox: TdxRichEditPlainTextBox);
    procedure DrawPageBreakBox(APageBreakBox: TdxRichEditPlainTextBox);
    procedure DrawColumnBreakBox(AColumnBreakBox: TdxRichEditPlainTextBox);
    procedure DrawHyphenBox(AHyphen: TdxRichEditPlainTextBox);
    procedure DrawTabSpaceBox(ATabSpaceBox: TdxRichEditPlainTextBox);
    procedure DrawPageNumberBox(APageNumberBox: TdxRichEditPlainTextBox);
    procedure DrawNumberingListMarkBox(ANumberingListMarkBox: TdxRichEditNumberingListMarkBox);
    procedure DrawNumberingListWithSeparatorBox(ANumberingListWithSeparatorBox: TdxRichEditNumberingListWithSeparatorBox);
    ...
    procedure DrawUnderlineBox(AUnderlineBox: TdxRichEditUnderlineBox);
    procedure DrawStrikeoutBox(AStrikeoutBox: TdxRichEditStrikeoutBox);
    procedure DrawErrorBox(AErrorBox: TdxRichEditErrorBox);
    procedure DrawHighlightAreaBox(AHighlightAreaBox: TdxRichEditHighlightAreaBox);
    procedure DrawBookmarkStartBox(ABookmarkStartBox: TdxRichEditBookmarkBox);
    procedure DrawBookmarkEndBox(ABookmarkEndBox: TdxRichEditBookmarkBox);
    procedure DrawHiddenTextUnderlineBox(AHiddenTextUnderlineBox: TdxRichEditHiddenTextUnderlineBox);
    procedure DrawLineNumberBox(ALineNumberBox: TdxRichEditLineNumberBox);
    procedure DrawFieldHighlightAreaBox(AFieldHighlightAreaBox: TdxRichEditFieldHighlightAreaBox);
    procedure DrawRangePermissionHighlightAreaBox(ARangePermissionHighlightAreaBox: TdxRichEditRangePermissionHighlightAreaBox);
    procedure DrawRangePermissionStartBox(ARangePermissionStartBox: TdxRichEditRangePermissionBox);
    procedure DrawRangePermissionEndBox(ARangePermissionEndBox: TdxRichEditRangePermissionBox);
    procedure DrawCommentHighlightAreaBox(ACommentHighlightAreaBox: TdxRichEditCommentHighlightAreaBox);
    procedure DrawCommentStartBox(ACommentStartBox: TdxRichEditCommentBox);
    procedure DrawCommentEndBox(ACommentEndBox: TdxRichEditCommentBox);
...
const
  dxThisUnitName = 'dxRichEdit.Api.Layout.Painters';
...
begin
  ...
  begin
    ...
    if Safe.Cast(TObject(Parent), TdxRichEditLayoutPageArea, APageArea) then
    begin
...
begin
  Result := Safe.Cast(AObj, TdxRichEditFixedRange, ARange) and (Start = ARange.Start) and (Length = ARange.Length);
end;
...
begin
  ...
  begin
    if Safe.Cast(FRow.NumberingListBox, TdxNumberingListBoxWithSeparator, ABoxWithSeparator) then
...
begin
  ...
  TdxFloatingObjectBox.AddReference(FFloatingObject);
end;

destructor TdxRichEditLayoutFloatingObject.Destroy;
begin
  TdxFloatingObjectBox.Release(FFloatingObject);
  inherited Destroy;
end;
...
begin
  ...
  try
    ...
    begin
      if Safe.Cast(ACollection[I], TdxModelFloatingObjectAnchorBox, AModelBox) then
      begin
        AInverseList.Add(TdxRichEditFloatingObjectAnchorBox.Create(AModelBox,
          TRect.CreateSize(ACollection[ABoxIndex].Bounds.Location, AModelBox.Bounds.Size), FRow));
      end
      else
        Break;
    end;
...
function TdxRichEditObjectLayoutElementCollection<T>.GetItem(Index: TdxListIndex): T;
begin
...
begin
  Exporter.ExportPage(APage.ModelPage,
    procedure
    begin
      TdxRichEditPagePainterVisitor(FPainterVisitor).DefaultVisitPage(APage);
    end);
end;

procedure TdxRichEditPagePainter.DrawPageArea(APageArea: TdxRichEditLayoutPageArea);
begin
  TdxRichEditPagePainterVisitor(FPainterVisitor).DefaultVisitPageArea(APageArea);
...
begin
  ...
  TdxRichEditPagePainterVisitor(FPainterVisitor).DefaultVisitColumn(AColumn);
...
begin
  ...
  begin
    ...
    TdxRichEditPagePainterVisitor(FPainterVisitor).DefaultVisitComments(APage);
  end;
end;
...
begin
  ...
  if Exporter.ShouldExportComment(AComment.ModelComment) then
    TdxRichEditPagePainterVisitor(FPainterVisitor).DefaultVisitComment(AComment);
...
begin
  ...
  TdxRichEditPagePainterVisitor(FPainterVisitor).DefaultVisitHeader(AHeader);
  Exporter.RestorePieceTable;
  Exporter.PopBackgroundLayer;
end;
...
begin
  ...
  TdxRichEditPagePainterVisitor(FPainterVisitor).DefaultVisitFooter(AFooter);
  Exporter.RestorePieceTable;
  Exporter.PopBackgroundLayer;
end;
...
begin
  ...
  try
    ...
    if Safe.Cast(ATextBox.AnchorRun.Content, TdxTextBoxFloatingObjectContent, AContent) then
    begin
    ...
    TdxRichEditPagePainterVisitor(FPainterVisitor).DefaultVisitTextBox(ATextBox);
    Exporter.PopBackgroundLayer;
    Exporter.EndExportCompositeObject(AOldClipRect, AOldPieceTable);
  finally
...
begin
  ...
  TdxRichEditPagePainterVisitor(FPainterVisitor).DefaultVisitTable(ATable);
...
begin
  TdxRichEditPagePainterVisitor(FPainterVisitor).DefaultVisitTableRow(ATableRow);
end;
...
begin
   ...
   TdxRichEditPagePainterVisitor(FPainterVisitor).DefaultVisitTableCell(ATableCell);
...
begin
  if ShouldExportRowBackground(ARowExtendedBoxes) then
    TdxRichEditPagePainterVisitor(FPainterVisitor).DefaultVisitRowBackground(ARowExtendedBoxes);
end;
...
begin
  ...
  TdxRichEditPagePainterVisitor(FPainterVisitor).DefaultVisitRow(ARow);
...
begin
  ...
  if not ShouldOptimizeBox(ACurrentRow) then
    TdxRichEditPagePainterVisitor(FPainterVisitor).DefaultVisitUnderlineBoxes(AUnderlineBoxes);
end;
...
begin
  ...
  if not ShouldOptimizeBox(ACurrentRow) then
    TdxRichEditPagePainterVisitor(FPainterVisitor).DefaultVisitStrikeoutBoxes(AStrikeoutBoxes);
end;
...
begin
  if ABookmarkBoxes.Count > 0 then
    TdxRichEditPagePainterVisitor(FPainterVisitor).DefaultVisitBookmarkBoxes(ABookmarkBoxes);
end;
...
begin
  ...
  begin
    if not AModelRows[I].IsTableCellRow then
...
begin
  ...
  for I := 0 to AModelRows.Count - 1 do
  begin
    ARow := TdxTableCellRow(AModelRows.List[I]);
    if ARow.IsTableCellRow and (ATable.ModelTable = ARow.CellViewInfo.TableViewInfo) then
