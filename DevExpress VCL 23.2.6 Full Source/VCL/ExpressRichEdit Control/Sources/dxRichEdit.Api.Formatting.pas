...
type
  ...
  { TdxNativeStyleCollections }

  TdxNativeStyleCollections = class sealed
  public
    class function GetCharacterStyleCollection(ADocument: TdxNativeDocument): IdxRichEditCharacterStyleCollection; static;
    class function GetParagraphStyleCollection(ADocument: TdxNativeDocument): IdxRichEditParagraphStyleCollection; static;
    class function GetTableStyles(ADocument: TdxNativeDocument): IdxRichEditTableStyleCollection; static;

    class function GetStyle(const AStyles: IdxRichEditTableStyleCollection; ATableStyle: TdxTableStyle): IdxRichEditTableStyle; overload; static;
    class function GetStyle(const AStyles: IdxRichEditParagraphStyleCollection; AParagraphStyle: TdxParagraphStyle): IdxRichEditParagraphStyle; overload; static;
    class function GetInnerStyle(const AStyle: IdxRichEditParagraphStyle): TdxParagraphStyle; overload; static;
    class function GetInnerStyle(const AStyle: IdxRichEditTableStyle): TdxTableStyle; overload; static;
  end;

  { TdxNativeProperties }

  TdxNativeProperties = class sealed
  public const
  ...
  public
    class function GetDefaultParagraphProperties(ADocument: TdxNativeDocument;
      AProperties: TdxParagraphProperties): IdxRichEditParagraphPropertiesBase; static;
    class function GetDefaultCharacterProperties(AProperties: TdxCharacterProperties): IdxRichEditCharacterPropertiesBase; static;
    class function GetDefaultTableProperties(ADocument: TdxNativeDocument;
      AProperties: TdxTableProperties): IdxRichEditTablePropertiesBase; static;
    class function GetNativeSimpleCharacterProperties(AProperties: TdxCharacterProperties): IdxRichEditCharacterPropertiesBase; static;
    class function GetNativeSimpleParagraphProperties(ADocument: TdxNativeDocument;
      AParagraphProperties: TdxParagraphProperties): IdxRichEditParagraphPropertiesBase; static;
    class function GetNativeParagraphProperties(ADocument: TdxNativeSubDocument; AFrom, ALength: Integer): IdxRichEditParagraphProperties; static;
    class function GetNativeCharacterProperties(ADocument: TdxNativeSubDocument;
      AFrom: TdxDocumentLogPosition; ALength: Integer): IdxRichEditCharacterProperties;

    class function ApiMaskToModelMask(const AMask: TdxRichEditTablePropertiesMask): Integer; static;

    class procedure ApplyRichEditCharacterProperties(const AProperties: IdxRichEditCharacterProperties);
    class procedure ApplyRichEditParagraphProperties(const AProperties: IdxRichEditParagraphProperties);
...
const
  dxThisUnitName = 'dxRichEdit.Api.Formatting';
...
var
  ...
  AOptions: TdxCharacterFormattingOptions;
begin
  ARun.CharacterProperties.ResetUse(TdxCharacterFormattingOptions.MaskUseAll - FResetOptions.Value);
...
begin
  AParagraph.ParagraphProperties.ResetUse(TdxParagraphFormattingOptions.MaskUseAll - FResetOptions.Value);
...
begin
  ...
  if ATabInfo = nil then
    Exit(nil);
  Result := TdxNativeProperties.CreateTabInfoCollection(Document, ATabInfo);
end;
...
begin
  ...
  AInfo := TdxNativeProperties.CreateModelTabInfoCollection(Document, ATabs);
  try
    FTabs.SetTabs(AInfo);
  finally
    AInfo.Free;
...
begin
  if AOnlyOwnTabs then
    AModifier := TdxPieceTableModifiers.CreateOwnTabFormattingInfoModifier(nil, Document.DocumentModel.DocumentProperties.DefaultTabWidth)
  else
    AModifier := TdxPieceTableModifiers.CreateTabFormattingInfoModifier(nil, Document.DocumentModel.DocumentProperties.DefaultTabWidth);
  try
  ...
  Result := TdxNativeProperties.CreateTabInfoCollection(Document, AInfo);
end;
...
begin
  ...
  AInfo := TdxNativeProperties.CreateModelTabInfoCollection(Document, ATabs);
  try
    AModifier := TdxPieceTableModifiers.CreateTabFormattingInfoModifier(AInfo, Document.DocumentModel.DocumentProperties.DefaultTabWidth);
    try
      Document.PieceTable.ApplyParagraphFormatting(From, Length, AModifier);
    finally
      AModifier.Free;
...
begin
  if not Properties.UseVerticalAlignment then
    ...
    Result := TdxNativeProperties.VerticalAlignmentMap[Properties.VerticalAlignment];
end;
...
begin
  if Value.IsNull then
    ...
    Properties.VerticalAlignment := TdxNativeProperties.ModelVerticalAlignmentMap[Value.Value];
end;
...
begin
  Properties.ResetUse(TdxNativeProperties.ApiMaskToModelMask(AMask));
end;
...
var
  AStyle: TdxStyleBase;
begin
  AStyle := InnerStyles[Index];
  Result := GetStyle(AStyle);
end;
...
var
  AStyle: TdxStyleBase;
begin
  AStyle := InnerStyles.GetStyleByName(AName);
  Result := GetStyle(AStyle);
end;
...
class function TdxNativeStyleCollections.GetCharacterStyleCollection(
  ADocument: TdxNativeDocument): IdxRichEditCharacterStyleCollection;
begin
  Result := TdxNativeCharacterStyleCollection.Create(ADocument);
end;

class function TdxNativeStyleCollections.GetInnerStyle(const AStyle: IdxRichEditParagraphStyle): TdxParagraphStyle;
begin
  Result := TdxNativeParagraphStyle(AStyle).InnerStyle;
end;

class function TdxNativeStyleCollections.GetInnerStyle(const AStyle: IdxRichEditTableStyle): TdxTableStyle;
begin
  Result := TdxNativeTableStyle(AStyle).InnerStyle;
end;

class function TdxNativeStyleCollections.GetParagraphStyleCollection(
  ADocument: TdxNativeDocument): IdxRichEditParagraphStyleCollection;
begin
  Result := TdxNativeParagraphStyleCollection.Create(ADocument);
end;

class function TdxNativeStyleCollections.GetStyle(const AStyles: IdxRichEditParagraphStyleCollection;
  AParagraphStyle: TdxParagraphStyle): IdxRichEditParagraphStyle;
begin
  Result := TdxNativeParagraphStyleCollection(AStyles).GetStyle(AParagraphStyle);
end;

class function TdxNativeStyleCollections.GetStyle(const AStyles: IdxRichEditTableStyleCollection;
  ATableStyle: TdxTableStyle): IdxRichEditTableStyle;
begin
  Result := TdxNativeTableStyleCollection(AStyles).GetStyle(ATableStyle);
end;

class function TdxNativeStyleCollections.GetTableStyles(ADocument: TdxNativeDocument): IdxRichEditTableStyleCollection;
begin
  Result := TdxNativeTableStyleCollection.Create(ADocument);
end;

{ TdxNativeProperties }

class function TdxNativeProperties.ApiMaskToModelMask(const AMask: TdxRichEditTablePropertiesMask): Integer;
begin
  Result := 0;
...
class procedure TdxNativeProperties.ApplyRichEditCharacterProperties(const AProperties: IdxRichEditCharacterProperties);
begin
  TdxNativeCharacterProperties(AProperties).Apply;
end;

class procedure TdxNativeProperties.ApplyRichEditParagraphProperties(const AProperties: IdxRichEditParagraphProperties);
begin
  TdxNativeParagraphProperties(AProperties).Apply;
end;

class function TdxNativeProperties.CreateModelTabInfo(ADocument: TdxNativeSubDocument;
...
class function TdxNativeProperties.CreateModelTabInfoCollection(ADocument: TdxNativeSubDocument;
...
class function TdxNativeProperties.CreateTabInfo(ADocument: TdxNativeSubDocument;
  const ATabInfo: TdxTabInfo): IdxRichEditTabInfo;
begin
  Result := TdxNativeTabInfo.Create;
...
class function TdxNativeProperties.CreateTabInfoCollection(ADocument: TdxNativeSubDocument;
...
class function TdxNativeProperties.GetDefaultCharacterProperties(AProperties: TdxCharacterProperties): IdxRichEditCharacterPropertiesBase;
begin
  Result := TdxNativeDefaultCharacterProperties.Create(AProperties);
end;

class function TdxNativeProperties.GetDefaultParagraphProperties(ADocument: TdxNativeDocument;
  AProperties: TdxParagraphProperties): IdxRichEditParagraphPropertiesBase;
begin
  Result := TdxNativeDefaultParagraphProperties.Create(ADocument, AProperties);
end;

class function TdxNativeProperties.GetDefaultTableProperties(ADocument: TdxNativeDocument;
  AProperties: TdxTableProperties): IdxRichEditTablePropertiesBase;
begin
  Result := TdxNativeDefaultTableProperties.Create(ADocument, AProperties);
end;

class function TdxNativeProperties.GetNativeCharacterProperties(ADocument: TdxNativeSubDocument;
  AFrom: TdxDocumentLogPosition; ALength: Integer): IdxRichEditCharacterProperties;
begin
  Result := TdxNativeCharacterProperties.Create(ADocument, AFrom, ALength);
end;

class function TdxNativeProperties.GetNativeParagraphProperties(ADocument: TdxNativeSubDocument; AFrom,
  ALength: Integer): IdxRichEditParagraphProperties;
begin
  Result := TdxNativeParagraphProperties.Create(ADocument, AFrom, ALength);
end;

class function TdxNativeProperties.GetNativeSimpleCharacterProperties(
  AProperties: TdxCharacterProperties): IdxRichEditCharacterPropertiesBase;
begin
  Result := TdxNativeSimpleCharacterProperties.Create(AProperties);
end;

class function TdxNativeProperties.GetNativeSimpleParagraphProperties(ADocument: TdxNativeDocument;
  AParagraphProperties: TdxParagraphProperties): IdxRichEditParagraphPropertiesBase;
begin
  REsult := TdxNativeSimpleParagraphProperties.Create(ADocument, AParagraphProperties);
end;
