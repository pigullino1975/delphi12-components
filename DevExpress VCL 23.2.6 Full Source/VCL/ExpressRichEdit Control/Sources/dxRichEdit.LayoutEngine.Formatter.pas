...
unit dxRichEdit.LayoutEngine.Formatter; // for internal use
...
type
  ...
  protected
    ...
    function GetParagraph: TdxParagraph; inline;
  ...
  private
    ...
    function GetRowsController: TdxRowsController; inline;
  protected
    ...
    procedure FinishParagraphCore(AIterator: TdxParagraphIteratorBase); override;
    function GetIterator: TdxParagraphIteratorBase; override;
    function GetIterator_: TdxParagraphBoxIterator; inline; 
    function GetFormattingComplete: Boolean; override;
    function GetMeasurer: TdxBoxMeasurer; override;
    ...
    class function GetContinueFormatResult(AResult: TdxCompleteFormattingResult): TdxStateContinueFormatResult; static; inline;
  ...
  private
    function GetItem(Index: Integer): TdxBoxInfo; inline;
  public
  ...
  private
    FBoxIndex: Integer;
    function GetCurrentBox: TdxBox; inline;
  public
    function CreatePosition: TdxFormatterPosition; override;
  ...
  public
    ...
    procedure ChangeState(AStateType: TdxParagraphBoxFormatterState); 
    ...
    procedure Initialize(ARowsController: TdxRowsController); 
    procedure SubscribeRowsControllerEvents;
    procedure UnsubscribeRowsControllerEvents;
    ...
    function ShouldPageBreakBeforeParagraph(AParagraph: TdxParagraph): Boolean;
  ...
  protected
    procedure CreateStates; override;
    procedure DestroyStates; override;
    procedure FormatParagraph(AIterator: TdxParagraphIteratorBase);
  ...
  public
    ...
    procedure ChangeState(AStateType: TdxCharacterFormatterState); 
    procedure BeginParagraph(ABeginFromParagraphStart, AParagraphFrameStarted: Boolean); override; final;
    procedure FormatNumberingListBoxes; 
    ...
    procedure Format(AIterator: TdxParagraphCharacterIterator);
  ...
  protected
    ...
    function CalculateSpacingBefore: Integer;
    function CanAddSectionBreakToPrevRow: Boolean;
    ...
    function CompleteCurrentColumnFormatting: TdxCompleteFormattingResult;
    ...
    function GetContextualSpacingAfter(AParagraph: TdxParagraph): Integer;
  ...
  public
    ...
    procedure RecreateHorizontalPositionController;
    ...
    procedure StartNewWord;
    procedure AddSingleDecimalTabInTable;
    procedure AddTabBox(const ATab: TdxTabInfo; ABoxInfo: TdxBoxInfo);
    ...
    procedure AddSectionBreakBoxToPrevRow(ABoxType: TdxBoxClass; ABoxInfo: TdxBoxInfo);
    function GetBox(ABoxType: TdxBoxClass; ABoxInfo: TdxBoxInfo): TdxBox;
    ...
    procedure ApplyParagraphFrameBoxBounds(AParagraphFrameBox: TdxParagraphFrameBox; ANewParagraphFrameBox: TdxParagraphFrameBox);
    procedure FormatParagraphFrameTextBox(AParagraphFrameBox: TdxParagraphFrameBox);
    procedure AddParagraphFrameToLayoutCore(AParagraphFrameBox: TdxParagraphFrameBox; ABoxInfo: TdxBoxInfo);
    function AddParagraphFrameToLayout(AParagraphFrameBox: TdxParagraphFrameBox; ABoxInfo: TdxBoxInfo): Boolean;
    ...
    function CalculateRestartPositionDueFloatingObject(ABox: TdxSinglePositionBox; const ABounds: TRect; AIsContains: Boolean;
      const ACurrentPosition: TPoint): TdxDocumentModelPosition; overload; virtual;
    function CanFitCurrentRowToColumnCore(ANewRowHeight: Integer): TdxCanFitCurrentRowToColumnResult; inline;
    function CanFitNumberingListBoxToCurrentRow(const ABoxSize: TSize): Boolean; inline;
    ...
    function HaveAvailableSpaceInRow: Boolean;
    ...
    function TryToRemoveLastTabBox: Boolean;
    ...
    function ShouldUseMaxDescent: Boolean;
    procedure CreateNewCurrentRow(APrevCurrentRow: TdxRow; AAfterRestart: Boolean);
    ...
    procedure EnforceNextRowToStartFromNewPage;
  ...
  private
    ...
    function GetState: TdxTablesControllerStateBase; inline;
  ...
  TdxTableCellIteratorBase = class abstract
  protected
  ...
  TdxTableCellHorizontalBorderCalculator = record
  private
    FTable: TdxTable;
  ...
  public
    ...
    procedure EnsureCurrentCell(ACell: TdxTableCell); override;
    procedure OnCurrentRowFinished; override;
    procedure LeaveCurrentTable(ABeforeRestart, ARollbackParent: Boolean);
    procedure EndParagraph(ALastRow: TdxRow); override;
    procedure UpdateCurrentCellBottom(ABottom: TdxLayoutUnit); override;
    procedure UpdateCurrentCellHeight(ARow: TdxRow); override;
    procedure BeforeMoveRowToNextColumn; override;
  ...
  public
    ...
    property IsInsideTable: Boolean read FIsInsideTable write FIsInsideTable;
  ...
  TdxFloatingObjectHorizontalPositionCalculator = record
  private
    FUnitConverter: TdxDocumentModelUnitToLayoutUnitConverter;
    ...
    function CalculateAbsoluteFloatingObjectHorizontalAlignmentPosition(
      AAlignment: TdxFloatingObjectHorizontalPositionAlignment; AAlignBounds: TRect; AActualWidth, APageIndex: Integer): Integer;
  public
    constructor Create(AUnitConverter: TdxDocumentModelUnitToLayoutUnitConverter);
    function CalculateAbsoluteFloatingObjectWidth(const ALocation: IdxFloatingObjectLocation;
      const APlacementInfo: TdxFloatingObjectTargetPlacementInfo): Integer;
  ...
  TdxFloatingObjectVerticalPositionCalculator = record
  private
    FUnitConverter: TdxDocumentModelUnitToLayoutUnitConverter;
  ...
  TdxMaxWidthCalculator = class sealed
  public
    class function GetMaxWidth(APage: TdxPage): Integer; overload; static;
    class function GetMaxWidth(AAreas: TdxPageAreaCollection): Integer; overload; static;
    class function GetMaxWidth(AColumns: TdxColumnCollection): Integer; overload; static;
    class function GetMaxWidth(ATables: TdxTableViewInfoCollection): Integer; overload; static;
    class function GetMaxWidth(ARows: TdxRowCollection): Integer; overload; static;

    class function GetMaxRight(ARows: TdxRowCollection): Integer; static;
    class function GetLastNonLineBreakBox(ARow: TdxRow): TdxBox; static;
    class function GetLastNonLineBreakOrSpaceBox(ARow: TdxRow): TdxBox; static;
  end;
  ...
  public
    ...
    function CalcBoxAscentAndFree(ABox: TdxBox): Integer; inline; 
    function CalcBaseBoxDescent(ABox: TdxBox): Integer; 
    function CalcBaseBoxAscentAndFree(ABox: TdxBox): Integer; 
    function CalculateSubscriptOrSuperScriptOffset(ABox: TdxBox): Integer; inline; 
    ...
    function CalculateContentOffset(AVerticalAlignment: TdxVerticalAlignment; AMaxContentHeight, AContentHeight: Integer): Integer; overload;
  ...
  protected
    ...
    function GetRowContentBoxes(ARow: TdxRow): TArray<TdxBox>;
  public
  ...
  protected
    function IsSpaceBox(ABox: TdxBox): Boolean; inline;
    function IsMarkBox(ABox: TdxBox): Boolean; inline;
...
const
  dxThisUnitName = 'dxRichEdit.LayoutEngine.Formatter';

type
  TdxBoxAccess = class(TdxBox);
  ...
  TdxTextAreaAndXComparable = record
  private
    FX: Integer;
  public
  ...
  TdxTableCellLeftComparable = record
  private
    FPos: Integer;
  public
  ...
  TdxRowParagraphComparer = record
  strict private
  ...
  TTableViewInfoAndStartRowSeparatorIndexComparer = record
  private
  ...
  TTableViewInfoAndEndRowSeparatorIndexComparer = record
  private
    FRowSeparatorIndex: Integer;
  public
    constructor Create(ARowSeparatorIndex: Integer);
  ...
  TdxParagraphFrameHorizontalPositionCalculator = record
  strict private
    FUnitConverter: TdxDocumentModelUnitToLayoutUnitConverter;
    function CalculateAlignBounds(const ALocation: IdxParagraphFrameLocation;
      const APlacementInfo: TdxFloatingObjectTargetPlacementInfo): TRect;
    ...
    function CalculateAbsoluteFloatingObjectHorizontalAlignmentPosition(AAlignment: TdxParagraphFrameHorizontalPositionAlignment;
      const AAlignBounds: TRect; AActualWidth: Integer): Integer;
  public
    constructor Create(AUnitConverter: TdxDocumentModelUnitToLayoutUnitConverter);
 ...
 { TdxStateParagraphStartAfterBreak }
  ...
  public
    ...
    procedure HyphenateCurrentWord;
  ...
  private
    ...
    function GetAvailableTextAreaInitialPosition(APreferredTextAreaIndex: Integer): TPositionInfo;
...
begin
  Result := TdxRow(Value).Paragraph.Index - FIndex;
end;
...
var
  A160B5961606346141C025B38140F1A05754219146E6D6525: TdxMergedFrameProperties;
begin
  A160B5961606346141C025B38140F1A05754219146E6D6525 := PieceTable.Runs[RunIndex].Paragraph.GetMergedFrameProperties;
  try
    Result := (A160B5961606346141C025B38140F1A05754219146E6D6525 <> nil) and A160B5961606346141C025B38140F1A05754219146E6D6525.IsParagraphFrame;
  finally
    A160B5961606346141C025B38140F1A05754219146E6D6525.Free;
  end;
end;
...
class function TdxBoxFormatterStateBase.GetContinueFormatResult(AResult: TdxCompleteFormattingResult): TdxStateContinueFormatResult;
begin
...
begin
  ...
  try
    AIterator := Iterator;
    ABoxInfo.StartPos := AIterator.GetCurrentPosition;
    if CanUseBox and (ABoxInfo.StartPos = AIterator.CurrentBox.StartPos) then
    begin
      AAddExistingBoxResult := AddExistedBox(ABoxInfo, AIterator);
      if AAddExistingBoxResult <> TdxStateContinueFormatResult.Success then
        Exit(AAddExistingBoxResult);
      if AIterator.IsEnd then
      begin
        if AIterator.IsParagraphFrame and (Self is TdxStateFloatingObject) then
          Exit(TdxStateContinueFormatResult.Success);
    ...
    Result := ContinueFormatByCharacter(ABoxInfo, Safe<TdxLayoutDependentTextBox>.Cast(AIterator.CurrentBox))
  finally
    ABoxInfo.Free;
  end;
end;
...
begin
  ...
  if (ACurrentBottom >= Formatter.MaxHeight) and not Iterator.Paragraph.IsInCell and
    (Iterator.Paragraph.FrameProperties = nil) or Formatter.RowsController.ForceFormattingComplete then
...
function TdxLineSpacingCalculatorBase.GetRowContentBoxes(ARow: TdxRow): TArray<TdxBox>;
var
  I, ACount: Integer;
begin
  ACount := ARow.Boxes.Count;
  if ARow.NumberingListBox <> nil then
    SetLength(Result, ACount + 1)
  else
    SetLength(Result, ACount);
  for I := 0 to ACount - 1 do
    Result[I] := ARow.Boxes.List[I];
  if ARow.NumberingListBox <> nil then
    Result[ACount] := ARow.NumberingListBox;
end;
...
class function TdxMaxWidthCalculator.GetMaxWidth(APage: TdxPage): Integer;
var
  I: Integer;
begin
...
class function TdxMaxWidthCalculator.GetMaxWidth(AAreas: TdxPageAreaCollection): Integer;
var
  ARows: TdxRowCollection;
  I: Integer;
begin
  ...
  begin
    ...
    Result := Max(Result, GetMaxWidth(AAreas[I].Columns));
  end;
end;

class function TdxMaxWidthCalculator.GetMaxWidth(AColumns: TdxColumnCollection): Integer;
var
  I: Integer;
begin
  Result := MinInt;
  for I := 0 to AColumns.Count - 1 do
    Result := Max(Result, GetMaxWidth(AColumns[I].Tables));
end;

class function TdxMaxWidthCalculator.GetMaxWidth(ATables: TdxTableViewInfoCollection): Integer;

  function GetMaxWidth(ARows: TdxTableRowViewInfoCollection): Integer;
  var
    I: Integer;
  begin
    Result := MinInt;
    for I := 0 to ARows.Count - 1 do
      Result := Max(Result, ARows[I].GetBounds.Right);
  end;
...
begin
  ...
  for I := 0 to ATables.Count - 1 do
    Result := Max(Result, GetMaxWidth(ATables[I].Rows));
end;

class function TdxMaxWidthCalculator.GetMaxWidth(ARows: TdxRowCollection): Integer;
var
  ALastBox: TdxBox;
  I: Integer;
begin
...
class function TdxMaxWidthCalculator.GetMaxRight(ARows: TdxRowCollection): Integer;
var
  I: Integer;
  ALastBox: TdxBox;
begin
...
class function TdxMaxWidthCalculator.GetLastNonLineBreakBox(ARow: TdxRow): TdxBox;
var
  I: Integer;
begin
...
class function TdxMaxWidthCalculator.GetLastNonLineBreakOrSpaceBox(ARow: TdxRow): TdxBox;
var
  I: Integer;
  ABox: TdxBox;
begin
  ...
  begin
    ABox := ARow.Boxes[I];
    if not ABox.IsLineBreak and ABox.IsNotWhiteSpaceBox then
      Exit(ABox);
  end;
  Result := nil;
end;
...
function TdxParagraphFinalFormatter.CalculateContentOffset(AVerticalAlignment: TdxVerticalAlignment; AMaxContentHeight,
...
begin
  ...
  if not TdxAlgorithms1<TdxBoxBase>.BinarySearch(FCurrentColumn.Rows, AComparer.CompareTo, Result) then
    Exit(-Result);

  for I := Result - 1 downto 0 do
  begin
    if TdxRow(ARows.List[I]).Paragraph.Index <> AParagraphIndex then
      Break;
    Result := I;
  end;
end;
...
var
  ABox, ANextBox: TdxParagraphFrameBox;
  I, ACount: Integer;
begin
  ANextBox := nil;
  ...
  for I := ACount - 1 downto 0 do
  begin
    ABox := AParagraphFrames.List[I];
    FormatParagraphFrame(ABox, ANextBox);
    ANextBox := ABox;
  end;
end;
...
begin
  AFields := PieceTable.Fields;
  TdxAlgorithms1<TdxField>.BinarySearch(AFields.InnerList,
    function (const AField: TdxField): Integer
    begin
      Result := AField.LastRunIndex - ARunIndex
    end, Result);
...
var
  ...
  ASourceFontName, ASubstituteFontName: string;
...
begin
  ...
  begin
    ASubstituteFontName := AFontCache.FindSubstituteFont(ASourceFontName, ACh, AFontCharacterSet);
    TdxTextRunBase(ABox.GetRun(PieceTable)).FontName := ASubstituteFontName;
  end;
end;
...
begin
  ...
  for I := 0 to ACount - 1 do
  begin
    ABox := Safe<TdxLayoutDependentTextBox>.Cast(ABoxes.List[I]);
    if ABox = nil then
      Continue;
...
var
  A160B5961606346141C025B38140F1A05754219146E6D6525: TdxSection;
begin
  CurrentSectionIndex := CurrentSectionIndex + 1;
  A160B5961606346141C025B38140F1A05754219146E6D6525 := TdxDocumentModel(DocumentLayout.DocumentModel).Sections[CurrentSectionIndex];

  ApplySectionStart(A160B5961606346141C025B38140F1A05754219146E6D6525);
  RestartFormattingFromTheMiddleOfSectionCore(A160B5961606346141C025B38140F1A05754219146E6D6525);
  FFirstPageOfSection := True;
end;
...
begin
  ...
  begin
    ...
    begin
      ...
      TdxAlgorithms1<TdxTableCellViewInfo>.BinarySearch(ACells, AComparable.CompareTo, ACurrentCellViewInfoIndex);
...
begin
  ...
  if not TdxAlgorithms1<TdxTableViewInfo>.BinarySearch(FTableViewInfos, AComparer.CompareTo, ATableViewInfoIndex) then
...
begin
  ...
  begin
    ...
    if TdxAlgorithms1<TdxTableCellViewInfo>.BinarySearch(ATableViewInfo.Rows[ARowViewInfoIndex].Cells, AComparable.CompareTo, ACellIndex) then
      Assert(False); 
...
begin
  ...
  AIndex := ABreaks.BinarySearch(AComparer.CompareTo);
  if AIndex < 0 then
...
begin
  case AAlignment of
    TdxFloatingObjectHorizontalPositionAlignment.Outside:
     if (APageIndex mod 2) = 0 then
        Exit(AAlignBounds.Right - FUnitConverter.ToLayoutUnits(AActualWidth))
      else
        Exit(AAlignBounds.Left);
...
begin
  ...
  begin
    ...
    Result := CalculateAbsoluteFloatingObjectHorizontalAlignmentPosition(ALocation.HorizontalPositionAlignment,
      AAlignBounds, AActualWidth, APlacementInfo.PageIndex);
  end;
end;
...
begin
  ...
  else if APlacementInfo.IsInsideTable and ALocation.LayoutInTableCell then
    Result := APlacementInfo.ColumnBounds.Top 
  else
  begin
    AAlignBounds := CalculateAlignBounds(ALocation, APlacementInfo);
...
begin
  ...
  TdxAlgorithms<TdxTextArea>.BinarySearch(FTextAreas, AComparable.CompareTo, ATextAreaIndex);
...
function TdxFloatingObjectsCurrentHorizontalPositionController.GetAvailableTextAreaInitialPosition(APreferredTextAreaIndex: Integer): TPositionInfo;
var
  ACount, ATextAreaIndex, ATextOffset, AIndex, AStartPosition: Integer;
begin
  ACount := FTextAreas.Count;
  AIndex := APreferredTextAreaIndex;
  repeat
...
begin
  ...
  if not TdxAlgorithms<TdxTextArea>.BinarySearch(FTextAreas, AComparable.CompareTo, ANewTextAreaIndex) then
  begin
...
begin
  ...
  begin
    APageArea := APage.Areas.Last;
    Result.PageBounds := APage.Bounds;
    if APageArea <> nil then
      Result.PageClientBounds := APageArea.Bounds
    else
  ...
  Result.PageIndex := APage.PageIndex;
  Result.IsInsideTable := RowsController.TablesController.IsInsideTable;
...
procedure TdxTablesControllerTableState.LeaveCurrentTable(ABeforeRestart, ARollbackParent: Boolean);
var
  AColumnController: TdxTableCellColumnController;
  ANewRowBounds: TRect;
begin
...
begin
  {$IFDEF DX_INITIALIZATION_LOGGING}TdxUnitSectionsLogger.ConstructorStarted(UnitName, 'TdxFloatingObjectsLayout.Initialize', SysInit.HInstance);{$ENDIF}
  FHorizontalObjectComparer := THorizontalObjectComparer.Create;
  FVerticalObjectComparer := TVerticalObjectComparer.Create;
  {$IFDEF DX_INITIALIZATION_LOGGING}TdxUnitSectionsLogger.ConstructorFinished(UnitName, 'TdxFloatingObjectsLayout.Initialize', SysInit.HInstance);{$ENDIF}
end;

class destructor TdxFloatingObjectsLayout.Finalize;
begin
  {$IFDEF DX_INITIALIZATION_LOGGING}TdxUnitSectionsLogger.DestructorStarted(UnitName, 'TdxFloatingObjectsLayout.Finalize', SysInit.HInstance);{$ENDIF}
  FreeAndNil(FHorizontalObjectComparer);
  FreeAndNil(FVerticalObjectComparer);
  {$IFDEF DX_INITIALIZATION_LOGGING}TdxUnitSectionsLogger.DestructorFinished(UnitName, 'TdxFloatingObjectsLayout.Finalize', SysInit.HInstance);{$ENDIF}
end;
...
begin
  ...
  Result.StartPos := Iterator.GetCurrentPosition;
  Result.EndPos := Result.StartPos;
  Measurer.MeasureParagraphMark(Result);
end;
...
begin
  {$IFDEF DX_INITIALIZATION_LOGGING}TdxUnitSectionsLogger.ConstructorStarted(dxThisUnitName, 'TdxTextArea.Initialize', SysInit.HInstance);{$ENDIF}
  FStartComparer := TdxTextAreaStartComparer.Create;
  {$IFDEF DX_INITIALIZATION_LOGGING}TdxUnitSectionsLogger.ConstructorFinished(dxThisUnitName, 'TdxTextArea.Initialize', SysInit.HInstance);{$ENDIF}
end;

class destructor TdxTextArea.Finalize;
begin
  {$IFDEF DX_INITIALIZATION_LOGGING}TdxUnitSectionsLogger.DestructorStarted(dxThisUnitName, 'TdxTextArea.Finalize', SysInit.HInstance);{$ENDIF}
  FStartComparer.Free;
  {$IFDEF DX_INITIALIZATION_LOGGING}TdxUnitSectionsLogger.DestructorFinished(dxThisUnitName, 'TdxTextArea.Finalize', SysInit.HInstance);{$ENDIF}
end;
...
begin
  ...
  if Result.HasSpaceBox then
    TdxBoxAccess(Result).SetMinWidth(ABoxInfo.Size.cx); 
...
begin
  ...
  begin
    ...
    if ABoxWithSeparator.SeparatorBox.HasSpaceBox then
...
function TdxRowsController.HaveAvailableSpaceInRow: Boolean;
begin
  Result := CurrentHorizontalPosition < FParagraphRight;
end;
  ...
  try
    ...
    try
      ...
      try
        ...
        begin
          AElementBoundsWidth := Max(TdxMaxWidthCalculator.GetMaxRight(ARows), AColumn.Bounds.Left) - AColumn.Bounds.Left;
...
function TdxRowsController.AddParagraphFrameToLayout(AParagraphFrameBox: TdxParagraphFrameBox; ABoxInfo: TdxBoxInfo): Boolean;
var
  ACurrentRun: TdxTextRunBase;
  AParagraph: TdxSimpleParagraph;
  AMergedFrameProperties: TdxMergedFrameProperties;
begin
  ...
  begin
    AddParagraphFrameToLayoutCore(AParagraphFrameBox, ABoxInfo);
    ...
    try
      if AMergedFrameProperties.Info.TextWrapType <> TdxParagraphFrameTextWrapType.None then
        AParagraphFrameBox.LockPosition := True;
      Result := True;
    finally
      AMergedFrameProperties.Free;
    end;
...
function TdxRowsController.TryToRemoveLastTabBox: Boolean;
var
  ABoxes: TdxBoxCollection;
  AIndex: Integer;
  ATab: TdxTabSpaceBox;
begin
  ...
  Result := ABoxes[AIndex] is TdxTabSpaceBox;
  if Result then
  begin
...
begin
  ...
  if RowsController.TryToRemoveLastTabBox then
  begin
    Formatter.RollbackToLastTab(TdxParagraphBoxIterator(Formatter.Iterator));
    Formatter.RollbackToLastTab;
  end;
...
begin
  ...
  ARects := R.SplitHorizontally(AColumnCount);
...
begin
  {$IFDEF DX_INITIALIZATION_LOGGING}TdxUnitSectionsLogger.ConstructorStarted(UnitName, 'TdxParagraphFramesLayout.Initialize', SysInit.HInstance);{$ENDIF}
  FHorizontalObjectComparer := TRectangularFrameXComparer.Create;
  FVerticalObjectComparer := TRectangularFrameYComparer.Create;
  {$IFDEF DX_INITIALIZATION_LOGGING}TdxUnitSectionsLogger.ConstructorFinished(UnitName, 'TdxParagraphFramesLayout.Initialize', SysInit.HInstance);{$ENDIF}
end;

class destructor TdxParagraphFramesLayout.Finalize;
begin
  {$IFDEF DX_INITIALIZATION_LOGGING}TdxUnitSectionsLogger.DestructorStarted(UnitName, 'TdxParagraphFramesLayout.Finalize', SysInit.HInstance);{$ENDIF}
  FreeAndNil(FHorizontalObjectComparer);
  FreeAndNil(FVerticalObjectComparer);
  {$IFDEF DX_INITIALIZATION_LOGGING}TdxUnitSectionsLogger.DestructorFinished(UnitName, 'TdxParagraphFramesLayout.Finalize', SysInit.HInstance);{$ENDIF}
end;
...
begin
  try
    ...
    begin
      ...
      begin
        ATextInfo := AMeasurer.CreateTextViewInfo(AText, AFontInfo);
...
begin
  Formatter.RollbackToStartOfWord;
  if 
    RowsController.HaveAvailableSpaceInRow then
  begin
    if RowsController.TryToRemoveLastTabBox then
      Formatter.RollbackToLastTab;
  end;
