...
{                                                                    }
{********************************************************************}
unit dxRichEdit.Export.Doc.DocParagraphPropertiesActions; // for internal use
...
type
  ...
  public
    ...
    procedure CreateParagraphPropertyModifiers;
...
const
  dxThisUnitName = 'dxRichEdit.Export.Doc.DocParagraphPropertiesActions';
...
begin
  ...
  CreateParagraphPropertyModifiers;
end;

procedure TdxDocParagraphPropertiesActions.CreateParagraphPropertyModifiers;
begin
  ListAction;
  TabsAction;
  AlignmentAction;
