...
uses
  Windows, Messages, SysUtils, Variants, Classes, RTLConsts, Graphics, Controls, Forms, Dialogs,
...
const
  dxThisUnitName = 'dxRichEdit.Dialogs.CustomNumberingListForm';
...
procedure TdxRichEditCustomNumberingListForm.ApplyCharacterProperties(AProperties: TdxMergedCharacterProperties; AData: TObject);
var
