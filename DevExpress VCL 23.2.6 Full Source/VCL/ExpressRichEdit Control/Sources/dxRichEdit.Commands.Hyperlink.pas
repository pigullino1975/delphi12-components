...
const
  dxThisUnitName = 'dxRichEdit.Commands.Hyperlink';
...
begin
  if Safe.Cast(APieceTable.ContentType, TdxSectionHeader, ASectionHeader) then
  begin
    ...
    if Safe.Cast(APieceTable.ContentType, TdxSectionFooter, ASectionFooter) then
    begin
