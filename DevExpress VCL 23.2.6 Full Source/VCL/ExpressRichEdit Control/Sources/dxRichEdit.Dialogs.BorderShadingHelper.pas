...
type
  ...
  public
    ...
    function DrawVerticalLineRight(ABorderInfoSource: TdxBorderShadingUserControlHelper; ADocumentModel: TdxDocumentModel;
      AToLayoutUnitConverter: TdxDocumentModelUnitToLayoutUnitConverter; const AExporter: TdxGraphicsDocumentLayoutExporterTableBorder;
...
const
  dxThisUnitName = 'dxRichEdit.Dialogs.BorderShadingHelper';
...
function TdxRichEditBorderShadingDialogHelper.DrawHorizontalLineDown(
  ...
  const AExporter: TdxGraphicsDocumentLayoutExporterTableBorder; AWidth, AHeight: Integer): Integer;
var
