...
unit dxRichEdit.Utils.BatchUpdateHelper; // for internal use
...
type
  ...
  TdxBatchUpdateHelper<T: class> = class(TdxBatchUpdateHelper)
  private
  ...
  TdxBatchUpdateHelper<TInfo: class; TOptions> = class(TdxBatchUpdateHelper)
  private
  ...
  TdxBatchInitHelper<T: class> = class(TdxBatchUpdateHelper<T>)
  strict private type
...
const
  dxThisUnitName = 'dxRichEdit.Utils.BatchUpdateHelper';
