...
const
  dxThisUnitName = 'dxGaugeCircularScale';
...
begin
  ...
  ScaleInfo.Selection := GetScaledRect(ASize,
    dxPointF(ScaleInfo.Bounds.Width / ASize.cx, ScaleInfo.Bounds.Height / ASize.cy)).InflateToTRect;
end;
