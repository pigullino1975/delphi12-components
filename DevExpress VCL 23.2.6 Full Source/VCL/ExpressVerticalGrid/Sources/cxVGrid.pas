...
uses
  ...
  dxCore, dxCoreClasses, cxControls, Graphics, dxUxTheme, dxThemeManager, cxGraphics, dxGenerics,
  ...
  cxDataControllerConditionalFormatting, cxFilter, cxDataStorage,
  cxCustomData, dxFilterPopupWindow, cxFindPanel, cxStorage, cxVGridUtils, cxGeometry, dxForms, dxMessages, dxCoreGraphics,
  dxScrollAnimation, cxListBox, cxPC, dxDateRanges, dxScrollbarAnnotations, cxDataControllerSpreadSheetExpressionProvider;
...
type
  ...
  TcxvgMultiRecordsScrollStrategy = class;
  ...
  private class var
    FAddRecordOnEditIfEmpty: Boolean;
  private
    FAppending: Boolean;
    FDeleting: Boolean;
    FInserting: Boolean;
  ...
  public
    ...
    class property AddRecordOnEditIfEmpty: Boolean read FAddRecordOnEditIfEmpty write FAddRecordOnEditIfEmpty;
  published
  ...
  protected
    ...
    function FindNextFocusedRowOnCollapse: TcxCustomRow; virtual;
    ...
    procedure RemoveEditor(AEditor: TcxCellEdit);
  ...
  private
    ...
    function GetVerticalGrid: TcxCustomVerticalGrid;
    function GetViewInfo: TcxCustomRowViewInfo;
    function InternalGetController: TcxvgController; inline;
  protected
    FCellIndex: Integer;
    ...
    procedure CheckInitializeViewInfoByHiddenEditor(ACellViewInfo: TcxRowValueInfo); virtual;
    ...
    procedure DoGetFilterImages(AValueList: TcxFilterValueList; var AImages: TCustomImageList); override;
    ...
    function HasErrors(ARecordIndex: Integer): Boolean; virtual;
    ...
    property Controller: TcxvgController read InternalGetController;
    property VerticalGrid: TcxCustomVerticalGrid read GetVerticalGrid;
  public
    constructor Create(AOwner: TComponent); override;
    destructor Destroy; override;
  ...
  strict private
    ...
    function GetVisibleForExpressionEditor: TdxDefaultBoolean;
    ...
    procedure SetVisibleForExpressionEditor(AValue: TdxDefaultBoolean);
    // events delegation
    ...
    function GetOnGetFilterImages: TcxGetFilterImagesEvent;
    ...
    procedure SetOnGetFilterImages(const Value: TcxGetFilterImagesEvent);
  ...
  protected
    ...
    property OnGetFilterImages: TcxGetFilterImagesEvent read GetOnGetFilterImages write SetOnGetFilterImages;
  ...
  published
    ...
    property VisibleForExpressionEditor: TdxDefaultBoolean read GetVisibleForExpressionEditor
      write SetVisibleForExpressionEditor default bDefault;
  end;
  ...
  public
    ...
    property Items[Index: Integer]: TBandInfo read GetItem; default; // for internal use
  end;
  ...
  protected
    ...
    procedure DoScrollRecords(AScrollCode: TScrollCode; var AScrollPos: Integer); virtual;
    ...
    function IsScrollAnimationEnabled: Boolean; virtual;
    ...
    procedure SetLeftVisibleRecordAndOffset(ALeftVisibleRecord, APixelScrollRecordOffset: Integer; AAnimated: Boolean); virtual;
  ...
  TcxvgRecordScrollAnimationHelper = class(TdxRecordPixelScrollAnimationHelper)
  strict private
    FOwner: TcxvgMultiRecordsScrollStrategy;
  protected
  ...
  public
    constructor Create(AOwner: TcxvgMultiRecordsScrollStrategy);
  end;
  ...
  private
    FRecordScrollAnimationHelper: TcxvgRecordScrollAnimationHelper;
  ...
  protected
    ...
    procedure DoScrollRecords(AScrollCode: TScrollCode; var AScrollPos: Integer); override;
    ...
    function IsScrollAnimationEnabled: Boolean; override;
    procedure RecordScrollAnimated(ALeftVisibleRecord, APixelScrollOffset: Integer);
    procedure SetLeftVisibleRecordAndOffset(ALeftVisibleRecord, APixelScrollRecordOffset: Integer; AAnimated: Boolean); override;

    property RecordsInterval: Integer read GetRecordsInterval;
  public
    constructor Create(AScroller: TcxvgScroller); override;
    destructor Destroy; override;
  ...
  public
    ...
    procedure SetLeftVisibleRecordAndOffset(ATopRecordIndex, ATopRecordOffset: Integer; AAnimated: Boolean);
    function SetRecordVisible(ARecordIndex: Integer): Boolean; virtual;
    procedure SetRowVisible(ARow: TcxCustomRow); virtual;
    procedure SetRowMaxVisible(ARow: TcxCustomRow);
    property BandsInfo: TBandInfoList read GetBandsInfo; // for internal use
  ...
  TcxVerticalGridScrollbarAnnotationOptionsHelper = class(TcxControlScrollbarAnnotationOptionsHelper)
  protected
    function GetDefaultValue(Index: Integer): Boolean; override;
    procedure SetValue(Index: Integer; Value: Boolean); override;
  end;

  TcxVerticalGridScrollbarAnnotationOptions = class(TcxControlScrollbarAnnotationOptions)
  protected
    function CreateHelper: TcxControlScrollbarAnnotationOptionsHelper; override;
  published
    property Active;
  ...
  TcxVirtualVerticalGrid = class(TcxCustomVerticalGrid,
  ...
  private
    ...
    function GetScrollbarAnnotations: TcxVerticalGridScrollbarAnnotationOptions;
    ...
    procedure SetScrollbarAnnotations(Value: TcxVerticalGridScrollbarAnnotationOptions);
  protected
    // IcxFilterControl
    ...
    function IsRecordHasErrors(ARecordIndex: Integer): Boolean;
  ...
  published
    ...
    property ParentFont;
    property PopupMenu;
    property ScrollbarAnnotations: TcxVerticalGridScrollbarAnnotationOptions read GetScrollbarAnnotations write SetScrollbarAnnotations;
    property Styles;
    property TabOrder;
    property TabStop;
    property Visible;
  ...
  private
    function GetItem(Index: TdxListIndex): TcxRowCaptionInfo;
  protected
    procedure RightToLeftConversion(const AClientBounds: TRect);
  public
    property Items[Index: TdxListIndex]: TcxRowCaptionInfo read GetItem; default;
  end;
  ...
  private
    ...
    function GetItem(Index: TdxListIndex): TcxRowValueInfo;
  protected
  ...
  public
    ...
    property Items[Index: TdxListIndex]: TcxRowValueInfo read GetItem; default;
  ...
  public
    ...
    property ValuesLinesInfo: TLineInfoList read FValuesLinesInfo; // for internal use
  ...
  private
    function GetItem(Index: TdxListIndex): TcxCustomRowViewInfo;
  protected
    procedure RightToLeftConversion(const AClientBounds: TRect);
  public
    constructor Create;
    function Find(ARow: TcxCustomRow): TcxCustomRowViewInfo;
    property Items[Index: TdxListIndex]: TcxCustomRowViewInfo read GetItem; default;
  end;
  ...
  public
    ...
    property BandInfo: TBandInfoList read GetBandInfo; // for internal use
    ...
    property CalcHelper: TcxvgCustomPaintStyleCalcHelper read FCalcHelper; // for internal use
    ...
    property FocusLinesInfo: TLineInfoList read FFocusLinesInfo; // for internal use
    ...
    property LinesInfo: TLineInfoList read FLinesInfo write FLinesInfo; // for internal use
    property Painter: TcxvgPainter read GetPainter; // for internal use
    property RowHeaderMinWidth: Integer read FRowHeaderMinWidth;
    property RowIndentWidth: Integer read FRowIndentWidth;
    property RowsViewInfo: TcxRowViewInfoList read FRowsViewInfo; // for internal use
    ...
    property ViewRects: TViewRects read FViewRects; // for internal use
  ...
  public
    ...
    property Painter: TcxCustomLookAndFeelPainter read GetPainter;
    property ScaleFactor: TdxScaleFactor read GetScaleFactor;
    property Scroller: TcxvgScroller read FScroller; // for internal use
    property VerticalGrid: TcxCustomVerticalGrid read FVerticalGrid;
    property ViewInfo: TcxvgCustomViewInfo read FViewInfo; // for internal use
  end;
  ...
  public
    ...
    procedure DrawImage(ACaptionInfo: TcxRowCaptionInfo); overload; virtual;
    procedure DrawImage(ACaptionInfo: TcxRowCaptionInfo; APalette: IdxColorPalette); overload; virtual;
    ...
    property VerticalGrid: TcxCustomVerticalGrid read GetVerticalGrid;
    property ViewInfo: TcxvgCustomViewInfo read GetViewInfo; // for internal use
  end;
  ...
  public
    ...
    property Form: TcxVerticalGridCustomizationForm read FForm; // for internal use
...
type
  ...
  TcxDataControllerHelper = class helper for TcxCustomDataController
  public
    function StartEdit(AItemIndex: Integer; AOptionsData: TcxvgMultiRecordsOptionsData): Boolean;
  end;
...
{ TcxDataControllerHelper }

function TcxDataControllerHelper.StartEdit(AItemIndex: Integer; AOptionsData: TcxvgMultiRecordsOptionsData): Boolean;
var
  AOperations: TcxDataControllerEditOperations;
begin
  if RowCount = 0 then
  begin
    if not TcxvgMultiRecordsOptionsData.AddRecordOnEditIfEmpty then
      Exit(False);
    if (AOptionsData <> nil) and IsUnboundMode then
    begin
      AOperations := GetEditOperations;
      if not (AOptionsData.Editing and (dceoEdit in AOperations)) then
        Exit(False);
      if AOptionsData.Appending and (dceoAppend in AOperations) then
        Append
      else if AOptionsData.Inserting and (dceoInsert in AOperations) then
        Insert
      else
        Exit(False);
    end;
  end;
  Result := CanInitEditing(AItemIndex);
end;

{ TcxVerticalGridFindPanel }

function TcxVerticalGridFindPanel.GetItemCaption(AItem: TcxFindPanelItemKind): string;
begin
  case AItem of
    fpikFindButton:
    ...
    fpikNextButton:
      Result := cxGetResourceString(@scxSvgFindPanelNextButtonCaption);
    fpikPreviousButton:
      Result := cxGetResourceString(@scxSvgFindPanelPreviousButtonCaption);
    else
      Result := inherited GetItemCaption(AItem);
  end;
end;

procedure TcxVerticalGridFindPanel.ClearText;
begin
  inherited;
  Controller.MakeFocusedRecordVisible;
end;

procedure TcxVerticalGridFindPanel.FocusControlContent;
var
  AFocusedRecordIndex: Integer;
  AFirstVisibleRecordIndex: Integer;
begin
  AFocusedRecordIndex := Controller.FocusedRecordIndex;
  AFirstVisibleRecordIndex := Controller.Scroller.LeftVisibleRecord;
  if (AFocusedRecordIndex < AFirstVisibleRecordIndex) or (AFocusedRecordIndex >= AFirstVisibleRecordIndex + Controller.Scroller.VisibleValueCount) then
    Controller.FocusedRecordIndex := AFirstVisibleRecordIndex;
...
function TcxVerticalGridFindPanel.GetController: TcxvgController;
begin
...
procedure TcxVerticalGridConditionalFormattingProvider.DoOwnerBeginUpdate;
begin
  FOwner.BeginUpdate;
end;

procedure TcxVerticalGridConditionalFormattingProvider.DoOwnerEndUpdate;
begin
  FOwner.EndUpdate;
end;

function TcxVerticalGridConditionalFormattingProvider.IsItemVisible(AItem: TObject): Boolean;
var
  ACell: TcxCellEdit absolute AItem;
begin
  Result := ACell.Row.Visible;
end;
...
function TcxVerticalGridConditionalFormattingProvider.GetItemDisplayName(AItem: TObject): string;
var
  ACell: TcxCellEdit absolute AItem;
begin
  Result := ACell.EditRowProperties.Caption;
end;
...
function TcxCustomVerticalGrid.IsDataScrollbar(AKind: TScrollBarKind): Boolean;
begin
...
function TcxCustomVerticalGrid.CreateExpressionProvider: TcxDataCustomExpressionProvider;
begin
...
begin
  ...
  RefreshScrollbarAnnotations(dxAllCustomScrollbarAnnotationKinds + [dxSearchResultScrollbarAnnotationID, dxErrorScrollbarAnnotationID]);
end;
...
procedure TcxCustomVerticalGrid.LayoutStyleChanged;
begin
  if SubClassesCreated then
  begin
    BeginUpdate;
...
function TcxCustomVerticalGrid.CanInitEditing(AItemIndex: Integer): Boolean;
begin
  Result := ((DragAndDropState = ddsNone) or ((DragMode <> dmAutomatic) or not HitTest.HitAtValue));
  if Result then
    Result := DataController.StartEdit(AItemIndex, Safe<TcxvgMultiRecordsOptionsData>.Cast(OptionsData));
end;
...
function TcxCustomVerticalGrid.GetUseLightBorders: Boolean;
begin
...
{ TcxVerticalGridScrollbarAnnotationOptionsHelper }

function TcxVerticalGridScrollbarAnnotationOptionsHelper.GetDefaultValue(
  Index: Integer): Boolean;
begin
  Result := (Index <> 1) and inherited GetDefaultValue(Index);
end;

procedure TcxVerticalGridScrollbarAnnotationOptionsHelper.SetValue(Index: Integer;
  Value: Boolean);
begin
  if Index <> 1 then
...
function TcxVerticalGridScrollbarAnnotationOptions.CreateHelper: TcxControlScrollbarAnnotationOptionsHelper;
begin
  Result := TcxVerticalGridScrollbarAnnotationOptionsHelper.Create(EditingControl as TcxExtEditingControl);
end;
...
function TcxVirtualVerticalGrid.GoToNextScrollbarAnnotation(AKinds: TdxScrollbarAnnotationKinds = dxAllScrollbarAnnotationKinds; AGoForward: Boolean = True; AGoOnCycle: Boolean = False): Boolean;
begin
...
function TcxVirtualVerticalGrid.CreateScrollbarAnnotations: TcxControlScrollbarAnnotationOptions;
begin
  Result := TcxVerticalGridScrollbarAnnotationOptions.Create(Self);
end;
...
function TcxVirtualVerticalGrid.IsRecordHasErrors(ARecordIndex: Integer): Boolean;
var
  I: Integer;
begin
  Result := False;
  for I := 0 to ContainerCount - 1 do
    if TcxCellEdit(Containers[I]).Row.Visible and TcxCellEdit(Containers[I]).HasErrors(ARecordIndex) then
    begin
      Result := True;
      Break;
    end;
...
procedure TcxVirtualVerticalGrid.CMBiDiModeChanged(var Message: TMessage);
begin
  InvalidateScrollbarAnnotations;
  inherited;
end;

function TcxVirtualVerticalGrid.GetScrollableRecordCount: Integer;
begin
  Result := RecordCount;
end;

function TcxVirtualVerticalGrid.IsScrollbarAnnotationVisible(AKind: Integer): Boolean;
begin
  case AKind of
    dxFocusedRowScrollbarAnnotationID:
      Result := FocusedRecordIndex <> -1
  else
...
function TcxVirtualVerticalGrid.GetOnFindCriteriaBeforeChange: TcxDataFindCriteriaBeforeChangeEvent;
begin
  Result := DataController.OnFindCriteriaBeforeChange;
end;

function TcxVirtualVerticalGrid.GetOnFindCriteriaChanged: TcxDataFindCriteriaChangedEvent;
begin
  Result := DataController.OnFindCriteriaChanged;
end;

function TcxVirtualVerticalGrid.GetCurrentScrollbarAnnotationRecordIndex: Integer;
begin
...
function TcxVirtualVerticalGrid.GetScrollbarAnnotations: TcxVerticalGridScrollbarAnnotationOptions;
begin
  Result := TcxVerticalGridScrollbarAnnotationOptions(inherited ScrollbarAnnotations);
end;

procedure TcxVirtualVerticalGrid.InvalidateScrollbarAnnotations;
begin
 if ScrollbarAnnotationHelper <> nil then
   ScrollbarAnnotationHelper.InvalidateRenderers;
end;

procedure TcxVirtualVerticalGrid.LayoutStyleChanged;
begin
  inherited LayoutStyleChanged;
  CheckGridModeBufferCount;
end;

procedure TcxVirtualVerticalGrid.Loaded;
begin
  inherited Loaded;
  RefreshScrollbarAnnotations(FLoadedChangedScrollbarAnnotationKinds);
end;

procedure TcxVirtualVerticalGrid.LookAndFeelChanged(Sender: TcxLookAndFeel; AChangedValues: TcxLookAndFeelValues);
begin
  InvalidateScrollbarAnnotations;
  inherited LookAndFeelChanged(Sender, AChangedValues);
end;

procedure TcxVirtualVerticalGrid.PopulateScrollbarAnnotations(AKind: TdxScrollbarAnnotationKind; AList: TdxScrollbarAnnotationRowIndexList);
var
  I: Integer;
begin
  case AKind of
    dxErrorScrollbarAnnotationID:
      for I := 0 to RecordCount - 1 do
        if IsRecordHasErrors(I) then
          AList.Add(I);
    dxFocusedRowScrollbarAnnotationID:
      AList.Add(FocusedRecordIndex);
  else
    inherited PopulateScrollbarAnnotations(AKind, AList);
  end;
end;

procedure TcxVirtualVerticalGrid.RefreshScrollbarAnnotations(AChangedAnnotationKinds: TdxScrollbarAnnotationKinds = dxAllScrollbarAnnotationKinds);
begin
  if IsLoading then
    FLoadedChangedScrollbarAnnotationKinds := FLoadedChangedScrollbarAnnotationKinds + AChangedAnnotationKinds
  else
    inherited RefreshScrollbarAnnotations(AChangedAnnotationKinds);
end;

procedure TcxVirtualVerticalGrid.SetCurrentScrollbarAnnotationRecordIndex(AIndex: Integer);
begin
  if FocusedRecordIndex <> AIndex then
...
procedure TcxVirtualVerticalGrid.SetOnFindCriteriaBeforeChange(Value: TcxDataFindCriteriaBeforeChangeEvent);
begin
  DataController.OnFindCriteriaBeforeChange := Value;
end;

procedure TcxVirtualVerticalGrid.SetOnFindCriteriaChanged(Value: TcxDataFindCriteriaChangedEvent);
begin
...
procedure TcxVirtualVerticalGrid.SetScrollbarAnnotations(Value: TcxVerticalGridScrollbarAnnotationOptions);
begin
  inherited ScrollbarAnnotations.Assign(Value);
end;
...
begin
  ...
  begin
    if not VerticalGrid.UseLightBorders then
    begin
      LinesInfo.Add(R.Left, R.Top, R.Right - R.Left, HorzLineWidth, BandBorderColor);
      LinesInfo.Add(R.Left + VertLineWidth, R.Bottom - HorzLineWidth, (R.Right - R.Left) - 2 * VertLineWidth, HorzLineWidth, BandBorderColor);
    end
    else
      LinesInfo.Add(R.Left, R.Bottom - HorzLineWidth, R.Right - R.Left, HorzLineWidth, BandBorderColor);
  end;
  if VertLineWidth > 0 then
  begin
    if not VerticalGrid.UseLightBorders then
      LinesInfo.Add(R.Left, R.Top + HorzLineWidth, VertLineWidth, (R.Bottom - R.Top) - HorzLineWidth, BandBorderColor);
  end;
end;
...
begin
  ...
  begin
    if (Self is TcxBandsViewInfo) or (Self is TcxInspectorViewInfo) then
      AWidth := cxRectWidth(ABandRect)
    else
      AWidth := cxRectWidth(ABandRect) - VertLineWidth;
  end;
  if AWidth > 0 then
    ...
    begin
      ...
      if not VerticalGrid.UseLightBorders then
        ...
        ARowRect := cxRectBounds(ABandRect.Left, ATop, AWidth, ARowViewInfo.CalculatedHeight);
      if not CanAddRowToBand(ARowRect, ABandRect, ABandRowIndex) then
        Break;
...
begin
  ...
  Inc(Result.Top, PanelsHeight[fpTop]);
  Dec(Result.Bottom, PanelsHeight[fpBottom]);
end;
...
begin
  FUseCategoryExplorerStyle := VerticalGrid.OptionsView.CategoryExplorerStyle and (VerticalGrid.LookAndFeel.SkinPainter = nil) and
    GetThemeScaledPartSize(totExplorerBar, ScaleFactor, EBP_NORMALGROUPEXPAND, FExplorerButtonSize, EBNGE_NORMAL, tssNoScaling);
...
begin
  VerticalGrid.Rows.CheckList;

  FHorzLineWidth := Byte(VerticalGrid.OptionsView.GridLines in [vglHorizontal, vglBoth]);
  FVertLineWidth := Byte(VerticalGrid.OptionsView.GridLines in [vglVertical, vglBoth]);

  if not VerticalGrid.UseLightBorders then
    FClipRect := cxRectInflate(Self.ClientRect, -FVertLineWidth, -FHorzLineWidth)
  else
    FClipRect := Self.ClientRect;

  FBandsInterval := VerticalGrid.OptionsView.BandsInterval;
  FRowHeaderMinWidth := VerticalGrid.OptionsView.RowHeaderMinWidth;
  FShowHeaders := VerticalGrid.OptionsView.ShowHeaders;
  FButtonAreaSize := VerticalGrid.LookAndFeel.Painter.ScaledExpandButtonAreaSize(VerticalGrid.ScaleFactor);
  FButtonSize := VerticalGrid.LookAndFeel.Painter.ScaledExpandButtonSize(VerticalGrid.ScaleFactor);
  ...
  FBandMinWidth := FRowHeaderMinWidth + VerticalGrid.OptionsView.ValueMinWidth + DividerWidth;
...
var
  ...
  R: TRect;
begin
  ARowIndex := Scroller.TopVisibleRowIndex;
  ALeftVisibleBand := Scroller.LeftVisibleBand;
  for ABandIndex := ALeftVisibleBand to Scroller.BandsInfo.Count - 1 do
  begin
    if ABandIndex - ALeftVisibleBand > ViewRects.BandRects.Count - 1 then
      Break;
    R := ViewRects.BandRects[ABandIndex - ALeftVisibleBand];
    if R.Left > ClientRect.Right then
      Break
    else
      CalcBandRowsViewInfo(ARowIndex, R, ABandIndex, Scroller.BandsInfo[ABandIndex].RowsCount);
  end;
...
begin
  ...
  Result := TdxTextMeasurer.TextLineHeight(VerticalGrid.Font) + 2 * ScaleFactor.Apply(cxTextOffset);
...
begin
  ...
  AEditTextOffset := EditContentDefaultOffsets[True];
  TdxVisualRefinements.HeaderPadding.InflatePadding(AEditTextOffset, ScaleFactor);
...
begin
  if ViewInfo.DividerWidth > 0 then
    ALinesInfo.Add(R.Right, R.Top, ViewInfo.VertLineWidth, R.Bottom - R.Top + ViewInfo.HorzLineWidth, ViewInfo.VertLineBrush);
end;
...
var
  W: Integer;
begin
  if not ViewInfo.ShowHeaders then
    Exit;
  if AAddVertLine and (ViewInfo.VertLineWidth > 0) then
    ARowHeaderInfo.LinesInfo.Add(R.Right - ViewInfo.VertLineWidth, R.Top, ViewInfo.VertLineWidth,
      R.Bottom - R.Top + ViewInfo.HorzLineWidth, ViewInfo.VertLineBrush);
  if ViewInfo.HorzLineWidth > 0 then
  begin
    W := R.Right - R.Left;
    if AAddVertLine then
      Dec(W, ViewInfo.VertLineWidth);
    if AUnderline then
      ARowHeaderInfo.LinesInfo.Add(R.Left, R.Bottom, W, ViewInfo.HorzLineWidth, ViewInfo.HorzLineBrush)
    else
      if (AViewParams.Bitmap <> nil) and not AViewParams.Bitmap.Empty then
        ARowHeaderInfo.RowIndents.Add(cxRectBounds(R.Left, R.Bottom, W, ViewInfo.HorzLineWidth), AViewParams)
      else
        ARowHeaderInfo.LinesInfo.Add(R.Left, R.Bottom, W, ViewInfo.HorzLineWidth, AViewParams.Color);
  end;
end;
...
begin
  ...
  begin
    if ViewInfo.VertLineWidth = 0 then
      Result := 1
    else
      Result := ViewInfo.VertLineWidth;
  end;
end;
...
function TcxCaptionInfoList.GetItem(Index: TdxListIndex): TcxRowCaptionInfo;
begin
...
function TcxValueInfoList.GetItem(Index: TdxListIndex): TcxRowValueInfo;
begin
...
procedure TcxCustomRowHeaderInfo.Calc(const AHeaderRect: TRect;
  ...
  ACalcBounds: Boolean);
var
  AActualHeaderRect: TRect;
  AAddRightVertLine: Boolean;
begin
  AActualHeaderRect := AHeaderRect;
  AAddRightVertLine := True;
  if AViewInfo.VerticalGrid.UseLightBorders then
  begin
    if Self is TcxCategoryRowHeaderInfo then
    begin
      if AActualHeaderRect.Right = TcxMultiRecordViewInfo(AViewInfo).ClientRect.Right - AViewInfo.VertLineWidth then
      begin
        AActualHeaderRect.Right := AActualHeaderRect.Right + AViewInfo.VertLineWidth;
        AAddRightVertLine := False;
      end;
    end;
  end;
  FViewInfo := AViewInfo;
...
begin
  ...
  try
    ...
    begin
      AIndent := AIndents[ALevelCount - I]^;
      if AIndent.IsCategory then
      begin
        ...
        cxRectIntersect(R, cxRectBounds(HeaderRect.Left + ABoundsWidth,
          HeaderRect.Top, AIndent.Size.cx + W, AIndent.Size.cy), HeaderRect);
        if not cxRectIsEmpty(R) then
          AddNextIndentInfo(cxRectBounds(HeaderRect.Left + ABoundsWidth, HeaderRect.Top,
            AIndent.Size.cx + W, AIndent.Size.cy), AIndent.ViewParams, True, AIndent.Underline, I < ALevelCount);
        Inc(ABoundsWidth, cxSetValue(I < ALevelCount, W, cxSetValue(IncreaseBoundsByLastVertLine, W, 0)));
        R := cxRectBounds(HeaderRect.Left + ABoundsWidth + AIndent.Size.cx, HeaderRect.Top, 0, AHeight);
      end
      else
      begin
        Inc(R.Right, AIndent.Size.cx);
        J := I;
      end;
      Inc(ABoundsWidth, AIndent.Size.cx);
    end;
...
begin
  if ALast then
  begin
    if R.Left > ViewInfo.ClipRect.Right then
      Exit;
    if not VerticalGrid.UseLightBorders then
      if R.Right > ViewInfo.ClipRect.Right then
        R.Right := ViewInfo.ClipRect.Right;
  end;
...
function TcxCustomRowViewInfo.GetRowValueInfo(ARecordIndex, ACellIndex: Integer): TcxRowValueInfo;
var
  I: Integer;
  ARowValueInfo: TcxRowValueInfo;
begin
  Result := nil;
  if (ValuesInfo = nil) or ((ARecordIndex < 0) and not TcxvgMultiRecordsOptionsData.AddRecordOnEditIfEmpty) then
    Exit;
  for I := 0 to ValuesInfo.Count - 1 do
  begin
...
function TcxRowViewInfoList.GetItem(Index: TdxListIndex): TcxCustomRowViewInfo;
begin
  Result := List[Index];
end;
...
constructor TcxvgController.Create(AOwner: TcxEditingControl);
begin
  inherited Create(AOwner);
...
begin
  if VerticalGrid.IsLoading or VerticalGrid.IsDestroying then
    Result := False
  else
  begin
...
procedure TcxvgController.LayoutChanged;
begin
...
begin
  ...
  FScrollTimer := cxCreateTimer(OnScrollTimer, 5);
end;
...
procedure TcxRowValueInfo.GetFindTextInfo(out AStart: Integer; out ALength: Integer);
var
  AText: string;
begin
  AStart := VerticalGrid.DataController.FindCriteria.GetTextStartPositionByRowIndex(RecordIndex, EditContainer.ItemIndex, AText);
  ALength := Length(AText);
end;

function TcxRowValueInfo.GetFocused: Boolean;
begin
  Result := Row.Focused and (EditContainer.FocusedCellViewInfo = Self);
end;
...
function TcxRowValueInfo.GetVerticalGrid: TcxCustomVerticalGrid;
begin
...
begin
  ItemHeight := TdxTextMeasurer.TextLineHeight(VerticalGrid.Font) +
    VerticalGrid.ScaleFactor.Apply(cxTextOffset) * 2;
end;
...
begin
  FOwner := AOwner; 
  CreateNew(nil);
  FHookTimer := cxCreateTimer(HookTimerHandler, 10, False);
  Visible := False;
end;
...
begin
  ...
  FLineHeight := TdxTextMeasurer.TextLineHeight(FForm.Font) + SizeDelta.cy;
...
begin
  ...
  begin
    ...
    begin
      ...
      DrawImage(CaptionsInfo[0], Painter.HeaderGlyphColorPalette(cxbsNormal));
    end;
    if (not cxRectIsEmpty(FocusRect)) and (not VerticalGrid.IsDesigning) and Painter.SupportsNativeFocusRect then
...
begin
  ...
  begin
    ...
    AOffset := EditContentDefaultOffsets[True];
...
begin
  DrawImage(ACaptionInfo, nil);
end;

procedure TcxvgPainter.DrawImage(ACaptionInfo: TcxRowCaptionInfo; APalette: IdxColorPalette);
var
  ARgn: TcxRegion;
  R: TRect;
begin
  ...
  try
    ...
    TdxImageDrawer.DrawImage(Canvas, ACaptionInfo.ImageRect, nil, ACaptionInfo.Images, ACaptionInfo.ImageIndex, True, APalette, ScaleFactor);
  finally
...
var
  ...
  function GetHeaderBoundsForClipping(AHeaderRect: TRect): TRect;
  begin
    Result := AHeaderRect;
    if VerticalGrid.OptionsView.GridLines in [vglHorizontal, vglBoth] then
      Result.Bottom := Result.Bottom + VerticalGrid.ViewInfo.HorzLineWidth;
  end;
...
begin
  ...
  begin
    ...
    try
      Canvas.ExcludeClipRect(GetHeaderBoundsForClipping(AHeaderInfo.HeaderRect));
...
begin
  ...
  Canvas.Brush.Style := bsSolid;
  DrawImage(ACaptionInfo, Painter.HeaderGlyphColorPalette(cxbsNormal));
...
begin
  if (not cxRectIsEmpty(ARowHeader.FocusRect)) and Painter.SupportsNativeFocusRect then
    Canvas.DrawFocusRect(ARowHeader.FocusRect);
end;

procedure TcxvgPainter.DrawRowHeaderSelected(ARowHeader: TcxCustomRowHeaderInfo);
begin
  if ARowHeader.Selected and Painter.SupportsNativeFocusRect then
  begin
...
begin
  ...
  if Result then
  begin
    ATheme := OpenTheme(totExplorerBar, ScaleFactor);
    Result := ATheme <> 0;
  end;
end;
...
begin
  ...
  begin
    ...
    PaintEx(Canvas);
    if Focused and Self.ViewInfo.CalcHelper.IsDrawValueFocusRect and (not cxRectIsEmpty(FocusRect))
      and Painter.SupportsNativeFocusRect then
      Canvas.DrawFocusRect(FocusRect);
  end;
end;
...
constructor TcxvgCustomScrollStrategy.Create(AScroller: TcxvgScroller);
begin
  inherited Create;
...
procedure TcxvgCustomScrollStrategy.DoScrollRecords(AScrollCode: TScrollCode; var AScrollPos: Integer);
begin
  case AScrollCode of
    scLineUp:
    ...
    scPageUp:
      LeftVisibleRecord := LeftVisibleRecord - VisibleValueCount;
    scPageDown:
      LeftVisibleRecord := LeftVisibleRecord + VisibleValueCount;
    scTrack:
      if not DataController.IsGridMode then
...
begin
  if not VerticalGrid.UseLightBorders then
    ...
    Result := X > ViewInfo.ClientRect.Right;
end;
...
function TcxvgCustomScrollStrategy.IsScrollAnimationEnabled: Boolean;
begin
  Result := False;
end;
...
begin
  if IsRecordsScrollMode then
    DoScrollRecords(AScrollCode, AScrollPos)
  else
    DoScrollBands;
end;
...
begin
  SetLeftVisibleRecordAndOffset(Value, 0, False);
end;

procedure TcxvgCustomScrollStrategy.SetLeftVisibleRecordAndOffset(ALeftVisibleRecord, APixelScrollRecordOffset: Integer; AAnimated: Boolean);
var
  APrevLeftVisibleRecord: Integer;
begin
  APrevLeftVisibleRecord := FLeftVisibleRecord;
  ...
  if FLeftVisibleRecord <> APrevLeftVisibleRecord then
...
{ TcxvgRecordScrollAnimationHelper }

constructor TcxvgRecordScrollAnimationHelper.Create(AOwner: TcxvgMultiRecordsScrollStrategy);
begin
  inherited Create;
  FOwner := AOwner;
end;

procedure TcxvgRecordScrollAnimationHelper.AfterAnimationEnded(AIsRaiseEvent: Boolean);
begin
  inherited AfterAnimationEnded(AIsRaiseEvent);
  TcxEditingControllerAccess(FOwner.Controller.EditingController).FinalizeCellAfterScrollAnimation;
end;

procedure TcxvgRecordScrollAnimationHelper.BeforeAnimationStarted;
begin
  TcxEditingControllerAccess(FOwner.Controller.EditingController).InitializeCellBeforeScrollAnimation;
  inherited BeforeAnimationStarted;
end;

function TcxvgRecordScrollAnimationHelper.CalculateAnimatedPosition(
  var APosition: Integer): TdxRecordPixelScrollData;
var
  AOverPan: Boolean;
begin
  Result := GetOwnerPosition;
  FOwner.CalculatePixelScrollInfo(Result.Index, Result.ScrollOffset,
    MaxInt, MinInt, -Sign(AnimationLength)*(APosition - PrevAnimatedPosition), AOverPan);
end;

function TcxvgRecordScrollAnimationHelper.CalculateScrollDelta(
  AValue: TdxRecordPixelScrollData): Integer;
begin
  Result := FOwner.GetPixelScrollOffset(GetOwnerPosition.Index, GetOwnerPosition.ScrollOffset,
    AValue.Index, AValue.ScrollOffset);
end;

function TcxvgRecordScrollAnimationHelper.GetOwnerPosition: TdxRecordPixelScrollData;
begin
  Result := TdxRecordPixelScrollData.Create(FOwner.LeftVisibleRecord, FOwner.PixelScrollRecordOffset);
end;

procedure TcxvgRecordScrollAnimationHelper.PositionChanged;
begin
  FOwner.VerticalGrid.DoLeftVisibleRecordIndexChanged;
end;

procedure TcxvgRecordScrollAnimationHelper.UpdateOwnerPosition(
  AValue: TdxRecordPixelScrollData);
begin
  FOwner.DoSetLeftVisibleRecordAndOffset(AValue.Index, AValue.ScrollOffset);
end;

{ TcxvgMultiRecordsScrollStrategy }

constructor TcxvgMultiRecordsScrollStrategy.Create(AScroller: TcxvgScroller);
begin
  inherited;
  FRecordScrollAnimationHelper := TcxvgRecordScrollAnimationHelper.Create(Self);
end;

destructor TcxvgMultiRecordsScrollStrategy.Destroy;
begin
...
var
  ARecordScrollSize, ASize, AMod: Integer;
begin
  AOverPan := False;
  ...
  begin
    ...
    begin
      ...
      AMod := Abs(ASize mod ARecordScrollSize);
      if AMod = 0 then
        ARecordOffset := 0
      else
        ARecordOffset := AMod - ARecordScrollSize;
    end
    else
      ARecordOffset := ASize;
...
begin
  ...
  begin
    if not VerticalGrid.UseLightBorders then
      ...
      Result := (ViewInfo.ViewValueWidth + GetRecordSpace) * (VerticalGrid.RecordCount - 1) +
        ViewInfo.ViewValueWidth + GetVScrollbarAreaWidth;
  end
  else
...
procedure TcxvgMultiRecordsScrollStrategy.DoScrollRecords(AScrollCode: TScrollCode; var AScrollPos: Integer);
var
  ALeftVisibleRecord: Integer;
begin
  if not IsScrollAnimationEnabled then
    inherited DoScrollRecords(AScrollCode, AScrollPos)
  else
  begin
    if IsRecordScrollAnimationActive then
      ALeftVisibleRecord := FRecordScrollAnimationHelper.TargetPosition.Index
    else
      ALeftVisibleRecord := LeftVisibleRecord;
    case AScrollCode of
      scLineUp:
        Scroller.SetLeftVisibleRecordAndOffset(ALeftVisibleRecord - 1, 0, True);
      scLineDown:
        Scroller.SetLeftVisibleRecordAndOffset(ALeftVisibleRecord + 1, 0, True);
      scPageUp:
        Scroller.SetLeftVisibleRecordAndOffset(ALeftVisibleRecord - VisibleValueCount, 0, True);
      scPageDown:
        Scroller.SetLeftVisibleRecordAndOffset(ALeftVisibleRecord + VisibleValueCount, 0, True)
    else
      inherited DoScrollRecords(AScrollCode, AScrollPos);
...
begin
  ...
  begin
    ...
    SetLeftVisibleRecordAndOffset(ARecordIndex, AOffset, False);
  end
  else
...
function TcxvgMultiRecordsScrollStrategy.GetPixelScrollOffset(AFirstRecordIndex, AFirstRecordOffset: Integer; ALastRecordIndex, ALastRecordOffset: Integer): Integer;
var
  ARecordSize: Integer;
  ASign: Integer;
begin
  ARecordSize := ViewInfo.ViewValueWidth + GetRecordSpace;
  ...
  begin
    ...
    ASign := 1;
  Result := (ALastRecordIndex - AFirstRecordIndex) * ARecordSize;
...
var
  ...
  APixelScrollRecordOffset: Integer;
begin
  if IsRecordScrollAnimationActive then
    APixelScrollRecordOffset := FRecordScrollAnimationHelper.TargetPosition.ScrollOffset
  else
    APixelScrollRecordOffset := PixelScrollRecordOffset;
  ARecordSpace := GetRecordSpace;
  if not ViewInfo.VerticalGrid.UseLightBorders then
    ARecordsWidth := ViewInfo.GetPixelScrollContentSize + ARecordSpace - ViewInfo.VertLineWidth - APixelScrollRecordOffset
  else
    ARecordsWidth := ViewInfo.GetPixelScrollContentSize + ARecordSpace - APixelScrollRecordOffset;
  ACount := Max(1, (ARecordsWidth - GetVScrollbarAreaWidth) div (ViewInfo.ViewValueWidth + ARecordSpace));
...
begin
  if IsRecordPixelScrolling then
  begin
    AAnimated := IsScrollAnimationEnabled and not TcxEditingControllerAccess(Controller.EditingController).EditingItemSetting;
    AOldLeftVisibleRecord := LeftVisibleRecord;
    ...
    if (ARecordIndex < LeftVisibleRecord) or
      ...
      SetLeftVisibleRecordAndOffset(ARecordIndex, 0, AAnimated)
    else
      ...
      begin
        ...
        SetLeftVisibleRecordAndOffset(ANewRecordIndex, ANewRecordPixelScrollOffset, AAnimated);
      end
      else
        if IsRecordScrollAnimationActive then
...
function TcxvgMultiRecordsScrollStrategy.IsRecordScrollAnimationActive: Boolean;
begin
  Result := FRecordScrollAnimationHelper.IsAnimationActive;
end;

function TcxvgMultiRecordsScrollStrategy.IsScrollAnimationEnabled: Boolean;
begin
  Result := VerticalGrid.IsScrollAnimationEnabled and IsRecordPixelScrolling;
end;

procedure TcxvgMultiRecordsScrollStrategy.RecordScrollAnimated(ALeftVisibleRecord, APixelScrollOffset: Integer);
begin
  FRecordScrollAnimationHelper.SetPosition(TdxRecordPixelScrollData.Create(ALeftVisibleRecord, APixelScrollOffset));
end;
...
begin
  Result := IfThen(RecordsInterval = 0, ViewInfo.VertLineWidth, 2 * ViewInfo.VertLineWidth + RecordsInterval);
end;

procedure TcxvgMultiRecordsScrollStrategy.SetLeftVisibleRecordAndOffset(ALeftVisibleRecord, APixelScrollRecordOffset: Integer; AAnimated: Boolean);
var
  APrevLeftVisibleRecord: Integer;
begin
  if AAnimated then
  begin
    CheckLeftVisibleRecordAndOffset(ALeftVisibleRecord, APixelScrollRecordOffset);
    RecordScrollAnimated(ALeftVisibleRecord, APixelScrollRecordOffset);
  end
  else
  begin
    if IsRecordScrollAnimationActive then
    begin
      APrevLeftVisibleRecord := FRecordScrollAnimationHelper.StartPosition.Index;
...
begin
  ...
  ABandIndex := 0;
  if not ViewInfo.VerticalGrid.UseLightBorders then
    AHeight := ViewInfo.HorzLineWidth
  else
    AHeight := 0;
  ViewInfo.ViewValueWidth := ViewInfo.GetViewValueWidth;
  AClientHeight := cxRectHeight(ViewInfo.ClientRect); 
  I := 0;
  while I < ViewInfo.VisibleRowCount do
  begin
    ARow := ViewInfo.VisibleRows[I];
    ARowViewInfo := ARow.ViewInfo;
    if AHeight + ARowViewInfo.CalculatedHeight + ViewInfo.HorzLineWidth > AClientHeight then
    begin
      AFirstRow := ViewInfo.VisibleRows[I - ARowCount];
      if ARowCount = 0 then
      begin
        ARowCount := 1;
        AFirstRow := ViewInfo.VisibleRows[I];
        AHeight := ARowViewInfo.CalculatedHeight + ViewInfo.HorzLineWidth;
      end
      else
        Dec(I);
    ...
    Inc(AHeight, ARowViewInfo.CalculatedHeight + ViewInfo.HorzLineWidth);
    Inc(ARowCount);
    Inc(I);
  end;
  if ARowCount <> 0 then
    BandsInfo.Add(ABandIndex, ARowCount, AHeight, ViewInfo.VisibleRows[I - ARowCount]);
end;
...
procedure TcxCaptionRowProperties.CaptionChanged;
begin
  Changed;
end;
...
function TcxCollectionItemEditorRowProperties.GetObjectName: string;
begin
  Result := inherited GetObjectName + IntToStr(ID);
end;

procedure TcxCollectionItemEditorRowProperties.GetPropertyValue(const AName: string; var AValue: Variant);
begin
  if AName = 'Expression' then
    AValue := DataBinding.Expression
  else
    AValue := Null;
end;

procedure TcxCollectionItemEditorRowProperties.SetPropertyValue(const AName: string; const AValue: Variant);
begin
  if AName = 'Expression' then
    DataBinding.Expression := AValue;
end;

function TcxCollectionItemEditorRowProperties.GetStoredProperties(AProperties: TStrings): Boolean;
begin
...
var
  AIndexes: TdxStringIntegerDictionary;
  AIndex: Integer;
  I: Integer;
begin
  AIndexes := TdxStringIntegerDictionary.Create;
  try
    ...
    try
      ...
      Row.VerticalGrid.DataController.UpdateExpressionItems;
    finally
...
begin
  Result := Max(VerticalGrid.OptionsView.RowHeight,
    TdxTextMeasurer.TextLineHeight(VerticalGrid.Styles.GetCategoryParams(Self).Font) +
    ScaleFactor.Apply(cxTextOffset) * 2);
  Inc(Result, TdxVisualRefinements.HeaderPadding.ScaledHeight(ScaleFactor));
...
procedure TcxCustomMultiEditorRow.GetStoredChildren(AChildren: TStringList);
var
  I: Integer;
begin
  for I := 0 to Properties.Editors.Count - 1 do
    AChildren.AddObject(Properties.Editors[I].GetObjectName, Properties.Editors[I]);
end;
...
procedure TcxCustomEditorRowProperties.ShowExpressionEditor;
begin
  EditContainer.ShowExpressionEditor;
end;

procedure TcxCustomEditorRowProperties.GetPropertyValue(const AName: string; var AValue: Variant);
begin
  if AName = 'Expression' then
...
procedure TcxCustomEditorRowProperties.SetPropertyValue(const AName: string; const AValue: Variant);
begin
  if AName = 'Expression' then
    DataBinding.StoredExpression := AValue;
end;

function TcxCustomEditorRowProperties.GetStoredProperties(AProperties: TStrings): Boolean;
begin
  AProperties.Add('Expression');
  Result := True;
end;

procedure TcxCustomEditorRowProperties.CaptionChanged;
begin
  Row.VerticalGrid.DataController.UpdateExpressionItems;
...
function TcxCustomEditorRowProperties.IsDefaultVisibleForExpressionEditor: Boolean;
begin
  Result := EditContainer.IsDefaultVisibleForExpressionEditor;
end;
...
function TcxCustomEditorRowProperties.GetVisibleForExpressionEditor: TdxDefaultBoolean;
begin
  Result := EditContainer.VisibleForExpressionEditor;
end;
...
procedure TcxCustomEditorRowProperties.SetVisibleForExpressionEditor(AValue: TdxDefaultBoolean);
begin
  EditContainer.VisibleForExpressionEditor := AValue;
end;
...
function TcxCustomEditorRowProperties.GetOnGetFilterImages: TcxGetFilterImagesEvent;
begin
  Result := EditContainer.OnGetFilterImages;
end;
...
procedure TcxCustomEditorRowProperties.SetOnGetFilterImages(const Value: TcxGetFilterImagesEvent);
begin
  EditContainer.OnGetFilterImages := Value;
end;
...
procedure TcxCustomEditorRow.GetStoredChildren(AChildren: TStringList);
begin
  AChildren.AddObject(Properties.GetObjectName, Properties);
end;
...
function TcxCellEdit.InternalGetController: TcxvgController;
begin
  Result := TcxvgController(inherited Controller);
end;

function TcxCellEdit.GetReferenceNameForExpression: string;
begin
...
begin
  ...
  try
    ...
    CheckInitializeViewInfoByHiddenEditor(ACellViewInfo);
  finally
    FCalculating := False;
  end;
end;

procedure TcxCellEdit.CheckInitializeViewInfoByHiddenEditor(ACellViewInfo: TcxRowValueInfo);
var
  AEdit: TcxCustomEdit;
begin
  if Editing and (Controller.FocusedRecordIndex = ACellViewInfo.RecordIndex) then
  begin
    AEdit := Controller.EditingController.Edit;
    if AEdit <> nil then
      ACellViewInfo.InitializeByHiddenEditor(AEdit);
  end;
end;
...
begin
  Result := VerticalGrid.CanInitEditing(ItemIndex);
end;
...
procedure TcxCellEdit.DoGetFilterImages(AValueList: TcxFilterValueList; var AImages: TCustomImageList);
begin
  if Assigned(FOnGetFilterImages) then
    FOnGetFilterImages(Row, AValueList, AImages);
end;
...
begin
  ...
  begin
    ...
    begin
      if (AProperties.GetEditValueSource(False) = evsValue) or
        VarIsNull(GetValue(FilteredRecordIndex[ARecordIndex], ItemIndex)) and
        (not IsExpression or (ErrorCodes[FilteredRecordIndex[ARecordIndex], ItemIndex] = 0)) then
...
function TcxCellEdit.HasErrors(ARecordIndex: Integer): Boolean;
var
  AData: TcxEditValidateInfo;
begin
  AData := TcxEditValidateInfo.Create;
  try
    EditRowProperties.DoValidateDrawValue(GetDisplayValue(DoGetEditProperties(Pointer(ARecordIndex)),
      ARecordIndex), ARecordIndex, AData);
    Result := AData.ErrorType <> eetNone;
  finally
    AData.Free;
  end;
end;

function TcxCellEdit.IsVisible: Boolean;
begin
  Result := Row.Visible;
end;
...
begin
  ...
  begin
    ...
    case Index of
      ...
      vgs_IncSearch:
        begin
          Color := LookAndFeelPainter.DefaultSearchResultHighlightColor;
          TextColor := LookAndFeelPainter.DefaultSearchResultHighlightTextColor;
        end;
    end;
  end;
end;
...
function TcxCustomRowProperties.GetObjectName: string;
begin
  Result := 'RowProperties';
end;

function TcxCustomRowProperties.GetStoredProperties(AProperties: TStrings): Boolean;
begin
  Result := False;
end;

procedure TcxCustomRowProperties.GetPropertyValue(const AName: string; var AValue: Variant);
begin
//do nothing
end;

procedure TcxCustomRowProperties.SetPropertyValue(const AName: string; const AValue: Variant);
begin
//do nothing
end;
...
function TcxCustomRow.CreateChild(const AObjectName, AClassName: string): TObject;
begin
  Result := nil;
end;

procedure TcxCustomRow.DeleteChild(const AObjectName: string; AObject: TObject);
begin
//do nothing
end;

procedure TcxCustomRow.GetStoredChildren(AChildren: TStringList);
begin
//do nothing
end;
...
procedure TcxCustomRow.CheckUsingInFindCriteria;
var
  I: Integer;
begin
  for I := 0 to GetEditContainerCount - 1 do
    GetEditContainer(I).CheckUsingInFindCriteria;
end;
...
function TcxCustomRow.FindNextFocusedRowOnCollapse: TcxCustomRow;
var
  I: Integer;
begin
  if CanFocus then
    Exit(Self);
  for I := VisibleIndex - 1 downto 0 do
  begin
    Result := OwnerRows.VisibleRows[I];
    if Result.CanFocus then
      Exit;
  end;
  for I := VisibleIndex + 1 to OwnerRows.VisibleRowCount - 1 do
  begin
    Result := OwnerRows.VisibleRows[I];
    if Result.CanFocus then
      Exit;
...
begin
  AHeaderHeight := TdxTextMeasurer.TextLineHeight(VerticalGrid.Styles.GetHeaderParams(Self).Font) +
    ScaleFactor.Apply(cxTextOffset);
  Inc(AHeaderHeight, TdxVisualRefinements.HeaderPadding.ScaledHeight(ScaleFactor));
  Result := Max(VerticalGrid.OptionsView.RowHeight, AHeaderHeight);
end;
...
procedure TcxCustomRow.RemoveEditor(AEditor: TcxCellEdit);
begin
  if FViewInfo <> nil then
    FViewInfo.ClearValuesInfo; 
...
begin
  ...
  begin
    FExpanded := Value;
    Changed(HasChildren);
    if not Value and IsParent(VerticalGrid.FocusedRow) then
      VerticalGrid.FocusedRow := FindNextFocusedRowOnCollapse;
  end;
end;
...
class constructor TcxvgMultiRecordsOptionsData.Initialize;
begin
  {$IFDEF DX_INITIALIZATION_LOGGING}TdxUnitSectionsLogger.ConstructorStarted(UnitName, 'TcxvgMultiRecordsOptionsData.Initialize', SysInit.HInstance);{$ENDIF}
  FAddRecordOnEditIfEmpty := True;
  {$IFDEF DX_INITIALIZATION_LOGGING}TdxUnitSectionsLogger.ConstructorFinished(UnitName, 'TcxvgMultiRecordsOptionsData.Initialize', SysInit.HInstance);{$ENDIF}
end;
...
procedure TcxVerticalGridFiltering.RunCustomizeDialog(AEditorRowProperties: TcxCustomEditorRowProperties = nil);
var
  AEditContainer: TcxCellEdit;
begin
  if AEditorRowProperties = nil then
    AEditContainer := nil
  else
    AEditContainer := AEditorRowProperties.EditContainer;
  inherited RunCustomizeDialog(AEditContainer);
end;
...
procedure TcxvgScroller.SetLeftVisibleRecordAndOffset(ATopRecordIndex, ATopRecordOffset: Integer; AAnimated: Boolean);
begin
  ScrollStrategy.SetLeftVisibleRecordAndOffset(ATopRecordIndex, ATopRecordOffset, AAnimated);
end;
...
procedure TcxvgScroller.LayoutChanged;
begin
  CheckDecrease := True;
  VerticalGrid.LayoutChanged;
end;
...
initialization
  ...
  dxRegisterCursor(crcxInspectorInsert, HInstance, cxInspectorInsertCursor);
  dxRegisterCursor(crcxInspectorAddChild, HInstance, cxInspectorAddChildCursor);
  dxRegisterCursor(crcxInspectorAdd, HInstance, cxInspectorAddCursor);
  dxRegisterCursor(crcxInspectorHide, HInstance, cxInspectorHideCursor);
  dxRegisterCursor(crcxInspectorNoDrag, HInstance, cxInspectorNoDragCursor);
  {$IFDEF DX_INITIALIZATION_LOGGING}TdxUnitSectionsLogger.InitializationFinished(dxThisUnitName, SysInit.HInstance);{$ENDIF}
finalization
  {$IFDEF DX_INITIALIZATION_LOGGING}TdxUnitSectionsLogger.FinalizationStarted(dxThisUnitName, SysInit.HInstance);{$ENDIF}
  dxUnregisterCursor(crcxInspectorInsert);
  dxUnregisterCursor(crcxInspectorAddChild);
  dxUnregisterCursor(crcxInspectorAdd);
  dxUnregisterCursor(crcxInspectorHide);
  dxUnregisterCursor(crcxInspectorNoDrag);
