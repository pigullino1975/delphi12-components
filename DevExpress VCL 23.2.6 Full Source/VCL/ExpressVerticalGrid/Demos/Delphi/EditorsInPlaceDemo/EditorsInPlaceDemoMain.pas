...
var
  ACarID: Variant;
begin
  if EditorsInPlaceDemoCarInfoForm.Accepted then
  begin
    ACarID := EditorsInPlaceDemoCarInfoForm.EditValue;
    if vgOrdersProductID.Properties.Value <> ACarID then
      vgOrdersProductID.Properties.Value := ACarID;
  end;
end;
