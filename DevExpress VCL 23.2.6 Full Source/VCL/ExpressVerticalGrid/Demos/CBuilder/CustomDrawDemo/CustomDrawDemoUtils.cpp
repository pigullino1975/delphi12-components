...
void AddIndentRect(TRect ARect, Cxgeometry::TcxBorders ABorders, TList* AList, TLineInfos ALineInfos)
{
...
void GetIndents(TLineInfos ALineInfos, TcxCustomRowHeaderInfo* AHeaderViewInfo, TList* AIndents)
{
  ...
  Cxgeometry::TcxBorders ABorders = Cxgeometry::TcxBorders() << bLeft << bTop << bBottom;
  if (!IsBottomNeeded)
  ...
  if (IsTopNeeded)
	ABorders = Cxgeometry::TcxBorders() << bLeft << bTop << bBottom;
  else
    ABorders = Cxgeometry::TcxBorders() << bLeft << bBottom;
