...
const
  ...
  //   Values for DWMWA_WINDOW_CORNER_PREFERENCE property (SizeOf = 4)
...
type
  ...
  TDWM_WINDOW_CORNER_PREFERENCE = type DWORD;
...
var
  DwmDefWindowProc: function (wnd: HWND; msg: UINT; wParam: WPARAM; lParam: LPARAM; plResult: LRESULT): HRESULT; stdcall;
  DwmEnableBlurBehindWindow: function (wnd: HWND; pBlurBehind: PDWM_BLURBEHIND): HRESULT; stdcall;
