...
var
  ...
  // dock
  dxOffice11DockColor1: TColor;
  dxOffice11DockColor2: TColor;
  // bar: background
  dxOffice11ToolbarsColor1: TColor;
  dxOffice11ToolbarsColor2: TColor;
  // bar: marks
  dxOffice11BarMarkColors1: array[1..3] of TColor; // Normal, Selected, Pressed
  dxOffice11BarMarkColors2: array[1..3] of TColor; // Normal, Selected, Pressed
  dxOffice11BarBorderColors: array[1..2] of TColor; // fixed colors
  dxOffice11BarBorderMarkColors: array[1..2, 1..3] of TColor;
  // bar: fingers, separators, mark arrows
  dxOffice11BarFingerColor1: TColor;
  dxOffice11BarFingerColor2: TColor;
  dxOffice11BarSeparatorColor1: TColor;
  dxOffice11BarSeparatorColor2: TColor;
  dxOffice11BarMarkArrowColor1: TColor;
  dxOffice11BarMarkArrowColor2: TColor;
  // bar: floating toolbar
  dxOffice11BarFloatingBorderColor1: TColor;
  dxOffice11BarFloatingBorderColor2: TColor;
  dxOffice11BarFloatingBorderColor3: TColor;
  dxOffice11BarFloatingCaptionColor: TColor;
  dxOffice11BarFloatingCaptionTextColor1: TColor;
  dxOffice11BarFloatingCaptionTextColor2: TColor;
  dxOffice11BarFloatingCaptionTextColor3: TColor;
  // drop downs
  dxOffice11MenuColor: TColor;
  dxOffice11MenuDownedColor1: TColor;
  dxOffice11MenuDownedColor2: TColor;
  dxOffice11MenuIndentColor1: TColor;
  dxOffice11MenuIndentColor2: TColor;
  dxOffice11MenuNonRecentIndentColor1: TColor;
  dxOffice11MenuNonRecentIndentColor2: TColor;
  dxOffice11DropDownBorderColor1: TColor;
  dxOffice11DropDownBorderColor2: TColor;
  // selected, pressed, downed
  dxOffice11ToolbarSelectedColor: TColor;
  dxOffice11SelectedBorderColor: TColor;
  dxOffice11SelectedColor1: TColor;
  dxOffice11SelectedColor2: TColor;
  dxOffice11SelectedDownColor1: TColor;
  dxOffice11SelectedDownColor2: TColor;
  dxOffice11OwnerControlDownedColor: TColor;
  dxOffice11DownedColor: TColor;
  dxOffice11DownedSelectedColor: TColor;
  // detachable
  dxOffice11DetachableColor: TColor;
  dxOffice11DetachableSelectedColor: TColor;
  // text
  dxOffice11TextEnabledColor: TColor;
  dxOffice11TextDisabledColor: TColor;
  // static
  dxOffice11StaticBorderColor: TColor;
  // date
  dxOffice11DateHeaderColor: TColor;
  // inplace sub item
  dxOffice11InPlaceSubItemColor: TColor;
  dxOffice11InPlaceSubItemTextColor: TColor;
  // LF painters
  // control border color
  dxOffice11ControlBorderColor: TColor;
  dxOffice11GroupColor: TColor;
  // Outlook colors
  dxOffice11DayNavigatorSelectedColor: TColor;
  dxOffice11OutlookBorderColor: TColor;
  dxOffice11OutlookControlColor: TColor;
  // Office11 group row style colors
  dxOffice11GroupIndentColor: TColor;
  dxOffice11GroupRowTextColor: TColor;
  dxOffice11GroupRowSeparatorColor: TColor;
  // NavPane colors
  dxOffice11NavPaneBorder: TColor;
  dxOffice11NavPaneGroupCaptionColor1: TColor;
  dxOffice11NavPaneGroupCaptionColor2: TColor;
  dxOffice11NavPaneGroupCaptionHotColor1: TColor;
  dxOffice11NavPaneGroupCaptionHotColor2: TColor;
  dxOffice11NavPaneGroupCaptionPressedColor1: TColor;
  dxOffice11NavPaneGroupCaptionPressedColor2: TColor;
  dxOffice11NavPaneGroupCaptionPressedHotColor1: TColor;
  dxOffice11NavPaneGroupCaptionPressedHotColor2: TColor;
  dxOffice11NavPaneHeaderColor1: TColor;
  dxOffice11NavPaneHeaderColor2: TColor;                 
  dxOffice11NavPaneHeaderFontColor: TColor;
  dxOffice11NavPaneSplitterColor1: TColor;
  dxOffice11NavPaneSplitterColor2: TColor;
  // Expand button colors
  dxOffice11ExpandButtonColor1: TColor;
  dxOffice11ExpandButtonColor2: TColor;
...
var
  I, J: Integer;
  ATransparentColor, AColor1, AColor2, APixelColor: TColor;
...
begin
  ...
  dxOffice11ExpandButtonBitmap1.LoadFromResourceName(HInstance, 'DXEXPANDBUTTON_MINUS');
  dxOffice11ExpandButtonBitmap2 := TBitmap.Create;
  dxOffice11ExpandButtonBitmap2.LoadFromResourceName(HInstance, 'DXEXPANDBUTTON_PLUS');
...
const
  Office11Colors: array[TOffice11SchemeColor, 0..48] of TColor = (
