...
unit dxSpreadSheetFunctionsStrs; // for internal use
...
resourcestring
  ...
  sfnFind = 'FIND';
  sfnFindDescription =  
                 'Locates one text string within a second text string, and returns the number of the starting position of the first text ' +
  ...
  sfnProperDescription =  
                 'Capitalizes the first letter in a text string and any other letters that follow any non-letter character. Converts all other letters' + 
                 ' to lowercase.';
  sfnReplace = 'REPLACE';
...
const
  dxThisUnitName = 'dxSpreadSheetFunctionsStrs';
