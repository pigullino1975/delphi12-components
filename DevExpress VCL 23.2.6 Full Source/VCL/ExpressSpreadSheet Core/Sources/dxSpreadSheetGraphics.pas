...
procedure dxSpreadSheetDrawBorder(ACanvas: TcxCanvas; R: TRect; AColor, ABackgroundColor: TColor;
  AStyle: TdxSpreadSheetCellBorderStyle; AIsHorizontalBorder: Boolean); overload;
procedure dxSpreadSheetDrawBorder(ACanvas: TcxCanvas; R: TRect; AColor, ABackgroundColor: TColor;
  ASide: TcxBorder; ABordersStyles: TdxSpreadSheetCellBordersStyles); overload;
...
function dxSpreadSheetGetBorderBounds(const ABounds: TRect; ASide: TcxBorder;
  ABordersStyles: TdxSpreadSheetCellBordersStyles; AIsRightToLeftLayout: Boolean = False): TRect;
...
uses
  Math, dxGDIPlusAPI, SysUtils, cxControls;

const
  dxThisUnitName = 'dxSpreadSheetGraphics';
...
procedure dxSpreadSheetDrawBorder(ACanvas: TcxCanvas; R: TRect;
  AColor, ABackgroundColor: TColor; ASide: TcxBorder; ABordersStyles: TdxSpreadSheetCellBordersStyles);
begin
  dxSpreadSheetDrawBorder(ACanvas,
    dxSpreadSheetGetBorderBounds(R, ASide, ABordersStyles, ACanvas.UseRightToLeftAlignment),
    AColor, ABackgroundColor, ABordersStyles[ASide], ASide in [bTop, bBottom]);
end;
...
begin
  ...
  for ASide := Low(ASide) to High(ASide) do
    dxSpreadSheetDrawBorder(ACanvas, R, AColor, ABackgroundColor, ASide, ABordersStyles);
end;

function dxSpreadSheetGetBorderBounds(const ABounds: TRect; ASide: TcxBorder;
  ABordersStyles: TdxSpreadSheetCellBordersStyles; AIsRightToLeftLayout: Boolean): TRect;
var
  ASize: Integer;
begin
