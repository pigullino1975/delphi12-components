...
type
  ...
  { TfrmSpreadSheetConditionalFormattingRulesManagerDialog }

  TfrmSpreadSheetConditionalFormattingRulesManagerDialogClass = class of TfrmSpreadSheetConditionalFormattingRulesManagerDialog;
...
var
  dxSpreadSheetConditionalFormattingRulesManagerDialogClass:
    TfrmSpreadSheetConditionalFormattingRulesManagerDialogClass =
    TfrmSpreadSheetConditionalFormattingRulesManagerDialog; 

procedure ShowConditionalFormattingRulesManagerDialog(AOwner: IdxDialogOwner); overload; 
procedure ShowConditionalFormattingRulesManagerDialog(AOwner: TObject); overload; // Special for CBuilder //#doc'd
...
const
  dxThisUnitName = 'dxSpreadSheetConditionalFormattingRulesManagerDialog';
...
begin
  ...
  begin
    ADialog := dxSpreadSheetConditionalFormattingRulesManagerDialogClass.Create(AOwner);
    try
...
begin
  ...
  acMoveDown.Hint := cxGetResourceString(@sdxConditionalFormattingRulesManagerDialogActionMoveDown);
  acMoveUp.Hint := cxGetResourceString(@sdxConditionalFormattingRulesManagerDialogActionMoveUp);
