...
unit dxSpreadSheetFunctionsLogical; // for internal use
...
const
  dxThisUnitName = 'dxSpreadSheetFunctionsLogical';
...
begin
  ARepository.InternalAdd(@sfnAnd, fnAND, fpiAND, frkValue, 36, ftLogical, @sfnAndDescription);
  ARepository.InternalAdd(@sfnFalse, fnFalse, fpiFalse, frkValue, 35, ftLogical, @sfnFalseDescription);
  ARepository.InternalAdd(@sfnIF, fnIF, fpiIF, frkParamValue, 1, ftLogical, @sfnIFDescription);
  ARepository.InternalAdd(@sfnIfError, fnIfError, fpiIfError, frkParamValue, 255, ftLogical, @sfnIfErrorDescription);
  ARepository.InternalAdd(@sfnIfNA, fnIfNA, fpiIfNA, frkParamValue, 255, ftLogical, @sfnIfNADescription, 1);
  ARepository.InternalAdd(@sfnNot, fnNOT, fpiNOT, frkValue, 38, ftLogical, @sfnNotDescription);
  ARepository.InternalAdd(@sfnOr, fnOR, fpiOR, frkValue, 37, ftLogical, @sfnOrDescription);
  ARepository.InternalAdd(@sfnTrue, fnTrue, fpiTrue, frkValue, 34, ftLogical, @sfnTrueDescription);
  ARepository.InternalAdd(@sfnXor, fnXOR, fpiXOR, frkValue, 255, ftLogical, @sfnXorDescription, 1);
end;
