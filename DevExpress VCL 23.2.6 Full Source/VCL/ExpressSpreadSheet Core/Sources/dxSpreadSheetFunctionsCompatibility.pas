...
unit dxSpreadSheetFunctionsCompatibility; // for internal use
...
const
  dxThisUnitName = 'dxSpreadSheetFunctionsCompatibility';
...
begin
  ARepository.InternalAdd(@sfnBetaDist, fnBetaDist, fpiBetaDist, frkValue, 270, ftCompatibility, @sfnBetaDistDescription);
  ARepository.InternalAdd(@sfnBetaInv, fnBetaInv, fpiBetaInv, frkValue, 272, ftCompatibility, @sfnBetaInvDescription);
  ARepository.InternalAdd(@sfnBinomDist, fnBinomDist, fpiBinomDist, frkValue, 273, ftCompatibility, @sfnBinomDistDescription);
  ARepository.InternalAdd(@sfnChiDist, fnChiDist, fpiChiDist, frkValue, 274, ftCompatibility, @sfnChiDistDescription);
  ARepository.InternalAdd(@sfnChiInv, fnChiInv, fpiChiInv, frkValue, 275, ftCompatibility, @sfnChiInvDescription);
  ARepository.InternalAdd(@sfnChiTest, nil, nil, frkValue, 306, ftCompatibility, @sfnChiTestDescription);
  ARepository.InternalAdd(@sfnCovar, fnCovariance_P, fpiCovariance_P, frkNonArrayValue, 308, ftCompatibility, @sfnCovarDescription, 0, False);
  ARepository.InternalAdd(@sfnCritBinom, nil, nil, frkValue, 278, ftCompatibility, @sfnCritBinomDescription);
  ARepository.InternalAdd(@sfnExponDist, fnExponDist, fpiExponDist, frkValue, 280, ftCompatibility, @sfnExponDistDescription);
  ARepository.InternalAdd(@sfnFDist, nil, nil, frkValue, 281, ftCompatibility, @sfnFDistDescription);
  ARepository.InternalAdd(@sfnFInv, nil, nil, frkValue, 282, ftCompatibility, @sfnFInvDescription);
  ARepository.InternalAdd(@sfnFTest, nil, nil, frkValue, 310, ftCompatibility, @sfnFTestDescription);
  ARepository.InternalAdd(@sfnGammaDist, fnGamma_Dist, fpiGamma_Dist, frkValue, 286, ftCompatibility, @sfnGammaDistDescription);
  ARepository.InternalAdd(@sfnGammaInv, fnGamma_Inv, fpiGamma_Inv, frkValue, 287, ftCompatibility, @sfnGammaInvDescription);
  ARepository.InternalAdd(@sfnHypgeomDist, fnHypgeomDist, fpiHypgeomDist, frkValue, 289, ftCompatibility, @sfnHypgeomDistDescription);
  ARepository.InternalAdd(@sfnLogInv, nil, nil, frkValue, 291, ftCompatibility, @sfnLogInvDescription);
  ARepository.InternalAdd(@sfnLogNormDist, nil, nil, frkValue, 290, ftCompatibility, @sfnLogNormDistDescription);
  ARepository.InternalAdd(@sfnMode, nil, nil, frkValue, 330, ftCompatibility, @sfnModeDescription);
  ARepository.InternalAdd(@sfnNegBinomDist, nil, nil, frkValue, 292, ftCompatibility, @sfnNegBinomDistDescription);
  ARepository.InternalAdd(@sfnNormDist, fnNormDist, fpiNormDist, frkValue, 293, ftCompatibility, @sfnNormDistDescription);
  ARepository.InternalAdd(@sfnNormInv, fnNormInv, fpiNormInv, frkValue, 295, ftCompatibility, @sfnNormInvDescription);
  ARepository.InternalAdd(@sfnNormSDist, fnNormSDist, fpiNormSDist, frkValue, 294, ftCompatibility, @sfnNormSDistDescription);
  ARepository.InternalAdd(@sfnNormSInv, fnNormSInv, fpiNormSInv, frkValue, 296, ftCompatibility, @sfnNormSInvDescription);
  ARepository.InternalAdd(@sfnPercentile, fnPercentile_Inc, fpiPercentile_Inc, frkValue, 328, ftCompatibility, @sfnPercentileDescription, 0, False);
  ARepository.InternalAdd(@sfnPercentRank, nil, nil, frkValue, 329, ftCompatibility, @sfnPercentRankDescription);
  ARepository.InternalAdd(@sfnPoisson, fnPoisson, fpiPoisson, frkValue, 300, ftCompatibility, @sfnPoissonDescription);
  ARepository.InternalAdd(@sfnQuartile, fnQuartile_Inc, fpiQuartile_Inc, frkValue, 327, ftCompatibility, @sfnQuartileDescription, 0, False);
  ARepository.InternalAdd(@sfnRank, fnRank, fpiRank, frkValue, 216, ftCompatibility, @sfnRankDescription);
  ARepository.InternalAdd(@sfnStDev, fnStDev, fpiStDev, frkNonArrayValue, 12, ftCompatibility, @sfnStDevDescription);
  ARepository.InternalAdd(@sfnStDevP, fnStDevP, fpiStDevP, frkNonArrayValue, 193, ftCompatibility, @sfnStDevPDescription);
  ARepository.InternalAdd(@sfnTDist, fnTDist, fpiTDist, frkValue, 301, ftCompatibility, @sfnTDistDescription);
  ARepository.InternalAdd(@sfnTInv, fnTInv, fpiTInv, frkValue, 332, ftCompatibility, @sfnTInvDescription);
  ARepository.InternalAdd(@sfnTTest, nil, nil, frkValue, 316, ftCompatibility, @sfnTTestDescription);
  ARepository.InternalAdd(@sfnVar, fnVar, fpiVar, frkNonArrayValue, 46, ftCompatibility, @sfnVarDescription);
  ARepository.InternalAdd(@sfnVarP, fnVarP, fpiVarP, frkNonArrayValue, 194, ftCompatibility, @sfnVarPDescription);
  ARepository.InternalAdd(@sfnWeibull, fnWeibull, fpiWeibull, frkValue, 302, ftCompatibility, @sfnWeibullDescription);
  ARepository.InternalAdd(@sfnZTest, nil, nil, frkValue, 324, ftCompatibility, @sfnZTestDescription);
end;
