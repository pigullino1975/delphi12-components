...
uses
  ...
  dxNavBarSkinBasedViews, dxNavBarOfficeNavigationBar, dxBuiltInPopupMenu, dxCore;

const
  dxThisUnitName = 'dxNavBarReg';
...
begin
  ...
  // OptionsView
    ...
    'LookAndFeelSchemes',
  // NavigationPane
    'OnNavigationPaneCollapsed', 'OnNavigationPaneExpanded', 'OnNavigationPanePopupShowed', 'OnNavigationPanePopupShowing',
   // CustomDraw
