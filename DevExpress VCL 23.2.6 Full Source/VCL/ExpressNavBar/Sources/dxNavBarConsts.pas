...
resourcestring
  ...
  //Customization
  sdxNavBarItemsDesignerCaptionFormat = '%s - Structure Designer';
...
begin
  ...
  InternalAdd('sdxNavBarRename', @sdxNavBarRename);
