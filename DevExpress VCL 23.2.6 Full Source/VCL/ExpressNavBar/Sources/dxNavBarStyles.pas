...
type
  ...
  public
    ...
    property OnChange: TdxNavBarChangeEvent read FOnChange write FOnChange; // for internal use
  published
  ...
  public
    ...
    destructor Destroy; override;
    procedure Assign(Source: TPersistent); override;
    property OnChange: TNotifyEvent read FOnChange write FOnChange; // for internal use
  published
...
uses
  dxNavBar, SysUtils, cxGraphics, dxDPIAwareUtils, dxCore;

const
  dxThisUnitName = 'dxNavBarStyles';
