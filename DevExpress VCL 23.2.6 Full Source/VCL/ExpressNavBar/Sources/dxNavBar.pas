...
uses
  ...
  Types, IniFiles, Registry, RTLConsts, MultiMon,
  ImgList, StdCtrls, ExtCtrls, Contnrs,
  Generics.Defaults, Generics.Collections,
  dxCore, dxCoreClasses, dxMessages, cxClasses, cxContainer, dxCoreGraphics, cxGraphics, cxGeometry,
  cxLookAndFeelPainters, dxThemeManager, dxAnimation, dxGdiPlusClasses, dxScrollAnimation,
  cxControls, cxLookAndFeels, cxAccessibility, cxLibraryConsts, dxCustomHint, cxScrollBar, dxForms, dxFluentDesignFormInterfaces,
  dxNavBarBase, dxNavBarCollns, dxNavBarStyles, dxNavBarConsts;

type
  TdxNavBarChildKind = (nbckGroup, nbckItem, nbckStyle, nbckGroupControl); // for internal use
  ...
  TdxNavBarDropKind = (dkNone, dkBefore, dkInside, dkAfter); // for internal use
  TdxNavBarDropKinds = set of TdxNavBarDropKind; // for internal use
  ...
  TdxNavBarPartState = (oisNormal, oisHot, oisPressed, oisChecked, oisHotCheck, oisDroppedDown); // for internal use
...
type
  ...
  TdxNavBarChildGroupViewInfo = class;
  ...
  TdxNavBarHamburgerMenuDisplayMode = (dmInline, dmOverlay, dmOverlayMinimal);
  TdxNavBarHamburgerMenuNavigationPaneMode = (npmCompact, npmFull, npmNone);
  TdxNavBarHamburgerMenuSelectedGroupPopupMode = (pmDocked, pmUnDocked);

  TdxNavBarDropTargetInfo = record // for internal use
    Group: TdxNavBarGroup;
    Position: Integer;
    Kind: TdxNavBarDropKind;
  end;

  TdxNavBarPart = record // for internal use
  ...
  TdxNavBarPartViewInfo = class(TdxNavBarCustomViewInfo) // for internal use
  private
  ...
  protected
    ...
    procedure CalcDesignRect(const ARect: TRect);
    procedure OffsetCaptionAndImageRects(dX, dY: Integer);
    procedure AdjustHeight(var AHeight: Integer); virtual;
  public
  ...
  protected
    ...
    function CreateLinkViewInfo(ALink: TdxNavBarItemLink; ACaptionVisible, AImageVisible: Boolean): TdxNavBarLinkViewInfo; virtual;
    procedure AddChildGroup(AGroup: TdxNavBarGroup; ACaptionVisible, AItemsVisible: Boolean); virtual;
    procedure AddLink(AViewInfo: TdxNavBarViewInfo; ALink: TdxNavBarItemLink; ACaptionVisible, AImageVisible: Boolean); virtual;
    ...
    function GetTextEdges: TPoint;
    function IsCaptionCalculationNeeded: Boolean; virtual;
    function IsTopLevel: Boolean; virtual;
    function HasScrollBarInGroupCaption: Boolean; virtual;

    procedure AdjustControlBounds; virtual;
    procedure CalculateCaptionImageRect(X, Y: Integer); virtual;
  ...
  public
    ...
    // Styles attributes
    function AcrylicForegroundColor: TColor; virtual;
  ...
  { TdxNavBarGroupCalculator }

  TdxNavBarGroupCalculator = class // for internal use only
  protected
    class function GetGroupCaptionSeparatorWidth(AGroupViewInfo: TdxNavBarGroupViewInfo): Integer; static;
    class procedure CalculateClientRect(AGroupViewInfo: TdxNavBarGroupViewInfo; var X, Y: Integer); static;
    class procedure CalculateFocusRect(AGroupViewInfo: TdxNavBarGroupViewInfo); static;
    class procedure CalculateItems(AGroupViewInfo: TdxNavBarGroupViewInfo; var X, Y: Integer;
      out AItemsRectBottom: Integer); static;
    class procedure CalculateItemsAsIconView(AGroupViewInfo: TdxNavBarGroupViewInfo; var X, Y: Integer;
      out AItemsRectBottom: Integer); static;
    class procedure CalculateItemsRect(AGroupViewInfo: TdxNavBarGroupViewInfo); static;
  public
    class procedure CalculateCaptionBounds(AGroupViewInfo: TdxNavBarGroupViewInfo; X, Y: Integer); static;
    class procedure CalculateExpandButtonRect(AGroupViewInfo: TdxNavBarGroupViewInfo); static;
  end;
  ...
  protected
    ...
    function GetNavBarItem: TdxNavBarCustomItem; override;
    function UseLargeImages: Boolean; override;
    procedure AdjustHeight(var AHeight: Integer); override;
    property OwnerGroupViewInfo: TdxNavBarGroupViewInfo read FOwnerGroupViewInfo;
  public
  ...
  protected
    ...
    function GetExpandButtonAreaRight: Integer; virtual;
    ...
    property CaptionInfo: TdxNavBarChildGroupCaptionViewInfo read FCaptionInfo;
  public
    constructor Create(AViewInfo: TdxNavBarViewInfo; AParentInfo: TdxNavBarGroupViewInfo;
      AGroup: TdxNavBarGroup; ACaptionVisible, AItemsVisible: Boolean); reintroduce; virtual;
    destructor Destroy; override;
  ...
  TdxNavBarHeaderPanelSignAccessibilityHelper = class(TdxNavBarCustomAccessibilityHelper) // for internal use
  strict private
  ...
  protected
    ...
    function GetSignState: TdxNavBarPartState; virtual;
    ...
    property SignState: TdxNavBarPartState read GetSignState;
  ...
  strict protected
    ...
    FSizeGripRect: TRect;
  protected
    class function InternalGetLinkViewInfoAtSelectedPos(AViewInfo: TdxNavBarViewInfo; const pt: TPoint): TdxNavBarLinkViewInfo;
    ...
    function GetGroupsArea: TRect; virtual;
    function GetLargeImageHeight: Integer; overload;
    function GetLargeImageHeight(AItemViewInfo: TdxNavBarCustomItemViewInfo): Integer; overload; virtual;
    function GetLargeImageWidth: Integer; overload;
    function GetLargeImageWidth(AItemViewInfo: TdxNavBarCustomItemViewInfo): Integer; overload; virtual;
    function GetScrollButtonsBounds: TRect; virtual;
    function GetSmallImageHeight: Integer; overload;
    function GetSmallImageHeight(AItemViewInfo: TdxNavBarCustomItemViewInfo): Integer; overload; virtual;
    function GetSmallImageWidth: Integer; overload;
    function GetSmallImageWidth(AItemViewInfo: TdxNavBarCustomItemViewInfo): Integer; overload; virtual;
    function GetSpaceBetweenGroups: Integer; virtual;
    function GetPopupTopPos: Integer; virtual;
    function IsTopAlignment(AGroup: TdxNavBarGroup): Boolean; virtual;
    ...
    function GetGroupAccessibilityHelperClass: TdxNavBarCustomAccessibilityHelperClass; virtual;
    function GetGroupCaptionPanelAccessibilityHelperClass: TdxNavBarCustomAccessibilityHelperClass; virtual;
    ...
    // Conditions
    function AllowControlExpandAnimation: Boolean; virtual;
    ...
    function IsPtHeaderSign(const pt: TPoint): Boolean; virtual;
    function IsTopScrollButtonStateDisabled: Boolean; virtual;
    function UseControlExpandAnimation: Boolean;

    procedure AddGroup(AViewInfo: TdxNavBarViewInfo; AGroup: TdxNavBarGroup; ACaptionVisible, AItemsVisible: Boolean); virtual;
    ...
    procedure CalculateGroups(X, Y: Integer); virtual;
    ...
    function GetDefaultOverflowPanelBitmap: TBitmap; virtual;
    function GetHeaderSignAccessibilityHelperClass: TdxNavBarCustomAccessibilityHelperClass; virtual;
    function GetPartIAccessibilityHelper(const APart: TdxNavBarPart): IdxNavBarAccessibilityHelper; virtual;
    ...
    property GroupsArea: TRect read GetGroupsArea;
  ...
  public
    ...
    // Hit tests
    function GetGroupViewInfoAtPos(const pt: TPoint): TdxNavBarGroupViewInfo; virtual;
    ...
    function ClientRect: TRect; // for internal use
  ...
  private
    class procedure CalculateImageRect(ACaptionViewInfo: TdxNavBarChildCaptionViewInfo; ALeft, ATop: Integer);
    class procedure CalculateLargeBounds(ACaptionViewInfo: TdxNavBarChildCaptionViewInfo; X, Y, ARightPosition: Integer);
    class procedure CalculateLeftPosition(ACaptionViewInfo: TdxNavBarChildCaptionViewInfo; X: Integer; out ALeft: Integer);
    class procedure CalculateSmallBounds(ACaptionViewInfo: TdxNavBarChildCaptionViewInfo; X, Y, ARightPosition: Integer);
    class procedure CalculateRect(ACaptionViewInfo: TdxNavBarChildCaptionViewInfo; ALeft, ATop, ARight, ABottom: Integer);
  protected
    class function HasScrollBar(ACaptionViewInfo: TdxNavBarChildCaptionViewInfo): Boolean; virtual;
    class procedure CalculateCaptionRect(ACaptionViewInfo: TdxNavBarChildCaptionViewInfo;
      ALeft, ATop, ARightPosition: Integer); virtual;
  public
    class procedure CalculateBounds(X, Y: Integer; AScaleFactor: TdxScaleFactor; var AItemViewInfo); override;
    class procedure CalculateDesignRect(AItemViewInfo: TdxNavBarCustomItemViewInfo; const ARect: TRect); static;
    class function CalculateFocusRect(const ARect, ATextRect: TRect): TRect; overload;
    class procedure CalculateFocusRect(AItemViewInfo: TdxNavBarCustomItemViewInfo); overload;
    class procedure CalculateFocusRect(AItemViewInfo: TdxNavBarCustomItemViewInfo; const ARect,
      ATextRect: TRect); overload;
  end;
  ...
  protected
    ...
    function AllowAcrylicBackground: Boolean; virtual;
    function GetAcrylicBackgroundColor: TdxAlphaColor;
    function GetAcrylicBorderColor: TdxAlphaColor; virtual;
    function GetAcrylicForegroundColor: TColor; virtual;
    function GetBackgroundColorForComposition: TColor; virtual;
    function GetOwner: TPersistent; override;
    procedure Initialize; virtual;
    function IsAcrylicEnabled: Boolean;
    function IsViewInfoValid: Boolean;
    // Drawing
    function UseHeaderCustomDrawing: Boolean; virtual;
  ...
  public
    ...
    property Controller: TdxNavBarController read FController; // for internal use
    property ViewInfo: TdxNavBarViewInfo read FViewInfo;
  end;
  ...
  private
    ...
    FHamburgerMenuHeader: TdxNavBarCustomDrawEvent;
    FHamburgerMenuNavigationPane: TdxNavBarCustomDrawEvent;
    FLink: TdxNavBarCustomDrawLinkEvent;
    FLinkHint: TdxNavBarCustomDrawLinkHintEvent;
    FLinkSelection: TdxNavBarCustomDrawLinkEvent;
  ...
  published
    ...
    property HamburgerMenuHeader: TdxNavBarCustomDrawEvent read FHamburgerMenuHeader write FHamburgerMenuHeader;
    property HamburgerMenuNavigationPane: TdxNavBarCustomDrawEvent read FHamburgerMenuNavigationPane write FHamburgerMenuNavigationPane;
    ...
    property LinkSelection: TdxNavBarCustomDrawLinkEvent read FLinkSelection write FLinkSelection;
  ...
  TdxNavBarCustomCustomizationForm = class(TdxForm) // for internal use
  private
    FNavBar: TdxCustomNavBar;
    FLockCount: Integer;
  ...
  public
    ...
    property Form: TdxNavBarCustomCustomizationForm read FForm; // for internal use
  ...
  private
    ...
    procedure SetRevealHighlight(Value: Boolean);
  public
    constructor Create(ANavBar: TdxCustomNavBar); override;
    procedure Assign(Source: TPersistent); override;
  published
    ...
    property RevealHighlight: Boolean read FRevealHighlight write SetRevealHighlight default True;
  ...
  protected
    property AllowPopupResizing: Boolean read FAllowPopupResizing write FAllowPopupResizing default True;
  public
    constructor Create(ANavBar: TdxCustomNavBar); override;
    procedure Assign(Source: TPersistent); override;
  published
  ...
  TdxNavBarHamburgerMenuBehaviorOptions = class(TdxNavBarPersistent)
  private
    FAllowCustomizing: Boolean;
    FCollapsed: Boolean;
    FDisplayMode: TdxNavBarHamburgerMenuDisplayMode;
    FSelectedGroupPopupMode: TdxNavBarHamburgerMenuSelectedGroupPopupMode;
    FIsOverlayVisible: Boolean;
    function GetCollapsed: Boolean;
    procedure SetAllowCustomizing(const AValue: Boolean);
    procedure SetCollapsed(const AValue: Boolean);
    procedure SetDisplayMode(const AValue: TdxNavBarHamburgerMenuDisplayMode);
    procedure SetSelectedGroupPopupMode(const AValue: TdxNavBarHamburgerMenuSelectedGroupPopupMode);
  protected
    function IsOverlayMode: Boolean;
    property IsOverlayVisible: Boolean read FIsOverlayVisible;
    procedure SetOverlayVisible(const AValue: Boolean);
    property AllowCustomizing: Boolean read FAllowCustomizing write SetAllowCustomizing default False;
  public
    procedure Assign(Source: TPersistent); override;
  published
    property Collapsed: Boolean read GetCollapsed write SetCollapsed default False;
    property DisplayMode: TdxNavBarHamburgerMenuDisplayMode read FDisplayMode write SetDisplayMode default dmInline;
    property SelectedGroupPopupMode: TdxNavBarHamburgerMenuSelectedGroupPopupMode read
      FSelectedGroupPopupMode write SetSelectedGroupPopupMode default pmDocked;
  end;
  ...
  private
    ...
    FHamburgerMenu: TdxNavBarHamburgerMenuBehaviorOptions;
    ...
    procedure SetHamburgerMenu(AValue: TdxNavBarHamburgerMenuBehaviorOptions);
  ...
  published
    ...
    property HamburgerMenu: TdxNavBarHamburgerMenuBehaviorOptions read FHamburgerMenu write SetHamburgerMenu;
  ...
  strict private
    ...
    procedure SetShowOverflowPanel(const AValue: Boolean);
  public
    constructor Create(ANavBar: TdxCustomNavBar); override;
    procedure Assign(Source: TPersistent); override;
  published
  ...
  TdxNavBarHamburgerMenuViewOptions = class(TdxNavBarPersistent)
  strict private
    FChildLevelIndent: Integer;
    FNavigationPaneMode: TdxNavBarHamburgerMenuNavigationPaneMode;
    FNavigationPaneUseSmallImages: Boolean;
    FSpaceBetweenGroups: Integer;
    FShowHeader: Boolean;
    FShowOverflowPanel: Boolean;
    procedure SetChildLevelIndent(const AValue: Integer);
    procedure SetNavigationPaneMode(const AValue: TdxNavBarHamburgerMenuNavigationPaneMode);
    procedure SetShowHeader(const AValue: Boolean);
    procedure SetShowOverflowPanel(const AValue: Boolean);
    procedure SetSpaceBetweenGroups(const AValue: Integer);
  public
    constructor Create(ANavBar: TdxCustomNavBar); override;
    procedure Assign(Source: TPersistent); override;
  published
    property ChildLevelIndent: Integer read  FChildLevelIndent write SetChildLevelIndent default -1;
    property NavigationPaneMode: TdxNavBarHamburgerMenuNavigationPaneMode read FNavigationPaneMode write
      SetNavigationPaneMode default npmCompact;
    property ShowHeader: Boolean read FShowHeader write SetShowHeader default True;
    property ShowOverflowPanel: Boolean read FShowOverflowPanel write SetShowOverflowPanel default True;
    property SpaceBetweenGroups: Integer read FSpaceBetweenGroups write SetSpaceBetweenGroups default -1;
  end;
  ...
  strict private
    ...
    FHamburgerMenu: TdxNavBarHamburgerMenuViewOptions;
    ...
    procedure SetHamburgerMenu(AValue: TdxNavBarHamburgerMenuViewOptions);
  ...
  published
    ...
    property HamburgerMenu: TdxNavBarHamburgerMenuViewOptions read FHamburgerMenu write SetHamburgerMenu;
  ...
  TdxNavBarController = class // for internal use
  private
    ...
    FSelectedPopupGroup: TdxNavBarGroup;
  ...
  strict protected
    procedure InternalCheckHeight; virtual;
    procedure InternalCheckWidth; virtual;
    procedure InternalSetWidth(const AValue: Integer); virtual;
    //
    procedure DoShowOverlayControl(Sender: TObject);
  protected
    FNavBar: TdxCustomNavBar;
    ...
    function GetPartState(const APart: TdxNavBarPart): TdxNavBarPartState; virtual;
    ...
    function NeedClosePopupControlsOnLinkClick: Boolean; virtual; // for internal use
    procedure DestroyPopupControls; virtual; // for internal use

    function GetActualNavBar: TdxCustomNavBar; overload; virtual;
    function GetActualNavBar(AGroup: TdxNavBarGroup): TdxCustomNavBar; overload; virtual;
    function GetCollapsible: Boolean; virtual;
    function GetPopupControlView: Integer; virtual;
    function GetPopupNavBar: TdxCustomNavBar; virtual;
    function IsPopupGroup(AGroup: TdxNavBarGroup): Boolean;
    function NeedShowPopupControl: Boolean; virtual;
    procedure InternalCloseOverlay; virtual;
    procedure InternalClosePopupControl;
    procedure InternalShowOverlay; virtual;
    procedure InternalShowPopupControl(AGroup: TdxNavBarGroup; const ADroppedDownPart: TdxNavBarPart); overload;
    procedure InternalShowPopupControl(const ADroppedDownPart: TdxNavBarPart); overload; virtual;

    function AllowResize: Boolean; virtual;

    function GetRealCollapsed: Boolean; virtual;
    procedure ChangeNavBarCollapseState; virtual;
    procedure SetCollapsed(AValue: Boolean); virtual;
    ...
    procedure BeginDragging; virtual;
    procedure EndDragging; virtual;
    ...
    property SelectedPopupGroup: TdxNavBarGroup read FSelectedPopupGroup;
  ...
  TdxNavBarGetLinkHintEvent = procedure(Sender: TObject; ALink: TdxNavBarItemLink;
      var AHint: string) of object;
  TdxNavBarGetOverlaySizeEvent = procedure(Sender: TObject; var AWidth, AHeight: Integer) of object;
  ...
  TdxNavBarInternalState = (nbisKeyDowned, nbisDragging, nbisAlreadyCollapsed, nbisAfterLoading, nbisGroupExpanding,
    nbisPrepareExpandAnimation, nbisResizing);
  ...
  { TdxNavBarCollapseStateAnimationController }

  TdxNavBarCollapseStateAnimationController = class // for internal use
  strict private
    FActive: Boolean;
    FAnimationTransition: TdxRectAnimationTransition;
    FBuffer: TcxBitmap32;
    FControl: TdxCustomNavBar;

    FCurrentAlpha: Byte;
    FCurrentBounds: TRect;
    FGroupWithControlList: TList<TdxNavBarGroup>;
    FTargetRect: TRect;

    function GetAnimationEffect: TdxAnimationTransitionEffect;
    function GetAnimationEffectMode: TdxAnimationTransitionEffectMode;
    function GetAnimationTime: Cardinal;
    function GetCollapseAnimationTime: Cardinal;
    procedure ChangeGroupControlsVisibility(AVisible: Boolean);
    procedure CheckState(AActive: Boolean);
    procedure HideGroupControls;
    procedure PopulateGroupControlsList;
    procedure ShowGroupControls;
    procedure OnAnimateHandler(Sender: TdxAnimationTransition; var APosition: Integer; var AFinished: Boolean);
    procedure OnTerminatedHandler(Sender: TObject);
  strict protected
    function GetClientRectOffset: TPoint; virtual;
    function GetExpandAnimationTime: Cardinal; virtual;
    function IsExpandMode: Boolean; virtual; abstract;
    procedure CalculateBounds(var ASourceRect, ATargetRect: TRect); virtual; abstract;
    procedure AfterAnimation; virtual;
    procedure BeforeAnimation; virtual;
    procedure HandleAnimationStep; virtual;
    procedure PrepareAnimationBuffer(AControl: TdxCustomNavBar); virtual;
    procedure ResumeAnimationTransition; virtual;

    procedure InternalAnimate;

    property AnimationTransition: TdxRectAnimationTransition read FAnimationTransition;
    property TargetRect: TRect read FTargetRect;
  protected
    function AllowAnimation(AIsExpandMode: Boolean): Boolean; virtual;
    function GetAnimationBufferRect: TRect; virtual;
    procedure HandleAnimationFinishStep; virtual;

    procedure DoPrepareBuffer;

    property Buffer: TcxBitmap32 read FBuffer;
    property Control: TdxCustomNavBar read FControl;
    property CurrentAlpha: Byte read FCurrentAlpha;
    property CurrentBounds: TRect read FCurrentBounds;
  public
    constructor Create(AControl: TdxCustomNavBar);
    destructor Destroy; override;

    function DrawAnimationBuffer(ACanvas: TcxCanvas): Boolean;
    procedure TerminateAnimation;

    property Active: Boolean read FActive;
  end;

  { TdxNavBarInlineExpandAnimationController }

  TdxNavBarInlineExpandAnimationController = class(TdxNavBarCollapseStateAnimationController) // for internal use
  private
  ...
  strict protected
    ...
    procedure PrepareAnimationBuffer(AControl: TdxCustomNavBar); override;
  protected
    procedure Animate(AWidth: Integer);
  end;

  { TdxNavBarDragControlObject }
  ...
  protected
    ...
    function GetDropKind(const APoint: TPoint; const ARect: TRect; AForbiddenDropKinds: TdxNavBarDropKinds;
      AIsVerticalItemLayout: Boolean): TdxNavBarDropKind; virtual;
    function GetDropTargetPoint: TPoint; virtual;
    function IsGroupCaptionTarget(const APoint: TPoint; var AGroup: TdxNavBarGroup; var ARect: TRect): Boolean; virtual;
    function IsTargetGroupVerticalLayout(const ATargetPoint: TPoint): Boolean; virtual;
    function IsTargetVerticalLayout(AGroup: TdxNavBarGroup): Boolean; virtual;
    function IsLinkTarget(const APoint: TPoint; var ALink: TdxNavBarItemLink; var ARect: TRect): Boolean; virtual;
    property NavBar: TdxCustomNavBar read FNavBar;
  public
  ...
  TdxCustomNavBar = class(TcxControl, IcxDesignSelectionChanged, IdxNavigationClient, IdxFluentDesignNavigationControl,
    IdxAcrylicHostControlListener)
  private
    FAcrylicHostColor: TdxAlphaColor;
    FAcrylicHostEnabled: Boolean;
    FAcrylicBackgroundColor: TdxAlphaColor;
    FAcrylicBackgroundBlur: TdxFluentDesignBackgroundBlur;
    ...
    FExpandAnimationController: TdxNavBarInlineExpandAnimationController;
    ...
    FIAccessibilityHelper: IdxNavBarAccessibilityHelper;
    FGroupContainerIAccessibilityHelper: IdxNavBarAccessibilityHelper;
    ...
    FNavigationControlListeners: TList<IdxFluentDesignNavigationControlListener>;
    FPainter: TdxNavBarPainter;
    FPreviousCollapsedValue: Boolean;
    FViewReal: Integer;
    ...
    FOnGetOverlaySize: TdxNavBarGetOverlaySizeEvent;
    ...
    FOnOverlayShowed: TNotifyEvent;
    FOnOverlayShowing: TdxNavBarShowingPopupEvent;
    FOnPopupShowed: TNotifyEvent;
    FOnPopupShowing: TdxNavBarShowingPopupEvent;
    ...
    function GetGroupContainerIAccessibilityHelper: IdxNavBarAccessibilityHelper;
    ...
    function GetOnNavigationPaneCollapsed: TNotifyEvent;
    function GetOnNavigationPaneExpanded: TNotifyEvent;
    function GetOnNavigationPanePopupShowed: TNotifyEvent;
    function GetOnNavigationPanePopupShowing: TdxNavBarNavigationPaneShowingPopupEvent;
    procedure SetOnNavigationPaneCollapsed(const Value: TNotifyEvent);
    procedure SetOnNavigationPaneExpanded(const Value: TNotifyEvent);
    procedure SetOnNavigationPanePopupShowed(const Value: TNotifyEvent);
    procedure SetOnNavigationPanePopupShowing(const Value: TdxNavBarNavigationPaneShowingPopupEvent);
  ...
  strict protected
    ...
    procedure DoMouseMove(AShift: TShiftState; const APoint: TPoint); virtual;
  protected
    function GetActualGroup(AGroup: TdxNavBarGroup): TdxNavBarGroup; virtual;
    function GetActualGroupViewInfoByGroup(AGroup: TdxNavBarGroup): TdxNavBarGroupViewInfo; virtual;
    function GetActualLinkViewInfoByLink(ALink: TdxNavBarItemLink): TdxNavBarLinkViewInfo; virtual;
    procedure DoCustomDrawBackground(Sender: TObject; ACanvas: TCanvas;
      AViewInfo: TdxNavBarViewInfo; var AHandled: Boolean); virtual;
    procedure DoCustomDrawGroupCaption(Sender: TObject; ACanvas: TCanvas;
      AViewInfo: TdxNavBarGroupViewInfo; var AHandled: Boolean); virtual;
    procedure DoCustomDrawGroupClientBackground(Sender: TObject; ACanvas: TCanvas;
      AViewInfo: TdxNavBarGroupViewInfo; var AHandled: Boolean); virtual;
    procedure DoCustomDrawGroupClientForeground(Sender: TObject; ACanvas: TCanvas;
      AViewInfo: TdxNavBarGroupViewInfo; var AHandled: Boolean); virtual;
    procedure DoCustomDrawGroupHint(Sender: TObject; ACanvas: TCanvas;
      AGroup: TdxNavBarGroup; AHint: string; R: TRect; var AHandled: Boolean); virtual;
  protected
    FDesignHelper: IcxDesignHelper;
    FAccessibleObjects: TList<TdxNavBarCustomAccessibilityHelper>;
    ...
    function IdxFluentDesignNavigationControl.IsAdaptable = FluentDesignNavigationControlIsAdaptable;
    function IdxFluentDesignNavigationControl.IsCollapsed = FluentDesignNavigationControlIsCollapsed;
    function IdxFluentDesignNavigationControl.GetAcrylicEnabled = FluentDesignNavigationControlGetAcrylicEnabled;
    function IdxFluentDesignNavigationControl.GetBackgroundColor = FluentDesignNavigationControlGetBackgroundColor;
    function IdxFluentDesignNavigationControl.GetBorderColor = FluentDesignNavigationControlGetBorderColor;
    function IdxFluentDesignNavigationControl.GetDisplayMode = FluentDesignNavigationControlGetDisplayMode;
    function IdxFluentDesignNavigationControl.GetForegroundColor = FluentDesignNavigationControlGetForegroundColor;
    procedure IdxFluentDesignNavigationControl.SetDisplayMode = FluentDesignNavigationControlSetDisplayMode;
    procedure IdxFluentDesignNavigationControl.AddListener = FluentDesignNavigationControlAddListener;
    procedure IdxFluentDesignNavigationControl.RemoveListener = FluentDesignNavigationControlRemoveListener;
    function FluentDesignNavigationControlIsAdaptable: Boolean;
    function FluentDesignNavigationControlIsCollapsed: Boolean;
    function FluentDesignNavigationControlGetAcrylicEnabled: Boolean;
    function FluentDesignNavigationControlGetBackgroundColor: TdxAlphaColor;
    function FluentDesignNavigationControlGetBorderColor: TdxAlphaColor;
    function FluentDesignNavigationControlGetDisplayMode: TdxFluentDesignNavigationControlDisplayMode;
    function FluentDesignNavigationControlGetForegroundColor: TColor;
    procedure FluentDesignNavigationControlAddListener(AListener: IdxFluentDesignNavigationControlListener);
    procedure FluentDesignNavigationControlRemoveListener(AListener: IdxFluentDesignNavigationControlListener);
    procedure FluentDesignNavigationControlSetDisplayMode(AValue: TdxFluentDesignNavigationControlDisplayMode);

    // IdxAcrylicHostControlListener
    procedure IdxAcrylicHostControlListener.Changed = AcrylicHostControlChanged;
    procedure AcrylicHostControlChanged(AValue: IdxAcrylicHostControl; AHasAcrylicParent: Boolean);

    function GetAcrylicAlphaValue: Byte;
    function GetAcrylicBackgroundColor: TdxAlphaColor;
    function GetAcrylicBackgroundBlur: TdxFluentDesignBackgroundBlur;
    function GetAcrylicHostColor: TdxAlphaColor;
    function IsAcrylicEnabled: Boolean;
    procedure NotifyNavigationControlListeners(AChanges: TdxFluentDesignNavigationControlChangeTypes);
    procedure ResetAcrylicBackgroundColor;
    ...
    //
    procedure CreateNavBarDragObject(ADragObject: TDragObject); virtual;
    ...
    function DoCanShowOverlay: Boolean;
    ...
    procedure DoShowOverlayControl;
...
//    procedure DoOverflowPanelMouseUp; virtual;
    ...
    // Painting
    function IsExpandAnimationPreparing: Boolean;
    ...
    function GetGroupContainerAccessibilityHelperClass: TdxNavBarCustomAccessibilityHelperClass; virtual;
    ...
    function IsAlreadyCollapsed: Boolean;
    function IsAnimationLocked: Boolean;
    function IsCalculationLocked: Boolean;
    ...
    procedure DrawContentWithChildren(ACanvas: TcxCanvas; const AOrigin: TPoint; AChangeExpandStateGroups: TList<TdxNavBarGroup>);
    procedure EndResize;
    procedure LockCalculation;
    procedure PerformWithAnimationLocking(AProc: TProc);
    procedure Recalculate;
    procedure RecreateViewInfo;
    procedure Redraw;
    procedure UnlockCalculation;

    // PopupControl
    function GetMasterNavBar: TdxCustomNavBar; virtual;
    function TryGetPopupNavBar(out ANavBar: TdxCustomNavBar): Boolean;
    ...
    property ExpandAnimationController: TdxNavBarInlineExpandAnimationController read FExpandAnimationController;
    ...
    property OnGetOverlaySize: TdxNavBarGetOverlaySizeEvent read FOnGetOverlaySize write FOnGetOverlaySize;
    property OnNavigationPanePopupShowed: TNotifyEvent read GetOnNavigationPanePopupShowed write SetOnNavigationPanePopupShowed;
    property OnNavigationPanePopupShowing: TdxNavBarNavigationPaneShowingPopupEvent read
      GetOnNavigationPanePopupShowing write SetOnNavigationPanePopupShowing;
    property OnOverlayShowed: TNotifyEvent read FOnOverlayShowed write FOnOverlayShowed;
    property OnOverlayShowing: TdxNavBarShowingPopupEvent read FOnOverlayShowing write FOnOverlayShowing;
    property OnPopupShowed: TNotifyEvent read FOnPopupShowed write FOnPopupShowed;
    property OnPopupShowing: TdxNavBarShowingPopupEvent read FOnPopupShowing write FOnPopupShowing;
  public
    ...
    property Controller: TdxNavBarController read GetController; // for internal use
    ...
    property GroupContainerIAccessibilityHelper: IdxNavBarAccessibilityHelper read GetGroupContainerIAccessibilityHelper; // for internal use
    ...
    property OnNavigationPaneCollapsed: TNotifyEvent read GetOnNavigationPaneCollapsed write SetOnNavigationPaneCollapsed;
    property OnNavigationPaneExpanded: TNotifyEvent read GetOnNavigationPaneExpanded write SetOnNavigationPaneExpanded;
  ...
  protected
    function GetOriginalNavBar: TdxCustomNavBar; virtual;
    function GetOriginalSourceGroup: TdxNavBarGroup; virtual;
    function GetOriginalSourceItem: TdxNavBarItem; virtual;
    function GetOriginalSourceLink: TdxNavBarItemLink; virtual;
    function GetOriginalTargetGroup: TdxNavBarGroup; virtual;
    procedure UpdateTargets; virtual;
    //
    property OriginalNavBar: TdxCustomNavBar read GetOriginalNavBar;
    property OriginalSourceGroup: TdxNavBarGroup read GetOriginalSourceGroup;
    property OriginalSourceItem: TdxNavBarItem read GetOriginalSourceItem;
    property OriginalSourceLink: TdxNavBarItemLink read GetOriginalSourceLink;
    property OriginalTargetGroup: TdxNavBarGroup read GetOriginalTargetGroup;
  public
    constructor Create(ANavBar: TdxCustomNavBar; var DragObject: TDragObject {deprecated}; ASourceGroup: TdxNavBarGroup;
      ASourceLink: TdxNavBarItemLink; ASourceItem: TdxNavBarItem); virtual;
    //
  ...
  { TdxInnerNavBarDragObject }

  TdxInnerNavBarDragObject = class(TdxNavBarDragObject) // for internal use
  private
    FOriginalNavBar: TdxCustomNavBar;
    //
    function GetMasterGroup(AGroup: TdxNavBarGroup): TdxNavBarGroup;
    function GetMasterLink(ALink: TdxNavBarItemLink): TdxNavBarItemLink;
  protected
    function GetOriginalNavBar: TdxCustomNavBar; override;
    function GetOriginalSourceGroup: TdxNavBarGroup; override;
    function GetOriginalSourceItem: TdxNavBarItem; override;
    function GetOriginalSourceLink: TdxNavBarItemLink; override;
    function GetOriginalTargetGroup: TdxNavBarGroup; override;
  public
    constructor Create(ANavBar: TdxCustomNavBar; var DragObject: TDragObject; ASourceGroup: TdxNavBarGroup;
      ASourceLink: TdxNavBarItemLink; ASourceItem: TdxNavBarItem); override;
  end;

  TdxNavBarScrollAnimationHelper = class(TdxScrollAnimationHelper) // for internal use
  strict private
    FOwner: TdxNavBarScrollBar;
  protected
    ...
    property Owner: TdxNavBarScrollBar read FOwner;
  public
    constructor Create(AOwner: TdxNavBarScrollBar);
  end;
  ...
  strict private
    ...
    FParent: TcxControl;
    FScrollAnimationHelper: TdxNavBarScrollAnimationHelper;
  ...
  protected
    ...
    procedure UpdateAnimatedPosition(AValue: Integer);
    ...
    procedure SetPositionAnimated(AValue: Integer);
  ...
  public
    ...
    procedure UpdatePosition(AValue: Integer; AAnimated: Boolean);
  ...
  published
    ...
    property OnNavigationPaneCollapsed stored False;
    property OnNavigationPaneExpanded stored False;
    property OnNavigationPanePopupShowed stored False;
    property OnNavigationPanePopupShowing stored False;
    property OnOverlayShowed;
    property OnOverlayShowing;
    property OnPopupShowed;
    property OnPopupShowing;
    property OnStartDrag;
  end;

  { TdxNavBarCustomPopupControlViewInfo }

  TdxNavBarCustomPopupControlViewInfo = class(TdxNavBarPartViewInfo) // for internal use
  protected
    FRect: TRect;
  ...
  { TdxNavBarCloneMapper }

  TdxNavBarCloneMapperClass = class of TdxNavBarCloneMapper; // for internal use
  TdxNavBarCloneMapper = class
  strict private
    FGroupMapping: TDictionary<TdxNavBarGroup, TdxNavBarGroup>;
    FMaster: TdxCustomNavBar;
    FMasterGroupMapping: TDictionary<TdxNavBarGroup, TdxNavBarGroup>;
    FMasterItemLinkMapping: TDictionary<TdxNavBarItemLink, TdxNavBarItemLink>;
    FNavBar: TdxCustomNavBar;
  ...
  strict protected
    ...
    procedure CloneMasterData; virtual;
    procedure CloneMasterOptions; virtual;
    procedure DoUpdateMasterFromClone; virtual; abstract;
    ...
    property Master: TdxCustomNavBar read FMaster;
  public
    constructor Create(AClone, AMaster: TdxCustomNavBar);
    destructor Destroy; override;

    procedure PopulateCloneFromMaster;
    procedure UpdateMasterFromClone;

    property GroupMapping: TDictionary<TdxNavBarGroup, TdxNavBarGroup> read FGroupMapping;
    property MasterGroupMapping: TDictionary<TdxNavBarGroup, TdxNavBarGroup> read FMasterGroupMapping;
    property MasterItemLinkMapping: TDictionary<TdxNavBarItemLink, TdxNavBarItemLink> read FMasterItemLinkMapping;
  end;

  { TdxNavBarControlMapper }

  TdxNavBarControlMapper = class(TdxNavBarCloneMapper) // for internal use
  strict private
    procedure SynchronizeGroupOrder;
  strict protected
    procedure AssignGroupProperties(ASource, ADestination: TdxNavBarGroup); override;
    procedure CloneMasterData; override;
    procedure CloneMasterOptions; override;
    procedure DoUpdateMasterFromClone; override;

    procedure CloneGroups; virtual;

    procedure CloneGroup(AGroup: TdxNavBarGroup);
    procedure UpdateOriginalGroup(AGroup: TdxNavBarGroup);
  end;

  { TdxNavBarActiveGroupMapper }

  TdxNavBarActiveGroupMapper = class(TdxNavBarCloneMapper) // for internal use
  strict private
  ...
  private
    FMapper: TdxNavBarCloneMapper;
    FMaster: TdxCustomNavBar;
    //
    function GetGroupMapping: TDictionary<TdxNavBarGroup, TdxNavBarGroup>;
    function GetMasterGroupMapping: TDictionary<TdxNavBarGroup, TdxNavBarGroup>;
    function GetMasterItemLinkMapping: TDictionary<TdxNavBarItemLink, TdxNavBarItemLink>;
    //
    procedure OnDragDropHandler(ASender, ASource: TObject; X, Y: Integer);
    procedure OnDragOverHandler(ASender, ASource: TObject; X, Y: Integer; AState: TDragState; var AAccept: Boolean);
    procedure OnEndDragHandler(ASender, ATarget: TObject; X, Y: Integer);
    procedure OnStartDragHandler(ASender: TObject; var ADragObject: TDragObject);
    //
    procedure WMNCHitTest(var Message: TWMNCHitTest); message WM_NCHITTEST;
  strict protected
    function DoGetCursor: HIcon; override;
    function GetMasterNavBar: TdxCustomNavBar; override;
    procedure CreateNavBarDragObject(ADragObject: TDragObject); override;
    ...
    //
    function GetMapperClass: TdxNavBarCloneMapperClass; virtual;
  protected
    procedure DoCustomDrawBackground(Sender: TObject; ACanvas: TCanvas;
      AViewInfo: TdxNavBarViewInfo; var AHandled: Boolean); override;
    procedure DoCustomDrawGroupCaption(Sender: TObject; ACanvas: TCanvas;
      AViewInfo: TdxNavBarGroupViewInfo; var AHandled: Boolean); override;
    procedure DoCustomDrawGroupClientBackground(Sender: TObject; ACanvas: TCanvas;
      AViewInfo: TdxNavBarGroupViewInfo; var AHandled: Boolean); override;
    procedure DoCustomDrawGroupClientForeground(Sender: TObject; ACanvas: TCanvas;
      AViewInfo: TdxNavBarGroupViewInfo; var AHandled: Boolean); override;
    procedure DoCustomDrawGroupHint(Sender: TObject; ACanvas: TCanvas;
      AGroup: TdxNavBarGroup; AHint: string; R: TRect; var AHandled: Boolean); override;
    //
    property Master: TdxCustomNavBar read FMaster;
  protected
    function GetActualGroup(AGroup: TdxNavBarGroup): TdxNavBarGroup; override;
    function GetActualGroupViewInfoByGroup(AGroup: TdxNavBarGroup): TdxNavBarGroupViewInfo; override;
    function GetActualLink(ALink: TdxNavBarItemLink): TdxNavBarItemLink;
    function GetActualLinkViewInfoByLink(ALink: TdxNavBarItemLink): TdxNavBarLinkViewInfo; override;

    procedure UpdateData;
    procedure UpdateOriginalData;

    property GroupMapping: TDictionary<TdxNavBarGroup, TdxNavBarGroup> read GetGroupMapping;
    property MasterGroupMapping: TDictionary<TdxNavBarGroup, TdxNavBarGroup> read GetMasterGroupMapping;
    property MasterItemLinkMapping: TDictionary<TdxNavBarItemLink, TdxNavBarItemLink> read GetMasterItemLinkMapping;
  public
  ...
  { TdxNavBarActiveGroupInnerControl }

  TdxNavBarActiveGroupInnerControl = class(TdxNavBarPopupInnerControl) // for internal use
  strict private
  ...
  public
    class function CalculateBounds(AViewInfo: TdxNavBarViewInfo; AGroupViewInfoClass: TdxNavBarGroupViewInfoClass;
      AClientWidth: Integer; const ABorderOffsets: TRect): TRect; overload;
    class function CalculateBounds(AViewInfo: TdxNavBarViewInfo; AClientWidth: Integer; const ABorderOffsets: TRect): TRect; overload;
...
uses
  Consts, Math, dxUxTheme, dxTypeHelpers, dxGdiPlusApi, dxNavBarGraphics,
  ...
  dxSkinsdxNavBarPainter, dxDPIAwareUtils;

const
  dxThisUnitName = 'dxNavBar';
...
constructor TdxNavBarCloneMapper.Create(AClone, AMaster: TdxCustomNAvBar);
begin
  inherited Create;
  FNavBar := AClone;
  FMaster := AMaster;
  FGroupMapping := TDictionary<TdxNavBarGroup, TdxNavBarGroup>.Create;
  FMasterGroupMapping := TDictionary<TdxNavBarGroup, TdxNavBarGroup>.Create;
  FMasterItemLinkMapping := TDictionary<TdxNavBarItemLink, TdxNavBarItemLink>.Create;
end;

destructor TdxNavBarCloneMapper.Destroy;
begin
  FreeAndNil(FMasterGroupMapping);
  FreeAndNil(FMasterItemLinkMapping);
  FreeAndNil(FGroupMapping);
  inherited Destroy;
end;

procedure TdxNavBarCloneMapper.AssignGroupProperties(ASource, ADestination: TdxNavBarGroup);
var
...
begin
  ...
  ADestinationGroup.Visible := ASourceGroup.Visible;
  ADestinationGroup.VisibleForCustomization := ASourceGroup.VisibleForCustomization;
  ...
  ADestinationGroup.OnClick := ASourceGroup.OnClick;
  ASourceGroup.OnSelectedLinkChanged := nil;
  ASourceGroup.OnTopVisibleLinkChanged := nil;
end;

procedure TdxNavBarCloneMapper.CloneMasterData;
begin
  FMasterItemLinkMapping.Clear;
  FMasterGroupMapping.Clear;
  FGroupMapping.Clear;
  FNavBar.Groups.Clear;
  FNavBar.Items.Assign(FMaster.Items);
end;

procedure TdxNavBarCloneMapper.CloneMasterOptions;
begin
  FNavBar.Name := FMaster.Name + 'Clone';
  FNavBar.View := FMaster.Controller.GetPopupControlView;
  FNavBar.LookAndFeelSchemes := FMaster.LookAndFeelSchemes;
  FNavBar.LookAndFeel.MasterLookAndFeel := FMaster.LookAndFeel;
  FNavBar.ViewStyle.Assign(FMaster.ViewStyle);
  FNavBar.OptionsStyle := FMaster.OptionsStyle;
  FNavBar.OptionsImage := FMaster.OptionsImage;
  FNavBar.OptionsBehavior := FMaster.OptionsBehavior;
  FNavBar.FExpandAnimationCursor := FMaster.ExpandAnimationCursor;
  FNavBar.HotTrackedGroupCursor := FMaster.HotTrackedGroupCursor;
  FNavBar.HotTrackedLinkCursor := FMaster.HotTrackedLinkCursor;
  FNavBar.ShowGroupsHint := FMaster.ShowGroupsHint;
  FNavBar.ShowLinksHint := FMaster.ShowLinksHint;
  FNavBar.OnCustomDraw := FMaster.OnCustomDraw;
  FNavBar.Font := FMaster.Font;
  FNavBar.TabStop := FMaster.TabStop;
end;

procedure TdxNavBarCloneMapper.PopulateCloneFromMaster;
begin
  FNavBar.PerformWithAnimationLocking(procedure
    begin
      FNavBar.BeginUpdate;
      try
        CloneMasterOptions;
...
procedure TdxNavBarCloneMapper.CloneGroupChildren(ASource, ADestination: TdxNavBarGroup);
var
  I: Integer;
...
begin
  ...
  FMasterGroupMapping.Add(ASource, ADestination);
  for I := 0 to ASource.ChildCount - 1 do
    if ASource.Children[I] is TdxNavBarGroup then
    begin
      ASourceChildGroup := TdxNavBarGroup(ASource.Children[I]);
      ADestinationChildGroup := NavBar.Groups.Add;
      ...
      begin
        ...
        ADestinationLink := ADestination.CreateLink(NavBar.Items[ASourceLink.Item.Index]);
        ADestinationLink.Data := TdxNativeInt(ASourceLink);
        FMasterItemLinkMapping.Add(ASourceLink, ADestinationLink);
      end;
end;

procedure TdxNavBarCloneMapper.SynchronizeGroupChildren(ASourceGroup, ADestinationGroup: TdxNavBarGroup);
var
  I: Integer;
  ASourceLink, ADestinationLink: TdxNavBarItemLink;
  ASourceChildGroup, ADestinationChildGroup: TdxNavBarGroup;
...
procedure TdxNavBarCloneMapper.UpdateMasterFromClone;
begin
  FMaster.BeginUpdate;
  try
    DoUpdateMasterFromClone;
  finally
    FMaster.EndUpdate;
  end;
end;

procedure TdxNavBarCloneMapper.AcceptActiveGroupControl(ASource, ADestination: TdxNavBarGroup);
...
begin
  ...
  if ASource.GetParentComponent = NavBar then
  begin
...
procedure TdxNavBarControlMapper.AssignGroupProperties(ASource, ADestination: TdxNavBarGroup);
begin
  inherited AssignGroupProperties(ASource, ADestination);
  ADestination.Align := ASource.Align;
end;

procedure TdxNavBarControlMapper.CloneMasterData;
begin
  inherited CloneMasterData;
  CloneGroups;
end;

procedure TdxNavBarControlMapper.CloneMasterOptions;
begin
  inherited CloneMasterOptions;
  NavBar.OptionsView := Master.OptionsView;
  NavBar.ShowGroupCaptions := Master.ShowGroupCaptions;
  NavBar.SpaceBetweenGroups := Master.SpaceBetweenGroups;
end;

procedure TdxNavBarControlMapper.DoUpdateMasterFromClone;
var
  I: Integer;
begin
  for I := 0 to NavBar.RootGroupCount - 1 do
    UpdateOriginalGroup(NavBar.RootGroups[I]);
  SynchronizeGroupOrder;
  Master.ActiveGroupIndex := NavBar.ActiveGroupIndex;
end;

procedure TdxNavBarControlMapper.CloneGroups;

  procedure SynchronizeGroupIndexes;
  var
    I: Integer;
    AGroup: TdxNavBarGroup;
  begin
    dxTestCheck(Master.Groups.Count = NavBar.Groups.Count, 'Master.Groups.Count = NavBar.Groups.Count');
    dxTestCheck(Master.RootGroupCount = NavBar.RootGroupCount, 'Master.RootGroupCount = NavBar.RootGroupCount');
    for I := 0 to Master.Groups.Count - 1 do
      if MasterGroupMapping.TryGetValue(Master.Groups[I], AGroup) then
        AGroup.Index := Master.Groups[I].Index;
    NavBar.ActiveGroupIndex := Master.ActiveGroupIndex;
  end;

var
  I: Integer;
begin
  for I := 0 to Master.RootGroupCount - 1 do
    CloneGroup(Master.RootGroups[I]);
  SynchronizeGroupIndexes;
end;

procedure TdxNavBarControlMapper.CloneGroup(AGroup: TdxNavBarGroup);
var
  AAddedGroup: TdxNavBarGroup;
begin
  AAddedGroup := NavBar.Groups.Add;
  CloneGroupChildren(AGroup, AAddedGroup);
  AssignGroupProperties(AGroup, AAddedGroup);
end;

procedure TdxNavBarControlMapper.UpdateOriginalGroup(AGroup: TdxNavBarGroup);
var
  AOriginalGroup: TdxNavBarGroup;
begin
  if GroupMapping.TryGetValue(AGroup, AOriginalGroup) then
  begin
    SynchronizeGroupChildren(AGroup, AOriginalGroup);
    AssignGroupProperties(AGroup, AOriginalGroup);
  end
end;

procedure TdxNavBarControlMapper.SynchronizeGroupOrder;

  function GetRootGroupOrders: TList<TdxNavBarGroup>;
  var
    I: Integer;
    AOriginalGroup: TdxNavBarGroup;
  begin
    Result := TList<TdxNavBarGroup>.Create;
    for I := 0 to NavBar.RootGroupCount - 1 do
      if GroupMapping.TryGetValue(NavBar.RootGroups[I], AOriginalGroup) then
        Result.Add(AOriginalGroup);
  end;

var
  ARootGroupOrder: TList<TdxNavBarGroup>;
begin
  ARootGroupOrder := GetRootGroupOrders;
  try
    TdxNavBarGroupsAccess(Master.Groups).SetGroupOrder(ARootGroupOrder);
  finally
    ARootGroupOrder.Free;
  end;
end;
...
begin
  ...
  FMapper := GetMapperClass.Create(Self, FMaster);
  OnStartDrag := OnStartDragHandler;
  OnEndDrag := OnEndDragHandler;
...
function TdxNavBarPopupInnerControl.GetActualGroup(AGroup: TdxNavBarGroup): TdxNavBarGroup;
begin
  if not FMapper.MasterGroupMapping.TryGetValue(AGroup,  Result) then
    Result := nil;
end;

function TdxNavBarPopupInnerControl.GetActualGroupViewInfoByGroup(AGroup: TdxNavBarGroup): TdxNavBarGroupViewInfo;
begin
  Result := ViewInfo.GetGroupViewInfoByGroup(GetActualGroup(AGroup));
end;

function TdxNavBarPopupInnerControl.GetActualLink(ALink: TdxNavBarItemLink): TdxNavBarItemLink;
begin
  if ALink <> nil then
    Result := TdxNavBarItemLink(ALink.Data)
  else
    Result := nil;
end;

function TdxNavBarPopupInnerControl.GetActualLinkViewInfoByLink(ALink: TdxNavBarItemLink): TdxNavBarLinkViewInfo;
var
  ATargetLink: TdxNavBarItemLink;
begin
  Result := nil;
  if MasterItemLinkMapping.TryGetValue(ALink, ATargetLink) then
    Result := ViewInfo.GetLinkViewInfoByLink(ATargetLink);
end;

procedure TdxNavBarPopupInnerControl.UpdateData;
begin
  FMapper.PopulateCloneFromMaster;
end;

procedure TdxNavBarPopupInnerControl.UpdateOriginalData;
begin
  FMapper.UpdateMasterFromClone;
end;
...
procedure TdxNavBarPopupInnerControl.CreateNavBarDragObject(ADragObject: TDragObject);
begin
  dxNavBarDragObject := TdxInnerNavBarDragObject.Create(Self, ADragObject, FSourceGroup, FSourceLink, nil);
end;
...
begin
  ...
  begin
    AOriginalGroup := GroupMapping[ALink.Group];
    ALinkPosition := ALink.Position;
  end;

  if FMaster.Controller.NeedClosePopupControlsOnLinkClick then
  begin
    FMaster.Painter.Controller.InternalClosePopupControl;
    FMaster.Painter.Controller.InternalCloseOverlay;
  end;
  if AOriginalLink = nil then
...
function TdxNavBarPopupInnerControl.GetMapperClass: TdxNavBarCloneMapperClass;
begin
  Result := TdxNavBarCloneMapper;
end;

procedure TdxNavBarPopupInnerControl.DoCustomDrawBackground(Sender: TObject; ACanvas: TCanvas;
  AViewInfo: TdxNavBarViewInfo; var AHandled: Boolean);
begin
  FMaster.OnCustomDrawBackground(Self, ACanvas, AViewInfo, AHandled);
end;

procedure TdxNavBarPopupInnerControl.DoCustomDrawGroupCaption(Sender: TObject; ACanvas: TCanvas;
  AViewInfo: TdxNavBarGroupViewInfo; var AHandled: Boolean);
begin
  FMaster.OnCustomDrawGroupCaption(FMaster, ACanvas, AViewInfo, AHandled);
end;

procedure TdxNavBarPopupInnerControl.DoCustomDrawGroupClientBackground(Sender: TObject; ACanvas: TCanvas;
  AViewInfo: TdxNavBarGroupViewInfo; var AHandled: Boolean);
begin
  FMaster.OnCustomDrawGroupClientBackground(FMaster, ACanvas, AViewInfo, AHandled);
end;

procedure TdxNavBarPopupInnerControl.DoCustomDrawGroupClientForeground(Sender: TObject; ACanvas: TCanvas;
  AViewInfo: TdxNavBarGroupViewInfo; var AHandled: Boolean);
begin
  FMaster.OnCustomDrawGroupClientForeground(FMaster, ACanvas, AViewInfo, AHandled);
end;

procedure TdxNavBarPopupInnerControl.DoCustomDrawGroupHint(Sender: TObject; ACanvas: TCanvas;
  AGroup: TdxNavBarGroup; AHint: string; R: TRect; var AHandled: Boolean);
var
  AOriginalGroup: TdxNavBarGroup;
begin
  AOriginalGroup := FMapper.GroupMapping[AGroup];
  dxTestCheck(AOriginalGroup <> nil, 'OriginalGroup is nil');
  FMaster.OnCustomDrawGroupHint(FMaster, ACanvas, AOriginalGroup, AHint, R, AHandled);
end;

function TdxNavBarPopupInnerControl.GetGroupMapping: TDictionary<TdxNavBarGroup, TdxNavBarGroup>;
begin
  Result := FMapper.GroupMapping;
end;

function TdxNavBarPopupInnerControl.GetMasterGroupMapping: TDictionary<TdxNavBarGroup, TdxNavBarGroup>;
begin
  Result := FMapper.MasterGroupMapping;
end;

function TdxNavBarPopupInnerControl.GetMasterItemLinkMapping: TDictionary<TdxNavBarItemLink, TdxNavBarItemLink>;
begin
  Result := FMapper.MasterItemLinkMapping;
end;

procedure TdxNavBarPopupInnerControl.OnDragDropHandler(ASender, ASource: TObject; X, Y: Integer);
begin
  if Assigned(FMaster.OnDragDrop) then
    FMaster.OnDragDrop(FMaster, ASource, X, Y);
end;

procedure TdxNavBarPopupInnerControl.OnDragOverHandler(ASender, ASource: TObject; X, Y: Integer; AState: TDragState;
  var AAccept: Boolean);
begin
  if Assigned(FMaster.OnDragOver) then
    FMaster.OnDragOver(FMaster, ASource, X, Y, AState, AAccept);
end;

procedure TdxNavBarPopupInnerControl.OnEndDragHandler(ASender, ATarget: TObject; X, Y: Integer);
begin
  if Assigned(FMaster.OnEndDrag) then
    FMaster.OnEndDrag(FMaster, ATarget, X, Y);
end;

procedure TdxNavBarPopupInnerControl.OnStartDragHandler(ASender: TObject; var ADragObject: TDragObject);
begin
  if Assigned(FMaster.OnStartDrag) then
    FMaster.OnStartDrag(FMaster, ADragObject)
end;
...
class function TdxNavBarGroupPopupControlCalculator.CalculateBounds(AViewInfo: TdxNavBarViewInfo;
  AGroupViewInfoClass: TdxNavBarGroupViewInfoClass; AClientWidth: Integer; const ABorderOffsets: TRect): TRect;
var
  X, Y, AMaxHeight: Integer;
  AActiveGroupViewInfo: TdxNavBarGroupViewInfo;
begin
  AActiveGroupViewInfo := AGroupViewInfoClass.Create(AViewInfo.NavBar.ViewInfo,
    AViewInfo.Painter.Controller.SelectedPopupGroup, False, True);
  try
    X := 0;
    Y := 0;
...
begin
  Result := CalculateBounds(AViewInfo, AViewInfo.Painter.GetGroupViewInfoClass, AClientWidth, ABorderOffsets);
end;
...
procedure TdxNavBarActiveGroupMapper.CloneMasterData;
begin
  inherited CloneMasterData;
  NavBar.Groups.Add;
  FSavedPopupGroupExpanded := ActualPopupGroup.Expanded;
  CloneGroupChildren(ActualPopupGroup, NavBar.ActiveGroup);
  AssignGroupProperties(ActualPopupGroup, NavBar.ActiveGroup);
  NavBar.ActiveGroup.ShowCaption := False;
  NavBar.ActiveGroup.Expanded := True;
  if NavBar.Groups.Count > 0 then
    NavBar.TabStop := Master.TabStop and not (NavBar.Groups[0].UseControl and NavBar.Groups[0].ShowControl);
end;

procedure TdxNavBarActiveGroupMapper.DoUpdateMasterFromClone;
begin
  if not Master.IsDestroying and (ActualPopupGroup <> nil) then
  begin
    SynchronizeGroupChildren(NavBar.ActiveGroup, ActualPopupGroup);
    AssignGroupProperties(NavBar.ActiveGroup, ActualPopupGroup);
    ActualPopupGroup.Expanded := FSavedPopupGroupExpanded;
  end;
end;

function TdxNavBarActiveGroupMapper.GetActualPopupGroup: TdxNavBarGroup;
begin
  Result := Master.Painter.Controller.SelectedPopupGroup;
end;

{ TdxNavBarActiveGroupInnerControl }

constructor TdxNavBarActiveGroupInnerControl.Create(APopupControl: TdxNavBarCustomPopupControl);
begin
  inherited Create(APopupControl);
...
function TdxNavBarActiveGroupInnerControl.GetMapperClass: TdxNavBarCloneMapperClass;
begin
  Result := TdxNavBarActiveGroupMapper;
end;

procedure TdxNavBarActiveGroupInnerControl.DoMouseDown(AButton: TMouseButton; AShift: TShiftState; const APoint: TPoint);
begin
  if not ProcessMouseDown(AButton, APoint) then
    inherited DoMouseDown(AButton, AShift, APoint);
end;

procedure TdxNavBarActiveGroupInnerControl.DoMouseMove(AShift: TShiftState; const APoint: TPoint);
begin
  if not IsPtSizeGrip(APoint) then
    inherited DoMouseMove(AShift, APoint);
end;

function TdxNavBarActiveGroupInnerControl.ProcessMouseDown(AButton: TMouseButton; const APoint: TPoint): Boolean;
begin
...
procedure TdxNavBarNavigationPaneViewOptions.SetShowHeader(const AValue: Boolean);
begin
  if ShowHeader <> AValue then
  begin
    FShowHeader := AValue;
    NavBar.BeginUpdate;
...
procedure TdxNavBarNavigationPaneViewOptions.SetShowOverflowPanel(const AValue: Boolean);
begin
  if ShowOverflowPanel <> AValue then
  begin
    FShowOverflowPanel := AValue;
    NavBar.RecreateViewInfo;
  end;
end;
...
constructor TdxNavBarHamburgerMenuViewOptions.Create(ANavBar: TdxCustomNavBar);
begin
  inherited Create(ANavBar);
  FNavigationPaneMode := npmCompact;
  FChildLevelIndent := -1;
  FSpaceBetweenGroups := -1;
  FNavigationPaneUseSmallImages := True;
  FShowHeader := True;
  FShowOverflowPanel := True;
end;

procedure TdxNavBarHamburgerMenuViewOptions.Assign(Source: TPersistent);
var
  ASourceOptions: TdxNavBarHamburgerMenuViewOptions;
begin
  if Source is TdxNavBarHamburgerMenuViewOptions then
  begin
    ASourceOptions := TdxNavBarHamburgerMenuViewOptions(Source);
    ChildLevelIndent := ASourceOptions.ChildLevelIndent;
    ShowHeader := ASourceOptions.ShowHeader;
    ShowOverflowPanel := ASourceOptions.ShowOverflowPanel;
    NavigationPaneMode := ASourceOptions.NavigationPaneMode;
    SpaceBetweenGroups := ASourceOptions.SpaceBetweenGroups;
  end
  else
    inherited;
...
procedure TdxNavBarHamburgerMenuViewOptions.SetChildLevelIndent(const AValue: Integer);
begin
  if (FChildLevelIndent <> AValue) and (AValue >= -1) then
  begin
    FChildLevelIndent := AValue;
    NavBar.RecreateViewInfo;
  end;
end;

procedure TdxNavBarHamburgerMenuViewOptions.SetNavigationPaneMode(const AValue: TdxNavBarHamburgerMenuNavigationPaneMode);
begin
  if FNavigationPaneMode <> AValue then
  begin
    FNavigationPaneMode := AValue;
    NavBar.PerformWithAnimationLocking(procedure
      begin
        NavBar.RecreateViewInfo;
      end);
  end;
...
procedure TdxNavBarHamburgerMenuViewOptions.SetShowHeader(const AValue: Boolean);
begin
  if ShowHeader <> AValue then
  begin
    FShowHeader := AValue;
...
procedure TdxNavBarHamburgerMenuViewOptions.SetShowOverflowPanel(const AValue: Boolean);
begin
  if ShowOverflowPanel <> AValue then
  begin
    FShowOverflowPanel := AValue;
...
procedure TdxNavBarHamburgerMenuViewOptions.SetSpaceBetweenGroups(const AValue: Integer);
begin
  if (FSpaceBetweenGroups <> AValue) and (AValue >= -1) then
  begin
    FSpaceBetweenGroups := AValue;
    NavBar.Recalculate;
  end;
end;
...
begin
  ...
  FHamburgerMenu := TdxNavBarHamburgerMenuViewOptions.Create(ANavBar);
end;
...
begin
  ...
  begin
    ...
    FHamburgerMenu.Assign(ASourceOptions.HamburgerMenu);
  end
  else
    inherited;
end;
...
procedure TdxNavBarViewOptions.SetHamburgerMenu(AValue: TdxNavBarHamburgerMenuViewOptions);
begin
  if FHamburgerMenu <> AValue then
    FHamburgerMenu.Assign(AValue)
end;
...
begin
  ...
  begin
    ...
    RevealHighlight := ASourceOptions.RevealHighlight;
...
begin
  if FAllowExpandAnimation <> Value then
  begin
    FAllowExpandAnimation := Value;
    NavBar.Controller.DestroyPopupControls;
  end;
end;
...
procedure TdxNavBarCommonBehaviorOptions.SetRevealHighlight(Value: Boolean);
begin
  if FRevealHighlight <> Value then
  begin
    FRevealHighlight := Value;
    NavBar.Redraw;
  end;
end;
...
procedure TdxNavBarNavigationPaneBehaviorOptions.SetCollapsed(const AValue: Boolean);
begin
  if (FCollapsed <> AValue) and (not AValue or Collapsible or NavBar.IsLoading) then
  begin
    FCollapsed := AValue;
...
procedure TdxNavBarHamburgerMenuBehaviorOptions.Assign(Source: TPersistent);
var
  ASourceOptions: TdxNavBarHamburgerMenuBehaviorOptions;
begin
  if Source is TdxNavBarHamburgerMenuBehaviorOptions then
  begin
    ASourceOptions := TdxNavBarHamburgerMenuBehaviorOptions(Source);
    AllowCustomizing := ASourceOptions.AllowCustomizing;
    if not NavBar.IsInternal then
    begin
      Collapsed := ASourceOptions.Collapsed;
      DisplayMode := ASourceOptions.DisplayMode;
    end;
    SelectedGroupPopupMode := ASourceOptions.SelectedGroupPopupMode;
  end
  else
    inherited Assign(Source);
end;

function TdxNavBarHamburgerMenuBehaviorOptions.IsOverlayMode: Boolean;
begin
  Result := not NavBar.IsDesigning and (DisplayMode in [dmOverlay, dmOverlayMinimal]) and not NavBar.IsBoundsChecking;
end;

function TdxNavBarHamburgerMenuBehaviorOptions.GetCollapsed: Boolean;
begin
  if FIsOverlayVisible then
    Result := False
  else
    Result := FCollapsed;
end;

procedure TdxNavBarHamburgerMenuBehaviorOptions.SetOverlayVisible(const AValue: Boolean);
begin
  FIsOverlayVisible := AValue;
end;

procedure TdxNavBarHamburgerMenuBehaviorOptions.SetAllowCustomizing(const AValue: Boolean);
begin
  if FAllowCustomizing <> AValue then
  begin
...
procedure TdxNavBarHamburgerMenuBehaviorOptions.SetCollapsed(const AValue: Boolean);
var
  ACollapsed, AActualValue: Boolean;
begin
  if IsOverlayMode or not (IsOverlayMode or NavBar.ExpandAnimationController.Active) then
  begin
    ACollapsed := IsOverlayMode and not NavBar.IsLoading;

    AActualValue := ACollapsed or AValue;
    if FCollapsed <> AActualValue then
    begin
      FCollapsed := AActualValue;
      if not NavBar.IsLoading then
        NavBar.CollapseStateChanged;
    end;

    if ACollapsed and not NavBar.IsAnimationLocked then
    begin
      if AValue then
      begin
        FIsOverlayVisible := False;
        NavBar.Controller.InternalCloseOverlay
      end
      else
      begin
        FIsOverlayVisible := True;
        NavBar.Controller.InternalShowOverlay;
      end;
    end
  end;
end;

procedure TdxNavBarHamburgerMenuBehaviorOptions.SetDisplayMode(const AValue: TdxNavBarHamburgerMenuDisplayMode);

  function CanChangeMode: Boolean;
  begin
    Result := not NavBar.ExpandAnimationController.Active and (FDisplayMode <> AValue) and
      not ((AValue = dmOverlayMinimal) and not NavBar.Painter.InheritsFrom(TdxNavBarHamburgerMenuPainter));
  end;
  ...
  begin
    NavBar.PerformWithAnimationLocking(procedure
      begin
        ...
        try
          NavBar.Controller.DestroyPopupControls;
          if AValue in [dmOverlay, dmOverlayMinimal] then
            Collapsed := True;
        finally
          NavBar.EndUpdate;
        end;
    ...
    begin
      NavBar.BeginUpdate;
      try
        AHeight := IfThen(FDisplayMode = dmOverlayMinimal, Max(NavBar.OriginalHeight, NavBar.Height), NavBar.Height);
        if AValue = dmOverlayMinimal then
        begin
          NavBar.BeginResize;
          NavBar.OriginalHeight := NavBar.Height;
          AHeight := NavBar.ViewInfo.HeaderRect.Height;
        end;
        FDisplayMode := AValue;
        NavBar.Height := AHeight;
        NavBar.EndResize;
      finally
        NavBar.EndUpdate;
      end;
      ...
      FDisplayMode := AValue;
    NavBar.NotifyNavigationControlListeners([nchtBounds]);
  end;
end;

procedure TdxNavBarHamburgerMenuBehaviorOptions.SetSelectedGroupPopupMode(
  const AValue: TdxNavBarHamburgerMenuSelectedGroupPopupMode);
begin
  if FSelectedGroupPopupMode <> AValue then
  begin
    FSelectedGroupPopupMode := AValue;
    NavBar.Controller.DestroyPopupControls;
  end;
end;
...
begin
  ...
  FAccessibleObjects := TList<TdxNavBarCustomAccessibilityHelper>.Create;
  ...
  FNavigationControlListeners := TList<IdxFluentDesignNavigationControlListener>.Create;
  ...
  FExpandAnimationController := TdxNavBarInlineExpandAnimationController.Create(Self);
...
begin
  ...
  NavBarAccessibleObjectOwnerObjectDestroyed(FGroupContainerIAccessibilityHelper);
  ...
  FreeAndNil(FExpandAnimationController);
  ...
  FreeAndNil(FNavigationControlListeners);
...
begin
  ...
  if InRange(FActiveGroupIndex, 0, Groups.Count - 1) then
    InternalSetActiveGroup(Groups[FActiveGroupIndex]);
...
begin
  ...
  Controller.HotPart := dxNavBarPart(nbNone);
...
function TdxCustomNavBar.GetActualGroup(AGroup: TdxNavBarGroup): TdxNavBarGroup;
begin
  Result := AGroup;
end;

function TdxCustomNavBar.GetActualGroupViewInfoByGroup(AGroup: TdxNavBarGroup): TdxNavBarGroupViewInfo;
begin
  Result := ViewInfo.GetGroupViewInfoByGroup(AGroup);
end;

function TdxCustomNavBar.GetActualLinkViewInfoByLink(ALink: TdxNavBarItemLink): TdxNavBarLinkViewInfo;
begin
  Result := ViewInfo.GetLinkViewInfoByLink(ALink);
end;

procedure TdxCustomNavBar.DoCustomDrawBackground(Sender: TObject; ACanvas: TCanvas; AViewInfo: TdxNavBarViewInfo;
  var AHandled: Boolean);
begin
  OnCustomDrawBackground(Sender, ACanvas, AViewInfo, AHandled);
end;

procedure TdxCustomNavBar.DoCustomDrawGroupCaption(Sender: TObject; ACanvas: TCanvas; AViewInfo: TdxNavBarGroupViewInfo;
  var AHandled: Boolean);
begin
  OnCustomDrawGroupCaption(Sender, ACanvas, AViewInfo, AHandled);
end;

procedure TdxCustomNavBar.DoCustomDrawGroupClientBackground(Sender: TObject; ACanvas: TCanvas;
  AViewInfo: TdxNavBarGroupViewInfo; var AHandled: Boolean);
begin
  OnCustomDrawGroupClientBackground(Sender, ACanvas, AViewInfo, AHandled);
end;

procedure TdxCustomNavBar.DoCustomDrawGroupClientForeground(Sender: TObject; ACanvas: TCanvas;
  AViewInfo: TdxNavBarGroupViewInfo; var AHandled: Boolean);
begin
  OnCustomDrawGroupClientForeground(Sender, ACanvas, AViewInfo, AHandled);
end;

procedure TdxCustomNavBar.DoCustomDrawGroupHint(Sender: TObject; ACanvas: TCanvas;
  AGroup: TdxNavBarGroup; AHint: string; R: TRect; var AHandled: Boolean);
begin
  OnCustomDrawGroupHint(Sender, ACanvas, AGroup, AHint, R, AHandled);
end;
...
function TdxCustomNavBar.AllowCompositionPainting: Boolean;
begin
  Result := IsAcrylicEnabled or inherited AllowCompositionPainting;
end;
...
function TdxCustomNavBar.CanExpandAnimation: Boolean;
  ...
  begin
    ...
    begin
      AGroup := RootGroups[I];
      if AGroup.UseRestSpace or not ViewInfo.IsTopAlignment(AGroup) then
      begin
        Result := False;
        Break;
      end;
...
begin
  Result := not IsLoading and not IsUpdateLocked and OptionsBehavior.Common.AllowExpandAnimation and
    ViewInfo.AllowExpandAnimation and CheckGroupAlign and (ViewInfo.GroupCount > 0);
end;
...
begin
  ...
  begin
    ...
    try
      ...
      OriginalHeight := MulDiv(OriginalHeight, M, D);
...
procedure TdxCustomNavBar.CheckCollapseState;
  ...
  begin
    ANeedCollapse := Controller.Collapsed and not IsAlreadyCollapsed;
    ANeedExpand := not Controller.Collapsed and IsAlreadyCollapsed;
...
begin
  if Controller.Collapsed and not IsLoading then
...
procedure TdxCustomNavBar.DefineProperties(Filer: TFiler);
  ...
  begin
    Result := OptionsBehavior.HamburgerMenu.DisplayMode = dmOverlayMinimal;
    if Filer.Ancestor is TdxCustomNavBar then
      Result := Result and (OriginalHeight <> TdxCustomNavBar(Filer.Ancestor).OriginalHeight);
  end;

begin
  inherited DefineProperties(Filer);
  Filer.DefineProperty('OriginalWidth', ReadOriginalWidth, WriteOriginalWidth, NeedWriteOriginalWidth);
  Filer.DefineProperty('OriginalHeight', ReadOriginalHeight, WriteOriginalHeight, NeedWriteOriginalHeight);
end;
...
function TdxCustomNavBar.GetPaintBlackOpaqueOnGlass: Boolean;
begin
   Result := IsAcrylicEnabled or inherited GetPaintBlackOpaqueOnGlass;
end;
...
begin
  ...
  begin
    ...
    try
      ...
      if not FExpandAnimationController.Active then
...
procedure TdxCustomNavBar.ReadOriginalHeight(Reader: TReader);
begin
...
procedure TdxCustomNavBar.StopScrollAnimation;
begin
  ScrollBar.StopAnimation;
  ActiveGroupScrollBar.StopAnimation;
end;
...
procedure TdxCustomNavBar.WriteOriginalHeight(Writer: TWriter);
begin
...
function TdxCustomNavBar.FluentDesignNavigationControlIsAdaptable: Boolean;
begin
  Result := ViewReal = dxNavBarHamburgerMenu;
end;

function TdxCustomNavBar.FluentDesignNavigationControlIsCollapsed: Boolean;
begin
  Result := OptionsBehavior.HamburgerMenu.Collapsed;
end;

function TdxCustomNavBar.FluentDesignNavigationControlGetBackgroundColor: TdxAlphaColor;
begin
  Result := GetAcrylicBackgroundColor;
end;

function TdxCustomNavBar.FluentDesignNavigationControlGetBorderColor: TdxAlphaColor;
begin
  Result := Painter.GetAcrylicBorderColor;
end;

function TdxCustomNavBar.FluentDesignNavigationControlGetDisplayMode: TdxFluentDesignNavigationControlDisplayMode;
begin
  Result := TdxFluentDesignNavigationControlDisplayMode(OptionsBehavior.HamburgerMenu.DisplayMode);
end;

function TdxCustomNavBar.FluentDesignNavigationControlGetForegroundColor: TColor;
begin
  Result := Painter.GetAcrylicForegroundColor;
end;

function TdxCustomNavBar.FluentDesignNavigationControlGetAcrylicEnabled: Boolean;
begin
  Result := Painter.AllowAcrylicBackground;
end;

procedure TdxCustomNavBar.FluentDesignNavigationControlAddListener(AListener: IdxFluentDesignNavigationControlListener);
begin
  FNavigationControlListeners.Add(AListener);
end;

procedure TdxCustomNavBar.FluentDesignNavigationControlRemoveListener(AListener: IdxFluentDesignNavigationControlListener);
begin
  if FNavigationControlListeners <> nil then
    FNavigationControlListeners.Remove(AListener);
end;

procedure TdxCustomNavBar.FluentDesignNavigationControlSetDisplayMode(AValue: TdxFluentDesignNavigationControlDisplayMode);
var
  APreviousDisplayModeValue: TdxNavBarHamburgerMenuDisplayMode;
begin
  LockAnimation;
  try
    if AValue <> ncdmOverlayMinimal then
    begin
      if Align <> alLeft then
        Align := alLeft;
    end;
    APreviousDisplayModeValue := OptionsBehavior.HamburgerMenu.DisplayMode;
    if (AValue <> ncdmInline) and (APreviousDisplayModeValue = dmInline) then
      FPreviousCollapsedValue := OptionsBehavior.HamburgerMenu.Collapsed;
    OptionsBehavior.HamburgerMenu.DisplayMode := TdxNavBarHamburgerMenuDisplayMode(AValue);
    if (AValue = ncdmInline) and (APreviousDisplayModeValue <> dmInline) then
      OptionsBehavior.HamburgerMenu.Collapsed := FPreviousCollapsedValue;
    if OptionsBehavior.HamburgerMenu.DisplayMode = dmOverlayMinimal then
    begin
      if Align <> alTop then
        Align := alTop;
    end;
...
procedure TdxCustomNavBar.AcrylicHostControlChanged(AValue: IdxAcrylicHostControl; AHasAcrylicParent: Boolean);
var
  AValue2: IdxAcrylicHostControl2;
begin
  FAcrylicHostEnabled := AValue.IsAcrylic and AHasAcrylicParent;
  if FAcrylicHostEnabled then
    FAcrylicHostColor := AValue.GetAcrylicColor
  else
    FAcrylicHostColor := dxacNone;
  if Supports(AValue, IdxAcrylicHostControl2, AValue2) then
    FAcrylicBackgroundBlur := AValue2.GetBackgroundBlur;
  ResetAcrylicBackgroundColor;
end;

function TdxCustomNavBar.GetAcrylicAlphaValue: Byte;
begin
  Result := 200;
end;

function TdxCustomNavBar.GetAcrylicBackgroundColor: TdxAlphaColor;
var
  ABackgroundColor: TdxAlphaColor;
  A, R, G, B: Integer;
  AOverload: Single;
  ACompositionLayerAlpha, ABackOpacity: Byte;
begin
  if FAcrylicHostEnabled then
  begin
    if FAcrylicBackgroundColor = dxacNone then
    begin
      ACompositionLayerAlpha := GetAcrylicAlphaValue;
      ABackgroundColor := dxColorToAlphaColor(Painter.GetBackgroundColorForComposition);
      A := Trunc(255 * (ACompositionLayerAlpha - TdxAlphaColors.Alpha(FAcrylicHostColor)) / (255 - TdxAlphaColors.Alpha(FAcrylicHostColor)));
      ABackOpacity := TdxAlphaColors.Alpha(FAcrylicHostColor);
      R := Trunc((255 * TdxAlphaColors.R(ABackgroundColor) - TdxAlphaColors.R(FAcrylicHostColor) * ABackOpacity) / A);
      G := Trunc((255 * TdxAlphaColors.G(ABackgroundColor) - TdxAlphaColors.G(FAcrylicHostColor) * ABackOpacity) / A);
      B := Trunc((255 * TdxAlphaColors.B(ABackgroundColor) - TdxAlphaColors.B(FAcrylicHostColor) * ABackOpacity) / A);
      AOverload := Math.Max(Math.Max(R, G), B) / 255;
      if AOverload > 1 then
      begin
        R := Trunc(R / AOverload);
        G := Trunc(G / AOverload);
      ...
      FAcrylicBackgroundColor := TdxAlphaColors.FromArgb(Math.Max(0, Math.Min(255, A)), Math.Max(0, Math.Min(255, R)),
        Math.Max(0, Math.Min(255, G)), Math.Max(0, Math.Min(255, B)));
    end;
    Result := FAcrylicBackgroundColor;
  end
  else
    Result := dxColorToAlphaColor(Painter.GetBackgroundColorForComposition);
end;

function TdxCustomNavBar.GetAcrylicBackgroundBlur: TdxFluentDesignBackgroundBlur;
begin
  Result := FAcrylicBackgroundBlur;
end;

function TdxCustomNavBar.GetAcrylicHostColor: TdxAlphaColor;
begin
  Result := FAcrylicHostColor;
end;

function TdxCustomNavBar.IsAcrylicEnabled: Boolean;
begin
  Result := FAcrylicHostEnabled and FluentDesignNavigationControlGetAcrylicEnabled;
end;

procedure TdxCustomNavBar.NotifyNavigationControlListeners(AChanges: TdxFluentDesignNavigationControlChangeTypes);
var
  AListener: IdxFluentDesignNavigationControlListener;
begin
  if FNavigationControlListeners <> nil then
    for AListener in FNavigationControlListeners do
      AListener.Changed(AChanges);
end;

procedure TdxCustomNavBar.ResetAcrylicBackgroundColor;
begin
  FAcrylicBackgroundColor := dxacNone;
end;
...
begin
  ...
  PerformWithAnimationLocking(procedure
    begin
      Recalculate;
    end);
end;
...
begin
  if not IsCalculationLocked then
  begin
...
procedure TdxCustomNavBar.CreateNavBarDragObject(ADragObject: TDragObject);
begin
  dxNavBarDragObject := TdxNavBarDragObject.Create(Self, ADragObject {deprecated}, FSourceGroup, FSourceLink, nil);
end;
...
begin
  if dxNavBarDragObject = nil then
    CreateNavBarDragObject(DragObject);
...
begin
  Include(FInternalState, nbisAlreadyCollapsed);
  if not ExpandAnimationController.Active then
  begin
    DoCollapseStateChanged;
...
procedure TdxCustomNavBar.DrawContentWithChildren(ACanvas: TcxCanvas; const AOrigin: TPoint;
  AChangeExpandStateGroups: TList<TdxNavBarGroup>);
...
begin
  ...
  try
    ...
    begin
      ...
      if (AControl <> nil) and (Groups[I].Expanded or (AChangeExpandStateGroups <> nil) and (AChangeExpandStateGroups.IndexOf(Groups[I]) <> -1)) and
      ...
      begin
        ...
        begin
          ...
          cxPaintControlTo(Groups[I].Control, ACanvas, AGroupInfo.ControlRect.TopLeft,
            cxRectSetNullOrigin(AGroupInfo.ControlRect), True, True, False);
        end;
      end;
    end;
  finally
...
begin
  ...
  begin
    ...
    TcxBitmap32(ABitmap).Clear;
    TcxBitmap32(ABitmap).AlphaFormat := afPremultiplied;
  end
  else
    ABitmap := TcxBitmap.CreateSize(ABounds);
  try
    ACanvas := ABitmap.cxCanvas;
    ViewInfo.FBackgroundRect := ABounds;
    DrawContentWithChildren(ACanvas, ViewInfo.Groups[0].Rect.TopLeft, AChangeExpandStateGroups);
    FreeAndNil(AImage);
    AImage := TdxSmartImage.CreateFromBitmap(ABitmap);
  finally
    ABitmap.Free;
...
begin
  ...
  begin
    AGroupInfo := ViewInfo.GetGroupViewInfoByGroup(AGroup);
    if AGroupInfo = nil then
      Exit;
...
procedure TdxCustomNavBar.DoShowOverlayControl;
begin
  CallNotify(OnOverlayShowed, Self);
end;

procedure TdxCustomNavBar.DoShowPopupControl;
begin
  CallNotify(OnPopupShowed, Self);
end;
...
function TdxCustomNavBar.DoCanShowOverlay: Boolean;
begin
  Result := True;
  if Assigned(FOnOverlayShowing) then
    FOnOverlayShowing(Self, Result);
end;

function TdxCustomNavBar.DoCanShowPopupControl: Boolean;
begin
  Result := True;
  if Assigned(FOnPopupShowing) then
    FOnPopupShowing(Self, Result);
end;
...
function TdxCustomNavBar.IsExpandAnimationPreparing: Boolean;
begin
  Result := nbisPrepareExpandAnimation in FInternalState;
end;

procedure TdxCustomNavBar.Paint;
begin
  if not FExpandAnimationController.DrawAnimationBuffer(Canvas) then
    Painter.Paint;
end;
...
begin
  if not IsLoading and not IsDestroying and not IsCalculationLocked then
  begin
    if FPainter <> nil then
    begin
...
function TdxCustomNavBar.GetGroupContainerAccessibilityHelperClass: TdxNavBarCustomAccessibilityHelperClass;
begin
  Result := TdxNavBarGroupContainerAccessibilityHelper;
end;
...
function TdxCustomNavBar.IsAlreadyCollapsed: Boolean;
begin
  Result := nbisAlreadyCollapsed in FInternalState;
end;

function TdxCustomNavBar.IsAnimationLocked: Boolean;
begin
  Result := FAnimationLockCount <> 0;
end;

function TdxCustomNavBar.IsCalculationLocked: Boolean;
begin
  Result := FCalculationLockCount <> 0;
end;
...
function TdxCustomNavBar.IsResizing: Boolean;
begin
  Result := nbisResizing in FInternalState;
end;
...
procedure TdxCustomNavBar.LockAnimation;
begin
  Inc(FAnimationLockCount);
end;

procedure TdxCustomNavBar.BeginResize;
begin
  Include(FInternalState, nbisResizing);
end;

procedure TdxCustomNavBar.EndResize;
begin
  Exclude(FInternalState, nbisResizing);
end;

procedure TdxCustomNavBar.LockCalculation;
begin
  Inc(FCalculationLockCount);
end;

procedure TdxCustomNavBar.PerformWithAnimationLocking(AProc: TProc);
begin
  LockAnimation;
  try
...
procedure TdxCustomNavBar.Recalculate;
begin
  InvalidateAll(doRecalc);
end;

procedure TdxCustomNavBar.RecreateViewInfo;
begin
  InvalidateAll(doRecreate);
end;

procedure TdxCustomNavBar.Redraw;
begin
  InvalidateAll(doRedraw);
end;

procedure TdxCustomNavBar.UnlockCalculation;
begin
  Dec(FCalculationLockCount);
end;
...
function TdxCustomNavBar.TryGetPopupNavBar(out ANavBar: TdxCustomNavBar): Boolean;
begin
  ANavBar := Controller.GetPopupNavBar;
  Result := ANavBar <> nil;
end;
...
procedure TdxCustomNavBar.UnlockAnimation;
begin
  Dec(FAnimationLockCount);
  dxTestCheck(FAnimationLockCount >= 0, 'Invalid FAnimationLockCount');
end;
...
//
  if FIAccessibilityHelper = nil then
    FIAccessibilityHelper := NavBarGetAccessibilityHelper(GetAccessibilityHelperClass.Create(Self, Self));
  Result := FIAccessibilityHelper;
end;

function TdxCustomNavBar.GetGroupContainerIAccessibilityHelper: IdxNavBarAccessibilityHelper;
begin
  if FGroupContainerIAccessibilityHelper = nil then
    FGroupContainerIAccessibilityHelper := NavBarGetAccessibilityHelper(GetGroupContainerAccessibilityHelperClass.Create(Self, Self));
  Result := FGroupContainerIAccessibilityHelper;
end;
...
function TdxCustomNavBar.GetOnNavigationPaneCollapsed: TNotifyEvent;
begin
  Result := FOnCollapsed;
end;

function TdxCustomNavBar.GetOnNavigationPaneExpanded: TNotifyEvent;
begin
  Result := FOnExpanded;
end;

function TdxCustomNavBar.GetOnNavigationPanePopupShowed: TNotifyEvent;
begin
  Result := FOnPopupShowed;
end;

function TdxCustomNavBar.GetOnNavigationPanePopupShowing: TdxNavBarNavigationPaneShowingPopupEvent;
begin
  Result := FOnPopupShowing;
end;

procedure TdxCustomNavBar.SetOnNavigationPaneCollapsed(const Value: TNotifyEvent);
begin
  FOnCollapsed := Value;
end;

procedure TdxCustomNavBar.SetOnNavigationPaneExpanded(const Value: TNotifyEvent);
begin
  FOnExpanded := Value;
end;

procedure TdxCustomNavBar.SetOnNavigationPanePopupShowed(const Value: TNotifyEvent);
begin
  FOnPopupShowed := Value;
end;

procedure TdxCustomNavBar.SetOnNavigationPanePopupShowing(const Value: TdxNavBarNavigationPaneShowingPopupEvent);
begin
  FOnPopupShowing := Value;
end;
  ...
  if Value <> nil then
    PerformWithAnimationLocking(procedure
      begin
        ...
        FPainter := Value;
        FPainter.Initialize;
        OnCollapseStateChanged := Controller.CollapseStateChanged;
        RecreateScrollTimer;
        DoUpdateScrollBarStyle;
        if not IsLoading then
        begin
        ...
        NotifyNavigationControlListeners([nchtAppearance]);
      end);
end;
...
procedure TdxCustomNavBar.SetOnCustomDrawBackground(const Value: TdxNavBarCustomDrawEvent);
begin
  OnCustomDraw.Background := Value;
end;

procedure TdxCustomNavBar.SetOnCustomDrawBottomScrollButton(const Value: TdxNavBarCustomDrawEvent);
begin
  OnCustomDraw.BottomScrollButton := Value;
end;

procedure TdxCustomNavBar.SetOnCustomDrawGroupCaption(const Value: TdxNavBarCustomDrawGroupEvent);
begin
  OnCustomDraw.GroupCaption := Value;
end;

procedure TdxCustomNavBar.SetOnCustomDrawGroupClientBackground(const Value: TdxNavBarCustomDrawGroupEvent);
begin
  OnCustomDraw.GroupClientBackground := Value;
end;

procedure TdxCustomNavBar.SetOnCustomDrawGroupClientForeground(const Value: TdxNavBarCustomDrawGroupEvent);
begin
  OnCustomDraw.GroupClientForeground := Value;
end;

procedure TdxCustomNavBar.SetOnCustomDrawGroupHint(const Value: TdxNavBarCustomDrawGroupHintEvent);
begin
  OnCustomDraw.GroupHint := Value;
end;

procedure TdxCustomNavBar.SetOnCustomDrawLink(const Value: TdxNavBarCustomDrawLinkEvent);
begin
  OnCustomDraw.Link := Value;
end;

procedure TdxCustomNavBar.SetOnCustomDrawLinkHint(const Value: TdxNavBarCustomDrawLinkHintEvent);
begin
  OnCustomDraw.LinkHint := Value;
end;

procedure TdxCustomNavBar.SetOnCustomDrawNavigationPaneHeader(const Value: TdxNavBarCustomDrawEvent);
begin
  OnCustomDraw.NavigationPaneHeader := Value;
end;

procedure TdxCustomNavBar.SetOnCustomDrawNavigationPaneOverflowPanel(const Value: TdxNavBarCustomDrawEvent);
begin
  OnCustomDraw.NavigationPaneOverflowPanel := Value;
end;

procedure TdxCustomNavBar.SetOnCustomDrawNavigationPaneOverflowPanelHint(const Value: TdxNavBarCustomDrawGroupHintEvent);
begin
  OnCustomDraw.NavigationPaneOverflowPanelHint := Value;
end;

procedure TdxCustomNavBar.SetOnCustomDrawNavigationPaneSplitter(const Value: TdxNavBarCustomDrawEvent);
begin
...
begin
  if not Controller.AllowResize and not IsScaleChanging then
  begin
    AHeight := Height;
    AWidth := Width;
  end;
...
procedure TdxCustomNavBar.WMGetObject(var Message: TMessage);
var
  AObjectID: Cardinal;
begin
...
procedure TdxCustomNavBar.WMSetCursor(var Msg: TWMSetCursor);
  ...
  procedure DoSetCursor(ACursor: TCursor);
  begin
    FExpandAnimationCursor := ACursor;
    SetCursor(Screen.Cursors[FExpandAnimationCursor]);
  end;
  ...
  begin
    ...
    begin
      ...
      if FHotTrackedGroup <> nil then
        DoSetCursor(HotTrackedGroupCursor)
      else
        if HotTrackedLink <> nil then
          DoSetCursor(HotTrackedLinkCursor)
        else
          Result := False;
    end;
  end;
...
procedure TdxCustomNavBar.WMWindowPosChanged(var Message: TWMWindowPosChanged);
  ...
  begin
    Result := Message.WindowPos.Flags and (SWP_SHOWWINDOW or SWP_HIDEWINDOW) <> 0;
  end;

var
  AChanges: TdxFluentDesignNavigationControlChangeTypes;
begin
  AChanges := [];
  if IsPositionChanged or IsSizeChanged then
    Include(AChanges, nchtBounds);
  if IsVisibilityChanged then
    Include(AChanges, nchtVisibility);
  inherited;
  if AChanges <> [] then
    NotifyNavigationControlListeners(AChanges);
end;
...
function TdxCustomNavBar.HasOwnScrollbars: Boolean;
begin
  Result := True;
end;
...
begin
  cxCanvas.Font := AFont;
  AFlags := DT_CENTER or DT_VCENTER or DT_SINGLELINE or NavBar.DrawTextBiDiModeFlagsReadingOnly;
  if IsAcrylicEnabled then
  begin
    cxCanvas.Font.Color := AColor;
    dxDrawTextOnGlass(cxCanvas, AText, ARect, AFlags, True, raMinus90);
  end
  else
...
begin
  if not NavBar.IsUpdateLocked and NavBar.HandleAllocated then
  begin
    NavBar.LockCalculation;
    CheckViewInfo;
    NavBar.UnlockCalculation;
...
function TdxNavBarPainter.AllowAcrylicBackground: Boolean;
begin
  Result := False;
end;

function TdxNavBarPainter.GetAcrylicBackgroundColor: TdxAlphaColor;
begin
  Result := NavBar.GetAcrylicBackgroundColor;
end;

function TdxNavBarPainter.GetAcrylicBorderColor: TdxAlphaColor;
begin
  Result := dxacNone;
end;

function TdxNavBarPainter.GetAcrylicForegroundColor: TColor;
begin
  Result := clNone;
end;

function TdxNavBarPainter.GetBackgroundColorForComposition: TColor;
begin
  Result := clNone;
end;
...
procedure TdxNavBarPainter.Initialize;
begin
end;

function TdxNavBarPainter.IsAcrylicEnabled: Boolean;
begin
  Result := NavBar.IsAcrylicEnabled;
end;
...
function TdxNavBarPainter.UseHeaderCustomDrawing: Boolean;
begin
  Result := False;
end;
...
begin
  ...
  begin
    ...
    if IsAcrylicEnabled then
      dxDrawTextOnGlass(cxCanvas, AText, R, HeaderDrawEdgeFlag or DT_NOPREFIX, True)
    else
...
begin
  ...
  begin
    ...
    cxCanvas.SetClipRegion(TcxRegion.Create(ViewInfo.GroupsArea), roIntersect);
...
begin
  ...
  if Assigned(NavBar.OnCustomDrawBackground) then
    NavBar.DoCustomDrawBackground(NavBar, Canvas, ViewInfo, AHandled);
...
begin
  ...
  if Assigned(NavBar.OnCustomDrawGroupHint) then
    NavBar.DoCustomDrawGroupHint(NavBar, ACanvas, NavBar.HotTrackedGroup, ViewInfo.HintText, ARect, AHandled);
  if not AHandled then
...
begin
  ...
  if Assigned(NavBar.OnCustomDrawLinkHint) then
    NavBar.OnCustomDrawLinkHint(NavBar, ACanvas, NavBar.HotTrackedLink, ViewInfo.HintText, ARect, AHandled);
  if not AHandled then
    DoDrawHint(ACanvas, ARect);
end;
...
begin
  ...
  begin
    ...
    if Assigned(NavBar.OnCustomDrawGroupCaption) then
      NavBar.DoCustomDrawGroupCaption(NavBar, Canvas, AGroupViewInfo, AHandled);
    if not AHandled then
...
begin
  ...
  if IsAcrylicEnabled then
  begin
    Canvas.Font.Color := AGroupViewInfo.AcrylicForegroundColor;
    dxDrawTextOnGlass(cxCanvas, AGroupViewInfo.Group.Caption, AGroupViewInfo.CaptionTextRect,
      AGroupViewInfo.GetDrawEdgeFlag, True);
  end
  else
  begin
...
begin
  ...
  try
    if not NavBar.IsGroupExpanding then
      cxCanvas.IntersectClipRect(ViewInfo.GroupsArea);
    for I := 0 to ViewInfo.GroupCount - 1 do
...
begin
  ...
  if not AHandled then
  begin
    if Assigned(NavBar.OnCustomDraw.LinkSelection) then
      NavBar.OnCustomDraw.LinkSelection(NavBar, Canvas, ALinkViewInfo, AHandled);
    if not AHandled then
...
begin
  ...
  begin
    ...
    if IsAcrylicEnabled then
      dxDrawTextOnGlass(cxCanvas, Item.Caption, CaptionRect, GetDrawEdgeFlag or DT_END_ELLIPSIS, True)
    else
...
begin
  DrawSolidFocusRect(ALinkViewInfo.FocusRect, ALinkViewInfo.FontColor);
end;
...
begin
  ...
  begin
    ...
    if Assigned(NavBar.OnCustomDrawGroupClientBackground) then
      NavBar.DoCustomDrawGroupClientBackground(NavBar, Canvas, AGroupViewInfo, AHandled);
    if not AHandled then
    begin
      if not IsAcrylicEnabled then
  ...
  begin
    ...
    if Assigned(NavBar.OnCustomDrawGroupClientForeground) then
      NavBar.DoCustomDrawGroupClientForeground(NavBar, Canvas, AGroupViewInfo, AHandled);
    if not AHandled then
...
function TdxNavBarController.GetPartState(const APart: TdxNavBarPart): TdxNavBarPartState;
var
  AIAccessibilityHelpers: IdxNavBarAccessibilityHelper;
begin
  Result := oisNormal;
  if IsdxNavBarPartsEqual(DroppedDownPart, APart) or IsdxNavBarPartsEqual(PressedPart, APart)  then
    ...
    if IsdxNavBarPartsEqual(HotPart, APart) and IsdxNavBarPartsEqual(PressedPart, dxNavBarPart(nbNone)) then
      ...
      if (APart.MajorPartIndex in [nbHeaderSign, nbOverflowPanelSign, nbOverflowPanelItem]) then
      begin
        AIAccessibilityHelpers := ViewInfo.GetPartIAccessibilityHelper(APart);
        if (AIAccessibilityHelpers <> nil) and AIAccessibilityHelpers.IsFocused then
          Result := oisHot;
      end;
end;
...
procedure TdxNavBarController.CheckSize;
begin
  InternalCheckWidth;
  InternalCheckHeight;
end;
...
begin
  if (AWidth <> FNavBar.Width) and not FNavBar.ExpandAnimationController.Active then
    if Collapsed then
...
procedure TdxNavBarController.RequestAlign;
begin
// do nothing
end;
...
function TdxNavBarController.NeedClosePopupControlsOnLinkClick: Boolean;
begin
  Result := True;
end;

procedure TdxNavBarController.DestroyPopupControls;
begin
  if IsPopupControlExists then
    FreeAndNil(FPopupControl);
end;

function TdxNavBarController.GetActualNavBar: TdxCustomNavBar;
begin
  Result := NavBar;
  if IsPopupControlExists and IsPopupControlVisible then
    Result := PopupControl.FInnerControl;
end;

function TdxNavBarController.GetActualNavBar(AGroup: TdxNavBarGroup): TdxCustomNavBar;
begin
  Result := NavBar;
  if IsPopupControlExists and IsPopupControlVisible and
    TdxNavBarPopupInnerControl(PopupControl.FInnerControl).MasterGroupMapping.ContainsKey(AGroup) then
    Result := PopupControl.FInnerControl;
end;

function TdxNavBarController.GetCollapsed: Boolean;
begin
  if NavBar.IsExpandAnimationPreparing then
    Result := False
  else
    Result := not FNavBar.ExpandAnimationController.Active and GetRealCollapsed;
end;
...
function TdxNavBarController.GetPopupNavBar: TdxCustomNavBar;
begin
  if IsPopupControlExists and IsPopupControlVisible then
    Result := PopupControl.FInnerControl
  else
...
begin
  Result := (AGroup <> nil) and (AGroup = SelectedPopupGroup);
end;

function TdxNavBarController.NeedShowPopupControl: Boolean;
begin
  Result := FSelectedPopupGroup <> nil;
end;

procedure TdxNavBarController.InternalCloseOverlay;
begin
// do nothing
end;
...
procedure TdxNavBarController.InternalShowOverlay;
begin
// do nothing
end;
...
begin
  FSelectedPopupGroup := AGroup;
  if FSelectedPopupGroup = nil then
    FSelectedPopupGroup := NavBar.ActiveGroup;
...
function TdxNavBarController.AllowResize: Boolean;
begin
  Result := True;
end;

procedure TdxNavBarController.InternalCheckWidth;

  procedure SetSpecificWidth(AWidth: Integer);
  begin
    if IsWindowVisible(NavBar.Handle) and ViewInfo.UseControlExpandAnimation and
      not(NavBar.ExpandAnimationController.Active or NavBar.IsInternal) then
        NavBar.ExpandAnimationController.Animate(AWidth)
    else
...
begin
  if Collapsed then
  begin
    if NavBar.Width <> ViewInfo.GetNavBarCollapsedWidth then
      SetSpecificWidth(ViewInfo.GetNavBarCollapsedWidth)
  end
  else
    if NavBar.IsAlreadyCollapsed then
      SetSpecificWidth(NavBar.OriginalWidth)
    else
      if Collapsible and (NavBar.Width < ViewInfo.GetNavBarMinExpandedWidth) then
        SetSpecificWidth(ViewInfo.GetNavBarMinExpandedWidth);
end;

procedure TdxNavBarController.InternalCheckHeight;
begin
//  do nothing
end;

procedure TdxNavBarController.InternalSetWidth(const AValue: Integer);
begin
  NavBar.Width := AValue;
end;

function TdxNavBarController.GetRealCollapsed: Boolean;
begin
  Result := False;
end;
...
procedure TdxNavBarController.SetCollapsed(AValue: Boolean);
begin
// do nothing
end;
...
procedure TdxNavBarController.BeginDragging;
begin
  Include(NavBar.FInternalState, nbisDragging); 
end;

procedure TdxNavBarController.EndDragging;
begin
  Exclude(NavBar.FInternalState, nbisDragging);
end;
...
procedure TdxNavBarController.DoShowOverlayControl(Sender: TObject);
begin
  NavBar.DoShowOverlayControl;
end;
...
begin
  ...
  try
    ...
    GdipSetCompositingMode(AGpCanvas.Handle, CompositingModeSourceCopy);
...
constructor TdxNavBarCollapseStateAnimationController.Create(AControl: TdxCustomNavBar);
begin
  inherited Create;
  FControl := AControl;
  FGroupWithControlList := TList<TdxNavBarGroup>.Create;
end;

destructor TdxNavBarCollapseStateAnimationController.Destroy;
begin
  TerminateAnimation;
  FreeAndNil(FGroupWithControlList);
  inherited Destroy;
end;

function TdxNavBarCollapseStateAnimationController.GetAnimationEffect: TdxAnimationTransitionEffect;
begin
  if IsExpandMode then
    Result := ateExponential
  else
    Result := ateLinear;
end;

function TdxNavBarCollapseStateAnimationController.GetAnimationEffectMode: TdxAnimationTransitionEffectMode;
begin
  Result := atmOut
end;

function TdxNavBarCollapseStateAnimationController.GetAnimationTime: Cardinal;
begin
  if IsExpandMode then
    Result := GetExpandAnimationTime
  else
    Result := GetCollapseAnimationTime;
end;

function TdxNavBarCollapseStateAnimationController.GetCollapseAnimationTime: Cardinal;
begin
  Result := GetExpandAnimationTime div 2;
end;

procedure TdxNavBarCollapseStateAnimationController.ChangeGroupControlsVisibility(AVisible: Boolean);
var
  I: Integer;
begin
  for I := 0 to FGroupWithControlList.Count - 1 do
    FGroupWithControlList[I].ShowControl := AVisible;
end;

procedure TdxNavBarCollapseStateAnimationController.CheckState(AActive: Boolean);

  procedure CreateTransition(const ASourceRect, ATargetRect: TRect);
  begin
    FAnimationTransition := TdxRectAnimationTransition.Create(ASourceRect, ATargetRect, GetAnimationTime,
      GetAnimationEffect, GetAnimationEffectMode);
    FAnimationTransition.OnAnimate := OnAnimateHandler;
    FAnimationTransition.OnTerminate := OnTerminatedHandler;
  end;
...
begin
  ...
  begin
    FActive := AActive;
    AfterAnimation;
    FAnimationTransition := nil;
  end
  else
  begin
    CalculateBounds(ASourceRect, FTargetRect);
    CreateTransition(ASourceRect, FTargetRect);
    BeforeAnimation;
    FActive := AActive;
  end;
end;

procedure TdxNavBarCollapseStateAnimationController.HideGroupControls;
begin
  ChangeGroupControlsVisibility(False);
end;

procedure TdxNavBarCollapseStateAnimationController.PopulateGroupControlsList;

  procedure CheckGroup(AGroup: TdxNavBarGroup);
  var
    I: Integer;
  begin
    if AGroup.UseControl and AGroup.ShowControl then
      FGroupWithControlList.Add(AGroup)
    else
      for I := 0 to AGroup.ChildCount - 1 do
        if AGroup.Children[I] is TdxNavBarGroup then
          CheckGroup(TdxNavBarGroup(AGroup.Children[I]));
  end;

var
  I: Integer;
begin
  FGroupWithControlList.Clear;
  for I := 0 to Control.Groups.Count - 1 do
    CheckGroup(Control.Groups[I]);
end;

procedure TdxNavBarCollapseStateAnimationController.ShowGroupControls;
begin
  ChangeGroupControlsVisibility(True);
  FGroupWithControlList.Clear;
end;

function TdxNavBarCollapseStateAnimationController.GetClientRectOffset: TPoint;
begin
  Result := cxNullPoint;
end;

function TdxNavBarCollapseStateAnimationController.GetExpandAnimationTime: Cardinal;
begin
  Result := 250;
end;

procedure TdxNavBarCollapseStateAnimationController.AfterAnimation;
begin
  ShowGroupControls;
  Control.UnlockCalculation;
  Control.RecreateViewInfo;
  FreeAndNil(FBuffer);
  FCurrentBounds := cxNullRect;
  FCurrentAlpha := 0;
  FGroupWithControlList.Clear;
end;

procedure TdxNavBarCollapseStateAnimationController.BeforeAnimation;
begin
  DoPrepareBuffer;
end;

procedure TdxNavBarCollapseStateAnimationController.HandleAnimationStep;
begin
  FCurrentBounds := FAnimationTransition.CurrentRect;
end;

procedure TdxNavBarCollapseStateAnimationController.PrepareAnimationBuffer(AControl: TdxCustomNavBar);
begin
  FreeAndNil(FBuffer);
  FBuffer := TcxBitmap32.CreateSize(AControl.ViewInfo.ClientWidth, AControl.Height);
  FBuffer.Clear;
  AControl.DrawContentWithChildren(FBuffer.cxCanvas, cxNullPoint, nil);
end;

procedure TdxNavBarCollapseStateAnimationController.ResumeAnimationTransition;
begin
  AnimationTransition.Resume;
end;

function TdxNavBarCollapseStateAnimationController.AllowAnimation(AIsExpandMode: Boolean): Boolean;
begin
  Result := Control.ViewInfo.UseControlExpandAnimation;
end;

function TdxNavBarCollapseStateAnimationController.GetAnimationBufferRect: TRect;
begin
  Result := Control.ClientRect;
end;

procedure TdxNavBarCollapseStateAnimationController.HandleAnimationFinishStep;
var
  ASourceRect: TRect;
begin
  CalculateBounds(ASourceRect, FTargetRect);
...
procedure TdxNavBarCollapseStateAnimationController.DoPrepareBuffer;
begin
  PrepareAnimationBuffer(Control);
  Control.LockCalculation;
  PopulateGroupControlsList;
  HideGroupControls;
end;

procedure TdxNavBarCollapseStateAnimationController.InternalAnimate;
begin
  if AllowAnimation(IsExpandMode) then
  begin
    CheckState(True);
    ...
    HandleAnimationFinishStep;
end;

function TdxNavBarCollapseStateAnimationController.DrawAnimationBuffer(ACanvas: TcxCanvas): Boolean;
begin
  Result := Active;
  if Result then
    cxBitBlt(ACanvas.Handle, FBuffer.cxCanvas.Handle, cxRectOffset(GetAnimationBufferRect, GetClientRectOffset), cxNullPoint,
      SRCCOPY);
end;

procedure TdxNavBarCollapseStateAnimationController.TerminateAnimation;
begin
  if FAnimationTransition <> nil then
  begin
    FAnimationTransition.OnAnimate := nil;
    FAnimationTransition.OnTerminate := nil;
    FAnimationTransition.Terminate;
    FAnimationTransition := nil;
  end;
end;

procedure TdxNavBarCollapseStateAnimationController.OnAnimateHandler(Sender: TdxAnimationTransition;
  var APosition: Integer; var AFinished: Boolean);

  function GetAlphaBlendValue: Byte;
  var
    AValue, ALength: Integer;
  begin
    ALength := TdxAnimationTransitionAccess(AnimationTransition).Length;
    if ALength = 0 then
      ALength := 1;
    AValue := Trunc((255 * AnimationTransition.Position) / ALength);
    Result := IfThen(IsExpandMode, AValue, 255 - AValue);
  end;

begin
  FCurrentAlpha := GetAlphaBlendValue;
  HandleAnimationStep;
end;

procedure TdxNavBarCollapseStateAnimationController.OnTerminatedHandler(Sender: TObject);
begin
  CheckState(False);
end;
...
procedure TdxNavBarInlineExpandAnimationController.Animate(AWidth: Integer);
begin
  FSourceWidth := Control.ClientRect.Width;
  FTargetWidth := AWidth;
  InternalAnimate
end;

function TdxNavBarInlineExpandAnimationController.IsExpandMode: Boolean;
begin
  Result := FSourceWidth < FTargetWidth;
end;

procedure TdxNavBarInlineExpandAnimationController.CalculateBounds(var ASourceRect, ATargetRect: TRect);
begin
  ASourceRect := Control.Bounds;
  ATargetRect := ASourceRect;
  ATargetRect.Width := FTargetWidth;
end;

procedure TdxNavBarInlineExpandAnimationController.AfterAnimation;
begin
  if IsExpandMode then
    Control.DoNavigationPaneExpanded
  else
    Control.DoNavigationPaneCollapsed;
  inherited AfterAnimation;
  Control.UnlockBoundsChecking;
end;

procedure TdxNavBarInlineExpandAnimationController.BeforeAnimation;
begin
  inherited BeforeAnimation;
  Control.LockBoundsChecking;
end;

procedure TdxNavBarInlineExpandAnimationController.HandleAnimationFinishStep;
begin
  inherited HandleAnimationFinishStep;
  Control.Width := cxRectWidth(TargetRect);
end;

procedure TdxNavBarInlineExpandAnimationController.HandleAnimationStep;
begin
  inherited HandleAnimationStep;
  Control.Width := cxRectWidth(CurrentBounds);
  Control.Refresh;
end;

procedure TdxNavBarInlineExpandAnimationController.PrepareAnimationBuffer(AControl: TdxCustomNavBar);
begin
  Include(AControl.FInternalState, nbisPrepareExpandAnimation);
  try
    AControl.ViewInfo.CreateInfo;
    AControl.ViewInfo.CalculateBounds;
    inherited PrepareAnimationBuffer(AControl);
  finally
    Exclude(AControl.FInternalState, nbisPrepareExpandAnimation);
  end;
end;
...
begin
  ...
  begin
    ...
    begin
      ...
      ADropTargetInfo.Kind := GetDropKind(ATargetPoint, ARect, AForbiddenStates, IsTargetGroupVerticalLayout(ATargetPoint));
    ...
    begin
      ...
      if AGroupInfo.Infos.Count > 0 then
        if APoint.Y < AGroupInfo.Infos[0].Rect.Top then
          ...
          ADropTargetInfo.Position := AGroupInfo.Group.ChildCount
      else
        ADropTargetInfo.Position := 0;
    end;
  end;
...
function TdxNavBarDropInfoCalculator.IsTargetGroupVerticalLayout(const ATargetPoint: TPoint): Boolean;
begin
  Result := True;
end;
...
begin
  OffsetCaptionAndImageRects(dX, dY);
...
function TdxNavBarCustomItemViewInfo.HasImage: Boolean;
begin
...
function TdxNavBarCustomItemViewInfo.GetImageHeight: Integer;
begin
  Result := 0;
end;

function TdxNavBarCustomItemViewInfo.GetImageWidth: Integer;
begin
  Result := 0;
end;
...
procedure TdxNavBarCustomItemViewInfo.AdjustHeight(var AHeight: Integer);
begin
// nothing to do
end;

procedure TdxNavBarCustomItemViewInfo.CalcDesignRect(const ARect: TRect);
begin
  TdxNavBarItemCalculator.CalculateDesignRect(Self, ARect);
end;

procedure TdxNavBarCustomItemViewInfo.OffsetCaptionAndImageRects(dX, dY: Integer);
begin
...
constructor TdxNavBarChildCaptionViewInfo.Create(AGroupViewInfo: TdxNavBarGroupViewInfo);
begin
...
begin
  if GroupViewInfo.IsLinksUseSmallImages then
    Result := ViewInfo.GetSmallImageWidth(Self)
  else
    Result := ViewInfo.GetLargeImageWidth(Self);
end;
...
begin
  R := TdxRightToLeftLayoutConverter.ConvertRect(R, NavBar.ViewInfo.ClientRect);
end;
...
begin
  ...
  RecreatecxScrollBar;
  FScrollAnimationHelper := TdxNavBarScrollAnimationHelper.Create(Self);
end;

destructor TdxNavBarScrollBar.Destroy;
begin
  FreeAndNil(FScrollAnimationHelper);
...
procedure TdxNavBarScrollBar.UpdatePosition(AValue: Integer; AAnimated: Boolean);
begin
  if AAnimated then
    SetPositionAnimated(AValue)
  else
  begin
    Position := AValue;
    GetParent.InvalidateAll(doRecreate);
  end;
end;

procedure TdxNavBarScrollBar.CheckPosition(var APosition: Integer);
begin
  CorrectPos(APosition, Min, Max, PageSize);
end;
...
var
  APos: Integer;
begin
  if IsScrollAnimationActive then
    APos := FScrollAnimationHelper.TargetPosition
  else
    APos := Position;
  case AScrollCode of
    scLineUp: Dec(APos, SmallChange);
    scLineDown: Inc(APos, SmallChange);
    scPageUp: Dec(APos, LargeChange);
    scPageDown: Inc(APos, LargeChange);
    scPosition, scTrack: APos := AScrollPos;
    scTop: APos := Min;
    scBottom: APos := Max
  else
    APos := AScrollPos;
  end;
  if IsScrollAnimationActive and (AScrollCode in [scPosition, scTrack]) then
    StopAnimation;
  if GetParent.IsScrollAnimationEnabled and (AScrollCode in [scLineUp..scPageDown]) then
  begin
    SetPositionAnimated(APos);
    AScrollPos := Position;
  end
  else
  begin
...
procedure TdxNavBarScrollBar.UpdateAnimatedPosition(AValue: Integer);
begin
  Position := AValue;
...
function TdxNavBarScrollBar.IsScrollAnimationActive: Boolean;
begin
  Result := FScrollAnimationHelper.IsAnimationActive;
end;

procedure TdxNavBarScrollBar.SetPositionAnimated(AValue: Integer);
begin
  FScrollAnimationHelper.SetPosition(AValue);
end;

procedure TdxNavBarScrollBar.StopAnimation;
begin
  FScrollAnimationHelper.StopAnimation(False);
end;
...
procedure TdxNavBarScrollBar.DoScroll(AScrollCode: TScrollCode; var AScrollPos: Integer);
begin
...
function TdxNavBarGroupViewInfo.AcrylicForegroundColor: TColor;
begin
...
begin
  Result := ViewInfo.CanHasSignInGroupCaption;
end;
...
begin
  AGroupHeight := GetCaptionHeight;
  if ViewInfo.CanHasSignInGroupCaption then
    AGroupHeight := Max(AGroupHeight, ViewInfo.GetGroupCaptionSignSize.cy);
  FCaptionRect.Bottom := Y + AGroupHeight;
  FCaptionTextRect := FCaptionRect;
  FImageRect := FCaptionRect;
  InflateRect(FCaptionTextRect, GetTextEdges.X, GetTextEdges.Y);
...
begin
  TdxNavBarGroupCalculator.CalculateExpandButtonRect(Self);
end;
...
begin
  ...
  TdxNavBarGroupCalculator.CalculateFocusRect(Self);
  TdxNavBarGroupCalculator.CalculateClientRect(Self, X, Y);
  TdxNavBarGroupCalculator.CalculateItemsRect(Self);
...
function TdxNavBarGroupViewInfo.CreateLinkViewInfo(ALink: TdxNavBarItemLink;
  ACaptionVisible, AImageVisible: Boolean): TdxNavBarLinkViewInfo;
begin
  Result := Painter.CreateLinkViewInfo(Self, ALink, ACaptionVisible, AImageVisible);
end;
...
var
  ALinkInfo: TdxNavBarLinkViewInfo;
begin
  ALinkInfo := CreateLinkViewInfo(ALink, ACaptionVisible, AImageVisible);
...
function TdxNavBarGroupViewInfo.GetLevel: Integer;
begin
  Result := FLevel;
end;

function TdxNavBarGroupViewInfo.GetTextEdges: TPoint;
begin
  Result := cxPoint(-2, -1);
end;
...
function TdxNavBarGroupViewInfo.HasScrollBarInGroupCaption: Boolean;
begin
  Result := ViewInfo.HasClientAreaScrollbar and not NavBar.IsPopupScrollBars;
end;

{ TdxNavBarGroupCalculator }

class procedure TdxNavBarGroupCalculator.CalculateCaptionBounds(AGroupViewInfo: TdxNavBarGroupViewInfo; X, Y: Integer);

  function HasScrollButtonInGroupCaption: Boolean;
  var
    AActiveIndex, AIndex: Integer;
  begin
    AIndex := AGroupViewInfo.ViewInfo.IndexOfGroupViewInfo(AGroupViewInfo);
    AActiveIndex := AGroupViewInfo.ViewInfo.IndexOfGroupViewInfo(AGroupViewInfo.ViewInfo.ActiveGroupViewInfo);
    Result := AGroupViewInfo.ViewInfo.CanHasScrollButtonInGroupCaption and
      ((AIndex = AActiveIndex) or (AIndex = AActiveIndex + 1));
  end;

begin
  AGroupViewInfo.FCaptionRect.Left := X;
  AGroupViewInfo.FCaptionRect.Top := Y;
  AGroupViewInfo.FCaptionRect.Right := AGroupViewInfo.ViewInfo.ClientWidth - X;
  if AGroupViewInfo.HasScrollBarInGroupCaption then
    Dec(AGroupViewInfo.FCaptionRect.Right, AGroupViewInfo.ViewInfo.GetActiveGroupScrollBarWidth);
  if HasScrollButtonInGroupCaption then
    Dec(AGroupViewInfo.FCaptionRect.Right, AGroupViewInfo.GetCaptionHeight + 2);
  if AGroupViewInfo.IsCaptionCalculationNeeded then
    AGroupViewInfo.DoCalculateCaptionBounds(X, Y)
  else
    AGroupViewInfo.FCaptionRect.Bottom := AGroupViewInfo.FCaptionRect.Top;
  AGroupViewInfo.CalcDesignRect(AGroupViewInfo.CaptionRect);
end;

class procedure TdxNavBarGroupCalculator.CalculateExpandButtonRect(AGroupViewInfo: TdxNavBarGroupViewInfo);
var
  AGroupCaptionSignSize: TSize;
  ASignZone: TRect;
  ASignZoneWidth: Integer;
  AViewInfo: TdxNavBarViewInfo;
begin
  AViewInfo := AGroupViewInfo.ViewInfo;
  if AViewInfo.CanHasSignInGroupCaption then
  begin
    AGroupCaptionSignSize := AViewInfo.GetGroupCaptionSignSize;
    ASignZone := AGroupViewInfo.FCaptionRect;
    ASignZoneWidth := AGroupCaptionSignSize.cx + AGroupViewInfo.FCaptionRect.Height - AGroupCaptionSignSize.cy;
    ASignZone.Left := ASignZone.Right - ASignZoneWidth;
    AGroupViewInfo.FCaptionSignRect := cxRectCenter(ASignZone, AGroupCaptionSignSize);
    AGroupViewInfo.FCaptionTextRect.Right := ASignZone.Left;
  end
  else
    AGroupViewInfo.FCaptionSignRect := cxNullRect;
end;

class function TdxNavBarGroupCalculator.GetGroupCaptionSeparatorWidth(AGroupViewInfo: TdxNavBarGroupViewInfo): Integer;
begin
  Result := IfThen(AGroupViewInfo.IsTopLevel, AGroupViewInfo.ViewInfo.GetGroupCaptionSeparatorWidth);
end;

class procedure TdxNavBarGroupCalculator.CalculateClientRect(AGroupViewInfo: TdxNavBarGroupViewInfo; var X, Y: Integer);
var
  AClientHeight, AItemsRectBottom: Integer;
begin
  AGroupViewInfo.FRect.TopLeft := AGroupViewInfo.FCaptionRect.TopLeft;
  AGroupViewInfo.FRect.Right := AGroupViewInfo.ViewInfo.ClientWidth - X;
  if AGroupViewInfo.IsItemsVisible then
  begin
    if AGroupViewInfo.Control <> nil then
      AGroupViewInfo.FRect.Bottom := AGroupViewInfo.FCaptionRect.Bottom +
        Max(AGroupViewInfo.Control.OriginalHeight, AGroupViewInfo.Control.GetMinHeight) +
        AGroupViewInfo.GetBorderOffsets.Top + AGroupViewInfo.GetBorderOffsets.Bottom
    else
    begin
      if AGroupViewInfo.IsViewAsIconView then
        CalculateItemsAsIconView(AGroupViewInfo, X, Y, AItemsRectBottom)
      else
        CalculateItems(AGroupViewInfo, X, Y, AItemsRectBottom);
      AGroupViewInfo.FRect.Bottom := AItemsRectBottom + GetGroupCaptionSeparatorWidth(AGroupViewInfo);
    end;
  end
  else
    AGroupViewInfo.FRect.Bottom := AGroupViewInfo.FCaptionRect.Bottom;
  if AGroupViewInfo.Group.Expanded and Assigned(AGroupViewInfo.NavBar.OnCalcGroupClientHeight) then
  begin
    AClientHeight := cxRectHeight(AGroupViewInfo.FRect) - cxRectHeight(AGroupViewInfo.FCaptionRect);
    AGroupViewInfo.NavBar.OnCalcGroupClientHeight(AGroupViewInfo.NavBar, AGroupViewInfo, AClientHeight);
    AGroupViewInfo.FRect.Bottom := AGroupViewInfo.FRect.Top + AClientHeight + cxRectHeight(AGroupViewInfo.FCaptionRect);
  end;
end;

class procedure TdxNavBarGroupCalculator.CalculateFocusRect(AGroupViewInfo: TdxNavBarGroupViewInfo);
begin
  if AGroupViewInfo.IsFocused then
    AGroupViewInfo.FFocusRect := cxRectContent(AGroupViewInfo.CaptionRect, cxRect(2, 2, 2, 2))
  else
    SetRectEmpty(AGroupViewInfo.FFocusRect);
end;

class procedure TdxNavBarGroupCalculator.CalculateItems(AGroupViewInfo: TdxNavBarGroupViewInfo; var X, Y: Integer;
  out AItemsRectBottom: Integer);
var
  AItemStartX, AItemStartY, I: Integer;
  AItemViewInfo: TdxNavBarCustomItemViewInfo;
begin
  AItemsRectBottom := AGroupViewInfo.FCaptionRect.Bottom + GetGroupCaptionSeparatorWidth(AGroupViewInfo);
  AItemStartX := X;
  AItemStartY := AItemsRectBottom;
  for I := 0 to AGroupViewInfo.Infos.Count - 1 do
  begin
    AItemViewInfo := AGroupViewInfo.Infos[I];
    if AItemViewInfo is TdxNavBarLinkViewInfo then
      TdxNavBarLinkViewInfo(AItemViewInfo).CalculateBounds(AItemStartX, AItemStartY)
    else
      if AItemViewInfo is TdxNavBarChildGroupViewInfo then
        TdxNavBarChildGroupViewInfo(AItemViewInfo).CalculateBounds(AItemStartX, AItemStartY)
      else
        dxTestCheck(False, 'Unknown item class');
    AItemStartY := AItemViewInfo.Rect.Bottom;
    AItemsRectBottom := AItemStartY;
  end;
end;

class procedure TdxNavBarGroupCalculator.CalculateItemsAsIconView(AGroupViewInfo: TdxNavBarGroupViewInfo;
  var X, Y: Integer; out AItemsRectBottom: Integer);
var
  AItemStartX, AItemStartY, I: Integer;
  ALinkViewInfo: TdxNavBarLinkViewInfo;
begin
  ...
  begin
    ALinkViewInfo := AGroupViewInfo.Items[I] as TdxNavBarLinkViewInfo;
    ALinkViewInfo.CalculateBounds(AItemStartX, AItemStartY);
    if AGroupViewInfo.IsViewAsIconView then
    begin
      if (ALinkViewInfo.Rect.Right > AGroupViewInfo.FCaptionRect.Right) and (I > 0) then
      begin
        AItemStartX := X;
        AItemStartY := AGroupViewInfo.Items[I - 1].Rect.Bottom;
        ALinkViewInfo.CalculateBounds(AItemStartX, AItemStartY);
      end;
      AItemStartX := ALinkViewInfo.Rect.Right;
    end
    else
      AItemStartY := ALinkViewInfo.Rect.Bottom;
    AItemsRectBottom := ALinkViewInfo.Rect.Bottom;
  end
end;

class procedure TdxNavBarGroupCalculator.CalculateItemsRect(AGroupViewInfo: TdxNavBarGroupViewInfo);
begin
  AGroupViewInfo.FItemsRect.Left := AGroupViewInfo.FCaptionRect.Left;
  AGroupViewInfo.FItemsRect.Top := AGroupViewInfo.FCaptionRect.Bottom;
  AGroupViewInfo.FItemsRect.BottomRight := AGroupViewInfo.FRect.BottomRight;
  if AGroupViewInfo.HasScrollBar and not AGroupViewInfo.NavBar.IsPopupScrollBars then
    Dec(AGroupViewInfo.FItemsRect.Right, AGroupViewInfo.ViewInfo.GetActiveGroupScrollBarWidth);
end;

{ TdxNavBarChildGroupCaptionViewInfo }

procedure TdxNavBarChildGroupCaptionViewInfo.AdjustHeight(var AHeight: Integer);
begin
  OwnerGroupViewInfo.AdjustHeight(AHeight);
end;
...
function TdxNavBarChildGroupCaptionViewInfo.GetImageList: TCustomImageList;
begin
  Result := FOwnerGroupViewInfo.ImageList;
end;
...
function TdxNavBarChildGroupCaptionViewInfo.UseLargeImages: Boolean;
begin
  Result := FOwnerGroupViewInfo.UseLargeImages;
end;
...
function TdxNavBarChildGroupViewInfo.GetExpandButtonAreaRight: Integer;
begin
...
procedure TdxNavBarChildGroupViewInfo.AdjustHeight(var AHeight: Integer);
begin
  AHeight := Max(AHeight, GetExpandButtonSize.cy);
end;
...
begin
  ...
  begin
    ...
    AOffset := GetExpandButtonAreaRight;
...
function TdxNavBarDragObject.GetOriginalNavBar: TdxCustomNavBar;
begin
  Result := FNavBar;
end;

function TdxNavBarDragObject.GetOriginalSourceGroup: TdxNavBarGroup;
begin
  Result := SourceGroup;
end;

function TdxNavBarDragObject.GetOriginalSourceItem: TdxNavBarItem;
begin
  Result := SourceItem;
end;

function TdxNavBarDragObject.GetOriginalSourceLink: TdxNavBarItemLink;
begin
  Result := SourceLink;
end;

function TdxNavBarDragObject.GetOriginalTargetGroup: TdxNavBarGroup;
begin
  Result := TargetGroup;
end;
...
constructor TdxInnerNavBarDragObject.Create(ANavBar: TdxCustomNavBar; var DragObject: TDragObject;
  ASourceGroup: TdxNavBarGroup; ASourceLink: TdxNavBarItemLink; ASourceItem: TdxNavBarItem);
begin
  inherited Create(ANavBar, DragObject, ASourceGroup, ASourceLink, ASourceItem);
  FOriginalNavBar := (ANavBar as TdxNavBarPopupInnerControl).Master;
end;

function TdxInnerNavBarDragObject.GetOriginalNavBar: TdxCustomNavBar;
begin
  Result := FOriginalNavBar;
end;

function TdxInnerNavBarDragObject.GetOriginalSourceGroup: TdxNavBarGroup;
begin
  Result := GetMasterGroup(SourceGroup);
end;

function TdxInnerNavBarDragObject.GetOriginalSourceItem: TdxNavBarItem;
begin
  Result := SourceItem;
end;

function TdxInnerNavBarDragObject.GetOriginalSourceLink: TdxNavBarItemLink;
begin
  Result := GetMasterLink(SourceLink)
end;

function TdxInnerNavBarDragObject.GetOriginalTargetGroup: TdxNavBarGroup;
begin
  Result := GetMasterGroup(TargetGroup);
end;

function TdxInnerNavBarDragObject.GetMasterGroup(AGroup: TdxNavBarGroup): TdxNavBarGroup;
begin
  if not TdxNavBarPopupInnerControl(NavBar).GroupMapping.TryGetValue(AGroup, Result) then
    Result := nil;
end;

function TdxInnerNavBarDragObject.GetMasterLink(ALink: TdxNavBarItemLink): TdxNavBarItemLink;
begin
  Result := TdxNavBarPopupInnerControl(NavBar).GetActualLink(ALink);
end;

{ TdxNavBarScrollAnimationHelper }

constructor TdxNavBarScrollAnimationHelper.Create(AOwner: TdxNavBarScrollBar);
begin
  inherited Create;
  FOwner := AOwner;
end;

procedure TdxNavBarScrollAnimationHelper.CheckPosition(var AValue: Integer);
begin
  FOwner.CheckPosition(AValue);
end;

function TdxNavBarScrollAnimationHelper.GetOwnerPosition: Integer;
begin
  Result := FOwner.Position;
end;

procedure TdxNavBarScrollAnimationHelper.UpdateOwnerPosition(AValue: Integer);
begin
  FOwner.UpdateAnimatedPosition(AValue);
end;
...
begin
  ...
  begin
    ...
    LinkSelection := ASourceEvents.LinkSelection;
    ...
    HamburgerMenuHeader := ASourceEvents.HamburgerMenuHeader;
    HamburgerMenuNavigationPane := ASourceEvents.HamburgerMenuNavigationPane;
  end
  else
    inherited;
end;
...
const
  BorderStyleMap: array[Boolean] of TFormBorderStyle = (bsNone, bsSizeable);
...
begin
  ...
  dxAssignFont(Font, NavBar.Font, ScaleFactor, dxGetScaleFactor(NavBar));
  Color := clBtnFace;
...
begin
  ...
  FHamburgerMenu := TdxNavBarHamburgerMenuBehaviorOptions.Create(NavBar);
end;
...
procedure TdxNavBarBehaviorOptions.SetHamburgerMenu(AValue: TdxNavBarHamburgerMenuBehaviorOptions);
begin
  if FHamburgerMenu <> AValue then
    FHamburgerMenu.Assign(AValue);
end;
...
procedure TdxNavBarHeaderPanelSignAccessibilityHelper.DoDefaultAction(AChildID: TcxAccessibleSimpleChildElementID);
begin
  inherited;
  GetViewInfo.Painter.Controller.DoHeaderSignClick;
end;

function TdxNavBarHeaderPanelSignAccessibilityHelper.GetName(AChildID: TcxAccessibleSimpleChildElementID): string;
begin
  if (TdxNavBarOffice11NavPaneViewInfo(OwnerObject).Painter.Controller as TdxNavBarNavigationPaneController).Collapsed then
...
function TdxNavBarHeaderPanelSignAccessibilityHelper.GetRole(AChildID: TcxAccessibleSimpleChildElementID): Integer;
begin
...
function TdxNavBarHeaderPanelSignAccessibilityHelper.GetSupportedProperties(
...
function TdxNavBarHeaderPanelViewInfo.GetSignState: TdxNavBarPartState;
begin
...
class function TdxNavBarViewInfo.InternalGetLinkViewInfoAtSelectedPos(AViewInfo: TdxNavBarViewInfo;
  const pt: TPoint): TdxNavBarLinkViewInfo;
var
  ACaptionRect: TRect;
begin
  Result := AViewInfo.GetLinkViewInfoAtPos(pt);
  if (Result <> nil) and not Result.Link.CanSelect then
    Result := nil
  else
    if (Result <> nil) and not AViewInfo.CanSelectLinkByRect then
    begin
      ACaptionRect := Result.CaptionRect;
      if Result.GroupViewInfo.IsLinksUseSmallImages then
        if AViewInfo.NavBar.UseRightToLeftScrollBar then
...
begin
  Result := nil;
  if IsPtContentArea(pt) then
    Result := InternalGetLinkViewInfoAtSelectedPos(Self, pt);
end;
...
function TdxNavBarViewInfo.GetLargeImageHeight(AItemViewInfo: TdxNavBarCustomItemViewInfo): Integer;
begin
...
function TdxNavBarViewInfo.GetLargeImageWidth(AItemViewInfo: TdxNavBarCustomItemViewInfo): Integer;
begin
...
function TdxNavBarViewInfo.GetSmallImageHeight(AItemViewInfo: TdxNavBarCustomItemViewInfo): Integer;
begin
...
function TdxNavBarViewInfo.GetSmallImageWidth(AItemViewInfo: TdxNavBarCustomItemViewInfo): Integer;
begin
...
function TdxNavBarViewInfo.IsTopAlignment(AGroup: TdxNavBarGroup): Boolean;
begin
  Result := AGroup.Align = cxClasses.vaTop;
end;
...
function TdxNavBarViewInfo.ClientRect: TRect;
begin
  Result := NavBar.ClientRect;
  if NavBar.IsExpandAnimationPreparing then
    Result.Width := NavBar.FOriginalWidth;
end;
...
function TdxNavBarViewInfo.GetBackgroundRect: TRect;
begin
  if NavBar.IsGroupExpanding then
    Result := FBackgroundRect
  else
    Result := ClientRect;
end;
...
function TdxNavBarViewInfo.GetGroupsArea: TRect;
begin
  Result := ClientRect;
  if IsHeaderVisible then
    Result.Top := HeaderRect.Bottom;
end;
...
function TdxNavBarViewInfo.GetGroupAccessibilityHelperClass: TdxNavBarCustomAccessibilityHelperClass;
begin
  Result := TdxNavBarGroupAccessibilityHelper;
end;

function TdxNavBarViewInfo.GetGroupCaptionPanelAccessibilityHelperClass: TdxNavBarCustomAccessibilityHelperClass;
begin
...
function TdxNavBarViewInfo.AllowControlExpandAnimation: Boolean;
begin
  Result := False;
end;
...
function TdxNavBarViewInfo.UseControlExpandAnimation: Boolean;
begin
  Result := not NavBar.IsDesigning and not NavBar.IsAnimationLocked  and
    Navbar.OptionsBehavior.Common.AllowExpandAnimation and AllowControlExpandAnimation;
end;
...
function TdxNavBarViewInfo.GetOverflowPanelHeight: Integer;
begin
  Result := 0;
end;

procedure TdxNavBarViewInfo.CalculateGroups(X, Y: Integer);
var
  I: Integer;
begin
  for I := 0 to GroupCount - 1 do
...
function TdxNavBarViewInfo.GetDefaultOverflowPanelBitmap: TBitmap;
begin
...
function TdxNavBarViewInfo.GetPartIAccessibilityHelper(const APart: TdxNavBarPart): IdxNavBarAccessibilityHelper;
begin
...
begin
  Result := PtInRect(GroupsArea, pt) and not (IsPtBottomScrollButton(pt) or IsPtTopScrollButton(pt));
end;
...
begin
  ...
  if not (sDisabled in TopScrollButtonState) then
    Result := GetScrollButtonRect(TcxAlignmentVert.vaTop);
end;
...
begin
  ...
  OffSetRect(Result, -GetScrollButtonHorizontalEdge, IfThen(APosition = TcxAlignmentVert.vaTop, 1, -1) * GetScrollButtonVerticalEdge);
end;
...
begin
  ...
  begin
    Result := GetScrollButtonRect(TcxAlignmentVert.vaBottom);
...
function TdxNavBarViewInfo.GetHeaderSignRect: TRect;
begin
  Result := HeaderPanelViewInfo.SignRect;
end;
...
class procedure TdxNavBarItemCalculator.CalculateBounds(X, Y: Integer; AScaleFactor: TdxScaleFactor; var AItemViewInfo);
var
  ARightPosition: Integer;
  ACaptionViewInfo: TdxNavBarChildCaptionViewInfo;
begin
  ACaptionViewInfo := TdxNavBarChildCaptionViewInfo(AItemViewInfo);
  ...
  begin
    ...
    if HasScrollBar(ACaptionViewInfo) then
...
class procedure TdxNavBarItemCalculator.CalculateDesignRect(AItemViewInfo: TdxNavBarCustomItemViewInfo;
  const ARect: TRect);
var
  ADesignArea: TRect;
begin
  if AItemViewInfo.NavBar.IsDesigning then
  begin
    ADesignArea := ARect;
    ADesignArea.Left := ADesignArea.Right - 20;
    AItemViewInfo.FDesignRect := cxRectCenter(ADesignArea, AItemViewInfo.GetDesignSelectorSize);
  end
  else
    AItemViewInfo.FDesignRect := cxNullRect;
end;

class function TdxNavBarItemCalculator.HasScrollBar(ACaptionViewInfo: TdxNavBarChildCaptionViewInfo): Boolean;
begin
  Result := ACaptionViewInfo.GroupViewInfo.HasScrollBar and not ACaptionViewInfo.NavBar.IsPopupScrollBars;
end;

class procedure TdxNavBarItemCalculator.CalculateCaptionRect(ACaptionViewInfo: TdxNavBarChildCaptionViewInfo;
  ALeft, ATop, ARightPosition: Integer);
var
  ARect: TRect;
begin
  with ACaptionViewInfo do
  begin
...
class function TdxNavBarItemCalculator.CalculateFocusRect(const ARect, ATextRect: TRect): TRect;
begin
  cxRectIntersect(Result, ARect, cxRectInflate(ATextRect, 2, 0, 2, 0))
end;

class procedure TdxNavBarItemCalculator.CalculateFocusRect(AItemViewInfo: TdxNavBarCustomItemViewInfo);
begin
  CalculateFocusRect(AItemViewInfo, AItemViewInfo.Rect, AItemViewInfo.CaptionRect);
end;

class procedure TdxNavBarItemCalculator.CalculateFocusRect(AItemViewInfo: TdxNavBarCustomItemViewInfo;
  const ARect, ATextRect: TRect);
begin
  if AItemViewInfo.IsFocused then
    AItemViewInfo.FFocusRect := CalculateFocusRect(ARect, ATextRect)
  else
    SetRectEmpty(AItemViewInfo.FFocusRect);
end;

class procedure TdxNavBarItemCalculator.CalculateImageRect(ACaptionViewInfo: TdxNavBarChildCaptionViewInfo;
  ALeft, ATop: Integer);
begin
  ACaptionViewInfo.FImageRect := cxRectBounds(ALeft, ATop, ACaptionViewInfo.GetImageWidth,
    ACaptionViewInfo.GetImageHeight);
end;

class procedure TdxNavBarItemCalculator.CalculateLargeBounds(ACaptionViewInfo: TdxNavBarChildCaptionViewInfo;
  X, Y, ARightPosition: Integer);
var
  ALeft, AWidth: Integer;
begin
  CalculateLeftPosition(ACaptionViewInfo, X, ALeft);
  CalculateImageRect(ACaptionViewInfo, ALeft, Y + ACaptionViewInfo.ViewInfo.GetLinksLargeSeparatorWidth div 2);
  CalculateCaptionRect(ACaptionViewInfo, ALeft + 1,
    ACaptionViewInfo.FImageRect.Bottom + ACaptionViewInfo.ViewInfo.GetLinksImageEdges.Bottom, ARightPosition - 1);
  CalculateRect(ACaptionViewInfo, ALeft, Y, ARightPosition,
    ACaptionViewInfo.CaptionRect.Bottom + ACaptionViewInfo.ViewInfo.GetLinksLargeSeparatorWidth div 2);
  AWidth := cxRectWidth(ACaptionViewInfo.Rect);
  OffsetRect(ACaptionViewInfo.FImageRect, (AWidth - cxRectWidth(ACaptionViewInfo.ImageRect)) div 2, 0);
  OffsetRect(ACaptionViewInfo.FCaptionRect, (AWidth - cxRectWidth(ACaptionViewInfo.CaptionRect)) div 2, 0);
end;

class procedure TdxNavBarItemCalculator.CalculateLeftPosition(ACaptionViewInfo: TdxNavBarChildCaptionViewInfo;
  X: Integer; out ALeft: Integer);
begin
  ALeft := X + ACaptionViewInfo.GroupViewInfo.Level * ACaptionViewInfo.ViewInfo.GetChildItemOffset;
end;

class procedure TdxNavBarItemCalculator.CalculateSmallBounds(ACaptionViewInfo: TdxNavBarChildCaptionViewInfo;
  X, Y, ARightPosition: Integer);
var
  ACaptionLeft, AHeight, ALeft: Integer;
begin
  CalculateLeftPosition(ACaptionViewInfo, X, ALeft);
  if ACaptionViewInfo.GetImageWidth <> 0 then
  begin
    CalculateImageRect(ACaptionViewInfo, ALeft + ACaptionViewInfo.ViewInfo.GetLinksImageEdges.Left, Y);
    ACaptionLeft := ACaptionViewInfo.FImageRect.Right + ACaptionViewInfo.ViewInfo.GetLinksImageEdges.Right;
  end
  else
  begin
    ACaptionViewInfo.FImageRect := cxNullRect;
    ACaptionLeft := ALeft + ACaptionViewInfo.ViewInfo.GetItemCaptionOffsets.Left;
  end;
  CalculateCaptionRect(ACaptionViewInfo, ACaptionLeft, Y, ARightPosition - 1);

  AHeight := Max(cxRectHeight(ACaptionViewInfo.ImageRect), cxRectHeight(ACaptionViewInfo.CaptionRect)) +
    ACaptionViewInfo.ViewInfo.GetLinksSmallSeparatorWidth;
  ACaptionViewInfo.AdjustHeight(AHeight);
  dxAdjustToTouchableSize(AHeight, ACaptionViewInfo.ScaleFactor);
  CalculateRect(ACaptionViewInfo, ALeft, Y, ARightPosition, Y + AHeight);
  AHeight := cxRectHeight(ACaptionViewInfo.Rect);
  if ACaptionViewInfo.GetImageWidth <> 0 then
    OffsetRect(ACaptionViewInfo.FImageRect, 0, (AHeight - cxRectHeight(ACaptionViewInfo.ImageRect)) div 2);
  OffsetRect(ACaptionViewInfo.FCaptionRect, 0, (AHeight div 2) - (cxRectHeight(ACaptionViewInfo.CaptionRect) div 2));
end;

class procedure TdxNavBarItemCalculator.CalculateRect(ACaptionViewInfo: TdxNavBarChildCaptionViewInfo;
  ALeft, ATop, ARight, ABottom: Integer);
begin
  ACaptionViewInfo.FRect := cxRect(ALeft, ATop, ARight, ABottom);
end;
...
begin
  ...
  if Painter.ViewInfo.GetExpandDirection = dirLeft then
    P.X := NavBar.ViewInfo.ClientRect.Right - NavBar.OriginalWidth;
...
begin
  ...
  try
    ...
    if FInnerControl.ViewInfo.GetExpandDirection = dirRight then
      FInnerControl.Left := PopupViewInfo.GetBorderOffsets.Left
    else
      FInnerControl.Left := PopupViewInfo.GetBorderOffsets.Right;
...
begin
  Result := TdxNavBarActiveGroupInnerControl.Create(Self);
end;
...
initialization
  ...
  dxRegisterCursor(dxNavBarDragCursor, HInstance, 'dxNavBarDragCursor');
  dxRegisterCursor(dxNavBarDragCopyCursor, HInstance, 'dxNavBarDragCopyCursor');
  dxRegisterCursor(dxNavBarLinksCursor, HInstance, 'dxNavBarLinksCursor');
  {$IFDEF DX_INITIALIZATION_LOGGING}TdxUnitSectionsLogger.InitializationFinished(dxThisUnitName, SysInit.HInstance);{$ENDIF}
finalization
  {$IFDEF DX_INITIALIZATION_LOGGING}TdxUnitSectionsLogger.FinalizationStarted(dxThisUnitName, SysInit.HInstance);{$ENDIF}
  dxUnregisterCursor(dxNavBarDragCursor);
  dxUnregisterCursor(dxNavBarDragCopyCursor);
  dxUnregisterCursor(dxNavBarLinksCursor);
