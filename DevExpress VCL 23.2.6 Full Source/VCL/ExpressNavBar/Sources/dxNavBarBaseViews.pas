...
uses
  ...
  dxNavBar, dxNavBarBase, dxNavBarCollns, dxNavBarStyles, dxNavBarCustomPainters, cxGeometry;
...
uses
  Math, cxGraphics, dxOffice11, cxContainer,
  dxNavBarViewsFact, dxNavBarGraphics, dxNavBarConsts, dxCore;

const
  dxThisUnitName = 'dxNavBarBaseViews';
  ...
  begin
    ...
    begin
      ...
      begin
        ...
        TdxNavBarAccess(NavBar).ActiveGroupScrollBar.UpdatePosition(
          TdxNavBarAccess(NavBar).ActiveGroupScrollBar.Position + ADisplacement, TdxNavBarAccess(NavBar).IsScrollAnimationEnabled);
      end
      else
...
class procedure TdxNavBarBaseScrollButtonsPainter.InternalDrawTopButton(ACanvas: TCanvas; ARect: TRect;
  AButtonPainterClass: TdxNavBarCustomButtonPainterClass; AColor1, AColor2: TColor; AAlphaBlend1, AAlphaBlend2: Byte;
  AGradientMode: TdxBarStyleGradientMode; ABorderColor: TColor; AState: TdxNavBarObjectStates;
  AScaleFactor: TdxScaleFactor);
var
  pt1, pt2, pt3: TPoint;
...
begin
  AButtonPainterClass.DrawButton(ACanvas, ARect, nil, AColor1, AColor2,
    AAlphaBlend2, AAlphaBlend2, AGradientMode, ABorderColor, AState, AScaleFactor);
...
class procedure TdxNavBarFlatButtonPainter.InternalDrawButton(ACanvas: TCanvas; ARect: TRect; APicture: TPicture;
