...
const
  dxThisUnitName = 'dxfmNavBarDsgnEditor';
...
begin
  DsgnWindow.nbPreview.BeginUpdate;
  DsgnWindow.nbPreview.View := NavBar.View;
  if DsgnWindow.nbPreview.View = dxNavBarHamburgerMenu then
    DsgnWindow.nbPreview.BorderStyle := bsNone
  else
    DsgnWindow.nbPreview.BorderStyle := bsSingle;
  ...
  DsgnWindow.nbPreview.EndUpdate;
end;
