...
uses
  Math, Classes, SysUtils, Generics.Defaults, Generics.Collections, dxPDFBase, dxJPX, dxGenerics;
...
type
  ...
  public
    ...
    function CreateAdaptiveTemplates(ALength: Integer): TdxIntegerList;
  end;
  ...
  strict private
    ...
    FReferredToSegments: TdxIntegerList;
  ...
  protected
    ...
    property ReferredToSegments: TdxIntegerList read FReferredToSegments;
  public
  ...
  public
    DataLength: Int64;
    Flags: Byte;
    ReferredToSegments: TdxIntegerList;
  ...
  strict private
    FAdaptiveTemplate: TdxIntegerList;
  protected
    function CreateAdaptiveTemplates(AGBAdaptiveTemplate: TdxIntegerList): TdxIntegerList; virtual; abstract;
    function GetInitialContext: Integer; virtual; abstract;

    property AdaptiveTemplate: TdxIntegerList read FAdaptiveTemplate;
    property InitialContext: Integer read GetInitialContext;
  public
    constructor Create(AImage: IdxJBIG2Image; AGBAdaptiveTemplate: TdxIntegerList); overload;
    destructor Destroy; override;

    class function CreateDecoder(AImage: IdxJBIG2Image; AGBAdaptiveTemplate: TdxIntegerList; AGBTemplate: Integer): TdxJBIG2TPGDONDecoder; overload;
  ...
  protected
    function CreateAdaptiveTemplates(AGBAdaptiveTemplate: TdxIntegerList): TdxIntegerList; override;
  ...
  strict private
    FAdaptiveTemplates: TdxIntegerList;
    ...
    FRefinementAdaptiveTemplates: TdxIntegerList;
  ...
  public
    ...
    constructor Create(AInfo: TdxJBIG2HeaderInfo; ADecoder: TdxJBIG2Decoder; ASymbolInstanceCount, ARefinementTemplate: Integer;
      AAt, ARAt: TdxIntegerList; AGlyphs: TList<IdxJBIG2Image>; AImage: IdxJBIG2Image); overload;
    destructor Destroy; override;

    procedure Process; override;

    function RefinementDecode(ADecoder: TdxJBIG2Decoder; AImage: IdxJBIG2Image; AAdaptiveTemplates: TdxIntegerList): IdxJBIG2Image;
  end;
  ...
  public
    constructor Create(AGlyph: IdxJBIG2Image; ADecoder: TdxJBIG2Decoder; ADx, ADy, ATemplate: Integer; AAt: TdxIntegerList; AImage: IdxJBIG2Image); overload;
    destructor Destroy; override;
  ...
  protected
    ...
    property AdaptiveTemplates: TdxIntegerList read FAdaptiveTemplates;
  ...
  public
    ...
    function CreateDecoder(AImage: IdxJBIG2Image; AAdaptiveTemplates: TdxIntegerList): TdxJBIG2GenericRegionDecoder;
  end;
  ...
  protected
    ...
    property RefinementAdaptiveTemplates: TdxIntegerList read FRefinementAdaptiveTemplates;
...
function TdxJBIG2StreamReader.CreateAdaptiveTemplates(ALength: Integer): TdxIntegerList;
var
  I: Integer;
begin
...
begin
  inherited Create;
  FReferredToSegments := TdxIntegerList.Create;
...
constructor TdxJBIG2TPGDONDecoder.Create(AImage: IdxJBIG2Image; AGBAdaptiveTemplate: TdxIntegerList);
begin
...
class function TdxJBIG2TPGDONDecoder.CreateDecoder(AImage: IdxJBIG2Image; AGBAdaptiveTemplate: TdxIntegerList;
...
var
  AImage: IdxJBIG2Image;
  AAdaptiveTemplate: TdxIntegerList;
...
function TdxJBIG2TPGDON0Decoder.CreateAdaptiveTemplates(AGBAdaptiveTemplate: TdxIntegerList): TdxIntegerList;
begin
  Result := TdxIntegerList.Create;
  Result.Add(-1);
  Result.Add(0);
...
function TdxJBIG2TPGDON1Decoder.CreateAdaptiveTemplates(AGBAdaptiveTemplate: TdxIntegerList): TdxIntegerList;
begin
  Result := TdxIntegerList.Create;
  Result.Add(-1);
  Result.Add(0);
...
function TdxJBIG2TPGDON2Decoder.CreateAdaptiveTemplates(AGBAdaptiveTemplate: TdxIntegerList): TdxIntegerList;
begin
  Result := TdxIntegerList.Create;
  Result.Add(-1);
  Result.Add(0);
...
function TdxJBIG2TPGDON3Decoder.CreateAdaptiveTemplates(AGBAdaptiveTemplate: TdxIntegerList): TdxIntegerList;
begin
  Result := TdxIntegerList.Create;
  Result.Add(-1);
  Result.Add(0);
...
constructor TdxJBIG2TextRegion.Create(AInfo: TdxJBIG2HeaderInfo; ADecoder: TdxJBIG2Decoder;
  ASymbolInstanceCount, ARefinementTemplate: Integer; AAt, ARAt: TdxIntegerList;
...
begin
  ...
  FAdaptiveTemplates := TdxIntegerList.Create;
  FAdaptiveTemplates.AddRange(AAt);

  FRefinementAdaptiveTemplates := TdxIntegerList.Create;
...
function TdxJBIG2TextRegion.RefinementDecode(ADecoder: TdxJBIG2Decoder; AImage: IdxJBIG2Image;
  AAdaptiveTemplates: TdxIntegerList): IdxJBIG2Image;
var
...
constructor TdxJBIG2RefinementRegion.Create(AGlyph: IdxJBIG2Image; ADecoder: TdxJBIG2Decoder;
  ADx, ADy, ATemplate: Integer; AAt: TdxIntegerList; AImage: IdxJBIG2Image);
begin
  inherited Create(AImage);
  FDecoderRef := ADecoder;
...
function TdxJBIG2GenericRegion.CreateDecoder(AImage: IdxJBIG2Image; AAdaptiveTemplates: TdxIntegerList): TdxJBIG2GenericRegionDecoder;
begin
  Result := nil;
  if FMMR then
    TdxPDFUtils.RaiseTestException;
...
begin
  inherited Create;
  ReferredToSegments := TdxIntegerList.Create;
  if AInfo <> nil then
  begin
