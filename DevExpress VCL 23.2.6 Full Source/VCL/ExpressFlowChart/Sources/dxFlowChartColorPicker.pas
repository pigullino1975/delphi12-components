...
uses
  Classes, Graphics, cxGraphics, dxColorDialog, dxBar, dxRibbonGallery, Contnrs;
...
uses
  Windows, SysUtils, Types, Forms, cxGeometry, dxCoreGraphics, dxRibbonColorGallery;

const
  dxThisUnitName = 'dxFlowChartColorPicker';
...
begin
  ...
  FColorItem := BarDesignController.AddInternalItem(TdxRibbonColorGalleryInternalItem, AColorItem.BarManager, AColorItem.BarManager, FInternalItems) as TdxRibbonColorGalleryInternalItem;
...
begin
  ...
  begin
    ...
    AddColorItem(FCustomColorsGroup, AColor).Selected := True;
  end;
end;
