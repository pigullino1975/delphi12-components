...
uses
  ...
  cxImageList, cxClasses, dxColorDialog, cxGeometry, dxBar, dxFcEdit, dxShellDialogs;
  ...
  try
    ...
    for i := 0 to Buf.Count - 1 do
      ...
      begin
        ...
        ObjAssign(TdxFcObject(TBufferItem(Buf.Items[i]).Obj), AObj);
    ...
    for i := 0 to Buf.Count - 1 do
      ...
      begin
        ...
        ConAssign(TdxFcConnection(TBufferItem(Buf.Items[i]).Obj), ACon);
