...
resourcestring
  ...
  sdxFlowChartEditorDesignConnectors = 'Connectors';
  sdxFlowChartEditorDesignSnapToGrid = 'Snap To Grid';
  sdxFlowChartEditorDesignLayeredLayout = 'Apply Layered Layout';
  sdxFlowChartEditorEdit = '&Edit';
  sdxFlowChartEditorEditBackground = 'Background';
  sdxFlowChartEditorEditBringToFront = 'Bring To &Front';
  sdxFlowChartEditorEditClearSelection = 'Cl&ear Selection';
  sdxFlowChartEditorEditCloseAndApplyChanges = 'Close And Apply Changes';
  sdxFlowChartEditorEditCopy = '&Copy';
  sdxFlowChartEditorEditConnector = 'Connectors';
  ...
  sdxFlowChartEditorEditStroke = 'Stroke';
  sdxFlowChartEditorEditUndo = '&Undo';
  sdxFlowChartEditorExitConfirmation = 'Do you want to apply the changes?';
  ...
  sdxFlowChartEditorNewConfirmation = 'The document you are about to close has unsaved changes. Do you want to save the document?';
  ...
  sdxFlowChartEditorShapes = 'Shapes';
  ...
  sdxFlowChartEditorViewGridLines = 'Grid';
...
begin
  ...
  AProduct.Add('sdxFlowChartEditorDesignSnapToGrid', @sdxFlowChartEditorDesignSnapToGrid);
  AProduct.Add('sdxFlowChartEditorDesignLayeredLayout', @sdxFlowChartEditorDesignLayeredLayout);

  AProduct.Add('sdxFlowChartEditorDesignConnectors', @sdxFlowChartEditorDesignConnectors);
  AProduct.Add('sdxFlowChartEditorEdit', @sdxFlowChartEditorEdit);
  AProduct.Add('sdxFlowChartEditorEditBackground', @sdxFlowChartEditorEditBackground);
  ...
  AProduct.Add('sdxFlowChartEditorEditCloseAndApplyChanges', @sdxFlowChartEditorEditCloseAndApplyChanges);
  AProduct.Add('sdxFlowChartEditorEditCopy', @sdxFlowChartEditorEditCopy);
  AProduct.Add('sdxFlowChartEditorEditConnector', @sdxFlowChartEditorEditConnector);
  ...
  AProduct.Add('sdxFlowChartEditorEditStroke', @sdxFlowChartEditorEditStroke);
  AProduct.Add('sdxFlowChartEditorEditUndo', @sdxFlowChartEditorEditUndo);
  AProduct.Add('sdxFlowChartEditorExitConfirmation', @sdxFlowChartEditorExitConfirmation);
  ...
  AProduct.Add('sdxFlowChartEditorNewConfirmation', @sdxFlowChartEditorNewConfirmation);
  ...
  AProduct.Add('sdxFlowChartEditorShapes', @sdxFlowChartEditorShapes);
  ...
  AProduct.Add('sdxFlowChartEditorViewGridLines', @sdxFlowChartEditorViewGridLines);
