...
type
  ...
  protected
    ...
    function GetMenuItemChecked(AMenuItem: TObject): Boolean; overload;
    function GetMenuItemChecked(AMenuItemName: string): Boolean; overload;
...
function TfmBaseForm.GetMenuItemChecked(AMenuItemName: string): Boolean;
var
  AItem: TdxBaseMenuItem;
begin
  Result := FindMenuItem(AMenuItemName, AItem) and GetMenuItemChecked(AItem);
end;
