...
uses
  ...
  cxImageComboBox, DemoUtils, dxShellDialogs;
...
type
  TCustomDrawTableViewDemoStylesEditorForm = class(TForm)
    ...
    procedure icbIndicatorImagesPropertiesEditValueChanged(Sender: TObject);
    procedure tvCustomDrawItemsKeyUp(Sender: TObject; var Key: Word; Shift: TShiftState);
  private
    ...
    procedure UpdateSettingsVisibility;
  end;
...
procedure TCustomDrawTableViewDemoStylesEditorForm.UpdateSettingsVisibility;
...
procedure TCustomDrawTableViewDemoStylesEditorForm.tvCustomDrawItemsClick(Sender: TObject);
begin
  UpdateSettingsVisibility;
end;

procedure TCustomDrawTableViewDemoStylesEditorForm.tvCustomDrawItemsKeyUp(
