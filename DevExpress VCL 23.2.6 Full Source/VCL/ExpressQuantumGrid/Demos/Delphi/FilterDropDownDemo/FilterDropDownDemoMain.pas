...
uses
  ...
  cxGridDBTableView, CarsDataForGrid, MidasLib, dxDateRanges, dxFilterPopupWindow,
...
begin
  ...
  TableView.DataController.Filter.AddItem(nil, TableViewPrice, foGreaterEqual, AEditValue, ADisplayText);
  AEditValue := 55000;
  ADisplayText := TableViewPrice.Properties.GetDisplayText(AEditValue);
  TableView.DataController.Filter.AddItem(nil, TableViewPrice, foLessEqual, AEditValue, ADisplayText);
  AList := TableView.DataController.Filter.Root.AddItemList(fboOr);
  TableView.DataController.Filter.AddItem(AList, TableViewSalesDate, foLastYear, Null, '');
  TableView.DataController.Filter.AddItem(AList, TableViewSalesDate, foThisYear, Null, '');
