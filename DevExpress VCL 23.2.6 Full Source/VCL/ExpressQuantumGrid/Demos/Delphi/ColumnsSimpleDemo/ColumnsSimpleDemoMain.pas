...
type
  TColumnsSimpleDemoMainForm = class(TfmBaseForm)
    ...
    procedure miHotTrackSelectionClick(Sender: TObject);
  private
...
begin
  ...
  MenuItemSetChecked('miHotTrack', View.OptionsBehavior.HotTrack);
  MenuItemSetChecked('miHotTrackSelection', View.OptionsBehavior.HotTrackSelection);
end;
  ...
  case AButtonIndex of
    0: if ColumnsSimpleDemoCitiesForm.ShowModal = mrOk then
       begin
         ...
         ColumnsSimpleDemoDataDM.tblCustomersCity.AsString := ColumnsSimpleDemoCitiesForm.Value;
       end;
    1:
...
procedure TColumnsSimpleDemoMainForm.miHotTrackSelectionClick(Sender: TObject);
begin
  View.OptionsBehavior.HotTrackSelection := not View.OptionsBehavior.HotTrackSelection;
  UpdateMenu;
end;
...
procedure TColumnsSimpleDemoMainForm.miHotTrackClick(Sender: TObject);
begin
  View.OptionsBehavior.HotTrack := not View.OptionsBehavior.HotTrack;
  UpdateMenu;
end;
