...
void __fastcall TColumnsSimpleDemoMainForm::UpdateMenu()
{
  ...
  miHotTrack->Checked = View->OptionsBehavior->HotTrack;
  miHotTrackSelection->Checked = View->OptionsBehavior->HotTrackSelection;
}
//---------------------------------------------------------------------------
...
void __fastcall TColumnsSimpleDemoMainForm::miHotTrackClick(TObject *Sender)
{
  View->OptionsBehavior->HotTrack = !View->OptionsBehavior->HotTrack;
  UpdateMenu();
}
//---------------------------------------------------------------------------

void __fastcall TColumnsSimpleDemoMainForm::miHotTrackSelectionClick(TObject *Sender)
{
  View->OptionsBehavior->HotTrackSelection = !View->OptionsBehavior->HotTrackSelection;
  UpdateMenu();
}
//---------------------------------------------------------------------------
