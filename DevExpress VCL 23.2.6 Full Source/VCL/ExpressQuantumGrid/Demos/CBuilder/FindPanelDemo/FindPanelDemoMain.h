...
__published: // IDE-managed Components
	...
	TStringField* cdsCustomersCustomerID;
	...
	TcxCheckBox* cbUseExtendedSyntax;
        TcxCheckBox* cbShowPrevAnNextButtons;
        TcxComboBox* cbeBehavior;
        TcxLabel* cxLabel1;
        TcxCheckBox* cbSearchInGroupRows;
        TcxCheckBox* cbSearchPreview;
	TMenuItem* UseExtendedSyntax1;
        TAction* actShowPrevAndNextButtons;
        TAction* actSearchInGroupRows;
        TAction* actSearchInPreview;
	TcxGrid* Grid;
	TcxGridDBTableView* TableView;
	TcxGridDBColumn* TableViewCompanyName;
	TcxGridDBColumn* TableViewContactName;
	TcxGridDBColumn* TableViewContactTitle;
	TcxGridDBColumn* TableViewCity;
	TcxGridDBColumn* TableViewCountry;
	TcxGridDBColumn* TableViewAddress;
	TcxGridLevel* GridLevel1;
	TcxComboBox* cbLocation;
	TcxLabel* cxLabel2;
	TcxComboBox* cbLayout;
	TcxLabel* cxLabel3;
	...
	void __fastcall cbeBehaviorPropertiesChange(TObject* Sender);
	...
	void __fastcall actShowPrevAndNextButtonsExecute(TObject* Sender);
	void __fastcall actSearchInGroupRowsExecute(TObject* Sender);
	void __fastcall actSearchInPreviewExecute(TObject* Sender);
	void __fastcall cbLocationPropertiesEditValueChanged(TObject* Sender);
	void __fastcall cbLayoutPropertiesEditValueChanged(TObject* Sender);
