inherited frmMain: TfrmMain
  ...
  inherited mmMain: TMainMenu
    ...
    object miFilterPopup: TMenuItem [1]
      ...
      object miCriteriaDisplayStyle: TMenuItem
        Caption = 'Criteria Display Style'
        object miCriteriaDisplayStyleText: TMenuItem
          Action = acCriteriaDisplayStyleText
          AutoCheck = True
          GroupIndex = 6
          RadioItem = True
        end
        object miCriteriaDisplayStyleTokens: TMenuItem
          Action = acCriteriaDisplayStyleTokens
          AutoCheck = True
          GroupIndex = 6
          RadioItem = True
        end
  ...
  object alAction: TActionList
    ...
    object acCriteriaDisplayStyleText: TAction
      Category = 'FilterPopup'
      AutoCheck = True
      Caption = 'Text'
      GroupIndex = 6
      OnExecute = acCriteriaDisplayStyleExecute
    end
    object acCriteriaDisplayStyleTokens: TAction
      Category = 'FilterPopup'
      AutoCheck = True
      Caption = 'Tokens'
      Checked = True
