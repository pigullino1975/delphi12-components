...
__published:	// IDE-managed Components
  ...
  void __fastcall icbIndicatorImagesPropertiesEditValueChanged(TObject *Sender);
  void __fastcall tvCustomDrawItemsKeyUp(TObject *Sender, WORD &Key, TShiftState Shift);
