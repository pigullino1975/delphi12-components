...
__published:	// IDE-managed Components
	...
	TAction* actDetachedEditForm;
	TcxRadioButton* rbInplace;
	TcxRadioButton* rbInplaceEditForm;
	TcxRadioButton* rbInplaceEditFormHideCurrentRow;
	TcxRadioButton* rbDetachedEditForm;
	TMenuItem* miHotTrack;
	TAction* actHotTrack;
	TdxLayoutGroup* lcOptionsGroup_Root;
	TdxLayoutControl* lcOptions;
	TdxLayoutGroup* lgEditMode;
	TdxLayoutItem* liInplace;
	TdxLayoutItem* liModalEditForm;
	TdxLayoutGroup* dxLayoutGroup1;
	TdxLayoutItem* liInplaceEditForm;
	TdxLayoutItem* liInplaceEditFromHCR;
	TdxLayoutGroup* dxLayoutGroup2;
	TdxLayoutItem* liCustomizeEditFrom;
	...
	void __fastcall TableViewDetachedEditFormInitialize(TcxGridTableView *Sender, TForm *AForm);
