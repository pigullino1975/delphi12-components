...
type
  ...
  protected
    ...
    procedure RefreshEnabled; override;
...
const
  dxThisUnitName = 'cxGridLayoutViewCustomizationForm';
...
begin
  Result := ViewSupport.IsLayoutChangeable and (not GridView.IsDesigning or cbSaveLayout.Checked);
end;
...
procedure TcxGridLayoutViewCustomizationForm.RefreshEnabled;
begin
  inherited RefreshEnabled;
