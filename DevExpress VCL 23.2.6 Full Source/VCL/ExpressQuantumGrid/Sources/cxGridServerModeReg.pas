...
const
  dxThisUnitName = 'cxGridServerModeReg';
...
{$IFNDEF NONDB}
  ...
  UnlistPublishedProperty(TcxGridItemServerModeDataBinding, 'Expression');
  UnlistPublishedProperty(TcxGridItemServerModeDataBinding, 'ValueType');
  UnlistPublishedProperty(TcxGridServerModeColumn, 'VisibleForExpressionEditor');
  UnlistPublishedProperty(TcxGridServerModeBandedColumn, 'VisibleForExpressionEditor');
  ...
  UnlistPublishedProperty(TcxGridServerModeScrollbarAnnotationOptions, 'ShowErrors');
  UnlistPublishedProperty(TcxGridServerModeScrollbarAnnotationOptions, 'ShowSearchResults');
  UnlistPublishedProperty(TcxGridServerModeTableFiltering, 'ExpressionEditing');
  UnlistPublishedProperty(TcxGridServerModeTableView, 'FixedDataRows');
{$ENDIF}
