...
const
  dxThisUnitName = 'cxGridServerModeBandedTableView';
...
procedure TcxGridServerModeBandedTableView.SetRecoveryState(ADataFocusingInfo: TdxServerModeDataFocusingInfo);
begin
...
procedure TcxGridServerModeBandedTableView.GetRecoveryState(ADataFocusingInfo: TdxServerModeDataFocusingInfo);
begin
...
procedure TcxGridServerModeBandedTableView.InitDataController;
begin
...
function TcxGridServerModeBandedTableView.CreateScrollbarAnnotations: TcxGridScrollbarAnnotationOptions;
begin
