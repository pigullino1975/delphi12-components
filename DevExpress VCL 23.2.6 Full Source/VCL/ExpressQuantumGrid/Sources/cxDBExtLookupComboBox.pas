...
uses
   cxGeometry, cxGridFilterHelpers, dxCore, Math;

const
  dxThisUnitName = 'cxDBExtLookupComboBox';
...
function TcxExtLookupComboBoxProperties.FindValueByItemIndex(
  AItemIndex: Integer; out AValue: Variant): Boolean;
begin
...
function TcxExtLookupComboBoxProperties.SupportsItemIndex: Boolean;
begin
  Result := True;
end;
...
function TcxExtLookupComboBox.SupportsItemIndex: Boolean;
begin
  Result := True;
end;
