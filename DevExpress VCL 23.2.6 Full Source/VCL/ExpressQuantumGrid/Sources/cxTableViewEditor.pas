...
type
  ...
  protected
    ...
    procedure ShowRowLayoutCustomizationForm(Sender: TcxGridViewMenuItem);
  public
...
const
  dxThisUnitName = 'cxTableViewEditor';
...
begin
  if GridView.OptionsBehavior.EditMode <> emInplace then
    Items.AddItem('Customize Edit Form Layout...', ShowInplaceEditFormCustomizationForm);
  if GridView.RowLayout.Active then
    Items.AddItem('Customize Row Layout...', ShowRowLayoutCustomizationForm);
...
procedure TcxGridTableViewMenuProvider.ShowRowLayoutCustomizationForm(Sender: TcxGridViewMenuItem);
begin
  GridView.Controller.ShowRowLayoutCustomizationDialog;
end;
