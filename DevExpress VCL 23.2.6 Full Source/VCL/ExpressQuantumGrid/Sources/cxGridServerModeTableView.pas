...
type
  ...
  { TcxGridServerModeScrollbarAnnotationOptionsHelper }

  TcxGridServerModeScrollbarAnnotationOptionsHelper = class(TcxGridScrollbarAnnotationOptionsHelper)
  protected
    function GetDefaultValue(Index: Integer): Boolean; override;
    procedure SetValue(Index: Integer; Value: Boolean); override;
  end;

  { TcxGridServerModeScrollbarAnnotationOptions }

  TcxGridServerModeScrollbarAnnotationOptions = class(TcxGridScrollbarAnnotationOptions)
  protected
    function CreateHelper: TcxGridScrollbarAnnotationOptionsHelper; override;
  end;

  { TcxGridServerModeTableFiltering }

  TcxGridServerModeTableFiltering = class(TcxGridTableFiltering);
  ...
  private
    ...
    function GetFiltering: TcxGridServerModeTableFiltering;
    ...
    procedure SetFiltering(Value: TcxGridServerModeTableFiltering);
  protected
    ...
    procedure GetRecoveryState(ADataFocusingInfo: TdxServerModeDataFocusingInfo);
    procedure SetRecoveryState(ADataFocusingInfo: TdxServerModeDataFocusingInfo);
  ...
  published
    ...
    property Filtering: TcxGridServerModeTableFiltering read GetFiltering write SetFiltering;
  end;
...
const
  dxThisUnitName = 'cxGridServerModeTableView';

type
  TcxGridServerModeDataControllerAccess = class(TcxGridServerModeDataController);
  TcxGridTableControllerAcces = class(TcxGridTableController);

{ TcxGridServerModeScrollbarAnnotationOptionsHelper }

function TcxGridServerModeScrollbarAnnotationOptionsHelper.GetDefaultValue(Index: Integer): Boolean;
begin
  Result := Index in [1, 2];
end;

procedure TcxGridServerModeScrollbarAnnotationOptionsHelper.SetValue(Index: Integer; Value: Boolean);
begin
...
function TcxGridServerModeScrollbarAnnotationOptions.CreateHelper: TcxGridScrollbarAnnotationOptionsHelper;
begin
  Result := TcxGridServerModeScrollbarAnnotationOptionsHelper.Create(GridView as TcxCustomGridTableView);
end;
...
function TcxGridServerModeTableView.GetFiltering: TcxGridServerModeTableFiltering;
begin
  Result := TcxGridServerModeTableFiltering(inherited Filtering);
end;
...
procedure TcxGridServerModeTableView.SetFiltering(Value: TcxGridServerModeTableFiltering);
begin
  inherited Filtering := Value;
end;

procedure TcxGridServerModeTableView.SetRecoveryState(ADataFocusingInfo: TdxServerModeDataFocusingInfo);
begin
  TcxGridTableControllerAcces(Controller).InternalTopRecordIndex := ADataFocusingInfo.InternalTopRecordIndex;
end;
...
function TcxGridServerModeTableView.GetFilteringClass: TcxCustomGridTableFilteringClass;
begin
  Result := TcxGridServerModeTableFiltering;
end;
...
procedure TcxGridServerModeTableView.GetRecoveryState(ADataFocusingInfo: TdxServerModeDataFocusingInfo);
begin
  ADataFocusingInfo.InternalTopRecordIndex := TcxGridTableControllerAcces(Controller).InternalTopRecordIndex;
end;
...
procedure TcxGridServerModeTableView.InitDataController;
begin
  inherited InitDataController;
  TcxGridServerModeDataControllerAccess(DataController).OnGetRecoveryState := GetRecoveryState;
  TcxGridServerModeDataControllerAccess(DataController).OnSetRecoveryState := SetRecoveryState;
end;
...
function TcxGridServerModeTableView.CreateScrollbarAnnotations: TcxGridScrollbarAnnotationOptions;
begin
  Result := TcxGridServerModeScrollbarAnnotationOptions.Create(Self);
end;
