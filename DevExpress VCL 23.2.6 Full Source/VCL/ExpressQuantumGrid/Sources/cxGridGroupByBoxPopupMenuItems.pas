...
uses
  Classes, StrUtils, dxCore, cxGridMenuOperations, cxGridCustomTableView, cxCustomData;
...
uses
  Variants, cxLookAndFeels, cxEdit, cxGridTableView, cxGridPopupMenuConsts;

const
  dxThisUnitName = 'cxGridGroupByBoxPopupMenuItems';
...
begin
  Result := IfThen(dxUseVectorIcons, ClassName, 'HDRIMG7');
end;
