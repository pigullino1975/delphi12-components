...
uses
  ...
  cxGeometry, cxStyles, cxStorage, cxPC, dxUIElementPopupWindow, dxCoreGraphics,
...
const
  ...
  cxGridDefaultFixedBandSeparatorWidth = cxGridDefaultFixedColumnSeparatorWidth;
...
type 
  TcxGridBandFixedKind = TcxGridColumnFixedKind;

const 
  fkNone = TcxGridBandFixedKind.fkNone;
  fkLeft = TcxGridBandFixedKind.fkLeft;
  fkRight = TcxGridBandFixedKind.fkRight;
  fkLeftDynamic = TcxGridBandFixedKind.fkLeftDynamic;
...
type
  ...
  protected
    ...
    function GetHeaderArrowAreaBounds(APlace: TcxGridArrowPlace): TRect; override;
    function GetDestZonesClientBounds: TRect; override;
  ...
  public
    procedure DrawFixedSeparator(ABounds: TRect; AIsRight: Boolean; AIsHeader: Boolean); override;
    property ViewInfo: TcxGridBandedTableViewInfo read GetViewInfo;
  end;
  ...
  private
    FColumnPosition: TcxGridBandedColumnPosition;

    function GetBandViewInfo: TcxGridBandViewInfo; inline;
    function GetColumn: TcxGridBandedColumn; inline;
    function GetContainer: TcxGridBandedHeaderViewInfo; inline;
    function GetRowViewInfo: TcxGridBandRowViewInfo; inline;
  protected
    ...
    function ExcludeLeftBorder: Boolean; override;
    function ExcludeRightBorder: Boolean; override;
  ...
  public
    constructor Create(AContainer: TcxGridColumnContainerViewInfo; AColumn: TcxGridColumn); override;
    //
    property Column: TcxGridBandedColumn read GetColumn;
    property ColumnPosition: TcxGridBandedColumnPosition read FColumnPosition;
  end;
  ...
  protected
    ...
    function ExcludeRightBorder: Boolean;
  ...
  private
    ...
    function GetAreAllChildBandFixed: Boolean;
    ...
    procedure SetIsDynamicFixed(AValue: Boolean);
  protected
    procedure AddColumnViewInfos; virtual;
    ...
    property AreAllChildBandFixed: Boolean read GetAreAllChildBandFixed;
    ...
    property IsDynamicFixed: Boolean read FIsDynamicFixed write SetIsDynamicFixed;
  public
  ...
  private
    ...
    FDynamicFixedRootItems: TList;
    FGridView: TcxGridBandedTableView;
    FGridViewInfo: TcxGridBandedTableViewInfo;
    FIsRightToLeftConverted: Boolean;
    FItems: TList;
    FLineCount: Integer;
    FRowCount: Integer;
    ...
    function GetBands: TcxGridBands; inline;
    function GetBorderOverlapSize: Integer; inline;
    ...
    function GetCount: Integer;
    function GetDynamicFixedRootItemCount: Integer;
    function GetDynamicFixedRootItem(AIndex: Integer): TcxGridBandViewInfo;
  ...
  protected
    ...
    procedure AddDynamicFixedRootItem(AItem: TcxGridBandViewInfo); virtual;
    ...
    property DynamicFixedRootItemCount: Integer read GetDynamicFixedRootItemCount;
    property DynamicFixedRootItems[AIndex: Integer]: TcxGridBandViewInfo read GetDynamicFixedRootItem;
    property GridViewInfo: TcxGridBandedTableViewInfo read FGridViewInfo;
  ...
  private
    ...
    function GetGridView: TcxGridBandedTableView;
    function GetGridViewInfo: TcxGridBandedTableViewInfo;
    function GetItem(Index: Integer): TcxGridBandedColumnHeaderViewInfo; inline;
    function GetLineCount: Integer;
    function GetRowCount: Integer;
  ...
  protected
    ...
    function GetVisible: Boolean; override;
    function GetWidth: Integer; override;
    function GetZone(const P: TPoint; ATrackingBounds: TRect; AFirst, ALast: Integer): TcxGridItemContainerZone; override;
  ...
  TcxGridBandedFooterViewInfoSpecific = class(TcxGridFooterViewInfoSpecific) // for internal use
  private
    function GetGridViewInfo: TcxGridBandedTableViewInfo;
  protected
    function CalculateHeight: Integer; override;
    function CalcCellHeight(AIndex, ACellHeight: Integer): Integer; override;
  public
    property GridViewInfo: TcxGridBandedTableViewInfo read GetGridViewInfo;
  end;
  ...
  public
    ...
    function IsForcedVisibleForPainting: Boolean; override;
    procedure DoRightToLeftConversion(const ABounds: TRect); override;
  ...
  protected
    ...
    function DrawMergedCell(ACell: TcxGridDataCellViewInfo): Boolean; override;
  ...
  protected
    function CalculateDataRowHeight(AConsideLayout: Boolean = True): Integer; override;
    function CalculateRowCellsAreaVisible: Boolean; virtual;
    function GetPainterClass: TcxCustomGridRecordsPainterClass; override;
    function GetRowFocusRectBounds(ARowViewInfo: TcxCustomGridRowViewInfo): TRect; override;
  ...
  private
    ...
    function GetHeaderViewInfo: TcxGridBandedHeaderViewInfo;
  protected
    function GetBoundsForMakeItemVisible(AColumn: TcxCustomGridColumn): TRect; override;
    ...
    function GetFixedHighlightColor: TdxAlphaColor; override;
    function GetFixedSeparatorColor: TColor; override;
    ...
    function NeedIncludeVerticalScrollBarAreaInScrollContent: Boolean; override;
    ...
    function GetFooterViewInfoSpecificClass: TcxGridFooterViewInfoSpecificClass; override;
  ...
  public
    ...
    function GetCellLineIndex(AIndex: Integer): Integer; override;
  ...
  strict private
    function GetItem: TcxGridBandedColumn; inline;
  protected
  ...
  TcxGridBandedColumnPositionClass = class of TcxGridBandedColumnPosition;
  ...
  private
    ...
    function GetGridView: TcxGridBandedTableView; inline;
    function GetRowIndex: Integer; inline;
    function GetVisibleBandIndex: Integer; inline;
    function GetVisibleRowIndex: Integer; inline;
  ...
  public
    ...
    property Band: TcxGridBand read FBand;
    property GridView: TcxGridBandedTableView read GetGridView;
    property Item: TcxGridBandedColumn read FItem;
  ...
  protected
    ...
    function GetPositionClass: TcxGridBandedColumnPositionClass; virtual;
  ...
  private
    ...
    FItems: TList;
    FLastAutoWidthSizableItemVisibleIndex: Integer;
    ...
    function GetLastAutoWidthSizableItemVisibleIndex: Integer;
    function GetLineCount: Integer;
  ...
  protected
    ...
    property LastAutoWidthSizableItemVisibleIndex: Integer read FLastAutoWidthSizableItemVisibleIndex;
  ...
  private
    ...
    function GetBand: TcxGridBand;
    function GetGridViewValue: TcxGridBandedTableView; inline;
  ...
  published
    ...
    property OnGetHeaderStyle: TcxGridBandGetHeaderStyle read FOnGetHeaderStyle write SetOnGetHeaderStyle;
  end;
  ...
  TcxGridBand = class(TcxInterfacedCollectionItem, IcxStoredObject, IdxScaleFactor)
  private
  ...
  protected
    ...
    function NeedFixedHighlight: Boolean; virtual;
    procedure PopulateTabOrderList(AList: TList);
    procedure RefreshStyleCache; virtual;
  ...
  public
    ...
    property VisibleBottomIndex: Integer read FVisibleBottomIndex;
    ...
    property VisibleIndex: Integer read FVisibleIndex;
    property VisibleRootIndex: Integer read FVisibleRootIndex;
  published
  ...
  private
    ...
    FVisibleDynamicFixedCount: Integer;
    FVisibleItems: TList;
    ...
    procedure AssignVisibleBottomItemsList;
    procedure AssignVisibleItemIndexes;
    procedure AssignVisibleRootItemsList;
    ...
    procedure RefreshVisibleRowCount; inline;
  protected
    // IcxStoredObject
    function GetObjectName: string; virtual;
    function GetProperties(AProperties: TStrings): Boolean; virtual;
    ...
    procedure PopulateTabOrderList(AList: TList);
    procedure RefreshStyleCache;
    procedure ReleaseID(AID: Integer);

    property VisibleDynamicFixedCount: Integer read FVisibleDynamicFixedCount;
  ...
  strict private
    ...
    FFixedBandHighlightColor: TdxAlphaColor;
    FFixedBandSeparatorColor: TColor;
    FFixedBandSeparatorWidth: Integer;
    FHighlightFixedBands: Boolean;
    ...
    procedure SetFixedBandHighlightColor(Value: TdxAlphaColor);
    procedure SetFixedBandSeparatorColor(Value: TColor);
    procedure SetFixedBandSeparatorWidth(Value: Integer);
    procedure SetHighlightFixedBands(Value: Boolean);
  protected
  ...
  published
    ...
    property FixedBandHighlightColor: TdxAlphaColor read FFixedBandHighlightColor write SetFixedBandHighlightColor default TdxAlphaColors.Default;
    ...
    property HighlightFixedBands: Boolean read FHighlightFixedBands write SetHighlightFixedBands default False;
  end;
  ...
  published
    ...
    property StyleSheet;
    property OnGetBandHeaderStyle: TcxGridBandGetHeaderStyle read FOnGetBandHeaderStyle write SetOnGetBandHeaderStyle;
  end;
  ...
  protected
    ...
    function SupportsColumnFixing: Boolean; override;
...
uses
  SysUtils, Math, Contnrs, cxGridStrs, cxCustomData, cxCheckListBox, cxLibraryConsts, dxTypeHelpers;

const
  dxThisUnitName = 'cxGridBandedTableView';
...
begin
  ...
  if (DestItemContainerKind = ckHeader) and (DestZone.Band.FixedKind in [fkNone, fkLeftDynamic]) then
    Result := ViewInfo.ScrollableAreaBoundsHorz;
end;

function TcxGridBandedColumnHeaderMovingObject.GetHeaderArrowAreaBounds(APlace: TcxGridArrowPlace): TRect;
var
...
begin
  ...
  begin
    Result := inherited GetHeaderArrowAreaBounds(APlace);
...
function TcxGridBandedColumnHeaderMovingObject.GetDestZonesClientBounds: TRect;
begin
...
begin
  Result := inherited GetArrowsClientRect;
  if (DestBandContainerKind = bcHeader) and (SourceBand.FixedKind in [fkNone, fkLeftDynamic]) then
  begin
    Result := ViewInfo.ScrollableAreaBoundsHorz;
    ABandViewInfo := ViewInfo.HeaderViewInfo.BandsViewInfo.LastFixedItems[fkLeftDynamic, 0];
    if ABandViewInfo <> nil then
      if ViewInfo.HeaderViewInfo.BandsViewInfo.IsRightToLeftConverted then
        Result.Right := Max(ABandViewInfo.Bounds.Left, Result.Left)
      else
        Result.Left := Min(ABandViewInfo.Bounds.Right, Result.Right);
  end;
end;
...
begin
  ...
  if Result then
  begin
    Result := (DestBand.FixedKind = SourceBand.FixedKind) or
      (DestBand.FixedKind in [fkNone, fkLeftDynamic]) and (SourceBand.FixedKind in [fkNone, fkLeftDynamic]);
...
begin
  ...
  Result := (APosition1 = APosition2) or (APosition1.Row = APosition2.Row) and
    (APosition2.VisibleColIndex < APosition2.Row.LastAutoWidthSizableItemVisibleIndex) and
  ...
  begin
    ...
    begin
      ...
      LookAndFeelPainter.DrawScaledHeader(Self.Canvas, Bounds, TextAreaBounds, [],
        ...
        Text, Params.Font, Params.TextColor, Params.Color, ScaleFactor,
        BandViewInfo.BandsViewInfo.DrawBandHeaderBackgroundHandler, AExcludeRightBorder, False, GridViewInfo.GridLineWidth);
    end;
...
procedure TcxGridBandHeaderPainter.DrawFixedHighlight;
begin
...
procedure TcxGridBandPainter.DrawBorder(ABorder: TcxBorder);
var
  ARect: TRect;
  ACheckedBorder: TcxBorder;
begin
  ...
  begin
    if not ViewInfo.IsRightToLeftConverted then
      ACheckedBorder := bRight
    else
      ACheckedBorder := bLeft;
    if (ABorder = ACheckedBorder) and (ViewInfo.FixedKind = fkLeft) then
    begin
      ARect := ViewInfo.BorderBounds[ABorder];
      if (ViewInfo.GridViewInfo.FixedBandSeparatorWidth > 0) and (ARect.Width = ViewInfo.GridViewInfo.FixedBandSeparatorWidth) then
      begin
        Canvas.SetBrushColor(ViewInfo.BorderColor[ABorder]);
        if not ViewInfo.IsRightToLeftConverted then
          Dec(ARect.Left, ViewInfo.GridViewInfo.GridLineWidth)
        else
          Inc(ARect.Right, ViewInfo.GridViewInfo.GridLineWidth * 2);
        ARect.Width := ARect.Width - ViewInfo.GridViewInfo.GridLineWidth;
        Canvas.SaveClipRegion;
        Canvas.SetClipRegion(TcxRegion.Create(ARect), roSet);
...
var
  I, J: Integer;
  ABandRowViewInfo: TcxGridBandRowViewInfo;
begin
  for I := 0 to ViewInfo.RowCount - 1 do
  begin
    ABandRowViewInfo := ViewInfo.RowsViewInfo[I];
    for J := 0 to ABandRowViewInfo.ColumnViewInfoCount - 1 do
      ABandRowViewInfo.ColumnViewInfos[J].Paint;
  end;
end;
...
procedure TcxGridBandedHeaderPainter.DrawBands;
  ...
  begin
    with ViewInfo.BandsViewInfo do
      ...
      begin
        AItem := RootItems[I];
        if ((AItem.FixedKind = AFixedKind) and ((AFixedKind <> fkLeftDynamic) or AItem.IsDynamicFixed) or
          (AFixedKind = fkNone) and (AItem.FixedKind = fkLeftDynamic) and not AItem.IsDynamicFixed) then
            AItem.Paint;
      end;    
  end;
...
var
  ...
  AFixedKind, ABandFixedKind: TcxGridBandFixedKind;
  I: Integer;
  ...
  var
    ABandViewInfo, ADynamicBandViewInfo: TcxGridBandViewInfo;
  begin
    Result := ViewInfo.Bounds;
    ABandViewInfo := BandsViewInfo.LastFixedItems[AFixedKind, 0];
    if AFixedKind = fkLeft then
    begin
      ADynamicBandViewInfo := BandsViewInfo.LastFixedItems[fkLeftDynamic, 0];
      if ADynamicBandViewInfo <> nil then
        ABandViewInfo := ADynamicBandViewInfo;
    end;
    if ABandViewInfo <> nil then
      case AFixedKind of
        fkLeft:
  ...
  try
    ...
    begin
      ...
      begin
        ...
        ABandFixedKind := ABand.FixedKind;
        if ABandFixedKind = fkLeftDynamic then
          if BandsViewInfo[ABand.VisibleIndex].IsDynamicFixed then
            ABandFixedKind := fkLeft
          else
            ABandFixedKind := fkNone;
        if ABandFixedKind = fkNone then
          ANonFixedItems.Add(AViewInfo)
        else
        begin
          if ABandFixedKind <> AFixedKind  then
            ChangeFixedKind(ABandFixedKind);
          AViewInfo.Paint;
        end;
      end;
    end;
...
begin
  ViewInfo.GridViewInfo.Painter.DrawFixedSeparator(ViewInfo.FixedBandsSeparatorBounds, ViewInfo.FixedBandsSeparatorLocation = slLeft, False);
end;

procedure TcxGridBandedDataRowCellsAreaItemPainter.DrawFixedHighlight;
begin
  ViewInfo.GridViewInfo.Painter.DrawFixedHighlight(ViewInfo.ClientBounds);
end;
...
function TcxGridBandedDataRowCellsAreaItemPainter.NeedFixedHighlight: Boolean;
begin
  Result := ViewInfo.BandViewInfo.Band.NeedFixedHighlight;
end;
  ...
  begin
    with TcxGridBandedTableViewInfo(ARowViewInfo.GridViewInfo).HeaderViewInfo.BandsViewInfo do
      ...
      begin
        ...
        if ((ABandViewInfo.FixedKind = AFixedKind) and ((AFixedKind <> fkLeftDynamic) or
          ABandViewInfo.IsDynamicFixed) or (AFixedKind = fkNone) and
          (ABandViewInfo.FixedKind = fkLeftDynamic) and not ABandViewInfo.IsDynamicFixed) then
...
procedure TcxGridBandedTablePainter.DrawFixedSeparator(ABounds: TRect;
  AIsRight, AIsHeader: Boolean);
var
  APartBounds: TRect;
begin
  ...
  begin
    ...
    begin
      ...
      begin
        if not ViewInfo.IsRightToLeftConverted then
        begin
          if not AIsRight then
          begin
            Canvas.SaveClipRegion;
            Canvas.OffsetClipRegion(-ViewInfo.GridLineWidth, 0);
          end;
        ...
        begin
          ...
          begin
            Canvas.SaveClipRegion;
            Canvas.OffsetClipRegion(ViewInfo.GridLineWidth * 2, 0);
          end;
          ABounds.Offset(ViewInfo.GridLineWidth * 2, 0);
          Canvas.FillRect(ABounds, ViewInfo.FixedSeparatorColor);
          if AIsRight then
            Canvas.RestoreClipRegion;
          Canvas.ExcludeClipRect(ABounds);
...
begin
  with ViewInfo.HeaderViewInfo.BandsViewInfo do
    Result := inherited CanOffset(AItemsOffset, DX, DY) and
      ...
      ((Bands.Layout = blNonFixed) or (GridView.GroupedColumnCount = 0) and not GridView.Preview.Active) and
      (Bands.VisibleDynamicFixedCount = 0));
end;
...
constructor TcxGridBandedColumnHeaderViewInfo.Create(AContainer: TcxGridColumnContainerViewInfo; AColumn: TcxGridColumn);
begin
  inherited;
  FColumnPosition := TcxGridBandedColumn(AColumn).Position;
end;

function TcxGridBandedColumnHeaderViewInfo.ExcludeLeftBorder: Boolean;

  function IsColumnFirstInRightFixedBands(AColumn: TcxGridBandedColumn): Boolean;
  var
    ABand: TcxGridBand;
  begin
    Result := False;
    if AColumn.Position.VisibleColIndex = 0 then
    begin
      ABand := AColumn.Position.Band.RootParentBand;
      if not Assigned(ABand) then
        ABand := AColumn.Position.Band;
      if (ABand.FixedKind = fkRight) and (ABand.VisibleRootIndex <> 0) then
      begin
        if AColumn.GridView.Bands.VisibleRootItems[ABand.VisibleRootIndex - 1].FixedKind = fkNone then
          Result := True;
      end;
    end;
  end;
...
begin
  if not UseLightBorders then
    ...
    Result := (Column.Position.Band.FixedKind = fkRight) and (BandViewInfo.GridViewInfo.FixedBandSeparatorWidth > 0) and
      IsColumnFirstInRightFixedBands(Column);
end;

function TcxGridBandedColumnHeaderViewInfo.ExcludeRightBorder: Boolean;
begin
  if not UseLightBorders then
    Result := False
  else
  begin
    if not IsRightToLeftConverted then
      Result := BandViewInfo.Band.IsMostRight and Column.IsMostRight and (GridView.OptionsView.ColumnAutoWidth or (GridViewInfo.Bounds.Right <= Bounds.Right)) and
        ((GridViewInfo.Bounds.Right = Bounds.Right) or (not GridViewInfo.ForceIncludeRightmostBorder))
    else
      Result := BandViewInfo.Band.IsMostRight and Column.IsMostRight and (GridView.OptionsView.ColumnAutoWidth or (GridViewInfo.Bounds.Left >= Bounds.Left)) and
...
begin
  Result := Container.BandsViewInfo[ColumnPosition.VisibleBandIndex];
end;

function TcxGridBandedColumnHeaderViewInfo.GetBorders: TcxBorders;
begin
  Result := inherited GetBorders;
  if UseLightBorders then
  begin
    Exclude(Result, bTop);
    if ExcludeLeftBorder then
...
begin
  Result := BandViewInfo.RowsViewInfo[ColumnPosition.VisibleRowIndex];
end;
...
begin
  inherited;
  if CanVertSize then
    AProc(TcxGridBandedColumnHeaderVertSizingEdgeViewInfo);
end;
...
begin
  ...
  begin
    ...
    if ColumnPosition.VisibleColIndex < RowViewInfo.BandRow.LastAutoWidthSizableItemVisibleIndex then
      for I := 0 to RowViewInfo.ColumnViewInfoCount - 1 do
      begin
        if I < ColumnPosition.VisibleColIndex then
...
function TcxGridBandHeaderViewInfo.ExcludeRightBorder: Boolean;
begin
  if not UseLightBorders then
    Result := False
  else
  begin
    if not IsRightToLeftConverted then
      Result := BandViewInfo.Band.IsMostRight and (GridView.OptionsView.ColumnAutoWidth or (GridViewInfo.Bounds.Right <= Bounds.Right)) and
        ((GridViewInfo.Bounds.Right = Bounds.Right) or (not GridViewInfo.ForceIncludeRightmostBorder))
    else
      Result := BandViewInfo.Band.IsMostRight and (GridView.OptionsView.ColumnAutoWidth or (GridViewInfo.Bounds.Left >= Bounds.Left)) and
        ((GridViewInfo.Bounds.Left = Bounds.Left) or (not GridViewInfo.ForceIncludeRightmostBorder));
  end;
end;
...
begin
  ...
  begin
    ...
    if Band.IsFirst then
      Exclude(Result, bLeft);
    if Band.IsMostRight and (GridView.OptionsView.ColumnAutoWidth or (Band.FixedKind = fkRight)) then
      Exclude(Result, bRight);
    Exclude(Result, bLeft);
    if (Band.FixedKind = fkRight) and (GridViewInfo.FixedBandSeparatorWidth = 0) then
...
begin
  AHeaderBorderSize := ABordersScaleFactor.Apply(ALookAndFeelPainter.HeaderBorderSize);

  Result := ATextHeight + 2 * AHeaderBorderSize +
...
function TcxGridBandHeaderViewInfo.NeedFixedHighlight: Boolean;
begin
  Result := Band.NeedFixedHighlight;
end;
...
procedure TcxGridBandRowViewInfo.AfterRecalculation;
var
  I: Integer;
begin
  for I := 0 to ColumnViewInfoCount - 1 do
    ColumnViewInfos[I].AfterRecalculation;
end;
...
procedure TcxGridBandRowViewInfo.BeforeRecalculation;
var
  I: Integer;
begin
  for I := 0 to ColumnViewInfoCount - 1 do
    ColumnViewInfos[I].BeforeRecalculation;
end;
...
begin
  ...
  begin
    ...
    AColumnViewInfo.Calculate(ALeftBound, ATopBound, AWidth, AColumnViewInfo.ColumnPosition.LineCount * ALineHeight);
...
procedure TcxGridBandRowsViewInfo.AfterRecalculation;
var
  I: Integer;
begin
  for I := 0 to Count - 1 do
    Items[I].AfterRecalculation;
end;
...
procedure TcxGridBandRowsViewInfo.BeforeRecalculation;
var
  I: Integer;
begin
  for I := 0 to Count - 1 do
...
begin
  ...
  FIndex := AIndex;
  FColumnViewInfos := TList.Create;
  FBand := ABandsViewInfo.Bands.VisibleItems[AIndex];
...
begin
  ...
  FreeAndNil(FColumnViewInfos);
  inherited;
end;

function TcxGridBandViewInfo.GetAreAllChildBandFixed: Boolean;
var
  I: Integer;
begin
  Result := False;
  for I := 0 to ChildBandViewInfoCount - 1 do
  begin
    Result := ChildBandViewInfos[I].IsFixed;
    if not Result then
      Exit;
  end;
end;
...
function TcxGridBandViewInfo.GetBordersScaleFactor: TdxScaleFactor;
begin
  Result := GridView.BordersScaleFactor;
end;

function TcxGridBandViewInfo.GetUseLightBorders: Boolean;
begin
  Result := GridView.UseLightBorders;
end;

procedure TcxGridBandViewInfo.SetIsDynamicFixed(AValue: Boolean);
var
  I: Integer;
begin
  if IsDynamicFixed <> AValue then
  begin
    FIsDynamicFixed := AValue;
    for I := 0 to ChildBandViewInfoCount - 1 do
      ChildBandViewInfos[I].IsDynamicFixed := IsDynamicFixed;
  end;
end;
...
begin
  Result := CompareVisibleColumnPositions(
    TcxGridBandedColumnHeaderViewInfo(Item1).ColumnPosition,
    TcxGridBandedColumnHeaderViewInfo(Item2).ColumnPosition);
end;
...
var
  ...
  AContainerViewInfo: TcxGridBandedHeaderViewInfo;
  I: Integer;
begin
  ABand := Band;
  AContainerViewInfo := ContainerViewInfo;
  for I := 0 to AContainerViewInfo.Count - 1 do
  begin
    AColumnHeaderViewInfo := TcxGridBandedColumnHeaderViewInfo(AContainerViewInfo.FItems.List[I]); 
    if AColumnHeaderViewInfo = nil then
      AColumnHeaderViewInfo := AContainerViewInfo.Items[I];
    if AColumnHeaderViewInfo.ColumnPosition.Band = ABand then
...
var
  I: Integer;
  AAreChildBandFixed: Boolean;
  AAutoWidthItem: TcxAutoWidthItem;
  AAutoWidthObject: TcxAutoWidthObject;
begin
  AAutoWidthObject := TcxAutoWidthObject.Create(ChildBandViewInfoCount);
  try
    AAreChildBandFixed := AreAllChildBandFixed;
    for I := 0 to ChildBandViewInfoCount - 1 do
    begin
      AAutoWidthItem := AAutoWidthObject.AddItem;
      ChildBandViewInfos[I].InitAutoWidthItem(AAutoWidthItem);
      AAutoWidthItem.Fixed := AAutoWidthItem.Fixed and not AAreChildBandFixed;
    end;
...
begin
  Result := [];
  if ((FixedKind = fkLeft) and (BandsViewInfo.DynamicFixedRootItemCount = 0) or
    (FixedKind in [fkRight, fkLeftDynamic])) and (BandsViewInfo.LastFixedItems[FixedKind, Band.BandLevelIndex] = Self) then
      case FixedKind of
        fkLeft, fkLeftDynamic:
...
procedure TcxGridBandViewInfo.AfterRecalculation;
var
  I: Integer;
begin
  if IsBottom then
    RowsViewInfo.AfterRecalculation
  else
    for I := 0 to ChildBandViewInfoCount - 1 do
      ChildBandViewInfos[I].AfterRecalculation;
  FHeaderViewInfo.AfterRecalculation;
  inherited AfterRecalculation;
end;

procedure TcxGridBandViewInfo.BeforeRecalculation;
var
  I: Integer;
begin
  inherited BeforeRecalculation;
  FWidth := -1;
  FHeaderViewInfo.BeforeRecalculation;
  if IsBottom then
    RowsViewInfo.BeforeRecalculation
  else
    for I := 0 to ChildBandViewInfoCount - 1 do
      ChildBandViewInfos[I].BeforeRecalculation;
end;
...
begin
  ...
  FDynamicFixedRootItems := TList.Create;
  FGridView := FContainerViewInfo.GridView;
  FGridViewInfo := FContainerViewInfo.GridViewInfo;
...
function TcxGridBandsViewInfo.GetDynamicFixedRootItemCount: Integer;
begin
  Result := FDynamicFixedRootItems.Count;
end;

function TcxGridBandsViewInfo.GetDynamicFixedRootItem(AIndex: Integer): TcxGridBandViewInfo;
begin
  Result := TcxGridBandViewInfo(FDynamicFixedRootItems[AIndex]);
end;
...
function TcxGridBandsViewInfo.GetLastFixedItem(AFixedKind: TcxGridBandFixedKind;
  ...
  function GetLastDynamicFixedItem: TcxGridBandViewInfo;
  begin
    Result := DynamicFixedRootItems[DynamicFixedRootItemCount - 1];
    while Result.Band.BandLevelIndex <> ALevelIndex do
      if not Result.IsBottom then
        Result := Result.ChildBandViewInfos[Result.ChildBandViewInfoCount - 1]
      else
...
begin
  ...
  case AFixedKind of
    ...
    fkLeftDynamic:
      if DynamicFixedRootItemCount <> 0 then
        Result := GetLastDynamicFixedItem;
  end;
end;
...
procedure TcxGridBandsViewInfo.AddDynamicFixedRootItem(AItem: TcxGridBandViewInfo);
begin
  FDynamicFixedRootItems.Add(AItem);
  AItem.IsDynamicFixed := True;
end;
...
var
  ABounds, AScrollableAreaBounds: TRect;
  ...
  begin
    ABounds := AScrollableAreaBounds;
    if (Bands.Layout in [blLeftFixed, blLeftRightFixed]) and not GridView.RowLayout.Active then
      Dec(ABounds.Left, GridViewInfo.LeftPos);
    for I := 0 to RootItemCount - 1 do
    begin
      AItem := RootItems[I];
      if AItem.FixedKind in [fkNone, fkLeftDynamic] then
      begin
        ABounds.Right := ABounds.Left + AItem.Width;
        AItem.Calculate(ABounds);
        ABounds.Left := ABounds.Right;
  ...
  procedure ProcessDynamicFixedItems;
  var
    I: Integer;
    AItem, ALastItem: TcxGridBandViewInfo;
  begin
    ABounds := AScrollableAreaBounds;
    if Bands.Layout in [blNonFixed, blRightFixed] then
    begin
      ABounds.Left := GridViewInfo.ClientBounds.Left;
      if GridViewInfo.HasFirstBorderOverlap then
        Dec(ABounds.Left, BorderOverlapSize);
    end;
    for I := 0 to RootItemCount - 1 do
    begin
      AItem := RootItems[I];
      if (AItem.FixedKind = fkLeftDynamic) and (AItem.Bounds.Left < ABounds.Left)  then
      begin
        ALastItem := LastFixedItems[fkLeftDynamic, AItem.Band.BandLevelIndex];
        if ALastItem = nil then
          ALastItem := LastFixedItems[fkLeft, AItem.Band.BandLevelIndex];

        AddDynamicFixedRootItem(AItem);

        if ALastItem <> nil then
        begin
          ALastItem.BeforeRecalculation;
          ABounds.Left := ALastItem.Bounds.Left;
          ABounds.Right := ABounds.Left + ALastItem.Width;
          ALastItem.Calculate(ABounds);
          ABounds.Left := ABounds.Right;
          Dec(ABounds.Left, BorderOverlapSize);
          ALastItem.AfterRecalculation;
        end;
...
begin
  ...
  if ABand.FixedKind in [fkLeft, fkRight] then
...
function TcxGridBandedHeaderViewInfo.GetColumnNeighbors(AColumn: TcxGridColumn): TcxNeighbors;
  ...
  function IsColumnNextToLeftFixedBands(AColumn: TcxGridBandedColumn): Boolean;
  var
    ABand: TcxGridBand;
  begin
    Result := False;
    ...
    begin
      ...
      if not Assigned(ABand) then
        ABand := AColumn.Position.Band;
      if (ABand.FixedKind = fkNone) and (ABand.VisibleRootIndex <> 0) then
      begin
        if AColumn.GridView.Bands.VisibleRootItems[ABand.VisibleRootIndex - 1].FixedKind = fkLeft then
          Result := True;
      end;
    end;
  end;
...
begin
  ...
  begin
    Result := [];
    if (not AColumn.IsLeft) or AColumn.IsMostLeft then
      Include(Result, nLeft);
    if (not AColumn.IsRight) or AColumn.IsMostRight then
      Include(Result, nRight);
    if not AColumn.IsTop then
      Include(Result, nTop);
    if not AColumn.IsBottom then
      Include(Result, nBottom);
    if IsColumnNextToLeftFixedBands(TcxGridBandedColumn(AColumn)) then
      Include(Result, nLeft);
  end;
end;
...
begin
  Result := inherited GetIsScrollable and (FBandsViewInfo.Bands.Layout in [blNonFixed, blRightFixed]);
end;
...
function TcxGridBandedHeaderViewInfo.GetZone(const P: TPoint; ATrackingBounds: TRect;
...
begin
  Result := TcxGridBandedColumn(GridView.VisibleColumns[AColumnIndex]).Position.Band.FixedKind in [fkLeft, fkRight];
end;
  ...
  begin
    with Result do
      case FixedBandsSeparatorLocation of
        slLeft:
          begin
            Left := Left - GridViewInfo.GridLineWidth;
            Right := Left + GridViewInfo.FixedBandSeparatorWidth;
          end;
        slRight:
          begin
            Right := Right - GridViewInfo.GridLineWidth;
            Left := Right - GridViewInfo.FixedBandSeparatorWidth;
          end;
      end;
  end;
...
function TcxGridBandedDataRowCellsAreaItemViewInfo.IsForcedVisibleForPainting: Boolean;
begin
  Result := FixedBandsSeparatorLocation <> slNone;
end;
...
function TcxGridBandedDataRowCellsAreaViewInfo.DrawMergedCell(ACell: TcxGridDataCellViewInfo): Boolean;
begin
  Result := True;
end;
...
function TcxGridBandedRowsViewInfo.CalculateDataRowHeight(AConsideLayout: Boolean = True): Integer;
begin
  Result := inherited CalculateDataRowHeight(AConsideLayout);
  if (HeaderViewInfo.LineCount <> 0) and (not GridView.RowLayout.Active or not AConsideLayout) then
...
function TcxGridBandedRowsViewInfo.GetRowFocusRectBounds(ARowViewInfo: TcxCustomGridRowViewInfo): TRect;
begin
  Result := inherited GetRowFocusRectBounds(ARowViewInfo);
  if ARowViewInfo.GridRecord.IsData and (HeaderViewInfo.BandsViewInfo.DynamicFixedRootItemCount > 0) and
    (HeaderViewInfo.BandsViewInfo.Bands.Layout in [blNonFixed, blRightFixed]) then
...
begin
  ...
  if (HeaderViewInfo.BandsViewInfo.Bands.Layout <> blNonFixed) and not GridView.RowLayout.Active then
  begin
...
function TcxGridBandedTableViewInfo.GetBoundsForMakeItemVisible(AColumn: TcxCustomGridColumn): TRect;
var
  I, ADelta: Integer;
  ABand: TcxGridBand;
  ADynamicBandHeader: TcxGridBandViewInfo;
  ABandedColumn: TcxGridBandedColumn absolute AColumn;
begin
  Result := inherited GetBoundsForMakeItemVisible(AColumn);
  ABand := ABandedColumn.Position.Band.RootParentBand;
  if ABand = nil then
    ABand := ABandedColumn.Position.Band;
  for I := HeaderViewInfo.BandsViewInfo.DynamicFixedRootItemCount - 1 downto 0 do
  begin
    ADynamicBandHeader := HeaderViewInfo.BandsViewInfo.DynamicFixedRootItems[I];
    ADelta := ABand.VisibleRootIndex - ADynamicBandHeader.Band.VisibleRootIndex;
    if ADelta > 0 then
    begin
      if ViewInfo.IsRightToLeftConverted then
        Result.Right := ADynamicBandHeader.Bounds.Left
      else
        Result.Left := ADynamicBandHeader.Bounds.Right;
      Break;
    end;
  end;
end;
...
function TcxGridBandedTableViewInfo.GetFixedHighlightColor: TdxAlphaColor;
var
  AAlpha: Byte;
begin
  if GridView.OptionsView.FixedBandHighlightColor <> TdxAlphaColors.Default then
  begin
    AAlpha := Min(dxGetAlpha(GridView.OptionsView.FixedBandHighlightColor), GetFixedHighlightColorMaxAlpha);
    Result := TdxAlphaColors.FromArgb(AAlpha, GridView.OptionsView.FixedBandHighlightColor);
  end
  else
    Result := LookAndFeelPainter.DefaultFixedColumnHighlightColor;
end;

function TcxGridBandedTableViewInfo.GetFixedSeparatorColor: TColor;
begin
  if GridView.OptionsView.FixedBandSeparatorColor <> clDefault then
    Result := GridView.OptionsView.FixedBandSeparatorColor
  else
...
function TcxGridBandedTableViewInfo.IsCellPartVisible(ACell: TcxGridTableDataCellViewInfo): Boolean;
var
  ABounds: TRect;
begin
  Result := inherited IsCellPartVisible(ACell);
  if not Result and (HeaderViewInfo.BandsViewInfo.DynamicFixedRootItemCount > 0) then
  begin
    ABounds := HeaderViewInfo.BandsViewInfo.LastFixedItems[fkLeftDynamic, 0].Bounds;
    if IsRightToLeftConverted then
      Result := ACell.Bounds.Right >= ABounds.Left
    else
      Result := ACell.Bounds.Left <= ABounds.Right;
  end;
end;

function TcxGridBandedTableViewInfo.NeedIncludeVerticalScrollBarAreaInScrollContent: Boolean;
begin
  Result := inherited NeedIncludeVerticalScrollBarAreaInScrollContent and (GridView.Bands.VisibleRightFixedCount = 0);
end;
...
function TcxGridBandedTableViewInfo.GetFooterViewInfoSpecificClass: TcxGridFooterViewInfoSpecificClass;
begin
  Result := TcxGridBandedFooterViewInfoSpecific;
end;
...
begin
  Result := inherited CanOffset(ARecordCountDelta, APixelScrollRecordOffsetDelta, DX, DY) and
    ((ARecordCountDelta <> 0) or (APixelScrollRecordOffsetDelta <> 0) or
    (GridView.Bands.Layout = blNonFixed) and (GridView.Bands.VisibleDynamicFixedCount = 0));
end;

function TcxGridBandedTableViewInfo.GetCellHeight(AIndex, ACellHeight: Integer): Integer;
begin
  Result := HeaderViewInfo[AIndex].ColumnPosition.LineCount * ACellHeight;
end;

function TcxGridBandedTableViewInfo.GetCellLineIndex(
  AIndex: Integer): Integer;
begin
  Result := HeaderViewInfo[AIndex].ColumnPosition.Row.LineOffset;
end;

function TcxGridBandedTableViewInfo.GetCellTopOffset(AIndex, ACellHeight: Integer): Integer;
begin
  Result := HeaderViewInfo[AIndex].ColumnPosition.Row.LineOffset * ACellHeight;
end;
...
procedure TcxGridBandedColumnStyles.GetDefaultViewParams(Index: Integer; AData: TObject; out AParams: TcxViewParams);
var
  ADataCellPos: TcxGridDataCellPos;
  AItem: TcxGridBandedColumn;
begin
  if Index = isContent then
  begin
    AItem := Item;
    if AItem.Position.Band <> nil then
    begin
      ADataCellPos := TcxGridDataCellPos.Create(TcxCustomGridRecord(AData), AItem);
      try
        AItem.Position.Band.Styles.GetViewParams(bsContent, ADataCellPos, nil, AParams);
      finally
        ADataCellPos.Free;
      end;
      Exit;
...
begin
  ...
  FRowIndex := -1;
  FVisibleColIndex := -1;
  FItem := TcxGridBandedColumn(AItem);
end;
...
function TcxGridBandedColumn.GetPositionClass: TcxGridBandedColumnPositionClass;
begin
   Result:= TcxGridBandedColumnPosition;
end;
...
var
  AHeaderViewInfo: TcxGridBandedHeaderViewInfo;
begin
  AHeaderViewInfo := GridView.ViewInfo.HeaderViewInfo;
  Result := inherited CanScroll and
    (Position.Band <> nil) and ((Position.Band.FixedKind = fkNone) or (Position.Band.FixedKind = fkLeftDynamic) and
    not AHeaderViewInfo.BandsViewInfo[Position.Band.VisibleIndex].IsDynamicFixed);
end;
...
begin
  Result := IsBottom and (Position.VisibleRowIndex = GridView.Bands.VisibleRowCount - 1);
end;
...
function TcxGridBandedColumn.NeedFixedHighlight: Boolean;
begin
  Result := (Position.Band <> nil) and Position.Band.NeedFixedHighlight;
end;
...
function TcxGridBandRow.GetLastAutoWidthSizableItemVisibleIndex: Integer;
var
  I: Integer;
begin
  Result := -1;
  for I := VisibleCount - 1 downto 0 do
    if VisibleItems[I].AutoWidthSizable then
      Exit(I);
end;
...
begin
  ...
  FLastAutoWidthSizableItemVisibleIndex := GetLastAutoWidthSizableItemVisibleIndex;
  FBandRows.RefreshVisibleItemsList;
end;

procedure TcxGridBandRow.ApplyBestFit(ACheckSizingAbility: Boolean = False; AFireEvents: Boolean = False);
var
  I: Integer;
begin
  for I := 0 to VisibleCount - 1 do
...
begin
  ...
  begin
    ...
    if ARow.Visible then
      ARow.FVisibleIndex := FVisibleItems.Add(ARow)
    else
      ARow.FVisibleIndex := -1;
  end;
  FBand.Bands.RefreshVisibleRowCount;
end;

procedure TcxGridBandRows.ApplyBestFit(ACheckSizingAbility: Boolean = False; AFireEvents: Boolean = False);
var
  I: Integer;
begin
  for I := 0 to VisibleCount - 1 do
...
begin
  ...
  for I := 0 to VisibleChildBandCount - 1 do
    Result := Max(Result, VisibleChildBands[I].VisibleBandLevelCount);
  Inc(Result);
end;
...
function TcxGridBand.HasFixedWidth: Boolean;
  ...
  function FixedByInnerColumns: Boolean;
  var
    I: Integer;
  begin
    for I := 0 to Rows.Count - 1 do
      if Rows[I].GetLastAutoWidthSizableItemVisibleIndex <> -1 then
        Exit(False);
    for I := 0 to Rows.Count - 1 do
      if (Rows[I].VisibleCount <> 0) and (Rows[I].GetLastAutoWidthSizableItemVisibleIndex = -1) then
        Exit(True);
    Result := False;
  end;

begin
  Result := (not FOptions.Sizing) or FixedByInnerColumns;
end;
...
function TcxGridBand.NeedFixedHighlight: Boolean;
begin
  Result := (FixedKind <> fkNone) and GridView.OptionsView.HighlightFixedBands and
    (GridView.OptionsView.FixedBandHighlightColor <> TdxAlphaColors.Empty);
end;
...
procedure TcxGridBand.RefreshStyleCache;
var
  I: Integer;
begin
  if FStyles <> nil then
  begin
    ...
    for I := 0 to ChildBandCount - 1 do
      ChildBands[I].RefreshStyleCache;
  end;
end;
...
procedure TcxGridBand.SetCollection(Value: TCollection);
begin
  inherited;
  RefreshStyleCache;
end;
...
function TcxGridBand.GetScaleFactor: TdxScaleFactor;
begin
  Result := Bands.GridView.ScaleFactor;
end;
...
var
  I: Integer;
begin
  if FVisibleRowCount < 0 then
  begin
    FVisibleRowCount := 0;
    for I := 0 to VisibleBottomItemCount - 1 do
      FVisibleRowCount := Max(FVisibleRowCount, VisibleBottomItems[I].Rows.VisibleCount);
  end;
...
procedure TcxGridBands.AssignVisibleBottomItemsList;
var
  AItem: TcxGridBand;
  I: Integer;
begin
  ...
  begin
    AItem := Items[I];
    AItem.FVisibleBottomIndex := FVisibleBottomItems.IndexOf(AItem);
  end;
  RefreshVisibleRowCount;
end;

procedure TcxGridBands.AssignVisibleItemIndexes;
var
  AItem: TcxGridBand;
  I: Integer;
begin
  ...
  begin
    AItem := Items[I];
    AItem.FVisibleIndex := FVisibleItems.IndexOf(AItem);
  end;
end;

procedure TcxGridBands.AssignVisibleRootItemsList;
var
  AItem: TcxGridBand;
  I: Integer;
begin
  ...
  begin
    AItem := Items[I];
    AItem.FVisibleRootIndex := FVisibleRootItems.IndexOf(AItem);
  end;
end;
...
begin
  ...
  begin
    AItem := Items[I];
    if AItem.IsBottom then
      FBottomItems.Add(AItem);
  end;
end;
...
begin
  if (FVisibleItems = nil) or GridView.IsAssigningBands then
    Exit;

  FVisibleItems.Clear;
  FVisibleLeftFixedCount := 0;
  FVisibleRightFixedCount := 0;
  FVisibleDynamicFixedCount := 0;
  for I := 0 to Count - 1 do
  begin
    ABand := Items[I];
      ...
      case AFixedKind of
        ...
        fkRight:
          ...
          begin
            ...
            if AFixedKind = fkLeftDynamic then
              Inc(FVisibleDynamicFixedCount);
          end;
      end;
    end;
  end;
...
begin
  ...
  AssignVisibleRootItemsList;
end;

procedure TcxGridBands.RefreshVisibleRowCount;
begin
  FVisibleRowCount := -1;
end;
...
procedure TcxGridBands.RefreshStyleCache;
var
  I: Integer;
begin
  for I := 0 to Count - 1 do
    Items[I].RefreshStyleCache;
end;
...
begin
  for I := 0 to Count - 1 do
  begin
    Result := Items[I].FixedKind in [fkLeft, fkRight];
    if Result then Exit;
  end;
  Result := False;
end;
...
begin
  ...
  FBandHeaders := True;
  FFixedBandHighlightColor := TdxAlphaColors.Default;
...
procedure TcxGridBandedTableOptionsView.SetFixedBandHighlightColor(Value: TdxAlphaColor);
begin
  if FFixedBandHighlightColor <> Value then
  begin
    FFixedBandHighlightColor := Value;
    Changed(vcSize);
  end;
end;
...
procedure TcxGridBandedTableOptionsView.SetHighlightFixedBands(Value: Boolean);
begin
  if FHighlightFixedBands <> Value then
  begin
    FHighlightFixedBands := Value;
    Changed(vcSize);
  end;
end;
...
begin
  Result := inherited CanOffset(ARecordCountDelta, APixelScrollRecordOffsetDelta) and
    ((ARecordCountDelta <> 0) or (APixelScrollRecordOffsetDelta <> 0) or
    (Bands.Layout = blNonFixed) and (Bands.VisibleDynamicFixedCount = 0));
end;
...
procedure TcxGridBandedTableView.DoRefreshStylesCache;
begin
  inherited;
  Bands.RefreshStyleCache;
end;
...
begin
  ...
  if (AFixedKind1 = AFixedKind2) or (AFixedKind1 in [fkNone, fkLeftDynamic]) and (AFixedKind2 in [fkNone, fkLeftDynamic]) then
    Result := CompareVisibleColumnPositions(AColumn1.Position, AColumn2.Position)
  else
    if (AFixedKind1 = fkLeft) or (AFixedKind2 = fkRight) then
      Result := -1
    else
      if (AFixedKind1 = fkRight) or (AFixedKind2 = fkLeft)  then
        Result := 1
      else
        Result := 0;
end;
...
begin
  if IsAssigningBands or IsAssigningItems then
    Exit;
  inherited;
...
function TcxGridBandedTableView.SupportsColumnFixing: Boolean;
begin
  Result := False;
end;
...
{ TcxGridBandedFooterViewInfoSpecific }

function TcxGridBandedFooterViewInfoSpecific.CalculateHeight: Integer;
var
  AItemHeight: Integer;
begin
  AItemHeight := ItemHeight;
  Result := (Max(1, GridViewInfo.HeaderViewInfo.LineCount) - 1) * (AItemHeight + GetVerticalSpaceBetweenItems) + AItemHeight;
end;

function TcxGridBandedFooterViewInfoSpecific.CalcCellHeight(AIndex,
  ACellHeight: Integer): Integer;
begin
  Result := ACellHeight + (GridViewInfo.HeaderViewInfo[AIndex].ColumnPosition.LineCount - 1) * (ACellHeight + GetVerticalSpaceBetweenItems);
end;

function TcxGridBandedFooterViewInfoSpecific.GetGridViewInfo: TcxGridBandedTableViewInfo;
begin
  Result := TcxGridBandedTableViewInfo(inherited GridViewInfo);
end;
...
initialization
  ...
  RegisterClasses([TcxGridBandedColumn, TcxGridBandedTableViewStyleSheet]);
