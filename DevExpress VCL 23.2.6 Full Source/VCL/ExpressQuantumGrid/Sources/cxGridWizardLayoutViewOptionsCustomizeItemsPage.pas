...
type
  ...
  TcxCustomGridCustomizationControllerAccess = class(TcxCustomGridCustomizationController);
  ...
  private
    ...
    function GetGridViewCustomizationController: TcxCustomGridCustomizationControllerAccess;
  protected
  ...
  public
    ...
    property GridViewCustomizationController: TcxCustomGridCustomizationControllerAccess read GetGridViewCustomizationController;
  end;

implementation

const
  dxThisUnitName = 'cxGridWizardLayoutViewOptionsCustomizeItemsPage';
...
begin
  ...
  begin
    ...
    GridViewCustomizationController.HideForm;
    GridViewCustomizationController.DoCustomization;
  end;
...
begin
  ...
  GridViewCustomizationController.DoCreateForm;
  if Assigned(CustomizationForm) then
  begin
...
function TcxGridWizardLayoutViewOptionsCustomizeItemsPageFrame.GetGridViewCustomizationController: TcxCustomGridCustomizationControllerAccess;
begin
  Result := TcxCustomGridCustomizationControllerAccess(GridViewController.CustomizationController);
end;
