...
uses
  ...
  cxGridViewLayoutCustomizationForm, cxGridInplaceEditForm, cxGridRowLayout, 
  cxGridRowLayoutCustomizationForm;

type
  { TcxGridTableViewInplaceEditFormCustomizationForm }

  TcxGridTableViewInplaceEditFormCustomizationForm = class(TcxGridRowLayoutCustomizationForm)
  protected
...
const
  dxThisUnitName = 'cxGridTableViewInplaceEditFormCustomizationForm';
...
function TcxGridTableViewInplaceEditFormCustomizationForm.GetLayoutController: TcxGridRowLayoutController;
begin
