...
uses
  ...
  dxLayoutLookAndFeels, dxLayoutControl, cxListBox, dxForms, cxCustomListBox, dxCoreGraphics;
...
const
  dxThisUnitName = 'cxGridImportDialog';
...
begin
  Height := TdxTextMeasurer.TextLineHeight(lbComponentsForImport.Canvas.Handle) + 2 * ScaleFactor.Apply(2);
end;
