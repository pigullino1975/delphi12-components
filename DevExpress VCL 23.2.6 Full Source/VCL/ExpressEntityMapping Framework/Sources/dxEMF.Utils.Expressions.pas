...
const
  dxThisUnitName = 'dxEMF.Utils.Expressions';
...
begin
  {$IFDEF DX_INITIALIZATION_LOGGING}TdxUnitSectionsLogger.ConstructorStarted(UnitName, 'TdxFunctionOperatorHelper.Create', SysInit.HInstance);{$ENDIF}
  ...
  {$IFDEF DX_INITIALIZATION_LOGGING}TdxUnitSectionsLogger.ConstructorFinished(UnitName, 'TdxFunctionOperatorHelper.Create', SysInit.HInstance);{$ENDIF}
end;

class destructor TdxFunctionOperatorHelper.Destroy;
begin
  {$IFDEF DX_INITIALIZATION_LOGGING}TdxUnitSectionsLogger.DestructorStarted(UnitName, 'TdxFunctionOperatorHelper.Destroy', SysInit.HInstance);{$ENDIF}
  FreeAndNil(FFunctionInfoStaticDictionary);
  FreeAndNil(FAggregateFunctionInfo);
  {$IFDEF DX_INITIALIZATION_LOGGING}TdxUnitSectionsLogger.DestructorFinished(UnitName, 'TdxFunctionOperatorHelper.Destroy', SysInit.HInstance);{$ENDIF}
end;
