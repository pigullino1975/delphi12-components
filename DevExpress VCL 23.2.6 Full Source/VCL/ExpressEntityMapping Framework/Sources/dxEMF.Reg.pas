...
{ TdxEMFTableDesigner }
  ...
  public
    function IsRegistered(AEntity: TClass): Boolean; overload;
    function GetEntities: TArray<TClass>;
  end;
...
function TdxEntityManagerHelper.GetEntities: TArray<TClass>;
begin
  Result := ClassAttributes.Keys.ToArray;
end;

function TdxEntityManagerHelper.IsRegistered(AEntity: TClass): Boolean;
begin
  Result := ClassAttributes.ContainsKey(AEntity);
end;
...
begin
  ...
  for AType in ATypes do
    ...
    begin
      ...
      if EntityManager.IsRegistered(AClass) then
        Exit(True);
    end;
  Result := False;
end;
...
begin
  ...
  RegisterPropertyEditor(TypeInfo(string), TdxCustomEMFQueryProperties, 'CriteriaText', TdxEMFCriteriaOperatorTextProperty);
  RegisterPropertyEditor(TypeInfo(string), TdxCustomEMFQueryProperties, 'GroupCriteriaText', TdxEMFCriteriaOperatorTextProperty);
  RegisterPropertyEditor(TypeInfo(string), TdxEMFCustomQueryDataSet, 'CriteriaText', TdxEMFCriteriaOperatorTextProperty);
  RegisterPropertyEditor(TypeInfo(string), TdxEMFCustomQueryDataSet, 'GroupCriteriaText', TdxEMFCriteriaOperatorTextProperty);
