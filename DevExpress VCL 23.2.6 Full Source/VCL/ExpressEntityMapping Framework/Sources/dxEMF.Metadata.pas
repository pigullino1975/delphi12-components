...
type
  ...
  ['{6534BDBF-41AD-42F2-8274-110AC098469A}']
    ...
    function LookupResultField(const AFieldNames: string): IdxMappingMemberInfo;
    function MaxValue(AValue: Double): IdxMappingMemberInfo;
    function MinValue(AValue: Double): IdxMappingMemberInfo;
    function Precision(AValue: Integer): IdxMappingMemberInfo;
    function DisplayFormat(const AValue: string): IdxMappingMemberInfo;
    function DisplayLabel(const AValue: string): IdxMappingMemberInfo;
    function DisplayWidth(AValue: Integer): IdxMappingMemberInfo;
    function EditFormat(const AValue: string): IdxMappingMemberInfo;
    function EditMask(const AValue: string): IdxMappingMemberInfo;
  end;
  ...
  protected
    ...
    procedure SetTypeKind(ATypeKind: TTypeKind);
  public
  ...
  protected
    ...
    function CreateNonPersistentObject: TObject;
  ...
  TdxEMFAccessorGetter = reference to function (AObject: TObject): Variant;
  TdxEMFAccessorSetter = reference to procedure (AObject: TObject; const AValue: Variant);
  TdxEMFAccessorGetter<T: class> = reference to function (AObject: T): Variant;
  TdxEMFAccessorSetter<T: class> = reference to procedure (AObject: T; const AValue: Variant);
  ...
  strict private
    ...
    FIsWritable: Boolean;
    FOnGetter: TdxEMFAccessorGetter;
    FOnSetter: TdxEMFAccessorSetter;

    FDisplayFormat: TdxNullableString;
    FDisplayLabel: TdxNullableString;
    FDisplayWidth: TdxNullableInteger;
    FEditFormat: TdxNullableString;
    FEditMask: TdxNullableString;
    FLookupResultField: TdxNullableString;
    FMaxValue: TdxNullableDouble;
    FMinValue: TdxNullableDouble;
    FPrecision: TdxNullableInteger;
    ...
    function GetDBColumnType: TdxDBColumnType;
    ...
    function GetIsKeyOrInKey: Boolean;
  private
    function GetInternalMemberType: TRttiType;
  protected
    FID: Integer;
    ...
    procedure SetMember(const Value: TRttiMember);
    ...
    procedure SetSubMembers(const AMembers: TArray<TdxMappingMemberInfo>);
    function IsMember(const AMemberName: string): Boolean;
    procedure UpdateReferenceType;
    procedure UpdateMemberInfo; virtual;
  ...
  protected
    ...
    function SetLookupResultField(const AFieldNames: string): IdxMappingMemberInfo;
    function SetMaxValue(AValue: Double): IdxMappingMemberInfo;
    function SetMinValue(AValue: Double): IdxMappingMemberInfo;
    function SetPrecision(AValue: Integer): IdxMappingMemberInfo;
    function SetDisplayFormat(const AValue: string): IdxMappingMemberInfo;
    function SetDisplayLabel(const AValue: string): IdxMappingMemberInfo;
    function SetDisplayWidth(AValue: Integer): IdxMappingMemberInfo;
    function SetEditFormat(const AValue: string): IdxMappingMemberInfo;
    function SetEditMask(const AValue: string): IdxMappingMemberInfo;
    function IdxMappingMemberInfo.LookupResultField = SetLookupResultField;
    function IdxMappingMemberInfo.MaxValue = SetMaxValue;
    function IdxMappingMemberInfo.MinValue = SetMinValue;
    function IdxMappingMemberInfo.Precision = SetPrecision;
    function IdxMappingMemberInfo.DisplayFormat = SetDisplayFormat;
    function IdxMappingMemberInfo.DisplayLabel = SetDisplayLabel;
    function IdxMappingMemberInfo.DisplayWidth = SetDisplayWidth;
    function IdxMappingMemberInfo.EditFormat = SetEditFormat;
    function IdxMappingMemberInfo.EditMask = SetEditMask;
  public
    ...
    function GetAsVariant(AObject: TObject): Variant; inline;
    function GetValue(AObject: TObject): TValue; virtual;
    function GetValues(AObject: TObject): TArray<TValue>; virtual;
    function GetValueAsDisplayText(const AValue: Variant): string;
    procedure SetAsVariant(AObject: TObject; const AValue: Variant);
    ...
    property DBColumnType: TdxDBColumnType read GetDBColumnType;
    property FieldType: TFieldType read GetFieldType;

    property LookupResultField: TdxNullableString read FLookupResultField;
    property DisplayLabel: TdxNullableString read FDisplayLabel;
    property DisplayFormat: TdxNullableString read FDisplayFormat;
    property DisplayWidth: TdxNullableInteger read FDisplayWidth;
    property EditFormat: TdxNullableString read FEditFormat;
    property EditMask: TdxNullableString read FEditMask;
    property MaxValue: TdxNullableDouble read FMaxValue;
    property MinValue: TdxNullableDouble read FMinValue;
    property Precision: TdxNullableInteger read FPrecision;
    ...
    property IsEnumeration: Boolean read FIsEnumeration; 
    ...
    property IsKeyOrInKey: Boolean read GetIsKeyOrInKey;
    ...
    property OnGetter: TdxEMFAccessorGetter read FOnGetter write FOnGetter;
    property OnSetter: TdxEMFAccessorSetter read FOnSetter write FOnSetter;
  end;
  ...
  TdxKeyMemberInfo = class(TdxMappingMemberInfo)
  strict private
    FKeyFieldCount: Integer;
    function GetMembers: TdxMemberInfoList; inline;
    function GetMember: TdxMappingMemberInfo; inline;
    function GetIsCompositeKey: Boolean; inline;
    function GetIsIdentity: Boolean;
  protected
    procedure UpdateKeyMemberInfo;
    function GetPersistentClass: TClass; override;
  public
    function GetValue(AObject: TObject): TValue; override; final;
    function GetValues(AObject: TObject): TArray<TValue>; override; final;
    procedure SetValue(AObject: TObject; const AValue: TValue); override; final;
    procedure SetValues(AObject: TObject; const AKeyValues: TArray<TValue>);
    function ToString(AObject: TObject): string; reintroduce; overload;
    property KeyFieldCount: Integer read FKeyFieldCount;
    property IsCompositeKey: Boolean read GetIsCompositeKey;
    property IsIdentity: Boolean read GetIsIdentity;
  ...
  protected
    ...
    procedure EntityInfoRemoved(AEntityInfo: TdxEntityInfo);
  ...
  private type
    ...
    TEntityClients = class
    private
      FEntityInfo: TdxEntityInfo;
      FClients: TDictionary<TObject, Pointer>;
    public
      constructor Create(AEntityInfo: TdxEntityInfo);
      destructor Destroy; override;
      procedure Register(AClient: TObject; AEvent: TConnectChangeEvent = nil);
      procedure Unregister(AClient: TObject);
      procedure SendDisconnectEvent;
    end;

  strict private class var
    FContext: TRttiContext;
    FEntityClients: TObjectDictionary<TdxEntityInfo, TEntityClients>;
  strict private
  ...
  protected
    ...
    class procedure ClearEntityClients(AEntityInfo: TdxEntityInfo);
    class procedure DisconnectEntityClients(AEntityInfo: TdxEntityInfo);
    ...
    class function CheckAttributes(AMember: TRttiMember; AAttributeInfo: TdxMappingMemberInfo): Boolean; static;
    ...
    class function GetMember(AClass: TClass; const AMemberName: string): TRttiMember; static;
    class function SerializeMember(AAttributeInfo: TdxMappingMemberInfo): Boolean; static;
    ...
    property ClassAttributes: TObjectDictionary<TClass, TdxEntityInfo> read FClassAttributes;
  ...
  public
    ...
    class procedure RegisterEntityClient(AEntityInfo: TdxEntityInfo; AClient: TObject; AEvent: TConnectChangeEvent = nil);
    class procedure UnregisterEntityClient(AEntityInfo: TdxEntityInfo; AClient: TObject);
    ...
    procedure RegisterEMFAccessor<T: class>(const AMemberName: string; AGetter: TdxEMFAccessorGetter<T>; ASetter: TdxEMFAccessorSetter<T>); overload;
    procedure RegisterEMFAccessor(AClass: TClass; const AMemberName: string; AGetter: TdxEMFAccessorGetter; ASetter: TdxEMFAccessorSetter); overload;
    procedure UnregisterEMFAccessor(AClass: TClass; const AMemberName: string);
...
type
  ...
  protected
    ...
    procedure UpdateMemberInfo; override;
    function GetIsEnumeration: Boolean; override;
...
function TdxMappingNullableMemberInfo.IsValidChar(InputChar: Char): Boolean;
begin
  Result := CheckValidChar(FUnderlyingType.TypeKind, InputChar);
end;

function TdxMappingNullableMemberInfo.GetIsEnumeration: Boolean;
begin
  Result := (FUnderlyingType.TypeKind = tkEnumeration) and (FUnderlyingType.Handle <> TypeInfo(Boolean));
end;

function TdxMappingNullableMemberInfo.GetIsNullable: Boolean;
begin
  Result := True;
end;

function TdxMappingNullableMemberInfo.GetMemberType: TRttiType;
begin
  Result := FUnderlyingType;
end;

function TdxMappingNullableMemberInfo.GetTypeKind: TTypeKind;
begin
  Result := FUnderlyingType.TypeKind;
end;
...
var
  AValue: TValue;
begin
  if Assigned(OnGetter) then
    Exit(TValue.FromVariant(OnGetter(AObject)));
...
procedure TdxMappingNullableMemberInfo.UpdateMemberInfo;
begin
  TryGetUnderlyingRttiType(GetInternalMemberType.Handle, FUnderlyingType);
  inherited UpdateMemberInfo;
end;
...
function TdxAttributeInfo.GetTypeKind: TTypeKind;
begin
  Result := FTypeKind;
end;
...
procedure TdxAttributeInfo.SetTypeKind(ATypeKind: TTypeKind);
begin
  FTypeKind := ATypeKind;
end;
...
begin
  {$IFDEF DX_INITIALIZATION_LOGGING}TdxUnitSectionsLogger.ConstructorStarted(UnitName, 'TdxEntityManager.Create', SysInit.HInstance);{$ENDIF}
  FContext := TRttiContext.Create;
  FEntityClients := TObjectDictionary<TdxEntityInfo, TEntityClients>.Create([doOwnsValues]);
  {$IFDEF DX_INITIALIZATION_LOGGING}TdxUnitSectionsLogger.ConstructorFinished(UnitName, 'TdxEntityManager.Create', SysInit.HInstance);{$ENDIF}
end;
...
begin
  {$IFDEF DX_INITIALIZATION_LOGGING}TdxUnitSectionsLogger.DestructorStarted(UnitName, 'TdxEntityManager.Destroy', SysInit.HInstance);{$ENDIF}
  FContext.Free;
  FreeAndNil(FEntityClients);
  {$IFDEF DX_INITIALIZATION_LOGGING}TdxUnitSectionsLogger.DestructorFinished(UnitName, 'TdxEntityManager.Destroy', SysInit.HInstance);{$ENDIF}
end;
...
begin
  ...
  if AAttribute is LookupResultFieldAttribute then
    AAttributeInfo.SetLookupResultField(LookupResultFieldAttribute(AAttribute).FieldName)
  else
  if AAttribute is MaxValueAttribute then
    AAttributeInfo.SetMaxValue(MaxValueAttribute(AAttribute).Value)
  else
  if AAttribute is MinValueAttribute then
    AAttributeInfo.SetMinValue(MinValueAttribute(AAttribute).Value)
  else
  if AAttribute is PrecisionAttribute then
    AAttributeInfo.SetPrecision(PrecisionAttribute(AAttribute).Value)
  else
  if AAttribute is DisplayFormatAttribute then
    AAttributeInfo.SetDisplayFormat(DisplayFormatAttribute(AAttribute).Value)
  else
  if AAttribute is DisplayLabelAttribute then
    AAttributeInfo.SetDisplayLabel(DisplayLabelAttribute(AAttribute).Value)
  else
  if AAttribute is DisplayWidthAttribute then
    AAttributeInfo.SetDisplayWidth(DisplayWidthAttribute(AAttribute).Value)
  else
  if AAttribute is EditFormatAttribute then
    AAttributeInfo.SetEditFormat(EditFormatAttribute(AAttribute).Value)
  else
  if AAttribute is EditMaskAttribute then
    AAttributeInfo.SetEditMask(EditMaskAttribute(AAttribute).Value)
end;
...
class function TdxEntityManager.CheckAttributes(AMember: TRttiMember; AAttributeInfo: TdxMappingMemberInfo): Boolean;
var
...
begin
  ...
  AAttributeInfo.SetTypeKind(AFieldType.TypeKind);
    ...
    begin
      ...
      begin
        ...
        begin
          ...
          if AFieldType.IsInstance then
          begin
            Result := TdxEntityManager.SerializeMember(AAttributeInfo);
            if not Result then
            begin
              AAttributeInfo.UpdateReferenceType;
...
begin
    Result := GetEntityInfo(AClass).CreateObject;
end;
...
class function TdxEntityManager.GetMember(AClass: TClass; const AMemberName: string): TRttiMember;
var
  AType: TRttiType;
begin
...
class procedure TdxEntityManager.RegisterEntityClient(AEntityInfo: TdxEntityInfo; AClient: TObject;
  AEvent: TConnectChangeEvent);
var
  AEntityClient: TEntityClients;
begin
  if not FEntityClients.TryGetValue(AEntityInfo, AEntityClient) then
  begin
    AEntityClient := TEntityClients.Create(AEntityInfo);
    FEntityClients.Add(AEntityInfo, AEntityClient);
  end;
  AEntityClient.Register(AClient, AEvent);
end;
...
class procedure TdxEntityManager.ClearEntityClients(AEntityInfo: TdxEntityInfo);
var
  AClients: TEntityClients;
begin
  if FEntityClients.TryGetValue(AEntityInfo, AClients) then
  begin
    AClients.SendDisconnectEvent;
    FEntityClients.Remove(AEntityInfo);
  end;
end;

procedure TdxEntityManager.DisconnectAll;
var
  AEntityInfo: TdxEntityInfo;
begin
  for AEntityInfo in FClassAttributes.Values do
    DisconnectEntityClients(AEntityInfo);
end;

class procedure TdxEntityManager.DisconnectEntityClients(AEntityInfo: TdxEntityInfo);
var
  AClients: TEntityClients;
begin
  if FEntityClients.TryGetValue(AEntityInfo, AClients) then
...
class function TdxEntityManager.SerializeMember(AAttributeInfo: TdxMappingMemberInfo): Boolean;
var
  AFieldType: TRttiType;
  AClass: TClass;
begin
...
var
  AClassEntityInfo, AEntityInfo: TdxEntityInfo;
begin
  FProcessingEntities.Remove(AClass);
  if FClassAttributes.TryGetValue(AClass, AClassEntityInfo) then
  begin
    for AEntityInfo in Self do
      AEntityInfo.EntityInfoRemoved(AClassEntityInfo);
    FClassAttributes.Remove(AClass);
  end;
end;

class procedure TdxEntityManager.UnregisterEntityClient(AEntityInfo: TdxEntityInfo; AClient: TObject);
var
  AClients: TEntityClients;
begin
  if FEntityClients.TryGetValue(AEntityInfo, AClients) then
    AClients.Unregister(AClient);
end;

procedure TdxEntityManager.RegisterEMFAccessor(AClass: TClass; const AMemberName: string; AGetter: TdxEMFAccessorGetter;
  ASetter: TdxEMFAccessorSetter);
var
  AEntityInfo: TdxEntityInfo;
  AMemberInfo: TdxMappingMemberInfo;
begin
  AEntityInfo := GetEntityInfo(AClass);
  AMemberInfo := AEntityInfo.FindMember(AMemberName);
  if AMemberInfo <> nil then
  begin
    AMemberInfo.OnGetter := AGetter;
    AMemberInfo.OnSetter := ASetter;
  end;
end;

procedure TdxEntityManager.RegisterEMFAccessor<T>(const AMemberName: string; AGetter: TdxEMFAccessorGetter<T>;
  ASetter: TdxEMFAccessorSetter<T>);
begin
  RegisterEMFAccessor(TClass(T), AMemberName, TdxEMFAccessorGetter(AGetter), TdxEMFAccessorSetter(ASetter));
end;

procedure TdxEntityManager.UnregisterEMFAccessor(AClass: TClass; const AMemberName: string);
var
  AEntityInfo: TdxEntityInfo;
  AMemberInfo: TdxMappingMemberInfo;
begin
  ...
  if AMemberInfo <> nil then
  begin
    AMemberInfo.OnGetter := nil;
    AMemberInfo.OnSetter := nil;
  end;
end;
...
begin
  TdxEntityManager.ClearEntityClients(Self);
  FreeAndNil(FMembers);
...
begin
  ...
  begin
    ...
    begin
      ...
      TdxEntityManager.CheckAttributes(AMemberInfo.Member, AMemberInfo);
  end;
...
procedure TdxEntityInfo.EntityInfoRemoved(AEntityInfo: TdxEntityInfo);
var
  AMappingMemberInfo: TdxMappingMemberInfo;
begin
  for AMappingMemberInfo in FObjectProperties do
    if AMappingMemberInfo.FReferenceType = AEntityInfo then
      AMappingMemberInfo.FReferenceType := nil;
  for AMappingMemberInfo in FAssociationListProperties do
    if AMappingMemberInfo.FCollectionElementType = AEntityInfo then
      AMappingMemberInfo.FCollectionElementType := nil;
end;
...
function TdxEntityInfo.CreateObject: TObject;
begin
  Result := FClassAttribute.CreateNonPersistentObject;
end;
...
begin
  ...
  if SameText(KeyProperty.MemberName, AMemberName) then
    Result := KeyProperty
  else
    Result := nil;
end;
...
begin
  ...
  if AKey = nil then
    ...
    if AKey.IsCompositeKey then
      Result := TValue.From<TArray<TValue>>(AKey.GetValues(AObject))
    else
...
var
  I, ACount: Integer;
begin
  ACount := MemberAttributes.Count;
  SetLength(Result, ACount);
  for I := 0 to ACount - 1 do
    Result[I] := MemberAttributes.List[I].GetAsVariant(AObject);
end;
...
begin
  ...
  begin
    ...
    begin
      ...
      begin
        if M.IsKey or M.IsReadOnly then
          Continue;
        if M.IsDelayed then
        begin
  ...
  begin
    AList := TdxMemberInfoCollection.Create(Self);
    for M in PersistentProperties do
      if not M.IsReadOnly or M.IsAutoGenerate then
        AList.Add(M);
...
begin
  Result := dxGetQualifiedClassName(AClass);
end;
...
var
  AMembers: TdxArray<TdxMappingMemberInfo>;
  AMemberInfo: TdxMappingMemberInfo;
begin
  AMembers := TdxArray<TdxMappingMemberInfo>.Create(MemberAttributes.Count);
  for AMemberInfo in MemberAttributes do
...
begin
  ...
  begin
    ...
    if TdxEntityManager.GetMember(AObject.ClassType, AMemberName) = nil then
...
begin
  ...
  begin
    ...
    if AMemberValue.IsNullOrEmpty then
...
begin
  ...
  if AType is TRttiInstanceType then
    Result := EntityManager.HasClass(TRttiInstanceType(AType).MetaclassType) or
      EntityManager.IsProcessingEntityInfo(TRttiInstanceType(AType).MetaclassType)
  else
    Result := False;
end;
...
procedure TdxEntityInfo.RegistrationFinalization;
  ...
  begin
    ...
    AKeyProperty.UpdateKeyMemberInfo;
  end;
...
begin
  if ClassAttributes.AttributeName = '' then
    ClassAttributes.SetName(TdxEntityManager.GetQualifiedTableName(ClassAttributes.PersistentClass.ClassName));
...
begin
  ...
  begin
    AAttributeInfo := FAttributeInfoList.List[I];
...
function TdxMappingMemberInfo.SetDisplayFormat(const AValue: string): IdxMappingMemberInfo;
begin
  FDisplayFormat := AValue;
  Result := Self;
end;

function TdxMappingMemberInfo.SetDisplayLabel(const AValue: string): IdxMappingMemberInfo;
begin
  FDisplayLabel := AValue;
  Result := Self;
end;

function TdxMappingMemberInfo.SetDisplayWidth(AValue: Integer): IdxMappingMemberInfo;
begin
  FDisplayWidth := AValue;
  Result := Self;
end;

function TdxMappingMemberInfo.SetEditFormat(const AValue: string): IdxMappingMemberInfo;
begin
  FEditFormat := AValue;
  Result := Self;
end;

function TdxMappingMemberInfo.SetEditMask(const AValue: string): IdxMappingMemberInfo;
begin
  FEditMask := AValue;
  Result := Self;
end;
...
var
  AResult: TdxArray<string>;
  AKey: TdxMappingMemberInfo;
begin
  AResult := TdxArray<string>.Create(Count);
  for AKey in Self do
...
function TdxMappingMemberInfo.CheckValidChar(ATypeKind: TTypeKind; InputChar: Char): Boolean;
begin
  case ATypeKind of
    TTypeKind.tkFloat:
      Result := CharInSet(InputChar, [FormatSettings.DecimalSeparator, '+', '-', '0'..'9', 'E', 'e']);
    TTypeKind.tkClass, TTypeKind.tkDynArray, TTypeKind.tkInterface, TTypeKind.tkRecord
      {$IFDEF DELPHI103}, TTypeKind.tkMRecord{$ENDIF}:
      Result := False;
    TTypeKind.tkInteger, TTypeKind.tkInt64:
      if FieldType in [TFieldType.ftByte, TFieldType.ftWord, TFieldType.ftLongWord] then
          Result := CharInSet(InputChar, ['+', '0'..'9'])
        else
          Result := CharInSet(InputChar, ['+', '-', '0'..'9']);
    else
      Result := True;
...
function TdxMappingMemberInfo.GetAsVariant(AObject: TObject): Variant;
begin
  if Assigned(FOnGetter) then
    Result := FOnGetter(AObject)
  else
    Result := GetValue(AObject).ToVariant;
end;
...
function TdxMappingMemberInfo.GetDBColumnType: TdxDBColumnType;
begin
  Result := TdxDBColumn.GetColumnType(RttiType.Handle);
end;
...
begin
  Result := (TypeKind = tkEnumeration) and (FMemberType.Handle <> TypeInfo(Boolean));
end;
...
function TdxMappingMemberInfo.GetIsKeyOrInKey: Boolean;
begin
  Result := IsKey;
end;
...
begin
  Result := [TdxAttribute.ReadOnly, TdxAttribute.Generator] * Attributes <> [];
end;
...
begin
  Result := (AttributeType = TdxAttributeType.Field) or (Member is TRttiField) or
    ((Member is TRttiProperty) and TRttiProperty(Member).IsWritable);
end;
...
function TdxMappingMemberInfo.GetInternalMemberType: TRttiType;
begin
...
begin
  if AObject = nil then
    Exit(TValue.Empty);
  if Assigned(FOnGetter) then
    Exit(TValue.FromVariant(FOnGetter(AObject)));
...
function TdxMappingMemberInfo.GetValueAsDisplayText(const AValue: Variant): string;
var
  AReferenceType: TdxEntityInfo;
  AReferenceEntity: TObject;
  AMember: TdxMappingMemberInfo;
begin
  if IsReference then
  begin
    AReferenceType := ReferenceType;
    if VarIsSoftEmpty(AValue) then
      Result := ''
    else
    begin
      AReferenceEntity := TObject(NativeInt(AValue));
      if FLookupResultField.IsNull then
        Result := AReferenceType.KeyProperty.ToString(AReferenceEntity)
      else
      begin
        AMember := AReferenceType.FindMember(FLookupResultField);
        if AMember <> nil then
          Result := AMember.GetValueAsDisplayText(AMember.GetAsVariant(AReferenceEntity))
        else
          Result := '';
      end;
    end;
...
function TdxMappingMemberInfo.GetValues(AObject: TObject): TArray<TValue>;
begin
  Result := TArray<TValue>.Create(GetValue(AObject));
end;
...
procedure TdxMappingMemberInfo.UpdateMemberInfo;
begin
  if Member = nil then
    Exit;
  FMemberType := GetInternalMemberType;
  FIsWritable := GetIsWritable;
  FIsEnumeration := GetIsEnumeration;
end;
...
begin
  ...
  if AMemberType = nil then
    ...
    Result := AMemberType.Handle = ATypeInfo;
end;

function TdxMappingMemberInfo.IsValidChar(InputChar: Char): Boolean;
begin
  Result := CheckValidChar(TypeKind, InputChar);
end;
...
function TdxMappingMemberInfo.SetLookupResultField(const AFieldNames: string): IdxMappingMemberInfo;
begin
  FLookupResultField := AFieldNames;
  Result := Self;
end;

function TdxMappingMemberInfo.SetMaxValue(AValue: Double): IdxMappingMemberInfo;
begin
  FMaxValue := AValue;
  Result := Self;
end;

function TdxMappingMemberInfo.SetMinValue(AValue: Double): IdxMappingMemberInfo;
begin
  FMinValue := AValue;
  Result := Self;
end;
...
function TdxMappingMemberInfo.SetPrecision(AValue: Integer): IdxMappingMemberInfo;
begin
  FPrecision := AValue;
  Result := Self;
end;
...
procedure TdxMappingMemberInfo.SetAsVariant(AObject: TObject; const AValue: Variant);
begin
  if Assigned(FOnSetter) then
    FOnSetter(AObject, AValue)
  else
  begin
    if IsReference then
    begin
      if VarIsSoftEmpty(AValue) then
        SetValue(AObject, TValue.Empty)
      else
        SetValue(AObject, TObject(NativeInt(AValue)));
    end
    else
      SetValue(AObject, TdxFieldValueConverter.ToValue(AValue, Self));
  end;
end;
...
procedure TdxMappingMemberInfo.SetSubMembers(const AMembers: TArray<TdxMappingMemberInfo>);
begin
  FSubMembers := AMembers;
end;
...
begin
  ALastDotPos := APath.LastIndexOf('.');
  if ALastDotPos < 0 then
    Exit(ALastDotPos);
  AClosingAngBr := APath.IndexOf('>', ALastDotPos);
  if AClosingAngBr < 0 then
    Exit(ALastDotPos);
  AOpeningAngBr := APath.LastIndexOf('<', AClosingAngBr);
  if AOpeningAngBr < 0 then
    raise EInvalidOperation.Create('Unbalanced <UpCasting> within '#$27 + APath + #$27' property path');
  Result := APath.LastIndexOf('.', AOpeningAngBr);
end;
...
begin
  ...
  begin
    if AClassName.LastIndexOfAny(NamespaceSplitters) >= 0 then
  ...
  begin
    ...
    begin
      ...
      begin
        ...
        begin
          if AEntity.ClassAttributes = nil then
          begin
            ...
            if not SameText(AEntity.ClassAttributes.EntityName, AClassName) then
              Continue;
        end;
      end;
      AEntityInfo := AEntity;
...
function TdxMappingClassInfo.CreateNonPersistentObject: TObject;
begin
  if FCreateMethod <> nil then
    Result := FCreateMethod.Invoke(FClass, []).AsObject
  else
...
begin
  KeyMemberNames.AddRange(AFieldNames.Split([',', ';']));
  Result := Self;
end;
...
var
  ...
  AMemberName: string;
begin
  AMemberName := TdxEntityManager.GetQualifiedFieldName(AFieldName);
  if Owner.Members.TryGetValue(AMemberName, AMemberInfo) then
    Exit(AMemberInfo);
  AMember := TdxEntityManager.GetMember(PersistentClass, AFieldName);
...
begin
  if Owner.Members.TryGetValue(APropertyName, AMemberInfo) then
    Exit(AMemberInfo);
  AMember := TdxEntityManager.GetMember(PersistentClass, APropertyName);
...
procedure TdxMappingClassInfo.UpdateClassInfo;
var
  ARttiType: TRttiType;
  AMethod: TRttiMethod;
begin
  ARttiType := TdxEntityManager.Context.GetType(FClass);
  for AMethod in ARttiType.GetMethods do
    if AMethod.IsConstructor and (Length(AMethod.GetParameters) = 0) then
      begin
        FCreateMethod := AMethod;
        Exit;
      end;
end;
...
begin
  for I := Count - 1 downto 0 do
    if SameText(List[I].MemberName, AMemberName) then
      Exit(I);
  Result := -1;
end;
...
begin
  Result := Owner.KeyAttributes;
end;

function TdxKeyMemberInfo.GetPersistentClass: TClass;
begin
  Result := Owner.ClassAttributes.PersistentClass;
end;

procedure TdxKeyMemberInfo.UpdateKeyMemberInfo;
var
  ANames: TStringList;

  function AddKeyMemberInfoNames(AKeyProperty: TdxKeyMemberInfo): integer; forward;

  function AddNames(AMemberInfo: TdxMappingMemberInfo): Integer;
  var
    ASubMemberInfo: TdxMappingMemberInfo;
  begin
    if AMemberInfo.IsReference then
      Result := AddKeyMemberInfoNames(AMemberInfo.ReferenceType.KeyProperty)
    else
    begin
      Result := Length(AMemberInfo.SubMembers);
      if Result = 0 then
      begin
        ANames.Add(AMemberInfo.MemberName);
        Result := 1
      end
      else
        for ASubMemberInfo in AMemberInfo.SubMembers do
          AddNames(ASubMemberInfo);
    end;
  end;

  function AddKeyMemberInfoNames(AKeyProperty: TdxKeyMemberInfo): Integer;
  var
    I: Integer;
    AMemberInfo, ASubMemberInfo: TdxMappingMemberInfo;
  begin
    Result := 0;
    for I := 0 to AKeyProperty.Members.Count - 1 do
    begin
      AMemberInfo := AKeyProperty.Members[I];
      if Length(AMemberInfo.SubMembers) = 0 then
      begin
        if AMemberInfo.IsReference then
        begin
          if AMemberInfo.ReferenceType.ClassAttributes.PersistentClass.InheritsFrom(Owner.ClassAttributes.PersistentClass) then
            raise EdxInvalidKeyPropertyException.Create('EdxInvalidKeyPropertyException');
          Inc(Result, AddKeyMemberInfoNames(AMemberInfo.ReferenceType.KeyProperty))
        end
        else
        begin
          ANames.Add(AMemberInfo.MemberName);
        ...
        for ASubMemberInfo in AMemberInfo.SubMembers do
         Inc(Result, AddNames(ASubMemberInfo));
    end;
  end;
...
begin
  ...
  try
    FKeyFieldCount := AddKeyMemberInfoNames(Self);
    SetMemberName(ANames.DelimitedText);
    SetSubMembers(Members.ToArray);
  finally
    ANames.Free;
  end;
end;

function TdxKeyMemberInfo.GetIsCompositeKey: Boolean;
begin
...
begin
  if Member.IsReference then
    Result := Member.ReferenceType.KeyProperty.GetValue(Member.GetValue(AObject).AsObject)
  else
...
var
  ...
  procedure SetResultValues(const AResult: TArray<TValue>; AMember: TdxMappingMemberInfo; var K: Integer);
  var
    J: Integer;
  begin
...
begin
  ...
  begin
    ...
    begin
      AMember := Owner.KeyAttributes.List[I];
      ASubMemberCount := Length(AMember.SubMembers);
      if ASubMemberCount > 0 then
        for J := 0 to ASubMemberCount - 1 do
          SetResultValues(Result, AMember.SubMembers[J], K)
      else
        SetResultValues(Result, AMember, K);
    end;
  end
  else
...
function TdxKeyMemberInfo.ToString(AObject: TObject): string;
var
...
begin
  ...
  try
    for AKeyValue in GetValues(AObject) do
    begin
      if AStringBuilder.Length > 0 then
        AStringBuilder.Append(';');
      AStringBuilder.Append(AKeyValue.ToString);
    end;
...
{ TdxEntityManager.TEntityClient }

constructor TdxEntityManager.TEntityClients.Create(AEntityInfo: TdxEntityInfo);
begin
  FEntityInfo := AEntityInfo;
  FClients := TDictionary<TObject, Pointer>.Create;
end;

destructor TdxEntityManager.TEntityClients.Destroy;
begin
  FreeAndNil(FClients);
  inherited Destroy;
end;

procedure TdxEntityManager.TEntityClients.SendDisconnectEvent;
var
  AConnectEvent: TConnectChangeEvent;
  AClient: TPair<TObject, Pointer>;
begin
  for AClient in FClients do
    if AClient.Value <> nil then
    begin
      TMethod(AConnectEvent).Code := AClient.Value;
      TMethod(AConnectEvent).Data := AClient.Key;
      AConnectEvent(FEntityInfo, False);
    end;
end;

procedure TdxEntityManager.TEntityClients.Register(AClient: TObject; AEvent: TConnectChangeEvent);
begin
  FClients.AddOrSetValue(AClient, TMethod(AEvent).Code);
end;

procedure TdxEntityManager.TEntityClients.Unregister(AClient: TObject);
begin
