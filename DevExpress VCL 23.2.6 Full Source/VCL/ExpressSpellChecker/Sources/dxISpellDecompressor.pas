...
uses
  Windows, Classes, SysUtils, cxClasses, dxSpellChecker, dxSpellCheckerUtils, dxSpellCheckerCore, dxCore;
...
type
  ...
  strict private
    function GetItem(Index: TdxListIndex): TdxCharValidator; inline;
  public
    ...
    property Items[Index: TdxListIndex]: TdxCharValidator read GetItem; default;
  end;
  ...
  strict private
    function GetItem(Index: TdxListIndex): TdxAffixRule; inline;
  public
    procedure AddWordforms(const AWord: string; ADictionary: TdxSpellCheckerStrings; ALangID: Cardinal);

    property Items[Index: TdxListIndex]: TdxAffixRule read GetItem; default;
  end;
  ...
  strict private
    function GetItem(Index: TdxListIndex): TdxCustomAffixElement; inline;
  public
    function FindForKey(AKey: WideChar; AIsPrefix: Boolean): TdxCustomAffixElement;

    property Items[Index: TdxListIndex]: TdxCustomAffixElement read GetItem; default;
  end;
...
uses
  Character, dxCharacters, AnsiStrings, dxSpellCheckerStrs;

const
  dxThisUnitName = 'dxISpellDecompressor';
...
function TdxRuleValidator.GetItem(Index: TdxListIndex): TdxCharValidator;
begin
...
function TdxAffixRuleList.GetItem(Index: TdxListIndex): TdxAffixRule;
begin
...
function TdxAffixList.GetItem(Index: TdxListIndex): TdxCustomAffixElement;
begin
