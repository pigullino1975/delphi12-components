...
uses
  Types, Classes, cxClasses, dxCore;
...
type
  ...
  strict private
    ...
    function GetItem(Index: TdxListIndex): TdxSpellCheckerRule; inline;
  public
    ...
    property Items[Index: TdxListIndex]: TdxSpellCheckerRule read GetItem; default; // for internal use
  end;
...
uses
   SysUtils, dxSpellCheckerUtils;

const
  dxThisUnitName = 'dxSpellCheckerRules';
...
function TdxSpellCheckerRules.GetItem(Index: TdxListIndex): TdxSpellCheckerRule;
begin
