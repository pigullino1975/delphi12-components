...
type
  ...
  private
    ...
    function GetItem(Index: TdxListIndex): PWideChar; inline;
  ...
  public
    ...
    property Items[Index: TdxListIndex]: PWideChar read GetItem; default;
  ...
  strict private
    ...
    function GetItem(AIndex: TdxListIndex): TdxSpellCheckerCodePage;
  ...
  public
    ...
    property Items[AIndex: TdxListIndex]: TdxSpellCheckerCodePage read GetItem; default;
...
const
  dxThisUnitName = 'dxSpellCheckerUtils';
...
begin
  if ACaseSensitive then
    ...
    S := WideUpperCase(dxAnsiStringToString(AnsiAlphabet, ACodePage));
...
function TdxSpellCheckerStrings.GetItem(Index: TdxListIndex): PWideChar;
begin
...
function TdxSpellCheckerCodePages.GetItem(AIndex: TdxListIndex): TdxSpellCheckerCodePage;
begin
