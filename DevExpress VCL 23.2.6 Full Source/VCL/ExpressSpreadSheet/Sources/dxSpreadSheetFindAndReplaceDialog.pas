...
uses
  ...
  dxSpreadSheetDialogStrs, dxSpreadSheetNumberFormat, StrUtils, cxFormats, dxSpreadSheetCoreStrs, dxMessageDialog;

const
  dxThisUnitName = 'dxSpreadSheetFindAndReplaceDialog';
...
begin
  dxMessageBox(Handle, AMessage, Application.Title, AType or MB_OK);
end;
