...
uses
  ...
  Generics.Defaults, Generics.Collections, Menus,
  // CX
  ...
  cxDrawTextUtils, dxMessages, dxProtectionUtils, cxDropDownEdit, cxContainer, cxCustomCanvas,
  // SpreadSheet
  dxSpreadSheetTypes, dxSpreadSheetUtils, dxSpreadSheetStrs, dxSpreadSheetGraphics, dxSpreadSheetNumberFormat,
  dxSpreadSheetPrinting, dxSpreadSheetHyperlinks, dxSpreadSheetProtection, dxSpreadSheetStyles,
  dxSpreadSheetInplaceEdit, dxSpreadSheetClasses,
  // SpreadSheetCore
  dxSpreadSheetConditionalFormatting, dxSpreadSheetCoreFormulas, dxSpreadSheetCoreFormulasParser,
  dxSpreadSheetCoreFormulasTokens, dxSpreadSheetCoreReferences, dxSpreadSheetCoreStyles;
...
const
  ...
  dxSpreadSheetBordersMergingOffset = 1;

  dxSpreadSheetContainerVersion = 1;

  dxSpreadSheetBestFitWidthCorrectionPercentage: Single = 0; // Recomended value is 2
...
type
  ...
  EdxSpreadSheetDefinedNameError = class(EdxSpreadSheetError);
  EdxSpreadSheetFormatError = class(EdxSpreadSheetError);
  EdxSpreadSheetInvalidPasswordError = class(EdxSpreadSheetError);
  ...
  TdxSpreadSheetTableViewRowHeaderCellViewInfo = class;
  ...
  TdxSpreadSheetPageControlNewTabButtonClickEvent = procedure(ASpreadSheet: TdxCustomSpreadSheet; var AHandled: Boolean) of object;
  TdxSpreadSheetPageControlTabDragAndDropEvent = procedure(ASpreadSheet: TdxCustomSpreadSheet; AIndex, ANewIndex: Integer; var AAccepted: Boolean) of object;
  TdxSpreadSheetPageControlTabEndDragEvent = procedure(ASpreadSheet: TdxCustomSpreadSheet; AOldIndex, AIndex: Integer) of object;
  TdxSpreadSheetPageControlTabStartDragEvent = procedure(ASpreadSheet: TdxCustomSpreadSheet; AIndex: Integer) of object;

  TdxSpreadSheetChange = (sscData, sscLayout, sscZoom, sscStyle, sscDimension, sscOptionsPrint, sscModified, sscBiDiMode, sscMetadata);
  TdxSpreadSheetChanges = set of TdxSpreadSheetChange;

  TdxSpreadSheetState = (sssReading, sssReadingCells, sssReadingFromClipboard, sssWriting, sssExporting, sssBiDiModeChanging);
  ...
  ['{5A6CD395-25BF-48FE-8FC8-B320466367BD}']
    ...
    function GetAbsoluteCellsArea: TRect;
  ...
  strict private
    ...
    procedure SetFont(const Value: TdxSpreadSheetFontHandle);
  public
    IsDirty: Boolean;
  ...
  strict private
    ...
    function GetDisplayValueDataType: TdxSpreadSheetCellDataType;
    function GetHasValue: Boolean;
    function GetHistory: TdxSpreadSheetHistory; inline;
    function GetIsEmpty: Boolean; 
    function GetIsFormula: Boolean;
    function GetIsMerged: Boolean;
    function GetNext: TdxSpreadSheetCell; inline;
    function GetPrev: TdxSpreadSheetCell; inline;
    ...
    function TryGetFloatAsDateTime(out ADateTime: TDateTime): Boolean; inline;
  ...
  protected
    ...
    function IsPartOfArrayFormula(var AFormulaArea: TRect; AFormula: PdxSpreadSheetCustomFormula = nil): TdxSpreadSheetArrayFormulaPart;
    ...
    procedure SetTextCore(const AText: string; const AFormulaChecking, AArrayFormulaAttributeIsDirty: Boolean); virtual;
  ...
  public
    ...
    procedure BeforeDestruction; override;
    procedure Clear;
    procedure Dormant; inline; // for internal use
    ...
    property ColumnIndex: Integer read FIndex write SetColumnIndex;
  ...
  {$REGION 'for internal use'}
    property DisplayValueDataType: TdxSpreadSheetCellDataType read GetDisplayValueDataType;
    property Next: TdxSpreadSheetCell read GetNext;
    property Prev: TdxSpreadSheetCell read GetPrev;
  ...
  protected
    ...
    function ValidateBounds(const R: TRect): TRect;
  public
  ...
  protected
    ...
    procedure ResolveValues; virtual;
  public
    Anchor: TPoint;
  ...
  strict private
    ...
    FValueAsText: Variant;
    procedure ClearValueAsText;
  protected
    procedure CalculateResultValue; override;
    procedure ClearResult; override;
    function GetController: TdxSpreadSheetCustomFormulaController; override;
    function GetValueAsText: string; override;
    function GetView: TObject; override;
  public
  ...
  strict private
    ...
    function GetItem(Index: TdxListIndex): TdxSpreadSheetFormula;
  protected type
    TUpdateTokenFunc = reference to function (AToken: TdxSpreadSheetFormulaToken): Boolean;
  protected
    ...
    procedure UpdateTokens(AFunc: TUpdateTokenFunc; AMinClass: TdxSpreadSheetFormulaTokenClass = nil);
  public
    constructor Create(AOwner: TdxCustomSpreadSheet); virtual;
    ...
    property Items[Index: TdxListIndex]: TdxSpreadSheetFormula read GetItem; default;
  ...
  protected
    ...
    procedure DblClick(const AUnscaledPos: TPoint); virtual;
  ...
  protected
    ...
    procedure Changed(AChanges: TdxSpreadSheetChanges); overload;
  ...
  strict private
    ...
    FIsCaptionMustBeEscaped: Boolean;
    FIsDestroying: Boolean;
    FLockCount: Integer;
    FOptions: TdxSpreadSheetCustomViewOptions;
    FReferenceLinkHost: IdxSpreadSheetObjectLink;
    ...
    function GetBoundsForRightToLeftConversion: TRect;
  ...
  protected
    ...
    function IsRightToLeftLayout: Boolean; virtual;
    ...
    property BoundsForRightToLeftConversion: TRect read GetBoundsForRightToLeftConversion;
    ...
    property ReferenceLinkHost: IdxSpreadSheetObjectLink read FReferenceLinkHost implements IdxSpreadSheetObjectLink;
  ...
  public
    ...
    property IsRightToLeftLayout: Boolean read FIsRightToLeftLayout;
  ...
  strict private
    function GetItem(Index: TdxListIndex): TdxSpreadSheetCustomView; inline;
  public
    ...
    property Items[Index: TdxListIndex]: TdxSpreadSheetCustomView read GetItem; default;
  end;
  ...
  protected
    ...
    procedure ApplyBestFitCore(ACanvas: TcxCanvas); virtual;
    function CalculateBestFit(ACanvas: TcxCanvas): Integer; virtual; abstract;
    ...
    function HasCells: Boolean; virtual;
    function HasNonEmptyCells: Boolean; overload;
    function HasNonEmptyCells(ARangeStart, ARangeFinish: Integer): Boolean; overload; virtual;
  ...
  protected
    ...
    function GetItemVisibleCount(AStartIndex, AFinishIndex: Integer): Integer;
    ...
    function IsItemSelected(AIndex: Integer): Boolean; virtual;
  ...
  protected
    function CalculateBestFit(ACanvas: TcxCanvas): Integer; override;
  ...
  protected
    ...
    function IsItemSelected(AIndex: Integer): Boolean; override;
  ...
  strict private
    function GetFirstCell: TdxSpreadSheetCell; inline;
    function GetLastCell: TdxSpreadSheetCell; inline;
  protected
    FBestFitIsDirty: Boolean;
    FCells: TdxSpreadSheetTableRowCells;

    procedure ApplyBestFitCore(ACanvas: TcxCanvas); override;
    function CalculateBestFit(ACanvas: TcxCanvas): Integer; override;
    procedure MarkBestFitDirty; override;

    procedure CheckCellsCreated; inline;
    function CreateRowCells: TdxSpreadSheetTableRowCells; virtual;
    procedure DoCellCreated(ACell: TdxSpreadSheetCell); virtual;
    procedure ForEachCell(const AProc: TdxSpreadSheetTableViewForEachCellProc; AStartIndex, AFinishIndex: Integer; AGoForward: Boolean);
    function GetCell(AColumn: Integer): TdxSpreadSheetCell; override;
    function GetCellCount: Integer; override;
    function HasCells: Boolean; override;
    function HasNonEmptyCells(ARangeStart, ARangeFinish: Integer): Boolean; override;
    procedure ReleaseCells; inline;
  ...
  {$REGION 'for internal use'}
    property FirstCell: TdxSpreadSheetCell read GetFirstCell;
    property LastCell: TdxSpreadSheetCell read GetLastCell;
  {$ENDREGION}
  end;
  ...
  protected
    ...
    procedure ForEachCell(const AArea: TRect; const AProc: TdxSpreadSheetTableViewForEachCellProc); overload;
    procedure ForEachCell(const AArea: TRect; const AProc: TdxSpreadSheetTableViewForEachCellProc;
      AGoForwardVertically, AGoForwardHorizontally: Boolean); overload;
    function GetDefaultSize: Integer; override;
    function GetFixedItemIndex: Integer; override;
    function GetItemClass: TdxDynamicListItemClass; override;
    function GetMaxItemIndex: Integer; override;
  ...
  strict private
    ...
    function GetActualRightToLeftLayout: Boolean;
    ...
    procedure SetRightToLeftLayout(AValue: TdxDefaultBoolean);
  ...
  public
    ...
    property ActualRightToLeftLayout: Boolean read GetActualRightToLeftLayout;
  ...
  protected
    ...
    function GetTextForEditMeasurement: string;
  ...
  public
    ...
    procedure ShowEditByMouse(const AUnscaledPos: TPoint; AShift: TShiftState);
  ...
  strict private
    ...
    function ExpandDataRegion(AArea: TRect): TRect;
  ...
  protected
    ...
    procedure DblClick(const AUnscaledPos: TPoint); override;
    ...
    function GetNextCellInDataBlock(AItem: TdxSpreadSheetTableItem; ACellIndex: Integer; AGoForward: Boolean): Integer;
  ...
  protected
    ...
    function IdxSpreadSheetConditionalFormattingOwner.IsRightToLeft = IsRightToLeftLayout;
    ...
    procedure ChangeSelectedItemsVisibility(AItems: TdxSpreadSheetTableItems; AVisibility: Boolean);
    ...
    function IsRightToLeftLayout: Boolean; override;
    procedure Pack; override;
    procedure PasteFromClipboardCore(AOptions: TdxSpreadSheetClipboardPasteOptions; const AData: IUnknown); virtual;
  ...
  public
    ...
    procedure PasteCellDataFromStream(const ADestination: TPoint; AStream: TStream;
      APasteOptions: TdxSpreadSheetClipboardPasteOptions = dxSpreadSheetDefaultPasteOptions);
    ...
    procedure UnhideSelectedColumns;
    ...
    property Controller: TdxSpreadSheetTableViewController read GetController; // for internal use
    property History: TdxSpreadSheetHistory read GetHistory;
  ...
  public
    ...
    procedure DrawGroupLinePart(ACanvas: TcxCanvas; const R: TRect); virtual;
  ...
  strict private
    ...
    FScrollableAreaHitMargins: TRect;
    ...
    function RemoveNeighborCellBorder(ASide: TcxBorder; AIndex, AStartIndex, AFinishIndex: Integer; var AEndPos: Integer): Boolean; inline;
  ...
  protected
    ...
    procedure CalculateCore; override;
    ...
    function CreateSelectionViewInfo: TdxSpreadSheetTableViewSelectionViewInfo; virtual;
    ...
    procedure GetCellAtPoint(P: TPoint; out ARow, AColumn: Integer; AReturnNearestCell: Boolean = False; AVisibleAreaOnly: Boolean = True);
    ...
    procedure MergeCellsBorders(APrevRow, ARow: TdxSpreadSheetTableViewRowHeaderCellViewInfo);
    procedure PostProcessRowCells(ARow: TdxSpreadSheetTableRow; AStartIndex, AFinishIndex: Integer);
    procedure RightToLeftConversion(const AClientBounds: TRect); override;
  ...
  public
    ...
    function GetCellBounds(const ARow, AColumn: Integer): TRect; overload;
    ...
    property DefaultCellStyleHandle: TdxSpreadSheetCellStyleHandle read FDefaultCellStyleHandle; // for internal use
    ...
    property ScrollableAreaHitMargins: TRect read FScrollableAreaHitMargins;
  ...
  private
    ...
    function GetIndex: Integer;
    function GetHistory: TdxSpreadSheetHistory; inline;
    function GetOwnerEx: TdxSpreadSheetDefinedNames; inline;
    function GetReference: string;
    function GetSpreadSheet: TdxCustomSpreadSheet;
    function GetValueAsText: string;
    function ValidateComment(const AValue: string): string;
  ...
  protected
    ...
    procedure LoadFromStream(AReader: TcxReader);
    function IsReferenceValid: Boolean;
    procedure Modify(AProc: TProc);
    procedure SaveToStream(AWriter: TcxWriter);
  ...
  public
    ...
    property Index: Integer read GetIndex;
    property Owner: TdxSpreadSheetDefinedNames read GetOwnerEx;
  ...
  protected const
    AutoNameSuffix = '_';
  strict private
    FIndex: TDictionary<string, TList>;

    function GetFormulaController: TdxSpreadSheetFormulaController; inline;
    function GetHistory: TdxSpreadSheetHistory; inline;
    function GetName(AIndex: Integer): TdxSpreadSheetDefinedName;
  protected
    procedure AfterLoad; virtual;
    procedure Changed; override;
    procedure CheckCaption(const ACaption: string);
    procedure CheckForDuplicates(const ACaption: string; AScope: TdxSpreadSheetCustomView = nil);
    function CreateItem: TdxSpreadSheetObjectListItem; override;
    function IsCaptionValid(const ACaption: string): Boolean;

    procedure DoAddToIndex(AItem: TdxSpreadSheetDefinedName);
    procedure DoClear; override;
    function DoCreateItem(const ACaption, AReference: string; AScope: TdxSpreadSheetCustomView): TdxSpreadSheetDefinedName;
    procedure DoChangeCaption(AName: TdxSpreadSheetDefinedName; const ANewCaption: string);
    procedure DoChangeScope(AName: TdxSpreadSheetDefinedName; AScope: TdxSpreadSheetCustomView);
    procedure DoRemoveFromIndex(AItem: TdxSpreadSheetDefinedName);
    procedure DoRemoveSheet(AScope: TdxSpreadSheetCustomView);

    function Find(const ACaption: string; AScope: TdxSpreadSheetCustomView;
      AScopeMaybeEmpty: Boolean; out AItem: TdxSpreadSheetDefinedName): Boolean; inline;

    property FormulaController: TdxSpreadSheetFormulaController read GetFormulaController;
    property History: TdxSpreadSheetHistory read GetHistory;
  public
    constructor Create(ASpreadSheet: TdxCustomSpreadSheet); override;
    destructor Destroy; override;
    ...
    procedure AddFromSelection; overload;
    procedure AddFromSelection(AView: TdxSpreadSheetTableView); overload;
    procedure AddFromSelection(AView: TdxSpreadSheetTableView; const ASelectedArea: TRect; AHeaders: TcxBorders); overload;
    ...
    function Contains(AScope: TdxSpreadSheetCustomView): Boolean; overload;
    ...
    procedure Remove(AItem: TdxSpreadSheetObjectListItem); override;
  ...
  TdxSpreadSheetExternalLink = class(TdxSpreadSheetObjectListItem, IdxSpreadSheetObjectLink)
  strict private
  ...
  protected
    ...
    property ReferenceLinkHost: IdxSpreadSheetObjectLink read FReferenceLinkHost implements IdxSpreadSheetObjectLink;
  public
    constructor Create(AOwner: TdxSpreadSheetObjectList); override;
    destructor Destroy; override;
    //
  ...
  protected
    ...
    function AddSharedString(const S: string): TdxSpreadSheetSharedString; overload;
    function AddSharedString(const S: string; ARuns: TdxSpreadSheetFormattedSharedStringRuns): TdxSpreadSheetSharedString; overload;
  ...
  strict private
    FIsRightToLeftLayout: Boolean;
    FRightToLeftClientBounds: TRect;
  ...
  protected
    ...
    procedure CalculateHitTest(const P: TPoint);
    procedure CheckScrollArea(const P: TPoint); virtual;
    function GetZoomFactor: Integer; override;
    function TranslateCoords(const P: TPoint): TPoint; override;

    property IsRightToLeftLayout: Boolean read FIsRightToLeftLayout;
    property RightToLeftClientBounds: TRect read FRightToLeftClientBounds;
  public
    property ContentOrigin: TPoint read GetContentOrigin;
  ...
  { TdxSpreadSheetCustomCellBasedDragAndDropObject }

  TdxSpreadSheetCustomCellBasedDragAndDropObject = class(TdxSpreadSheetCustomDragAndDropObject)
  protected
    FTableViewIntf: IdxSpreadSheetTableView;

    procedure BeforeBeginDragAndDrop; override;
    function EnsureCellInArea(const ACellRef: TPoint; const AArea: TRect): TPoint;
    function GetAbsoluteCellBounds(const ARowIndex, AColumnIndex: Integer; ACheckMergedCells: Boolean = True): TRect;
    function GetCellAtAbsolutePoint(const P: TPoint): TPoint; overload;
    function GetCellAtAbsolutePoint(const P: TPoint; out ARowIndex, AColumnIndex: Integer): Boolean; overload; virtual;
    function RightToLeftDependedPointToAbsolutePoint(const P: TPoint): TPoint;
    function ToAbsolutePoint(const P: TPoint): TPoint;
  ...
  protected
    ...
    function CreateFrameViewInfo: TdxSpreadSheetCellViewInfo; {TdxSpreadSheetTableViewSelectionFrameViewInfo} virtual;
  public
    ...
    property IsFrameVisible: Boolean read FIsFrameVisible;
  ...
  public
    ...
    function Find(AItemOwner: TObject; out AItem; AIndex: PInteger = nil): Boolean;
  ...
  public
    ...
    property LineTailRect: TRect read FLineTailRect;
  ...
  strict private
    ...
    function GetIsRightToLeftLayout: Boolean; inline;
    function GetOptionsView: TdxSpreadSheetOptionsView; inline;
  ...
  public
    ...
    procedure Offset(X: Integer; Y: Integer); override;
    procedure RightToLeftConversion(const AClientBounds: TRect); override;
    //
    ...
    property IsRightToLeftLayout: Boolean read GetIsRightToLeftLayout;
    property OptionsView: TdxSpreadSheetOptionsView read GetOptionsView;
  ...
  TdxSpreadSheetContainerCustomDragAndDropObject = class(TdxSpreadSheetCustomCellBasedDragAndDropObject)
  strict private
    FBounds: TRect;
    FContentRect: TRect;
  ...
  protected
    ...
    procedure AlignToCell(var ADeltaX, ADeltaY: Integer; P: TPoint); virtual;
    ...
    function TranslateCoords(const P: TPoint): TPoint; override;
    procedure UpdateViewInfoBounds(const AAbsoluteBounds: TRect);
  ...
  protected
    ...
    function GetDragAndDropObjectClass(AHitTest: TdxSpreadSheetCustomHitTest): TcxDragAndDropObjectClass; override;
    function GetItems: TdxSpreadSheetTableItems; virtual; abstract;
    function GetRectEdges(const R: TRect): TPoint; virtual; abstract;
    function GetResizeArea(const AResizeAreaSize: Integer): TRect; virtual; abstract;
    function GetTextColor: TColor; virtual;
    procedure Initialize(AItem: TdxSpreadSheetTableItem; AIndex: Integer; ANeighbors: TcxNeighbors; const ADisplayText: string); virtual;
    function InitHitTest(AHitTest: TdxSpreadSheetCustomHitTest): Boolean; override;
    procedure UpdateState; override;
  ...
  protected
    ...
    function GetItems: TdxSpreadSheetTableItems; override;
    function GetRectEdges(const R: TRect): TPoint; override;
  ...
  protected
    ...
    procedure CalculateDisplayStyle; override;
  ...
  protected
    ...
    class function GetMeasureTextSize(AActive: Boolean; const AFont: TFont; const AText: string): TSize; virtual;
  ...
  protected
    function GetHitTest: TdxSpreadSheetCustomHitTest; override;
    function GetSpreadSheet: TdxCustomSpreadSheet; override;
    procedure DoAddNewSheet; virtual;
    procedure DoMouseDown(Button: TMouseButton; Shift: TShiftState; X, Y: Integer); override;
    procedure DoMouseClickAtButton(AButton: TMouseButton; X, Y: Integer; AButtonViewInfo: TdxSpreadSheetPageControlButtonCellViewInfo); virtual;
    procedure DoMouseClickAtTab(AButton: TMouseButton; X, Y: Integer; ATabViewInfo: TdxSpreadSheetPageControlTabCellViewInfo); virtual;
    procedure UpdateStates; override;
  public
  ...
  strict private
    ...
    function GetLookAndFeelPainter: TcxCustomLookAndFeelPainter; inline;
    function GetPage(Index: Integer): TdxSpreadSheetCustomView;
  ...
  protected
    ...
    function FindTabViewInfo(AView: TdxSpreadSheetCustomView; out ATabViewInfo: TdxSpreadSheetPageControlTabCellViewInfo): Boolean;
    procedure RightToLeftConversion(const AClientBounds: TRect); virtual;
    procedure InitializeViewParams; virtual;
    procedure PopulatePages; virtual;
  ...
  public
    ...
    property Pages[Index: Integer]: TdxSpreadSheetCustomView read GetPage;
  ...
  public
    ...
    property SpreadSheet: TdxCustomSpreadSheet read GetSpreadSheet;
  published
    property Background: TcxStyle index ssvsBackground read GetValue write SetValue;
    property Content: TcxStyle index ssvsContent read GetValue write SetValue;
    property Header: TcxStyle  index ssvsHeader read GetValue write SetValue;
    property PageControl: TcxStyle index ssvsPageControl read GetValue write SetValue;
    property Selection: TcxStyle index ssvsSelection read GetValue write SetValue;
  end;

  { TdxSpreadSheetOptionsMetadata }

  TdxSpreadSheetOptionsMetadata = class(TcxLockablePersistent)
  strict private
    FDateTime: array[0..2] of TDateTime;
    FSpreadSheet: TdxCustomSpreadSheet;
    FStrings: array[0..5] of string;
  ...
  public
    ...
    procedure UpdateLastModificationData; virtual;
    procedure UpdateLastPrinted; virtual;
  published
    property Created: TDateTime index 0 read GetDateTime write SetDateTime;
    property CreatedBy: string index 0 read GetString write SetString;
    property Description: string index 1 read GetString write SetString;
    property Keywords: string index 2 read GetString write SetString;
    property LastModified: TDateTime index 1 read GetDateTime write SetDateTime;
    property LastModifiedBy: string index 3 read GetString write SetString;
    property LastPrinted: TDateTime index 2 read GetDateTime write SetDateTime;
    property Subject: string index 4 read GetString write SetString;
    property Title: string index 5 read GetString write SetString;
  end;
  ...
  strict private
    ...
    function GetHistoryMaxActionCount: Integer;
    function GetProtected: Boolean;
    procedure SetHistory(AValue: Boolean);
    procedure SetHistoryMaxActionCount(AValue: Integer);
  ...
  published
    ...
    property HistoryMaxActionCount: Integer read GetHistoryMaxActionCount write SetHistoryMaxActionCount default 0;
    ...
    property IterativeCalculationMaxCount: Integer read FIterativeCalculationMaxCount write SetIterativeCalculationMaxCount default 1;
    property Protected: Boolean read GetProtected write SetProtected stored False; // obsolete
  end;
  ...
  { TdxSpreadSheetHistoryChangeDefinedNameAction }

  TdxSpreadSheetHistoryChangeDefinedNameAction = class(TdxSpreadSheetHistoryAction)
  protected
    class function GetDescription: string; override;
  end;

  { TdxSpreadSheetHistoryDeleteDefinedNameAction }

  TdxSpreadSheetHistoryDeleteDefinedNameAction = class(TdxSpreadSheetHistoryAction)
  protected
    class function GetDescription: string; override;
  end;
  ...
  strict private
    ...
    procedure SetMaxActionCount(AValue: Integer);
  protected
  ...
  public
    ...
    property MaxActionCount: Integer read FMaxActionCount write SetMaxActionCount;
  ...
  { TdxSpreadSheetChangeAggregator }

  TdxSpreadSheetChangeAggregator = class
  strict private
    FHandler: TProc;
    FLastChangeTimestamp: Cardinal;
    FTimer: TcxTimer;
  ...
  protected
    procedure Process;
  public
    constructor Create(AChangeHandler: TProc; AWaitInterval: Cardinal); reintroduce;
    destructor Destroy; override;
    procedure Changed;
    procedure Flush;
    procedure ForceProcess;
  end;
  ...
  strict private
    ...
    FOptionsMetadata: TdxSpreadSheetOptionsMetadata;
    ...
    FUpdateMetadataHelper: TdxSpreadSheetChangeAggregator;
    ...
    FOnPageControlContextPopup: TdxSpreadSheetPageControlContextPopupEvent;
    FOnPageControlNewTabButtonClick: TdxSpreadSheetPageControlNewTabButtonClickEvent;
    FOnPageControlTabDragAndDrop: TdxSpreadSheetPageControlTabDragAndDropEvent;
    FOnPageControlTabEndDrag: TdxSpreadSheetPageControlTabEndDragEvent;
    FOnPageControlTabStartDrag: TdxSpreadSheetPageControlTabStartDragEvent;
    FOnPrepareLockedStateImage: TdxSpreadSheetPrepareLockedStateImageEvent;
    FOnProgress: TdxSpreadSheetProgressEvent;
    FOnScroll: TdxSpreadSheetScrollEvent;
    FOnSelectionChanged: TNotifyEvent;
    FOnTableViewContextPopup: TdxSpreadSheetTableViewContextPopupEvent;
    ...
    procedure SetOptionsMetadata(AValue: TdxSpreadSheetOptionsMetadata);
  ...
  protected
    ...
    function CreateOptionsMetadata: TdxSpreadSheetOptionsMetadata; virtual;
    ...
    function CreateUpdateMetadataHelper: TdxSpreadSheetChangeAggregator; virtual;
    ...
    function DoPageControlContextPopup(const P: TPoint; APopupMenu: TPopupMenu): Boolean; virtual;
    function DoPageControlTabNewTabButtonClick: Boolean; virtual;
    procedure DoPageControlTabStartDrag(AIndex: Integer); virtual;
    procedure DoPageControlTabDragAndDrop(AIndex, ANewIndex: Integer; var AAccepted: Boolean); virtual;
    procedure DoPageControlTabEndDrag(AOldIndex, AIndex: Integer); virtual;
    ...
    function DoTableViewContextPopup(const P: TPoint; APopupMenu: TPopupMenu): Boolean; virtual;
    ...
    // RTL
    procedure SetActualBiDiMode(AValue: TBiDiMode);
    ...
    property UpdateMetadataHelper: TdxSpreadSheetChangeAggregator read FUpdateMetadataHelper;
    ...
    property OnPageControlContextPopup: TdxSpreadSheetPageControlContextPopupEvent read FOnPageControlContextPopup write FOnPageControlContextPopup;
    property OnPageControlNewTabButtonClick: TdxSpreadSheetPageControlNewTabButtonClickEvent read FOnPageControlNewTabButtonClick write FOnPageControlNewTabButtonClick;
    property OnPageControlTabDragAndDrop: TdxSpreadSheetPageControlTabDragAndDropEvent read FOnPageControlTabDragAndDrop write FOnPageControlTabDragAndDrop;
    property OnPageControlTabEndDrag: TdxSpreadSheetPageControlTabEndDragEvent read FOnPageControlTabEndDrag write FOnPageControlTabEndDrag;
    property OnPageControlTabStartDrag: TdxSpreadSheetPageControlTabStartDragEvent read FOnPageControlTabStartDrag write FOnPageControlTabStartDrag;
    ...
    property OnTableViewContextPopup: TdxSpreadSheetTableViewContextPopupEvent read FOnTableViewContextPopup write FOnTableViewContextPopup;
  public
    constructor Create(AOwner: TComponent); override;
    destructor Destroy; override;
    procedure AfterConstruction; override;
  ...
  {$WARNINGS ON}
    ...
    property OptionsMetadata: TdxSpreadSheetOptionsMetadata read FOptionsMetadata write SetOptionsMetadata;
  ...
  TdxSpreadSheetShrinkToFitCalculator = class(TdxAdjustFontSizeHelper)
  strict private
    FCell: TdxSpreadSheetCell;
    FStyle: TdxSpreadSheetCellDisplayStyle;
  public
    constructor Create(ACell: TdxSpreadSheetCell; AStyle: TdxSpreadSheetCellDisplayStyle); virtual;
    function Calculate(AWidth: Integer): TdxSpreadSheetFontHandle; reintroduce;
    //
    property Cell: TdxSpreadSheetCell read FCell;
    property Style: TdxSpreadSheetCellDisplayStyle read FStyle;
  end;
  ...
  public
    class procedure CalculateSize(ACell: TdxSpreadSheetCell; ACanvas: TcxCanvas; const ABounds: TRect;
      AIsMerged: Boolean; AWidth, AHeight: PInteger; AStyle: TdxSpreadSheetCellStyleHandle = nil); virtual;
    class function CreateShrinkToFitCalculator(ACell: TdxSpreadSheetCell;
      AStyle: TdxSpreadSheetCellDisplayStyle): TdxSpreadSheetShrinkToFitCalculator; virtual;
    ...
    class procedure MeasureSize(ACanvas: TcxCanvas; ACell: TdxSpreadSheetCell;
      AWidth, AHeight: PInteger; ADisplayStyle: TdxSpreadSheetCellDisplayStyle = nil); virtual;
...
uses
  Consts, RTLConsts, dxTypeHelpers, dxOLECryptoContainerStrs, dxDPIAwareUtils, dxStringHelper, dxGDIPlusAPI,
  // SpreadSheet - Formats
  ...
  dxSpreadSheetEditHyperlinkDialog,
  dxSpreadSheetFindAndReplaceDialog,
  dxSpreadSheetFormatCellsDialog,
  dxSpreadSheetPasswordDialog,
  dxSpreadSheetProtectSheetDialog,
  dxSpreadSheetProtectWorkbookDialog,
  dxSpreadSheetDefinedNameManagerDialog,
  //
  dxSpreadSheetFormulas, dxSpreadSheetFunctions, dxSpreadSheetCoreHelpers, dxSpreadSheetPopupMenu,
  dxSpreadSheetCoreHistory, dxSpreadSheetFormattedTextUtils, dxSpreadSheetConditionalFormattingIconSet,
  dxSpreadSheetContainers, dxSpreadSheetClipboard, dxSpreadSheetSelection, dxSpreadSheetClipboardFormats,
  dxSpreadSheetAutoFilling, dxSpreadSheetCoreStrs, dxSpreadSheetActions, dxSpreadSheetFormulasHelpers;

const
  dxThisUnitName = 'dxSpreadSheetCore';
...
function dxIsMultilineText(const S: string): Boolean;
begin
  Result := (Pos(dxCR, S) > 0) or (Pos(dxLF, S) > 0);
end;

function dxRemoveLineBreaks(const S: string): string;
begin
  Result := S;
  Result := StringReplace(Result, dxCR, '', [rfReplaceAll]);
  Result := StringReplace(Result, dxLF, '', [rfReplaceAll]);
end;
...
procedure TdxSpreadSheetObjectList.BeforeDestruction;
begin
  inherited;
  Clear;
end;
...
procedure TdxSpreadSheetObjectList.DoClear;
var
  I: Integer;
begin
  for I := Count - 1 downto 0 do
...
destructor TdxSpreadSheetCellDisplayValue.Destroy;
begin
  Font := nil;
  inherited;
end;
...
begin
  ...
  begin
    ...
    if not ACell.IsMultiline and dxDefaultBooleanToBoolean(FFormattedValue.IsText, ACell.DataType = cdtString) then
    begin
      if dxIsMultilineText(FFormattedValue.Text) then
        FFormattedValue.Text := dxRemoveLineBreaks(FFormattedValue.Text);
    end;
  end;
  Result := FFormattedValue;
end;

procedure TdxSpreadSheetCellDisplayValue.SetFont(const Value: TdxSpreadSheetFontHandle);
begin
  dxChangeHandle(FFont, Value);
end;
...
procedure TdxSpreadSheetCell.Dormant;
begin
  ReleaseDisplayValue;
  ReleaseWrappers;
end;
...
begin
  if Self <> nil then
    Result := View.GetAbsoluteCellBounds(RowIndex, ColumnIndex, False)
  else
    Result := cxNullRect;
end;
...
var
  AFormulaArea: TRect;
begin
  if not SpreadSheet.FormulaController.UpdatingSlaveCells and (IsPartOfArrayFormula(AFormulaArea) <> afpNone)
     and dxSpreadSheetIsValidArea(AFormulaArea) and not cxPointIsEqual(AFormulaArea.TopLeft, AFormulaArea.BottomRight) then
    raise EdxSpreadSheetCannotChangePartOfArrayError.Create(cxGetResourceString(@sdxErrorCannotChangePartOfArray));
  SetTextCore(AText, AFormulaChecking, AFormulaChecking and (AsFormula <> nil) and AsFormula.IsArrayFormula);
end;
...
begin
  ARow := Row;
  if [sscData, sscStyle] * AChanges <> [] then
  begin
    ReleaseDisplayValue; // first
    if not ARow.IsCustomSize then
      ARow.FBestFitIsDirty := True;
  end;
  if (sscData in AChanges) and (IsPartOfArrayFormula(AFormulaArea) = afpSlaveCell) then
    Exclude(AChanges, sscData);
...
begin
  if AParentToken = nil then
    Exit;
  if AParentToken is TdxSpreadSheetFormulaAreaReferenceToken then
    TdxSpreadSheetFormulaAreaReferenceToken(AParentToken).Check
  else
  begin
...
begin
  ...
  begin
    AItem := nil;
    if ARow.FCells <> nil then
      AItem := ARow.FCells.FindItem(AColumn.Index);
    ...
    if FOwner <> nil then
      TdxSpreadSheetTableRowCells(FOwner).DeleteItem(Self);

    ARow.CheckCellsCreated;
    FOwner := ARow.FCells;
    FIndex := AColumn.Index;
    TdxSpreadSheetTableRowCells(FOwner).InsertItem(Self, AItem);
...
begin
  AColumnIndex := EnsureRange(AColumnIndex, 0, dxSpreadSheetMaxColumnIndex);
  ARowIndex := EnsureRange(ARowIndex, 0, dxSpreadSheetMaxRowIndex);
...
begin
  if APrevStyle.Borders <> ANewStyle.Borders then
  begin
    AView := View;
    ACellStyles := AView.CellStyles;
    if not ANewStyle.Borders.IsEqual(APrevStyle.Borders, bLeft) then
      TdxSpreadSheetCellStyleHelper.MergeBorders(AView.Cells[RowIndex, ColumnIndex - 1], nil, nil, Self, nil, ACellStyles, False);
    if not ANewStyle.Borders.IsEqual(APrevStyle.Borders, bTop) then
      TdxSpreadSheetCellStyleHelper.MergeBorders(AView.Cells[RowIndex - 1, ColumnIndex], nil, nil, nil, Self, ACellStyles, False);
    if not ANewStyle.Borders.IsEqual(APrevStyle.Borders, bRight) then
      TdxSpreadSheetCellStyleHelper.MergeBorders(AView.Cells[RowIndex, ColumnIndex + 1], Self, nil, nil, nil, ACellStyles, False);
    if not ANewStyle.Borders.IsEqual(APrevStyle.Borders, bBottom) then
      TdxSpreadSheetCellStyleHelper.MergeBorders(AView.Cells[RowIndex + 1, ColumnIndex], nil, Self, nil, nil, ACellStyles, False);
  end;
...
function TdxSpreadSheetCell.GetAsString: string;
  ...
  function DateTimeToString(const AValue: TDateTime): string;
  begin
...
begin
  case DataType of
    ...
    cdtBoolean:
      Result := dxBoolToString[AsBoolean];
    cdtCurrency:
      Result := CurrToStr(AsCurrency);
    cdtInteger:
      Result := IntToStr(AsInteger);
    cdtDateTime:
      Result := DateTimeToString(AsDateTime);
    cdtError:
      Result := dxSpreadSheetErrorCodeToString(AsError);

    cdtFloat:
      if StyleHandle.DataFormat.IsTime then
        Result := TimeToStr(AsFloat)
      else if TryGetFloatAsDateTime(ADateTime) then
        Result := DateTimeToString(ADateTime)
      else
...
begin
  case DataType of
    ...
    cdtFloat:
      if TryGetFloatAsDateTime(ADateTime) then
        Result := ADateTime
      else
        Result := AsFloat;
  else
...
function TdxSpreadSheetCell.GetDisplayValueDataType: TdxSpreadSheetCellDataType;
begin
  Result := FDataType;
  if Result = cdtFormula then
  begin
    if AsFormula.ActualErrorCode <> ecNone then
      Result := cdtError
    else
...
function TdxSpreadSheetCell.GetNext: TdxSpreadSheetCell;
begin
  Result := TdxSpreadSheetCell(FNext);
end;

function TdxSpreadSheetCell.GetPrev: TdxSpreadSheetCell;
begin
  Result := TdxSpreadSheetCell(FPrev);
end;
  ...
  if (FStyleObject <> nil) and (FStyleObject.ClassType = TdxSpreadSheetCellStyle) then
    ...
    begin
      if (FStyleObject <> nil) and (AValue <> nil) then
        CellStyleChanging;
      if dxChangeHandle(FStyleObject, AValue) then
        StyleChanged;
    end;
end;

function TdxSpreadSheetCell.TryGetFloatAsDateTime(out ADateTime: TDateTime): Boolean;
begin
  Result := StyleHandle.DataFormat.IsDateTime and dxIsValidDateTime(AsFloat);
  if Result then
    ADateTime := cxFloatToDateTime(AsFloat);
end;
...
function TdxSpreadSheetCell.IsPartOfArrayFormula(var AFormulaArea: TRect; AFormula:
  PdxSpreadSheetCustomFormula = nil): TdxSpreadSheetArrayFormulaPart;
var
  ARow: TdxSpreadSheetTableRow;
  AView: TdxSpreadSheetTableView;
begin
  ARow := Row;
  AView := ARow.View;
  Result := AView.SpreadSheet.FormulaController.IsPartOfArrayFormula(AView, ARow.Index, ColumnIndex, AFormulaArea, AFormula);
end;
...
begin
  Result := DisplayValueDataType in [cdtCurrency, cdtFloat, cdtInteger, cdtDateTime];
end;
...
begin
  ...
  ATempValue := cxFloatToDateTime(AValue);
  if InRange(ATempValue, 1, 60) then
    ATempValue := ATempValue - 1;

  if (DataType <> cdtDateTime) or (AsDateTime <> ATempValue) then
  begin
    CheckAndDeleteObjectData;
    FDataType := cdtDateTime;
    PDateTime(@FData)^ := ATempValue;
    CheckDefaultCellFormat;
    Changed([sscData, sscModified]);
  end;
end;
...
procedure TdxSpreadSheetCell.SetTextCore(const AText: string; const AFormulaChecking, AArrayFormulaAttributeIsDirty: Boolean);

  procedure CheckFormula(const AText: string);
  var
    AParser: TdxSpreadSheetFormulaParser;
  begin
    if History.InProcess or (AsFormula = nil) or
      (dxSpreadSheetFormulaIncludeEqualSymbol(AsFormula.SourceText) <> AText) or AArrayFormulaAttributeIsDirty then
    begin
...
begin
  ...
  try
    if dxSpreadSheetIsErrorString(AText, AErrorCode) and (AErrorCode <> ecNone) then
      AsError := AErrorCode
    else if StyleHandle.DataFormat.IsText and (AText <> '') then
      AsString := AText
    ...
    if (DataType = cdtString) and dxIsMultilineText(AsString) then
      Style.WordWrap := True;
  finally
    View.EndUpdate;
  end;
...
begin
  SpreadSheet.BeginUpdate;
  try
    if [ccAnchors, ccPosition, ccTransform, ccVisibility] * AChanges <> [] then
      SpreadSheet.AddChanges([sscLayout]);
    if ccContent in AChanges then
      SpreadSheet.AddChanges([sscData]);
    SpreadSheet.AddChanges([sscModified]);
  finally
    SpreadSheet.EndUpdate;
  end;
end;
...
procedure TdxSpreadSheetContainer.SetName(const Value: string);
begin
  if FName <> Value then
  begin
    FName := Value;
...
begin
  Result := ACell.View.Caption + '.' + TdxSpreadSheetColumnReferences.NameByIndex(ACell.ColumnIndex) + IntToStr(ACell.RowIndex + 1);
end;
...
begin
  ...
  case AnchorType of
    catOneCell, catTwoCell:
      Result.TopLeft := CalculateOffset(AnchorPoint1.Cell.GetAbsoluteBounds, AnchorPoint1.Offset);
    catAbsolute:
  ...
  case AnchorType of
    ...
    catTwoCell:
      Result.BottomRight := CalculateOffset(AnchorPoint2.Cell.GetAbsoluteBounds, AnchorPoint2.Offset);
  end;
    ...
    case AnchorType of
      catOneCell:
        ...
        begin
          ...
          AnchorPoint1.Offset := cxPointOffset(ARect.TopLeft, ACell1.GetAbsoluteBounds.TopLeft, False);
      ...
      catTwoCell:
        ...
        begin
          ...
          AnchorPoint2.Offset := cxPointOffset(ARect.BottomRight, ACell2.GetAbsoluteBounds.TopLeft, False);
        end
        else
          AnchorType := catAbsolute;
    end;
...
begin
  if Supports(Owner.Parent, IdxSpreadSheetTableView, ATableView) then
    Result := ATableView.GetAbsoluteCellsArea
  else
    Result := cxNullRect;
end;
...
begin
  ...
  UpdateAnchors(ValidateBounds(ARect));
end;
...
function TdxSpreadSheetContainerCalculator.ValidateBounds(const R: TRect): TRect;
var
  AContentRect: TRect;
  ADeltaX: Integer;
  ADeltaY: Integer;
...
begin
  ...
  if AView <> nil then
  begin
    if AView.ViewInfo.Containers.Find(Owner, AViewInfo) then
    begin
  ...
  try
    ...
    begin
      ...
      try
        ...
        Result.Calculator.UpdateAnchors(TdxSpreadSheetCommentContainer.GetDefaultPosition(ACell));
      finally
        Result.EndChanging;
      end;
    end;
...
function TdxSpreadSheetContainers.FindByName(const AName: string; out AContainer: TdxSpreadSheetContainer): Boolean;
var
  I: Integer;
begin
  Result := False;
  if AName <> '' then
    ...
    begin
      Result := dxSameText(AName, Items[I].Name);
      if Result then
      begin
        AContainer := Items[I];
        Break;
...
begin
  if AReader.Version < 4 then
    raise EdxSpreadSheetFormatError.Create('Unsupported operation');
...
begin
  ...
  if not AParser.FormatSettings.R1C1Reference then
...
procedure TdxSpreadSheetFormulaAsTextInfo.ResolveValues;
begin
  if Cell <> nil then
    Cell.AsVariant := FormulaResult;
end;
...
begin
  ...
  try
    for I := 0 to Count - 1 do
      Items[I].ResolveReferences(AParser);
  finally
    AParser.Free;
  end;
end;

procedure TdxSpreadSheetFormulaAsTextInfoList.ResolveValues;
var
  I: Integer;
begin
  for I := 0 to Count - 1 do
    Items[I].ResolveValues;
end;
...
procedure TdxSpreadSheetDefinedNameFormula.AfterConstruction;
begin
  inherited;
  Controller.Add(Self);
end;

procedure TdxSpreadSheetDefinedNameFormula.CalculateResultValue;
begin
  ClearValueAsText;
  inherited;
  if Iteration = 0 then
...
procedure TdxSpreadSheetDefinedNameFormula.ClearResult;
begin
  inherited;
  ClearValueAsText;
end;

procedure TdxSpreadSheetDefinedNameFormula.ClearValueAsText;
begin
  FValueAsText := Null;
end;
...
function TdxSpreadSheetDefinedNameFormula.GetValueAsText: string;
begin
  if VarIsNull(FValueAsText) then
  begin
    FValueAsText := ''; 
    FValueAsText := inherited GetValueAsText;
  end;
  Result := FValueAsText;
end;
...
begin
  if FOwner.OptionsBehavior.IterativeCalculation then
    FMaxIterationCount := Max(FOwner.OptionsBehavior.IterativeCalculationMaxCount, 0) + 1
  else
...
procedure TdxSpreadSheetFormulaController.UpdateTokens(AFunc: TUpdateTokenFunc; AMinClass: TdxSpreadSheetFormulaTokenClass = nil);

  function ProcessTokens(AToken: TdxSpreadSheetFormulaToken): Boolean;
  begin
    Result := (AToken <> nil) and ((AMinClass = nil) or AToken.InheritsFrom(AMinClass)) and AFunc(AToken);
    while AToken <> nil do
    begin
...
function TdxSpreadSheetFormulaController.GetItem(Index: TdxListIndex): TdxSpreadSheetFormula;
begin
...
procedure TdxSpreadSheetCustomController.DblClick(const AUnscaledPos: TPoint);
begin
  // do nothing
end;
...
procedure TdxSpreadSheetCustomViewOptions.Changed(AChanges: TdxSpreadSheetChanges);
begin
  if AChanges <> [] then
  begin
    FChanges := FChanges + AChanges + [sscModified];
    inherited Changed;
  end;
end;
...
begin
  inherited Create(AOwner);
  FReferenceLinkHost := TdxSpreadSheetObjectLink.Create(Self);
  FVisible := True;
  CreateSubClasses;
...
begin
  inherited BeforeDestruction;
  FIsDestroying := True;
  SpreadSheet.DoRemoveSheet(Self); // before cxClearObjectLinks
  cxClearObjectLinks(Self);
  FReferenceLinkHost.ReleaseObject;
  FReferenceLinkHost := nil;
end;
...
begin
  if (Changes <> []) and not (IsLocked or SpreadSheet.FormulaController.CalculationInProcess) then
    DoCheckChanges;
end;
...
begin
  ADelta := [sscData, sscBiDiMode, sscStyle, sscModified] * Changes;
  if ADelta <> [] then
  begin
...
function TdxSpreadSheetCustomView.IsCaptionMustBeEscaped: Boolean;
begin
  Result := FIsCaptionMustBeEscaped;
end;

function TdxSpreadSheetCustomView.IsRightToLeftLayout: Boolean;
begin
  Result := False;
end;

procedure TdxSpreadSheetCustomView.ClearModified;
begin
...
begin
  ...
  begin
    ...
    if (ASheet <> Self) and dxSpreadSheetTextIsEqual(ASheet.Caption, FCaption) then
      Abort;
  end;
  FIsCaptionMustBeEscaped := TdxSpreadSheetReferenceAsString.CheckIfViewNameMustBeEscaped(
    FCaption, FormatSettings.BreakChars + FormatSettings.Data.DecimalSeparator);
end;
...
function TdxSpreadSheetCustomView.GetBoundsForRightToLeftConversion: TRect;
begin
  Result := SpreadSheet.Bounds;
end;
...
begin
  Result := (FLockCount > 0) or FIsDestroying or SpreadSheet.IsLocked;
end;
...
var
  AOldCaption: string;
begin
  dxSpreadSheetValidateCaption(AValue);
...
begin
  Painter.FlushCache;
  FIsRightToLeftLayout := False;
  FIsDirty := False;

  FBounds := View.Bounds;
  if SpreadSheet.UseRightToLeftScrollBar and not SpreadSheet.IsPopupScrollBars then
    FBounds := cxRectOffset(FBounds, -SpreadSheet.GetVScrollBarAreaWidth, 0);
...
procedure TdxSpreadSheetCustomViewViewInfo.AfterCalculate;
begin
  if View.IsRightToLeftLayout then
  begin
    FIsRightToLeftLayout := True;
    RightToLeftConversion(cxRectScale(View.BoundsForRightToLeftConversion, 100, View.ZoomFactor));
  end;
end;

procedure TdxSpreadSheetCustomViewViewInfo.BeforeCalculate;
begin
  // do nothing
end;

procedure TdxSpreadSheetCustomViewViewInfo.CalculateCore;
begin
  // do nothing
end;

procedure TdxSpreadSheetCustomViewViewInfo.CalculateContainerDependedCells(AContainerViewInfo: TdxSpreadSheetContainerViewInfo);
begin
  // do nothing
end;
...
begin
  ...
  for AComments := False to True do
    ...
    begin
      ...
      begin
        if Containers.Find(AContainer, ACell, @AIndex) then
...
procedure TdxSpreadSheetCustomViewViewInfo.RightToLeftConversion(const AClientBounds: TRect);
begin
  FBounds := TdxRightToLeftLayoutConverter.ConvertRect(FBounds, AClientBounds);
  Containers.RightToLeftConversion(AClientBounds);
end;
...
function TdxSpreadSheetCustomViewViewInfo.GetContentOrigin: TPoint;
begin
  Result := cxNullPoint;
end;
...
procedure TdxSpreadSheetCustomViewViewInfo.InitViewParams;
begin
  // do nothing
end;
...
procedure TdxSpreadSheetViewList.ClearModified;
var
  I: Integer;
begin
  for I := 0 to Count - 1 do
...
function TdxSpreadSheetViewList.GetItem(Index: TdxListIndex): TdxSpreadSheetCustomView;
begin
...
function TdxSpreadSheetMergedCellList.Add(const AArea: TRect): TdxSpreadSheetMergedCell;
begin
  Result := nil;
  ...
  begin
    ...
    try
      ...
      Result := TdxSpreadSheetMergedCell(inherited Add);
      Inc(FCount);
      if History.CanAddCommand then
      begin
        History.BeginAction(TdxSpreadSheetHistoryMergeCellsAction);
        try
          History.AddCommand(TdxSpreadSheetHistoryMergeCellsCommand.Create(Result, AArea));
          InitializeCell(Result, AArea);
        finally
...
function TdxSpreadSheetMergedCellList.Add(const AArea: string): TdxSpreadSheetMergedCell;
begin
  Result := Add(View.StringToAreaReference(AArea));
end;
...
begin
  ...
  if ([sssReading, sssReadingFromClipboard] * View.State = []) and not History.InProcess then
    TdxSpreadSheetTableViewMergedCellStyleHelper.Calculate(ACell);
  Changed;
end;
...
procedure TdxSpreadSheetTableItem.ApplyBestFitCore(ACanvas: TcxCanvas);
var
  ASize: Integer;
begin
  if Visible then
  begin
    ASize := CalculateBestFit(ACanvas);
    if ASize = 0 then
...
function TdxSpreadSheetTableItem.HasCells: Boolean;
var
  I: Integer;
begin
  for I := 0 to CellCount - 1 do
...
function TdxSpreadSheetTableItem.HasNonEmptyCells: Boolean;
var
  AItems: TdxSpreadSheetTableItems;
begin
  AItems := Owner.GetOppositeItems;
  Result := HasNonEmptyCells(AItems.FirstIndex, AItems.LastIndex);
end;

function TdxSpreadSheetTableItem.HasNonEmptyCells(ARangeStart, ARangeFinish: Integer): Boolean;
var
  ACell :TdxSpreadSheetCell;
begin
  while ARangeStart <= ARangeFinish do
  begin
    ACell := Cells[ARangeStart];
...
var
  AGroup: TdxSpreadSheetTableItemGroup;
begin
  AStartIndex := EnsureRange(AStartIndex, 0, Root.Owner.GetMaxItemIndex);
  AFinishIndex := EnsureRange(AFinishIndex, 0, Root.Owner.GetMaxItemIndex);
...
function TdxSpreadSheetTableItems.GetItemVisibleCount(AStartIndex, AFinishIndex: Integer): Integer;
var
  AHiddenCount: Integer;
  AItem: TdxSpreadSheetTableItem;
begin
  AHiddenCount := 0;
  AItem := First;
  ...
  Result := AFinishIndex - AStartIndex + 1 - AHiddenCount;
end;
...
function TdxSpreadSheetTableItems.IsItemSelected(AIndex: Integer): Boolean;
begin
  Result := False;
end;
...
function TdxSpreadSheetTableColumn.CalculateBestFit(ACanvas: TcxCanvas): Integer;
var
  ASize: Integer;
  AStyle: TdxSpreadSheetCellDisplayStyle;
begin
  ASize := 0;
  AStyle := TdxSpreadSheetCellDisplayStyle.Create(View);
  try
    EnumCells(
      ...
      var
        ACellSize: Integer;
      begin
        dxSpreadSheetTextService.MeasureSize(ACanvas, ACell, @ACellSize, nil, AStyle);
        ASize := Max(ASize, ACellSize);
      end);
  finally
    AStyle.Free;
  end;
...
begin
  Result := TdxSpreadSheetColumnReferences.NameByIndex(AIndex, View.SpreadSheet.OptionsView.R1C1Reference);
end;
...
function TdxSpreadSheetTableColumns.IsItemSelected(AIndex: Integer): Boolean;
begin
  Result := View.Selection.IsColumnSelected(AIndex);
end;
...
procedure TdxSpreadSheetTableRow.ApplyBestFitCore(ACanvas: TcxCanvas);
begin
  inherited;
  FBestFitIsDirty := False;
end;

function TdxSpreadSheetTableRow.CalculateBestFit(ACanvas: TcxCanvas): Integer;
var
  ASize: Integer;
begin
  ASize := Owner.DefaultSize;
  EnumCells(
    ...
    var
      ACellSize: Integer;
    begin
      dxSpreadSheetTextService.MeasureSize(ACanvas, ACell, nil, @ACellSize);
      ASize := Max(ASize, ACellSize);
    end);
  Result := ASize;
end;

procedure TdxSpreadSheetTableRow.CheckCellsCreated;
begin
  if FCells = nil then
...
begin
  if not (sssReadingCells in View.State) then
    TdxSpreadSheetCellStyleHelper.Calculate(ACell);
  Changed;
end;

procedure TdxSpreadSheetTableRow.ForEachCell(
  const AProc: TdxSpreadSheetTableViewForEachCellProc;
  AStartIndex, AFinishIndex: Integer; AGoForward: Boolean);
var
  ACell: TdxSpreadSheetCell;
  ANextCell: TdxSpreadSheetCell;
begin
  if FCells = nil then
    Exit;
  if AGoForward then
  begin
    ACell := TdxSpreadSheetCell(FCells.First);
    while (ACell <> nil) and (ACell.Index < AStartIndex) do
      ACell := ACell.Next;
    while (ACell <> nil) and (ACell.Index <= AFinishIndex) do
    begin
  ...
  begin
    ACell := TdxSpreadSheetCell(FCells.FLast);
    while (ACell <> nil) and (ACell.Index > AFinishIndex) do
      ACell := ACell.Prev;
    while (ACell <> nil) and (ACell.Index >= AStartIndex) do
    begin
      ANextCell := ACell.Prev;
      AProc(ACell);
      ACell := ANextCell;
    end;
  end;
...
begin
  if (FCells <> nil) and (FCells.FLast <> nil) then
    Result := FCells.FLast.Index + 1
  else
    Result := 0;
end;

function TdxSpreadSheetTableRow.GetFirstCell: TdxSpreadSheetCell;
begin
  if FCells <> nil then
    Result := TdxSpreadSheetCell(FCells.First)
  else
    Result := nil;
end;

function TdxSpreadSheetTableRow.GetLastCell: TdxSpreadSheetCell;
begin
  if FCells <> nil then
    Result := TdxSpreadSheetCell(FCells.Last)
  else
    Result := nil;
end;

function TdxSpreadSheetTableRow.HasCells: Boolean;
begin
  Result := (FCells <> nil) and (FCells.First <> nil);
end;

function TdxSpreadSheetTableRow.HasNonEmptyCells(ARangeStart, ARangeFinish: Integer): Boolean;
var
  ACell: TdxSpreadSheetCell;
begin
  if FCells <> nil then
  begin
    ACell := TdxSpreadSheetCell(FCells.First);
    while (ACell <> nil) and (ACell.Index <  ARangeStart) do
      ACell := ACell.Next;
    while (ACell <> nil) and (ACell.Index <= ARangeFinish) do
    begin
...
procedure TdxSpreadSheetTableRow.ReleaseCells;
begin
  FreeAndNil(FCells);
end;
...
var
  ...
  ARow: TdxSpreadSheetTableRow;
begin
  if SpreadSheet.OptionsView.CellAutoHeight and not View.History.InProcess then
  begin
    View.BeginUpdate;
    try
      ACanvas := cxMeasureCanvas;
      APrevDPI := dxSpreadSheetPrepareCanvas(ACanvas, SpreadSheet.Font, dxDefaultDPI);
      try
        ARow := TdxSpreadSheetTableRow(First);
        while ARow <> nil do
        begin
          if ARow.FBestFitIsDirty then
          begin
            if not ARow.IsCustomSize then
              ARow.ApplyBestFitCore(ACanvas);
...
procedure TdxSpreadSheetTableRows.DeleteAllCells;
var
  ARow: TdxSpreadSheetTableRow;
begin
  ARow := TdxSpreadSheetTableRow(FFirst);
  while ARow <> nil do
  begin
    ARow.ReleaseCells;
    ARow := TdxSpreadSheetTableRow(ARow.FNext);
  end;
end;

procedure TdxSpreadSheetTableRows.ForEachCell(const AArea: TRect; const AProc: TdxSpreadSheetTableViewForEachCellProc);
begin
  ForEachCell(AArea, AProc, True, True);
end;

procedure TdxSpreadSheetTableRows.ForEachCell(
  const AArea: TRect; const AProc: TdxSpreadSheetTableViewForEachCellProc;
  AGoForwardVertically, AGoForwardHorizontally: Boolean);
var
  ARow: TdxSpreadSheetTableRow;
begin
  if AGoForwardVertically then
  begin
    ARow := TdxSpreadSheetTableRow(First);
    ...
    begin
      ARow.ForEachCell(AProc, AArea.Left, AArea.Right, AGoForwardHorizontally);
      ARow := TdxSpreadSheetTableRow(ARow.Next);
    end;
  end
  else
  begin
    ARow := TdxSpreadSheetTableRow(Last);
    while (ARow <> nil) and (ARow.Index > AArea.Bottom) do
      ARow := TdxSpreadSheetTableRow(ARow.Prev);
    while (ARow <> nil) and (ARow.Index >= AArea.Top) do
    begin
      ARow.ForEachCell(AProc, AArea.Left, AArea.Right, AGoForwardHorizontally);
      ARow := TdxSpreadSheetTableRow(ARow.Prev);
...
function TdxSpreadSheetTableRows.IsItemSelected(AIndex: Integer): Boolean;
begin
  Result := View.Selection.IsRowSelected(AIndex);
end;
...
begin
  ...
  begin
    ...
    FRightToLeftLayout := TdxSpreadSheetTableViewOptions(Source).RightToLeftLayout;
...
function TdxSpreadSheetTableViewOptions.GetActualRightToLeftLayout: Boolean;
begin
  Result := dxDefaultBooleanToBoolean(RightToLeftLayout, View.SpreadSheet.BiDiMode = bdRightToLeft);
end;
...
procedure TdxSpreadSheetTableViewOptions.SetRightToLeftLayout(AValue: TdxDefaultBoolean);
begin
...
begin
  ...
  begin
    ARect := TcxRect(FItems.Last);
    if not dxSpreadSheetContains(ARect.Rect, APrevRow, APrevColumn) then
    begin
      APrevArea := ARect.Rect;
...
procedure TdxSpreadSheetTableViewSelection.Add(const AArea: string; AShift: TShiftState = []);
begin
  Add(View.StringToAreaReference(AArea), AShift);
end;

procedure TdxSpreadSheetTableViewSelection.Add(const AArea: string; AShift: TShiftState; const AFocusedCell: string);
var
  AFocusedCellArea: TRect;
begin
  AFocusedCellArea := View.StringToAreaReference(AFocusedCell);
  Add(View.StringToAreaReference(AArea), AShift, AFocusedCellArea.Top, AFocusedCellArea.Left);
end;
...
begin
  for I := 0 to Count - 1 do
  begin
    if cxRectIsEqual(AArea, Items[I].Rect) then
      Exit(True);
  end;
  Result := False;
end;
...
var
  I: Integer;
begin
  Result := (ARow = FocusedRow) and (AColumn = FocusedColumn) and (FocusedRow >= 0) and (FocusedColumn >= 0);
  I := 0;
...
begin
  I := 0;
  Result := (AColumn = FocusedColumn) and (FocusedColumn >= 0);
  while not Result and (I < Count) do
  begin
...
begin
  I := 0;
  Result := (ARow = FocusedRow) and (FocusedRow >= 0);
  while not Result and (I < Count) do
  begin
...
begin
  Add(cxRect(AColumn, ARow, AColumn, ARow), AShift);
end;

procedure TdxSpreadSheetTableViewSelection.SelectColumns(AStartColumn, AFinishColumn: Integer; AShift: TShiftState = []);
var
  AFocusedColumn: Integer;
  AFocusedRow: Integer;
begin
  AFocusedColumn := FocusedColumn;
  AFocusedRow := FocusedRow;
  if not (ssShift in AShift) or not cxInRange(AFocusedRow, View.TopRow, View.BottomRow) or not SelectionByColumns then
    AFocusedRow := View.TopRow;
  if not (ssShift in AShift) then
    AFocusedColumn := -1;
  Add(cxRect(AStartColumn, 0, AFinishColumn, dxSpreadSheetMaxRowIndex), AShift, AFocusedRow, AFocusedColumn);
end;
...
begin
  AFocusedRow := FocusedRow;
  AFocusedColumn := FocusedColumn;
  if not (ssShift in AShift) and not cxInRange(AFocusedColumn, View.LeftColumn, View.RightColumn) or not SelectionByRows then
    AFocusedColumn := View.LeftColumn;
  if not (ssShift in AShift) then
    AFocusedRow := -1;
  Add(cxRect(0, AStartRow, dxSpreadSheetMaxColumnIndex, AFinishRow), AShift, AFocusedRow, AFocusedColumn);
end;
...
begin
  AColumn := EnsureRange(AColumn, 0, dxSpreadSheetMaxColumnIndex);
  ARow := EnsureRange(ARow, 0, dxSpreadSheetMaxRowIndex);
...
function TdxSpreadSheetTableViewSelection.ToRectList: TdxRectList;
var
  I: Integer;
begin
...
begin
  with FocusedCellPosition do
    Result := View.Cells[Y, X];
end;

function TdxSpreadSheetTableViewSelection.GetFocusedCellPosition: TPoint;
begin
  Result := MergedCells.ExpandArea(FocusedColumn, FocusedRow).TopLeft;
end;
...
begin
  Result := TcxRect(FItems.List[AIndex]);
end;
...
procedure TdxSpreadSheetTableViewEditingController.ShowEditByMouse(const AUnscaledPos: TPoint; AShift: TShiftState);
begin
  FEditValue := '';
  View.HitTest.Calculate(AUnscaledPos);
  ...
  if PrepareEdit(True) then
  begin
    FEdit.ActivateByMouse(AShift, AUnscaledPos.X, AUnscaledPos.Y, FEditData);
    EditActivated;
...
procedure TdxSpreadSheetTableViewEditingController.AfterViewInfoCalculate;
begin
  if not FIsEditHiding then
  begin
    UpdateEditPosition;
...
begin
  Result := TcxSpreadSheetRichEditProperties.Create(View);
...
begin
  if IsOurAction(FindControl(GetFocus)) or IsOurAction(Screen.ActiveControl) or not CanFinishEditingOnExit(Edit) then
    Exit;
  if not (EditPreparing or FIsEditPostHide) then
  begin
    FIsEditPostHide := True;
    PostMessage(SpreadSheet.Handle, DXM_POSTHIDEEDIT, TdxNativeUInt(Self), 0);
  end
  else
  begin
    FIsEditPostHide := False;
  ...
  case Key of
    ...
    VK_RETURN:
      if Edit <> DefaultEdit then
        HideEdit(True);
    Word('Z'):
      if [ssAlt, ssCtrl, ssShift] * Shift = [ssCtrl] then
      begin
        Undo;
        Key := 0;
      end;
...
const
  HorzAlignToTextAlign: array[TcxTextAlignX] of TAlignment = (
    taLeftJustify, taCenter, taRightJustify, taLeftJustify, taLeftJustify
  );
var
  AMergedArea: TRect;
...
begin
  ...
  begin
    if (Cell <> nil) and Cell.IsFormula then
      ...
      FAlignment := HorzAlignToTextAlign[CellViewInfo.AlignHorz];
  end;

  AText := GetTextForEditMeasurement;
  ATextBounds := cxRect(GetEditSize(AText, cxDefaultEditSizeProperties));
  ...
  begin
    ...
    ASizeProperties.ScaleFactor := View.ScaleFactor;
...
begin
  Result := ViewInfo.ContentRectToScreenRect(ViewInfo.GetAreaBounds(AArea));
end;
...
begin
  ACellViewInfo := CellViewInfo;
  Result := ViewInfo.GetCellClipArea(ACellViewInfo.Row, ACellViewInfo.Column);
end;
...
var
  ACellViewInfo: TdxSpreadSheetTableViewCellViewInfo;
  ATableViewInfo: TdxSpreadSheetTableViewInfo;
  ABounds: TRect;
begin
  ACellViewInfo := CellViewInfo;
  ATableViewInfo := ViewInfo;
  ABounds := cxRectInflate(ACellViewInfo.Bounds, -1, 0);
  if ACellViewInfo.IsMerged then
    ABounds := ATableViewInfo.GetAreaBounds(ACellViewInfo.Row, ACellViewInfo.Column, ACellViewInfo.MergedCell.Area, ABounds);

  Result := ATableViewInfo.ContentRectToScreenRect(ACellViewInfo.ContentRect(ABounds));
  if cxRectIntersect(Result, Result, ATableViewInfo.CellsArea) then
...
begin
  if ACell = nil then
    ...
    if ACell.IsPartOfArrayFormula(AFormulaArea, @AArrayFormula) = afpSlaveCell then
...
begin
  ...
  if (ACell <> nil) and (ACell.IsPartOfArrayFormula(AFormulaArea) <> afpNone) and
    dxSpreadSheetIsValidArea(AFormulaArea) and not cxPointIsEqual(AFormulaArea.TopLeft, AFormulaArea.BottomRight) then
  begin
    ...
    if VarIsNull(AValue) and (ACell <> nil) then
      ACell.SetTextCore(ATextValue, True, True)
    else
      ...
      begin
        ...
        try
          if IsArrayFormula then
            ...
            if IsEditValueFormula then
              ACell.SetTextCore(ATextValue, True, (ACell.AsFormula <> nil) and ACell.AsFormula.IsArrayFormula)
            else
              if not dxSpreadSheetTextService.SetAsRTF(ACell, AValue) then
                ACell.SetTextCore(ATextValue, False, False);
        finally
          View.EndUpdate;
        end;
      end;
...
function TdxSpreadSheetTableViewEditingController.GetTextForEditMeasurement: string;
begin
  if (FPropertiesValue is TcxRichEditProperties) and not TcxRichEditProperties(FPropertiesValue).PlainText then
...
function TdxSpreadSheetTableViewEditingController.GetViewInfo: TdxSpreadSheetTableViewInfo;
begin
...
class function TdxSpreadSheetInplaceEdit.GetPropertiesClass: TcxCustomEditPropertiesClass;
begin
  Result := TcxSpreadSheetRichEditProperties;
end;
...
begin
  ...
  begin
    ...
    begin
      ARect := TdxSpreadSheetCommentContainer.GetDefaultPosition(TdxSpreadSheetCommentContainer(AContainer).Cell);
...
begin
  ...
  Result := EnsureRange(Result, ViewInfo.FirstScrollableRow, View.BottomRow);
end;
...
begin
  if View.OptionsProtection.ActualAllowFormatCells then
    case AKey of
      ...
      '2', 'B':
        TdxSpreadSheetCellStylesHelper.ToggleFontStyle(View, fsBold);
      '3', 'I':
        TdxSpreadSheetCellStylesHelper.ToggleFontStyle(View, fsItalic);
      '4', 'U':
        TdxSpreadSheetCellStylesHelper.ToggleFontStyle(View, fsUnderline);
      '5':
        TdxSpreadSheetCellStylesHelper.ToggleFontStyle(View, fsStrikeOut);
    end;
  ...
  case AKey of
    ...
    '+':
      View.InsertCells;
    '0':
      View.HideSelectedColumns;
    '9':
      View.HideSelectedRows;
    'A':
      TrySelectAll;
    'C':
...
begin
  if View.OptionsProtection.ActualAllowFormatCells then
    case AKey of
      49:  
        TdxSpreadSheetCellStylesHelper.SetNumberFormat(View, sknfNumber00);
      50:  
        TdxSpreadSheetCellStylesHelper.SetNumberFormat(View, sknfTime);
      51:  
        TdxSpreadSheetCellStylesHelper.SetNumberFormat(View, sknfDate);
      52:  
        TdxSpreadSheetCellStylesHelper.SetNumberFormat(View, sknfCurrency);
      53:  
        TdxSpreadSheetCellStylesHelper.SetNumberFormat(View, sknfPercent);
      54:  
        TdxSpreadSheetCellStylesHelper.SetNumberFormat(View, sknfScientific);
      55:  
        TdxSpreadSheetCellStylesHelper.SetBorder(View, True);
      80:  
        ShowFormatCellsDialog(View, 2);
      189:  
        TdxSpreadSheetCellStylesHelper.SetBorder(View, False);
    end;

  case AKey of
    192:  
      TdxSpreadSheetCellStylesHelper.SetNumberFormat(View, sknfGeneral);
    56:  
...
procedure TdxSpreadSheetTableViewController.CheckScrollArea(const P: TPoint);
  ...
  begin
    Result := (PtInRect(ViewInfo.ScrollableArea, P) or
      ...
      not PtInRect(cxRectContent(ViewInfo.ScrollableArea, ViewInfo.ScrollableAreaHitMargins), P);
  end;
...
procedure TdxSpreadSheetTableViewController.DblClick(const AUnscaledPos: TPoint);
var
  ACell: TdxSpreadSheetTableViewHeaderCellViewInfo;
begin
  ...
  begin
    ...
    EditingController.ShowEditByMouse(AUnscaledPos, KeyboardStateToShiftState);
end;

function TdxSpreadSheetTableViewController.ExpandDataRegion(AArea: TRect): TRect;

  function GetNext(AItems: TdxSpreadSheetTableItems; ACurrentItemIndex: Integer; var ACurrentItem: TdxSpreadSheetTableItem): Boolean;
  begin
    if ACurrentItem <> nil then
    begin
      ACurrentItem := ACurrentItem.Next;
      Result := (ACurrentItem <> nil) and (ACurrentItem.Index = ACurrentItemIndex + 1);
    end
    else
    begin
      ACurrentItem := AItems.Items[ACurrentItemIndex + 1];
      Result := ACurrentItem <> nil;
    end;
  end;

  function GetPrior(AItems: TdxSpreadSheetTableItems; ACurrentItemIndex: Integer; var ACurrentItem: TdxSpreadSheetTableItem): Boolean;
  begin
    if ACurrentItem <> nil then
    begin
      ACurrentItem := ACurrentItem.Prev;
      Result := (ACurrentItem <> nil) and (ACurrentItem.Index + 1 = ACurrentItemIndex);
    end
    else
    begin
      ACurrentItem := AItems.Items[ACurrentItemIndex - 1];
...
begin
  ...
  repeat
    ...
    AItem := nil;
    while GetPrior(View.Rows, Result.Top, AItem) and AItem.HasNonEmptyCells(AArea.Left - 1, AArea.Right + 1) do
      Dec(Result.Top);

    AItem := nil;
    while GetNext(View.Rows, Result.Bottom, AItem) and AItem.HasNonEmptyCells(AArea.Left - 1, AArea.Right + 1) do
      Inc(Result.Bottom);

    AItem := nil;
    while GetPrior(View.Columns, Result.Left, AItem) and AItem.HasNonEmptyCells(AArea.Top - 1, AArea.Bottom + 1) do
      Dec(Result.Left);

    AItem := nil;
    while GetNext(View.Columns, Result.Right, AItem) and AItem.HasNonEmptyCells(AArea.Top - 1, AArea.Bottom + 1) do
      Inc(Result.Right);

  until cxRectIsEqual(Result, AArea);
end;
...
function TdxSpreadSheetTableViewController.GetNextCellInDataBlock(
  AItem: TdxSpreadSheetTableItem; ACellIndex: Integer; AGoForward: Boolean): Integer;

  function CanSelect(ACell: TdxSpreadSheetCell; AAllowSelectLocked, AAllowSelectUnlocked, AIsNavigationByColumn: Boolean): Boolean;
  var
    AMergedCell: TdxSpreadSheetMergedCell;
  begin
    if csLocked in ACell.StyleHandle.States then
      Result := AAllowSelectLocked
    else
      Result := AAllowSelectUnlocked;

    if Result then
    begin
      AMergedCell := MergedCells.FindCell(ACell.RowIndex, ACell.ColumnIndex);
      if AMergedCell <> nil then
      begin
        if AIsNavigationByColumn then
          Result := ACell.ColumnIndex = AMergedCell.Area.Left
        else
          Result := ACell.RowIndex = AMergedCell.Area.Top;
      end;
    end;
  end;

var
  AAllowSelectLocked: Boolean;
  AAllowSelectUnlocked: Boolean;
  ACell: TdxSpreadSheetCell;
  ACellCount: Integer;
  AIndex: Integer;
  AIsNavigationByColumn: Boolean;
  AOppositeItems: TdxSpreadSheetTableItems;
  AReturnFirstNonEmptyCell: Boolean;
begin
  Result := -1;

  if AItem <> nil then
  begin
    ACellCount := AItem.CellCount;
    AOppositeItems := AItem.Owner.GetOppositeItems;
    AReturnFirstNonEmptyCell := AItem.Cells[ACellIndex].IsEmpty;
    AAllowSelectLocked := View.OptionsProtection.ActualAllowSelectLockedCells;
    AAllowSelectUnlocked := View.OptionsProtection.ActualAllowSelectUnlockedCells;
    AIsNavigationByColumn := AOppositeItems = Rows;

    AIndex := Min(ACellIndex, ACellCount) + ValueIncr[AGoForward];
    while InRange(AIndex, 0, ACellCount - 1) do
    begin
      if AOppositeItems.GetItemVisible(AIndex) then
      begin
        ACell := AItem.Cells[AIndex];
        if ACell.IsEmpty then
        begin
          if not AReturnFirstNonEmptyCell then
          begin
            if Result >= 0 then
              Break;
            AReturnFirstNonEmptyCell := True;
          end;
        end
        else
          if CanSelect(ACell, AAllowSelectLocked, AAllowSelectUnlocked, AIsNavigationByColumn) then
          begin
            Result := AIndex;
            if AReturnFirstNonEmptyCell then
              Break;
          end;
      end;
...
var
  ...
  AItems: TdxSpreadSheetTableItems;
begin
  AItems := GetTableItemsForNavigation(ADirection);
  Result := AItems.GetNextVisibleItemIndex(AIndex, ADirection in [adRight, adDown], AResult);
  ...
  begin
    ...
    begin
      if (AResult > AIndex1) and (AIndex + 1 > AIndex1) then
        Result := AItems.GetNextVisibleItemIndex(AIndex2, True, AResult)
    end
    else
      if (AResult < AIndex2) and (AIndex - 1 < AIndex2) then
        Result := AItems.GetNextVisibleItemIndex(AIndex1, False, AResult)
  end;
end;
...
begin
  ...
  case Key of
    VK_DECIMAL:
      EditingController.ShowEditByKey(dxFormatSettings.DecimalSeparator);
    ...
    VK_LEFT:
      if ssCtrl in Shift then
        SelectColumn(GetNextCellInDataBlock(Rows[FocusedRow], FocusedColumn, False), Shift - [ssCtrl])
      else
        SelectColumn(GetNextVisibleCell(GetSelectionItem(bLeft, Shift), adLeft), Shift);

    VK_UP:
      if ssCtrl in Shift then
        SelectRow(GetNextCellInDataBlock(Columns[FocusedColumn], FocusedRow, False), Shift - [ssCtrl])
      else
        SelectRow(GetNextVisibleCell(GetSelectionItem(bTop, Shift), adUp), Shift);

    VK_DOWN:
      if ssCtrl in Shift then
        SelectRow(GetNextCellInDataBlock(Columns[FocusedColumn], FocusedRow, True), Shift - [ssCtrl])
      else
        SelectRow(GetNextVisibleCell(GetSelectionItem(bBottom, Shift), adDown), Shift);

    VK_RIGHT:
      if ssCtrl in Shift then
        SelectColumn(GetNextCellInDataBlock(Rows[FocusedRow], FocusedColumn, True), Shift - [ssCtrl])
      else
    ...
    VK_F3:
      if Shift = [ssCtrl] then
        ShowDefinedNameManagerDialog(SpreadSheet);
...
procedure TdxSpreadSheetTableViewController.ScrollingTimerHandler(Sender: TObject);
  ...
  procedure ScrollContent(APoint: TPoint);
  var
    AContentArea: TRect;
    AScrollPos: Integer;
  begin
    if ViewInfo.IsRightToLeftLayout then
      APoint := TdxRightToLeftLayoutConverter.ConvertPoint(APoint, View.BoundsForRightToLeftConversion);

    AScrollPos := 0;
    AContentArea := cxRectContent(ViewInfo.ScrollableArea, ViewInfo.ScrollableAreaHitMargins);
    if (APoint.Y < AContentArea.Top) and not InRange(FocusedRow, 0, View.FrozenRow) and (SelectionMode <> smColumns) then
      ViewInfo.DoScroll(sbVertical, scLineUp, AScrollPos);
    if (APoint.Y > AContentArea.Bottom) and (SelectionMode <> smColumns) then
      ViewInfo.DoScroll(sbVertical, scLineDown, AScrollPos);
    if (APoint.X < AContentArea.Left) and not InRange(FocusedColumn, 0, View.FrozenColumn) and (SelectionMode <> smRows) then
      ViewInfo.DoScroll(sbHorizontal, scLineUp, AScrollPos);
    if (APoint.X > AContentArea.Right) and  (SelectionMode <> smRows) then
      ViewInfo.DoScroll(sbHorizontal, scLineDown, AScrollPos);
  end;

  procedure UpdateHotTrack(const AUnscaledPoint: TPoint);
  var
    AAccepted: Boolean;
  begin
    ...
    begin
      ViewInfo.Validate;
      View.HitTest.Calculate(AUnscaledPoint);
      MouseMove(KeyboardStateToShiftState, AUnscaledPoint.X, AUnscaledPoint.Y);
    end;

    if SpreadSheet.DragAndDropState = ddsInProcess then
    begin
      AAccepted := False;
      SpreadSheet.DragAndDrop(AUnscaledPoint, AAccepted);
    end;
  end;
...
var
  APoint: TPoint;
begin
  APoint := SpreadSheet.GetMouseCursorClientPos;
  ScrollContent(cxPointScale(APoint, 100, ZoomFactor));
  UpdateHotTrack(APoint);
end;
...
begin
  if FForcedSelectionMode <> Value then
  begin
...
begin
  Result := ViewInfo.FirstScrollableRow;
  ARow := EnsureRange(ARow, ViewInfo.FirstScrollableRow, View.BottomRow);
  ACount := 0;
...
begin
  inherited DoChanged;
  FView.AddChanges([sscLayout, sscModified, sscStyle]);
end;
...
var
  ADefaultStyle: TdxSpreadSheetCellStyleHandle;
begin
  ...
  try
    ...
    begin
      ADefaultStyle := CellStyles.DefaultStyle;
      Rows.ForEachCell(AArea,
        procedure (ACell: TdxSpreadSheetCell)
        begin
          if Options.Protected and (csLocked in ACell.StyleHandle.States) then
            Exit;
          ...
          begin
            ...
            begin
              ACell.StyleHandle := ADefaultStyle;
              if Options.Protected then
                ACell.Style.Locked := False;
            end;
          end;
        end);
      AddChanges([sscData, sscStyle]);
    end;
    Pack;
  finally
    EndUpdate;
...
begin
  ...
  try
    ADestArea := AArea;
    if SpreadSheet.FormulaController.IsPartOfArrayFormula(Self, AArea.Top, AArea.Left,
      AFormulaArea, @AExistingFormula) <> afpNone then
    begin
    ...
    begin
      ...
      ACell.SetTextCore(AText, True, False);
      if ACell.IsFormula then
...
begin
  if not TdxSpreadSheetColumnReferences.TryIndexByName(S, Result) then
...
begin
  if not dxTryStringToReference(S, False, ARow, AColumn) then
...
begin
  inherited;
  TdxSpreadSheetCellStyleHelper.MergeBorders(Self);
end;
...
begin
  Rows.ForEachCell(AArea, AProc, AGoForward, AGoForward);
end;
...
procedure TdxSpreadSheetTableView.Invalidate;
begin
  inherited InvalidateRect(ViewInfo.Bounds);
end;
...
begin
  MakeVisible(MergedCells.ExpandArea(Selection.FocusedColumn, Selection.FocusedRow));
end;
...
begin
  ...
  AArea.Left := EnsureRange(AArea.Left, 0, dxSpreadSheetMaxColumnIndex);
  AArea.Bottom := EnsureRange(AArea.Bottom, 0, dxSpreadSheetMaxRowIndex);
  AArea.Right := EnsureRange(AArea.Right, 0, dxSpreadSheetMaxColumnIndex);
  AArea.Top := EnsureRange(AArea.Top, 0, dxSpreadSheetMaxRowIndex);
...
begin
  ...
  begin
    if TdxSpreadSheetTableViewClipboardHelper.GetData(AClipboardData) then
    begin
      AOptions := dxSpreadSheetDefaultPasteOptions;
      if dxSpreadSheetIsEntireColumn(AClipboardData.OriginalArea) then
        Include(AOptions, cpoColumnWidths);
      PasteFromClipboardCore(AOptions, AClipboardData);
    end;
  end;
end;
...
begin
  if CanPasteFromClipboard then
  begin
    if TdxSpreadSheetTableViewClipboardHelper.GetData(AClipboardData, AOptions) then
      PasteFromClipboardCore(AOptions, AClipboardData);
  end;
end;
...
begin
  ...
  begin
    ...
    try
      ...
      Include(SpreadSheet.FState, sssReadingFromClipboard);
      try
        if AData <> nil then
          AData.Paste(Self, ADestination, APasteOptions);
      finally
        Exclude(SpreadSheet.FState, sssReadingFromClipboard);
      end;
    finally
...
begin
  EditingController.ShowEditByMouse(cxPoint(X, Y), AShift);
end;
...
begin
  ...
  Rows.ForEachCell(AArea,
    procedure(ACell: TdxSpreadSheetCell)
    begin
      if (csLocked in ACell.StyleHandle.States) <> ADefaultLocked then
        Inc(AChangedCount);
    end);
...
function TdxSpreadSheetTableView.GetAbsoluteCellsArea: TRect;
begin
  Result.TopLeft := cxNullPoint;
  Result.BottomRight := GetAbsoluteCellBounds(dxSpreadSheetMaxRowIndex, dxSpreadSheetMaxColumnIndex, False).BottomRight;
end;
...
procedure TdxSpreadSheetTableView.ChangeSelectedItemsVisibility(AItems: TdxSpreadSheetTableItems; AVisibility: Boolean);

  procedure ChangeVisibilityInArea(AItems: TdxSpreadSheetTableItems; const AArea: TRect; AVisibility: Boolean);
  var
    AStartIndex: Integer;
    AFinishIndex: Integer;
    I: Integer;
  begin
    AStartIndex := IfThen(AItems is TdxSpreadSheetTableColumns, AArea.Left, AArea.Top);
    AFinishIndex := IfThen(AItems is TdxSpreadSheetTableColumns, AArea.Right, AArea.Bottom);
    ...
    begin
      AItems.ForEach(
        ...
        end, AStartIndex, AFinishIndex);
    end
    else
      for I := AStartIndex to AFinishIndex do
        AItems.CreateItem(I).Visible := False;
  end;
...
begin
  ...
  try
    BeginUpdate;
    try
      for AAreaIndex := 0 to Selection.Count - 1 do
        ChangeVisibilityInArea(AItems, dxSpreadSheetGetRealArea(Selection[AAreaIndex].Rect), AVisibility);
      if AVisibility then
        Pack;
    finally
      EndUpdate;
...
function TdxSpreadSheetTableView.IsRightToLeftLayout: Boolean;
begin
  Result := Options.ActualRightToLeftLayout;
end;
...
procedure TdxSpreadSheetTableView.PasteFromClipboardCore(
  AOptions: TdxSpreadSheetClipboardPasteOptions; const AData: IUnknown);
var
  AClipboardData: IdxSpreadSheetClipboardData;
begin
  if AData <> nil then
  begin
    AClipboardData := AData as IdxSpreadSheetClipboardData;
    CheckPasteSelection(AClipboardData.OriginalArea, AClipboardData.Mode);
    ...
    try
      ...
      try
        Include(SpreadSheet.FState, sssReadingFromClipboard);
        try
          TdxSpreadSheetTableViewClipboardHelper.Paste(Self, AClipboardData, AOptions);
        finally
          Exclude(SpreadSheet.FState, sssReadingFromClipboard);
        end;
      finally
      ...
      History.EndAction; // after EndUpdate
      HideHourglassCursor;
    end;
  end;
end;
...
begin
  ...
  begin
    ...
    begin
      if ARow.FCells <> nil then
        FDimensions.Right := Max(FDimensions.Right, ARow.FCells.LastIndex);
...
procedure TdxSpreadSheetTableView.HideSelectedColumns;
begin
  ChangeSelectedItemsVisibility(Columns, False);
end;

procedure TdxSpreadSheetTableView.HideSelectedRows;
begin
  ChangeSelectedItemsVisibility(Rows, False);
end;

procedure TdxSpreadSheetTableView.UnhideSelectedColumns;
begin
  ChangeSelectedItemsVisibility(Columns, True);
end;

procedure TdxSpreadSheetTableView.UnhideSelectedRows;
begin
  ChangeSelectedItemsVisibility(Rows, True);
end;
...
begin
  if OptionsPrint.Source.Area.Assigned then
    ...
    Result := dxSpreadSheetEntireSheetArea;
end;
...
begin
  AValue := EnsureRange(AValue, -1, dxSpreadSheetMaxColumnIndex);
...
begin
  AValue := EnsureRange(AValue, -1, dxSpreadSheetMaxRowIndex);
...
procedure TdxSpreadSheetTableViewPainter.DrawGroupLinePart(ACanvas: TcxCanvas; const R: TRect);
begin
  ACanvas.FillRect(R, LookAndFeelPainter.SpreadSheetGroupLineColor);
end;
...
function TdxSpreadSheetTableViewPainter.GetGroupExpandButtonMinSize: TSize;
  ...
  function Align(AGlyphSize, ATextSize: Integer): Integer;
  begin
    Result := Max(AGlyphSize, ATextSize);
    if Odd(AGlyphSize) <> Odd(Result) then
      Inc(Result);
  end;
...
var
  ...
  ATextHeight: Integer;
begin
  if cxSizeIsEmpty(FGroupExpandButtonMinSize) then
  begin
    PrepareCanvasFont(cxScreenCanvas, SpreadSheet.Font);
    ATextHeight := cxTextHeight(cxScreenCanvas.Handle);
    cxScreenCanvas.Dormant;

    AMargins := LookAndFeelPainter.SpreadSheetScaledGroupExpandButtonContentOffsets(dxDefaultScaleFactor);
    FGroupExpandButtonMinSize := LookAndFeelPainter.SpreadSheetScaledGroupExpandButtonGlyphSize(dxDefaultScaleFactor);
    FGroupExpandButtonMinSize.cx := Align(FGroupExpandButtonMinSize.cx, ATextHeight) + cxMarginsWidth(AMargins);
    FGroupExpandButtonMinSize.cy := Align(FGroupExpandButtonMinSize.cy, ATextHeight) + cxMarginsHeight(AMargins);
  end;
...
begin
  ...
  FSelectionCell := CreateSelectionViewInfo;
...
begin
  ...
  if IsRightToLeftLayout then
    ExchangeLongWords(AMargins.Left, AMargins.Right);

  Result := cxRectInflate(ACellBounds, AMargins);
...
begin
  ...
  begin
    ...
    if IsRightToLeftLayout then
    begin
      Result := cxRectSetRight(Result, CellsArea.Right + FirstColumnOrigin - Result.Left);
      Result := cxRectOffset(Result, dxSpreadSheetBordersMergingOffset, CellsArea.Top - FirstRowOrigin);
    end
    else
      Result := cxRectOffset(Result, CellsArea.Left - FirstColumnOrigin, CellsArea.Top - FirstRowOrigin);
  end
  else
    Result := cxNullRect;
end;

function TdxSpreadSheetTableViewInfo.GetCellBounds(const ARow, AColumn: Integer): TRect;
begin
  Result := GetAreaBounds(cxRectBounds(AColumn, ARow, 0, 0));
end;
...
begin
  ...
  begin
    ...
    ARect := cxRectOffset(ARect, 0, -dxSpreadSheetBordersMergingOffset);
...
begin
  ...
  begin
    ...
    ARect := cxRectOffset(ARect, -dxSpreadSheetBordersMergingOffset, 0);
...
procedure TdxSpreadSheetTableViewInfo.AfterCalculate;
begin
  inherited AfterCalculate;

  SelectionChanged;
  if View.IsEditing then
    View.EditingController.AfterViewInfoCalculate;
  SpreadSheet.UpdateScrollBars;
end;

procedure TdxSpreadSheetTableViewInfo.BeforeCalculate;
begin
...
procedure TdxSpreadSheetTableViewInfo.CalculateCore;
begin
  inherited;
  CheckRowsBestFit;
...
var
  ...
  APrevRow: TdxSpreadSheetTableViewRowHeaderCellViewInfo;
...
begin
  ...
  begin
    ...
    ARowBounds := ARow.Bounds;
    for J := 1 to ColumnsHeader.Count - 1 do
    begin
      AColumn := TdxSpreadSheetTableViewHeaderCellViewInfo(ColumnsHeader.List[J]);
      ABounds := cxRect(
        AColumn.Bounds.Left - dxSpreadSheetBordersMergingOffset,
        ARowBounds.Top - dxSpreadSheetBordersMergingOffset,
        AColumn.Bounds.Right - dxSpreadSheetBordersMergingOffset,
        ARowBounds.Bottom - dxSpreadSheetBordersMergingOffset);
  ...
  begin
    ARow := TdxSpreadSheetTableViewRowHeaderCellViewInfo(RowsHeader.List[I]);
    MergeCellsBorders(APrevRow, ARow);
    APrevRow := ARow;
  end;
  if APrevRow <> nil then
  begin
    for I := APrevRow.FFirstCellIndex to APrevRow.FLastCellIndex do
      TdxSpreadSheetTableViewCellViewInfo(Cells.List[I]).MergeBorder(bBottom, DefaultCellStyleHandle);
  end;
...
begin
  ...
  FScrollableAreaHitMargins := cxRect(ScrollAreaHitSize, ScrollAreaHitSize, ScrollAreaHitSize, ScrollAreaHitSize);
  ...
  begin
    ...
    FScrollableAreaHitMargins.Left := 2 * OptionsView.FrozenPaneSeparatorWidth;
  end;
  if FrozenRow >= 0 then
  begin
    FScrollableArea.Top := FrozenRowSeparatorPosition - 1 + OptionsView.FrozenPaneSeparatorWidth;
    FScrollableAreaHitMargins.Top := 2 * OptionsView.FrozenPaneSeparatorWidth;
  end;
...
begin
  case ASide of
    bLeft, bRight:
      AValue := EnsureRange(AValue, 0, dxSpreadSheetMaxColumnIndex);
    bTop, bBottom:
      AValue := EnsureRange(AValue, 0, dxSpreadSheetMaxRowIndex);
  end;
...
function TdxSpreadSheetTableViewInfo.CreateSelectionViewInfo: TdxSpreadSheetTableViewSelectionViewInfo;
begin
  Result := TdxSpreadSheetTableViewSelectionViewInfo.Create(Self);
end;
...
begin
  ...
  if (FrozenRow >= 0) and (Result.Top >= FrozenRowSeparatorPosition) then
    Result := cxRectOffsetVert(Result, -FirstScrollableRowOffset);
  if (FrozenColumn >= 0) then
  begin
    if IsRightToLeftLayout then
    begin
      if Result.Right <= FrozenColumnSeparatorPosition then
        Result := cxRectOffsetHorz(Result, FirstScrollableColumnOffset);
    end
    else
      if Result.Left >= FrozenColumnSeparatorPosition then
        Result := cxRectOffsetHorz(Result, -FirstScrollableColumnOffset);
  end;
end;
  ...
  begin
    ...
    begin
      if AColumn > FrozenColumn then
        Result.Right := FrozenColumnSeparatorPosition + OptionsView.FrozenPaneSeparatorWidth + 1
      else
        Result.Left := FrozenColumnSeparatorPosition - 1;
    end
    else
      if AColumn > FrozenColumn then
...
procedure TdxSpreadSheetTableViewInfo.GetCellAtPoint(P: TPoint; out ARow, AColumn: Integer;
  AReturnNearestCell: Boolean = False; AVisibleAreaOnly: Boolean = True);

  function FindItem(APos, AMinPos, AMaxPos, AFirstIndex, ALastIndex, AFixedPosition, AFixedOffset: Integer;
    ACells: TdxSpreadSheetCellViewInfoList; AIsContentFlipped: Boolean): Integer;
  var
    ACell: TdxSpreadSheetTableViewHeaderCellViewInfo;
    ARectEdges: TPoint;
    I: Integer;
  begin
    ...
    begin
      if AFixedPosition <> -1 then
      begin
        if AIsContentFlipped and (APos < AFixedPosition - OptionsView.FrozenPaneSeparatorWidth + 1) then
          Dec(APos, AFixedOffset);
        if not AIsContentFlipped and (APos > AFixedPosition + OptionsView.FrozenPaneSeparatorWidth - 1) then
          Inc(APos, AFixedOffset);
      end;
      for I := 0 to ACells.Count - 1 do
      begin
        ACell := TdxSpreadSheetTableViewHeaderCellViewInfo(ACells.List[I]);
        ARectEdges := ACell.GetRectEdges(ACell.Bounds);
        if ARectEdges.X <> ARectEdges.Y then 
        begin
          Result := ACell.Index;
          if InRange(APos, ARectEdges.X, ARectEdges.Y) then
            Break;
        end;
      end;
    end;
...
begin
  ...
  begin
    AColumn := FindItem(P.X, CellsArea.Left, CellsArea.Right, View.LeftColumn, VisibleCells.Right,
      FrozenColumnSeparatorPosition, FirstScrollableColumnOffset, ColumnsHeader, IsRightToLeftLayout);
    ARow := FindItem(P.Y, CellsArea.Top, CellsArea.Bottom, View.TopRow, VisibleCells.Bottom,
      FrozenRowSeparatorPosition, FirstScrollableRowOffset, RowsHeader, False);
  end;
end;
...
begin
  ...
  case APart of
    ...
    2:
      if FrozenColumn >= 0 then
        Dec(Result.X, ValueIncr[IsRightToLeftLayout] * FirstScrollableColumnOffset);
    3:
      begin
        Inc(Result.Y, FirstScrollableRowOffset);
        Dec(Result.X, ValueIncr[IsRightToLeftLayout] * FirstScrollableColumnOffset);
...
function TdxSpreadSheetTableViewInfo.GetPartOffsetByPoint(const P: TPoint): TPoint;
  ...
  begin
    for I := 0 to GetPartCount - 1 do
    begin
      if cxRectPtIn(GetPartBounds(I), P) then
        Exit(I);
    end;
    Result := 0;
  end;
...
function TdxSpreadSheetTableViewInfo.GetContentOrigin: TPoint;
begin
  Result.X := FirstColumnOrigin;
  Result.Y := FirstRowOrigin - CellsArea.Top;
  if IsRightToLeftLayout then
    Dec(Result.X, View.Bounds.Right - CellsArea.Right)
  else
    Dec(Result.X, CellsArea.Left);
end;
...
procedure TdxSpreadSheetTableViewInfo.InitViewParams;
begin
  inherited;
...
procedure TdxSpreadSheetTableViewInfo.MergeCellsBorders(APrevRow, ARow: TdxSpreadSheetTableViewRowHeaderCellViewInfo);
var
  ACell: TdxSpreadSheetTableViewCellViewInfo;
  AIndex: Integer;
  ANeighborCellViewInfo: TdxSpreadSheetTableViewCellViewInfo;
  APrevCell: TdxSpreadSheetTableViewCellViewInfo;
begin
  APrevCell := nil;
  if (APrevRow <> nil) and (APrevRow.Index + 1 <> ARow.Index) then
  begin
    for AIndex := APrevRow.FFirstCellIndex to APrevRow.FLastCellIndex do
      TdxSpreadSheetTableViewCellViewInfo(Cells.List[AIndex]).MergeBorder(bBottom, DefaultCellStyleHandle);
    APrevRow := nil;
  end;

  for AIndex := ARow.FFirstCellIndex to ARow.FLastCellIndex do
  begin
    ACell := TdxSpreadSheetTableViewCellViewInfo(Cells.List[AIndex]);

    if APrevRow <> nil then
    begin
      if Cells.FindItemForCell(APrevRow.Index, ACell.Column, ANeighborCellViewInfo) then
      begin
        ANeighborCellViewInfo.MergeBorder(bBottom, ACell.Style.Handle);
        ACell.MergeBorder(bTop, ANeighborCellViewInfo.Style.Handle);
      end;
    end
    else
      ACell.MergeBorder(bTop, DefaultCellStyleHandle);

    if APrevCell <> nil then
    begin
      APrevCell.MergeBorder(bRight, ACell.Style.Handle);
      ACell.MergeBorder(bLeft, APrevCell.Style.Handle);
    end
    else
      ACell.MergeBorder(bLeft, DefaultCellStyleHandle);

    APrevCell := ACell;
  end;
  if APrevCell <> nil then
    APrevCell.MergeBorder(bRight, DefaultCellStyleHandle);
end;
...
procedure TdxSpreadSheetTableViewInfo.RightToLeftConversion(const AClientBounds: TRect);
begin
  inherited;

  GroupingAreas.RightToLeftConversion(AClientBounds);

  FScrollableArea := TdxRightToLeftLayoutConverter.ConvertRect(FScrollableArea, AClientBounds);
  FCellsArea := TdxRightToLeftLayoutConverter.ConvertRect(FCellsArea, AClientBounds);
  if FFrozenColumnSeparatorPosition <> -1 then
    FFrozenColumnSeparatorPosition := Bounds.Right - FFrozenColumnSeparatorPosition;

  RowsHeader.RightToLeftConversion(AClientBounds);
  ColumnsHeader.RightToLeftConversion(AClientBounds);
  MergedCells.RightToLeftConversion(AClientBounds);
  Cells.RightToLeftConversion(AClientBounds);
  Cells.Offset(-dxSpreadSheetBordersMergingOffset, 0); // rollback the correction
  CellsOverlay.RightToLeftConversion(AClientBounds);
  BackgroundCells.RightToLeftConversion(AClientBounds);
end;
...
var
  ...
  I: Integer;
begin
  if (ARow = nil) or (ARow.FCells = nil) then
    Exit;
  if AGoForward then
  begin
    for I := AIndex + 1 to ARow.FCells.LastIndex do
    ...
    for I := AIndex - 1 downto ARow.FCells.FirstIndex do
      if Columns.GetItemVisible(I) and ARow.IsValueDefined(I) then
      begin
        if not (ARow.Cells[I].IsMerged or ARow.IsValueDefined(I + 1)) then
        begin
...
begin
  ...
  begin
    ...
    AHasValue := (ANeighborCell.DisplayText <> '') or ANeighborCell.IsMerged;
...
begin
  ...
  AValue := EnsureRange(AValue, FrozenColumn + 1, dxSpreadSheetMaxColumnIndex - (FrozenColumn + 1));
  if FrozenColumn < 0 then
    FVisibleCells.Left := AValue
  else
...
begin
  ...
  AValue := EnsureRange(AValue, FrozenRow + 1, dxSpreadSheetMaxRowIndex - (FrozenRow + 1));
  if FrozenRow < 0 then
    FVisibleCells.Top := AValue
  else
...
begin
  ...
  if History.CanAddCommand then
  begin
    History.BeginAction(TdxSpreadSheetHistoryDeleteDefinedNameAction);
    try
      History.AddCommand(TdxSpreadSheetHistoryDeleteDefinedNameCommand.Create(Self));
      FreeAndNil(FFormula);
    finally
      History.EndAction;
    end;
...
begin
  ...
  if AReader.Version >= 14 then
    Comment := AReader.ReadWideString;
end;

procedure TdxSpreadSheetDefinedName.Modify(AProc: TProc);
var
  ACommand: TdxSpreadSheetHistoryChangeDefinedNameCommand;
begin
  if History.CanAddCommand then
  begin
    ACommand := TdxSpreadSheetHistoryChangeDefinedNameCommand.Create(Self);
    try
      AProc;
      ACommand.NewCaption := Caption;
      ACommand.NewReference := Reference;
      ACommand.NewComment := Comment;
      ACommand.NewScope := Scope;
      History.AddCommand(ACommand);
    except
      ACommand.Free;
      raise;
...
begin
  ...
  AWriter.WriteWideString(Comment);
end;
  ...
  begin
    ...
    begin
      Result :=
        ...
        (AToken is TdxSpreadSheetFormulaReferenceToken);
...
function TdxSpreadSheetDefinedName.IsReferenceValid: Boolean;

  procedure CheckToken(AToken: TdxSpreadSheetFormulaToken; var AResult: Boolean);
  begin
    while AResult and (AToken <> nil) do
    begin
      if AToken is TdxSpreadSheetFormulaReferenceToken then
        AResult := TdxSpreadSheetFormulaReferenceTokenAccess(AToken).IsValid;
      CheckToken(AToken.FirstChild, AResult);
      if AResult then
        AToken := AToken.Next;
    end;
  end;
...
begin
  Result := Formula <> nil;
  if Result then
    CheckToken(Formula.Tokens, Result);
end;
...
function TdxSpreadSheetDefinedName.GetHistory: TdxSpreadSheetHistory;
begin
  Result := SpreadSheet.History;
end;

function TdxSpreadSheetDefinedName.GetOwnerEx: TdxSpreadSheetDefinedNames;
begin
  Result := inherited Owner as TdxSpreadSheetDefinedNames;
end;

function TdxSpreadSheetDefinedName.GetReference: string;
begin
  if IsReferenceValid then
    Result := Formula.AsText
  else
    if Formula <> nil then
      Result := serRefError // Excel like behavior
    else
      Result := '';
end;
...
begin
  if Formula <> nil then
    Result := Formula.ValueAsText
  else
    Result := '';
end;

function TdxSpreadSheetDefinedName.ValidateComment(const AValue: string): string;
begin
  Result := AValue;
...
begin
  if not dxSpreadSheetTextIsEqual(Caption, AValue) then
  begin
    Modify(
      procedure
      begin
        Owner.DoChangeCaption(Self, AValue);
      end);
  end;
end;

procedure TdxSpreadSheetDefinedName.SetComment(const AValue: string);
begin
  ...
  begin
    Modify(
      procedure
      begin
        FComment := ValidateComment(AValue);
      end);
  end;
end;
...
begin
  if FScope <> AValue then
  begin
    Modify(
      procedure
      begin
        Owner.DoChangeScope(Self, AValue);
      end);
  end;
end;
...
constructor TdxSpreadSheetDefinedNames.Create(ASpreadSheet: TdxCustomSpreadSheet);
begin
  inherited Create(ASpreadSheet);
  FIndex := TObjectDictionary<string, TList>.Create([doOwnsValues], TdxIStringComparer.Ordinal);
end;

destructor TdxSpreadSheetDefinedNames.Destroy;
begin
  FreeAndNil(FIndex);
  inherited;
end;

procedure TdxSpreadSheetDefinedNames.BeginUpdate;
begin
  SpreadSheet.BeginUpdate;
end;

procedure TdxSpreadSheetDefinedNames.EndUpdate;
begin
  SpreadSheet.EndUpdate;
end;

function TdxSpreadSheetDefinedNames.Add(const ACaption, AReference: string; AScope: TdxSpreadSheetCustomView = nil): TdxSpreadSheetDefinedName;
begin
  CheckCaption(ACaption);
  CheckForDuplicates(ACaption, AScope);
  Result := DoCreateItem(ACaption, AReference, AScope);
end;

procedure TdxSpreadSheetDefinedNames.AddFromSelection;
begin
  AddFromSelection(SpreadSheet.ActiveSheetAsTable);
end;

procedure TdxSpreadSheetDefinedNames.AddFromSelection(AView: TdxSpreadSheetTableView);
var
  AAreas: TdxRectList;
begin
  AAreas := AView.Selection.ToRectList;
  try
    AddFromSelection(AView, AAreas, TdxSpreadSheetDefinedNameHelper.GetHeaders(AView, AAreas));
  finally
    AAreas.Free;
  end;
end;
...
procedure TdxSpreadSheetDefinedNames.AddFromSelection(
  AView: TdxSpreadSheetTableView; const ASelectedArea: TRect; AHeaders: TcxBorders);

  procedure TryCreate(ARow, AColumn: Integer; const AArea: TRect);
  var
    ACell: TdxSpreadSheetCell;
    AName: string;
  begin
    ...
    ACell := AView.Cells[ARow, AColumn];
    if (ACell = nil) or (ACell.DataType <> cdtString) then
      Exit;

    AName := ACell.AsString;
    if not IsCaptionValid(AName) then
      AName := TdxSpreadSheetDefinedNameHelper.ReplaceIllegalChars(AName, SpreadSheet);
    if not IsCaptionValid(AName) then
      AName := AName + AutoNameSuffix;
    if not IsCaptionValid(AName) then
      Exit;

    if not Contains(AName, nil) then
    begin
      Add(AName, dxReferenceToString(AArea, SpreadSheet.OptionsView.R1C1Reference,
        [croSheetName, croAbsoluteColumn, croAbsoluteRow], AView.Caption), nil);
    end;
  end;
...
begin
  ...
  AContentArea := ASelectedArea;
  if bTop in AHeaders then
    Inc(AContentArea.Top);
  if bLeft in AHeaders then
    Inc(AContentArea.Left);
  if bRight in AHeaders then
    Dec(AContentArea.Right);
  if bBottom in AHeaders then
    Dec(AContentArea.Bottom);

  if dxSpreadSheetIsValidArea(AContentArea) then
  begin
    BeginUpdate;
    try
      History.BeginAction(TdxSpreadSheetHistoryCreateDefinedNameAction);
      try
        if [bTop, bLeft] * AHeaders = [bTop, bLeft] then
          TryCreate(ASelectedArea.Top, ASelectedArea.Left, AContentArea);
        if [bTop, bRight] * AHeaders = [bTop, bRight] then
          TryCreate(ASelectedArea.Top, ASelectedArea.Right, AContentArea);
        if [bBottom, bLeft] * AHeaders = [bBottom, bLeft] then
          TryCreate(ASelectedArea.Bottom, ASelectedArea.Left, AContentArea);
        if [bBottom, bRight] * AHeaders = [bBottom, bRight] then
          TryCreate(ASelectedArea.Bottom, ASelectedArea.Right, AContentArea);

        if bTop in AHeaders then
        begin
          for I := AContentArea.Left to AContentArea.Right do
            TryCreate(ASelectedArea.Top, I, cxRect(I, AContentArea.Top, I, AContentArea.Bottom));
        end;

        if bBottom in AHeaders then
        begin
          for I := AContentArea.Left to AContentArea.Right do
            TryCreate(ASelectedArea.Bottom, I, cxRect(I, AContentArea.Top, I, AContentArea.Bottom));
        end;

        if bLeft in AHeaders then
        begin
          for I := AContentArea.Top to AContentArea.Bottom do
            TryCreate(I, ASelectedArea.Left, cxRect(AContentArea.Left, I, AContentArea.Right, I));
        end;

        if bRight in AHeaders then
        begin
          for I := AContentArea.Top to AContentArea.Bottom do
            TryCreate(I, ASelectedArea.Right, cxRect(AContentArea.Left, I, AContentArea.Right, I));
        end;
      finally
        History.EndAction;
      end;
...
procedure TdxSpreadSheetDefinedNames.AddFromSelection(
  AView: TdxSpreadSheetTableView; ASelectedAreas: TdxRectList; AHeaders: TcxBorders);
var
  I: Integer;
begin
  BeginUpdate;
  try
    for I := 0 to ASelectedAreas.Count - 1 do
      AddFromSelection(AView, ASelectedAreas[I], AHeaders);
  finally
    EndUpdate;
  end;
end;
...
function TdxSpreadSheetDefinedNames.AddOrSet(const ACaption, AReference: string; AScope: TdxSpreadSheetCustomView = nil): TdxSpreadSheetDefinedName;
begin
...
function TdxSpreadSheetDefinedNames.Contains(AScope: TdxSpreadSheetCustomView): Boolean;
var
  I: Integer;
begin
  for I := 0 to Count - 1 do
...
begin
  Result := GetItemByName(ACaption, AScope) <> nil;
end;
...
begin
  if not Find(ACaption, AScope, False, Result) then
    Result := nil;
end;
...
begin
  if Find(ACaption, nil, False, AItem) or Find(ACaption, nil, True, AItem) then
...
var
  AItem: TdxSpreadSheetDefinedName;
begin
  if Find(ACaption, AScope, False, AItem) then
    Result := ItemList.IndexOf(AItem)
  else
    Result := -1;
end;

procedure TdxSpreadSheetDefinedNames.Remove(AItem: TdxSpreadSheetObjectListItem);
begin
  DoRemoveFromIndex(TdxSpreadSheetDefinedName(AItem));
  inherited Remove(AItem);
end;

procedure TdxSpreadSheetDefinedNames.AfterLoad;

  function ChangeSpreadSheetFormatSettings(const Settings: TdxSpreadSheetFormatSettings): TdxSpreadSheetFormatSettings;
  begin
    Result := SpreadSheet.FormatSettings;
    SpreadSheet.FormatSettings := Settings;
  end;
...
begin
  SpreadSheet.BeginUpdate;
  try
    AFormatSettings := TdxSpreadSheetFormatSettings.Create;
    try
      AFormatSettings := ChangeSpreadSheetFormatSettings(AFormatSettings);
      for I := 0 to Count - 1 do
...
procedure TdxSpreadSheetDefinedNames.CheckCaption(const ACaption: string);
begin
  if not IsCaptionValid(ACaption) then
    raise EdxSpreadSheetDefinedNameError.Create(cxGetResourceString(@sdxErrorInvalidDefinedNameSyntax));
end;

procedure TdxSpreadSheetDefinedNames.CheckForDuplicates(const ACaption: string; AScope: TdxSpreadSheetCustomView = nil);
begin
  if Contains(ACaption, AScope) then
    raise EdxSpreadSheetDefinedNameError.CreateFmt(cxGetResourceString(@sdxErrorDefinedNameAlreadyExists), [ACaption]);
end;
...
function TdxSpreadSheetDefinedNames.IsCaptionValid(const ACaption: string): Boolean;
var
  ALength: Integer;
  I: Integer;
  R: TRect;
begin
  ALength := Length(ACaption);
  if (ALength = 0) then
    Exit(False);
  if (ALength = 1) and (Ord(ACaption[1]) < Ord(' ')) then 
    Exit(True);
  if (ACaption[1] <> '_') and not dxCharIsAlpha(ACaption[1]) then
    Exit(False);
  for I := 1 to ALength do
  begin
    if Pos(ACaption[I], SpreadSheet.FormatSettings.BreakChars) > 0 then
      Exit(False);
  end;
  Result := not (dxTryStringToReferenceArea(ACaption, False, R) and dxSpreadSheetIsValidArea(dxSpreadSheetGetRealArea(R)));
end;

procedure TdxSpreadSheetDefinedNames.DoAddToIndex(AItem: TdxSpreadSheetDefinedName);
var
  AList: TList;
begin
  if not FIndex.TryGetValue(AItem.Caption, AList) then
  begin
    AList := TList.Create;
    FIndex.AddOrSetValue(AItem.Caption, AList);
  end;
  AList.Add(AItem);
end;

procedure TdxSpreadSheetDefinedNames.DoClear;
begin
  FIndex.Clear;
  inherited;
end;

function TdxSpreadSheetDefinedNames.DoCreateItem(const ACaption, AReference: string; AScope: TdxSpreadSheetCustomView): TdxSpreadSheetDefinedName;
begin
  ...
  Result.Reference := AReference;
  if History.CanAddCommand then
    History.AddCommand(TdxSpreadSheetHistoryCreateDefinedNameCommand.Create(Result));
  DoAddToIndex(Result);
end;

procedure TdxSpreadSheetDefinedNames.DoChangeCaption(AName: TdxSpreadSheetDefinedName; const ANewCaption: string);
begin
  CheckCaption(ANewCaption);
  CheckForDuplicates(ANewCaption, AName.Scope);

  DoRemoveFromIndex(AName);
  try
    FormulaController.UpdateTokens(
      function (AToken: TdxSpreadSheetFormulaToken): Boolean
      begin
        Result := TdxSpreadSheetFormulaDefinedNameToken(AToken).UpdateValue(AName.Caption, ANewCaption, AName.Scope);
      end, TdxSpreadSheetFormulaDefinedNameToken);
    AName.FCaption := ANewCaption;
  finally
    DoAddToIndex(AName);
  end;
end;

procedure TdxSpreadSheetDefinedNames.DoChangeScope(AName: TdxSpreadSheetDefinedName; AScope: TdxSpreadSheetCustomView);
begin
  FormulaController.UpdateTokens(
    function (AToken: TdxSpreadSheetFormulaToken): Boolean
    begin
      Result := TdxSpreadSheetFormulaDefinedNameToken(AToken).UpdateScope(AName.Caption, AName.Scope, AScope);
    end, TdxSpreadSheetFormulaDefinedNameToken);
  AName.FScope := AScope;
end;

procedure TdxSpreadSheetDefinedNames.DoRemoveFromIndex(AItem: TdxSpreadSheetDefinedName);
var
  AList: TList;
begin
  if FIndex.TryGetValue(AItem.Caption, AList) then
    AList.Remove(AItem);
end;

function TdxSpreadSheetDefinedNames.Find(const ACaption: string; AScope: TdxSpreadSheetCustomView;
  AScopeMaybeEmpty: Boolean; out AItem: TdxSpreadSheetDefinedName): Boolean;
var
  AList: TList;
  I: Integer;
begin
  Result := False;
  if FIndex.TryGetValue(ACaption, AList) then
    for I := 0 to AList.Count - 1 do
    begin
      AItem := AList.List[I];
      if (AItem.Scope = AScope) or AScopeMaybeEmpty and (AScope = nil) then
        Exit(True);
    end;
end;

procedure TdxSpreadSheetDefinedNames.DoRemoveSheet(AScope: TdxSpreadSheetCustomView);
var
  AItem: TdxSpreadSheetDefinedName;
  I: Integer;
begin
...
begin
  Result := TdxSpreadSheetDefinedName(ItemList.List[AIndex]);
end;

function TdxSpreadSheetDefinedNames.GetFormulaController: TdxSpreadSheetFormulaController;
begin
  Result := SpreadSheet.FormulaController;
end;

function TdxSpreadSheetDefinedNames.GetHistory: TdxSpreadSheetHistory;
begin
  Result := SpreadSheet.History;
end;
...
constructor TdxSpreadSheetExternalLink.Create(AOwner: TdxSpreadSheetObjectList);
begin
  inherited;
  FReferenceLinkHost := TdxSpreadSheetObjectLink.Create(Self);
end;
...
function TdxSpreadSheetCustomReader.AddSharedString(const S: string; ARuns: TdxSpreadSheetFormattedSharedStringRuns): TdxSpreadSheetSharedString;
var
  AFormattedString: TdxSpreadSheetFormattedSharedString;
begin
  if ARuns.Count > 0 then
  begin
    AFormattedString := CreateTempFormattedSharedString(S);
    AFormattedString.Runs.Assign(ARuns);
    Result := AddFormattedSharedString(AFormattedString);
  end
  else
    Result := AddSharedString(S);
end;
...
procedure TdxSpreadSheetCustomDragAndDropObject.BeforeBeginDragAndDrop;
begin
  inherited;
  FRightToLeftClientBounds := View.BoundsForRightToLeftConversion;
  FIsRightToLeftLayout := View.ViewInfo.IsRightToLeftLayout;
end;

procedure TdxSpreadSheetCustomDragAndDropObject.CalculateHitTest(const P: TPoint);
begin
  HitTest.Calculate(GetClientCursorPos);
end;
...
begin
  ...
  Result := cxPointOffset(Result, View.GetPartOffsetByPoint(Result));
end;

function TdxSpreadSheetCustomDragAndDropObject.GetContentOrigin: TPoint;
begin
  Result := View.ViewInfo.ContentOrigin;
end;
...
procedure TdxSpreadSheetCustomCellBasedDragAndDropObject.BeforeBeginDragAndDrop;
begin
  inherited;
  Supports(View, IdxSpreadSheetTableView, FTableViewIntf);
end;

function TdxSpreadSheetCustomCellBasedDragAndDropObject.EnsureCellInArea(const ACellRef: TPoint; const AArea: TRect): TPoint;
begin
  Result.X := Max(AArea.Left, Min(AArea.Right, ACellRef.X));
  Result.Y := Max(AArea.Top, Min(AArea.Bottom, ACellRef.Y));
end;

function TdxSpreadSheetCustomCellBasedDragAndDropObject.GetAbsoluteCellBounds(
  const ARowIndex, AColumnIndex: Integer; ACheckMergedCells: Boolean = True): TRect;
begin
  if FTableViewIntf <> nil then
    Result := FTableViewIntf.GetAbsoluteCellBounds(ARowIndex, AColumnIndex, ACheckMergedCells)
  else
    Result := cxNullRect;
end;

function TdxSpreadSheetCustomCellBasedDragAndDropObject.GetCellAtAbsolutePoint(const P: TPoint): TPoint;
begin
  if not GetCellAtAbsolutePoint(P, Result.Y, Result.X) then
    Result := cxInvalidPoint;
end;

function TdxSpreadSheetCustomCellBasedDragAndDropObject.GetCellAtAbsolutePoint(
  const P: TPoint; out ARowIndex, AColumnIndex: Integer): Boolean;
begin
  Result := (FTableViewIntf <> nil) and FTableViewIntf.GetCellAtAbsolutePoint(
    RightToLeftDependedPointToAbsolutePoint(P), ARowIndex, AColumnIndex);
end;

function TdxSpreadSheetCustomCellBasedDragAndDropObject.RightToLeftDependedPointToAbsolutePoint(const P: TPoint): TPoint;
begin
  if IsRightToLeftLayout then
    Result := TdxRightToLeftLayoutConverter.ConvertPoint(P, ToAbsoluteRect(RightToLeftClientBounds))
  else
    Result := P;
end;

function TdxSpreadSheetCustomCellBasedDragAndDropObject.ToAbsolutePoint(const P: TPoint): TPoint;
begin
  Result := cxPointOffset(P, ContentOrigin);
end;

function TdxSpreadSheetCustomCellBasedDragAndDropObject.ToAbsoluteRect(const R: TRect): TRect;
begin
  Result := cxRectOffset(R, ContentOrigin);
end;

function TdxSpreadSheetCustomCellBasedDragAndDropObject.ToContentRect(const R: TRect): TRect;
begin
...
procedure TdxSpreadSheetCustomCellViewInfo.RightToLeftConversion(const AClientBounds: TRect);
begin
  // do nothing
end;
...
procedure TdxSpreadSheetCustomCellViewInfo.Offset(X, Y: Integer);
begin
  // do nothing
end;
...
begin
  ...
  FScreenClipRect := cxFullAreaRect;
end;
...
procedure TdxSpreadSheetCellViewInfo.Offset(X, Y: Integer);
begin
  inherited;
  FBounds := cxRectOffset(FBounds, X, Y);
  FClipRect := cxRectOffset(FClipRect, X, Y);
  if not cxRectIsEqual(FScreenClipRect, cxFullAreaRect) then
    FScreenClipRect := cxRectOffset(FScreenClipRect, X, Y);
end;
...
procedure TdxSpreadSheetCellViewInfo.RightToLeftConversion(const AClientBounds: TRect);
begin
  inherited;
  FBounds := TdxRightToLeftLayoutConverter.ConvertRect(FBounds, AClientBounds);
  FClipRect := TdxRightToLeftLayoutConverter.ConvertRect(FClipRect, AClientBounds);
  if not cxRectIsEqual(FScreenClipRect, cxFullAreaRect) then
    FScreenClipRect := TdxRightToLeftLayoutConverter.ConvertRect(FScreenClipRect, AClientBounds);
end;
...
begin
  ...
  FFrameViewInfo := CreateFrameViewInfo;
end;
...
begin
  Result := IsFrameVisible and FrameViewInfo.InitHitTest(AHitTest);
end;

procedure TdxSpreadSheetTableViewSelectionViewInfo.CalculateCore(ASelection: TdxSpreadSheetTableViewSelection);
const
  CornersMap: array[Boolean] of TdxCorner = (coBottomRight, coBottomLeft);
var
  AFocusedCellArea: TRect;
  AFrameArea: TRect;
  AFrameViewInfo: TdxSpreadSheetTableViewSelectionFrameViewInfo;
  I: Integer;
begin
  ...
  FIsFrameVisible := dxSpreadSheetIsValidArea(AFocusedCellArea);
  ...
  AFrameViewInfo := FrameViewInfo as TdxSpreadSheetTableViewSelectionFrameViewInfo;
  AFrameViewInfo.Corner := CornersMap[OwnerViewInfo.IsRightToLeftLayout];
  AFrameViewInfo.SetBounds(OwnerViewInfo.GetAreaBounds(AFrameArea), OwnerViewInfo.Bounds);
  AFrameViewInfo.Recalculate;
...
function TdxSpreadSheetTableViewSelectionViewInfo.CreateFrameViewInfo: TdxSpreadSheetCellViewInfo;
begin
  Result := TdxSpreadSheetTableViewSelectionFrameViewInfo.Create(OwnerViewInfo.View);
end;
...
begin
  Result := cxRectOffset(OwnerViewInfo.GetAreaBounds(AArea),
    -dxSpreadSheetBordersMergingOffset,
    -dxSpreadSheetBordersMergingOffset);
end;
...
function TdxSpreadSheetCellViewInfoList.Find(AItemOwner: TObject; out AItem; AIndex: PInteger = nil): Boolean;
var
  ATempItem: TdxSpreadSheetCellViewInfo;
  I: Integer;
begin
  for I := 0 to Count - 1 do
  begin
    ATempItem := TdxSpreadSheetCellViewInfo(List[I]);
    if ATempItem.Owner = AItemOwner then
    begin
      if AIndex <> nil then
        AIndex^ := I;
      TObject(AItem) := ATempItem;
      Exit(True);
    end;
  end;
  Result := False;
...
procedure TdxSpreadSheetCellViewInfoList.Offset(X, Y: Integer);
var
  I: Integer;
begin
  for I := 0 to Count - 1 do
...
procedure TdxSpreadSheetCellViewInfoList.RightToLeftConversion(const AClientBounds: TRect);
var
  I: Integer;
begin
  for I := 0 to Count - 1 do
...
procedure TdxSpreadSheetTableViewMergedCellViewInfo.DoDraw(ACanvas: TcxCanvas);
begin
...
procedure TdxSpreadSheetTableViewMergedCellViewInfo.CalculateDisplayStyle;
begin
  View.ConditionalFormatting.CalculateStyle(Style, Area.Top, Area.Left, Cell);
end;
...
procedure TdxSpreadSheetTableViewMergedCellViewInfo.UpdateSupportedDrawingStages;
begin
  FSupportedDrawingStages := [dsSecond] + StyleViewInfo.SupportedDrawingStages;
end;
...
begin
  ...
  begin
    ...
    begin
      ...
      FLineTailRect := cxRectSetHeight(FLineRect, Thickness);
      FLineRect := cxRect(FLineRect.Left, FLineTailRect.Bottom, FLineRect.Left + Thickness, FExpandButtonRect.Top);
    end
    else
    begin
      FExpandButtonRect := cxRectSetHeight(Bounds, AMinSize.cy);
      FLineTailRect := cxRectSetBottom(FLineRect, FLineRect.Bottom, Thickness);
      FLineRect := cxRect(FLineRect.Left, FExpandButtonRect.Bottom, FLineRect.Left + Thickness, FLineTailRect.Top);
    end;
  end
  else
  begin
    ...
    begin
      ...
      FLineTailRect := cxRectSetWidth(FLineRect, Thickness);
      FLineRect := cxRect(FLineTailRect.Right, FLineRect.Top, FExpandButtonRect.Left, FLineRect.Top + Thickness);
    end
    else
    begin
      FExpandButtonRect := cxRectSetWidth(Bounds, AMinSize.cx);
      FLineTailRect := cxRectSetRight(FLineRect, FLineRect.Right, Thickness);
      FLineRect := cxRect(FExpandButtonRect.Right, FLineRect.Top, FLineTailRect.Left, FLineRect.Top + Thickness);
    end;
  end;
end;
...
begin
  ...
  try
    ...
    if Expanded then
    begin
      Painter.DrawGroupLinePart(ACanvas, LineRect);
      Painter.DrawGroupLinePart(ACanvas, LineTailRect);
    end;
...
procedure TdxSpreadSheetTableViewGroupViewInfo.Offset(X, Y: Integer);
begin
  inherited;
  FLineRect := cxRectOffset(FLineRect, X, Y);
  FLineTailRect := cxRectOffset(FLineTailRect, X, Y);
  FExpandButtonRect := cxRectOffset(FExpandButtonRect, X, Y);
end;

procedure TdxSpreadSheetTableViewGroupViewInfo.RightToLeftConversion(const AClientBounds: TRect);
begin
  inherited;
  FExpandButtonRect := TdxRightToLeftLayoutConverter.ConvertRect(FExpandButtonRect, AClientBounds);
  FLineTailRect := TdxRightToLeftLayoutConverter.ConvertRect(FLineTailRect, AClientBounds);
  FLineRect := TdxRightToLeftLayoutConverter.ConvertRect(FLineRect, AClientBounds);
end;
...
procedure TdxSpreadSheetTableViewCustomGroupingAreaViewInfo.Offset(X, Y: Integer);
begin
  inherited;
  Cells.Offset(X, Y);
  Marks.Offset(X, Y);
...
procedure TdxSpreadSheetTableViewCustomGroupingAreaViewInfo.RightToLeftConversion(const AClientBounds: TRect);
var
  I: Integer;
begin
  inherited;
  ...
  for I := 0 to Marks.Count - 1 do
    Marks[I] := TdxRightToLeftLayoutConverter.ConvertRect(Marks[I], AClientBounds);
end;
...
procedure TdxSpreadSheetContainerViewInfo.Offset(X, Y: Integer);
begin
  inherited;
  DoCalculate;
end;
...
begin
  Result := PtInRect(ContentBounds.DeflateToTRect, P);
end;
...
begin
  Result := TransformMatrix.GetBoundingRectangle(ContentBounds).DeflateToTRect;
end;

function TdxSpreadSheetContainerViewInfo.GetRealDrawingBounds: TRect;
begin
  Result := TransformMatrix.GetBoundingRectangle(cxRectInflate(ContentBounds, Ceil(BorderWidth))).InflateToTRect;
end;
...
procedure TdxSpreadSheetContainerViewInfo.RightToLeftConversion(const AClientBounds: TRect);
begin
  inherited;
  DoCalculate;
end;
...
function TdxSpreadSheetContainerViewInfo.GetIsRightToLeftLayout: Boolean;
begin
  Result := Owner.Parent.ViewInfo.IsRightToLeftLayout;
end;
...
procedure TdxSpreadSheetContainerCustomDragAndDropObject.AlignToCell(var ADeltaX, ADeltaY: Integer; P: TPoint);
...
var
  ...
  ARowIndex: Integer;
begin
  if GetCellAtAbsolutePoint(P, ARowIndex, AColumnIndex) then
  begin
    P := RightToLeftDependedPointToAbsolutePoint(P);
    ACellBounds := GetAbsoluteCellBounds(ARowIndex, AColumnIndex, False);

    if P.X > cxRectCenter(ACellBounds).X then
      SetDelta(ADeltaX, ValueIncr[IsRightToLeftLayout] * (P.X - ACellBounds.Right))
    else
      SetDelta(ADeltaX, ValueIncr[IsRightToLeftLayout] * (P.X - ACellBounds.Left));
...
begin
  if FTableViewIntf <> nil then
    Result := FTableViewIntf.GetAbsoluteCellsArea
  else
    Result := cxNullRect;
end;
...
begin
  R := ViewInfo.Bounds;
  if IsRightToLeftLayout then
    R := TdxRightToLeftLayoutConverter.ConvertRect(R, RightToLeftClientBounds);
  Container.Calculator.UpdateAnchors(ToAbsoluteRect(R));
end;
...
procedure TdxSpreadSheetContainerCustomDragAndDropObject.UpdateViewInfoBounds(const AAbsoluteBounds: TRect);

  function ValidateBounds(const ARect: TRect): TRect;
  var
    AParentRect: TRect;
  begin
    if IsRightToLeftLayout then
    begin
      AParentRect := ToAbsoluteRect(RightToLeftClientBounds);
      Result := TdxRightToLeftLayoutConverter.ConvertRect(ARect, AParentRect);
      Result := Container.Calculator.ValidateBounds(Result);
      Result := TdxRightToLeftLayoutConverter.ConvertRect(Result, AParentRect);
    end
    else
      Result := Container.Calculator.ValidateBounds(ARect);
  end;

var
  ARect: TRect;
begin
  ARect := ToContentRect(ValidateBounds(AAbsoluteBounds));
  ViewInfo.SetBounds(ARect);
  ViewInfo.Calculate;
  if IsRightToLeftLayout then
    ViewInfo.RightToLeftConversion(ARect);
end;

function TdxSpreadSheetContainerCustomDragAndDropObject.TranslateCoords(const P: TPoint): TPoint;
begin
  Result := ToAbsolutePoint(inherited TranslateCoords(P));
end;
...
procedure TdxSpreadSheetContainerSelectionCellViewInfo.Offset(X, Y: Integer);
begin
  inherited;
  FSizeMarkersArea := cxRectOffset(FSizeMarkersArea, X, Y);
end;
...
begin
  Result := cxRectInflate(ContainerViewInfo.TransformMatrix.GetBoundingRectangle(dxRectF(Bounds)).DeflateToTRect, 1);
end;
...
procedure TdxSpreadSheetContainerSelectionCellViewInfo.RightToLeftConversion(const AClientBounds: TRect);
begin
  inherited;
  FSizeMarkersArea := TdxRightToLeftLayoutConverter.ConvertRect(FSizeMarkersArea, AClientBounds);
end;
...
begin
  ...
  APartOffset := View.GetPartOffsetByPoint(cxPointScale(StartPos, 100, ZoomFactor));
  ...
  if Items.GetItemVisible(ItemIndex + 1) then
    ItemStartPos := cxPoint(AHeaderViewInfo.Bounds.Left, AHeaderViewInfo.Bounds.Top)
  else
  ...
  ItemStartPos := cxPointOffset(ItemStartPos, APartOffset, False);
  ItemStartPos := cxPointScale(ItemStartPos, ZoomFactor, 100);
end;
...
begin
  ...
  begin
    ...
    try
      ...
      if Items.IsItemSelected(ItemIndex) then
      begin
        ...
        begin
          ...
          AEntireAreaSelected := dxSpreadSheetIsEntireArea(ARect);
          if not AEntireAreaSelected then
            ...
            begin
              ...
              AEntireAreaSelected := AEntireAreaSelected or dxSpreadSheetIsEntireArea(View.Selection.Items[I].Rect);
            end;
          ...
          begin
            ...
            for I := ARect.Left to ARect.Right do
              if (Orientation = orHorizontal) and View.Selection.IsEntireColumnSelected(I) or
                 (Orientation = orVertical) and View.Selection.IsEntireRowSelected(I)
              then
...
begin
  ...
  DoPrepareCanvas(ACanvas);
  LookAndFeelPainter.DrawSpreadSheetScaledHeader(ACanvas, Bounds, Neighbors, Borders, State, dxDefaultScaleFactor);

  if DisplayText <> '' then
  begin
    ACanvas.Font.Color := ViewParams.TextColor;
    ACanvas.Brush.Style := bsClear;
    ACanvas.DrawText(DisplayText, cxTextRect(Bounds), cxAlignmentsHorz[AlignHorz] or cxAlignmentsVert[AlignVert] or cxSingleLine);
...
function TdxSpreadSheetTableViewHeaderCellViewInfo.GetState: TcxButtonState;
begin
  if IsSelected then
    Result := cxbsPressed
  else
...
begin
  Result := cxGetActualColor(ViewParams.TextColor, ColorMap[IsSelected]);
end;
...
begin
  ...
  FBorders := LookAndFeelPainter.HeaderBorders(Neighbors);
  if not Items.GetItemVisible(Index - 1) then
  begin
    if Neighbors * [nLeft, nRight] = [] then
      Include(FBorders, bTop)
    else
      Include(FBorders, bLeft);
  end;
end;

procedure TdxSpreadSheetTableViewHeaderCellViewInfo.RightToLeftConversion(const AClientBounds: TRect);
begin
  inherited;
...
function TdxSpreadSheetTableViewHeaderCellViewInfo.InitHitTest(AHitTest: TdxSpreadSheetCustomHitTest): Boolean;
  ...
  function IsInResizeArea: Boolean;
  var
    AAreaSize: Integer;
  begin
    AAreaSize := 2 * dxSpreadSheetResizeAreaSize;
    if (FNextNeighbor <> nil) and (FNextNeighbor.Item <> nil) and (FNextNeighbor.Item.Size < AAreaSize) then
      AAreaSize := dxSpreadSheetResizeAreaSize;
    Result := cxRectPtIn(GetResizeArea(AAreaSize), AHitTest.ActualHitPoint);
  end;
...
begin
  ...
  if Index >= 0 then
  begin
    AHitTest.SetHitCode(hcResizeArea, IsInResizeArea and AllowResize and (View.Controller.SelectionMode = smNone));
...
begin
  SetIsSelected(Items.IsItemSelected(Index));
end;

procedure TdxSpreadSheetTableViewHeaderCellViewInfo.SetIsSelected(AValue: Boolean);
begin
...
function TdxSpreadSheetTableViewColumnHeaderCellViewInfo.GetRectEdges(const R: TRect): TPoint;
begin
  Result := cxPoint(R.Left, R.Right);
end;

function TdxSpreadSheetTableViewColumnHeaderCellViewInfo.GetResizeArea(const AResizeAreaSize: Integer): TRect;
begin
  if ViewInfo.IsRightToLeftLayout then
    Result := cxRectSetRight(Bounds, Bounds.Left + dxSpreadSheetResizeAreaSize, AResizeAreaSize)
  else
    Result := cxRectSetLeft(Bounds, Bounds.Right - dxSpreadSheetResizeAreaSize, AResizeAreaSize);
end;
...
function TdxSpreadSheetTableViewHeaderCornerCellViewInfo.GetRectEdges(const R: TRect): TPoint;
begin
  Result := cxNullPoint;
end;
...
begin
  if AHitTest.GetHitCode(hcResizeArea) then
    ...
    if ViewInfo.IsRightToLeftLayout then
      Result := crdxSpreadSheetRightArrow
    else
...
function TdxSpreadSheetTableViewRowHeaderCellViewInfo.GetRectEdges(const R: TRect): TPoint;
begin
  Result := cxPoint(R.Top, R.Bottom);
end;

function TdxSpreadSheetTableViewRowHeaderCellViewInfo.GetResizeArea(const AResizeAreaSize: Integer): TRect;
begin
  Result := cxRectSetTop(Bounds, Bounds.Bottom - dxSpreadSheetResizeAreaSize, AResizeAreaSize);
end;
...
procedure TdxSpreadSheetTableViewCustomDataCellViewInfo.Offset(X: Integer; Y: Integer);
begin
  inherited;
  FContentBounds := cxRectOffset(FContentBounds, X, Y);
  FTextBounds := cxRectOffset(FTextBounds, X, Y);
  StyleViewInfo.Offset(Point(X, Y));
end;
...
procedure TdxSpreadSheetTableViewCustomDataCellViewInfo.CalculateDisplayStyle;
begin
  // do nothing
end;
...
var
  ACalculator: TdxSpreadSheetShrinkToFitCalculator;
...
begin
  ...
  begin
    ...
    if (ADisplayValue.Font = nil) or (ADisplayValue.ShrinkToFitCacheContentWidth <> R.Width) then
    begin
      ACalculator := dxSpreadSheetTextService.CreateShrinkToFitCalculator(Cell, Style);
      try
        ADisplayValue.ShrinkToFitCacheContentWidth := R.Width;
        ADisplayValue.Font := ACalculator.Calculate(ADisplayValue.ShrinkToFitCacheContentWidth);
      finally
        ACalculator.Free;
      end;
    end;
    Style.Font.Assign(ADisplayValue.Font);
  end;

  FTextBounds := R;
  APrevPixelsPerInch := dxSpreadSheetPrepareCanvas(cxScreenCanvas, Style.Handle.Font.GraphicObject, dxDefaultDPI);
  try
    if View.ZoomFactor <> 100 then
    begin
  ...
  begin
    ATopPos := cxRectCenter(R).Y - cxRectHeight(FTextBounds) div 2;
    if Multiline then
      ATopPos := Max(ATopPos, R.Top);
    FTextBounds := cxRectSetTop(FTextBounds, ATopPos, cxRectHeight(FTextBounds));
  end;
...
begin
  ...
  AHasStyle := dsSecond in StyleViewInfo.SupportedDrawingStages;
  AHasText := not cxRectIsEmpty(FTextBounds);
  if not (AHasText or AHasStyle) then
    Exit;
  if not cxRectIntersect(AClipRect, ContentBounds, FScreenClipRect) then
    Exit;
  if not ACanvas.RectVisible(AClipRect) then
    Exit;
...
begin
  ...
  if ACell <> nil then
    FTextColor := ACell.DisplayValue.Color;
  if FTextColor = clDefault then
    FTextColor := Style.Handle.Font.Color;
  if FTextColor = clDefault then
    FTextColor := SpreadSheet.CellStyles.DefaultStyle.Font.Color;
  if FTextColor = clDefault then
    FTextColor := ViewInfo.ContentParams.TextColor;
  ...
  begin
    ...
    if Style.AlignHorz = ssahGeneral then
      FAlignHorz := GeneralAlignToTextAlign[ACell.DisplayValueDataType]
    else
...
begin
  ...
  begin
    FStyle := TdxSpreadSheetCellDisplayStyle.Create(View, AStyleHandle);
...
procedure TdxSpreadSheetTableViewCustomDataCellViewInfo.RightToLeftConversion(const AClientBounds: TRect);
begin
  inherited;

  FAlignHorz := TdxRightToLeftLayoutConverter.ConvertcxTextAlignX(FAlignHorz);
  ...
  StyleViewInfo.UseRightToLeftLayout := True;
  StyleViewInfo.Calculate(FContentBounds, FContentBounds);
end;
...
procedure TdxSpreadSheetTableViewCellViewInfo.Offset(X: Integer; Y: Integer);
begin
  inherited;
  FCellBounds := cxRectOffset(FCellBounds, X, Y);
end;
...
procedure TdxSpreadSheetTableViewCellViewInfo.RightToLeftConversion(const AClientBounds: TRect);
begin
  inherited;
  FCellBounds := TdxRightToLeftLayoutConverter.ConvertRect(FCellBounds, AClientBounds);
end;
...
begin
  ...
  begin
    FSupportedDrawingStages := FSupportedDrawingStages + StyleViewInfo.SupportedDrawingStages;
    if not cxRectIsEmpty(TextBounds) and (DisplayText <> '') then
      Include(FSupportedDrawingStages, dsSecond);
  end;
...
begin
  ...
  begin
    inherited CalculateDisplayTextParameters(R, ACell);
    if Style.AlignHorz <> ssahFill then
    begin
  ...
  try
    ...
    begin
      if HasBorder(ASide) and ((DrawingStage = dsFirst) = (BorderStyle[ASide] = sscbsDefault)) then
        dxSpreadSheetDrawBorder(ACanvas, ABounds, BorderColor[ASide], BackgroundColor, ASide, FBorderStyle);
    end;
  finally
...
begin
  if ViewInfo.IsRightToLeftLayout then
  begin
    APoints[0] := cxPoint(CellBounds.Left + 1, CellBounds.Top + 1);
...
begin
  ...
  if HitTest.HitAtPageTab then
    DoMouseClickAtTab(Button, X, Y, TdxSpreadSheetPageControlTabCellViewInfo(HitTest.HitObject));
  if HitTest.HitAtButton then
    DoMouseClickAtButton(Button, X, Y, TdxSpreadSheetPageControlButtonCellViewInfo(HitTest.HitObject));
end;

procedure TdxSpreadSheetPageControlController.DoAddNewSheet;
begin
  if not SpreadSheet.DoPageControlTabNewTabButtonClick then
    SpreadSheet.AddSheet('').Active := True;
end;

procedure TdxSpreadSheetPageControlController.DoMouseClickAtButton(
  AButton: TMouseButton; X, Y: Integer; AButtonViewInfo: TdxSpreadSheetPageControlButtonCellViewInfo);
begin
  if AButton <> mbLeft then
    Exit;
  if AButtonViewInfo.State = cxbsDisabled then
    Exit;

  case AButtonViewInfo.ButtonType of
    sspcbFirst:
    ...
    sspcbNext:
      PageControl.FirstVisiblePageIndex := PageControl.FirstVisiblePageIndex + 1;
    sspcbLast:
      PageControl.FirstVisiblePageIndex := PageControl.ViewInfo.PageCount - 1;
    sspcbNew:
      DoAddNewSheet;
  end;
end;

procedure TdxSpreadSheetPageControlController.DoMouseClickAtTab(
  AButton: TMouseButton; X, Y: Integer; ATabViewInfo: TdxSpreadSheetPageControlTabCellViewInfo);
var
  AActiveSheet: TdxSpreadSheetCustomView;
  ACursorOffset: TPoint;
  ATargetSheet: TdxSpreadSheetCustomView;
begin
  AActiveSheet := SpreadSheet.ActiveSheet;
  ATargetSheet := ATabViewInfo.View;
  if (AActiveSheet <> nil) and (AActiveSheet.IsRightToLeftLayout <> ATargetSheet.IsRightToLeftLayout) then
  begin
    ACursorOffset := cxPointOffset(Mouse.CursorPos, SpreadSheet.ClientToScreen(ATabViewInfo.Bounds.TopLeft), False);
    ATargetSheet.Active := True;
    if PageControl.ViewInfo.FindTabViewInfo(ATargetSheet, ATabViewInfo) then
    begin
      ACursorOffset := cxPointOffset(ACursorOffset, SpreadSheet.ClientToScreen(ATabViewInfo.Bounds.TopLeft));
      SetCursorPos(ACursorOffset.X, ACursorOffset.Y);
      SpreadSheet.CancelMouseOperations;
    end;
  end
  else
    ATargetSheet.Active := True;
...
begin
  ...
  try
    ...
    cxRightToLeftDependentDraw(ACanvas, Bounds,
      procedure
      begin
...
procedure TdxSpreadSheetPageControlTabDragAndDropObject.BeginDragAndDrop;
begin
  inherited;
  SpreadSheet.DoPageControlTabStartDrag(View.Index);
end;

procedure TdxSpreadSheetPageControlTabDragAndDropObject.DragAndDrop(const P: TPoint; var Accepted: Boolean);
const
  SideMap: array[Boolean] of TcxBorder = (bLeft, bRight);
var
  ASide: TcxBorder;
  R: TRect;
begin
  ...
  begin
    ASide := SideMap[(cxRectCenter(R).X < P.X)];
    R := cxRectOffset(R, SpreadSheet.ClientToScreen(cxNullPoint));
    R.Right := R.Right - Byte(ASide = bRight);
    DropIndex := HitTestView.Index + Byte((ASide <> bRight) = PageControl.IsRightToLeftLayout);
  ...
  if Accepted then
    SpreadSheet.DoPageControlTabDragAndDrop(View.Index, DropIndex, Accepted);
  if Accepted then
...
begin
  ...
  APrevIndex := View.Index;
  if Accepted and (DropIndex >= 0) then
    View.Index := DropIndex;

  SpreadSheet.DoPageControlTabEndDrag(APrevIndex, View.Index);
end;
...
function TdxSpreadSheetPageControlTabDragAndDropObject.GetSpreadSheet: TdxCustomSpreadSheet;
begin
  Result := PageControl.SpreadSheet;
end;
...
begin
  ...
  begin
    ...
    cxTextOut(ACanvas.Handle, View.Caption, ATextRect, FTextFlags, nil, 0, 0, 0, ColorToRGB(ViewParams.TextColor));
  end;
end;

procedure TdxSpreadSheetPageControlTabCellViewInfo.RightToLeftConversion(const AClientBounds: TRect);
begin
  inherited;
  FTextFlags := FTextFlags or CXTO_RTLREADING;
end;
...
begin
  FView := AView;
  FTextFlags := cxMakeFormat(taLeft, taBottom);
  SetBounds(cxRectSetWidth(ABounds, GetMeasureTextSize(View.Active, ViewParams.Font, View.Caption).cx), AClipRect);
  UpdateState;
end;

class function TdxSpreadSheetPageControlTabCellViewInfo.GetMeasureTextSize(
  AActive: Boolean; const AFont: TFont; const AText: string): TSize;
begin
  cxScreenCanvas.Font := AFont;
  if AActive then
    cxScreenCanvas.Font.Style := cxScreenCanvas.Font.Style + [fsBold];
  Result := cxSizeAddMargins(cxScreenCanvas.TextExtent(AText), GetTextMargins);
  cxScreenCanvas.Dormant;
end;
...
function TdxSpreadSheetPageControlSplitterCellViewInfo.GetDragAndDropObjectClass(
  AHitTest: TdxSpreadSheetCustomHitTest): TcxDragAndDropObjectClass;
begin
...
begin
  ...
  if SpreadSheet.DragAndDropState = ddsInProcess then
  begin
    if SpreadSheet.DragAndDropObject is TdxSpreadSheetPageControlSplitterDragAndDropObject then
      Result := cxbsHot;
  end;
end;
...
begin
  Result := LookAndFeelPainter.GetScaledSplitterSize(True, ScaleFactor).cx;
  if Result = 0 then
    Result := 17;
...
begin
  FStartPos := GetMouseCursorPos;
  FStartWidth := cxRectWidth(PageControl.ViewInfo.Bounds);
end;
...
var
  ADelta: Integer;
begin
  ADelta := GetMouseCursorPos.X - FStartPos.X;
  if PageControl.IsRightToLeftLayout then
    ADelta := -ADelta;
  PageControl.Width := FStartWidth + ADelta;
end;
...
begin
  ...
  AClientBounds := cxRect(AClientBounds.Left, AClientBounds.Bottom, AClientBounds.Right, AClientBounds.Bottom + MeasureHeight);
  FBounds := cxRectSetWidth(AClientBounds, MeasureWidth);

  AddCells;

  if PageControl.IsRightToLeftLayout then
    RightToLeftConversion(AClientBounds);
end;
...
begin
  ...
  begin
    ...
    Result := Max(Result, TdxSpreadSheetPageControlTabCellViewInfo.GetMeasureTextSize(True, ViewParams.Font, dxMeasurePattern).cy);
    cxScreenCanvas.Dormant;
  end;
end;
...
begin
  ...
  if PageControl.FirstVisiblePageIndex > 0 then
    FLeftScrollArea := cxRectSetXPos(R, Bounds.Left, R.Right + dxSpreadSheetResizeAreaSize * 3);

  FLastVisiblePageIndex := PageControl.FirstVisiblePageIndex;
  for I := PageControl.FirstVisiblePageIndex to PageCount - 1 do
  begin
  ...
  if FLastVisiblePageIndex < PageCount - 1 then
    FRightScrollArea := cxRectSetXPos(R, FClipRect.Right - dxSpreadSheetResizeAreaSize * 3, SpreadSheet.ClientBounds.Right)
  else
...
function TdxSpreadSheetPageControlViewInfo.FindTabViewInfo(
  AView: TdxSpreadSheetCustomView; out ATabViewInfo: TdxSpreadSheetPageControlTabCellViewInfo): Boolean;
var
...
begin
  ...
  begin
    ACell := Cells[I];
    if ACell is TdxSpreadSheetPageControlTabCellViewInfo then
      if TdxSpreadSheetPageControlTabCellViewInfo(ACell).View = AView then
      begin
        ATabViewInfo := TdxSpreadSheetPageControlTabCellViewInfo(ACell);
        Exit(True);
      end;
  end;
  Result := False;
...
procedure TdxSpreadSheetPageControlViewInfo.RightToLeftConversion(const AClientBounds: TRect);
begin
  FBounds := TdxRightToLeftLayoutConverter.ConvertRect(FBounds, AClientBounds);
  FClipRect := TdxRightToLeftLayoutConverter.ConvertRect(FClipRect, AClientBounds);
  FLeftScrollArea := TdxRightToLeftLayoutConverter.ConvertRect(FLeftScrollArea, AClientBounds);
  FRightScrollArea := TdxRightToLeftLayoutConverter.ConvertRect(FRightScrollArea, AClientBounds);
  Cells.RightToLeftConversion(AClientBounds);
end;
...
procedure TdxSpreadSheetPageControlViewInfo.PopulatePages;
var
  I: Integer;
begin
  FPages.Count := 0;
  FPages.Capacity := SpreadSheet.VisibleSheetCount;
  for I := 0 to SpreadSheet.VisibleSheetCount - 1 do
    FPages.Add(SpreadSheet.VisibleSheets[I]);
end;
...
function TdxSpreadSheetPageControlViewInfo.GetPage(Index: Integer): TdxSpreadSheetCustomView;
begin
  Result := TdxSpreadSheetCustomView(FPages[Index]);
end;

function TdxSpreadSheetPageControlViewInfo.GetPageCount: Integer;
begin
  Result := FPages.Count;
end;
...
begin
  if APage <> nil then
  begin
    Calculate; // TODO: introduce IsDirty flag
    AIndex := ViewInfo.FPages.IndexOf(APage);
...
procedure TdxSpreadSheetPageControl.Calculate;
begin
  HitTest.Clear;
  ViewInfo.Calculate;
...
function TdxSpreadSheetPageControl.IsRightToLeftLayout: Boolean;
begin
  Result := SpreadSheet.UseRightToLeftAlignment;
end;
...
constructor TdxSpreadSheetOptionsMetadata.Create(ASpreadSheet: TdxCustomSpreadSheet);
begin
  inherited Create(nil);
  FSpreadSheet := ASpreadSheet;
  Initialize;
...
function TdxSpreadSheetOptionsMetadata.HasData: Boolean;
var
  I: Integer;
begin
  Result := False;
  for I := Low(FDateTime) to High(FDateTime) do
    Result := Result or (FDateTime[I] > 0);
  for I := Low(FStrings) to High(FStrings) do
    Result := Result or (FStrings[I] <> EmptyStr);
end;

procedure TdxSpreadSheetOptionsMetadata.Initialize;
begin
  BeginUpdate;
  try
    Reset;
    Created := dxGetNowInUTC;
    CreatedBy := dxGetUserNameEx(dxUserNameDisplay);
  finally
    CancelUpdate;
  end;
end;

procedure TdxSpreadSheetOptionsMetadata.Reset;
var
  I: Integer;
begin
  for I := Low(FStrings) to High(FStrings) do
...
procedure TdxSpreadSheetOptionsMetadata.UpdateLastModificationData;
begin
  BeginUpdate;
  try
    LastModified := dxGetNowInUTC;
    LastModifiedBy := dxGetUserNameEx(dxUserNameDisplay);
  finally
    CancelUpdate;
  end;
end;

procedure TdxSpreadSheetOptionsMetadata.UpdateLastPrinted;
begin
  BeginUpdate;
  try
    LastPrinted := dxGetNowInUTC;
  finally
    CancelUpdate;
  end;
end;

function TdxSpreadSheetOptionsMetadata.GetDateTime(const Index: Integer): TDateTime;
begin
  Result := FDateTime[Index];
end;

function TdxSpreadSheetOptionsMetadata.GetString(const Index: Integer): string;
begin
  Result := FStrings[Index];
end;

procedure TdxSpreadSheetOptionsMetadata.SetDateTime(const Index: Integer; const Value: TDateTime);
begin
  if not SameValue(Value, FDateTime[Index]) then
  begin
    FDateTime[Index] := Value;
    Changed;
  end;
end;

procedure TdxSpreadSheetOptionsMetadata.SetString(const Index: Integer; const Value: string);
begin
  if Value <> FStrings[Index] then
  begin
...
procedure TdxSpreadSheetOptionsMetadata.DoAssign(Source: TPersistent);
var
  I: Integer;
begin
  if Source is TdxSpreadSheetOptionsMetadata then
  begin
    for I := Low(FStrings) to High(FStrings) do
      SetString(I, TdxSpreadSheetOptionsMetadata(Source).FStrings[I]);
    for I := Low(FDateTime) to High(FDateTime) do
      SetDateTime(I, TdxSpreadSheetOptionsMetadata(Source).FDateTime[I]);
  end;
end;

procedure TdxSpreadSheetOptionsMetadata.DoChanged;
begin
  SpreadSheet.AddChanges([sscMetadata, sscModified]);
end;
...
begin
  ...
  FDragMoving := True;
  FDragFilling := True;
  FIterativeCalculationMaxCount := 1;
end;
...
begin
  ...
  begin
    ...
    HistoryMaxActionCount := TdxSpreadSheetOptionsBehavior(Source).HistoryMaxActionCount;
...
function TdxSpreadSheetOptionsBehavior.GetHistoryMaxActionCount: Integer;
begin
  Result := SpreadSheet.History.MaxActionCount;
end;
...
procedure TdxSpreadSheetOptionsBehavior.SetHistoryMaxActionCount(AValue: Integer);
begin
  SpreadSheet.History.MaxActionCount := AValue;
end;

procedure TdxSpreadSheetOptionsBehavior.SetIterativeCalculationMaxCount(AValue: Integer);
begin
  FIterativeCalculationMaxCount := Max(AValue, 1);
end;
...
begin
  AValue := EnsureRange(AValue, 0, dxSpreadSheetMaxSeparatorWidth);
...
begin
  ASpreadSheet := SpreadSheet;
  AHistory := SpreadSheet.History;

  AHistory.CurrentAction := nil;
  if AHistory.RedoActions[AHistory.RedoActionCount - 1] = Self then
  begin
    ASpreadSheet.BeginUpdate;
    AHistory.InProcess := True;
    try
      AData := StoreSelection;
      try
        DoRedo;
        AHistory.RedoActionList.Remove(Self);
        AHistory.UndoActionList.Add(Self);
      finally
        RestoreSelection(AData);
      end;
    finally
      AHistory.InProcess := False;
      ASpreadSheet.EndUpdate;
      AHistory.CheckCapacity;
    end;
  end;
end;
...
class function TdxSpreadSheetHistoryChangeDefinedNameAction.GetDescription: string;
begin
  Result := cxGetResourceString(@sdxActionChangeDefinedName);
end;

{ TdxSpreadSheetHistoryDeleteDefinedNameAction }

class function TdxSpreadSheetHistoryDeleteDefinedNameAction.GetDescription: string;
begin
  Result := cxGetResourceString(@sdxActionDeleteDefinedName);
end;
...
procedure TdxSpreadSheetHistory.DoChanged;
begin
  SpreadSheet.DoHistoryChanged;
end;

function TdxSpreadSheetHistory.CheckCapacity: Boolean;
begin
  Result := False;
  if MaxActionCount > 0 then
    while (FUndoActions.Count > 0) and (GetActionCount > MaxActionCount) do
    begin
      FUndoActions.FreeAndDelete(0);
      Result := True;
    end;
end;

function TdxSpreadSheetHistory.GetActionCount: Integer;
begin
  Result := FUndoActions.Count + FRedoActions.Count;
end;
...
procedure TdxSpreadSheetHistory.SetMaxActionCount(AValue: Integer);
begin
  AValue := Max(AValue, 0);
  if MaxActionCount <> AValue then
  begin
    FMaxActionCount := AValue;
...
constructor TdxSpreadSheetChangeAggregator.Create(AChangeHandler: TProc; AWaitInterval: Cardinal);
begin
  FHandler := AChangeHandler;
  FWaitInterval := AWaitInterval;
end;

destructor TdxSpreadSheetChangeAggregator.Destroy;
begin
  FreeAndNil(FTimer);
  inherited;
end;

procedure TdxSpreadSheetChangeAggregator.Changed;
begin
  FLastChangeTimestamp := GetTickCount;
  if FTimer = nil then
    FTimer := cxCreateTimer(TimerHandler, FWaitInterval, True);
end;

procedure TdxSpreadSheetChangeAggregator.Flush;
begin
  FreeAndNil(FTimer);
end;

procedure TdxSpreadSheetChangeAggregator.ForceProcess;
begin
  if FTimer <> nil then
    Process;
end;

procedure TdxSpreadSheetChangeAggregator.Process;
begin
  FreeAndNil(FTimer);
  FHandler();
end;

procedure TdxSpreadSheetChangeAggregator.TimerHandler(Sender: TObject);
begin
  if GetTickCount - FLastChangeTimestamp >= FWaitInterval then
    Process;
end;
...
procedure TdxCustomSpreadSheet.AfterConstruction;
begin
  inherited AfterConstruction;
...
begin
  ...
  try
    History.Lock;
    try
      ClipboardArea.View := nil;
      StopEditing;
      OptionsMetadata.Reset;
...
procedure TdxCustomSpreadSheet.CancelUpdate;
begin
  FChanges := [];
  EndUpdate;
end;
...
procedure TdxCustomSpreadSheet.CreateNew;
begin
  BeginUpdate;
  try
    ClearAll;
    AddSheet;
    OptionsMetadata.Initialize;
    ClearModified;
  finally
    EndUpdate;
  end;
...
begin
  ...
  try
    ...
    begin
      ...
      if sscBiDiMode in Changes then
      begin
        UpdateBiDiMode;
        Changes := Changes + [sscLayout] - [sscBiDiMode];
      end;
      ...
      begin
        ...
        begin
          if sscMetadata in Changes then
            UpdateMetadataHelper.Flush
          else
            UpdateMetadataHelper.Changed;

          Modified := True;
        end;
      end;

      Changes := Changes - [sscStyle, sscMetadata];
      FSheets.CheckChanges;
    end;
  finally
...
procedure TdxCustomSpreadSheet.ClearModified;
begin
  FSheets.ClearModified;
  Exclude(FChanges, sscModified);
  Modified := False;
end;
...
function TdxCustomSpreadSheet.CreateUpdateMetadataHelper: TdxSpreadSheetChangeAggregator;
begin
  Result := TdxSpreadSheetChangeAggregator.Create(OptionsMetadata.UpdateLastModificationData, 300);
end;
...
function TdxCustomSpreadSheet.CreateOptionsMetadata: TdxSpreadSheetOptionsMetadata;
begin
  Result := TdxSpreadSheetOptionsMetadata.Create(Self);
end;
...
begin
  ...
  FOptionsProtection := CreateOptionsProtection;
  FOptionsMetadata := CreateOptionsMetadata;
  ...
  FUpdateMetadataHelper := CreateUpdateMetadataHelper;
...
begin
  ...
  FreeAndNil(FUpdateMetadataHelper);
...
begin
  ...
  AddChanges([sscLayout, sscBiDiMode]);
  BoundsChanged;
...
begin
  if Assigned(OnGetPassword) then
    ...
    Result := ShowPasswordDialog(Self, TdxSpreadSheetPasswordDialogMode.pdmQuery, APassword);
end;
...
function TdxCustomSpreadSheet.DoPageControlContextPopup(const P: TPoint; APopupMenu: TPopupMenu): Boolean;
begin
  Result := False;
  if Assigned(OnPageControlContextPopup) then
    OnPageControlContextPopup(Self, P, APopupMenu, Result);
end;

function TdxCustomSpreadSheet.DoPageControlTabNewTabButtonClick: Boolean;
begin
  Result := False;
  if Assigned(OnPageControlNewTabButtonClick) then
    OnPageControlNewTabButtonClick(Self, Result);
end;

procedure TdxCustomSpreadSheet.DoPageControlTabStartDrag(AIndex: Integer);
begin
  if Assigned(OnPageControlTabStartDrag) then
    OnPageControlTabStartDrag(Self, AIndex);
end;

procedure TdxCustomSpreadSheet.DoPageControlTabDragAndDrop(AIndex, ANewIndex: Integer; var AAccepted: Boolean);
begin
  if Assigned(OnPageControlTabDragAndDrop) then
    OnPageControlTabDragAndDrop(Self, AIndex, ANewIndex, AAccepted);
end;

procedure TdxCustomSpreadSheet.DoPageControlTabEndDrag(AOldIndex, AIndex: Integer);
begin
  if Assigned(OnPageControlTabEndDrag) then
    OnPageControlTabEndDrag(Self, AOldIndex, AIndex);
end;
...
function TdxCustomSpreadSheet.DoTableViewContextPopup(const P: TPoint; APopupMenu: TPopupMenu): Boolean;
begin
  Result := False;
  if Assigned(OnTableViewContextPopup) then
    OnTableViewContextPopup(ActiveSheetAsTable, P, APopupMenu, Result);
end;
...
begin
  ...
  begin
    ...
    try
      BeginUpdate;
      try
        if ClipboardArea.View = ASheet then
          Clipboard.Clear;
        FVisibleSheets.Remove(ASheet);
        FSheets.Remove(ASheet);
        FDefinedNames.DoRemoveSheet(ASheet);
        SetActiveSheetIndex(ActiveSheetIndex);
...
begin
  ...
  begin
    ...
    begin
      if UseRightToLeftAlignment then
        Result.Right := MulDiv(ActiveSheetAsTable.ViewInfo.CellsArea.Right, ActiveSheet.ZoomFactor, 100)
      else
        Result.Left := MulDiv(ActiveSheetAsTable.ViewInfo.CellsArea.Left, ActiveSheet.ZoomFactor, 100);
    end;
  ...
  begin
    if PageControl.IsRightToLeftLayout then
      Dec(Result.Right, PageControl.ViewInfo.MeasureWidth)
    else
...
begin
  ...
  begin
    Result := cxRectBounds(ClientBounds.BottomRight, 0, 0);
...
procedure TdxCustomSpreadSheet.SetActualBiDiMode(AValue: TBiDiMode);
var
  AParentBiDiMode: Boolean;
begin
  Include(FState, sssBiDiModeChanging);
  try
    AParentBiDiMode := ParentBiDiMode;
    inherited SetBiDiMode(AValue);
    ParentBiDiMode := AParentBiDiMode;
  finally
    Exclude(FState, sssBiDiModeChanging);
  end;
end;

procedure TdxCustomSpreadSheet.SetBiDiMode(AValue: TBiDiMode);
begin
  if sssBiDiModeChanging in FState then
    Exit;
  if FBiDiMode <> AValue then
  begin
    FBiDiMode := AValue;
    ParentBiDiMode := False;
    AddChanges([sscBiDiMode]);
  end;
end;
...
begin
  ...
  begin
    ...
    if ssDouble in Shift then
      ActiveController.DblClick(Point(X, Y));
  end;
  UpdateHitTests(X, Y);
end;
...
begin
  for I := 0 to SheetCount - 1 do
    Sheets[I].AddChanges([sscData, sscStyle]);
end;
...
begin
  ...
  begin
    if ShowPasswordDialog(Self, TdxSpreadSheetPasswordDialogMode.pdmQuery, APassword) then
    begin
      if not AOptions.ProtectionInfo.CheckPassword(APassword) then
        raise EdxSpreadSheetInvalidPasswordError.Create(cxGetResourceString(@sdxOleCryptoContainerInvalidPassword));
...
procedure TdxCustomSpreadSheet.UpdateBiDiMode;
var
  ASheet: TdxSpreadSheetCustomView;
begin
  ASheet := ActiveSheet;
  if ASheet <> nil then
  begin
    if ASheet.IsRightToLeftLayout then
      SetActualBiDiMode(bdRightToLeft)
    else
      SetActualBiDiMode(bdLeftToRight);
  end
  else
    SetActualBiDiMode(BiDiMode);
end;
...
begin
  if History.CanAddCommand then
    History.AddCommand(TdxSpreadSheetHistoryChangeDefaultCellStyleCommand.Create(Self));
end;
    ...
    try
      ...
      try
        ...
        try
          ...
          try
            ClearAll;
            DefaultCellStyle.Handle := CellStyles.DefaultStyle;
...
begin
  UpdateMetadataHelper.ForceProcess;
  StopEditing;
  if AFormat = nil then
...
begin
  ...
  begin
    ...
    begin
      ...
      ActiveSheetAsTable.EditingController.HideEdit(True);
    end;
...
procedure TdxCustomSpreadSheet.SetOptionsMetadata(AValue: TdxSpreadSheetOptionsMetadata);
begin
  FOptionsMetadata.Assign(AValue);
end;
...
procedure TdxCustomSpreadSheet.CMBiDiModeChanged(var Message: TMessage);
begin
  NotifyControls(CM_PARENTBIDIMODECHANGED);
  if IsPopupScrollBars then
  begin
    if HScrollBar <> nil then
      HScrollBar.GetControl.BiDiMode := inherited BiDiMode;
    if VScrollBar <> nil then
      VScrollBar.GetControl.BiDiMode := inherited BiDiMode;
  end;
  if not ProcessingChanges then
    LayoutChanged;
end;
...
constructor TdxSpreadSheetShrinkToFitCalculator.Create(ACell: TdxSpreadSheetCell; AStyle: TdxSpreadSheetCellDisplayStyle);
begin
  inherited Create;
  FCell := ACell;
  FStyle := AStyle;
  ZoomFactor := ACell.View.ZoomFactor;
end;

function TdxSpreadSheetShrinkToFitCalculator.Calculate(AWidth: Integer): TdxSpreadSheetFontHandle;
begin
  Style.Font.AssignToFont(Font);
  inherited Calculate(AWidth, Cell.DisplayText);
  Result := Style.Handle.Font.Clone;
  Result.Size := Font.Size;
  Result := Cell.View.CellStyles.Fonts.AddFont(Result);
end;
...
begin
  Result := GetAsRTF(ACell, AValue, True);
end;

class function TdxSpreadSheetTextService.GetAsRTF(ACell: TdxSpreadSheetCell; var AValue: string; ARichEditCompatibility: Boolean): Boolean;
begin
  Result := False;
end;
...
class procedure TdxSpreadSheetTextService.CalculateSize(ACell: TdxSpreadSheetCell; ACanvas: TcxCanvas;
...
begin
  ...
  if AStyle = nil then
    AStyle := ACell.StyleHandle;

  AStyle.Font.AssignToFont(ACanvas.Font);
...
class procedure TdxSpreadSheetTextService.MeasureSize(ACanvas: TcxCanvas;
  ACell: TdxSpreadSheetCell; AWidth, AHeight: PInteger; ADisplayStyle: TdxSpreadSheetCellDisplayStyle = nil);
var
  ABounds: TRect;
  AColumnIndex: Integer;
  AHasText: Boolean;
...
begin
  ...
  if not AHasText and (AHeight = nil) then Exit;
  ...
  // calculate style
  AStyle := ACell.StyleHandle;
  if ADisplayStyle <> nil then
  begin
    ADisplayStyle.Reset;
    ADisplayStyle.Handle := ACell.StyleHandle;
    AView.ConditionalFormatting.CalculateStyle(ADisplayStyle, ARowIndex, AColumnIndex, ACell);
    AHasText := AHasText and ADisplayStyle.ShowCellValue;
    AStyle := ADisplayStyle.Handle;
  end;
  ...
  // calculate bounds
  ABounds := cxNullRect;
  AMergedCell := AView.MergedCells.FindCell(ARowIndex, AColumnIndex);
  if AMergedCell <> nil then
  begin
    if (AHeight <> nil) and (AMergedCell.Area.Top <> AMergedCell.Area.Bottom) or
       (AWidth <> nil) and (AMergedCell.Area.Left <> AMergedCell.Area.Right) or
       (AMergedCell.Area.Left <> AColumnIndex) or (AMergedCell.Area.Top <> ARowIndex)
    then
      Exit;

    ABounds.Right := AView.Columns.GetDistance(AMergedCell.Area.Left, AMergedCell.Area.Right);
    ABounds.Bottom := AView.Rows.GetDistance(AMergedCell.Area.Top, AMergedCell.Area.Bottom);
  end
  else
  begin
    ABounds.Right := AView.Columns.GetRealItemSize(AColumnIndex);
    ABounds.Bottom := AView.Rows.GetRealItemSize(ARowIndex);
  end;

  // calculate indents
  AIndents := ACell.GetContentOffsets(AStyle.Borders.BorderStyle[bBottom]);
  if (ADisplayStyle <> nil) and (ADisplayStyle.IconIndex >= 0) then
    Inc(AIndents.Left, ConditionalFormattingIconSet.Icons.Width + cxTextSpace);

  // measure the size
  ABounds := cxRectContent(ABounds, AIndents);
  ABounds.Right := Max(ABounds.Left + 1, ABounds.Right - AStyle.AlignHorzIndent);
  CalculateSize(ACell, ACanvas, ABounds, AMergedCell <> nil, AWidth, AHeight, AStyle);
  ...
  begin
    if AHasText then
      Inc(AWidth^, AStyle.AlignHorzIndent + cxMarginsWidth(AIndents))
    else
      AWidth^ := 0;
  end;
end;

class function TdxSpreadSheetTextService.CreateShrinkToFitCalculator(ACell: TdxSpreadSheetCell;
  AStyle: TdxSpreadSheetCellDisplayStyle): TdxSpreadSheetShrinkToFitCalculator;
begin
  Result := TdxSpreadSheetShrinkToFitCalculator.Create(ACell, AStyle);
end;
...
initialization
  ...
  dxRegisterCursor(crdxSpreadSheetRotate, HInstance, 'DXSPREADSHEET_ROTATECURSOR');
  dxRegisterCursor(crdxSpreadSheetRotation, HInstance, 'DXSPREADSHEET_ROTATIONCURSOR');
  dxRegisterCursor(crdxSpreadSheetDownArrow, HInstance, 'DXSPREADSHEET_DOWNARROW');

  RegisterClasses([TdxSpreadSheetTableView, TdxSpreadSheetContainer]);
  {$IFDEF DX_INITIALIZATION_LOGGING}TdxUnitSectionsLogger.InitializationFinished(dxThisUnitName, SysInit.HInstance);{$ENDIF}
finalization
  {$IFDEF DX_INITIALIZATION_LOGGING}TdxUnitSectionsLogger.FinalizationStarted(dxThisUnitName, SysInit.HInstance);{$ENDIF}
  dxUnregisterCursor(crdxSpreadSheetRotate);
  dxUnregisterCursor(crdxSpreadSheetRotation);
  dxUnregisterCursor(crdxSpreadSheetDownArrow);
