...
unit dxSpreadSheetFormatXLSXTags; // for internal use
...
type
  TdxSpreadSheetXLSXCellType = (sxctUnknown, sxctUndefined, sxctBoolean, sxctError,
    sxctFloat, sxctSharedString, sxctString, sxctRichText, sxctDateTime, sxctFormula);

const
  sdxXLSXCommonContentType = 'application/vnd.openxmlformats-officedocument.spreadsheetml';
  sdxXLSXCommonRelationshipPath = 'http://schemas.openxmlformats.org/officeDocument/2006/relationships';

  sdxXLSXChartsheetRelationship = sdxXLSXCommonRelationshipPath + '/chartsheet';
  sdxXLSXCommentsRelationship = sdxXLSXCommonRelationshipPath + '/comments';
  sdxXLSXCorePropertiesRelationship = 'http://schemas.openxmlformats.org/package/2006/relationships/metadata/core-properties';
  sdxXLSXDrawingRelationship = sdxXLSXCommonRelationshipPath + '/drawing';
  sdxXLSXExternalLinkPathRelationship = sdxXLSXCommonRelationshipPath + '/externalLinkPath';
  sdxXLSXExternalLinkRelationship = sdxXLSXCommonRelationshipPath + '/externalLink';
  sdxXLSXHyperlinkRelationship = sdxXLSXCommonRelationshipPath + '/hyperlink';
  sdxXLSXImageRelationship = sdxXLSXCommonRelationshipPath + '/image';
  sdxXLSXSharedStringRelationship = sdxXLSXCommonRelationshipPath + '/sharedStrings';
  sdxXLSXStyleRelationship = sdxXLSXCommonRelationshipPath + '/styles';
  sdxXLSXThemeRelationship = sdxXLSXCommonRelationshipPath + '/theme';
  sdxXLSXVMLDrawingRelationship = sdxXLSXCommonRelationshipPath + '/vmlDrawing';
  sdxXLSXWorkbookRelationship = sdxXLSXCommonRelationshipPath + '/officeDocument';
  sdxXLSXWorksheetRelationship = sdxXLSXCommonRelationshipPath + '/worksheet';

  sdxXLSXCommentsContentType = sdxXLSXCommonContentType + AnsiString('.comments+xml');
  sdxXLSXCorePropertiesContentType = AnsiString('application/vnd.openxmlformats-package.core-properties+xml');
  ...
  // FileName templates
  sdxXLSXFileTemplateComments = 'xl/comments%d.xml';
  sdxXLSXFileTemplateDrawing = 'xl/drawings/drawing%d.xml';
  sdxXLSXFileTemplateExternalLink = 'xl/externalLinks/externalLink%d.xml';
  sdxXLSXFileTemplateImage = 'xl/media/image%d.%s';
  sdxXLSXFileTemplateVMLDrawing = 'xl/drawings/vmlDrawing%d.vml';
  sdxXLSXFileTemplateWorksheet = 'xl/worksheets/sheet%d.xml';

  sdxXLSXContentTypeFileName = '[Content_Types].xml';
  sdxXLSXCorePropertiesFileName = 'docProps/core.xml';
...
const
  // Namespaces
  sdxXLSXNamespaceCoreProperties = AnsiString('cp');
  sdxXLSXNamespaceDublinCore = AnsiString('dc');
  sdxXLSXNamespaceDublinCoreTerms = AnsiString('dcterms');
  sdxXLSXNamespaceExcel = AnsiString('x');
  sdxXLSXNamespaceOffice = AnsiString('o');
  sdxXLSXNamespaceDrawing = AnsiString('a');
  sdxXLSXNamespaceDrawingSpreadSheet = AnsiString('xdr');
  sdxXLSXNamespaceRelationship = AnsiString('r');
  sdxXLSXNamespaceVML = AnsiString('v');
  sdxXLSXNamespaceX14 = AnsiString('x14');
  sdxXLSXNamespaceXM = AnsiString('xm');
  ...
  sdxXLSXAttrComment = AnsiString('comment');
  ...
  sdxXLSXAttrDrawingResourceEmbed = AnsiString('embed');
  ...
  sdxXLSXAttrInsetMode = AnsiString('insetmode');
  ...
  sdxXLSXAttrOpacity2 = AnsiString('opacity2');
  sdxXLSXAttrOperator = AnsiString('operator');
  sdxXLSXAttrRelID = AnsiString('relid');
  ...
  sdxXLSXAttrRightToLeft = AnsiString('rightToLeft');
  ...
  sdxXLSXNodeAnchorAbsolute = AnsiString('absoluteAnchor');
  sdxXLSXNodeAnchorFrom = AnsiString('from');
  sdxXLSXNodeAnchorOneCell = AnsiString('oneCellAnchor');
  sdxXLSXNodeAnchorTo = AnsiString('to');
  sdxXLSXNodeAnchorTwoCell = AnsiString('twoCellAnchor');
  sdxXLSXNodeAuthor = AnsiString('author');
  sdxXLSXNodeAuthors = AnsiString('authors');
  sdxXLSXNodeAVList = AnsiString('avLst');
  sdxXLSXNodeAxisColor = AnsiString('axisColor');
  sdxXLSXNodeBackgroundColor = AnsiString('bgColor');
  sdxXLSXNodeBodyProperties = AnsiString('bodyPr');
  ...
  sdxXLSXNodeCellInlineString = AnsiString('is');
  ...
  sdxXLSXNodeClientData = AnsiString('clientData');
  sdxXLSXNodeColBreaks = AnsiString('colBreaks');
  sdxXLSXNodeColor = AnsiString('color');
  sdxXLSXNodeColorAlpha = AnsiString('alpha');
  ...
  sdxXLSXNodeCoordExt = AnsiString('ext');
  sdxXLSXNodeCoordOff = AnsiString('off');
  ...
  sdxXLSXNodeDrawingAttributeSourceRect = AnsiString('srcRect');
  sdxXLSXNodeDrawingBlip = AnsiString('blip');
  sdxXLSXNodeDrawingBlipFill = AnsiString('blipFill');
  sdxXLSXNodeDrawingDescription = AnsiString('cNvPr');
  sdxXLSXNodeDrawingHeader = AnsiString('wsDr');
  sdxXLSXNodeDrawingPatternBackgroundColor = AnsiString('bgClr');
  sdxXLSXNodeDrawingPatternForegroundColor = AnsiString('fgClr');
  sdxXLSXNodeDrawingPictureAttributes = AnsiString('cNvPicPr');
  sdxXLSXNodeDrawingPictureContainer = AnsiString('pic');
  sdxXLSXNodeDrawingPictureDescription = AnsiString('nvPicPr');
  sdxXLSXNodeDrawingPictureLocks = AnsiString('picLocks');
  sdxXLSXNodeDrawingPosMarkerColumn = AnsiString('col');
  sdxXLSXNodeDrawingPosMarkerColumnOffset = AnsiString('colOff');
  sdxXLSXNodeDrawingPosMarkerRow = AnsiString('row');
  sdxXLSXNodeDrawingPosMarkerRowOffset = AnsiString('rowOff');
  sdxXLSXNodeDrawingShapeContainer = AnsiString('sp');
  sdxXLSXNodeDrawingShapeDescription = AnsiString('nvSpPr');
  sdxXLSXNodeDrawingShapeGeometry = AnsiString('prstGeom');
  sdxXLSXNodeDrawingShapeGroup = AnsiString('grpSp');
  sdxXLSXNodeDrawingShapeHLink = AnsiString('hlinkClick');
  sdxXLSXNodeDrawingShapeLocks = AnsiString('spLocks');
  sdxXLSXNodeDrawingShapeProperties = AnsiString('spPr');
  sdxXLSXNodeDrawingShapePropertiesEx = AnsiString('cNvSpPr');
  sdxXLSXNodeDrawingStyle = AnsiString('style');
  sdxXLSXNodeDrawingTextBody = AnsiString('txBody');
  sdxXLSXNodeDrawingXForm = AnsiString('xfrm');
  ...
  sdxXLSXNodeFillRect = AnsiString('fillRect');
  sdxXLSXNodeFillRef = AnsiString('fillRef');
  ...
  sdxXLSXNodeFunction = AnsiString('f');
  sdxXLSXNodeGradientFill = AnsiString('gradFill');
  sdxXLSXNodeGradientPoint = AnsiString('gs');
  sdxXLSXNodeGradientPoints = AnsiString('gsLst');
  ...
  sdxXLSXNodeLatin = AnsiString('latin');
  sdxXLSXNodeLegacyDrawing = AnsiString('legacyDrawing');
  sdxXLSXNodeLine = AnsiString('ln');
  sdxXLSXNodeLinearGradientFill = AnsiString('lin');
  sdxXLSXNodeLineDash = AnsiString('prstDash');
  sdxXLSXNodeLineRef = AnsiString('lnRef');
  sdxXLSXNodeListStyle = AnsiString('lstStyle');
  sdxXLSXNodeLumMod = AnsiString('lumMod');
  sdxXLSXNodeLumOff = AnsiString('lumOff');
  ...
  sdxXLSXNodeNoFill = AnsiString('noFill');
  ...
  sdxXLSXNodeParagraph = AnsiString('p');
  sdxXLSXNodePatternFill = AnsiString('pattFill');
  sdxXLSXNodePos = AnsiString('pos');
  ...
  sdxXLSXNodeSchemeColor = AnsiString('schemeClr');
  sdxXLSXNodeSelection = AnsiString('selection');
  sdxXLSXNodeShade = AnsiString('shade');
  sdxXLSXNodeShape = AnsiString('shape');
  ...
  sdxXLSXNodeSheetViews = AnsiString('sheetViews');
  sdxXLSXNodeSI = AnsiString('si');
  sdxXLSXNodeSolidFill = AnsiString('solidFill');
  sdxXLSXNodeSpAutoFit = AnsiString('spAutoFit');
  sdxXLSXNodeSqRef = AnsiString('sqref');
  sdxXLSXNodeSST = AnsiString('sst');
  sdxXLSXNodeStretch = AnsiString('stretch');
  sdxXLSXNodeStyle = AnsiString('style');
  ...
  sdxXLSXNodeSystemColor = AnsiString('sysClr');
  sdxXLSXNodeSZ = AnsiString('sz');
  sdxXLSXNodeText = AnsiString('t');
  sdxXLSXNodeTextFull = AnsiString('text');
  sdxXLSXNodeTexturedFill = AnsiString('blipFill');
  sdxXLSXNodeThemesColorScheme = AnsiString('clrScheme');
  sdxXLSXNodeThemesCustomColor = AnsiString('srgbClr');
  sdxXLSXNodeThemesElements = AnsiString('themeElements');
  sdxXLSXNodeThemesFormatScheme = AnsiString('fmtScheme');
  sdxXLSXNodeThemesFormatSchemeFillStyleList = AnsiString('fillStyleLst');
  sdxXLSXNodeThemesFormatSchemeLineStyleList = AnsiString('lnStyleLst');
  sdxXLSXNodeThemesSystemColor = AnsiString('sysClr');
  sdxXLSXNodeTile = 'tile';
  sdxXLSXNodeVertAlign = AnsiString('vertAlign');
  sdxXLSXNodeVMLFill = AnsiString('fill');
  sdxXLSXNodeVMLStroke = AnsiString('stroke');
  sdxXLSXNodeVMLTextBox = AnsiString('textbox');
  ...
  sdxXLSXNodeXAnchor = AnsiString('Anchor');
  sdxXLSXNodeXAutoFill = AnsiString('AutoFill');
  sdxXLSXNodeXClientData = AnsiString('ClientData');
  sdxXLSXNodeXColumn = AnsiString('Column');
  sdxXLSXNodeXML = AnsiString('xml');
  sdxXLSXNodeXMoveWithCells = AnsiString('MoveWithCells');
  sdxXLSXNodeXRow = AnsiString('Row');
  sdxXLSXNodeXSizeWithCells = AnsiString('SizeWithCells');
  sdxXLSXNodeXTextHAlign = AnsiString('TextHAlign');
  sdxXLSXNodeXTextVAlign = AnsiString('TextVAlign');
  sdxXLSXNodeXVisible = AnsiString('Visible');

  sdxXLSXNodeCoreProperties = AnsiString('coreProperties');
  sdxXLSXNodeCategory = AnsiString('category');
  sdxXLSXNodeContentStatus = AnsiString('contentStatus');
  sdxXLSXNodeCreationDate = AnsiString('created');
  sdxXLSXNodeCreator = AnsiString('creator');
  sdxXLSXNodeDescription = AnsiString('description');
  sdxXLSXNodeKeywords = AnsiString('keywords');
  sdxXLSXNodeLastPrinted = AnsiString('lastPrinted');
  sdxXLSXNodeLastModifiedBy = AnsiString('lastModifiedBy');
  sdxXLSXNodeModificationDate = AnsiString('modified');
  sdxXLSXNodeSubject = AnsiString('subject');
  sdxXLSXNodeTitle = AnsiString('title');
  ...
  sdxXLSXValueTargetModeExternal = 'External';
  ...
  sdxXLSXValueW3CDTF = AnsiString('dcterms:W3CDTF');
...
const
  ...
  dxXLSXFontStyles: array[TFontStyle] of string = ('b', 'i', 'u', 'strike');

  dxXLSXRestrictionNames: array[TdxSpreadSheetContainerRestriction] of string = (
...
type
  ...
  public
    ...
    class function StringToAlignHorz(const S: AnsiString): TdxSpreadSheetDataAlignHorz; overload;
    class function StringToAlignHorz(const S: string): TdxSpreadSheetDataAlignHorz; overload;
    class function StringToAlignment(const S: AnsiString): TAlignment; overload;
    class function StringToAlignment(const S: string): TAlignment; overload;
    class function StringToAlignVert(const S: AnsiString): TdxSpreadSheetDataAlignVert; overload;
    class function StringToAlignVert(const S: string): TdxSpreadSheetDataAlignVert; overload;
    class function StringToAxisPosition(const S: AnsiString): TdxSpreadSheetConditionalFormattingRuleDataBarAxisPosition; overload;
    class function StringToAxisPosition(const S: string): TdxSpreadSheetConditionalFormattingRuleDataBarAxisPosition; overload;
    class function StringToBorderStyle(const S: AnsiString): TdxSpreadSheetCellBorderStyle; overload;
    class function StringToBorderStyle(const S: string): TdxSpreadSheetCellBorderStyle; overload;
    class function StringToCellType(const S: AnsiString): TdxSpreadSheetXLSXCellType; overload;
    class function StringToCellType(const S: string): TdxSpreadSheetXLSXCellType; overload;
    class function StringToCfCellIsRuleOperator(const S: AnsiString): TdxSpreadSheetConditionalFormattingRuleCellIsComparisonOperator; overload;
    class function StringToCfCellIsRuleOperator(const S: string): TdxSpreadSheetConditionalFormattingRuleCellIsComparisonOperator; overload;
    class function StringToColorScaleStopValueType(const S: AnsiString): TdxSpreadSheetConditionalFormattingRuleCustomScaleStopValueType; overload;
    class function StringToColorScaleStopValueType(const S: string): TdxSpreadSheetConditionalFormattingRuleCustomScaleStopValueType; overload;
    class function StringToDataBarDirection(const S: AnsiString): TdxSpreadSheetConditionalFormattingRuleDataBarDirection; overload;
    class function StringToDataBarDirection(const S: string): TdxSpreadSheetConditionalFormattingRuleDataBarDirection; overload;
    class function StringToFillStyle(const S: AnsiString): TdxSpreadSheetCellFillStyle; overload;
    class function StringToFillStyle(const S: string): TdxSpreadSheetCellFillStyle; overload;
    class function StringToHashAlgorithm(const S: string): TdxHashAlgorithmType;
    class function StringToPenStyle(const S: string): TdxGPPenStyle; overload;
    class function StringToPenStyle(const S: AnsiString): TdxGPPenStyle; overload;
    class function StringToPrintCellComments(const S: AnsiString): TdxSpreadSheetTableViewOptionsPrintSourceCellComments; overload;
    class function StringToPrintCellComments(const S: string): TdxSpreadSheetTableViewOptionsPrintSourceCellComments; overload;
    class function StringToPrintErrorIndication(const S: AnsiString): TdxSpreadSheetTableViewOptionsPrintSourceErrorIndication; overload;
    class function StringToPrintErrorIndication(const S: string): TdxSpreadSheetTableViewOptionsPrintSourceErrorIndication; overload;
    class function StringToPrintPageOrder(const S: AnsiString): TdxSpreadSheetTableViewOptionsPrintPrintingPageOrder; overload;
    class function StringToPrintPageOrder(const S: string): TdxSpreadSheetTableViewOptionsPrintPrintingPageOrder; overload;
    class function StringToPrintPageOrientation(const S: AnsiString): TdxSpreadSheetTableViewOptionsPrintPageOrientation; overload;
    class function StringToPrintPageOrientation(const S: string): TdxSpreadSheetTableViewOptionsPrintPageOrientation; overload;
    class function StringToShapeType(const S: AnsiString): TdxSpreadSheetShapeType; overload;
    class function StringToShapeType(const S: string): TdxSpreadSheetShapeType; overload;
    class function StringToVerticalAlignment(const S: AnsiString): TVerticalAlignment; overload;
    class function StringToVerticalAlignment(const S: string): TVerticalAlignment; overload;
    class function StringToVMLDashStyle(S: string): TdxGPPenStyle;
...
const
  dxThisUnitName = 'dxSpreadSheetFormatXLSXTags';
...
class function TdxSpreadSheetXLSXHelper.StringToAlignHorz(const S: string): TdxSpreadSheetDataAlignHorz;
begin
  Result := StringToAlignHorz(AnsiString(S));
end;

class function TdxSpreadSheetXLSXHelper.StringToAlignment(const S: string): TAlignment;
begin
  Result := StringToAlignment(AnsiString(S));
end;
...
class function TdxSpreadSheetXLSXHelper.StringToAlignVert(const S: string): TdxSpreadSheetDataAlignVert;
begin
  Result := StringToAlignVert(AnsiString(S));
end;

class function TdxSpreadSheetXLSXHelper.StringToAxisPosition(
  const S: string): TdxSpreadSheetConditionalFormattingRuleDataBarAxisPosition;
begin
  Result := StringToAxisPosition(AnsiString(S));
end;
...
class function TdxSpreadSheetXLSXHelper.StringToBorderStyle(const S: string): TdxSpreadSheetCellBorderStyle;
begin
  Result := StringToBorderStyle(AnsiString(S));
end;
...
class function TdxSpreadSheetXLSXHelper.StringToCellType(const S: string): TdxSpreadSheetXLSXCellType;
begin
  Result := StringToCellType(AnsiString(S));
end;

class function TdxSpreadSheetXLSXHelper.StringToCfCellIsRuleOperator(
  const S: string): TdxSpreadSheetConditionalFormattingRuleCellIsComparisonOperator;
begin
  Result := StringToCfCellIsRuleOperator(AnsiString(S));
end;

class function TdxSpreadSheetXLSXHelper.StringToColorScaleStopValueType(
  const S: string): TdxSpreadSheetConditionalFormattingRuleCustomScaleStopValueType;
begin
  Result := StringToColorScaleStopValueType(AnsiString(S));
end;

class function TdxSpreadSheetXLSXHelper.StringToDataBarDirection(
  const S: string): TdxSpreadSheetConditionalFormattingRuleDataBarDirection;
begin
  Result := StringToDataBarDirection(AnsiString(S));
end;
...
class function TdxSpreadSheetXLSXHelper.StringToFillStyle(const S: string): TdxSpreadSheetCellFillStyle;
begin
  Result := StringToFillStyle(AnsiString(S));
end;
...
begin
  ...
  if SameText(S, sLongDash) or SameText(S, sSystemDash) then
    Result := gppsDash
  else if SameText(S, sLongDashDot) or SameText(S, sSystemDashDot) then
    Result := gppsDashDot
  else if SameText(S, sLongDashDotDot) or SameText(S, sSystemDashDotDot) then
    Result := gppsDashDotDot
  else if SameText(S, sSystemDot) then
    Result := gppsDot
  else
    Result := gppsSolid;
end;

class function TdxSpreadSheetXLSXHelper.StringToPenStyle(const S: string): TdxGPPenStyle;
begin
  Result := StringToPenStyle(AnsiString(S));
end;
...
class function TdxSpreadSheetXLSXHelper.StringToPrintCellComments(
  const S: string): TdxSpreadSheetTableViewOptionsPrintSourceCellComments;
begin
  Result := StringToPrintCellComments(AnsiString(S));
end;

class function TdxSpreadSheetXLSXHelper.StringToPrintErrorIndication(
  const S: string): TdxSpreadSheetTableViewOptionsPrintSourceErrorIndication;
begin
  Result := StringToPrintErrorIndication(AnsiString(S));
end;
...
class function TdxSpreadSheetXLSXHelper.StringToPrintPageOrder(
  const S: string): TdxSpreadSheetTableViewOptionsPrintPrintingPageOrder;
begin
  Result := StringToPrintPageOrder(AnsiString(S));
end;

class function TdxSpreadSheetXLSXHelper.StringToPrintPageOrientation(
  const S: string): TdxSpreadSheetTableViewOptionsPrintPageOrientation;
begin
  Result := StringToPrintPageOrientation(AnsiString(S));
end;
...
class function TdxSpreadSheetXLSXHelper.StringToShapeType(const S: string): TdxSpreadSheetShapeType;
begin
  Result := StringToShapeType(AnsiString(S));
end;
...
class function TdxSpreadSheetXLSXHelper.StringToVerticalAlignment(const S: string): TVerticalAlignment;
begin
  Result := StringToVerticalAlignment(AnsiString(S));
end;

class function TdxSpreadSheetXLSXHelper.StringToVMLDashStyle(S: string): TdxGPPenStyle;
begin
  S := UpperCase(S);
  if Pos('DASHDOTDOT', S) > 0 then
    Exit(gppsDashDotDot);
  if Pos('DASHDOT', S) > 0 then
    Exit(gppsDashDot);
  if Pos('DASH', S) > 0 then
    Exit(gppsDash);
  if Pos('DOT', S) > 0 then
    Exit(gppsDot);
  Result := gppsSolid;
