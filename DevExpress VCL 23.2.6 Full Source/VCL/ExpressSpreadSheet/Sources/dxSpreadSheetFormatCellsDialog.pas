...
type
  ...
  public
    class procedure ModifyCellStyles(ASheet: TdxSpreadSheetTableView; AProcRef: TdxSpreadSheetCellStyleEnumProcRef);
    class procedure SetBackgroundColor(ASheet: TdxSpreadSheetTableView; AColor: TColor);
    class procedure SetBorder(ASheet: TdxSpreadSheetTableView; AIsBorder: Boolean);
    class procedure SetNumberFormat(ASheet: TdxSpreadSheetTableView; AFormat: Integer);
    class procedure ToggleFontStyle(ASheet: TdxSpreadSheetTableView; AFontStyle: TFontStyle);
  end;

var
  dxSpreadSheetCellStyleEditDialogClass: TdxSpreadSheetCellStyleEditDialogFormClass = TdxSpreadSheetCellStyleEditDialogForm; 
...
const
  dxThisUnitName = 'dxSpreadSheetFormatCellsDialog';
...
begin
  ADialog := dxSpreadSheetCellStyleEditDialogClass.Create(ASheet.SpreadSheet, AActivePage);
  try
...
class procedure TdxSpreadSheetCellStylesHelper.ModifyCellStyles(
...
begin
  ...
  try
    ...
    try
      ASheet.History.BeginAction(TdxSpreadSheetHistoryFormatCellAction);
      try
...
class procedure TdxSpreadSheetCellStylesHelper.SetBackgroundColor(ASheet: TdxSpreadSheetTableView; AColor: TColor);
begin
  ModifyCellStyles(ASheet,
    procedure (ACellStyle: TdxSpreadSheetCellStyle; ARow, AColumn: Integer; const AArea: TRect)
    begin
      ACellStyle.Brush.BackgroundColor := AColor;
    end);
end;

class procedure TdxSpreadSheetCellStylesHelper.SetBorder(ASheet: TdxSpreadSheetTableView; AIsBorder: Boolean);
begin
  if AIsBorder then
    ModifyCellStyles(ASheet, SetBorderAroundLine)
  else
    ModifyCellStyles(ASheet, SetBorderNone);
end;

class procedure TdxSpreadSheetCellStylesHelper.ToggleFontStyle(ASheet: TdxSpreadSheetTableView; AFontStyle: TFontStyle);
var
...
class procedure TdxSpreadSheetCellStylesHelper.SetNumberFormat(ASheet: TdxSpreadSheetTableView; AFormat: Integer);
begin
  ModifyCellStyles(ASheet,
    procedure (ACellStyle: TdxSpreadSheetCellStyle; ARow, AColumn: Integer; const AArea: TRect)
    begin
