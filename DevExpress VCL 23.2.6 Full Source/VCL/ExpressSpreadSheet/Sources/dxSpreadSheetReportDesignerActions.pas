...
const
  dxThisUnitName = 'dxSpreadSheetReportDesignerActions';
...
function TdxSpreadSheetReportDesignerAction.GetMaxSectionID(ASectionType: TdxSpreadSheetReportSectionType): Integer;
var
  I: Integer;
begin
  Result := 0;
  for I := 0 to Designer.Sections.Count - 1 do
    if Designer.Sections[I].SectionType = ASectionType then
      Result := Max(Result, TdxSpreadSheetReportSectionAccess(Designer.Sections[I]).Index);
end;
