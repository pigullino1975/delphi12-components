...
void _fastcall TfrmRibbonNotepadMain::EditorContextPopup(System::TObject* Sender, const TPoint &MousePos, bool &Handled)
#else

#if (__BORLANDC__ >= 0x0650) // C++Builder XE3
	#ifndef _WIN64
void _fastcall TfrmRibbonNotepadMain::EditorContextPopup(System::TObject* Sender, TPoint &MousePos, bool &Handled)
	#else
void _fastcall TfrmRibbonNotepadMain::EditorContextPopup(System::TObject* Sender, TPoint MousePos, bool &Handled)
	#endif
#else
...
void _fastcall TfrmRibbonNotepadMain::EditorMouseUp(System::TObject* Sender, TMouseButton Button, TShiftState Shift, int X, int Y)
{
...
//---------------------------------------------------------------------------
void __fastcall TfrmRibbonNotepadMain::bbFormCornersDefaultClick(TObject* Sender)
{
	FormCorners = TdxFormCorners(((TdxBarButton*)Sender)->Tag);
}
//---------------------------------------------------------------------------
