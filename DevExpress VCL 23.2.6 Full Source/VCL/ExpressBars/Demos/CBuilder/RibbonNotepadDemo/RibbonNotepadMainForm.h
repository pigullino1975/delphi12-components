...
__published: // IDE-managed Components
	...
	TdxOpenPictureDialog* OpenPictureDialog;
	...
	TdxBarSubItem *bsiFormCorners;
	TdxBarButton *bbFormCornersDefault;
	TdxBarButton *bbFormCornersRectangular;
	TdxBarButton *bbFormCornersRounded;
	TdxBarButton *bbFormCornersSmallRounded;
	...
	void __fastcall bbFormCornersDefaultClick(TObject* Sender);
private: // User declarations
	...
	void _fastcall EditorContextPopup(System::TObject* Sender, const TPoint &MousePos, bool &Handled);
#else
#if (__BORLANDC__ >= 0x0650)  // C++Builder XE3
	#ifndef _WIN64
	void _fastcall EditorContextPopup(System::TObject* Sender, TPoint &MousePos, bool &Handled);
	#else
	void _fastcall EditorContextPopup(System::TObject* Sender, TPoint MousePos, bool &Handled);
	#endif
#else
...
#endif
#endif
	void __fastcall EditorMouseUp(System::TObject* Sender, TMouseButton Button, TShiftState Shift, int X, int Y);
