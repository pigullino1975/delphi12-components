...
{$ENDIF}
  ...
  cxMaskEdit, dxRibbonColorGallery, cxImageList, dxOfficeSearchBox, dxCore, dxShellDialogs;
...
type
  ...
  TfrmRibbonNotepadMain = class(TfrmNotepadMain)
    ...
    bsiFormCorners: TdxBarSubItem;
    bbFormCornersDefault: TdxBarButton;
    bbFormCornersRectangular: TdxBarButton;
    bbFormCornersRounded: TdxBarButton;
    bbFormCornersSmallRounded: TdxBarButton;
    ...
    procedure bbFormCornersDefaultClick(Sender: TObject);
  private
...
procedure TfrmRibbonNotepadMain.bbFormCornersDefaultClick(Sender: TObject);
begin
