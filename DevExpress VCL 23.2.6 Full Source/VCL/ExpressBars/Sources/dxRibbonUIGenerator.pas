...
type
  ...
  { TdxUIGeneratorMarginsGalleryItemInfo }

  TdxUIGeneratorMarginsGalleryItemInfo = class(TdxUIGeneratorRibbonGalleryItemInfo)
  public
    class function GetBarItemClass: TdxBarItemClass; override;
    class function IsBuiltInCommand(AAction: TAction; ACommandInfo: TdxUIGeneratorCommandInfo): Boolean; override;
    class procedure Initialize(AItem: TdxBarItem; ACommandInfo: TdxUIGeneratorCommandInfo; AAdapter: TdxUIGeneratorAdapter); override;
...
const
  dxThisUnitName = 'dxRibbonUIGenerator';
...
begin
  AGalleryItem := AItem.BarManager.AddItem(TdxRibbonGalleryItem) as TdxRibbonGalleryItem;
...
begin
  ...
  FBarItems.Add(TdxUIGeneratorMarginsGalleryItemInfo);
end;
...
begin
  ...
  begin
    ...
    TdxUIGeneratorHelper.LoadImage(AGroup.ToolBar.Glyph, GetCorrectedImageName(AItem.Category.BarGlyphFileName), ImageSet);
...
class function TdxUIGeneratorMarginsGalleryItemInfo.GetBarItemClass: TdxBarItemClass;
begin
  Result := TdxRibbonMarginsGalleryItem;
end;

class procedure TdxUIGeneratorMarginsGalleryItemInfo.Initialize(AItem: TdxBarItem;
  ACommandInfo: TdxUIGeneratorCommandInfo; AAdapter: TdxUIGeneratorAdapter);
begin
  InitializeGallery(AItem as TdxRibbonMarginsGalleryItem, ACommandInfo as TdxUIGeneratorGalleryInfo, AAdapter);
end;

class function TdxUIGeneratorMarginsGalleryItemInfo.IsBuiltInCommand(AAction: TAction;
  ACommandInfo: TdxUIGeneratorCommandInfo): Boolean;
begin
  Result := (AAction <> nil) and Supports(AAction, IdxActionGalleryWithDescriptionTabbedText);
end;
