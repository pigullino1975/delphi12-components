...
type
  TdxBarItemAddEditor = class(TdxForm)
    BCancel: TcxButton;
    BOk: TcxButton;
...
uses
  TypInfo, dxBarCustomCustomizationForm, dxBarStrs, dxDPIAwareUtils;

const
  dxThisUnitName = 'dxBarItemEd';
...
begin
  ...
  try
    ...
    dxAssignFont(AForm.Font, ABarManager.Font, AForm.ScaleFactor, dxGetScaleFactor(ABarManager));
...
begin
  BarItem := BarManager.AddItem(RegdxItemList.VisibleItemClass[ComboBox1.ItemIndex]);
  try
