...
uses
  Classes, DesignIntf, DesignEditors, dxOfficeSearchBox, cxEditPropEditors, cxEdit;

const
  dxThisUnitName = 'dxOfficeSearchBoxReg';
...
begin
  ...
  RegisterEditPropertiesIcon(TdxOfficeSearchBoxProperties, 'TdxOfficeSearchBox', HInstance);
end;
