...
uses
  ...
  dxTypeInfo, cxButtons, cxClasses, cxEdit, cxFilterControlUtils, cxLookAndFeelPainters,
  dxBarStrs;

const
  dxThisUnitName = 'cxBarEditItemValueEditor';
...
begin
  TdxTypeInfo.EnumProperties(AInstance.ClassInfo, [tkMethod],
    procedure(APropInfo: PPropInfo; var ABreak: Boolean)
    var
      AMethod: TMethod;
    begin
      AMethod := GetMethodProp(AInstance, APropInfo);
