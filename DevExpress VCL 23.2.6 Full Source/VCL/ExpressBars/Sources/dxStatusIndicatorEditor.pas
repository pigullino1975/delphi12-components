...
uses
  Windows, Messages, SysUtils, Variants, Classes, Controls, Forms, StdCtrls, ExtCtrls, CheckLst, Graphics,
  dxStatusBar, cxGraphics, cxLookAndFeels, cxLookAndFeelPainters, Menus, cxButtons, cxControls, cxContainer, cxEdit,
  cxCheckListBox, cxTextEdit, cxMaskEdit, cxDropDownEdit, dxLayoutContainer, dxLayoutcxEditAdapters,
  dxLayoutControlAdapters, cxClasses, dxLayoutControl, dxLayoutLookAndFeels, cxCheckBox, cxCustomListBox;
...
uses
  dxDPIAwareUtils, cxGeometry;

const
  dxThisUnitName = 'dxStatusIndicatorEditor';
