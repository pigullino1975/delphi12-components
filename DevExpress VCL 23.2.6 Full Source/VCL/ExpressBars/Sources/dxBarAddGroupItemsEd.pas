...
const
  dxThisUnitName = 'dxBarAddGroupItemsEd';
...
begin
  Height := TdxTextMeasurer.TextLineHeight(AControl.Style.Font) + cxTextOffset;
end;
...
begin
  FGroup := Value;
  dxAssignFont(Font, FGroup.BarManager.Font, ScaleFactor, dxGetScaleFactor(FGroup.BarManager));
