...
type
  ...
  TdxOfficeSearchBoxPopupMenuSubMenuControlAccessibilityHelper = class(TdxBarSubMenuControlAccessibilityHelper) // for internal use
  strict private
  ...
  protected
    ...
    procedure InitializeDropDownMenu; virtual;
...
const
  dxThisUnitName = 'dxOfficeSearchBox';
...
begin
  ...
  TdxImageDrawer.DrawImage(ACanvas, FGlyphRect, Properties.Glyph, nil, -1, Enabled, GetGlyphColorPalette, ScaleFactor);
end;
...
procedure TdxOfficeSearchBoxInnerEdit.InitializeDropDownMenu;
begin
