...
begin
  ...
  RegisterNoIcon([
    TdxBarGroup, TdxBarButton, TdxBarLargeButton,  TdxBarEdit, TdxBarCombo, TdxBarSeparator,
    TdxBarSubItem, TdxBarListItem, TdxBarContainerItem, TdxBar, TdxBarScreenTip]);

  RegisterSelectionEditor(TdxBarManager, TdxSkinsBaseSelectionEditor);
...
//  RegisterPropertyEditor(TypeInfo(TBitmap), TdxBarLargeButton, 'Glyph', nil);
  ...
  HideClassProperties(TdxBarCustomCompositeItem, ['Action', 'Align', 'Hint', 'KeyTip', 'MergeKind', 'MergeOrder', 'Style', 'ScreenTip', 'OnGetScreenTip']);
end;
