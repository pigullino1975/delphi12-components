...
uses
 {$IFDEF USEJPEGIMAGE} 
  Jpeg,
 {$ENDIF}
  ClipBrd, dxPSGlbl, dxPcPrVw, dxPSPopupMan, dxPSImgs, dxPSRes, dxPSUtl, dxShellDialogs;

const
  dxThisUnitName = 'dxFEFDlg';
...
var
  ARegistered: Boolean;
  Dialog: TdxOpenPictureDialog;
  FileName: string;
  B: TBitmap;
begin
  ARegistered := UnregisterIcon;
  try
    Dialog := TdxOpenPictureDialog.Create(nil);
    try
