...
uses
  ...
  cxDataControllerConditionalFormatting, dxSpreadSheetStyles, cxGridRows, dxPSdxLCLnk, cxGridViewLayoutContainer;
...
type
  ...
  TdxCustomGridTableViewFormatter = class;
  ...
  TdxReportCustomLayout = class(TdxReportCell)
  strict private
    function GetGridRecord: TcxCustomGridRecord;
  protected
    procedure AdjustRecordWidth; virtual;
  public
    constructor CreateEx(AParent: TdxReportCell; AGridRecord: TcxCustomGridRecord); virtual;

    property GridRecord: TcxCustomGridRecord read GetGridRecord;
  end;
  TdxReportCustomLayoutClass = class of TdxReportCustomLayout;

  TdxReportLayout = class(TdxReportCustomLayout)
  private
    FGroupLookAndFeel: TdxPSReportLayoutGroupStandardLookAndFeel;
  protected
    property GroupLookAndFeel: TdxPSReportLayoutGroupStandardLookAndFeel read FGroupLookAndFeel;
  public
    constructor Create(AParent: TdxReportCell); override;
    destructor Destroy; override;
  end;
  TdxReportLayoutClass = class of TdxReportLayout;

  TdxGridCustomLayoutContainerProducer = class
  strict private
    FContainerViewInfo: TcxGridLayoutContainerViewInfo;
    FFormatter: TdxCustomGridTableViewFormatter;
    FParent: TdxReportLayout;

    function GetAdapter: TdxCustomGridTableViewAdapter;
    function GetBuilder: TdxCustomGridTableViewBuilder;
    function GetReportLink: TdxGridReportLink;
  protected
    procedure AddLayoutItem(AViewInfo: TdxCustomLayoutItemViewInfo);
    function GetGroupViewParams(ARecord: TcxCustomGridRecord): TdxReportItemViewParams; virtual; abstract;
    function GetItemCaptionViewParams(ARecord: TcxCustomGridRecord): TdxReportItemViewParams; virtual; abstract;
    function GetRelativeBounds(const ABounds: TRect): TRect;
    function GetReportItemClass(ALayoutItem: TdxCustomLayoutItem): TdxCustomReportLayoutItemClass; virtual;
    procedure GetViewInfoHandler(AItem: TdxCustomLayoutItem; var AViewInfo: TdxCustomLayoutItemViewInfo);

    property Adapter: TdxCustomGridTableViewAdapter read GetAdapter;
    property Builder: TdxCustomGridTableViewBuilder read GetBuilder;
    property ContainerViewInfo: TcxGridLayoutContainerViewInfo read FContainerViewInfo;
    property Formatter: TdxCustomGridTableViewFormatter read FFormatter;
    property Parent: TdxReportLayout read FParent;
    property ReportLink: TdxGridReportLink read GetReportLink;
  public
    constructor Create(AContainerViewInfo: TcxGridLayoutContainerViewInfo;
      AParent: TdxReportLayout; AFormatter: TdxCustomGridTableViewFormatter); virtual;

    procedure Produce;
  end;
  TdxGridCustomLayoutContainerProducerClass = class of TdxGridCustomLayoutContainerProducer;

  TdxGridRowLayoutContainerProducer = class(TdxGridCustomLayoutContainerProducer)
  protected
  ...
  private
    ...
    function GetRowLayoutActive: Boolean;
    function GetRowLayoutHeight: Integer;
  ...
  protected
    ...
    function GetViewRequiredWidth: Integer; virtual;
  ...
  public
    ...
    property RowLayoutActive: Boolean read GetRowLayoutActive;
    property RowLayoutHeight: Integer read GetRowLayoutHeight;
  ...
  protected
    ...
    function GetViewAvailableWidth: Integer; override;
    function GetViewWidth: Integer; override;
  ...
  public
    ...
    { Row Layout }
    function CreateRowLayout(AParent: TdxReportCell; AGridRecord: TcxCustomGridRecord): TdxReportLayout; virtual;
    function CreateRowLayoutContainerProducer(AContainerViewInfo: TcxGridLayoutContainerViewInfo;
      AParent: TdxReportLayout): TdxGridCustomLayoutContainerProducer; virtual;
    procedure DoInitializeRowLayout(ARowLayout: TdxReportLayout); virtual;
    function GetRowLayoutClass: TdxReportLayoutClass; virtual;
    function GetRowLayoutContainerProducerClass: TdxGridCustomLayoutContainerProducerClass; virtual;
    function GetRowLayoutContentViewParams(ARecord: TcxCustomGridRecord;
      ATableItem: TcxCustomGridTableItem): TdxReportItemViewParams; virtual;
    function GetRowLayoutViewParams(ARecord: TcxCustomGridRecord): TdxReportItemViewParams; virtual;
  ...
  TdxReportCard = class(TdxReportCustomLayout)
  private
  ...
  public
    ...
    function GetRecordClass(AGridRecord: TcxGridCustomLayoutRecord): TdxReportCustomLayoutClass; virtual;
    procedure DoInitializeRecord(ARecord: TdxReportCustomLayout; AGridRecord: TcxGridCustomLayoutRecord); virtual;
  ...
  private
    FMaxRecordWidth: Integer;
    FRecords: TList;
    function GetRecord(Index: Integer): TdxReportCustomLayout;
    function GetRecordCount: Integer;
  protected
    procedure DoBuildViewBody; override;
    ...
    property RecordCount: Integer read GetRecordCount;
    property Records[Index: Integer]: TdxReportCustomLayout read GetRecord;
  public
    constructor Create(AReportLink: TdxGridReportLink;
      AMasterBuilder: TdxCustomGridViewBuilder; AGridView: TcxCustomGridView); override;
    destructor Destroy; override;
  ...
  protected
    ...
    procedure AddRowLayout(AParent: TdxReportCell); virtual;
    ...
    procedure InitializeRow; override;
    procedure InitializeSubItem(ASubItem: TAbstractdxReportCellData; AIndex: Integer); override;
    procedure ProduceRowLayoutContainer(AContainerViewInfo: TcxGridLayoutContainerViewInfo; AParent: TdxReportLayout); virtual;
  ...
  public
    ...
    function CreateRecord(AParent: TdxReportCell; AGridRecord: TcxGridCustomLayoutRecord): TdxReportCustomLayout; virtual;
    function Produce(AHostInfo: TdxGridAttributeHostInfo; ARowHeight: Integer): TdxReportCell; reintroduce; virtual;
    procedure InjectRecord(ARecord: TdxReportCustomLayout; AIndex: Integer); virtual;
  end;
  ...
  protected
    ...
    function SupportsGapsBetweenCells: Boolean; override;
...
uses
  RTLConsts, Registry, Forms, Variants, Contnrs, cxVariants, cxGridStrs,
  ...
  dxCoreGraphics, dxPSdxSpreadSheetLnkCore;

const
  dxThisUnitName = 'dxPScxGridLnk';
...
begin
  Result := TcxGridColumnAccess(AInstance).IsFixedByWidth;
end;
...
function TdxReportGridLayoutItem.GetViewInfo: TcxGridCustomLayoutItemViewInfo;
begin
  Result := inherited ViewInfo as TcxGridCustomLayoutItemViewInfo;
end;

{ TdxReportCustomLayout }

constructor TdxReportCustomLayout.CreateEx(AParent: TdxReportCell; AGridRecord: TcxCustomGridRecord);
begin
  Create(AParent);
  Data := TdxNativeInt(AGridRecord);
end;

procedure TdxReportCustomLayout.AdjustRecordWidth;
begin
end;

function TdxReportCustomLayout.GetGridRecord: TcxCustomGridRecord;
begin
  Result := TcxCustomGridRecord(Data);
end;

{ TdxReportLayout }

constructor TdxReportLayout.Create(AParent: TdxReportCell);
begin
  inherited;
  FGroupLookAndFeel := TdxPSReportLayoutGroupStandardLookAndFeel.Create(ReportCells);
end;

destructor TdxReportLayout.Destroy;
begin
  FreeAndNil(FGroupLookAndFeel);
  inherited;
end;

{ TdxGridCustomLayoutContainerProducer }

constructor TdxGridCustomLayoutContainerProducer.Create(AContainerViewInfo: TcxGridLayoutContainerViewInfo;
  AParent: TdxReportLayout; AFormatter: TdxCustomGridTableViewFormatter);
begin
  inherited Create;
...
procedure TdxGridCustomLayoutContainerProducer.Produce;
begin
  AddLayoutItem(ContainerViewInfo.ItemsViewInfo);
end;

procedure TdxGridCustomLayoutContainerProducer.AddLayoutItem(AViewInfo: TdxCustomLayoutItemViewInfo);
var
  I: Integer;
  AItem: TdxCustomLayoutItem;
  AGroupViewInfo: TdxLayoutGroupViewInfo;
  AReportItem: TdxCustomReportLayoutItem;
  AReportDataItem: TdxReportGridLayoutItem;
  AViewInfoAccess: TdxCustomLayoutItemViewInfoAccess;
begin
  AViewInfoAccess := TdxCustomLayoutItemViewInfoAccess(AViewInfo);
  if not AViewInfoAccess.ActuallyVisible then
    Exit;
  AItem := AViewInfoAccess.Item;
  AReportItem := GetReportItemClass(AItem).Create(Parent);
  AReportItem.Data := TdxNativeInt(AItem);
  AReportItem.BoundsRect := GetRelativeBounds(AViewInfo.Bounds);

  AReportItem.OnGetLayoutItemViewInfo := GetViewInfoHandler;
  try
    if AViewInfo is TdxLayoutGroupViewInfo then
      Formatter.SetViewParams(AReportItem, GetGroupViewParams(Parent.GridRecord))
    else
      Formatter.SetViewParams(AReportItem, GetItemCaptionViewParams(Parent.GridRecord));
    TdxCustomReportLayoutItemAccess(AReportItem).Initialize(Builder.ReportLink);
    if AReportItem is TdxReportGridLayoutItem then
    begin
      AReportDataItem := TdxReportGridLayoutItem(AReportItem);
      Formatter.DoInitializeItem(AReportDataItem.DataCell, AReportDataItem.GridTableItem, AReportDataItem.GridRecord);
    end;
    if AViewInfo is TdxLayoutGroupViewInfo then
    begin
      AGroupViewInfo := TdxLayoutGroupViewInfo(AViewInfo);
      AReportItem.LookAndFeel := Parent.GroupLookAndFeel;
      if AViewInfoAccess.HasBorder then
      ...
      for I := 0 to AGroupViewInfo.ItemViewInfoCount - 1 do
        AddLayoutItem(AGroupViewInfo.ItemViewInfos[I]);
    end;
  finally
...
function TdxGridCustomLayoutContainerProducer.GetRelativeBounds(const ABounds: TRect): TRect;
begin
  Result := cxRectOffset(ABounds, ContainerViewInfo.ContentBounds.TopLeft, False);
end;

function TdxGridCustomLayoutContainerProducer.GetReportItemClass(ALayoutItem: TdxCustomLayoutItem): TdxCustomReportLayoutItemClass;
begin
  if ALayoutItem is TdxLayoutGroup then
    Result := TdxReportLayoutGroup
  else if ALayoutItem is TcxGridCustomLayoutItem then
    Result := TdxReportGridLayoutItem
  else if ALayoutItem is TdxLayoutEmptySpaceItem then
    Result := TdxReportLayoutEmptySpaceItem
  else if ALayoutItem is TdxLayoutLabeledItem then
    Result := TdxReportLayoutLabeledItem
  else if ALayoutItem is TdxLayoutSeparatorItem then
    Result := TdxReportLayoutSeparatorItem
  else if ALayoutItem is TdxLayoutSplitterItem then
    Result := TdxReportLayoutSplitterItem
  else
    Result := TdxCustomReportLayoutItem;
end;

procedure TdxGridCustomLayoutContainerProducer.GetViewInfoHandler(AItem: TdxCustomLayoutItem; var AViewInfo: TdxCustomLayoutItemViewInfo);
begin
  AViewInfo := ContainerViewInfo.GetItemViewInfo(AItem);
end;

function TdxGridCustomLayoutContainerProducer.GetAdapter: TdxCustomGridTableViewAdapter;
begin
  Result := Formatter.Adapter;
end;

function TdxGridCustomLayoutContainerProducer.GetBuilder: TdxCustomGridTableViewBuilder;
begin
  Result := Formatter.Builder;
end;

function TdxGridCustomLayoutContainerProducer.GetReportLink: TdxGridReportLink;
begin
  Result := Formatter.ReportLink;
end;

{ TdxGridRowLayoutContainerProducer }

function TdxGridRowLayoutContainerProducer.GetGroupViewParams(ARecord: TcxCustomGridRecord): TdxReportItemViewParams;
begin
  Result.Transparent := True;
end;

function TdxGridRowLayoutContainerProducer.GetItemCaptionViewParams(ARecord: TcxCustomGridRecord): TdxReportItemViewParams;
begin
  Result.FontStyle := [];
  Result.CellSides := [];
  Result.Transparent := True;
...
begin
  ...
  if AItem is TCustomdxReportCellImageContainer then
    TCustomdxReportCellImageContainer(AItem).Palette := ReportLink.GetControlActivePalette;
...
procedure TdxGridTableViewAdapter.AfterBuilding;
begin
  ...
  inherited AfterBuilding;
end;

procedure TdxGridTableViewAdapter.BeforeBuilding;
begin
  inherited BeforeBuilding;
  if TcxGridTableViewAccess(GridView).HasRowLayoutController then
    TcxGridTableViewAccess(GridView).RowLayoutController.InvalidateDefaultContainer;
end;
...
begin
  Result := GridView.OptionsView.ColumnAutoWidth or RowLayoutActive;
end;
...
function TdxGridTableViewAdapter.GetViewRequiredWidth: Integer;
begin
  if RowLayoutActive then
    Result := TcxGridTableViewAccess(GridView).RowLayoutController.ContainerDefaultWidth + IndentCount * IndentWidth
  else
    Result := 0;
end;

function TdxGridTableViewAdapter.GetViewWidth: Integer;
begin
  Result := inherited GetViewWidth - TcxCustomGridViewAccess(GridView).GetVerticalScrollBarAreaWidth;
end;
...
function TdxGridTableViewAdapter.GetRowLayoutActive: Boolean;
begin
  Result := GridView.RowLayout.Active;
end;

function TdxGridTableViewAdapter.GetRowLayoutHeight: Integer;
begin
...
begin
  if Adapter.RowLayoutActive and not AnIsPreview then
    Result := GetRowLayoutContentViewParams(ARecord, ATableItem)
  else
  begin
...
function TdxGridTableViewFormatter.CreateRowLayout(AParent: TdxReportCell;
  AGridRecord: TcxCustomGridRecord): TdxReportLayout;
begin
  Result := GetRowLayoutClass.CreateEx(AParent, AGridRecord);
end;

function TdxGridTableViewFormatter.CreateRowLayoutContainerProducer(AContainerViewInfo: TcxGridLayoutContainerViewInfo;
  AParent: TdxReportLayout): TdxGridCustomLayoutContainerProducer;
begin
  Result := GetRowLayoutContainerProducerClass.Create(AContainerViewInfo, AParent, Self);
end;

procedure TdxGridTableViewFormatter.DoInitializeRowLayout(ARowLayout: TdxReportLayout);
begin
  SetViewParams(ARowLayout, GetRowLayoutViewParams(ARowLayout.GridRecord));
end;

function TdxGridTableViewFormatter.GetRowLayoutClass: TdxReportLayoutClass;
begin
  Result := TdxReportLayout;
end;

function TdxGridTableViewFormatter.GetRowLayoutContainerProducerClass: TdxGridCustomLayoutContainerProducerClass;
begin
  Result := TdxGridRowLayoutContainerProducer;
end;

function TdxGridTableViewFormatter.GetRowLayoutContentViewParams(ARecord: TcxCustomGridRecord;
  ATableItem: TcxCustomGridTableItem): TdxReportItemViewParams;
begin
  if ReportLink.OptionsFormatting.UseNativeStyles then
    ReportLink.Styles.GetContentParams(ARecord, ATableItem, Result.NativeParams)
  else
...
function TdxGridTableViewFormatter.GetRowLayoutViewParams(ARecord: TcxCustomGridRecord): TdxReportItemViewParams;
begin
  Result := GetRowLayoutContentViewParams(ARecord, nil);
  if not ReportLink.OptionsFormatting.UseNativeStyles then
    Result.NativeParams.Color := TcxCustomLookAndFeelPainterAccess(Adapter.LookAndFeelPainter).GetDataRowLayoutContentColor;
  Result.CellSides := csAll;
  Result.Transparent := False;
end;
...
begin
  ...
  begin
    ...
    begin
      ...
      if (HeaderLineCount = 1) and not Adapter.RowLayoutActive then
...
begin
  ...
  if Adapter.DataRowHeightAssigned then
    ...
    if Adapter.RowLayoutActive then
      FDetailsLineHeight := Adapter.RowLayoutHeight
    else
  ...
  begin
    ...
    if not Adapter.DataRowHeightAssigned and not Adapter.RowLayoutActive and not Column.IsPreview then
...
function TdxGridTableViewFormatter.GetViewAvailableWidth: Integer;
begin
  Result := Max(inherited GetViewAvailableWidth, Adapter.GetViewRequiredWidth);
end;
...
begin
  if RowLayoutActive then
    Result := inherited CalculateDetailsLineCount
  else
  begin
    Result := 0;
...
function TdxGridCustomLayoutViewFormatter.GetRecordClass(AGridRecord: TcxGridCustomLayoutRecord): TdxReportCustomLayoutClass;
begin
  Result := TdxReportCustomLayout;
end;

procedure TdxGridCustomLayoutViewFormatter.DoInitializeRecord(
  ARecord: TdxReportCustomLayout; AGridRecord: TcxGridCustomLayoutRecord);
begin
...
function TdxGridCardViewFormatter.GetRecordClass(AGridRecord: TcxGridCustomLayoutRecord): TdxReportCustomLayoutClass;
begin
...
function TdxGridCustomLayoutViewBuilder.GetRecord(Index: Integer): TdxReportCustomLayout;
begin
  Result := TdxReportCustomLayout(FRecords[Index]);
end;
...
begin
  ...
  PreviewItem.Width := RowWidth - IndentArea;
...
procedure TdxGridTableViewDataRowProducer.AddRowLayout(AParent: TdxReportCell);
var
  ARowLayout: TdxReportLayout;
  ARecordsViewInfo: TcxGridRowsViewInfo;
  ARecordViewInfo: TcxGridDataRowViewInfo;
  ARecordViewInfoClass: TcxCustomGridRecordViewInfoClass;
begin
  ARowLayout := Formatter.CreateRowLayout(AParent, GridRow);
  Formatter.DoInitializeRowLayout(ARowLayout);
  ARecordViewInfoClass := TcxCustomGridRecordAccess(GridRow).GetViewInfoClass;
  ARecordsViewInfo := GridRow.GridView.ViewInfo.RecordsViewInfo;
  ARecordViewInfo := TcxGridDataRowViewInfo(ARecordViewInfoClass.Create(ARecordsViewInfo, GridRow));
  try
    if ARecordViewInfo.GridView.IsMaster then
      TcxGridMasterDataRowViewInfo(ARecordViewInfo).DetailsSiteVisible := False;
    ARecordViewInfo.Calculate(-10000, -10000, RowWidth);
    ARowLayout.Left := IndentArea;
    ARowLayout.Width := ARecordViewInfo.LayoutViewInfo.Width;
    ARowLayout.Height := ARecordViewInfo.LayoutViewInfo.Height;
    ProduceRowLayoutContainer(ARecordViewInfo.LayoutViewInfo.ContainerViewInfo, ARowLayout);
  finally
...
begin
  if Adapter.RowLayoutActive then
    AddRowLayout(AParent)
  else
    inherited AddSubItems(AParent);
  if HasPreview then
    AddPreview(AParent);
end;
...
procedure TdxGridTableViewDataRowProducer.ProduceRowLayoutContainer(
  AContainerViewInfo: TcxGridLayoutContainerViewInfo; AParent: TdxReportLayout);
var
  AProducer: TdxGridCustomLayoutContainerProducer;
begin
  AProducer := Formatter.CreateRowLayoutContainerProducer(AContainerViewInfo, AParent);
  try
    AProducer.Produce;
  finally
    AProducer.Free;
...
begin
  Result := inherited GetAutoHeight and not Adapter.RowLayoutActive and Adapter.CellAutoHeight;
end;
...
begin
  ...
  begin
    ...
    if not Formatter.AlignSummaryWithColumns then
      AInfo.Column := nil;
...
begin
  ...
  if AIndex <> 0 then
  begin
    if (csRight in ASubItem.CellSides) and SummaryItemInfos[AIndex].Column.IsMostRight then
      ASubItem.CellSides := [csRight]
    else
      ASubItem.CellSides := [];
...
begin
  ...
  begin
    ...
    begin
      if Formatter.AlignSummaryWithColumns then
        for I := SubItemCount - 1 downto 0 do
          with SummaryItemInfos[I] do
            if (Column <> nil) and (Column.VisibleIndex < 0) then DeleteInfo(I);
      I := 0;
      ...
      begin
        with GridRow.GroupSummaryItems do
          SummaryItemInfos[0].DisplayText := GridRow.DisplayCaption + ' ' + BeginText + SummaryItemInfos[0].DisplayText + EndText;
        cxGridCustomTableView.TcxCustomGridTableItemAccess.DoGetDisplayText(GridRow.GroupedColumn, GridRow, SummaryItemInfos[0].DisplayText);
      end
      else
      begin
        ...
        begin
          ...
          cxGridCustomTableView.TcxCustomGridTableItemAccess.DoGetDisplayText(GridRow.GroupedColumn, GridRow, S);
        end;
...
function TdxGridCustomLayoutViewRecordProducer.CreateRecord(AParent: TdxReportCell; AGridRecord: TcxGridCustomLayoutRecord): TdxReportCustomLayout;
begin
...
procedure TdxGridCustomLayoutViewRecordProducer.InjectRecord(ARecord: TdxReportCustomLayout; AIndex: Integer);
...
function TdxGridReportLink.SupportsGapsBetweenCells: Boolean;
begin
...
begin
  ...
  begin
    ...
    begin
      ...
      begin
        ATableView := TcxGridTableView(View);
        OptionsPreview.AutoHeight := ATableView.Preview.AutoHeight;
        OptionsPreview.MaxLineCount := ATableView.Preview.MaxLineCount;
        OptionsPreview.Visible := ATableView.Preview.Visible;
    
        if View is TcxGridBandedTableView then     
          OptionsView.BandHeaders := TcxGridBandedTableView(View).OptionsView.BandHeaders;
        OptionsView.FilterBar := (ATableView.Filtering.Visible = fvAlways) or
          ((ATableView.Filtering.Visible = fvNonEmpty) and
           (ATableView.DataController.Filter.FilterText <> ''));
        OptionsView.Footers := ATableView.OptionsView.Footer;
        OptionsView.GroupFooters := ATableView.OptionsView.GroupFooters <> gfInvisible;
        OptionsView.Headers := ATableView.OptionsView.Header;

        OptionsSize.AutoWidth := ATableView.OptionsView.ColumnAutoWidth or ATableView.RowLayout.Active;
      end;
...
procedure TdxfmGridReportLinkDesignWindow.colSpeedCountCustomDrawCell(Sender: TcxCustomGridTableView;
  ...
  begin
    ...
    try
      AViewData := TcxCustomTrackBarViewData(AProperties.CreateViewData(DefaultEditStyleController.Style, True, ScaleFactor));
      try
