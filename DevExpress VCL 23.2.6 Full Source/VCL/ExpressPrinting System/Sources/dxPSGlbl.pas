...
uses
  ...
  dxCore, dxMessages, cxControls, cxColorComboBox, dxPrintUtils;

type
  TdxPageNumbers = dxPrintUtils.TdxPageNumbers;
  TdxPageRanges = dxPrintUtils.TdxPageRanges;

const
  pnAll = dxPrintUtils.pnAll;
  pnEven = dxPrintUtils.pnEven;
  pnOdd = dxPrintUtils.pnOdd;
  prAll = dxPrintUtils.prAll;

  prCurrent = dxPrintUtils.prCurrent;
  prRange = dxPrintUtils.prRange;
  prSelection = dxPrintUtils.prSelection;
...
const
  ...
  cPageRangeSeparator = dxPrintUtils.cPageRangeSeparator;
  cPageSeparator = dxPrintUtils.cPageSeparator;
