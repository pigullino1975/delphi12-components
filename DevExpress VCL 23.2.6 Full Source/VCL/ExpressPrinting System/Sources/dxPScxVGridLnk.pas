...
begin
  ...
  begin
    ACell.X := TcxCustomRowAccess(ARow).GetEditContainer(ACellIndex).ItemIndex;
...
begin
  ...
  begin
    ...
    AImageItem.Palette := ReportLink.GetControlActivePalette;
  end;
...
begin
  ...
  if AnItem is TCustomdxReportCellImageContainer then
    TCustomdxReportCellImageContainer(AnItem).Palette := ReportLink.GetControlActivePalette;
end;
