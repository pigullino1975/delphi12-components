...
const
  dxThisUnitName = 'dxPScxPivotGridLnk';
...
begin
  ...
  try
    AController.PivotGrid.BeginUpdate;
    try
      ...
      AController.PivotGrid.EndUpdate;
    end;
  finally
    AController.Free;
  end;
...
begin
  ...
  begin
    ...
    begin
      ...
      TextAlignY := TextAlignYMap[vaTop];
...
procedure TcxPivotGridReportLink.InitializeOptionsBeforeBuildReport(
  ...
  procedure ExpandFields(ANeedExpand: Boolean; AFields: TcxPivotGridFields);
  var
    I: Integer;
  begin
    if (AController.PivotGrid.OLAPDataSource = nil) or (AFields.Count = 0) then
      Exit;
    ...
    begin
      if ANeedExpand then
        ...
        AFields[I].CollapseAll;
    end;
  end;

begin
  ExpandFields(OptionsExpanding.AutoExpandColumns,
    TcxPivotGridAccess(AController.PivotGrid).DataBuilder.ColumnFields);
  ExpandFields(OptionsExpanding.AutoExpandRows,
    TcxPivotGridAccess(AController.PivotGrid).DataBuilder.RowFields);
