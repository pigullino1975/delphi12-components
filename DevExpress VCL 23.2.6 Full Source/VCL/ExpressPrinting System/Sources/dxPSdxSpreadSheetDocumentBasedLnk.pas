...
uses
  ...
  dxSpreadSheetContainers, dxPSGlbl, dxPrnPg, dxPgsDlg, dxPSHFLibrary, dxSpreadSheet, dxGenerics;
...
type
  ...
  strict private
    class var FPSToExcel: TdxStringsDictionary;
  protected
...
const
  dxThisUnitName = 'dxPSdxSpreadSheetDocumentBasedLnk';
...
begin
  ...
  begin
    FPSToExcel := TdxStringsDictionary.Create;
    FPSToExcel.Add('&', '&&');
...
begin
  if ACell.DisplayValueDataType = cdtError then
