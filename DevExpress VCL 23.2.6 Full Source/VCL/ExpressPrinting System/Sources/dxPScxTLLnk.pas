...
procedure TcxTreeListCustomBandPlace.InitAutoWidthItem(AnItem: TcxAutoWidthItem);
begin
  AnItem.Fixed := IsFixed;
  AnItem.MinWidth := MinWidth + Band.IndentWidth;
  AnItem.Width := Width;
end;
...
begin
  ...
  begin
    for I := 0 to ItemCount - 1 do
      Result := Max(Result, Items[I].LevelIndex);
    Inc(Result);
  end;
end;
...
begin
  ...
  AnItem.Palette := ReportLink.GetControlActivePalette;
end;
...
function TcxTreeListCustomReportLink.GetItemCustomDrawInfo(AnItem: TdxReportVisualItem; 
  ...
  function IsAttributedRow(AData: TdxNativeInt; AAttributeClass: TcxTreeListAttributeClass): Boolean;
  begin
    try
  ...
  function IsBandRow(AData: TdxNativeInt): Boolean;
  begin
    Result := IsAttributedRow(AData, TcxTreeListBandAttribute);
  end;

  function IsHeaderRow(AData: TdxNativeInt): Boolean;
  begin
    Result := IsAttributedRow(AData, TcxTreeListHeaderAttribute);
  end;

  function IsFooterRow(AData: TdxNativeInt): Boolean;
  begin
    Result := IsAttributedRow(AData, TcxTreeListFooterAttribute);
  end;

  function IsIndentRow(AData: TdxNativeInt): Boolean;
  begin
    Result := IsAttributedRow(AData, TcxTreeListIndentsRowAttribute);
  end;

  function CheckBand(AData: TdxNativeInt): Boolean;
  begin
    try
  ...
  function CheckColumn(AData: TdxNativeInt): Boolean;
  begin
    try
  ...
  function CheckNode(AData: TdxNativeInt): Boolean;
  begin
    try
  ...
  function IsBandCell(AData: TdxNativeInt): Boolean;
  begin
  ...
  function IsFooterCell(AData: TdxNativeInt): Boolean;
  begin
  ...
  function IsNode(AData: TdxNativeInt): Boolean;
  begin
