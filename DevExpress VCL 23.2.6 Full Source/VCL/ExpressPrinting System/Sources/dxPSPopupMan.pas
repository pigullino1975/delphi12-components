...
uses
  Types, SysUtils, Messages, Forms, dxPSGlbl, dxPSUtl, cxControls, dxCore;

const
  dxThisUnitName = 'dxPSPopupMan';
...
procedure dxPSPopupManMouseHook(ACode: Integer; wParam: WPARAM; lParam: LPARAM; var AHookResult: LRESULT);
  ...
  function FindControl(Wnd: HWND; const Pt: TPoint): TControl;
    ...
    begin
      Result := (dxPSPopupMenuController.IndexOfControl(AControl) > -1) and 
        PtInRect(AControl.ClientRect, AControl.ScreenToClient(Pt));
    end;
