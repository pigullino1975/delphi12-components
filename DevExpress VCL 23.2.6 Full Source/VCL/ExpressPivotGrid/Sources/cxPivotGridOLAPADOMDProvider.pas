...
uses
  ...
  ActiveX, Generics.Defaults, Generics.Collections, dxCore, cxClasses, cxPivotGridOLAPDataSource, dxGenerics,
...
{$ENDREGION}
  ...
  protected
    ...
    procedure PopulateHierarchyAllMemberNames(const ACubeName: string; ANames: TdxStringsDictionary); override;
...
const
  dxThisUnitName = 'cxPivotGridOLAPADOMDProvider';
