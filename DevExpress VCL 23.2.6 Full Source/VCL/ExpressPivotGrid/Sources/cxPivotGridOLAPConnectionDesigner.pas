...
uses
  ...
  dxLayoutContainer, dxLayoutControl, dxLayoutLookAndFeels, dxForms, dxShellDialogs;
...
const
  dxThisUnitName = 'cxPivotGridOLAPConnectionDesigner';
