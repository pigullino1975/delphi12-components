...
{$IFNDEF NONDB}
  FMTBcd, SqlTimSt,
{$ENDIF}
  dxCore, dxCoreClasses, dxMessages, cxClasses, cxControls, cxGraphics, dxCoreGraphics, dxForms,
  ...
  cxFilterControlDialog, cxNavigator, dxCustomTree, dxThreading, dxIncrementalFiltering, dxTypeHelpers;
...
type
  ...
  TcxPivotGridFilterPopupListBox = class;
  ...
  TcxPivotGridAdvancedDataGroupIntervalItem = class;
  ...
  TcxPivotGridSummaryType = (stCount, stSum, stMin, stMax, stAverage,
    stStdDev, stStdDevP, stVariance, stVarianceP, stCustom, stCountDistinct);
  TcxPivotGridSummaryTypes = set of TcxPivotGridSummaryType;
  ...
  public
    ...
    property Items[Index: Integer]: TcxPivotGridVariantValue read GetItem; // for internal use
  ...
  private
    FSorted: Boolean;
    function GetItem(AIndex: TdxListIndex): TdxNativeInt;
    procedure SetItem(AIndex: TdxListIndex; AValue: TdxNativeInt);
  protected
  ...
  public
    ...
    property Items[Index: TdxListIndex]: TdxNativeInt read GetItem write SetItem; default;
  end;
  ...
  private
    function GetField(Index: TdxListIndex): TcxPivotGridField;
  protected
    function GetItem(Index: TdxListIndex): TcxPivotGridField; inline;
  public
    procedure ArrangeFields;

    property Fields[Index: TdxListIndex]: TcxPivotGridField read GetField; default;
  end;
  ...
  private
    function GetItem(AIndex: TdxListIndex): TcxPivotGridCustomCellViewInfo;
  protected
  ...
  public
    ...
    property Items[Index: TdxListIndex]: TcxPivotGridCustomCellViewInfo read GetItem; default;
  end;
...
// PivotGrid DataBuilder
  ...
  private
    ...
    function GetSummaryNullIgnore: Boolean; inline;
    function GetRecords: TcxPivotGridRecords;
    function GetVariationNullIgnore: Boolean;
  protected
    procedure CalculateCountDistinct; virtual;
  ...
  public
    ...
    property DistinctCount: Variant index 10 read GetSummaryByIndex;
  ...
  public
    ...
    property ColumnFields: TcxPivotGridFields read FColumnFields; // for internal use
    ...
    property DataController: TcxCustomDataController read FDataController;
    property DataFields: TcxPivotGridFields read FDataFields; // for internal use
    property Fields: TcxPivotGridFields read FFields; // for internal use
    property FilteredFields: TcxPivotGridFields read FFilteredFields; // for internal use
    property FilteredIndexes: TcxPivotGridRecords read FFilteredIndexes;
    property FilterFields: TcxPivotGridFields read FFilterFields; // for internal use
    ...
    property PivotGrid: TcxCustomPivotGrid read FPivotGrid;
    property RowFields: TcxPivotGridFields read FRowFields; // for internal use
    property Rows: TcxPivotGridGroupItem read FRows;
    property SummaryFields: TcxPivotGridFields read GetSummaryFields; // for internal use
  end;
...
//  Pivot ViewData
  ...
  private
    function GetItem(Index: TdxListIndex): TcxPivotGridViewDataLimitValue;
  public
    ...
    property Items[Index: TdxListIndex]: TcxPivotGridViewDataLimitValue read GetItem; default;
  end;
  ...
  public
    ...
    property DataBuilder: TcxPivotGridDataBuilder read GetDataBuilder; // for internal use
...
// ViewInfo
  ...
  protected
    ...
    FMainViewInfo: TcxPivotGridViewInfo;
  ...
  protected
    ...
    procedure CalculateEditViewInfo(AEditViewInfo: TcxCustomEditViewInfo;
      const AMousePos: TPoint; AIsHeader: Boolean);
    ...
    procedure DrawHeaderUsingEditProperties; virtual;
  ...
  public
    ...
    property Background: TcxPivotGridHeaderBackgroundCellViewInfo read FBackground write FBackground; // for internal use
    property Borders;
...
// PivotGrid Base Classes
  ...
  public
    ...
    property Parent: TcxPivotGridOLAPStructureNode read GetParent; // for internal use
  ...
  public
    ...
    property Structure: TcxPivotGridOLAPStructureNode read FStructure; // for internal use
  end;
  ...
  { TcxPivotGridInnerCheckListBox }

  TcxPivotGridInnerCheckListBox = class(TcxCustomInnerCheckListBox)
  private
    function GetContainer: TcxPivotGridFilterPopupListBox;
  protected
    procedure DrawItemText(const AText: string; ARect: TRect; AState: TOwnerDrawState); override;
    property Container: TcxPivotGridFilterPopupListBox read GetContainer;
  end;
  ...
  protected
    ...
    property Popup: TcxPivotGridFilterPopup read FPopup;
  public
    constructor Create(AOwner: TComponent); override;
  end;
  ...
  public
    ...
    property Items[Index: Integer]: TcxPivotGridFieldSortCondition read GetItem write SetItem; default; // for internal use
  ...
  public
    ...
    property Conditions: TcxPivotGridFieldSortConditionCollection read FConditions write SetConditions; // for internal use
  ...
  protected
    ...
    function GetDefaultValuesProvider: TcxCustomEditDefaultValuesProvider; virtual;
    ...
    function GetOwner: TPersistent; override;
    procedure Init; virtual;
    function IsCurrencyField: Boolean; virtual;
  public
    constructor Create(AOwner: TcxPivotGridField); virtual;
    destructor Destroy; override;
    procedure Assign(Source: TPersistent); override;
  ...
  private
    ...
    FGroupIntervalAdvanced: Integer;
    FGroupIntervalItem: TcxPivotGridAdvancedDataGroupIntervalItem;
    ...
    function GetGroupInterval: TcxPivotGridGroupInterval;
    ...
    procedure SetGroupIntervalAdvanced(AValue: Integer);
  ...
  protected
    ...
    function IsCompatibleWidth(AInfo: TcxPivotGridDragDropAreaInfo): Boolean;
    function IsDefaultGroupValues: Boolean;
    ...
    property GroupIntervalItem: TcxPivotGridAdvancedDataGroupIntervalItem read FGroupIntervalItem;
  ...
  published
    ...
    property GroupInterval: TcxPivotGridGroupInterval read GetGroupInterval write SetGroupInterval default giDefault;
    property GroupIntervalAdvanced: Integer read FGroupIntervalAdvanced write SetGroupIntervalAdvanced default -1;
  ...
  public
    ...
    property Structure: TcxPivotGridOLAPStructureNode read FStructure write SetStructure; // for internal use
  published
  ...
  protected
    procedure AdapterClickHandler(Sender: TObject); virtual;
    ...
    function CreateSubItem(AOwner: TMenuItem; const ACaption: string;
      ACommand: Integer; AEnabled: Boolean = True; AChecked: Boolean = False): TMenuItem;
  ...
  TcxPivotGridFieldHeaderPopupMenuItem = (fpmiHide, fpmiOrder, fpmiFieldList, fpmiSummaryType);
  ...
  private
    ...
    FSummaryItems: TcxPivotGridSummaryTypes;
  ...
  published
    ...
    property SummaryItems: TcxPivotGridSummaryTypes read FSummaryItems write FSummaryItems stored IsSummaryItemsStored;
  end;
  ...
  protected
    ...
    procedure CreateSubClasses; virtual;
    procedure DestroyFieldsEditViewData;
    procedure DestroySubClasses; virtual;
    procedure DataChanged; virtual;
  ...
  { TcxPivotGridDataGroupIntervalRepository }

  TcxPivotGridGroupValueFunc<T,TResult> = reference to function (const AValue: T): TResult;

  TcxPivotGridAdvancedDataGroupIntervalItem = class  // for internal use
  private
    FDisplayName: string;
    FGetGroupValueFunc: TcxPivotGridGroupValueFunc<Variant, Variant>;
    FGetGroupValueDisplayTextFunc: TcxPivotGridGroupValueFunc<Variant, string>;
    FID: Integer;
  protected
    function GetDateTimeValue(const AValue: Variant; var ADateTime: TDateTime): Boolean;
    function HalfOfTheYear(const AValue: TDateTime): Integer;
    function QuarterOfTheYear(const AValue: TDateTime): Integer;
    function RegisterInstance: Integer;
  public
    function GetGroupValue(const AValue: Variant): Variant; virtual;
    function GetGroupValueDisplayText(const AValue: Variant): string; virtual;
  ...
  { TcxPivotGridAdvancedDataGroupIntervalRepository }

  TcxPivotGridAdvancedDataGroupIntervalRepository = class // for internal use
  strict private
    type
      TMonthYearGroupInterval = class(TcxPivotGridAdvancedDataGroupIntervalItem)
      public
        function GetGroupValue(const AValue: Variant): Variant; override;
        function GetGroupValueDisplayText(const AValue: Variant): string; override;
        function GetName: string; override;
      end;

      TQuarterYearGroupInterval = class(TcxPivotGridAdvancedDataGroupIntervalItem)
      public
        function GetGroupValue(const AValue: Variant): Variant; override;
        function GetGroupValueDisplayText(const AValue: Variant): string; override;
        function GetName: string; override;
      ...
      THalfYearGroupInterval = class(TcxPivotGridAdvancedDataGroupIntervalItem)
      public
        function GetGroupValue(const AValue: Variant): Variant; override;
        function GetGroupValueDisplayText(const AValue: Variant): string; override;
        function GetName: string; override;
  ...
  protected
    ...
    class var FItems: TObjectList<TcxPivotGridAdvancedDataGroupIntervalItem>;

    class function GetNextID: Integer;
    class function FindItemByName(const ADisplayName: string; var AItem: TcxPivotGridAdvancedDataGroupIntervalItem): Integer;
  public
    class function GetCount: Integer;
    class function GetItem(Index: Integer): TcxPivotGridAdvancedDataGroupIntervalItem;
    class function GetItemByID(ID: Integer): TcxPivotGridAdvancedDataGroupIntervalItem;
    class function GetItemByName(const ADisplayName: string): TcxPivotGridAdvancedDataGroupIntervalItem;
    class function Register(const ADisplayName: string; AGetGroupValueFunc: TcxPivotGridGroupValueFunc<Variant, Variant>;
      AGetGroupValueDisplayTextFunc: TcxPivotGridGroupValueFunc<Variant, string>): Integer; 
    class procedure Unregister(ID: Integer);
  end;
...
uses
  ...
  cxPivotGridAdvancedCustomization, dxHash, dxHashUtils, dxDPIAwareUtils, dxBuiltInPopupMenu;

const
  dxThisUnitName = 'cxCustomPivotGrid';
...
const
  ...
  DefaultSummaryItems: TcxPivotGridSummaryTypes = [stCount, stSum, stMin, stMax, stAverage];
...
var
  InternalMenuImages: TcxImageList;

type
  TControlAccess = class(TControl);
  TcxDataControllerMultiThreadedOptionsAccess = class(TcxDataControllerMultiThreadedOptions);

  TdxRemovePaddingsTuner = class(TInterfacedObject, IdxVisualRefinementsTuner)
  protected
...
function FormatDisplayValue(const AValue: Variant;
  const ADisplayFormat: string; AIsCurrency, AIsPercent: Boolean; AIsOLAP: Boolean): string;
var
  AFormatStr: string;
begin
  ...
  if VarIsNumericEx(AValue){$IFNDEF NONDB} or (VarType(AValue) = varFMTBCD){$ENDIF} then
...
procedure TcxPivotGridInnerCheckListBox.DrawItemText(const AText: string;
  ARect: TRect; AState: TOwnerDrawState);
const
  FlagsMap: array[Boolean] of Cardinal = (CXTO_LEFT, CXTO_RIGHT or CXTO_RTLREADING);
var
  ASelStart: Integer;
  ASearchText: string;
  R: TRect;
begin
  if Container.Popup.UseIncrementalFiltering and (ifoHighlightSearchText in Container.Popup.IncrementalFilteringOptions) then
  begin
    R := ARect;
    ASearchText := Container.Popup.GetSearchText;
    ASelStart := Pos(AnsiUpperCase(ASearchText), AnsiUpperCase(AText)) - 1;
    cxTextOut(Canvas.Canvas, AText, R,
      FlagsMap[UseRightToLeftAlignment] or CXTO_CENTER_VERTICALLY or CXTO_SINGLELINE,
      ASelStart, Length(ASearchText), Canvas.Font,
      cxGetActualColor(Painter.DefaultSearchResultHighlightColor, clHighlight),
      cxGetActualColor(Painter.DefaultSearchResultHighlightTextColor, clHighlightText),
...
function TcxPivotGridInnerCheckListBox.GetContainer: TcxPivotGridFilterPopupListBox;
begin
  Result := inherited Container as TcxPivotGridFilterPopupListBox;
end;
...
begin
  inherited;
  FPopup := Owner as TcxPivotGridFilterPopup;
end;

function TcxPivotGridFilterPopupListBox.GetInnerCheckListBoxClass: TcxCustomInnerCheckListBoxClass;
begin
  Result := TcxPivotGridInnerCheckListBox;
end;
...
begin
  if Field.UseEditProperties and (Field.SummaryVariation = svNone) and (Field.Area <> faData) and Field.IsDefaultGroupValues then
...
procedure TcxPivotGridController.MakeCellFocused(ACell: TcxPivotGridDataCellViewInfo; AShift: TShiftState);
begin
  SetSelection(ACell.ColumnIndex, ACell.RowIndex, AShift);
end;

procedure TcxPivotGridController.MouseDown(Button: TMouseButton; Shift: TShiftState; X, Y: Integer);
var
...
function TcxPivotGridRecords.GetItem(AIndex: TdxListIndex): TdxNativeInt;
begin
  Result := TdxNativeInt(inherited Items[AIndex]);
end;

procedure TcxPivotGridRecords.SetItem(AIndex: TdxListIndex; AValue: TdxNativeInt);
begin
...
function TcxPivotGridFields.GetItem(Index: TdxListIndex): TcxPivotGridField;
begin
  Result := TcxPivotGridField(List[Index]);
end;

function TcxPivotGridFields.GetField(Index: TdxListIndex): TcxPivotGridField;
begin
...
function TcxPivotGridCells.GetItem(AIndex: TdxListIndex): TcxPivotGridCustomCellViewInfo;
begin
...
begin
  ...
  begin
    ...
    if AField.IsDefaultGroupValues then
...
begin
  ...
  begin
    ...
    if (AType <> nil) and not ADataField.DataBinding.IsCurrencyField then
    begin
...
begin
  ...
  if not (VarTypeIsCurrency(ASourceType) and ADataField.DataBinding.IsCurrencyField) then
  begin
...
begin
  ...
  if (AType = stCountDistinct) and VarIsNull(Result) then
  begin
...
procedure TcxPivotGridCrossCellSummary.CalculateCountDistinct;
var
  I: Integer;
  AValue: Variant;
  AList: TList;
  AValues: TdxVariantDictionary<Integer>;
  AGetValueProc: TcxPivotGridGetRecordValueProc;
begin
  AGetValueProc := GetRecordValue;
  if Owner.UseRawData then
    AList := Owner.Records
  else
  begin
    AList := Owner.CreateCrossCellsList;
    AGetValueProc := GetIntermediateValue;
  end;
  try
    AValues := TdxVariantDictionary<Integer>.Create(AList.Count);
    try
      for I := 0 to AList.Count - 1 do
      begin
        AValue := AGetValueProc(AList.List[I], not DataField.IsDefaultGroupValues);
        if not VarIsSoftEmpty(AValue) then
          AValues.AddOrSetValue(AValue, 0);
      end;
      FSummaries[stCountDistinct] := AValues.Count;
    finally
      AValues.Free;
    end;
  finally
    if not Owner.UseRawData then
      AList.Free;
  end;
end;
...
var
  ...
  begin
    ...
    begin
      ASourceValue := Null;
      if not AIsStringField or not Owner.UseRawData then
        ASourceValue := AGetValueProc(ARecords[I], not DataField.IsDefaultGroupValues)
      else
      begin
      ...
      if not (SummaryNullIgnore and (VarIsNull(ASourceValue) or
        ((AIsStringField or VarIsStr(ASourceValue)) and (ASourceValue = '')))) then  // not null or empty
        Inc(ACount);
      if AIsStringField then
        Continue;
      if not DataField.IsDefaultGroupValues then
      begin
  ...
  begin
    ...
    if DataField.IsDefaultGroupValues and not AIsStringField and (ACount <> ANotNumericCount) then
    begin
...
begin
  ...
  try
    ...
    begin
      if (AVarType <> varCurrency) or ((AValue <= MaxCurrency) and (AValue >= MinCurrency)) then
...
begin
  ...
  begin
    ...
    if AImageIndex > 0 then
      TdxImageDrawer.DrawImage(Canvas, Bounds, nil, cxPivotGridKPIImageList, AImageIndex, True, nil, ScaleFactor);
  end;
end;
...
function TcxPivotGridViewDataLimitValues.GetItem(
  Index: TdxListIndex): TcxPivotGridViewDataLimitValue;
begin
...
begin
  ...
  try
    if AIsHeader then
      FEditViewData.RefinementsTuner := TdxRemovePaddingsTuner.Create;
...
begin
  ...
  FTextBounds.Deflate(TdxVisualRefinements.Padding.Left, 0, TdxVisualRefinements.Padding.Right, 0);
end;
...
begin
  if FUseLocalViewData then
    FEditViewData := FProperties.CreateViewData(FEditStyle, True, ScaleFactor)
  else
...
procedure TcxPivotGridEditContainerViewInfo.DrawHeaderUsingEditProperties;
begin
  CalculateEditViewInfo(FEditViewInfo, cxNullPoint, True);
  FEditViewInfo.Paint(Canvas);
end;

procedure TcxPivotGridEditContainerViewInfo.DrawUsingEditProperties;
begin
  CalculateEditViewInfo(FEditViewInfo, cxNullPoint, False);
  FEditViewInfo.Paint(Canvas);
end;

function TcxPivotGridEditContainerViewInfo.GetDrawTextFlags: Integer;
const
  MultiLines: array[Boolean] of Integer = (cxSingleLine, cxWordBreak);
  ShowEndEllipses: array[Boolean] of Integer = (0, cxShowEndEllipsis);
begin
  Result := cxFlagsToDTFlags(cxAlignmentsHorz[GetRealAlignHorz] or cxAlignmentsVert[FAlignVert] or
    MultiLines[FMultiLine] or ShowEndEllipses[FShowEndEllipsis]);
end;

function TcxPivotGridEditContainerViewInfo.GetRealAlignHorz: TAlignment;
begin
  Result := FAlignment;
  if IsRightToLeftConverted then
...
begin
  ...
  begin
    ...
    FImageRect := cxRectSetTop(FImageRect, Bounds.Top + ScaleFactor.Apply(cxTextOffset + Byte(bTop in Borders)));
...
begin
  ...
  if FMainViewInfo = nil then
    FTextBounds := cxRectContent(ExcludeBorders(FBounds, Borders), Painter.HeaderContentOffsets(ScaleFactor))
  else
  begin
    if Properties = nil then
      FTextBounds := cxRectSetHeight(Bounds, FMainViewInfo.HeaderHeight + 1)
    else
      FTextBounds := Bounds;
    FTextBounds := cxRectContent(ExcludeBorders(FTextBounds, Borders), Painter.HeaderContentOffsets(ScaleFactor));
  end;
  if HasButton then
  begin
    if FMainViewInfo <> nil then
    begin
      FButtonRect := cxRectContent(ExcludeBorders(cxRectSetHeight(Bounds, FMainViewInfo.HeaderHeight + 1), Borders),
        Painter.HeaderContentOffsets(ScaleFactor));
      FButtonRect := cxRectSetWidth(cxRectCenterVertically(FButtonRect,
        Painter.ScaledExpandButtonSize(ScaleFactor)), Painter.ScaledExpandButtonSize(ScaleFactor));
    end
    else
    begin
      FButtonRect := cxRectSetSize(cxRectContent(ExcludeBorders(Bounds, Borders), Painter.HeaderContentOffsets(ScaleFactor)),
        Painter.ScaledExpandButtonSize(ScaleFactor), Painter.ScaledExpandButtonSize(ScaleFactor));
      OffsetRect(FButtonRect, 1, 1);
    end;
    FButtonAreaRect := cxRectCenter(FButtonRect, Painter.ScaledExpandButtonAreaSize(ScaleFactor),
      Painter.ScaledExpandButtonAreaSize(ScaleFactor));
...
begin
  ...
  begin
    ...
    if Background = nil then
      Painter.DrawScaledGroupByBox(Canvas, R, Transparent, clDefault, nil, ScaleFactor, dxDefaultScaleFactor)
    else
    begin
  ...
  if IsImageAssigned(Images, ImageIndex) then
    TdxImageDrawer.DrawImage(Canvas, ImageRect, nil, Images, ImageIndex, True, nil, ScaleFactor);
end;
...
procedure TcxPivotGridHeaderCellViewInfo.DrawHeaderText;
  ...
  begin
    ...
    begin
      ...
      cxDrawText(Canvas, DisplayText, TextBounds, GetDrawTextFlags);
    end;
  end;
...
begin
  Result := inherited UseEditProperties and FDataField.IsDefaultGroupValues and (FDataField.FArea <> faData);
end;
...
begin
  ...
  if FocusRectStyle = frsLine then
    ...
    if (FocusRectStyle = frsDot) and Painter.SupportsNativeFocusRect then
    begin
...
begin
  ...
  begin
    ...
    try
      ...
      FPainter.DrawScaledGroupByBox(FCanvas, FieldHeadersBounds.Rect, Bitmap <> nil, Color,
        Bitmap, ScaleFactor, dxDefaultScaleFactor);
    finally
...
begin
  ...
  begin
    ...
    if PivotGrid.UseLightBorders then
    begin
      if not (PivotGrid.OptionsView.FilterFields or PivotGrid.OptionsView.ColumnFields or PivotGrid.OptionsView.DataFields) then
        Result.Neighbors := Result.Neighbors + [nTop];
    end;
...
begin
  ...
  begin
    ...
    if PivotGrid.UseLightBorders then
      Result.Neighbors := Result.Neighbors + [nLeft];
...
begin
  ...
  FFieldHeaderHeight := Painter.ScaledHeaderHeight(Max(AContentHeight, GetIconsSize.cy), PivotGrid.ScaleFactor);
  for I := 0 to PivotGrid.FieldCount - 1 do
  begin
...
function TcxPivotGridFieldDataBinding.GetDefaultValuesProvider: TcxCustomEditDefaultValuesProvider;
begin
...
function TcxPivotGridFieldDataBinding.IsCurrencyField: Boolean;
begin
  Result := ValueTypeClass = TcxCurrencyValueType;
end;
...
begin
  ...
  FSummaryItems := DefaultSummaryItems;
end;
...
const
  AImageIndexes: array[TcxPivotGridSummaryType] of Integer = (0, 1, 2, 3, 4, -1, -1, -1, -1, -1, -1);
begin
  inherited CreateItems;
  if (Field <> nil) and (Field.Area = faData) and ((fpmiSummaryType in Items) and (SummaryItems <> [])) then
  begin
    AItem := CreateSubItem(Root, cxGetResourceString(@scxSummaryType), -1, Field <> nil);
    for ASummaryType in SummaryItems do
    begin
      ASubItem := CreateSubItem(AItem, Trim(Format(cxGetResourceString(TotalDescriptions[ASummaryType]), [' '])),
        pgcmSummaryTypeBase + Byte(ASummaryType), True, Field.SummaryType = ASummaryType);
      ASubItem.AutoCheck := True;
      if FBuiltInMenu.Images = InternalMenuImages then
        ASubItem.ImageIndex := AImageIndexes[ASummaryType];
    end;
  ...
  begin
    ...
    with PivotGrid.Customization do
    begin
      ASubItem := CreateSubItem(Root, cxGetResourceString(scxCustomization[Visible]),
        CustomizationCommand[Visible], PivotGrid.OptionsCustomize.QuickCustomization);
      if FBuiltInMenu.Images = InternalMenuImages then
        ASubItem.ImageIndex := 5;
    end;
  //
...
begin
  case ACommand of
    ...
    pgcmSummaryTypeBase..pgcmSummaryTypeBase + Byte(High(TcxPivotGridSummaryType)):
      Field.SummaryType := TcxPivotGridSummaryType(ACommand - pgcmSummaryTypeBase);
  else
...
function TcxPivotGridFieldHeaderMenu.IsSummaryItemsStored: Boolean;
begin
  Result := SummaryItems <> DefaultSummaryItems;
end;
...
begin
  ...
  begin
    ...
    if vpmiExpandAll in Items then
      CreateSubItem(Root, cxGetResourceString(@scxExpandAll), pgcmExpandAll).ImageIndex :=
        IfThen(FBuiltInMenu.Images = InternalMenuImages, 7, -1);

    if vpmiCollapseAll in Items then
      CreateSubItem(Root, cxGetResourceString(@scxCollapseAll), pgcmCollapseAll).ImageIndex :=
        IfThen(FBuiltInMenu.Images = InternalMenuImages, 8, -1);
  end;
...
begin
  ...
  begin
    ...
    begin
      ...
      try
        AAdapter.SetImages(FBuiltInMenu.Images);
        AAdapter.SetLookAndFeel(PivotGrid.LookAndFeel);
        TdxBuiltInPopupMenuAdapterHelper.AddMenu(AAdapter, FBuiltInMenu, AdapterClickHandler);
...
procedure TcxPivotGridCustomPopupMenu.AdapterClickHandler(Sender: TObject);
begin
...
begin
  ...
  if FBuiltInMenu.Images = nil then
    FBuiltInMenu.Images := InternalMenuImages;
  CreateItems;
end;
...
function TcxPivotGridCustomPopupMenu.CreateSubItem(AOwner: TMenuItem;
  const ACaption: string; ACommand: Integer; AEnabled: Boolean; AChecked: Boolean): TMenuItem;
begin
...
procedure TcxCustomPivotGrid.DestroyFieldsEditViewData;
var
  I: Integer;
begin
  for I := 0 to FieldCount - 1 do
...
function TcxCustomPivotGrid.GetUseLightBorders: Boolean;
begin
...
begin
  ...
  if AGroupInterval = giDefault then
  begin
     if (Area <> faData) and (GroupIntervalItem <> nil)  then
       Result := GroupIntervalItem.GetGroupValue(Result);
    Exit;
  end;
  try
...
begin
  try
    case GroupInterval of
      giDefault:
        if (Area <> faData) and (GroupIntervalItem <> nil)  then
          Result := GroupIntervalItem.GetGroupValueDisplayText(AGroupValue)
        else
...
begin
  FEditViewData := GetUserEditProperties.CreateViewData(FEditStyle, True, ScaleFactor);
end;
...
procedure TcxPivotGridField.DoGetDisplayText(
  ACell: TcxPivotGridDataCellViewInfo);
begin
  ACell.FDisplayText := FormatDisplayValue(ACell.Value, ACell.DisplayFormat, DataBinding.IsCurrencyField,
...
function TcxPivotGridField.IsDefaultGroupValues: Boolean;
begin
  Result := GroupInterval = giDefault;
end;
...
begin
  ...
  begin
    ...
    AProperties.DefaultValuesProvider := DataBinding.GetDefaultValuesProvider;
...
function TcxPivotGridField.GetGroupInterval: TcxPivotGridGroupInterval;
begin
  Result := FGroupInterval;
  if FGroupIntervalAdvanced >= 0 then
    Result := giDefault;
end;
...
begin
  if GroupInterval <> AValue then
  begin
    FGroupInterval := AValue;
    if AValue <> giDefault then
      GroupIntervalAdvanced := -1;
    DataChanged;
  end;
end;

procedure TcxPivotGridField.SetGroupIntervalAdvanced(AValue: Integer);
begin
  if AValue <> FGroupIntervalAdvanced then
  begin
    FGroupIntervalItem := TcxPivotGridAdvancedDataGroupIntervalRepository.GetItemByID(AValue);
    if FGroupIntervalItem <> nil then
      FGroupIntervalAdvanced := AValue
    else
      FGroupIntervalAdvanced := -1;
    DataChanged;
  end;
...
begin
  ...
  B := TcxDataControllerMultiThreadedOptionsAccess(DataController.MultiThreadedOptions).IsMultiThreadedSorting;
  dxQuickSortList(FItems, @CompareItems, B);
  FHelper.Clear;
...
begin
  ...
  if (Field = AField) and (PivotGrid <> nil) and (not IsTotal or AIncludeTotals) then
    ...
    begin
      ...
      Inc(Result, cxTextWidth(AParams.Font, Value) + cxMarginsWidth(LookAndFeelPainter.HeaderContentOffsets(ScaleFactor)));
      Exit;
    end;

  if IsGrandTotal and ((AField = Field) or (ItemCount = 0)) then
   Inc(Result, cxTextWidth(PivotGrid.Styles.GetRowHeaderParams(Self).Font, Value) +
     cxMarginsWidth(PivotGrid.LookAndFeelPainter.HeaderContentOffsets(ScaleFactor)))
  else
    for I := 0 to ItemCount - 1 do
...
function TcxPivotGridAdvancedDataGroupIntervalItem.GetGroupValue(const AValue: Variant): Variant;
begin
  Result := FGetGroupValueFunc(AValue);
end;

function TcxPivotGridAdvancedDataGroupIntervalItem.GetGroupValueDisplayText(const AValue: Variant): string;
begin
  Result := FGetGroupValueDisplayTextFunc(AValue);
end;

function TcxPivotGridAdvancedDataGroupIntervalItem.GetName: string;
begin
  Result := FDisplayName;
end;

class function TcxPivotGridAdvancedDataGroupIntervalItem.Register: Integer;
begin
  Result := Create.RegisterInstance;
end;

function TcxPivotGridAdvancedDataGroupIntervalItem.GetDateTimeValue(const AValue: Variant; var ADateTime: TDateTime): Boolean;
begin
  Result := VarIsSoftNumeric(AValue);
  if Result then
  try
...
function TcxPivotGridAdvancedDataGroupIntervalItem.HalfOfTheYear(const AValue: TDateTime): Integer;
begin
  Result := (MonthOf(AValue) - 1) div 6 + 1;
end;

function TcxPivotGridAdvancedDataGroupIntervalItem.QuarterOfTheYear(const AValue: TDateTime): Integer;
begin
  Result := (MonthOf(AValue) - 1) div 3 + 1;
end;

function TcxPivotGridAdvancedDataGroupIntervalItem.RegisterInstance: Integer;
var
  AIndex: Integer;
  APrevItem: TcxPivotGridAdvancedDataGroupIntervalItem;
begin
  AIndex := TcxPivotGridAdvancedDataGroupIntervalRepository.FindItemByName(GetName, APrevItem);
  if AIndex >= 0 then
  begin
    Result := APrevItem.FID;
    TcxPivotGridAdvancedDataGroupIntervalRepository.FItems[AIndex] := self;
  end
  else
  begin
    Result := TcxPivotGridAdvancedDataGroupIntervalRepository.GetNextID;
    TcxPivotGridAdvancedDataGroupIntervalRepository.FItems.Add(Self);
  end;
  Self.FID := Result;
end;
...
class destructor TcxPivotGridAdvancedDataGroupIntervalRepository.Finalize;
begin
  {$IFDEF DX_INITIALIZATION_LOGGING}TdxUnitSectionsLogger.DestructorStarted(UnitName, 'TcxPivotGridAdvancedDataGroupIntervalRepository.Finalize', SysInit.HInstance);{$ENDIF}
  FItems.Free;
  {$IFDEF DX_INITIALIZATION_LOGGING}TdxUnitSectionsLogger.DestructorFinished(UnitName, 'TcxPivotGridAdvancedDataGroupIntervalRepository.Finalize', SysInit.HInstance);{$ENDIF}
end;

class function TcxPivotGridAdvancedDataGroupIntervalRepository.GetCount: Integer;
begin
  Result := FItems.Count;
end;

class function TcxPivotGridAdvancedDataGroupIntervalRepository.GetItem(Index: Integer): TcxPivotGridAdvancedDataGroupIntervalItem;
begin
  Result := FItems[Index];
end;

class function TcxPivotGridAdvancedDataGroupIntervalRepository.GetItemByID(ID: Integer): TcxPivotGridAdvancedDataGroupIntervalItem;
var
  I: Integer;
begin
  Result := nil;
...
class function TcxPivotGridAdvancedDataGroupIntervalRepository.GetItemByName(const ADisplayName: string): TcxPivotGridAdvancedDataGroupIntervalItem;
begin
  if FindItemByName(ADisplayName, Result) < 0 then
    Result := nil;
end;

class function TcxPivotGridAdvancedDataGroupIntervalRepository.Register(const ADisplayName: string;
  AGetGroupValueFunc: TcxPivotGridGroupValueFunc<Variant, Variant>; AGetGroupValueDisplayTextFunc: TcxPivotGridGroupValueFunc<Variant, string>): Integer;
var
  AItem: TcxPivotGridAdvancedDataGroupIntervalItem;
begin
  AItem := TcxPivotGridAdvancedDataGroupIntervalItem.Create;
  AItem.FDisplayName := ADisplayName;
  AItem.FGetGroupValueFunc := AGetGroupValueFunc;
  AItem.FGetGroupValueDisplayTextFunc := AGetGroupValueDisplayTextFunc;
  Result := AItem.RegisterInstance;
end;

class procedure TcxPivotGridAdvancedDataGroupIntervalRepository.Unregister(ID: Integer);
var
  I: Integer;
begin
  for I := 0 to FItems.Count - 1 do
...
class constructor TcxPivotGridAdvancedDataGroupIntervalRepository.Initialize;
begin
  {$IFDEF DX_INITIALIZATION_LOGGING}TdxUnitSectionsLogger.ConstructorStarted(UnitName, 'TcxPivotGridAdvancedDataGroupIntervalRepository.Initialize', SysInit.HInstance);{$ENDIF}
  FItems := TObjectList<TcxPivotGridAdvancedDataGroupIntervalItem>.Create();
  THalfYearGroupInterval.Register;
  TQuarterYearGroupInterval.Register;
  TMonthYearGroupInterval.Register;
  {$IFDEF DX_INITIALIZATION_LOGGING}TdxUnitSectionsLogger.ConstructorFinished(UnitName, 'TcxPivotGridAdvancedDataGroupIntervalRepository.Initialize', SysInit.HInstance);{$ENDIF}
end;

class function TcxPivotGridAdvancedDataGroupIntervalRepository.GetNextID: Integer;
begin
  Inc(FID);
  Result := FID;
end;

class function TcxPivotGridAdvancedDataGroupIntervalRepository.FindItemByName(
  const ADisplayName: string; var AItem: TcxPivotGridAdvancedDataGroupIntervalItem): Integer;
var
  I: Integer;
begin
  Result := -1;
  for I := 0 to FItems.Count - 1 do
   if SameText(FItems[I].GetName, ADisplayName) then
   begin
     AItem := FItems[I];
     Exit(I);
   end;
...
function TcxPivotGridAdvancedDataGroupIntervalRepository.TMonthYearGroupInterval.GetGroupValue(const AValue: Variant): Variant;
var
  ADate: TDateTime;
begin
  if GetDateTimeValue(AValue, ADate) then
    Result := StartOfTheMonth(ADate)
  else
    Result := Null;
end;

function TcxPivotGridAdvancedDataGroupIntervalRepository.TMonthYearGroupInterval.GetGroupValueDisplayText(const AValue: Variant): string;
begin
  if VarIsSoftNumeric(AValue) then
    Result := dxFormatSettings.LongMonthNames[MonthOf(AValue)] + ', ' + IntToStr(YearOf(AValue))
  else
    Result := '';
end;

function TcxPivotGridAdvancedDataGroupIntervalRepository.TMonthYearGroupInterval.GetName: string;
begin
  Result := 'Month, Year';
end;

{ TcxPivotGridAdvancedDataGroupIntervalRepository.TQuarterYearGroupInterval }

function TcxPivotGridAdvancedDataGroupIntervalRepository.TQuarterYearGroupInterval.GetGroupValue(
...
begin
  ...
  begin
    ...
    Result := EncodeDate(Y, (M - 1) div 3 * 3 + 1, 1);
  end
  else
    Result := Null;
end;

function TcxPivotGridAdvancedDataGroupIntervalRepository.TQuarterYearGroupInterval.GetGroupValueDisplayText(
  const AValue: Variant): string;
begin
  if VarIsSoftNumeric(AValue) then
    Result := Format(cxGetResourceString(@scxQuarterFormat), [QuarterOfTheYear(AValue)]) + ', ' + IntToStr(YearOf(AValue))
  else
    Result := ''
end;

function TcxPivotGridAdvancedDataGroupIntervalRepository.TQuarterYearGroupInterval.GetName: string;
begin
  Result := 'Quarter, Year';
end;

{ TcxPivotGridAdvancedDataGroupIntervalRepository.THalfYearGroupInterval }

function TcxPivotGridAdvancedDataGroupIntervalRepository.THalfYearGroupInterval.GetGroupValue(const AValue: Variant): Variant;
var
  Y, M, D: Word;
  ADate: TDateTime;
begin
  ...
  begin
    DecodeDate(ADate, Y, M, D);
    Result := EncodeDate(Y, (M - 1) div 6 * 6 + 1, 1);
  end
  else
    Result := Null;
end;

function TcxPivotGridAdvancedDataGroupIntervalRepository.THalfYearGroupInterval.GetGroupValueDisplayText(
  const AValue: Variant): string;
begin
  if VarIsSoftNumeric(AValue) then
    Result := Format(cxGetResourceString(@scxHalfFormat), [HalfOfTheYear(AValue)]) + ', ' + IntToStr(YearOf(AValue))
  else
    Result := ''
end;

function TcxPivotGridAdvancedDataGroupIntervalRepository.THalfYearGroupInterval.GetName: string;
begin
  Result := 'Half Year, Year';
end;

procedure InitializePivotGrid;
var
  I: Integer;
const
  MenuResNames: array[0..8] of string =
    ('CXPIVOT_POPUPMENU_COUNT', 'CXPIVOT_POPUPMENU_SUM', 'CXPIVOT_POPUPMENU_MIN', 'CXPIVOT_POPUPMENU_MAX',
     'CXPIVOT_POPUPMENU_AVERAGE', 'CXPIVOT_POPUPMENU_FIELDLIST', 'CXPIVOT_POPUPMENU_REFRESHDATA',
     'CXPIVOT_POPUPMENU_EXPANDALL', 'CXPIVOT_POPUPMENU_COLLAPSEALL');
begin
  ...
  InternalMenuImages := TcxImageList.CreateSize(16, 16);
  for I := 0 to High(MenuResNames) do
    PivotGridError((InternalMenuImages.AddImageFromResource(HInstance, MenuResNames[I], 'SVG') >= 0)
       or True , Format('Invalid %d Resource Image', [I]));
end;

procedure FinalizePivotGrid;
begin
  FreeAndNil(CompareHelper);
  FreeAndNil(FKPIImageList);
  FreeAndNil(FHierarchyImages);
  FreeAndNil(InternalMenuImages);
end;

{ TdxRemovePaddingsTuner }

procedure TdxRemovePaddingsTuner.AdjustPadding(var APadding: TdxPadding);
begin
...
initialization
  ...
  dxUnitsLoader.AddUnit(SysInit.HInstance, dxThisUnitName, InitializePivotGrid, FinalizePivotGrid);

finalization

  dxUnitsLoader.RemoveUnit(SysInit.HInstance, dxThisUnitName, FinalizePivotGrid);
