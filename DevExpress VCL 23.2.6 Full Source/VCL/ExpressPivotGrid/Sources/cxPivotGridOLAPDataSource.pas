...
{$ENDREGION}
  ...
  protected
    FDataSetFieldIndexes: TdxIntegerList;
    FPivotGridFields: TList<TcxPivotGridField>;
    function GetFieldCount: Integer; override;
    function GetPivotGridField(AIndex: Integer): TcxPivotGridField; override;
    function GetRecordCount: Integer; override;
  ...
  protected
    ...
    procedure PopulateHierarchyAllMemberNames(const ACubeName: string; ANames: TdxStringsDictionary); virtual; abstract;
...
const
  dxThisUnitName = 'cxPivotGridOLAPDataSource';
...
begin
  ...
  begin
    FDataSetFieldIndexes := TdxIntegerList.Create;
    FPivotGridFields := TList<TcxPivotGridField>.Create;
  end
  else
  begin
