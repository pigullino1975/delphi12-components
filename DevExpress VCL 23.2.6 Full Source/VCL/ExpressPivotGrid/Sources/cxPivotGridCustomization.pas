...
uses
  ...
  dxCore, cxClasses,
  cxControls, cxGraphics, dxCoreGraphics, cxDropDownEdit, cxButtons, cxLookAndFeels, cxListBox, cxLabel,
...
const
  dxThisUnitName = 'cxPivotGridCustomization';
...
begin
  ...
  begin
    ...
    try
      AFieldViewInfo.AlignVert := vaCenter;
...
begin
  ItemHeight := Max(LookAndFeelPainter.ScaledHeaderHeight(cxTextHeight(Font), ScaleFactor), FieldChooser.FieldItemHeight);
end;
