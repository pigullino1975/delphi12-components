...
uses
  Variants, Math, Graphics, Forms, StdCtrls, ComCtrls, StrUtils, DateUtils, LocalizationStrs;
...
begin
  Result := '';
  ALookupValue := mdStatesSpr.Lookup('ID', AStateIndex, 'ShortName');
  if not VarIsNull(ALookupValue) then
    Result := ALookupValue;
end;
