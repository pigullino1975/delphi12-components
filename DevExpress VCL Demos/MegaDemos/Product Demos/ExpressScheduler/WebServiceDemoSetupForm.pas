...
procedure TWebServiceDemoSetupWizard.FormShow(Sender: TObject);
begin
  reAbout.Style.Font.Color := RootLookAndFeel.Painter.DefaultEditorTextColor(False);
  reMSGraph.Style.Font.Color := RootLookAndFeel.Painter.DefaultEditorTextColor(False);
  reGoogleApi.Style.Font.Color := RootLookAndFeel.Painter.DefaultEditorTextColor(False);
end;
...
procedure TWebServiceDemoSetupWizard.teChange(Sender: TObject);
begin
  UpdateStateButtons;
end;
