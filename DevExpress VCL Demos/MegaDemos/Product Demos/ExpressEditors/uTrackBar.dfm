inherited frmTrackBar: TfrmTrackBar
  inherited lcFrame: TdxLayoutControl
    object cbOrientation: TcxCheckBox [0]
      Left = 376
      Top = 46
    ...
    object cbReverseDirection: TcxCheckBox [1]
      Left = 376
      Top = 73
    ...
    object cbShowChangeButtons: TcxCheckBox [2]
      Left = 376
      Top = 100
    ...
    object cbShowTrack: TcxCheckBox [3]
      Left = 376
      Top = 154
      Action = acShowTrack
      Style.BorderColor = clWindowFrame
    ...
    object cmbTickMarks: TcxComboBox [6]
      Left = 460
      Top = 235
      Properties.DropDownListStyle = lsFixedList
      Properties.Items.Strings = (
    ...
    object cmbTickType: TcxComboBox [7]
      Left = 460
      Top = 262
      Properties.DropDownListStyle = lsFixedList
      Properties.Items.Strings = (
    ...
    object edTickSize: TcxSpinEdit [8]
      Left = 460
      Top = 289
    ...
    object edFrequency: TcxSpinEdit [10]
      Left = 460
      Top = 181
      Properties.ImmediatePost = True
    ...
    object dxLayoutItem1: TdxLayoutItem
      ...
      AlignHorz = ahCenter
      AlignVert = avCenter
      CaptionOptions.Text = 'cxTrackBar1'
      CaptionOptions.Visible = False
      Control = TrackBar
