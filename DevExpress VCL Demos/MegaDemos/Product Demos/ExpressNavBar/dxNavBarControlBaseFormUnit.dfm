object dxNavBarControlDemoUnitForm: TdxNavBarControlDemoUnitForm
  Left = 0
  Top = 0
  Align = alClient
  BorderStyle = bsNone
  Caption = 'dxNavBarControlDemoUnitForm'
  ClientHeight = 306
  ClientWidth = 384
  Color = clBtnFace
  ...
  object lcMain: TdxLayoutControl
    ...
    object BaseAutoCreatedGroup: TdxLayoutAutoCreatedGroup
      Parent = lcMainGroup_Root
      AlignVert = avClient
      LayoutDirection = ldHorizontal
      Index = 0
