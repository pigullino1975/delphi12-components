object dxCustomSpreadSheetDemoUnitForm: TdxCustomSpreadSheetDemoUnitForm
  Left = 0
  Top = 0
  Width = 451
  Height = 305
  ...
  ParentFont = False
  TabOrder = 0
  object lcCustom: TdxLayoutControl
    Left = 0
    Top = 0
    Width = 451
    Height = 305
    ...
    object lcCustomGroup_Root: TdxLayoutGroup
    ...
    object lgFeedback: TdxLayoutGroup
    ...
    object lliDescriprion: TdxLayoutLabeledItem
      Parent = lgFeedback
      AlignHorz = ahClient
      AlignVert = avClient
