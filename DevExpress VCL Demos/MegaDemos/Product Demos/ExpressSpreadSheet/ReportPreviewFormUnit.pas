...
{$ENDIF}
  ...
  cxGraphics, cxControls, cxLookAndFeels, cxLookAndFeelPainters, dxCore, dxCoreClasses, 
  ...
  dxSpreadSheetPrinting, dxSpreadSheetTypes, dxSpreadSheetUtils, dxBarBuiltInMenu, dxRibbonSkins,
  dxRibbonCustomizationForm, cxFontNameComboBox, cxDropDownEdit, ImgList, dxPrinting, 
  dxSpreadSheetActions, dxSpreadSheetConditionalFormattingRulesActions, ActnList, dxActions, 
  dxBar, dxRibbonColorGallery, cxBarEditItem, cxClasses, dxRibbon, dxSpreadSheet, dxSpreadSheetFormattedTextUtils,
  ...
  dxSpreadSheetCoreStrs, dxPSdxSpreadSheetLnkCore, dxRibbonForm, dxGallery, dxRibbonGallery, dxRibbonMarginsGallery, Actions;

type
  TfrmPreview = class(TdxRibbonForm)
    Report: TdxSpreadSheet;
    dxRibbon1: TdxRibbon;
  ...
  public
    procedure InitializeRibbon(ARibbon: TdxRibbon);
  end;
...
procedure TfrmPreview.InitializeRibbon(ARibbon: TdxRibbon);
begin
  DisableAero := ARibbon.Style >= rs2013;
  dxRibbon1.Style := ARibbon.Style;
  dxRibbon1.ColorSchemeName := ARibbon.ColorSchemeName;
end;
