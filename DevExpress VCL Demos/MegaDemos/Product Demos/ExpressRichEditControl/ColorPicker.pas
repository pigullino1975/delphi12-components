...
{$IFDEF DELPHI16}
  System.UITypes,
{$ENDIF}
  Windows, Classes, Forms, Graphics, dxBar, dxRibbonGallery, cxGraphics, dxRibbon, dxColorDialog, dxGDIPlusClasses,
  cxGeometry, Contnrs;
...
type
  ...
  public
    constructor Create(AContainerItem: TObject; AColorItem, AColorMapItem: TdxRibbonGalleryItem;
      ADefaultColor: TColor; ADefaultColorCaption: string); virtual;
  ...
  public
    constructor Create(APopupMenu: TdxRibbonPopupMenu; AColorItem, AColorMapItem: TdxRibbonGalleryItem;
      ADefaultColor: TColor; ADefaultColorCaption: string); reintroduce; virtual;
  end;
...
uses
  Types, SysUtils, dxCoreGraphics, RibbonRichEditDemoGallerySetup, dxRibbonColorGallery;
...
procedure InitColorItem;
  begin
    ...
    FColorItem.GalleryGroups[1].Options.SpaceBetweenItemsVertically := -1;
  end;
  ...
  begin
    ...
    FContainerItemLinks.Add(FColorItem);
...
begin
  ...
  FColorItem := BarDesignController.CreateDetachedItem(TdxRibbonColorGalleryInternalItem, AColorItem.BarManager, AColorItem.BarManager, FInternalItems) as TdxRibbonColorGalleryInternalItem;
  FColorItem.Assign(AColorItem);
...
constructor TPopupColorPickerController.Create(APopupMenu: TdxRibbonPopupMenu;
  AColorItem, AColorMapItem: TdxRibbonGalleryItem;
  ADefaultColor: TColor; ADefaultColorCaption: string);
begin
  inherited Create(APopupMenu, AColorItem, AColorMapItem, ADefaultColor, ADefaultColorCaption);
end;
...
begin
  inherited Create(ASubItem, AColorItem, AColorMapItem,
    ADefaultColor, ADefaultColorCaption);
end;
