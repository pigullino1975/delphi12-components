...
uses
  Windows, Messages, SysUtils, Variants, Classes, Graphics, Controls, Forms, Dialogs, ActnList, cxPC, dxTabbedMDI,
  dxBar, cxLookAndFeels, ImgList, cxGraphics, cxClasses, dxBarExtItems, cxFontNameComboBox, cxBarEditItem,
...
procedure TfrmBarsNotepadMain.scgiLookAndFeelPopulate(Sender: TObject);
begin
...
procedure TfrmBarsNotepadMain.bbAboutClick(Sender: TObject);
begin
  dxShowAboutForm;
end;
...
procedure TfrmBarsNotepadMain.InitializeLookAndFeel;
begin
  inherited;
  scgiLookAndFeel.SelectedSkinName := sdxFirstSelectedSkinName;
end;
