...
uses
  ...
  cxLabel, cxTextEdit, cxDropDownEdit, cxLookAndFeels, dxLayoutContainer, ActnList, dxLayoutLookAndFeels,
  dxLayoutControl, dxLayoutcxEditAdapters, cxImageList, dxScrollbarAnnotations, ImageList, Actions,
  cxFilter;
...
begin
  ...
  cbStyle.ItemIndex := 0;
  TreeList.LookAndFeel.SkinName := '';
end;

function TfrmTreeListStyles.HasOptions: Boolean;
begin
  Result := True;
end;
