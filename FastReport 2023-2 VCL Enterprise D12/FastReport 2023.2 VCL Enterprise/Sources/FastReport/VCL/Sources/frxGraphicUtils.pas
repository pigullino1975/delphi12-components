...
uses
  ...
  frCore, frCoreClasses, frUnicodeUtils, frxClass, Variants, frxVectorCanvas;
...
// call these methods before and after doing something
    ...
    property ForcedWordBreak: Boolean read FForcedWordBreak;
  end;
