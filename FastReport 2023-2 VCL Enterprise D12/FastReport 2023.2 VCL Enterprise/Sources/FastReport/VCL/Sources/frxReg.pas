...
const
  frxDefaultProductPage = 'FastReport'{$IFNDEF FPC} + ' VCL'{$ENDIF};
...
{$ENDIF}
  ...
  RegisterComponents(frxDefaultProductPage,
...
{$ENDIF}
  RegisterComponents(frxDefaultProductPage + ' Tools',
    [TfrxDockSite, TfrxTBPanel, TfrxComboEdit,
     TfrxComboBox, TfrxFontComboBox, TfrxRuler, TfrxScrollBox, TfrxColorComboBox, TfrxDockToolBar{$IFDEF FPC}, TfrxControlBar{$ENDIF}]);
