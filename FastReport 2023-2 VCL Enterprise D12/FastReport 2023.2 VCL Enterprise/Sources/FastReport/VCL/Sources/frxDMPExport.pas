...
{$IFDEF FPC}
  LResources,
{$ENDIF}
  Messages, SysUtils, Classes, Graphics, Controls, Forms, Dialogs, Variants,
  StdCtrls, ExtCtrls, frxClass, Buttons, ComCtrls,
  frCore, frxDMPClass, frXML;
...
type
  ...
  public
    ...
    procedure ReadPrinters(x: TfrXMLDocument);
...
procedure TfrxDMPrinters.ReadPrinters(x: TfrXMLDocument);
var
  i, j: Integer;
  xi: TfrXMLItem;
  Item: TfrxDMPrinter;
