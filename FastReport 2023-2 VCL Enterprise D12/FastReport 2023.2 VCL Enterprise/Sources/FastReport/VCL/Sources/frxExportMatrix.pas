...
uses
  ...
  SysUtils, Classes, Graphics, frxClass, frxPreviewPages, frBaseGraphicsTypes,
  frxProgress, Printers, frxUtils, frUnicodeUtils, frPictureCache,
  frPictureGraphics, frxExportHelpers
{$IFDEF FPC}
