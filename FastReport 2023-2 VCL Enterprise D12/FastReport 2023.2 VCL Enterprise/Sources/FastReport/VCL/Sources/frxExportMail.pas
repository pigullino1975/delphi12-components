...
uses
  ...
  StdCtrls, extctrls, frxClass, IniFiles, ComCtrls, frCore,
{$IFDEF USE_INDY}
  IdSMTP, IdMessage,
...
uses
  frHashUtils,
  frxDsgnIntf, frxFileUtils, frxNetUtils, frxUtils,
  frUnicodeUtils, frxRes, Registry,
  frxSendMAPI, ComObj;
...
//      CheckBox1.Checked := FUseMAPI;
      ...
      try
        ...
        begin
          ...
          LoginE.Text := String(frBase64Decode(AnsiString(ini.ReadString(Section, 'Login', ''))));
          PasswordE.Text := String(frBase64Decode(AnsiString(ini.ReadString(Section, 'Password', ''))));
...
//          FUseMAPI := CheckBox1.Checked;
          ...
          begin
            ...
            ini.WriteString(Section, 'Login', String(frBase64Encode(AnsiString(LoginE.Text))));
            ini.WriteString(Section, 'Password', String(frBase64Encode(AnsiString(PasswordE.Text))));
