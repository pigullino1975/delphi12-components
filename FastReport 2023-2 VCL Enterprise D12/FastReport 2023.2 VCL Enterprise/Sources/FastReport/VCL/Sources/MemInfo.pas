...
type
  ...
  TGetProcessMemoryInfo = function (Process: TfrHandle; out Counters; cb: DWORD): BOOL stdcall;
...
function GetProcessMemoryInfo(Process: TfrHandle; out Counters; cb: DWORD): BOOL;
begin
