...
uses
  ComCtrls, frxDesgnCtrls, frUtils, frxUtils, frxDataTree, frxDMPClass, frxRes;
...
var
  ...
  begin
    if AGuides.IndexOf(frFloatToStr(Position)) = -1 then
    begin
      AGuides.Add(frFloatToStr(Position));
