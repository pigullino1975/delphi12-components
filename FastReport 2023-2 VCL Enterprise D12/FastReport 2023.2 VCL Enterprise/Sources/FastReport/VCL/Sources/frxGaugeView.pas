...
uses
  frxDsgnIntf, frUtils, frxUtils, frxRes, frxGaugeViewRTTI, frxGaugeEditor, Variants, SysUtils;
...
begin
  ...
  try
    ...
    GetData;
    aItem.Item[Index] := frFloatToStr(FGauge.CurrentValue);
  finally
...
begin
  ...
  if Assigned(Parent) then
    bName := Parent.Name;
  s := frFloatToStr(FGauge.CurrentValue);
