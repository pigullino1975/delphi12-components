...
{$ENDIF}
  ...
  frxClass, ComCtrls, frZip, frxImageConverter,
...
uses
  frxUtils, frxFileUtils, frUnicodeUtils, frxRes, frxGraphicUtils,
  frxOfficeOpen, frxExportPPTXDialog, frxPlatformServices, frBaseGraphicsTypes;
...
var
  ...
  IntertNum: Integer;
begin
  if (Obj.Height * Obj.Width = 0) and not (Obj is TfrxLineView) then Exit;
  Inc(FObjectId);
{$IFDEF FPC}
