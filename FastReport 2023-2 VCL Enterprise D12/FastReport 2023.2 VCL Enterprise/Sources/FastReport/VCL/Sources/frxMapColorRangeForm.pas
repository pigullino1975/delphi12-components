...
uses
  frxRes, frUtils, frxUtils, frxDsgnIntf, frxMapLayer, Types, Math;
...
begin
  inherited;
  frxImages.MainButtonImages.GetBitmap(100, UpSpeedButton.Glyph);
  frxImages.MainButtonImages.GetBitmap(101, DownSpeedButton.Glyph);
end;
...
begin
  Result := inherited AsString(FValueFormat) +
    ' - ' + frIfStr(AutoColor, GetStr('Auto'), ColorToString(Color));
end;
