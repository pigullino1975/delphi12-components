...
{$ENDIF}
  ...
  Dialogs, frCoreClasses,
  frxClass, frxDMPClass, frxDesgn, frxDsgnIntf, frxUtils,
  ...
  frUnicodeUtils, frxPrinter, math, Variants, frCore, frxSignatureEditor;
...
initialization
  ...
  frxPropertyEditors.Register(TypeInfo(TfrxStyleName), TfrxView, 'Style', TfrxStyleProperty);
