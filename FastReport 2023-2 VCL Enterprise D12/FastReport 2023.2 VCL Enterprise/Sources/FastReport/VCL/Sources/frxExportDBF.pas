...
uses
  ...
  StdCtrls, extctrls, frxClass, frxExportMatrix, frCore
...
uses frxUtils, frxFileUtils, frUnicodeUtils, frxRes;
...
begin
  ...
  begin
    if Report.FileName <> '' then
      FileName := ChangeFileExt(frGetTemporaryFolder +
        ExtractFileName(Report.FileName), frxGet(9103))
    else
      FileName := ChangeFileExt(frGetTempFile, frxGet(9103))
  end;
