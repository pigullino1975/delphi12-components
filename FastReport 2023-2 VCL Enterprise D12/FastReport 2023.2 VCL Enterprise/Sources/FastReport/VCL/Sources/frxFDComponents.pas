...
uses
  Windows, Classes, SysUtils, DB, frxClass, frxCustomDB, frXML, frCore,
  {$IFDEF ANYDAC}
...
{-------------------------------------------------------------------------------}
procedure TfrxFDQuery.WriteNestedProperties(Item :TfrXmlItem; aAcenstor :TPersistent = nil);
begin
...
{-------------------------------------------------------------------------------}
function TfrxFDQuery.ReadNestedProperty(Item :TfrXmlItem) :Boolean;
begin
...
begin
 ...
 if FAfterOpen <> '' then begin
   ...
   vArr := VarArrayOf([frInteger(DataSet)]);
...
begin
 ...
 if FOnFilterRecord <> '' then begin
   ...
   vArr := VarArrayOf([frInteger(DataSet), Accept]);
...
begin
 ...
 vArr := VarArrayOf([frInteger(Field)]);
...
begin
 ...
 vArr := VarArrayOf([frInteger(Field), Text, DisplayText]);
