...
procedure DbgDumpObj(Obj: TObject; Node: TfrXMLItem);
...
procedure DumpMatrix(Matrix: TfrxIEMatrix; Node: TfrXMLItem);
var
  i, j: LongInt;
  Obj: TfrxIEMObject;
begin
...
procedure DumpReportPage(Page: TfrxReportPage; Node: TfrXMLItem);
begin
  with Node do
  begin
...
procedure DumpIEMObject(Obj: TfrxIEMObject; Node: TfrXMLItem);
begin
  with Node do
  begin
