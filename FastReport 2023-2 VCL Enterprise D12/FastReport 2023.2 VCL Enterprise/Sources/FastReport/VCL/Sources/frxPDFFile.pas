...
uses
  ...
  ComObj, ComCtrls, frxClass, frxUtils, JPEG, frUnicodeUtils
...
uses
  frxGraphicUtils, frGZip, frHashUtils, ActiveX, SyncObjs, math;
...
begin
  ...
  try
    ...
    begin
      frDeflateStream(TmpPageStream2, TmpPageStream, gzFastest);
          ...
          begin
            ...
            try
              ...
              try
                ...
                try
                  frDeflateStream(MemStream, MemStream1, gzMax);
