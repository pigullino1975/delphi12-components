...
{$ELSE}
  Windows,
{$ENDIF}
  Classes, Contnrs, frCore, frxClass, Graphics, Types, frxMapHelpers, frxOSMFileFormat,
...
(******************************************************************************)
  ...
  private
    ...
    function GetShape(Index: TfrListInteger): TShape;
    procedure SetShape(Index: TfrListInteger; const AShape: TShape);
  protected
  ...
  public
    ...
    property Items[Index: TfrListInteger]: TShape read GetShape write SetShape; default;
...
function TShapeList.GetShape(Index: TfrListInteger): TShape;
begin
...
procedure TShapeList.SetShape(Index: TfrListInteger; const AShape: TShape);
begin
