...
uses
  ...
  ,frLazGraphicClasses, typinfo, types, LazGraphicHelper
{$IFNDEF NONWINFPC}
...
uses
  frxUtils, Printers, frxPrinter, frCore
...
begin
 ...
 constructor TfrxControlBar.Create(AOwner: TComponent);
begin
