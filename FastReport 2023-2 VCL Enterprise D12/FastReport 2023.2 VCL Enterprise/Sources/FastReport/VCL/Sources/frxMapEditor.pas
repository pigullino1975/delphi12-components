...
uses
  ...
  frxMapColorRangeForm, frxMapSizeRangeForm, frDPIAwareUtils;
...
begin
  ...
  frxImages.MainButtonImages.GetBitmap(100, UpButton.Glyph);
  ...
  frxImages.MainButtonImages.GetBitmap(101, DownButton.Glyph);
end;
