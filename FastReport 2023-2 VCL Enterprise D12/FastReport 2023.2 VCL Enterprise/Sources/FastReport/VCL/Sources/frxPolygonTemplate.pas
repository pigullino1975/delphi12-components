...
uses
  ...
  frCore, frxJSON, frxMapHelpers, frxAnaliticGeometry;
...
type
  ...
  private
    function GetItems(Index: TfrListInteger): TAbstractTemplateComponent;
    procedure SetItems(Index: TfrListInteger; const Value: TAbstractTemplateComponent);
  public
    constructor Create;

    property Items[Index: TfrListInteger]: TAbstractTemplateComponent read GetItems write SetItems; default;
  end;
  ...
  private
    function GetTemplate(Index: TfrListInteger): TfrxPolygonTemplate;
    procedure SetTemplate(Index: TfrListInteger; const Value: TfrxPolygonTemplate);
  ...
  public
    ...
    property Items[Index: TfrListInteger]: TfrxPolygonTemplate read GetTemplate write SetTemplate; default;
...
function TfrxPolygonTemplateList.GetTemplate(Index: TfrListInteger): TfrxPolygonTemplate;
begin
  Result := (inherited Items[Index]) as TfrxPolygonTemplate;
end;

procedure TfrxPolygonTemplateList.SetTemplate(Index: TfrListInteger; const Value: TfrxPolygonTemplate);
begin
...
function TTemplateComponentList.GetItems(Index: TfrListInteger): TAbstractTemplateComponent;
begin
  Result := (inherited Items[Index]) as TAbstractTemplateComponent;
end;

procedure TTemplateComponentList.SetItems(Index: TfrListInteger; const Value: TAbstractTemplateComponent);
begin
  inherited Items[Index] := Value;
end;
