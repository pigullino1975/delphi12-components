...
uses
  ...
  {$ENDIF}
  Graphics, Menus, Controls, Types,
  Classes, Contnrs, frxClass, frXML, frxAnaliticGeometry;
...
type
  ...
  TfrxMapXMLReader = class(TfrXMLReader)
  protected
    FValueDlm: TValueDlm;
  ...
  public
    ...
    function IsReadMapXMLRootItem(Item: TfrXMLItem): Boolean;
    function IsReadMapXMLItem(Item: TfrXMLItem): Boolean;
  end;

  TfrxMapXMLDocument = class(TfrXMLDocument)
  protected
...
uses
  Math, SysUtils, Dialogs, frxUtils, frPictureGraphics;
...
function TfrxMapXMLReader.IsReadMapXMLItem(Item: TfrXMLItem): Boolean;
var
...
function TfrxMapXMLReader.IsReadMapXMLRootItem(Item: TfrXMLItem): Boolean;
var
...
function TfrxMapXMLDocument.IsReadItem(Item: TfrXMLItem): Boolean;
begin
