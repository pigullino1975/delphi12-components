  ...
  begin
    Item := frxWizards[i];
      ...
      if Item.WizardButtonBmp <> nil then
        begin
          frxImages.SetWizardImages(Item.WizardButtonBmp);
          Item.ButtonImageIndex := frxImages.WizardImages.Count - 1;
        end
      else if Item.ButtonBmp <> nil then
        begin
          frxImages.SetWizardImages(Item.ButtonBmp);
          Item.ButtonImageIndex := frxImages.WizardImages.Count - 1;
        end;
    end;
...
begin
  inherited;
  ItemsLV.LargeImages := frxImages.WizardImages;
  TemplateLV.LargeImages := frxImages.WizardImages;
end;
