...
uses
  SysUtils, Dialogs, Math, frxRes, frUtils, frxUtils;
...
begin
  Result := frIfStr(AutoStart, GetStr('Auto'), Format(FValueFormat, [StartValue])) +
    ' - ' + frIfStr(AutoEnd,   GetStr('Auto'), Format(FValueFormat, [EndValue]));
end;
...
begin
  Result := frIfInt(FMapScale.TitleText <> '', CalcTextHeight(FMapScale.TitleFont, '0123456789'));
end;
