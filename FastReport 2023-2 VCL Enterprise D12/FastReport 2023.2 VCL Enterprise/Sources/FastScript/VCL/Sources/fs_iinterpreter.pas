...
{$IFDEF FR_COM}
  protected
    ...
    function AddScriptRTTI: HResult; stdcall;
    function ClearScript: HResult; stdcall;
    function Get_IncludePath(out Value: WideString): HResult; stdcall;
    function Set_IncludePath(const Value: WideString): HResult; stdcall;
{$ENDIF}
  public
...
begin
  FParentValue := val;
  if{$IFDEF DELPHI12} not VarIsArray(val) and {$ENDIF}(val = 0) and (Self is TfsPropertyHelper) then
...
begin
  Lines.SetText(PChar(String(Value)));
  Result := S_OK;
end;

function TfsScript.Get_IncludePath(out Value: WideString): HResult; stdcall;
begin
  Value := IncludePath.GetText;
  Result := S_OK;
end;

function TfsScript.Set_IncludePath(const Value: WideString): HResult; stdcall;
begin
  IncludePath.SetText(PChar(String(Value)));
  Result := S_OK;
end;
...
function TfsScript.AddScriptRTTI: HResult; stdcall;
begin
  AddRTTI;
  Result := S_OK;
end;

function TfsScript.ClearScript: HResult; stdcall;
begin
  Clear;
  Result := S_OK;
end;
