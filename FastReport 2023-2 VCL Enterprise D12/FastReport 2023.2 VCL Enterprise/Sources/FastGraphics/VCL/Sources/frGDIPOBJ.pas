...
\**************************************************************************)
  ...
  public
    ...
    function Equals(region: TGPRegion; g: TGPGraphics): BOOL; {$IFDEF DELPHI14} reintroduce; overload; {$ENDIF}
...
\**************************************************************************)
  ...
  public
    ...
    function Equals(matrix: TGPMatrix): BOOL; {$IFDEF DELPHI14} reintroduce; overload; {$ENDIF}
    function GetLastStatus: TStatus;
  end;
...
\**************************************************************************)
  ...
  public
    ...
    function FromHDC(hdc: HDC; hdevice: TfrHandle): TGPGraphics; overload;
    function FromHWND(hwnd: HWND; icm: BOOL = FALSE): TGPGraphics;
    function FromImage(image: TGPImage): TGPGraphics;
    constructor Create(hdc: HDC); reintroduce; overload;
    constructor Create(hdc: HDC; hdevice: TfrHandle); reintroduce; overload;
...
\**************************************************************************)
  ...
  function TGPGraphics.FromHDC(hdc: HDC; hdevice: TfrHandle): TGPGraphics;
  begin
  ...
  constructor TGPGraphics.Create(hdc: HDC; hdevice: TfrHandle);
  var graphics: GpGraphics;
  begin
    graphics:= nil;
