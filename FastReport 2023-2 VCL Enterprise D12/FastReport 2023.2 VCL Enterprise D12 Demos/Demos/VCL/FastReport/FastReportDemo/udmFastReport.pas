...
uses
  ...
  frxDBSet, Db, frxClass, ADODB, frCoreClasses;
...
{$IFNDEF CPUX64}
  ADOConnection.ConnectionString := 'Provider=Microsoft.Jet.OLEDB.4.0;Data Source=' + ExtractFilePath(Application.ExeName) + '..\..\Data\' + FileName;
{$ELSE}
  ADOConnection.ConnectionString := 'Provider=Microsoft.ACE.OLEDB.12.0;Data Source=' + ExtractFilePath(Application.ExeName) + '..\..\Data\' + FileName;
{$ENDIF}
  ADOConnection.Open;
end;
